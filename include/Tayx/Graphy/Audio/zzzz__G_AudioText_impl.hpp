...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> Tayx::Graphy::Audio::G_AudioText::__get_m_DBText() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Text*, 0x18>(this);
}
constexpr void Tayx::Graphy::Audio::G_AudioText::__set_m_graphyManager(::Tayx::Graphy::GraphyManager*  value)  {
::cordl_internals::setInstanceField<::Tayx::Graphy::GraphyManager*, 0x20>(this, std::forward<::Tayx::Graphy::GraphyManager*>(value));
}
constexpr ::Tayx::Graphy::GraphyManager* Tayx::Graphy::Audio::G_AudioText::__get_m_graphyManager()  {
return ::cordl_internals::getInstanceField<::Tayx::Graphy::GraphyManager*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Tayx::Graphy::GraphyManager*> Tayx::Graphy::Audio::G_AudioText::__get_m_graphyManager() const {
return ::cordl_internals::getInstanceField<::Tayx::Graphy::GraphyManager*, 0x20>(this);
}
constexpr void Tayx::Graphy::Audio::G_AudioText::__set_m_audioMonitor(::Tayx::Graphy::Audio::G_AudioMonitor*  value)  {
::cordl_internals::setInstanceField<::Tayx::Graphy::Audio::G_AudioMonitor*, 0x28>(this, std::forward<::Tayx::Graphy::Audio::G_AudioMonitor*>(value));
}
constexpr ::Tayx::Graphy::Audio::G_AudioMonitor* Tayx::Graphy::Audio::G_AudioText::__get_m_audioMonitor()  {
return ::cordl_internals::getInstanceField<::Tayx::Graphy::Audio::G_AudioMonitor*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Tayx::Graphy::Audio::G_AudioMonitor*> Tayx::Graphy::Audio::G_AudioText::__get_m_audioMonitor() const {
return ::cordl_internals::getInstanceField<::Tayx::Graphy::Audio::G_AudioMonitor*, 0x28>(this);
}
