...
/// @brief Field m_audioGraphGameObject offset 0x18
...
/// @brief Field m_audioDbText offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_audioGraphGameObject() const;

constexpr void __set_m_audioDbText(::UnityEngine::UI::Text*  value) ;

constexpr ::UnityEngine::UI::Text* __get_m_audioDbText() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_audioDbText() const;
...
constexpr ::cordl_internals::to_const_pointer<::Tayx::Graphy::Audio::G_AudioGraph*> __get_m_audioGraph() const;
...
constexpr ::cordl_internals::to_const_pointer<::Tayx::Graphy::Audio::G_AudioText*> __get_m_audioText() const;
...
/// @brief Method Awake addr 0x2a09ff8 size 0x4 virtual false final false
inline void Awake() ;

/// @brief Method Start addr 0x2a09ffc size 0x4 virtual false final false
inline void Start() ;

/// @brief Method SetPosition addr 0x2a00e9c size 0x300 virtual true final true
inline void SetPosition(::Tayx::Graphy::__GraphyManager__ModulePosition  newModulePosition) ;

/// @brief Method SetState addr 0x2a01bac size 0x150 virtual true final true
inline void SetState(::Tayx::Graphy::__GraphyManager__ModuleState  state, bool  silentUpdate) ;

/// @brief Method RestorePreviousState addr 0x2a03608 size 0xc virtual false final false
inline void RestorePreviousState() ;

/// @brief Method UpdateParameters addr 0x2a01d24 size 0x1c4 virtual false final false
inline void UpdateParameters() ;

/// @brief Method RefreshParameters addr 0x2a05ef4 size 0x1bc virtual false final false
inline void RefreshParameters() ;

/// @brief Method Init addr 0x2a04190 size 0x4e4 virtual false final false
inline void Init() ;

/// @brief Method SetGraphActive addr 0x2a0a000 size 0x44 virtual false final false
inline void SetGraphActive(bool  active) ;

static inline ::Tayx::Graphy::Audio::G_AudioManager* New_ctor() ;

/// @brief Method .ctor addr 0x2a0a244 size 0xc0 virtual false final false
inline void _ctor() ;
