...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x78 - sizeof(::Tayx::Graphy::Graph::G_Graph)]{};
...
/// @brief Field m_imageGraphHighestValues offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Image*> __get_m_imageGraphHighestValues() const;
...
constexpr ::cordl_internals::to_const_pointer<::Tayx::Graphy::G_GraphShader*> __get_m_shaderGraphHighestValues() const;
