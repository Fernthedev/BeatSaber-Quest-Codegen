...
/// @brief Field m_ramGraphGameObject offset 0x18
...
/// @brief Field m_backgroundImages offset 0x20
...
/// @brief Field m_previousModuleState offset 0x50
...
/// @brief Field m_currentModuleState offset 0x54
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_ramGraphGameObject() const;
...
constexpr ::cordl_internals::to_const_pointer<::Tayx::Graphy::Ram::G_RamGraph*> __get_m_ramGraph() const;

constexpr void __set_m_ramText(::Tayx::Graphy::Ram::G_RamText*  value) ;

constexpr ::Tayx::Graphy::Ram::G_RamText* __get_m_ramText() ;

constexpr ::cordl_internals::to_const_pointer<::Tayx::Graphy::Ram::G_RamText*> __get_m_ramText() const;
