...
struct CORDL_TYPE __GraphyDebugger__DebugVariable : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____GraphyDebugger__DebugVariable_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __GraphyDebugger__DebugVariable(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __GraphyDebugger__DebugVariable()  = default;
...
struct CORDL_TYPE __GraphyDebugger__DebugComparer : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____GraphyDebugger__DebugComparer_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __GraphyDebugger__DebugComparer(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __GraphyDebugger__DebugComparer()  = default;
...
struct CORDL_TYPE __GraphyDebugger__ConditionEvaluation : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____GraphyDebugger__ConditionEvaluation_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __GraphyDebugger__ConditionEvaluation(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __GraphyDebugger__ConditionEvaluation()  = default;
...
struct CORDL_TYPE __GraphyDebugger__MessageType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____GraphyDebugger__MessageType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __GraphyDebugger__MessageType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __GraphyDebugger__MessageType()  = default;
...
struct CORDL_TYPE __GraphyDebugger__DebugCondition : public ::bs_hook::ValueTypeWrapper<0xc> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0xc};

/// @brief Field Variable offset 0x0
 __declspec(property(get=__get_Variable, put=__set_Variable)) ::Tayx::Graphy::__GraphyDebugger__DebugVariable  Variable;

/// @brief Field Comparer offset 0x4
 __declspec(property(get=__get_Comparer, put=__set_Comparer)) ::Tayx::Graphy::__GraphyDebugger__DebugComparer  Comparer;

/// @brief Field Value offset 0x8
 __declspec(property(get=__get_Value, put=__set_Value)) float_t  Value;

constexpr void __set_Variable(::Tayx::Graphy::__GraphyDebugger__DebugVariable  value) ;

constexpr ::Tayx::Graphy::__GraphyDebugger__DebugVariable& __get_Variable() ;

constexpr ::Tayx::Graphy::__GraphyDebugger__DebugVariable const& __get_Variable() const;

constexpr void __set_Comparer(::Tayx::Graphy::__GraphyDebugger__DebugComparer  value) ;

constexpr ::Tayx::Graphy::__GraphyDebugger__DebugComparer& __get_Comparer() ;

constexpr ::Tayx::Graphy::__GraphyDebugger__DebugComparer const& __get_Comparer() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __GraphyDebugger__DebugCondition(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0xc>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __GraphyDebugger__DebugCondition()  = default;
...
/// @brief Field DebugConditions offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Tayx::Graphy::__GraphyDebugger__DebugCondition>*> __get_DebugConditions() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Events::UnityEvent*> __get_UnityEvents() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Action*>*> __get_Callbacks() const;
...
// Ctor Parameters []
// @brief default ctor
 __GraphyDebugger__DebugPacket()  = default;
public:
...
/// @brief Field packetId offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __GraphyDebugger____c__DisplayClass18_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __GraphyDebugger____c__DisplayClass19_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __GraphyDebugger____c__DisplayClass21_0()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::Tayx::Graphy::Utils::G_Singleton_1<::Tayx::Graphy::GraphyDebugger*>)]{};

/// @brief Field m_debugPackets offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Tayx::Graphy::__GraphyDebugger__DebugPacket*>*> __get_m_debugPackets() const;
