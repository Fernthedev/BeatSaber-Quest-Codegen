...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_fpsText() const;

constexpr void __set_m_msText(::UnityEngine::UI::Text*  value) ;

constexpr ::UnityEngine::UI::Text* __get_m_msText() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_msText() const;

constexpr void __set_m_avgFpsText(::UnityEngine::UI::Text*  value) ;

constexpr ::UnityEngine::UI::Text* __get_m_avgFpsText() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_avgFpsText() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_onePercentFpsText() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_zero1PercentFpsText() const;
