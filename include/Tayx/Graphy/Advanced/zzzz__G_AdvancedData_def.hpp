...
/// @brief Field m_backgroundImages offset 0x18
...
/// @brief Field m_graphicsDeviceVersionText offset 0x20
...
/// @brief Field m_graphicsMemorySizeText offset 0x48
...
/// @brief Field m_screenResolutionText offset 0x50
...
/// @brief Field m_gameWindowResolutionText offset 0x58
...
/// @brief Field m_currentModuleState offset 0x8c
...
/// @brief Field m_windowStrings offset 0x90
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_graphicsDeviceVersionText() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_processorTypeText() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_operatingSystemText() const;

constexpr void __set_m_systemMemoryText(::UnityEngine::UI::Text*  value) ;

constexpr ::UnityEngine::UI::Text* __get_m_systemMemoryText() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_systemMemoryText() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_graphicsDeviceNameText() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_graphicsMemorySizeText() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_screenResolutionText() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_gameWindowResolutionText() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Text::StringBuilder*> __get_m_sb() const;
