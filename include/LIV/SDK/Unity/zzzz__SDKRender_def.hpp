...
static constexpr auto  __IL2CPP_REFERENCE_TYPE_SIZE{0x340};

/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x340 - sizeof(::System::Object)]{};

/// @brief Field _clipPlaneCommandBuffer offset 0x10
...
/// @brief Field _combineAlphaCommandBuffer offset 0x18
...
/// @brief Field _captureTextureCommandBuffer offset 0x20
...
/// @brief Field _applyTextureCommandBuffer offset 0x28
...
/// @brief Field _optimizedRenderingCommandBuffer offset 0x30
...
/// @brief Field _clipPlaneCameraEvent offset 0x38
...
/// @brief Field _optimizedRenderingCameraEvent offset 0x3c
...
/// @brief Field _clipPlaneSimpleDebugMaterial offset 0x50
...
/// @brief Field _clipPlaneComplexMaterial offset 0x58
...
/// @brief Field _clipPlaneComplexDebugMaterial offset 0x60
...
/// @brief Field _writeOpaqueToAlphaMaterial offset 0x68
...
/// @brief Field _combineAlphaMaterial offset 0x70
...
/// @brief Field _backgroundRenderTexture offset 0x88
...
/// @brief Field _foregroundRenderTexture offset 0x90
...
/// @brief Field _optimizedRenderTexture offset 0x98
...
/// @brief Field _complexClipPlaneRenderTexture offset 0xa0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::CommandBuffer*> __get__clipPlaneCommandBuffer() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::CommandBuffer*> __get__combineAlphaCommandBuffer() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::CommandBuffer*> __get__captureTextureCommandBuffer() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::CommandBuffer*> __get__applyTextureCommandBuffer() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rendering::CommandBuffer*> __get__optimizedRenderingCommandBuffer() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Mesh*> __get__clipPlaneMesh() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get__clipPlaneSimpleMaterial() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get__clipPlaneSimpleDebugMaterial() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get__clipPlaneComplexMaterial() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get__clipPlaneComplexDebugMaterial() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get__writeOpaqueToAlphaMaterial() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get__combineAlphaMaterial() const;

constexpr void __set__writeMaterial(::UnityEngine::Material*  value) ;

constexpr ::UnityEngine::Material* __get__writeMaterial() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get__writeMaterial() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get__forceForwardRenderingMaterial() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RenderTexture*> __get__backgroundRenderTexture() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RenderTexture*> __get__foregroundRenderTexture() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RenderTexture*> __get__optimizedRenderTexture() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RenderTexture*> __get__complexClipPlaneRenderTexture() const;

constexpr void __set__liv(::LIV::SDK::Unity::LIV*  value) ;

constexpr ::LIV::SDK::Unity::LIV* __get__liv() ;

constexpr ::cordl_internals::to_const_pointer<::LIV::SDK::Unity::LIV*> __get__liv() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Camera*> __get__cameraInstance() const;
