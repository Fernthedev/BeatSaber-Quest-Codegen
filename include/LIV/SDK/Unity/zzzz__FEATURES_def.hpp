...
struct CORDL_TYPE FEATURES : public ::bs_hook::EnumTypeWrapper<0x8> {
public:
// Declarations
...
return std::bit_cast<__FEATURES_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x8>::instance);
}
...
constexpr explicit FEATURES(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x8>(instance) {
}
