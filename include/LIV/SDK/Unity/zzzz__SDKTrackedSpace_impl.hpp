...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::LIV::SDK::Unity::SDKTrackedSpace (*)()>(&::LIV::SDK::Unity::SDKTrackedSpace::get_empty)> {
  ...
  constexpr static std::size_t addrs = 0x22155b0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::LIV::SDK::Unity::SDKTrackedSpace::*)()>(&::LIV::SDK::Unity::SDKTrackedSpace::ToString)> {
  ...
  constexpr static std::size_t addrs = 0x22156d8;
...
constexpr ::LIV::SDK::Unity::SDKVector3& LIV::SDK::Unity::SDKTrackedSpace::__get_trackedSpaceWorldPosition()  {
...
constexpr ::LIV::SDK::Unity::SDKVector3 const& LIV::SDK::Unity::SDKTrackedSpace::__get_trackedSpaceWorldPosition() const {
return ::cordl_internals::getInstanceField<::LIV::SDK::Unity::SDKVector3, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::LIV::SDK::Unity::SDKQuaternion& LIV::SDK::Unity::SDKTrackedSpace::__get_trackedSpaceWorldRotation()  {
...
constexpr ::LIV::SDK::Unity::SDKQuaternion const& LIV::SDK::Unity::SDKTrackedSpace::__get_trackedSpaceWorldRotation() const {
return ::cordl_internals::getInstanceField<::LIV::SDK::Unity::SDKQuaternion, 0xc>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::LIV::SDK::Unity::SDKVector3& LIV::SDK::Unity::SDKTrackedSpace::__get_trackedSpaceLocalScale()  {
...
constexpr ::LIV::SDK::Unity::SDKVector3 const& LIV::SDK::Unity::SDKTrackedSpace::__get_trackedSpaceLocalScale() const {
return ::cordl_internals::getInstanceField<::LIV::SDK::Unity::SDKVector3, 0x1c>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void LIV::SDK::Unity::SDKTrackedSpace::__set_trackedSpaceLocalToWorldMatrix(::LIV::SDK::Unity::SDKMatrix4x4  value)  {
::cordl_internals::setInstanceField<::LIV::SDK::Unity::SDKMatrix4x4, 0x28>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::LIV::SDK::Unity::SDKMatrix4x4>(value));
}
constexpr ::LIV::SDK::Unity::SDKMatrix4x4& LIV::SDK::Unity::SDKTrackedSpace::__get_trackedSpaceLocalToWorldMatrix()  {
return ::cordl_internals::getInstanceField<::LIV::SDK::Unity::SDKMatrix4x4, 0x28>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::LIV::SDK::Unity::SDKMatrix4x4 const& LIV::SDK::Unity::SDKTrackedSpace::__get_trackedSpaceLocalToWorldMatrix() const {
return ::cordl_internals::getInstanceField<::LIV::SDK::Unity::SDKMatrix4x4, 0x28>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void LIV::SDK::Unity::SDKTrackedSpace::__set_trackedSpaceWorldToLocalMatrix(::LIV::SDK::Unity::SDKMatrix4x4  value)  {
::cordl_internals::setInstanceField<::LIV::SDK::Unity::SDKMatrix4x4, 0x68>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::LIV::SDK::Unity::SDKMatrix4x4>(value));
}
constexpr ::LIV::SDK::Unity::SDKMatrix4x4& LIV::SDK::Unity::SDKTrackedSpace::__get_trackedSpaceWorldToLocalMatrix()  {
return ::cordl_internals::getInstanceField<::LIV::SDK::Unity::SDKMatrix4x4, 0x68>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::LIV::SDK::Unity::SDKMatrix4x4 const& LIV::SDK::Unity::SDKTrackedSpace::__get_trackedSpaceWorldToLocalMatrix() const {
return ::cordl_internals::getInstanceField<::LIV::SDK::Unity::SDKMatrix4x4, 0x68>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
