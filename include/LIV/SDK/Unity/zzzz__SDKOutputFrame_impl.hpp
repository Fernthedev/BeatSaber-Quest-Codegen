...
::cordl_internals::setInstanceField<::LIV::SDK::Unity::RENDERING_PIPELINE, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::LIV::SDK::Unity::RENDERING_PIPELINE>(value));
}
constexpr ::LIV::SDK::Unity::RENDERING_PIPELINE& LIV::SDK::Unity::SDKOutputFrame::__get_renderingPipeline()  {
return ::cordl_internals::getInstanceField<::LIV::SDK::Unity::RENDERING_PIPELINE, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::LIV::SDK::Unity::RENDERING_PIPELINE const& LIV::SDK::Unity::SDKOutputFrame::__get_renderingPipeline() const {
return ::cordl_internals::getInstanceField<::LIV::SDK::Unity::RENDERING_PIPELINE, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void LIV::SDK::Unity::SDKOutputFrame::__set_trackedSpace(::LIV::SDK::Unity::SDKTrackedSpace  value)  {
::cordl_internals::setInstanceField<::LIV::SDK::Unity::SDKTrackedSpace, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::LIV::SDK::Unity::SDKTrackedSpace>(value));
}
constexpr ::LIV::SDK::Unity::SDKTrackedSpace& LIV::SDK::Unity::SDKOutputFrame::__get_trackedSpace()  {
return ::cordl_internals::getInstanceField<::LIV::SDK::Unity::SDKTrackedSpace, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::LIV::SDK::Unity::SDKTrackedSpace const& LIV::SDK::Unity::SDKOutputFrame::__get_trackedSpace() const {
return ::cordl_internals::getInstanceField<::LIV::SDK::Unity::SDKTrackedSpace, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::LIV::SDK::Unity::SDKOutputFrame::SDKOutputFrame(::LIV::SDK::Unity::RENDERING_PIPELINE  renderingPipeline, ::LIV::SDK::Unity::SDKTrackedSpace  trackedSpace) noexcept : ::bs_hook::ValueTypeWrapper<0xac>() {this->renderingPipeline = renderingPipeline;
