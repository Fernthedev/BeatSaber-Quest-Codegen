...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityOpus::Encoder::*)(::ArrayW<float_t,::Array<float_t>*>, int32_t, ::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::UnityOpus::Encoder::Encode)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "Encode",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<float_t,::Array<float_t>*>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<uint8_t,::Array<uint8_t>*>>::get()}
                        )));
    return ___internal_method;
  }
};
...
::cordl_internals::setInstanceField<::UnityOpus::OpusSignal, 0x18>(this, std::forward<::UnityOpus::OpusSignal>(value));
}
constexpr ::UnityOpus::OpusSignal& UnityOpus::Encoder::__get_signal()  {
return ::cordl_internals::getInstanceField<::UnityOpus::OpusSignal, 0x18>(this);
}
...
constexpr ::cordl_internals::intptr_t& UnityOpus::Encoder::__get_encoder()  {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x20>(this);
}
constexpr ::cordl_internals::intptr_t const& UnityOpus::Encoder::__get_encoder() const {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x20>(this);
}
constexpr void UnityOpus::Encoder::__set_channels(::UnityOpus::NumChannels  value)  {
::cordl_internals::setInstanceField<::UnityOpus::NumChannels, 0x28>(this, std::forward<::UnityOpus::NumChannels>(value));
}
constexpr ::UnityOpus::NumChannels& UnityOpus::Encoder::__get_channels()  {
return ::cordl_internals::getInstanceField<::UnityOpus::NumChannels, 0x28>(this);
}
