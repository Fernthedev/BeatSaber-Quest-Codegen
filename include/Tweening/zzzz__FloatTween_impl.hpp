...
return THROW_UNLESS(::il2cpp_utils::New<::Tweening::FloatTween*>());
}
...
return THROW_UNLESS(::il2cpp_utils::New<::Tweening::FloatTween*>(fromValue, toValue, onUpdate, duration, easeType, delay));
}
/// @param delay: float_t (default: 0.0)
