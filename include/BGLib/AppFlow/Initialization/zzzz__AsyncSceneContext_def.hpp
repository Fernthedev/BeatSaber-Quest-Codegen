...
struct CORDL_TYPE __AsyncSceneContext__State : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____AsyncSceneContext__State_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __AsyncSceneContext__State(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __AsyncSceneContext__State()  = default;
...
struct CORDL_TYPE __AsyncSceneContext___Run_d__4 : public ::bs_hook::ValueTypeWrapper<0x38> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field <>4__this offset 0x28
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::BGLib::AppFlow::Initialization::AsyncSceneContext*  __4__this;
...
constexpr void __set___4__this(::BGLib::AppFlow::Initialization::AsyncSceneContext*  value) ;

constexpr ::BGLib::AppFlow::Initialization::AsyncSceneContext* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::BGLib::AppFlow::Initialization::AsyncSceneContext*> __get___4__this() const;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::BGLib::AppFlow::Initialization::AsyncSceneContext*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
constexpr __AsyncSceneContext___Run_d__4(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::BGLib::AppFlow::Initialization::AsyncSceneContext*  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter  __u__1) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __AsyncSceneContext___Run_d__4(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x38>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __AsyncSceneContext___Run_d__4()  = default;
...
struct CORDL_TYPE __AsyncSceneContext___RunAsync_d__5 : public ::bs_hook::ValueTypeWrapper<0x30> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field <>u__1 offset 0x28
 __declspec(property(get=__get___u__1, put=__set___u__1)) ::System::Runtime::CompilerServices::TaskAwaiter_1<::BGLib::AppFlow::Initialization::AsyncInstallerRegistry*>  __u__1;
...
constexpr void __set___u__1(::System::Runtime::CompilerServices::TaskAwaiter_1<::BGLib::AppFlow::Initialization::AsyncInstallerRegistry*>  value) ;

constexpr ::System::Runtime::CompilerServices::TaskAwaiter_1<::BGLib::AppFlow::Initialization::AsyncInstallerRegistry*>& __get___u__1() ;

constexpr ::System::Runtime::CompilerServices::TaskAwaiter_1<::BGLib::AppFlow::Initialization::AsyncInstallerRegistry*> const& __get___u__1() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __AsyncSceneContext___RunAsync_d__5(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x30>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __AsyncSceneContext___RunAsync_d__5()  = default;
...
/// @brief Field registry offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::BGLib::AppFlow::Initialization::AsyncInstallerRegistry*> __get_registry() const;
...
// Ctor Parameters []
// @brief default ctor
 __AsyncSceneContext____c__DisplayClass6_0()  = default;
public:
...
// CS Name: ::AsyncSceneContext::<LoadInstallersAsync>d__6
struct CORDL_TYPE __AsyncSceneContext___LoadInstallersAsync_d__6 : public ::bs_hook::ValueTypeWrapper<0x38> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x38};
...
/// @brief Field <>t__builder offset 0x8
 __declspec(property(get=__get___t__builder, put=__set___t__builder)) ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::BGLib::AppFlow::Initialization::AsyncInstallerRegistry*>  __t__builder;

/// @brief Field <>4__this offset 0x20
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::BGLib::AppFlow::Initialization::AsyncSceneContext*  __4__this;

/// @brief Field <>8__1 offset 0x28
 __declspec(property(get=__get___8__1, put=__set___8__1)) ::BGLib::AppFlow::Initialization::__AsyncSceneContext____c__DisplayClass6_0*  __8__1;
...
constexpr void __set___t__builder(::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::BGLib::AppFlow::Initialization::AsyncInstallerRegistry*>  value) ;

constexpr ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::BGLib::AppFlow::Initialization::AsyncInstallerRegistry*>& __get___t__builder() ;

constexpr ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::BGLib::AppFlow::Initialization::AsyncInstallerRegistry*> const& __get___t__builder() const;
...
constexpr void __set___8__1(::BGLib::AppFlow::Initialization::__AsyncSceneContext____c__DisplayClass6_0*  value) ;

constexpr ::BGLib::AppFlow::Initialization::__AsyncSceneContext____c__DisplayClass6_0* __get___8__1() ;

constexpr ::cordl_internals::to_const_pointer<::BGLib::AppFlow::Initialization::__AsyncSceneContext____c__DisplayClass6_0*> __get___8__1() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __AsyncSceneContext___LoadInstallersAsync_d__6(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x38>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __AsyncSceneContext___LoadInstallersAsync_d__6()  = default;
...
namespace BGLib::AppFlow::Initialization {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11126))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xd0 - sizeof(::Zenject::SceneContext)]{};

/// @brief Field _asyncInstallers offset 0xb8
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::BGLib::AppFlow::Initialization::AsyncInstaller*>*> __get__asyncInstallers() const;
...
constexpr ::cordl_internals::to_const_pointer<::BGLib::AppFlow::Initialization::AsyncInstallerRegistry*> __get__registry() const;
