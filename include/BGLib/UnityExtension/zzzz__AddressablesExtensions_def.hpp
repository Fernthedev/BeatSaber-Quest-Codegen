...
template<typename T>
static inline ::System::Collections::Generic::IList_1<T>* LoadContent(::UnityEngine::AddressableAssets::IKeyEvaluator*  label) ;

/// @brief Method LoadContentOperation addr 0x0 size 0xffffffffffffffff virtual false final false
template<typename T>
static inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::System::Collections::Generic::IList_1<T>*> LoadContentOperation(::UnityEngine::AddressableAssets::IKeyEvaluator*  label) ;
...
// Ctor Parameters []
// @brief default ctor
 AddressablesExtensions()  = default;
public:
