...
struct CORDL_TYPE Compute_DistanceTransform_EventTypes : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<__Compute_DistanceTransform_EventTypes_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit Compute_DistanceTransform_EventTypes(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 Compute_DistanceTransform_EventTypes()  = default;
