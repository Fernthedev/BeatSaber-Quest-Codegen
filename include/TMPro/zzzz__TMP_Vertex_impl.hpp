...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::TMPro::TMP_Vertex (*)()>(&::TMPro::TMP_Vertex::get_zero)> {
  ...
  constexpr static std::size_t addrs = 0x2c01800;
...
constexpr ::UnityEngine::Vector3& TMPro::TMP_Vertex::__get_position()  {
...
constexpr ::UnityEngine::Vector3 const& TMPro::TMP_Vertex::__get_position() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Vector2& TMPro::TMP_Vertex::__get_uv()  {
...
constexpr ::UnityEngine::Vector2 const& TMPro::TMP_Vertex::__get_uv() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0xc>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Vector2& TMPro::TMP_Vertex::__get_uv2()  {
...
constexpr ::UnityEngine::Vector2 const& TMPro::TMP_Vertex::__get_uv2() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0x14>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Vector2& TMPro::TMP_Vertex::__get_uv4()  {
...
constexpr ::UnityEngine::Vector2 const& TMPro::TMP_Vertex::__get_uv4() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0x1c>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Color32& TMPro::TMP_Vertex::__get_color()  {
...
constexpr ::UnityEngine::Color32 const& TMPro::TMP_Vertex::__get_color() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Color32, 0x24>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::TMPro::TMP_Vertex::TMP_Vertex(::UnityEngine::Vector3  position, ::UnityEngine::Vector2  uv, ::UnityEngine::Vector2  uv2, ::UnityEngine::Vector2  uv4, ::UnityEngine::Color32  color) noexcept : ::bs_hook::ValueTypeWrapper<0x28>() {this->position = position;
this->uv = uv;
this->uv2 = uv2;
this->uv4 = uv4;
this->color = color;
