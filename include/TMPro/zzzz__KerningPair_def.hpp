...
/// @brief Field xOffset offset 0x38
 __declspec(property(get=__get_xOffset, put=__set_xOffset)) float_t  xOffset;

/// @brief Field m_IgnoreSpacingAdjustments offset 0x3c
