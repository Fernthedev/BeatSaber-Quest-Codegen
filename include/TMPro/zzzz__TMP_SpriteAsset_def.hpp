...
// Ctor Parameters []
// @brief default ctor
 __TMP_SpriteAsset____c()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xe8 - sizeof(::TMPro::TMP_Asset)]{};

/// @brief Field m_NameLookup offset 0x30
...
/// @brief Field m_GlyphIndexLookup offset 0x38
...
/// @brief Field m_Version offset 0x40
...
/// @brief Field spriteSheet offset 0xa8
...
/// @brief Field m_SpriteCharacterLookup offset 0xb8
 __declspec(property(get=__get_m_SpriteCharacterLookup, put=__set_m_SpriteCharacterLookup)) ::System::Collections::Generic::Dictionary_2<uint32_t,::TMPro::TMP_SpriteCharacter*>*  m_SpriteCharacterLookup;
...
/// @brief Field spriteInfoList offset 0xd0
...
/// @brief Field fallbackSpriteAssets offset 0xd8
...
/// @brief Field m_IsSpriteAssetLookupTablesDirty offset 0xe0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Texture*> __get_spriteSheet() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::TMPro::TMP_SpriteCharacter*>*> __get_m_SpriteCharacterTable() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint32_t,::TMPro::TMP_SpriteCharacter*>*> __get_m_SpriteCharacterLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::TMPro::TMP_SpriteGlyph*>*> __get_m_SpriteGlyphTable() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint32_t,::TMPro::TMP_SpriteGlyph*>*> __get_m_SpriteGlyphLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::TMPro::TMP_Sprite*>*> __get_spriteInfoList() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::TMPro::TMP_SpriteAsset*>*> __get_fallbackSpriteAssets() const;
...
static inline ::TMPro::TMP_SpriteAsset* SearchForSpriteByUnicodeInternal(::System::Collections::Generic::List_1<::TMPro::TMP_SpriteAsset*>*  spriteAssets, uint32_t  unicode, bool  includeFallbacks, ByRef<int32_t>  spriteIndex) ;
...
static inline ::TMPro::TMP_SpriteAsset* SearchForSpriteByHashCodeInternal(::System::Collections::Generic::List_1<::TMPro::TMP_SpriteAsset*>*  spriteAssets, int32_t  hashCode, bool  searchFallbacks, ByRef<int32_t>  spriteIndex) ;
