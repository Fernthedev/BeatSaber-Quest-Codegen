...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::TMPro::TMP_GlyphPairAdjustmentRecord::*)(::TMPro::TMP_GlyphAdjustmentRecord)>(&::TMPro::TMP_GlyphPairAdjustmentRecord::set_firstAdjustmentRecord)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::TMPro::TMP_GlyphAdjustmentRecord>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::TMPro::TMP_GlyphPairAdjustmentRecord::*)(::TMPro::FontFeatureLookupFlags)>(&::TMPro::TMP_GlyphPairAdjustmentRecord::set_featureLookupFlags)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::TMPro::FontFeatureLookupFlags>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::TMPro::TMP_GlyphPairAdjustmentRecord::*)(::TMPro::TMP_GlyphAdjustmentRecord, ::TMPro::TMP_GlyphAdjustmentRecord)>(&::TMPro::TMP_GlyphPairAdjustmentRecord::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::TMPro::TMP_GlyphAdjustmentRecord>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::TMPro::TMP_GlyphAdjustmentRecord>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::TMPro::TMP_GlyphPairAdjustmentRecord::*)(::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord)>(&::TMPro::TMP_GlyphPairAdjustmentRecord::_ctor)> {
...
::cordl_internals::setInstanceField<::TMPro::TMP_GlyphAdjustmentRecord, 0x10>(this, std::forward<::TMPro::TMP_GlyphAdjustmentRecord>(value));
}
constexpr ::TMPro::TMP_GlyphAdjustmentRecord& TMPro::TMP_GlyphPairAdjustmentRecord::__get_m_FirstAdjustmentRecord()  {
return ::cordl_internals::getInstanceField<::TMPro::TMP_GlyphAdjustmentRecord, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::TMPro::TMP_GlyphAdjustmentRecord, 0x24>(this, std::forward<::TMPro::TMP_GlyphAdjustmentRecord>(value));
}
constexpr ::TMPro::TMP_GlyphAdjustmentRecord& TMPro::TMP_GlyphPairAdjustmentRecord::__get_m_SecondAdjustmentRecord()  {
return ::cordl_internals::getInstanceField<::TMPro::TMP_GlyphAdjustmentRecord, 0x24>(this);
}
...
::cordl_internals::setInstanceField<::TMPro::FontFeatureLookupFlags, 0x38>(this, std::forward<::TMPro::FontFeatureLookupFlags>(value));
}
constexpr ::TMPro::FontFeatureLookupFlags& TMPro::TMP_GlyphPairAdjustmentRecord::__get_m_FeatureLookupFlags()  {
return ::cordl_internals::getInstanceField<::TMPro::FontFeatureLookupFlags, 0x38>(this);
}
