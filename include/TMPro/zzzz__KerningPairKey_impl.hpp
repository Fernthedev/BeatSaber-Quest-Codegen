...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::TMPro::KerningPairKey::*)(uint32_t, uint32_t)>(&::TMPro::KerningPairKey::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2c102e8;
...
constexpr uint32_t& TMPro::KerningPairKey::__get_ascii_Left()  {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& TMPro::KerningPairKey::__get_ascii_Left() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr uint32_t& TMPro::KerningPairKey::__get_ascii_Right()  {
return ::cordl_internals::getInstanceField<uint32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& TMPro::KerningPairKey::__get_ascii_Right() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::TMPro::KerningPairKey::KerningPairKey(uint32_t  ascii_Left, uint32_t  ascii_Right, uint32_t  key) noexcept : ::bs_hook::ValueTypeWrapper<0xc>() {this->ascii_Left = ascii_Left;
