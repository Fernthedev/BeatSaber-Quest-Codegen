...
/// @brief Field m_RootCanvasTransform offset 0x120
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get_m_fallbackMaterial() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get_m_fallbackSourceMaterial() const;
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> __get_m_TextComponent() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_m_RootCanvasTransform() const;
