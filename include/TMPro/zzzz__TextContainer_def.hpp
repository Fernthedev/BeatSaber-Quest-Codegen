...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x70 - sizeof(::UnityEngine::EventSystems::UIBehaviour)]{};

/// @brief Field m_hasChanged offset 0x18
 __declspec(property(get=__get_m_hasChanged, put=__set_m_hasChanged)) bool  m_hasChanged;

/// @brief Field m_pivot offset 0x1c
 __declspec(property(get=__get_m_pivot, put=__set_m_pivot)) ::UnityEngine::Vector2  m_pivot;

/// @brief Field m_anchorPosition offset 0x24
...
/// @brief Field m_worldCorners offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshPro*> __get_m_textMeshPro() const;
