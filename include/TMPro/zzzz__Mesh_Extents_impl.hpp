...
constexpr ::UnityEngine::Vector2& TMPro::Mesh_Extents::__get_min()  {
...
constexpr ::UnityEngine::Vector2 const& TMPro::Mesh_Extents::__get_min() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Vector2& TMPro::Mesh_Extents::__get_max()  {
...
constexpr ::UnityEngine::Vector2 const& TMPro::Mesh_Extents::__get_max() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::TMPro::Mesh_Extents::Mesh_Extents(::UnityEngine::Vector2  min, ::UnityEngine::Vector2  max) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->min = min;
this->max = max;
}
