...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::TMPro::TMP_TextElement_Legacy)]{};

/// @brief Method Clone addr 0x2c10190 size 0x7c virtual false final false
static inline ::TMPro::TMP_Glyph* Clone(::TMPro::TMP_Glyph*  source) ;

static inline ::TMPro::TMP_Glyph* New_ctor() ;

/// @brief Method .ctor addr 0x2c1020c size 0x8 virtual false final false
inline void _ctor() ;
