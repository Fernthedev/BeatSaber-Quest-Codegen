...
namespace TMPro {
template<>
class __TweenRunner_1___Start_d__2<::TMPro::FloatTween>;
}
// Write type traits
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(12343))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12343), inst: 5197 })
// CS Name: ::TweenRunner`1::<Start>d__2<T>*
class CORDL_TYPE __TweenRunner_1___Start_d__2<::TMPro::FloatTween> : public ::System::Object {
public:
// Declarations
...
/// @brief Field tweenInfo offset 0x20
 __declspec(property(get=__get_tweenInfo, put=__set_tweenInfo)) ::TMPro::FloatTween  tweenInfo;
...
constexpr ::TMPro::FloatTween& __get_tweenInfo() ;

constexpr ::TMPro::FloatTween const& __get_tweenInfo() const;
...
static inline ::TMPro::__TweenRunner_1___Start_d__2<::TMPro::FloatTween>* New_ctor(int32_t  __1__state) ;
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12344)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12344), inst: 5197 })
// CS Name: ::TMPro::TweenRunner`1<T>*
class CORDL_TYPE TweenRunner_1<::TMPro::FloatTween> : public ::System::Object {
public:
// Declarations
using _Start_d__2 = ::TMPro::__TweenRunner_1___Start_d__2<::TMPro::FloatTween>;
...
static inline ::System::Collections::IEnumerator* Start(::TMPro::FloatTween  tweenInfo) ;
...
inline void StartTween(::TMPro::FloatTween  info) ;

/// @brief Method StopTween addr 0x0 size 0xffffffffffffffff virtual false final false
inline void StopTween() ;

static inline ::TMPro::TweenRunner_1<::TMPro::FloatTween>* New_ctor() ;
