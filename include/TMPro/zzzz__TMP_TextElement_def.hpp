...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TMP_Asset*> __get_m_TextAsset() const;

constexpr void __set_m_Glyph(::UnityEngine::TextCore::Glyph*  value) ;

constexpr ::UnityEngine::TextCore::Glyph* __get_m_Glyph() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TextCore::Glyph*> __get_m_Glyph() const;
