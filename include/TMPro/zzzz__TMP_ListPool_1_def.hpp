...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12395)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12395), inst: 2 })
// CS Name: ::TMP_ListPool`1::<>c<T>*
class CORDL_TYPE __TMP_ListPool_1____c<T> : public ::System::Object {
public:
// Declarations
...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12396)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12396), inst: 2 })
// CS Name: ::TMPro::TMP_ListPool`1<T>*
class CORDL_TYPE TMP_ListPool_1<T> : public ::System::Object {
public:
// Declarations
