...
/// @brief Method get_instance addr 0x2c48bf4 size 0x58 virtual false final false
static inline ::TMPro::TMP_TextParsingUtilities* get_instance() ;

/// @brief Method GetHashCode addr 0x2c44cf8 size 0xbc virtual false final false
static inline int32_t GetHashCode(::StringW  s) ;

/// @brief Method GetHashCodeCaseSensitive addr 0x2c44840 size 0x6c virtual false final false
static inline int32_t GetHashCodeCaseSensitive(::StringW  s) ;

/// @brief Method ToLowerASCIIFast addr 0x2c48cc0 size 0x74 virtual false final false
static inline char16_t ToLowerASCIIFast(char16_t  c) ;

/// @brief Method ToUpperASCIIFast addr 0x2c48c4c size 0x74 virtual false final false
static inline char16_t ToUpperASCIIFast(char16_t  c) ;

/// @brief Method ToUpperASCIIFast addr 0x2c48d34 size 0x74 virtual false final false
static inline uint32_t ToUpperASCIIFast(uint32_t  c) ;

/// @brief Method ToLowerASCIIFast addr 0x2c48da8 size 0x74 virtual false final false
static inline uint32_t ToLowerASCIIFast(uint32_t  c) ;

/// @brief Method IsHighSurrogate addr 0x2c48e1c size 0x14 virtual false final false
static inline bool IsHighSurrogate(uint32_t  c) ;

/// @brief Method IsLowSurrogate addr 0x2c48e30 size 0x14 virtual false final false
static inline bool IsLowSurrogate(uint32_t  c) ;

/// @brief Method ConvertToUTF32 addr 0x2c48e44 size 0x14 virtual false final false
...
/// @brief Method .ctor addr 0x2c48bec size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 TMP_TextParsingUtilities()  = default;
public:
