...
/// @brief Field m_FontAssetReferenceLookup offset 0x18
 __declspec(property(get=__get_m_FontAssetReferenceLookup, put=__set_m_FontAssetReferenceLookup)) ::System::Collections::Generic::Dictionary_2<int32_t,::TMPro::TMP_FontAsset*>*  m_FontAssetReferenceLookup;

/// @brief Field m_SpriteAssetReferenceLookup offset 0x20
 __declspec(property(get=__get_m_SpriteAssetReferenceLookup, put=__set_m_SpriteAssetReferenceLookup)) ::System::Collections::Generic::Dictionary_2<int32_t,::TMPro::TMP_SpriteAsset*>*  m_SpriteAssetReferenceLookup;

/// @brief Field m_ColorGradientReferenceLookup offset 0x28
 __declspec(property(get=__get_m_ColorGradientReferenceLookup, put=__set_m_ColorGradientReferenceLookup)) ::System::Collections::Generic::Dictionary_2<int32_t,::TMPro::TMP_ColorGradient*>*  m_ColorGradientReferenceLookup;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::TMPro::TMP_FontAsset*>*> __get_m_FontAssetReferenceLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::TMPro::TMP_SpriteAsset*>*> __get_m_SpriteAssetReferenceLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::TMPro::TMP_ColorGradient*>*> __get_m_ColorGradientReferenceLookup() const;
