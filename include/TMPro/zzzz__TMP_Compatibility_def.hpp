...
struct CORDL_TYPE __TMP_Compatibility__AnchorPositions : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____TMP_Compatibility__AnchorPositions_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __TMP_Compatibility__AnchorPositions(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __TMP_Compatibility__AnchorPositions()  = default;
