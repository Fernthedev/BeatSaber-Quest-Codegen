...
constexpr ::StringW& __get_sourceFontFileName() ;

constexpr ::StringW const& __get_sourceFontFileName() const;
...
constexpr explicit FontAssetCreationSettings(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x58>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 FontAssetCreationSettings()  = default;
