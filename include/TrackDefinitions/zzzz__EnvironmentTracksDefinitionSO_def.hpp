...
struct CORDL_TYPE __EnvironmentTracksDefinitionSO__BasicEventTrackPage : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____EnvironmentTracksDefinitionSO__BasicEventTrackPage_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __EnvironmentTracksDefinitionSO__BasicEventTrackPage(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __EnvironmentTracksDefinitionSO__BasicEventTrackPage()  = default;
...
struct CORDL_TYPE __EnvironmentTracksDefinitionSO__OverrideDefaultLightAxis : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____EnvironmentTracksDefinitionSO__OverrideDefaultLightAxis_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __EnvironmentTracksDefinitionSO__OverrideDefaultLightAxis(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __EnvironmentTracksDefinitionSO__OverrideDefaultLightAxis()  = default;
...
/// @brief Field _trackToolbarType offset 0x1c
...
/// @brief Field _trackDefinition offset 0x20
...
/// @brief Field _basicEventTrackPage offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::TrackDefinitions::EventTrackDefinitionSO*> __get__trackDefinition() const;
...
// Ctor Parameters []
// @brief default ctor
 __EnvironmentTracksDefinitionSO__BasicEventTrackInfo()  = default;
public:
...
/// @brief Field _eventBoxGroupPageName offset 0x10
 __declspec(property(get=__get__eventBoxGroupPageName, put=__set__eventBoxGroupPageName)) ::StringW  _eventBoxGroupPageName;

/// @brief Field _eventBoxGroupTrackInfos offset 0x18
 __declspec(property(get=__get__eventBoxGroupTrackInfos, put=__set__eventBoxGroupTrackInfos)) ::System::Collections::Generic::List_1<::TrackDefinitions::__EnvironmentTracksDefinitionSO__EventBoxGroupTrackInfo*>*  _eventBoxGroupTrackInfos;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::TrackDefinitions::__EnvironmentTracksDefinitionSO__EventBoxGroupTrackInfo*>*> __get__eventBoxGroupTrackInfos() const;
...
// Ctor Parameters []
// @brief default ctor
 __EnvironmentTracksDefinitionSO__EventBoxGroupPageInfo()  = default;
public:
...
/// @brief Field _showColorTrack offset 0x20
 __declspec(property(get=__get__showColorTrack, put=__set__showColorTrack)) bool  _showColorTrack;

/// @brief Field _showRotationXTrack offset 0x21
 __declspec(property(get=__get__showRotationXTrack, put=__set__showRotationXTrack)) bool  _showRotationXTrack;

/// @brief Field _showRotationYTrack offset 0x22
 __declspec(property(get=__get__showRotationYTrack, put=__set__showRotationYTrack)) bool  _showRotationYTrack;

/// @brief Field _showRotationZTrack offset 0x23
 __declspec(property(get=__get__showRotationZTrack, put=__set__showRotationZTrack)) bool  _showRotationZTrack;

/// @brief Field _overrideDefaultRotationAxis offset 0x24
 __declspec(property(get=__get__overrideDefaultRotationAxis, put=__set__overrideDefaultRotationAxis)) ::TrackDefinitions::__EnvironmentTracksDefinitionSO__OverrideDefaultLightAxis  _overrideDefaultRotationAxis;

/// @brief Field _showTranslationXTrack offset 0x28
 __declspec(property(get=__get__showTranslationXTrack, put=__set__showTranslationXTrack)) bool  _showTranslationXTrack;

/// @brief Field _showTranslationYTrack offset 0x29
 __declspec(property(get=__get__showTranslationYTrack, put=__set__showTranslationYTrack)) bool  _showTranslationYTrack;

/// @brief Field _showTranslationZTrack offset 0x2a
 __declspec(property(get=__get__showTranslationZTrack, put=__set__showTranslationZTrack)) bool  _showTranslationZTrack;

/// @brief Field _overrideDefaultTranslationAxis offset 0x2c
 __declspec(property(get=__get__overrideDefaultTranslationAxis, put=__set__overrideDefaultTranslationAxis)) ::TrackDefinitions::__EnvironmentTracksDefinitionSO__OverrideDefaultLightAxis  _overrideDefaultTranslationAxis;

/// @brief Field _showFloatFxTrack offset 0x30
 __declspec(property(get=__get__showFloatFxTrack, put=__set__showFloatFxTrack)) bool  _showFloatFxTrack;

/// @brief Field _enableDuplicate offset 0x31
 __declspec(property(get=__get__enableDuplicate, put=__set__enableDuplicate)) bool  _enableDuplicate;

/// @brief Field _duplicationGroup offset 0x38
...
/// @brief Field _targetLightGroups offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LightGroupSO*> __get__lightGroup() const;
...
constexpr ::cordl_internals::to_const_pointer<::TrackDefinitions::LightGroupDuplicationGroup*> __get__duplicationGroup() const;
...
// Ctor Parameters []
// @brief default ctor
 __EnvironmentTracksDefinitionSO__EventBoxGroupTrackInfo()  = default;
public:
...
/// @brief Field _environmentInfo offset 0x18
...
/// @brief Field _basicEventTrackInfos offset 0x20
 __declspec(property(get=__get__basicEventTrackInfos, put=__set__basicEventTrackInfos)) ::ArrayW<::TrackDefinitions::__EnvironmentTracksDefinitionSO__BasicEventTrackInfo*,::Array<::TrackDefinitions::__EnvironmentTracksDefinitionSO__BasicEventTrackInfo*>*>  _basicEventTrackInfos;

/// @brief Field _eventBoxGroupPageInfos offset 0x28
 __declspec(property(get=__get__eventBoxGroupPageInfos, put=__set__eventBoxGroupPageInfos)) ::System::Collections::Generic::List_1<::TrackDefinitions::__EnvironmentTracksDefinitionSO__EventBoxGroupPageInfo*>*  _eventBoxGroupPageInfos;
...
constexpr void __set__basicEventTrackInfos(::ArrayW<::TrackDefinitions::__EnvironmentTracksDefinitionSO__BasicEventTrackInfo*,::Array<::TrackDefinitions::__EnvironmentTracksDefinitionSO__BasicEventTrackInfo*>*>  value) ;

constexpr ::ArrayW<::TrackDefinitions::__EnvironmentTracksDefinitionSO__BasicEventTrackInfo*,::Array<::TrackDefinitions::__EnvironmentTracksDefinitionSO__BasicEventTrackInfo*>*>& __get__basicEventTrackInfos() ;

constexpr ::ArrayW<::TrackDefinitions::__EnvironmentTracksDefinitionSO__BasicEventTrackInfo*,::Array<::TrackDefinitions::__EnvironmentTracksDefinitionSO__BasicEventTrackInfo*>*> const& __get__basicEventTrackInfos() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::TrackDefinitions::__EnvironmentTracksDefinitionSO__EventBoxGroupPageInfo*>*> __get__eventBoxGroupPageInfos() const;
...
// Ctor Parameters []
// @brief default ctor
 EnvironmentTracksDefinitionSO()  = default;
public:
