...
// Ctor Parameters []
// @brief default ctor
 __EnvironmentTrackDefinitionsListModel____c()  = default;
public:
...
/// @brief Field _environmentTracksTypeMap offset 0x10
 __declspec(property(get=__get__environmentTracksTypeMap, put=__set__environmentTracksTypeMap)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::EnvironmentInfoSO*,::TrackDefinitions::DataModels::EnvironmentTrackDefinitionModel*>*  _environmentTracksTypeMap;

 __declspec(property(get=get_Item)) ::TrackDefinitions::DataModels::EnvironmentTrackDefinitionModel*  Item[];

constexpr void __set__environmentTracksTypeMap(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::EnvironmentInfoSO*,::TrackDefinitions::DataModels::EnvironmentTrackDefinitionModel*>*  value) ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::EnvironmentInfoSO*,::TrackDefinitions::DataModels::EnvironmentTrackDefinitionModel*>*> __get__environmentTracksTypeMap() const;
...
static inline ::TrackDefinitions::DataModels::EnvironmentTrackDefinitionsListModel* New_ctor(::System::Collections::Generic::IEnumerable_1<::TrackDefinitions::EnvironmentTracksDefinitionSO*>*  environmentTrackDefinitions) ;
...
// Ctor Parameters []
// @brief default ctor
 EnvironmentTrackDefinitionsListModel()  = default;
public:
