...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Bson::BsonBinaryWriter*> __get__writer() const;

constexpr void __set__root(::Newtonsoft::Json::Bson::BsonToken*  value) ;

constexpr ::Newtonsoft::Json::Bson::BsonToken* __get__root() ;

constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Bson::BsonToken*> __get__root() const;

constexpr void __set__parent(::Newtonsoft::Json::Bson::BsonToken*  value) ;

constexpr ::Newtonsoft::Json::Bson::BsonToken* __get__parent() ;

constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Bson::BsonToken*> __get__parent() const;
