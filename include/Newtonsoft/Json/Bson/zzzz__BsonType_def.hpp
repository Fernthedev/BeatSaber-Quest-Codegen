...
struct CORDL_TYPE BsonType : public ::bs_hook::EnumTypeWrapper<0x1> {
public:
// Declarations
...
return std::bit_cast<__BsonType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x1>::instance);
}
...
constexpr explicit BsonType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x1>(instance) {
}
