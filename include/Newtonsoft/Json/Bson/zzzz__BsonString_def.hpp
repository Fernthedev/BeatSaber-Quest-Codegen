...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::Newtonsoft::Json::Bson::BsonValue)]{};

/// @brief Field <ByteCount>k__BackingField offset 0x2c
...
/// @brief Field <IncludeLength>k__BackingField offset 0x30
