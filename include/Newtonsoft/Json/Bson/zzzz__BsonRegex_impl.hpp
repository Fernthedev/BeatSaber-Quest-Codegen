...
::cordl_internals::setInstanceField<::Newtonsoft::Json::Bson::BsonString*, 0x20>(this, std::forward<::Newtonsoft::Json::Bson::BsonString*>(value));
}
constexpr ::Newtonsoft::Json::Bson::BsonString* Newtonsoft::Json::Bson::BsonRegex::__get__Pattern_k__BackingField()  {
return ::cordl_internals::getInstanceField<::Newtonsoft::Json::Bson::BsonString*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Bson::BsonString*> Newtonsoft::Json::Bson::BsonRegex::__get__Pattern_k__BackingField() const {
return ::cordl_internals::getInstanceField<::Newtonsoft::Json::Bson::BsonString*, 0x20>(this);
}
constexpr void Newtonsoft::Json::Bson::BsonRegex::__set__Options_k__BackingField(::Newtonsoft::Json::Bson::BsonString*  value)  {
::cordl_internals::setInstanceField<::Newtonsoft::Json::Bson::BsonString*, 0x28>(this, std::forward<::Newtonsoft::Json::Bson::BsonString*>(value));
}
constexpr ::Newtonsoft::Json::Bson::BsonString* Newtonsoft::Json::Bson::BsonRegex::__get__Options_k__BackingField()  {
return ::cordl_internals::getInstanceField<::Newtonsoft::Json::Bson::BsonString*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Bson::BsonString*> Newtonsoft::Json::Bson::BsonRegex::__get__Options_k__BackingField() const {
return ::cordl_internals::getInstanceField<::Newtonsoft::Json::Bson::BsonString*, 0x28>(this);
}
