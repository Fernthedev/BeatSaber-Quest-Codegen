...
/// @brief Field <Options>k__BackingField offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Bson::BsonString*> __get__Pattern_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Bson::BsonString*> __get__Options_k__BackingField() const;
