...
/// @brief Field _converterType offset 0x10
 __declspec(property(get=__get__converterType, put=__set__converterType)) ::System::Type*  _converterType;

/// @brief Field <ConverterParameters>k__BackingField offset 0x18
 __declspec(property(get=__get__ConverterParameters_k__BackingField, put=__set__ConverterParameters_k__BackingField)) ::ArrayW<::System::Object*,::Array<::System::Object*>*>  _ConverterParameters_k__BackingField;
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get__converterType() const;
