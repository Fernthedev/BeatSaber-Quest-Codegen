...
struct CORDL_TYPE __JsonSerializerInternalReader__PropertyPresence : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____JsonSerializerInternalReader__PropertyPresence_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __JsonSerializerInternalReader__PropertyPresence(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __JsonSerializerInternalReader__PropertyPresence()  = default;
...
/// @brief Field Presence offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Serialization::JsonProperty*> __get_Property() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Serialization::JsonProperty*> __get_ConstructorProperty() const;
...
// Ctor Parameters []
// @brief default ctor
 __JsonSerializerInternalReader__CreatorPropertyContext()  = default;
public:
...
/// @brief Field property offset 0x10
 __declspec(property(get=__get_property, put=__set_property)) ::Newtonsoft::Json::Serialization::JsonProperty*  property;
...
// Ctor Parameters []
// @brief default ctor
 __JsonSerializerInternalReader____c__DisplayClass36_0()  = default;
public:
...
static inline void setStaticF___9__41_1(::System::Func_2<::Newtonsoft::Json::Serialization::JsonProperty*,::Newtonsoft::Json::Serialization::__JsonSerializerInternalReader__PropertyPresence>*  value) ;
...
// Ctor Parameters []
// @brief default ctor
 __JsonSerializerInternalReader____c()  = default;
public:
...
// Static field <>9__36_2

// Static field <>9__41_0

// Static field <>9__41_1
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::Newtonsoft::Json::Serialization::JsonSerializerInternalBase)]{};
...
// Ctor Parameters []
// @brief default ctor
 JsonSerializerInternalReader()  = default;
public:
...
DEFINE_IL2CPP_ARG_TYPE(::Newtonsoft::Json::Serialization::__JsonSerializerInternalReader____c__DisplayClass36_0*, "Newtonsoft.Json.Serialization", "JsonSerializerInternalReader/<>c__DisplayClass36_0");
