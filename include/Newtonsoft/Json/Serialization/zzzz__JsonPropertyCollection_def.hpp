...
namespace Newtonsoft::Json::Serialization {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3816), inst: 3945 }), TypeDefinitionIndex(TypeDefinitionIndex(3816)), TypeDefinitionIndex(TypeDefinitionIndex(11945))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::System::Collections::ObjectModel::KeyedCollection_2<::StringW,::Newtonsoft::Json::Serialization::JsonProperty*>)]{};

/// @brief Field _type offset 0x30
 __declspec(property(get=__get__type, put=__set__type)) ::System::Type*  _type;

/// @brief Field _list offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Newtonsoft::Json::Serialization::JsonProperty*>*> __get__list() const;

static inline ::Newtonsoft::Json::Serialization::JsonPropertyCollection* New_ctor(::System::Type*  type) ;

/// @brief Method .ctor addr 0x2671824 size 0x160 virtual false final false
inline void _ctor(::System::Type*  type) ;

/// @brief Method GetKeyForItem addr 0x267ab18 size 0x18 virtual true final false
inline ::StringW GetKeyForItem(::Newtonsoft::Json::Serialization::JsonProperty*  item) ;

/// @brief Method AddProperty addr 0x26719c4 size 0x234 virtual false final false
inline void AddProperty(::Newtonsoft::Json::Serialization::JsonProperty*  property) ;

/// @brief Method GetClosestMatchProperty addr 0x2671984 size 0x40 virtual false final false
inline ::Newtonsoft::Json::Serialization::JsonProperty* GetClosestMatchProperty(::StringW  propertyName) ;

/// @brief Method TryGetValue addr 0x267ac1c size 0xdc virtual false final false
inline bool TryGetValue(::StringW  key, ByRef<::Newtonsoft::Json::Serialization::JsonProperty*>  item) ;

/// @brief Method GetProperty addr 0x267ab30 size 0xec virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 JsonPropertyCollection()  = default;
public:
