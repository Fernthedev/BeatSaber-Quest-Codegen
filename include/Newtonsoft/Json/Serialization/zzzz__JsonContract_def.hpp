...
/// @brief Field callbackMethodInfo offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Reflection::MethodInfo*> __get_callbackMethodInfo() const;
...
// Ctor Parameters []
// @brief default ctor
 __JsonContract____c__DisplayClass73_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __JsonContract____c__DisplayClass74_0()  = default;
public:
...
/// @brief Field IsReadOnlyOrFixedSize offset 0x28
 __declspec(property(get=__get_IsReadOnlyOrFixedSize, put=__set_IsReadOnlyOrFixedSize)) bool  IsReadOnlyOrFixedSize;

/// @brief Field IsSealed offset 0x29
 __declspec(property(get=__get_IsSealed, put=__set_IsSealed)) bool  IsSealed;

/// @brief Field IsInstantiable offset 0x2a
 __declspec(property(get=__get_IsInstantiable, put=__set_IsInstantiable)) bool  IsInstantiable;

/// @brief Field _onDeserializedCallbacks offset 0x30
 __declspec(property(get=__get__onDeserializedCallbacks, put=__set__onDeserializedCallbacks)) ::System::Collections::Generic::List_1<::Newtonsoft::Json::Serialization::SerializationCallback*>*  _onDeserializedCallbacks;

/// @brief Field _onDeserializingCallbacks offset 0x38
 __declspec(property(get=__get__onDeserializingCallbacks, put=__set__onDeserializingCallbacks)) ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Serialization::SerializationCallback*>*  _onDeserializingCallbacks;

/// @brief Field _onSerializedCallbacks offset 0x40
 __declspec(property(get=__get__onSerializedCallbacks, put=__set__onSerializedCallbacks)) ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Serialization::SerializationCallback*>*  _onSerializedCallbacks;

/// @brief Field _onSerializingCallbacks offset 0x48
 __declspec(property(get=__get__onSerializingCallbacks, put=__set__onSerializingCallbacks)) ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Serialization::SerializationCallback*>*  _onSerializingCallbacks;

/// @brief Field _onErrorCallbacks offset 0x50
 __declspec(property(get=__get__onErrorCallbacks, put=__set__onErrorCallbacks)) ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Serialization::SerializationErrorCallback*>*  _onErrorCallbacks;

/// @brief Field _createdType offset 0x58
 __declspec(property(get=__get__createdType, put=__set__createdType)) ::System::Type*  _createdType;

/// @brief Field <UnderlyingType>k__BackingField offset 0x60
...
/// @brief Field <IsReference>k__BackingField offset 0x68
...
/// @brief Field <Converter>k__BackingField offset 0x70
...
/// @brief Field <InternalConverter>k__BackingField offset 0x78
...
/// @brief Field <DefaultCreator>k__BackingField offset 0x80
...
/// @brief Field <DefaultCreatorNonPublic>k__BackingField offset 0x88
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get_NonNullableUnderlyingType() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Newtonsoft::Json::Serialization::SerializationCallback*>*> __get__onDeserializedCallbacks() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<::Newtonsoft::Json::Serialization::SerializationCallback*>*> __get__onDeserializingCallbacks() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<::Newtonsoft::Json::Serialization::SerializationCallback*>*> __get__onSerializedCallbacks() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<::Newtonsoft::Json::Serialization::SerializationCallback*>*> __get__onSerializingCallbacks() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<::Newtonsoft::Json::Serialization::SerializationErrorCallback*>*> __get__onErrorCallbacks() const;

constexpr void __set__createdType(::System::Type*  value) ;

constexpr ::System::Type* __get__createdType() ;

constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get__createdType() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::JsonConverter*> __get__InternalConverter_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_1<::System::Object*>*> __get__DefaultCreator_k__BackingField() const;
