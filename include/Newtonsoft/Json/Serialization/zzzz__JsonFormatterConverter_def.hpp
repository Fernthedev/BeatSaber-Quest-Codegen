...
/// @brief Field _contract offset 0x18
...
/// @brief Field _member offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Serialization::JsonSerializerInternalReader*> __get__reader() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Serialization::JsonISerializableContract*> __get__contract() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Serialization::JsonProperty*> __get__member() const;
...
// Ctor Parameters []
// @brief default ctor
 JsonFormatterConverter()  = default;
public:
