...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Newtonsoft::Json::Serialization::ResolverContractKey::*)(::System::Object*)>(&::Newtonsoft::Json::Serialization::ResolverContractKey::Equals)> {
...
constexpr ::System::Type* Newtonsoft::Json::Serialization::ResolverContractKey::__get__resolverType()  {
return ::cordl_internals::getInstanceField<::System::Type*, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::cordl_internals::to_const_pointer<::System::Type*> Newtonsoft::Json::Serialization::ResolverContractKey::__get__resolverType() const {
return ::cordl_internals::getInstanceField<::System::Type*, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::System::Type* Newtonsoft::Json::Serialization::ResolverContractKey::__get__contractType()  {
return ::cordl_internals::getInstanceField<::System::Type*, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::cordl_internals::to_const_pointer<::System::Type*> Newtonsoft::Json::Serialization::ResolverContractKey::__get__contractType() const {
return ::cordl_internals::getInstanceField<::System::Type*, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::Newtonsoft::Json::Serialization::ResolverContractKey::ResolverContractKey(::System::Type*  _resolverType, ::System::Type*  _contractType) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->_resolverType = _resolverType;
