...
// Ctor Parameters []
// @brief default ctor
 __JsonSerializerInternalBase__ReferenceEqualsEqualityComparer()  = default;
public:
...
/// @brief Field _currentErrorContext offset 0x10
...
/// @brief Field _mappings offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Serialization::ErrorContext*> __get__currentErrorContext() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Utilities::BidirectionalDictionary_2<::StringW,::System::Object*>*> __get__mappings() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::JsonSerializer*> __get_Serializer() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Serialization::ITraceWriter*> __get_TraceWriter() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Serialization::JsonSerializerProxy*> __get_InternalSerializer() const;
...
// Ctor Parameters []
// @brief default ctor
 JsonSerializerInternalBase()  = default;
public:
