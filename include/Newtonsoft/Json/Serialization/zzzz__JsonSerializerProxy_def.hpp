...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xf8 - sizeof(::Newtonsoft::Json::JsonSerializer)]{};

/// @brief Field _serializerReader offset 0xe0
...
/// @brief Field _serializerWriter offset 0xe8
...
/// @brief Field _serializer offset 0xf0
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Serialization::JsonSerializerInternalReader*> __get__serializerReader() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Serialization::JsonSerializerInternalWriter*> __get__serializerWriter() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::JsonSerializer*> __get__serializer() const;
