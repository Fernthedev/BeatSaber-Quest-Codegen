...
struct CORDL_TYPE __DefaultSerializationBinder__TypeNameKey : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x10};

/// @brief Field AssemblyName offset 0x0
 __declspec(property(get=__get_AssemblyName, put=__set_AssemblyName)) ::StringW  AssemblyName;

/// @brief Field TypeName offset 0x8
...
/// @brief Method .ctor addr 0x2677664 size 0x8 virtual false final false
inline void _ctor(::StringW  assemblyName, ::StringW  typeName) ;

/// @brief Method GetHashCode addr 0x2677794 size 0x50 virtual true final false
inline int32_t GetHashCode() ;

/// @brief Method Equals addr 0x26777e4 size 0x78 virtual true final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals addr 0x267785c size 0x48 virtual false final false
...
constexpr explicit __DefaultSerializationBinder__TypeNameKey(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __DefaultSerializationBinder__TypeNameKey()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::System::Runtime::Serialization::SerializationBinder)]{};

/// @brief Field _typeCache offset 0x10
 __declspec(property(get=__get__typeCache, put=__set__typeCache)) ::Newtonsoft::Json::Utilities::ThreadSafeStore_2<::Newtonsoft::Json::Serialization::__DefaultSerializationBinder__TypeNameKey,::System::Type*>*  _typeCache;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Utilities::ThreadSafeStore_2<::Newtonsoft::Json::Serialization::__DefaultSerializationBinder__TypeNameKey,::System::Type*>*> __get__typeCache() const;

/// @brief Method GetTypeFromTypeNameKey addr 0x26773dc size 0x220 virtual false final false
...
/// @brief Method BindToType addr 0x26775fc size 0x68 virtual true final false
...
/// @brief Method .ctor addr 0x267766c size 0xc8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 DefaultSerializationBinder()  = default;
public:
