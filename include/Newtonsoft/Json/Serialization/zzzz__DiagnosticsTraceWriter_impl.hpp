...
::cordl_internals::setInstanceField<::System::Diagnostics::TraceLevel, 0x10>(this, std::forward<::System::Diagnostics::TraceLevel>(value));
}
...
return ::cordl_internals::getInstanceField<::System::Diagnostics::TraceLevel, 0x10>(this);
}
