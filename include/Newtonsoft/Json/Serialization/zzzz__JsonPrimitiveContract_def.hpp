...
/// @brief Field <TypeCode>k__BackingField offset 0x8c
...
/// @brief Method get_TypeCode addr 0x266e304 size 0x8 virtual false final false
inline ::Newtonsoft::Json::Utilities::PrimitiveTypeCode get_TypeCode() ;

/// @brief Method set_TypeCode addr 0x266e30c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x266e314 size 0xf4 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 JsonPrimitiveContract()  = default;
public:


// Fields

// Static field ReadTypeMap
