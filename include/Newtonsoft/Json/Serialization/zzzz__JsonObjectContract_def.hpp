...
/// @brief Field <MemberSerialization>k__BackingField offset 0xbc
...
/// @brief Field <ItemRequired>k__BackingField offset 0xc0
...
/// @brief Field <Properties>k__BackingField offset 0xc8
...
/// @brief Field <ExtensionDataSetter>k__BackingField offset 0xd0
 __declspec(property(get=__get__ExtensionDataSetter_k__BackingField, put=__set__ExtensionDataSetter_k__BackingField)) ::Newtonsoft::Json::Serialization::ExtensionDataSetter*  _ExtensionDataSetter_k__BackingField;

/// @brief Field <ExtensionDataGetter>k__BackingField offset 0xd8
 __declspec(property(get=__get__ExtensionDataGetter_k__BackingField, put=__set__ExtensionDataGetter_k__BackingField)) ::Newtonsoft::Json::Serialization::ExtensionDataGetter*  _ExtensionDataGetter_k__BackingField;

/// @brief Field ExtensionDataIsJToken offset 0xe0
 __declspec(property(get=__get_ExtensionDataIsJToken, put=__set_ExtensionDataIsJToken)) bool  ExtensionDataIsJToken;

/// @brief Field _hasRequiredOrDefaultValueProperties offset 0xe1
...
/// @brief Field _parametrizedConstructor offset 0xe8
...
/// @brief Field _overrideConstructor offset 0xf0
...
/// @brief Field _overrideCreator offset 0xf8
...
/// @brief Field _creatorParameters offset 0x108
...
/// @brief Field _extensionDataValueType offset 0x110
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Serialization::JsonPropertyCollection*> __get__Properties_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Serialization::ExtensionDataSetter*> __get__ExtensionDataSetter_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Serialization::ExtensionDataGetter*> __get__ExtensionDataGetter_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Reflection::ConstructorInfo*> __get__parametrizedConstructor() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Reflection::ConstructorInfo*> __get__overrideConstructor() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Serialization::JsonPropertyCollection*> __get__creatorParameters() const;

constexpr void __set__extensionDataValueType(::System::Type*  value) ;

constexpr ::System::Type* __get__extensionDataValueType() ;

constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get__extensionDataValueType() const;

/// @brief Method get_MemberSerialization addr 0x267acf8 size 0x8 virtual false final false
inline ::Newtonsoft::Json::MemberSerialization get_MemberSerialization() ;

/// @brief Method set_MemberSerialization addr 0x267ad00 size 0x8 virtual false final false
inline void set_MemberSerialization(::Newtonsoft::Json::MemberSerialization  value) ;

/// @brief Method get_ItemRequired addr 0x267ad08 size 0x8 virtual false final false
inline ::System::Nullable_1<::Newtonsoft::Json::Required> get_ItemRequired() ;

/// @brief Method set_ItemRequired addr 0x267ad10 size 0x8 virtual false final false
inline void set_ItemRequired(::System::Nullable_1<::Newtonsoft::Json::Required>  value) ;

/// @brief Method get_Properties addr 0x267ad18 size 0x8 virtual false final false
inline ::Newtonsoft::Json::Serialization::JsonPropertyCollection* get_Properties() ;

/// @brief Method set_Properties addr 0x267ad20 size 0x8 virtual false final false
inline void set_Properties(::Newtonsoft::Json::Serialization::JsonPropertyCollection*  value) ;

/// @brief Method get_ConstructorParameters addr 0x267ad28 size 0x4 virtual false final false
inline ::Newtonsoft::Json::Serialization::JsonPropertyCollection* get_ConstructorParameters() ;

/// @brief Method get_CreatorParameters addr 0x26706d4 size 0x70 virtual false final false
inline ::Newtonsoft::Json::Serialization::JsonPropertyCollection* get_CreatorParameters() ;

/// @brief Method get_OverrideConstructor addr 0x267ad2c size 0x8 virtual false final false
inline ::System::Reflection::ConstructorInfo* get_OverrideConstructor() ;

/// @brief Method set_OverrideConstructor addr 0x267064c size 0x88 virtual false final false
inline void set_OverrideConstructor(::System::Reflection::ConstructorInfo*  value) ;

/// @brief Method get_ParametrizedConstructor addr 0x267ad34 size 0x8 virtual false final false
inline ::System::Reflection::ConstructorInfo* get_ParametrizedConstructor() ;

/// @brief Method set_ParametrizedConstructor addr 0x26708a4 size 0x88 virtual false final false
inline void set_ParametrizedConstructor(::System::Reflection::ConstructorInfo*  value) ;

/// @brief Method get_OverrideCreator addr 0x267ad3c size 0x8 virtual false final false
inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_OverrideCreator() ;

/// @brief Method set_OverrideCreator addr 0x267ad44 size 0x8 virtual false final false
inline void set_OverrideCreator(::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>*  value) ;

/// @brief Method get_ParameterizedCreator addr 0x267ad4c size 0x8 virtual false final false
inline ::Newtonsoft::Json::Serialization::ObjectConstructor_1<::System::Object*>* get_ParameterizedCreator() ;

/// @brief Method get_ExtensionDataSetter addr 0x267ad54 size 0x8 virtual false final false
inline ::Newtonsoft::Json::Serialization::ExtensionDataSetter* get_ExtensionDataSetter() ;

/// @brief Method set_ExtensionDataSetter addr 0x267ad5c size 0x8 virtual false final false
inline void set_ExtensionDataSetter(::Newtonsoft::Json::Serialization::ExtensionDataSetter*  value) ;

/// @brief Method get_ExtensionDataGetter addr 0x267ad64 size 0x8 virtual false final false
inline ::Newtonsoft::Json::Serialization::ExtensionDataGetter* get_ExtensionDataGetter() ;

/// @brief Method set_ExtensionDataGetter addr 0x267ad6c size 0x8 virtual false final false
inline void set_ExtensionDataGetter(::Newtonsoft::Json::Serialization::ExtensionDataGetter*  value) ;

/// @brief Method get_ExtensionDataValueType addr 0x267ad74 size 0x8 virtual false final false
inline ::System::Type* get_ExtensionDataValueType() ;

/// @brief Method set_ExtensionDataValueType addr 0x26715f0 size 0xac virtual false final false
inline void set_ExtensionDataValueType(::System::Type*  value) ;

/// @brief Method get_HasRequiredOrDefaultValueProperties addr 0x267ad7c size 0x3f4 virtual false final false
...
/// @brief Method .ctor addr 0x266ff28 size 0x88 virtual false final false
inline void _ctor(::System::Type*  underlyingType) ;

/// @brief Method GetUninitializedObject addr 0x267b170 size 0x10c virtual false final false
