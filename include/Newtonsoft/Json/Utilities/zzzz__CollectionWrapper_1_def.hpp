...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(11878))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11878), inst: 2 })
// CS Name: ::Newtonsoft.Json.Utilities::CollectionWrapper`1<T>*
class CORDL_TYPE CollectionWrapper_1<T> : public ::System::Object {
public:
// Declarations
...
/// @brief Field _genericCollection offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> __get__list() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::ICollection_1<T>*> __get__genericCollection() const;
