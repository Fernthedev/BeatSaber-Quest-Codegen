...
// Declarations
template<typename T>
using __c__2_1 = ::Newtonsoft::Json::Utilities::__EnumUtils____c__2_1<T>;
...
static inline void setStaticF_EnumMemberNamesPerType(::Newtonsoft::Json::Utilities::ThreadSafeStore_2<::System::Type*,::Newtonsoft::Json::Utilities::BidirectionalDictionary_2<::StringW,::StringW>*>*  value) ;
...
template<typename T>
static inline ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Utilities::EnumValue_1<uint64_t>*>* GetNamesAndValues() ;

/// @brief Method GetNamesAndValues addr 0x0 size 0xffffffffffffffff virtual false final false
template<typename TUnderlyingType>
static inline ::System::Collections::Generic::IList_1<::Newtonsoft::Json::Utilities::EnumValue_1<TUnderlyingType>*>* GetNamesAndValues(::System::Type*  enumType) ;
...
// Static field EnumMemberNamesPerType
