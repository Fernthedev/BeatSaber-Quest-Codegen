...
struct CORDL_TYPE __JsonReader__State : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____JsonReader__State_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __JsonReader__State(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __JsonReader__State()  = default;
...
/// @brief Field _tokenType offset 0x10
...
/// @brief Field _dateTimeZoneHandling offset 0x48
...
/// @brief Field _floatParseHandling offset 0x5c
...
/// @brief Field _stack offset 0x68
...
/// @brief Field <CloseInput>k__BackingField offset 0x70
...
/// @brief Field <SupportMultipleContent>k__BackingField offset 0x71
...
/// @brief Method get_CurrentState addr 0x264a574 size 0x8 virtual false final false
inline ::Newtonsoft::Json::__JsonReader__State get_CurrentState() ;

/// @brief Method get_CloseInput addr 0x264a57c size 0x8 virtual false final false
inline bool get_CloseInput() ;

/// @brief Method set_CloseInput addr 0x264a584 size 0xc virtual false final false
inline void set_CloseInput(bool  value) ;

/// @brief Method get_SupportMultipleContent addr 0x264a590 size 0x8 virtual false final false
inline bool get_SupportMultipleContent() ;

/// @brief Method set_SupportMultipleContent addr 0x264a598 size 0xc virtual false final false
inline void set_SupportMultipleContent(bool  value) ;

/// @brief Method get_QuoteChar addr 0x264a5a4 size 0x8 virtual true final false
inline char16_t get_QuoteChar() ;

/// @brief Method set_QuoteChar addr 0x264a5ac size 0x8 virtual true final false
inline void set_QuoteChar(char16_t  value) ;

/// @brief Method get_DateTimeZoneHandling addr 0x264a5b4 size 0x8 virtual false final false
inline ::Newtonsoft::Json::DateTimeZoneHandling get_DateTimeZoneHandling() ;

/// @brief Method set_DateTimeZoneHandling addr 0x264a5bc size 0x64 virtual false final false
inline void set_DateTimeZoneHandling(::Newtonsoft::Json::DateTimeZoneHandling  value) ;

/// @brief Method get_DateParseHandling addr 0x264a620 size 0x8 virtual false final false
inline ::Newtonsoft::Json::DateParseHandling get_DateParseHandling() ;

/// @brief Method set_DateParseHandling addr 0x264a628 size 0x64 virtual false final false
inline void set_DateParseHandling(::Newtonsoft::Json::DateParseHandling  value) ;

/// @brief Method get_FloatParseHandling addr 0x264a68c size 0x8 virtual false final false
inline ::Newtonsoft::Json::FloatParseHandling get_FloatParseHandling() ;

/// @brief Method set_FloatParseHandling addr 0x264a694 size 0x64 virtual false final false
inline void set_FloatParseHandling(::Newtonsoft::Json::FloatParseHandling  value) ;

/// @brief Method get_DateFormatString addr 0x264a6f8 size 0x8 virtual false final false
inline ::StringW get_DateFormatString() ;

/// @brief Method set_DateFormatString addr 0x264a700 size 0x8 virtual false final false
inline void set_DateFormatString(::StringW  value) ;

/// @brief Method get_MaxDepth addr 0x264a708 size 0x8 virtual false final false
inline ::System::Nullable_1<int32_t> get_MaxDepth() ;

/// @brief Method set_MaxDepth addr 0x264a710 size 0xc0 virtual false final false
inline void set_MaxDepth(::System::Nullable_1<int32_t>  value) ;

/// @brief Method get_TokenType addr 0x264a7d0 size 0x8 virtual true final false
inline ::Newtonsoft::Json::JsonToken get_TokenType() ;

/// @brief Method get_Value addr 0x264a7d8 size 0x8 virtual true final false
inline ::System::Object* get_Value() ;

/// @brief Method get_ValueType addr 0x264a7e0 size 0x14 virtual true final false
inline ::System::Type* get_ValueType() ;

/// @brief Method get_Depth addr 0x264a7f4 size 0x7c virtual true final false
inline int32_t get_Depth() ;

/// @brief Method get_Path addr 0x264a870 size 0x120 virtual true final false
inline ::StringW get_Path() ;

/// @brief Method get_Culture addr 0x26414b4 size 0x68 virtual false final false
inline ::System::Globalization::CultureInfo* get_Culture() ;

/// @brief Method set_Culture addr 0x264a990 size 0x8 virtual false final false
inline void set_Culture(::System::Globalization::CultureInfo*  value) ;

/// @brief Method GetPosition addr 0x264a998 size 0xa4 virtual false final false
inline ::Newtonsoft::Json::JsonPosition GetPosition(int32_t  depth) ;

static inline ::Newtonsoft::Json::JsonReader* New_ctor() ;

/// @brief Method .ctor addr 0x2640920 size 0x38 virtual false final false
inline void _ctor() ;

/// @brief Method Push addr 0x264aa3c size 0x288 virtual false final false
inline void Push(::Newtonsoft::Json::JsonContainerType  value) ;

/// @brief Method Pop addr 0x264acdc size 0x11c virtual false final false
inline ::Newtonsoft::Json::JsonContainerType Pop() ;

/// @brief Method Peek addr 0x264adf8 size 0x8 virtual false final false
inline ::Newtonsoft::Json::JsonContainerType Peek() ;

/// @brief Method Read addr 0x0 size 0xffffffffffffffff virtual true final false
inline bool Read() ;

/// @brief Method ReadAsInt32 addr 0x264ae00 size 0x2dc virtual true final false
inline ::System::Nullable_1<int32_t> ReadAsInt32() ;

/// @brief Method ReadInt32String addr 0x264600c size 0x1e8 virtual false final false
inline ::System::Nullable_1<int32_t> ReadInt32String(::StringW  s) ;

/// @brief Method ReadAsString addr 0x264b150 size 0x368 virtual true final false
inline ::StringW ReadAsString() ;

/// @brief Method ReadAsBytes addr 0x264b4b8 size 0x3f8 virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadAsBytes() ;

/// @brief Method ReadArrayIntoByteArray addr 0x2643a38 size 0x29c virtual false final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadArrayIntoByteArray() ;

/// @brief Method ReadAsDouble addr 0x264b8b0 size 0x2cc virtual true final false
inline ::System::Nullable_1<double_t> ReadAsDouble() ;

/// @brief Method ReadDoubleString addr 0x2646420 size 0x1dc virtual false final false
inline ::System::Nullable_1<double_t> ReadDoubleString(::StringW  s) ;

/// @brief Method ReadAsBoolean addr 0x264bb7c size 0x2c0 virtual true final false
inline ::System::Nullable_1<bool> ReadAsBoolean() ;

/// @brief Method ReadBooleanString addr 0x2645d34 size 0x1e8 virtual false final false
inline ::System::Nullable_1<bool> ReadBooleanString(::StringW  s) ;

/// @brief Method ReadAsDecimal addr 0x264be3c size 0x310 virtual true final false
inline ::System::Nullable_1<::System::Decimal> ReadAsDecimal() ;

/// @brief Method ReadDecimalString addr 0x26461f4 size 0x22c virtual false final false
inline ::System::Nullable_1<::System::Decimal> ReadDecimalString(::StringW  s) ;

/// @brief Method ReadAsDateTime addr 0x264c14c size 0x2c0 virtual true final false
inline ::System::Nullable_1<::System::DateTime> ReadAsDateTime() ;

/// @brief Method ReadDateTimeString addr 0x26440b8 size 0x288 virtual false final false
inline ::System::Nullable_1<::System::DateTime> ReadDateTimeString(::StringW  s) ;

/// @brief Method ReadAsDateTimeOffset addr 0x264c40c size 0x2cc virtual true final false
inline ::System::Nullable_1<::System::DateTimeOffset> ReadAsDateTimeOffset() ;

/// @brief Method ReadDateTimeOffsetString addr 0x2644340 size 0x268 virtual false final false
inline ::System::Nullable_1<::System::DateTimeOffset> ReadDateTimeOffsetString(::StringW  s) ;

/// @brief Method ReaderReadAndAssert addr 0x264383c size 0x44 virtual false final false
inline void ReaderReadAndAssert() ;

/// @brief Method CreateUnexpectedEndException addr 0x26468f4 size 0x4c virtual false final false
inline ::Newtonsoft::Json::JsonReaderException* CreateUnexpectedEndException() ;

/// @brief Method ReadIntoWrappedTypeObject addr 0x2643880 size 0x1b8 virtual false final false
inline void ReadIntoWrappedTypeObject() ;

/// @brief Method Skip addr 0x264c6d8 size 0x98 virtual false final false
inline void Skip() ;

/// @brief Method SetToken addr 0x2642380 size 0xc virtual false final false
inline void SetToken(::Newtonsoft::Json::JsonToken  newToken) ;

/// @brief Method SetToken addr 0x264558c size 0x8 virtual false final false
inline void SetToken(::Newtonsoft::Json::JsonToken  newToken, ::System::Object*  value) ;

/// @brief Method SetToken addr 0x264135c size 0x158 virtual false final false
inline void SetToken(::Newtonsoft::Json::JsonToken  newToken, ::System::Object*  value, bool  updateIndex) ;

/// @brief Method SetPostValueState addr 0x264131c size 0x40 virtual false final false
inline void SetPostValueState(bool  updateIndex) ;

/// @brief Method UpdateScopeWithFinishedValue addr 0x264acc4 size 0x18 virtual false final false
inline void UpdateScopeWithFinishedValue() ;

/// @brief Method ValidateEnd addr 0x264c770 size 0x100 virtual false final false
inline void ValidateEnd(::Newtonsoft::Json::JsonToken  endToken) ;

/// @brief Method SetStateBasedOnCurrent addr 0x2645f1c size 0xf0 virtual false final false
inline void SetStateBasedOnCurrent() ;

/// @brief Method SetFinished addr 0x264c870 size 0x18 virtual false final false
inline void SetFinished() ;

/// @brief Method GetTypeForCloseToken addr 0x264c888 size 0xa8 virtual false final false
inline ::Newtonsoft::Json::JsonContainerType GetTypeForCloseToken(::Newtonsoft::Json::JsonToken  token) ;

/// @brief Method System.IDisposable.Dispose addr 0x264c930 size 0x70 virtual true final true
inline void System_IDisposable_Dispose() ;

/// @brief Method Dispose addr 0x264c9a0 size 0x24 virtual true final false
inline void Dispose(bool  disposing) ;

/// @brief Method Close addr 0x2647a04 size 0x14 virtual true final false
inline void Close() ;

/// @brief Method ReadAndAssert addr 0x264c9c4 size 0x54 virtual false final false
inline void ReadAndAssert() ;

/// @brief Method ReadAndMoveToContent addr 0x264ca20 size 0x30 virtual false final false
inline bool ReadAndMoveToContent() ;

/// @brief Method MoveToContent addr 0x264ca50 size 0x58 virtual false final false
inline bool MoveToContent() ;

/// @brief Method GetContentToken addr 0x264b0dc size 0x74 virtual false final false
