...
/// @brief Field _xmlObject offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Linq::XObject*> __get__xmlObject() const;
...
// Ctor Parameters []
// @brief default ctor
 XObjectWrapper()  = default;
public:


// Fields

// Static field EmptyChildNodes
