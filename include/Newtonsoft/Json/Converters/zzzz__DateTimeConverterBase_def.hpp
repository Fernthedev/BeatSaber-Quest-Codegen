...
/// @brief Method CanConvert addr 0x26b3ca4 size 0x140 virtual true final false
inline bool CanConvert(::System::Type*  objectType) ;

static inline ::Newtonsoft::Json::Converters::DateTimeConverterBase* New_ctor() ;

/// @brief Method .ctor addr 0x26b3de4 size 0x8 virtual false final false
inline void _ctor() ;
