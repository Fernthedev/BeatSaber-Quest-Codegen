...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11830)), TypeDefinitionIndex(TypeDefinitionIndex(12033))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12033), inst: 2 })
...
// Ctor Parameters []
// @brief default ctor
 EnumerableVectorConverter_1()  = default;
public:


// Fields

// Static field VectorConverter
