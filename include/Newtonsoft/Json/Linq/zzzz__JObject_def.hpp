...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Linq::JObject*> __get___4__this() const;
...
/// @brief Method System.Collections.Generic.IEnumerator<System.Collections.Generic.KeyValuePair<System.String,Newtonsoft.Json.Linq.JToken>>.get_Current addr 0x269ae60 size 0xc virtual true final true
...
// Ctor Parameters []
// @brief default ctor
 __JObject___GetEnumerator_d__58()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x68 - sizeof(::Newtonsoft::Json::Linq::JContainer)]{};

/// @brief Field _properties offset 0x50
...
/// @brief Field PropertyChanged offset 0x58
...
/// @brief Field PropertyChanging offset 0x60
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Linq::JPropertyKeyedCollection*> __get__properties() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::ComponentModel::PropertyChangedEventHandler*> __get_PropertyChanged() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::ComponentModel::PropertyChangingEventHandler*> __get_PropertyChanging() const;
...
/// @brief Method System.Collections.Generic.ICollection<System.Collections.Generic.KeyValuePair<System.String,Newtonsoft.Json.Linq.JToken>>.get_IsReadOnly addr 0x269a254 size 0x8 virtual true final true
