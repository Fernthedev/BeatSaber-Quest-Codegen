...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Linq::__JProperty__JPropertyList*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __JProperty__JPropertyList___GetEnumerator_d__1()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Linq::JToken*> __get__token() const;
...
// Ctor Parameters []
// @brief default ctor
 __JProperty__JPropertyList()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x60 - sizeof(::Newtonsoft::Json::Linq::JContainer)]{};

/// @brief Field _content offset 0x50
 __declspec(property(get=__get__content, put=__set__content)) ::Newtonsoft::Json::Linq::__JProperty__JPropertyList*  _content;

/// @brief Field _name offset 0x58
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Linq::__JProperty__JPropertyList*> __get__content() const;
