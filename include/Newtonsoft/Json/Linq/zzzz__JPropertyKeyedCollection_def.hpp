...
namespace Newtonsoft::Json::Linq {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3814), inst: 1024 }), TypeDefinitionIndex(TypeDefinitionIndex(12002)), TypeDefinitionIndex(TypeDefinitionIndex(3814))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::System::Collections::ObjectModel::Collection_1<::Newtonsoft::Json::Linq::JToken*>)]{};

/// @brief Field _dictionary offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::Newtonsoft::Json::Linq::JToken*>*> __get__dictionary() const;
...
// Ctor Parameters []
// @brief default ctor
 JPropertyKeyedCollection()  = default;
public:
