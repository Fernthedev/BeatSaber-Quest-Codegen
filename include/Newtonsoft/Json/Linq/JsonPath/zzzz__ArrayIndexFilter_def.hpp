...
/// @brief Field <t>5__1 offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Linq::JsonPath::ArrayIndexFilter*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __ArrayIndexFilter___ExecuteFilter_d__4()  = default;
public:
...
/// @brief Field <Index>k__BackingField offset 0x10
