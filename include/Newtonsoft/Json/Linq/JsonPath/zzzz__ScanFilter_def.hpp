...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Linq::JsonPath::ScanFilter*> __get___4__this() const;

constexpr void __set__root_5__1(::Newtonsoft::Json::Linq::JToken*  value) ;

constexpr ::Newtonsoft::Json::Linq::JToken* __get__root_5__1() ;

constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Linq::JToken*> __get__root_5__1() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Linq::JToken*> __get__value_5__2() const;
...
// Ctor Parameters []
// @brief default ctor
 __ScanFilter___ExecuteFilter_d__4()  = default;
public:
