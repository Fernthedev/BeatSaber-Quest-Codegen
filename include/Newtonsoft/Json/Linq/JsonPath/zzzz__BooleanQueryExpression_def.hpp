...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::Newtonsoft::Json::Linq::JsonPath::QueryExpression)]{};

/// @brief Field <Path>k__BackingField offset 0x18
 __declspec(property(get=__get__Path_k__BackingField, put=__set__Path_k__BackingField)) ::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JsonPath::PathFilter*>*  _Path_k__BackingField;

/// @brief Field <Value>k__BackingField offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JsonPath::PathFilter*>*> __get__Path_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::Newtonsoft::Json::Linq::JValue*> __get__Value_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 BooleanQueryExpression()  = default;
public:
