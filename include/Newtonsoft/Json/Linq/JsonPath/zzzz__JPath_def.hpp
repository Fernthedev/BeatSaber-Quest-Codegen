...
/// @brief Field _expression offset 0x10
 __declspec(property(get=__get__expression, put=__set__expression)) ::StringW  _expression;

/// @brief Field <Filters>k__BackingField offset 0x18
 __declspec(property(get=__get__Filters_k__BackingField, put=__set__Filters_k__BackingField)) ::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JsonPath::PathFilter*>*  _Filters_k__BackingField;

/// @brief Field _currentIndex offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JsonPath::PathFilter*>*> __get__Filters_k__BackingField() const;
...
/// @brief Method get_Filters addr 0x26aea90 size 0x8 virtual false final false
inline ::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JsonPath::PathFilter*>* get_Filters() ;

/// @brief Method set_Filters addr 0x26aea98 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x26aeaa0 size 0xb8 virtual false final false
inline void _ctor(::StringW  expression) ;

/// @brief Method ParseMain addr 0x26aeb58 size 0x160 virtual false final false
inline void ParseMain() ;

/// @brief Method ParsePath addr 0x26aed0c size 0x608 virtual false final false
...
/// @brief Method ParseIndexer addr 0x26af31c size 0xf4 virtual false final false
inline ::Newtonsoft::Json::Linq::JsonPath::PathFilter* ParseIndexer(char16_t  indexerOpenChar) ;

/// @brief Method ParseArrayIndexer addr 0x26af980 size 0x798 virtual false final false
inline ::Newtonsoft::Json::Linq::JsonPath::PathFilter* ParseArrayIndexer(char16_t  indexerCloseChar) ;

/// @brief Method EatWhitespace addr 0x26aecb8 size 0x54 virtual false final false
inline void EatWhitespace() ;

/// @brief Method ParseQuery addr 0x26af7d8 size 0x1a8 virtual false final false
inline ::Newtonsoft::Json::Linq::JsonPath::PathFilter* ParseQuery(char16_t  indexerCloseChar) ;

/// @brief Method ParseExpression addr 0x26b0118 size 0x690 virtual false final false
inline ::Newtonsoft::Json::Linq::JsonPath::QueryExpression* ParseExpression() ;

/// @brief Method ParseValue addr 0x26b0994 size 0x38c virtual false final false
inline ::System::Object* ParseValue() ;

/// @brief Method ReadQuotedString addr 0x26b0e50 size 0x244 virtual false final false
inline ::StringW ReadQuotedString() ;

/// @brief Method Match addr 0x26b0d28 size 0xa8 virtual false final false
inline bool Match(::StringW  s) ;

/// @brief Method ParseOperator addr 0x26b07b0 size 0x1e4 virtual false final false
inline ::Newtonsoft::Json::Linq::JsonPath::QueryOperator ParseOperator() ;

/// @brief Method ParseQuotedField addr 0x26af484 size 0x354 virtual false final false
inline ::Newtonsoft::Json::Linq::JsonPath::PathFilter* ParseQuotedField(char16_t  indexerCloseChar) ;

/// @brief Method EnsureLength addr 0x26af410 size 0x74 virtual false final false
inline void EnsureLength(::StringW  message) ;

/// @brief Method Evaluate addr 0x26b1094 size 0xc virtual false final false
...
/// @brief Method Evaluate addr 0x26b10a0 size 0x1cc virtual false final false
static inline ::System::Collections::Generic::IEnumerable_1<::Newtonsoft::Json::Linq::JToken*>* Evaluate(::System::Collections::Generic::List_1<::Newtonsoft::Json::Linq::JsonPath::PathFilter*>*  filters, ::Newtonsoft::Json::Linq::JToken*  t, bool  errorWhenNoMatch) ;
