...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::JsonSerializationException::*)()>(&::Newtonsoft::Json::JsonSerializationException::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::JsonSerializationException::*)(::StringW)>(&::Newtonsoft::Json::JsonSerializationException::_ctor)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x264f650;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::JsonSerializationException::*)(::StringW, ::System::Exception*)>(&::Newtonsoft::Json::JsonSerializationException::_ctor)> {
  constexpr static std::size_t size = 0x4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Newtonsoft::Json::JsonSerializationException::*)(::System::Runtime::Serialization::SerializationInfo*, ::System::Runtime::Serialization::StreamingContext)>(&::Newtonsoft::Json::JsonSerializationException::_ctor)> {
  constexpr static std::size_t size = 0x4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Newtonsoft::Json::JsonSerializationException* (*)(::Newtonsoft::Json::JsonReader*, ::StringW)>(&::Newtonsoft::Json::JsonSerializationException::Create)> {
  ...
  constexpr static std::size_t addrs = 0x264ca18;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Newtonsoft::Json::JsonSerializationException* (*)(::Newtonsoft::Json::JsonReader*, ::StringW, ::System::Exception*)>(&::Newtonsoft::Json::JsonSerializationException::Create)> {
  ...
  constexpr static std::size_t addrs = 0x264ff28;
...
return THROW_UNLESS(::il2cpp_utils::New<::Newtonsoft::Json::JsonSerializationException*>());
}
...
return THROW_UNLESS(::il2cpp_utils::New<::Newtonsoft::Json::JsonSerializationException*>(message));
}
...
return THROW_UNLESS(::il2cpp_utils::New<::Newtonsoft::Json::JsonSerializationException*>(message, innerException));
}
...
return THROW_UNLESS(::il2cpp_utils::New<::Newtonsoft::Json::JsonSerializationException*>(info, context));
}
