...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xd0 - sizeof(::Newtonsoft::Json::JsonReader)]{};

/// @brief Field UnicodeReplacementChar offset 0x0
static constexpr char16_t  UnicodeReplacementChar{u'\u{fffd}'};

/// @brief Field MaximumJavascriptIntegerCharacterLength offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::System::IO::TextReader*> __get__reader() const;
