...
/// @brief Method CountDigits addr 0x258c6c8 size 0xbc virtual false final false
static inline int32_t CountDigits(uint64_t  value) ;

/// @brief Method CountDigits addr 0x258c784 size 0x6c virtual false final false
static inline int32_t CountDigits(uint32_t  value) ;

/// @brief Method CountHexDigits addr 0x258c7f0 size 0x48 virtual false final false
