...
struct CORDL_TYPE __ArrayPoolEventSource__BufferAllocatedReason : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____ArrayPoolEventSource__BufferAllocatedReason_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __ArrayPoolEventSource__BufferAllocatedReason(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ArrayPoolEventSource__BufferAllocatedReason()  = default;
...
/// @brief Method .ctor addr 0x258c194 size 0xac virtual false final false
inline void _ctor() ;

/// @brief Method BufferRented addr 0x258c240 size 0x110 virtual false final false
inline void BufferRented(int32_t  bufferId, int32_t  bufferSize, int32_t  poolId, int32_t  bucketId) ;

/// @brief Method BufferAllocated addr 0x258c350 size 0x12c virtual false final false
...
/// @brief Method BufferReturned addr 0x258c47c size 0x18 virtual false final false
inline void BufferReturned(int32_t  bufferId, int32_t  bufferSize, int32_t  poolId) ;

/// @brief Method BufferTrimmed addr 0x258c494 size 0x18 virtual false final false
inline void BufferTrimmed(int32_t  bufferId, int32_t  bufferSize, int32_t  poolId) ;

/// @brief Method BufferTrimPoll addr 0x258c4ac size 0x14 virtual false final false
