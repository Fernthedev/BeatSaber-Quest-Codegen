...
struct CORDL_TYPE Int64 : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
...
/// @brief Field m_value offset 0x0
 __declspec(property(get=__get_m_value, put=__set_m_value)) int64_t  m_value;
...
constexpr int64_t& __get_m_value() ;

constexpr int64_t const& __get_m_value() const;
...
constexpr explicit Int64(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}
