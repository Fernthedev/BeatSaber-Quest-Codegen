...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::IO::PinnedBufferMemoryStream::*)(::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::System::IO::PinnedBufferMemoryStream::_ctor)> {
...
::cordl_internals::setInstanceField<::System::Runtime::InteropServices::GCHandle, 0x70>(this, std::forward<::System::Runtime::InteropServices::GCHandle>(value));
}
constexpr ::System::Runtime::InteropServices::GCHandle& System::IO::PinnedBufferMemoryStream::__get__pinningHandle()  {
return ::cordl_internals::getInstanceField<::System::Runtime::InteropServices::GCHandle, 0x70>(this);
}
