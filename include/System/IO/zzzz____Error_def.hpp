...
/// @brief Method EndOfFile addr 0x2538674 size 0x60 virtual false final false
static inline void EndOfFile() ;

/// @brief Method FileNotOpen addr 0x25386d4 size 0x64 virtual false final false
static inline void FileNotOpen() ;

/// @brief Method ReaderClosed addr 0x2538738 size 0x64 virtual false final false
static inline void ReaderClosed() ;

/// @brief Method GetDisplayablePath addr 0x253879c size 0x144 virtual false final false
static inline ::StringW GetDisplayablePath(::StringW  path, bool  isInvalidPath) ;

/// @brief Method WinIOError addr 0x2538a7c size 0x5a0 virtual false final false
static inline void WinIOError(int32_t  errorCode, ::StringW  maybeFullPath) ;

/// @brief Method WriterClosed addr 0x253901c size 0x64 virtual false final false
