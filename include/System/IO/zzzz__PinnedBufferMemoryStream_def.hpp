...
namespace System::IO {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3587))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x78 - sizeof(::System::IO::UnmanagedMemoryStream)]{};

/// @brief Field _array offset 0x68
 __declspec(property(get=__get__array, put=__set__array)) ::ArrayW<uint8_t,::Array<uint8_t>*>  _array;

/// @brief Field _pinningHandle offset 0x70
...
// Ctor Parameters []
// @brief default ctor
 PinnedBufferMemoryStream()  = default;
public:
