...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x60 - sizeof(::System::IO::StreamReader)]{};
...
/// @brief Method .ctor addr 0x2502d0c size 0x94 virtual false final false
inline void _ctor() ;

/// @brief Method get_BaseStream addr 0x2502da0 size 0x58 virtual true final false
inline ::System::IO::Stream* get_BaseStream() ;

/// @brief Method get_CurrentEncoding addr 0x2502df8 size 0x8 virtual true final false
inline ::System::Text::Encoding* get_CurrentEncoding() ;

/// @brief Method Dispose addr 0x2502e00 size 0x4 virtual true final false
inline void Dispose(bool  disposing) ;

/// @brief Method Peek addr 0x2502e04 size 0x8 virtual true final false
inline int32_t Peek() ;

/// @brief Method Read addr 0x2502e0c size 0x8 virtual true final false
inline int32_t Read() ;

/// @brief Method Read addr 0x2502e14 size 0x8 virtual true final false
inline int32_t Read(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method ReadLine addr 0x2502e1c size 0x8 virtual true final false
inline ::StringW ReadLine() ;

/// @brief Method ReadToEnd addr 0x2502e24 size 0x48 virtual true final false
inline ::StringW ReadToEnd() ;

/// @brief Method ReadBuffer addr 0x2502e6c size 0x8 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 __StreamReader__NullStreamReader()  = default;
public:
