...
/// @brief Method OpenText addr 0x250b7dc size 0xc8 virtual false final false
static inline ::System::IO::StreamReader* OpenText(::StringW  path) ;

/// @brief Method CreateText addr 0x250b8a4 size 0xb4 virtual false final false
static inline ::System::IO::StreamWriter* CreateText(::StringW  path) ;

/// @brief Method AppendText addr 0x250b958 size 0xb4 virtual false final false
static inline ::System::IO::StreamWriter* AppendText(::StringW  path) ;

/// @brief Method Create addr 0x250ba0c size 0x8 virtual false final false
static inline ::System::IO::FileStream* Create(::StringW  path) ;

/// @brief Method Create addr 0x250ba14 size 0x80 virtual false final false
static inline ::System::IO::FileStream* Create(::StringW  path, int32_t  bufferSize) ;

/// @brief Method Delete addr 0x250ba94 size 0xac virtual false final false
static inline void Delete(::StringW  path) ;

/// @brief Method Exists addr 0x24ffff8 size 0x1bc virtual false final false
static inline bool Exists(::StringW  path) ;

/// @brief Method Open addr 0x250bd68 size 0x14 virtual false final false
static inline ::System::IO::FileStream* Open(::StringW  path, ::System::IO::FileMode  mode) ;

/// @brief Method Open addr 0x250bd7c size 0x8c virtual false final false
...
/// @brief Method GetAttributes addr 0x250be08 size 0x5c virtual false final false
static inline ::System::IO::FileAttributes GetAttributes(::StringW  path) ;

/// @brief Method OpenRead addr 0x250bee4 size 0x70 virtual false final false
static inline ::System::IO::FileStream* OpenRead(::StringW  path) ;

/// @brief Method OpenWrite addr 0x250bf54 size 0x70 virtual false final false
static inline ::System::IO::FileStream* OpenWrite(::StringW  path) ;

/// @brief Method ReadAllText addr 0x250bfc4 size 0xcc virtual false final false
static inline ::StringW ReadAllText(::StringW  path) ;

/// @brief Method InternalReadAllText addr 0x250c090 size 0x1a8 virtual false final false
static inline ::StringW InternalReadAllText(::StringW  path, ::System::Text::Encoding*  encoding) ;

/// @brief Method WriteAllText addr 0x250c238 size 0x23c virtual false final false
static inline void WriteAllText(::StringW  path, ::StringW  contents) ;

/// @brief Method ReadAllBytes addr 0x250c474 size 0x2c0 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadAllBytes(::StringW  path) ;

/// @brief Method ReadAllBytesUnknownLength addr 0x250c734 size 0x470 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadAllBytesUnknownLength(::System::IO::FileStream*  fs) ;

/// @brief Method WriteAllBytes addr 0x250cba4 size 0x108 virtual false final false
static inline void WriteAllBytes(::StringW  path, ::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method InternalWriteAllBytes addr 0x250ccac size 0x1b8 virtual false final false
static inline void InternalWriteAllBytes(::StringW  path, ::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method ReadAllLines addr 0x250ce64 size 0xcc virtual false final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> ReadAllLines(::StringW  path) ;

/// @brief Method InternalReadAllLines addr 0x250cf30 size 0x284 virtual false final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> InternalReadAllLines(::StringW  path, ::System::Text::Encoding*  encoding) ;

/// @brief Method WriteAllLines addr 0x250d1b4 size 0x4 virtual false final false
static inline void WriteAllLines(::StringW  path, ::ArrayW<::StringW,::Array<::StringW>*>  contents) ;

/// @brief Method WriteAllLines addr 0x250d1b8 size 0x134 virtual false final false
static inline void WriteAllLines(::StringW  path, ::System::Collections::Generic::IEnumerable_1<::StringW>*  contents) ;

/// @brief Method InternalWriteAllLines addr 0x250d2ec size 0x404 virtual false final false
...
/// @brief Method Replace addr 0x250d6f0 size 0x8 virtual false final false
static inline void Replace(::StringW  sourceFileName, ::StringW  destinationFileName, ::StringW  destinationBackupFileName) ;

/// @brief Method Replace addr 0x250d6f8 size 0x130 virtual false final false
...
/// @brief Method Move addr 0x250d998 size 0x240 virtual false final false
static inline void Move(::StringW  sourceFileName, ::StringW  destFileName) ;

/// @brief Method GetAccessControl addr 0x250dcf0 size 0x8 virtual false final false
static inline ::System::Security::AccessControl::FileSecurity* GetAccessControl(::StringW  path) ;

/// @brief Method GetAccessControl addr 0x250dcf8 size 0x74 virtual false final false
