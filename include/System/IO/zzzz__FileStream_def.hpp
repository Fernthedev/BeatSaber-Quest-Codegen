...
static inline ::System::IO::__FileStream__ReadDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __FileStream__ReadDelegate()  = default;
public:
...
static inline ::System::IO::__FileStream__WriteDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __FileStream__WriteDelegate()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Microsoft::Win32::SafeHandles::SafeFileHandle*> __get_safeHandle() const;
...
static inline ::System::IO::FileStream* New_ctor(::cordl_internals::intptr_t  handle, ::System::IO::FileAccess  access, bool  ownsHandle, int32_t  bufferSize) ;

/// @brief Method .ctor addr 0x253c3a8 size 0x10 virtual false final false
inline void _ctor(::cordl_internals::intptr_t  handle, ::System::IO::FileAccess  access, bool  ownsHandle, int32_t  bufferSize) ;

static inline ::System::IO::FileStream* New_ctor(::cordl_internals::intptr_t  handle, ::System::IO::FileAccess  access, bool  ownsHandle, int32_t  bufferSize, bool  isAsync, bool  isConsoleWrapper) ;

/// @brief Method .ctor addr 0x253c3b8 size 0x1ac virtual false final false
inline void _ctor(::cordl_internals::intptr_t  handle, ::System::IO::FileAccess  access, bool  ownsHandle, int32_t  bufferSize, bool  isAsync, bool  isConsoleWrapper) ;
...
// Static field buf_recycle

// Static field buf_recycle_lock
