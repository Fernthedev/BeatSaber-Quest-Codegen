...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::System::IO::TextReader)]{};
...
constexpr ::cordl_internals::to_const_pointer<::System::IO::TextReader*> __get__in() const;
...
// Ctor Parameters []
// @brief default ctor
 __TextReader__SyncTextReader()  = default;
public:
