...
constexpr void System::IO::FileStatus::__set__fileStatus(::GlobalNamespace::__Interop__Sys__FileStatus  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::__Interop__Sys__FileStatus, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::GlobalNamespace::__Interop__Sys__FileStatus>(value));
}
constexpr ::GlobalNamespace::__Interop__Sys__FileStatus& System::IO::FileStatus::__get__fileStatus()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::__Interop__Sys__FileStatus, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::GlobalNamespace::__Interop__Sys__FileStatus const& System::IO::FileStatus::__get__fileStatus() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::__Interop__Sys__FileStatus, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& System::IO::FileStatus::__get__fileStatusInitialized()  {
return ::cordl_internals::getInstanceField<int32_t, 0x70>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& System::IO::FileStatus::__get__fileStatusInitialized() const {
return ::cordl_internals::getInstanceField<int32_t, 0x70>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr bool& System::IO::FileStatus::__get__InitiallyDirectory_k__BackingField()  {
return ::cordl_internals::getInstanceField<bool, 0x74>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr bool const& System::IO::FileStatus::__get__InitiallyDirectory_k__BackingField() const {
return ::cordl_internals::getInstanceField<bool, 0x74>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr bool& System::IO::FileStatus::__get__isDirectory()  {
return ::cordl_internals::getInstanceField<bool, 0x75>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr bool const& System::IO::FileStatus::__get__isDirectory() const {
return ::cordl_internals::getInstanceField<bool, 0x75>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void System::IO::FileStatus::__set__exists(bool  value)  {
::cordl_internals::setInstanceField<bool, 0x76>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<bool>(value));
}
constexpr bool& System::IO::FileStatus::__get__exists()  {
return ::cordl_internals::getInstanceField<bool, 0x76>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr bool const& System::IO::FileStatus::__get__exists() const {
return ::cordl_internals::getInstanceField<bool, 0x76>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::System::IO::FileStatus::FileStatus(::GlobalNamespace::__Interop__Sys__FileStatus  _fileStatus, int32_t  _fileStatusInitialized, bool  _InitiallyDirectory_k__BackingField, bool  _isDirectory, bool  _exists) noexcept : ::bs_hook::ValueTypeWrapper<0x78>() {this->_fileStatus = _fileStatus;
