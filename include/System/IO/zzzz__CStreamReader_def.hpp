...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x68 - sizeof(::System::IO::StreamReader)]{};

/// @brief Field driver offset 0x60
...
constexpr ::cordl_internals::to_const_pointer<::System::TermInfoDriver*> __get_driver() const;
