...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::System::Reflection::SignatureType)]{};

/// @brief Field _genericTypeDefinition offset 0x18
 __declspec(property(get=__get__genericTypeDefinition, put=__set__genericTypeDefinition)) ::System::Type*  _genericTypeDefinition;

/// @brief Field _genericTypeArguments offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get__genericTypeDefinition() const;
...
// Ctor Parameters []
// @brief default ctor
 SignatureConstructedGenericType()  = default;
public:
