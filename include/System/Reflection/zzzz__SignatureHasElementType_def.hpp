...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::System::Reflection::SignatureType)]{};

/// @brief Field _elementType offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Reflection::SignatureType*> __get__elementType() const;
...
// Ctor Parameters []
// @brief default ctor
 SignatureHasElementType()  = default;
public:
