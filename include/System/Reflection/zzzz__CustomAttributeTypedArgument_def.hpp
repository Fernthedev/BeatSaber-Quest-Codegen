...
struct CORDL_TYPE CustomAttributeTypedArgument : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x10};

/// @brief Field <ArgumentType>k__BackingField offset 0x0
 __declspec(property(get=__get__ArgumentType_k__BackingField, put=__set__ArgumentType_k__BackingField)) ::System::Type*  _ArgumentType_k__BackingField;

/// @brief Field <Value>k__BackingField offset 0x8
...
constexpr ::System::Type* __get__ArgumentType_k__BackingField() ;

constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get__ArgumentType_k__BackingField() const;
...
constexpr explicit CustomAttributeTypedArgument(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}
