...
static inline ::System::Reflection::__EventInfo__AddEventAdapter* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __EventInfo__AddEventAdapter()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::System::Reflection::MemberInfo)]{};

/// @brief Field cached_add_event offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Reflection::__EventInfo__AddEventAdapter*> __get_cached_add_event() const;
...
static inline ::System::Reflection::EventInfo* internal_from_handle_type(::cordl_internals::intptr_t  event_handle, ::cordl_internals::intptr_t  type_handle) ;
