...
/// @brief Field _caseInsensitiveTable offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Resources::IResourceReader*> __get_Reader() const;

constexpr void __set_Table(::System::Collections::Hashtable*  value) ;

constexpr ::System::Collections::Hashtable* __get_Table() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> __get_Table() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> __get__caseInsensitiveTable() const;
