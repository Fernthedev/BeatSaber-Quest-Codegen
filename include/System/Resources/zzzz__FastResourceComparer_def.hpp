...
/// @brief Method GetHashCode addr 0x24e0a90 size 0x8c virtual true final true
inline int32_t GetHashCode(::System::Object*  key) ;

/// @brief Method GetHashCode addr 0x24e0b88 size 0x54 virtual true final true
inline int32_t GetHashCode(::StringW  key) ;

/// @brief Method HashFunction addr 0x24e0b1c size 0x6c virtual false final false
static inline int32_t HashFunction(::StringW  key) ;

/// @brief Method Compare addr 0x24e0bdc size 0x9c virtual true final true
inline int32_t Compare(::System::Object*  a, ::System::Object*  b) ;

/// @brief Method Compare addr 0x24e0c78 size 0x10 virtual true final true
inline int32_t Compare(::StringW  a, ::StringW  b) ;

/// @brief Method Equals addr 0x24e0c88 size 0x10 virtual true final true
inline bool Equals(::StringW  a, ::StringW  b) ;

/// @brief Method Equals addr 0x24e0c98 size 0x9c virtual true final true
inline bool Equals(::System::Object*  a, ::System::Object*  b) ;

/// @brief Method CompareOrdinal addr 0x24e0d34 size 0xbc virtual false final false
static inline int32_t CompareOrdinal(::StringW  a, ::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  bCharLength) ;

/// @brief Method CompareOrdinal addr 0x24e0df0 size 0x74 virtual false final false
static inline int32_t CompareOrdinal(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes, int32_t  aCharLength, ::StringW  b) ;

/// @brief Method CompareOrdinal addr 0x24e0e64 size 0x94 virtual false final false
...
/// @brief Method .ctor addr 0x24e0ef8 size 0x8 virtual false final false
inline void _ctor() ;
