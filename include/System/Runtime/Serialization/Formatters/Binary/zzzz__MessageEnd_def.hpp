...
/// @brief Method .ctor addr 0x24c351c size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method Write addr 0x24c3524 size 0x28 virtual true final true
inline void Write(::System::Runtime::Serialization::Formatters::Binary::__BinaryWriter*  sout) ;

/// @brief Method Read addr 0x24c354c size 0x4 virtual true final true
inline void Read(::System::Runtime::Serialization::Formatters::Binary::__BinaryParser*  input) ;

/// @brief Method Dump addr 0x24c3550 size 0x4 virtual false final false
inline void Dump() ;

/// @brief Method Dump addr 0x24c3554 size 0x4 virtual false final false
