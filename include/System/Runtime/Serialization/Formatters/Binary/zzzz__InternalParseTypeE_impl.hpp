...
constexpr int32_t& System::Runtime::Serialization::Formatters::Binary::InternalParseTypeE::__get_value__()  {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& System::Runtime::Serialization::Formatters::Binary::InternalParseTypeE::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::System::Runtime::Serialization::Formatters::Binary::InternalParseTypeE::InternalParseTypeE(int32_t  value__) noexcept : ::bs_hook::EnumTypeWrapper<0x4>() {this->value__ = value__;
}
...
constexpr ::System::Runtime::Serialization::Formatters::Binary::InternalParseTypeE  System::Runtime::Serialization::Formatters::Binary::InternalParseTypeE::SerializedStreamHeader{static_cast<int32_t>(0x1)};
...
constexpr ::System::Runtime::Serialization::Formatters::Binary::InternalParseTypeE  System::Runtime::Serialization::Formatters::Binary::InternalParseTypeE::SerializedStreamHeaderEnd{static_cast<int32_t>(0x8)};
