...
/// @brief Method FlagTest addr 0x24c1154 size 0xc virtual false final false
...
/// @brief Method WriteStringWithCode addr 0x24c1160 size 0x74 virtual false final false
static inline void WriteStringWithCode(::StringW  value, ::System::Runtime::Serialization::Formatters::Binary::__BinaryWriter*  sout) ;

/// @brief Method WriteWithCode addr 0x24c11d4 size 0x12c virtual false final false
