...
/// @brief Method .ctor addr 0x24cb294 size 0x74 virtual false final false
inline void _ctor(::StringW  stackId) ;

/// @brief Method Push addr 0x24cd1a8 size 0xac virtual false final false
inline void Push(::System::Object*  obj) ;

/// @brief Method Pop addr 0x24cd254 size 0x50 virtual false final false
inline ::System::Object* Pop() ;

/// @brief Method IncreaseCapacity addr 0x24d59dc size 0x88 virtual false final false
inline void IncreaseCapacity() ;

/// @brief Method Peek addr 0x24cd930 size 0x40 virtual false final false
inline ::System::Object* Peek() ;

/// @brief Method PeekPeek addr 0x24d493c size 0x44 virtual false final false
inline ::System::Object* PeekPeek() ;

/// @brief Method IsEmpty addr 0x24d1e38 size 0x10 virtual false final false
inline bool IsEmpty() ;
