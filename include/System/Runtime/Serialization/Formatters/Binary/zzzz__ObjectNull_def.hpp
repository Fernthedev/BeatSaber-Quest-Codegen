...
/// @brief Field nullCount offset 0x10
...
/// @brief Method .ctor addr 0x24c33fc size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method SetNullCount addr 0x24c3404 size 0x8 virtual false final false
inline void SetNullCount(int32_t  nullCount) ;

/// @brief Method Write addr 0x24c340c size 0xac virtual true final true
inline void Write(::System::Runtime::Serialization::Formatters::Binary::__BinaryWriter*  sout) ;

/// @brief Method Read addr 0x24c34b8 size 0x60 virtual false final false
...
/// @brief Method Dump addr 0x24c3518 size 0x4 virtual false final false
inline void Dump() ;
