...
/// @brief Field m_nextSelector offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Serialization::SurrogateHashtable*> __get_m_surrogates() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Serialization::ISurrogateSelector*> __get_m_nextSelector() const;
