...
::cordl_internals::setInstanceField<::System::Runtime::Serialization::ObjectHolderList*, 0x18>(this, std::forward<::System::Runtime::Serialization::ObjectHolderList*>(value));
}
...
return ::cordl_internals::getInstanceField<::System::Runtime::Serialization::ObjectHolderList*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Serialization::ObjectHolderList*> System::Runtime::Serialization::ObjectHolderListEnumerator::__get_m_list() const {
return ::cordl_internals::getInstanceField<::System::Runtime::Serialization::ObjectHolderList*, 0x18>(this);
}
