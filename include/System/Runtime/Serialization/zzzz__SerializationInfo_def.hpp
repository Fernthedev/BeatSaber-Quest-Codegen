...
/// @brief Field isAssemblyNameSetExplicit offset 0x59
...
/// @brief Field requireSameTokenInPartialTrust offset 0x5a
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,int32_t>*> __get_m_nameToIndex() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Serialization::IFormatterConverter*> __get_m_converter() const;
