...
/// @brief Field innerSurrogate offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Serialization::ISerializationSurrogate*> __get_innerSurrogate() const;
...
// Ctor Parameters []
// @brief default ctor
 SurrogateForCyclicalReference()  = default;
public:
