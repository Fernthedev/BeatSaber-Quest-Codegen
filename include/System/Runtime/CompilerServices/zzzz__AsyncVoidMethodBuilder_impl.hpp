...
::cordl_internals::setInstanceField<::System::Threading::SynchronizationContext*, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::System::Threading::SynchronizationContext*>(value));
}
constexpr ::System::Threading::SynchronizationContext* System::Runtime::CompilerServices::AsyncVoidMethodBuilder::__get_m_synchronizationContext()  {
return ::cordl_internals::getInstanceField<::System::Threading::SynchronizationContext*, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::cordl_internals::to_const_pointer<::System::Threading::SynchronizationContext*> System::Runtime::CompilerServices::AsyncVoidMethodBuilder::__get_m_synchronizationContext() const {
return ::cordl_internals::getInstanceField<::System::Threading::SynchronizationContext*, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
::cordl_internals::setInstanceField<::System::Runtime::CompilerServices::AsyncMethodBuilderCore, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::System::Runtime::CompilerServices::AsyncMethodBuilderCore>(value));
}
constexpr ::System::Runtime::CompilerServices::AsyncMethodBuilderCore& System::Runtime::CompilerServices::AsyncVoidMethodBuilder::__get_m_coreState()  {
return ::cordl_internals::getInstanceField<::System::Runtime::CompilerServices::AsyncMethodBuilderCore, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::System::Runtime::CompilerServices::AsyncMethodBuilderCore const& System::Runtime::CompilerServices::AsyncVoidMethodBuilder::__get_m_coreState() const {
return ::cordl_internals::getInstanceField<::System::Runtime::CompilerServices::AsyncMethodBuilderCore, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void System::Runtime::CompilerServices::AsyncVoidMethodBuilder::__set_m_task(::System::Threading::Tasks::Task*  value)  {
::cordl_internals::setInstanceField<::System::Threading::Tasks::Task*, 0x18>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::System::Threading::Tasks::Task*>(value));
}
constexpr ::System::Threading::Tasks::Task* System::Runtime::CompilerServices::AsyncVoidMethodBuilder::__get_m_task()  {
return ::cordl_internals::getInstanceField<::System::Threading::Tasks::Task*, 0x18>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::Task*> System::Runtime::CompilerServices::AsyncVoidMethodBuilder::__get_m_task() const {
return ::cordl_internals::getInstanceField<::System::Threading::Tasks::Task*, 0x18>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder::AsyncVoidMethodBuilder(::System::Threading::SynchronizationContext*  m_synchronizationContext, ::System::Runtime::CompilerServices::AsyncMethodBuilderCore  m_coreState, ::System::Threading::Tasks::Task*  m_task) noexcept : ::bs_hook::ValueTypeWrapper<0x20>() {this->m_synchronizationContext = m_synchronizationContext;
