...
template<>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3391))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3391), inst: 98 })
// CS Name: ::System.Runtime.CompilerServices::ValueTaskAwaiter`1<TResult>
struct CORDL_TYPE ValueTaskAwaiter_1<int32_t> : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
constexpr explicit ValueTaskAwaiter_1(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 ValueTaskAwaiter_1()  = default;
...
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3391))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3391), inst: 2 })
// CS Name: ::System.Runtime.CompilerServices::ValueTaskAwaiter`1<TResult>
struct CORDL_TYPE ValueTaskAwaiter_1<TResult> : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit ValueTaskAwaiter_1(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}
