...
/// @brief Method Add addr 0x0 size 0xffffffffffffffff virtual false final false
template<typename T>
static inline ByRef<T> Add(ByRef<T>  source, ::cordl_internals::intptr_t  elementOffset) ;
...
template<typename T>
static inline ByRef<T> AddByteOffset(ByRef<T>  source, ::cordl_internals::intptr_t  byteOffset) ;
