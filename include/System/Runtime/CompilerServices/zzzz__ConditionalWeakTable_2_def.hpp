...
namespace System::Runtime::CompilerServices {
template<::il2cpp_utils::il2cpp_reference_type TKey,::il2cpp_utils::il2cpp_reference_type TValue>
class __ConditionalWeakTable_2__CreateValueCallback<TKey,TValue>;
}
namespace System::Runtime::CompilerServices {
template<::il2cpp_utils::il2cpp_reference_type TKey,::il2cpp_utils::il2cpp_reference_type TValue>
class __ConditionalWeakTable_2__Enumerator<TKey,TValue>;
}
// Write type traits
...
template<::il2cpp_utils::il2cpp_reference_type TKey,::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3420)), TypeDefinitionIndex(TypeDefinitionIndex(2611))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3420), inst: 81 })
// CS Name: ::ConditionalWeakTable`2::CreateValueCallback<TKey,TValue>*
class CORDL_TYPE __ConditionalWeakTable_2__CreateValueCallback<TKey,TValue> : public ::System::MulticastDelegate {
public:
// Declarations
...
static inline ::System::Runtime::CompilerServices::__ConditionalWeakTable_2__CreateValueCallback<TKey,TValue>* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __ConditionalWeakTable_2__CreateValueCallback()  = default;
public:
...
template<::il2cpp_utils::il2cpp_reference_type TKey,::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(3421))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3421), inst: 81 })
// CS Name: ::ConditionalWeakTable`2::Enumerator<TKey,TValue>*
class CORDL_TYPE __ConditionalWeakTable_2__Enumerator<TKey,TValue> : public ::System::Object {
public:
// Declarations
/// @brief The size of the true reference type
...
/// @brief Field _table offset 0x10
...
/// @brief Field _currentIndex offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::CompilerServices::ConditionalWeakTable_2<TKey,TValue>*> __get__table() const;
...
// Ctor Parameters []
// @brief default ctor
 __ConditionalWeakTable_2__Enumerator()  = default;
public:
...
template<::il2cpp_utils::il2cpp_reference_type TKey,::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(3422))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3422), inst: 81 })
// CS Name: ::System.Runtime.CompilerServices::ConditionalWeakTable`2<TKey,TValue>*
class CORDL_TYPE ConditionalWeakTable_2<TKey,TValue> : public ::System::Object {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
 ConditionalWeakTable_2()  = default;
public:
