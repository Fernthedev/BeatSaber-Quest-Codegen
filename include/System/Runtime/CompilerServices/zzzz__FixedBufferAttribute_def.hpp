...
/// @brief Field <ElementType>k__BackingField offset 0x10
...
/// @brief Field <Length>k__BackingField offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get__ElementType_k__BackingField() const;
...
/// @brief Method .ctor addr 0x24db044 size 0x30 virtual false final false
inline void _ctor(::System::Type*  elementType, int32_t  length) ;

/// @brief Method get_ElementType addr 0x24db074 size 0x8 virtual false final false
inline ::System::Type* get_ElementType() ;

/// @brief Method get_Length addr 0x24db07c size 0x8 virtual false final false
