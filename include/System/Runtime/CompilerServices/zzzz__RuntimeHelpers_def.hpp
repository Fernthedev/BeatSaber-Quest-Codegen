...
/// @brief Method InitializeArray addr 0x24decf0 size 0x4 virtual false final false
static inline void InitializeArray(::System::Array*  array, ::cordl_internals::intptr_t  fldHandle) ;

/// @brief Method InitializeArray addr 0x24decf4 size 0xa8 virtual false final false
static inline void InitializeArray(::System::Array*  array, ::System::RuntimeFieldHandle  fldHandle) ;

/// @brief Method get_OffsetToStringData addr 0x24ded9c size 0x4 virtual false final false
static inline int32_t get_OffsetToStringData() ;

/// @brief Method GetHashCode addr 0x24deda0 size 0x8 virtual false final false
static inline int32_t GetHashCode(::System::Object*  o) ;

/// @brief Method RunClassConstructor addr 0x24deda8 size 0x4 virtual false final false
static inline void RunClassConstructor(::cordl_internals::intptr_t  type) ;

/// @brief Method RunClassConstructor addr 0x24dedac size 0xc0 virtual false final false
static inline void RunClassConstructor(::System::RuntimeTypeHandle  type) ;

/// @brief Method SufficientExecutionStack addr 0x24dee6c size 0x4 virtual false final false
static inline bool SufficientExecutionStack() ;

/// @brief Method TryEnsureSufficientExecutionStack addr 0x24dee70 size 0x4 virtual false final false
static inline bool TryEnsureSufficientExecutionStack() ;

/// @brief Method PrepareConstrainedRegions addr 0x24dee74 size 0x4 virtual false final false
