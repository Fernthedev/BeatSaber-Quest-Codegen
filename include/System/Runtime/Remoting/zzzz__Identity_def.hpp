...
/// @brief Field _serverDynamicProperties offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::IMessageSink*> __get__channelSink() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::IMessageSink*> __get__envoySink() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Contexts::DynamicPropertyCollection*> __get__clientDynamicProperties() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Contexts::DynamicPropertyCollection*> __get__serverDynamicProperties() const;

constexpr void __set__objRef(::System::Runtime::Remoting::ObjRef*  value) ;

constexpr ::System::Runtime::Remoting::ObjRef* __get__objRef() ;

constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::ObjRef*> __get__objRef() const;
