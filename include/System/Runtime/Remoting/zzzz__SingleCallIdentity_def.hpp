...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x70 - sizeof(::System::Runtime::Remoting::ServerIdentity)]{};
...
/// @brief Method .ctor addr 0x2493f5c size 0x30 virtual false final false
inline void _ctor(::StringW  objectUri, ::System::Runtime::Remoting::Contexts::Context*  context, ::System::Type*  objectType) ;

/// @brief Method SyncObjectProcessMessage addr 0x2493f8c size 0x210 virtual true final false
...
/// @brief Method AsyncObjectProcessMessage addr 0x249419c size 0x1c0 virtual true final false
