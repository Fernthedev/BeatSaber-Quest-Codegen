...
constexpr void System::Runtime::Remoting::Channels::__CrossAppDomainSink__ProcessMessageRes::__set_arrResponse(::ArrayW<uint8_t,::Array<uint8_t>*>  value)  {
...
constexpr ::ArrayW<uint8_t,::Array<uint8_t>*>& System::Runtime::Remoting::Channels::__CrossAppDomainSink__ProcessMessageRes::__get_arrResponse()  {
...
constexpr ::ArrayW<uint8_t,::Array<uint8_t>*> const& System::Runtime::Remoting::Channels::__CrossAppDomainSink__ProcessMessageRes::__get_arrResponse() const {
return ::cordl_internals::getInstanceField<::ArrayW<uint8_t,::Array<uint8_t>*>, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void System::Runtime::Remoting::Channels::__CrossAppDomainSink__ProcessMessageRes::__set_cadMrm(::System::Runtime::Remoting::Messaging::CADMethodReturnMessage*  value)  {
::cordl_internals::setInstanceField<::System::Runtime::Remoting::Messaging::CADMethodReturnMessage*, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::System::Runtime::Remoting::Messaging::CADMethodReturnMessage*>(value));
}
constexpr ::System::Runtime::Remoting::Messaging::CADMethodReturnMessage* System::Runtime::Remoting::Channels::__CrossAppDomainSink__ProcessMessageRes::__get_cadMrm()  {
return ::cordl_internals::getInstanceField<::System::Runtime::Remoting::Messaging::CADMethodReturnMessage*, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::CADMethodReturnMessage*> System::Runtime::Remoting::Channels::__CrossAppDomainSink__ProcessMessageRes::__get_cadMrm() const {
return ::cordl_internals::getInstanceField<::System::Runtime::Remoting::Messaging::CADMethodReturnMessage*, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "arrResponse", ty: "::ArrayW<uint8_t,::Array<uint8_t>*>", modifiers: "", def_value: Some("csnull") }, CppParam { name: "cadMrm", ty: "::System::Runtime::Remoting::Messaging::CADMethodReturnMessage*", modifiers: "", def_value: Some("csnull") }]
constexpr ::System::Runtime::Remoting::Channels::__CrossAppDomainSink__ProcessMessageRes::__CrossAppDomainSink__ProcessMessageRes(::ArrayW<uint8_t,::Array<uint8_t>*>  arrResponse, ::System::Runtime::Remoting::Messaging::CADMethodReturnMessage*  cadMrm) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->arrResponse = arrResponse;
this->cadMrm = cadMrm;
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Runtime::Remoting::Channels::__CrossAppDomainSink__ProcessMessageRes (*)(::ArrayW<uint8_t,::Array<uint8_t>*>, ::System::Runtime::Remoting::Messaging::CADMethodCallMessage*)>(&::System::Runtime::Remoting::Channels::CrossAppDomainSink::ProcessMessageInDomain)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<uint8_t,::Array<uint8_t>*>>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Runtime::Remoting::Messaging::CADMethodCallMessage*>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Runtime::Remoting::Channels::CrossAppDomainSink::*)(::System::Object*)>(&::System::Runtime::Remoting::Channels::CrossAppDomainSink::SendAsyncMessage)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Runtime::Remoting::Channels::CrossAppDomainSink::*)(::System::Object*)>(&::System::Runtime::Remoting::Channels::CrossAppDomainSink::_AsyncProcessMessage_b__10_0)> {
