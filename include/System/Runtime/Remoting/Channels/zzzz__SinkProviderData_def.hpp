...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> __get_properties() const;

static inline ::System::Runtime::Remoting::Channels::SinkProviderData* New_ctor(::StringW  name) ;

/// @brief Method .ctor addr 0x24a41d4 size 0xac virtual false final false
inline void _ctor(::StringW  name) ;

/// @brief Method get_Children addr 0x24a4280 size 0x8 virtual false final false
inline ::System::Collections::IList* get_Children() ;

/// @brief Method get_Properties addr 0x24a4288 size 0x8 virtual false final false
