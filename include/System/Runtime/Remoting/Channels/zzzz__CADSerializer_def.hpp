...
/// @brief Method DeserializeMessage addr 0x24a39b0 size 0x40 virtual false final false
...
/// @brief Method SerializeMessage addr 0x24a33fc size 0xf0 virtual false final false
static inline ::System::IO::MemoryStream* SerializeMessage(::System::Runtime::Remoting::Messaging::IMessage*  msg) ;

/// @brief Method DeserializeObjectSafe addr 0x24a3fbc size 0xa0 virtual false final false
static inline ::System::Object* DeserializeObjectSafe(::ArrayW<uint8_t,::Array<uint8_t>*>  mem) ;

/// @brief Method SerializeObject addr 0x24a40e4 size 0xf0 virtual false final false
static inline ::System::IO::MemoryStream* SerializeObject(::System::Object*  obj) ;

/// @brief Method DeserializeObject addr 0x24a405c size 0x88 virtual false final false
