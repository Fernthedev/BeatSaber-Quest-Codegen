...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Serialization::ISurrogateSelector*> __get__next() const;
...
// Ctor Parameters []
// @brief default ctor
 RemotingSurrogateSelector()  = default;
public:


// Fields

// Static field s_cachedTypeObjRef

// Static field _objRefSurrogate

// Static field _objRemotingSurrogate
