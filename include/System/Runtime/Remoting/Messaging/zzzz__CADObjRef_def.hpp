...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::ObjRef*> __get_objref() const;
...
/// @brief Method .ctor addr 0x24a7be0 size 0x48 virtual false final false
