...
/// @brief Method .ctor addr 0x24a616c size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method SetCurrentCallContext addr 0x24a6174 size 0x8 virtual false final false
static inline ::System::Object* SetCurrentCallContext(::System::Runtime::Remoting::Messaging::LogicalCallContext*  ctx) ;

/// @brief Method SetLogicalCallContext addr 0x24a617c size 0x44 virtual false final false
...
/// @brief Method LogicalGetData addr 0x24a61c0 size 0x50 virtual false final false
static inline ::System::Object* LogicalGetData(::StringW  name) ;

/// @brief Method LogicalSetData addr 0x24a6220 size 0x68 virtual false final false
