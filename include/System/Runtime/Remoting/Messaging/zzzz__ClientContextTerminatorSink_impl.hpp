...
::cordl_internals::setInstanceField<::System::Runtime::Remoting::Contexts::Context*, 0x10>(this, std::forward<::System::Runtime::Remoting::Contexts::Context*>(value));
}
...
return ::cordl_internals::getInstanceField<::System::Runtime::Remoting::Contexts::Context*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Contexts::Context*> System::Runtime::Remoting::Messaging::ClientContextTerminatorSink::__get__context() const {
return ::cordl_internals::getInstanceField<::System::Runtime::Remoting::Contexts::Context*, 0x10>(this);
}
