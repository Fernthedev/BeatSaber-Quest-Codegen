...
/// @brief Field async_state offset 0x10
...
/// @brief Field async_delegate offset 0x20
...
/// @brief Field message_ctrl offset 0x68
...
/// @brief Field reply_message offset 0x70
...
/// @brief Field orig_cb offset 0x78
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get_async_state() const;

constexpr void __set_handle(::System::Threading::WaitHandle*  value) ;

constexpr ::System::Threading::WaitHandle* __get_handle() ;

constexpr ::cordl_internals::to_const_pointer<::System::Threading::WaitHandle*> __get_handle() const;

constexpr void __set_async_delegate(::System::Object*  value) ;

constexpr ::System::Object* __get_async_delegate() ;

constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get_async_delegate() const;

constexpr void __set_data(::cordl_internals::intptr_t  value) ;

constexpr ::cordl_internals::intptr_t& __get_data() ;

constexpr ::cordl_internals::intptr_t const& __get_data() const;

constexpr void __set_object_data(::System::Object*  value) ;

constexpr ::System::Object* __get_object_data() ;

constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get_object_data() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get_async_callback() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::ExecutionContext*> __get_current() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::ExecutionContext*> __get_original() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::MonoMethodMessage*> __get_call_message() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::IMessageCtrl*> __get_message_ctrl() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::IMessage*> __get_reply_message() const;

constexpr void __set_orig_cb(::System::Threading::WaitCallback*  value) ;

constexpr ::System::Threading::WaitCallback* __get_orig_cb() ;

constexpr ::cordl_internals::to_const_pointer<::System::Threading::WaitCallback*> __get_orig_cb() const;

static inline ::System::Runtime::Remoting::Messaging::AsyncResult* New_ctor() ;

/// @brief Method .ctor addr 0x24a7848 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method get_AsyncState addr 0x24a7850 size 0x8 virtual true final false
inline ::System::Object* get_AsyncState() ;

/// @brief Method get_AsyncWaitHandle addr 0x24a7858 size 0x124 virtual true final false
inline ::System::Threading::WaitHandle* get_AsyncWaitHandle() ;

/// @brief Method get_CompletedSynchronously addr 0x24a797c size 0x8 virtual true final false
inline bool get_CompletedSynchronously() ;

/// @brief Method get_IsCompleted addr 0x24a7984 size 0x8 virtual true final false
inline bool get_IsCompleted() ;

/// @brief Method get_EndInvokeCalled addr 0x24a798c size 0x8 virtual false final false
inline bool get_EndInvokeCalled() ;

/// @brief Method set_EndInvokeCalled addr 0x24a7994 size 0xc virtual false final false
inline void set_EndInvokeCalled(bool  value) ;

/// @brief Method get_AsyncDelegate addr 0x24a79a0 size 0x8 virtual true final false
inline ::System::Object* get_AsyncDelegate() ;

/// @brief Method get_NextSink addr 0x24a79a8 size 0x8 virtual true final true
inline ::System::Runtime::Remoting::Messaging::IMessageSink* get_NextSink() ;

/// @brief Method AsyncProcessMessage addr 0x24a79b0 size 0x40 virtual true final false
...
/// @brief Method GetReplyMessage addr 0x24a79f0 size 0x8 virtual true final false
inline ::System::Runtime::Remoting::Messaging::IMessage* GetReplyMessage() ;

/// @brief Method SetMessageCtrl addr 0x24a79f8 size 0x8 virtual true final false
inline void SetMessageCtrl(::System::Runtime::Remoting::Messaging::IMessageCtrl*  mc) ;

/// @brief Method SetCompletedSynchronously addr 0x24a7a00 size 0xc virtual false final false
inline void SetCompletedSynchronously(bool  completed) ;

/// @brief Method EndInvoke addr 0x2497a4c size 0x110 virtual false final false
inline ::System::Runtime::Remoting::Messaging::IMessage* EndInvoke() ;

/// @brief Method SyncProcessMessage addr 0x24a7a0c size 0x190 virtual true final false
inline ::System::Runtime::Remoting::Messaging::IMessage* SyncProcessMessage(::System::Runtime::Remoting::Messaging::IMessage*  msg) ;

/// @brief Method get_CallMessage addr 0x24a7b9c size 0x8 virtual false final false
inline ::System::Runtime::Remoting::Messaging::MonoMethodMessage* get_CallMessage() ;

/// @brief Method set_CallMessage addr 0x24a7ba4 size 0x8 virtual false final false
inline void set_CallMessage(::System::Runtime::Remoting::Messaging::MonoMethodMessage*  value) ;

/// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem addr 0x24a7bac size 0x4 virtual true final true
inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem() ;

/// @brief Method System.Threading.IThreadPoolWorkItem.MarkAborted addr 0x24a7bb4 size 0x4 virtual true final true
inline void System_Threading_IThreadPoolWorkItem_MarkAborted(::System::Threading::ThreadAbortException*  tae) ;

/// @brief Method Invoke addr 0x24a7bb0 size 0x4 virtual false final false
