...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x50 - sizeof(::System::Runtime::Remoting::Messaging::CADMessageBase)]{};

/// @brief Field _returnValue offset 0x38
 __declspec(property(get=__get__returnValue, put=__set__returnValue)) ::System::Object*  _returnValue;

/// @brief Field _exception offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::CADArgHolder*> __get__exception() const;
...
// Ctor Parameters []
// @brief default ctor
 CADMethodReturnMessage()  = default;
public:
