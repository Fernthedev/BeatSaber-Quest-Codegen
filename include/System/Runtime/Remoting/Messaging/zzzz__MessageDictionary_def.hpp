...
/// @brief Field _methodDictionary offset 0x10
...
/// @brief Field _hashtableEnum offset 0x18
...
/// @brief Field _posMethod offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::MessageDictionary*> __get__methodDictionary() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IDictionaryEnumerator*> __get__hashtableEnum() const;
...
// Ctor Parameters []
// @brief default ctor
 __MessageDictionary__DictionaryEnumerator()  = default;
public:
...
/// @brief Field _internalProperties offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IDictionary*> __get__internalProperties() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::IMethodMessage*> __get__message() const;
