...
/// @brief Field serializedMethod offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::CADArgHolder*> __get__callContext() const;
