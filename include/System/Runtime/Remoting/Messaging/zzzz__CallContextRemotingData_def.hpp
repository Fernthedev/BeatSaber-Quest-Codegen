...
/// @brief Field _logicalCallID offset 0x10
...
/// @brief Method get_LogicalCallID addr 0x24a757c size 0x8 virtual false final false
inline ::StringW get_LogicalCallID() ;

/// @brief Method set_LogicalCallID addr 0x24a7584 size 0x8 virtual false final false
inline void set_LogicalCallID(::StringW  value) ;

/// @brief Method get_HasInfo addr 0x24a7408 size 0x10 virtual false final false
inline bool get_HasInfo() ;

/// @brief Method Clone addr 0x24a7338 size 0x68 virtual true final true
inline ::System::Object* Clone() ;

static inline ::System::Runtime::Remoting::Messaging::CallContextRemotingData* New_ctor() ;

/// @brief Method .ctor addr 0x24a758c size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 CallContextRemotingData()  = default;
public:
