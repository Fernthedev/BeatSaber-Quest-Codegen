...
/// @brief Field _principal offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Principal::IPrincipal*> __get__principal() const;

/// @brief Method get_HasInfo addr 0x24a7418 size 0x10 virtual false final false
inline bool get_HasInfo() ;

/// @brief Method Clone addr 0x24a73a0 size 0x68 virtual true final true
inline ::System::Object* Clone() ;

static inline ::System::Runtime::Remoting::Messaging::CallContextSecurityData* New_ctor() ;

/// @brief Method .ctor addr 0x24a7574 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 CallContextSecurityData()  = default;
public:
