...
/// @brief Field channel_info offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::IChannelInfo*> __get_channel_info() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::IRemotingTypeInfo*> __get_typeInfo() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::IEnvoyInfo*> __get_envoyInfo() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get__serverType() const;
...
// Static field MarshalledObjectRef

// Static field WellKnowObjectRef
