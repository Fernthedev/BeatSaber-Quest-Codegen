...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> __get_Attributes() const;

constexpr void __set_Elements(::System::Collections::Hashtable*  value) ;

constexpr ::System::Collections::Hashtable* __get_Elements() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> __get_Elements() const;
...
// Ctor Parameters []
// @brief default ctor
 __SoapServices__TypeInfo()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 SoapServices()  = default;
public:


// Fields

// Static field _xmlTypes

// Static field _xmlElements

// Static field _soapActions

// Static field _soapActionsMethods

// Static field _typeInfos
