...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::IMessageSink*> __get__next() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::IMessage*> __get__call() const;
...
// Ctor Parameters []
// @brief default ctor
 __CrossContextChannel__ContextRestoreSink()  = default;
public:
