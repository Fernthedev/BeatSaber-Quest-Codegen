...
/// @brief Field data offset 0x20
 __declspec(property(get=__get_data, put=__set_data)) ::cordl_internals::uintptr_t  data;

/// @brief Field server_context_sink_chain offset 0x28
...
/// @brief Field client_context_sink_chain offset 0x30
...
/// @brief Field context_properties offset 0x38
 __declspec(property(get=__get_context_properties, put=__set_context_properties)) ::System::Collections::Generic::List_1<::System::Runtime::Remoting::Contexts::IContextProperty*>*  context_properties;

/// @brief Field _localDataStore offset 0x40
 __declspec(property(get=__get__localDataStore, put=__set__localDataStore)) ::System::LocalDataStoreHolder*  _localDataStore;

/// @brief Field context_dynamic_properties offset 0x48
...
/// @brief Field callback_object offset 0x50
...
constexpr ::cordl_internals::uintptr_t& __get_data() ;

constexpr ::cordl_internals::uintptr_t const& __get_data() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::IMessageSink*> __get_server_context_sink_chain() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::IMessageSink*> __get_client_context_sink_chain() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Runtime::Remoting::Contexts::IContextProperty*>*> __get_context_properties() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::LocalDataStoreHolder*> __get__localDataStore() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Contexts::DynamicPropertyCollection*> __get_context_dynamic_properties() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Contexts::ContextCallbackObject*> __get_callback_object() const;
...
// Static field local_slots

// Static field default_server_context_sink

// Static field global_count

// Static field _localDataStoreMgr

// Static field global_dynamic_properties
