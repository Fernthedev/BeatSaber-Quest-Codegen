...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Contexts::IDynamicProperty*> __get_Property() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Contexts::IDynamicMessageSink*> __get_Sink() const;
...
// Ctor Parameters []
// @brief default ctor
 __DynamicPropertyCollection__DynamicPropertyReg()  = default;
public:
...
/// @brief Field _properties offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get__properties() const;
...
// Ctor Parameters []
// @brief default ctor
 DynamicPropertyCollection()  = default;
public:
