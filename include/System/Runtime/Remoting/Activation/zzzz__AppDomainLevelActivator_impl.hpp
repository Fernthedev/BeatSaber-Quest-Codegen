...
::cordl_internals::setInstanceField<::System::Runtime::Remoting::Activation::IActivator*, 0x18>(this, std::forward<::System::Runtime::Remoting::Activation::IActivator*>(value));
}
...
return ::cordl_internals::getInstanceField<::System::Runtime::Remoting::Activation::IActivator*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Activation::IActivator*> System::Runtime::Remoting::Activation::AppDomainLevelActivator::__get__next() const {
return ::cordl_internals::getInstanceField<::System::Runtime::Remoting::Activation::IActivator*, 0x18>(this);
}
