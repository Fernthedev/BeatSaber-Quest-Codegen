...
/// @brief Method get_ConstructionActivator addr 0x24a4290 size 0x94 virtual false final false
static inline ::System::Runtime::Remoting::Activation::IActivator* get_ConstructionActivator() ;

/// @brief Method Activate addr 0x249a528 size 0x228 virtual false final false
...
/// @brief Method RemoteActivate addr 0x24a432c size 0x1d0 virtual false final false
...
/// @brief Method CreateConstructionCall addr 0x2498c78 size 0x9bc virtual false final false
...
/// @brief Method CreateInstanceFromMessage addr 0x24a4550 size 0x400 virtual false final false
...
/// @brief Method CreateProxyForType addr 0x24a4954 size 0x140 virtual false final false
static inline ::System::Object* CreateProxyForType(::System::Type*  type) ;

/// @brief Method AllocateUninitializedClassInstance addr 0x24a4950 size 0x4 virtual false final false
static inline ::System::Object* AllocateUninitializedClassInstance(::System::Type*  type) ;

/// @brief Method EnableProxyActivation addr 0x24a4a94 size 0x8 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 ActivationServices()  = default;
public:


// Fields

// Static field _constructionActivator
