...
/// @brief Field m_NextActivator offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Activation::IActivator*> __get_m_NextActivator() const;
