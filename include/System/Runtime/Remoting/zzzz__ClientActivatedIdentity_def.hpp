...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x78 - sizeof(::System::Runtime::Remoting::ServerIdentity)]{};

/// @brief Field _targetThis offset 0x70
...
constexpr ::cordl_internals::to_const_pointer<::System::MarshalByRefObject*> __get__targetThis() const;
...
// Ctor Parameters []
// @brief default ctor
 ClientActivatedIdentity()  = default;
public:
