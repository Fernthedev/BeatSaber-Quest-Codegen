...
/// @brief Field _custom_type_info offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Proxies::RealProxy*> __get__rp() const;
...
inline ::System::Object* LoadRemoteFieldNew(::cordl_internals::intptr_t  classPtr, ::cordl_internals::intptr_t  fieldPtr) ;

/// @brief Method StoreRemoteField addr 0x249738c size 0x2d8 virtual false final false
inline void StoreRemoteField(::cordl_internals::intptr_t  classPtr, ::cordl_internals::intptr_t  fieldPtr, ::System::Object*  arg) ;
