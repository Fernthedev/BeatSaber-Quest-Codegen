...
/// @brief Field m_instantiation offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get_m_declaringType() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Reflection::MethodBase*> __get_m_declaringMethod() const;
...
// Ctor Parameters []
// @brief default ctor
 UnitySerializationHolder()  = default;
public:
