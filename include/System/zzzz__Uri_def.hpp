...
// CS Name: ::Uri::Flags
struct CORDL_TYPE __Uri__Flags : public ::bs_hook::EnumTypeWrapper<0x8> {
public:
// Declarations
...
return std::bit_cast<____Uri__Flags_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x8>::instance);
}
...
constexpr explicit __Uri__Flags(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Uri__Flags()  = default;
...
constexpr ::cordl_internals::to_const_pointer<::System::__Uri__MoreInfo*> __get_MoreInfo() const;
...
// CS Name: ::Uri::Offset
struct CORDL_TYPE __Uri__Offset : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field Scheme offset 0x0
 __declspec(property(get=__get_Scheme, put=__set_Scheme)) uint16_t  Scheme;

/// @brief Field User offset 0x2
 __declspec(property(get=__get_User, put=__set_User)) uint16_t  User;

/// @brief Field Host offset 0x4
 __declspec(property(get=__get_Host, put=__set_Host)) uint16_t  Host;

/// @brief Field PortValue offset 0x6
 __declspec(property(get=__get_PortValue, put=__set_PortValue)) uint16_t  PortValue;

/// @brief Field Path offset 0x8
 __declspec(property(get=__get_Path, put=__set_Path)) uint16_t  Path;

/// @brief Field Query offset 0xa
 __declspec(property(get=__get_Query, put=__set_Query)) uint16_t  Query;

/// @brief Field Fragment offset 0xc
 __declspec(property(get=__get_Fragment, put=__set_Fragment)) uint16_t  Fragment;

/// @brief Field End offset 0xe
 __declspec(property(get=__get_End, put=__set_End)) uint16_t  End;

constexpr void __set_Scheme(uint16_t  value) ;

constexpr uint16_t& __get_Scheme() ;

constexpr uint16_t const& __get_Scheme() const;

constexpr void __set_User(uint16_t  value) ;

constexpr uint16_t& __get_User() ;

constexpr uint16_t const& __get_User() const;

constexpr void __set_Host(uint16_t  value) ;

constexpr uint16_t& __get_Host() ;

constexpr uint16_t const& __get_Host() const;

constexpr void __set_PortValue(uint16_t  value) ;

constexpr uint16_t& __get_PortValue() ;

constexpr uint16_t const& __get_PortValue() const;

constexpr void __set_Path(uint16_t  value) ;

constexpr uint16_t& __get_Path() ;

constexpr uint16_t const& __get_Path() const;

constexpr void __set_Query(uint16_t  value) ;

constexpr uint16_t& __get_Query() ;

constexpr uint16_t const& __get_Query() const;

constexpr void __set_Fragment(uint16_t  value) ;

constexpr uint16_t& __get_Fragment() ;

constexpr uint16_t const& __get_Fragment() const;

constexpr void __set_End(uint16_t  value) ;

constexpr uint16_t& __get_End() ;

constexpr uint16_t const& __get_End() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Uri__Offset(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Uri__Offset()  = default;
...
// CS Name: ::Uri::Check
struct CORDL_TYPE __Uri__Check : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____Uri__Check_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Uri__Check(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Uri__Check()  = default;
...
namespace System {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(8879)), TypeDefinitionIndex(TypeDefinitionIndex(8877))}
...
/// @brief Field m_iriParsing offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::System::UriParser*> __get_m_Syntax() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::__Uri__UriInfo*> __get_m_Info() const;
...
// Static field UriSchemeFile

// Static field UriSchemeFtp

// Static field UriSchemeGopher

// Static field UriSchemeHttp

// Static field UriSchemeHttps

// Static field UriSchemeWs

// Static field UriSchemeWss

// Static field UriSchemeMailto

// Static field UriSchemeNews

// Static field UriSchemeNntp

// Static field UriSchemeNetTcp

// Static field UriSchemeNetPipe

// Static field SchemeDelimiter

// Static field s_ConfigInitialized

// Static field s_ConfigInitializing

// Static field s_IdnScope

// Static field s_IriParsing

// Static field useDotNetRelativeOrAbsolute

// Static field IsWindowsFileSystem

// Static field s_initLock

// Static field HexLowerChars

// Static field _WSchars
