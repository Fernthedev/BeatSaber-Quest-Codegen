...
struct CORDL_TYPE __BigInteger__GetBytesMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____BigInteger__GetBytesMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __BigInteger__GetBytesMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __BigInteger__GetBytesMode()  = default;
...
struct CORDL_TYPE BigInteger : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
/// @brief Field _sign offset 0x0
 __declspec(property(get=__get__sign, put=__set__sign)) int32_t  _sign;

/// @brief Field _bits offset 0x8
 __declspec(property(get=__get__bits, put=__set__bits)) ::ArrayW<uint32_t,::Array<uint32_t>*>  _bits;
...
constexpr void __set__bits(::ArrayW<uint32_t,::Array<uint32_t>*>  value) ;

constexpr ::ArrayW<uint32_t,::Array<uint32_t>*>& __get__bits() ;

constexpr ::ArrayW<uint32_t,::Array<uint32_t>*> const& __get__bits() const;
...
/// @brief Method .ctor addr 0x2844534 size 0x7c virtual false final false
inline void _ctor(int32_t  value) ;

/// @brief Method .ctor addr 0x28445b0 size 0x118 virtual false final false
inline void _ctor(int64_t  value) ;

/// @brief Method .ctor addr 0x28446c8 size 0xa0 virtual false final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method .ctor addr 0x2844768 size 0x52c virtual false final false
inline void _ctor(::System::ReadOnlySpan_1<uint8_t>  value, bool  isUnsigned, bool  isBigEndian) ;

/// @brief Method .ctor addr 0x2844d50 size 0xc virtual false final false
inline void _ctor(int32_t  n, ::ArrayW<uint32_t,::Array<uint32_t>*>  rgu) ;

/// @brief Method .ctor addr 0x2844d5c size 0x1a4 virtual false final false
inline void _ctor(::ArrayW<uint32_t,::Array<uint32_t>*>  value, bool  negative) ;

/// @brief Method get_MinusOne addr 0x2844f00 size 0x58 virtual false final false
static inline ::System::Numerics::BigInteger get_MinusOne() ;

/// @brief Method GetHashCode addr 0x2844f58 size 0x4c virtual true final false
inline int32_t GetHashCode() ;

/// @brief Method Equals addr 0x2844fac size 0x78 virtual true final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals addr 0x2845024 size 0xbc virtual true final true
inline bool Equals(::System::Numerics::BigInteger  other) ;

/// @brief Method CompareTo addr 0x2845148 size 0x128 virtual true final true
inline int32_t CompareTo(::System::Numerics::BigInteger  other) ;

/// @brief Method CompareTo addr 0x2845270 size 0xd8 virtual true final true
inline int32_t CompareTo(::System::Object*  obj) ;

/// @brief Method TryWriteBytes addr 0x2845348 size 0x40 virtual false final false
inline bool TryWriteBytes(::System::Span_1<uint8_t>  destination, ByRef<int32_t>  bytesWritten, bool  isUnsigned, bool  isBigEndian) ;

/// @brief Method TryWriteOrCountBytes addr 0x2845874 size 0x34 virtual false final false
...
/// @brief Method TryGetBytes addr 0x2845388 size 0x4ec virtual false final false
...
/// @brief Method ToString addr 0x28458a8 size 0x30 virtual true final false
inline ::StringW ToString() ;

/// @brief Method ToString addr 0x2845984 size 0x38 virtual true final true
inline ::StringW ToString(::StringW  format, ::System::IFormatProvider*  provider) ;

/// @brief Method Add addr 0x28459bc size 0x14c virtual false final false
...
/// @brief Method Subtract addr 0x2845d0c size 0x180 virtual false final false
...
/// @brief Method GetDiffLength addr 0x28450e0 size 0x68 virtual false final false
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit BigInteger(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}
...
// Static field s_bnMinInt

// Static field s_bnOneInt

// Static field s_bnZeroInt

// Static field s_bnMinusOneInt

// Static field s_success
