...
// CS Name: ::System::Char
struct CORDL_TYPE Char : public ::bs_hook::ValueTypeWrapper<0x2> {
public:
// Declarations
...
/// @brief Field UNICODE_PLANE00_END offset 0x0
...
/// @brief Field UNICODE_PLANE16_END offset 0x0
...
/// @brief Field m_value offset 0x0
 __declspec(property(get=__get_m_value, put=__set_m_value)) char16_t  m_value;
...
constexpr char16_t& __get_m_value() ;

constexpr char16_t const& __get_m_value() const;
...
constexpr explicit Char(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x2>(instance) {
}
...
// Static field s_categoryForLatin1
