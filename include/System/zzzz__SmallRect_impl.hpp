...
constexpr ::System::SmallRect::SmallRect(int16_t  Left, int16_t  Top, int16_t  Right, int16_t  Bottom) noexcept : ::bs_hook::ValueTypeWrapper<0x8>() {this->Left = Left;
this->Top = Top;
this->Right = Right;
this->Bottom = Bottom;
}
