...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::System::OrdinalComparer)]{};
...
/// @brief Method .ctor addr 0x25c5398 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method Compare addr 0x25c5d1c size 0x18 virtual true final false
inline int32_t Compare(::StringW  x, ::StringW  y) ;

/// @brief Method Equals addr 0x25c5d34 size 0x18 virtual true final false
inline bool Equals(::StringW  x, ::StringW  y) ;

/// @brief Method GetHashCode addr 0x25c5d4c size 0x64 virtual true final false
inline int32_t GetHashCode(::StringW  obj) ;

/// @brief Method GetObjectData addr 0x25c5db0 size 0xb4 virtual true final true
...
// Ctor Parameters []
// @brief default ctor
 OrdinalIgnoreCaseComparer()  = default;
public:
