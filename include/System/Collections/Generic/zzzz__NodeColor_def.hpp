...
struct CORDL_TYPE NodeColor : public ::bs_hook::EnumTypeWrapper<0x1> {
public:
// Declarations
...
return std::bit_cast<__NodeColor_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x1>::instance);
}
...
constexpr explicit NodeColor(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x1>(instance) {
}
