...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3859)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3859), inst: 2 })
// CS Name: ::System.Collections.Generic::LowLevelList`1<T>*
class CORDL_TYPE LowLevelList_1<T> : public ::System::Object {
public:
// Declarations
