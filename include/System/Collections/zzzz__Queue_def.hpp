...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Queue*> __get__q() const;
...
// Ctor Parameters []
// @brief default ctor
 __Queue__QueueEnumerator()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __Queue__QueueDebugView()  = default;
public:
