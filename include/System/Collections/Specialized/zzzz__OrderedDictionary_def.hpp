...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IEnumerator*> __get__arrayEnumerator() const;
...
// Ctor Parameters []
// @brief default ctor
 __OrderedDictionary__OrderedDictionaryEnumerator()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __OrderedDictionary__OrderedDictionaryKeyValueCollection()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get__objectsArray() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> __get__objectsTable() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IEqualityComparer*> __get__comparer() const;
