...
struct CORDL_TYPE BitVector32 : public ::bs_hook::ValueTypeWrapper<0x4> {
public:
// Declarations
...
/// @brief Field _data offset 0x0
 __declspec(property(get=__get__data, put=__set__data)) uint32_t  _data;

 __declspec(property(get=get_Item, put=set_Item)) bool  Item[];

constexpr void __set__data(uint32_t  value) ;

constexpr uint32_t& __get__data() ;

constexpr uint32_t const& __get__data() const;
...
constexpr explicit BitVector32(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x4>(instance) {
}
