...
/// @brief Field _start offset 0x24
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Specialized::ListDictionary*> __get__list() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Specialized::__ListDictionary__DictionaryNode*> __get__current() const;
...
// Ctor Parameters []
// @brief default ctor
 __ListDictionary__NodeEnumerator()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __ListDictionary__NodeKeyValueCollection__NodeKeyValueEnumerator()  = default;
public:
...
/// @brief Field _isKeys offset 0x18
 __declspec(property(get=__get__isKeys, put=__set__isKeys)) bool  _isKeys;
...
// Ctor Parameters []
// @brief default ctor
 __ListDictionary__NodeKeyValueCollection()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Specialized::__ListDictionary__DictionaryNode*> __get_next() const;
...
// Ctor Parameters []
// @brief default ctor
 __ListDictionary__DictionaryNode()  = default;
public:
...
/// @brief Field comparer offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Specialized::__ListDictionary__DictionaryNode*> __get_head() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IComparer*> __get_comparer() const;
