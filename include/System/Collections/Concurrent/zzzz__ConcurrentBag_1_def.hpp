...
namespace System::Collections::Concurrent {
template<::il2cpp_utils::il2cpp_reference_type T>
class __ConcurrentBag_1__Enumerator<T>;
}
namespace System::Collections::Concurrent {
template<::il2cpp_utils::il2cpp_reference_type T>
class __ConcurrentBag_1__WorkStealingQueue<T>;
}
// Write type traits
...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(9527)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9527), inst: 2 })
// CS Name: ::ConcurrentBag`1::WorkStealingQueue<T>*
class CORDL_TYPE __ConcurrentBag_1__WorkStealingQueue<T> : public ::System::Object {
public:
// Declarations
...
/// @brief Field _ownerThreadId offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Concurrent::__ConcurrentBag_1__WorkStealingQueue<T>*> __get__nextQueue() const;
...
// Ctor Parameters []
// @brief default ctor
 __ConcurrentBag_1__WorkStealingQueue()  = default;
public:
...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(9528))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9528), inst: 2 })
// CS Name: ::ConcurrentBag`1::Enumerator<T>*
class CORDL_TYPE __ConcurrentBag_1__Enumerator<T> : public ::System::Object {
public:
// Declarations
/// @brief The size of the true reference type
...
// Ctor Parameters []
// @brief default ctor
 __ConcurrentBag_1__Enumerator()  = default;
public:
...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(9529))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9529), inst: 2 })
// CS Name: ::System.Collections.Concurrent::ConcurrentBag`1<T>*
class CORDL_TYPE ConcurrentBag_1<T> : public ::System::Object {
public:
// Declarations
...
/// @brief Field _locals offset 0x10
...
/// @brief Field _workStealingQueues offset 0x18
...
/// @brief Field _emptyToNonEmptyListTransitionCount offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::ThreadLocal_1<::System::Collections::Concurrent::__ConcurrentBag_1__WorkStealingQueue<T>*>*> __get__locals() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Concurrent::__ConcurrentBag_1__WorkStealingQueue<T>*> __get__workStealingQueues() const;
