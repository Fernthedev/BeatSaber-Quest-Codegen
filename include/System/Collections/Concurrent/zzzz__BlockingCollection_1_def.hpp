...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(9524))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9524), inst: 2 })
// CS Name: ::System.Collections.Concurrent::BlockingCollection`1<T>*
class CORDL_TYPE BlockingCollection_1<T> : public ::System::Object {
public:
// Declarations
...
/// @brief Field _producersCancellationTokenSource offset 0x40
...
/// @brief Field _currentAdders offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Concurrent::IProducerConsumerCollection_1<T>*> __get__collection() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::SemaphoreSlim*> __get__freeNodes() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::SemaphoreSlim*> __get__occupiedNodes() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::CancellationTokenSource*> __get__consumersCancellationTokenSource() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::CancellationTokenSource*> __get__producersCancellationTokenSource() const;
