...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x58 - sizeof(::System::Collections::Hashtable)]{};

/// @brief Field _table offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> __get__table() const;
...
// Ctor Parameters []
// @brief default ctor
 __Hashtable__SyncHashtable()  = default;
public:
