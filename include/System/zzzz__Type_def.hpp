...
namespace System {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(3474)), TypeDefinitionIndex(TypeDefinitionIndex(3459))}
...
/// @brief Field DefaultTypeNameWhenMissingMetadata offset 0x0
...
static inline ::System::Type* internal_from_handle(::cordl_internals::intptr_t  handle) ;
...
// Static field s_defaultBinder

// Static field Delimiter

// Static field EmptyTypes

// Static field Missing

// Static field FilterAttribute

// Static field FilterName

// Static field FilterNameIgnoreCase
