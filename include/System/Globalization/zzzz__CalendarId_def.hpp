...
struct CORDL_TYPE CalendarId : public ::bs_hook::EnumTypeWrapper<0x2> {
public:
// Declarations
...
return std::bit_cast<__CalendarId_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x2>::instance);
}
...
constexpr explicit CalendarId(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x2>(instance) {
}
