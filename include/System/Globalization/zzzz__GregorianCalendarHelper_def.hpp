...
constexpr ::cordl_internals::to_const_pointer<::System::Globalization::Calendar*> __get_m_Cal() const;
...
/// @brief Method get_MaxYear addr 0x256289c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x25628a4 size 0x78 virtual false final false
...
/// @brief Method GetYearOffset addr 0x256291c size 0x2f4 virtual false final false
inline int32_t GetYearOffset(int32_t  year, int32_t  era, bool  throwOnError) ;

/// @brief Method GetGregorianYear addr 0x2562c10 size 0x1c virtual false final false
inline int32_t GetGregorianYear(int32_t  year, int32_t  era) ;

/// @brief Method IsValidYear addr 0x2562c2c size 0x1c virtual false final false
inline bool IsValidYear(int32_t  year, int32_t  era) ;

/// @brief Method GetDatePart addr 0x2562c48 size 0x20c virtual true final false
inline int32_t GetDatePart(int64_t  ticks, int32_t  part) ;

/// @brief Method GetAbsoluteDate addr 0x2562fec size 0x1e8 virtual false final false
static inline int64_t GetAbsoluteDate(int32_t  year, int32_t  month, int32_t  day) ;

/// @brief Method DateToTicks addr 0x25631d4 size 0x80 virtual false final false
static inline int64_t DateToTicks(int32_t  year, int32_t  month, int32_t  day) ;

/// @brief Method TimeToTicks addr 0x2563254 size 0x1bc virtual false final false
static inline int64_t TimeToTicks(int32_t  hour, int32_t  minute, int32_t  second, int32_t  millisecond) ;

/// @brief Method CheckTicksRange addr 0x2562e54 size 0x198 virtual false final false
inline void CheckTicksRange(int64_t  ticks) ;

/// @brief Method GetDayOfMonth addr 0x2563410 size 0x40 virtual false final false
inline int32_t GetDayOfMonth(::System::DateTime  time) ;

/// @brief Method GetDayOfWeek addr 0x2563450 size 0x8c virtual false final false
inline ::System::DayOfWeek GetDayOfWeek(::System::DateTime  time) ;

/// @brief Method GetDaysInMonth addr 0x25634dc size 0x18c virtual false final false
inline int32_t GetDaysInMonth(int32_t  year, int32_t  month, int32_t  era) ;

/// @brief Method GetDaysInYear addr 0x2563668 size 0x70 virtual false final false
inline int32_t GetDaysInYear(int32_t  year, int32_t  era) ;

/// @brief Method GetEra addr 0x25636d8 size 0xd0 virtual false final false
inline int32_t GetEra(::System::DateTime  time) ;

/// @brief Method get_Eras addr 0x25637a8 size 0xf0 virtual false final false
inline ::ArrayW<int32_t,::Array<int32_t>*> get_Eras() ;

/// @brief Method GetMonth addr 0x2563898 size 0x40 virtual false final false
inline int32_t GetMonth(::System::DateTime  time) ;

/// @brief Method GetMonthsInYear addr 0x25638d8 size 0x18 virtual false final false
inline int32_t GetMonthsInYear(int32_t  year, int32_t  era) ;

/// @brief Method GetYear addr 0x25638f0 size 0xf0 virtual false final false
inline int32_t GetYear(::System::DateTime  time) ;

/// @brief Method IsLeapYear addr 0x25639e0 size 0x70 virtual false final false
inline bool IsLeapYear(int32_t  year, int32_t  era) ;

/// @brief Method ToDateTime addr 0x2563a50 size 0x104 virtual false final false
...
/// @brief Method ToFourDigitYear addr 0x2563b54 size 0x188 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 GregorianCalendarHelper()  = default;
public:
