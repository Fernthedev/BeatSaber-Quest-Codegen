...
struct CORDL_TYPE __CultureInfo__Data : public ::bs_hook::ValueTypeWrapper<0x14> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x14};

/// @brief Field ansi offset 0x0
 __declspec(property(get=__get_ansi, put=__set_ansi)) int32_t  ansi;

/// @brief Field ebcdic offset 0x4
 __declspec(property(get=__get_ebcdic, put=__set_ebcdic)) int32_t  ebcdic;

/// @brief Field mac offset 0x8
 __declspec(property(get=__get_mac, put=__set_mac)) int32_t  mac;

/// @brief Field oem offset 0xc
 __declspec(property(get=__get_oem, put=__set_oem)) int32_t  oem;

/// @brief Field right_to_left offset 0x10
 __declspec(property(get=__get_right_to_left, put=__set_right_to_left)) bool  right_to_left;

/// @brief Field list_sep offset 0x11
 __declspec(property(get=__get_list_sep, put=__set_list_sep)) uint8_t  list_sep;

constexpr void __set_ansi(int32_t  value) ;

constexpr int32_t& __get_ansi() ;

constexpr int32_t const& __get_ansi() const;

constexpr void __set_ebcdic(int32_t  value) ;

constexpr int32_t& __get_ebcdic() ;

constexpr int32_t const& __get_ebcdic() const;

constexpr void __set_mac(int32_t  value) ;

constexpr int32_t& __get_mac() ;

constexpr int32_t const& __get_mac() const;

constexpr void __set_oem(int32_t  value) ;

constexpr int32_t& __get_oem() ;

constexpr int32_t const& __get_oem() const;

constexpr void __set_right_to_left(bool  value) ;

constexpr bool& __get_right_to_left() ;

constexpr bool const& __get_right_to_left() const;

constexpr void __set_list_sep(uint8_t  value) ;

constexpr uint8_t& __get_list_sep() ;

constexpr uint8_t const& __get_list_sep() const;
...
constexpr explicit __CultureInfo__Data(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x14>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __CultureInfo__Data()  = default;
...
static inline ::System::Globalization::__CultureInfo__OnCultureInfoChangedDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method .ctor addr 0x2577a20 size 0xd4 virtual false final false
inline void _ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method Invoke addr 0x2577ca8 size 0x14 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 __CultureInfo__OnCultureInfoChangedDelegate()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Globalization::NumberFormatInfo*> __get_numInfo() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Globalization::DateTimeFormatInfo*> __get_dateTimeInfo() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Globalization::CompareInfo*> __get_compareInfo() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Globalization::CultureInfo*> __get_parent_culture() const;
...
/// @brief Method get__cultureData addr 0x2572a9c size 0x8 virtual false final false
inline ::System::Globalization::CultureData* get__cultureData() ;

/// @brief Method get__isInherited addr 0x2572aa4 size 0x8 virtual false final false
inline bool get__isInherited() ;

/// @brief Method get_InvariantCulture addr 0x2572aac size 0x60 virtual false final false
static inline ::System::Globalization::CultureInfo* get_InvariantCulture() ;

/// @brief Method get_CurrentCulture addr 0x2572b0c size 0x20 virtual false final false
static inline ::System::Globalization::CultureInfo* get_CurrentCulture() ;

/// @brief Method get_CurrentUICulture addr 0x2572b2c size 0x20 virtual false final false
static inline ::System::Globalization::CultureInfo* get_CurrentUICulture() ;

/// @brief Method ConstructCurrentCulture addr 0x2572b4c size 0x1e4 virtual false final false
static inline ::System::Globalization::CultureInfo* ConstructCurrentCulture() ;

/// @brief Method ConstructCurrentUICulture addr 0x2572f50 size 0x4c virtual false final false
static inline ::System::Globalization::CultureInfo* ConstructCurrentUICulture() ;

/// @brief Method get_Territory addr 0x2572f9c size 0x8 virtual false final false
inline ::StringW get_Territory() ;

/// @brief Method get__name addr 0x2572fa4 size 0x8 virtual false final false
inline ::StringW get__name() ;

/// @brief Method get_LCID addr 0x2572fac size 0x8 virtual true final false
inline int32_t get_LCID() ;

/// @brief Method get_Name addr 0x2572fb4 size 0x8 virtual true final false
inline ::StringW get_Name() ;

/// @brief Method get_Calendar addr 0x2572fbc size 0x84 virtual true final false
inline ::System::Globalization::Calendar* get_Calendar() ;

/// @brief Method get_Parent addr 0x2573298 size 0x23c virtual true final false
inline ::System::Globalization::CultureInfo* get_Parent() ;

/// @brief Method get_TextInfo addr 0x25734ec size 0x11c virtual true final false
inline ::System::Globalization::TextInfo* get_TextInfo() ;

/// @brief Method Clone addr 0x2573684 size 0x19c virtual true final false
inline ::System::Object* Clone() ;

/// @brief Method Equals addr 0x2573820 size 0xac virtual true final false
inline bool Equals(::System::Object*  value) ;

/// @brief Method GetCultures addr 0x25738cc size 0x230 virtual false final false
...
/// @brief Method GetTextInfoData addr 0x2573b0c size 0x18 virtual false final false
inline ::System::Globalization::__CultureInfo__Data GetTextInfoData() ;

/// @brief Method GetHashCode addr 0x2573b9c size 0xc virtual true final false
inline int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2573ba8 size 0x8 virtual true final false
inline ::StringW ToString() ;

/// @brief Method get_CompareInfo addr 0x2573bb0 size 0x158 virtual true final false
inline ::System::Globalization::CompareInfo* get_CompareInfo() ;

/// @brief Method get_IsNeutralCulture addr 0x2573d08 size 0x48 virtual true final false
inline bool get_IsNeutralCulture() ;

/// @brief Method CheckNeutral addr 0x2573d50 size 0x4 virtual false final false
inline void CheckNeutral() ;

/// @brief Method get_NumberFormat addr 0x2573d54 size 0x90 virtual true final false
inline ::System::Globalization::NumberFormatInfo* get_NumberFormat() ;

/// @brief Method set_NumberFormat addr 0x2573de4 size 0xd0 virtual true final false
inline void set_NumberFormat(::System::Globalization::NumberFormatInfo*  value) ;

/// @brief Method get_DateTimeFormat addr 0x2573eb4 size 0x160 virtual true final false
inline ::System::Globalization::DateTimeFormatInfo* get_DateTimeFormat() ;

/// @brief Method set_DateTimeFormat addr 0x2574014 size 0xd0 virtual true final false
inline void set_DateTimeFormat(::System::Globalization::DateTimeFormatInfo*  value) ;

/// @brief Method get_EnglishName addr 0x25740e4 size 0x30 virtual true final false
inline ::StringW get_EnglishName() ;

/// @brief Method GetFormat addr 0x2574114 size 0x110 virtual true final false
inline ::System::Object* GetFormat(::System::Type*  formatType) ;

/// @brief Method Construct addr 0x2573040 size 0x20 virtual false final false
inline void Construct() ;

/// @brief Method construct_internal_locale_from_lcid addr 0x2574224 size 0x4 virtual false final false
inline bool construct_internal_locale_from_lcid(int32_t  lcid) ;

/// @brief Method construct_internal_locale_from_name addr 0x2574228 size 0x4 virtual false final false
inline bool construct_internal_locale_from_name(::StringW  name) ;

/// @brief Method get_current_locale_name addr 0x2572d30 size 0x4 virtual false final false
static inline ::StringW get_current_locale_name() ;

/// @brief Method internal_get_cultures addr 0x2573afc size 0x10 virtual false final false
...
/// @brief Method ConstructInvariant addr 0x257422c size 0x158 virtual false final false
inline void ConstructInvariant(bool  read_only) ;

/// @brief Method CreateTextInfo addr 0x2573608 size 0x7c virtual false final false
...
/// @brief Method .ctor addr 0x25734e0 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x2574384 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x2574390 size 0x264 virtual false final false
...
/// @brief Method .ctor addr 0x25734d4 size 0xc virtual false final false
inline void _ctor(::StringW  name) ;

static inline ::System::Globalization::CultureInfo* New_ctor(::StringW  name, bool  useUserOverride) ;

/// @brief Method .ctor addr 0x25745f4 size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x2574600 size 0x230 virtual false final false
...
/// @brief Method .ctor addr 0x2574984 size 0x20 virtual false final false
inline void _ctor() ;

/// @brief Method insert_into_shared_tables addr 0x25749a4 size 0x188 virtual false final false
static inline void insert_into_shared_tables(::System::Globalization::CultureInfo*  c) ;

/// @brief Method GetCultureInfo addr 0x2574b2c size 0x244 virtual false final false
static inline ::System::Globalization::CultureInfo* GetCultureInfo(int32_t  culture) ;

/// @brief Method GetCultureInfo addr 0x2574d70 size 0x22c virtual false final false
static inline ::System::Globalization::CultureInfo* GetCultureInfo(::StringW  name) ;

/// @brief Method CreateCulture addr 0x2574f9c size 0x74 virtual false final false
static inline ::System::Globalization::CultureInfo* CreateCulture(::StringW  name, bool  reference) ;

/// @brief Method CreateSpecificCulture addr 0x2572d34 size 0x21c virtual false final false
static inline ::System::Globalization::CultureInfo* CreateSpecificCulture(::StringW  name) ;

/// @brief Method ConstructLocaleFromName addr 0x2574830 size 0x8c virtual false final false
inline bool ConstructLocaleFromName(::StringW  name) ;

/// @brief Method CreateSpecificCultureFromNeutral addr 0x2575010 size 0x2754 virtual false final false
static inline ::System::Globalization::CultureInfo* CreateSpecificCultureFromNeutral(::StringW  name) ;

/// @brief Method get_CalendarType addr 0x2573b24 size 0x78 virtual false final false
inline int32_t get_CalendarType() ;

/// @brief Method CreateCalendar addr 0x2573060 size 0x238 virtual false final false
static inline ::System::Globalization::Calendar* CreateCalendar(int32_t  calendarType) ;

/// @brief Method CreateNotFoundException addr 0x25748bc size 0xc8 virtual false final false
static inline ::System::Exception* CreateNotFoundException(::StringW  name) ;

/// @brief Method get_DefaultThreadCurrentCulture addr 0x2577764 size 0x60 virtual false final false
static inline ::System::Globalization::CultureInfo* get_DefaultThreadCurrentCulture() ;

/// @brief Method set_DefaultThreadCurrentCulture addr 0x25777c4 size 0x60 virtual false final false
static inline void set_DefaultThreadCurrentCulture(::System::Globalization::CultureInfo*  value) ;

/// @brief Method get_DefaultThreadCurrentUICulture addr 0x2577824 size 0x60 virtual false final false
static inline ::System::Globalization::CultureInfo* get_DefaultThreadCurrentUICulture() ;

/// @brief Method get_SortName addr 0x2577884 size 0x8 virtual false final false
inline ::StringW get_SortName() ;

/// @brief Method get_UserDefaultUICulture addr 0x257788c size 0x4c virtual false final false
static inline ::System::Globalization::CultureInfo* get_UserDefaultUICulture() ;

/// @brief Method get_UserDefaultCulture addr 0x25778d8 size 0x4c virtual false final false
static inline ::System::Globalization::CultureInfo* get_UserDefaultCulture() ;

/// @brief Method InitializeUserPreferredCultureInfoInAppX addr 0x2577924 size 0x10 virtual false final false
...
/// @brief Method SetUserPreferredCultureInfoInAppX addr 0x2577934 size 0x10 virtual false final false
static inline void SetUserPreferredCultureInfoInAppX(::StringW  name) ;

/// @brief Method OnCultureInfoChangedInAppX addr 0x25729fc size 0xa0 virtual false final false
static inline void OnCultureInfoChangedInAppX(::StringW  language) ;

/// @brief Method GetCultureInfoForUserPreferredLanguageInAppX addr 0x2577944 size 0xdc virtual false final false
static inline ::System::Globalization::CultureInfo* GetCultureInfoForUserPreferredLanguageInAppX() ;

/// @brief Method SetCultureInfoForUserPreferredLanguageInAppX addr 0x2577af4 size 0x10c virtual false final false
...
// Static field invariant_culture_info

// Static field shared_table_lock

// Static field default_current_culture

// Static field s_DefaultThreadCurrentUICulture

// Static field s_DefaultThreadCurrentCulture

// Static field shared_by_number

// Static field shared_by_name

// Static field s_UserPreferredCultureInfoInAppX

// Static field IsTaiwanSku
