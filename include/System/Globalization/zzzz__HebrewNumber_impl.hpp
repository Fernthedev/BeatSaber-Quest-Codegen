...
constexpr void System::Globalization::__HebrewNumber__HebrewToken::__set_value__(int16_t  value)  {
...
constexpr int16_t& System::Globalization::__HebrewNumber__HebrewToken::__get_value__()  {
return ::cordl_internals::getInstanceField<int16_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int16_t const& System::Globalization::__HebrewNumber__HebrewToken::__get_value__() const {
return ::cordl_internals::getInstanceField<int16_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "value__", ty: "int16_t", modifiers: "", def_value: Some("{}") }]
constexpr ::System::Globalization::__HebrewNumber__HebrewToken::__HebrewNumber__HebrewToken(int16_t  value__) noexcept : ::bs_hook::EnumTypeWrapper<0x2>() {this->value__ = value__;
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Globalization::__HebrewNumber__HebrewValue::*)(::System::Globalization::__HebrewNumber__HebrewToken, int16_t)>(&::System::Globalization::__HebrewNumber__HebrewValue::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Globalization::__HebrewNumber__HebrewToken>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int16_t>::get()}
                        )));
    return ___internal_method;
  }
};
constexpr void System::Globalization::__HebrewNumber__HebrewValue::__set_token(::System::Globalization::__HebrewNumber__HebrewToken  value)  {
::cordl_internals::setInstanceField<::System::Globalization::__HebrewNumber__HebrewToken, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::System::Globalization::__HebrewNumber__HebrewToken>(value));
}
constexpr ::System::Globalization::__HebrewNumber__HebrewToken& System::Globalization::__HebrewNumber__HebrewValue::__get_token()  {
return ::cordl_internals::getInstanceField<::System::Globalization::__HebrewNumber__HebrewToken, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::System::Globalization::__HebrewNumber__HebrewToken const& System::Globalization::__HebrewNumber__HebrewValue::__get_token() const {
return ::cordl_internals::getInstanceField<::System::Globalization::__HebrewNumber__HebrewToken, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void System::Globalization::__HebrewNumber__HebrewValue::__set_value(int16_t  value)  {
...
constexpr int16_t& System::Globalization::__HebrewNumber__HebrewValue::__get_value()  {
return ::cordl_internals::getInstanceField<int16_t, 0x2>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int16_t const& System::Globalization::__HebrewNumber__HebrewValue::__get_value() const {
return ::cordl_internals::getInstanceField<int16_t, 0x2>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::System::Globalization::__HebrewNumber__HebrewValue::__HebrewNumber__HebrewValue(::System::Globalization::__HebrewNumber__HebrewToken  token, int16_t  value) noexcept : ::bs_hook::ValueTypeWrapper<0x4>() {this->token = token;
this->value = value;
}
constexpr void System::Globalization::__HebrewNumber__HS::__set_value__(int8_t  value)  {
...
constexpr int8_t& System::Globalization::__HebrewNumber__HS::__get_value__()  {
return ::cordl_internals::getInstanceField<int8_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int8_t const& System::Globalization::__HebrewNumber__HS::__get_value__() const {
return ::cordl_internals::getInstanceField<int8_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "value__", ty: "int8_t", modifiers: "", def_value: Some("{}") }]
constexpr ::System::Globalization::__HebrewNumber__HS::__HebrewNumber__HS(int8_t  value__) noexcept : ::bs_hook::EnumTypeWrapper<0x1>() {this->value__ = value__;
}
