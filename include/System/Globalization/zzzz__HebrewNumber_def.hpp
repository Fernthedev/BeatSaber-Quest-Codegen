...
struct CORDL_TYPE __HebrewNumber__HebrewToken : public ::bs_hook::EnumTypeWrapper<0x2> {
public:
// Declarations
...
return std::bit_cast<____HebrewNumber__HebrewToken_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x2>::instance);
}
...
constexpr explicit __HebrewNumber__HebrewToken(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x2>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HebrewNumber__HebrewToken()  = default;
...
struct CORDL_TYPE __HebrewNumber__HebrewValue : public ::bs_hook::ValueTypeWrapper<0x4> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x4};

/// @brief Field token offset 0x0
 __declspec(property(get=__get_token, put=__set_token)) ::System::Globalization::__HebrewNumber__HebrewToken  token;

/// @brief Field value offset 0x2
 __declspec(property(get=__get_value, put=__set_value)) int16_t  value;

constexpr void __set_token(::System::Globalization::__HebrewNumber__HebrewToken  value) ;

constexpr ::System::Globalization::__HebrewNumber__HebrewToken& __get_token() ;

constexpr ::System::Globalization::__HebrewNumber__HebrewToken const& __get_token() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HebrewNumber__HebrewValue(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HebrewNumber__HebrewValue()  = default;
...
struct CORDL_TYPE __HebrewNumber__HS : public ::bs_hook::EnumTypeWrapper<0x1> {
public:
// Declarations
...
return std::bit_cast<____HebrewNumber__HS_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x1>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HebrewNumber__HS(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x1>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HebrewNumber__HS()  = default;
...
// Ctor Parameters []
// @brief default ctor
 HebrewNumber()  = default;
public:


// Fields

// Static field s_hebrewValues

// Static field s_maxHebrewNumberCh

// Static field s_numberPasingState
