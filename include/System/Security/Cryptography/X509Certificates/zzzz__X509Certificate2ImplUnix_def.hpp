...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xb0 - sizeof(::System::Security::Cryptography::X509Certificates::X509Certificate2Impl)]{};

/// @brief Field readCertData offset 0x10
 __declspec(property(get=__get_readCertData, put=__set_readCertData)) bool  readCertData;

/// @brief Field certData offset 0x18
...
/// @brief Method EnsureCertData addr 0x297e858 size 0x80 virtual false final false
...
/// @brief Method get_KeyAlgorithm addr 0x297e8d8 size 0x18 virtual true final true
inline ::StringW get_KeyAlgorithm() ;

/// @brief Method get_KeyAlgorithmParameters addr 0x297e8f0 size 0x18 virtual true final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_KeyAlgorithmParameters() ;

/// @brief Method get_PublicKeyValue addr 0x297e908 size 0x18 virtual true final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_PublicKeyValue() ;

/// @brief Method get_SerialNumber addr 0x297e920 size 0x18 virtual true final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_SerialNumber() ;

/// @brief Method get_SignatureAlgorithm addr 0x297e938 size 0x18 virtual true final true
inline ::StringW get_SignatureAlgorithm() ;

/// @brief Method get_Version addr 0x297e950 size 0x1c virtual true final true
inline int32_t get_Version() ;

/// @brief Method get_SubjectName addr 0x297e96c size 0x18 virtual true final true
inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_SubjectName() ;

/// @brief Method get_IssuerName addr 0x297e984 size 0x18 virtual true final true
inline ::System::Security::Cryptography::X509Certificates::X500DistinguishedName* get_IssuerName() ;

/// @brief Method get_Subject addr 0x297e99c size 0x28 virtual true final true
inline ::StringW get_Subject() ;

/// @brief Method get_Issuer addr 0x297e9c4 size 0x28 virtual true final true
inline ::StringW get_Issuer() ;

/// @brief Method get_RawData addr 0x297e9ec size 0x18 virtual true final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_RawData() ;

/// @brief Method get_Thumbprint addr 0x297ea04 size 0x194 virtual true final true
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Thumbprint() ;

/// @brief Method GetNameInfo addr 0x297eb98 size 0x34 virtual true final true
inline ::StringW GetNameInfo(::System::Security::Cryptography::X509Certificates::X509NameType  nameType, bool  forIssuer) ;

/// @brief Method get_Extensions addr 0x297ebcc size 0x18 virtual true final true
...
/// @brief Method get_NotAfter addr 0x297ebe4 size 0x1c virtual true final true
inline ::System::DateTime get_NotAfter() ;

/// @brief Method get_NotBefore addr 0x297ec00 size 0x1c virtual true final true
inline ::System::DateTime get_NotBefore() ;

/// @brief Method AppendPrivateKeyInfo addr 0x297ec1c size 0x94 virtual true final true
...
/// @brief Method .ctor addr 0x297d314 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 X509Certificate2ImplUnix()  = default;
public:
