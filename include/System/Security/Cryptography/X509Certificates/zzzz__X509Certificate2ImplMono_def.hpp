...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xc0 - sizeof(::System::Security::Cryptography::X509Certificates::X509Certificate2ImplUnix)]{};

/// @brief Field intermediateCerts offset 0xb0
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::X509Certificates::X509CertificateImplCollection*> __get_intermediateCerts() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::X509::X509Certificate*> __get__cert() const;
...
// Ctor Parameters []
// @brief default ctor
 X509Certificate2ImplMono()  = default;
public:


// Fields

// Static field empty_error
