...
// Ctor Parameters []
// @brief default ctor
 __X509CertificateCollection__X509CertificateEnumerator()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::System::Collections::CollectionBase)]{};
...
// Ctor Parameters []
// @brief default ctor
 X509CertificateCollection()  = default;
public:
