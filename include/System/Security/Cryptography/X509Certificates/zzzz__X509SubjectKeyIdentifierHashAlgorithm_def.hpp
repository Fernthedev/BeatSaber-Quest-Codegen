...
struct CORDL_TYPE X509SubjectKeyIdentifierHashAlgorithm : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<__X509SubjectKeyIdentifierHashAlgorithm_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit X509SubjectKeyIdentifierHashAlgorithm(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 X509SubjectKeyIdentifierHashAlgorithm()  = default;
