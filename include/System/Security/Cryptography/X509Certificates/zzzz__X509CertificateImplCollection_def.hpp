...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Security::Cryptography::X509Certificates::X509CertificateImpl*>*> __get_list() const;
...
// Ctor Parameters []
// @brief default ctor
 X509CertificateImplCollection()  = default;
public:
