...
/// @brief Field _keyValue offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::AsnEncodedData*> __get__keyValue() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::AsnEncodedData*> __get__params() const;

constexpr void __set__oid(::System::Security::Cryptography::Oid*  value) ;

constexpr ::System::Security::Cryptography::Oid* __get__oid() ;

constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::Oid*> __get__oid() const;
...
/// @brief Method .ctor addr 0x29777f4 size 0x174 virtual false final false
...
/// @brief Method get_EncodedKeyValue addr 0x2977968 size 0x8 virtual false final false
inline ::System::Security::Cryptography::AsnEncodedData* get_EncodedKeyValue() ;

/// @brief Method get_EncodedParameters addr 0x2977970 size 0x8 virtual false final false
inline ::System::Security::Cryptography::AsnEncodedData* get_EncodedParameters() ;

/// @brief Method get_Key addr 0x2977978 size 0x1a4 virtual false final false
inline ::System::Security::Cryptography::AsymmetricAlgorithm* get_Key() ;

/// @brief Method get_Oid addr 0x2978380 size 0x8 virtual false final false
inline ::System::Security::Cryptography::Oid* get_Oid() ;

/// @brief Method GetUnsignedBigInteger addr 0x2978388 size 0x94 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetUnsignedBigInteger(::ArrayW<uint8_t,::Array<uint8_t>*>  integer) ;

/// @brief Method DecodeDSA addr 0x2977ed4 size 0x4ac virtual false final false
...
/// @brief Method DecodeRSA addr 0x2977b1c size 0x3b8 virtual false final false
