...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::System::Security::Cryptography::X509Certificates::X509Extension)]{};
...
/// @brief Field _subjectKeyIdentifier offset 0x28
...
// Ctor Parameters []
// @brief default ctor
 X509SubjectKeyIdentifierExtension()  = default;
public:
