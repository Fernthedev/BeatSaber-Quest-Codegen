...
/// @brief Method .ctor addr 0x2978c7c size 0xa8 virtual false final false
inline void _ctor() ;
...
/// @brief Method .ctor addr 0x2977644 size 0xd8 virtual false final false
...
/// @brief Method .ctor addr 0x2978ee8 size 0x140 virtual false final false
inline void _ctor(bool  certificateAuthority, bool  hasPathLengthConstraint, int32_t  pathLengthConstraint, bool  critical) ;

/// @brief Method get_CertificateAuthority addr 0x2979180 size 0x6c virtual false final false
inline bool get_CertificateAuthority() ;

/// @brief Method get_HasPathLengthConstraint addr 0x29791ec size 0x6c virtual false final false
inline bool get_HasPathLengthConstraint() ;

/// @brief Method get_PathLengthConstraint addr 0x2979258 size 0x6c virtual false final false
inline int32_t get_PathLengthConstraint() ;

/// @brief Method CopyFrom addr 0x29792c4 size 0x1dc virtual true final false
inline void CopyFrom(::System::Security::Cryptography::AsnEncodedData*  asnEncodedData) ;

/// @brief Method Decode addr 0x2978d24 size 0x1c4 virtual false final false
inline ::System::Security::Cryptography::AsnDecodeStatus Decode(::ArrayW<uint8_t,::Array<uint8_t>*>  extension) ;

/// @brief Method Encode addr 0x2979028 size 0x158 virtual false final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> Encode() ;

/// @brief Method ToString addr 0x29794a0 size 0x298 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 X509BasicConstraintsExtension()  = default;
public:
