...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::System::Security::Cryptography::SHA1)]{};
...
/// @brief Method .ctor addr 0x245ed4c size 0x124 virtual false final false
inline void _ctor() ;

/// @brief Method Initialize addr 0x2466ca8 size 0x44 virtual true final false
inline void Initialize() ;

/// @brief Method HashCore addr 0x2466cec size 0x4 virtual true final false
inline void HashCore(::ArrayW<uint8_t,::Array<uint8_t>*>  rgb, int32_t  ibStart, int32_t  cbSize) ;

/// @brief Method HashFinal addr 0x2466e6c size 0x4 virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> HashFinal() ;

/// @brief Method InitializeState addr 0x2466c24 size 0x84 virtual false final false
inline void InitializeState() ;

/// @brief Method _HashData addr 0x2466cf0 size 0x17c virtual false final false
inline void _HashData(::ArrayW<uint8_t,::Array<uint8_t>*>  partIn, int32_t  ibStart, int32_t  cbSize) ;

/// @brief Method _EndHash addr 0x2466e70 size 0x1a8 virtual false final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> _EndHash() ;

/// @brief Method SHATransform addr 0x2467018 size 0x3f4 virtual false final false
...
/// @brief Method SHAExpand addr 0x246740c size 0x3c virtual false final false
