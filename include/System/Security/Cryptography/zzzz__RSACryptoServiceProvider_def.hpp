...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::System::Security::Cryptography::RSA)]{};
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::Cryptography::RSAManaged*> __get_rsa() const;
...
// Ctor Parameters []
// @brief default ctor
 RSACryptoServiceProvider()  = default;
public:


// Fields

// Static field s_UseMachineKeyStore
