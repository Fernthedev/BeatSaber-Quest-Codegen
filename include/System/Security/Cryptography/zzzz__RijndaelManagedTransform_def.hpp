...
/// @brief Field m_transformMode offset 0x18
...
/// @brief Field m_decryptKeyExpansion offset 0x38
...
// Ctor Parameters []
// @brief default ctor
 RijndaelManagedTransform()  = default;
public:
