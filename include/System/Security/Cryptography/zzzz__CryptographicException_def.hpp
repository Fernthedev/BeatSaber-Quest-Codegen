...
/// @brief Method .ctor addr 0x245c0e4 size 0x6c virtual false final false
inline void _ctor() ;

static inline ::System::Security::Cryptography::CryptographicException* New_ctor(::StringW  message) ;

/// @brief Method .ctor addr 0x245bf48 size 0x28 virtual false final false
inline void _ctor(::StringW  message) ;

static inline ::System::Security::Cryptography::CryptographicException* New_ctor(::StringW  format, ::StringW  insert) ;

/// @brief Method .ctor addr 0x245c150 size 0x98 virtual false final false
...
/// @brief Method .ctor addr 0x245c1e8 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x245c210 size 0x8 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 CryptographicException()  = default;
public:
