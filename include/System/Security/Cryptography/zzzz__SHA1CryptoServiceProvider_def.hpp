...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::System::Security::Cryptography::SHA1)]{};

/// @brief Field sha offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::SHA1Internal*> __get_sha() const;
...
// Ctor Parameters []
// @brief default ctor
 SHA1CryptoServiceProvider()  = default;
public:
