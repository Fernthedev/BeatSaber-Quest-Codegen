...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x50 - sizeof(::System::Security::Cryptography::Aes)]{};

/// @brief Field m_rijndael offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::RijndaelManaged*> __get_m_rijndael() const;

static inline ::System::Security::Cryptography::AesManaged* New_ctor() ;

/// @brief Method .ctor addr 0x280cd58 size 0x164 virtual false final false
inline void _ctor() ;

/// @brief Method get_FeedbackSize addr 0x280cebc size 0x20 virtual true final false
inline int32_t get_FeedbackSize() ;

/// @brief Method get_IV addr 0x280cedc size 0x20 virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_IV() ;

/// @brief Method set_IV addr 0x280cefc size 0x20 virtual true final false
inline void set_IV(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method get_Key addr 0x280cf1c size 0x20 virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Key() ;

/// @brief Method set_Key addr 0x280cf3c size 0x20 virtual true final false
inline void set_Key(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

/// @brief Method get_KeySize addr 0x280cf5c size 0x24 virtual true final false
inline int32_t get_KeySize() ;

/// @brief Method set_KeySize addr 0x280cf80 size 0x24 virtual true final false
inline void set_KeySize(int32_t  value) ;

/// @brief Method get_Mode addr 0x280cfa4 size 0x24 virtual true final false
inline ::System::Security::Cryptography::CipherMode get_Mode() ;

/// @brief Method set_Mode addr 0x280cfc8 size 0x88 virtual true final false
inline void set_Mode(::System::Security::Cryptography::CipherMode  value) ;

/// @brief Method get_Padding addr 0x280d050 size 0x24 virtual true final false
inline ::System::Security::Cryptography::PaddingMode get_Padding() ;

/// @brief Method set_Padding addr 0x280d074 size 0x24 virtual true final false
inline void set_Padding(::System::Security::Cryptography::PaddingMode  value) ;

/// @brief Method CreateDecryptor addr 0x280d098 size 0x24 virtual true final false
inline ::System::Security::Cryptography::ICryptoTransform* CreateDecryptor() ;

/// @brief Method CreateDecryptor addr 0x280d0bc size 0x14c virtual true final false
...
/// @brief Method CreateEncryptor addr 0x280d208 size 0x24 virtual true final false
inline ::System::Security::Cryptography::ICryptoTransform* CreateEncryptor() ;

/// @brief Method CreateEncryptor addr 0x280d22c size 0x14c virtual true final false
...
/// @brief Method Dispose addr 0x280d378 size 0x130 virtual true final false
inline void Dispose(bool  disposing) ;

/// @brief Method GenerateIV addr 0x280d4a8 size 0x24 virtual true final false
inline void GenerateIV() ;

/// @brief Method GenerateKey addr 0x280d4cc size 0x24 virtual true final false
