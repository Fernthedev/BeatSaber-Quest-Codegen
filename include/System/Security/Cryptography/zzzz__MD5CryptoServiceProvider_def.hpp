...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x50 - sizeof(::System::Security::Cryptography::MD5)]{};

/// @brief Field _H offset 0x28
 __declspec(property(get=__get__H, put=__set__H)) ::ArrayW<uint32_t,::Array<uint32_t>*>  _H;

/// @brief Field buff offset 0x30
...
/// @brief Field _ProcessingBuffer offset 0x40
...
/// @brief Field _ProcessingBufferCount offset 0x48
...
/// @brief Method .ctor addr 0x246e418 size 0xa8 virtual false final false
inline void _ctor() ;

/// @brief Method Finalize addr 0x2470abc size 0xa0 virtual true final false
inline void Finalize() ;

/// @brief Method Dispose addr 0x2470b5c size 0x70 virtual true final false
inline void Dispose(bool  disposing) ;

/// @brief Method HashCore addr 0x2470bcc size 0x100 virtual true final false
inline void HashCore(::ArrayW<uint8_t,::Array<uint8_t>*>  rgb, int32_t  ibStart, int32_t  cbSize) ;

/// @brief Method HashFinal addr 0x2471944 size 0xd8 virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> HashFinal() ;

/// @brief Method Initialize addr 0x2471bc8 size 0x74 virtual true final false
inline void Initialize() ;

/// @brief Method ProcessBlock addr 0x2470ccc size 0xc78 virtual false final false
inline void ProcessBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  inputBuffer, int32_t  inputOffset) ;

/// @brief Method ProcessFinalBlock addr 0x2471a1c size 0x1ac virtual false final false
inline void ProcessFinalBlock(::ArrayW<uint8_t,::Array<uint8_t>*>  inputBuffer, int32_t  inputOffset, int32_t  inputCount) ;

/// @brief Method AddLength addr 0x2471c3c size 0xf0 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 MD5CryptoServiceProvider()  = default;
public:
