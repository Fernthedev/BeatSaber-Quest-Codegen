...
/// @brief Field m_currentStrings offset 0x40
...
/// @brief Field m_indexStrings offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Util::TokenizerShortBlock*> __get_m_headTokens() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Util::TokenizerShortBlock*> __get_m_lastTokens() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Util::TokenizerShortBlock*> __get_m_currentTokens() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Util::TokenizerStringBlock*> __get_m_headStrings() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Util::TokenizerStringBlock*> __get_m_currentStrings() const;
