...
::cordl_internals::setInstanceField<::System::Security::AccessControl::AccessControlType, 0x28>(this, std::forward<::System::Security::AccessControl::AccessControlType>(value));
}
constexpr ::System::Security::AccessControl::AccessControlType& System::Security::AccessControl::AccessRule::__get_type()  {
return ::cordl_internals::getInstanceField<::System::Security::AccessControl::AccessControlType, 0x28>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::System::Security::AccessControl::AccessRule*>(identity, accessMask, isInherited, inheritanceFlags, propagationFlags, type));
}
