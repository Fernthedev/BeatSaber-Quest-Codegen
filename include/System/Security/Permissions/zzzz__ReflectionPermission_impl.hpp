...
::cordl_internals::setInstanceField<::System::Security::Permissions::ReflectionPermissionFlag, 0x10>(this, std::forward<::System::Security::Permissions::ReflectionPermissionFlag>(value));
}
...
return ::cordl_internals::getInstanceField<::System::Security::Permissions::ReflectionPermissionFlag, 0x10>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::System::Security::Permissions::ReflectionPermission*>(flag));
}
