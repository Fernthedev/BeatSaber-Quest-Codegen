...
struct CORDL_TYPE UInt16 : public ::bs_hook::ValueTypeWrapper<0x2> {
public:
// Declarations
...
/// @brief Field m_value offset 0x0
 __declspec(property(get=__get_m_value, put=__set_m_value)) uint16_t  m_value;
...
constexpr uint16_t& __get_m_value() ;

constexpr uint16_t const& __get_m_value() const;
...
constexpr explicit UInt16(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x2>(instance) {
}
