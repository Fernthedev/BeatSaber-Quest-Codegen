...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::__UriParser__BuiltInUriParser::*)(::StringW, int32_t, ::System::UriSyntaxFlags)>(&::System::__UriParser__BuiltInUriParser::_ctor)> {
  constexpr static std::size_t size = 0x80;
  constexpr static std::size_t addrs = 0x294bc84;
...
return THROW_UNLESS(::il2cpp_utils::New<::System::__UriParser__BuiltInUriParser*>(lwrCaseScheme, defaultPort, syntaxFlags));
}
