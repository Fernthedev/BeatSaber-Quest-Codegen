...
struct ValueTuple_4<T1,T2,T3,T4>;
}
namespace System {
template<::il2cpp_utils::il2cpp_reference_type T3,::il2cpp_utils::il2cpp_reference_type T4>
struct ValueTuple_4<bool,bool,T3,T4>;
}
// Write type traits
...
template<::il2cpp_utils::il2cpp_reference_type T3,::il2cpp_utils::il2cpp_reference_type T4>
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2509))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2509), inst: 7801 })
// CS Name: ::System::ValueTuple`4<T1,T2,T3,T4>
struct CORDL_TYPE ValueTuple_4<bool,bool,T3,T4> : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
...
/// @brief Convert operator to "::System::IEquatable_1<::System::ValueTuple_4<bool,bool,T3,T4>>"
constexpr operator  ::System::IEquatable_1<::System::ValueTuple_4<bool,bool,T3,T4>>*() ;
...
/// @brief Convert operator to "::System::IComparable_1<::System::ValueTuple_4<bool,bool,T3,T4>>"
constexpr operator  ::System::IComparable_1<::System::ValueTuple_4<bool,bool,T3,T4>>*() ;
...
inline void _ctor(bool  item1, bool  item2, T3  item3, T4  item4) ;

/// @brief Method Equals addr 0x0 size 0xffffffffffffffff virtual true final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals addr 0x0 size 0xffffffffffffffff virtual true final true
inline bool Equals(::System::ValueTuple_4<bool,bool,T3,T4>  other) ;
...
inline int32_t CompareTo(::System::ValueTuple_4<bool,bool,T3,T4>  other) ;
...
// Ctor Parameters [CppParam { name: "Item1", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "Item2", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "Item3", ty: "T3", modifiers: "", def_value: None }, CppParam { name: "Item4", ty: "T4", modifiers: "", def_value: None }]
constexpr ValueTuple_4(bool  Item1, bool  Item2, T3  Item3, T4  Item4) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit ValueTuple_4(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}
...
// Is value type: true
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2509))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2509), inst: 6124 })
// CS Name: ::System::ValueTuple`4<T1,T2,T3,T4>
struct CORDL_TYPE ValueTuple_4<T1,T2,T3,T4> : public ::bs_hook::ValueTypeWrapper<0x20> {
public:
// Declarations
/// @brief The size of the true value type
