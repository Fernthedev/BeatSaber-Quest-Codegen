...
/// @brief Field FirstChanceException offset 0x70
 __declspec(property(get=__get_FirstChanceException, put=__set_FirstChanceException)) ::System::EventHandler_1<::System::Runtime::ExceptionServices::FirstChanceExceptionEventArgs*>*  FirstChanceException;

/// @brief Field _domain_manager offset 0x78
 __declspec(property(get=__get__domain_manager, put=__set__domain_manager)) ::System::Object*  _domain_manager;

/// @brief Field ReflectionOnlyAssemblyResolve offset 0x80
...
constexpr ::cordl_internals::intptr_t& __get__mono_app_domain() ;

constexpr ::cordl_internals::intptr_t const& __get__mono_app_domain() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::AssemblyLoadEventHandler*> __get_AssemblyLoad() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::ResolveEventHandler*> __get_AssemblyResolve() const;

constexpr void __set_DomainUnload(::System::EventHandler*  value) ;

constexpr ::System::EventHandler* __get_DomainUnload() ;

constexpr ::cordl_internals::to_const_pointer<::System::EventHandler*> __get_DomainUnload() const;

constexpr void __set_ProcessExit(::System::EventHandler*  value) ;

constexpr ::System::EventHandler* __get_ProcessExit() ;

constexpr ::cordl_internals::to_const_pointer<::System::EventHandler*> __get_ProcessExit() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::ResolveEventHandler*> __get_ResourceResolve() const;

constexpr void __set_TypeResolve(::System::ResolveEventHandler*  value) ;

constexpr ::System::ResolveEventHandler* __get_TypeResolve() ;

constexpr ::cordl_internals::to_const_pointer<::System::ResolveEventHandler*> __get_TypeResolve() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::UnhandledExceptionEventHandler*> __get_UnhandledException() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::EventHandler_1<::System::Runtime::ExceptionServices::FirstChanceExceptionEventArgs*>*> __get_FirstChanceException() const;

constexpr void __set__domain_manager(::System::Object*  value) ;

constexpr ::System::Object* __get__domain_manager() ;

constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__domain_manager() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::ResolveEventHandler*> __get_ReflectionOnlyAssemblyResolve() const;

constexpr void __set__activation(::System::Object*  value) ;

constexpr ::System::Object* __get__activation() ;

constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__activation() const;

constexpr void __set__applicationIdentity(::System::Object*  value) ;

constexpr ::System::Object* __get__applicationIdentity() ;

constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__applicationIdentity() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> __get_compatibility_switch() const;
...
// Static field _process_guid

// Static field type_resolve_in_progress

// Static field assembly_resolve_in_progress

// Static field assembly_resolve_in_progress_refonly
