...
struct CORDL_TYPE __Exception__ExceptionMessageKind : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____Exception__ExceptionMessageKind_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __Exception__ExceptionMessageKind(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Exception__ExceptionMessageKind()  = default;
...
/// @brief Field captured_traces offset 0x78
...
/// @brief Field native_trace_ips offset 0x80
 __declspec(property(get=__get_native_trace_ips, put=__set_native_trace_ips)) ::ArrayW<::cordl_internals::intptr_t,::Array<::cordl_internals::intptr_t>*>  native_trace_ips;

/// @brief Field caught_in_unmanaged offset 0x88
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IDictionary*> __get__data() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__stackTrace() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__dynamicMethods() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Serialization::SafeSerializationManager*> __get__safeSerializationManager() const;
...
constexpr void __set_native_trace_ips(::ArrayW<::cordl_internals::intptr_t,::Array<::cordl_internals::intptr_t>*>  value) ;

constexpr ::ArrayW<::cordl_internals::intptr_t,::Array<::cordl_internals::intptr_t>*>& __get_native_trace_ips() ;

constexpr ::ArrayW<::cordl_internals::intptr_t,::Array<::cordl_internals::intptr_t>*> const& __get_native_trace_ips() const;
