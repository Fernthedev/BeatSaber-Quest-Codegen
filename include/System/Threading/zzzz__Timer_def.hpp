...
struct CORDL_TYPE __Timer__TimerComparer : public ::bs_hook::ValueTypeWrapper<0x1> {
public:
// Declarations
...
constexpr explicit __Timer__TimerComparer(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x1>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Timer__TimerComparer()  = default;
...
/// @brief Field needReSort offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Threading::Timer*>*> __get_list() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::ManualResetEvent*> __get_changed() const;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::System::MarshalByRefObject)]{};
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::TimerCallback*> __get_callback() const;
