...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x68 - sizeof(::System::Threading::Tasks::Task_1<bool>)]{};
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::__SemaphoreSlim__TaskNode*> __get_Prev() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::__SemaphoreSlim__TaskNode*> __get_Next() const;
...
// Ctor Parameters []
// @brief default ctor
 __SemaphoreSlim__TaskNode()  = default;
public:
...
struct CORDL_TYPE __SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32 : public ::bs_hook::ValueTypeWrapper<0x70> {
public:
// Declarations
...
/// @brief Field asyncWaiter offset 0x28
 __declspec(property(get=__get_asyncWaiter, put=__set_asyncWaiter)) ::System::Threading::__SemaphoreSlim__TaskNode*  asyncWaiter;

/// @brief Field millisecondsTimeout offset 0x30
 __declspec(property(get=__get_millisecondsTimeout, put=__set_millisecondsTimeout)) int32_t  millisecondsTimeout;

/// @brief Field <>4__this offset 0x38
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::System::Threading::SemaphoreSlim*  __4__this;

/// @brief Field <cts>5__2 offset 0x40
 __declspec(property(get=__get__cts_5__2, put=__set__cts_5__2)) ::System::Threading::CancellationTokenSource*  _cts_5__2;

/// @brief Field <>7__wrap2 offset 0x48
 __declspec(property(get=__get___7__wrap2, put=__set___7__wrap2)) ::System::Object*  __7__wrap2;
...
constexpr void __set_asyncWaiter(::System::Threading::__SemaphoreSlim__TaskNode*  value) ;

constexpr ::System::Threading::__SemaphoreSlim__TaskNode* __get_asyncWaiter() ;

constexpr ::cordl_internals::to_const_pointer<::System::Threading::__SemaphoreSlim__TaskNode*> __get_asyncWaiter() const;

constexpr void __set_millisecondsTimeout(int32_t  value) ;

constexpr int32_t& __get_millisecondsTimeout() ;

constexpr int32_t const& __get_millisecondsTimeout() const;

constexpr void __set___4__this(::System::Threading::SemaphoreSlim*  value) ;

constexpr ::System::Threading::SemaphoreSlim* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::System::Threading::SemaphoreSlim*> __get___4__this() const;
...
constexpr void __set___7__wrap2(::System::Object*  value) ;

constexpr ::System::Object* __get___7__wrap2() ;

constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get___7__wrap2() const;
...
constexpr explicit __SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x70>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __SemaphoreSlim___WaitUntilCountOrTimeoutAsync_d__32()  = default;
...
/// @brief Field NO_MAXIMUM offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get_m_lockObj() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::__SemaphoreSlim__TaskNode*> __get_m_asyncHead() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::__SemaphoreSlim__TaskNode*> __get_m_asyncTail() const;
...
// Ctor Parameters []
// @brief default ctor
 SemaphoreSlim()  = default;
public:


// Fields

// Static field s_trueTask

// Static field s_falseTask

// Static field s_cancellationTokenCanceledEventHandler
