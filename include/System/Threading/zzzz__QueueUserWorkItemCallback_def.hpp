...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::WaitCallback*> __get_callback() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::ExecutionContext*> __get_context() const;
...
// Ctor Parameters []
// @brief default ctor
 QueueUserWorkItemCallback()  = default;
public:
