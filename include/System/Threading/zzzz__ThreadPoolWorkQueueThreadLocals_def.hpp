...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::ThreadPoolWorkQueue*> __get_workQueue() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::__ThreadPoolWorkQueue__WorkStealingQueue*> __get_workStealingQueue() const;
...
// Ctor Parameters []
// @brief default ctor
 ThreadPoolWorkQueueThreadLocals()  = default;
public:


// Fields

// Static field threadLocals
