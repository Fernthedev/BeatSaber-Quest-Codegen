...
/// @brief Method CompareExchange addr 0x261bdac size 0x4 virtual false final false
static inline int32_t CompareExchange(ByRef<int32_t>  location1, int32_t  value, int32_t  comparand) ;

/// @brief Method CompareExchange addr 0x261ded8 size 0x4 virtual false final false
static inline int32_t CompareExchange(ByRef<int32_t>  location1, int32_t  value, int32_t  comparand, ByRef<bool>  succeeded) ;

/// @brief Method CompareExchange addr 0x261dedc size 0x4 virtual false final false
...
/// @brief Method CompareExchange addr 0x261dee0 size 0x2c virtual false final false
static inline ::System::Object* CompareExchange(ByRef<::System::Object*>  location1, ::System::Object*  value, ::System::Object*  comparand) ;

/// @brief Method CompareExchange addr 0x261df0c size 0x4 virtual false final false
static inline float_t CompareExchange(ByRef<float_t>  location1, float_t  value, float_t  comparand) ;

/// @brief Method Decrement addr 0x261df10 size 0x4 virtual false final false
static inline int32_t Decrement(ByRef<int32_t>  location) ;

/// @brief Method Decrement addr 0x261df14 size 0x4 virtual false final false
static inline int64_t Decrement(ByRef<int64_t>  location) ;

/// @brief Method Increment addr 0x261df18 size 0x4 virtual false final false
static inline int32_t Increment(ByRef<int32_t>  location) ;

/// @brief Method Increment addr 0x261df1c size 0x4 virtual false final false
static inline int64_t Increment(ByRef<int64_t>  location) ;

/// @brief Method Exchange addr 0x261df20 size 0x4 virtual false final false
static inline int32_t Exchange(ByRef<int32_t>  location1, int32_t  value) ;

/// @brief Method Exchange addr 0x261df24 size 0x4 virtual false final false
static inline void Exchange(ByRef<::System::Object*>  location1, ByRef<::System::Object*>  value, ByRef<::System::Object*>  result) ;

/// @brief Method Exchange addr 0x261df28 size 0x24 virtual false final false
static inline ::System::Object* Exchange(ByRef<::System::Object*>  location1, ::System::Object*  value) ;

/// @brief Method Exchange addr 0x261df4c size 0x4 virtual false final false
static inline float_t Exchange(ByRef<float_t>  location1, float_t  value) ;

/// @brief Method CompareExchange addr 0x261df50 size 0x4 virtual false final false
static inline int64_t CompareExchange(ByRef<int64_t>  location1, int64_t  value, int64_t  comparand) ;

/// @brief Method CompareExchange addr 0x261df54 size 0x4 virtual false final false
static inline ::cordl_internals::intptr_t CompareExchange(ByRef<::cordl_internals::intptr_t>  location1, ::cordl_internals::intptr_t  value, ::cordl_internals::intptr_t  comparand) ;

/// @brief Method CompareExchange addr 0x261df58 size 0x4 virtual false final false
...
/// @brief Method Exchange addr 0x261df5c size 0x4 virtual false final false
static inline int64_t Exchange(ByRef<int64_t>  location1, int64_t  value) ;

/// @brief Method Exchange addr 0x261df60 size 0x4 virtual false final false
static inline ::cordl_internals::intptr_t Exchange(ByRef<::cordl_internals::intptr_t>  location1, ::cordl_internals::intptr_t  value) ;

/// @brief Method Exchange addr 0x261df64 size 0x4 virtual false final false
...
/// @brief Method Read addr 0x261df68 size 0x4 virtual false final false
static inline int64_t Read(ByRef<int64_t>  location) ;

/// @brief Method Add addr 0x261df6c size 0x4 virtual false final false
static inline int32_t Add(ByRef<int32_t>  location1, int32_t  value) ;

/// @brief Method Add addr 0x261df70 size 0x4 virtual false final false
static inline int64_t Add(ByRef<int64_t>  location1, int64_t  value) ;

/// @brief Method MemoryBarrier addr 0x261df74 size 0x8 virtual false final false
