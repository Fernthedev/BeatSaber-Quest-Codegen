...
namespace System::Threading::Tasks {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2773)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2773), inst: 400 }), TypeDefinitionIndex(TypeDefinitionIndex(2787))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x60 - sizeof(::System::Threading::Tasks::Task_1<::System::Threading::Tasks::Task*>)]{};

/// @brief Field _tasks offset 0x58
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<::System::Threading::Tasks::Task*>*> __get__tasks() const;
...
// Ctor Parameters []
// @brief default ctor
 __TaskFactory__CompleteOnInvokePromise()  = default;
public:
