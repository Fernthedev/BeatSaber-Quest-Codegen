...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::ITaskCompletionAction*> __get_m_action() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::Task*> __get_m_completingTask() const;
...
/// @brief Method .ctor addr 0x2627bf4 size 0x2c virtual false final false
inline void _ctor(::System::Threading::Tasks::ITaskCompletionAction*  action, ::System::Threading::Tasks::Task*  completingTask) ;

/// @brief Method System.Threading.IThreadPoolWorkItem.ExecuteWorkItem addr 0x262b2f0 size 0xa8 virtual true final true
inline void System_Threading_IThreadPoolWorkItem_ExecuteWorkItem() ;

/// @brief Method MarkAborted addr 0x262b398 size 0x4 virtual true final true
...
// Ctor Parameters []
// @brief default ctor
 CompletionActionInvoker()  = default;
public:
