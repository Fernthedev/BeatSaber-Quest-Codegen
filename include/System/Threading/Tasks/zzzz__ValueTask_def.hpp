...
// Ctor Parameters []
// @brief default ctor
 __ValueTask__ValueTaskSourceAsTask____c()  = default;
public:
...
namespace System::Threading::Tasks {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(2773), inst: 900 }), TypeDefinitionIndex(TypeDefinitionIndex(2773)), TypeDefinitionIndex(TypeDefinitionIndex(2794))}
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::Sources::IValueTaskSource*> __get__source() const;
...
// Ctor Parameters []
// @brief default ctor
 __ValueTask__ValueTaskSourceAsTask()  = default;
public:
...
struct CORDL_TYPE ValueTask : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
/// @brief Field _token offset 0x8
 __declspec(property(get=__get__token, put=__set__token)) int16_t  _token;

/// @brief Field _continueOnCapturedContext offset 0xa
...
constexpr explicit ValueTask(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}
