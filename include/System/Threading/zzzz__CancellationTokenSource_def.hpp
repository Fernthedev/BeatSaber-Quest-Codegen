...
// Ctor Parameters []
// @brief default ctor
 __CancellationTokenSource__LinkedNCancellationTokenSource____c()  = default;
public:
...
/// @brief Field CannotBeCanceled offset 0x0
static constexpr int32_t  CannotBeCanceled{static_cast<int32_t>(0x0)};

/// @brief Field NotCanceledState offset 0x0
static constexpr int32_t  NotCanceledState{static_cast<int32_t>(0x1)};

/// @brief Field NotifyingState offset 0x0
static constexpr int32_t  NotifyingState{static_cast<int32_t>(0x2)};

/// @brief Field NotifyingCompleteState offset 0x0
static constexpr int32_t  NotifyingCompleteState{static_cast<int32_t>(0x3)};

/// @brief Field _kernelEvent offset 0x10
 __declspec(property(get=__get__kernelEvent, put=__set__kernelEvent)) ::System::Threading::ManualResetEvent*  _kernelEvent;

/// @brief Field _registeredCallbacksLists offset 0x18
 __declspec(property(get=__get__registeredCallbacksLists, put=__set__registeredCallbacksLists)) ::ArrayW<::System::Threading::SparselyPopulatedArray_1<::System::Threading::CancellationCallbackInfo*>*,::Array<::System::Threading::SparselyPopulatedArray_1<::System::Threading::CancellationCallbackInfo*>*>*>  _registeredCallbacksLists;

/// @brief Field _state offset 0x20
 __declspec(property(get=__get__state, put=__set__state)) int32_t  _state;

/// @brief Field _threadIDExecutingCallbacks offset 0x24
...
/// @brief Field _disposed offset 0x28
 __declspec(property(get=__get__disposed, put=__set__disposed)) bool  _disposed;

/// @brief Field _executingCallback offset 0x30
...
/// @brief Field _timer offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::ManualResetEvent*> __get__kernelEvent() const;

constexpr void __set__registeredCallbacksLists(::ArrayW<::System::Threading::SparselyPopulatedArray_1<::System::Threading::CancellationCallbackInfo*>*,::Array<::System::Threading::SparselyPopulatedArray_1<::System::Threading::CancellationCallbackInfo*>*>*>  value) ;

constexpr ::ArrayW<::System::Threading::SparselyPopulatedArray_1<::System::Threading::CancellationCallbackInfo*>*,::Array<::System::Threading::SparselyPopulatedArray_1<::System::Threading::CancellationCallbackInfo*>*>*>& __get__registeredCallbacksLists() ;

constexpr ::ArrayW<::System::Threading::SparselyPopulatedArray_1<::System::Threading::CancellationCallbackInfo*>*,::Array<::System::Threading::SparselyPopulatedArray_1<::System::Threading::CancellationCallbackInfo*>*>*> const& __get__registeredCallbacksLists() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::CancellationCallbackInfo*> __get__executingCallback() const;
...
// Static field s_canceledSource

// Static field s_neverCanceledSource

// Static field s_nLists

// Static field s_timerCallback
