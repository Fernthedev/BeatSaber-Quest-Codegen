...
struct CORDL_TYPE __ReaderWriterLockSlim__TimeoutTracker : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x8};

/// @brief Field m_total offset 0x0
 __declspec(property(get=__get_m_total, put=__set_m_total)) int32_t  m_total;

/// @brief Field m_start offset 0x4
...
constexpr int32_t& __get_m_total() ;

constexpr int32_t const& __get_m_total() const;
...
constexpr explicit __ReaderWriterLockSlim__TimeoutTracker(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ReaderWriterLockSlim__TimeoutTracker()  = default;
...
/// @brief Field lockID offset 0x58
 __declspec(property(get=__get_lockID, put=__set_lockID)) int64_t  lockID;

/// @brief Field fUpgradeThreadHoldingRead offset 0x60
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::EventWaitHandle*> __get_writeEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::EventWaitHandle*> __get_readEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::EventWaitHandle*> __get_upgradeEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::EventWaitHandle*> __get_waitUpgradeEvent() const;
