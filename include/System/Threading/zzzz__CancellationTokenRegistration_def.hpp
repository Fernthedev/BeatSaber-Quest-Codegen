...
struct CORDL_TYPE CancellationTokenRegistration : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x18};

/// @brief Field m_callbackInfo offset 0x0
 __declspec(property(get=__get_m_callbackInfo, put=__set_m_callbackInfo)) ::System::Threading::CancellationCallbackInfo*  m_callbackInfo;

/// @brief Field m_registrationInfo offset 0x8
 __declspec(property(get=__get_m_registrationInfo, put=__set_m_registrationInfo)) ::System::Threading::SparselyPopulatedArrayAddInfo_1<::System::Threading::CancellationCallbackInfo*>  m_registrationInfo;
...
constexpr ::System::Threading::CancellationCallbackInfo* __get_m_callbackInfo() ;

constexpr ::cordl_internals::to_const_pointer<::System::Threading::CancellationCallbackInfo*> __get_m_callbackInfo() const;
...
constexpr ::System::Threading::SparselyPopulatedArrayAddInfo_1<::System::Threading::CancellationCallbackInfo*>& __get_m_registrationInfo() ;

constexpr ::System::Threading::SparselyPopulatedArrayAddInfo_1<::System::Threading::CancellationCallbackInfo*> const& __get_m_registrationInfo() const;
...
constexpr explicit CancellationTokenRegistration(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}
