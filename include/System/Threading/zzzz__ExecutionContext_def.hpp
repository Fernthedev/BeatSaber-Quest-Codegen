...
struct CORDL_TYPE __ExecutionContext__Flags : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____ExecutionContext__Flags_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __ExecutionContext__Flags(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ExecutionContext__Flags()  = default;
...
struct CORDL_TYPE __ExecutionContext__Reader : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x8};

/// @brief Field m_ec offset 0x0
 __declspec(property(get=__get_m_ec, put=__set_m_ec)) ::System::Threading::ExecutionContext*  m_ec;
...
constexpr ::System::Threading::ExecutionContext* __get_m_ec() ;

constexpr ::cordl_internals::to_const_pointer<::System::Threading::ExecutionContext*> __get_m_ec() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __ExecutionContext__Reader(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ExecutionContext__Reader()  = default;
...
struct CORDL_TYPE __ExecutionContext__CaptureOptions : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____ExecutionContext__CaptureOptions_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __ExecutionContext__CaptureOptions(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ExecutionContext__CaptureOptions()  = default;
...
/// @brief Field _logicalCallContext offset 0x20
...
/// @brief Field _illogicalCallContext offset 0x28
...
/// @brief Field _localChangeNotifications offset 0x40
 __declspec(property(get=__get__localChangeNotifications, put=__set__localChangeNotifications)) ::System::Collections::Generic::List_1<::System::Threading::IAsyncLocal*>*  _localChangeNotifications;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::SynchronizationContext*> __get__syncContext() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::SynchronizationContext*> __get__syncContextNoFlow() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::LogicalCallContext*> __get__logicalCallContext() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::Remoting::Messaging::IllogicalCallContext*> __get__illogicalCallContext() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::Threading::IAsyncLocal*,::System::Object*>*> __get__localValues() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Threading::IAsyncLocal*>*> __get__localChangeNotifications() const;
