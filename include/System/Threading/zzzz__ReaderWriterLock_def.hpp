...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::LockQueue*> __get_writer_queue() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> __get_reader_locks() const;
