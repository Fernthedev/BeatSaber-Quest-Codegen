...
constexpr int16_t& System::InputRecord::__get_EventType()  {
return ::cordl_internals::getInstanceField<int16_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int16_t const& System::InputRecord::__get_EventType() const {
return ::cordl_internals::getInstanceField<int16_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int16_t& System::InputRecord::__get_RepeatCount()  {
return ::cordl_internals::getInstanceField<int16_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int16_t const& System::InputRecord::__get_RepeatCount() const {
return ::cordl_internals::getInstanceField<int16_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int16_t& System::InputRecord::__get_VirtualKeyCode()  {
return ::cordl_internals::getInstanceField<int16_t, 0x6>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int16_t const& System::InputRecord::__get_VirtualKeyCode() const {
return ::cordl_internals::getInstanceField<int16_t, 0x6>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int16_t& System::InputRecord::__get_VirtualScanCode()  {
return ::cordl_internals::getInstanceField<int16_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int16_t const& System::InputRecord::__get_VirtualScanCode() const {
return ::cordl_internals::getInstanceField<int16_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void System::InputRecord::__set_Character(char16_t  value)  {
::cordl_internals::setInstanceField<char16_t, 0xa>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<char16_t>(value));
}
constexpr char16_t& System::InputRecord::__get_Character()  {
return ::cordl_internals::getInstanceField<char16_t, 0xa>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr char16_t const& System::InputRecord::__get_Character() const {
return ::cordl_internals::getInstanceField<char16_t, 0xa>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& System::InputRecord::__get_ControlKeyState()  {
return ::cordl_internals::getInstanceField<int32_t, 0xc>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& System::InputRecord::__get_ControlKeyState() const {
return ::cordl_internals::getInstanceField<int32_t, 0xc>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::System::InputRecord::InputRecord(int16_t  EventType, bool  KeyDown, int16_t  RepeatCount, int16_t  VirtualKeyCode, int16_t  VirtualScanCode, char16_t  Character, int32_t  ControlKeyState, int32_t  pad1, bool  pad2) noexcept : ::bs_hook::ValueTypeWrapper<0x18>() {this->EventType = EventType;
