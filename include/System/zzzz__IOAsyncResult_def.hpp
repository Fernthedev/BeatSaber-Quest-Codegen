...
constexpr ::cordl_internals::to_const_pointer<::System::AsyncCallback*> __get_async_callback() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::ManualResetEvent*> __get_wait_handle() const;
