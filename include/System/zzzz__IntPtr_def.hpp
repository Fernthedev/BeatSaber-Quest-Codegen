...
struct CORDL_TYPE IntPtr : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
...
/// @brief Field m_value offset 0x0
 __declspec(property(get=__get_m_value, put=__set_m_value)) ::cordl_internals::Ptr<void>  m_value;

/// @brief Convert operator to "::System::Runtime::Serialization::ISerializable"
constexpr operator  ::System::Runtime::Serialization::ISerializable*() ;

/// @brief Convert operator to "::System::IEquatable_1<::cordl_internals::intptr_t>"
constexpr operator  ::System::IEquatable_1<::cordl_internals::intptr_t>*() ;

constexpr void __set_m_value(::cordl_internals::Ptr<void>  value) ;

constexpr ::cordl_internals::Ptr<void>& __get_m_value() ;

constexpr ::cordl_internals::Ptr<void> const& __get_m_value() const;

static inline void setStaticF_Zero(::cordl_internals::intptr_t  value) ;

static inline ::cordl_internals::intptr_t getStaticF_Zero() ;
...
static inline bool op_Equality(::cordl_internals::intptr_t  value1, ::cordl_internals::intptr_t  value2) ;

/// @brief Method op_Inequality addr 0x25f96a8 size 0xc virtual false final false
static inline bool op_Inequality(::cordl_internals::intptr_t  value1, ::cordl_internals::intptr_t  value2) ;

/// @brief Method op_Explicit addr 0x25fa2b0 size 0x8 virtual false final false
static inline ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(int32_t  value) ;

/// @brief Method op_Explicit addr 0x25fa2b8 size 0x4 virtual false final false
static inline ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(int64_t  value) ;

/// @brief Method op_Explicit addr 0x25fa2bc size 0x4 virtual false final false
static inline ::cordl_internals::intptr_t op_Explicit___cordl_internals__intptr_t(::cordl_internals::Ptr<void>  value) ;

/// @brief Method op_Explicit addr 0x25fa2c0 size 0x4 virtual false final false
static inline int32_t op_Explicit_int32_t(::cordl_internals::intptr_t  value) ;

/// @brief Method op_Explicit addr 0x25fa2c4 size 0x4 virtual false final false
static inline int64_t op_Explicit_int64_t(::cordl_internals::intptr_t  value) ;

/// @brief Method op_Explicit addr 0x25fa2c8 size 0x4 virtual false final false
static inline ::cordl_internals::Ptr<void> op_Explicit___cordl_internals__Ptr_void_(::cordl_internals::intptr_t  value) ;

/// @brief Method Add addr 0x25fa2cc size 0x8 virtual false final false
static inline ::cordl_internals::intptr_t Add(::cordl_internals::intptr_t  pointer, int32_t  offset) ;

/// @brief Method op_Addition addr 0x25fa2d4 size 0x8 virtual false final false
static inline ::cordl_internals::intptr_t op_Addition(::cordl_internals::intptr_t  pointer, int32_t  offset) ;

/// @brief Method op_Subtraction addr 0x25fa2dc size 0x8 virtual false final false
static inline ::cordl_internals::intptr_t op_Subtraction(::cordl_internals::intptr_t  pointer, int32_t  offset) ;
...
inline bool System_IEquatable_System_IntPtr__Equals(::cordl_internals::intptr_t  other) ;
...
constexpr explicit IntPtr(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}
