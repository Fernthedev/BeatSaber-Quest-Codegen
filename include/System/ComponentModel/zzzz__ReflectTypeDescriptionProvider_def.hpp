...
constexpr ::cordl_internals::to_const_pointer<::System::ComponentModel::AttributeCollection*> __get__attributes() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::ComponentModel::EventDescriptorCollection*> __get__events() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::ComponentModel::PropertyDescriptorCollection*> __get__properties() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::ComponentModel::TypeConverter*> __get__converter() const;
...
// Ctor Parameters []
// @brief default ctor
 __ReflectTypeDescriptionProvider__ReflectedTypeData()  = default;
public:
...
/// @brief Field _typeData offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> __get__typeData() const;
...
// Ctor Parameters []
// @brief default ctor
 ReflectTypeDescriptionProvider()  = default;
public:


// Fields

// Static field _typeConstructor

// Static field _editorTables

// Static field _intrinsicTypeConverters

// Static field _intrinsicReferenceKey

// Static field _intrinsicNullableKey

// Static field _dictionaryKey

// Static field _propertyCache

// Static field _eventCache

// Static field _attributeCache

// Static field _extendedPropertyCache

// Static field _extenderProviderKey

// Static field _extenderPropertiesKey

// Static field _extenderProviderPropertiesKey

// Static field _skipInterfaceAttributeList
