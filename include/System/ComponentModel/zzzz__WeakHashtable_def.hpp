...
/// @brief Method System.Collections.IEqualityComparer.Equals addr 0x293a970 size 0x15c virtual true final true
inline bool System_Collections_IEqualityComparer_Equals(::System::Object*  x, ::System::Object*  y) ;

/// @brief Method System.Collections.IEqualityComparer.GetHashCode addr 0x293aacc size 0x20 virtual true final true
...
/// @brief Method .ctor addr 0x293a968 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __WeakHashtable__WeakKeyComparer()  = default;
public:
...
/// @brief Method .ctor addr 0x293a87c size 0x64 virtual false final false
inline void _ctor() ;

/// @brief Method Clear addr 0x293a8e0 size 0x8 virtual true final false
inline void Clear() ;

/// @brief Method Remove addr 0x293a8e8 size 0x8 virtual true final false
