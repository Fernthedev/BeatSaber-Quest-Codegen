...
/// @brief Field <Browsable>k__BackingField offset 0x10
 __declspec(property(get=__get__Browsable_k__BackingField, put=__set__Browsable_k__BackingField)) bool  _Browsable_k__BackingField;
...
constexpr bool& __get__Browsable_k__BackingField() ;

constexpr bool const& __get__Browsable_k__BackingField() const;

static inline ::System::ComponentModel::BrowsableAttribute* New_ctor(bool  browsable) ;

/// @brief Method .ctor addr 0x29039d0 size 0x28 virtual false final false
inline void _ctor(bool  browsable) ;

/// @brief Method get_Browsable addr 0x29039f8 size 0x8 virtual false final false
inline bool get_Browsable() ;

/// @brief Method Equals addr 0x2903a00 size 0xe4 virtual true final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode addr 0x2903ae4 size 0x20 virtual true final false
inline int32_t GetHashCode() ;

/// @brief Method IsDefaultAttribute addr 0x2903b04 size 0x68 virtual true final false
