...
constexpr ::cordl_internals::to_const_pointer<::System::ComponentModel::CultureInfoConverter*> __get__converter() const;
...
// Ctor Parameters []
// @brief default ctor
 __CultureInfoConverter__CultureComparer()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __CultureInfoConverter__CultureInfoMapper()  = default;
public:


// Fields

// Static field s_cultureInfoNameMap
...
/// @brief Field _values offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::ComponentModel::__TypeConverter__StandardValuesCollection*> __get__values() const;
