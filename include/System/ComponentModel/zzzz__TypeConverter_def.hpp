...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get_componentType() const;

constexpr void __set_propertyType(::System::Type*  value) ;

constexpr ::System::Type* __get_propertyType() ;

constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get_propertyType() const;
...
// Ctor Parameters []
// @brief default ctor
 __TypeConverter__SimplePropertyDescriptor()  = default;
public:
...
/// @brief Field valueArray offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ICollection*> __get_values() const;

constexpr void __set_valueArray(::System::Array*  value) ;

constexpr ::System::Array* __get_valueArray() ;

constexpr ::cordl_internals::to_const_pointer<::System::Array*> __get_valueArray() const;
...
// Ctor Parameters []
// @brief default ctor
 __TypeConverter__StandardValuesCollection()  = default;
public:
...
/// @brief Field s_UseCompatibleTypeConverterBehavior offset 0x0
...
// Static field useCompatibleTypeConversion
