...
struct CORDL_TYPE RuntimeTypeHandle : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
...
inline void _ctor(::cordl_internals::intptr_t  val) ;
...
static inline ::cordl_internals::intptr_t GetGenericParameterInfo(::System::RuntimeType*  type) ;
...
static inline bool is_subclass_of(::cordl_internals::intptr_t  childType, ::cordl_internals::intptr_t  baseType) ;
...
constexpr explicit RuntimeTypeHandle(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}
