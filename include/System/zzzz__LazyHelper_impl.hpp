...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Object* (*)(::System::Type*)>(&::System::LazyHelper::CreateViaDefaultConstructor)> {
...
::cordl_internals::setInstanceField<::System::LazyState, 0x10>(this, std::forward<::System::LazyState>(value));
}
constexpr ::System::LazyState& System::LazyHelper::__get__State_k__BackingField()  {
return ::cordl_internals::getInstanceField<::System::LazyState, 0x10>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Runtime::ExceptionServices::ExceptionDispatchInfo*> System::LazyHelper::__get__exceptionDispatch() const {
return ::cordl_internals::getInstanceField<::System::Runtime::ExceptionServices::ExceptionDispatchInfo*, 0x18>(this);
}
