...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::System::Text::DecoderNLS)]{};

/// @brief Field bits offset 0x30
 __declspec(property(get=__get_bits, put=__set_bits)) int32_t  bits;

/// @brief Field bitCount offset 0x34
 __declspec(property(get=__get_bitCount, put=__set_bitCount)) int32_t  bitCount;

/// @brief Field firstByte offset 0x38
...
// Ctor Parameters []
// @brief default ctor
 __UTF7Encoding__Decoder()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::System::Text::EncoderNLS)]{};

/// @brief Field bits offset 0x38
 __declspec(property(get=__get_bits, put=__set_bits)) int32_t  bits;

/// @brief Field bitCount offset 0x3c
 __declspec(property(get=__get_bitCount, put=__set_bitCount)) int32_t  bitCount;
...
// Ctor Parameters []
// @brief default ctor
 __UTF7Encoding__Encoder()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x10 - sizeof(::System::Text::DecoderFallback)]{};
...
// Ctor Parameters []
// @brief default ctor
 __UTF7Encoding__DecoderUTF7Fallback()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::System::Text::DecoderFallbackBuffer)]{};

/// @brief Field cFallback offset 0x20
 __declspec(property(get=__get_cFallback, put=__set_cFallback)) char16_t  cFallback;

/// @brief Field iCount offset 0x24
 __declspec(property(get=__get_iCount, put=__set_iCount)) int32_t  iCount;

/// @brief Field iSize offset 0x28
...
// Ctor Parameters []
// @brief default ctor
 __UTF7Encoding__DecoderUTF7FallbackBuffer()  = default;
public:
