...
constexpr ::cordl_internals::to_const_pointer<::System::Text::InternalDecoderBestFitFallback*> __get__oFallback() const;
...
// Ctor Parameters []
// @brief default ctor
 InternalDecoderBestFitFallbackBuffer()  = default;
public:
