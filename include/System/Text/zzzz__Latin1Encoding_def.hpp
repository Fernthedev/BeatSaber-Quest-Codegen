...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::System::Text::EncodingNLS)]{};
...
/// @brief Method .ctor addr 0x243882c size 0xc virtual false final false
inline void _ctor() ;
...
/// @brief Method .ctor addr 0x2438838 size 0x4c virtual false final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x2438884 size 0xe8 virtual true final true
inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method GetByteCount addr 0x243896c size 0x1fc virtual true final false
inline int32_t GetByteCount(::cordl_internals::Ptr<char16_t>  chars, int32_t  charCount, ::System::Text::EncoderNLS*  encoder) ;

/// @brief Method GetBytes addr 0x2438b68 size 0x354 virtual true final false
...
/// @brief Method GetCharCount addr 0x2438ebc size 0x8 virtual true final false
inline int32_t GetCharCount(::cordl_internals::Ptr<uint8_t>  bytes, int32_t  count, ::System::Text::DecoderNLS*  decoder) ;

/// @brief Method GetChars addr 0x2438ec4 size 0x74 virtual true final false
...
/// @brief Method GetMaxByteCount addr 0x2438f38 size 0x108 virtual true final false
inline int32_t GetMaxByteCount(int32_t  charCount) ;

/// @brief Method GetMaxCharCount addr 0x2439040 size 0x104 virtual true final false
inline int32_t GetMaxCharCount(int32_t  byteCount) ;

/// @brief Method GetBestFitUnicodeToBytesData addr 0x2439144 size 0x58 virtual true final false
