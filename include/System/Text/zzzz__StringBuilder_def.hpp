...
constexpr ::cordl_internals::to_const_pointer<::System::Text::StringBuilder*> __get_m_ChunkPrevious() const;
...
/// @brief Method .ctor addr 0x243925c size 0x64 virtual false final false
inline void _ctor() ;

static inline ::System::Text::StringBuilder* New_ctor(int32_t  capacity) ;

/// @brief Method .ctor addr 0x24392c0 size 0x8 virtual false final false
inline void _ctor(int32_t  capacity) ;

static inline ::System::Text::StringBuilder* New_ctor(::StringW  value) ;

/// @brief Method .ctor addr 0x243949c size 0x1c virtual false final false
inline void _ctor(::StringW  value) ;

static inline ::System::Text::StringBuilder* New_ctor(::StringW  value, int32_t  capacity) ;

/// @brief Method .ctor addr 0x24394b8 size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0x24394d4 size 0x25c virtual false final false
...
/// @brief Method .ctor addr 0x24392c8 size 0x1d4 virtual false final false
...
/// @brief Method .ctor addr 0x24397fc size 0x2fc virtual false final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x2439af8 size 0x148 virtual true final true
inline void System_Runtime_Serialization_ISerializable_GetObjectData(::System::Runtime::Serialization::SerializationInfo*  info, ::System::Runtime::Serialization::StreamingContext  context) ;

/// @brief Method get_Capacity addr 0x2439c40 size 0x24 virtual false final false
inline int32_t get_Capacity() ;

/// @brief Method set_Capacity addr 0x2439c64 size 0x17c virtual false final false
inline void set_Capacity(int32_t  value) ;

/// @brief Method get_MaxCapacity addr 0x2439dec size 0x8 virtual false final false
inline int32_t get_MaxCapacity() ;

/// @brief Method EnsureCapacity addr 0x2439df4 size 0xb8 virtual false final false
inline int32_t EnsureCapacity(int32_t  capacity) ;

/// @brief Method ToString addr 0x2439eac size 0x140 virtual true final false
inline ::StringW ToString() ;

/// @brief Method ToString addr 0x2439fec size 0x1d4 virtual false final false
inline ::StringW ToString(int32_t  startIndex, int32_t  length) ;

/// @brief Method Clear addr 0x243a398 size 0x1c virtual false final false
inline ::System::Text::StringBuilder* Clear() ;

/// @brief Method get_Length addr 0x2439de0 size 0xc virtual false final false
inline int32_t get_Length() ;

/// @brief Method set_Length addr 0x243a3b4 size 0x250 virtual false final false
inline void set_Length(int32_t  value) ;

/// @brief Method get_Chars addr 0x243a770 size 0x90 virtual false final false
inline char16_t get_Chars(int32_t  index) ;

/// @brief Method set_Chars addr 0x243a800 size 0xbc virtual false final false
inline void set_Chars(int32_t  index, char16_t  value) ;

/// @brief Method Append addr 0x243a604 size 0x144 virtual false final false
inline ::System::Text::StringBuilder* Append(char16_t  value, int32_t  repeatCount) ;

/// @brief Method Append addr 0x243aa5c size 0x14c virtual false final false
inline ::System::Text::StringBuilder* Append(::ArrayW<char16_t,::Array<char16_t>*>  value, int32_t  startIndex, int32_t  charCount) ;

/// @brief Method Append addr 0x243ad00 size 0x104 virtual false final false
inline ::System::Text::StringBuilder* Append(::StringW  value) ;

/// @brief Method AppendHelper addr 0x243ae04 size 0x38 virtual false final false
inline void AppendHelper(::StringW  value) ;

/// @brief Method Append addr 0x243ae3c size 0x144 virtual false final false
inline ::System::Text::StringBuilder* Append(::StringW  value, int32_t  startIndex, int32_t  count) ;

/// @brief Method Append addr 0x243af80 size 0x1c virtual false final false
inline ::System::Text::StringBuilder* Append(::System::Text::StringBuilder*  value) ;

/// @brief Method AppendCore addr 0x243af9c size 0x254 virtual false final false
inline ::System::Text::StringBuilder* AppendCore(::System::Text::StringBuilder*  value, int32_t  startIndex, int32_t  count) ;

/// @brief Method AppendLine addr 0x243b1f0 size 0x20 virtual false final false
inline ::System::Text::StringBuilder* AppendLine() ;

/// @brief Method AppendLine addr 0x243b210 size 0x24 virtual false final false
inline ::System::Text::StringBuilder* AppendLine(::StringW  value) ;

/// @brief Method CopyTo addr 0x243a1c0 size 0x1d8 virtual false final false
inline void CopyTo(int32_t  sourceIndex, ::System::Span_1<char16_t>  destination, int32_t  count) ;

/// @brief Method Remove addr 0x243b3a4 size 0x140 virtual false final false
inline ::System::Text::StringBuilder* Remove(int32_t  startIndex, int32_t  length) ;

/// @brief Method Append addr 0x243b634 size 0x38 virtual false final false
inline ::System::Text::StringBuilder* Append(bool  value) ;

/// @brief Method Append addr 0x243b66c size 0x50 virtual false final false
inline ::System::Text::StringBuilder* Append(char16_t  value) ;

/// @brief Method Append addr 0x243b6bc size 0x58 virtual false final false
inline ::System::Text::StringBuilder* Append(uint8_t  value) ;

/// @brief Method Append addr 0x243b714 size 0x58 virtual false final false
inline ::System::Text::StringBuilder* Append(int32_t  value) ;

/// @brief Method Append addr 0x243b76c size 0x58 virtual false final false
inline ::System::Text::StringBuilder* Append(int64_t  value) ;

/// @brief Method Append addr 0x243b7c4 size 0x58 virtual false final false
inline ::System::Text::StringBuilder* Append(double_t  value) ;

/// @brief Method Append addr 0x243b81c size 0x58 virtual false final false
...
/// @brief Method FormatError addr 0x243c8ac size 0x50 virtual false final false
static inline void FormatError() ;

/// @brief Method AppendFormatHelper addr 0x243bb68 size 0xb0c virtual false final false
...
/// @brief Method Replace addr 0x243c8fc size 0x10 virtual false final false
inline ::System::Text::StringBuilder* Replace(::StringW  oldValue, ::StringW  newValue) ;

/// @brief Method Replace addr 0x243c90c size 0x330 virtual false final false
inline ::System::Text::StringBuilder* Replace(::StringW  oldValue, ::StringW  newValue, int32_t  startIndex, int32_t  count) ;

/// @brief Method Append addr 0x243aba8 size 0x158 virtual false final false
inline ::System::Text::StringBuilder* Append(::cordl_internals::Ptr<char16_t>  value, int32_t  valueCount) ;

/// @brief Method Insert addr 0x243ba10 size 0xd4 virtual false final false
inline void Insert(int32_t  index, ::cordl_internals::Ptr<char16_t>  value, int32_t  valueCount) ;

/// @brief Method ReplaceAllInChunk addr 0x243cd14 size 0x1bc virtual false final false
...
/// @brief Method StartsWith addr 0x243cc3c size 0xd8 virtual false final false
inline bool StartsWith(::System::Text::StringBuilder*  chunk, int32_t  indexInChunk, int32_t  count, ::StringW  value) ;

/// @brief Method ReplaceInPlaceAtChunk addr 0x243d180 size 0x108 virtual false final false
...
/// @brief Method ThreadSafeCopy addr 0x2439730 size 0xcc virtual false final false
...
/// @brief Method ThreadSafeCopy addr 0x243b234 size 0x170 virtual false final false
...
/// @brief Method FindChunkForIndex addr 0x243a748 size 0x28 virtual false final false
inline ::System::Text::StringBuilder* FindChunkForIndex(int32_t  index) ;

/// @brief Method get_RemainingCurrentChunk addr 0x243d2c8 size 0xac virtual false final false
inline ::System::Span_1<char16_t> get_RemainingCurrentChunk() ;

/// @brief Method Next addr 0x243d288 size 0x40 virtual false final false
inline ::System::Text::StringBuilder* Next(::System::Text::StringBuilder*  chunk) ;

/// @brief Method ExpandByABlock addr 0x243a8bc size 0x1a0 virtual false final false
...
/// @brief Method .ctor addr 0x243d374 size 0x44 virtual false final false
inline void _ctor(::System::Text::StringBuilder*  from) ;

/// @brief Method MakeRoom addr 0x243ced0 size 0x2b0 virtual false final false
...
/// @brief Method .ctor addr 0x243d3b8 size 0x8c virtual false final false
inline void _ctor(int32_t  size, int32_t  maxCapacity, ::System::Text::StringBuilder*  previousBlock) ;

/// @brief Method Remove addr 0x243b4e4 size 0x150 virtual false final false
