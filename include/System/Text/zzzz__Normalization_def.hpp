...
static inline void load_normalization_resource(ByRef<::cordl_internals::intptr_t>  props, ByRef<::cordl_internals::intptr_t>  mappedChars, ByRef<::cordl_internals::intptr_t>  charMapIndex, ByRef<::cordl_internals::intptr_t>  helperIndex, ByRef<::cordl_internals::intptr_t>  mapIdxToComposite, ByRef<::cordl_internals::intptr_t>  combiningClass) ;
...
// Static field mappedChars

// Static field charMapIndex

// Static field helperIndex

// Static field mapIdxToComposite

// Static field combiningClass
