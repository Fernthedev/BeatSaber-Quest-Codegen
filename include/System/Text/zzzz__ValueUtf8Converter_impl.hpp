...
constexpr void System::Text::ValueUtf8Converter::__set__arrayToReturnToPool(::ArrayW<uint8_t,::Array<uint8_t>*>  value)  {
...
constexpr ::ArrayW<uint8_t,::Array<uint8_t>*>& System::Text::ValueUtf8Converter::__get__arrayToReturnToPool()  {
...
constexpr ::ArrayW<uint8_t,::Array<uint8_t>*> const& System::Text::ValueUtf8Converter::__get__arrayToReturnToPool() const {
return ::cordl_internals::getInstanceField<::ArrayW<uint8_t,::Array<uint8_t>*>, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void System::Text::ValueUtf8Converter::__set__bytes(::System::Span_1<uint8_t>  value)  {
::cordl_internals::setInstanceField<::System::Span_1<uint8_t>, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::System::Span_1<uint8_t>>(value));
}
constexpr ::System::Span_1<uint8_t>& System::Text::ValueUtf8Converter::__get__bytes()  {
return ::cordl_internals::getInstanceField<::System::Span_1<uint8_t>, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::System::Span_1<uint8_t> const& System::Text::ValueUtf8Converter::__get__bytes() const {
return ::cordl_internals::getInstanceField<::System::Span_1<uint8_t>, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
// Ctor Parameters [CppParam { name: "_arrayToReturnToPool", ty: "::ArrayW<uint8_t,::Array<uint8_t>*>", modifiers: "", def_value: Some("csnull") }, CppParam { name: "_bytes", ty: "::System::Span_1<uint8_t>", modifiers: "", def_value: Some("{}") }]
constexpr ::System::Text::ValueUtf8Converter::ValueUtf8Converter(::ArrayW<uint8_t,::Array<uint8_t>*>  _arrayToReturnToPool, ::System::Span_1<uint8_t>  _bytes) noexcept : ::bs_hook::ValueTypeWrapper<0x18>() {this->_arrayToReturnToPool = _arrayToReturnToPool;
this->_bytes = _bytes;
}
