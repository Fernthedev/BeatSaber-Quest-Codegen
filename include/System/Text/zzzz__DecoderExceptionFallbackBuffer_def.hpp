...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::System::Text::DecoderFallbackBuffer)]{};

 __declspec(property(get=get_Remaining)) int32_t  Remaining;

/// @brief Method Fallback addr 0x26310fc size 0x8 virtual true final false
inline bool Fallback(::ArrayW<uint8_t,::Array<uint8_t>*>  bytesUnknown, int32_t  index) ;

/// @brief Method GetNextChar addr 0x26312d8 size 0x8 virtual true final false
inline char16_t GetNextChar() ;

/// @brief Method get_Remaining addr 0x26312e0 size 0x8 virtual true final false
inline int32_t get_Remaining() ;

/// @brief Method Throw addr 0x2631104 size 0x1d4 virtual false final false
...
/// @brief Method .ctor addr 0x2631088 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 DecoderExceptionFallbackBuffer()  = default;
public:
