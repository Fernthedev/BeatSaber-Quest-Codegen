...
/// @brief Field _ignoreNextParen offset 0x90
...
constexpr ::cordl_internals::to_const_pointer<::System::Text::RegularExpressions::RegexNode*> __get__stack() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Text::RegularExpressions::RegexNode*> __get__group() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Text::RegularExpressions::RegexNode*> __get__alternation() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Text::RegularExpressions::RegexNode*> __get__concatenation() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Text::RegularExpressions::RegexNode*> __get__unit() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> __get__capnames() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> __get__capnamelist() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Text::RegularExpressions::RegexOptions>*> __get__optionsStack() const;
