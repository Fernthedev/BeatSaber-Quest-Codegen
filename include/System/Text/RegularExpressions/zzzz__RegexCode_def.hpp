...
/// @brief Field Nonboundary offset 0x0
static constexpr int32_t  Nonboundary{static_cast<int32_t>(0x11)};

/// @brief Field Beginning offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::System::Text::RegularExpressions::RegexBoyerMoore*> __get_BMPrefix() const;
...
/// @brief Method .ctor addr 0x295ec68 size 0xd0 virtual false final false
inline void _ctor(::ArrayW<int32_t,::Array<int32_t>*>  codes, ::System::Collections::Generic::List_1<::StringW>*  stringlist, int32_t  trackcount, ::System::Collections::Hashtable*  caps, int32_t  capsize, ::System::Text::RegularExpressions::RegexBoyerMoore*  bmPrefix, ::System::Nullable_1<::System::Text::RegularExpressions::RegexPrefix>  fcPrefix, int32_t  anchors, bool  rightToLeft) ;

/// @brief Method OpcodeBacktracks addr 0x295ed38 size 0x30 virtual false final false
