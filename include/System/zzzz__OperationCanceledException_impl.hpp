...
::cordl_internals::setInstanceField<::System::Threading::CancellationToken, 0x90>(this, std::forward<::System::Threading::CancellationToken>(value));
}
constexpr ::System::Threading::CancellationToken& System::OperationCanceledException::__get__cancellationToken()  {
return ::cordl_internals::getInstanceField<::System::Threading::CancellationToken, 0x90>(this);
}
