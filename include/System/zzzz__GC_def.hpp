...
static inline void GetMemoryInfo(ByRef<uint32_t>  highMemLoadThreshold, ByRef<uint64_t>  totalPhysicalMem, ByRef<uint32_t>  lastRecordedMemLoad, ByRef<::cordl_internals::uintptr_t>  lastRecordedHeapSize, ByRef<::cordl_internals::uintptr_t>  lastRecordedFragmentation) ;
...
// Static field EPHEMERON_TOMBSTONE
