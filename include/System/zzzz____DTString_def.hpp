...
struct CORDL_TYPE __DTString : public ::bs_hook::ValueTypeWrapper<0x28> {
public:
// Declarations
...
/// @brief Field Value offset 0x0
 __declspec(property(get=__get_Value, put=__set_Value)) ::System::ReadOnlySpan_1<char16_t>  Value;

/// @brief Field Index offset 0x10
 __declspec(property(get=__get_Index, put=__set_Index)) int32_t  Index;

/// @brief Field m_current offset 0x14
 __declspec(property(get=__get_m_current, put=__set_m_current)) char16_t  m_current;

/// @brief Field m_info offset 0x18
 __declspec(property(get=__get_m_info, put=__set_m_info)) ::System::Globalization::CompareInfo*  m_info;

/// @brief Field m_checkDigitToken offset 0x20
 __declspec(property(get=__get_m_checkDigitToken, put=__set_m_checkDigitToken)) bool  m_checkDigitToken;
...
constexpr ::System::ReadOnlySpan_1<char16_t>& __get_Value() ;

constexpr ::System::ReadOnlySpan_1<char16_t> const& __get_Value() const;
...
constexpr char16_t& __get_m_current() ;

constexpr char16_t const& __get_m_current() const;

constexpr void __set_m_info(::System::Globalization::CompareInfo*  value) ;

constexpr ::System::Globalization::CompareInfo* __get_m_info() ;

constexpr ::cordl_internals::to_const_pointer<::System::Globalization::CompareInfo*> __get_m_info() const;

constexpr void __set_m_checkDigitToken(bool  value) ;

constexpr bool& __get_m_checkDigitToken() ;

constexpr bool const& __get_m_checkDigitToken() const;
...
constexpr explicit __DTString(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x28>(instance) {
}
