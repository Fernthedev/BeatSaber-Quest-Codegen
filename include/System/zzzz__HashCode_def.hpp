...
struct CORDL_TYPE HashCode : public ::bs_hook::ValueTypeWrapper<0x20> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x20};

/// @brief Field _v1 offset 0x0
 __declspec(property(get=__get__v1, put=__set__v1)) uint32_t  _v1;

/// @brief Field _v2 offset 0x4
 __declspec(property(get=__get__v2, put=__set__v2)) uint32_t  _v2;

/// @brief Field _v3 offset 0x8
 __declspec(property(get=__get__v3, put=__set__v3)) uint32_t  _v3;

/// @brief Field _v4 offset 0xc
 __declspec(property(get=__get__v4, put=__set__v4)) uint32_t  _v4;

/// @brief Field _queue1 offset 0x10
 __declspec(property(get=__get__queue1, put=__set__queue1)) uint32_t  _queue1;

/// @brief Field _queue2 offset 0x14
 __declspec(property(get=__get__queue2, put=__set__queue2)) uint32_t  _queue2;

/// @brief Field _queue3 offset 0x18
 __declspec(property(get=__get__queue3, put=__set__queue3)) uint32_t  _queue3;

/// @brief Field _length offset 0x1c
 __declspec(property(get=__get__length, put=__set__length)) uint32_t  _length;
...
constexpr uint32_t& __get__v1() ;

constexpr uint32_t const& __get__v1() const;

constexpr void __set__v2(uint32_t  value) ;

constexpr uint32_t& __get__v2() ;

constexpr uint32_t const& __get__v2() const;

constexpr void __set__v3(uint32_t  value) ;

constexpr uint32_t& __get__v3() ;

constexpr uint32_t const& __get__v3() const;

constexpr void __set__v4(uint32_t  value) ;

constexpr uint32_t& __get__v4() ;

constexpr uint32_t const& __get__v4() const;

constexpr void __set__queue1(uint32_t  value) ;

constexpr uint32_t& __get__queue1() ;

constexpr uint32_t const& __get__queue1() const;

constexpr void __set__queue2(uint32_t  value) ;

constexpr uint32_t& __get__queue2() ;

constexpr uint32_t const& __get__queue2() const;

constexpr void __set__queue3(uint32_t  value) ;

constexpr uint32_t& __get__queue3() ;

constexpr uint32_t const& __get__queue3() const;

constexpr void __set__length(uint32_t  value) ;

constexpr uint32_t& __get__length() ;

constexpr uint32_t const& __get__length() const;
...
constexpr explicit HashCode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x20>(instance) {
}
