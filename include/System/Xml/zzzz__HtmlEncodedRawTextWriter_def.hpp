...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xe8 - sizeof(::System::Xml::XmlEncodedRawTextWriter)]{};

/// @brief Field elementScope offset 0xb8
 __declspec(property(get=__get_elementScope, put=__set_elementScope)) ::System::Xml::ByteStack*  elementScope;

/// @brief Field currentElementProperties offset 0xc0
...
/// @brief Field currentAttributeProperties offset 0xc4
...
/// @brief Field mediaType offset 0xd8
 __declspec(property(get=__get_mediaType, put=__set_mediaType)) ::StringW  mediaType;

/// @brief Field doNotEscapeUriAttributes offset 0xe0
...
// Ctor Parameters []
// @brief default ctor
 HtmlEncodedRawTextWriter()  = default;
public:
