...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::XmlDocument*> __get_ownerDoc() const;

constexpr void __set_next(::System::Xml::XmlName*  value) ;

constexpr ::System::Xml::XmlName* __get_next() ;

constexpr ::cordl_internals::to_const_pointer<::System::Xml::XmlName*> __get_next() const;
