...
/// @brief Method GetFullChars addr 0x28a68f8 size 0x214 virtual true final false
...
/// @brief Method .ctor addr 0x28a5fc4 size 0x4 virtual false final false
inline void _ctor() ;
