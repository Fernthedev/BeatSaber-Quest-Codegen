...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Xml::XmlRawWriterBase64Encoder::*)(::ArrayW<char16_t,::Array<char16_t>*>, int32_t, int32_t)>(&::System::Xml::XmlRawWriterBase64Encoder::WriteChars)> {
  constexpr static std::size_t size = 0x24;
...
::cordl_internals::setInstanceField<::System::Xml::XmlRawWriter*, 0x28>(this, std::forward<::System::Xml::XmlRawWriter*>(value));
}
constexpr ::System::Xml::XmlRawWriter* System::Xml::XmlRawWriterBase64Encoder::__get_rawWriter()  {
return ::cordl_internals::getInstanceField<::System::Xml::XmlRawWriter*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Xml::XmlRawWriter*> System::Xml::XmlRawWriterBase64Encoder::__get_rawWriter() const {
return ::cordl_internals::getInstanceField<::System::Xml::XmlRawWriter*, 0x28>(this);
}
