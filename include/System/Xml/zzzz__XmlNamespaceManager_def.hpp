...
struct CORDL_TYPE __XmlNamespaceManager__NamespaceDeclaration : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
...
/// @brief Field uri offset 0x8
 __declspec(property(get=__get_uri, put=__set_uri)) ::StringW  uri;

/// @brief Field scopeId offset 0x10
 __declspec(property(get=__get_scopeId, put=__set_scopeId)) int32_t  scopeId;

/// @brief Field previousNsIndex offset 0x14
 __declspec(property(get=__get_previousNsIndex, put=__set_previousNsIndex)) int32_t  previousNsIndex;
...
constexpr int32_t& __get_previousNsIndex() ;

constexpr int32_t const& __get_previousNsIndex() const;
...
constexpr explicit __XmlNamespaceManager__NamespaceDeclaration(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __XmlNamespaceManager__NamespaceDeclaration()  = default;
...
/// @brief Field nsdecls offset 0x10
 __declspec(property(get=__get_nsdecls, put=__set_nsdecls)) ::ArrayW<::System::Xml::__XmlNamespaceManager__NamespaceDeclaration,::Array<::System::Xml::__XmlNamespaceManager__NamespaceDeclaration>*>  nsdecls;

/// @brief Field lastDecl offset 0x18
...
/// @brief Field scopeId offset 0x28
 __declspec(property(get=__get_scopeId, put=__set_scopeId)) int32_t  scopeId;

/// @brief Field hashTable offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,int32_t>*> __get_hashTable() const;
