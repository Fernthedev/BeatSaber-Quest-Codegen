...
/// @brief Method .ctor addr 0x28819a4 size 0x110 virtual false final false
...
/// @brief Method .ctor addr 0x2881b8c size 0x3c virtual false final false
inline void _ctor(::StringW  prefix, ::StringW  localName, ::StringW  namespaceURI, ::System::Xml::XmlDocument*  doc) ;

/// @brief Method get_XmlName addr 0x2881ce4 size 0x8 virtual false final false
inline ::System::Xml::XmlName* get_XmlName() ;

/// @brief Method set_XmlName addr 0x2881cec size 0x8 virtual false final false
inline void set_XmlName(::System::Xml::XmlName*  value) ;

/// @brief Method CloneNode addr 0x2881cf4 size 0xc8 virtual true final false
inline ::System::Xml::XmlNode* CloneNode(bool  deep) ;

/// @brief Method get_ParentNode addr 0x2881dbc size 0x8 virtual true final false
inline ::System::Xml::XmlNode* get_ParentNode() ;

/// @brief Method get_Name addr 0x2881dc4 size 0x1c virtual true final false
inline ::StringW get_Name() ;

/// @brief Method get_LocalName addr 0x2881de0 size 0x1c virtual true final false
inline ::StringW get_LocalName() ;

/// @brief Method get_NamespaceURI addr 0x2881dfc size 0x1c virtual true final false
inline ::StringW get_NamespaceURI() ;

/// @brief Method get_Prefix addr 0x2881e18 size 0x1c virtual true final false
inline ::StringW get_Prefix() ;

/// @brief Method get_NodeType addr 0x2881e34 size 0x8 virtual true final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method get_OwnerDocument addr 0x2881e3c size 0x1c virtual true final false
inline ::System::Xml::XmlDocument* get_OwnerDocument() ;

/// @brief Method get_Value addr 0x2881e58 size 0x10 virtual true final false
inline ::StringW get_Value() ;

/// @brief Method set_Value addr 0x2881e68 size 0x10 virtual true final false
inline void set_Value(::StringW  value) ;

/// @brief Method set_InnerText addr 0x2881e78 size 0x64 virtual true final false
inline void set_InnerText(::StringW  value) ;

/// @brief Method PrepareOwnerElementInElementIdAttrMap addr 0x2881edc size 0xb0 virtual false final false
inline bool PrepareOwnerElementInElementIdAttrMap() ;

/// @brief Method ResetOwnerElementInElementIdAttrMap addr 0x2881f8c size 0x7c virtual false final false
inline void ResetOwnerElementInElementIdAttrMap(::StringW  oldInnerText) ;

/// @brief Method get_IsContainer addr 0x28821bc size 0x8 virtual true final false
inline bool get_IsContainer() ;

/// @brief Method AppendChildForLoad addr 0x28821c4 size 0x168 virtual true final false
inline ::System::Xml::XmlNode* AppendChildForLoad(::System::Xml::XmlNode*  newChild, ::System::Xml::XmlDocument*  doc) ;

/// @brief Method get_LastNode addr 0x28823e8 size 0x8 virtual true final false
inline ::System::Xml::XmlLinkedNode* get_LastNode() ;

/// @brief Method set_LastNode addr 0x28823f0 size 0x8 virtual true final false
inline void set_LastNode(::System::Xml::XmlLinkedNode*  value) ;

/// @brief Method IsValidChildType addr 0x28823f8 size 0x18 virtual true final false
inline bool IsValidChildType(::System::Xml::XmlNodeType  type) ;

/// @brief Method get_Specified addr 0x2882410 size 0x8 virtual true final false
inline bool get_Specified() ;

/// @brief Method RemoveChild addr 0x2882418 size 0x78 virtual true final false
inline ::System::Xml::XmlNode* RemoveChild(::System::Xml::XmlNode*  oldChild) ;

/// @brief Method AppendChild addr 0x2882490 size 0x78 virtual true final false
inline ::System::Xml::XmlNode* AppendChild(::System::Xml::XmlNode*  newChild) ;

/// @brief Method get_OwnerElement addr 0x2882508 size 0x7c virtual true final false
inline ::System::Xml::XmlElement* get_OwnerElement() ;

/// @brief Method set_InnerXml addr 0x2882584 size 0x8c virtual true final false
inline void set_InnerXml(::StringW  value) ;

/// @brief Method get_BaseURI addr 0x2882610 size 0x98 virtual true final false
inline ::StringW get_BaseURI() ;

/// @brief Method SetParent addr 0x28826a8 size 0x8 virtual true final false
