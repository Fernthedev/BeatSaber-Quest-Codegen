...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x68 - sizeof(::System::Xml::XmlName)]{};

/// @brief Field flags offset 0x48
 __declspec(property(get=__get_flags, put=__set_flags)) uint8_t  flags;

/// @brief Field memberType offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get_decl() const;
