...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::System::Xml::XmlNode)]{};
...
/// @brief Method .ctor addr 0x288d2bc size 0x68 virtual false final false
inline void _ctor(::StringW  name, ::StringW  publicId, ::StringW  systemId, ::System::Xml::XmlDocument*  doc) ;

/// @brief Method get_Name addr 0x2891980 size 0x8 virtual true final false
inline ::StringW get_Name() ;

/// @brief Method get_LocalName addr 0x2891988 size 0x8 virtual true final false
inline ::StringW get_LocalName() ;

/// @brief Method get_NodeType addr 0x2891990 size 0x8 virtual true final false
inline ::System::Xml::XmlNodeType get_NodeType() ;

/// @brief Method CloneNode addr 0x2891998 size 0x60 virtual true final false
inline ::System::Xml::XmlNode* CloneNode(bool  deep) ;

/// @brief Method get_IsReadOnly addr 0x28919f8 size 0x8 virtual true final false
inline bool get_IsReadOnly() ;

/// @brief Method set_InnerXml addr 0x2891a00 size 0x60 virtual true final false
