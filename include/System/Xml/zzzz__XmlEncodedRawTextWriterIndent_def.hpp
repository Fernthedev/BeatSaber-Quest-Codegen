...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xe0 - sizeof(::System::Xml::XmlEncodedRawTextWriter)]{};

/// @brief Field indentLevel offset 0xb8
 __declspec(property(get=__get_indentLevel, put=__set_indentLevel)) int32_t  indentLevel;

/// @brief Field newLineOnAttributes offset 0xbc
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::BitStack*> __get_mixedContentStack() const;
...
/// @brief Method .ctor addr 0x28586c8 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x2858804 size 0x28 virtual false final false
inline void _ctor(::System::IO::Stream*  stream, ::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method WriteDocType addr 0x285882c size 0x60 virtual true final false
inline void WriteDocType(::StringW  name, ::StringW  pubid, ::StringW  sysid, ::StringW  subset) ;

/// @brief Method WriteStartElement addr 0x28588d4 size 0x98 virtual true final false
inline void WriteStartElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method StartElementContent addr 0x285896c size 0x44 virtual true final false
inline void StartElementContent() ;

/// @brief Method OnRootElement addr 0x28589b0 size 0x8 virtual true final false
inline void OnRootElement(::System::Xml::ConformanceLevel  currentConformanceLevel) ;

/// @brief Method WriteEndElement addr 0x28589b8 size 0x98 virtual true final false
inline void WriteEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteFullEndElement addr 0x2858a50 size 0x98 virtual true final false
inline void WriteFullEndElement(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteStartAttribute addr 0x2858ae8 size 0x3c virtual true final false
inline void WriteStartAttribute(::StringW  prefix, ::StringW  localName, ::StringW  ns) ;

/// @brief Method WriteCData addr 0x2858b24 size 0xc virtual true final false
inline void WriteCData(::StringW  text) ;

/// @brief Method WriteComment addr 0x2858b30 size 0x40 virtual true final false
inline void WriteComment(::StringW  text) ;

/// @brief Method WriteProcessingInstruction addr 0x2858b70 size 0x48 virtual true final false
inline void WriteProcessingInstruction(::StringW  target, ::StringW  text) ;

/// @brief Method WriteEntityRef addr 0x2858bb8 size 0xc virtual true final false
inline void WriteEntityRef(::StringW  name) ;

/// @brief Method WriteCharEntity addr 0x2858bc4 size 0xc virtual true final false
inline void WriteCharEntity(char16_t  ch) ;

/// @brief Method WriteSurrogateCharEntity addr 0x2858bd0 size 0xc virtual true final false
inline void WriteSurrogateCharEntity(char16_t  lowChar, char16_t  highChar) ;

/// @brief Method WriteWhitespace addr 0x2858bdc size 0xc virtual true final false
inline void WriteWhitespace(::StringW  ws) ;

/// @brief Method WriteString addr 0x2858be8 size 0xc virtual true final false
inline void WriteString(::StringW  text) ;

/// @brief Method WriteChars addr 0x2858bf4 size 0xc virtual true final false
inline void WriteChars(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteRaw addr 0x2858c00 size 0xc virtual true final false
inline void WriteRaw(::ArrayW<char16_t,::Array<char16_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method WriteRaw addr 0x2858c0c size 0xc virtual true final false
inline void WriteRaw(::StringW  data) ;

/// @brief Method WriteBase64 addr 0x2858c18 size 0xc virtual true final false
inline void WriteBase64(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  index, int32_t  count) ;

/// @brief Method Init addr 0x28586f0 size 0x114 virtual false final false
inline void Init(::System::Xml::XmlWriterSettings*  settings) ;

/// @brief Method WriteIndent addr 0x285888c size 0x48 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 XmlEncodedRawTextWriterIndent()  = default;
public:
