...
/// @brief Field preserveWhitespace offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::XmlDocument*> __get_doc() const;

constexpr void __set_reader(::System::Xml::XmlReader*  value) ;

constexpr ::System::Xml::XmlReader* __get_reader() ;

constexpr ::cordl_internals::to_const_pointer<::System::Xml::XmlReader*> __get_reader() const;
