...
struct CORDL_TYPE __DtdParser__Token : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____DtdParser__Token_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __DtdParser__Token(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __DtdParser__Token()  = default;
...
struct CORDL_TYPE __DtdParser__ScanningFunction : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____DtdParser__ScanningFunction_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __DtdParser__ScanningFunction(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __DtdParser__ScanningFunction()  = default;
...
struct CORDL_TYPE __DtdParser__LiteralType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____DtdParser__LiteralType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __DtdParser__LiteralType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __DtdParser__LiteralType()  = default;
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::__DtdParser__UndeclaredNotation*> __get_next() const;
...
// Ctor Parameters []
// @brief default ctor
 __DtdParser__UndeclaredNotation()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __DtdParser__ParseElementOnlyContent_LocalFrame()  = default;
public:
...
/// @brief Field nextScaningFunction offset 0x64
...
/// @brief Field savedScanningFunction offset 0x68
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::IDtdParserAdapter*> __get_readerAdapter() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::IDtdParserAdapterWithValidation*> __get_readerAdapterWithValidation() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Text::StringBuilder*> __get_internalSubsetValueSb() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::System::Xml::__DtdParser__UndeclaredNotation*>*> __get_undeclaredNotations() const;
