...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::XmlRawWriterBase64Encoder*> __get_base64Encoder() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::IXmlNamespaceResolver*> __get_resolver() const;
