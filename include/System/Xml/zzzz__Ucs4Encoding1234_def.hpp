...
/// @brief Method .ctor addr 0x28a5dd4 size 0x68 virtual false final false
inline void _ctor() ;

/// @brief Method get_EncodingName addr 0x28a5fc8 size 0x40 virtual true final false
inline ::StringW get_EncodingName() ;

/// @brief Method GetPreamble addr 0x28a6008 size 0x78 virtual true final false
