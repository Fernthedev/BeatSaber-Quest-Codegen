...
/// @brief Field <a>5__2 offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Linq::XAttribute*> __get___2__current() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Linq::XElement*> __get___4__this() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Linq::XName*> __get___3__name() const;

constexpr void __set__a_5__2(::System::Xml::Linq::XAttribute*  value) ;

constexpr ::System::Xml::Linq::XAttribute* __get__a_5__2() ;

constexpr ::cordl_internals::to_const_pointer<::System::Xml::Linq::XAttribute*> __get__a_5__2() const;
...
// Ctor Parameters []
// @brief default ctor
 __XElement___GetAttributes_d__116()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::System::Xml::Linq::XContainer)]{};

/// @brief Field name offset 0x30
 __declspec(property(get=__get_name, put=__set_name)) ::System::Xml::Linq::XName*  name;

/// @brief Field lastAttr offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Linq::XAttribute*> __get_lastAttr() const;
