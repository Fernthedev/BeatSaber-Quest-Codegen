...
/// @brief Method ConstructPos addr 0x28aec54 size 0x9c virtual true final false
...
/// @brief Method get_IsNullable addr 0x28aecf0 size 0x8 virtual true final false
inline bool get_IsNullable() ;

static inline ::System::Xml::Schema::StarNode* New_ctor() ;

/// @brief Method .ctor addr 0x28aecf8 size 0x8 virtual false final false
inline void _ctor() ;
