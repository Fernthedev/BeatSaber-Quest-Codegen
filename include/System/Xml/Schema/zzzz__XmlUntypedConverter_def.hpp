...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::System::Xml::Schema::XmlListConverter)]{};

/// @brief Field allowListToList offset 0x30
...
// Ctor Parameters []
// @brief default ctor
 XmlUntypedConverter()  = default;
public:


// Fields

// Static field Untyped

// Static field UntypedList
