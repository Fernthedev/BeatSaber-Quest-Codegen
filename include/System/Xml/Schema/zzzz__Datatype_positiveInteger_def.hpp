...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::System::Xml::Schema::Datatype_nonNegativeInteger)]{};
...
/// @brief Method get_FacetsChecker addr 0x28be810 size 0x58 virtual true final false
inline ::System::Xml::Schema::FacetsChecker* get_FacetsChecker() ;

/// @brief Method get_TypeCode addr 0x28be868 size 0x8 virtual true final false
inline ::System::Xml::Schema::XmlTypeCode get_TypeCode() ;

static inline ::System::Xml::Schema::Datatype_positiveInteger* New_ctor() ;

/// @brief Method .ctor addr 0x28be870 size 0x54 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 Datatype_positiveInteger()  = default;
public:
