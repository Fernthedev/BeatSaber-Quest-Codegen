...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::System::Xml::Schema::ContentValidator)]{};
...
/// @brief Method .ctor addr 0x28b0ab0 size 0xbc virtual false final false
