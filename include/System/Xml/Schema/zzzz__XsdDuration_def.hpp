...
struct CORDL_TYPE __XsdDuration__Parts : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____XsdDuration__Parts_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __XsdDuration__Parts(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __XsdDuration__Parts()  = default;
...
struct CORDL_TYPE __XsdDuration__DurationType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____XsdDuration__DurationType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __XsdDuration__DurationType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __XsdDuration__DurationType()  = default;
...
struct CORDL_TYPE XsdDuration : public ::bs_hook::ValueTypeWrapper<0x1c> {
public:
// Declarations
...
/// @brief Field years offset 0x0
 __declspec(property(get=__get_years, put=__set_years)) int32_t  years;

/// @brief Field months offset 0x4
 __declspec(property(get=__get_months, put=__set_months)) int32_t  months;

/// @brief Field days offset 0x8
 __declspec(property(get=__get_days, put=__set_days)) int32_t  days;

/// @brief Field hours offset 0xc
 __declspec(property(get=__get_hours, put=__set_hours)) int32_t  hours;

/// @brief Field minutes offset 0x10
 __declspec(property(get=__get_minutes, put=__set_minutes)) int32_t  minutes;

/// @brief Field seconds offset 0x14
 __declspec(property(get=__get_seconds, put=__set_seconds)) int32_t  seconds;

/// @brief Field nanoseconds offset 0x18
 __declspec(property(get=__get_nanoseconds, put=__set_nanoseconds)) uint32_t  nanoseconds;
...
constexpr int32_t& __get_years() ;

constexpr int32_t const& __get_years() const;

constexpr void __set_months(int32_t  value) ;

constexpr int32_t& __get_months() ;

constexpr int32_t const& __get_months() const;

constexpr void __set_days(int32_t  value) ;

constexpr int32_t& __get_days() ;

constexpr int32_t const& __get_days() const;

constexpr void __set_hours(int32_t  value) ;

constexpr int32_t& __get_hours() ;

constexpr int32_t const& __get_hours() const;

constexpr void __set_minutes(int32_t  value) ;

constexpr int32_t& __get_minutes() ;

constexpr int32_t const& __get_minutes() const;

constexpr void __set_seconds(int32_t  value) ;

constexpr int32_t& __get_seconds() ;

constexpr int32_t const& __get_seconds() const;

constexpr void __set_nanoseconds(uint32_t  value) ;

constexpr uint32_t& __get_nanoseconds() ;

constexpr uint32_t const& __get_nanoseconds() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit XsdDuration(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x1c>(instance) {
}
