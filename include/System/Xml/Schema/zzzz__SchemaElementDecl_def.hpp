...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x90 - sizeof(::System::Xml::Schema::SchemaDeclBase)]{};

/// @brief Field attdefs offset 0x60
...
/// @brief Field defaultAttdefs offset 0x68
...
/// @brief Field isIdDeclared offset 0x70
 __declspec(property(get=__get_isIdDeclared, put=__set_isIdDeclared)) bool  isIdDeclared;

/// @brief Field hasNonCDataAttribute offset 0x71
 __declspec(property(get=__get_hasNonCDataAttribute, put=__set_hasNonCDataAttribute)) bool  hasNonCDataAttribute;

/// @brief Field hasRequiredAttribute offset 0x72
 __declspec(property(get=__get_hasRequiredAttribute, put=__set_hasRequiredAttribute)) bool  hasRequiredAttribute;

/// @brief Field isNotationDeclared offset 0x73
 __declspec(property(get=__get_isNotationDeclared, put=__set_isNotationDeclared)) bool  isNotationDeclared;

/// @brief Field prohibitedAttributes offset 0x78
 __declspec(property(get=__get_prohibitedAttributes, put=__set_prohibitedAttributes)) ::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Xml::XmlQualifiedName*>*  prohibitedAttributes;

/// @brief Field contentValidator offset 0x80
...
/// @brief Field anyAttribute offset 0x88
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Xml::Schema::SchemaAttDef*>*> __get_attdefs() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Xml::IDtdDefaultAttributeInfo*>*> __get_defaultAttdefs() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::Xml::XmlQualifiedName*,::System::Xml::XmlQualifiedName*>*> __get_prohibitedAttributes() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Schema::ContentValidator*> __get_contentValidator() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Schema::XmlSchemaAnyAttribute*> __get_anyAttribute() const;
