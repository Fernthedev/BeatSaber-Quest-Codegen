...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::System::Xml::Schema::Datatype_NMTOKEN)]{};

 __declspec(property(get=get_TokenizedType)) ::System::Xml::XmlTokenizedType  TokenizedType;

/// @brief Method get_TokenizedType addr 0x28bf3bc size 0x8 virtual true final false
inline ::System::Xml::XmlTokenizedType get_TokenizedType() ;

static inline ::System::Xml::Schema::Datatype_ENUMERATION* New_ctor() ;

/// @brief Method .ctor addr 0x28bf3c4 size 0x4 virtual false final false
inline void _ctor() ;
