...
/// @brief Field message offset 0xb8
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Schema::XmlSchemaObject*> __get_sourceSchemaObject() const;
