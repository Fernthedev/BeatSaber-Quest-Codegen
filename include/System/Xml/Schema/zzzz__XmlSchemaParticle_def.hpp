...
struct CORDL_TYPE __XmlSchemaParticle__Occurs : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____XmlSchemaParticle__Occurs_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __XmlSchemaParticle__Occurs(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __XmlSchemaParticle__Occurs()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::System::Xml::Schema::XmlSchemaAnnotated)]{};

/// @brief Field minOccurs offset 0x10
 __declspec(property(get=__get_minOccurs, put=__set_minOccurs)) ::System::Decimal  minOccurs;

/// @brief Field maxOccurs offset 0x20
