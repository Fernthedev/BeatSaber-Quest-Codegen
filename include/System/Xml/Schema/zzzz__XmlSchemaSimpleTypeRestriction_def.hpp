...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::System::Xml::Schema::XmlSchemaSimpleTypeContent)]{};

/// @brief Field baseTypeName offset 0x10
 __declspec(property(get=__get_baseTypeName, put=__set_baseTypeName)) ::System::Xml::XmlQualifiedName*  baseTypeName;

/// @brief Field facets offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::XmlQualifiedName*> __get_baseTypeName() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Schema::XmlSchemaObjectCollection*> __get_facets() const;
...
// Ctor Parameters []
// @brief default ctor
 XmlSchemaSimpleTypeRestriction()  = default;
public:
