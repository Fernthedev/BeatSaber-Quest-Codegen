...
/// @brief Method get_TypeCode addr 0x28b9fec size 0x8 virtual true final false
inline ::System::Xml::Schema::XmlTypeCode get_TypeCode() ;

static inline ::System::Xml::Schema::Datatype_date* New_ctor() ;

/// @brief Method .ctor addr 0x28b9ff4 size 0x58 virtual false final false
inline void _ctor() ;
