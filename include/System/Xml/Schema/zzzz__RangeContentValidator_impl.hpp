...
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Schema::BitSet*> System::Xml::Schema::RangeContentValidator::__get_firstpos() const {
return ::cordl_internals::getInstanceField<::System::Xml::Schema::BitSet*, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::System::Xml::Schema::BitSet*, 0x28>(this, std::forward<::System::Xml::Schema::BitSet*>(value));
}
constexpr ::System::Xml::Schema::BitSet* System::Xml::Schema::RangeContentValidator::__get_positionsWithRangeTerminals()  {
return ::cordl_internals::getInstanceField<::System::Xml::Schema::BitSet*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Schema::BitSet*> System::Xml::Schema::RangeContentValidator::__get_positionsWithRangeTerminals() const {
return ::cordl_internals::getInstanceField<::System::Xml::Schema::BitSet*, 0x28>(this);
}
constexpr void System::Xml::Schema::RangeContentValidator::__set_symbols(::System::Xml::Schema::SymbolsDictionary*  value)  {
::cordl_internals::setInstanceField<::System::Xml::Schema::SymbolsDictionary*, 0x30>(this, std::forward<::System::Xml::Schema::SymbolsDictionary*>(value));
}
constexpr ::System::Xml::Schema::SymbolsDictionary* System::Xml::Schema::RangeContentValidator::__get_symbols()  {
return ::cordl_internals::getInstanceField<::System::Xml::Schema::SymbolsDictionary*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Schema::SymbolsDictionary*> System::Xml::Schema::RangeContentValidator::__get_symbols() const {
return ::cordl_internals::getInstanceField<::System::Xml::Schema::SymbolsDictionary*, 0x30>(this);
}
constexpr void System::Xml::Schema::RangeContentValidator::__set_positions(::System::Xml::Schema::Positions*  value)  {
::cordl_internals::setInstanceField<::System::Xml::Schema::Positions*, 0x38>(this, std::forward<::System::Xml::Schema::Positions*>(value));
}
constexpr ::System::Xml::Schema::Positions* System::Xml::Schema::RangeContentValidator::__get_positions()  {
return ::cordl_internals::getInstanceField<::System::Xml::Schema::Positions*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Xml::Schema::Positions*> System::Xml::Schema::RangeContentValidator::__get_positions() const {
return ::cordl_internals::getInstanceField<::System::Xml::Schema::Positions*, 0x38>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::System::Xml::Schema::RangeContentValidator*>(firstpos, followpos, symbols, positions, endMarkerPos, contentType, isEmptiable, positionsWithRangeTerminals, minmaxNodesCount));
}
