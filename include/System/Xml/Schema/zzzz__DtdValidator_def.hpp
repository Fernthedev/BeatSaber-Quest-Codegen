...
/// @brief Method LookupNamespace addr 0x28c092c size 0x8 virtual true final false
inline ::StringW LookupNamespace(::StringW  prefix) ;

static inline ::System::Xml::Schema::__DtdValidator__NamespaceManager* New_ctor() ;

/// @brief Method .ctor addr 0x28c0924 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __DtdValidator__NamespaceManager()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x10 - sizeof(::System::Xml::Schema::BaseValidator)]{};
...
/// @brief Method SetDefaultTypedValue addr 0x28c047c size 0x3dc virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 DtdValidator()  = default;
public:


// Fields

// Static field namespaceManager
