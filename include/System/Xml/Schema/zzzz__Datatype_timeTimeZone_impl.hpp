...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Xml::Schema::Datatype_timeTimeZone::*)()>(&::System::Xml::Schema::Datatype_timeTimeZone::_ctor)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x28b9f34;
...
return THROW_UNLESS(::il2cpp_utils::New<::System::Xml::Schema::Datatype_timeTimeZone*>());
}
