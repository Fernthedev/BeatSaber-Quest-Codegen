...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x50 - sizeof(::System::Xml::Schema::XmlSchemaParticle)]{};

/// @brief Field ns offset 0x38
 __declspec(property(get=__get_ns, put=__set_ns)) ::StringW  ns;

/// @brief Field processContents offset 0x40
...
/// @brief Field namespaceList offset 0x48
