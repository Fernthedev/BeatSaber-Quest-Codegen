...
// Ctor Parameters []
// @brief default ctor
 __FtpWebResponse__EmptyStream()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::IO::Stream*> __get__responseStream() const;
