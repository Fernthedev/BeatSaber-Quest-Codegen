...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> __get_prefixes() const;

constexpr void __set_unhandled(::System::Collections::ArrayList*  value) ;

constexpr ::System::Collections::ArrayList* __get_unhandled() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get_unhandled() const;

constexpr void __set_all(::System::Collections::ArrayList*  value) ;

constexpr ::System::Collections::ArrayList* __get_all() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get_all() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::Net::HttpConnection*,::System::Net::HttpConnection*>*> __get_unregistered() const;
