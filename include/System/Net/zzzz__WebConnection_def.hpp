...
struct CORDL_TYPE __WebConnection___Connect_d__16 : public ::bs_hook::ValueTypeWrapper<0x60> {
public:
// Declarations
...
/// @brief Field <>4__this offset 0x20
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::System::Net::WebConnection*  __4__this;

/// @brief Field operation offset 0x28
 __declspec(property(get=__get_operation, put=__set_operation)) ::System::Net::WebOperation*  operation;
...
/// @brief Field <connectException>5__2 offset 0x38
 __declspec(property(get=__get__connectException_5__2, put=__set__connectException_5__2)) ::System::Exception*  _connectException_5__2;

/// @brief Field <>7__wrap2 offset 0x40
 __declspec(property(get=__get___7__wrap2, put=__set___7__wrap2)) ::ArrayW<::System::Net::IPAddress*,::Array<::System::Net::IPAddress*>*>  __7__wrap2;
...
constexpr ::System::Net::WebConnection* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::System::Net::WebConnection*> __get___4__this() const;

constexpr void __set_operation(::System::Net::WebOperation*  value) ;

constexpr ::System::Net::WebOperation* __get_operation() ;

constexpr ::cordl_internals::to_const_pointer<::System::Net::WebOperation*> __get_operation() const;
...
constexpr ::System::Exception* __get__connectException_5__2() ;

constexpr ::cordl_internals::to_const_pointer<::System::Exception*> __get__connectException_5__2() const;

constexpr void __set___7__wrap2(::ArrayW<::System::Net::IPAddress*,::Array<::System::Net::IPAddress*>*>  value) ;

constexpr ::ArrayW<::System::Net::IPAddress*,::Array<::System::Net::IPAddress*>*>& __get___7__wrap2() ;

constexpr ::ArrayW<::System::Net::IPAddress*,::Array<::System::Net::IPAddress*>*> const& __get___7__wrap2() const;
...
constexpr explicit __WebConnection___Connect_d__16(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x60>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __WebConnection___Connect_d__16()  = default;
...
struct CORDL_TYPE __WebConnection___CreateStream_d__18 : public ::bs_hook::ValueTypeWrapper<0x68> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field reused offset 0x30
 __declspec(property(get=__get_reused, put=__set_reused)) bool  reused;

/// @brief Field cancellationToken offset 0x38
 __declspec(property(get=__get_cancellationToken, put=__set_cancellationToken)) ::System::Threading::CancellationToken  cancellationToken;

/// @brief Field <stream>5__2 offset 0x40
 __declspec(property(get=__get__stream_5__2, put=__set__stream_5__2)) ::System::Net::Sockets::NetworkStream*  _stream_5__2;
...
constexpr bool& __get_reused() ;

constexpr bool const& __get_reused() const;
...
constexpr ::System::Net::Sockets::NetworkStream* __get__stream_5__2() ;

constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::NetworkStream*> __get__stream_5__2() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __WebConnection___CreateStream_d__18(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x68>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __WebConnection___CreateStream_d__18()  = default;
...
struct CORDL_TYPE __WebConnection___InitConnection_d__19 : public ::bs_hook::ValueTypeWrapper<0x60> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x60};
...
/// @brief Field <>t__builder offset 0x8
 __declspec(property(get=__get___t__builder, put=__set___t__builder)) ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::System::Net::WebRequestStream*>  __t__builder;

/// @brief Field operation offset 0x20
 __declspec(property(get=__get_operation, put=__set_operation)) ::System::Net::WebOperation*  operation;
...
/// @brief Field <reused>5__2 offset 0x38
 __declspec(property(get=__get__reused_5__2, put=__set__reused_5__2)) bool  _reused_5__2;

/// @brief Field <>u__1 offset 0x40
 __declspec(property(get=__get___u__1, put=__set___u__1)) ::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable__ConfiguredTaskAwaiter  __u__1;

/// @brief Field <>u__2 offset 0x50
 __declspec(property(get=__get___u__2, put=__set___u__2)) ::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<bool>  __u__2;
...
constexpr ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::System::Net::WebRequestStream*>& __get___t__builder() ;

constexpr ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::System::Net::WebRequestStream*> const& __get___t__builder() const;
...
constexpr bool& __get__reused_5__2() ;

constexpr bool const& __get__reused_5__2() const;
...
constexpr void __set___u__2(::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<bool>  value) ;

constexpr ::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<bool>& __get___u__2() ;

constexpr ::System::Runtime::CompilerServices::__ConfiguredTaskAwaitable_1__ConfiguredTaskAwaiter<bool> const& __get___u__2() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __WebConnection___InitConnection_d__19(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x60>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __WebConnection___InitConnection_d__19()  = default;
...
/// @brief Field <ServicePoint>k__BackingField offset 0x48
...
/// @brief Field currentOperation offset 0x58
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::NetworkCredential*> __get_ntlm_credentials() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::IO::Stream*> __get_networkStream() const;

constexpr void __set_socket(::System::Net::Sockets::Socket*  value) ;

constexpr ::System::Net::Sockets::Socket* __get_socket() ;

constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::Socket*> __get_socket() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Net::Security::MonoTlsStream*> __get_monoTlsStream() const;
