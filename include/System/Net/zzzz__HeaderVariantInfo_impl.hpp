...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::System::Net::HeaderVariantInfo::*)(::StringW, ::System::Net::CookieVariant)>(&::System::Net::HeaderVariantInfo::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x29aee20;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::System::Net::HeaderVariantInfo::*)()>(&::System::Net::HeaderVariantInfo::get_Name)> {
  ...
  constexpr static std::size_t addrs = 0x29aee2c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Net::CookieVariant (::System::Net::HeaderVariantInfo::*)()>(&::System::Net::HeaderVariantInfo::get_Variant)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x29aee34;
...
constexpr ::StringW& System::Net::HeaderVariantInfo::__get_m_name()  {
return ::cordl_internals::getInstanceField<::StringW, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::StringW const& System::Net::HeaderVariantInfo::__get_m_name() const {
return ::cordl_internals::getInstanceField<::StringW, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void System::Net::HeaderVariantInfo::__set_m_variant(::System::Net::CookieVariant  value)  {
::cordl_internals::setInstanceField<::System::Net::CookieVariant, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::System::Net::CookieVariant>(value));
}
constexpr ::System::Net::CookieVariant& System::Net::HeaderVariantInfo::__get_m_variant()  {
return ::cordl_internals::getInstanceField<::System::Net::CookieVariant, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::System::Net::CookieVariant const& System::Net::HeaderVariantInfo::__get_m_variant() const {
return ::cordl_internals::getInstanceField<::System::Net::CookieVariant, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::System::Net::HeaderVariantInfo::HeaderVariantInfo(::StringW  m_name, ::System::Net::CookieVariant  m_variant) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->m_name = m_name;
