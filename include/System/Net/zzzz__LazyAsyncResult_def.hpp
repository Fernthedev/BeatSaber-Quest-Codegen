...
/// @brief Field m_NestedIOCount offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __LazyAsyncResult__ThreadContext()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get_m_AsyncObject() const;

constexpr void __set_m_AsyncState(::System::Object*  value) ;

constexpr ::System::Object* __get_m_AsyncState() ;

constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get_m_AsyncState() const;

constexpr void __set_m_AsyncCallback(::System::AsyncCallback*  value) ;

constexpr ::System::AsyncCallback* __get_m_AsyncCallback() ;

constexpr ::cordl_internals::to_const_pointer<::System::AsyncCallback*> __get_m_AsyncCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get_m_Event() const;
...
inline void ProtectedInvokeCallback(::System::Object*  result, ::cordl_internals::intptr_t  userToken) ;
...
// Ctor Parameters []
// @brief default ctor
 LazyAsyncResult()  = default;
public:


// Fields

// Static field t_ThreadContext
