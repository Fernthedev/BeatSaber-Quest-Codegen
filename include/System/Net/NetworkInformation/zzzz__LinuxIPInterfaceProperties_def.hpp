...
/// @brief Method .ctor addr 0x29eda80 size 0x70 virtual false final false
...
/// @brief Method ParseRouteInfo addr 0x29edaf0 size 0x488 virtual false final false
inline ::System::Net::NetworkInformation::IPAddressCollection* ParseRouteInfo(::StringW  iface) ;

/// @brief Method get_GatewayAddresses addr 0x29edf78 size 0x3c virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 LinuxIPInterfaceProperties()  = default;
public:
