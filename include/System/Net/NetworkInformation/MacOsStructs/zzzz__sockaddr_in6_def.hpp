...
/// @brief Field sin6_addr offset 0x8
 __declspec(property(get=__get_sin6_addr, put=__set_sin6_addr)) ::System::Net::NetworkInformation::MacOsStructs::in6_addr  sin6_addr;
...
constexpr ::System::Net::NetworkInformation::MacOsStructs::in6_addr& __get_sin6_addr() ;

constexpr ::System::Net::NetworkInformation::MacOsStructs::in6_addr const& __get_sin6_addr() const;
