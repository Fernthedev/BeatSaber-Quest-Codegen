...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::StringW, ByRef<::ArrayW<::StringW,::Array<::StringW>*>>)>(&::System::Net::NetworkInformation::MacOsIPInterfaceProperties::ParseRouteInfo_icall)> {
...
return THROW_UNLESS(::il2cpp_utils::New<::System::Net::NetworkInformation::MacOsIPInterfaceProperties*>(iface, addresses));
}
