...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ObjectModel::Collection_1<::System::Net::NetworkInformation::GatewayIPAddressInformation*>*> __get_addresses() const;
...
// Ctor Parameters []
// @brief default ctor
 GatewayIPAddressInformationCollection()  = default;
public:
