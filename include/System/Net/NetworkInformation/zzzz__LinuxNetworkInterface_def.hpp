...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x50 - sizeof(::System::Net::NetworkInformation::UnixNetworkInterface)]{};

/// @brief Field iface_path offset 0x38
 __declspec(property(get=__get_iface_path, put=__set_iface_path)) ::StringW  iface_path;

/// @brief Field iface_operstate_path offset 0x40
 __declspec(property(get=__get_iface_operstate_path, put=__set_iface_operstate_path)) ::StringW  iface_operstate_path;

/// @brief Field iface_flags_path offset 0x48
