...
/// @brief Field sin_family offset 0x0
 __declspec(property(get=__get_sin_family, put=__set_sin_family)) uint16_t  sin_family;
...
constexpr void __set_sin_family(uint16_t  value) ;

constexpr uint16_t& __get_sin_family() ;

constexpr uint16_t const& __get_sin_family() const;
