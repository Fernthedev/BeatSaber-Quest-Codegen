...
/// @brief Field ifa_ifu offset 0x28
 __declspec(property(get=__get_ifa_ifu, put=__set_ifa_ifu)) ::System::Net::NetworkInformation::ifa_ifu  ifa_ifu;
...
constexpr ::System::Net::NetworkInformation::ifa_ifu& __get_ifa_ifu() ;

constexpr ::System::Net::NetworkInformation::ifa_ifu const& __get_ifa_ifu() const;
