...
struct CORDL_TYPE __ifreq_flags___ifr_name_e__FixedBuffer : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
constexpr explicit __ifreq_flags___ifr_name_e__FixedBuffer(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ifreq_flags___ifr_name_e__FixedBuffer()  = default;
...
struct CORDL_TYPE ifreq_flags : public ::bs_hook::ValueTypeWrapper<0x14> {
public:
// Declarations
...
/// @brief Field ifru_flags offset 0x10
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit ifreq_flags(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x14>(instance) {
}
