...
constexpr uint8_t& System::Net::NetworkInformation::AixStructs::sockaddr::__get_sa_len()  {
return ::cordl_internals::getInstanceField<uint8_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint8_t const& System::Net::NetworkInformation::AixStructs::sockaddr::__get_sa_len() const {
return ::cordl_internals::getInstanceField<uint8_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr uint8_t& System::Net::NetworkInformation::AixStructs::sockaddr::__get_sa_family()  {
return ::cordl_internals::getInstanceField<uint8_t, 0x1>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint8_t const& System::Net::NetworkInformation::AixStructs::sockaddr::__get_sa_family() const {
return ::cordl_internals::getInstanceField<uint8_t, 0x1>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::System::Net::NetworkInformation::AixStructs::sockaddr::sockaddr(uint8_t  sa_len, uint8_t  sa_family) noexcept : ::bs_hook::ValueTypeWrapper<0x2>() {this->sa_len = sa_len;
