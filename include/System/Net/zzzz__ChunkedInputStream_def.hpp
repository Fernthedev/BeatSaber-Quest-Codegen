...
constexpr ::cordl_internals::to_const_pointer<::System::Net::HttpStreamAsyncResult*> __get_Ares() const;
...
// Ctor Parameters []
// @brief default ctor
 __ChunkedInputStream__ReadBufferState()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::MonoChunkParser*> __get_decoder() const;
