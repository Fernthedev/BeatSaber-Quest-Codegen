...
struct CORDL_TYPE __FtpWebRequest__RequestStage : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____FtpWebRequest__RequestStage_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __FtpWebRequest__RequestStage(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __FtpWebRequest__RequestStage()  = default;
...
struct CORDL_TYPE __FtpWebRequest___CreateConnectionAsync_d__86 : public ::bs_hook::ValueTypeWrapper<0x48> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field <>4__this offset 0x28
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::System::Net::FtpWebRequest*  __4__this;

/// @brief Field <client>5__2 offset 0x30
 __declspec(property(get=__get__client_5__2, put=__set__client_5__2)) ::System::Net::Sockets::TcpClient*  _client_5__2;
...
constexpr ::System::Net::FtpWebRequest* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::System::Net::FtpWebRequest*> __get___4__this() const;

constexpr void __set__client_5__2(::System::Net::Sockets::TcpClient*  value) ;

constexpr ::System::Net::Sockets::TcpClient* __get__client_5__2() ;

constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::TcpClient*> __get__client_5__2() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __FtpWebRequest___CreateConnectionAsync_d__86(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x48>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __FtpWebRequest___CreateConnectionAsync_d__86()  = default;
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__syncObject() const;

constexpr void __set__authInfo(::System::Net::ICredentials*  value) ;

constexpr ::System::Net::ICredentials* __get__authInfo() ;

constexpr ::cordl_internals::to_const_pointer<::System::Net::ICredentials*> __get__authInfo() const;

constexpr void __set__uri(::System::Uri*  value) ;

constexpr ::System::Uri* __get__uri() ;

constexpr ::cordl_internals::to_const_pointer<::System::Uri*> __get__uri() const;

constexpr void __set__methodInfo(::System::Net::FtpMethodInfo*  value) ;

constexpr ::System::Net::FtpMethodInfo* __get__methodInfo() ;

constexpr ::cordl_internals::to_const_pointer<::System::Net::FtpMethodInfo*> __get__methodInfo() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Exception*> __get__exception() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::__TimerThread__Queue*> __get__timerQueue() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::__TimerThread__Callback*> __get__timerCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::FtpControlStream*> __get__connection() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::WebHeaderCollection*> __get__ftpRequestHeaders() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::FtpWebResponse*> __get__ftpWebResponse() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::ContextAwareResult*> __get__writeAsyncResult() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::LazyAsyncResult*> __get__readAsyncResult() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::LazyAsyncResult*> __get__requestCompleteAsyncResult() const;
...
// Ctor Parameters []
// @brief default ctor
 FtpWebRequest()  = default;
public:


// Fields

// Static field s_defaultFtpNetworkCredential
