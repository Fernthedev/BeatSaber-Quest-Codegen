...
/// @brief Method GetHashCode addr 0x29a26ec size 0x118 virtual true final true
inline int32_t GetHashCode(::System::Object*  myObject) ;

/// @brief Method Compare addr 0x29a2804 size 0x170 virtual true final true
inline int32_t Compare(::System::Object*  firstObject, ::System::Object*  secondObject) ;

/// @brief Method FastGetHashCode addr 0x29a2974 size 0xf0 virtual false final false
inline int32_t FastGetHashCode(::StringW  myString) ;

/// @brief Method Equals addr 0x29a2a64 size 0x178 virtual true final true
...
/// @brief Method .ctor addr 0x29a2bdc size 0x8 virtual false final false
inline void _ctor() ;
