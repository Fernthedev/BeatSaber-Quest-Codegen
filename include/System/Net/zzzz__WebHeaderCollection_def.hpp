...
struct CORDL_TYPE __WebHeaderCollection__RfcChar : public ::bs_hook::EnumTypeWrapper<0x1> {
public:
// Declarations
...
return std::bit_cast<____WebHeaderCollection__RfcChar_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x1>::instance);
}
...
constexpr explicit __WebHeaderCollection__RfcChar(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x1>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __WebHeaderCollection__RfcChar()  = default;
...
/// @brief Field m_Type offset 0x78
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Specialized::NameValueCollection*> __get_m_InnerCollection() const;
...
/// @brief Method NormalizeCommonHeaders addr 0x299fd38 size 0x100 virtual false final false
inline void NormalizeCommonHeaders() ;

/// @brief Method get_InnerCollection addr 0x299fe38 size 0xa4 virtual false final false
inline ::System::Collections::Specialized::NameValueCollection* get_InnerCollection() ;

/// @brief Method AllowMultiValues addr 0x299fedc size 0xa8 virtual false final false
static inline bool AllowMultiValues(::StringW  name) ;

/// @brief Method get_AllowHttpRequestHeader addr 0x29a0060 size 0x38 virtual false final false
inline bool get_AllowHttpRequestHeader() ;

/// @brief Method Remove addr 0x29a0098 size 0xf8 virtual false final false
inline void Remove(::System::Net::HttpRequestHeader  header) ;

/// @brief Method AddInternal addr 0x29a0190 size 0x54 virtual false final false
inline void AddInternal(::StringW  name, ::StringW  value) ;

/// @brief Method ChangeInternal addr 0x29a01e4 size 0x54 virtual false final false
inline void ChangeInternal(::StringW  name, ::StringW  value) ;

/// @brief Method RemoveInternal addr 0x29a0238 size 0x5c virtual false final false
inline void RemoveInternal(::StringW  name) ;

/// @brief Method CheckBadChars addr 0x29a0294 size 0x394 virtual false final false
static inline ::StringW CheckBadChars(::StringW  name, bool  isHeaderValue) ;

/// @brief Method ContainsNonAsciiChars addr 0x29a0628 size 0x84 virtual false final false
static inline bool ContainsNonAsciiChars(::StringW  token) ;

/// @brief Method ThrowOnRestrictedHeader addr 0x29a06ac size 0x168 virtual false final false
inline void ThrowOnRestrictedHeader(::StringW  headerName) ;

/// @brief Method Add addr 0x29a0814 size 0x1b4 virtual true final false
inline void Add(::StringW  name, ::StringW  value) ;

/// @brief Method Add addr 0x29a09c8 size 0x2dc virtual false final false
inline void Add(::StringW  header) ;

/// @brief Method Set addr 0x29a0ca4 size 0x230 virtual true final false
inline void Set(::StringW  name, ::StringW  value) ;

/// @brief Method SetInternal addr 0x29a0ed4 size 0x224 virtual false final false
inline void SetInternal(::StringW  name, ::StringW  value) ;

/// @brief Method Remove addr 0x29a10f8 size 0x13c virtual true final false
inline void Remove(::StringW  name) ;

/// @brief Method GetValues addr 0x29a1234 size 0x208 virtual true final false
inline ::ArrayW<::StringW,::Array<::StringW>*> GetValues(::StringW  header) ;

/// @brief Method ToString addr 0x29a143c size 0x5c virtual true final false
inline ::StringW ToString() ;

/// @brief Method GetAsString addr 0x29a1498 size 0x2a4 virtual false final false
...
/// @brief Method .ctor addr 0x29a173c size 0x64 virtual false final false
inline void _ctor() ;

static inline ::System::Net::WebHeaderCollection* New_ctor(::System::Net::WebHeaderCollectionType  type) ;

/// @brief Method .ctor addr 0x29a17a0 size 0xe4 virtual false final false
...
/// @brief Method .ctor addr 0x29a1884 size 0x1c4 virtual false final false
inline void _ctor(::System::Runtime::Serialization::SerializationInfo*  serializationInfo, ::System::Runtime::Serialization::StreamingContext  streamingContext) ;

/// @brief Method OnDeserialization addr 0x29a1a48 size 0x4 virtual true final false
inline void OnDeserialization(::System::Object*  sender) ;

/// @brief Method GetObjectData addr 0x29a1a4c size 0x180 virtual true final false
inline void GetObjectData(::System::Runtime::Serialization::SerializationInfo*  serializationInfo, ::System::Runtime::Serialization::StreamingContext  streamingContext) ;

/// @brief Method System.Runtime.Serialization.ISerializable.GetObjectData addr 0x29a1bcc size 0xc virtual true final true
...
/// @brief Method Get addr 0x29a1bd8 size 0x328 virtual true final false
inline ::StringW Get(::StringW  name) ;

/// @brief Method GetEnumerator addr 0x29a1f00 size 0x7c virtual true final false
inline ::System::Collections::IEnumerator* GetEnumerator() ;

/// @brief Method get_Count addr 0x29a1f7c size 0x30 virtual true final false
inline int32_t get_Count() ;

/// @brief Method Get addr 0x29a1fac size 0x40 virtual true final false
inline ::StringW Get(int32_t  index) ;

/// @brief Method GetValues addr 0x29a1fec size 0x40 virtual true final false
inline ::ArrayW<::StringW,::Array<::StringW>*> GetValues(int32_t  index) ;

/// @brief Method GetKey addr 0x29a202c size 0x40 virtual true final false
...
// Static field s_CommonHeaderNames

// Static field s_CommonHeaderHints

// Static field HttpTrimCharacters

// Static field RfcCharMap
