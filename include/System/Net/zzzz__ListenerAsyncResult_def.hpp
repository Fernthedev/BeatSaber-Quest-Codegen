...
/// @brief Field exception offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::ManualResetEvent*> __get_handle() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Exception*> __get_exception() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::ListenerAsyncResult*> __get_forward() const;
...
// Ctor Parameters []
// @brief default ctor
 ListenerAsyncResult()  = default;
public:


// Fields

// Static field InvokeCB
