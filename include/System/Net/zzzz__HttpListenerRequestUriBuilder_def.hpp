...
struct CORDL_TYPE __HttpListenerRequestUriBuilder__ParsingResult : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____HttpListenerRequestUriBuilder__ParsingResult_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __HttpListenerRequestUriBuilder__ParsingResult(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HttpListenerRequestUriBuilder__ParsingResult()  = default;
...
struct CORDL_TYPE __HttpListenerRequestUriBuilder__EncodingType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____HttpListenerRequestUriBuilder__EncodingType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HttpListenerRequestUriBuilder__EncodingType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HttpListenerRequestUriBuilder__EncodingType()  = default;
...
constexpr ::cordl_internals::to_const_pointer<::System::Text::StringBuilder*> __get_requestUriString() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<uint8_t>*> __get_rawOctets() const;
...
// Ctor Parameters []
// @brief default ctor
 HttpListenerRequestUriBuilder()  = default;
public:


// Fields

// Static field useCookedRequestUrl

// Static field utf8Encoding

// Static field ansiEncoding
