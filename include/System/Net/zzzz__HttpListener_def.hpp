...
/// @brief Field extendedProtectionPolicy offset 0x80
 __declspec(property(get=__get_extendedProtectionPolicy, put=__set_extendedProtectionPolicy)) ::System::Security::Authentication::ExtendedProtection::ExtendedProtectionPolicy*  extendedProtectionPolicy;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::Interface::MonoTlsProvider*> __get_tlsProvider() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::HttpListenerPrefixCollection*> __get_prefixes() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::AuthenticationSchemeSelector*> __get_auth_selector() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__internalLock() const;

constexpr void __set_registry(::System::Collections::Hashtable*  value) ;

constexpr ::System::Collections::Hashtable* __get_registry() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> __get_registry() const;

constexpr void __set_ctx_queue(::System::Collections::ArrayList*  value) ;

constexpr ::System::Collections::ArrayList* __get_ctx_queue() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get_ctx_queue() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get_wait_queue() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::ServiceNameStore*> __get_defaultServiceNames() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Authentication::ExtendedProtection::ExtendedProtectionPolicy*> __get_extendedProtectionPolicy() const;
