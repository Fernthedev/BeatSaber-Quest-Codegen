...
/// @brief Method get_AddressFamily addr 0x299b6d4 size 0x28 virtual true final false
inline ::System::Net::Sockets::AddressFamily get_AddressFamily() ;

/// @brief Method Serialize addr 0x299b6fc size 0x28 virtual true final false
inline ::System::Net::SocketAddress* Serialize() ;

/// @brief Method Create addr 0x299b724 size 0x28 virtual true final false
inline ::System::Net::EndPoint* Create(::System::Net::SocketAddress*  socketAddress) ;

static inline ::System::Net::EndPoint* New_ctor() ;

/// @brief Method .ctor addr 0x298c710 size 0x8 virtual false final false
inline void _ctor() ;
