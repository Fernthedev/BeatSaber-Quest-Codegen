...
/// @brief Field m_fqdnMyDomain offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Hashtable*> __get_m_domainTable() const;
