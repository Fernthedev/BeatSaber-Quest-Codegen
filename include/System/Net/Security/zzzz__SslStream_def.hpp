...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Security::LocalCertificateSelectionCallback*> __get_callback() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Security::SslStream*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __SslStream____c__DisplayClass21_0()  = default;
public:
...
/// @brief Field selectionCallback offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Security::RemoteCertificateValidationCallback*> __get_validationCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Security::LocalCertificateSelectionCallback*> __get_selectionCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Net::Security::MobileAuthenticatedStream*> __get_impl() const;
