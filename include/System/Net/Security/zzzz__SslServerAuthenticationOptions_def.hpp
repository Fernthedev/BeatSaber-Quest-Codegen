...
/// @brief Field _checkCertificateRevocation offset 0x10
...
/// @brief Field _enabledSslProtocols offset 0x14
...
/// @brief Field _encryptionPolicy offset 0x18
...
/// @brief Field <ClientCertificateRequired>k__BackingField offset 0x1d
...
/// @brief Field <ServerCertificate>k__BackingField offset 0x20
 __declspec(property(get=__get__ServerCertificate_k__BackingField, put=__set__ServerCertificate_k__BackingField)) ::System::Security::Cryptography::X509Certificates::X509Certificate*  _ServerCertificate_k__BackingField;
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::X509Certificates::X509Certificate*> __get__ServerCertificate_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 SslServerAuthenticationOptions()  = default;
public:
