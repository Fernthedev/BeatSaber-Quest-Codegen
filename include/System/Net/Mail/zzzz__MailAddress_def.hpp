...
/// @brief Field _displayNameEncoding offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Text::Encoding*> __get__displayNameEncoding() const;
