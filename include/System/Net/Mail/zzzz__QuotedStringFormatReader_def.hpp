...
/// @brief Method ReadReverseQuoted addr 0x2902da8 size 0x1cc virtual false final false
static inline int32_t ReadReverseQuoted(::StringW  data, int32_t  index, bool  permitUnicode) ;

/// @brief Method ReadReverseUnQuoted addr 0x2902f74 size 0x1a0 virtual false final false
static inline int32_t ReadReverseUnQuoted(::StringW  data, int32_t  index, bool  permitUnicode, bool  expectCommaDelimiter) ;

/// @brief Method IsValidQtext addr 0x29031b8 size 0xb8 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 QuotedStringFormatReader()  = default;
public:
