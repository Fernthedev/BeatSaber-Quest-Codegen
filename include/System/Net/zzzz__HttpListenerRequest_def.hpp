...
constexpr ::cordl_internals::to_const_pointer<::System::Net::CookieCollection*> __get_cookies() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::IO::Stream*> __get_input_stream() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Specialized::NameValueCollection*> __get_query_string() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Uri*> __get_url() const;

constexpr void __set_referrer(::System::Uri*  value) ;

constexpr ::System::Uri* __get_referrer() ;

constexpr ::cordl_internals::to_const_pointer<::System::Uri*> __get_referrer() const;
...
// Ctor Parameters []
// @brief default ctor
 HttpListenerRequest()  = default;
public:


// Fields

// Static field _100continue
