...
// Ctor Parameters []
// @brief default ctor
 __Parser__DateTime____c()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __Parser__EmailAddress()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __Parser__TimeSpanSeconds()  = default;
public:
