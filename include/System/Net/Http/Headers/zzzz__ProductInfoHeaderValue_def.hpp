...
/// @brief Field <Comment>k__BackingField offset 0x10
...
/// @brief Field <Product>k__BackingField offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Http::Headers::ProductHeaderValue*> __get__Product_k__BackingField() const;
