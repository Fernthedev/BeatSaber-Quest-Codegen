...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(14674))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14674), inst: 2 })
// CS Name: ::System.Net.Http.Headers::HttpHeaderValueCollection`1<T>*
class CORDL_TYPE HttpHeaderValueCollection_1<T> : public ::System::Object {
public:
// Declarations
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<T>*> __get_list() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Http::Headers::HttpHeaders*> __get_headers() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Http::Headers::HeaderInfo*> __get_headerInfo() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> __get_invalidValues() const;
...
// Ctor Parameters []
// @brief default ctor
 HttpHeaderValueCollection_1()  = default;
public:
