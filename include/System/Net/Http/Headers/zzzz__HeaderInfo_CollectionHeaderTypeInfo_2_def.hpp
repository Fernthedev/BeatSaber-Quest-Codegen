...
class __HeaderInfo__CollectionHeaderTypeInfo_2<T,U>;
}
// Write type traits
...
template<::il2cpp_utils::il2cpp_reference_type T,::il2cpp_utils::il2cpp_reference_type U>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14670)), TypeDefinitionIndex(TypeDefinitionIndex(14669)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14669), inst: 2613 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14670), inst: 81 })
// CS Name: ::HeaderInfo::CollectionHeaderTypeInfo`2<T,U>*
class CORDL_TYPE __HeaderInfo__CollectionHeaderTypeInfo_2<T,U> : public ::System::Net::Http::Headers::__HeaderInfo__HeaderTypeInfo_2<T,U> {
public:
// Declarations
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::System::Net::Http::Headers::__HeaderInfo__HeaderTypeInfo_2<T,U>)]{};

/// @brief Field minimalCount offset 0x30
 __declspec(property(get=__get_minimalCount, put=__set_minimalCount)) int32_t  minimalCount;

/// @brief Field separator offset 0x38
 __declspec(property(get=__get_separator, put=__set_separator)) ::StringW  separator;

/// @brief Field parser offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Http::Headers::TryParseListDelegate_1<T>*> __get_parser() const;
...
// Ctor Parameters []
// @brief default ctor
 __HeaderInfo__CollectionHeaderTypeInfo_2()  = default;
public:
