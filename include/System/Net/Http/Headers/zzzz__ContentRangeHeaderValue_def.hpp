...
/// @brief Field unit offset 0x10
 __declspec(property(get=__get_unit, put=__set_unit)) ::StringW  unit;

/// @brief Field <From>k__BackingField offset 0x18
...
/// @brief Field <Length>k__BackingField offset 0x28
...
/// @brief Field <To>k__BackingField offset 0x38
