...
::cordl_internals::setInstanceField<::System::Net::ResponseDescription*, 0x10>(this, std::forward<::System::Net::ResponseDescription*>(value));
}
constexpr ::System::Net::ResponseDescription* System::Net::ReceiveState::__get_Resp()  {
return ::cordl_internals::getInstanceField<::System::Net::ResponseDescription*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Net::ResponseDescription*> System::Net::ReceiveState::__get_Resp() const {
return ::cordl_internals::getInstanceField<::System::Net::ResponseDescription*, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::System::Net::CommandStream*, 0x28>(this, std::forward<::System::Net::CommandStream*>(value));
}
constexpr ::System::Net::CommandStream* System::Net::ReceiveState::__get_Connection()  {
return ::cordl_internals::getInstanceField<::System::Net::CommandStream*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Net::CommandStream*> System::Net::ReceiveState::__get_Connection() const {
return ::cordl_internals::getInstanceField<::System::Net::CommandStream*, 0x28>(this);
}
