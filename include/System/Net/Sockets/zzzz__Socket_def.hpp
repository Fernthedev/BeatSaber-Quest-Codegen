...
class __Socket__TaskSocketAsyncEventArgs_1<TResult>;
}
namespace System::Net::Sockets {
template<>
class __Socket__TaskSocketAsyncEventArgs_1<int32_t>;
}
namespace System::Net::Sockets {
class __Socket____c;
}
...
/// @brief Field TaskAccept offset 0x10
...
/// @brief Field TaskReceive offset 0x18
...
/// @brief Field TaskSend offset 0x20
...
/// @brief Field ValueTaskReceive offset 0x28
...
/// @brief Field ValueTaskSend offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::__Socket__TaskSocketAsyncEventArgs_1<::System::Net::Sockets::Socket*>*> __get_TaskAccept() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::__Socket__Int32TaskSocketAsyncEventArgs*> __get_TaskReceive() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::__Socket__Int32TaskSocketAsyncEventArgs*> __get_TaskSend() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::__Socket__AwaitableSocketAsyncEventArgs*> __get_ValueTaskReceive() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::__Socket__AwaitableSocketAsyncEventArgs*> __get_ValueTaskSend() const;
...
// Ctor Parameters []
// @brief default ctor
 __Socket__CachedEventArgs()  = default;
public:
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(9326)), TypeDefinitionIndex(TypeDefinitionIndex(9357))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9326), inst: 98 })
// CS Name: ::Socket::TaskSocketAsyncEventArgs`1<TResult>*
class CORDL_TYPE __Socket__TaskSocketAsyncEventArgs_1<int32_t> : public ::System::Net::Sockets::SocketAsyncEventArgs {
public:
// Declarations
/// @brief The size of the true reference type
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xd8 - sizeof(::System::Net::Sockets::SocketAsyncEventArgs)]{};

/// @brief Field _builder offset 0xb8
 __declspec(property(get=__get__builder, put=__set__builder)) ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<int32_t>  _builder;

/// @brief Field _accessed offset 0xd0
...
constexpr ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<int32_t>& __get__builder() ;

constexpr ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<int32_t> const& __get__builder() const;
...
static inline ::System::Net::Sockets::__Socket__TaskSocketAsyncEventArgs_1<int32_t>* New_ctor() ;

/// @brief Method .ctor addr 0x0 size 0xffffffffffffffff virtual false final false
inline void _ctor() ;

/// @brief Method GetCompletionResponsibility addr 0x0 size 0xffffffffffffffff virtual false final false
inline ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<int32_t> GetCompletionResponsibility(ByRef<bool>  responsibleForReturningToPool) ;
...
// Ctor Parameters []
// @brief default ctor
 __Socket__TaskSocketAsyncEventArgs_1()  = default;
public:
...
template<::il2cpp_utils::il2cpp_reference_type TResult>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(9357)), TypeDefinitionIndex(TypeDefinitionIndex(9326))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9326), inst: 2 })
// CS Name: ::Socket::TaskSocketAsyncEventArgs`1<TResult>*
class CORDL_TYPE __Socket__TaskSocketAsyncEventArgs_1<TResult> : public ::System::Net::Sockets::SocketAsyncEventArgs {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __IL2CPP_REFERENCE_TYPE_SIZE{0xd8};
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xd8 - sizeof(::System::Net::Sockets::__Socket__TaskSocketAsyncEventArgs_1<int32_t>)]{};

/// @brief Field _wrapExceptionsInIOExceptions offset 0xd1
...
// Ctor Parameters []
// @brief default ctor
 __Socket__Int32TaskSocketAsyncEventArgs()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __Socket__AwaitableSocketAsyncEventArgs____c()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::System::Object*>*> __get__continuation() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__scheduler() const;
...
// Ctor Parameters []
// @brief default ctor
 __Socket__AwaitableSocketAsyncEventArgs()  = default;
public:


// Fields

// Static field Reserved

// Static field s_completedSentinel

// Static field s_availableSentinel
...
struct CORDL_TYPE __Socket__WSABUF : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x10};

/// @brief Field len offset 0x0
 __declspec(property(get=__get_len, put=__set_len)) int32_t  len;

/// @brief Field buf offset 0x8
 __declspec(property(get=__get_buf, put=__set_buf)) ::cordl_internals::intptr_t  buf;
...
constexpr ::cordl_internals::intptr_t& __get_buf() ;

constexpr ::cordl_internals::intptr_t const& __get_buf() const;
...
constexpr __Socket__WSABUF(int32_t  len, ::cordl_internals::intptr_t  buf) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Socket__WSABUF(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Socket__WSABUF()  = default;
...
// Static field <>9__22_0

// Static field <>9__22_1

// Static field <>9__23_0

// Static field <>9__23_1

// Static field <>9__295_0

// Static field <>9__297_0
...
/// @brief Field sockares offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::SocketAsyncResult*> __get_sockares() const;
...
// Ctor Parameters []
// @brief default ctor
 __Socket____c__DisplayClass240_0()  = default;
public:
...
/// @brief Field sent_so_far offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __Socket____c__DisplayClass298_0()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::Socket*> __get___4__this() const;

constexpr void __set_job(::System::IOSelectorJob*  value) ;

constexpr ::System::IOSelectorJob* __get_job() ;

constexpr ::cordl_internals::to_const_pointer<::System::IOSelectorJob*> __get_job() const;
...
// Ctor Parameters []
// @brief default ctor
 __Socket____c__DisplayClass355_0()  = default;
public:
...
/// @brief Field _cachedTaskEventArgs offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::__Socket__CachedEventArgs*> __get__cachedTaskEventArgs() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::SafeSocketHandle*> __get_m_Handle() const;

constexpr void __set_seed_endpoint(::System::Net::EndPoint*  value) ;

constexpr ::System::Net::EndPoint* __get_seed_endpoint() ;

constexpr ::cordl_internals::to_const_pointer<::System::Net::EndPoint*> __get_seed_endpoint() const;

constexpr void __set_ReadSem(::System::Threading::SemaphoreSlim*  value) ;

constexpr ::System::Threading::SemaphoreSlim* __get_ReadSem() ;

constexpr ::cordl_internals::to_const_pointer<::System::Threading::SemaphoreSlim*> __get_ReadSem() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::SemaphoreSlim*> __get_WriteSem() const;
...
static inline ::cordl_internals::intptr_t Socket_icall(::System::Net::Sockets::AddressFamily  family, ::System::Net::Sockets::SocketType  type, ::System::Net::Sockets::ProtocolType  proto, ByRef<int32_t>  error) ;
...
static inline int32_t Available_icall(::cordl_internals::intptr_t  socket, ByRef<int32_t>  error) ;
...
static inline ::System::Net::SocketAddress* LocalEndPoint_icall(::cordl_internals::intptr_t  socket, int32_t  family, ByRef<int32_t>  error) ;
...
static inline void Blocking_icall(::cordl_internals::intptr_t  socket, bool  block, ByRef<int32_t>  error) ;
...
static inline ::System::Net::SocketAddress* RemoteEndPoint_icall(::cordl_internals::intptr_t  socket, int32_t  family, ByRef<int32_t>  error) ;
...
static inline bool Poll_icall(::cordl_internals::intptr_t  socket, ::System::Net::Sockets::SelectMode  mode, int32_t  timeout, ByRef<int32_t>  error) ;
...
static inline ::cordl_internals::intptr_t Accept_icall(::cordl_internals::intptr_t  sock, ByRef<int32_t>  error, bool  blocking) ;
...
static inline void Bind_icall(::cordl_internals::intptr_t  sock, ::System::Net::SocketAddress*  sa, ByRef<int32_t>  error) ;
...
static inline void Listen_icall(::cordl_internals::intptr_t  sock, int32_t  backlog, ByRef<int32_t>  error) ;
...
static inline void Connect_icall(::cordl_internals::intptr_t  sock, ::System::Net::SocketAddress*  sa, ByRef<int32_t>  error, bool  blocking) ;
...
static inline void Disconnect_icall(::cordl_internals::intptr_t  sock, bool  reuse, ByRef<int32_t>  error) ;
...
static inline int32_t Receive_array_icall(::cordl_internals::intptr_t  sock, ::cordl_internals::Ptr<::System::Net::Sockets::__Socket__WSABUF>  bufarray, int32_t  count, ::System::Net::Sockets::SocketFlags  flags, ByRef<int32_t>  error, bool  blocking) ;
...
static inline int32_t Receive_icall(::cordl_internals::intptr_t  sock, ::cordl_internals::Ptr<uint8_t>  buffer, int32_t  count, ::System::Net::Sockets::SocketFlags  flags, ByRef<int32_t>  error, bool  blocking) ;
...
static inline int32_t ReceiveFrom_icall(::cordl_internals::intptr_t  sock, ::cordl_internals::Ptr<uint8_t>  buffer, int32_t  count, ::System::Net::Sockets::SocketFlags  flags, ByRef<::System::Net::SocketAddress*>  sockaddr, ByRef<int32_t>  error, bool  blocking) ;
...
static inline int32_t Send_array_icall(::cordl_internals::intptr_t  sock, ::cordl_internals::Ptr<::System::Net::Sockets::__Socket__WSABUF>  bufarray, int32_t  count, ::System::Net::Sockets::SocketFlags  flags, ByRef<int32_t>  error, bool  blocking) ;
...
static inline int32_t Send_icall(::cordl_internals::intptr_t  sock, ::cordl_internals::Ptr<uint8_t>  buffer, int32_t  count, ::System::Net::Sockets::SocketFlags  flags, ByRef<int32_t>  error, bool  blocking) ;
...
static inline int32_t SendTo_icall(::cordl_internals::intptr_t  sock, ::cordl_internals::Ptr<uint8_t>  buffer, int32_t  count, ::System::Net::Sockets::SocketFlags  flags, ::System::Net::SocketAddress*  sa, ByRef<int32_t>  error, bool  blocking) ;
...
static inline void GetSocketOption_obj_icall(::cordl_internals::intptr_t  socket, ::System::Net::Sockets::SocketOptionLevel  level, ::System::Net::Sockets::SocketOptionName  name, ByRef<::System::Object*>  obj_val, ByRef<int32_t>  error) ;
...
static inline void SetSocketOption_icall(::cordl_internals::intptr_t  socket, ::System::Net::Sockets::SocketOptionLevel  level, ::System::Net::Sockets::SocketOptionName  name, ::System::Object*  obj_val, ::ArrayW<uint8_t,::Array<uint8_t>*>  byte_val, int32_t  int_val, ByRef<int32_t>  error) ;
...
static inline int32_t IOControl_icall(::cordl_internals::intptr_t  sock, int32_t  ioctl_code, ::ArrayW<uint8_t,::Array<uint8_t>*>  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, ByRef<int32_t>  error) ;
...
static inline void Close_icall(::cordl_internals::intptr_t  socket, ByRef<int32_t>  error) ;
...
static inline void Shutdown_icall(::cordl_internals::intptr_t  socket, ::System::Net::Sockets::SocketShutdown  how, ByRef<int32_t>  error) ;
...
inline void Linger(::cordl_internals::intptr_t  handle) ;
...
inline void QueueIOSelectorJob(::System::Threading::SemaphoreSlim*  sem, ::cordl_internals::intptr_t  handle, ::System::IOSelectorJob*  job) ;
...
// Static field AcceptCompletedHandler

// Static field ReceiveCompletedHandler

// Static field SendCompletedHandler

// Static field s_rentedSocketSentinel

// Static field s_rentedInt32Sentinel

// Static field s_zeroTask

// Static field s_InternalSyncObject

// Static field s_SupportsIPv4

// Static field s_SupportsIPv6

// Static field s_OSSupportsIPv6

// Static field s_Initialized

// Static field s_LoggingEnabled

// Static field s_PerfCountersEnabled

// Static field AcceptAsyncCallback

// Static field BeginAcceptCallback

// Static field BeginAcceptReceiveCallback

// Static field ConnectAsyncCallback

// Static field BeginConnectCallback

// Static field DisconnectAsyncCallback

// Static field BeginDisconnectCallback

// Static field ReceiveAsyncCallback

// Static field BeginReceiveCallback

// Static field BeginReceiveGenericCallback

// Static field ReceiveFromAsyncCallback

// Static field BeginReceiveFromCallback

// Static field SendAsyncCallback

// Static field BeginSendGenericCallback

// Static field SendToAsyncCallback
