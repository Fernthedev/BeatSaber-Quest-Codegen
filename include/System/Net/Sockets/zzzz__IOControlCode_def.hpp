...
struct CORDL_TYPE IOControlCode : public ::bs_hook::EnumTypeWrapper<0x8> {
public:
// Declarations
...
return std::bit_cast<__IOControlCode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x8>::instance);
}
...
constexpr explicit IOControlCode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 IOControlCode()  = default;
