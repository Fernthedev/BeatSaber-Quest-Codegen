...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::Socket*> __get_m_ClientSocket() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::NetworkStream*> __get_m_DataStream() const;
...
/// @brief Method .ctor addr 0x28fc678 size 0x20 virtual false final false
inline void _ctor() ;

static inline ::System::Net::Sockets::TcpClient* New_ctor(::System::Net::Sockets::AddressFamily  family) ;

/// @brief Method .ctor addr 0x28fc698 size 0x110 virtual false final false
...
/// @brief Method .ctor addr 0x28fc81c size 0x44 virtual false final false
inline void _ctor(::System::Net::Sockets::Socket*  acceptedSocket) ;

/// @brief Method get_Client addr 0x28fc860 size 0x8 virtual false final false
inline ::System::Net::Sockets::Socket* get_Client() ;

/// @brief Method set_Client addr 0x28fc868 size 0x8 virtual false final false
inline void set_Client(::System::Net::Sockets::Socket*  value) ;

/// @brief Method get_Connected addr 0x28fc870 size 0x1c virtual false final false
inline bool get_Connected() ;

/// @brief Method Connect addr 0x28fc88c size 0x6d0 virtual false final false
inline void Connect(::StringW  hostname, int32_t  port) ;

/// @brief Method Connect addr 0x28fcf5c size 0x10c virtual false final false
inline void Connect(::System::Net::IPEndPoint*  remoteEP) ;

/// @brief Method BeginConnect addr 0x28fd068 size 0x6c virtual false final false
...
/// @brief Method EndConnect addr 0x28fd0d4 size 0x48 virtual false final false
inline void EndConnect(::System::IAsyncResult*  asyncResult) ;

/// @brief Method ConnectAsync addr 0x28fd11c size 0x16c virtual false final false
inline ::System::Threading::Tasks::Task* ConnectAsync(::StringW  host, int32_t  port) ;

/// @brief Method GetStream addr 0x28fd288 size 0x14c virtual false final false
inline ::System::Net::Sockets::NetworkStream* GetStream() ;

/// @brief Method Close addr 0x28fd3d4 size 0xa4 virtual false final false
inline void Close() ;

/// @brief Method Dispose addr 0x28fd478 size 0x194 virtual true final false
inline void Dispose(bool  disposing) ;

/// @brief Method Dispose addr 0x28fd60c size 0x10 virtual true final true
inline void Dispose() ;

/// @brief Method Finalize addr 0x28fd61c size 0xa0 virtual true final false
inline void Finalize() ;

/// @brief Method initialize addr 0x28fc7a8 size 0x74 virtual false final false
