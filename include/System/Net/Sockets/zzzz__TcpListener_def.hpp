...
constexpr ::cordl_internals::to_const_pointer<::System::Net::IPEndPoint*> __get_m_ServerSocketEP() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::Socket*> __get_m_ServerSocket() const;
