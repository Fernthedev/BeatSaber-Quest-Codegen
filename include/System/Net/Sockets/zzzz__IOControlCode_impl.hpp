...
constexpr int64_t& System::Net::Sockets::IOControlCode::__get_value__()  {
return ::cordl_internals::getInstanceField<int64_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int64_t const& System::Net::Sockets::IOControlCode::__get_value__() const {
return ::cordl_internals::getInstanceField<int64_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "value__", ty: "int64_t", modifiers: "", def_value: Some("{}") }]
constexpr ::System::Net::Sockets::IOControlCode::IOControlCode(int64_t  value__) noexcept : ::bs_hook::EnumTypeWrapper<0x8>() {this->value__ = value__;
}
