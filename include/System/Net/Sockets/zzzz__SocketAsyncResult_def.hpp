...
/// @brief Method .ctor addr 0x28ff010 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <Complete>b__27_0 addr 0x28ff018 size 0x78 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __SocketAsyncResult____c()  = default;
public:
...
namespace System::Net::Sockets {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8895))}
...
constexpr ::cordl_internals::to_const_pointer<::System::Exception*> __get_DelayedException() const;

constexpr void __set_EndPoint(::System::Net::EndPoint*  value) ;

constexpr ::System::Net::EndPoint* __get_EndPoint() ;

constexpr ::cordl_internals::to_const_pointer<::System::Net::EndPoint*> __get_EndPoint() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::Socket*> __get_AcceptSocket() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<::System::ArraySegment_1<uint8_t>>*> __get_Buffers() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Sockets::Socket*> __get_AcceptedSocket() const;
...
/// @brief Method get_Handle addr 0x28fed14 size 0x64 virtual false final false
inline ::cordl_internals::intptr_t get_Handle() ;

static inline ::System::Net::Sockets::SocketAsyncResult* New_ctor() ;

/// @brief Method .ctor addr 0x28fe9b8 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method Init addr 0x28fed78 size 0xb4 virtual false final false
...
/// @brief Method .ctor addr 0x28fee2c size 0x38 virtual false final false
...
/// @brief Method get_ErrorCode addr 0x28fee64 size 0x80 virtual false final false
inline ::System::Net::Sockets::SocketError get_ErrorCode() ;

/// @brief Method CheckIfThrowDelayedException addr 0x28feee4 size 0xa8 virtual false final false
inline void CheckIfThrowDelayedException() ;

/// @brief Method CompleteDisposed addr 0x28fef8c size 0x4 virtual true final false
inline void CompleteDisposed() ;

/// @brief Method Complete addr 0x28fac2c size 0x1f0 virtual false final false
inline void Complete() ;

/// @brief Method Complete addr 0x28fef90 size 0xc virtual false final false
inline void Complete(bool  synch) ;

/// @brief Method Complete addr 0x28fb6ec size 0x8 virtual false final false
inline void Complete(int32_t  total) ;

/// @brief Method Complete addr 0x28fef9c size 0x10 virtual false final false
inline void Complete(::System::Exception*  e, bool  synch) ;

/// @brief Method Complete addr 0x28fa4a4 size 0x8 virtual false final false
inline void Complete(::System::Exception*  e) ;

/// @brief Method Complete addr 0x28fa4ac size 0x8 virtual false final false
inline void Complete(::System::Net::Sockets::Socket*  s) ;

/// @brief Method Complete addr 0x28fa6f4 size 0xc virtual false final false
