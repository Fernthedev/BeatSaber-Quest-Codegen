...
constexpr ::cordl_internals::to_const_pointer<::System::Net::IWebRequestCreate*> __get_creator() const;

constexpr void __set_creatorType(::System::Type*  value) ;

constexpr ::System::Type* __get_creatorType() ;

constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get_creatorType() const;
...
// Ctor Parameters []
// @brief default ctor
 WebRequestPrefixElement()  = default;
public:
