...
/// @brief Method .ctor addr 0x2944ff4 size 0x38 virtual false final false
inline void _ctor() ;

/// @brief Method get_Properties addr 0x294502c size 0x38 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 PerformanceCountersElement()  = default;
public:
