...
/// @brief Method .ctor addr 0x29450d4 size 0x38 virtual false final false
inline void _ctor() ;

/// @brief Method get_Properties addr 0x294510c size 0x38 virtual true final false
