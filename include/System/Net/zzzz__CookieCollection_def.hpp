...
struct CORDL_TYPE __CookieCollection__Stamp : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____CookieCollection__Stamp_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __CookieCollection__Stamp(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __CookieCollection__Stamp()  = default;
...
/// @brief Field m_cookies offset 0x10
...
/// @brief Field m_index offset 0x1c
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::CookieCollection*> __get_m_cookies() const;
...
// Ctor Parameters []
// @brief default ctor
 __CookieCollection__CookieCollectionEnumerator()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get_m_list() const;
