...
::cordl_internals::setInstanceField<::System::ConsoleSpecialKey, 0x10>(this, std::forward<::System::ConsoleSpecialKey>(value));
}
constexpr ::System::ConsoleSpecialKey& System::ConsoleCancelEventArgs::__get__type()  {
return ::cordl_internals::getInstanceField<::System::ConsoleSpecialKey, 0x10>(this);
}
