...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Mono::RuntimeEventHandle::*)(::cordl_internals::intptr_t)>(&::Mono::RuntimeEventHandle::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2412824;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::cordl_internals::intptr_t (::Mono::RuntimeEventHandle::*)()>(&::Mono::RuntimeEventHandle::get_Value)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x241282c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Mono::RuntimeEventHandle::*)(::System::Object*)>(&::Mono::RuntimeEventHandle::Equals)> {
  constexpr static std::size_t size = 0x10c;
  constexpr static std::size_t addrs = 0x2412834;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Mono::RuntimeEventHandle::*)()>(&::Mono::RuntimeEventHandle::GetHashCode)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2412940;
...
constexpr ::cordl_internals::intptr_t& Mono::RuntimeEventHandle::__get_value()  {
...
constexpr ::cordl_internals::intptr_t const& Mono::RuntimeEventHandle::__get_value() const {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
inline void Mono::RuntimeEventHandle::_ctor(::cordl_internals::intptr_t  v)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Mono::RuntimeEventHandle>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
inline ::cordl_internals::intptr_t Mono::RuntimeEventHandle::get_Value()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Mono::RuntimeEventHandle>::get(),
                            "get_Value",
                            std::vector<Il2CppClass*>{},
...
constexpr ::Mono::RuntimeEventHandle::RuntimeEventHandle(::cordl_internals::intptr_t  value) noexcept : ::bs_hook::ValueTypeWrapper<0x8>() {this->value = value;
}
