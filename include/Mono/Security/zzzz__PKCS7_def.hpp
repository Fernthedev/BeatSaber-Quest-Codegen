...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::ASN1*> __get_content() const;
...
/// @brief Field _encrypted offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::__PKCS7__ContentInfo*> __get__content() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::__PKCS7__ContentInfo*> __get__encryptionAlgorithm() const;
...
// Ctor Parameters []
// @brief default ctor
 __PKCS7__EncryptedData()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::__PKCS7__ContentInfo*> __get_contentInfo() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::X509::X509CertificateCollection*> __get_certs() const;

constexpr void __set_crls(::System::Collections::ArrayList*  value) ;

constexpr ::System::Collections::ArrayList* __get_crls() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get_crls() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::__PKCS7__SignerInfo*> __get_signerInfo() const;
...
/// @brief Field authenticatedAttributes offset 0x20
...
/// @brief Field unauthenticatedAttributes offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get_authenticatedAttributes() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get_unauthenticatedAttributes() const;
