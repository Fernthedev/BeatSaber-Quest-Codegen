...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Mono::Security::Interface::MonoRemoteCertificateValidationCallback::*)(::System::Object*, ::cordl_internals::intptr_t)>(&::Mono::Security::Interface::MonoRemoteCertificateValidationCallback::_ctor)> {
...
inline ::Mono::Security::Interface::MonoRemoteCertificateValidationCallback* Mono::Security::Interface::MonoRemoteCertificateValidationCallback::New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method)  {
return THROW_UNLESS(::il2cpp_utils::New<::Mono::Security::Interface::MonoRemoteCertificateValidationCallback*>(object, method));
}
inline void Mono::Security::Interface::MonoRemoteCertificateValidationCallback::_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Mono::Security::Interface::MonoRemoteCertificateValidationCallback*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
