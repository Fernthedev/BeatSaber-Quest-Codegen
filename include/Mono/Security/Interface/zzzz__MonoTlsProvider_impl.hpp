...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Mono::Security::Interface::MonoTlsProvider::*)()>(&::Mono::Security::Interface::MonoTlsProvider::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2402d84;
...
return THROW_UNLESS(::il2cpp_utils::New<::Mono::Security::Interface::MonoTlsProvider*>());
}
