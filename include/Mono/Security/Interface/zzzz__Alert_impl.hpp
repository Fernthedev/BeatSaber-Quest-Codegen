...
::cordl_internals::setInstanceField<::Mono::Security::Interface::AlertLevel, 0x10>(this, std::forward<::Mono::Security::Interface::AlertLevel>(value));
}
constexpr ::Mono::Security::Interface::AlertLevel& Mono::Security::Interface::Alert::__get_level()  {
return ::cordl_internals::getInstanceField<::Mono::Security::Interface::AlertLevel, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::Mono::Security::Interface::AlertDescription, 0x11>(this, std::forward<::Mono::Security::Interface::AlertDescription>(value));
}
constexpr ::Mono::Security::Interface::AlertDescription& Mono::Security::Interface::Alert::__get_description()  {
return ::cordl_internals::getInstanceField<::Mono::Security::Interface::AlertDescription, 0x11>(this);
}
