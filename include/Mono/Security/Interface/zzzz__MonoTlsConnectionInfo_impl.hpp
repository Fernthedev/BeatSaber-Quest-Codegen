...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Mono::Security::Interface::MonoTlsConnectionInfo::*)(::Mono::Security::Interface::CipherSuiteCode)>(&::Mono::Security::Interface::MonoTlsConnectionInfo::set_CipherSuiteCode)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_CipherSuiteCode",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Mono::Security::Interface::CipherSuiteCode>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Mono::Security::Interface::MonoTlsConnectionInfo::*)(::Mono::Security::Interface::TlsProtocols)>(&::Mono::Security::Interface::MonoTlsConnectionInfo::set_ProtocolVersion)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_ProtocolVersion",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Mono::Security::Interface::TlsProtocols>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Mono::Security::Interface::MonoTlsConnectionInfo::*)()>(&::Mono::Security::Interface::MonoTlsConnectionInfo::_ctor)> {
  constexpr static std::size_t size = 0x8;
...
::cordl_internals::setInstanceField<::Mono::Security::Interface::CipherSuiteCode, 0x10>(this, std::forward<::Mono::Security::Interface::CipherSuiteCode>(value));
}
...
return ::cordl_internals::getInstanceField<::Mono::Security::Interface::CipherSuiteCode, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::Mono::Security::Interface::TlsProtocols, 0x14>(this, std::forward<::Mono::Security::Interface::TlsProtocols>(value));
}
...
return ::cordl_internals::getInstanceField<::Mono::Security::Interface::TlsProtocols, 0x14>(this);
}
