...
struct CORDL_TYPE CipherSuiteCode : public ::bs_hook::EnumTypeWrapper<0x2> {
public:
// Declarations
...
return std::bit_cast<__CipherSuiteCode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x2>::instance);
}
...
constexpr explicit CipherSuiteCode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x2>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 CipherSuiteCode()  = default;
