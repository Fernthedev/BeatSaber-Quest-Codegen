...
::cordl_internals::setInstanceField<::Mono::Security::Interface::Alert*, 0x90>(this, std::forward<::Mono::Security::Interface::Alert*>(value));
}
constexpr ::Mono::Security::Interface::Alert* Mono::Security::Interface::TlsException::__get_alert()  {
return ::cordl_internals::getInstanceField<::Mono::Security::Interface::Alert*, 0x90>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::Interface::Alert*> Mono::Security::Interface::TlsException::__get_alert() const {
return ::cordl_internals::getInstanceField<::Mono::Security::Interface::Alert*, 0x90>(this);
}
