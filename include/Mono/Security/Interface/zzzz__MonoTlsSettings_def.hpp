...
/// @brief Field <RemoteCertificateValidationCallback>k__BackingField offset 0x10
 __declspec(property(get=__get__RemoteCertificateValidationCallback_k__BackingField, put=__set__RemoteCertificateValidationCallback_k__BackingField)) ::Mono::Security::Interface::MonoRemoteCertificateValidationCallback*  _RemoteCertificateValidationCallback_k__BackingField;

/// @brief Field <ClientCertificateSelectionCallback>k__BackingField offset 0x18
 __declspec(property(get=__get__ClientCertificateSelectionCallback_k__BackingField, put=__set__ClientCertificateSelectionCallback_k__BackingField)) ::Mono::Security::Interface::MonoLocalCertificateSelectionCallback*  _ClientCertificateSelectionCallback_k__BackingField;

/// @brief Field <CertificateValidationTime>k__BackingField offset 0x20
 __declspec(property(get=__get__CertificateValidationTime_k__BackingField, put=__set__CertificateValidationTime_k__BackingField)) ::System::Nullable_1<::System::DateTime>  _CertificateValidationTime_k__BackingField;

/// @brief Field <TrustAnchors>k__BackingField offset 0x30
 __declspec(property(get=__get__TrustAnchors_k__BackingField, put=__set__TrustAnchors_k__BackingField)) ::System::Security::Cryptography::X509Certificates::X509CertificateCollection*  _TrustAnchors_k__BackingField;

/// @brief Field <UserSettings>k__BackingField offset 0x38
...
/// @brief Field <CertificateSearchPaths>k__BackingField offset 0x40
 __declspec(property(get=__get__CertificateSearchPaths_k__BackingField, put=__set__CertificateSearchPaths_k__BackingField)) ::ArrayW<::StringW,::Array<::StringW>*>  _CertificateSearchPaths_k__BackingField;

/// @brief Field <SendCloseNotify>k__BackingField offset 0x48
...
/// @brief Field <ClientCertificateIssuers>k__BackingField offset 0x50
 __declspec(property(get=__get__ClientCertificateIssuers_k__BackingField, put=__set__ClientCertificateIssuers_k__BackingField)) ::ArrayW<::StringW,::Array<::StringW>*>  _ClientCertificateIssuers_k__BackingField;

/// @brief Field <DisallowUnauthenticatedCertificateRequest>k__BackingField offset 0x58
 __declspec(property(get=__get__DisallowUnauthenticatedCertificateRequest_k__BackingField, put=__set__DisallowUnauthenticatedCertificateRequest_k__BackingField)) bool  _DisallowUnauthenticatedCertificateRequest_k__BackingField;

/// @brief Field <EnabledProtocols>k__BackingField offset 0x5c
 __declspec(property(get=__get__EnabledProtocols_k__BackingField, put=__set__EnabledProtocols_k__BackingField)) ::System::Nullable_1<::Mono::Security::Interface::TlsProtocols>  _EnabledProtocols_k__BackingField;

/// @brief Field <EnabledCiphers>k__BackingField offset 0x68
 __declspec(property(get=__get__EnabledCiphers_k__BackingField, put=__set__EnabledCiphers_k__BackingField)) ::ArrayW<::Mono::Security::Interface::CipherSuiteCode,::Array<::Mono::Security::Interface::CipherSuiteCode>*>  _EnabledCiphers_k__BackingField;

/// @brief Field cloned offset 0x70
 __declspec(property(get=__get_cloned, put=__set_cloned)) bool  cloned;

/// @brief Field checkCertName offset 0x71
 __declspec(property(get=__get_checkCertName, put=__set_checkCertName)) bool  checkCertName;

/// @brief Field checkCertRevocationStatus offset 0x72
...
/// @brief Field useServicePointManagerCallback offset 0x73
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::Interface::MonoRemoteCertificateValidationCallback*> __get__RemoteCertificateValidationCallback_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::Interface::MonoLocalCertificateSelectionCallback*> __get__ClientCertificateSelectionCallback_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::X509Certificates::X509CertificateCollection*> __get__TrustAnchors_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__UserSettings_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::Interface::ICertificateValidator*> __get_certificateValidator() const;
...
// Ctor Parameters []
// @brief default ctor
 MonoTlsSettings()  = default;
public:


// Fields

// Static field defaultSettings
