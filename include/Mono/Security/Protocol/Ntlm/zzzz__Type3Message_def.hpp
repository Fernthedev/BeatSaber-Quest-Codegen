...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x60 - sizeof(::Mono::Security::Protocol::Ntlm::MessageBase)]{};
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::Protocol::Ntlm::Type2Message*> __get__type2() const;
