...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::ASN1*> __get_decoder() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::ASN1*> __get_issuer() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::ASN1*> __get_subject() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::RSA*> __get__rsa() const;

constexpr void __set__dsa(::System::Security::Cryptography::DSA*  value) ;

constexpr ::System::Security::Cryptography::DSA* __get__dsa() ;

constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::DSA*> __get__dsa() const;
