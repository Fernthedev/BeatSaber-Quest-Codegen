...
// Ctor Parameters []
// @brief default ctor
 __PKCS12__DeriveBytes()  = default;
public:


// Fields

// Static field keyDiversifier

// Static field ivDiversifier

// Static field macDiversifier
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get__keyBags() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get__secretBags() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::X509::X509CertificateCollection*> __get__certs() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get__safeBags() const;
...
// Static field password_max_length
