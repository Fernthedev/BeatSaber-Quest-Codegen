...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::X509::X509CertificateCollection*> __get__certificates() const;

constexpr void __set__crls(::System::Collections::ArrayList*  value) ;

constexpr ::System::Collections::ArrayList* __get__crls() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get__crls() const;
