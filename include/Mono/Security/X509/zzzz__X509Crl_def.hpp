...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::X509::X509ExtensionCollection*> __get_extensions() const;

static inline ::Mono::Security::X509::__X509Crl__X509CrlEntry* New_ctor(::Mono::Security::ASN1*  entry) ;

/// @brief Method .ctor addr 0x23f9054 size 0xd8 virtual false final false
inline void _ctor(::Mono::Security::ASN1*  entry) ;

/// @brief Method get_SerialNumber addr 0x23f96d8 size 0x78 virtual false final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_SerialNumber() ;

/// @brief Method get_RevocationDate addr 0x23f9c7c size 0x8 virtual false final false
inline ::System::DateTime get_RevocationDate() ;

/// @brief Method get_Extensions addr 0x23f9c84 size 0x8 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __X509Crl__X509CrlEntry()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::ArrayList*> __get_entries() const;
...
/// @brief Method .ctor addr 0x23f88ac size 0xf8 virtual false final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  crl) ;

/// @brief Method Parse addr 0x23f89a4 size 0x6b0 virtual false final false
inline void Parse(::ArrayW<uint8_t,::Array<uint8_t>*>  crl) ;

/// @brief Method get_Extensions addr 0x23f9268 size 0x8 virtual false final false
inline ::Mono::Security::X509::X509ExtensionCollection* get_Extensions() ;

/// @brief Method get_Hash addr 0x23f9270 size 0x214 virtual false final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Hash() ;

/// @brief Method get_IssuerName addr 0x23f9484 size 0x8 virtual false final false
inline ::StringW get_IssuerName() ;

/// @brief Method get_NextUpdate addr 0x23f948c size 0x8 virtual false final false
inline ::System::DateTime get_NextUpdate() ;

/// @brief Method Compare addr 0x23f9494 size 0x7c virtual false final false
inline bool Compare(::ArrayW<uint8_t,::Array<uint8_t>*>  array1, ::ArrayW<uint8_t,::Array<uint8_t>*>  array2) ;

/// @brief Method GetCrlEntry addr 0x23f9510 size 0x80 virtual false final false
inline ::Mono::Security::X509::__X509Crl__X509CrlEntry* GetCrlEntry(::Mono::Security::X509::X509Certificate*  x509) ;

/// @brief Method GetCrlEntry addr 0x23f9590 size 0x148 virtual false final false
inline ::Mono::Security::X509::__X509Crl__X509CrlEntry* GetCrlEntry(::ArrayW<uint8_t,::Array<uint8_t>*>  serialNumber) ;

/// @brief Method VerifySignature addr 0x23f9750 size 0x2cc virtual false final false
inline bool VerifySignature(::System::Security::Cryptography::DSA*  dsa) ;

/// @brief Method VerifySignature addr 0x23f9a1c size 0xd4 virtual false final false
inline bool VerifySignature(::System::Security::Cryptography::RSA*  rsa) ;

/// @brief Method VerifySignature addr 0x23f9af0 size 0x18c virtual false final false
