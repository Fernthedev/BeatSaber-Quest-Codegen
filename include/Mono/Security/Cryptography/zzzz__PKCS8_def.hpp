...
// Ctor Parameters []
// @brief default ctor
 __PKCS8__PrivateKeyInfo()  = default;
public:
...
/// @brief Field _algorithm offset 0x10
 __declspec(property(get=__get__algorithm, put=__set__algorithm)) ::StringW  _algorithm;

/// @brief Field _salt offset 0x18
 __declspec(property(get=__get__salt, put=__set__salt)) ::ArrayW<uint8_t,::Array<uint8_t>*>  _salt;

/// @brief Field _iterations offset 0x20
...
// Ctor Parameters []
// @brief default ctor
 __PKCS8__EncryptedPrivateKeyInfo()  = default;
public:
