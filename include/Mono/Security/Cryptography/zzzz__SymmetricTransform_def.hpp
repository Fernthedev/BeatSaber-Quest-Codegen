...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::SymmetricAlgorithm*> __get_algo() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::RandomNumberGenerator*> __get__rng() const;
...
/// @brief Method .ctor addr 0x2424fe0 size 0x2c8 virtual false final false
...
/// @brief Method Finalize addr 0x24252a8 size 0xa0 virtual true final false
inline void Finalize() ;

/// @brief Method System.IDisposable.Dispose addr 0x2425348 size 0x6c virtual true final true
inline void System_IDisposable_Dispose() ;

/// @brief Method Dispose addr 0x24253b4 size 0x54 virtual true final false
inline void Dispose(bool  disposing) ;

/// @brief Method get_CanTransformMultipleBlocks addr 0x2425408 size 0x8 virtual true final false
inline bool get_CanTransformMultipleBlocks() ;

/// @brief Method get_InputBlockSize addr 0x2425410 size 0x8 virtual true final false
inline int32_t get_InputBlockSize() ;

/// @brief Method get_OutputBlockSize addr 0x2425418 size 0x8 virtual true final false
inline int32_t get_OutputBlockSize() ;

/// @brief Method Transform addr 0x2425420 size 0x164 virtual true final false
...
/// @brief Method get_KeepLastBlock addr 0x2425da4 size 0x24 virtual false final false
inline bool get_KeepLastBlock() ;

/// @brief Method InternalTransformBlock addr 0x2425dc8 size 0x1bc virtual false final false
...
/// @brief Method Random addr 0x2425f84 size 0xb0 virtual false final false
inline void Random(::ArrayW<uint8_t,::Array<uint8_t>*>  buffer, int32_t  start, int32_t  length) ;

/// @brief Method ThrowBadPaddingException addr 0x2426034 size 0x1a8 virtual false final false
inline void ThrowBadPaddingException(::System::Security::Cryptography::PaddingMode  padding, int32_t  length, int32_t  position) ;

/// @brief Method FinalEncrypt addr 0x2426220 size 0x2a0 virtual true final false
...
/// @brief Method FinalDecrypt addr 0x24264c0 size 0x2ac virtual true final false
...
/// @brief Method TransformFinalBlock addr 0x242676c size 0xb4 virtual true final false
