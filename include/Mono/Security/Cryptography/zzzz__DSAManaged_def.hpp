...
static inline ::Mono::Security::Cryptography::__DSAManaged__KeyGeneratedEventHandler* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __DSAManaged__KeyGeneratedEventHandler()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Math::BigInteger*> __get_g() const;

constexpr void __set_x(::Mono::Math::BigInteger*  value) ;

constexpr ::Mono::Math::BigInteger* __get_x() ;

constexpr ::cordl_internals::to_const_pointer<::Mono::Math::BigInteger*> __get_x() const;

constexpr void __set_y(::Mono::Math::BigInteger*  value) ;

constexpr ::Mono::Math::BigInteger* __get_y() ;

constexpr ::cordl_internals::to_const_pointer<::Mono::Math::BigInteger*> __get_y() const;

constexpr void __set_j(::Mono::Math::BigInteger*  value) ;

constexpr ::Mono::Math::BigInteger* __get_j() ;

constexpr ::cordl_internals::to_const_pointer<::Mono::Math::BigInteger*> __get_j() const;

constexpr void __set_seed(::Mono::Math::BigInteger*  value) ;

constexpr ::Mono::Math::BigInteger* __get_seed() ;

constexpr ::cordl_internals::to_const_pointer<::Mono::Math::BigInteger*> __get_seed() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::RandomNumberGenerator*> __get_rng() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::Cryptography::__DSAManaged__KeyGeneratedEventHandler*> __get_KeyGenerated() const;
