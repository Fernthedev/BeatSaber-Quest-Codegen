...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::CspParameters*> __get__params() const;
...
// Ctor Parameters []
// @brief default ctor
 KeyPairPersistence()  = default;
public:


// Fields

// Static field _userPathExists

// Static field _userPath

// Static field _machinePathExists

// Static field _machinePath
