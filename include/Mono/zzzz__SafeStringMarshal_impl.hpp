...
constexpr ::cordl_internals::intptr_t& Mono::SafeStringMarshal::__get_marshaled_string()  {
...
constexpr ::cordl_internals::intptr_t const& Mono::SafeStringMarshal::__get_marshaled_string() const {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
inline ::cordl_internals::intptr_t Mono::SafeStringMarshal::StringToUtf8_icall(ByRef<::StringW>  str)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Mono::SafeStringMarshal>::get(),
                            "StringToUtf8_icall",
                            std::vector<Il2CppClass*>{},
...
inline ::cordl_internals::intptr_t Mono::SafeStringMarshal::StringToUtf8(::StringW  str)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Mono::SafeStringMarshal>::get(),
                            "StringToUtf8",
                            std::vector<Il2CppClass*>{},
...
inline void Mono::SafeStringMarshal::GFree(::cordl_internals::intptr_t  ptr)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Mono::SafeStringMarshal>::get(),
                            "GFree",
                            std::vector<Il2CppClass*>{},
...
inline ::cordl_internals::intptr_t Mono::SafeStringMarshal::get_Value()  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Mono::SafeStringMarshal>::get(),
                            "get_Value",
                            std::vector<Il2CppClass*>{},
...
constexpr ::Mono::SafeStringMarshal::SafeStringMarshal(::StringW  str, ::cordl_internals::intptr_t  marshaled_string) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->str = str;
