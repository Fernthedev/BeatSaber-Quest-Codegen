...
::cordl_internals::setInstanceField<::Mono::RuntimeGPtrArrayHandle, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::Mono::RuntimeGPtrArrayHandle>(value));
}
constexpr ::Mono::RuntimeGPtrArrayHandle& Mono::SafeGPtrArrayHandle::__get_handle()  {
return ::cordl_internals::getInstanceField<::Mono::RuntimeGPtrArrayHandle, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::Mono::RuntimeGPtrArrayHandle const& Mono::SafeGPtrArrayHandle::__get_handle() const {
return ::cordl_internals::getInstanceField<::Mono::RuntimeGPtrArrayHandle, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
inline void Mono::SafeGPtrArrayHandle::_ctor(::cordl_internals::intptr_t  ptr)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Mono::SafeGPtrArrayHandle>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
inline ::cordl_internals::intptr_t Mono::SafeGPtrArrayHandle::get_Item(int32_t  i)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Mono::SafeGPtrArrayHandle>::get(),
                            "get_Item",
                            std::vector<Il2CppClass*>{},
...
constexpr ::Mono::SafeGPtrArrayHandle::SafeGPtrArrayHandle(::Mono::RuntimeGPtrArrayHandle  handle) noexcept : ::bs_hook::ValueTypeWrapper<0x8>() {this->handle = handle;
}
