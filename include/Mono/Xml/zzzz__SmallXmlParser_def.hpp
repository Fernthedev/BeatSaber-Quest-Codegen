...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> __get_attrNames() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> __get_attrValues() const;
...
// Ctor Parameters []
// @brief default ctor
 __SmallXmlParser__AttrListImpl()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Xml::__SmallXmlParser__IContentHandler*> __get_handler() const;

constexpr void __set_reader(::System::IO::TextReader*  value) ;

constexpr ::System::IO::TextReader* __get_reader() ;

constexpr ::cordl_internals::to_const_pointer<::System::IO::TextReader*> __get_reader() const;

constexpr void __set_elementNames(::System::Collections::Stack*  value) ;

constexpr ::System::Collections::Stack* __get_elementNames() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Stack*> __get_elementNames() const;

constexpr void __set_xmlSpaces(::System::Collections::Stack*  value) ;

constexpr ::System::Collections::Stack* __get_xmlSpaces() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Stack*> __get_xmlSpaces() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Xml::__SmallXmlParser__AttrListImpl*> __get_attributes() const;
