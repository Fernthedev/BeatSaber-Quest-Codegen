...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::Mono::Net::Security::AsyncProtocolRequest)]{};

/// @brief Field <UserBuffer>k__BackingField offset 0x38
...
/// @brief Field <CurrentSize>k__BackingField offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Net::Security::BufferOffsetSize*> __get__UserBuffer_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 AsyncReadOrWriteRequest()  = default;
public:
