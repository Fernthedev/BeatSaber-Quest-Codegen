...
/// @brief Field <ServerCertSelectionDelegate>k__BackingField offset 0x10
 __declspec(property(get=__get__ServerCertSelectionDelegate_k__BackingField, put=__set__ServerCertSelectionDelegate_k__BackingField)) ::System::Net::Security::ServerCertSelectionCallback*  _ServerCertSelectionDelegate_k__BackingField;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Security::ServerCertSelectionCallback*> __get__ServerCertSelectionDelegate_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 MonoSslAuthenticationOptions()  = default;
public:
