...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::Mono::Net::Security::BufferOffsetSize)]{};

/// @brief Field InitialSize offset 0x28
...
/// @brief Method .ctor addr 0x281df80 size 0x70 virtual false final false
inline void _ctor(int32_t  size) ;

/// @brief Method Reset addr 0x281dff0 size 0x5c virtual false final false
inline void Reset() ;

/// @brief Method MakeRoom addr 0x281e04c size 0xb4 virtual false final false
inline void MakeRoom(int32_t  size) ;

/// @brief Method AppendData addr 0x281e100 size 0x60 virtual false final false
