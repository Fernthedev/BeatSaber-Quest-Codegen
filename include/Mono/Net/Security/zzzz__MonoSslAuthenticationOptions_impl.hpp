...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Mono::Net::Security::MonoSslAuthenticationOptions::*)()>(&::Mono::Net::Security::MonoSslAuthenticationOptions::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2823f8c;
...
constexpr void Mono::Net::Security::MonoSslAuthenticationOptions::__set__ServerCertSelectionDelegate_k__BackingField(::System::Net::Security::ServerCertSelectionCallback*  value)  {
::cordl_internals::setInstanceField<::System::Net::Security::ServerCertSelectionCallback*, 0x10>(this, std::forward<::System::Net::Security::ServerCertSelectionCallback*>(value));
}
constexpr ::System::Net::Security::ServerCertSelectionCallback* Mono::Net::Security::MonoSslAuthenticationOptions::__get__ServerCertSelectionDelegate_k__BackingField()  {
return ::cordl_internals::getInstanceField<::System::Net::Security::ServerCertSelectionCallback*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Net::Security::ServerCertSelectionCallback*> Mono::Net::Security::MonoSslAuthenticationOptions::__get__ServerCertSelectionDelegate_k__BackingField() const {
return ::cordl_internals::getInstanceField<::System::Net::Security::ServerCertSelectionCallback*, 0x10>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::Mono::Net::Security::MonoSslAuthenticationOptions*>());
}
