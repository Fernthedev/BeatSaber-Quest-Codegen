...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Security::SslServerAuthenticationOptions*> __get__Options_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 MonoSslServerAuthenticationOptions()  = default;
public:
