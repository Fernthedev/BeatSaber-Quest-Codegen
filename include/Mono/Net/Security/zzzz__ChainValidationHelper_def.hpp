...
/// @brief Field settings offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __ChainValidationHelper____c__DisplayClass11_0()  = default;
public:
...
/// @brief Field certValidationCallback offset 0x28
...
/// @brief Field certSelectionCallback offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::System::WeakReference_1<::System::Net::Security::SslStream*>*> __get_owner() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Security::LocalCertSelectionCallback*> __get_certSelectionCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Net::Security::MonoTlsStream*> __get_tlsStream() const;
