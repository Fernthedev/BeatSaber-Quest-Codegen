...
constexpr ::cordl_internals::to_const_pointer<::System::Net::Security::RemoteCertificateValidationCallback*> __get_callback() const;
...
// Ctor Parameters []
// @brief default ctor
 __CallbackHelpers____c__DisplayClass0_0()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::Interface::MonoLocalCertificateSelectionCallback*> __get_callback() const;
...
// Ctor Parameters []
// @brief default ctor
 __CallbackHelpers____c__DisplayClass6_0()  = default;
public:
