...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Mono::Net::Security::AsyncWriteRequest::*)(::Mono::Net::Security::MobileAuthenticatedStream*, bool, ::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t)>(&::Mono::Net::Security::AsyncWriteRequest::_ctor)> {
...
return THROW_UNLESS(::il2cpp_utils::New<::Mono::Net::Security::AsyncWriteRequest*>(parent, sync, buffer, offset, size));
}
