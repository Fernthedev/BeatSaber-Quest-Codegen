...
::cordl_internals::setInstanceField<::Mono::SystemCertificateProvider*, 0x10>(this, std::forward<::Mono::SystemCertificateProvider*>(value));
}
constexpr ::Mono::SystemCertificateProvider* Mono::SystemDependencyProvider::__get__CertificateProvider_k__BackingField()  {
return ::cordl_internals::getInstanceField<::Mono::SystemCertificateProvider*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Mono::SystemCertificateProvider*> Mono::SystemDependencyProvider::__get__CertificateProvider_k__BackingField() const {
return ::cordl_internals::getInstanceField<::Mono::SystemCertificateProvider*, 0x10>(this);
}
