...
static inline ::StringW PtrToUtf8String(::cordl_internals::intptr_t  ptr) ;
...
static inline int32_t DecodeBlobSize(::cordl_internals::intptr_t  in_ptr, ByRef<::cordl_internals::intptr_t>  out_ptr) ;

/// @brief Method DecodeBlobArray addr 0x2412d4c size 0xb8 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> DecodeBlobArray(::cordl_internals::intptr_t  ptr) ;
