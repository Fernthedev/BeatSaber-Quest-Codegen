...
namespace Mono::Unity {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8837))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xd0 - sizeof(::Mono::Net::Security::MobileTlsContext)]{};

/// @brief Field tlsContext offset 0x58
...
/// @brief Field requestedClientCertChain offset 0x60
...
/// @brief Field requestedClientKey offset 0x68
...
/// @brief Field readCallback offset 0x70
...
/// @brief Field writeCallback offset 0x78
...
/// @brief Field certificateCallback offset 0x80
...
/// @brief Field verifyCallback offset 0x88
...
/// @brief Field localClientCertificate offset 0x90
...
/// @brief Field remoteCertificate offset 0x98
...
/// @brief Field connectioninfo offset 0xa0
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Unity::__UnityTls__unitytls_tlsctx_read_callback*> __get_readCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Unity::__UnityTls__unitytls_tlsctx_write_callback*> __get_writeCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Unity::__UnityTls__unitytls_tlsctx_certificate_callback*> __get_certificateCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Unity::__UnityTls__unitytls_tlsctx_x509verify_callback*> __get_verifyCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::X509Certificates::X509Certificate*> __get_localClientCertificate() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::X509Certificates::X509Certificate2*> __get_remoteCertificate() const;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Security::Interface::MonoTlsConnectionInfo*> __get_connectioninfo() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Exception*> __get_lastException() const;
...
static inline ::cordl_internals::intptr_t WriteCallback(::cordl_internals::Ptr<void>  userData, ::cordl_internals::Ptr<uint8_t>  data, ::cordl_internals::intptr_t  bufferLen, ::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_errorstate>  errorState) ;

/// @brief Method WriteCallback addr 0x281b5f4 size 0x260 virtual false final false
inline ::cordl_internals::intptr_t WriteCallback(::cordl_internals::Ptr<uint8_t>  data, ::cordl_internals::intptr_t  bufferLen, ::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_errorstate>  errorState) ;

/// @brief Method ReadCallback addr 0x2819dfc size 0xc8 virtual false final false
static inline ::cordl_internals::intptr_t ReadCallback(::cordl_internals::Ptr<void>  userData, ::cordl_internals::Ptr<uint8_t>  buffer, ::cordl_internals::intptr_t  bufferLen, ::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_errorstate>  errorState) ;

/// @brief Method ReadCallback addr 0x281ba44 size 0x2f8 virtual false final false
inline ::cordl_internals::intptr_t ReadCallback(::cordl_internals::Ptr<uint8_t>  buffer, ::cordl_internals::intptr_t  bufferLen, ::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_errorstate>  errorState) ;
...
static inline void CertificateCallback(::cordl_internals::Ptr<void>  userData, ::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_tlsctx>  ctx, ::cordl_internals::Ptr<uint8_t>  cn, ::cordl_internals::intptr_t  cnLen, ::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_x509name>  caList, ::cordl_internals::intptr_t  caListLen, ::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_x509list_ref>  chain, ::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_key_ref>  key, ::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_errorstate>  errorState) ;

/// @brief Method CertificateCallback addr 0x281c2d8 size 0x2cc virtual false final false
inline void CertificateCallback(::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_tlsctx>  ctx, ::cordl_internals::Ptr<uint8_t>  cn, ::cordl_internals::intptr_t  cnLen, ::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_x509name>  caList, ::cordl_internals::intptr_t  caListLen, ::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_x509list_ref>  chain, ::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_key_ref>  key, ::cordl_internals::Ptr<::Mono::Unity::__UnityTls__unitytls_errorstate>  errorState) ;
