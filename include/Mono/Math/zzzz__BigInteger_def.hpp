...
struct CORDL_TYPE __BigInteger__Sign : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____BigInteger__Sign_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __BigInteger__Sign(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __BigInteger__Sign()  = default;
...
constexpr ::cordl_internals::to_const_pointer<::Mono::Math::BigInteger*> __get_mod() const;

constexpr void __set_constant(::Mono::Math::BigInteger*  value) ;

constexpr ::Mono::Math::BigInteger* __get_constant() ;

constexpr ::cordl_internals::to_const_pointer<::Mono::Math::BigInteger*> __get_constant() const;
...
// Ctor Parameters []
// @brief default ctor
 __BigInteger__ModulusRing()  = default;
public:
