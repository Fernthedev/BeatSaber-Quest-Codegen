...
inline ::Oculus::Platform::MessageWithNetSyncSessionList* Oculus::Platform::MessageWithNetSyncSessionList::New_ctor(::cordl_internals::intptr_t  c_message)  {
return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::MessageWithNetSyncSessionList*>(c_message));
}
inline void Oculus::Platform::MessageWithNetSyncSessionList::_ctor(::cordl_internals::intptr_t  c_message)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::MessageWithNetSyncSessionList*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
inline ::Oculus::Platform::Models::NetSyncSessionList* Oculus::Platform::MessageWithNetSyncSessionList::GetDataFromMessage(::cordl_internals::intptr_t  c_message)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::MessageWithNetSyncSessionList*>::get(),
                            "GetDataFromMessage",
                            std::vector<Il2CppClass*>{},
