...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Oculus::Platform::Request* (*)(::Oculus::Platform::ReportRequestResponse)>(&::Oculus::Platform::AbuseReport::ReportRequestHandled)> {
  ...
  constexpr static std::size_t addrs = 0x26cd0a0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::Oculus::Platform::__Message_1__Callback<::StringW>*)>(&::Oculus::Platform::AbuseReport::SetReportButtonPressedNotificationCallback)> {
