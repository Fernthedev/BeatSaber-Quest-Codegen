...
static inline ::Oculus::Platform::__Message__Callback* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
struct CORDL_TYPE __Message__MessageType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____Message__MessageType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __Message__MessageType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Message__MessageType()  = default;
...
static inline ::Oculus::Platform::__Message__ExtraMessageTypesHandler* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
inline ::Oculus::Platform::Message* Invoke(::cordl_internals::intptr_t  messageHandle, ::Oculus::Platform::__Message__MessageType  message_type) ;

/// @brief Method BeginInvoke addr 0x26f0698 size 0xb4 virtual true final false
inline ::System::IAsyncResult* BeginInvoke(::cordl_internals::intptr_t  messageHandle, ::Oculus::Platform::__Message__MessageType  message_type, ::System::AsyncCallback*  callback, ::System::Object*  object) ;
...
// Ctor Parameters []
// @brief default ctor
 __Message__ExtraMessageTypesHandler()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::Error*> __get_error() const;
...
static inline ::Oculus::Platform::Message* New_ctor(::cordl_internals::intptr_t  c_message) ;
...
static inline ::Oculus::Platform::Message* ParseMessageHandle(::cordl_internals::intptr_t  messageHandle) ;
...
// Static field <HandleExtraMessageTypes>k__BackingField
