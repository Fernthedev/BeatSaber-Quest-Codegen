...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4606 }), TypeDefinitionIndex(TypeDefinitionIndex(13474))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::Oculus::Platform::Message_1<::Oculus::Platform::Models::ProductList*>)]{};

static inline ::Oculus::Platform::MessageWithProductList* New_ctor(::cordl_internals::intptr_t  c_message) ;
...
inline ::Oculus::Platform::Models::ProductList* GetDataFromMessage(::cordl_internals::intptr_t  c_message) ;
...
// Ctor Parameters []
// @brief default ctor
 MessageWithProductList()  = default;
public:
