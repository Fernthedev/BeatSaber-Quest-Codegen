...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::ApplicationOptions::*)()>(&::Oculus::Platform::ApplicationOptions::_ctor)> {
  constexpr static std::size_t size = 0x64;
  constexpr static std::size_t addrs = 0x26ce794;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::ApplicationOptions::*)(::StringW)>(&::Oculus::Platform::ApplicationOptions::SetDeeplinkMessage)> {
  ...
  constexpr static std::size_t addrs = 0x26ce860;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::ApplicationOptions::*)(::StringW)>(&::Oculus::Platform::ApplicationOptions::SetDestinationApiName)> {
  constexpr static std::size_t size = 0x68;
  constexpr static std::size_t addrs = 0x26ce968;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::ApplicationOptions::*)(::StringW)>(&::Oculus::Platform::ApplicationOptions::SetLobbySessionId)> {
  constexpr static std::size_t size = 0x68;
  constexpr static std::size_t addrs = 0x26cea70;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::ApplicationOptions::*)(::StringW)>(&::Oculus::Platform::ApplicationOptions::SetMatchSessionId)> {
  constexpr static std::size_t size = 0x68;
  constexpr static std::size_t addrs = 0x26ceb78;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::ApplicationOptions::*)(uint64_t)>(&::Oculus::Platform::ApplicationOptions::SetRoomId)> {
  constexpr static std::size_t size = 0x68;
  constexpr static std::size_t addrs = 0x26cec80;
...
//  Writing Method size for method: ::Oculus::Platform::ApplicationOptions.op_Explicit___cordl_internals__intptr_t
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::cordl_internals::intptr_t (*)(::Oculus::Platform::ApplicationOptions*)>(&::Oculus::Platform::ApplicationOptions::op_Explicit___cordl_internals__intptr_t)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0x26ced6c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "op_Explicit",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Oculus::Platform::ApplicationOptions*>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::ApplicationOptions::*)()>(&::Oculus::Platform::ApplicationOptions::Finalize)> {
  ...
  constexpr static std::size_t addrs = 0x26cedc4;
...
constexpr void Oculus::Platform::ApplicationOptions::__set_Handle(::cordl_internals::intptr_t  value)  {
::cordl_internals::setInstanceField<::cordl_internals::intptr_t, 0x10>(this, std::forward<::cordl_internals::intptr_t>(value));
}
constexpr ::cordl_internals::intptr_t& Oculus::Platform::ApplicationOptions::__get_Handle()  {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x10>(this);
}
constexpr ::cordl_internals::intptr_t const& Oculus::Platform::ApplicationOptions::__get_Handle() const {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x10>(this);
}
inline ::Oculus::Platform::ApplicationOptions* Oculus::Platform::ApplicationOptions::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::ApplicationOptions*>());
}
...
inline ::cordl_internals::intptr_t Oculus::Platform::ApplicationOptions::op_Explicit___cordl_internals__intptr_t(::Oculus::Platform::ApplicationOptions*  options)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::ApplicationOptions*>::get(),
                            "op_Explicit",
                            std::vector<Il2CppClass*>{},
