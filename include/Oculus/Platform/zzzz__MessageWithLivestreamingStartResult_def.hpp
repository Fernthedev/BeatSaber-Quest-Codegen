...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4595 }), TypeDefinitionIndex(TypeDefinitionIndex(13454)), TypeDefinitionIndex(TypeDefinitionIndex(13262))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::Oculus::Platform::Message_1<::Oculus::Platform::Models::LivestreamingStartResult*>)]{};

static inline ::Oculus::Platform::MessageWithLivestreamingStartResult* New_ctor(::cordl_internals::intptr_t  c_message) ;

/// @brief Method .ctor addr 0x26f2618 size 0x58 virtual false final false
inline void _ctor(::cordl_internals::intptr_t  c_message) ;

/// @brief Method GetLivestreamingStartResult addr 0x26f2670 size 0x3c virtual true final false
inline ::Oculus::Platform::Models::LivestreamingStartResult* GetLivestreamingStartResult() ;

/// @brief Method GetDataFromMessage addr 0x26f26ac size 0x9c virtual true final false
inline ::Oculus::Platform::Models::LivestreamingStartResult* GetDataFromMessage(::cordl_internals::intptr_t  c_message) ;
...
// Ctor Parameters []
// @brief default ctor
 MessageWithLivestreamingStartResult()  = default;
public:
