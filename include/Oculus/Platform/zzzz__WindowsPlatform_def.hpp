...
static inline ::Oculus::Platform::__WindowsPlatform__UnityLogDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __WindowsPlatform__UnityLogDelegate()  = default;
public:
...
inline void CPPLogCallback(::cordl_internals::intptr_t  tag, ::cordl_internals::intptr_t  message) ;

/// @brief Method getCallbackPointer addr 0x2702504 size 0x48 virtual false final false
inline ::cordl_internals::intptr_t getCallbackPointer() ;
