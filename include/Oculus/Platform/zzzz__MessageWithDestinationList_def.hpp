...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13432)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4585 }), TypeDefinitionIndex(TypeDefinitionIndex(13262))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::Oculus::Platform::Message_1<::Oculus::Platform::Models::DestinationList*>)]{};

static inline ::Oculus::Platform::MessageWithDestinationList* New_ctor(::cordl_internals::intptr_t  c_message) ;

/// @brief Method .ctor addr 0x26eefd8 size 0x58 virtual false final false
inline void _ctor(::cordl_internals::intptr_t  c_message) ;

/// @brief Method GetDestinationList addr 0x26f18e8 size 0x3c virtual true final false
inline ::Oculus::Platform::Models::DestinationList* GetDestinationList() ;

/// @brief Method GetDataFromMessage addr 0x26f1924 size 0x9c virtual true final false
inline ::Oculus::Platform::Models::DestinationList* GetDataFromMessage(::cordl_internals::intptr_t  c_message) ;
...
// Ctor Parameters []
// @brief default ctor
 MessageWithDestinationList()  = default;
public:
