...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13262)), TypeDefinitionIndex(TypeDefinitionIndex(13422)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 970 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::Oculus::Platform::Message_1<::Oculus::Platform::Models::AssetFileDownloadUpdate*>)]{};

static inline ::Oculus::Platform::MessageWithAssetFileDownloadUpdate* New_ctor(::cordl_internals::intptr_t  c_message) ;
...
inline ::Oculus::Platform::Models::AssetFileDownloadUpdate* GetDataFromMessage(::cordl_internals::intptr_t  c_message) ;
...
// Ctor Parameters []
// @brief default ctor
 MessageWithAssetFileDownloadUpdate()  = default;
public:
