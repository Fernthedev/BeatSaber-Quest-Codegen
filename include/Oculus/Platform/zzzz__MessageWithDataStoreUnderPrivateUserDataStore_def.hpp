...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3824), inst: 608 }), TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4568 }), TypeDefinitionIndex(TypeDefinitionIndex(3824))}
...
static inline ::Oculus::Platform::MessageWithDataStoreUnderPrivateUserDataStore* New_ctor(::cordl_internals::intptr_t  c_message) ;

/// @brief Method .ctor addr 0x26eef28 size 0x58 virtual false final false
inline void _ctor(::cordl_internals::intptr_t  c_message) ;

/// @brief Method GetDataStore addr 0x26f17b8 size 0x3c virtual true final false
inline ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>* GetDataStore() ;

/// @brief Method GetDataFromMessage addr 0x26f17f4 size 0x5c virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 MessageWithDataStoreUnderPrivateUserDataStore()  = default;
public:
