...
struct CORDL_TYPE __PlatformInternal__MessageTypeInternal : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____PlatformInternal__MessageTypeInternal_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __PlatformInternal__MessageTypeInternal(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __PlatformInternal__MessageTypeInternal()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __PlatformInternal__HTTP()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __PlatformInternal__Users()  = default;
public:
...
static inline ::Oculus::Platform::Message* ParseMessageHandle(::cordl_internals::intptr_t  messageHandle, ::Oculus::Platform::__Message__MessageType  messageType) ;
