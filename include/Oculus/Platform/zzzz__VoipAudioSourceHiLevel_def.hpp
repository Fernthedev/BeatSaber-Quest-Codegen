...
/// @brief Field scratchBuffer offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::VoipAudioSourceHiLevel*> __get_parent() const;
...
/// @brief Method Awake addr 0x2701b50 size 0xb4 virtual false final false
inline void Awake() ;

/// @brief Method OnAudioFilterRead addr 0x2701c04 size 0x4cc virtual false final false
...
/// @brief Method .ctor addr 0x27020d0 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __VoipAudioSourceHiLevel__FilterReadDelegate()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::IVoipPCMSource*> __get_pcmSource() const;
...
/// @brief Method set_senderID addr 0x27013e8 size 0xac virtual false final false
inline void set_senderID(uint64_t  value) ;

/// @brief Method Stop addr 0x2701494 size 0x4 virtual false final false
inline void Stop() ;

/// @brief Method SampleRateToEnum addr 0x2701498 size 0x3c virtual false final false
inline ::Oculus::Platform::VoipSampleRate SampleRateToEnum(int32_t  rate) ;

/// @brief Method Awake addr 0x27014d4 size 0x2a0 virtual false final false
inline void Awake() ;

/// @brief Method Start addr 0x2701774 size 0x1c virtual false final false
inline void Start() ;

/// @brief Method CreatePCMSource addr 0x2701790 size 0x60 virtual true final false
inline void CreatePCMSource() ;

/// @brief Method MSToElements addr 0x27017f8 size 0x68 virtual false final false
static inline int32_t MSToElements(int32_t  ms) ;

/// @brief Method Update addr 0x2701860 size 0x2e8 virtual false final false
inline void Update() ;

static inline ::Oculus::Platform::VoipAudioSourceHiLevel* New_ctor() ;

/// @brief Method .ctor addr 0x2701b48 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 VoipAudioSourceHiLevel()  = default;
public:


// Fields

// Static field audioSystemPlaybackFrequency

// Static field verboseLogging
