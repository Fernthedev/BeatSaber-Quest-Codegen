...
/// @brief Method GetLaunchDetails addr 0x26f5aac size 0x90 virtual false final false
static inline ::Oculus::Platform::Models::LaunchDetails* GetLaunchDetails() ;

/// @brief Method LogDeeplinkResult addr 0x26f5b3c size 0x64 virtual false final false
static inline void LogDeeplinkResult(::StringW  trackingID, ::Oculus::Platform::LaunchResult  result) ;

/// @brief Method SetLaunchIntentChangedNotificationCallback addr 0x26f5ba0 size 0x74 virtual false final false
