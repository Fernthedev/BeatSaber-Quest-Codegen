...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13439)), TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4587 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::Oculus::Platform::Message_1<::Oculus::Platform::Models::InvitePanelResultInfo*>)]{};

static inline ::Oculus::Platform::MessageWithInvitePanelResultInfo* New_ctor(::cordl_internals::intptr_t  c_message) ;

/// @brief Method .ctor addr 0x26ef0e0 size 0x58 virtual false final false
inline void _ctor(::cordl_internals::intptr_t  c_message) ;

/// @brief Method GetInvitePanelResultInfo addr 0x26f1ca0 size 0x3c virtual true final false
inline ::Oculus::Platform::Models::InvitePanelResultInfo* GetInvitePanelResultInfo() ;

/// @brief Method GetDataFromMessage addr 0x26f1cdc size 0x9c virtual true final false
inline ::Oculus::Platform::Models::InvitePanelResultInfo* GetDataFromMessage(::cordl_internals::intptr_t  c_message) ;
...
// Ctor Parameters []
// @brief default ctor
 MessageWithInvitePanelResultInfo()  = default;
public:
