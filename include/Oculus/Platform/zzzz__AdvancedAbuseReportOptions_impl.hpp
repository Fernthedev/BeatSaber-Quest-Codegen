...
constexpr ::cordl_internals::intptr_t& Oculus::Platform::AdvancedAbuseReportOptions::__get_Handle()  {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x10>(this);
}
constexpr ::cordl_internals::intptr_t const& Oculus::Platform::AdvancedAbuseReportOptions::__get_Handle() const {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x10>(this);
}
inline ::Oculus::Platform::AdvancedAbuseReportOptions* Oculus::Platform::AdvancedAbuseReportOptions::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::AdvancedAbuseReportOptions*>());
}
...
inline ::cordl_internals::intptr_t Oculus::Platform::AdvancedAbuseReportOptions::op_Explicit___cordl_internals__intptr_t(::Oculus::Platform::AdvancedAbuseReportOptions*  options)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::AdvancedAbuseReportOptions*>::get(),
                            "op_Explicit",
                            std::vector<Il2CppClass*>{},
