...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 1184 }), TypeDefinitionIndex(TypeDefinitionIndex(13484)), TypeDefinitionIndex(TypeDefinitionIndex(13262))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::Oculus::Platform::Message_1<::Oculus::Platform::Models::User*>)]{};

static inline ::Oculus::Platform::MessageWithUser* New_ctor(::cordl_internals::intptr_t  c_message) ;
...
inline ::Oculus::Platform::Models::User* GetDataFromMessage(::cordl_internals::intptr_t  c_message) ;
