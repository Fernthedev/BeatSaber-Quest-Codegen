...
constexpr ::cordl_internals::intptr_t& Oculus::Platform::UserOptions::__get_Handle()  {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x10>(this);
}
constexpr ::cordl_internals::intptr_t const& Oculus::Platform::UserOptions::__get_Handle() const {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x10>(this);
}
inline ::Oculus::Platform::UserOptions* Oculus::Platform::UserOptions::New_ctor()  {
return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::UserOptions*>());
}
...
inline ::cordl_internals::intptr_t Oculus::Platform::UserOptions::op_Explicit___cordl_internals__intptr_t(::Oculus::Platform::UserOptions*  options)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::UserOptions*>::get(),
                            "op_Explicit",
                            std::vector<Il2CppClass*>{},
