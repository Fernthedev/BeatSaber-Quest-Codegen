...
inline ::Oculus::Platform::MessageWithDataStoreUnderPrivateUserDataStore* Oculus::Platform::MessageWithDataStoreUnderPrivateUserDataStore::New_ctor(::cordl_internals::intptr_t  c_message)  {
return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::MessageWithDataStoreUnderPrivateUserDataStore*>(c_message));
}
inline void Oculus::Platform::MessageWithDataStoreUnderPrivateUserDataStore::_ctor(::cordl_internals::intptr_t  c_message)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::MessageWithDataStoreUnderPrivateUserDataStore*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
inline ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>* Oculus::Platform::MessageWithDataStoreUnderPrivateUserDataStore::GetDataFromMessage(::cordl_internals::intptr_t  c_message)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::MessageWithDataStoreUnderPrivateUserDataStore*>::get(),
                            "GetDataFromMessage",
                            std::vector<Il2CppClass*>{},
