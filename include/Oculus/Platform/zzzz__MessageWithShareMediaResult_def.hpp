...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4610 }), TypeDefinitionIndex(TypeDefinitionIndex(13481)), TypeDefinitionIndex(TypeDefinitionIndex(13262))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::Oculus::Platform::Message_1<::Oculus::Platform::Models::ShareMediaResult*>)]{};

static inline ::Oculus::Platform::MessageWithShareMediaResult* New_ctor(::cordl_internals::intptr_t  c_message) ;
...
inline ::Oculus::Platform::Models::ShareMediaResult* GetDataFromMessage(::cordl_internals::intptr_t  c_message) ;
...
// Ctor Parameters []
// @brief default ctor
 MessageWithShareMediaResult()  = default;
public:
