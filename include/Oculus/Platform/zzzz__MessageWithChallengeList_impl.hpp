...
inline ::Oculus::Platform::MessageWithChallengeList* Oculus::Platform::MessageWithChallengeList::New_ctor(::cordl_internals::intptr_t  c_message)  {
return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::MessageWithChallengeList*>(c_message));
}
inline void Oculus::Platform::MessageWithChallengeList::_ctor(::cordl_internals::intptr_t  c_message)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::MessageWithChallengeList*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
inline ::Oculus::Platform::Models::ChallengeList* Oculus::Platform::MessageWithChallengeList::GetDataFromMessage(::cordl_internals::intptr_t  c_message)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::MessageWithChallengeList*>::get(),
                            "GetDataFromMessage",
                            std::vector<Il2CppClass*>{},
