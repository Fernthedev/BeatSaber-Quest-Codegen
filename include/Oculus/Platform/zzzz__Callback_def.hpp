...
class __Callback__RequestCallback_1<T>;
}
// Write type traits
...
/// @brief Field messageCallback offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::__Message__Callback*> __get_messageCallback() const;
...
// Ctor Parameters []
// @brief default ctor
 __Callback__RequestCallback()  = default;
public:
...
// Static field requestIDsToRequests

// Static field notificationCallbacks

// Static field hasRegisteredJoinIntentNotificationHandler

// Static field latestPendingJoinIntentNotifications
...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13233)), TypeDefinitionIndex(TypeDefinitionIndex(13232))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13233), inst: 2 })
// CS Name: ::Callback::RequestCallback`1<T>*
class CORDL_TYPE __Callback__RequestCallback_1<T> : public ::Oculus::Platform::__Callback__RequestCallback {
public:
// Declarations
/// @brief The size of the true reference type
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::Oculus::Platform::__Callback__RequestCallback)]{};
...
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::__Message_1__Callback<T>*> __get_callback() const;
...
// Ctor Parameters []
// @brief default ctor
 __Callback__RequestCallback_1()  = default;
public:
