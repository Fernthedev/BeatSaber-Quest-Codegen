...
/// @brief Field IsPersistantBetweenSceneLoads offset 0x18
...
/// @brief Method ovr_UnityResetTestPlatform addr 0x26cfaf0 size 0x64 virtual false final false
static inline void ovr_UnityResetTestPlatform() ;

/// @brief Method Awake addr 0x26cfb54 size 0x100 virtual false final false
inline void Awake() ;

/// @brief Method Update addr 0x26cfc54 size 0x8 virtual false final false
inline void Update() ;

/// @brief Method OnDestroy addr 0x26cfcc4 size 0x4 virtual false final false
inline void OnDestroy() ;

/// @brief Method OnApplicationQuit addr 0x26cfcc8 size 0x4c virtual false final false
inline void OnApplicationQuit() ;

static inline ::Oculus::Platform::CallbackRunner* New_ctor() ;

/// @brief Method .ctor addr 0x26cfd14 size 0x10 virtual false final false
inline void _ctor() ;
