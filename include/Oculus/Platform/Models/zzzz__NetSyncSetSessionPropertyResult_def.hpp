...
/// @brief Field Session offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::NetSyncSession*> __get_Session() const;

static inline ::Oculus::Platform::Models::NetSyncSetSessionPropertyResult* New_ctor(::cordl_internals::intptr_t  o) ;

/// @brief Method .ctor addr 0x2707950 size 0xb0 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 NetSyncSetSessionPropertyResult()  = default;
public:
