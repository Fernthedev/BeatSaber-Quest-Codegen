...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::AchievementProgress::*)(::cordl_internals::intptr_t)>(&::Oculus::Platform::Models::AchievementProgress::_ctor)> {
...
::cordl_internals::setInstanceField<::System::DateTime, 0x30>(this, std::forward<::System::DateTime>(value));
}
constexpr ::System::DateTime& Oculus::Platform::Models::AchievementProgress::__get_UnlockTime()  {
return ::cordl_internals::getInstanceField<::System::DateTime, 0x30>(this);
}
constexpr ::System::DateTime const& Oculus::Platform::Models::AchievementProgress::__get_UnlockTime() const {
return ::cordl_internals::getInstanceField<::System::DateTime, 0x30>(this);
}
inline ::Oculus::Platform::Models::AchievementProgress* Oculus::Platform::Models::AchievementProgress::New_ctor(::cordl_internals::intptr_t  o)  {
return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::Models::AchievementProgress*>(o));
}
inline void Oculus::Platform::Models::AchievementProgress::_ctor(::cordl_internals::intptr_t  o)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::AchievementProgress*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
