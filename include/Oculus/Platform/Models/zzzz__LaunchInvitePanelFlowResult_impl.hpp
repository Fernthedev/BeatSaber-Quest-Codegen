...
::cordl_internals::setInstanceField<::Oculus::Platform::Models::UserList*, 0x10>(this, std::forward<::Oculus::Platform::Models::UserList*>(value));
}
constexpr ::Oculus::Platform::Models::UserList* Oculus::Platform::Models::LaunchInvitePanelFlowResult::__get_InvitedUsers()  {
return ::cordl_internals::getInstanceField<::Oculus::Platform::Models::UserList*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::UserList*> Oculus::Platform::Models::LaunchInvitePanelFlowResult::__get_InvitedUsers() const {
return ::cordl_internals::getInstanceField<::Oculus::Platform::Models::UserList*, 0x10>(this);
}
inline ::Oculus::Platform::Models::LaunchInvitePanelFlowResult* Oculus::Platform::Models::LaunchInvitePanelFlowResult::New_ctor(::cordl_internals::intptr_t  o)  {
return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::Models::LaunchInvitePanelFlowResult*>(o));
}
inline void Oculus::Platform::Models::LaunchInvitePanelFlowResult::_ctor(::cordl_internals::intptr_t  o)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::LaunchInvitePanelFlowResult*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
