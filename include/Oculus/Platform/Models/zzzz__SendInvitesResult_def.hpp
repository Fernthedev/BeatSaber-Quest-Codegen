...
/// @brief Field Invites offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::ApplicationInviteList*> __get_Invites() const;

static inline ::Oculus::Platform::Models::SendInvitesResult* New_ctor(::cordl_internals::intptr_t  o) ;

/// @brief Method .ctor addr 0x2708e10 size 0xb0 virtual false final false
