...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::PurchaseList::*)(::cordl_internals::intptr_t)>(&::Oculus::Platform::Models::PurchaseList::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2708874;
...
inline ::Oculus::Platform::Models::PurchaseList* Oculus::Platform::Models::PurchaseList::New_ctor(::cordl_internals::intptr_t  a)  {
return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::Models::PurchaseList*>(a));
}
inline void Oculus::Platform::Models::PurchaseList::_ctor(::cordl_internals::intptr_t  a)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::PurchaseList*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
