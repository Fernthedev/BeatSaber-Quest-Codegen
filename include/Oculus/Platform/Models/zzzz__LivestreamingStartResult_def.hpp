...
/// @brief Field StreamingResult offset 0x10
...
static inline ::Oculus::Platform::Models::LivestreamingStartResult* New_ctor(::cordl_internals::intptr_t  o) ;
...
// Ctor Parameters []
// @brief default ctor
 LivestreamingStartResult()  = default;
public:
