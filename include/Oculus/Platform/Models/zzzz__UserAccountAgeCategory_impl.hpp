...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::UserAccountAgeCategory::*)(::cordl_internals::intptr_t)>(&::Oculus::Platform::Models::UserAccountAgeCategory::_ctor)> {
...
::cordl_internals::setInstanceField<::Oculus::Platform::AccountAgeCategory, 0x10>(this, std::forward<::Oculus::Platform::AccountAgeCategory>(value));
}
constexpr ::Oculus::Platform::AccountAgeCategory& Oculus::Platform::Models::UserAccountAgeCategory::__get_AgeCategory()  {
return ::cordl_internals::getInstanceField<::Oculus::Platform::AccountAgeCategory, 0x10>(this);
}
constexpr ::Oculus::Platform::AccountAgeCategory const& Oculus::Platform::Models::UserAccountAgeCategory::__get_AgeCategory() const {
return ::cordl_internals::getInstanceField<::Oculus::Platform::AccountAgeCategory, 0x10>(this);
}
inline ::Oculus::Platform::Models::UserAccountAgeCategory* Oculus::Platform::Models::UserAccountAgeCategory::New_ctor(::cordl_internals::intptr_t  o)  {
return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::Models::UserAccountAgeCategory*>(o));
}
inline void Oculus::Platform::Models::UserAccountAgeCategory::_ctor(::cordl_internals::intptr_t  o)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::UserAccountAgeCategory*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
