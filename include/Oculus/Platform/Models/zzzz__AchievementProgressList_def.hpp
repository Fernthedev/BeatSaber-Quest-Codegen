...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst: 1167 }), TypeDefinitionIndex(TypeDefinitionIndex(13430)), TypeDefinitionIndex(TypeDefinitionIndex(13409))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::Oculus::Platform::Models::DeserializableList_1<::Oculus::Platform::Models::AchievementProgress*>)]{};

static inline ::Oculus::Platform::Models::AchievementProgressList* New_ctor(::cordl_internals::intptr_t  a) ;

/// @brief Method .ctor addr 0x2703b00 size 0x25c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 AchievementProgressList()  = default;
public:
