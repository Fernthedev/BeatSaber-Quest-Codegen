...
/// @brief Field DidSendRequest offset 0x11
...
static inline ::Oculus::Platform::Models::LaunchFriendRequestFlowResult* New_ctor(::cordl_internals::intptr_t  o) ;
...
// Ctor Parameters []
// @brief default ctor
 LaunchFriendRequestFlowResult()  = default;
public:
