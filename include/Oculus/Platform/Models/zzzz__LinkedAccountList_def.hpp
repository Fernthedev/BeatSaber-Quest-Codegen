...
namespace Oculus::Platform::Models {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13451)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst: 1177 }), TypeDefinitionIndex(TypeDefinitionIndex(13430))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::Oculus::Platform::Models::DeserializableList_1<::Oculus::Platform::Models::LinkedAccount*>)]{};

static inline ::Oculus::Platform::Models::LinkedAccountList* New_ctor(::cordl_internals::intptr_t  a) ;
