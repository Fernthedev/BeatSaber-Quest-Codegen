...
/// @brief Field InvitedUsersOptional offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::User*> __get_LeaderOptional() const;

constexpr void __set_Leader(::Oculus::Platform::Models::User*  value) ;

constexpr ::Oculus::Platform::Models::User* __get_Leader() ;

constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::User*> __get_Leader() const;
...
static inline ::Oculus::Platform::Models::Party* New_ctor(::cordl_internals::intptr_t  o) ;
