...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::GroupPresenceLeaveIntent::*)(::cordl_internals::intptr_t)>(&::Oculus::Platform::Models::GroupPresenceLeaveIntent::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2705ea4;
...
inline ::Oculus::Platform::Models::GroupPresenceLeaveIntent* Oculus::Platform::Models::GroupPresenceLeaveIntent::New_ctor(::cordl_internals::intptr_t  o)  {
return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::Models::GroupPresenceLeaveIntent*>(o));
}
inline void Oculus::Platform::Models::GroupPresenceLeaveIntent::_ctor(::cordl_internals::intptr_t  o)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::GroupPresenceLeaveIntent*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
