...
inline ::Oculus::Platform::Models::AssetFileDownloadCancelResult* Oculus::Platform::Models::AssetFileDownloadCancelResult::New_ctor(::cordl_internals::intptr_t  o)  {
return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::Models::AssetFileDownloadCancelResult*>(o));
}
inline void Oculus::Platform::Models::AssetFileDownloadCancelResult::_ctor(::cordl_internals::intptr_t  o)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::AssetFileDownloadCancelResult*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
