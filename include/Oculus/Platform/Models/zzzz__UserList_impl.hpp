...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Oculus::Platform::Models::UserList::*)(::cordl_internals::intptr_t)>(&::Oculus::Platform::Models::UserList::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x27051d8;
...
inline ::Oculus::Platform::Models::UserList* Oculus::Platform::Models::UserList::New_ctor(::cordl_internals::intptr_t  a)  {
return THROW_UNLESS(::il2cpp_utils::New<::Oculus::Platform::Models::UserList*>(a));
}
inline void Oculus::Platform::Models::UserList::_ctor(::cordl_internals::intptr_t  a)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Oculus::Platform::Models::UserList*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
