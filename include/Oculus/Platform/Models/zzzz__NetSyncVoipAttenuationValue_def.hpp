...
static inline ::Oculus::Platform::Models::NetSyncVoipAttenuationValue* New_ctor(::cordl_internals::intptr_t  o) ;
...
// Ctor Parameters []
// @brief default ctor
 NetSyncVoipAttenuationValue()  = default;
public:
