...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13430)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13430), inst: 2 })
// CS Name: ::Oculus.Platform.Models::DeserializableList`1<T>*
class CORDL_TYPE DeserializableList_1<T> : public ::System::Object {
public:
// Declarations
