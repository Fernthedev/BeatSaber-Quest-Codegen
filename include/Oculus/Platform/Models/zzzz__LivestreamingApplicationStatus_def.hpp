...
/// @brief Field StreamingEnabled offset 0x10
...
static inline ::Oculus::Platform::Models::LivestreamingApplicationStatus* New_ctor(::cordl_internals::intptr_t  o) ;
...
// Ctor Parameters []
// @brief default ctor
 LivestreamingApplicationStatus()  = default;
public:
