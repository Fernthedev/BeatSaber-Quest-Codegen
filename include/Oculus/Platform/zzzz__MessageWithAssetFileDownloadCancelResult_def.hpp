...
namespace Oculus::Platform {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13420)), TypeDefinitionIndex(TypeDefinitionIndex(13262)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13262), inst: 4579 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::Oculus::Platform::Message_1<::Oculus::Platform::Models::AssetFileDownloadCancelResult*>)]{};

static inline ::Oculus::Platform::MessageWithAssetFileDownloadCancelResult* New_ctor(::cordl_internals::intptr_t  c_message) ;

/// @brief Method .ctor addr 0x26eec68 size 0x58 virtual false final false
inline void _ctor(::cordl_internals::intptr_t  c_message) ;

/// @brief Method GetAssetFileDownloadCancelResult addr 0x26f10f8 size 0x3c virtual true final false
inline ::Oculus::Platform::Models::AssetFileDownloadCancelResult* GetAssetFileDownloadCancelResult() ;

/// @brief Method GetDataFromMessage addr 0x26f1134 size 0x9c virtual true final false
inline ::Oculus::Platform::Models::AssetFileDownloadCancelResult* GetDataFromMessage(::cordl_internals::intptr_t  c_message) ;
...
// Ctor Parameters []
// @brief default ctor
 MessageWithAssetFileDownloadCancelResult()  = default;
public:
