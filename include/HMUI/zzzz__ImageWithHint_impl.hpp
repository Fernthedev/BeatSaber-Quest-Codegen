...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Image*> HMUI::ImageWithHint::__get__image() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Image*, 0x18>(this);
}
constexpr void HMUI::ImageWithHint::__set__hoverHint(::HMUI::HoverHint*  value)  {
::cordl_internals::setInstanceField<::HMUI::HoverHint*, 0x20>(this, std::forward<::HMUI::HoverHint*>(value));
}
constexpr ::HMUI::HoverHint* HMUI::ImageWithHint::__get__hoverHint()  {
return ::cordl_internals::getInstanceField<::HMUI::HoverHint*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::HMUI::HoverHint*> HMUI::ImageWithHint::__get__hoverHint() const {
return ::cordl_internals::getInstanceField<::HMUI::HoverHint*, 0x20>(this);
}
