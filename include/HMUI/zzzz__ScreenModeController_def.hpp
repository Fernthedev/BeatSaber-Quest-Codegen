...
/// @brief Field _curvedCanvases offset 0x18
...
/// @brief Field _defaultModeData offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::ScreenModeData*> __get__defaultModeData() const;
