...
static inline ::HMUI::__ViewController__DidActivateDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __ViewController__DidActivateDelegate()  = default;
public:
...
static inline ::HMUI::__ViewController__DidDeactivateDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __ViewController__DidDeactivateDelegate()  = default;
public:
...
struct CORDL_TYPE __ViewController__AnimationType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____ViewController__AnimationType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __ViewController__AnimationType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ViewController__AnimationType()  = default;
...
struct CORDL_TYPE __ViewController__AnimationDirection : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____ViewController__AnimationDirection_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __ViewController__AnimationDirection(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ViewController__AnimationDirection()  = default;
...
/// @brief Field animationDirection offset 0x34
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::ViewController*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __ViewController___PresentViewControllerCoroutine_d__58()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __ViewController___ReplaceViewControllerCoroutine_d__60()  = default;
public:
...
/// @brief Field animationDirection offset 0x2c
 __declspec(property(get=__get_animationDirection, put=__set_animationDirection)) ::HMUI::__ViewController__AnimationDirection  animationDirection;

/// @brief Field finishedCallback offset 0x30
 __declspec(property(get=__get_finishedCallback, put=__set_finishedCallback)) ::System::Action*  finishedCallback;

/// @brief Field <movingInViewController>5__2 offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::ViewController*> __get__movingInViewController_5__2() const;
...
// Ctor Parameters []
// @brief default ctor
 __ViewController___DismissViewControllerCoroutine_d__62()  = default;
public:
...
/// @brief Field kTransitionMoveOffset offset 0x0
static constexpr float_t  kTransitionMoveOffset{2.0};

/// @brief Field didActivateEvent offset 0x18
...
/// @brief Field didDeactivateEvent offset 0x20
...
/// @brief Field <buttonBinder>k__BackingField offset 0x28
...
/// @brief Field _containerViewController offset 0x30
...
/// @brief Field _parentViewController offset 0x38
...
/// @brief Field _childViewController offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::__ViewController__DidActivateDelegate*> __get_didActivateEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::__ViewController__DidDeactivateDelegate*> __get_didDeactivateEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::ButtonBinder*> __get__buttonBinder_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::ContainerViewController*> __get__containerViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::ViewController*> __get__parentViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::ViewController*> __get__childViewController() const;

constexpr void __set__screen(::HMUI::Screen*  value) ;

constexpr ::HMUI::Screen* __get__screen() ;

constexpr ::cordl_internals::to_const_pointer<::HMUI::Screen*> __get__screen() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::EventSystems::BaseRaycaster*> __get__graphicRaycaster() const;
