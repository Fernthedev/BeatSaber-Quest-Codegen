...
/// @brief Field _selectedClip offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationClip*> __get__selectedClip() const;
...
// Ctor Parameters []
// @brief default ctor
 InputFieldViewStaticAnimations()  = default;
public:
