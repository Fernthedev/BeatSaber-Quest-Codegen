...
constexpr ::cordl_internals::to_const_pointer<::HMUI::UIKeyboardKey*> __get_key() const;

constexpr void __set___4__this(::HMUI::UIKeyboard*  value) ;

constexpr ::HMUI::UIKeyboard* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::HMUI::UIKeyboard*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __UIKeyboard____c__DisplayClass13_0()  = default;
public:
...
/// @brief Field keyWasPressedEvent offset 0x28
...
/// @brief Field deleteButtonWasPressedEvent offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<char16_t>*> __get_keyWasPressedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::TMPro::TextMeshProUGUI*>*> __get__letterBtnTexts() const;
