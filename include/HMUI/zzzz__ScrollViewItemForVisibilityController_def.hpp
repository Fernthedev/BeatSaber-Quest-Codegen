...
/// @brief Method GetWorldCorners addr 0x2144e44 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x2144eac size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 ScrollViewItemForVisibilityController()  = default;
public:
