...
/// @brief Field _canvas offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::EventSystems::RaycastResult>*> __get_results() const;
...
// Ctor Parameters []
// @brief default ctor
 RaycastUITopLevelChecker()  = default;
public:
