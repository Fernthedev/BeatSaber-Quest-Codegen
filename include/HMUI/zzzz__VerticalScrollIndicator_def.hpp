...
/// @brief Field _handle offset 0x18
...
/// @brief Field _disabledAnimationClip offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> __get__handle() const;
...
// Ctor Parameters []
// @brief default ctor
 VerticalScrollIndicator()  = default;
public:
