...
/// @brief Field hoverHint offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::HoverHint*> __get_hoverHint() const;

constexpr void __set___4__this(::HMUI::HoverHintController*  value) ;

constexpr ::HMUI::HoverHintController* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::HMUI::HoverHintController*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __HoverHintController___ShowHintAfterDelay_d__10()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __HoverHintController___HideHintAfterDelay_d__11()  = default;
public:
...
/// @brief Field kShowHintDelay offset 0x0
static constexpr float_t  kShowHintDelay{0.6};

/// @brief Field kHideHintDelay offset 0x0
static constexpr float_t  kHideHintDelay{0.3};

/// @brief Field _hoverHintPanelPrefab offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::HoverHintPanel*> __get__hoverHintPanelPrefab() const;

constexpr void __set__hoverHintPanel(::HMUI::HoverHintPanel*  value) ;

constexpr ::HMUI::HoverHintPanel* __get__hoverHintPanel() ;

constexpr ::cordl_internals::to_const_pointer<::HMUI::HoverHintPanel*> __get__hoverHintPanel() const;
