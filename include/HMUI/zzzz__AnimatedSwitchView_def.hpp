...
/// @brief Method .ctor addr 0x2130100 size 0x18 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __AnimatedSwitchView__ColorBlock()  = default;
public:
...
struct CORDL_TYPE __AnimatedSwitchView__AnimationState : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____AnimatedSwitchView__AnimationState_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __AnimatedSwitchView__AnimationState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __AnimatedSwitchView__AnimationState()  = default;
...
static inline ::HMUI::__AnimatedSwitchView__GetColorDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method .ctor addr 0x212fd40 size 0x12c virtual false final false
inline void _ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method Invoke addr 0x2130118 size 0x14 virtual true final false
inline ::UnityEngine::Color Invoke(::HMUI::__AnimatedSwitchView__ColorBlock*  colorBlock) ;

/// @brief Method BeginInvoke addr 0x213012c size 0x20 virtual true final false
...
/// @brief Method EndInvoke addr 0x213014c size 0x2c virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 __AnimatedSwitchView__GetColorDelegate()  = default;
public:
...
/// @brief Method .ctor addr 0x21301dc size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <LerpColors>b__31_0 addr 0x21301e4 size 0x1c virtual false final false
inline ::UnityEngine::Color _LerpColors_b__31_0(::HMUI::__AnimatedSwitchView__ColorBlock*  colorBlock) ;

/// @brief Method <LerpColors>b__31_1 addr 0x2130200 size 0x1c virtual false final false
inline ::UnityEngine::Color _LerpColors_b__31_1(::HMUI::__AnimatedSwitchView__ColorBlock*  colorBlock) ;

/// @brief Method <LerpColors>b__31_2 addr 0x213021c size 0x1c virtual false final false
inline ::UnityEngine::Color _LerpColors_b__31_2(::HMUI::__AnimatedSwitchView__ColorBlock*  colorBlock) ;

/// @brief Method <LerpColors>b__31_3 addr 0x2130238 size 0x1c virtual false final false
inline ::UnityEngine::Color _LerpColors_b__31_3(::HMUI::__AnimatedSwitchView__ColorBlock*  colorBlock) ;

/// @brief Method <LerpColors>b__31_4 addr 0x2130254 size 0x1c virtual false final false
inline ::UnityEngine::Color _LerpColors_b__31_4(::HMUI::__AnimatedSwitchView__ColorBlock*  colorBlock) ;

/// @brief Method <LerpColors>b__31_5 addr 0x2130270 size 0x1c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __AnimatedSwitchView____c()  = default;
public:
...
// Static field <>9__31_0

// Static field <>9__31_1

// Static field <>9__31_2

// Static field <>9__31_3

// Static field <>9__31_4

// Static field <>9__31_5
...
/// @brief Field _knobRectTransform offset 0x18
...
/// @brief Field _highlightAnimationDuration offset 0x48
...
/// @brief Field _horizontalStretchAmount offset 0x4c
...
/// @brief Field _offHighlightedColors offset 0x70
...
/// @brief Field _disabledColors offset 0x78
...
/// @brief Field _animationState offset 0x80
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> __get__knobRectTransform() const;

constexpr void __set__backgroundImage(::HMUI::ImageView*  value) ;

constexpr ::HMUI::ImageView* __get__backgroundImage() ;

constexpr ::cordl_internals::to_const_pointer<::HMUI::ImageView*> __get__backgroundImage() const;

constexpr void __set__knobImage(::HMUI::ImageView*  value) ;

constexpr ::HMUI::ImageView* __get__knobImage() ;

constexpr ::cordl_internals::to_const_pointer<::HMUI::ImageView*> __get__knobImage() const;

constexpr void __set__onText(::TMPro::TextMeshProUGUI*  value) ;

constexpr ::TMPro::TextMeshProUGUI* __get__onText() ;

constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> __get__onText() const;

constexpr void __set__offText(::TMPro::TextMeshProUGUI*  value) ;

constexpr ::TMPro::TextMeshProUGUI* __get__offText() ;

constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> __get__offText() const;
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::__AnimatedSwitchView__ColorBlock*> __get__onColors() const;
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::__AnimatedSwitchView__ColorBlock*> __get__offColors() const;
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::__AnimatedSwitchView__ColorBlock*> __get__onHighlightedColors() const;
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::__AnimatedSwitchView__ColorBlock*> __get__offHighlightedColors() const;
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::__AnimatedSwitchView__ColorBlock*> __get__disabledColors() const;
...
/// @brief Method Awake addr 0x212f190 size 0x50 virtual false final false
inline void Awake() ;

/// @brief Method Start addr 0x212f1e0 size 0x1a0 virtual false final false
inline void Start() ;

/// @brief Method OnDestroy addr 0x212f8d8 size 0x150 virtual false final false
inline void OnDestroy() ;

/// @brief Method Update addr 0x212fa28 size 0x298 virtual false final false
inline void Update() ;

/// @brief Method LerpPosition addr 0x212f874 size 0x64 virtual false final false
inline void LerpPosition(float_t  switchAmount) ;

/// @brief Method LerpStretch addr 0x212fcc0 size 0x80 virtual false final false
inline void LerpStretch(float_t  switchAmount) ;

/// @brief Method LerpColors addr 0x212f380 size 0x4f4 virtual false final false
inline void LerpColors(float_t  switchAmount, float_t  highlightAmount, float_t  disabledAmount) ;

/// @brief Method LerpColor addr 0x212fe6c size 0x1ac virtual false final false
...
/// @brief Method HandleOnValueChanged addr 0x2130058 size 0x28 virtual false final false
inline void HandleOnValueChanged(bool  value) ;

/// @brief Method HandleStateDidChange addr 0x2130080 size 0x60 virtual false final false
...
/// @brief Method .ctor addr 0x21300e0 size 0x20 virtual false final false
inline void _ctor() ;
