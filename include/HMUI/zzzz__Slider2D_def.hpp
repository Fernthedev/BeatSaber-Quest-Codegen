...
/// @brief Field _normalizedValue offset 0x100
...
/// @brief Field normalizedValueDidChangeEvent offset 0x108
 __declspec(property(get=__get_normalizedValueDidChangeEvent, put=__set_normalizedValueDidChangeEvent)) ::System::Action_2<::HMUI::Slider2D*,::UnityEngine::Vector2>*  normalizedValueDidChangeEvent;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::HMUI::Slider2D*,::UnityEngine::Vector2>*> __get_normalizedValueDidChangeEvent() const;
