...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Sprite*> __get__normalStateSprite() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Sprite*> __get__highlightStateSprite() const;

constexpr void __set__pressedStateSprite(::UnityEngine::Sprite*  value) ;

constexpr ::UnityEngine::Sprite* __get__pressedStateSprite() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Sprite*> __get__pressedStateSprite() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Sprite*> __get__disabledStateSprite() const;
