...
::cordl_internals::setInstanceField<::UnityEngine::RectTransform*, 0xa8>(this, std::forward<::UnityEngine::RectTransform*>(value));
}
constexpr ::UnityEngine::RectTransform* HMUI::CircleTouchable::__get__containerRect()  {
return ::cordl_internals::getInstanceField<::UnityEngine::RectTransform*, 0xa8>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> HMUI::CircleTouchable::__get__containerRect() const {
return ::cordl_internals::getInstanceField<::UnityEngine::RectTransform*, 0xa8>(this);
}
