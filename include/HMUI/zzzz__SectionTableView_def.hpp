...
struct CORDL_TYPE __SectionTableView__Section : public ::bs_hook::ValueTypeWrapper<0xc> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0xc};

/// @brief Field unfolded offset 0x0
 __declspec(property(get=__get_unfolded, put=__set_unfolded)) bool  unfolded;

/// @brief Field startBaseRow offset 0x4
 __declspec(property(get=__get_startBaseRow, put=__set_startBaseRow)) int32_t  startBaseRow;

/// @brief Field numberOfBaseRows offset 0x8
 __declspec(property(get=__get_numberOfBaseRows, put=__set_numberOfBaseRows)) int32_t  numberOfBaseRows;

constexpr void __set_unfolded(bool  value) ;

constexpr bool& __get_unfolded() ;

constexpr bool const& __get_unfolded() const;

constexpr void __set_startBaseRow(int32_t  value) ;

constexpr int32_t& __get_startBaseRow() ;

constexpr int32_t const& __get_startBaseRow() const;

constexpr void __set_numberOfBaseRows(int32_t  value) ;

constexpr int32_t& __get_numberOfBaseRows() ;

constexpr int32_t const& __get_numberOfBaseRows() const;
...
constexpr explicit __SectionTableView__Section(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0xc>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __SectionTableView__Section()  = default;
...
/// @brief Field didSelectHeaderEvent offset 0xb0
...
/// @brief Field _sections offset 0xc0
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_3<::HMUI::SectionTableView*,int32_t,int32_t>*> __get_didSelectRowInSectionEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::HMUI::SectionTableView*,int32_t>*> __get_didSelectHeaderEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::__SectionTableView__IDataSource*> __get__dataSource() const;
