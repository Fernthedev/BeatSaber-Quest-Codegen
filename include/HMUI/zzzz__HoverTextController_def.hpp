...
constexpr ::cordl_internals::to_const_pointer<::HMUI::HoverTextController*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __HoverTextController___ShowTextCoroutine_d__10()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __HoverTextController___HideTextCoroutine_d__12()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> __get__textMesh() const;
