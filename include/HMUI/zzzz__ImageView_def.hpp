...
struct CORDL_TYPE __ImageView__GradientDirection : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____ImageView__GradientDirection_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __ImageView__GradientDirection(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ImageView__GradientDirection()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x160 - sizeof(::UnityEngine::UI::Image)]{};

/// @brief Field _useScriptableObjectColors offset 0x108
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorSO*> __get__color0So() const;

constexpr void __set__color1So(::GlobalNamespace::ColorSO*  value) ;

constexpr ::GlobalNamespace::ColorSO* __get__color1So() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorSO*> __get__color1So() const;
