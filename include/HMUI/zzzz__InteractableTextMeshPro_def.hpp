...
/// @brief Field _canvasGroupCache offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::CanvasGroup*>*> __get__canvasGroupCache() const;
...
// Ctor Parameters []
// @brief default ctor
 InteractableTextMeshPro()  = default;
public:
