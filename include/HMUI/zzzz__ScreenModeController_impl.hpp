...
::cordl_internals::setInstanceField<::ArrayW<::HMUI::CurvedCanvasSettings*,::Array<::HMUI::CurvedCanvasSettings*>*>, 0x18>(this, std::forward<::ArrayW<::HMUI::CurvedCanvasSettings*,::Array<::HMUI::CurvedCanvasSettings*>*>>(value));
}
...
return ::cordl_internals::getInstanceField<::ArrayW<::HMUI::CurvedCanvasSettings*,::Array<::HMUI::CurvedCanvasSettings*>*>, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IVRPlatformHelper*> HMUI::ScreenModeController::__get__vrPlatformHelper() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IVRPlatformHelper*, 0x20>(this);
}
constexpr void HMUI::ScreenModeController::__set__defaultModeData(::HMUI::ScreenModeData*  value)  {
::cordl_internals::setInstanceField<::HMUI::ScreenModeData*, 0x28>(this, std::forward<::HMUI::ScreenModeData*>(value));
}
constexpr ::HMUI::ScreenModeData* HMUI::ScreenModeController::__get__defaultModeData()  {
return ::cordl_internals::getInstanceField<::HMUI::ScreenModeData*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::HMUI::ScreenModeData*> HMUI::ScreenModeController::__get__defaultModeData() const {
return ::cordl_internals::getInstanceField<::HMUI::ScreenModeData*, 0x28>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> HMUI::ScreenModeController::__get__transform() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x30>(this);
}
