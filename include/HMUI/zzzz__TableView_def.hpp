...
struct CORDL_TYPE __TableView__TableType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____TableView__TableType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __TableView__TableType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __TableView__TableType()  = default;
...
struct CORDL_TYPE __TableView__ScrollPositionType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____TableView__ScrollPositionType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __TableView__ScrollPositionType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __TableView__ScrollPositionType()  = default;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HMUI::TableCell*>*> __get__cells() const;
...
// Ctor Parameters []
// @brief default ctor
 __TableView__CellsGroup()  = default;
public:
...
/// @brief Field didReloadDataEvent offset 0x40
...
/// @brief Field didInsertCellsEvent offset 0x48
...
/// @brief Field didDeleteCellsEvent offset 0x50
...
/// @brief Field didChangeRectSizeEvent offset 0x58
...
/// @brief Field _reusableCells offset 0x88
 __declspec(property(get=__get__reusableCells, put=__set__reusableCells)) ::System::Collections::Generic::Dictionary_2<::StringW,::System::Collections::Generic::List_1<::HMUI::TableCell*>*>*  _reusableCells;

/// @brief Field _selectedCellIdxs offset 0x90
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::HMUI::TableView*,int32_t>*> __get_didSelectCellWithIdxEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::HMUI::TableView*>*> __get_didReloadDataEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::HMUI::TableView*>*> __get_didInsertCellsEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::HMUI::TableView*>*> __get_didDeleteCellsEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::HMUI::TableView*>*> __get_didChangeRectSizeEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> __get__viewportTransform() const;
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::__TableView__IDataSource*> __get__dataSource() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HMUI::TableCell*>*> __get__visibleCells() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::System::Collections::Generic::List_1<::HMUI::TableCell*>*>*> __get__reusableCells() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<int32_t>*> __get__selectedCellIdxs() const;
