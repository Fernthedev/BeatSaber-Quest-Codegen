...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x60 - sizeof(::UnityEngine::UI::LayoutGroup)]{};

/// @brief Field m_ChildForceExpandWidth offset 0x58
 __declspec(property(get=__get_m_ChildForceExpandWidth, put=__set_m_ChildForceExpandWidth)) bool  m_ChildForceExpandWidth;

/// @brief Field m_ChildForceExpandHeight offset 0x59
