...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> __get__handleRect() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::HMUI::CircleSlider*,float_t>*> __get_normalizedValueDidChangeEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Graphic*> __get__handleGraphic() const;
...
/// @brief Method get_handleRect addr 0x2120854 size 0x8 virtual false final false
inline ::UnityEngine::RectTransform* get_handleRect() ;

/// @brief Method set_handleRect addr 0x212085c size 0x88 virtual false final false
inline void set_handleRect(::UnityEngine::RectTransform*  value) ;

/// @brief Method set_handleColor addr 0x2120a1c size 0xc4 virtual false final false
inline void set_handleColor(::UnityEngine::Color  value) ;

/// @brief Method get_normalizedValue addr 0x2120ae0 size 0x8 virtual false final false
inline float_t get_normalizedValue() ;

/// @brief Method set_normalizedValue addr 0x2120ae8 size 0x38 virtual false final false
inline void set_normalizedValue(float_t  value) ;

/// @brief Method add_normalizedValueDidChangeEvent addr 0x2120b9c size 0xb4 virtual false final false
inline void add_normalizedValueDidChangeEvent(::System::Action_2<::HMUI::CircleSlider*,float_t>*  value) ;

/// @brief Method remove_normalizedValueDidChangeEvent addr 0x2120c50 size 0xb4 virtual false final false
inline void remove_normalizedValueDidChangeEvent(::System::Action_2<::HMUI::CircleSlider*,float_t>*  value) ;

/// @brief Method Rebuild addr 0x2120d04 size 0x4 virtual true final false
inline void Rebuild(::UnityEngine::UI::CanvasUpdate  executing) ;

/// @brief Method LayoutComplete addr 0x2120d08 size 0x4 virtual true final false
inline void LayoutComplete() ;

/// @brief Method GraphicUpdateComplete addr 0x2120d0c size 0x4 virtual true final false
inline void GraphicUpdateComplete() ;

/// @brief Method OnEnable addr 0x2120d10 size 0x68 virtual true final false
inline void OnEnable() ;

/// @brief Method OnDisable addr 0x2120d78 size 0x24 virtual true final false
inline void OnDisable() ;

/// @brief Method UpdateCachedReferences addr 0x21208e4 size 0x138 virtual false final false
inline void UpdateCachedReferences() ;

/// @brief Method SetNormalizedValue addr 0x2120d9c size 0x8 virtual false final false
inline void SetNormalizedValue(float_t  input) ;

/// @brief Method SetNormalizedValue addr 0x2120b20 size 0x7c virtual false final false
inline void SetNormalizedValue(float_t  input, bool  sendCallback) ;

/// @brief Method OnRectTransformDimensionsChange addr 0x2120da4 size 0x44 virtual true final false
inline void OnRectTransformDimensionsChange() ;

/// @brief Method UpdateVisuals addr 0x2120de8 size 0x168 virtual true final false
inline void UpdateVisuals() ;

/// @brief Method UpdateDrag addr 0x2120f50 size 0x27c virtual false final false
inline void UpdateDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method MayDrag addr 0x21211cc size 0x64 virtual false final false
inline bool MayDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnBeginDrag addr 0x2121230 size 0x80 virtual true final false
inline void OnBeginDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnDrag addr 0x21212b0 size 0x90 virtual true final false
inline void OnDrag(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnPointerDown addr 0x2121340 size 0xa0 virtual true final false
inline void OnPointerDown(::UnityEngine::EventSystems::PointerEventData*  eventData) ;

/// @brief Method OnInitializePotentialDrag addr 0x21213e0 size 0x18 virtual true final false
...
/// @brief Method .ctor addr 0x21213f8 size 0x60 virtual false final false
inline void _ctor() ;

/// @brief Method UnityEngine.UI.ICanvasElement.get_transform addr 0x2121458 size 0x8 virtual true final true
