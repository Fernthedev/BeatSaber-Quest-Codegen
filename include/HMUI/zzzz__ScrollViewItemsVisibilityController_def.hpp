...
// Ctor Parameters []
// @brief default ctor
 __ScrollViewItemsVisibilityController____c()  = default;
public:
...
/// @brief Field _items offset 0x28
...
/// @brief Field _lastContentAnchoredPositionY offset 0x30
...
/// @brief Field _viewportWorldCorners offset 0x38
...
/// @brief Field _upperItemsCornes offset 0x40
 __declspec(property(get=__get__upperItemsCornes, put=__set__upperItemsCornes)) ::ArrayW<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*,::Array<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*>*>  _upperItemsCornes;

/// @brief Field _lowerItemsCornes offset 0x48
 __declspec(property(get=__get__lowerItemsCornes, put=__set__lowerItemsCornes)) ::ArrayW<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*,::Array<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*>*>  _lowerItemsCornes;

/// @brief Field _lowerLastVisibleIndex offset 0x50
 __declspec(property(get=__get__lowerLastVisibleIndex, put=__set__lowerLastVisibleIndex)) int32_t  _lowerLastVisibleIndex;

/// @brief Field _upperLastVisibleIndex offset 0x54
 __declspec(property(get=__get__upperLastVisibleIndex, put=__set__upperLastVisibleIndex)) int32_t  _upperLastVisibleIndex;

/// @brief Field _contentMaxY offset 0x58
 __declspec(property(get=__get__contentMaxY, put=__set__contentMaxY)) float_t  _contentMaxY;

/// @brief Field _contentMinY offset 0x5c
...
constexpr void __set__upperItemsCornes(::ArrayW<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*,::Array<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*>*>  value) ;

constexpr ::ArrayW<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*,::Array<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*>*>& __get__upperItemsCornes() ;

constexpr ::ArrayW<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*,::Array<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*>*> const& __get__upperItemsCornes() const;

constexpr void __set__lowerItemsCornes(::ArrayW<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*,::Array<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*>*>  value) ;

constexpr ::ArrayW<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*,::Array<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*>*>& __get__lowerItemsCornes() ;

constexpr ::ArrayW<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*,::Array<::System::Tuple_2<::HMUI::ScrollViewItemForVisibilityController*,float_t>*>*> const& __get__lowerItemsCornes() const;
...
// Ctor Parameters []
// @brief default ctor
 ScrollViewItemsVisibilityController()  = default;
public:
