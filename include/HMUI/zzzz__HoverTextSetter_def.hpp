...
/// @brief Field _hoverTextController offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::HoverTextController*> __get__hoverTextController() const;
