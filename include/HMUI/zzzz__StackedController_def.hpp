...
/// @brief Field numberOfViewControllersToPop offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __StackedController____c__DisplayClass5_0()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x80 - sizeof(::HMUI::ContainerViewController)]{};
