...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Unity::Collections::NativeDisableParallelForRestrictionAttribute::*)()>(&::Unity::Collections::NativeDisableParallelForRestrictionAttribute::_ctor)> {
