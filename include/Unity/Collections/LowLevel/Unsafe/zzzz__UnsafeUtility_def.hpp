...
struct CORDL_TYPE __UnsafeUtility__AlignOfHelper_1 : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x10};

/// @brief Field dummy offset 0x0
 __declspec(property(get=__get_dummy, put=__set_dummy)) uint8_t  dummy;
...
constexpr uint8_t& __get_dummy() ;

constexpr uint8_t const& __get_dummy() const;
...
constexpr explicit __UnsafeUtility__AlignOfHelper_1(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __UnsafeUtility__AlignOfHelper_1()  = default;
