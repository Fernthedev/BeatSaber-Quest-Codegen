...
struct CORDL_TYPE __OculusLoader__DeviceSupportedResult : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____OculusLoader__DeviceSupportedResult_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __OculusLoader__DeviceSupportedResult(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OculusLoader__DeviceSupportedResult()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::UnityEngine::XR::Management::XRLoaderHelper)]{};
...
// Static field s_InputSubsystemDescriptors
