...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x170 - sizeof(::UnityEngine::InputSystem::InputDevice)]{};

/// @brief Field <back>k__BackingField offset 0x158
...
/// @brief Field <start>k__BackingField offset 0x160
...
/// @brief Field <touchpad>k__BackingField offset 0x168
