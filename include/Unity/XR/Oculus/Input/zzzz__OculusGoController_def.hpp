...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x1e0 - sizeof(::Unity::XR::Oculus::Input::GearVRTrackedController)]{};

static inline ::Unity::XR::Oculus::Input::OculusGoController* New_ctor() ;

/// @brief Method .ctor addr 0x2c7cb78 size 0x8 virtual false final false
inline void _ctor() ;
