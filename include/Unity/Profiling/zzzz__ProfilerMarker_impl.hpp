...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Unity::Profiling::__ProfilerMarker__AutoScope::*)(::cordl_internals::intptr_t)>(&::Unity::Profiling::__ProfilerMarker__AutoScope::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Unity::Profiling::__ProfilerMarker__AutoScope::*)()>(&::Unity::Profiling::__ProfilerMarker__AutoScope::Dispose)> {
...
constexpr void Unity::Profiling::__ProfilerMarker__AutoScope::__set_m_Ptr(::cordl_internals::intptr_t  value)  {
...
constexpr ::cordl_internals::intptr_t& Unity::Profiling::__ProfilerMarker__AutoScope::__get_m_Ptr()  {
...
constexpr ::cordl_internals::intptr_t const& Unity::Profiling::__ProfilerMarker__AutoScope::__get_m_Ptr() const {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
inline void Unity::Profiling::__ProfilerMarker__AutoScope::_ctor(::cordl_internals::intptr_t  markerPtr)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Unity::Profiling::__ProfilerMarker__AutoScope>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
constexpr ::Unity::Profiling::__ProfilerMarker__AutoScope::__ProfilerMarker__AutoScope(::cordl_internals::intptr_t  m_Ptr) noexcept : ::bs_hook::ValueTypeWrapper<0x8>() {this->m_Ptr = m_Ptr;
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Unity::Profiling::__ProfilerMarker__AutoScope (::Unity::Profiling::ProfilerMarker::*)()>(&::Unity::Profiling::ProfilerMarker::Auto)> {
...
constexpr ::cordl_internals::intptr_t& Unity::Profiling::ProfilerMarker::__get_m_Ptr()  {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::cordl_internals::intptr_t const& Unity::Profiling::ProfilerMarker::__get_m_Ptr() const {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
// Ctor Parameters [CppParam { name: "m_Ptr", ty: "::cordl_internals::intptr_t", modifiers: "", def_value: Some("{}") }]
constexpr ::Unity::Profiling::ProfilerMarker::ProfilerMarker(::cordl_internals::intptr_t  m_Ptr) noexcept : ::bs_hook::ValueTypeWrapper<0x8>() {this->m_Ptr = m_Ptr;
}
