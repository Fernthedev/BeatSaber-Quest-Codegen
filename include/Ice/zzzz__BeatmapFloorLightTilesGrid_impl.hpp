...
::cordl_internals::setInstanceField<::Ice::FloorLightTilesGrid*, 0x28>(this, std::forward<::Ice::FloorLightTilesGrid*>(value));
}
constexpr ::Ice::FloorLightTilesGrid* Ice::BeatmapFloorLightTilesGrid::__get__floorLightTilesGrid()  {
return ::cordl_internals::getInstanceField<::Ice::FloorLightTilesGrid*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Ice::FloorLightTilesGrid*> Ice::BeatmapFloorLightTilesGrid::__get__floorLightTilesGrid() const {
return ::cordl_internals::getInstanceField<::Ice::FloorLightTilesGrid*, 0x28>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::IBeatmapObjectSpawnController*, 0x30>(this, std::forward<::GlobalNamespace::IBeatmapObjectSpawnController*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::IBeatmapObjectSpawnController*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IBeatmapObjectSpawnController*> Ice::BeatmapFloorLightTilesGrid::__get__beatmapObjectSpawnController() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IBeatmapObjectSpawnController*, 0x30>(this);
}
