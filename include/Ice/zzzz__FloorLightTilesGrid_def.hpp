...
/// @brief Field _floorLightTileMemoryPool offset 0x18
...
/// @brief Field _floorLightTileMemoryPoolContainer offset 0x20
 __declspec(property(get=__get__floorLightTileMemoryPoolContainer, put=__set__floorLightTileMemoryPoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::Ice::FloorLightTile*>*  _floorLightTileMemoryPoolContainer;

/// @brief Field _grid offset 0x28
 __declspec(property(get=__get__grid, put=__set__grid)) ::ArrayW<::ArrayW<::Ice::FloorLightTile*,::Array<::Ice::FloorLightTile*>*>,::Array<::ArrayW<::Ice::FloorLightTile*,::Array<::Ice::FloorLightTile*>*>>*>  _grid;

/// @brief Field _tileWidth offset 0x30
 __declspec(property(get=__get__tileWidth, put=__set__tileWidth)) float_t  _tileWidth;

/// @brief Field _tileHeight offset 0x34
 __declspec(property(get=__get__tileHeight, put=__set__tileHeight)) float_t  _tileHeight;

/// @brief Field _anchorPoint offset 0x38
 __declspec(property(get=__get__anchorPoint, put=__set__anchorPoint)) ::UnityEngine::Vector3  _anchorPoint;

/// @brief Field _ySize offset 0x44
...
constexpr ::cordl_internals::to_const_pointer<::Ice::__FloorLightTile__Pool*> __get__floorLightTileMemoryPool() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::Ice::FloorLightTile*>*> __get__floorLightTileMemoryPoolContainer() const;
