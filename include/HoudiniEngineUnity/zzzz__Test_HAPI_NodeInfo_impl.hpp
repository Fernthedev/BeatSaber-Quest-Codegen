...
::cordl_internals::setInstanceField<::HoudiniEngineUnity::HAPI_NodeInfo, 0x10>(this, std::forward<::HoudiniEngineUnity::HAPI_NodeInfo>(value));
}
constexpr ::HoudiniEngineUnity::HAPI_NodeInfo& HoudiniEngineUnity::Test_HAPI_NodeInfo::__get_self()  {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HAPI_NodeInfo, 0x10>(this);
}
constexpr ::HoudiniEngineUnity::HAPI_NodeInfo const& HoudiniEngineUnity::Test_HAPI_NodeInfo::__get_self() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HAPI_NodeInfo, 0x10>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::HoudiniEngineUnity::Test_HAPI_NodeInfo*>(self));
}
