...
constexpr int32_t& HoudiniEngineUnity::HAPI_ImageFileFormat::__get_nameSH()  {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& HoudiniEngineUnity::HAPI_ImageFileFormat::__get_nameSH() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& HoudiniEngineUnity::HAPI_ImageFileFormat::__get_descriptionSH()  {
return ::cordl_internals::getInstanceField<int32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& HoudiniEngineUnity::HAPI_ImageFileFormat::__get_descriptionSH() const {
return ::cordl_internals::getInstanceField<int32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& HoudiniEngineUnity::HAPI_ImageFileFormat::__get_defaultExtensionSH()  {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& HoudiniEngineUnity::HAPI_ImageFileFormat::__get_defaultExtensionSH() const {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::HoudiniEngineUnity::HAPI_ImageFileFormat::HAPI_ImageFileFormat(int32_t  nameSH, int32_t  descriptionSH, int32_t  defaultExtensionSH) noexcept : ::bs_hook::ValueTypeWrapper<0xc>() {this->nameSH = nameSH;
