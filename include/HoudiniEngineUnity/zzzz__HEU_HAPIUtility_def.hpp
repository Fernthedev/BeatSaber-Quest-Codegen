...
/// @brief Method GetHoudiniEngineInstallationInfo addr 0x2185864 size 0x40 virtual false final false
static inline ::StringW GetHoudiniEngineInstallationInfo() ;

/// @brief Method GetEnvironmentPath addr 0x21858a4 size 0x48 virtual false final false
static inline ::StringW GetEnvironmentPath() ;

/// @brief Method GetRealPathFromHFSPath addr 0x21858ec size 0x160 virtual false final false
static inline ::StringW GetRealPathFromHFSPath(::StringW  inPath) ;

/// @brief Method DoesMappedPathExist addr 0x2185aa0 size 0x9c virtual false final false
static inline bool DoesMappedPathExist(::StringW  inPath) ;

/// @brief Method IsHoudiniAssetFile addr 0x2185df8 size 0x144 virtual false final false
static inline bool IsHoudiniAssetFile(::StringW  filePath) ;

/// @brief Method FindHoudiniAssetFileInPathWithExt addr 0x2185f3c size 0x284 virtual false final false
static inline ::StringW FindHoudiniAssetFileInPathWithExt(::StringW  filePath) ;

/// @brief Method Log addr 0x21861c8 size 0x8 virtual false final false
static inline void Log(::StringW  message) ;

/// @brief Method LogWarning addr 0x21861d0 size 0x8 virtual false final false
static inline void LogWarning(::StringW  message) ;

/// @brief Method LogError addr 0x21861d8 size 0x8 virtual false final false
static inline void LogError(::StringW  message) ;

/// @brief Method LocateValidFilePath addr 0x21861e0 size 0x6c virtual false final false
static inline ::StringW LocateValidFilePath(::UnityEngine::Object*  inObject) ;

/// @brief Method LocateValidFilePath addr 0x218624c size 0x8 virtual false final false
static inline ::StringW LocateValidFilePath(::StringW  assetName, ::StringW  inFilePath) ;

/// @brief Method InstantiateHDA addr 0x2186254 size 0x260 virtual false final false
static inline ::UnityEngine::GameObject* InstantiateHDA(::StringW  filePath, ::UnityEngine::Vector3  initialPosition, ::HoudiniEngineUnity::HEU_SessionBase*  session, bool  bBuildAsync, bool  bLoadFromMemory, bool  bAlwaysOverwriteOnLoad, ::UnityEngine::GameObject*  rootGO) ;

/// @brief Method LoadHDAFile addr 0x21865a4 size 0x220 virtual false final false
...
/// @brief Method CreateAndCookAssetNode addr 0x21867c4 size 0x1b8 virtual false final false
...
/// @brief Method CreateAndCookCurveAsset addr 0x2186ba8 size 0xec virtual false final false
...
/// @brief Method CreateAndCookInputAsset addr 0x2186c94 size 0x1d4 virtual false final false
...
/// @brief Method CookNodeInHoudini addr 0x2186b50 size 0x58 virtual false final false
...
/// @brief Method CookNodeInHoudiniWithOptions addr 0x2186ec0 size 0x7c virtual false final false
...
/// @brief Method GetDefaultCookOptions addr 0x2186f3c size 0x44 virtual false final false
static inline ::HoudiniEngineUnity::HAPI_CookOptions GetDefaultCookOptions(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method ProcessHoudiniCookStatus addr 0x218697c size 0x1d4 virtual false final false
static inline bool ProcessHoudiniCookStatus(::HoudiniEngineUnity::HEU_SessionBase*  session, ::StringW  assetName) ;

/// @brief Method CreateNewAsset addr 0x2186fe0 size 0x3b0 virtual false final false
static inline ::UnityEngine::GameObject* CreateNewAsset(::HoudiniEngineUnity::__HEU_HoudiniAsset__HEU_AssetType  assetType, ::StringW  rootName, ::UnityEngine::Transform*  parentTransform, ::HoudiniEngineUnity::HEU_SessionBase*  session, bool  bBuildAsync, ::UnityEngine::GameObject*  rootGO) ;

/// @brief Method CreateNewCurveAsset addr 0x2187390 size 0x24 virtual false final false
static inline ::UnityEngine::GameObject* CreateNewCurveAsset(::StringW  name, ::UnityEngine::Transform*  parentTransform, ::HoudiniEngineUnity::HEU_SessionBase*  session, bool  bBuildAsync, ::UnityEngine::GameObject*  rootGO) ;

/// @brief Method CreateNewInputAsset addr 0x21873b4 size 0x24 virtual false final false
static inline ::UnityEngine::GameObject* CreateNewInputAsset(::StringW  name, ::UnityEngine::Transform*  parentTransform, ::HoudiniEngineUnity::HEU_SessionBase*  session, bool  bBuildAsync, ::UnityEngine::GameObject*  rootGO) ;

/// @brief Method LoadGeoWithNewGeoSync addr 0x21873d8 size 0x8 virtual false final false
static inline ::UnityEngine::GameObject* LoadGeoWithNewGeoSync(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method DestroyChildren addr 0x21873e0 size 0x47c virtual false final false
static inline void DestroyChildren(::UnityEngine::Transform*  inTransform) ;

/// @brief Method DestroyGameObject addr 0x218785c size 0x10 virtual false final false
...
/// @brief Method IsNodeValidInHoudini addr 0x218786c size 0xa0 virtual false final false
static inline bool IsNodeValidInHoudini(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  nodeID) ;

/// @brief Method GetAssetInScene addr 0x218790c size 0x104 virtual false final false
static inline ::HoudiniEngineUnity::HEU_HoudiniAssetRoot* GetAssetInScene(int32_t  assetID) ;

/// @brief Method ApplyWorldTransfromFromHoudiniToUnity addr 0x2187a10 size 0x1e8 virtual false final false
...
/// @brief Method ApplyLocalTransfromFromHoudiniToUnity addr 0x2187bf8 size 0x114 virtual false final false
...
/// @brief Method ApplyLocalTransfromFromHoudiniToUnityForInstance addr 0x2187d0c size 0x1c8 virtual false final false
...
/// @brief Method ApplyMatrixToLocalTransform addr 0x2187ed4 size 0x60 virtual false final false
static inline void ApplyMatrixToLocalTransform(ByRef<::UnityEngine::Matrix4x4>  matrix, ::UnityEngine::Transform*  transform) ;

/// @brief Method GetMatrixFromHAPITransform addr 0x2188304 size 0x17c virtual false final false
...
/// @brief Method GetQuaternion addr 0x2187f40 size 0x360 virtual false final false
static inline ::UnityEngine::Quaternion GetQuaternion(ByRef<::UnityEngine::Matrix4x4>  m) ;

/// @brief Method GetPosition addr 0x2187f34 size 0xc virtual false final false
static inline ::UnityEngine::Vector3 GetPosition(ByRef<::UnityEngine::Matrix4x4>  m) ;

/// @brief Method SetMatrixPosition addr 0x2188480 size 0x18 virtual false final false
static inline void SetMatrixPosition(ByRef<::UnityEngine::Matrix4x4>  m, ByRef<::UnityEngine::Vector3>  position) ;

/// @brief Method GetScale addr 0x21882a0 size 0x64 virtual false final false
static inline ::UnityEngine::Vector3 GetScale(ByRef<::UnityEngine::Matrix4x4>  m) ;

/// @brief Method GetHAPITransformFromMatrix addr 0x2188498 size 0x178 virtual false final false
static inline ::HoudiniEngineUnity::HAPI_TransformEuler GetHAPITransformFromMatrix(ByRef<::UnityEngine::Matrix4x4>  mat) ;

/// @brief Method GetHAPITransform addr 0x21886b4 size 0x124 virtual false final false
...
/// @brief Method GetHAPITransformQuatFromMatrix addr 0x21887d8 size 0x1b4 virtual false final false
static inline ::HoudiniEngineUnity::HAPI_Transform GetHAPITransformQuatFromMatrix(ByRef<::UnityEngine::Matrix4x4>  mat) ;

/// @brief Method GetMatrix4x4 addr 0x2188a38 size 0xc4 virtual false final false
...
/// @brief Method IsSameTransform addr 0x2188afc size 0x64 virtual false final false
...
/// @brief Method IsEqualTol addr 0x2188b60 size 0x10 virtual false final false
static inline bool IsEqualTol(float_t  a, float_t  b, float_t  t) ;

/// @brief Method IsTransformEqual addr 0x2188b70 size 0x1a0 virtual false final false
...
/// @brief Method IsViewportEqual addr 0x2188d10 size 0xe8 virtual false final false
...
/// @brief Method IsSessionSyncEqual addr 0x2188df8 size 0x2c virtual false final false
...
/// @brief Method DoesGeoPartHaveAttribute addr 0x2188e24 size 0x40 virtual false final false
...
/// @brief Method SetAnimationCurveTangentModes addr 0x2188e64 size 0x4 virtual false final false
...
/// @brief Method IsSupportedPolygonType addr 0x2188e68 size 0x1c virtual false final false
static inline bool IsSupportedPolygonType(::HoudiniEngineUnity::HAPI_PartType  partType) ;

/// @brief Method GetParentNodeID addr 0x2188e84 size 0x68 virtual false final false
static inline int32_t GetParentNodeID(::HoudiniEngineUnity::HEU_SessionBase*  session, int32_t  nodeID) ;

/// @brief Method GetObjectInfos addr 0x2188eec size 0x4b8 virtual false final false
