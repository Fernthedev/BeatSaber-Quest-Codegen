...
/// @brief Field _containerObjectNode offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_PartData*>*> __get__parts() const;
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_ObjectNode*> __get__containerObjectNode() const;
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_InputNode*> __get__inputNode() const;

constexpr void __set__geoCurve(::HoudiniEngineUnity::HEU_Curve*  value) ;

constexpr ::HoudiniEngineUnity::HEU_Curve* __get__geoCurve() ;

constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_Curve*> __get__geoCurve() const;
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_VolumeCache*> __get__volumeCache() const;
...
inline void GetPartsByOutputType(::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_PartData*>*  meshParts, ::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_PartData*>*  volumeParts) ;
