...
::cordl_internals::setInstanceField<::HoudiniEngineUnity::HAPI_AssetInfo, 0x10>(this, std::forward<::HoudiniEngineUnity::HAPI_AssetInfo>(value));
}
constexpr ::HoudiniEngineUnity::HAPI_AssetInfo& HoudiniEngineUnity::Test_HAPI_AssetInfo::__get_self()  {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HAPI_AssetInfo, 0x10>(this);
}
