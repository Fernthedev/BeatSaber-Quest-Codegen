...
struct CORDL_TYPE __HEU_PartData__PartOutputType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____HEU_PartData__PartOutputType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __HEU_PartData__PartOutputType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HEU_PartData__PartOutputType()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __HEU_PartData____c__DisplayClass86_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __HEU_PartData____c__DisplayClass88_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __HEU_PartData____c__DisplayClass88_1()  = default;
public:
...
/// @brief Field _objectInstanceInfos offset 0x50
...
/// @brief Field _terrainOffsetPosition offset 0x58
...
/// @brief Field _haveInstancesBeenGenerated offset 0x88
...
/// @brief Field _volumeLayerName offset 0x98
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_GeoNode*> __get__geoNode() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_ObjectInstanceInfo*>*> __get__objectInstanceInfos() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Object*> __get__assetDBTerrainData() const;
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_Curve*> __get__curve() const;
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_AttributesStore*> __get__attributesStore() const;
