...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::HoudiniEngineUnity::__HEU_InputInterfaceTilemap__HEU_InputDataTilemap::*)()>(&::HoudiniEngineUnity::__HEU_InputInterfaceTilemap__HEU_InputDataTilemap::_ctor)> {
...
::cordl_internals::setInstanceField<::UnityEngine::Tilemaps::Tilemap*, 0x18>(this, std::forward<::UnityEngine::Tilemaps::Tilemap*>(value));
}
...
return ::cordl_internals::getInstanceField<::UnityEngine::Tilemaps::Tilemap*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Tilemaps::Tilemap*> HoudiniEngineUnity::__HEU_InputInterfaceTilemap__HEU_InputDataTilemap::__get__tilemap() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Tilemaps::Tilemap*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> HoudiniEngineUnity::__HEU_InputInterfaceTilemap__HEU_InputDataTilemap::__get__transform() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x20>(this);
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::HoudiniEngineUnity::__HEU_InputInterfaceTilemap__HEU_InputDataTilemap* (::HoudiniEngineUnity::HEU_InputInterfaceTilemap::*)(::UnityEngine::GameObject*)>(&::HoudiniEngineUnity::HEU_InputInterfaceTilemap::GenerateTilemapDataFromGameObject)> {
...
::cordl_internals::setInstanceField<::HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings*, 0x18>(this, std::forward<::HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings*>(value));
}
...
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings*> HoudiniEngineUnity::HEU_InputInterfaceTilemap::__get_settings() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings*, 0x18>(this);
}
