...
/// @brief Field _objectTransform offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeoNode*>*> __get__geoNodes() const;
...
/// @brief Method get_ObjectID addr 0x2172ad0 size 0x8 virtual false final false
inline int32_t get_ObjectID() ;

/// @brief Method get_ObjectName addr 0x2172ad8 size 0x8 virtual false final false
inline ::StringW get_ObjectName() ;

/// @brief Method get_ParentAsset addr 0x2172ae0 size 0x8 virtual false final false
inline ::HoudiniEngineUnity::HEU_HoudiniAsset* get_ParentAsset() ;

/// @brief Method IsInstanced addr 0x2172ae8 size 0x8 virtual false final false
inline bool IsInstanced() ;

/// @brief Method IsVisible addr 0x2172af0 size 0x8 virtual false final false
inline bool IsVisible() ;

static inline ::HoudiniEngineUnity::HEU_ObjectNode* New_ctor() ;

/// @brief Method .ctor addr 0x2172af8 size 0x1c virtual false final false
inline void _ctor() ;

/// @brief Method Reset addr 0x2172b14 size 0xd8 virtual false final false
inline void Reset() ;

/// @brief Method SyncWithObjectInfo addr 0x2172bec size 0xe8 virtual false final false
inline void SyncWithObjectInfo(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method Initialize addr 0x2172cd4 size 0x430 virtual false final false
...
/// @brief Method DestroyAllData addr 0x21731b8 size 0x100 virtual false final false
inline void DestroyAllData(bool  bIsRebuild) ;

/// @brief Method CreateGeoNode addr 0x2173104 size 0xb4 virtual false final false
...
/// @brief Method GetDebugInfo addr 0x21732b8 size 0x2bc virtual false final false
inline void GetDebugInfo(::System::Text::StringBuilder*  sb) ;

/// @brief Method SetObjectInfo addr 0x2173574 size 0x1c virtual false final false
inline void SetObjectInfo(::HoudiniEngineUnity::HAPI_ObjectInfo  newObjectInfo) ;

/// @brief Method UpdateObject addr 0x2173590 size 0x9f8 virtual false final false
inline void UpdateObject(::HoudiniEngineUnity::HEU_SessionBase*  session, bool  bForceUpdate) ;

/// @brief Method GenerateGeometry addr 0x2173f88 size 0x714 virtual false final false
inline void GenerateGeometry(::HoudiniEngineUnity::HEU_SessionBase*  session, bool  bRebuild) ;

/// @brief Method GeneratePartInstances addr 0x2174cd4 size 0x154 virtual false final false
inline void GeneratePartInstances(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method GenerateAttributesStore addr 0x2174e28 size 0x154 virtual false final false
inline void GenerateAttributesStore(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method ApplyObjectTransformToGeoNodes addr 0x2174ab4 size 0x154 virtual false final false
inline void ApplyObjectTransformToGeoNodes() ;

/// @brief Method IsUsingMaterial addr 0x2174f7c size 0x180 virtual false final false
inline bool IsUsingMaterial(::HoudiniEngineUnity::HEU_MaterialData*  materialData) ;

/// @brief Method GetClonableParts addr 0x21750fc size 0x164 virtual false final false
inline void GetClonableParts(::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_PartData*>*  clonableParts) ;

/// @brief Method GetOutputGameObjects addr 0x2175260 size 0x154 virtual false final false
inline void GetOutputGameObjects(::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*  outputObjects) ;

/// @brief Method GetOutput addr 0x21753b4 size 0x154 virtual false final false
inline void GetOutput(::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeneratedOutput*>*  outputs) ;

/// @brief Method GetHDAPartWithGameObject addr 0x2175508 size 0x1ac virtual false final false
inline ::HoudiniEngineUnity::HEU_PartData* GetHDAPartWithGameObject(::UnityEngine::GameObject*  outputGameObject) ;

/// @brief Method GetGeoNode addr 0x21756b4 size 0x190 virtual false final false
inline ::HoudiniEngineUnity::HEU_GeoNode* GetGeoNode(::StringW  geoName) ;

/// @brief Method GetCurves addr 0x2175844 size 0x158 virtual false final false
inline void GetCurves(::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_Curve*>*  curves, bool  bEditableOnly) ;

/// @brief Method GetOutputGeoNodes addr 0x217599c size 0x1e0 virtual false final false
inline void GetOutputGeoNodes(::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeoNode*>*  outGeoNodes) ;

/// @brief Method GenerateObjectInstances addr 0x2175b7c size 0x48c virtual false final false
inline void GenerateObjectInstances(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method ClearObjectInstances addr 0x2177800 size 0x184 virtual false final false
inline void ClearObjectInstances(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method PopulateObjectInstanceInfos addr 0x2177c94 size 0x138 virtual false final false
...
/// @brief Method ProcessUnityScriptAttributes addr 0x2177e24 size 0x154 virtual false final false
inline void ProcessUnityScriptAttributes(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method HideAllGeometry addr 0x2177f78 size 0x14c virtual false final false
inline void HideAllGeometry() ;

/// @brief Method CalculateVisibility addr 0x21780c4 size 0x150 virtual false final false
inline void CalculateVisibility() ;

/// @brief Method CalculateColliderState addr 0x2178214 size 0x14c virtual false final false
inline void CalculateColliderState() ;

/// @brief Method DisableAllColliders addr 0x2178360 size 0x14c virtual false final false
inline void DisableAllColliders() ;

/// @brief Method IsInstancer addr 0x2176008 size 0x184 virtual false final false
inline bool IsInstancer() ;

/// @brief Method ToString addr 0x21784ac size 0x70 virtual true final false
inline ::StringW ToString() ;

/// @brief Method IsEquivalentTo addr 0x217851c size 0x280 virtual true final true
