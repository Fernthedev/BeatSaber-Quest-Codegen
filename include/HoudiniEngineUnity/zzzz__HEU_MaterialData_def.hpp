...
struct CORDL_TYPE __HEU_MaterialData__Source : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____HEU_MaterialData__Source_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __HEU_MaterialData__Source(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HEU_MaterialData__Source()  = default;
...
/// @brief Field _materialSource offset 0x20
...
/// @brief Field _materialKey offset 0x24
