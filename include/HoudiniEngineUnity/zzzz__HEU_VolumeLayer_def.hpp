...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_PartData*> __get__part() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TerrainLayer*> __get__terrainLayer() const;
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_DetailPrototype*> __get__detailPrototype() const;
