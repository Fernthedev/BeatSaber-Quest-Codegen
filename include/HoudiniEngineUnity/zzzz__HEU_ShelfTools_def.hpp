...
/// @brief Field TARGET_ALL offset 0x0
static constexpr ::ConstString  TARGET_ALL{u"all"};

/// @brief Field TARGET_UNITY offset 0x0
...
// Ctor Parameters []
// @brief default ctor
 HEU_ShelfTools()  = default;
public:


// Fields

// Static field _shelves

// Static field _shelvesLoaded

// Static field _currentSelectedShelf
