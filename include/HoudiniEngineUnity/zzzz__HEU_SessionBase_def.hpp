...
/// @brief Field <ThrowErrorOverride>k__BackingField offset 0x29
...
/// @brief Field <LastCallResultCode>k__BackingField offset 0x2c
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_SessionData*> __get__sessionData() const;
