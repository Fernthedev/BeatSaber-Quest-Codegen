...
/// @brief Field _tilemap offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Tilemaps::Tilemap*> __get__tilemap() const;
...
/// @brief Method .ctor addr 0x21cde18 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __HEU_InputInterfaceTilemap__HEU_InputDataTilemap()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::HoudiniEngineUnity::HEU_InputInterface)]{};

/// @brief Field settings offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings*> __get_settings() const;

static inline ::HoudiniEngineUnity::HEU_InputInterfaceTilemap* New_ctor() ;

/// @brief Method .ctor addr 0x21cb584 size 0xc virtual false final false
inline void _ctor() ;

/// @brief Method Initialize addr 0x21cb590 size 0x70 virtual false final false
inline void Initialize(::HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings*  settings) ;

/// @brief Method CreateInputNodeWithDataUpload addr 0x21cb600 size 0x198 virtual true final false
...
/// @brief Method IsThisInputObjectSupported addr 0x21cd26c size 0xc4 virtual true final false
inline bool IsThisInputObjectSupported(::UnityEngine::GameObject*  inputObject) ;

/// @brief Method UploadData addr 0x21cb870 size 0x19fc virtual false final false
...
/// @brief Method GenerateTilemapDataFromGameObject addr 0x21cb798 size 0xd8 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 HEU_InputInterfaceTilemap()  = default;
public:
