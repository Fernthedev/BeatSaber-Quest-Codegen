...
static inline ::HoudiniEngineUnity::__HEU_SessionManager__CreateSessionFromTypeDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method .ctor addr 0x21a5264 size 0x12c virtual false final false
inline void _ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method Invoke addr 0x21a5390 size 0x14 virtual true final false
inline ::HoudiniEngineUnity::HEU_SessionBase* Invoke(::System::Type*  type) ;

/// @brief Method BeginInvoke addr 0x21a53a4 size 0x20 virtual true final false
inline ::System::IAsyncResult* BeginInvoke(::System::Type*  type, ::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke addr 0x21a53c4 size 0xc virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 __HEU_SessionManager__CreateSessionFromTypeDelegate()  = default;
public:
...
/// @brief Method CreateSessionObject addr 0x21a2a94 size 0x64 virtual false final false
static inline ::HoudiniEngineUnity::HEU_SessionBase* CreateSessionObject() ;

/// @brief Method CreateSessionFromType addr 0x21a2af8 size 0x64 virtual false final false
static inline ::HoudiniEngineUnity::HEU_SessionBase* CreateSessionFromType(::System::Type*  type) ;

/// @brief Method GetDefaultSession addr 0x219d4b4 size 0x88 virtual false final false
static inline ::HoudiniEngineUnity::HEU_SessionBase* GetDefaultSession() ;

/// @brief Method RegisterSession addr 0x21a2c00 size 0x94 virtual false final false
static inline void RegisterSession(int64_t  sessionID, ::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method UnregisterSession addr 0x21a2d64 size 0x84 virtual false final false
static inline void UnregisterSession(int64_t  sessionID) ;

/// @brief Method GetSessionWithID addr 0x21a2de8 size 0x98 virtual false final false
static inline ::HoudiniEngineUnity::HEU_SessionBase* GetSessionWithID(int64_t  sessionID) ;

/// @brief Method SaveAllSessionData addr 0x21a2c94 size 0xd0 virtual false final false
static inline void SaveAllSessionData() ;

/// @brief Method LoadAllSessionData addr 0x21a2e80 size 0x470 virtual false final false
static inline void LoadAllSessionData() ;

/// @brief Method InternalValidateSceneAssets addr 0x21a32f0 size 0x154 virtual false final false
static inline void InternalValidateSceneAssets() ;

/// @brief Method GetOrCreateDefaultSession addr 0x219d22c size 0x288 virtual false final false
static inline ::HoudiniEngineUnity::HEU_SessionBase* GetOrCreateDefaultSession(bool  bNotifyUserError) ;

/// @brief Method CreateInProcessSession addr 0x21a356c size 0x84 virtual false final false
static inline bool CreateInProcessSession() ;

/// @brief Method CreateThriftSocketSession addr 0x21a36a0 size 0xc4 virtual false final false
...
/// @brief Method CreateThriftPipeSession addr 0x21a3444 size 0xb4 virtual false final false
static inline bool CreateThriftPipeSession(::StringW  pipeName, bool  autoClose, float_t  timeout, bool  logError) ;

/// @brief Method CreateCustomSession addr 0x21a3764 size 0x84 virtual false final false
static inline bool CreateCustomSession() ;

/// @brief Method ConnectThriftSocketSession addr 0x21a37e8 size 0xbc virtual false final false
static inline bool ConnectThriftSocketSession(::StringW  hostName, int32_t  serverPort, bool  autoClose, float_t  timeout) ;

/// @brief Method ConnectThriftPipeSession addr 0x21a38a4 size 0xb4 virtual false final false
static inline bool ConnectThriftPipeSession(::StringW  pipeName, bool  autoClose, float_t  timeout) ;

/// @brief Method RecreateDefaultSessionData addr 0x21a3958 size 0x60 virtual false final false
static inline void RecreateDefaultSessionData() ;

/// @brief Method ConnectSessionSyncUsingThriftSocket addr 0x21a39b8 size 0xe4 virtual false final false
...
/// @brief Method ConnectSessionSyncUsingThriftPipe addr 0x21a3a9c size 0xd4 virtual false final false
static inline bool ConnectSessionSyncUsingThriftPipe(::StringW  pipeName, bool  autoClose, float_t  timeout, bool  logError) ;

/// @brief Method InitializeDefaultSession addr 0x21a3b70 size 0xa0 virtual false final false
static inline bool InitializeDefaultSession() ;

/// @brief Method CloseDefaultSession addr 0x21a3c10 size 0xbc virtual false final false
static inline bool CloseDefaultSession() ;

/// @brief Method CloseAllSessions addr 0x21a3ccc size 0x2dc virtual false final false
static inline void CloseAllSessions() ;

/// @brief Method CheckAndCloseExistingSession addr 0x21a35f0 size 0xb0 virtual false final false
static inline void CheckAndCloseExistingSession() ;

/// @brief Method GetSessionData addr 0x21a3fa8 size 0x58 virtual false final false
static inline ::HoudiniEngineUnity::HEU_SessionData* GetSessionData() ;

/// @brief Method GetSessionInfo addr 0x21a4000 size 0x84 virtual false final false
static inline ::StringW GetSessionInfo() ;

/// @brief Method LoadStoredDefaultSession addr 0x21a2b5c size 0xa4 virtual false final false
static inline bool LoadStoredDefaultSession() ;

/// @brief Method RestartSession addr 0x21a4084 size 0x134 virtual false final false
static inline bool RestartSession() ;

/// @brief Method ValidatePluginSession addr 0x21a41b8 size 0x80 virtual false final false
static inline bool ValidatePluginSession(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method GetLastSessionError addr 0x21a34f8 size 0x74 virtual false final false
static inline ::StringW GetLastSessionError() ;

/// @brief Method CheckVersionMatch addr 0x21a4238 size 0x70 virtual false final false
static inline bool CheckVersionMatch() ;

/// @brief Method ClearConnectionError addr 0x21a42a8 size 0x8 virtual false final false
static inline bool ClearConnectionError() ;

/// @brief Method GetConnectionError addr 0x21a1da4 size 0x40 virtual false final false
static inline ::StringW GetConnectionError(bool  clear) ;

/// @brief Method IsHARSProcessRunning addr 0x21a42b0 size 0x94 virtual false final false
static inline bool IsHARSProcessRunning(int32_t  processID) ;

/// @brief Method LoadSessionFromHIP addr 0x21a4344 size 0xe0 virtual false final false
static inline bool LoadSessionFromHIP(bool  bCookNodes, ::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method SaveSessionToHIP addr 0x21a4424 size 0xe0 virtual false final false
static inline bool SaveSessionToHIP(bool  bLockNodes, ::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method GetHoudiniPathOnMacOS addr 0x21a4504 size 0x4 virtual false final false
static inline ::StringW GetHoudiniPathOnMacOS(::StringW  houdiniPath) ;

/// @brief Method OpenHoudini addr 0x21a4508 size 0x9c virtual false final false
static inline bool OpenHoudini(::StringW  args) ;

/// @brief Method OpenSessionInHoudini addr 0x21a45a4 size 0x314 virtual false final false
static inline bool OpenSessionInHoudini(::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method GetCurrentLicense addr 0x21a48b8 size 0x9c virtual false final false
static inline ::HoudiniEngineUnity::HAPI_License GetCurrentLicense(bool  bLogError) ;

/// @brief Method GetString addr 0x219a4f8 size 0xec virtual false final false
static inline ::StringW GetString(int32_t  stringHandle, ::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method GetStringValuesFromStringIndices addr 0x21a4954 size 0x1ac virtual false final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> GetStringValuesFromStringIndices(::ArrayW<int32_t,::Array<int32_t>*>  strIndices) ;

/// @brief Method GetGroupNames addr 0x21a4b00 size 0x248 virtual false final false
...
/// @brief Method GetGroupMembership addr 0x21a4d48 size 0x13c virtual false final false
...
/// @brief Method GetNodeName addr 0x21a4e84 size 0xf0 virtual false final false
static inline ::StringW GetNodeName(int32_t  nodeID, ::HoudiniEngineUnity::HEU_SessionBase*  session) ;

/// @brief Method GetNodeInputName addr 0x21a4f74 size 0xe4 virtual false final false
static inline bool GetNodeInputName(int32_t  nodeID, int32_t  inputIndex, ByRef<::StringW>  inputName) ;

/// @brief Method GetComposedChildNodeList addr 0x219a5e4 size 0xf8 virtual false final false
...
/// @brief Method GetComposedObjectListMemorySafe addr 0x21a5058 size 0xb8 virtual false final false
...
/// @brief Method GetComposedObjectTransformsMemorySafe addr 0x21a5110 size 0xc8 virtual false final false
...
/// @brief Method GetUniqueMaterialShopName addr 0x21a1574 size 0x218 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 HEU_SessionManager()  = default;
public:


// Fields

// Static field _defaultSession

// Static field _sessionMap

// Static field _createSessionFromTypeDelegate
