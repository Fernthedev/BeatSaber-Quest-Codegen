...
/// @brief Method .ctor addr 0x21cb574 size 0x10 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 HEU_InputInterfaceTilemapSettings()  = default;
public:
