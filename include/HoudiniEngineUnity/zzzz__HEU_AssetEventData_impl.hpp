...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_HoudiniAsset*> HoudiniEngineUnity::HEU_AssetEventData::__get_Asset() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HEU_HoudiniAsset*, 0x10>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*> HoudiniEngineUnity::HEU_AssetEventData::__get_OutputObjects() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*, 0x20>(this);
}
constexpr void HoudiniEngineUnity::HEU_AssetEventData::__set_EventType(::HoudiniEngineUnity::HEU_AssetEventType  value)  {
::cordl_internals::setInstanceField<::HoudiniEngineUnity::HEU_AssetEventType, 0x28>(this, std::forward<::HoudiniEngineUnity::HEU_AssetEventType>(value));
}
constexpr ::HoudiniEngineUnity::HEU_AssetEventType& HoudiniEngineUnity::HEU_AssetEventData::__get_EventType()  {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HEU_AssetEventType, 0x28>(this);
}
constexpr ::HoudiniEngineUnity::HEU_AssetEventType const& HoudiniEngineUnity::HEU_AssetEventData::__get_EventType() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HEU_AssetEventType, 0x28>(this);
}
inline ::HoudiniEngineUnity::HEU_AssetEventData* HoudiniEngineUnity::HEU_AssetEventData::New_ctor(::HoudiniEngineUnity::HEU_HoudiniAsset*  asset, bool  successful, ::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*  outputObjects)  {
return THROW_UNLESS(::il2cpp_utils::New<::HoudiniEngineUnity::HEU_AssetEventData*>(asset, successful, outputObjects));
}
inline void HoudiniEngineUnity::HEU_AssetEventData::_ctor(::HoudiniEngineUnity::HEU_HoudiniAsset*  asset, bool  successful, ::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*  outputObjects)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::HEU_AssetEventData*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
