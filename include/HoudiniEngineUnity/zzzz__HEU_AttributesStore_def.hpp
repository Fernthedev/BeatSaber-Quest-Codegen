...
static inline ::HoudiniEngineUnity::__HEU_AttributesStore__SetAttributeValueFunc* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __HEU_AttributesStore__SetAttributeValueFunc()  = default;
public:
...
/// @brief Field _localMeshCollider offset 0x88
...
/// @brief Field _outputMeshRendererInitiallyEnabled offset 0x90
...
/// @brief Field _outputMeshColliderInitiallyEnabled offset 0x91
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_AttributeData*>*> __get__attributeDatas() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get__localMaterial() const;

constexpr void __set__outputTransform(::UnityEngine::Transform*  value) ;

constexpr ::UnityEngine::Transform* __get__outputTransform() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__outputTransform() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__outputGameObject() const;

constexpr void __set__outputMesh(::UnityEngine::Mesh*  value) ;

constexpr ::UnityEngine::Mesh* __get__outputMesh() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Mesh*> __get__outputMesh() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::MeshCollider*> __get__outputCollider() const;

constexpr void __set__outputColliderMesh(::UnityEngine::Mesh*  value) ;

constexpr ::UnityEngine::Mesh* __get__outputColliderMesh() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Mesh*> __get__outputColliderMesh() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::MeshCollider*> __get__outputMeshCollider() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::MeshCollider*> __get__localMeshCollider() const;
