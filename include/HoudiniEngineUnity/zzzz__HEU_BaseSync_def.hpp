...
/// @brief Field _generateOptions offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeneratedOutput*>*> __get__generatedOutputs() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> __get__outputCacheFilePaths() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Text::StringBuilder*> __get__log() const;

constexpr void __set__error(::System::Text::StringBuilder*  value) ;

constexpr ::System::Text::StringBuilder* __get__error() ;

constexpr ::cordl_internals::to_const_pointer<::System::Text::StringBuilder*> __get__error() const;
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_ThreadedTaskLoadGeo*> __get__loadTask() const;
