...
::cordl_internals::setInstanceField<::UnityEngine::MeshRenderer*, 0x10>(this, std::forward<::UnityEngine::MeshRenderer*>(value));
}
constexpr ::UnityEngine::MeshRenderer* HoudiniEngineUnity::Test_MeshRenderer::__get_self()  {
return ::cordl_internals::getInstanceField<::UnityEngine::MeshRenderer*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::MeshRenderer*> HoudiniEngineUnity::Test_MeshRenderer::__get_self() const {
return ::cordl_internals::getInstanceField<::UnityEngine::MeshRenderer*, 0x10>(this);
}
