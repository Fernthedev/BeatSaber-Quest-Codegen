...
template<::il2cpp_utils::il2cpp_reference_type TKey,::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(9855))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(9855), inst: 81 })
// CS Name: ::HoudiniEngineUnity::HEU_SerializableDictionary`2<TKey,TValue>*
class CORDL_TYPE HEU_SerializableDictionary_2<TKey,TValue> : public ::System::Object {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
 HEU_SerializableDictionary_2()  = default;
public:
