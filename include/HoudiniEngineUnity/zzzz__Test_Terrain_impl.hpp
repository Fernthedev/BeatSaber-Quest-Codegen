...
::cordl_internals::setInstanceField<::UnityEngine::Terrain*, 0x10>(this, std::forward<::UnityEngine::Terrain*>(value));
}
constexpr ::UnityEngine::Terrain* HoudiniEngineUnity::Test_Terrain::__get_self()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Terrain*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Terrain*> HoudiniEngineUnity::Test_Terrain::__get_self() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Terrain*, 0x10>(this);
}
