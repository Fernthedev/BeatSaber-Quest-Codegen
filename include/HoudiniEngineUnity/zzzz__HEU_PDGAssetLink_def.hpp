...
struct CORDL_TYPE __HEU_PDGAssetLink__LinkState : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____HEU_PDGAssetLink__LinkState_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __HEU_PDGAssetLink__LinkState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HEU_PDGAssetLink__LinkState()  = default;
...
static inline ::HoudiniEngineUnity::__HEU_PDGAssetLink__UpdateUIDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __HEU_PDGAssetLink__UpdateUIDelegate()  = default;
public:
...
/// @brief Field _loadRootGameObject offset 0x78
...
/// @brief Field _outputCachePathRoot offset 0x80
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__assetGO() const;
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_HoudiniAsset*> __get__heu() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_TOPNetworkData*>*> __get__topNetworks() const;
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::__HEU_PDGAssetLink__UpdateUIDelegate*> __get__repaintUIDelegate() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__loadRootGameObject() const;
