...
#include "HoudiniEngineUnity/zzzz__HEU_TOPNodeData_def.hpp"
constexpr void HoudiniEngineUnity::__HEU_TOPNodeData__PDGState::__set_value__(int32_t  value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<int32_t>(value));
}
constexpr int32_t& HoudiniEngineUnity::__HEU_TOPNodeData__PDGState::__get_value__()  {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& HoudiniEngineUnity::__HEU_TOPNodeData__PDGState::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::HoudiniEngineUnity::__HEU_TOPNodeData__PDGState::__HEU_TOPNodeData__PDGState(int32_t  value__) noexcept : ::bs_hook::EnumTypeWrapper<0x4>() {this->value__ = value__;
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> HoudiniEngineUnity::HEU_TOPNodeData::__get__workResultParentGO() const {
return ::cordl_internals::getInstanceField<::UnityEngine::GameObject*, 0x28>(this);
}
...
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_TOPWorkResult*>*, 0x30>(this, std::forward<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_TOPWorkResult*>*>(value));
}
...
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_TOPWorkResult*>*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_TOPWorkResult*>*> HoudiniEngineUnity::HEU_TOPNodeData::__get__workResults() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_TOPWorkResult*>*, 0x30>(this);
}
constexpr void HoudiniEngineUnity::HEU_TOPNodeData::__set__tags(::HoudiniEngineUnity::TOPNodeTags*  value)  {
::cordl_internals::setInstanceField<::HoudiniEngineUnity::TOPNodeTags*, 0x38>(this, std::forward<::HoudiniEngineUnity::TOPNodeTags*>(value));
}
constexpr ::HoudiniEngineUnity::TOPNodeTags* HoudiniEngineUnity::HEU_TOPNodeData::__get__tags()  {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::TOPNodeTags*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::TOPNodeTags*> HoudiniEngineUnity::HEU_TOPNodeData::__get__tags() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::TOPNodeTags*, 0x38>(this);
}
...
::cordl_internals::setInstanceField<::HoudiniEngineUnity::__HEU_TOPNodeData__PDGState, 0x44>(this, std::forward<::HoudiniEngineUnity::__HEU_TOPNodeData__PDGState>(value));
}
constexpr ::HoudiniEngineUnity::__HEU_TOPNodeData__PDGState& HoudiniEngineUnity::HEU_TOPNodeData::__get__pdgState()  {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::__HEU_TOPNodeData__PDGState, 0x44>(this);
}
...
::cordl_internals::setInstanceField<::HoudiniEngineUnity::HEU_WorkItemTally*, 0x48>(this, std::forward<::HoudiniEngineUnity::HEU_WorkItemTally*>(value));
}
constexpr ::HoudiniEngineUnity::HEU_WorkItemTally* HoudiniEngineUnity::HEU_TOPNodeData::__get__workItemTally()  {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HEU_WorkItemTally*, 0x48>(this);
}
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_WorkItemTally*> HoudiniEngineUnity::HEU_TOPNodeData::__get__workItemTally() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HEU_WorkItemTally*, 0x48>(this);
}
