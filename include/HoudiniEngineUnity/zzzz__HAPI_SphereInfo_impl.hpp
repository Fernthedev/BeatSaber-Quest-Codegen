...
constexpr void HoudiniEngineUnity::HAPI_SphereInfo::__set_center(::ArrayW<float_t,::Array<float_t>*>  value)  {
...
constexpr ::ArrayW<float_t,::Array<float_t>*>& HoudiniEngineUnity::HAPI_SphereInfo::__get_center()  {
...
constexpr ::ArrayW<float_t,::Array<float_t>*> const& HoudiniEngineUnity::HAPI_SphereInfo::__get_center() const {
return ::cordl_internals::getInstanceField<::ArrayW<float_t,::Array<float_t>*>, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr float_t& HoudiniEngineUnity::HAPI_SphereInfo::__get_radius()  {
return ::cordl_internals::getInstanceField<float_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr float_t const& HoudiniEngineUnity::HAPI_SphereInfo::__get_radius() const {
return ::cordl_internals::getInstanceField<float_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
// Ctor Parameters [CppParam { name: "center", ty: "::ArrayW<float_t,::Array<float_t>*>", modifiers: "", def_value: Some("csnull") }, CppParam { name: "radius", ty: "float_t", modifiers: "", def_value: Some("{}") }]
constexpr ::HoudiniEngineUnity::HAPI_SphereInfo::HAPI_SphereInfo(::ArrayW<float_t,::Array<float_t>*>  center, float_t  radius) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->center = center;
this->radius = radius;
}
