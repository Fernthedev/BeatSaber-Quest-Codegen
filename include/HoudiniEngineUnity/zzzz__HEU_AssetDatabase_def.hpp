...
struct CORDL_TYPE __HEU_AssetDatabase__HEU_ImportAssetOptions : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____HEU_AssetDatabase__HEU_ImportAssetOptions_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __HEU_AssetDatabase__HEU_ImportAssetOptions(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HEU_AssetDatabase__HEU_ImportAssetOptions()  = default;
...
static inline ::UnityEngine::Object* CopyAndLoadAssetWithRelativePath(::UnityEngine::Object*  srcAsset, ::StringW  copyAssetFolder, ::StringW  relativePath, ::System::Type*  type, bool  bOverwriteExisting) ;
