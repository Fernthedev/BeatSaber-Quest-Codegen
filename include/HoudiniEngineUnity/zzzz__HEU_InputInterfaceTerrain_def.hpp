...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Terrain*> __get__terrain() const;
...
// Ctor Parameters []
// @brief default ctor
 __HEU_InputInterfaceTerrain__HEU_InputDataTerrain()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 HEU_InputInterfaceTerrain()  = default;
public:
