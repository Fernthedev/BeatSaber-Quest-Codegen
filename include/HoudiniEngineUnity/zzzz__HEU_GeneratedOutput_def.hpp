...
/// @brief Field isInstancer offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_GeneratedOutputData*> __get__outputData() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeneratedOutputData*>*> __get__childOutputs() const;
...
static inline ::ArrayW<::UnityEngine::Material*,::Array<::UnityEngine::Material*>*> GetGeneratedMaterialsForGameObject(::HoudiniEngineUnity::HEU_GeneratedOutput*  output, ::UnityEngine::GameObject*  inGameObject) ;
