...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::JSONArray*> __get___4__this() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::JSONNode*>*> __get_m_List() const;
