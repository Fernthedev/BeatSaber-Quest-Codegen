...
::cordl_internals::setInstanceField<::UnityEngine::Rendering::IndexFormat, 0x10>(this, std::forward<::UnityEngine::Rendering::IndexFormat>(value));
}
constexpr ::UnityEngine::Rendering::IndexFormat& HoudiniEngineUnity::HEU_MeshIndexFormat::__get__indexFormat()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Rendering::IndexFormat, 0x10>(this);
}
