...
struct CORDL_TYPE __HEU_InputNode__InputNodeType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____HEU_InputNode__InputNodeType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __HEU_InputNode__InputNodeType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HEU_InputNode__InputNodeType()  = default;
...
struct CORDL_TYPE __HEU_InputNode__InputObjectType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____HEU_InputNode__InputObjectType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HEU_InputNode__InputObjectType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HEU_InputNode__InputObjectType()  = default;
...
struct CORDL_TYPE __HEU_InputNode__InternalObjectType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____HEU_InputNode__InternalObjectType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HEU_InputNode__InternalObjectType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HEU_InputNode__InternalObjectType()  = default;
...
struct CORDL_TYPE __HEU_InputNode__InputActions : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____HEU_InputNode__InputActions_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HEU_InputNode__InputActions(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HEU_InputNode__InputActions()  = default;
...
/// @brief Field _inputNodeType offset 0x18
...
/// @brief Field _inputObjectType offset 0x1c
...
/// @brief Field _pendingInputObjectType offset 0x20
...
/// @brief Field _inputObjects offset 0x28
...
/// @brief Field _inputObjectsConnectedAssetIDs offset 0x30
...
/// @brief Field _inputAssetInfos offset 0x48
...
/// @brief Field _uiCache offset 0x90
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_InputObjectInfo*>*> __get__inputObjects() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<int32_t>*> __get__inputObjectsConnectedAssetIDs() const;

constexpr void __set__inputAsset(::UnityEngine::GameObject*  value) ;

constexpr ::UnityEngine::GameObject* __get__inputAsset() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__inputAsset() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__connectedInputAsset() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_InputHDAInfo*>*> __get__inputAssetInfos() const;
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_InputInterfaceTilemapSettings*> __get__tilemapSettings() const;
...
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_InputNodeUICache*> __get__uiCache() const;
...
static inline ::HoudiniEngineUnity::HEU_InputNode* CreateSetupInput(int32_t  nodeID, int32_t  inputIndex, ::StringW  inputName, ::StringW  labelName, ::HoudiniEngineUnity::__HEU_InputNode__InputNodeType  inputNodeType, ::HoudiniEngineUnity::HEU_HoudiniAsset*  parentAsset) ;
