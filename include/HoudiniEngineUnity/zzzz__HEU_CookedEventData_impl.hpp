...
inline ::HoudiniEngineUnity::HEU_CookedEventData* HoudiniEngineUnity::HEU_CookedEventData::New_ctor(::HoudiniEngineUnity::HEU_HoudiniAsset*  asset, bool  successful, ::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*  outputObjects)  {
return THROW_UNLESS(::il2cpp_utils::New<::HoudiniEngineUnity::HEU_CookedEventData*>(asset, successful, outputObjects));
}
inline void HoudiniEngineUnity::HEU_CookedEventData::_ctor(::HoudiniEngineUnity::HEU_HoudiniAsset*  asset, bool  successful, ::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*  outputObjects)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::HoudiniEngineUnity::HEU_CookedEventData*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
