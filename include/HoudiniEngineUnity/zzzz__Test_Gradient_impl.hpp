...
::cordl_internals::setInstanceField<::UnityEngine::Gradient*, 0x10>(this, std::forward<::UnityEngine::Gradient*>(value));
}
constexpr ::UnityEngine::Gradient* HoudiniEngineUnity::Test_Gradient::__get_self()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Gradient*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Gradient*> HoudiniEngineUnity::Test_Gradient::__get_self() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Gradient*, 0x10>(this);
}
