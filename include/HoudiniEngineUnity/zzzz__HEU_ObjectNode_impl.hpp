...
::cordl_internals::setInstanceField<::HoudiniEngineUnity::HEU_HoudiniAsset*, 0x20>(this, std::forward<::HoudiniEngineUnity::HEU_HoudiniAsset*>(value));
}
constexpr ::HoudiniEngineUnity::HEU_HoudiniAsset* HoudiniEngineUnity::HEU_ObjectNode::__get__parentAsset()  {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HEU_HoudiniAsset*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::HoudiniEngineUnity::HEU_HoudiniAsset*> HoudiniEngineUnity::HEU_ObjectNode::__get__parentAsset() const {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HEU_HoudiniAsset*, 0x20>(this);
}
constexpr void HoudiniEngineUnity::HEU_ObjectNode::__set__objectInfo(::HoudiniEngineUnity::HAPI_ObjectInfo  value)  {
::cordl_internals::setInstanceField<::HoudiniEngineUnity::HAPI_ObjectInfo, 0x28>(this, std::forward<::HoudiniEngineUnity::HAPI_ObjectInfo>(value));
}
constexpr ::HoudiniEngineUnity::HAPI_ObjectInfo& HoudiniEngineUnity::HEU_ObjectNode::__get__objectInfo()  {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HAPI_ObjectInfo, 0x28>(this);
}
...
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeoNode*>*, 0x48>(this, std::forward<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeoNode*>*>(value));
}
...
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeoNode*>*, 0x48>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeoNode*>*> HoudiniEngineUnity::HEU_ObjectNode::__get__geoNodes() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::HoudiniEngineUnity::HEU_GeoNode*>*, 0x48>(this);
}
constexpr void HoudiniEngineUnity::HEU_ObjectNode::__set__objectTransform(::HoudiniEngineUnity::HAPI_Transform  value)  {
::cordl_internals::setInstanceField<::HoudiniEngineUnity::HAPI_Transform, 0x50>(this, std::forward<::HoudiniEngineUnity::HAPI_Transform>(value));
}
constexpr ::HoudiniEngineUnity::HAPI_Transform& HoudiniEngineUnity::HEU_ObjectNode::__get__objectTransform()  {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HAPI_Transform, 0x50>(this);
}
