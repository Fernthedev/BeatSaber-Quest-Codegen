...
/// @brief Method UpdateDefines addr 0x21d0250 size 0xd8 virtual false final false
static inline void UpdateDefines() ;

/// @brief Method GetPipeline addr 0x21d0328 size 0x130 virtual false final false
static inline ::HoudiniEngineUnity::HEU_PipelineType GetPipeline() ;

/// @brief Method AddDefine addr 0x21d0458 size 0x108 virtual false final false
static inline void AddDefine(::StringW  define) ;

/// @brief Method RemoveDefine addr 0x21d0560 size 0xc0 virtual false final false
static inline void RemoveDefine(::StringW  define) ;

/// @brief Method GetDefines addr 0x21d0620 size 0x70 virtual false final false
static inline ::System::Collections::Generic::List_1<::StringW>* GetDefines() ;

/// @brief Method SetDefines addr 0x21d0690 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x21d0694 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 HEU_RenderingPipelineDefines()  = default;
public:
