...
constexpr void HoudiniEngineUnity::__HEU_MaterialData__Source::__set_value__(int32_t  value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<int32_t>(value));
}
constexpr int32_t& HoudiniEngineUnity::__HEU_MaterialData__Source::__get_value__()  {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& HoudiniEngineUnity::__HEU_MaterialData__Source::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::HoudiniEngineUnity::__HEU_MaterialData__Source::__HEU_MaterialData__Source(int32_t  value__) noexcept : ::bs_hook::EnumTypeWrapper<0x4>() {this->value__ = value__;
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::HoudiniEngineUnity::HEU_SessionBase*, int32_t, ::ArrayW<::HoudiniEngineUnity::HAPI_ParmInfo,::Array<::HoudiniEngineUnity::HAPI_ParmInfo>*>)>(&::HoudiniEngineUnity::HEU_MaterialData::IsTransparentMaterial)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::HoudiniEngineUnity::HEU_SessionBase*, int32_t, ::ArrayW<::HoudiniEngineUnity::HAPI_ParmInfo,::Array<::HoudiniEngineUnity::HAPI_ParmInfo>*>, float_t, ByRef<float_t>)>(&::HoudiniEngineUnity::HEU_MaterialData::GetMaterialAlpha)> {
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> HoudiniEngineUnity::HEU_MaterialData::__get__material() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Material*, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::HoudiniEngineUnity::__HEU_MaterialData__Source, 0x20>(this, std::forward<::HoudiniEngineUnity::__HEU_MaterialData__Source>(value));
}
constexpr ::HoudiniEngineUnity::__HEU_MaterialData__Source& HoudiniEngineUnity::HEU_MaterialData::__get__materialSource()  {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::__HEU_MaterialData__Source, 0x20>(this);
}
