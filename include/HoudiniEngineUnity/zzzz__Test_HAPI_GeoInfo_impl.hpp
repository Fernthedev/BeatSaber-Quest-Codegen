...
::cordl_internals::setInstanceField<::HoudiniEngineUnity::HAPI_GeoInfo, 0x10>(this, std::forward<::HoudiniEngineUnity::HAPI_GeoInfo>(value));
}
constexpr ::HoudiniEngineUnity::HAPI_GeoInfo& HoudiniEngineUnity::Test_HAPI_GeoInfo::__get_self()  {
return ::cordl_internals::getInstanceField<::HoudiniEngineUnity::HAPI_GeoInfo, 0x10>(this);
}
