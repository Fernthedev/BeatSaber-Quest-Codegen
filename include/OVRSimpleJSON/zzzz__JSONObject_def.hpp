...
constexpr ::cordl_internals::to_const_pointer<::OVRSimpleJSON::JSONNode*> __get_aNode() const;
...
constexpr ::cordl_internals::to_const_pointer<::OVRSimpleJSON::JSONObject*> __get___4__this() const;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::OVRSimpleJSON::JSONNode)]{};
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::OVRSimpleJSON::JSONNode*>*> __get_m_Dict() const;
