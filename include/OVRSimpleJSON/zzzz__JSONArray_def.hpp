...
constexpr ::cordl_internals::to_const_pointer<::OVRSimpleJSON::JSONArray*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __JSONArray___get_Children_d__22()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::OVRSimpleJSON::JSONNode*>*> __get_m_List() const;
