...
/// @brief Field _timestampOpen offset 0x18
...
/// @brief Method Awake addr 0x27f8174 size 0x1c virtual false final false
inline void Awake() ;

/// @brief Method Start addr 0x27f8190 size 0x34 virtual false final false
inline void Start() ;

/// @brief Method OnDestroy addr 0x27f8484 size 0xc virtual false final false
inline void OnDestroy() ;

/// @brief Method SendEvent addr 0x27f81c4 size 0x2c0 virtual false final false
inline void SendEvent(int32_t  eventType) ;

static inline ::Meta::XR::Samples::SampleMetadata* New_ctor() ;

/// @brief Method .ctor addr 0x27f8490 size 0x8 virtual false final false
inline void _ctor() ;
