...
/// @brief Field _trackedButtons offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::VRUIControls::ButtonState*>*> __get__trackedButtons() const;
