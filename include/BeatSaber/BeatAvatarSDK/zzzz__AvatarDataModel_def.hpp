...
/// @brief Field kAvatarDataFileName offset 0x0
...
/// @brief Field <avatarCreated>k__BackingField offset 0x10
...
/// @brief Field didChangeAvatarDataEvent offset 0x18
...
/// @brief Field _avatarData offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::BeatSaber::BeatAvatarSDK::AvatarData*>*> __get_didChangeAvatarDataEvent() const;
...
/// @brief Method get_avatarData addr 0xe1932c size 0x8 virtual false final false
inline ::BeatSaber::BeatAvatarSDK::AvatarData* get_avatarData() ;

/// @brief Method set_avatarData addr 0xe19334 size 0x78 virtual false final false
inline void set_avatarData(::BeatSaber::BeatAvatarSDK::AvatarData*  value) ;

/// @brief Method get_avatarCreated addr 0xe193cc size 0x8 virtual false final false
inline bool get_avatarCreated() ;

/// @brief Method set_avatarCreated addr 0xe193d4 size 0xc virtual false final false
inline void set_avatarCreated(bool  value) ;

/// @brief Method add_didChangeAvatarDataEvent addr 0xe193e0 size 0xb0 virtual false final false
inline void add_didChangeAvatarDataEvent(::System::Action_1<::BeatSaber::BeatAvatarSDK::AvatarData*>*  value) ;

/// @brief Method remove_didChangeAvatarDataEvent addr 0xe19490 size 0xb0 virtual false final false
inline void remove_didChangeAvatarDataEvent(::System::Action_1<::BeatSaber::BeatAvatarSDK::AvatarData*>*  value) ;

/// @brief Method Init addr 0xe19540 size 0x84 virtual false final false
inline void Init() ;

/// @brief Method Save addr 0xe19658 size 0x178 virtual false final false
inline void Save() ;

/// @brief Method Load addr 0xe195c4 size 0x94 virtual false final false
inline void Load() ;

/// @brief Method Delete addr 0xe198c4 size 0x1cc virtual false final false
inline void Delete() ;

/// @brief Method ReportAvatarChanged addr 0xe193ac size 0x20 virtual false final false
inline void ReportAvatarChanged() ;

/// @brief Method LoadFromSaveData addr 0xe197d8 size 0xe8 virtual false final false
static inline ::BeatSaber::BeatAvatarSDK::AvatarData* LoadFromSaveData(::GlobalNamespace::ISaveData*  saveData) ;

/// @brief Method LoadFromCurrentVersion addr 0xe19a90 size 0x24c virtual false final false
...
/// @brief Method CreateDefaultAvatarData addr 0xe198c0 size 0x4 virtual false final false
inline ::BeatSaber::BeatAvatarSDK::AvatarData* CreateDefaultAvatarData() ;

/// @brief Method CreateRandomAvatarData addr 0xe19cdc size 0xac virtual false final false
...
/// @brief Method .ctor addr 0xe19e34 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 AvatarDataModel()  = default;
public:


// Fields

// Static field filePath

// Static field tempFilePath

// Static field backupFilePath
