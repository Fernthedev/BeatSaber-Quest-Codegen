...
/// @brief Method get_headNeckOffset addr 0xe1c0f8 size 0xc virtual false final false
inline ::UnityEngine::Vector3 get_headNeckOffset() ;

/// @brief Method get_verticalOffset addr 0xe1c104 size 0x8 virtual false final false
inline float_t get_verticalOffset() ;

static inline ::BeatSaber::BeatAvatarSDK::HeadBodyOffsetSO* New_ctor() ;

/// @brief Method .ctor addr 0xe1c10c size 0x14 virtual false final false
inline void _ctor() ;
