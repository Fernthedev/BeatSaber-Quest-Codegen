...
static inline ::BeatSaber::BeatAvatarSDK::__BeatAvatarVisualController__HighlighterDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method .ctor addr 0xe1b588 size 0xc4 virtual false final false
inline void _ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method Invoke addr 0xe1c018 size 0x18 virtual true final false
inline void Invoke(bool  highlighted, int32_t  uvSegmentNumber) ;

/// @brief Method BeginInvoke addr 0xe1c030 size 0xbc virtual true final false
...
/// @brief Method EndInvoke addr 0xe1c0ec size 0xc virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 __BeatAvatarVisualController__HighlighterDelegate()  = default;
public:
...
/// @brief Field _leftHandsHairMeshFilter offset 0x30
...
/// @brief Field _rightHandsHairMeshFilter offset 0x38
...
/// @brief Field _eyesSprite offset 0x40
 __declspec(property(get=__get__eyesSprite, put=__set__eyesSprite)) ::UnityEngine::SpriteRenderer*  _eyesSprite;

/// @brief Field _mouthSprite offset 0x48
 __declspec(property(get=__get__mouthSprite, put=__set__mouthSprite)) ::UnityEngine::SpriteRenderer*  _mouthSprite;

/// @brief Field _bodyMeshFilter offset 0x50
 __declspec(property(get=__get__bodyMeshFilter, put=__set__bodyMeshFilter)) ::UnityEngine::MeshFilter*  _bodyMeshFilter;

/// @brief Field _headTopPropertyBlockColorSetter offset 0x58
 __declspec(property(get=__get__headTopPropertyBlockColorSetter, put=__set__headTopPropertyBlockColorSetter)) ::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter*  _headTopPropertyBlockColorSetter;

/// @brief Field _glassesPropertyBlockColorSetter offset 0x60
 __declspec(property(get=__get__glassesPropertyBlockColorSetter, put=__set__glassesPropertyBlockColorSetter)) ::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter*  _glassesPropertyBlockColorSetter;

/// @brief Field _facialHairPropertyBlockColorSetter offset 0x68
 __declspec(property(get=__get__facialHairPropertyBlockColorSetter, put=__set__facialHairPropertyBlockColorSetter)) ::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter*  _facialHairPropertyBlockColorSetter;

/// @brief Field _skinPropertyBlockColorSetter offset 0x70
...
/// @brief Field _clothesPropertyBlockSetter offset 0x78
 __declspec(property(get=__get__clothesPropertyBlockSetter, put=__set__clothesPropertyBlockSetter)) ::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter*  _clothesPropertyBlockSetter;

/// @brief Field _leftHandPropertyBlockSetter offset 0x80
 __declspec(property(get=__get__leftHandPropertyBlockSetter, put=__set__leftHandPropertyBlockSetter)) ::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter*  _leftHandPropertyBlockSetter;

/// @brief Field _rightHandPropertyBlockSetter offset 0x88
 __declspec(property(get=__get__rightHandPropertyBlockSetter, put=__set__rightHandPropertyBlockSetter)) ::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter*  _rightHandPropertyBlockSetter;

/// @brief Field _avatarPartsModel offset 0x90
...
/// @brief Field _avatarPartHighlightSetters offset 0x98
 __declspec(property(get=__get__avatarPartHighlightSetters, put=__set__avatarPartHighlightSetters)) ::System::Collections::Generic::Dictionary_2<::BeatSaber::BeatAvatarSDK::AvatarPart,::BeatSaber::BeatAvatarSDK::__BeatAvatarVisualController__HighlighterDelegate*>*  _avatarPartHighlightSetters;

/// @brief Field _lightColor offset 0xa0
 __declspec(property(get=__get__lightColor, put=__set__lightColor)) ::UnityEngine::Color  _lightColor;

/// @brief Field _avatarData offset 0xb0
 __declspec(property(get=__get__avatarData, put=__set__avatarData)) ::BeatSaber::BeatAvatarSDK::AvatarData*  _avatarData;

/// @brief Field _currentHighlighter offset 0xb8
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::MeshFilter*> __get__headTopMeshFilter() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::MeshFilter*> __get__glassesMeshFilter() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::MeshFilter*> __get__facialHairMeshFilter() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::MeshFilter*> __get__leftHandsHairMeshFilter() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::MeshFilter*> __get__rightHandsHairMeshFilter() const;

constexpr void __set__eyesSprite(::UnityEngine::SpriteRenderer*  value) ;

constexpr ::UnityEngine::SpriteRenderer* __get__eyesSprite() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::SpriteRenderer*> __get__eyesSprite() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::SpriteRenderer*> __get__mouthSprite() const;

constexpr void __set__bodyMeshFilter(::UnityEngine::MeshFilter*  value) ;

constexpr ::UnityEngine::MeshFilter* __get__bodyMeshFilter() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::MeshFilter*> __get__bodyMeshFilter() const;
...
constexpr ::cordl_internals::to_const_pointer<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter*> __get__headTopPropertyBlockColorSetter() const;
...
constexpr ::cordl_internals::to_const_pointer<::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter*> __get__glassesPropertyBlockColorSetter() const;
...
constexpr ::cordl_internals::to_const_pointer<::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter*> __get__facialHairPropertyBlockColorSetter() const;
...
constexpr ::cordl_internals::to_const_pointer<::BeatSaber::BeatAvatarSDK::AvatarPropertyBlockColorSetter*> __get__skinPropertyBlockColorSetter() const;
...
constexpr ::cordl_internals::to_const_pointer<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter*> __get__clothesPropertyBlockSetter() const;
...
constexpr ::cordl_internals::to_const_pointer<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter*> __get__leftHandPropertyBlockSetter() const;
...
constexpr ::cordl_internals::to_const_pointer<::BeatSaber::BeatAvatarSDK::MulticolorAvatarPartPropertyBlockSetter*> __get__rightHandPropertyBlockSetter() const;
...
constexpr void __set__avatarPartHighlightSetters(::System::Collections::Generic::Dictionary_2<::BeatSaber::BeatAvatarSDK::AvatarPart,::BeatSaber::BeatAvatarSDK::__BeatAvatarVisualController__HighlighterDelegate*>*  value) ;

constexpr ::System::Collections::Generic::Dictionary_2<::BeatSaber::BeatAvatarSDK::AvatarPart,::BeatSaber::BeatAvatarSDK::__BeatAvatarVisualController__HighlighterDelegate*>* __get__avatarPartHighlightSetters() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::BeatSaber::BeatAvatarSDK::AvatarPart,::BeatSaber::BeatAvatarSDK::__BeatAvatarVisualController__HighlighterDelegate*>*> __get__avatarPartHighlightSetters() const;
...
constexpr ::cordl_internals::to_const_pointer<::BeatSaber::BeatAvatarSDK::AvatarData*> __get__avatarData() const;
...
constexpr ::cordl_internals::to_const_pointer<::BeatSaber::BeatAvatarSDK::__BeatAvatarVisualController__HighlighterDelegate*> __get__currentHighlighter() const;

/// @brief Method Awake addr 0xe1b2fc size 0x28c virtual false final false
inline void Awake() ;

/// @brief Method UpdateAvatarVisual addr 0xe1b64c size 0x424 virtual false final false
inline void UpdateAvatarVisual(::BeatSaber::BeatAvatarSDK::AvatarData*  avatarData) ;

/// @brief Method SetLightColor addr 0xe1bd04 size 0xc virtual false final false
inline void SetLightColor(::UnityEngine::Color  color) ;

/// @brief Method UpdateAvatarColors addr 0xe1ba70 size 0x294 virtual false final false
inline void UpdateAvatarColors() ;

/// @brief Method HighlightEditedPart addr 0xe1bee0 size 0x9c virtual false final false
inline void HighlightEditedPart(::BeatSaber::BeatAvatarSDK::AvatarPart  editPart, int32_t  uvSegment) ;

/// @brief Method DisableEditedPartHighlight addr 0xe1bf7c size 0x34 virtual false final false
inline void DisableEditedPartHighlight() ;

/// @brief Method SetHandsHighlight addr 0xe1bfb0 size 0x48 virtual false final false
...
/// @brief Method .ctor addr 0xe1c008 size 0x10 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 BeatAvatarVisualController()  = default;
public:
