...
/// @brief Method get_currentPose addr 0x0 size 0xffffffffffffffff virtual true final false
inline ::BeatSaber::AvatarCore::AvatarPoseData get_currentPose() ;

/// @brief Method add_poseDidChangeEvent addr 0x0 size 0xffffffffffffffff virtual true final false
inline void add_poseDidChangeEvent(::System::Action_1<::BeatSaber::AvatarCore::AvatarPoseData>*  value) ;

/// @brief Method remove_poseDidChangeEvent addr 0x0 size 0xffffffffffffffff virtual true final false
