...
/// @brief Method InstallBindings addr 0xe10254 size 0x23c virtual true final false
inline void InstallBindings() ;

static inline ::BeatSaber::AvatarCore::MultiplayerGameAvatarInstaller* New_ctor() ;

/// @brief Method .ctor addr 0xe10490 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerGameAvatarInstaller()  = default;
public:
