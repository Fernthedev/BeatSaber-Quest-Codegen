...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::PacketPool_1<::BeatSaber::AvatarCore::OptionalAvatarDataPacket*>* (*)()>(&::BeatSaber::AvatarCore::OptionalAvatarDataPacket::get_pool)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::AvatarCore::OptionalAvatarDataPacket::*)(::LiteNetLib::Utils::NetDataWriter*)>(&::BeatSaber::AvatarCore::OptionalAvatarDataPacket::Serialize)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::AvatarCore::OptionalAvatarDataPacket::*)(::LiteNetLib::Utils::NetDataReader*)>(&::BeatSaber::AvatarCore::OptionalAvatarDataPacket::Deserialize)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::AvatarCore::OptionalAvatarDataPacket::*)()>(&::BeatSaber::AvatarCore::OptionalAvatarDataPacket::Release)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BeatSaber::AvatarCore::OptionalAvatarDataPacket* (::BeatSaber::AvatarCore::OptionalAvatarDataPacket::*)(::BeatSaber::AvatarCore::OptionalAvatarData)>(&::BeatSaber::AvatarCore::OptionalAvatarDataPacket::Init)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BeatSaber::AvatarCore::OptionalAvatarDataPacket* (::BeatSaber::AvatarCore::OptionalAvatarDataPacket::*)(uint32_t, ::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t)>(&::BeatSaber::AvatarCore::OptionalAvatarDataPacket::Init)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::BeatSaber::AvatarCore::OptionalAvatarDataPacket::*)()>(&::BeatSaber::AvatarCore::OptionalAvatarDataPacket::_ctor)> {
...
::cordl_internals::setInstanceField<::GlobalNamespace::ByteArrayNetSerializable*, 0x18>(this, std::forward<::GlobalNamespace::ByteArrayNetSerializable*>(value));
}
constexpr ::GlobalNamespace::ByteArrayNetSerializable* BeatSaber::AvatarCore::OptionalAvatarDataPacket::__get_data()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ByteArrayNetSerializable*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ByteArrayNetSerializable*> BeatSaber::AvatarCore::OptionalAvatarDataPacket::__get_data() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ByteArrayNetSerializable*, 0x18>(this);
}
