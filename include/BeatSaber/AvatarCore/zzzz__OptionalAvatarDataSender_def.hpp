...
/// @brief Field _avatarSystemCollection offset 0x10
...
/// @brief Field _optionalAvatarDataSyncHandler offset 0x18
...
/// @brief Field _optionalAvatarDataProvider offset 0x20
...
/// @brief Field _currentAvatarDisplayContext offset 0x28
...
/// @brief Field _selectedAvatarTypeId offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::BeatSaber::AvatarCore::IOptionalAvatarDataProvider*> __get__optionalAvatarDataProvider() const;
...
// Ctor Parameters []
// @brief default ctor
 OptionalAvatarDataSender()  = default;
public:
