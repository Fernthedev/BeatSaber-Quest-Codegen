...
/// @brief Method get_currentData addr 0x0 size 0xffffffffffffffff virtual true final false
inline ::System::Collections::Generic::Dictionary_2<uint32_t,::BeatSaber::AvatarCore::OptionalAvatarData>* get_currentData() ;

/// @brief Method get_playbackDelaySeconds addr 0x0 size 0xffffffffffffffff virtual true final false
inline float_t get_playbackDelaySeconds() ;

/// @brief Method add_dataDidChangeEvent addr 0x0 size 0xffffffffffffffff virtual true final false
inline void add_dataDidChangeEvent(::System::Action_1<::BeatSaber::AvatarCore::OptionalAvatarData>*  value) ;

/// @brief Method remove_dataDidChangeEvent addr 0x0 size 0xffffffffffffffff virtual true final false
inline void remove_dataDidChangeEvent(::System::Action_1<::BeatSaber::AvatarCore::OptionalAvatarData>*  value) ;

/// @brief Method SetDisplayContext addr 0x0 size 0xffffffffffffffff virtual true final false
