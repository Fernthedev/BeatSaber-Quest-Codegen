...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::BeatSaber::AvatarCore::AvatarSystemIdentifier (::BeatSaber::AvatarCore::IAvatarSystemMetadata::*)()>(&::BeatSaber::AvatarCore::IAvatarSystemMetadata::get_typeIdentifier)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::Tasks::Task_1<bool>* (::BeatSaber::AvatarCore::IAvatarSystemMetadata::*)()>(&::BeatSaber::AvatarCore::IAvatarSystemMetadata::get_avatarCreated)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
