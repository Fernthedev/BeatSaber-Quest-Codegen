...
/// @brief Field dataType offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ByteArrayNetSerializable*> __get_data() const;
...
// Ctor Parameters []
// @brief default ctor
 OptionalAvatarDataPacket()  = default;
public:
