...
constexpr ::cordl_internals::to_const_pointer<::Zenject::SubContainerCreatorBindInfo*> Zenject::WithKernelScopeConcreteIdArgConditionCopyNonLazyBinder::__get__subContainerBindInfo() const {
return ::cordl_internals::getInstanceField<::Zenject::SubContainerCreatorBindInfo*, 0x20>(this);
}
