...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::GetFromGameObjectGetterComponentProvider::*)(::System::Type*, ::System::Func_2<::Zenject::InjectContext*,::UnityEngine::GameObject*>*, bool)>(&::Zenject::GetFromGameObjectGetterComponentProvider::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2f06e5c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Zenject::GetFromGameObjectGetterComponentProvider::*)()>(&::Zenject::GetFromGameObjectGetterComponentProvider::get_IsCached)> {
  ...
  constexpr static std::size_t addrs = 0x2f06e98;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Zenject::GetFromGameObjectGetterComponentProvider::*)()>(&::Zenject::GetFromGameObjectGetterComponentProvider::get_TypeVariesBasedOnMemberType)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2f06ea0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Type* (::Zenject::GetFromGameObjectGetterComponentProvider::*)(::Zenject::InjectContext*)>(&::Zenject::GetFromGameObjectGetterComponentProvider::GetInstanceType)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2f06ea8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::GetFromGameObjectGetterComponentProvider::*)(::Zenject::InjectContext*, ::System::Collections::Generic::List_1<::Zenject::TypeValuePair>*, ByRef<::System::Action*>, ::System::Collections::Generic::List_1<::System::Object*>*)>(&::Zenject::GetFromGameObjectGetterComponentProvider::GetAllInstancesWithInjectSplit)> {
  constexpr static std::size_t size = 0x234;
  constexpr static std::size_t addrs = 0x2f06eb0;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<::Zenject::InjectContext*,::UnityEngine::GameObject*>*> Zenject::GetFromGameObjectGetterComponentProvider::__get__gameObjectGetter() const {
return ::cordl_internals::getInstanceField<::System::Func_2<::Zenject::InjectContext*,::UnityEngine::GameObject*>*, 0x10>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> Zenject::GetFromGameObjectGetterComponentProvider::__get__componentType() const {
return ::cordl_internals::getInstanceField<::System::Type*, 0x18>(this);
}
...
inline ::Zenject::GetFromGameObjectGetterComponentProvider* Zenject::GetFromGameObjectGetterComponentProvider::New_ctor(::System::Type*  componentType, ::System::Func_2<::Zenject::InjectContext*,::UnityEngine::GameObject*>*  gameObjectGetter, bool  matchSingle)  {
return THROW_UNLESS(::il2cpp_utils::New<::Zenject::GetFromGameObjectGetterComponentProvider*>(componentType, gameObjectGetter, matchSingle));
}
inline void Zenject::GetFromGameObjectGetterComponentProvider::_ctor(::System::Type*  componentType, ::System::Func_2<::Zenject::InjectContext*,::UnityEngine::GameObject*>*  gameObjectGetter, bool  matchSingle)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::Zenject::GetFromGameObjectGetterComponentProvider*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
