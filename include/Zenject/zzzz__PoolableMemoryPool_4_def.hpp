...
template<::il2cpp_utils::il2cpp_reference_type TParam1,::il2cpp_utils::il2cpp_reference_type TParam2,::il2cpp_utils::il2cpp_reference_type TParam3,::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11068)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11041), inst: 3511 }), TypeDefinitionIndex(TypeDefinitionIndex(11041))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11068), inst: 6124 })
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::Zenject::MemoryPool_4<TParam1,TParam2,TParam3,TValue>)]{};
