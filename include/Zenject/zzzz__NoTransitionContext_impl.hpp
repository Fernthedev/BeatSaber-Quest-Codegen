...
::cordl_internals::setInstanceField<::Zenject::NoTransitionInstaller*, 0x18>(this, std::forward<::Zenject::NoTransitionInstaller*>(value));
}
constexpr ::Zenject::NoTransitionInstaller* Zenject::NoTransitionContext::__get__noScenesTransitionInstaller()  {
return ::cordl_internals::getInstanceField<::Zenject::NoTransitionInstaller*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Zenject::NoTransitionInstaller*> Zenject::NoTransitionContext::__get__noScenesTransitionInstaller() const {
return ::cordl_internals::getInstanceField<::Zenject::NoTransitionInstaller*, 0x18>(this);
}
