...
::cordl_internals::setInstanceField<::Zenject::SignalDeclarationBindInfo*, 0x18>(this, std::forward<::Zenject::SignalDeclarationBindInfo*>(value));
}
constexpr ::Zenject::SignalDeclarationBindInfo* Zenject::SignalTickPriorityCopyBinder::__get__SignalBindInfo_k__BackingField()  {
return ::cordl_internals::getInstanceField<::Zenject::SignalDeclarationBindInfo*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Zenject::SignalDeclarationBindInfo*> Zenject::SignalTickPriorityCopyBinder::__get__SignalBindInfo_k__BackingField() const {
return ::cordl_internals::getInstanceField<::Zenject::SignalDeclarationBindInfo*, 0x18>(this);
}
