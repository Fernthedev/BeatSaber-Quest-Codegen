...
/// @brief Field <SubContainerCreatorBindInfo>k__BackingField offset 0x20
 __declspec(property(get=__get__SubContainerCreatorBindInfo_k__BackingField, put=__set__SubContainerCreatorBindInfo_k__BackingField)) ::Zenject::SubContainerCreatorBindInfo*  _SubContainerCreatorBindInfo_k__BackingField;
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::SubContainerCreatorBindInfo*> __get__SubContainerCreatorBindInfo_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 DefaultParentScopeConcreteIdArgConditionCopyNonLazyBinder()  = default;
public:
