...
template<::il2cpp_utils::il2cpp_reference_type P1,::il2cpp_utils::il2cpp_reference_type P2,::il2cpp_utils::il2cpp_reference_type P3,::il2cpp_utils::il2cpp_reference_type P4,::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11109)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11109), inst: 6125 })
// CS Name: ::Zenject::PrefabResourceFactory`5<P1,P2,P3,P4,T>*
class CORDL_TYPE PrefabResourceFactory_5<P1,P2,P3,P4,T> : public ::System::Object {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
 PrefabResourceFactory_5()  = default;
public:
