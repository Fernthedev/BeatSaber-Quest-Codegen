...
::cordl_internals::setInstanceField<::Zenject::MemoryPoolBindInfo*, 0x38>(this, std::forward<::Zenject::MemoryPoolBindInfo*>(value));
}
template<::il2cpp_utils::il2cpp_reference_type TContract>
constexpr ::Zenject::MemoryPoolBindInfo* Zenject::MemoryPoolExpandBinder_1<TContract>::__get__MemoryPoolBindInfo_k__BackingField()  {
return ::cordl_internals::getInstanceField<::Zenject::MemoryPoolBindInfo*, 0x38>(this);
}
template<::il2cpp_utils::il2cpp_reference_type TContract>
constexpr ::cordl_internals::to_const_pointer<::Zenject::MemoryPoolBindInfo*> Zenject::MemoryPoolExpandBinder_1<TContract>::__get__MemoryPoolBindInfo_k__BackingField() const {
return ::cordl_internals::getInstanceField<::Zenject::MemoryPoolBindInfo*, 0x38>(this);
}
template<::il2cpp_utils::il2cpp_reference_type TContract>
