...
template<::il2cpp_utils::il2cpp_reference_type TParam1,::il2cpp_utils::il2cpp_reference_type TParam2,::il2cpp_utils::il2cpp_reference_type TParam3,::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11089)), TypeDefinitionIndex(TypeDefinitionIndex(11085)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11085), inst: 186 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11089), inst: 6124 })
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_4<TParam1,TParam2,TParam3,TValue>*> __get__onSpawnMethod() const;
