...
class PrefabResourceFactory_3<P1,P2,T>;
}
// Write type traits
...
template<::il2cpp_utils::il2cpp_reference_type P1,::il2cpp_utils::il2cpp_reference_type P2,::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(11107))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11107), inst: 5330 })
// CS Name: ::Zenject::PrefabResourceFactory`3<P1,P2,T>*
class CORDL_TYPE PrefabResourceFactory_3<P1,P2,T> : public ::System::Object {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
 PrefabResourceFactory_3()  = default;
public:
