...
// Ctor Parameters []
// @brief default ctor
 __CachedOpenTypeProvider____c()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::IProvider*> __get__creator() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::Type*,::Zenject::CachedProvider*>*> __get__providerMap() const;
...
// Ctor Parameters []
// @brief default ctor
 CachedOpenTypeProvider()  = default;
public:
