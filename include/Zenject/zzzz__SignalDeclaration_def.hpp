...
/// @brief Field _subscriptions offset 0x10
...
/// @brief Field _asyncQueue offset 0x18
...
/// @brief Field _isAsync offset 0x34
...
/// @brief Field <TickPriority>k__BackingField offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Zenject::SignalSubscription*>*> __get__subscriptions() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Object*>*> __get__asyncQueue() const;
...
namespace Zenject {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10654)), TypeDefinitionIndex(TypeDefinitionIndex(10659)), TypeDefinitionIndex(TypeDefinitionIndex(11005)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11005), inst: 3493 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::Zenject::PlaceholderFactory_2<::Zenject::SignalDeclarationBindInfo*,::Zenject::SignalDeclaration*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __SignalDeclaration__Factory()  = default;
public:
