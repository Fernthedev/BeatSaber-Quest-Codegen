...
constexpr ::cordl_internals::to_const_pointer<::Zenject::ProjectKernel*> __get__projectKernel() const;

constexpr void __set__sceneContainer(::Zenject::DiContainer*  value) ;

constexpr ::Zenject::DiContainer* __get__sceneContainer() ;

constexpr ::cordl_internals::to_const_pointer<::Zenject::DiContainer*> __get__sceneContainer() const;
