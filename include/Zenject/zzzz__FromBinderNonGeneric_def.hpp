...
class __FromBinderNonGeneric____c__1_2<TConcrete,TFactory>;
}
// Write type traits
...
template<::il2cpp_utils::il2cpp_reference_type TConcrete,::il2cpp_utils::il2cpp_reference_type TFactory>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10915)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10915), inst: 81 })
// CS Name: ::FromBinderNonGeneric::<>c__1`2<TConcrete,TFactory>*
class CORDL_TYPE __FromBinderNonGeneric____c__1_2<TConcrete,TFactory> : public ::System::Object {
public:
// Declarations
/// @brief The size of the true reference type
...
// Ctor Parameters []
// @brief default ctor
 __FromBinderNonGeneric____c__1_2()  = default;
public:
