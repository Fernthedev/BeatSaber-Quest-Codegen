...
constexpr ::cordl_internals::to_const_pointer<::Zenject::DiContainer*> Zenject::SubContainerCreatorByMethodBase::__get__container() const {
return ::cordl_internals::getInstanceField<::Zenject::DiContainer*, 0x10>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::SubContainerCreatorBindInfo*> Zenject::SubContainerCreatorByMethodBase::__get__containerBindInfo() const {
return ::cordl_internals::getInstanceField<::Zenject::SubContainerCreatorBindInfo*, 0x18>(this);
}
