...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::Zenject::Context)]{};

/// @brief Field _autoRun offset 0x40
 __declspec(property(get=__get__autoRun, put=__set__autoRun)) bool  _autoRun;

/// @brief Field <Initialized>k__BackingField offset 0x41
...
// Ctor Parameters []
// @brief default ctor
 RunnableContext()  = default;
public:


// Fields

// Static field _staticAutoRun
