...
constexpr ::cordl_internals::to_const_pointer<::Zenject::ISubContainerCreator*> Zenject::SubContainerCreatorCached::__get__subCreator() const {
return ::cordl_internals::getInstanceField<::Zenject::ISubContainerCreator*, 0x10>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::DiContainer*> Zenject::SubContainerCreatorCached::__get__subContainer() const {
return ::cordl_internals::getInstanceField<::Zenject::DiContainer*, 0x20>(this);
}
