...
/// @brief Field <InstantiateFailed>k__BackingField offset 0x10
...
/// @brief Field <MarkedType>k__BackingField offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get__MarkedType_k__BackingField() const;
