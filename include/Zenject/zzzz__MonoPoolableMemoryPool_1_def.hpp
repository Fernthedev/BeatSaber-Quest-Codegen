...
template<::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11038)), TypeDefinitionIndex(TypeDefinitionIndex(11056)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11038), inst: 2754 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11056), inst: 2 })
...
// Ctor Parameters []
// @brief default ctor
 MonoPoolableMemoryPool_1()  = default;
public:
