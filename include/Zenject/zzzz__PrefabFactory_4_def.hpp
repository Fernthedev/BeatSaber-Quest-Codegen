...
template<::il2cpp_utils::il2cpp_reference_type P1,::il2cpp_utils::il2cpp_reference_type P2,::il2cpp_utils::il2cpp_reference_type P3,::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11103)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11103), inst: 6124 })
// CS Name: ::Zenject::PrefabFactory`4<P1,P2,P3,T>*
class CORDL_TYPE PrefabFactory_4<P1,P2,P3,T> : public ::System::Object {
public:
// Declarations
