...
constexpr ::cordl_internals::to_const_pointer<::Zenject::GameObjectCreationParameters*> Zenject::SubContainerCreatorByNewPrefab::__get__gameObjectBindInfo() const {
return ::cordl_internals::getInstanceField<::Zenject::GameObjectCreationParameters*, 0x10>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::IPrefabProvider*> Zenject::SubContainerCreatorByNewPrefab::__get__prefabProvider() const {
return ::cordl_internals::getInstanceField<::Zenject::IPrefabProvider*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::DiContainer*> Zenject::SubContainerCreatorByNewPrefab::__get__container() const {
return ::cordl_internals::getInstanceField<::Zenject::DiContainer*, 0x20>(this);
}
