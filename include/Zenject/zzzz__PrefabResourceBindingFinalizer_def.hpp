...
constexpr ::cordl_internals::to_const_pointer<::Zenject::PrefabResourceBindingFinalizer*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __PrefabResourceBindingFinalizer____c__DisplayClass5_0()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::__PrefabResourceBindingFinalizer____c__DisplayClass5_0*> __get_CS$__8__locals1() const;
...
// Ctor Parameters []
// @brief default ctor
 __PrefabResourceBindingFinalizer____c__DisplayClass5_1()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __PrefabResourceBindingFinalizer____c__DisplayClass6_0()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::__PrefabResourceBindingFinalizer____c__DisplayClass6_0*> __get_CS$__8__locals1() const;
...
// Ctor Parameters []
// @brief default ctor
 __PrefabResourceBindingFinalizer____c__DisplayClass6_1()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 PrefabResourceBindingFinalizer()  = default;
public:
