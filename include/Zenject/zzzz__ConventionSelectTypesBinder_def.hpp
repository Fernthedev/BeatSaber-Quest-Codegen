...
// Ctor Parameters []
// @brief default ctor
 __ConventionSelectTypesBinder____c()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::ConventionBindInfo*> __get__bindInfo() const;
...
// Ctor Parameters []
// @brief default ctor
 ConventionSelectTypesBinder()  = default;
public:
