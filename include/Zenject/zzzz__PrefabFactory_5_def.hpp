...
template<::il2cpp_utils::il2cpp_reference_type P1,::il2cpp_utils::il2cpp_reference_type P2,::il2cpp_utils::il2cpp_reference_type P3,::il2cpp_utils::il2cpp_reference_type P4,::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11104)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11104), inst: 6125 })
// CS Name: ::Zenject::PrefabFactory`5<P1,P2,P3,P4,T>*
class CORDL_TYPE PrefabFactory_5<P1,P2,P3,P4,T> : public ::System::Object {
public:
// Declarations
