...
/// @brief Field _bindingFinalizer offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::IBindingFinalizer*> __get__bindingFinalizer() const;

static inline ::Zenject::BindStatement* New_ctor() ;

/// @brief Method .ctor addr 0x2edebbc size 0x84 virtual false final false
inline void _ctor() ;

/// @brief Method get_BindingInheritanceMethod addr 0x2eded7c size 0xa8 virtual false final false
inline ::Zenject::BindingInheritanceMethods get_BindingInheritanceMethod() ;

/// @brief Method get_HasFinalizer addr 0x2edee68 size 0x10 virtual false final false
inline bool get_HasFinalizer() ;

/// @brief Method SetFinalizer addr 0x2edee78 size 0x8 virtual false final false
inline void SetFinalizer(::Zenject::IBindingFinalizer*  bindingFinalizer) ;

/// @brief Method AssertHasFinalizer addr 0x2edee24 size 0x44 virtual false final false
inline void AssertHasFinalizer() ;

/// @brief Method AddDisposable addr 0x2edee80 size 0xa8 virtual false final false
inline void AddDisposable(::System::IDisposable*  disposable) ;

/// @brief Method SpawnBindInfo addr 0x2edef28 size 0x6c virtual false final false
inline ::Zenject::BindInfo* SpawnBindInfo() ;

/// @brief Method FinalizeBinding addr 0x2edef94 size 0xb4 virtual false final false
inline void FinalizeBinding(::Zenject::DiContainer*  container) ;

/// @brief Method Reset addr 0x2edec40 size 0x13c virtual false final false
inline void Reset() ;

/// @brief Method Dispose addr 0x2edf048 size 0x58 virtual true final true
inline void Dispose() ;
