...
template<::il2cpp_utils::il2cpp_reference_type TParam1,::il2cpp_utils::il2cpp_reference_type TDerived>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11132)), TypeDefinitionIndex(TypeDefinitionIndex(11137))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11132), inst: 81 })
