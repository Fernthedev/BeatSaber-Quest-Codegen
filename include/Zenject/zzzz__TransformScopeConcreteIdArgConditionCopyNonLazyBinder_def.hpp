...
/// @brief Field <GameObjectInfo>k__BackingField offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::GameObjectCreationParameters*> __get__GameObjectInfo_k__BackingField() const;
...
/// @brief Method .ctor addr 0x2eda080 size 0x28 virtual false final false
inline void _ctor(::Zenject::BindInfo*  bindInfo, ::Zenject::GameObjectCreationParameters*  gameObjectInfo) ;

/// @brief Method get_GameObjectInfo addr 0x2eda0c4 size 0x8 virtual false final false
inline ::Zenject::GameObjectCreationParameters* get_GameObjectInfo() ;

/// @brief Method set_GameObjectInfo addr 0x2eda0cc size 0x8 virtual false final false
inline void set_GameObjectInfo(::Zenject::GameObjectCreationParameters*  value) ;

/// @brief Method UnderTransform addr 0x2eda0d4 size 0x1c virtual false final false
inline ::Zenject::ScopeConcreteIdArgConditionCopyNonLazyBinder* UnderTransform(::UnityEngine::Transform*  parent) ;

/// @brief Method UnderTransform addr 0x2eda0f0 size 0x1c virtual false final false
...
/// @brief Method UnderTransformGroup addr 0x2eda10c size 0x1c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 TransformScopeConcreteIdArgConditionCopyNonLazyBinder()  = default;
public:
