...
template<::il2cpp_utils::il2cpp_reference_type TParam1,::il2cpp_utils::il2cpp_reference_type TParam2,::il2cpp_utils::il2cpp_reference_type TParam3,::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11059)), TypeDefinitionIndex(TypeDefinitionIndex(11041)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11041), inst: 3509 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11059), inst: 6124 })
...
// Ctor Parameters []
// @brief default ctor
 MonoPoolableMemoryPool_4()  = default;
public:
