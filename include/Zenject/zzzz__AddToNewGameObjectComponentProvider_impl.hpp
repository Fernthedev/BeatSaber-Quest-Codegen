...
::cordl_internals::setInstanceField<::Zenject::GameObjectCreationParameters*, 0x38>(this, std::forward<::Zenject::GameObjectCreationParameters*>(value));
}
constexpr ::Zenject::GameObjectCreationParameters* Zenject::AddToNewGameObjectComponentProvider::__get__gameObjectBindInfo()  {
return ::cordl_internals::getInstanceField<::Zenject::GameObjectCreationParameters*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Zenject::GameObjectCreationParameters*> Zenject::AddToNewGameObjectComponentProvider::__get__gameObjectBindInfo() const {
return ::cordl_internals::getInstanceField<::Zenject::GameObjectCreationParameters*, 0x38>(this);
}
