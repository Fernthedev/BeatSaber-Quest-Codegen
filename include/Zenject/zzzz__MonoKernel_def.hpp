...
/// @brief Field _disposablesManager offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::InitializableManager*> __get__initializableManager() const;
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::DisposableManager*> __get__disposablesManager() const;
