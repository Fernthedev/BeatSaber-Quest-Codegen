...
/// @brief Method .ctor addr 0x2f1f0dc size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <CreateTypeInfoFromReflection>b__0 addr 0x2f1f514 size 0x8 virtual false final false
...
/// @brief Method <CreateTypeInfoFromReflection>b__1 addr 0x2f1f5a4 size 0x8 virtual false final false
...
/// @brief Method __zenCreate addr 0x2f1f634 size 0x5c virtual false final false
static inline ::System::Object* __zenCreate(::ArrayW<::System::Object*,::Array<::System::Object*>*>  P_0) ;

/// @brief Method __zenCreateInjectTypeInfo addr 0x2f1f690 size 0x1c0 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __TypeAnalyzer____c__DisplayClass23_0()  = default;
public:
...
/// @brief Method get_ReflectionBakingCoverageMode addr 0x2f1e76c size 0x58 virtual false final false
static inline ::Zenject::ReflectionBakingCoverageModes get_ReflectionBakingCoverageMode() ;

/// @brief Method set_ReflectionBakingCoverageMode addr 0x2f1e7c4 size 0x5c virtual false final false
...
/// @brief Method ShouldAllowDuringValidation addr 0x2f05dfc size 0xec virtual false final false
static inline bool ShouldAllowDuringValidation(::System::Type*  type) ;

/// @brief Method ShouldAllowDuringValidationInternal addr 0x2f1e820 size 0x118 virtual false final false
...
/// @brief Method HasInfo addr 0x2f1e938 size 0x60 virtual false final false
...
/// @brief Method GetInfo addr 0x2f0cf08 size 0x84 virtual false final false
...
/// @brief Method TryGetInfo addr 0x2f03c8c size 0x1d4 virtual false final false
static inline ::Zenject::InjectTypeInfo* TryGetInfo(::System::Type*  type) ;

/// @brief Method GetInfoInternal addr 0x2f1e998 size 0x27c virtual false final false
static inline ::Zenject::InjectTypeInfo* GetInfoInternal(::System::Type*  type) ;

/// @brief Method ShouldSkipTypeAnalysis addr 0x2f1ec14 size 0x170 virtual false final false
static inline bool ShouldSkipTypeAnalysis(::System::Type*  type) ;

/// @brief Method IsStaticType addr 0x2f1f054 size 0x88 virtual false final false
static inline bool IsStaticType(::System::Type*  type) ;

/// @brief Method CreateTypeInfoFromReflection addr 0x2f1ed84 size 0x2d0 virtual false final false
...
// Static field _typeInfo

// Static field _allowDuringValidation

// Static field <ReflectionBakingCoverageMode>k__BackingField
