...
template<::il2cpp_utils::il2cpp_reference_type TParam1,::cordl_internals::is_or_is_backed_by<int32_t> TParam2,::il2cpp_utils::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10738), inst: 1811 }), TypeDefinitionIndex(TypeDefinitionIndex(10738)), TypeDefinitionIndex(TypeDefinitionIndex(10851))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10851), inst: 6142 })
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::Zenject::FactoryFromBinder_3<TParam1,TParam2,TContract>)]{};
...
// Ctor Parameters []
// @brief default ctor
 FactoryToChoiceBinder_3()  = default;
public:
...
template<::il2cpp_utils::il2cpp_reference_type TParam1,::il2cpp_utils::il2cpp_reference_type TParam2,::il2cpp_utils::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10738)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10738), inst: 1811 }), TypeDefinitionIndex(TypeDefinitionIndex(10851))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10851), inst: 5330 })
// CS Name: ::Zenject::FactoryToChoiceBinder`3<TParam1,TParam2,TContract>*
class CORDL_TYPE FactoryToChoiceBinder_3<TParam1,TParam2,TContract> : public ::Zenject::FactoryFromBinder_3<TParam1,TParam2,TContract> {
public:
// Declarations
