...
template<::il2cpp_utils::il2cpp_reference_type TParam1,::il2cpp_utils::il2cpp_reference_type TDerived>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11149)), TypeDefinitionIndex(TypeDefinitionIndex(11154))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11149), inst: 81 })
...
// Ctor Parameters []
// @brief default ctor
 ScriptableObjectInstaller_2()  = default;
public:
