...
template<::il2cpp_utils::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10703)), TypeDefinitionIndex(TypeDefinitionIndex(10848)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10848), inst: 1906 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10703), inst: 2 })
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::Zenject::FactoryToChoiceBinder_1<TContract>)]{};
...
// Ctor Parameters []
// @brief default ctor
 FactoryArgumentsToChoiceBinder_1()  = default;
public:
