...
template<::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11002)), TypeDefinitionIndex(TypeDefinitionIndex(11003)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11002), inst: 3470 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11003), inst: 2 })
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::Zenject::PlaceholderFactory_1<TValue>)]{};
