...
template<::il2cpp_utils::il2cpp_reference_type TParam1,::il2cpp_utils::il2cpp_reference_type TParam2,::il2cpp_utils::il2cpp_reference_type TParam3>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11246)), TypeDefinitionIndex(TypeDefinitionIndex(11250))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11250), inst: 5330 })
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_4<::Zenject::DiContainer*,TParam1,TParam2,TParam3>*> __get__installMethod() const;
...
// Ctor Parameters []
// @brief default ctor
 SubContainerCreatorByMethod_3()  = default;
public:
