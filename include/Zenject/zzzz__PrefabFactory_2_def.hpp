...
template<::il2cpp_utils::il2cpp_reference_type P1,::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(11101))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11101), inst: 81 })
// CS Name: ::Zenject::PrefabFactory`2<P1,T>*
class CORDL_TYPE PrefabFactory_2<P1,T> : public ::System::Object {
public:
// Declarations
