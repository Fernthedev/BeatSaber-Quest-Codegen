...
template<::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11211)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11211), inst: 2 })
// CS Name: ::Zenject::MethodProviderWithContainer`1<TValue>*
class CORDL_TYPE MethodProviderWithContainer_1<TValue> : public ::System::Object {
public:
// Declarations
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<::Zenject::DiContainer*,TValue>*> __get__method() const;
...
// Ctor Parameters []
// @brief default ctor
 MethodProviderWithContainer_1()  = default;
public:
