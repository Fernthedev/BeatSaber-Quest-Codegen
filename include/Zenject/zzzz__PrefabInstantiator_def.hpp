...
/// @brief Field shouldMakeActive offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::PrefabInstantiator*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __PrefabInstantiator____c__DisplayClass15_0()  = default;
public:
...
/// @brief Field _prefabProvider offset 0x10
...
/// @brief Field _gameObjectBindInfo offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get__argumentTarget() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Type*>*> __get__instantiateCallbackTypes() const;
