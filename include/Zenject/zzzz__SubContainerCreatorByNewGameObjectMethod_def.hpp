...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::Zenject::DiContainer*>*> __get__installerMethod() const;
...
// Ctor Parameters []
// @brief default ctor
 SubContainerCreatorByNewGameObjectMethod()  = default;
public:
