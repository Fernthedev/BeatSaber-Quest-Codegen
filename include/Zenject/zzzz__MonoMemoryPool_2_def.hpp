...
template<::il2cpp_utils::il2cpp_reference_type TParam1,::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11039)), TypeDefinitionIndex(TypeDefinitionIndex(11051)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11039), inst: 3482 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11051), inst: 81 })
