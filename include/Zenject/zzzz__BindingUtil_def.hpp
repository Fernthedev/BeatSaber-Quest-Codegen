...
/// @brief Method AssertIsValidPrefab addr 0x2edbd08 size 0x5c virtual false final false
static inline void AssertIsValidPrefab(::UnityEngine::Object*  prefab) ;

/// @brief Method AssertIsValidGameObject addr 0x2edf6f0 size 0x5c virtual false final false
static inline void AssertIsValidGameObject(::UnityEngine::GameObject*  gameObject) ;

/// @brief Method AssertIsNotComponent addr 0x2edf74c size 0x2c0 virtual false final false
...
/// @brief Method AssertIsNotComponent addr 0x2edfa0c size 0xe0 virtual false final false
static inline void AssertIsNotComponent(::System::Type*  type) ;

/// @brief Method AssertDerivesFromUnityObject addr 0x2edfaec size 0x2c0 virtual false final false
...
/// @brief Method AssertDerivesFromUnityObject addr 0x2edfdac size 0x94 virtual false final false
static inline void AssertDerivesFromUnityObject(::System::Type*  type) ;

/// @brief Method AssertTypesAreNotComponents addr 0x2edfe40 size 0x2c0 virtual false final false
static inline void AssertTypesAreNotComponents(::System::Collections::Generic::IEnumerable_1<::System::Type*>*  types) ;

/// @brief Method AssertIsValidResourcePath addr 0x2edc2e8 size 0x5c virtual false final false
static inline void AssertIsValidResourcePath(::StringW  resourcePath) ;

/// @brief Method AssertIsInterfaceOrScriptableObject addr 0x2ee0100 size 0x2c0 virtual false final false
...
/// @brief Method AssertIsInterfaceOrScriptableObject addr 0x2ee03c0 size 0x104 virtual false final false
static inline void AssertIsInterfaceOrScriptableObject(::System::Type*  type) ;

/// @brief Method AssertIsInterfaceOrComponent addr 0x2ee04c4 size 0x2c0 virtual false final false
...
/// @brief Method AssertIsInterfaceOrComponent addr 0x2ee0784 size 0x104 virtual false final false
static inline void AssertIsInterfaceOrComponent(::System::Type*  type) ;

/// @brief Method AssertIsComponent addr 0x2ee0888 size 0x2c0 virtual false final false
...
/// @brief Method AssertIsComponent addr 0x2ee0b48 size 0xdc virtual false final false
static inline void AssertIsComponent(::System::Type*  type) ;

/// @brief Method AssertTypesAreNotAbstract addr 0x2ee0c24 size 0x2c0 virtual false final false
static inline void AssertTypesAreNotAbstract(::System::Collections::Generic::IEnumerable_1<::System::Type*>*  types) ;

/// @brief Method AssertIsNotAbstract addr 0x2ee0f68 size 0x2c0 virtual false final false
...
/// @brief Method AssertIsNotAbstract addr 0x2ee0ee4 size 0x84 virtual false final false
static inline void AssertIsNotAbstract(::System::Type*  type) ;

/// @brief Method AssertIsDerivedFromType addr 0x2ee1228 size 0x144 virtual false final false
static inline void AssertIsDerivedFromType(::System::Type*  concreteType, ::System::Type*  parentType) ;

/// @brief Method AssertConcreteTypeListIsNotEmpty addr 0x2ee136c size 0x78 virtual false final false
static inline void AssertConcreteTypeListIsNotEmpty(::System::Collections::Generic::IEnumerable_1<::System::Type*>*  concreteTypes) ;

/// @brief Method AssertIsDerivedFromTypes addr 0x2ee13e4 size 0xa4 virtual false final false
...
/// @brief Method AssertIsDerivedFromTypes addr 0x2ee1488 size 0x2d4 virtual false final false
...
/// @brief Method AssertIsDerivedFromTypes addr 0x2ee175c size 0x2d8 virtual false final false
...
/// @brief Method AssertInstanceDerivesFromOrEqual addr 0x2ee1a34 size 0x2e4 virtual false final false
...
/// @brief Method AssertInstanceDerivesFromOrEqual addr 0x2ee1d18 size 0xe4 virtual false final false
static inline void AssertInstanceDerivesFromOrEqual(::System::Object*  instance, ::System::Type*  baseType) ;

/// @brief Method CreateCachedProvider addr 0x2ee1dfc size 0x10c virtual false final false
