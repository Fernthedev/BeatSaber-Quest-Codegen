...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::DefaultParentScopeConcreteIdArgConditionCopyNonLazyBinder::*)(::Zenject::SubContainerCreatorBindInfo*, ::Zenject::BindInfo*)>(&::Zenject::DefaultParentScopeConcreteIdArgConditionCopyNonLazyBinder::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Zenject::DefaultParentScopeConcreteIdArgConditionCopyNonLazyBinder::*)(::Zenject::SubContainerCreatorBindInfo*)>(&::Zenject::DefaultParentScopeConcreteIdArgConditionCopyNonLazyBinder::set_SubContainerCreatorBindInfo)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::Zenject::SubContainerCreatorBindInfo*>::get()}
                        )));
    return ___internal_method;
  }
};
...
::cordl_internals::setInstanceField<::Zenject::SubContainerCreatorBindInfo*, 0x20>(this, std::forward<::Zenject::SubContainerCreatorBindInfo*>(value));
}
...
return ::cordl_internals::getInstanceField<::Zenject::SubContainerCreatorBindInfo*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Zenject::SubContainerCreatorBindInfo*> Zenject::DefaultParentScopeConcreteIdArgConditionCopyNonLazyBinder::__get__SubContainerCreatorBindInfo_k__BackingField() const {
return ::cordl_internals::getInstanceField<::Zenject::SubContainerCreatorBindInfo*, 0x20>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::Zenject::DefaultParentScopeConcreteIdArgConditionCopyNonLazyBinder*>(subContainerBindInfo, bindInfo));
}
