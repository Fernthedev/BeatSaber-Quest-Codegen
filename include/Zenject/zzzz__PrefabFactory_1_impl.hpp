...
constexpr  Zenject::PrefabFactory_1<T>::operator ::Zenject::IFactory_2<::UnityEngine::Object*,T>*() noexcept {
...
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::Zenject::DiContainer* Zenject::PrefabFactory_1<T>::__get__container()  {
return ::cordl_internals::getInstanceField<::Zenject::DiContainer*, 0x10>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::cordl_internals::to_const_pointer<::Zenject::DiContainer*> Zenject::PrefabFactory_1<T>::__get__container() const {
return ::cordl_internals::getInstanceField<::Zenject::DiContainer*, 0x10>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
