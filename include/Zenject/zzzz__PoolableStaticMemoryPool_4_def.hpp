...
template<::il2cpp_utils::il2cpp_reference_type TParam1,::il2cpp_utils::il2cpp_reference_type TParam2,::il2cpp_utils::il2cpp_reference_type TParam3,::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11089)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11089), inst: 3629 }), TypeDefinitionIndex(TypeDefinitionIndex(11079))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11079), inst: 6124 })
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::Zenject::StaticMemoryPool_4<TParam1,TParam2,TParam3,TValue>)]{};
...
// Ctor Parameters []
// @brief default ctor
 PoolableStaticMemoryPool_4()  = default;
public:
