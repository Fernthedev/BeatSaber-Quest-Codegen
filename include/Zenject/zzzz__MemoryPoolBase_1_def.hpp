...
template<::il2cpp_utils::il2cpp_reference_type TContract>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(11049))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11049), inst: 2 })
// CS Name: ::Zenject::MemoryPoolBase`1<TContract>*
class CORDL_TYPE MemoryPoolBase_1<TContract> : public ::System::Object {
public:
// Declarations
...
/// @brief Field _inactiveItems offset 0x10
...
/// @brief Field _settings offset 0x20
...
/// @brief Field _activeCount offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Stack_1<TContract>*> __get__inactiveItems() const;

constexpr void __set__factory(::Zenject::IFactory_1<TContract>*  value) ;

constexpr ::Zenject::IFactory_1<TContract>* __get__factory() ;

constexpr ::cordl_internals::to_const_pointer<::Zenject::IFactory_1<TContract>*> __get__factory() const;

constexpr void __set__settings(::Zenject::MemoryPoolSettings*  value) ;

constexpr ::Zenject::MemoryPoolSettings* __get__settings() ;

constexpr ::cordl_internals::to_const_pointer<::Zenject::MemoryPoolSettings*> __get__settings() const;
