...
namespace Zenject {
template<::il2cpp_utils::il2cpp_reference_type TValue>
class __PlaceholderFactory_1___get_ParamTypes_d__2<TValue>;
}
// Write type traits
...
template<::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(11001))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11001), inst: 2 })
// CS Name: ::PlaceholderFactory`1::<get_ParamTypes>d__2<TValue>*
class CORDL_TYPE __PlaceholderFactory_1___get_ParamTypes_d__2<TValue> : public ::System::Object {
public:
// Declarations
...
// Ctor Parameters []
// @brief default ctor
 __PlaceholderFactory_1___get_ParamTypes_d__2()  = default;
public:
...
template<::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11002)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11026), inst: 3471 }), TypeDefinitionIndex(TypeDefinitionIndex(11026))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11002), inst: 2 })
