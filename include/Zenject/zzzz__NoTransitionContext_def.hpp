...
/// @brief Field _noScenesTransitionInstaller offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::NoTransitionInstaller*> __get__noScenesTransitionInstaller() const;
