...
namespace Zenject {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11337), inst: 4201 }), TypeDefinitionIndex(TypeDefinitionIndex(11337)), TypeDefinitionIndex(TypeDefinitionIndex(15734))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::Zenject::TaskUpdater_1<::Zenject::ILateTickable*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 LateTickablesTaskUpdater()  = default;
public:
