...
template<::il2cpp_utils::il2cpp_reference_type T1,::il2cpp_utils::il2cpp_reference_type T2,::il2cpp_utils::il2cpp_reference_type T3>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(10627))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10627), inst: 5330 })
// CS Name: ::ModestTree.Util::ValuePair`3<T1,T2,T3>*
class CORDL_TYPE ValuePair_3<T1,T2,T3> : public ::System::Object {
public:
// Declarations
