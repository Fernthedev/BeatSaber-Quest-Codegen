...
/// @brief Field hdrBuilBuilder offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cmp::PkiHeaderBuilder*> __get_hdrBuilBuilder() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> __get_generalInfos() const;

constexpr void __set_extraCerts(::System::Collections::IList*  value) ;

constexpr ::System::Collections::IList* __get_extraCerts() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> __get_extraCerts() const;
...
// Ctor Parameters []
// @brief default ctor
 ProtectedPkiMessageBuilder()  = default;
public:
