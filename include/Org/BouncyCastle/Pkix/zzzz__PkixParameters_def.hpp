...
/// @brief Field necessaryACAttributes offset 0x70
...
/// @brief Field prohibitedACAttributes offset 0x78
...
/// @brief Field attrCertCheckers offset 0x80
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_trustAnchors() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Date::DateTimeObject*> __get_date() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> __get_certPathCheckers() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_initialPolicies() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::X509::Store::IX509Selector*> __get_certSelector() const;

constexpr void __set_stores(::System::Collections::IList*  value) ;

constexpr ::System::Collections::IList* __get_stores() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> __get_stores() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::X509::Store::IX509Selector*> __get_selector() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> __get_additionalStores() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_trustedACIssuers() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_necessaryACAttributes() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_prohibitedACAttributes() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_attrCertCheckers() const;
