...
/// @brief Field excludedSubtreesDN offset 0x10
...
/// @brief Field excludedSubtreesDNS offset 0x18
...
/// @brief Field excludedSubtreesEmail offset 0x20
...
/// @brief Field excludedSubtreesURI offset 0x28
...
/// @brief Field excludedSubtreesIP offset 0x30
...
/// @brief Field excludedSubtreesOtherName offset 0x38
...
/// @brief Field permittedSubtreesDN offset 0x40
...
/// @brief Field permittedSubtreesDNS offset 0x48
...
/// @brief Field permittedSubtreesEmail offset 0x50
...
/// @brief Field permittedSubtreesURI offset 0x58
...
/// @brief Field permittedSubtreesIP offset 0x60
...
/// @brief Field permittedSubtreesOtherName offset 0x68
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_excludedSubtreesDN() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_excludedSubtreesDNS() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_excludedSubtreesEmail() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_excludedSubtreesURI() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_excludedSubtreesIP() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_excludedSubtreesOtherName() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_permittedSubtreesDN() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_permittedSubtreesDNS() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_permittedSubtreesEmail() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_permittedSubtreesURI() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_permittedSubtreesIP() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_permittedSubtreesOtherName() const;

static inline ::Org::BouncyCastle::Pkix::PkixNameConstraintValidator* New_ctor() ;

/// @brief Method .ctor addr 0x10f6c00 size 0xf4 virtual false final false
inline void _ctor() ;

/// @brief Method WithinDNSubtree addr 0x1105f30 size 0x3bc virtual false final false
static inline bool WithinDNSubtree(::Org::BouncyCastle::Asn1::Asn1Sequence*  dns, ::Org::BouncyCastle::Asn1::Asn1Sequence*  subtree) ;

/// @brief Method CheckPermittedDN addr 0x11062ec size 0x10 virtual false final false
inline void CheckPermittedDN(::Org::BouncyCastle::Asn1::Asn1Sequence*  dn) ;

/// @brief Method CheckExcludedDN addr 0x110641c size 0x10 virtual false final false
inline void CheckExcludedDN(::Org::BouncyCastle::Asn1::Asn1Sequence*  dn) ;

/// @brief Method IntersectDN addr 0x1106488 size 0x7d4 virtual false final false
...
/// @brief Method UnionDN addr 0x1106c5c size 0x5e4 virtual false final false
...
/// @brief Method IntersectOtherName addr 0x1107240 size 0x698 virtual false final false
...
/// @brief Method IntersectOtherName addr 0x11078d8 size 0xd8 virtual false final false
...
/// @brief Method UnionOtherName addr 0x11079b0 size 0xf0 virtual false final false
...
/// @brief Method IntersectEmail addr 0x1107aa0 size 0x6b8 virtual false final false
...
/// @brief Method UnionEmail addr 0x1108708 size 0x438 virtual false final false
...
/// @brief Method IntersectIP addr 0x1109480 size 0x780 virtual false final false
...
/// @brief Method UnionIP addr 0x1109e40 size 0x4a8 virtual false final false
...
/// @brief Method UnionIPRange addr 0x110a2e8 size 0x174 virtual false final false
...
/// @brief Method IntersectIPRange addr 0x1109c00 size 0x240 virtual false final false
...
/// @brief Method IpWithSubnetMask addr 0x110ab8c size 0xa4 virtual false final false
...
/// @brief Method ExtractIPsAndSubnetMasks addr 0x110a45c size 0x1fc virtual false final false
...
/// @brief Method MinMaxIPs addr 0x110a658 size 0x2bc virtual false final false
...
/// @brief Method IsOtherNameConstrained addr 0x110ac30 size 0x1c virtual false final false
...
/// @brief Method IsOtherNameConstrained addr 0x110ac4c size 0x324 virtual false final false
...
/// @brief Method CheckPermittedOtherName addr 0x110af70 size 0x60 virtual false final false
...
/// @brief Method CheckExcludedOtherName addr 0x110b038 size 0x5c virtual false final false
...
/// @brief Method IsEmailConstrained addr 0x110b094 size 0x164 virtual false final false
inline bool IsEmailConstrained(::StringW  constraint, ::StringW  email) ;

/// @brief Method IsEmailConstrained addr 0x110b3ec size 0x354 virtual false final false
inline bool IsEmailConstrained(::Org::BouncyCastle::Utilities::Collections::ISet*  constraints, ::StringW  email) ;

/// @brief Method CheckPermittedEmail addr 0x110b740 size 0x120 virtual false final false
inline void CheckPermittedEmail(::Org::BouncyCastle::Utilities::Collections::ISet*  permitted, ::StringW  email) ;

/// @brief Method CheckExcludedEmail addr 0x110b860 size 0x5c virtual false final false
inline void CheckExcludedEmail(::Org::BouncyCastle::Utilities::Collections::ISet*  excluded, ::StringW  email) ;

/// @brief Method IsDnsConstrained addr 0x110b8bc size 0x80 virtual false final false
inline bool IsDnsConstrained(::StringW  constraint, ::StringW  dns) ;

/// @brief Method IsDnsConstrained addr 0x110b93c size 0x33c virtual false final false
inline bool IsDnsConstrained(::Org::BouncyCastle::Utilities::Collections::ISet*  constraints, ::StringW  dns) ;

/// @brief Method CheckPermittedDns addr 0x110bc78 size 0x110 virtual false final false
inline void CheckPermittedDns(::Org::BouncyCastle::Utilities::Collections::ISet*  permitted, ::StringW  dns) ;

/// @brief Method CheckExcludedDns addr 0x110bd88 size 0x5c virtual false final false
inline void CheckExcludedDns(::Org::BouncyCastle::Utilities::Collections::ISet*  excluded, ::StringW  dns) ;

/// @brief Method IsDirectoryConstrained addr 0x110bde4 size 0x34c virtual false final false
...
/// @brief Method CheckPermittedDirectory addr 0x11062fc size 0x120 virtual false final false
...
/// @brief Method CheckExcludedDirectory addr 0x110642c size 0x5c virtual false final false
...
/// @brief Method UnionDns addr 0x110dfd8 size 0x5c8 virtual false final false
...
/// @brief Method IntersectEmail addr 0x1108184 size 0x584 virtual false final false
inline void IntersectEmail(::StringW  email1, ::StringW  email2, ::Org::BouncyCastle::Utilities::Collections::ISet*  intersect) ;

/// @brief Method IntersectUri addr 0x110e5a0 size 0x6a4 virtual false final false
...
/// @brief Method UnionUri addr 0x110f1c8 size 0x428 virtual false final false
...
/// @brief Method IntersectUri addr 0x110ec44 size 0x584 virtual false final false
inline void IntersectUri(::StringW  email1, ::StringW  email2, ::Org::BouncyCastle::Utilities::Collections::ISet*  intersect) ;

/// @brief Method ExtractHostFromURL addr 0x110c21c size 0x19c virtual false final false
static inline ::StringW ExtractHostFromURL(::StringW  url) ;

/// @brief Method checkPermitted addr 0x110f5f0 size 0x128 virtual false final false
inline void checkPermitted(::Org::BouncyCastle::Asn1::X509::GeneralName*  name) ;

/// @brief Method checkExcluded addr 0x110f718 size 0x128 virtual false final false
inline void checkExcluded(::Org::BouncyCastle::Asn1::X509::GeneralName*  name) ;

/// @brief Method IntersectPermittedSubtree addr 0x110f840 size 0xaa4 virtual false final false
inline void IntersectPermittedSubtree(::Org::BouncyCastle::Asn1::Asn1Sequence*  permitted) ;

/// @brief Method ExtractNameAsString addr 0x1108158 size 0x2c virtual false final false
inline ::StringW ExtractNameAsString(::Org::BouncyCastle::Asn1::X509::GeneralName*  name) ;

/// @brief Method IntersectEmptyPermittedSubtree addr 0x11102e4 size 0x128 virtual false final false
inline void IntersectEmptyPermittedSubtree(int32_t  nameType) ;

/// @brief Method AddExcludedSubtree addr 0x111040c size 0x188 virtual false final false
inline void AddExcludedSubtree(::Org::BouncyCastle::Asn1::X509::GeneralSubtree*  subtree) ;

/// @brief Method Max addr 0x110a980 size 0x6c virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Max(::ArrayW<uint8_t,::Array<uint8_t>*>  ip1, ::ArrayW<uint8_t,::Array<uint8_t>*>  ip2) ;

/// @brief Method Min addr 0x110a914 size 0x6c virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Min(::ArrayW<uint8_t,::Array<uint8_t>*>  ip1, ::ArrayW<uint8_t,::Array<uint8_t>*>  ip2) ;

/// @brief Method CompareTo addr 0x110a9ec size 0xdc virtual false final false
static inline int32_t CompareTo(::ArrayW<uint8_t,::Array<uint8_t>*>  ip1, ::ArrayW<uint8_t,::Array<uint8_t>*>  ip2) ;

/// @brief Method Or addr 0x110aac8 size 0xc4 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Or(::ArrayW<uint8_t,::Array<uint8_t>*>  ip1, ::ArrayW<uint8_t,::Array<uint8_t>*>  ip2) ;

/// @brief Method HashCode addr 0x1110594 size 0xc virtual false final false
inline int32_t HashCode() ;

/// @brief Method GetHashCode addr 0x11105a0 size 0xf0 virtual true final false
inline int32_t GetHashCode() ;

/// @brief Method HashCollection addr 0x1110690 size 0x39c virtual false final false
inline int32_t HashCollection(::System::Collections::ICollection*  c) ;

/// @brief Method Equals addr 0x1110a2c size 0x16c virtual true final false
inline bool Equals(::System::Object*  o) ;

/// @brief Method CollectionsAreEqual addr 0x1110b98 size 0x6a4 virtual false final false
inline bool CollectionsAreEqual(::System::Collections::ICollection*  coll1, ::System::Collections::ICollection*  coll2) ;

/// @brief Method SpecialEquals addr 0x111123c size 0x128 virtual false final false
inline bool SpecialEquals(::System::Object*  o1, ::System::Object*  o2) ;

/// @brief Method StringifyIP addr 0x1111364 size 0x1b4 virtual false final false
inline ::StringW StringifyIP(::ArrayW<uint8_t,::Array<uint8_t>*>  ip) ;

/// @brief Method StringifyIPCollection addr 0x1111518 size 0x3f0 virtual false final false
inline ::StringW StringifyIPCollection(::Org::BouncyCastle::Utilities::Collections::ISet*  ips) ;

/// @brief Method StringifyOtherNameCollection addr 0x1111908 size 0x594 virtual false final false
inline ::StringW StringifyOtherNameCollection(::Org::BouncyCastle::Utilities::Collections::ISet*  otherNames) ;

/// @brief Method ToString addr 0x1111e9c size 0x6bc virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 PkixNameConstraintValidator()  = default;
public:


// Fields

// Static field SerialNumberOid
