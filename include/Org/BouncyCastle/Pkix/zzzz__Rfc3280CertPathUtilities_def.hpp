...
/// @brief Method ProcessCrlB2 addr 0x1113640 size 0xe10 virtual false final false
...
/// @brief Method ProcessCertBC addr 0x10f7464 size 0xa84 virtual false final false
...
/// @brief Method PrepareNextCertA addr 0x10f9f98 size 0x4dc virtual false final false
static inline void PrepareNextCertA(::Org::BouncyCastle::Pkix::PkixCertPath*  certPath, int32_t  index) ;

/// @brief Method ProcessCertD addr 0x10f7ee8 size 0x1dd8 virtual false final false
...
/// @brief Method ProcessCrlB1 addr 0x1114450 size 0x39c virtual false final false
...
/// @brief Method ProcessCrlD addr 0x11147ec size 0x318 virtual false final false
...
/// @brief Method ProcessCrlF addr 0x1114b04 size 0xe0c virtual false final false
...
/// @brief Method ProcessCrlG addr 0x1115910 size 0x46c virtual false final false
...
/// @brief Method ProcessCrlH addr 0x1115d7c size 0x46c virtual false final false
...
/// @brief Method CheckCrl addr 0x11161e8 size 0xbb8 virtual false final false
...
/// @brief Method CheckCrls addr 0x1117478 size 0xa08 virtual false final false
...
/// @brief Method PrepareCertB addr 0x10fa474 size 0x1e94 virtual false final false
...
/// @brief Method ProcessCrlA1ii addr 0x1117e80 size 0x4cc virtual false final false
...
/// @brief Method ProcessCrlA1i addr 0x111834c size 0x4a0 virtual false final false
...
/// @brief Method ProcessCertF addr 0x10f9f20 size 0x78 virtual false final false
...
/// @brief Method ProcessCertA addr 0x10f6ddc size 0x688 virtual false final false
...
/// @brief Method PrepareNextCertI1 addr 0x10fcc1c size 0x424 virtual false final false
static inline int32_t PrepareNextCertI1(::Org::BouncyCastle::Pkix::PkixCertPath*  certPath, int32_t  index, int32_t  explicitPolicy) ;

/// @brief Method PrepareNextCertI2 addr 0x10fd040 size 0x428 virtual false final false
static inline int32_t PrepareNextCertI2(::Org::BouncyCastle::Pkix::PkixCertPath*  certPath, int32_t  index, int32_t  policyMapping) ;

/// @brief Method PrepareNextCertG addr 0x10fc308 size 0x4f4 virtual false final false
...
/// @brief Method PrepareNextCertJ addr 0x10fd468 size 0x270 virtual false final false
...
/// @brief Method PrepareNextCertH1 addr 0x10fc7fc size 0x160 virtual false final false
static inline int32_t PrepareNextCertH1(::Org::BouncyCastle::Pkix::PkixCertPath*  certPath, int32_t  index, int32_t  explicitPolicy) ;

/// @brief Method PrepareNextCertH2 addr 0x10fc95c size 0x160 virtual false final false
static inline int32_t PrepareNextCertH2(::Org::BouncyCastle::Pkix::PkixCertPath*  certPath, int32_t  index, int32_t  policyMapping) ;

/// @brief Method PrepareNextCertH3 addr 0x10fcabc size 0x160 virtual false final false
...
/// @brief Method WrapupCertA addr 0x10fe840 size 0x7c virtual false final false
static inline int32_t WrapupCertA(int32_t  explicitPolicy, ::Org::BouncyCastle::X509::X509Certificate*  cert) ;

/// @brief Method WrapupCertB addr 0x10fe8bc size 0x450 virtual false final false
static inline int32_t WrapupCertB(::Org::BouncyCastle::Pkix::PkixCertPath*  certPath, int32_t  index, int32_t  explicitPolicy) ;

/// @brief Method WrapupCertF addr 0x10fed0c size 0x498 virtual false final false
...
/// @brief Method WrapupCertG addr 0x10ff1a4 size 0x1520 virtual false final false
...
/// @brief Method ProcessCrlC addr 0x1116da0 size 0x588 virtual false final false
...
/// @brief Method ProcessCrlI addr 0x1117328 size 0xb8 virtual false final false
...
/// @brief Method ProcessCrlJ addr 0x11173e0 size 0x98 virtual false final false
...
/// @brief Method ProcessCertE addr 0x10f9cc0 size 0x260 virtual false final false
...
/// @brief Method .ctor addr 0x1118b9c size 0x1008 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 Rfc3280CertPathUtilities()  = default;
public:


// Fields

// Static field CrlUtilities

// Static field ANY_POLICY

// Static field KEY_CERT_SIGN

// Static field CRL_SIGN

// Static field CrlReasons
