...
constexpr ::System::Exception* Org::BouncyCastle::Pkix::PkixAttrCertPathBuilder::__get_certPathException()  {
return ::cordl_internals::getInstanceField<::System::Exception*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Exception*> Org::BouncyCastle::Pkix::PkixAttrCertPathBuilder::__get_certPathException() const {
return ::cordl_internals::getInstanceField<::System::Exception*, 0x10>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::Org::BouncyCastle::Pkix::PkixAttrCertPathBuilder*>());
}
