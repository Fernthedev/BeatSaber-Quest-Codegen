...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xa0 - sizeof(::Org::BouncyCastle::Pkix::PkixParameters)]{};

/// @brief Field maxPathLength offset 0x90
 __declspec(property(get=__get_maxPathLength, put=__set_maxPathLength)) int32_t  maxPathLength;

/// @brief Field excludedCerts offset 0x98
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_excludedCerts() const;
