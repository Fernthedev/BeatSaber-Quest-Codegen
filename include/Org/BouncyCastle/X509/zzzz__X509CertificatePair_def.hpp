...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::X509::X509Certificate*> __get_forward() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::X509::X509Certificate*> __get_reverse() const;
...
/// @brief Method .ctor addr 0x1179d04 size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0x1179d30 size 0xa8 virtual false final false
inline void _ctor(::Org::BouncyCastle::Asn1::X509::CertificatePair*  pair) ;

/// @brief Method GetEncoded addr 0x1179dd8 size 0x270 virtual false final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetEncoded() ;

/// @brief Method get_Forward addr 0x117a048 size 0x8 virtual false final false
inline ::Org::BouncyCastle::X509::X509Certificate* get_Forward() ;

/// @brief Method get_Reverse addr 0x117a050 size 0x8 virtual false final false
inline ::Org::BouncyCastle::X509::X509Certificate* get_Reverse() ;

/// @brief Method Equals addr 0x117a058 size 0xc0 virtual true final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode addr 0x117a118 size 0x50 virtual true final false
