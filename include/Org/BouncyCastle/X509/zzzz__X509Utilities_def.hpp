...
/// @brief Method CreatePssParams addr 0x11818e8 size 0x12c virtual false final false
...
/// @brief Method GetAlgorithmOid addr 0x1181a14 size 0x20c virtual false final false
static inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* GetAlgorithmOid(::StringW  algorithmName) ;

/// @brief Method GetSigAlgID addr 0x1181c20 size 0x330 virtual false final false
...
/// @brief Method GetAlgNames addr 0x1181f50 size 0x10c virtual false final false
static inline ::System::Collections::IEnumerable* GetAlgNames() ;

/// @brief Method GetSignatureForObject addr 0x118205c size 0x2d0 virtual false final false
...
/// @brief Method .ctor addr 0x118232c size 0x8 virtual false final false
inline void _ctor() ;
