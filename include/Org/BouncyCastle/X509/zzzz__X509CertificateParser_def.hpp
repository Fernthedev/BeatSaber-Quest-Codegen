...
/// @brief Method ReadDerCertificate addr 0x117a168 size 0x218 virtual false final false
inline ::Org::BouncyCastle::X509::X509Certificate* ReadDerCertificate(::Org::BouncyCastle::Asn1::Asn1InputStream*  dIn) ;

/// @brief Method GetCertificate addr 0x117a380 size 0xe4 virtual false final false
inline ::Org::BouncyCastle::X509::X509Certificate* GetCertificate() ;

/// @brief Method ReadPemCertificate addr 0x117a464 size 0xa8 virtual false final false
inline ::Org::BouncyCastle::X509::X509Certificate* ReadPemCertificate(::System::IO::Stream*  inStream) ;

/// @brief Method CreateX509Certificate addr 0x117a50c size 0x60 virtual true final false
inline ::Org::BouncyCastle::X509::X509Certificate* CreateX509Certificate(::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*  c) ;

/// @brief Method ReadCertificate addr 0x117a56c size 0x78 virtual false final false
inline ::Org::BouncyCastle::X509::X509Certificate* ReadCertificate(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method ReadCertificates addr 0x117a8c8 size 0x78 virtual false final false
inline ::System::Collections::ICollection* ReadCertificates(::ArrayW<uint8_t,::Array<uint8_t>*>  input) ;

/// @brief Method ReadCertificate addr 0x117a5e4 size 0x2e4 virtual false final false
inline ::Org::BouncyCastle::X509::X509Certificate* ReadCertificate(::System::IO::Stream*  inStream) ;

/// @brief Method ReadCertificates addr 0x117a940 size 0x110 virtual false final false
...
/// @brief Method .ctor addr 0x117aae0 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 X509CertificateParser()  = default;
public:


// Fields

// Static field PemCertParser
