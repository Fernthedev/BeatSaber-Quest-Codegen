...
/// @brief Field extGenerator offset 0x10
...
/// @brief Field acInfoGen offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::X509ExtensionsGenerator*> __get_extGenerator() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::V2AttributeCertificateInfoGenerator*> __get_acInfoGen() const;
...
// Ctor Parameters []
// @brief default ctor
 X509V2AttributeCertificateGenerator()  = default;
public:
