...
/// @brief Field certificateChecking offset 0x10
...
/// @brief Field dateAndTime offset 0x18
...
/// @brief Field issuingDistributionPointEnabled offset 0x50
...
/// @brief Field maxBaseCrlNumber offset 0x58
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::X509::X509Certificate*> __get_certificateChecking() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Date::DateTimeObject*> __get_dateAndTime() const;

constexpr void __set_issuers(::System::Collections::ICollection*  value) ;

constexpr ::System::Collections::ICollection* __get_issuers() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::ICollection*> __get_issuers() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::BigInteger*> __get_maxCrlNumber() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::BigInteger*> __get_minCrlNumber() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::X509::IX509AttributeCertificate*> __get_attrCertChecking() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::BigInteger*> __get_maxBaseCrlNumber() const;
