...
/// @brief Field authorityKeyIdentifier offset 0x10
...
/// @brief Field basicConstraints offset 0x18
...
/// @brief Field certificateValid offset 0x28
...
/// @brief Field extendedKeyUsage offset 0x30
...
/// @brief Field subjectPublicKey offset 0x78
...
/// @brief Field subjectPublicKeyAlgID offset 0x80
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::X509::X509Certificate*> __get_certificate() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Date::DateTimeObject*> __get_certificateValid() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_extendedKeyUsage() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::ISet*> __get_policy() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Date::DateTimeObject*> __get_privateKeyValid() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::SubjectPublicKeyInfo*> __get_subjectPublicKey() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::DerObjectIdentifier*> __get_subjectPublicKeyAlgID() const;
