...
/// @brief Field tbsGen offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::V3TbsCertificateGenerator*> __get_tbsGen() const;
...
// Ctor Parameters []
// @brief default ctor
 X509V3CertificateGenerator()  = default;
public:
