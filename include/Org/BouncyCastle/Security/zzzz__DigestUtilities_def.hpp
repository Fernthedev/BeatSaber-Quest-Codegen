...
struct CORDL_TYPE __DigestUtilities__DigestAlgorithm : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____DigestUtilities__DigestAlgorithm_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __DigestUtilities__DigestAlgorithm(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __DigestUtilities__DigestAlgorithm()  = default;
