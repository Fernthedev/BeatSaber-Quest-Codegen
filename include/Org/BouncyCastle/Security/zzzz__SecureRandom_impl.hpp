...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (*)(::Org::BouncyCastle::Security::SecureRandom*, int32_t)>(&::Org::BouncyCastle::Security::SecureRandom::GetNextBytes)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (*)(int32_t)>(&::Org::BouncyCastle::Security::SecureRandom::GetSeed)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Security::SecureRandom::*)(::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::Org::BouncyCastle::Security::SecureRandom::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (::Org::BouncyCastle::Security::SecureRandom::*)(int32_t)>(&::Org::BouncyCastle::Security::SecureRandom::GenerateSeed)> {
  constexpr static std::size_t size = 0x90;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Security::SecureRandom::*)(::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::Org::BouncyCastle::Security::SecureRandom::SetSeed)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Security::SecureRandom::*)(::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::Org::BouncyCastle::Security::SecureRandom::NextBytes)> {
  constexpr static std::size_t size = 0xac;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Security::SecureRandom::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t)>(&::Org::BouncyCastle::Security::SecureRandom::NextBytes)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Prng::IRandomGenerator*, 0x20>(this, std::forward<::Org::BouncyCastle::Crypto::Prng::IRandomGenerator*>(value));
}
constexpr ::Org::BouncyCastle::Crypto::Prng::IRandomGenerator* Org::BouncyCastle::Security::SecureRandom::__get_generator()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Prng::IRandomGenerator*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Prng::IRandomGenerator*> Org::BouncyCastle::Security::SecureRandom::__get_generator() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Prng::IRandomGenerator*, 0x20>(this);
}
