...
struct CORDL_TYPE __WrapperUtilities__WrapAlgorithm : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____WrapperUtilities__WrapAlgorithm_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __WrapperUtilities__WrapAlgorithm(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __WrapperUtilities__WrapAlgorithm()  = default;
...
/// @brief Field forWrapping offset 0x18
...
// Ctor Parameters []
// @brief default ctor
 __WrapperUtilities__BufferedCipherWrapper()  = default;
public:
