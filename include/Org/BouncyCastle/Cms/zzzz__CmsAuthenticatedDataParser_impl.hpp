...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Cms::CmsAuthenticatedDataParser::*)(::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::Org::BouncyCastle::Cms::CmsAuthenticatedDataParser::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (::Org::BouncyCastle::Cms::CmsAuthenticatedDataParser::*)()>(&::Org::BouncyCastle::Cms::CmsAuthenticatedDataParser::GetMac)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Cms::RecipientInformationStore*, 0x20>(this, std::forward<::Org::BouncyCastle::Cms::RecipientInformationStore*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Cms::RecipientInformationStore*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Cms::RecipientInformationStore*> Org::BouncyCastle::Cms::CmsAuthenticatedDataParser::__get__recipientInfoStore() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Cms::RecipientInformationStore*, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Asn1::Cms::AuthenticatedDataParser*, 0x28>(this, std::forward<::Org::BouncyCastle::Asn1::Cms::AuthenticatedDataParser*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::AuthenticatedDataParser*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::AuthenticatedDataParser*> Org::BouncyCastle::Cms::CmsAuthenticatedDataParser::__get_authData() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::AuthenticatedDataParser*, 0x28>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*> Org::BouncyCastle::Cms::CmsAuthenticatedDataParser::__get_macAlg() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*, 0x30>(this);
}
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Asn1::Cms::AttributeTable*, 0x40>(this, std::forward<::Org::BouncyCastle::Asn1::Cms::AttributeTable*>(value));
}
constexpr ::Org::BouncyCastle::Asn1::Cms::AttributeTable* Org::BouncyCastle::Cms::CmsAuthenticatedDataParser::__get_authAttrs()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::AttributeTable*, 0x40>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::AttributeTable*> Org::BouncyCastle::Cms::CmsAuthenticatedDataParser::__get_authAttrs() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::AttributeTable*, 0x40>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::AttributeTable*> Org::BouncyCastle::Cms::CmsAuthenticatedDataParser::__get_unauthAttrs() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::AttributeTable*, 0x48>(this);
}
