...
/// @brief Method find addr 0x11ed328 size 0x264 virtual false final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* find(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  sigAlgId) ;

/// @brief Method find addr 0x11fd360 size 0x19c virtual false final false
...
/// @brief Method .ctor addr 0x11ed320 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 DefaultDigestAlgorithmIdentifierFinder()  = default;
public:
