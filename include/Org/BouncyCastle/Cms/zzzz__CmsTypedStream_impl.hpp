...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Cms::__CmsTypedStream__FullReaderStream::*)(::System::IO::Stream*)>(&::Org::BouncyCastle::Cms::__CmsTypedStream__FullReaderStream::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Org::BouncyCastle::Cms::__CmsTypedStream__FullReaderStream::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t)>(&::Org::BouncyCastle::Cms::__CmsTypedStream__FullReaderStream::Read)> {
...
constexpr ::cordl_internals::to_const_pointer<::System::IO::Stream*> Org::BouncyCastle::Cms::CmsTypedStream::__get__in() const {
return ::cordl_internals::getInstanceField<::System::IO::Stream*, 0x18>(this);
}
