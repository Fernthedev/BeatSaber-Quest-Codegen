...
/// @brief Field contentSigner offset 0x18
...
/// @brief Field isDirectSignature offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::ISignatureFactory*> __get_contentSigner() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::SignerIdentifier*> __get_sigId() const;
