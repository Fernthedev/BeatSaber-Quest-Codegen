...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Asn1::Cms::PasswordRecipientInfo*, 0x30>(this, std::forward<::Org::BouncyCastle::Asn1::Cms::PasswordRecipientInfo*>(value));
}
constexpr ::Org::BouncyCastle::Asn1::Cms::PasswordRecipientInfo* Org::BouncyCastle::Cms::PasswordRecipientInformation::__get_info()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::PasswordRecipientInfo*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::PasswordRecipientInfo*> Org::BouncyCastle::Cms::PasswordRecipientInformation::__get_info() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::PasswordRecipientInfo*, 0x30>(this);
}
