...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Cms::CmsSignedGenerator*> __get_outer() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::ISignatureFactory*> __get_sigCalc() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::SignerIdentifier*> __get_signerIdentifier() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Cms::CmsAttributeTableGenerator*> __get_sAttr() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Cms::CmsAttributeTableGenerator*> __get_unsAttr() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::AttributeTable*> __get_baseSignedTable() const;
...
/// @brief Method .ctor addr 0x11eaf94 size 0x14c virtual false final false
...
/// @brief Method .ctor addr 0x11ead54 size 0x240 virtual false final false
...
/// @brief Method get_DigestAlgorithmID addr 0x11ebfd8 size 0xd4 virtual false final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithmID() ;

/// @brief Method get_SignedAttributes addr 0x11ed58c size 0x8 virtual false final false
inline ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* get_SignedAttributes() ;

/// @brief Method get_UnsignedAttributes addr 0x11ed594 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Cms::CmsAttributeTableGenerator* get_UnsignedAttributes() ;

/// @brief Method ToSignerInfo addr 0x11ec0ac size 0xb58 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __CmsSignedDataGenerator__SignerInf()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::Org::BouncyCastle::Cms::CmsSignedGenerator)]{};

/// @brief Field signerInfs offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> __get_signerInfs() const;

static inline ::Org::BouncyCastle::Cms::CmsSignedDataGenerator* New_ctor() ;

/// @brief Method .ctor addr 0x11e9ac8 size 0x84 virtual false final false
inline void _ctor() ;

static inline ::Org::BouncyCastle::Cms::CmsSignedDataGenerator* New_ctor(::Org::BouncyCastle::Security::SecureRandom*  rand) ;

/// @brief Method .ctor addr 0x11e9b4c size 0x94 virtual false final false
inline void _ctor(::Org::BouncyCastle::Security::SecureRandom*  rand) ;

/// @brief Method AddSigner addr 0x11e9be0 size 0xa0 virtual false final false
...
/// @brief Method AddSigner addr 0x11ea160 size 0xd8 virtual false final false
...
/// @brief Method AddSigner addr 0x11ea3d4 size 0xa0 virtual false final false
...
/// @brief Method AddSigner addr 0x11ea474 size 0xd8 virtual false final false
...
/// @brief Method AddSigner addr 0x11ea54c size 0xb8 virtual false final false
...
/// @brief Method AddSigner addr 0x11ea604 size 0x11c virtual false final false
...
/// @brief Method AddSigner addr 0x11ea7a0 size 0xb8 virtual false final false
...
/// @brief Method AddSigner addr 0x11ea858 size 0x11c virtual false final false
...
/// @brief Method AddSigner addr 0x11ea974 size 0xb8 virtual false final false
...
/// @brief Method AddSigner addr 0x11eaa2c size 0xb4 virtual false final false
...
/// @brief Method AddSigner addr 0x11eaae0 size 0xb8 virtual false final false
...
/// @brief Method AddSigner addr 0x11eab98 size 0xb4 virtual false final false
...
/// @brief Method AddSignerInfoGenerator addr 0x11eac4c size 0x108 virtual false final false
inline void AddSignerInfoGenerator(::Org::BouncyCastle::Cms::SignerInfoGenerator*  signerInfoGenerator) ;

/// @brief Method doAddSigner addr 0x11ea2a0 size 0x134 virtual false final false
...
/// @brief Method Generate addr 0x11eb0e0 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Cms::CmsSignedData* Generate(::Org::BouncyCastle::Cms::CmsProcessable*  content) ;

/// @brief Method Generate addr 0x11eb160 size 0xe78 virtual false final false
...
/// @brief Method Generate addr 0x11eb0e8 size 0x78 virtual false final false
inline ::Org::BouncyCastle::Cms::CmsSignedData* Generate(::Org::BouncyCastle::Cms::CmsProcessable*  content, bool  encapsulate) ;

/// @brief Method GenerateCounterSigners addr 0x11ecf94 size 0x8c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 CmsSignedDataGenerator()  = default;
public:
