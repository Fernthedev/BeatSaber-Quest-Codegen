...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Cms::CmsEnvelopedDataParser::*)(::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::Org::BouncyCastle::Cms::CmsEnvelopedDataParser::_ctor)> {
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Cms::RecipientInformationStore*> Org::BouncyCastle::Cms::CmsEnvelopedDataParser::__get_recipientInfoStore() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Cms::RecipientInformationStore*, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Asn1::Cms::EnvelopedDataParser*, 0x28>(this, std::forward<::Org::BouncyCastle::Asn1::Cms::EnvelopedDataParser*>(value));
}
constexpr ::Org::BouncyCastle::Asn1::Cms::EnvelopedDataParser* Org::BouncyCastle::Cms::CmsEnvelopedDataParser::__get_envelopedData()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::EnvelopedDataParser*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::EnvelopedDataParser*> Org::BouncyCastle::Cms::CmsEnvelopedDataParser::__get_envelopedData() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::EnvelopedDataParser*, 0x28>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*> Org::BouncyCastle::Cms::CmsEnvelopedDataParser::__get__encAlg() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*, 0x30>(this);
}
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Asn1::Cms::AttributeTable*, 0x38>(this, std::forward<::Org::BouncyCastle::Asn1::Cms::AttributeTable*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::AttributeTable*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::AttributeTable*> Org::BouncyCastle::Cms::CmsEnvelopedDataParser::__get__unprotectedAttributes() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::AttributeTable*, 0x38>(this);
}
