...
/// @brief Field _outer offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Cms::CmsEnvelopedGenerator*> __get__outer() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::IO::CipherStream*> __get__out() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::BerSequenceGenerator*> __get__envGen() const;
...
// Ctor Parameters []
// @brief default ctor
 __CmsEnvelopedDataStreamGenerator__CmsEnvelopedDataOutputStream()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::Org::BouncyCastle::Cms::CmsEnvelopedGenerator)]{};

/// @brief Field _originatorInfo offset 0x28
 __declspec(property(get=__get__originatorInfo, put=__set__originatorInfo)) ::System::Object*  _originatorInfo;

/// @brief Field _unprotectedAttributes offset 0x30
...
/// @brief Field _berEncodeRecipientSet offset 0x3c
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__originatorInfo() const;

constexpr void __set__unprotectedAttributes(::System::Object*  value) ;

constexpr ::System::Object* __get__unprotectedAttributes() ;

constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__unprotectedAttributes() const;
...
// Ctor Parameters []
// @brief default ctor
 CmsEnvelopedDataStreamGenerator()  = default;
public:
