...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Asn1::Cms::OriginatorInfo*, 0x10>(this, std::forward<::Org::BouncyCastle::Asn1::Cms::OriginatorInfo*>(value));
}
constexpr ::Org::BouncyCastle::Asn1::Cms::OriginatorInfo* Org::BouncyCastle::Cms::OriginatorInformation::__get_originatorInfo()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::OriginatorInfo*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::OriginatorInfo*> Org::BouncyCastle::Cms::OriginatorInformation::__get_originatorInfo() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::OriginatorInfo*, 0x10>(this);
}
