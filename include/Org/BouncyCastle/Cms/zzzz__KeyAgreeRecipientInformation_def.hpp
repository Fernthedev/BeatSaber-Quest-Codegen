...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::Org::BouncyCastle::Cms::RecipientInformation)]{};
...
/// @brief Field encryptedKey offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::KeyAgreeRecipientInfo*> __get_info() const;
...
// Ctor Parameters []
// @brief default ctor
 KeyAgreeRecipientInformation()  = default;
public:
