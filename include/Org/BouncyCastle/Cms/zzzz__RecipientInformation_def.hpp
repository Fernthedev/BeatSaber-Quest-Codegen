...
/// @brief Field resultMac offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Cms::RecipientID*> __get_rid() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*> __get_keyEncAlg() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Cms::CmsSecureReadable*> __get_secureReadable() const;
