...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Asn1::Cms::KekRecipientInfo*, 0x30>(this, std::forward<::Org::BouncyCastle::Asn1::Cms::KekRecipientInfo*>(value));
}
constexpr ::Org::BouncyCastle::Asn1::Cms::KekRecipientInfo* Org::BouncyCastle::Cms::KekRecipientInformation::__get_info()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::KekRecipientInfo*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::KekRecipientInfo*> Org::BouncyCastle::Cms::KekRecipientInformation::__get_info() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Cms::KekRecipientInfo*, 0x30>(this);
}
