...
/// @brief Field keyAgreementOID offset 0x10
...
/// @brief Field keyEncryptionOID offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::DerObjectIdentifier*> __get_keyAgreementOID() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::DerObjectIdentifier*> __get_keyEncryptionOID() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> __get_recipientCerts() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair*> __get_senderKeyPair() const;
...
// Ctor Parameters []
// @brief default ctor
 KeyAgreeRecipientInfoGenerator()  = default;
public:
