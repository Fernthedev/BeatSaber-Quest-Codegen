...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::X25519PrivateKeyParameters*> __get_privateKey() const;

/// @brief Method Init addr 0x121d1f0 size 0x74 virtual true final true
inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method get_AgreementSize addr 0x121d264 size 0x58 virtual true final true
inline int32_t get_AgreementSize() ;

/// @brief Method CalculateAgreement addr 0x121d2bc size 0x8c virtual true final true
...
/// @brief Method .ctor addr 0x121d348 size 0x8 virtual false final false
inline void _ctor() ;
