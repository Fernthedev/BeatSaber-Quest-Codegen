...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Agreement::X448Agreement::*)(::Org::BouncyCastle::Crypto::ICipherParameters*, ::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t)>(&::Org::BouncyCastle::Crypto::Agreement::X448Agreement::CalculateAgreement)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Parameters::X448PrivateKeyParameters*, 0x10>(this, std::forward<::Org::BouncyCastle::Crypto::Parameters::X448PrivateKeyParameters*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::X448PrivateKeyParameters*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::X448PrivateKeyParameters*> Org::BouncyCastle::Crypto::Agreement::X448Agreement::__get_privateKey() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::X448PrivateKeyParameters*, 0x10>(this);
}
