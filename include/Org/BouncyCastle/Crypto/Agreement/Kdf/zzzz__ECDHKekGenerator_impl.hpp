...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Org::BouncyCastle::Crypto::Agreement::Kdf::ECDHKekGenerator::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t)>(&::Org::BouncyCastle::Crypto::Agreement::Kdf::ECDHKekGenerator::GenerateBytes)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::IDerivationFunction*, 0x10>(this, std::forward<::Org::BouncyCastle::Crypto::IDerivationFunction*>(value));
}
constexpr ::Org::BouncyCastle::Crypto::IDerivationFunction* Org::BouncyCastle::Crypto::Agreement::Kdf::ECDHKekGenerator::__get_kdf()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::IDerivationFunction*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::IDerivationFunction*> Org::BouncyCastle::Crypto::Agreement::Kdf::ECDHKekGenerator::__get_kdf() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::IDerivationFunction*, 0x10>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::DerObjectIdentifier*> Org::BouncyCastle::Crypto::Agreement::Kdf::ECDHKekGenerator::__get_algorithm() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::DerObjectIdentifier*, 0x18>(this);
}
