...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::IO::MacSink::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t)>(&::Org::BouncyCastle::Crypto::IO::MacSink::Write)> {
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::IMac*> Org::BouncyCastle::Crypto::IO::MacSink::__get_mMac() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::IMac*, 0x30>(this);
}
