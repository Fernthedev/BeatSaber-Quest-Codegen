...
/// @brief Field cipher offset 0x10
 __declspec(property(get=__get_cipher, put=__set_cipher)) ::Org::BouncyCastle::Crypto::IStreamCipher*  cipher;

 __declspec(property(get=get_AlgorithmName)) ::StringW  AlgorithmName;

constexpr void __set_cipher(::Org::BouncyCastle::Crypto::IStreamCipher*  value) ;

constexpr ::Org::BouncyCastle::Crypto::IStreamCipher* __get_cipher() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::IStreamCipher*> __get_cipher() const;

static inline ::Org::BouncyCastle::Crypto::BufferedStreamCipher* New_ctor(::Org::BouncyCastle::Crypto::IStreamCipher*  cipher) ;

/// @brief Method .ctor addr 0xfc4eb8 size 0xbc virtual false final false
inline void _ctor(::Org::BouncyCastle::Crypto::IStreamCipher*  cipher) ;

/// @brief Method get_AlgorithmName addr 0xfc4f74 size 0xa0 virtual true final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xfc5014 size 0x104 virtual true final false
inline void Init(bool  forEncryption, ::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method GetBlockSize addr 0xfc5118 size 0x8 virtual true final false
inline int32_t GetBlockSize() ;

/// @brief Method GetOutputSize addr 0xfc5120 size 0x8 virtual true final false
inline int32_t GetOutputSize(int32_t  inputLen) ;

/// @brief Method GetUpdateOutputSize addr 0xfc5128 size 0x8 virtual true final false
inline int32_t GetUpdateOutputSize(int32_t  inputLen) ;

/// @brief Method ProcessByte addr 0xfc5130 size 0xf4 virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ProcessByte(uint8_t  input) ;

/// @brief Method ProcessByte addr 0xfc5224 size 0x138 virtual true final false
inline int32_t ProcessByte(uint8_t  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method ProcessBytes addr 0xfc535c size 0x108 virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> ProcessBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method ProcessBytes addr 0xfc5464 size 0xf4 virtual true final false
...
/// @brief Method DoFinal addr 0xfc5558 size 0x70 virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> DoFinal() ;

/// @brief Method DoFinal addr 0xfc55c8 size 0xb8 virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> DoFinal(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  length) ;

/// @brief Method Reset addr 0xfc5680 size 0xa4 virtual true final false
inline void Reset() ;
