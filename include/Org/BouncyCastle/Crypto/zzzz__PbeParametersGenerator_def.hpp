...
/// @brief Method .ctor addr 0xf02858 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method Init addr 0xf02860 size 0x100 virtual true final false
inline void Init(::ArrayW<uint8_t,::Array<uint8_t>*>  password, ::ArrayW<uint8_t,::Array<uint8_t>*>  salt, int32_t  iterationCount) ;

/// @brief Method get_Password addr 0xf02960 size 0x5c virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Password() ;

/// @brief Method GetPassword addr 0xf029bc size 0xc virtual false final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetPassword() ;

/// @brief Method get_Salt addr 0xf029c8 size 0x5c virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Salt() ;

/// @brief Method GetSalt addr 0xf02a24 size 0xc virtual false final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSalt() ;

/// @brief Method get_IterationCount addr 0xf02a30 size 0x8 virtual true final false
...
/// @brief Method Pkcs5PasswordToBytes addr 0xf02a38 size 0x60 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Pkcs5PasswordToBytes(::ArrayW<char16_t,::Array<char16_t>*>  password) ;

/// @brief Method Pkcs5PasswordToBytes addr 0xf02a98 size 0x60 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Pkcs5PasswordToBytes(::StringW  password) ;

/// @brief Method Pkcs5PasswordToUtf8Bytes addr 0xf02af8 size 0x78 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Pkcs5PasswordToUtf8Bytes(::ArrayW<char16_t,::Array<char16_t>*>  password) ;

/// @brief Method Pkcs5PasswordToUtf8Bytes addr 0xf02b70 size 0x78 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Pkcs5PasswordToUtf8Bytes(::StringW  password) ;

/// @brief Method Pkcs12PasswordToBytes addr 0xf02be8 size 0x8 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> Pkcs12PasswordToBytes(::ArrayW<char16_t,::Array<char16_t>*>  password) ;

/// @brief Method Pkcs12PasswordToBytes addr 0xf02bf0 size 0xbc virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 PbeParametersGenerator()  = default;
public:
