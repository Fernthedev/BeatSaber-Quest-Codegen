...
/// @brief Field mKeyExchange offset 0x10
...
/// @brief Method .ctor addr 0xf5b564 size 0x30 virtual false final false
inline void _ctor(int32_t  keyExchange, ::System::Collections::IList*  supportedSignatureAlgorithms) ;

/// @brief Method ParseSignature addr 0xf5b594 size 0x98 virtual true final false
inline ::Org::BouncyCastle::Crypto::Tls::DigitallySigned* ParseSignature(::System::IO::Stream*  input) ;

/// @brief Method Init addr 0xf5b708 size 0x218 virtual true final false
...
/// @brief Method ProcessServerCertificate addr 0xf5b920 size 0x4 virtual true final false
inline void ProcessServerCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate*  serverCertificate) ;

/// @brief Method ProcessServerCredentials addr 0xf5b924 size 0xb8 virtual true final false
inline void ProcessServerCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials*  serverCredentials) ;

/// @brief Method get_RequiresServerKeyExchange addr 0xf5b9dc size 0x8 virtual true final false
inline bool get_RequiresServerKeyExchange() ;

/// @brief Method GenerateServerKeyExchange addr 0xf5b9e4 size 0x64 virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateServerKeyExchange() ;

/// @brief Method SkipServerKeyExchange addr 0xf5ba48 size 0x60 virtual true final false
inline void SkipServerKeyExchange() ;

/// @brief Method ProcessServerKeyExchange addr 0xf5baa8 size 0x60 virtual true final false
...
/// @brief Method SkipClientCredentials addr 0xf5bb08 size 0x4 virtual true final false
...
/// @brief Method ProcessClientCertificate addr 0xf5bb0c size 0x4 virtual true final false
...
/// @brief Method ProcessClientKeyExchange addr 0xf5bb10 size 0x44 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 AbstractTlsKeyExchange()  = default;
public:
