...
/// @brief Field secret offset 0x18
...
/// @brief Method .ctor addr 0xfae054 size 0x404 virtual false final false
...
/// @brief Method get_MacSecret addr 0xfae504 size 0x8 virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_MacSecret() ;

/// @brief Method get_Size addr 0xfae50c size 0x8 virtual true final false
inline int32_t get_Size() ;

/// @brief Method CalculateMac addr 0xfae514 size 0x2f4 virtual true final false
...
/// @brief Method CalculateMacConstantTime addr 0xfae9dc size 0x284 virtual true final false
...
/// @brief Method GetDigestBlockCount addr 0xfaec60 size 0x10 virtual true final false
inline int32_t GetDigestBlockCount(int32_t  inputLength) ;

/// @brief Method Truncate addr 0xfaec70 size 0x88 virtual true final false
