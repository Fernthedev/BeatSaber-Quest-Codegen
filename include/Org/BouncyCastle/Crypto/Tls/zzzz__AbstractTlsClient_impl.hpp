...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Org::BouncyCastle::Crypto::Tls::AbstractTlsClient::*)(int32_t, ::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::Org::BouncyCastle::Crypto::Tls::AbstractTlsClient::AllowUnexpectedServerExtension)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<int32_t,::Array<int32_t>*> (::Org::BouncyCastle::Crypto::Tls::AbstractTlsClient::*)()>(&::Org::BouncyCastle::Crypto::Tls::AbstractTlsClient::GetCipherSuites)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (::Org::BouncyCastle::Crypto::Tls::AbstractTlsClient::*)()>(&::Org::BouncyCastle::Crypto::Tls::AbstractTlsClient::GetCompressionMethods)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::AbstractTlsClient::*)(::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::Org::BouncyCastle::Crypto::Tls::AbstractTlsClient::NotifySessionID)> {
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsCipherFactory*> Org::BouncyCastle::Crypto::Tls::AbstractTlsClient::__get_mCipherFactory() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::TlsCipherFactory*, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Tls::TlsClientContext*, 0x20>(this, std::forward<::Org::BouncyCastle::Crypto::Tls::TlsClientContext*>(value));
}
constexpr ::Org::BouncyCastle::Crypto::Tls::TlsClientContext* Org::BouncyCastle::Crypto::Tls::AbstractTlsClient::__get_mContext()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::TlsClientContext*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsClientContext*> Org::BouncyCastle::Crypto::Tls::AbstractTlsClient::__get_mContext() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::TlsClientContext*, 0x20>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> Org::BouncyCastle::Crypto::Tls::AbstractTlsClient::__get_mSupportedSignatureAlgorithms() const {
return ::cordl_internals::getInstanceField<::System::Collections::IList*, 0x28>(this);
}
...
::cordl_internals::setInstanceField<int16_t, 0x4c>(this, std::forward<int16_t>(value));
}
constexpr int16_t& Org::BouncyCastle::Crypto::Tls::AbstractTlsClient::__get_mSelectedCompressionMethod()  {
return ::cordl_internals::getInstanceField<int16_t, 0x4c>(this);
}
