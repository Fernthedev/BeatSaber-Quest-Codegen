...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::UserMappingType::*)()>(&::Org::BouncyCastle::Crypto::Tls::UserMappingType::_ctor)> {
