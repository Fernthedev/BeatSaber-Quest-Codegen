...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x68 - sizeof(::Org::BouncyCastle::Crypto::Tls::AbstractTlsKeyExchange)]{};
...
/// @brief Field mServerECPointFormats offset 0x40
...
/// @brief Field mServerPublicKey offset 0x48
...
/// @brief Field mAgreementCredentials offset 0x50
...
/// @brief Field mECAgreePrivateKey offset 0x58
...
/// @brief Field mECAgreePublicKey offset 0x60
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::ECPrivateKeyParameters*> __get_mECAgreePrivateKey() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters*> __get_mECAgreePublicKey() const;
...
/// @brief Method .ctor addr 0xfa9f1c size 0x140 virtual false final false
...
/// @brief Method Init addr 0xfaa06c size 0xc0 virtual true final false
inline void Init(::Org::BouncyCastle::Crypto::Tls::TlsContext*  context) ;

/// @brief Method SkipServerCredentials addr 0xfaa12c size 0x54 virtual true final false
inline void SkipServerCredentials() ;

/// @brief Method ProcessServerCertificate addr 0xfaa1c0 size 0x3b0 virtual true final false
inline void ProcessServerCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate*  serverCertificate) ;

/// @brief Method get_RequiresServerKeyExchange addr 0xfaa6ac size 0x2c virtual true final false
inline bool get_RequiresServerKeyExchange() ;

/// @brief Method GenerateServerKeyExchange addr 0xfaa6d8 size 0x164 virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateServerKeyExchange() ;

/// @brief Method ProcessServerKeyExchange addr 0xfaa83c size 0x120 virtual true final false
inline void ProcessServerKeyExchange(::System::IO::Stream*  input) ;

/// @brief Method ValidateCertificateRequest addr 0xfaa9e8 size 0xe0 virtual true final false
inline void ValidateCertificateRequest(::Org::BouncyCastle::Crypto::Tls::CertificateRequest*  certificateRequest) ;

/// @brief Method ProcessClientCredentials addr 0xfaaac8 size 0x114 virtual true final false
inline void ProcessClientCredentials(::Org::BouncyCastle::Crypto::Tls::TlsCredentials*  clientCredentials) ;

/// @brief Method GenerateClientKeyExchange addr 0xfaabdc size 0x110 virtual true final false
inline void GenerateClientKeyExchange(::System::IO::Stream*  output) ;

/// @brief Method ProcessClientCertificate addr 0xfaacec size 0x54 virtual true final false
inline void ProcessClientCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate*  clientCertificate) ;

/// @brief Method ProcessClientKeyExchange addr 0xfaad40 size 0xc8 virtual true final false
inline void ProcessClientKeyExchange(::System::IO::Stream*  input) ;

/// @brief Method GeneratePremasterSecret addr 0xfaae08 size 0x128 virtual true final false
