...
/// @brief Field mServerNameList offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> __get_mServerNameList() const;
