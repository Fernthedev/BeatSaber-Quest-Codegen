...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::TlsSessionImpl::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, ::Org::BouncyCastle::Crypto::Tls::SessionParameters*)>(&::Org::BouncyCastle::Crypto::Tls::TlsSessionImpl::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (::Org::BouncyCastle::Crypto::Tls::TlsSessionImpl::*)()>(&::Org::BouncyCastle::Crypto::Tls::TlsSessionImpl::get_SessionID)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Tls::SessionParameters*, 0x18>(this, std::forward<::Org::BouncyCastle::Crypto::Tls::SessionParameters*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::SessionParameters*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::SessionParameters*> Org::BouncyCastle::Crypto::Tls::TlsSessionImpl::__get_mSessionParameters() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::SessionParameters*, 0x18>(this);
}
