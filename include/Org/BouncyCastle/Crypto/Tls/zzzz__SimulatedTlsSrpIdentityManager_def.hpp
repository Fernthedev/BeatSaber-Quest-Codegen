...
/// @brief Field mVerifierGenerator offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Agreement::Srp::Srp6VerifierGenerator*> __get_mVerifierGenerator() const;
...
// Ctor Parameters []
// @brief default ctor
 SimulatedTlsSrpIdentityManager()  = default;
public:


// Fields

// Static field PREFIX_PASSWORD

// Static field PREFIX_SALT
