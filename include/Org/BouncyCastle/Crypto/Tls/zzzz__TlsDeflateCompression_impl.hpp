...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::__TlsDeflateCompression__DeflateOutputStream::*)(::System::IO::Stream*, ::Org::BouncyCastle::Utilities::Zlib::ZStream*, bool)>(&::Org::BouncyCastle::Crypto::Tls::__TlsDeflateCompression__DeflateOutputStream::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::__TlsDeflateCompression__DeflateOutputStream::*)()>(&::Org::BouncyCastle::Crypto::Tls::__TlsDeflateCompression__DeflateOutputStream::Flush)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Utilities::Zlib::ZStream*, 0x10>(this, std::forward<::Org::BouncyCastle::Utilities::Zlib::ZStream*>(value));
}
constexpr ::Org::BouncyCastle::Utilities::Zlib::ZStream* Org::BouncyCastle::Crypto::Tls::TlsDeflateCompression::__get_zIn()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Utilities::Zlib::ZStream*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Zlib::ZStream*> Org::BouncyCastle::Crypto::Tls::TlsDeflateCompression::__get_zIn() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Utilities::Zlib::ZStream*, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Utilities::Zlib::ZStream*, 0x18>(this, std::forward<::Org::BouncyCastle::Utilities::Zlib::ZStream*>(value));
}
constexpr ::Org::BouncyCastle::Utilities::Zlib::ZStream* Org::BouncyCastle::Crypto::Tls::TlsDeflateCompression::__get_zOut()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Utilities::Zlib::ZStream*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Zlib::ZStream*> Org::BouncyCastle::Crypto::Tls::TlsDeflateCompression::__get_zOut() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Utilities::Zlib::ZStream*, 0x18>(this);
}
