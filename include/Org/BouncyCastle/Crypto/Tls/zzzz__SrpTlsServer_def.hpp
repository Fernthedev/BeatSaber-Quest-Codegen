...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xa8 - sizeof(::Org::BouncyCastle::Crypto::Tls::AbstractTlsServer)]{};

/// @brief Field mSrpIdentityManager offset 0x90
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsSrpIdentityManager*> __get_mSrpIdentityManager() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsSrpLoginParameters*> __get_mLoginParameters() const;
