...
/// @brief Method .ctor addr 0xf68a04 size 0x78 virtual false final false
inline void _ctor(::Org::BouncyCastle::Security::SecureRandom*  secureRandom) ;

/// @brief Method ProcessFinished addr 0xf68a7c size 0x130 virtual true final false
inline void ProcessFinished(::ArrayW<uint8_t,::Array<uint8_t>*>  body, ::ArrayW<uint8_t,::Array<uint8_t>*>  expected_verify_data) ;

/// @brief Method ApplyMaxFragmentLengthExtension addr 0xf68bac size 0xa0 virtual false final false
...
/// @brief Method EvaluateMaxFragmentLengthExtension addr 0xf68c4c size 0xac virtual false final false
...
/// @brief Method GenerateCertificate addr 0xf68cf8 size 0x84 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateCertificate(::Org::BouncyCastle::Crypto::Tls::Certificate*  certificate) ;

/// @brief Method GenerateSupplementalData addr 0xf68d7c size 0x7c virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GenerateSupplementalData(::System::Collections::IList*  supplementalData) ;

/// @brief Method ValidateSelectedCipherSuite addr 0xf68df8 size 0xb4 virtual false final false
