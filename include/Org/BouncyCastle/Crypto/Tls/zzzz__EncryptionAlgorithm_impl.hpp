...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::EncryptionAlgorithm::*)()>(&::Org::BouncyCastle::Crypto::Tls::EncryptionAlgorithm::_ctor)> {
