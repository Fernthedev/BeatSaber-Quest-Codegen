...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::CompressionMethod::*)()>(&::Org::BouncyCastle::Crypto::Tls::CompressionMethod::_ctor)> {
