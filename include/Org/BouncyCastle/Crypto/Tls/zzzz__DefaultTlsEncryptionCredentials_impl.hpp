...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (::Org::BouncyCastle::Crypto::Tls::DefaultTlsEncryptionCredentials::*)(::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::Org::BouncyCastle::Crypto::Tls::DefaultTlsEncryptionCredentials::DecryptPreMasterSecret)> {
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsContext*> Org::BouncyCastle::Crypto::Tls::DefaultTlsEncryptionCredentials::__get_mContext() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::TlsContext*, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Tls::Certificate*, 0x18>(this, std::forward<::Org::BouncyCastle::Crypto::Tls::Certificate*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::Certificate*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::Certificate*> Org::BouncyCastle::Crypto::Tls::DefaultTlsEncryptionCredentials::__get_mCertificate() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::Certificate*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*> Org::BouncyCastle::Crypto::Tls::DefaultTlsEncryptionCredentials::__get_mPrivateKey() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*, 0x20>(this);
}
