...
/// @brief Field NONCE_RFC5288 offset 0x0
static constexpr int32_t  NONCE_RFC5288{static_cast<int32_t>(0x1)};

/// @brief Field NONCE_DRAFT_CHACHA20_POLY1305 offset 0x0
...
/// @brief Field decryptCipher offset 0x28
...
/// @brief Field encryptImplicitNonce offset 0x30
...
/// @brief Field decryptImplicitNonce offset 0x38
...
/// @brief Field nonceMode offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher*> __get_encryptCipher() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Modes::IAeadBlockCipher*> __get_decryptCipher() const;
...
/// @brief Method .ctor addr 0xf98c34 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xf98c3c size 0x4c8 virtual false final false
...
/// @brief Method GetPlaintextLimit addr 0xf99104 size 0x10 virtual true final false
inline int32_t GetPlaintextLimit(int32_t  ciphertextLimit) ;

/// @brief Method EncodePlaintext addr 0xf99114 size 0x574 virtual true final false
...
/// @brief Method DecodeCiphertext addr 0xf99688 size 0x568 virtual true final false
...
/// @brief Method GetAdditionalData addr 0xf99bf0 size 0x160 virtual true final false
