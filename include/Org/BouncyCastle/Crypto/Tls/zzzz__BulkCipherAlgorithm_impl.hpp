...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::BulkCipherAlgorithm::*)()>(&::Org::BouncyCastle::Crypto::Tls::BulkCipherAlgorithm::_ctor)> {
