...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<int32_t,::Array<int32_t>*> (::Org::BouncyCastle::Crypto::Tls::SrpTlsServer::*)()>(&::Org::BouncyCastle::Crypto::Tls::SrpTlsServer::GetCipherSuites)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Tls::TlsSrpIdentityManager*, 0x90>(this, std::forward<::Org::BouncyCastle::Crypto::Tls::TlsSrpIdentityManager*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::TlsSrpIdentityManager*, 0x90>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsSrpIdentityManager*> Org::BouncyCastle::Crypto::Tls::SrpTlsServer::__get_mSrpIdentityManager() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::TlsSrpIdentityManager*, 0x90>(this);
}
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Tls::TlsSrpLoginParameters*, 0xa0>(this, std::forward<::Org::BouncyCastle::Crypto::Tls::TlsSrpLoginParameters*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::TlsSrpLoginParameters*, 0xa0>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsSrpLoginParameters*> Org::BouncyCastle::Crypto::Tls::SrpTlsServer::__get_mLoginParameters() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::TlsSrpLoginParameters*, 0xa0>(this);
}
