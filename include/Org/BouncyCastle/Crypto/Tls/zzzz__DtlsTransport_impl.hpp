...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::DtlsTransport::*)(::Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer*)>(&::Org::BouncyCastle::Crypto::Tls::DtlsTransport::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0xf90bec;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Org::BouncyCastle::Crypto::Tls::DtlsTransport::*)()>(&::Org::BouncyCastle::Crypto::Tls::DtlsTransport::GetReceiveLimit)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0xf90c14;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Org::BouncyCastle::Crypto::Tls::DtlsTransport::*)()>(&::Org::BouncyCastle::Crypto::Tls::DtlsTransport::GetSendLimit)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0xf90c38;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Org::BouncyCastle::Crypto::Tls::DtlsTransport::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t, int32_t)>(&::Org::BouncyCastle::Crypto::Tls::DtlsTransport::Receive)> {
  constexpr static std::size_t size = 0x39c;
  constexpr static std::size_t addrs = 0xf90c5c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::DtlsTransport::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t)>(&::Org::BouncyCastle::Crypto::Tls::DtlsTransport::Send)> {
  constexpr static std::size_t size = 0x348;
  constexpr static std::size_t addrs = 0xf90ff8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Tls::DtlsTransport::*)()>(&::Org::BouncyCastle::Crypto::Tls::DtlsTransport::Close)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0xf91340;
...
constexpr void Org::BouncyCastle::Crypto::Tls::DtlsTransport::__set_mRecordLayer(::Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer*  value)  {
...
constexpr ::Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer* Org::BouncyCastle::Crypto::Tls::DtlsTransport::__get_mRecordLayer()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer*> Org::BouncyCastle::Crypto::Tls::DtlsTransport::__get_mRecordLayer() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::DtlsRecordLayer*, 0x10>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::Org::BouncyCastle::Crypto::Tls::DtlsTransport*>(recordLayer));
}
