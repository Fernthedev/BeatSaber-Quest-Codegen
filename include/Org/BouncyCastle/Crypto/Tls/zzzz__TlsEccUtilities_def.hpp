...
/// @brief Method AddSupportedEllipticCurvesExtension addr 0xfa7078 size 0x120 virtual false final false
...
/// @brief Method AddSupportedPointFormatsExtension addr 0xfa7240 size 0x120 virtual false final false
...
/// @brief Method GetSupportedEllipticCurvesExtension addr 0xfa7418 size 0x9c virtual false final false
static inline ::ArrayW<int32_t,::Array<int32_t>*> GetSupportedEllipticCurvesExtension(::System::Collections::IDictionary*  extensions) ;

/// @brief Method GetSupportedPointFormatsExtension addr 0xfa7604 size 0x9c virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSupportedPointFormatsExtension(::System::Collections::IDictionary*  extensions) ;

/// @brief Method CreateSupportedEllipticCurvesExtension addr 0xfa7198 size 0xa8 virtual false final false
...
/// @brief Method CreateSupportedPointFormatsExtension addr 0xfa7360 size 0xb8 virtual false final false
...
/// @brief Method ReadSupportedEllipticCurvesExtension addr 0xfa74b4 size 0x150 virtual false final false
...
/// @brief Method ReadSupportedPointFormatsExtension addr 0xfa76a0 size 0xe0 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadSupportedPointFormatsExtension(::ArrayW<uint8_t,::Array<uint8_t>*>  extensionData) ;

/// @brief Method GetNameOfNamedCurve addr 0xfa7780 size 0xa4 virtual false final false
static inline ::StringW GetNameOfNamedCurve(int32_t  namedCurve) ;

/// @brief Method GetParametersForNamedCurve addr 0xfa78a4 size 0x12c virtual false final false
static inline ::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters* GetParametersForNamedCurve(int32_t  namedCurve) ;

/// @brief Method HasAnySupportedNamedCurves addr 0xfa79d0 size 0x6c virtual false final false
static inline bool HasAnySupportedNamedCurves() ;

/// @brief Method ContainsEccCipherSuites addr 0xfa7a3c size 0xb0 virtual false final false
static inline bool ContainsEccCipherSuites(::ArrayW<int32_t,::Array<int32_t>*>  cipherSuites) ;

/// @brief Method IsEccCipherSuite addr 0xfa7aec size 0x8c virtual false final false
static inline bool IsEccCipherSuite(int32_t  cipherSuite) ;

/// @brief Method AreOnSameCurve addr 0xfa7b78 size 0x14 virtual false final false
...
/// @brief Method IsSupportedNamedCurve addr 0xfa7824 size 0x80 virtual false final false
static inline bool IsSupportedNamedCurve(int32_t  namedCurve) ;

/// @brief Method IsCompressionPreferred addr 0xfa7b8c size 0x58 virtual false final false
static inline bool IsCompressionPreferred(::ArrayW<uint8_t,::Array<uint8_t>*>  ecPointFormats, uint8_t  compressionFormat) ;

/// @brief Method SerializeECFieldElement addr 0xfa7be4 size 0x1c virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> SerializeECFieldElement(int32_t  fieldSize, ::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method SerializeECPoint addr 0xfa7c00 size 0xd4 virtual false final false
...
/// @brief Method SerializeECPublicKey addr 0xfa7cd4 size 0x68 virtual false final false
...
/// @brief Method DeserializeECFieldElement addr 0xfa7d3c size 0xcc virtual false final false
...
/// @brief Method DeserializeECPoint addr 0xfa7e08 size 0x130 virtual false final false
...
/// @brief Method DeserializeECPublicKey addr 0xfa7f38 size 0x180 virtual false final false
...
/// @brief Method CalculateECDHBasicAgreement addr 0xfa80b8 size 0xac virtual false final false
...
/// @brief Method GenerateECKeyPair addr 0xfa8164 size 0xb4 virtual false final false
...
/// @brief Method GenerateEphemeralClientKeyExchange addr 0xfa8218 size 0x128 virtual false final false
...
/// @brief Method GenerateEphemeralServerKeyExchange addr 0xfa83e4 size 0x22c virtual false final false
...
/// @brief Method ValidateECPublicKey addr 0xfa8bcc size 0x4 virtual false final false
...
/// @brief Method ReadECExponent addr 0xfa8bd0 size 0xdc virtual false final false
static inline int32_t ReadECExponent(int32_t  fieldSize, ::System::IO::Stream*  input) ;

/// @brief Method ReadECFieldElement addr 0xfa8d4c size 0x9c virtual false final false
static inline ::Org::BouncyCastle::Math::BigInteger* ReadECFieldElement(int32_t  fieldSize, ::System::IO::Stream*  input) ;

/// @brief Method ReadECParameter addr 0xfa8cac size 0xa0 virtual false final false
static inline ::Org::BouncyCastle::Math::BigInteger* ReadECParameter(::System::IO::Stream*  input) ;

/// @brief Method ReadECParameters addr 0xfa8de8 size 0x6a8 virtual false final false
...
/// @brief Method CheckNamedCurve addr 0xfa9490 size 0xac virtual false final false
static inline void CheckNamedCurve(::ArrayW<int32_t,::Array<int32_t>*>  namedCurves, int32_t  namedCurve) ;

/// @brief Method WriteECExponent addr 0xfa953c size 0x9c virtual false final false
static inline void WriteECExponent(int32_t  k, ::System::IO::Stream*  output) ;

/// @brief Method WriteECFieldElement addr 0xfa9654 size 0x84 virtual false final false
static inline void WriteECFieldElement(::Org::BouncyCastle::Math::EC::ECFieldElement*  x, ::System::IO::Stream*  output) ;

/// @brief Method WriteECFieldElement addr 0xfa96d8 size 0xb8 virtual false final false
static inline void WriteECFieldElement(int32_t  fieldSize, ::Org::BouncyCastle::Math::BigInteger*  x, ::System::IO::Stream*  output) ;

/// @brief Method WriteECParameter addr 0xfa95d8 size 0x7c virtual false final false
static inline void WriteECParameter(::Org::BouncyCastle::Math::BigInteger*  x, ::System::IO::Stream*  output) ;

/// @brief Method WriteExplicitECParameters addr 0xfa8610 size 0x4f0 virtual false final false
...
/// @brief Method WriteECPoint addr 0xfa8340 size 0xa4 virtual false final false
...
/// @brief Method WriteNamedECParameters addr 0xfa8b00 size 0xcc virtual false final false
...
/// @brief Method .ctor addr 0xfa9f14 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 TlsEccUtilities()  = default;
public:


// Fields

// Static field CurveNames
