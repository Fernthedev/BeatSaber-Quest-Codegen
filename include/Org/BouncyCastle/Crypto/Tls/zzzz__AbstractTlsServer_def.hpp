...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x90 - sizeof(::Org::BouncyCastle::Crypto::Tls::AbstractTlsPeer)]{};

/// @brief Field mCipherFactory offset 0x18
...
/// @brief Field mContext offset 0x20
...
/// @brief Field mOfferedCipherSuites offset 0x30
...
/// @brief Field mOfferedCompressionMethods offset 0x38
...
/// @brief Field mClientExtensions offset 0x40
...
/// @brief Field mServerECPointFormats offset 0x70
...
/// @brief Field mServerVersion offset 0x78
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsCipherFactory*> __get_mCipherFactory() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsServerContext*> __get_mContext() const;
