...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::ISigner*> __get_s() const;
...
// Ctor Parameters []
// @brief default ctor
 __SignerInputBuffer__SigStream()  = default;
public:
