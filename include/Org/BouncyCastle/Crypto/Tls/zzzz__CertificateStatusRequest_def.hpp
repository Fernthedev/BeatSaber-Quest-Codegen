...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get_mRequest() const;
...
// Ctor Parameters []
// @brief default ctor
 CertificateStatusRequest()  = default;
public:
