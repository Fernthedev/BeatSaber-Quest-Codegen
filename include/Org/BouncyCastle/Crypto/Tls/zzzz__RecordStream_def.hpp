...
/// @brief Field mOuter offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::RecordStream*> __get_mOuter() const;
...
// Ctor Parameters []
// @brief default ctor
 __RecordStream__HandshakeHashUpdateStream()  = default;
public:
...
/// @brief Field exhausted offset 0x18
...
// Ctor Parameters []
// @brief default ctor
 __RecordStream__SequenceNumber()  = default;
public:
...
/// @brief Field mReadCompression offset 0x30
...
/// @brief Field mWriteCompression offset 0x38
...
/// @brief Field mPendingCipher offset 0x40
...
/// @brief Field mWriteSeqNo offset 0x60
...
/// @brief Field mHandshakeHashUpdater offset 0x78
...
/// @brief Field mReadVersion offset 0x80
...
/// @brief Field mWriteVersion offset 0x88
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsProtocol*> __get_mHandler() const;

constexpr void __set_mInput(::System::IO::Stream*  value) ;

constexpr ::System::IO::Stream* __get_mInput() ;

constexpr ::cordl_internals::to_const_pointer<::System::IO::Stream*> __get_mInput() const;

constexpr void __set_mOutput(::System::IO::Stream*  value) ;

constexpr ::System::IO::Stream* __get_mOutput() ;

constexpr ::cordl_internals::to_const_pointer<::System::IO::Stream*> __get_mOutput() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsCompression*> __get_mPendingCompression() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsCompression*> __get_mReadCompression() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsCompression*> __get_mWriteCompression() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsCipher*> __get_mPendingCipher() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsCipher*> __get_mReadCipher() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsCipher*> __get_mWriteCipher() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::__RecordStream__SequenceNumber*> __get_mReadSeqNo() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::__RecordStream__SequenceNumber*> __get_mWriteSeqNo() const;

constexpr void __set_mBuffer(::System::IO::MemoryStream*  value) ;

constexpr ::System::IO::MemoryStream* __get_mBuffer() ;

constexpr ::cordl_internals::to_const_pointer<::System::IO::MemoryStream*> __get_mBuffer() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::IO::BaseOutputStream*> __get_mHandshakeHashUpdater() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::ProtocolVersion*> __get_mReadVersion() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::ProtocolVersion*> __get_mWriteVersion() const;
