...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x50 - sizeof(::Org::BouncyCastle::Crypto::Tls::AbstractTlsPeer)]{};
...
/// @brief Field mSupportedSignatureAlgorithms offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsClientContext*> __get_mContext() const;
