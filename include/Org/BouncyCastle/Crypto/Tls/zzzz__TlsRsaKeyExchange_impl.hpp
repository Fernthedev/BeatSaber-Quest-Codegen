...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (::Org::BouncyCastle::Crypto::Tls::TlsRsaKeyExchange::*)()>(&::Org::BouncyCastle::Crypto::Tls::TlsRsaKeyExchange::GeneratePremasterSecret)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*, 0x28>(this, std::forward<::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*> Org::BouncyCastle::Crypto::Tls::TlsRsaKeyExchange::__get_mServerPublicKey() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::AsymmetricKeyParameter*, 0x28>(this);
}
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Parameters::RsaKeyParameters*, 0x30>(this, std::forward<::Org::BouncyCastle::Crypto::Parameters::RsaKeyParameters*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::RsaKeyParameters*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::RsaKeyParameters*> Org::BouncyCastle::Crypto::Tls::TlsRsaKeyExchange::__get_mRsaServerPublicKey() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::RsaKeyParameters*, 0x30>(this);
}
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Tls::TlsEncryptionCredentials*, 0x38>(this, std::forward<::Org::BouncyCastle::Crypto::Tls::TlsEncryptionCredentials*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::TlsEncryptionCredentials*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsEncryptionCredentials*> Org::BouncyCastle::Crypto::Tls::TlsRsaKeyExchange::__get_mServerCredentials() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Tls::TlsEncryptionCredentials*, 0x38>(this);
}
