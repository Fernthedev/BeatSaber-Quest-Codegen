...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters*> __get_mGroup() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::BigInteger*> __get_mVerifier() const;
...
/// @brief Method .ctor addr 0xfb8a24 size 0x3c virtual false final false
...
/// @brief Method get_Group addr 0xfb8a60 size 0x8 virtual true final false
inline ::Org::BouncyCastle::Crypto::Parameters::Srp6GroupParameters* get_Group() ;

/// @brief Method get_Salt addr 0xfb8a68 size 0x8 virtual true final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> get_Salt() ;

/// @brief Method get_Verifier addr 0xfb8a70 size 0x8 virtual true final false
