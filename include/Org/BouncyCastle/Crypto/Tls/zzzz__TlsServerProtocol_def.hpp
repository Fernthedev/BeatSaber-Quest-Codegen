...
/// @brief Field mKeyExchange offset 0xb8
...
/// @brief Field mServerCredentials offset 0xc0
...
/// @brief Field mCertificateRequest offset 0xc8
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsServer*> __get_mTlsServer() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsServerContextImpl*> __get_mTlsServerContext() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsCredentials*> __get_mServerCredentials() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Tls::TlsHandshakeHash*> __get_mPrepareFinishHash() const;
