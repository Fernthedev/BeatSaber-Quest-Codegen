...
// Ctor Parameters []
// @brief default ctor
 __Ed25519ctxSigner__Buffer()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Signers::__Ed25519ctxSigner__Buffer*> __get_buffer() const;
