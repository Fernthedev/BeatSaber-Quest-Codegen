...
/// @brief Field lookupPowX2 offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> __get_lookupPowX2() const;

/// @brief Method Init addr 0xf1352c size 0x20c virtual true final true
inline void Init(::ArrayW<uint8_t,::Array<uint8_t>*>  x) ;

/// @brief Method ExponentiateX addr 0xf13738 size 0x1b0 virtual true final true
inline void ExponentiateX(int64_t  pow, ::ArrayW<uint8_t,::Array<uint8_t>*>  output) ;

/// @brief Method EnsureAvailable addr 0xf138e8 size 0x268 virtual false final false
inline void EnsureAvailable(int32_t  bit) ;

static inline ::Org::BouncyCastle::Crypto::Modes::Gcm::Tables1kGcmExponentiator* New_ctor() ;

/// @brief Method .ctor addr 0xf13b50 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 Tables1kGcmExponentiator()  = default;
public:
