...
/// @brief Field multiplier offset 0x18
...
/// @brief Field initialAssociatedText offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmMultiplier*> __get_multiplier() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Modes::Gcm::IGcmExponentiator*> __get_exp() const;
