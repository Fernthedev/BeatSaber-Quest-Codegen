...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::Org::BouncyCastle::Crypto::BufferedBlockCipher)]{};
...
/// @brief Method .ctor addr 0xf1b158 size 0x1ac virtual false final false
inline void _ctor(::Org::BouncyCastle::Crypto::IBlockCipher*  cipher) ;

/// @brief Method GetUpdateOutputSize addr 0xf1b304 size 0x38 virtual true final false
inline int32_t GetUpdateOutputSize(int32_t  length) ;

/// @brief Method GetOutputSize addr 0xf1b33c size 0xc virtual true final false
inline int32_t GetOutputSize(int32_t  length) ;

/// @brief Method ProcessByte addr 0xf1b348 size 0x14c virtual true final false
inline int32_t ProcessByte(uint8_t  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff) ;

/// @brief Method ProcessBytes addr 0xf1b494 size 0x340 virtual true final false
...
/// @brief Method DoFinal addr 0xf1b7d4 size 0x5a8 virtual true final false
