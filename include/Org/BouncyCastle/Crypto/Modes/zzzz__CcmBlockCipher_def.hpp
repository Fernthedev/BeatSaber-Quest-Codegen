...
/// @brief Field macBlock offset 0x18
...
/// @brief Field initialAssociatedText offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::ICipherParameters*> __get_keyParam() const;
...
// Ctor Parameters []
// @brief default ctor
 CcmBlockCipher()  = default;
public:


// Fields

// Static field BlockSize
