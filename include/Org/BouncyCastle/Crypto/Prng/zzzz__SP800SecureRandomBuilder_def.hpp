...
/// @brief Field mSecurityStrength offset 0x28
...
// Ctor Parameters []
// @brief default ctor
 __SP800SecureRandomBuilder__HashDrbgProvider()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __SP800SecureRandomBuilder__HMacDrbgProvider()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::IBlockCipher*> __get_mBlockCipher() const;
...
// Ctor Parameters []
// @brief default ctor
 __SP800SecureRandomBuilder__CtrDrbgProvider()  = default;
public:
...
/// @brief Field mEntropyBitsRequired offset 0x2c
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::IEntropySourceProvider*> __get_mEntropySourceProvider() const;
...
// Ctor Parameters []
// @brief default ctor
 SP800SecureRandomBuilder()  = default;
public:
