...
constexpr ::cordl_internals::to_const_pointer<::System::Security::Cryptography::RandomNumberGenerator*> __get_mRng() const;
...
// Ctor Parameters []
// @brief default ctor
 __CryptoApiEntropySourceProvider__CryptoApiEntropySource()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 CryptoApiEntropySourceProvider()  = default;
public:
