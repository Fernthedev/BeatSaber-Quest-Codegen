...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Prng::IRandomGenerator*> __get_generator() const;
...
// Ctor Parameters []
// @brief default ctor
 ReversedWindowGenerator()  = default;
public:
