...
/// @brief Method .ctor addr 0xf10f00 size 0x84 virtual false final false
...
/// @brief Method .ctor addr 0xf10f84 size 0x7c virtual false final false
inline void _ctor(::Org::BouncyCastle::Crypto::Macs::SkeinMac*  mac) ;

/// @brief Method get_AlgorithmName addr 0xf11000 size 0x1b4 virtual true final true
inline ::StringW get_AlgorithmName() ;

/// @brief Method Init addr 0xf111b4 size 0x230 virtual true final true
inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters*  parameters) ;

/// @brief Method GetMacSize addr 0xf113e4 size 0x1c virtual true final true
inline int32_t GetMacSize() ;

/// @brief Method Reset addr 0xf11400 size 0x1c virtual true final true
inline void Reset() ;

/// @brief Method Update addr 0xf1141c size 0x1c virtual true final true
inline void Update(uint8_t  inByte) ;

/// @brief Method BlockUpdate addr 0xf11438 size 0x1c virtual true final true
inline void BlockUpdate(::ArrayW<uint8_t,::Array<uint8_t>*>  input, int32_t  inOff, int32_t  len) ;

/// @brief Method DoFinal addr 0xf11454 size 0x1c virtual true final true
