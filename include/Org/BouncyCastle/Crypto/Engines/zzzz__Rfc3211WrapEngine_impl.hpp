...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (::Org::BouncyCastle::Crypto::Engines::Rfc3211WrapEngine::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t)>(&::Org::BouncyCastle::Crypto::Engines::Rfc3211WrapEngine::Wrap)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (::Org::BouncyCastle::Crypto::Engines::Rfc3211WrapEngine::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t)>(&::Org::BouncyCastle::Crypto::Engines::Rfc3211WrapEngine::Unwrap)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher*, 0x10>(this, std::forward<::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher*>(value));
}
constexpr ::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher* Org::BouncyCastle::Crypto::Engines::Rfc3211WrapEngine::__get_engine()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher*> Org::BouncyCastle::Crypto::Engines::Rfc3211WrapEngine::__get_engine() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Modes::CbcBlockCipher*, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Parameters::ParametersWithIV*, 0x18>(this, std::forward<::Org::BouncyCastle::Crypto::Parameters::ParametersWithIV*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::ParametersWithIV*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::ParametersWithIV*> Org::BouncyCastle::Crypto::Engines::Rfc3211WrapEngine::__get_param() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::ParametersWithIV*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Security::SecureRandom*> Org::BouncyCastle::Crypto::Engines::Rfc3211WrapEngine::__get_rand() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Security::SecureRandom*, 0x28>(this);
}
