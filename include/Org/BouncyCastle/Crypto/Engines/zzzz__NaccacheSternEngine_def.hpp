...
/// @brief Field forEncryption offset 0x10
...
/// @brief Field lookup offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::NaccacheSternKeyParameters*> __get_key() const;
