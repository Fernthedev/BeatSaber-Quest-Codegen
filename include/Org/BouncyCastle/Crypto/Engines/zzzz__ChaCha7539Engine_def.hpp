...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::Org::BouncyCastle::Crypto::Engines::Salsa20Engine)]{};
...
/// @brief Method .ctor addr 0xec8950 size 0x54 virtual false final false
inline void _ctor() ;

/// @brief Method get_AlgorithmName addr 0xec89a4 size 0x40 virtual true final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method get_NonceSize addr 0xec89e4 size 0x8 virtual true final false
inline int32_t get_NonceSize() ;

/// @brief Method AdvanceCounter addr 0xec89ec size 0x84 virtual true final false
inline void AdvanceCounter() ;

/// @brief Method ResetCounter addr 0xec8a70 size 0x2c virtual true final false
inline void ResetCounter() ;

/// @brief Method SetKey addr 0xec8a9c size 0xe8 virtual true final false
inline void SetKey(::ArrayW<uint8_t,::Array<uint8_t>*>  keyBytes, ::ArrayW<uint8_t,::Array<uint8_t>*>  ivBytes) ;

/// @brief Method GenerateKeyStream addr 0xec8b84 size 0x3c virtual true final false
