...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::Org::BouncyCastle::Crypto::Engines::VmpcEngine)]{};

 __declspec(property(get=get_AlgorithmName)) ::StringW  AlgorithmName;

/// @brief Method get_AlgorithmName addr 0xef479c size 0x40 virtual true final false
inline ::StringW get_AlgorithmName() ;

/// @brief Method InitKey addr 0xef47dc size 0x2a4 virtual true final false
...
/// @brief Method .ctor addr 0xef4a80 size 0x14 virtual false final false
inline void _ctor() ;
