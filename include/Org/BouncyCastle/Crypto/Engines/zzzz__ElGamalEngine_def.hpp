...
/// @brief Field bitSize offset 0x24
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::ElGamalKeyParameters*> __get_key() const;
