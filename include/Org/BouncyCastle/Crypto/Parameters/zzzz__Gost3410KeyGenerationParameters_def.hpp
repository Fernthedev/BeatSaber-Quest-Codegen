...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters*> __get_parameters() const;
...
/// @brief Method .ctor addr 0xf35d88 size 0x4c virtual false final false
...
/// @brief Method .ctor addr 0xf35dd4 size 0x3c virtual false final false
...
/// @brief Method get_Parameters addr 0xf35f88 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Crypto::Parameters::Gost3410Parameters* get_Parameters() ;

/// @brief Method get_PublicKeyParamSet addr 0xf35f90 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_PublicKeyParamSet() ;

/// @brief Method LookupParameters addr 0xf35e10 size 0x178 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 Gost3410KeyGenerationParameters()  = default;
public:
