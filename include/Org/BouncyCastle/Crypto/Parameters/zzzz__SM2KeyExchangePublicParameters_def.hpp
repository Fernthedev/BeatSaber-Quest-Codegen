...
/// @brief Field mStaticPublicKey offset 0x10
...
/// @brief Field mEphemeralPublicKey offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters*> __get_mStaticPublicKey() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::ECPublicKeyParameters*> __get_mEphemeralPublicKey() const;
...
// Ctor Parameters []
// @brief default ctor
 SM2KeyExchangePublicParameters()  = default;
public:
