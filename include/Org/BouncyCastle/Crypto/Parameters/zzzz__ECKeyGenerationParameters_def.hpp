...
/// @brief Field domainParams offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::ECDomainParameters*> __get_domainParams() const;
...
// Ctor Parameters []
// @brief default ctor
 ECKeyGenerationParameters()  = default;
public:
