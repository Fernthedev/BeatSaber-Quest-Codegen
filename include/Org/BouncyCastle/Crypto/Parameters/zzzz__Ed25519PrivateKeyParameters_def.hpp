...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::Ed25519PublicKeyParameters*> __get_cachedPublicKey() const;
...
// Ctor Parameters []
// @brief default ctor
 Ed25519PrivateKeyParameters()  = default;
public:
