...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Parameters::DHParameters*, 0x20>(this, std::forward<::Org::BouncyCastle::Crypto::Parameters::DHParameters*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::DHParameters*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::DHParameters*> Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters::__get_parameters() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::DHParameters*, 0x20>(this);
}
