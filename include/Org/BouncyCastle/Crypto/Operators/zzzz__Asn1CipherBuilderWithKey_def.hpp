...
/// @brief Field encKey offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::KeyParameter*> __get_encKey() const;
...
// Ctor Parameters []
// @brief default ctor
 Asn1CipherBuilderWithKey()  = default;
public:
