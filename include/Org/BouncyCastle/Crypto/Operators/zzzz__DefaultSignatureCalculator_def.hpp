...
/// @brief Method .ctor addr 0xf2ccb0 size 0x7c virtual false final false
inline void _ctor(::Org::BouncyCastle::Crypto::ISigner*  signer) ;

/// @brief Method get_Stream addr 0xf2dd04 size 0x8 virtual true final true
inline ::System::IO::Stream* get_Stream() ;

/// @brief Method GetResult addr 0xf2dd0c size 0x84 virtual true final true
...
// Ctor Parameters []
// @brief default ctor
 DefaultSignatureCalculator()  = default;
public:
