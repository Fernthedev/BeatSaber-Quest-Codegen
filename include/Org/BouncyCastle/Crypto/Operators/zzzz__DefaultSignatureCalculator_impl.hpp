...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Object* (::Org::BouncyCastle::Crypto::Operators::DefaultSignatureCalculator::*)()>(&::Org::BouncyCastle::Crypto::Operators::DefaultSignatureCalculator::GetResult)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::IO::SignerSink*, 0x10>(this, std::forward<::Org::BouncyCastle::Crypto::IO::SignerSink*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::IO::SignerSink*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::IO::SignerSink*> Org::BouncyCastle::Crypto::Operators::DefaultSignatureCalculator::__get_mSignerSink() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::IO::SignerSink*, 0x10>(this);
}
