...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Object* (::Org::BouncyCastle::Crypto::Operators::DefaultVerifierCalculator::*)()>(&::Org::BouncyCastle::Crypto::Operators::DefaultVerifierCalculator::GetResult)> {
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::IO::SignerSink*> Org::BouncyCastle::Crypto::Operators::DefaultVerifierCalculator::__get_mSignerSink() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::IO::SignerSink*, 0x10>(this);
}
