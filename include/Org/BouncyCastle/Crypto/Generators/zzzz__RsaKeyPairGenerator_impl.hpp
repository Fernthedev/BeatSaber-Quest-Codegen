...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Parameters::RsaKeyGenerationParameters*, 0x10>(this, std::forward<::Org::BouncyCastle::Crypto::Parameters::RsaKeyGenerationParameters*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::RsaKeyGenerationParameters*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::RsaKeyGenerationParameters*> Org::BouncyCastle::Crypto::Generators::RsaKeyPairGenerator::__get_parameters() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::RsaKeyGenerationParameters*, 0x10>(this);
}
