...
/// @brief Method Init addr 0xf06f50 size 0x1c virtual true final false
inline void Init(::Org::BouncyCastle::Crypto::KeyGenerationParameters*  parameters) ;

/// @brief Method GenerateKeyPair addr 0xf06f6c size 0xb0 virtual true final false
...
/// @brief Method .ctor addr 0xf0701c size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 X25519KeyPairGenerator()  = default;
public:
