...
/// @brief Field DefaultTests offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::RsaKeyGenerationParameters*> __get_parameters() const;
...
// Ctor Parameters []
// @brief default ctor
 RsaKeyPairGenerator()  = default;
public:


// Fields

// Static field SPECIAL_E_VALUES

// Static field SPECIAL_E_HIGHEST

// Static field SPECIAL_E_BITS

// Static field One

// Static field DefaultPublicExponent
