...
/// @brief Field N offset 0x1c
 __declspec(property(get=__get_N, put=__set_N)) int32_t  N;

/// @brief Field certainty offset 0x20
...
// Ctor Parameters []
// @brief default ctor
 DsaParametersGenerator()  = default;
public:
