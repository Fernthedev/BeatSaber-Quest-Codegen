...
/// @brief Method .ctor addr 0xefdd28 size 0xf0 virtual false final false
inline void _ctor(::Org::BouncyCastle::Crypto::IMac*  prf) ;

/// @brief Method Init addr 0xefde18 size 0x2bc virtual true final true
inline void Init(::Org::BouncyCastle::Crypto::IDerivationParameters*  parameters) ;

/// @brief Method generateNext addr 0xefe0d4 size 0x4ec virtual false final false
inline void generateNext() ;

/// @brief Method get_Digest addr 0xefe5c0 size 0x88 virtual true final true
inline ::Org::BouncyCastle::Crypto::IDigest* get_Digest() ;

/// @brief Method GenerateBytes addr 0xefe648 size 0x208 virtual true final true
inline int32_t GenerateBytes(::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  outOff, int32_t  length) ;

/// @brief Method GetMac addr 0xefe850 size 0x8 virtual true final true
...
// Ctor Parameters []
// @brief default ctor
 KdfDoublePipelineIterationBytesGenerator()  = default;
public:
