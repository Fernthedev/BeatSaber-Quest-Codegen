...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Security::SecureRandom*> __get_init_random() const;
...
// Ctor Parameters []
// @brief default ctor
 Gost3410ParametersGenerator()  = default;
public:
