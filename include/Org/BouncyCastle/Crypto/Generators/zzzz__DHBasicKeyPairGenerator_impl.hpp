...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Generators::DHBasicKeyPairGenerator::*)(::Org::BouncyCastle::Crypto::KeyGenerationParameters*)>(&::Org::BouncyCastle::Crypto::Generators::DHBasicKeyPairGenerator::Init)> {
  ...
  constexpr static std::size_t addrs = 0xef7254;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Crypto::AsymmetricCipherKeyPair* (::Org::BouncyCastle::Crypto::Generators::DHBasicKeyPairGenerator::*)()>(&::Org::BouncyCastle::Crypto::Generators::DHBasicKeyPairGenerator::GenerateKeyPair)> {
  ...
  constexpr static std::size_t addrs = 0xef72f8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Crypto::Generators::DHBasicKeyPairGenerator::*)()>(&::Org::BouncyCastle::Crypto::Generators::DHBasicKeyPairGenerator::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0xef7624;
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters*, 0x10>(this, std::forward<::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters*>(value));
}
constexpr ::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters* Org::BouncyCastle::Crypto::Generators::DHBasicKeyPairGenerator::__get_param()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters*> Org::BouncyCastle::Crypto::Generators::DHBasicKeyPairGenerator::__get_param() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::DHKeyGenerationParameters*, 0x10>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::Org::BouncyCastle::Crypto::Generators::DHBasicKeyPairGenerator*>());
}
