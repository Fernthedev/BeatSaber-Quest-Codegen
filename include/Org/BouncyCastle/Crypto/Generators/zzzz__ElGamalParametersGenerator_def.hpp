...
/// @brief Method Init addr 0xefa598 size 0xc virtual false final false
inline void Init(int32_t  size, int32_t  certainty, ::Org::BouncyCastle::Security::SecureRandom*  random) ;

/// @brief Method GenerateParameters addr 0xefa5a4 size 0xdc virtual false final false
...
/// @brief Method .ctor addr 0xefa680 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 ElGamalParametersGenerator()  = default;
public:
