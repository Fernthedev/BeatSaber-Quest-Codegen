...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::Org::BouncyCastle::Crypto::CipherKeyGenerator)]{};

/// @brief Field R_MASK_LOW_2 offset 0x0
static constexpr uint8_t  R_MASK_LOW_2{static_cast<uint8_t>(0xfcu)};

/// @brief Field R_MASK_HIGH_4 offset 0x0
