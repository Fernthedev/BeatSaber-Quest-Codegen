...
/// @brief Method Init addr 0xf057c4 size 0x1d8 virtual false final false
inline void Init(::Org::BouncyCastle::Crypto::ICipherParameters*  param) ;

/// @brief Method GenerateBlindingFactor addr 0xf0599c size 0x188 virtual false final false
...
/// @brief Method .ctor addr 0xf05b24 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 RsaBlindingFactorGenerator()  = default;
public:
