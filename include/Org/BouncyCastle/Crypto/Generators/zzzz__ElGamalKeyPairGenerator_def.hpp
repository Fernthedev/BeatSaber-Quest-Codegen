...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::ElGamalKeyGenerationParameters*> __get_param() const;
...
// Ctor Parameters []
// @brief default ctor
 ElGamalKeyPairGenerator()  = default;
public:
