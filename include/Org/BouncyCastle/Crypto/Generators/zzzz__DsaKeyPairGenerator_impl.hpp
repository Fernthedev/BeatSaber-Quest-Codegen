...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Parameters::DsaKeyGenerationParameters*, 0x10>(this, std::forward<::Org::BouncyCastle::Crypto::Parameters::DsaKeyGenerationParameters*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::DsaKeyGenerationParameters*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::DsaKeyGenerationParameters*> Org::BouncyCastle::Crypto::Generators::DsaKeyPairGenerator::__get_param() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::DsaKeyGenerationParameters*, 0x10>(this);
}
