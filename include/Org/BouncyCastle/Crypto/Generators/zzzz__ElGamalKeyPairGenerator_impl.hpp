...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Crypto::Parameters::ElGamalKeyGenerationParameters*, 0x10>(this, std::forward<::Org::BouncyCastle::Crypto::Parameters::ElGamalKeyGenerationParameters*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::ElGamalKeyGenerationParameters*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Parameters::ElGamalKeyGenerationParameters*> Org::BouncyCastle::Crypto::Generators::ElGamalKeyPairGenerator::__get_param() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Crypto::Parameters::ElGamalKeyGenerationParameters*, 0x10>(this);
}
