...
// Ctor Parameters []
// @brief default ctor
 __SkeinEngine__Configuration()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __SkeinEngine__Parameter()  = default;
public:
...
/// @brief Field extendedPosition offset 0x18
...
// Ctor Parameters []
// @brief default ctor
 __SkeinEngine__UbiTweak()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__UbiTweak*> __get_tweak() const;
...
/// @brief Field initialState offset 0x28
...
/// @brief Field preMessageParameters offset 0x38
 __declspec(property(get=__get_preMessageParameters, put=__set_preMessageParameters)) ::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*>  preMessageParameters;

/// @brief Field postMessageParameters offset 0x40
 __declspec(property(get=__get_postMessageParameters, put=__set_postMessageParameters)) ::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*>  postMessageParameters;

/// @brief Field ubi offset 0x48
 __declspec(property(get=__get_ubi, put=__set_ubi)) ::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__UBI*  ubi;

/// @brief Field singleByte offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Engines::ThreefishEngine*> __get_threefish() const;
...
constexpr ::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*> const& __get_preMessageParameters() const;

constexpr void __set_postMessageParameters(::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*>  value) ;
...
constexpr ::ArrayW<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*,::Array<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__Parameter*>*> const& __get_postMessageParameters() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Digests::__SkeinEngine__UBI*> __get_ubi() const;
