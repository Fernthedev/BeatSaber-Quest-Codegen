...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::Org::BouncyCastle::Bcpg::ECPublicBcpgKey)]{};

/// @brief Field reserved offset 0x20
 __declspec(property(get=__get_reserved, put=__set_reserved)) uint8_t  reserved;

/// @brief Field hashFunctionId offset 0x24
...
/// @brief Field symAlgorithmId offset 0x28
