...
/// @brief Field idData offset 0x10
 __declspec(property(get=__get_idData, put=__set_idData)) ::ArrayW<uint8_t,::Array<uint8_t>*>  idData;

constexpr void __set_idData(::ArrayW<uint8_t,::Array<uint8_t>*>  value) ;

constexpr ::ArrayW<uint8_t,::Array<uint8_t>*>& __get_idData() ;

constexpr ::ArrayW<uint8_t,::Array<uint8_t>*> const& __get_idData() const;
