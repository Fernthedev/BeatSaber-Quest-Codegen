...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Bcpg::BcpgInputStream*> __get_m_in() const;
...
// Ctor Parameters []
// @brief default ctor
 __BcpgInputStream__PartialInputStream()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::IO::Stream*> __get_m_in() const;
