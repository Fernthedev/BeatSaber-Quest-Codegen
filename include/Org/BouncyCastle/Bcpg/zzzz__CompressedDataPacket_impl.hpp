...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag, 0x18>(this, std::forward<::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag>(value));
}
constexpr ::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag& Org::BouncyCastle::Bcpg::CompressedDataPacket::__get_algorithm()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag, 0x18>(this);
}
