...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (::Org::BouncyCastle::Bcpg::ExperimentalPacket::*)()>(&::Org::BouncyCastle::Bcpg::ExperimentalPacket::GetContents)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Bcpg::PacketTag, 0x10>(this, std::forward<::Org::BouncyCastle::Bcpg::PacketTag>(value));
}
constexpr ::Org::BouncyCastle::Bcpg::PacketTag& Org::BouncyCastle::Bcpg::ExperimentalPacket::__get_tag()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Bcpg::PacketTag, 0x10>(this);
}
