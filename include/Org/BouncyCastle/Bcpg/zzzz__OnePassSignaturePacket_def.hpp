...
/// @brief Field sigType offset 0x14
...
/// @brief Field keyAlgorithm offset 0x1c
...
/// @brief Field nested offset 0x28
...
/// @brief Method .ctor addr 0x11ce47c size 0x198 virtual false final false
...
/// @brief Method .ctor addr 0x11d1fb0 size 0x68 virtual false final false
...
/// @brief Method get_SignatureType addr 0x11d2018 size 0x8 virtual false final false
inline int32_t get_SignatureType() ;

/// @brief Method get_KeyAlgorithm addr 0x11d2020 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag get_KeyAlgorithm() ;

/// @brief Method get_HashAlgorithm addr 0x11d2028 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Bcpg::HashAlgorithmTag get_HashAlgorithm() ;

/// @brief Method get_KeyId addr 0x11d2030 size 0x8 virtual false final false
inline int64_t get_KeyId() ;

/// @brief Method Encode addr 0x11d2038 size 0x16c virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 OnePassSignaturePacket()  = default;
public:
