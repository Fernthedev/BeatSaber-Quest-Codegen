...
/// @brief Field secretRings offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IDictionary*> __get_secretRings() const;

constexpr void __set_order(::System::Collections::IList*  value) ;

constexpr ::System::Collections::IList* __get_order() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> __get_order() const;
...
// Ctor Parameters []
// @brief default ctor
 PgpSecretKeyRingBundle()  = default;
public:
