...
/// @brief Field sigPack offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Bcpg::OnePassSignaturePacket*> __get_sigPack() const;
