...
/// @brief Field sigs offset 0x10
 __declspec(property(get=__get_sigs, put=__set_sigs)) ::ArrayW<::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*,::Array<::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*>*>  sigs;
...
constexpr void __set_sigs(::ArrayW<::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*,::Array<::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*>*>  value) ;

constexpr ::ArrayW<::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*,::Array<::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*>*>& __get_sigs() ;

constexpr ::ArrayW<::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*,::Array<::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*>*> const& __get_sigs() const;
...
/// @brief Method .ctor addr 0x10b1360 size 0xb8 virtual false final false
...
/// @brief Method .ctor addr 0x10b211c size 0xa8 virtual false final false
inline void _ctor(::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature*  sig) ;

/// @brief Method get_Item addr 0x10b21c4 size 0x30 virtual false final false
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature* get_Item(int32_t  index) ;

/// @brief Method Get addr 0x10b21f4 size 0x4 virtual false final false
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpOnePassSignature* Get(int32_t  index) ;

/// @brief Method get_Size addr 0x10b21f8 size 0x1c virtual false final false
inline int32_t get_Size() ;

/// @brief Method get_Count addr 0x10b2214 size 0x1c virtual false final false
inline int32_t get_Count() ;

/// @brief Method get_IsEmpty addr 0x10b2230 size 0x24 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 PgpOnePassSignatureList()  = default;
public:
