...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xf8 - sizeof(::Org::BouncyCastle::Apache::Bzip2::CBZip2OutputStream)]{};
...
/// @brief Method .ctor addr 0x10a5b44 size 0x8 virtual false final false
inline void _ctor(::System::IO::Stream*  output) ;

/// @brief Method Close addr 0x10a5bf8 size 0x4 virtual true final false
inline void Close() ;
...
// Ctor Parameters []
// @brief default ctor
 __PgpCompressedDataGenerator__SafeCBZip2OutputStream()  = default;
public:
...
/// @brief Method .ctor addr 0x10a5b38 size 0xc virtual false final false
inline void _ctor(::System::IO::Stream*  output, int32_t  level, bool  nowrap) ;

/// @brief Method Close addr 0x10a5c60 size 0x30 virtual true final false
inline void Close() ;
...
// Ctor Parameters []
// @brief default ctor
 __PgpCompressedDataGenerator__SafeZOutputStream()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::IO::Stream*> __get_dOut() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Bcpg::BcpgOutputStream*> __get_pkOut() const;
...
/// @brief Method .ctor addr 0x10a55e4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x10a55ec size 0x124 virtual false final false
inline void _ctor(::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag  algorithm, int32_t  compression) ;

/// @brief Method Open addr 0x10a5710 size 0x148 virtual false final false
inline ::System::IO::Stream* Open(::System::IO::Stream*  outStr) ;

/// @brief Method Open addr 0x10a59c0 size 0x178 virtual false final false
inline ::System::IO::Stream* Open(::System::IO::Stream*  outStr, ::ArrayW<uint8_t,::Array<uint8_t>*>  buffer) ;

/// @brief Method doOpen addr 0x10a5858 size 0x168 virtual false final false
inline void doOpen() ;

/// @brief Method Close addr 0x10a5b4c size 0xa4 virtual true final true
inline void Close() ;
...
// Ctor Parameters []
// @brief default ctor
 PgpCompressedDataGenerator()  = default;
public:
