...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Bcpg::MarkerPacket*, 0x10>(this, std::forward<::Org::BouncyCastle::Bcpg::MarkerPacket*>(value));
}
constexpr ::Org::BouncyCastle::Bcpg::MarkerPacket* Org::BouncyCastle::Bcpg::OpenPgp::PgpMarker::__get_data()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Bcpg::MarkerPacket*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Bcpg::MarkerPacket*> Org::BouncyCastle::Bcpg::OpenPgp::PgpMarker::__get_data() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Bcpg::MarkerPacket*, 0x10>(this);
}
