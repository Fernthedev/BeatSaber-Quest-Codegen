...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Bcpg::CompressedDataPacket*, 0x10>(this, std::forward<::Org::BouncyCastle::Bcpg::CompressedDataPacket*>(value));
}
constexpr ::Org::BouncyCastle::Bcpg::CompressedDataPacket* Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedData::__get_data()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Bcpg::CompressedDataPacket*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Bcpg::CompressedDataPacket*> Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedData::__get_data() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Bcpg::CompressedDataPacket*, 0x10>(this);
}
