...
/// @brief Field encAlgorithm offset 0x20
...
/// @brief Field unhashedPacketVector offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Bcpg::OpenPgp::PgpKeyPair*> __get_masterKey() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureSubpacketVector*> __get_hashedPacketVector() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Bcpg::OpenPgp::PgpSignatureSubpacketVector*> __get_unhashedPacketVector() const;
