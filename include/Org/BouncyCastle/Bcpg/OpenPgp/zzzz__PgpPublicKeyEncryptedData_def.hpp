...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::PgpEncryptedData)]{};

/// @brief Field keyData offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Bcpg::PublicKeyEncSessionPacket*> __get_keyData() const;
...
/// @brief Method .ctor addr 0x10b85b8 size 0x2c virtual false final false
...
/// @brief Method GetKeyCipher addr 0x10b85e4 size 0x248 virtual false final false
static inline ::Org::BouncyCastle::Crypto::IBufferedCipher* GetKeyCipher(::Org::BouncyCastle::Bcpg::PublicKeyAlgorithmTag  algorithm) ;

/// @brief Method ConfirmCheckSum addr 0x10b882c size 0x98 virtual false final false
inline bool ConfirmCheckSum(::ArrayW<uint8_t,::Array<uint8_t>*>  sessionInfo) ;

/// @brief Method get_KeyId addr 0x10b88c4 size 0x1c virtual false final false
inline int64_t get_KeyId() ;

/// @brief Method GetSymmetricAlgorithm addr 0x10b88e0 size 0x28 virtual false final false
...
/// @brief Method GetDataStream addr 0x10b90d0 size 0x78c virtual false final false
inline ::System::IO::Stream* GetDataStream(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey*  privKey) ;

/// @brief Method RecoverSessionData addr 0x10b8908 size 0x7c8 virtual false final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> RecoverSessionData(::Org::BouncyCastle::Bcpg::OpenPgp::PgpPrivateKey*  privKey) ;

/// @brief Method ProcessEncodedMpi addr 0x10b9d58 size 0x190 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 PgpPublicKeyEncryptedData()  = default;
public:
