...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Bcpg::ExperimentalPacket*, 0x10>(this, std::forward<::Org::BouncyCastle::Bcpg::ExperimentalPacket*>(value));
}
constexpr ::Org::BouncyCastle::Bcpg::ExperimentalPacket* Org::BouncyCastle::Bcpg::OpenPgp::PgpExperimental::__get_p()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Bcpg::ExperimentalPacket*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Bcpg::ExperimentalPacket*> Org::BouncyCastle::Bcpg::OpenPgp::PgpExperimental::__get_p() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Bcpg::ExperimentalPacket*, 0x10>(this);
}
