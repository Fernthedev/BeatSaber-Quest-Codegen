...
// Ctor Parameters []
// @brief default ctor
 __PgpEncryptedDataGenerator__EncMethod()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::Org::BouncyCastle::Bcpg::OpenPgp::__PgpEncryptedDataGenerator__EncMethod)]{};

/// @brief Field s2k offset 0x28
...
// Ctor Parameters []
// @brief default ctor
 __PgpEncryptedDataGenerator__PbeMethod()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Bcpg::OpenPgp::PgpPublicKey*> __get_pubKey() const;
...
// Ctor Parameters []
// @brief default ctor
 __PgpEncryptedDataGenerator__PubMethod()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Bcpg::BcpgOutputStream*> __get_pOut() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::IO::CipherStream*> __get_cOut() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::IBufferedCipher*> __get_c() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::IO::DigestStream*> __get_digestOut() const;

constexpr void __set_methods(::System::Collections::IList*  value) ;

constexpr ::System::Collections::IList* __get_methods() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> __get_methods() const;
...
// Ctor Parameters []
// @brief default ctor
 PgpEncryptedDataGenerator()  = default;
public:
