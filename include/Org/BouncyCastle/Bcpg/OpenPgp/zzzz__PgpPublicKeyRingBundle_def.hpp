...
/// @brief Field pubRings offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IDictionary*> __get_pubRings() const;
...
// Ctor Parameters []
// @brief default ctor
 PgpPublicKeyRingBundle()  = default;
public:
