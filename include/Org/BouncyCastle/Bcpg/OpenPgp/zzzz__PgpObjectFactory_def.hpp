...
/// @brief Method .ctor addr 0x10b0828 size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x10b085c size 0x8c virtual false final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method NextPgpObject addr 0x10b08e8 size 0xa48 virtual false final false
inline ::Org::BouncyCastle::Bcpg::OpenPgp::PgpObject* NextPgpObject() ;

/// @brief Method NextObject addr 0x10b1418 size 0x4 virtual false final false
inline ::System::Object* NextObject() ;

/// @brief Method AllPgpObjects addr 0x10b141c size 0x104 virtual false final false
inline ::System::Collections::IList* AllPgpObjects() ;

/// @brief Method FilterPgpObjects addr 0x10b1520 size 0x134 virtual false final false
