...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Bcpg::OpenPgp::__PgpCompressedDataGenerator__SafeCBZip2OutputStream::*)(::System::IO::Stream*)>(&::Org::BouncyCastle::Bcpg::OpenPgp::__PgpCompressedDataGenerator__SafeCBZip2OutputStream::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Bcpg::OpenPgp::__PgpCompressedDataGenerator__SafeCBZip2OutputStream::*)()>(&::Org::BouncyCastle::Bcpg::OpenPgp::__PgpCompressedDataGenerator__SafeCBZip2OutputStream::Close)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Bcpg::OpenPgp::__PgpCompressedDataGenerator__SafeZOutputStream::*)(::System::IO::Stream*, int32_t, bool)>(&::Org::BouncyCastle::Bcpg::OpenPgp::__PgpCompressedDataGenerator__SafeZOutputStream::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Bcpg::OpenPgp::__PgpCompressedDataGenerator__SafeZOutputStream::*)()>(&::Org::BouncyCastle::Bcpg::OpenPgp::__PgpCompressedDataGenerator__SafeZOutputStream::Close)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::IO::Stream* (::Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedDataGenerator::*)(::System::IO::Stream*, ::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedDataGenerator::Open)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag, 0x10>(this, std::forward<::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Bcpg::CompressionAlgorithmTag, 0x10>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::System::IO::Stream*> Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedDataGenerator::__get_dOut() const {
return ::cordl_internals::getInstanceField<::System::IO::Stream*, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Bcpg::BcpgOutputStream*, 0x20>(this, std::forward<::Org::BouncyCastle::Bcpg::BcpgOutputStream*>(value));
}
constexpr ::Org::BouncyCastle::Bcpg::BcpgOutputStream* Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedDataGenerator::__get_pkOut()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Bcpg::BcpgOutputStream*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Bcpg::BcpgOutputStream*> Org::BouncyCastle::Bcpg::OpenPgp::PgpCompressedDataGenerator::__get_pkOut() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Bcpg::BcpgOutputStream*, 0x20>(this);
}
