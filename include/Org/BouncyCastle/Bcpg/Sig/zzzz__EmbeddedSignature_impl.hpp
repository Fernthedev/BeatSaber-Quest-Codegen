...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Bcpg::Sig::EmbeddedSignature::*)(bool, bool, ::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::Org::BouncyCastle::Bcpg::Sig::EmbeddedSignature::_ctor)> {
  constexpr static std::size_t size = 0x48;
  constexpr static std::size_t addrs = 0x11c7418;
...
return THROW_UNLESS(::il2cpp_utils::New<::Org::BouncyCastle::Bcpg::Sig::EmbeddedSignature*>(critical, isLongLength, data));
}
