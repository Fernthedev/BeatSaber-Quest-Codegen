...
/// @brief Method TimeToBytes addr 0x11c8e54 size 0x94 virtual false final false
...
/// @brief Method .ctor addr 0x11c8ee8 size 0x48 virtual false final false
inline void _ctor(bool  critical, bool  isLongLength, ::ArrayW<uint8_t,::Array<uint8_t>*>  data) ;

static inline ::Org::BouncyCastle::Bcpg::Sig::SignatureExpirationTime* New_ctor(bool  critical, int64_t  seconds) ;

/// @brief Method .ctor addr 0x11c8f30 size 0x4c virtual false final false
inline void _ctor(bool  critical, int64_t  seconds) ;

/// @brief Method get_Time addr 0x11c8f7c size 0x5c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 SignatureExpirationTime()  = default;
public:
