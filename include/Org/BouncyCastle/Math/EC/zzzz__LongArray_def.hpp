...
/// @brief Method .ctor addr 0x1057bc4 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x104e62c size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x1057c2c size 0xb4 virtual false final false
...
/// @brief Method .ctor addr 0x1050528 size 0x224 virtual false final false
inline void _ctor(::Org::BouncyCastle::Math::BigInteger*  bigInt) ;

/// @brief Method CopyTo addr 0x104e154 size 0x2c virtual false final false
inline void CopyTo(::ArrayW<int64_t,::Array<int64_t>*>  z, int32_t  zOff) ;

/// @brief Method IsOne addr 0x1050830 size 0x60 virtual false final false
inline bool IsOne() ;

/// @brief Method IsZero addr 0x10508e4 size 0x4c virtual false final false
inline bool IsZero() ;

/// @brief Method GetUsedLength addr 0x1057ce0 size 0x1c virtual false final false
inline int32_t GetUsedLength() ;

/// @brief Method GetUsedLengthFrom addr 0x1057cfc size 0xe0 virtual false final false
inline int32_t GetUsedLengthFrom(int32_t  from) ;

/// @brief Method Degree addr 0x1050774 size 0xa4 virtual false final false
inline int32_t Degree() ;

/// @brief Method DegreeFrom addr 0x1057efc size 0xac virtual false final false
inline int32_t DegreeFrom(int32_t  limit) ;

/// @brief Method BitLength addr 0x1057ddc size 0x120 virtual false final false
static inline int32_t BitLength(int64_t  w) ;

/// @brief Method ResizedInts addr 0x1057fa8 size 0xbc virtual false final false
inline ::ArrayW<int64_t,::Array<int64_t>*> ResizedInts(int32_t  newLen) ;

/// @brief Method ToBigInteger addr 0x10509b8 size 0x214 virtual false final false
inline ::Org::BouncyCastle::Math::BigInteger* ToBigInteger() ;

/// @brief Method ShiftUp addr 0x1058064 size 0x80 virtual false final false
static inline int64_t ShiftUp(::ArrayW<int64_t,::Array<int64_t>*>  x, int32_t  xOff, int32_t  count, int32_t  shift) ;

/// @brief Method ShiftUp addr 0x10580e4 size 0x98 virtual false final false
...
/// @brief Method AddOne addr 0x1051078 size 0x11c virtual false final false
inline ::Org::BouncyCastle::Math::EC::LongArray* AddOne() ;

/// @brief Method AddShiftedByBitsSafe addr 0x105817c size 0x100 virtual false final false
inline void AddShiftedByBitsSafe(::Org::BouncyCastle::Math::EC::LongArray*  other, int32_t  otherDegree, int32_t  bits) ;

/// @brief Method AddShiftedUp addr 0x10582f4 size 0xa4 virtual false final false
...
/// @brief Method AddShiftedDown addr 0x1058398 size 0x90 virtual false final false
...
/// @brief Method AddShiftedByWords addr 0x1050f18 size 0xd4 virtual false final false
inline void AddShiftedByWords(::Org::BouncyCastle::Math::EC::LongArray*  other, int32_t  words) ;

/// @brief Method Add addr 0x105827c size 0x78 virtual false final false
...
/// @brief Method Add addr 0x1058428 size 0x90 virtual false final false
...
/// @brief Method AddBoth addr 0x10584b8 size 0x98 virtual false final false
...
/// @brief Method Distribute addr 0x1058550 size 0xa8 virtual false final false
static inline void Distribute(::ArrayW<int64_t,::Array<int64_t>*>  x, int32_t  src, int32_t  dst1, int32_t  dst2, int32_t  count) ;

/// @brief Method get_Length addr 0x10585f8 size 0x1c virtual false final false
inline int32_t get_Length() ;

/// @brief Method FlipWord addr 0x1058614 size 0x7c virtual false final false
static inline void FlipWord(::ArrayW<int64_t,::Array<int64_t>*>  buf, int32_t  off, int32_t  bit, int64_t  word) ;

/// @brief Method TestBitZero addr 0x105096c size 0x34 virtual false final false
inline bool TestBitZero() ;

/// @brief Method TestBit addr 0x1058690 size 0x40 virtual false final false
static inline bool TestBit(::ArrayW<int64_t,::Array<int64_t>*>  buf, int32_t  off, int32_t  n) ;

/// @brief Method FlipBit addr 0x10586d0 size 0x44 virtual false final false
static inline void FlipBit(::ArrayW<int64_t,::Array<int64_t>*>  buf, int32_t  off, int32_t  n) ;

/// @brief Method MultiplyWord addr 0x1058714 size 0x118 virtual false final false
...
/// @brief Method ModMultiplyLD addr 0x105882c size 0x518 virtual false final false
...
/// @brief Method ModMultiply addr 0x1051274 size 0x450 virtual false final false
...
/// @brief Method ModMultiplyAlt addr 0x1058dfc size 0x4bc virtual false final false
...
/// @brief Method ModReduce addr 0x1059430 size 0xe4 virtual false final false
inline ::Org::BouncyCastle::Math::EC::LongArray* ModReduce(int32_t  m, ::ArrayW<int32_t,::Array<int32_t>*>  ks) ;

/// @brief Method Multiply addr 0x105186c size 0x430 virtual false final false
...
/// @brief Method Reduce addr 0x1051c9c size 0xe0 virtual false final false
inline void Reduce(int32_t  m, ::ArrayW<int32_t,::Array<int32_t>*>  ks) ;

/// @brief Method ReduceResult addr 0x1058d44 size 0xb8 virtual false final false
...
/// @brief Method ReduceInPlace addr 0x1059514 size 0x248 virtual false final false
...
/// @brief Method ReduceBitWise addr 0x1059a04 size 0xc4 virtual false final false
...
/// @brief Method ReduceBit addr 0x1059ac8 size 0x114 virtual false final false
...
/// @brief Method ReduceWordWise addr 0x1059894 size 0x170 virtual false final false
...
/// @brief Method ReduceWord addr 0x1059bdc size 0x108 virtual false final false
...
/// @brief Method ReduceVectorWise addr 0x105975c size 0x138 virtual false final false
...
/// @brief Method FlipVector addr 0x1059ce4 size 0x100 virtual false final false
...
/// @brief Method Interleave3 addr 0x1059f84 size 0xe4 virtual false final false
...
/// @brief Method Interleave3 addr 0x105a324 size 0x88 virtual false final false
static inline int64_t Interleave3(int64_t  x) ;

/// @brief Method Interleave3_21to63 addr 0x105a3ac size 0xac virtual false final false
static inline int64_t Interleave3_21to63(int32_t  x) ;

/// @brief Method Interleave5 addr 0x105a068 size 0xe4 virtual false final false
...
/// @brief Method Interleave5 addr 0x105a458 size 0xa0 virtual false final false
static inline int64_t Interleave5(int64_t  x) ;

/// @brief Method Interleave3_13to65 addr 0x105a4f8 size 0x94 virtual false final false
static inline int64_t Interleave3_13to65(int32_t  x) ;

/// @brief Method Interleave7 addr 0x105a14c size 0xe4 virtual false final false
...
/// @brief Method Interleave7 addr 0x105a58c size 0x114 virtual false final false
static inline int64_t Interleave7(int64_t  x) ;

/// @brief Method Interleave2_n addr 0x105a230 size 0xf4 virtual false final false
...
/// @brief Method Interleave2_n addr 0x105a6a0 size 0xec virtual false final false
static inline int64_t Interleave2_n(int64_t  x, int32_t  rounds) ;

/// @brief Method Interleave4_16to64 addr 0x105a78c size 0x94 virtual false final false
static inline int64_t Interleave4_16to64(int32_t  x) ;

/// @brief Method Interleave2_32to64 addr 0x1059de4 size 0xc0 virtual false final false
static inline int64_t Interleave2_32to64(int32_t  x) ;

/// @brief Method ModInverse addr 0x1052504 size 0x480 virtual false final false
inline ::Org::BouncyCastle::Math::EC::LongArray* ModInverse(int32_t  m, ::ArrayW<int32_t,::Array<int32_t>*>  ks) ;

/// @brief Method Equals addr 0x105a820 size 0x88 virtual true final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method Equals addr 0x105a8a8 size 0xb0 virtual true final false
inline bool Equals(::Org::BouncyCastle::Math::EC::LongArray*  other) ;

/// @brief Method GetHashCode addr 0x105a958 size 0x7c virtual true final false
inline int32_t GetHashCode() ;

/// @brief Method Copy addr 0x1050e78 size 0xa0 virtual false final false
inline ::Org::BouncyCastle::Math::EC::LongArray* Copy() ;

/// @brief Method ToString addr 0x105a9d4 size 0x1bc virtual true final false
...
// Static field INTERLEAVE2_TABLE

// Static field INTERLEAVE3_TABLE

// Static field INTERLEAVE4_TABLE

// Static field INTERLEAVE5_TABLE

// Static field INTERLEAVE7_TABLE

// Static field BitLengths
