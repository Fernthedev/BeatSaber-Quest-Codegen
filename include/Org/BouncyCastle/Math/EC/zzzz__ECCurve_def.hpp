...
/// @brief Field coord offset 0x18
 __declspec(property(get=__get_coord, put=__set_coord)) int32_t  coord;

/// @brief Field endomorphism offset 0x20
...
/// @brief Field multiplier offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::ECCurve*> __get_outer() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Endo::ECEndomorphism*> __get_endomorphism() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier*> __get_multiplier() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::ECCurve*> __get_m_outer() const;
...
// Ctor Parameters []
// @brief default ctor
 __ECCurve__DefaultLookupTable()  = default;
public:
...
/// @brief Field m_multiplier offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::Field::IFiniteField*> __get_m_field() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::ECFieldElement*> __get_m_a() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::ECFieldElement*> __get_m_b() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::BigInteger*> __get_m_order() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::BigInteger*> __get_m_cofactor() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier*> __get_m_multiplier() const;
