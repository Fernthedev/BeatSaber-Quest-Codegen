...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::Org::BouncyCastle::Math::EC::AbstractF2mFieldElement)]{};

/// @brief Field Gnb offset 0x0
static constexpr int32_t  Gnb{static_cast<int32_t>(0x1)};

/// @brief Field Tpb offset 0x0
static constexpr int32_t  Tpb{static_cast<int32_t>(0x2)};

/// @brief Field Ppb offset 0x0
static constexpr int32_t  Ppb{static_cast<int32_t>(0x3)};

/// @brief Field representation offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::LongArray*> __get_x() const;
