...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x50 - sizeof(::Org::BouncyCastle::Math::EC::ECCurve)]{};

static inline ::Org::BouncyCastle::Math::EC::AbstractFpCurve* New_ctor(::Org::BouncyCastle::Math::BigInteger*  q) ;

/// @brief Method .ctor addr 0xfcbca0 size 0x84 virtual false final false
inline void _ctor(::Org::BouncyCastle::Math::BigInteger*  q) ;

/// @brief Method IsValidFieldElement addr 0xfcbd24 size 0xe4 virtual true final false
inline bool IsValidFieldElement(::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method RandomFieldElement addr 0xfcbe08 size 0x120 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElement(::Org::BouncyCastle::Security::SecureRandom*  r) ;

/// @brief Method RandomFieldElementMult addr 0xfcbf80 size 0x120 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* RandomFieldElementMult(::Org::BouncyCastle::Security::SecureRandom*  r) ;

/// @brief Method DecompressPoint addr 0xfcc128 size 0x180 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* DecompressPoint(int32_t  yTilde, ::Org::BouncyCastle::Math::BigInteger*  X1) ;

/// @brief Method ImplRandomFieldElement addr 0xfcbf28 size 0x58 virtual false final false
...
/// @brief Method ImplRandomFieldElementMult addr 0xfcc0a0 size 0x88 virtual false final false
