...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Math::EC::Abc::ZTauElement::*)(::Org::BouncyCastle::Math::BigInteger*, ::Org::BouncyCastle::Math::BigInteger*)>(&::Org::BouncyCastle::Math::EC::Abc::ZTauElement::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0xfc7994;
...
constexpr ::Org::BouncyCastle::Math::BigInteger* Org::BouncyCastle::Math::EC::Abc::ZTauElement::__get_u()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Math::BigInteger*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::BigInteger*> Org::BouncyCastle::Math::EC::Abc::ZTauElement::__get_u() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Math::BigInteger*, 0x10>(this);
}
...
constexpr ::Org::BouncyCastle::Math::BigInteger* Org::BouncyCastle::Math::EC::Abc::ZTauElement::__get_v()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Math::BigInteger*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::BigInteger*> Org::BouncyCastle::Math::EC::Abc::ZTauElement::__get_v() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Math::BigInteger*, 0x18>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::Org::BouncyCastle::Math::EC::Abc::ZTauElement*>(u, v));
}
