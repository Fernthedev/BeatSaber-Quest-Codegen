...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecP256K1Curve*> __get_m_outer() const;
...
// Ctor Parameters []
// @brief default ctor
 __SecP256K1Curve__SecP256K1LookupTable()  = default;
public:
...
/// @brief Field SECP256K1_DEFAULT_COORDS offset 0x0
static constexpr int32_t  SECP256K1_DEFAULT_COORDS{static_cast<int32_t>(0x2)};

/// @brief Field SECP256K1_FE_INTS offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecP256K1Point*> __get_m_infinity() const;
...
// Static field SECP256K1_AFFINE_ZS
