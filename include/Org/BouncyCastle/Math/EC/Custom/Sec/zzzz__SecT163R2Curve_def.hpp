...
// Self: TypeDefinitionIndex(TypeDefinitionIndex(1467))
...
/// @brief Field m_outer offset 0x10
 __declspec(property(get=__get_m_outer, put=__set_m_outer)) ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve*  m_outer;
...
constexpr void __set_m_outer(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve*  value) ;

constexpr ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve* __get_m_outer() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve*> __get_m_outer() const;
...
/// @brief Method .ctor addr 0x1013afc size 0x3c virtual false final false
...
/// @brief Method get_Size addr 0x1013c44 size 0x8 virtual true final false
inline int32_t get_Size() ;

/// @brief Method Lookup addr 0x1013c4c size 0x108 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t  index) ;

/// @brief Method LookupVar addr 0x1013e34 size 0xcc virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t  index) ;

/// @brief Method CreatePoint addr 0x1013d54 size 0xe0 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __SecT163R2Curve__SecT163R2LookupTable()  = default;
public:
...
// Self: TypeDefinitionIndex(TypeDefinitionIndex(1468))
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x60 - sizeof(::Org::BouncyCastle::Math::EC::AbstractF2mCurve)]{};

/// @brief Field SECT163R2_DEFAULT_COORDS offset 0x0
static constexpr int32_t  SECT163R2_DEFAULT_COORDS{static_cast<int32_t>(0x6)};

/// @brief Field SECT163R2_FE_LONGS offset 0x0
static constexpr int32_t  SECT163R2_FE_LONGS{static_cast<int32_t>(0x3)};

/// @brief Field m_infinity offset 0x58
 __declspec(property(get=__get_m_infinity, put=__set_m_infinity)) ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Point*  m_infinity;
...
constexpr void __set_m_infinity(::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Point*  value) ;

constexpr ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Point* __get_m_infinity() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Point*> __get_m_infinity() const;

static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT163R2Curve* New_ctor() ;

/// @brief Method .ctor addr 0x10134d4 size 0x1c0 virtual false final false
inline void _ctor() ;

/// @brief Method CloneCurve addr 0x101369c size 0x58 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method SupportsCoordinateSystem addr 0x10136f4 size 0xc virtual true final false
inline bool SupportsCoordinateSystem(int32_t  coord) ;

/// @brief Method get_Infinity addr 0x1013700 size 0x8 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_FieldSize addr 0x1013708 size 0x8 virtual true final false
inline int32_t get_FieldSize() ;

/// @brief Method FromBigInteger addr 0x1013710 size 0x60 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* FromBigInteger(::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method CreateRawPoint addr 0x1013770 size 0x88 virtual true final false
...
/// @brief Method CreateRawPoint addr 0x1013884 size 0x94 virtual true final false
...
/// @brief Method get_IsKoblitz addr 0x1013924 size 0x8 virtual true final false
inline bool get_IsKoblitz() ;

/// @brief Method get_M addr 0x101392c size 0x8 virtual true final false
inline int32_t get_M() ;

/// @brief Method get_IsTrinomial addr 0x1013934 size 0x8 virtual true final false
inline bool get_IsTrinomial() ;

/// @brief Method get_K1 addr 0x101393c size 0x8 virtual true final false
inline int32_t get_K1() ;

/// @brief Method get_K2 addr 0x1013944 size 0x8 virtual true final false
inline int32_t get_K2() ;

/// @brief Method get_K3 addr 0x101394c size 0x8 virtual true final false
inline int32_t get_K3() ;

/// @brief Method CreateCacheSafeLookupTable addr 0x1013954 size 0x1a8 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 SecT163R2Curve()  = default;
public:


// Fields

// Static field SECT163R2_AFFINE_ZS
