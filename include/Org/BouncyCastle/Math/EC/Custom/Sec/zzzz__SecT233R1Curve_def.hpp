...
/// @brief Field m_outer offset 0x10
 __declspec(property(get=__get_m_outer, put=__set_m_outer)) ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve*  m_outer;
...
constexpr ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve* __get_m_outer() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve*> __get_m_outer() const;
...
/// @brief Method .ctor addr 0x101ea44 size 0x3c virtual false final false
...
/// @brief Method get_Size addr 0x101eb90 size 0x8 virtual true final false
inline int32_t get_Size() ;

/// @brief Method Lookup addr 0x101eb98 size 0x118 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t  index) ;

/// @brief Method LookupVar addr 0x101ed90 size 0xc8 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t  index) ;

/// @brief Method CreatePoint addr 0x101ecb0 size 0xe0 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __SecT233R1Curve__SecT233R1LookupTable()  = default;
public:
...
/// @brief Field SECT233R1_DEFAULT_COORDS offset 0x0
static constexpr int32_t  SECT233R1_DEFAULT_COORDS{static_cast<int32_t>(0x6)};

/// @brief Field SECT233R1_FE_LONGS offset 0x0
static constexpr int32_t  SECT233R1_FE_LONGS{static_cast<int32_t>(0x4)};

/// @brief Field m_infinity offset 0x58
 __declspec(property(get=__get_m_infinity, put=__set_m_infinity)) ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Point*  m_infinity;
...
constexpr ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Point* __get_m_infinity() ;

constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Point*> __get_m_infinity() const;

static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT233R1Curve* New_ctor() ;

/// @brief Method .ctor addr 0x101e41c size 0x1c0 virtual false final false
inline void _ctor() ;

/// @brief Method CloneCurve addr 0x101e5e4 size 0x58 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method SupportsCoordinateSystem addr 0x101e63c size 0xc virtual true final false
inline bool SupportsCoordinateSystem(int32_t  coord) ;

/// @brief Method get_Infinity addr 0x101e648 size 0x8 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_FieldSize addr 0x101e650 size 0x8 virtual true final false
inline int32_t get_FieldSize() ;

/// @brief Method FromBigInteger addr 0x101e658 size 0x64 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* FromBigInteger(::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method CreateRawPoint addr 0x101e6bc size 0x88 virtual true final false
...
/// @brief Method CreateRawPoint addr 0x101e7d0 size 0x94 virtual true final false
...
/// @brief Method get_IsKoblitz addr 0x101e870 size 0x8 virtual true final false
inline bool get_IsKoblitz() ;

/// @brief Method get_M addr 0x101e878 size 0x8 virtual true final false
inline int32_t get_M() ;

/// @brief Method get_IsTrinomial addr 0x101e880 size 0x8 virtual true final false
inline bool get_IsTrinomial() ;

/// @brief Method get_K1 addr 0x101e888 size 0x8 virtual true final false
inline int32_t get_K1() ;

/// @brief Method get_K2 addr 0x101e890 size 0x8 virtual true final false
inline int32_t get_K2() ;

/// @brief Method get_K3 addr 0x101e898 size 0x8 virtual true final false
inline int32_t get_K3() ;

/// @brief Method CreateCacheSafeLookupTable addr 0x101e8a0 size 0x1a4 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 SecT233R1Curve()  = default;
public:


// Fields

// Static field SECT233R1_AFFINE_ZS
