...
/// @brief Method Add addr 0xffaad4 size 0xe4 virtual false final false
...
/// @brief Method AddExt addr 0xffac74 size 0x134 virtual false final false
...
/// @brief Method SubtractExt addr 0xffbb18 size 0xe4 virtual false final false
...
/// @brief Method Twice addr 0xffbbfc size 0xd4 virtual false final false
static inline void Twice(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method AddPInvTo addr 0xffabb8 size 0xbc virtual false final false
static inline void AddPInvTo(::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method SubPInvFrom addr 0xffba5c size 0xbc virtual false final false
...
/// @brief Method .ctor addr 0xffbde4 size 0x8 virtual false final false
inline void _ctor() ;
