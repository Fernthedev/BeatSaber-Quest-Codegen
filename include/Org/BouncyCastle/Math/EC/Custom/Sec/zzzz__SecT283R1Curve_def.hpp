...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT283R1Curve*> __get_m_outer() const;
...
// Ctor Parameters []
// @brief default ctor
 __SecT283R1Curve__SecT283R1LookupTable()  = default;
public:
...
/// @brief Field SECT283R1_DEFAULT_COORDS offset 0x0
static constexpr int32_t  SECT283R1_DEFAULT_COORDS{static_cast<int32_t>(0x6)};

/// @brief Field SECT283R1_FE_LONGS offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT283R1Point*> __get_m_infinity() const;
...
// Ctor Parameters []
// @brief default ctor
 SecT283R1Curve()  = default;
public:


// Fields

// Static field SECT283R1_AFFINE_ZS
