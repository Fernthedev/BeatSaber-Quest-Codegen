...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1Curve*> __get_m_outer() const;
...
// Ctor Parameters []
// @brief default ctor
 __SecP192K1Curve__SecP192K1LookupTable()  = default;
public:
...
/// @brief Field SECP192K1_DEFAULT_COORDS offset 0x0
static constexpr int32_t  SECP192K1_DEFAULT_COORDS{static_cast<int32_t>(0x2)};

/// @brief Field SECP192K1_FE_INTS offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecP192K1Point*> __get_m_infinity() const;
...
// Static field SECP192K1_AFFINE_ZS
