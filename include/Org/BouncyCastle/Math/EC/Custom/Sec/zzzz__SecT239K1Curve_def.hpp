...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Curve*> __get_m_outer() const;
...
// Ctor Parameters []
// @brief default ctor
 __SecT239K1Curve__SecT239K1LookupTable()  = default;
public:
...
/// @brief Field SECT239K1_DEFAULT_COORDS offset 0x0
static constexpr int32_t  SECT239K1_DEFAULT_COORDS{static_cast<int32_t>(0x6)};

/// @brief Field SECT239K1_FE_LONGS offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT239K1Point*> __get_m_infinity() const;
...
// Ctor Parameters []
// @brief default ctor
 SecT239K1Curve()  = default;
public:


// Fields

// Static field SECT239K1_AFFINE_ZS
