...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT113R2Curve*> __get_m_outer() const;
...
/// @brief Method .ctor addr 0x1006960 size 0x3c virtual false final false
...
/// @brief Method get_Size addr 0x1006aa8 size 0x8 virtual true final false
inline int32_t get_Size() ;

/// @brief Method Lookup addr 0x1006ab0 size 0x118 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t  index) ;

/// @brief Method LookupVar addr 0x1006ca8 size 0xc8 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t  index) ;

/// @brief Method CreatePoint addr 0x1006bc8 size 0xe0 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __SecT113R2Curve__SecT113R2LookupTable()  = default;
public:
...
/// @brief Field SECT113R2_DEFAULT_COORDS offset 0x0
static constexpr int32_t  SECT113R2_DEFAULT_COORDS{static_cast<int32_t>(0x6)};

/// @brief Field SECT113R2_FE_LONGS offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT113R2Point*> __get_m_infinity() const;

static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT113R2Curve* New_ctor() ;

/// @brief Method .ctor addr 0x10062f0 size 0x20c virtual false final false
inline void _ctor() ;

/// @brief Method CloneCurve addr 0x1006504 size 0x58 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method SupportsCoordinateSystem addr 0x100655c size 0xc virtual true final false
inline bool SupportsCoordinateSystem(int32_t  coord) ;

/// @brief Method get_Infinity addr 0x1006568 size 0x8 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_FieldSize addr 0x1006570 size 0x8 virtual true final false
inline int32_t get_FieldSize() ;

/// @brief Method FromBigInteger addr 0x1006578 size 0x60 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* FromBigInteger(::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method CreateRawPoint addr 0x10065d8 size 0x88 virtual true final false
...
/// @brief Method CreateRawPoint addr 0x10066ec size 0x94 virtual true final false
...
/// @brief Method get_IsKoblitz addr 0x100678c size 0x8 virtual true final false
inline bool get_IsKoblitz() ;

/// @brief Method get_M addr 0x1006794 size 0x8 virtual true final false
inline int32_t get_M() ;

/// @brief Method get_IsTrinomial addr 0x100679c size 0x8 virtual true final false
inline bool get_IsTrinomial() ;

/// @brief Method get_K1 addr 0x10067a4 size 0x8 virtual true final false
inline int32_t get_K1() ;

/// @brief Method get_K2 addr 0x10067ac size 0x8 virtual true final false
inline int32_t get_K2() ;

/// @brief Method get_K3 addr 0x10067b4 size 0x8 virtual true final false
inline int32_t get_K3() ;

/// @brief Method CreateCacheSafeLookupTable addr 0x10067bc size 0x1a4 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 SecT113R2Curve()  = default;
public:


// Fields

// Static field SECT113R2_AFFINE_ZS
