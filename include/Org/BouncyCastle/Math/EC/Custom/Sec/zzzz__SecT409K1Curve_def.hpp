...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409K1Curve*> __get_m_outer() const;
...
/// @brief Method .ctor addr 0x102be64 size 0x3c virtual false final false
...
/// @brief Method get_Size addr 0x102bfac size 0x8 virtual true final false
inline int32_t get_Size() ;

/// @brief Method Lookup addr 0x102bfb4 size 0x108 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Lookup(int32_t  index) ;

/// @brief Method LookupVar addr 0x102c19c size 0xcc virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* LookupVar(int32_t  index) ;

/// @brief Method CreatePoint addr 0x102c0bc size 0xe0 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __SecT409K1Curve__SecT409K1LookupTable()  = default;
public:
...
/// @brief Field SECT409K1_DEFAULT_COORDS offset 0x0
static constexpr int32_t  SECT409K1_DEFAULT_COORDS{static_cast<int32_t>(0x6)};

/// @brief Field SECT409K1_FE_LONGS offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409K1Point*> __get_m_infinity() const;

static inline ::Org::BouncyCastle::Math::EC::Custom::Sec::SecT409K1Curve* New_ctor() ;

/// @brief Method .ctor addr 0x102b820 size 0x180 virtual false final false
inline void _ctor() ;

/// @brief Method CloneCurve addr 0x102b9a8 size 0x58 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECCurve* CloneCurve() ;

/// @brief Method SupportsCoordinateSystem addr 0x102ba00 size 0xc virtual true final false
inline bool SupportsCoordinateSystem(int32_t  coord) ;

/// @brief Method CreateDefaultMultiplier addr 0x102ba0c size 0x5c virtual true final false
inline ::Org::BouncyCastle::Math::EC::Multiplier::ECMultiplier* CreateDefaultMultiplier() ;

/// @brief Method get_Infinity addr 0x102ba68 size 0x8 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* get_Infinity() ;

/// @brief Method get_FieldSize addr 0x102ba70 size 0x8 virtual true final false
inline int32_t get_FieldSize() ;

/// @brief Method FromBigInteger addr 0x102ba78 size 0x60 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* FromBigInteger(::Org::BouncyCastle::Math::BigInteger*  x) ;

/// @brief Method CreateRawPoint addr 0x102bad8 size 0x88 virtual true final false
...
/// @brief Method CreateRawPoint addr 0x102bbec size 0x94 virtual true final false
...
/// @brief Method get_IsKoblitz addr 0x102bc8c size 0x8 virtual true final false
inline bool get_IsKoblitz() ;

/// @brief Method get_M addr 0x102bc94 size 0x8 virtual true final false
inline int32_t get_M() ;

/// @brief Method get_IsTrinomial addr 0x102bc9c size 0x8 virtual true final false
inline bool get_IsTrinomial() ;

/// @brief Method get_K1 addr 0x102bca4 size 0x8 virtual true final false
inline int32_t get_K1() ;

/// @brief Method get_K2 addr 0x102bcac size 0x8 virtual true final false
inline int32_t get_K2() ;

/// @brief Method get_K3 addr 0x102bcb4 size 0x8 virtual true final false
inline int32_t get_K3() ;

/// @brief Method CreateCacheSafeLookupTable addr 0x102bcbc size 0x1a8 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 SecT409K1Curve()  = default;
public:


// Fields

// Static field SECT409K1_AFFINE_ZS
