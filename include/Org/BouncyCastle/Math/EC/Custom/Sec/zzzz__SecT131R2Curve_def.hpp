...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT131R2Curve*> __get_m_outer() const;
...
// Ctor Parameters []
// @brief default ctor
 __SecT131R2Curve__SecT131R2LookupTable()  = default;
public:
...
/// @brief Field SECT131R2_DEFAULT_COORDS offset 0x0
static constexpr int32_t  SECT131R2_DEFAULT_COORDS{static_cast<int32_t>(0x6)};

/// @brief Field SECT131R2_FE_LONGS offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Sec::SecT131R2Point*> __get_m_infinity() const;
...
// Ctor Parameters []
// @brief default ctor
 SecT131R2Curve()  = default;
public:


// Fields

// Static field SECT131R2_AFFINE_ZS
