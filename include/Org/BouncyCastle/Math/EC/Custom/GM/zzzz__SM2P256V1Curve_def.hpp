...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Curve*> __get_m_outer() const;
...
// Ctor Parameters []
// @brief default ctor
 __SM2P256V1Curve__SM2P256V1LookupTable()  = default;
public:
...
/// @brief Field SM2P256V1_DEFAULT_COORDS offset 0x0
static constexpr int32_t  SM2P256V1_DEFAULT_COORDS{static_cast<int32_t>(0x2)};

/// @brief Field SM2P256V1_FE_INTS offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::GM::SM2P256V1Point*> __get_m_infinity() const;
...
// Static field SM2P256V1_AFFINE_ZS
