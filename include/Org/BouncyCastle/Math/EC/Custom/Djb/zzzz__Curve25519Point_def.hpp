...
/// @brief Method .ctor addr 0xfcc448 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0xfcc778 size 0x88 virtual false final false
...
/// @brief Method .ctor addr 0xfcc890 size 0x8 virtual false final false
...
/// @brief Method Detach addr 0xfd11e4 size 0x98 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Detach() ;

/// @brief Method GetZCoord addr 0xfd127c size 0x1c virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* GetZCoord(int32_t  index) ;

/// @brief Method Add addr 0xfd1298 size 0x6f8 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Add(::Org::BouncyCastle::Math::EC::ECPoint*  b) ;

/// @brief Method Twice addr 0xfd1990 size 0xa4 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Twice() ;

/// @brief Method TwicePlus addr 0xfd1a34 size 0xd0 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* TwicePlus(::Org::BouncyCastle::Math::EC::ECPoint*  b) ;

/// @brief Method ThreeTimes addr 0xfd1b04 size 0x80 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* ThreeTimes() ;

/// @brief Method Negate addr 0xfd1b84 size 0xd4 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Negate() ;

/// @brief Method CalculateJacobianModifiedW addr 0xfd1c58 size 0x180 virtual true final false
...
/// @brief Method GetJacobianModifiedW addr 0xfd1dd8 size 0x128 virtual true final false
inline ::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519FieldElement* GetJacobianModifiedW() ;

/// @brief Method TwiceJacobianModified addr 0xfd1f00 size 0x470 virtual true final false
