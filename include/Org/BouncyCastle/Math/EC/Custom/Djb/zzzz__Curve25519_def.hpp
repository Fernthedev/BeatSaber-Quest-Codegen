...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519*> __get_m_outer() const;
...
// Ctor Parameters []
// @brief default ctor
 __Curve25519__Curve25519LookupTable()  = default;
public:
...
/// @brief Field CURVE25519_DEFAULT_COORDS offset 0x0
static constexpr int32_t  CURVE25519_DEFAULT_COORDS{static_cast<int32_t>(0x4)};

/// @brief Field CURVE25519_FE_INTS offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Custom::Djb::Curve25519Point*> __get_m_infinity() const;
...
// Static field CURVE25519_AFFINE_ZS
