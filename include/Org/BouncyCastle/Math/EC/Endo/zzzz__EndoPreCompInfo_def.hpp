...
/// @brief Field m_mappedPoint offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::ECPoint*> __get_m_mappedPoint() const;
