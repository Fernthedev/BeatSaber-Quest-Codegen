...
struct CORDL_TYPE __Ed25519__Algorithm : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____Ed25519__Algorithm_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __Ed25519__Algorithm(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Ed25519__Algorithm()  = default;
...
/// @brief Method .ctor addr 0x104505c size 0x94 virtual false final false
inline void _ctor() ;
...
/// @brief Method .ctor addr 0x10450f0 size 0x88 virtual false final false
inline void _ctor() ;
...
/// @brief Method .ctor addr 0x1045178 size 0x7c virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __Ed25519__PointPrecomp()  = default;
public:
...
/// @brief Method CalculateS addr 0x1040660 size 0x194 virtual false final false
...
/// @brief Method CheckContextVar addr 0x1040d7c size 0x2c virtual false final false
static inline bool CheckContextVar(::ArrayW<uint8_t,::Array<uint8_t>*>  ctx, uint8_t  phflag) ;

/// @brief Method CheckPoint addr 0x1040da8 size 0x114 virtual false final false
static inline int32_t CheckPoint(::ArrayW<int32_t,::Array<int32_t>*>  x, ::ArrayW<int32_t,::Array<int32_t>*>  y) ;

/// @brief Method CheckPoint addr 0x1040ebc size 0x158 virtual false final false
...
/// @brief Method CheckPointVar addr 0x1041014 size 0xdc virtual false final false
static inline bool CheckPointVar(::ArrayW<uint8_t,::Array<uint8_t>*>  p) ;

/// @brief Method CheckScalarVar addr 0x10411c0 size 0xb0 virtual false final false
static inline bool CheckScalarVar(::ArrayW<uint8_t,::Array<uint8_t>*>  s) ;

/// @brief Method CreateDigest addr 0x1041270 size 0x5c virtual false final false
static inline ::Org::BouncyCastle::Crypto::IDigest* CreateDigest() ;

/// @brief Method CreatePrehash addr 0x10412cc size 0x4c virtual false final false
static inline ::Org::BouncyCastle::Crypto::IDigest* CreatePrehash() ;

/// @brief Method Decode24 addr 0x1041318 size 0x54 virtual false final false
static inline uint32_t Decode24(::ArrayW<uint8_t,::Array<uint8_t>*>  bs, int32_t  off) ;

/// @brief Method Decode32 addr 0x104136c size 0x68 virtual false final false
static inline uint32_t Decode32(::ArrayW<uint8_t,::Array<uint8_t>*>  bs, int32_t  off) ;

/// @brief Method Decode32 addr 0x10410f0 size 0xd0 virtual false final false
...
/// @brief Method DecodePointVar addr 0x10413d4 size 0x234 virtual false final false
...
/// @brief Method GeneratePrivateKey addr 0x1041ad8 size 0x1c virtual false final false
static inline void GeneratePrivateKey(::Org::BouncyCastle::Security::SecureRandom*  random, ::ArrayW<uint8_t,::Array<uint8_t>*>  k) ;

/// @brief Method GeneratePublicKey addr 0x1041af4 size 0x220 virtual false final false
...
/// @brief Method GetWnafVar addr 0x1041e58 size 0x1b8 virtual false final false
static inline ::ArrayW<int8_t,::Array<int8_t>*> GetWnafVar(::ArrayW<uint32_t,::Array<uint32_t>*>  n, int32_t  width) ;

/// @brief Method ImplSign addr 0x1042010 size 0x450 virtual false final false
...
/// @brief Method ImplSign addr 0x1042460 size 0x31c virtual false final false
...
/// @brief Method ImplSign addr 0x104277c size 0x328 virtual false final false
...
/// @brief Method ImplVerify addr 0x1042aa4 size 0x584 virtual false final false
...
/// @brief Method PointAddVar addr 0x10431e4 size 0x220 virtual false final false
...
/// @brief Method PointAddVar addr 0x1043404 size 0x22c virtual false final false
...
/// @brief Method PointAddPrecomp addr 0x1043630 size 0x154 virtual false final false
...
/// @brief Method PointCopy addr 0x1043784 size 0xe0 virtual false final false
...
/// @brief Method PointCopy addr 0x1043864 size 0xe8 virtual false final false
...
/// @brief Method PointDouble addr 0x104394c size 0x158 virtual false final false
static inline void PointDouble(::Org::BouncyCastle::Math::EC::Rfc8032::__Ed25519__PointAccum*  r) ;

/// @brief Method PointExtendXY addr 0x1043aa4 size 0x88 virtual false final false
static inline void PointExtendXY(::Org::BouncyCastle::Math::EC::Rfc8032::__Ed25519__PointAccum*  p) ;

/// @brief Method PointExtendXY addr 0x1041608 size 0x6c virtual false final false
static inline void PointExtendXY(::Org::BouncyCastle::Math::EC::Rfc8032::__Ed25519__PointExt*  p) ;

/// @brief Method PointLookup addr 0x1043b2c size 0x12c virtual false final false
static inline void PointLookup(int32_t  block, int32_t  index, ::Org::BouncyCastle::Math::EC::Rfc8032::__Ed25519__PointPrecomp*  p) ;

/// @brief Method PointPrecompVar addr 0x1043c58 size 0x1c0 virtual false final false
...
/// @brief Method PointSetNeutral addr 0x1043e18 size 0x80 virtual false final false
static inline void PointSetNeutral(::Org::BouncyCastle::Math::EC::Rfc8032::__Ed25519__PointAccum*  p) ;

/// @brief Method PointSetNeutral addr 0x1043e98 size 0x78 virtual false final false
static inline void PointSetNeutral(::Org::BouncyCastle::Math::EC::Rfc8032::__Ed25519__PointExt*  p) ;

/// @brief Method Precompute addr 0x103c35c size 0x804 virtual false final false
static inline void Precompute() ;

/// @brief Method PruneScalar addr 0x1041d14 size 0x58 virtual false final false
static inline void PruneScalar(::ArrayW<uint8_t,::Array<uint8_t>*>  n, int32_t  nOff, ::ArrayW<uint8_t,::Array<uint8_t>*>  r) ;

/// @brief Method ReduceScalar addr 0x10408e8 size 0x494 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReduceScalar(::ArrayW<uint8_t,::Array<uint8_t>*>  n) ;

/// @brief Method ScalarMultBase addr 0x1043f10 size 0x254 virtual false final false
...
/// @brief Method ScalarMultBaseEncoded addr 0x1041d6c size 0xec virtual false final false
static inline void ScalarMultBaseEncoded(::ArrayW<uint8_t,::Array<uint8_t>*>  k, ::ArrayW<uint8_t,::Array<uint8_t>*>  r, int32_t  rOff) ;

/// @brief Method ScalarMultBaseYZ addr 0x103ce8c size 0x178 virtual false final false
...
/// @brief Method ScalarMultStrausVar addr 0x1043028 size 0x1bc virtual false final false
...
/// @brief Method Sign addr 0x1044164 size 0xb0 virtual false final false
...
/// @brief Method Sign addr 0x1044214 size 0xc8 virtual false final false
...
/// @brief Method Sign addr 0x10442dc size 0xbc virtual false final false
...
/// @brief Method Sign addr 0x1044398 size 0xcc virtual false final false
...
/// @brief Method SignPrehash addr 0x1044464 size 0xb8 virtual false final false
...
/// @brief Method SignPrehash addr 0x104451c size 0xd4 virtual false final false
...
/// @brief Method SignPrehash addr 0x10445f0 size 0x1cc virtual false final false
...
/// @brief Method SignPrehash addr 0x10447bc size 0x1e8 virtual false final false
...
/// @brief Method Verify addr 0x10449a4 size 0xb4 virtual false final false
...
/// @brief Method Verify addr 0x1044a58 size 0xc0 virtual false final false
...
/// @brief Method VerifyPrehash addr 0x1044b18 size 0xc0 virtual false final false
...
/// @brief Method VerifyPrehash addr 0x1044bd8 size 0x1d4 virtual false final false
...
/// @brief Method .ctor addr 0x1045054 size 0x8 virtual false final false
inline void _ctor() ;
...
// Static field PrehashSize

// Static field PublicKeySize

// Static field SecretKeySize

// Static field SignatureSize

// Static field Dom2Prefix
...
// Static field precompLock

// Static field precompBaseTable

// Static field precompBase
