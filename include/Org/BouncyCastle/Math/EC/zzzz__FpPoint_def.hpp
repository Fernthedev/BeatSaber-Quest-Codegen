...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::Org::BouncyCastle::Math::EC::AbstractFpPoint)]{};
...
/// @brief Method .ctor addr 0x1052c94 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x104cf5c size 0x8c virtual false final false
...
/// @brief Method .ctor addr 0x104d3e4 size 0xc virtual false final false
...
/// @brief Method Detach addr 0x1052c9c size 0x98 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Detach() ;

/// @brief Method GetZCoord addr 0x1052d34 size 0x64 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* GetZCoord(int32_t  index) ;

/// @brief Method Add addr 0x1052d98 size 0xbe0 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Add(::Org::BouncyCastle::Math::EC::ECPoint*  b) ;

/// @brief Method Twice addr 0x1053978 size 0xb08 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Twice() ;

/// @brief Method TwicePlus addr 0x1054480 size 0x474 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* TwicePlus(::Org::BouncyCastle::Math::EC::ECPoint*  b) ;

/// @brief Method ThreeTimes addr 0x10548f4 size 0x3fc virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* ThreeTimes() ;

/// @brief Method TimesPow2 addr 0x1054cf0 size 0x7dc virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* TimesPow2(int32_t  e) ;

/// @brief Method Two addr 0x10554cc size 0x20 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Two(::Org::BouncyCastle::Math::EC::ECFieldElement*  x) ;

/// @brief Method Three addr 0x10554ec size 0x34 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Three(::Org::BouncyCastle::Math::EC::ECFieldElement*  x) ;

/// @brief Method Four addr 0x1055520 size 0x34 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Four(::Org::BouncyCastle::Math::EC::ECFieldElement*  x) ;

/// @brief Method Eight addr 0x1055554 size 0x34 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* Eight(::Org::BouncyCastle::Math::EC::ECFieldElement*  x) ;

/// @brief Method DoubleProductFromSquares addr 0x1055588 size 0x74 virtual true final false
...
/// @brief Method Negate addr 0x10555fc size 0x120 virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECPoint* Negate() ;

/// @brief Method CalculateJacobianModifiedW addr 0x105571c size 0x154 virtual true final false
...
/// @brief Method GetJacobianModifiedW addr 0x1055870 size 0x8c virtual true final false
inline ::Org::BouncyCastle::Math::EC::ECFieldElement* GetJacobianModifiedW() ;

/// @brief Method TwiceJacobianModified addr 0x10558fc size 0x350 virtual true final false
