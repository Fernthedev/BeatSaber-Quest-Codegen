...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::AbstractF2mPoint*> __get_m_p() const;
...
// Ctor Parameters []
// @brief default ctor
 __WTauNafMultiplier__WTauNafCallback()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x10 - sizeof(::Org::BouncyCastle::Math::EC::Multiplier::AbstractECMultiplier)]{};
