...
/// @brief Method MultiplyPositive addr 0x103aef0 size 0x130 virtual true final false
...
/// @brief Method .ctor addr 0x103b020 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 ZSignedDigitR2LMultiplier()  = default;
public:
