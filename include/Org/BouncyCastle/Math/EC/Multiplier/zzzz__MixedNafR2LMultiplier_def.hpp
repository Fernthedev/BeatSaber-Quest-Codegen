...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::Org::BouncyCastle::Math::EC::Multiplier::AbstractECMultiplier)]{};

/// @brief Field additionCoord offset 0x10
 __declspec(property(get=__get_additionCoord, put=__set_additionCoord)) int32_t  additionCoord;

/// @brief Field doublingCoord offset 0x14
