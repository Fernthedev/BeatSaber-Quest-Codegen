...
/// @brief Method MultiplyPositive addr 0x103adf8 size 0xf0 virtual true final false
...
/// @brief Method .ctor addr 0x103aee8 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 ZSignedDigitL2RMultiplier()  = default;
public:
