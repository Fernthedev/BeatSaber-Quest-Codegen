...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::ECCurve*> Org::BouncyCastle::Math::EC::Multiplier::GlvMultiplier::__get_curve() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Math::EC::ECCurve*, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Math::EC::Endo::GlvEndomorphism*, 0x18>(this, std::forward<::Org::BouncyCastle::Math::EC::Endo::GlvEndomorphism*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Math::EC::Endo::GlvEndomorphism*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Endo::GlvEndomorphism*> Org::BouncyCastle::Math::EC::Multiplier::GlvMultiplier::__get_glvEndomorphism() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Math::EC::Endo::GlvEndomorphism*, 0x18>(this);
}
