...
/// @brief Field m_confWidth offset 0x18
...
// Ctor Parameters []
// @brief default ctor
 __WNafUtilities__ConfigureBasepointCallback()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo*> __get_m_infoP() const;
...
// Ctor Parameters []
// @brief default ctor
 __WNafUtilities__MapPointCallback()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __WNafUtilities__PrecomputeCallback()  = default;
public:
...
/// @brief Field m_point offset 0x10
...
/// @brief Field m_fromWNaf offset 0x20
...
/// @brief Field m_includeNegated offset 0x28
 __declspec(property(get=__get_m_includeNegated, put=__set_m_includeNegated)) bool  m_includeNegated;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Multiplier::WNafPreCompInfo*> __get_m_fromWNaf() const;
...
// Ctor Parameters []
// @brief default ctor
 __WNafUtilities__PrecomputeWithPointMapCallback()  = default;
public:
...
// Static field DEFAULT_WINDOW_SIZE_CUTOFFS

// Static field MAX_WIDTH

// Static field EMPTY_POINTS
