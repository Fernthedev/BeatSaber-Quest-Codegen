...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::Org::BouncyCastle::Math::EC::Multiplier::AbstractECMultiplier)]{};

/// @brief Field curve offset 0x10
 __declspec(property(get=__get_curve, put=__set_curve)) ::Org::BouncyCastle::Math::EC::ECCurve*  curve;

/// @brief Field glvEndomorphism offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::EC::Endo::GlvEndomorphism*> __get_glvEndomorphism() const;
...
/// @brief Method .ctor addr 0x10368d8 size 0xa8 virtual false final false
inline void _ctor(::Org::BouncyCastle::Math::EC::ECCurve*  curve, ::Org::BouncyCastle::Math::EC::Endo::GlvEndomorphism*  glvEndomorphism) ;

/// @brief Method MultiplyPositive addr 0x1036980 size 0x26c virtual true final false
