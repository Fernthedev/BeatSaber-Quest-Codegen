...
/// @brief Field M32 offset 0x0
static constexpr uint64_t  M32{static_cast<uint64_t>(0x55555555u)};

/// @brief Field M64 offset 0x0
static constexpr uint64_t  M64{static_cast<uint64_t>(0x5555555555555555u)};

/// @brief Field M64R offset 0x0
static constexpr uint64_t  M64R{static_cast<uint64_t>(0xaaaaaaaaaaaaaaaau)};

/// @brief Method Expand8to16 addr 0x105bbe4 size 0x20 virtual false final false
static inline uint32_t Expand8to16(uint32_t  x) ;

/// @brief Method Expand16to32 addr 0x105bc04 size 0x28 virtual false final false
static inline uint32_t Expand16to32(uint32_t  x) ;

/// @brief Method Expand32to64 addr 0x105bc2c size 0x58 virtual false final false
static inline uint64_t Expand32to64(uint32_t  x) ;

/// @brief Method Expand64To128 addr 0x105bc84 size 0xa8 virtual false final false
static inline void Expand64To128(uint64_t  x, ::ArrayW<uint64_t,::Array<uint64_t>*>  z, int32_t  zOff) ;

/// @brief Method Expand64To128Rev addr 0x105bd2c size 0xa8 virtual false final false
static inline void Expand64To128Rev(uint64_t  x, ::ArrayW<uint64_t,::Array<uint64_t>*>  z, int32_t  zOff) ;

/// @brief Method Shuffle addr 0x105bdd4 size 0x48 virtual false final false
static inline uint32_t Shuffle(uint32_t  x) ;

/// @brief Method Shuffle addr 0x105be1c size 0x5c virtual false final false
static inline uint64_t Shuffle(uint64_t  x) ;

/// @brief Method Shuffle2 addr 0x105be78 size 0x54 virtual false final false
static inline uint32_t Shuffle2(uint32_t  x) ;

/// @brief Method Unshuffle addr 0x105becc size 0x48 virtual false final false
static inline uint32_t Unshuffle(uint32_t  x) ;

/// @brief Method Unshuffle addr 0x105bf14 size 0x5c virtual false final false
static inline uint64_t Unshuffle(uint64_t  x) ;

/// @brief Method Unshuffle2 addr 0x105bf70 size 0x54 virtual false final false
static inline uint32_t Unshuffle2(uint32_t  x) ;

static inline ::Org::BouncyCastle::Math::Raw::Interleave* New_ctor() ;

/// @brief Method .ctor addr 0x105bfc4 size 0x8 virtual false final false
inline void _ctor() ;
