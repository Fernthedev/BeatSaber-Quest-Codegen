...
/// @brief Method Add addr 0x106721c size 0x16c virtual false final false
...
/// @brief Method Add addr 0x1067388 size 0x214 virtual false final false
...
/// @brief Method AddBothTo addr 0x106759c size 0x1a4 virtual false final false
...
/// @brief Method AddBothTo addr 0x1067740 size 0x24c virtual false final false
...
/// @brief Method AddTo addr 0x106798c size 0x130 virtual false final false
static inline uint32_t AddTo(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method AddTo addr 0x1067abc size 0x1a8 virtual false final false
...
/// @brief Method AddToEachOther addr 0x1067c64 size 0x1d0 virtual false final false
...
/// @brief Method Copy addr 0x1067e34 size 0xc4 virtual false final false
static inline void Copy(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method Copy addr 0x1067ef8 size 0x134 virtual false final false
static inline void Copy(::ArrayW<uint32_t,::Array<uint32_t>*>  x, int32_t  xOff, ::ArrayW<uint32_t,::Array<uint32_t>*>  z, int32_t  zOff) ;

/// @brief Method Create addr 0x106802c size 0x44 virtual false final false
static inline ::ArrayW<uint32_t,::Array<uint32_t>*> Create() ;

/// @brief Method CreateExt addr 0x1068070 size 0x44 virtual false final false
static inline ::ArrayW<uint32_t,::Array<uint32_t>*> CreateExt() ;

/// @brief Method Diff addr 0x10680b4 size 0x7c virtual false final false
...
/// @brief Method Mul addr 0x1068860 size 0x2ec virtual false final false
...
/// @brief Method MulAddTo addr 0x1068b4c size 0x190 virtual false final false
...
/// @brief Method MulAddTo addr 0x1068cdc size 0x240 virtual false final false
...
/// @brief Method Mul33Add addr 0x1068f1c size 0x230 virtual false final false
...
/// @brief Method MulByWord addr 0x106914c size 0xc4 virtual false final false
static inline uint32_t MulByWord(uint32_t  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method MulByWordAddTo addr 0x1069210 size 0x134 virtual false final false
static inline uint32_t MulByWordAddTo(uint32_t  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  y, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method MulWordAddTo addr 0x1069344 size 0x1a4 virtual false final false
...
/// @brief Method Sub addr 0x10681b0 size 0x214 virtual false final false
...
/// @brief Method SubBothFrom addr 0x106a00c size 0x1a4 virtual false final false
...
/// @brief Method SubFrom addr 0x106a1b0 size 0x130 virtual false final false
static inline int32_t SubFrom(::ArrayW<uint32_t,::Array<uint32_t>*>  x, ::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

/// @brief Method SubFrom addr 0x106a2e0 size 0x1b0 virtual false final false
...
/// @brief Method ToBigInteger addr 0x106a490 size 0xe4 virtual false final false
static inline ::Org::BouncyCastle::Math::BigInteger* ToBigInteger(::ArrayW<uint32_t,::Array<uint32_t>*>  x) ;

/// @brief Method Zero addr 0x106a574 size 0x6c virtual false final false
static inline void Zero(::ArrayW<uint32_t,::Array<uint32_t>*>  z) ;

static inline ::Org::BouncyCastle::Math::Raw::Nat224* New_ctor() ;

/// @brief Method .ctor addr 0x106a5e0 size 0x8 virtual false final false
inline void _ctor() ;
