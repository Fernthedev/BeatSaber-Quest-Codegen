...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::Field::IFiniteField*> __get_subfield() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::Field::IPolynomial*> __get_minimalPolynomial() const;
...
// Ctor Parameters []
// @brief default ctor
 GenericPolynomialExtensionField()  = default;
public:
