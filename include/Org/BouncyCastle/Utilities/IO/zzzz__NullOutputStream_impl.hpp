...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Utilities::IO::NullOutputStream::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t)>(&::Org::BouncyCastle::Utilities::IO::NullOutputStream::Write)> {
  constexpr static std::size_t size = 0x4;
  constexpr static std::size_t addrs = 0x115fba4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Utilities::IO::NullOutputStream::*)()>(&::Org::BouncyCastle::Utilities::IO::NullOutputStream::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x115fba8;
...
return THROW_UNLESS(::il2cpp_utils::New<::Org::BouncyCastle::Utilities::IO::NullOutputStream*>());
}
