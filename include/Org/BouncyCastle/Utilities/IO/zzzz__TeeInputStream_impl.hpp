...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Org::BouncyCastle::Utilities::IO::TeeInputStream::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t)>(&::Org::BouncyCastle::Utilities::IO::TeeInputStream::Read)> {
...
constexpr ::cordl_internals::to_const_pointer<::System::IO::Stream*> Org::BouncyCastle::Utilities::IO::TeeInputStream::__get_input() const {
return ::cordl_internals::getInstanceField<::System::IO::Stream*, 0x30>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::System::IO::Stream*> Org::BouncyCastle::Utilities::IO::TeeInputStream::__get_tee() const {
return ::cordl_internals::getInstanceField<::System::IO::Stream*, 0x38>(this);
}
