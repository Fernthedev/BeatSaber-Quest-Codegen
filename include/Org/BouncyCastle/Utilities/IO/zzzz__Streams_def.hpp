...
/// @brief Method .ctor addr 0x115fcc8 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method Drain addr 0x115fcd0 size 0x84 virtual false final false
static inline void Drain(::System::IO::Stream*  inStr) ;

/// @brief Method ReadAll addr 0x115fd54 size 0x78 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadAll(::System::IO::Stream*  inStr) ;

/// @brief Method ReadAllLimited addr 0x115feac size 0x88 virtual false final false
static inline ::ArrayW<uint8_t,::Array<uint8_t>*> ReadAllLimited(::System::IO::Stream*  inStr, int32_t  limit) ;

/// @brief Method ReadFully addr 0x116007c size 0x1c virtual false final false
static inline int32_t ReadFully(::System::IO::Stream*  inStr, ::ArrayW<uint8_t,::Array<uint8_t>*>  buf) ;

/// @brief Method ReadFully addr 0x1160098 size 0x80 virtual false final false
static inline int32_t ReadFully(::System::IO::Stream*  inStr, ::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method PipeAll addr 0x115fdcc size 0xe0 virtual false final false
static inline void PipeAll(::System::IO::Stream*  inStr, ::System::IO::Stream*  outStr) ;

/// @brief Method PipeAllLimited addr 0x115ff34 size 0x148 virtual false final false
static inline int64_t PipeAllLimited(::System::IO::Stream*  inStr, int64_t  limit, ::System::IO::Stream*  outStr) ;

/// @brief Method WriteBufTo addr 0x1160118 size 0x20 virtual false final false
static inline void WriteBufTo(::System::IO::MemoryStream*  buf, ::System::IO::Stream*  output) ;

/// @brief Method WriteBufTo addr 0x1160138 size 0xb4 virtual false final false
static inline int32_t WriteBufTo(::System::IO::MemoryStream*  buf, ::ArrayW<uint8_t,::Array<uint8_t>*>  output, int32_t  offset) ;

/// @brief Method WriteZeroes addr 0x11601ec size 0xb0 virtual false final false
