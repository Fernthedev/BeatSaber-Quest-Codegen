...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Collections::LinkedDictionary*> __get_parent() const;
...
// Ctor Parameters []
// @brief default ctor
 LinkedDictionaryEnumerator()  = default;
public:
