...
/// @brief Method .ctor addr 0x1157ab4 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method MoveNext addr 0x1157abc size 0x8 virtual true final true
inline bool MoveNext() ;

/// @brief Method Reset addr 0x1157ac4 size 0x4 virtual true final true
inline void Reset() ;

/// @brief Method get_Current addr 0x1157ac8 size 0x50 virtual true final true
