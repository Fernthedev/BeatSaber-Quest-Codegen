...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Org::BouncyCastle::Utilities::Encoders::BufferedEncoder::*)(uint8_t, ::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t)>(&::Org::BouncyCastle::Utilities::Encoders::BufferedEncoder::ProcessByte)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::Org::BouncyCastle::Utilities::Encoders::BufferedEncoder::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t, ::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t)>(&::Org::BouncyCastle::Utilities::Encoders::BufferedEncoder::ProcessBytes)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Utilities::Encoders::ITranslator*, 0x20>(this, std::forward<::Org::BouncyCastle::Utilities::Encoders::ITranslator*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Utilities::Encoders::ITranslator*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Encoders::ITranslator*> Org::BouncyCastle::Utilities::Encoders::BufferedEncoder::__get_translator() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Utilities::Encoders::ITranslator*, 0x20>(this);
}
