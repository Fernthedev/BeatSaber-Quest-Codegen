...
/// @brief Field translator offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Encoders::ITranslator*> __get_translator() const;
...
/// @brief Method .ctor addr 0x115d34c size 0x13c virtual false final false
inline void _ctor(::Org::BouncyCastle::Utilities::Encoders::ITranslator*  translator, int32_t  bufferSize) ;

/// @brief Method ProcessByte addr 0x115d488 size 0x128 virtual false final false
inline int32_t ProcessByte(uint8_t  input, ::ArrayW<uint8_t,::Array<uint8_t>*>  outBytes, int32_t  outOff) ;

/// @brief Method ProcessBytes addr 0x115d5b0 size 0x264 virtual false final false
