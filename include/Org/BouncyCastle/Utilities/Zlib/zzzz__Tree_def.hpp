...
/// @brief Field MAX_BL_BITS offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Zlib::StaticTree*> __get_stat_desc() const;
...
// Static field extra_lbits

// Static field extra_dbits

// Static field extra_blbits

// Static field bl_order

// Static field _dist_code

// Static field _length_code

// Static field base_length

// Static field base_dist
