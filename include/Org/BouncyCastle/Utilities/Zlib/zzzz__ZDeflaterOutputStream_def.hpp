...
/// @brief Field flushLevel offset 0x30
...
/// @brief Field buf1 offset 0x40
 __declspec(property(get=__get_buf1, put=__set_buf1)) ::ArrayW<uint8_t,::Array<uint8_t>*>  buf1;

/// @brief Field outp offset 0x48
 __declspec(property(get=__get_outp, put=__set_outp)) ::System::IO::Stream*  outp;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Utilities::Zlib::ZStream*> __get_z() const;
...
constexpr ::System::IO::Stream* __get_outp() ;

constexpr ::cordl_internals::to_const_pointer<::System::IO::Stream*> __get_outp() const;
