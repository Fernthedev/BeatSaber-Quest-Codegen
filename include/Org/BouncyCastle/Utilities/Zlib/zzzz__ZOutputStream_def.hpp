...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x60 - sizeof(::System::IO::Stream)]{};
...
constexpr ::cordl_internals::to_const_pointer<::System::IO::Stream*> __get_output() const;
