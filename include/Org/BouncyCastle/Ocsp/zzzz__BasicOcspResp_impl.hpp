...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (::Org::BouncyCastle::Ocsp::BasicOcspResp::*)()>(&::Org::BouncyCastle::Ocsp::BasicOcspResp::GetTbsResponseData)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::Org::BouncyCastle::Ocsp::SingleResp*,::Array<::Org::BouncyCastle::Ocsp::SingleResp*>*> (::Org::BouncyCastle::Ocsp::BasicOcspResp::*)()>(&::Org::BouncyCastle::Ocsp::BasicOcspResp::get_Responses)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (::Org::BouncyCastle::Ocsp::BasicOcspResp::*)()>(&::Org::BouncyCastle::Ocsp::BasicOcspResp::GetSignature)> {
  constexpr static std::size_t size = 0x1c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::Org::BouncyCastle::X509::X509Certificate*,::Array<::Org::BouncyCastle::X509::X509Certificate*>*> (::Org::BouncyCastle::Ocsp::BasicOcspResp::*)()>(&::Org::BouncyCastle::Ocsp::BasicOcspResp::GetCerts)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<uint8_t,::Array<uint8_t>*> (::Org::BouncyCastle::Ocsp::BasicOcspResp::*)()>(&::Org::BouncyCastle::Ocsp::BasicOcspResp::GetEncoded)> {
  constexpr static std::size_t size = 0x1c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::Org::BouncyCastle::Ocsp::BasicOcspResp::*)(::System::Object*)>(&::Org::BouncyCastle::Ocsp::BasicOcspResp::Equals)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Asn1::Ocsp::BasicOcspResponse*, 0x10>(this, std::forward<::Org::BouncyCastle::Asn1::Ocsp::BasicOcspResponse*>(value));
}
constexpr ::Org::BouncyCastle::Asn1::Ocsp::BasicOcspResponse* Org::BouncyCastle::Ocsp::BasicOcspResp::__get_resp()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Ocsp::BasicOcspResponse*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Ocsp::BasicOcspResponse*> Org::BouncyCastle::Ocsp::BasicOcspResp::__get_resp() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Ocsp::BasicOcspResponse*, 0x10>(this);
}
constexpr void Org::BouncyCastle::Ocsp::BasicOcspResp::__set_data(::Org::BouncyCastle::Asn1::Ocsp::ResponseData*  value)  {
::cordl_internals::setInstanceField<::Org::BouncyCastle::Asn1::Ocsp::ResponseData*, 0x18>(this, std::forward<::Org::BouncyCastle::Asn1::Ocsp::ResponseData*>(value));
}
constexpr ::Org::BouncyCastle::Asn1::Ocsp::ResponseData* Org::BouncyCastle::Ocsp::BasicOcspResp::__get_data()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Ocsp::ResponseData*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Ocsp::ResponseData*> Org::BouncyCastle::Ocsp::BasicOcspResp::__get_data() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Ocsp::ResponseData*, 0x18>(this);
}
