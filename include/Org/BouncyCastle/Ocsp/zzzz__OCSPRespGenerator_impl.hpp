...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Ocsp::OcspResp* (::Org::BouncyCastle::Ocsp::OCSPRespGenerator::*)(int32_t, ::System::Object*)>(&::Org::BouncyCastle::Ocsp::OCSPRespGenerator::Generate)> {
  constexpr static std::size_t size = 0x318;
  constexpr static std::size_t addrs = 0x10a2248;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Ocsp::OCSPRespGenerator::*)()>(&::Org::BouncyCastle::Ocsp::OCSPRespGenerator::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x10a2560;
...
return THROW_UNLESS(::il2cpp_utils::New<::Org::BouncyCastle::Ocsp::OCSPRespGenerator*>());
}
