...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x10 - sizeof(::Org::BouncyCastle::Ocsp::OcspRespStatus)]{};

static inline ::Org::BouncyCastle::Ocsp::OcscpRespStatus* New_ctor() ;

/// @brief Method .ctor addr 0x10a2570 size 0x8 virtual false final false
inline void _ctor() ;
