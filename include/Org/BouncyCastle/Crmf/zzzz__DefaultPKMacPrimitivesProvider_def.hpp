...
/// @brief Method CreateDigest addr 0x121075c size 0x78 virtual true final true
inline ::Org::BouncyCastle::Crypto::IDigest* CreateDigest(::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*  digestAlg) ;

/// @brief Method CreateMac addr 0x12107d4 size 0x78 virtual true final true
...
/// @brief Method .ctor addr 0x121084c size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 DefaultPKMacPrimitivesProvider()  = default;
public:
