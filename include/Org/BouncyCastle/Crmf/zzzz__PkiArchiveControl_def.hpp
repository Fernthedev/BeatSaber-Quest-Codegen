...
/// @brief Field pkiArchiveOptions offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Crmf::PkiArchiveOptions*> __get_pkiArchiveOptions() const;
...
/// @brief Method .ctor addr 0x120e268 size 0x28 virtual false final false
inline void _ctor(::Org::BouncyCastle::Asn1::Crmf::PkiArchiveOptions*  pkiArchiveOptions) ;

/// @brief Method get_Type addr 0x12117d0 size 0x58 virtual true final true
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_Type() ;

/// @brief Method get_Value addr 0x1211828 size 0x8 virtual true final true
inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Value() ;

/// @brief Method get_ArchiveType addr 0x1211830 size 0x20 virtual false final false
inline int32_t get_ArchiveType() ;

/// @brief Method get_EnvelopedData addr 0x1211850 size 0x44 virtual false final false
inline bool get_EnvelopedData() ;

/// @brief Method GetEnvelopedData addr 0x1211894 size 0x264 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 PkiArchiveControl()  = default;
public:


// Fields

// Static field encryptedPrivKey

// Static field keyGenParameters

// Static field archiveRemGenPrivKey
