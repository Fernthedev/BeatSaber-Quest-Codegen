...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Cms::CmsEnvelopedDataGenerator*, 0x10>(this, std::forward<::Org::BouncyCastle::Cms::CmsEnvelopedDataGenerator*>(value));
}
constexpr ::Org::BouncyCastle::Cms::CmsEnvelopedDataGenerator* Org::BouncyCastle::Crmf::PkiArchiveControlBuilder::__get_envGen()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Cms::CmsEnvelopedDataGenerator*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Cms::CmsEnvelopedDataGenerator*> Org::BouncyCastle::Crmf::PkiArchiveControlBuilder::__get_envGen() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Cms::CmsEnvelopedDataGenerator*, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Cms::CmsProcessableByteArray*, 0x18>(this, std::forward<::Org::BouncyCastle::Cms::CmsProcessableByteArray*>(value));
}
constexpr ::Org::BouncyCastle::Cms::CmsProcessableByteArray* Org::BouncyCastle::Crmf::PkiArchiveControlBuilder::__get_keyContent()  {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Cms::CmsProcessableByteArray*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Cms::CmsProcessableByteArray*> Org::BouncyCastle::Crmf::PkiArchiveControlBuilder::__get_keyContent() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Cms::CmsProcessableByteArray*, 0x18>(this);
}
