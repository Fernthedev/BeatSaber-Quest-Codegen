...
/// @brief Field _templateBuilder offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Math::BigInteger*> __get__certReqId() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::X509ExtensionsGenerator*> __get__extGenerator() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> __get__controls() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::ISignatureFactory*> __get__popSigner() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crmf::PKMacBuilder*> __get__pkMacBuilder() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::GeneralName*> __get__sender() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Crmf::PopoPrivKey*> __get__popoPrivKey() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Asn1Null*> __get__popRaVerified() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Crmf::PKMacValue*> __get__agreeMac() const;

static inline ::Org::BouncyCastle::Crmf::CertificateRequestMessageBuilder* New_ctor(::Org::BouncyCastle::Math::BigInteger*  certReqId) ;

/// @brief Method .ctor addr 0x120ea84 size 0xe4 virtual false final false
inline void _ctor(::Org::BouncyCastle::Math::BigInteger*  certReqId) ;

/// @brief Method SetPublicKey addr 0x120eb68 size 0x30 virtual false final false
...
/// @brief Method SetValidity addr 0x120ec88 size 0x94 virtual false final false
...
/// @brief Method AddExtension addr 0x120ed1c size 0x2c virtual false final false
...
/// @brief Method AddExtension addr 0x120ed48 size 0x2c virtual false final false
...
/// @brief Method AddControl addr 0x120ed74 size 0xb4 virtual false final false
inline ::Org::BouncyCastle::Crmf::CertificateRequestMessageBuilder* AddControl(::Org::BouncyCastle::Crmf::IControl*  control) ;

/// @brief Method SetProofOfPossessionSignKeySigner addr 0x120ee28 size 0x74 virtual false final false
...
/// @brief Method SetProofOfPossessionSubsequentMessage addr 0x120ee9c size 0xd8 virtual false final false
...
/// @brief Method SetProofOfPossessionSubsequentMessage addr 0x120ef74 size 0x124 virtual false final false
...
/// @brief Method SetProofOfPossessionAgreeMac addr 0x120f098 size 0x74 virtual false final false
...
/// @brief Method SetProofOfPossessionRaVerified addr 0x120f10c size 0xc0 virtual false final false
inline ::Org::BouncyCastle::Crmf::CertificateRequestMessageBuilder* SetProofOfPossessionRaVerified() ;

/// @brief Method SetAuthInfoPKMAC addr 0x120f1cc size 0x8 virtual false final false
...
/// @brief Method SetAuthInfoSender addr 0x120f1d4 size 0x74 virtual false final false
...
/// @brief Method SetAuthInfoSender addr 0x120f248 size 0x8 virtual false final false
...
/// @brief Method Build addr 0x120f250 size 0x95c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 CertificateRequestMessageBuilder()  = default;
public:
