...
/// @brief Field timeStampToken offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Tsp::TimeStampResp*> __get_resp() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Tsp::TimeStampToken*> __get_timeStampToken() const;
