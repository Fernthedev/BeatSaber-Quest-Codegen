...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::Org::BouncyCastle::Cms::KeyTransRecipientInfoGenerator)]{};

/// @brief Field keyWrapper offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::IKeyWrapper*> __get_keyWrapper() const;
...
// Ctor Parameters []
// @brief default ctor
 CmsKeyTransRecipientInfoGenerator()  = default;
public:
