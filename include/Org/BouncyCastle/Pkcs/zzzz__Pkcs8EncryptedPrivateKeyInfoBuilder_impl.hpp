...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder::*)(::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder::_ctor)> {
...
::cordl_internals::setInstanceField<::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo*, 0x10>(this, std::forward<::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo*>(value));
}
...
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo*> Org::BouncyCastle::Pkcs::Pkcs8EncryptedPrivateKeyInfoBuilder::__get_privateKeyInfo() const {
return ::cordl_internals::getInstanceField<::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo*, 0x10>(this);
}
