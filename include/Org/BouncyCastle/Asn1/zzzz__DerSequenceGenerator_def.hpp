...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::Org::BouncyCastle::Asn1::DerGenerator)]{};

/// @brief Field _bOut offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::IO::MemoryStream*> __get__bOut() const;
