...
/// @brief Field UBDataGroups offset 0x0
...
/// @brief Field digestAlgorithmIdentifier offset 0x18
...
/// @brief Field datagroupHash offset 0x20
 __declspec(property(get=__get_datagroupHash, put=__set_datagroupHash)) ::ArrayW<::Org::BouncyCastle::Asn1::Icao::DataGroupHash*,::Array<::Org::BouncyCastle::Asn1::Icao::DataGroupHash*>*>  datagroupHash;

/// @brief Field versionInfo offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*> __get_digestAlgorithmIdentifier() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Icao::LdsVersionInfo*> __get_versionInfo() const;
