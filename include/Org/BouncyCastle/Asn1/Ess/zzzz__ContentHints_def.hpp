...
/// @brief Field contentDescription offset 0x10
...
/// @brief Field contentType offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::DerUtf8String*> __get_contentDescription() const;
