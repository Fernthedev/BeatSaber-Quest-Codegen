...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::Org::BouncyCastle::Asn1::DerApplicationSpecific)]{};
...
/// @brief Method .ctor addr 0x11bbb94 size 0x4 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 BerApplicationSpecific()  = default;
public:
