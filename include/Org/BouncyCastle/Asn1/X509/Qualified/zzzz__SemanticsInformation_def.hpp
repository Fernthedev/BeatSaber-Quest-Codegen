...
/// @brief Field semanticsIdentifier offset 0x10
...
/// @brief Field nameRegistrationAuthorities offset 0x18
 __declspec(property(get=__get_nameRegistrationAuthorities, put=__set_nameRegistrationAuthorities)) ::ArrayW<::Org::BouncyCastle::Asn1::X509::GeneralName*,::Array<::Org::BouncyCastle::Asn1::X509::GeneralName*>*>  nameRegistrationAuthorities;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::DerObjectIdentifier*> __get_semanticsIdentifier() const;
