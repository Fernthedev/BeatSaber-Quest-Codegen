...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IEnumerator*> __get_e() const;
...
// Ctor Parameters []
// @brief default ctor
 __TbsCertificateList__RevokedCertificatesEnumeration__RevokedCertificatesEnumerator()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IEnumerable*> __get_en() const;
...
// Ctor Parameters []
// @brief default ctor
 __TbsCertificateList__RevokedCertificatesEnumeration()  = default;
public:
...
/// @brief Field crlExtensions offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Asn1Sequence*> __get_revokedCertificates() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::X509Extensions*> __get_crlExtensions() const;
