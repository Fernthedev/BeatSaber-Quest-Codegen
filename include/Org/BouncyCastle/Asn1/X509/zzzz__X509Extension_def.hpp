...
/// @brief Field critical offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Asn1OctetString*> __get_value() const;
...
/// @brief Method .ctor addr 0x119dc5c size 0x90 virtual false final false
...
/// @brief Method .ctor addr 0x119c014 size 0x30 virtual false final false
inline void _ctor(bool  critical, ::Org::BouncyCastle::Asn1::Asn1OctetString*  value) ;

/// @brief Method get_IsCritical addr 0x119dcec size 0x8 virtual false final false
inline bool get_IsCritical() ;

/// @brief Method get_Value addr 0x119dcf4 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_Value() ;

/// @brief Method GetParsedValue addr 0x119dcfc size 0x4 virtual false final false
inline ::Org::BouncyCastle::Asn1::Asn1Encodable* GetParsedValue() ;

/// @brief Method GetHashCode addr 0x119dd00 size 0x30 virtual true final false
inline int32_t GetHashCode() ;

/// @brief Method Equals addr 0x119dd30 size 0xbc virtual true final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method ConvertValueToObject addr 0x118cf6c size 0x108 virtual false final false
