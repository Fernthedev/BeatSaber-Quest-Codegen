...
/// @brief Field tbsCert offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::TbsCertificateStructure*> __get_tbsCert() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::DerBitString*> __get_sig() const;
...
// Ctor Parameters []
// @brief default ctor
 X509CertificateStructure()  = default;
public:
