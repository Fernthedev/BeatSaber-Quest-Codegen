...
/// @brief Field signatureValue offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::AttributeCertificateInfo*> __get_acinfo() const;
...
/// @brief Method GetInstance addr 0x1084344 size 0xa4 virtual false final false
...
/// @brief Method .ctor addr 0x1084564 size 0x3c virtual false final false
...
/// @brief Method .ctor addr 0x10843e8 size 0x17c virtual false final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_ACInfo addr 0x1084728 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::X509::AttributeCertificateInfo* get_ACInfo() ;

/// @brief Method get_SignatureAlgorithm addr 0x1084730 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_SignatureAlgorithm() ;

/// @brief Method get_SignatureValue addr 0x1084738 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::DerBitString* get_SignatureValue() ;

/// @brief Method GetSignatureOctets addr 0x1084740 size 0x20 virtual false final false
inline ::ArrayW<uint8_t,::Array<uint8_t>*> GetSignatureOctets() ;

/// @brief Method ToAsn1Object addr 0x1084760 size 0x11c virtual true final false
