...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes* (*)(::System::Object*)>(&::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes::GetInstance)> {
  constexpr static std::size_t size = 0x188;
  constexpr static std::size_t addrs = 0x1196688;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes::*)(::Org::BouncyCastle::Asn1::Asn1Sequence*)>(&::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes::_ctor)> {
  constexpr static std::size_t size = 0x360;
  constexpr static std::size_t addrs = 0x1196810;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes::*)(::System::Collections::ArrayList*)>(&::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes::*)(::System::Collections::IList*)>(&::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::Org::BouncyCastle::Asn1::Asn1Object* (::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes::*)()>(&::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes::ToAsn1Object)> {
  constexpr static std::size_t size = 0x2c8;
  constexpr static std::size_t addrs = 0x1196bec;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::IEnumerable* (::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes::*)()>(&::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes::get_Attributes)> {
  constexpr static std::size_t size = 0x68;
  constexpr static std::size_t addrs = 0x1196eb4;
...
constexpr void Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes::__set_attributes(::System::Collections::IList*  value)  {
::cordl_internals::setInstanceField<::System::Collections::IList*, 0x10>(this, std::forward<::System::Collections::IList*>(value));
}
constexpr ::System::Collections::IList* Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes::__get_attributes()  {
return ::cordl_internals::getInstanceField<::System::Collections::IList*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes::__get_attributes() const {
return ::cordl_internals::getInstanceField<::System::Collections::IList*, 0x10>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes*>(seq));
}
...
return THROW_UNLESS(::il2cpp_utils::New<::Org::BouncyCastle::Asn1::X509::SubjectDirectoryAttributes*>(attributes));
}
