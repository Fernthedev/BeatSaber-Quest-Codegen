...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Asn1Set*> __get_outer() const;
...
// Ctor Parameters []
// @brief default ctor
 __Asn1Set__Asn1SetParserImpl()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __Asn1Set__DerComparer()  = default;
public:
