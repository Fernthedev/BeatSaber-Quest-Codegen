...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::Org::BouncyCastle::Asn1::LimitedInputStream)]{};

/// @brief Field _originalLength offset 0x3c
 __declspec(property(get=__get__originalLength, put=__set__originalLength)) int32_t  _originalLength;

/// @brief Field _remaining offset 0x40
...
/// @brief Method .ctor addr 0x11b4720 size 0xc8 virtual false final false
inline void _ctor(::System::IO::Stream*  inStream, int32_t  length, int32_t  limit) ;

/// @brief Method get_Remaining addr 0x11c0180 size 0x8 virtual false final false
inline int32_t get_Remaining() ;

/// @brief Method ReadByte addr 0x11c0188 size 0x1e4 virtual true final false
inline int32_t ReadByte() ;

/// @brief Method Read addr 0x11c036c size 0x254 virtual true final false
inline int32_t Read(::ArrayW<uint8_t,::Array<uint8_t>*>  buf, int32_t  off, int32_t  len) ;

/// @brief Method ReadAllIntoByteArray addr 0x11b69e8 size 0x3a4 virtual false final false
inline void ReadAllIntoByteArray(::ArrayW<uint8_t,::Array<uint8_t>*>  buf) ;

/// @brief Method ToArray addr 0x11b47e8 size 0x3a8 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 DefiniteLengthInputStream()  = default;
public:
