...
/// @brief Field sigPolicy offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Esf::SignaturePolicyId*> __get_sigPolicy() const;

/// @brief Method GetInstance addr 0xe9843c size 0x1dc virtual false final false
...
/// @brief Method .ctor addr 0xe98690 size 0x1c virtual false final false
inline void _ctor() ;
...
/// @brief Method .ctor addr 0xe98618 size 0x78 virtual false final false
inline void _ctor(::Org::BouncyCastle::Asn1::Esf::SignaturePolicyId*  signaturePolicyId) ;

/// @brief Method get_SignaturePolicyId addr 0xe986ac size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::Esf::SignaturePolicyId* get_SignaturePolicyId() ;

/// @brief Method ToAsn1Object addr 0xe986b4 size 0x78 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 SignaturePolicyIdentifier()  = default;
public:
