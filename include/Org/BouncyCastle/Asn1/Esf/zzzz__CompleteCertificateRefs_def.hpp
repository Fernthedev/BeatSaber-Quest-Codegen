...
/// @brief Field otherCertIDs offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Asn1Sequence*> __get_otherCertIDs() const;
...
// Ctor Parameters []
// @brief default ctor
 CompleteCertificateRefs()  = default;
public:
