...
/// @brief Field crlOcspRefs offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Asn1Sequence*> __get_crlOcspRefs() const;
...
// Ctor Parameters []
// @brief default ctor
 CompleteRevocationRefs()  = default;
public:
