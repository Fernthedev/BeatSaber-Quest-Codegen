...
/// @brief Field x509v3PKCert offset 0x10
...
/// @brief Field x509v2AttrCert offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::X509CertificateStructure*> __get_x509v3PKCert() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::AttributeCertificate*> __get_x509v2AttrCert() const;
