...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::BerOctetStringGenerator*> __get__gen() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::DerOutputStream*> __get__derOut() const;
...
// Ctor Parameters []
// @brief default ctor
 __BerOctetStringGenerator__BufferedBerOctetStream()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::Org::BouncyCastle::Asn1::BerGenerator)]{};
...
// Ctor Parameters []
// @brief default ctor
 BerOctetStringGenerator()  = default;
public:
