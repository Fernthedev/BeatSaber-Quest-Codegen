...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::DerObjectIdentifier*> __get_oriType() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Asn1Encodable*> __get_oriValue() const;
...
/// @brief Method .ctor addr 0xe7b964 size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0xe7b990 size 0xac virtual false final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method GetInstance addr 0xe7ba3c size 0x18 virtual false final false
...
/// @brief Method GetInstance addr 0xe7ba54 size 0xa4 virtual false final false
static inline ::Org::BouncyCastle::Asn1::Cms::OtherRecipientInfo* GetInstance(::System::Object*  obj) ;

/// @brief Method get_OriType addr 0xe7baf8 size 0x8 virtual true final false
inline ::Org::BouncyCastle::Asn1::DerObjectIdentifier* get_OriType() ;

/// @brief Method get_OriValue addr 0xe7bb00 size 0x8 virtual true final false
inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_OriValue() ;

/// @brief Method ToAsn1Object addr 0xe7bb08 size 0xf0 virtual true final false
