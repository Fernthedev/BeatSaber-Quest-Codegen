...
/// @brief Field issuerSerial offset 0x10
...
/// @brief Field rKeyID offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::IssuerAndSerialNumber*> __get_issuerSerial() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::RecipientKeyIdentifier*> __get_rKeyID() const;
...
// Ctor Parameters []
// @brief default ctor
 KeyAgreeRecipientIdentifier()  = default;
public:
