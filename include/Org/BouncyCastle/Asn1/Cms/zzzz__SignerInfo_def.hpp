...
/// @brief Field authenticatedAttributes offset 0x28
...
/// @brief Field digEncryptionAlgorithm offset 0x30
...
/// @brief Field encryptedDigest offset 0x38
...
/// @brief Field unauthenticatedAttributes offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Cms::SignerIdentifier*> __get_sid() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*> __get_digAlgorithm() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Asn1Set*> __get_authenticatedAttributes() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*> __get_digEncryptionAlgorithm() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Asn1OctetString*> __get_encryptedDigest() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Asn1Set*> __get_unauthenticatedAttributes() const;

/// @brief Method GetInstance addr 0xe80c3c size 0x188 virtual false final false
...
/// @brief Method .ctor addr 0xe81470 size 0xc8 virtual false final false
...
/// @brief Method .ctor addr 0xe815c4 size 0xe4 virtual false final false
...
/// @brief Method .ctor addr 0xe80dc4 size 0x6ac virtual false final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_Version addr 0xe816a8 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::DerInteger* get_Version() ;

/// @brief Method get_SignerID addr 0xe816b0 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::Cms::SignerIdentifier* get_SignerID() ;

/// @brief Method get_AuthenticatedAttributes addr 0xe816b8 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::Asn1Set* get_AuthenticatedAttributes() ;

/// @brief Method get_DigestAlgorithm addr 0xe816c0 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestAlgorithm() ;

/// @brief Method get_EncryptedDigest addr 0xe816c8 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::Asn1OctetString* get_EncryptedDigest() ;

/// @brief Method get_DigestEncryptionAlgorithm addr 0xe816d0 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_DigestEncryptionAlgorithm() ;

/// @brief Method get_UnauthenticatedAttributes addr 0xe816d8 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::Asn1Set* get_UnauthenticatedAttributes() ;

/// @brief Method ToAsn1Object addr 0xe816e0 size 0x1fc virtual true final false
