...
/// @brief Field otherRevInfoFormat offset 0x10
...
/// @brief Field otherRevInfo offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::DerObjectIdentifier*> __get_otherRevInfoFormat() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Asn1Encodable*> __get_otherRevInfo() const;
...
// Ctor Parameters []
// @brief default ctor
 OtherRevocationInfoFormat()  = default;
public:
