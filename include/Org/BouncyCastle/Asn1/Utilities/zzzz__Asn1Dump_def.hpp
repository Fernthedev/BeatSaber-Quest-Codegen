...
/// @brief Field SampleSize offset 0x0
...
/// @brief Method .ctor addr 0x107b108 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method AsString addr 0x107b110 size 0x2664 virtual false final false
...
/// @brief Method outputApplicationSpecific addr 0x107d9dc size 0x8d4 virtual false final false
...
/// @brief Method DumpAsString addr 0x107e2b0 size 0x184 virtual false final false
static inline ::StringW DumpAsString(::System::Object*  obj) ;

/// @brief Method DumpAsString addr 0x107e434 size 0x58 virtual false final false
static inline ::StringW DumpAsString(::Org::BouncyCastle::Asn1::Asn1Encodable*  obj) ;

/// @brief Method DumpAsString addr 0x107e48c size 0xd8 virtual false final false
static inline ::StringW DumpAsString(::Org::BouncyCastle::Asn1::Asn1Encodable*  obj, bool  verbose) ;

/// @brief Method dumpBinaryDataAsString addr 0x107d774 size 0x268 virtual false final false
static inline ::StringW dumpBinaryDataAsString(::StringW  indent, ::ArrayW<uint8_t,::Array<uint8_t>*>  bytes) ;

/// @brief Method calculateAscString addr 0x107e564 size 0xb8 virtual false final false
