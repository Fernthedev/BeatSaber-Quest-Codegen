...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::Org::BouncyCastle::Asn1::Asn1Generator)]{};

/// @brief Field _tagged offset 0x18
 __declspec(property(get=__get__tagged, put=__set__tagged)) bool  _tagged;

/// @brief Field _isExplicit offset 0x19
 __declspec(property(get=__get__isExplicit, put=__set__isExplicit)) bool  _isExplicit;

/// @brief Field _tagNo offset 0x1c
