...
constexpr ::cordl_internals::to_const_pointer<::System::IO::Stream*> __get__currentStream() const;
...
// Ctor Parameters []
// @brief default ctor
 ConstructedOctetStream()  = default;
public:
