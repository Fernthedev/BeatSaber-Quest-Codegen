...
/// @brief Field privKeyInfo offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo*> __get_privKeyInfo() const;
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Asn1Encodable*> __get_identifier() const;

/// @brief Method GetInstance addr 0xe85b38 size 0xa4 virtual false final false
...
/// @brief Method .ctor addr 0xe85bdc size 0x10c virtual false final false
...
/// @brief Method .ctor addr 0xe85ce8 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0xe85d10 size 0x2c virtual false final false
...
/// @brief Method .ctor addr 0xe85d3c size 0x2c virtual false final false
...
/// @brief Method get_PrivateKey addr 0xe85d68 size 0x8 virtual true final false
inline ::Org::BouncyCastle::Asn1::Pkcs::PrivateKeyInfo* get_PrivateKey() ;

/// @brief Method get_HasIdentifier addr 0xe85d70 size 0x10 virtual true final false
inline bool get_HasIdentifier() ;

/// @brief Method get_IsIdentifierUtf8String addr 0xe85d80 size 0x7c virtual true final false
inline bool get_IsIdentifierUtf8String() ;

/// @brief Method get_Identifier addr 0xe85dfc size 0x8 virtual true final false
inline ::Org::BouncyCastle::Asn1::Asn1Encodable* get_Identifier() ;

/// @brief Method ToAsn1Object addr 0xe85e04 size 0x148 virtual true final false
