...
/// @brief Field contentsOfAdmissions offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::Asn1Sequence*> __get_contentsOfAdmissions() const;
