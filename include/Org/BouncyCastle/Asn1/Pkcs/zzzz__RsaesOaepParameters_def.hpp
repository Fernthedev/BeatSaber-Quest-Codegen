...
/// @brief Field pSourceAlgorithm offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier*> __get_pSourceAlgorithm() const;
...
/// @brief Method GetInstance addr 0xf8db54 size 0x188 virtual false final false
...
/// @brief Method .ctor addr 0xf8de90 size 0x74 virtual false final false
inline void _ctor() ;
...
/// @brief Method .ctor addr 0xf8df04 size 0x3c virtual false final false
...
/// @brief Method .ctor addr 0xf8dcdc size 0x1b4 virtual false final false
inline void _ctor(::Org::BouncyCastle::Asn1::Asn1Sequence*  seq) ;

/// @brief Method get_HashAlgorithm addr 0xf8df40 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_HashAlgorithm() ;

/// @brief Method get_MaskGenAlgorithm addr 0xf8df48 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_MaskGenAlgorithm() ;

/// @brief Method get_PSourceAlgorithm addr 0xf8df50 size 0x8 virtual false final false
inline ::Org::BouncyCastle::Asn1::X509::AlgorithmIdentifier* get_PSourceAlgorithm() ;

/// @brief Method ToAsn1Object addr 0xf8df58 size 0x20c virtual true final false
...
// Static field DefaultPSourceAlgorithm
