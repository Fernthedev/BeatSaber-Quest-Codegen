...
static inline ::Microsoft::Win32::SafeHandles::SafeWaitHandle* New_ctor(::cordl_internals::intptr_t  existingHandle, bool  ownsHandle) ;

/// @brief Method .ctor addr 0x242c224 size 0x28 virtual false final false
inline void _ctor(::cordl_internals::intptr_t  existingHandle, bool  ownsHandle) ;

/// @brief Method ReleaseHandle addr 0x242c24c size 0x1c virtual true final false
