...
/// @brief Method .ctor addr 0x242c2c4 size 0x44 virtual false final false
inline void _ctor(bool  ownsHandle) ;

/// @brief Method get_IsInvalid addr 0x242c308 size 0x40 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 SafeHandleMinusOneIsInvalid()  = default;
public:
