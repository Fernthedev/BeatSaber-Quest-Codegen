...
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::MidiParser::MidiEvent>*, 0x18>(this, std::forward<::System::Collections::Generic::List_1<::MidiParser::MidiEvent>*>(value));
}
constexpr ::System::Collections::Generic::List_1<::MidiParser::MidiEvent>* MidiParser::MidiTrack::__get_MidiEvents()  {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::MidiParser::MidiEvent>*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::MidiParser::MidiEvent>*> MidiParser::MidiTrack::__get_MidiEvents() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::MidiParser::MidiEvent>*, 0x18>(this);
}
