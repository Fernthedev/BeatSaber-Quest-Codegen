...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::TerrainUtils::TerrainTileCoord::*)(int32_t, int32_t)>(&::UnityEngine::TerrainUtils::TerrainTileCoord::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2d1e87c;
...
constexpr int32_t& UnityEngine::TerrainUtils::TerrainTileCoord::__get_tileX()  {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::TerrainUtils::TerrainTileCoord::__get_tileX() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& UnityEngine::TerrainUtils::TerrainTileCoord::__get_tileZ()  {
return ::cordl_internals::getInstanceField<int32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::TerrainUtils::TerrainTileCoord::__get_tileZ() const {
return ::cordl_internals::getInstanceField<int32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::TerrainUtils::TerrainTileCoord::TerrainTileCoord(int32_t  tileX, int32_t  tileZ) noexcept : ::bs_hook::ValueTypeWrapper<0x8>() {this->tileX = tileX;
this->tileZ = tileZ;
}
