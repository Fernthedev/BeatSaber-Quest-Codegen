...
static inline ::UnityEngine::Video::__VideoPlayer__EventHandler* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method .ctor addr 0x2eb18b4 size 0xd4 virtual false final false
inline void _ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method Invoke addr 0x2eb1988 size 0x14 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 __VideoPlayer__EventHandler()  = default;
public:
...
static inline ::UnityEngine::Video::__VideoPlayer__ErrorEventHandler* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method .ctor addr 0x2eb199c size 0xd8 virtual false final false
inline void _ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method Invoke addr 0x2eb1a74 size 0x14 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 __VideoPlayer__ErrorEventHandler()  = default;
public:
...
static inline ::UnityEngine::Video::__VideoPlayer__FrameReadyEventHandler* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method .ctor addr 0x2eb1a88 size 0xd8 virtual false final false
inline void _ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method Invoke addr 0x2eb1b60 size 0x14 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 __VideoPlayer__FrameReadyEventHandler()  = default;
public:
...
static inline ::UnityEngine::Video::__VideoPlayer__TimeEventHandler* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method .ctor addr 0x2eb1b74 size 0xd8 virtual false final false
inline void _ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method Invoke addr 0x2eb1c4c size 0x14 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 __VideoPlayer__TimeEventHandler()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x58 - sizeof(::UnityEngine::Behaviour)]{};

/// @brief Field prepareCompleted offset 0x18
...
/// @brief Field loopPointReached offset 0x20
...
/// @brief Field errorReceived offset 0x38
...
/// @brief Field seekCompleted offset 0x40
...
/// @brief Field clockResyncOccurred offset 0x48
...
/// @brief Field frameReady offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Video::__VideoPlayer__EventHandler*> __get_prepareCompleted() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Video::__VideoPlayer__EventHandler*> __get_loopPointReached() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Video::__VideoPlayer__EventHandler*> __get_started() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Video::__VideoPlayer__EventHandler*> __get_frameDropped() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Video::__VideoPlayer__ErrorEventHandler*> __get_errorReceived() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Video::__VideoPlayer__EventHandler*> __get_seekCompleted() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Video::__VideoPlayer__TimeEventHandler*> __get_clockResyncOccurred() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Video::__VideoPlayer__FrameReadyEventHandler*> __get_frameReady() const;

/// @brief Method get_clip addr 0x2eb1450 size 0x3c virtual false final false
inline ::UnityEngine::Video::VideoClip* get_clip() ;

/// @brief Method set_clip addr 0x2eb148c size 0x44 virtual false final false
inline void set_clip(::UnityEngine::Video::VideoClip*  value) ;

/// @brief Method get_texture addr 0x2eb14d0 size 0x3c virtual false final false
inline ::UnityEngine::Texture* get_texture() ;

/// @brief Method Play addr 0x2eb150c size 0x3c virtual false final false
inline void Play() ;

/// @brief Method Stop addr 0x2eb1548 size 0x3c virtual false final false
inline void Stop() ;

/// @brief Method get_isPlaying addr 0x2eb1584 size 0x3c virtual false final false
inline bool get_isPlaying() ;

/// @brief Method set_frame addr 0x2eb15c0 size 0x44 virtual false final false
inline void set_frame(int64_t  value) ;

/// @brief Method set_playbackSpeed addr 0x2eb1604 size 0x4c virtual false final false
inline void set_playbackSpeed(float_t  value) ;

/// @brief Method set_timeReference addr 0x2eb1650 size 0x44 virtual false final false
inline void set_timeReference(::UnityEngine::Video::VideoTimeReference  value) ;

/// @brief Method get_frameCount addr 0x2eb1694 size 0x3c virtual false final false
inline uint64_t get_frameCount() ;

/// @brief Method get_frameRate addr 0x2eb16d0 size 0x3c virtual false final false
inline float_t get_frameRate() ;

/// @brief Method InvokePrepareCompletedCallback_Internal addr 0x2eb170c size 0x34 virtual false final false
static inline void InvokePrepareCompletedCallback_Internal(::UnityEngine::Video::VideoPlayer*  source) ;

/// @brief Method InvokeFrameReadyCallback_Internal addr 0x2eb1740 size 0x38 virtual false final false
static inline void InvokeFrameReadyCallback_Internal(::UnityEngine::Video::VideoPlayer*  source, int64_t  frameIdx) ;

/// @brief Method InvokeLoopPointReachedCallback_Internal addr 0x2eb1778 size 0x34 virtual false final false
static inline void InvokeLoopPointReachedCallback_Internal(::UnityEngine::Video::VideoPlayer*  source) ;

/// @brief Method InvokeStartedCallback_Internal addr 0x2eb17ac size 0x34 virtual false final false
static inline void InvokeStartedCallback_Internal(::UnityEngine::Video::VideoPlayer*  source) ;

/// @brief Method InvokeFrameDroppedCallback_Internal addr 0x2eb17e0 size 0x34 virtual false final false
static inline void InvokeFrameDroppedCallback_Internal(::UnityEngine::Video::VideoPlayer*  source) ;

/// @brief Method InvokeErrorReceivedCallback_Internal addr 0x2eb1814 size 0x38 virtual false final false
static inline void InvokeErrorReceivedCallback_Internal(::UnityEngine::Video::VideoPlayer*  source, ::StringW  errorStr) ;

/// @brief Method InvokeSeekCompletedCallback_Internal addr 0x2eb184c size 0x34 virtual false final false
static inline void InvokeSeekCompletedCallback_Internal(::UnityEngine::Video::VideoPlayer*  source) ;

/// @brief Method InvokeClockResyncOccurredCallback_Internal addr 0x2eb1880 size 0x34 virtual false final false
