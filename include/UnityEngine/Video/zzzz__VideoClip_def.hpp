...
/// @brief Method .ctor addr 0x2eb10d4 size 0x58 virtual false final false
inline void _ctor() ;

/// @brief Method get_originalPath addr 0x2eb112c size 0x3c virtual false final false
inline ::StringW get_originalPath() ;

/// @brief Method get_frameCount addr 0x2eb1168 size 0x3c virtual false final false
inline uint64_t get_frameCount() ;

/// @brief Method get_frameRate addr 0x2eb11a4 size 0x3c virtual false final false
inline double_t get_frameRate() ;

/// @brief Method get_length addr 0x2eb11e0 size 0x3c virtual false final false
inline double_t get_length() ;

/// @brief Method get_width addr 0x2eb121c size 0x3c virtual false final false
inline uint32_t get_width() ;

/// @brief Method get_height addr 0x2eb1258 size 0x3c virtual false final false
inline uint32_t get_height() ;

/// @brief Method get_pixelAspectRatioNumerator addr 0x2eb1294 size 0x3c virtual false final false
inline uint32_t get_pixelAspectRatioNumerator() ;

/// @brief Method get_pixelAspectRatioDenominator addr 0x2eb12d0 size 0x3c virtual false final false
inline uint32_t get_pixelAspectRatioDenominator() ;

/// @brief Method get_sRGB addr 0x2eb130c size 0x3c virtual false final false
inline bool get_sRGB() ;

/// @brief Method get_audioTrackCount addr 0x2eb1348 size 0x3c virtual false final false
inline uint16_t get_audioTrackCount() ;

/// @brief Method GetAudioChannelCount addr 0x2eb1384 size 0x44 virtual false final false
inline uint16_t GetAudioChannelCount(uint16_t  audioTrackIdx) ;

/// @brief Method GetAudioSampleRate addr 0x2eb13c8 size 0x44 virtual false final false
inline uint32_t GetAudioSampleRate(uint16_t  audioTrackIdx) ;

/// @brief Method GetAudioLanguage addr 0x2eb140c size 0x44 virtual false final false
