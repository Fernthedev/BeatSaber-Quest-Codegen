...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::XR::WindowsMR::Input::HololensHand::*)()>(&::UnityEngine::XR::WindowsMR::Input::HololensHand::_ctor)> {
  constexpr static std::size_t size = 0x8;
...
constexpr void UnityEngine::XR::WindowsMR::Input::HololensHand::__set__deviceVelocity_k__BackingField(::UnityEngine::InputSystem::Controls::Vector3Control*  value)  {
::cordl_internals::setInstanceField<::UnityEngine::InputSystem::Controls::Vector3Control*, 0x178>(this, std::forward<::UnityEngine::InputSystem::Controls::Vector3Control*>(value));
}
constexpr ::UnityEngine::InputSystem::Controls::Vector3Control* UnityEngine::XR::WindowsMR::Input::HololensHand::__get__deviceVelocity_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::Controls::Vector3Control*, 0x178>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::Vector3Control*> UnityEngine::XR::WindowsMR::Input::HololensHand::__get__deviceVelocity_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::Controls::Vector3Control*, 0x178>(this);
}
constexpr void UnityEngine::XR::WindowsMR::Input::HololensHand::__set__airTap_k__BackingField(::UnityEngine::InputSystem::Controls::ButtonControl*  value)  {
...
constexpr ::UnityEngine::InputSystem::Controls::ButtonControl* UnityEngine::XR::WindowsMR::Input::HololensHand::__get__airTap_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::Controls::ButtonControl*, 0x180>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::ButtonControl*> UnityEngine::XR::WindowsMR::Input::HololensHand::__get__airTap_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::Controls::ButtonControl*, 0x180>(this);
}
constexpr void UnityEngine::XR::WindowsMR::Input::HololensHand::__set__sourceLossRisk_k__BackingField(::UnityEngine::InputSystem::Controls::AxisControl*  value)  {
...
constexpr ::UnityEngine::InputSystem::Controls::AxisControl* UnityEngine::XR::WindowsMR::Input::HololensHand::__get__sourceLossRisk_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::Controls::AxisControl*, 0x188>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::AxisControl*> UnityEngine::XR::WindowsMR::Input::HololensHand::__get__sourceLossRisk_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::Controls::AxisControl*, 0x188>(this);
}
constexpr void UnityEngine::XR::WindowsMR::Input::HololensHand::__set__sourceLossMitigationDirection_k__BackingField(::UnityEngine::InputSystem::Controls::Vector3Control*  value)  {
::cordl_internals::setInstanceField<::UnityEngine::InputSystem::Controls::Vector3Control*, 0x190>(this, std::forward<::UnityEngine::InputSystem::Controls::Vector3Control*>(value));
}
constexpr ::UnityEngine::InputSystem::Controls::Vector3Control* UnityEngine::XR::WindowsMR::Input::HololensHand::__get__sourceLossMitigationDirection_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::Controls::Vector3Control*, 0x190>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::Vector3Control*> UnityEngine::XR::WindowsMR::Input::HololensHand::__get__sourceLossMitigationDirection_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::Controls::Vector3Control*, 0x190>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::UnityEngine::XR::WindowsMR::Input::HololensHand*>());
}
