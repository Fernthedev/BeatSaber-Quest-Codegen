...
static constexpr auto  __IL2CPP_REFERENCE_TYPE_SIZE{0x200};

/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x200 - sizeof(::UnityEngine::InputSystem::XR::XRControllerWithRumble)]{};

/// @brief Field <joystick>k__BackingField offset 0x178
...
/// @brief Field <touchpad>k__BackingField offset 0x180
...
/// @brief Field <menu>k__BackingField offset 0x198
...
/// @brief Field <trigger>k__BackingField offset 0x1a0
...
/// @brief Field <joystickClicked>k__BackingField offset 0x1b0
...
/// @brief Field <touchpadClicked>k__BackingField offset 0x1b8
...
/// @brief Field <touchpadTouched>k__BackingField offset 0x1c0
...
/// @brief Field <deviceVelocity>k__BackingField offset 0x1c8
...
/// @brief Field <batteryLevel>k__BackingField offset 0x1d8
...
/// @brief Field <sourceLossRisk>k__BackingField offset 0x1e0
...
/// @brief Field <sourceLossMitigationDirection>k__BackingField offset 0x1e8
...
/// @brief Field <pointerPosition>k__BackingField offset 0x1f0
 __declspec(property(get=__get__pointerPosition_k__BackingField, put=__set__pointerPosition_k__BackingField)) ::UnityEngine::InputSystem::Controls::Vector3Control*  _pointerPosition_k__BackingField;

/// @brief Field <pointerRotation>k__BackingField offset 0x1f8
 __declspec(property(get=__get__pointerRotation_k__BackingField, put=__set__pointerRotation_k__BackingField)) ::UnityEngine::InputSystem::Controls::QuaternionControl*  _pointerRotation_k__BackingField;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::ButtonControl*> __get__joystickClicked_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::AxisControl*> __get__batteryLevel_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::Vector3Control*> __get__pointerPosition_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::QuaternionControl*> __get__pointerRotation_k__BackingField() const;
