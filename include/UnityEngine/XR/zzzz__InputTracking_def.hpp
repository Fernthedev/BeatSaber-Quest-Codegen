...
struct CORDL_TYPE __InputTracking__TrackingStateEventType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____InputTracking__TrackingStateEventType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __InputTracking__TrackingStateEventType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputTracking__TrackingStateEventType()  = default;
...
// Static field nodeAdded

// Static field nodeRemoved
