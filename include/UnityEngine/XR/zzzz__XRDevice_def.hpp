...
/// @brief Method SetTrackingSpaceType addr 0x2eb1f34 size 0x3c virtual false final false
static inline bool SetTrackingSpaceType(::UnityEngine::XR::TrackingSpaceType  trackingSpaceType) ;

/// @brief Method DisableAutoXRCameraTracking addr 0x2eb1f70 size 0x44 virtual false final false
static inline void DisableAutoXRCameraTracking(::UnityEngine::Camera*  camera, bool  disabled) ;

/// @brief Method InvokeDeviceLoaded addr 0x2eb1fb4 size 0x6c virtual false final false
