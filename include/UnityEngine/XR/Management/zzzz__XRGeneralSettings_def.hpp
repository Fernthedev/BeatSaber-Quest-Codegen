...
/// @brief Field m_LoaderManagerInstance offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::XR::Management::XRManagerSettings*> __get_m_LoaderManagerInstance() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::XR::Management::XRManagerSettings*> __get_m_XRManager() const;
...
// Ctor Parameters []
// @brief default ctor
 XRGeneralSettings()  = default;
public:


// Fields

// Static field k_SettingsKey

// Static field s_RuntimeSettingsInstance
