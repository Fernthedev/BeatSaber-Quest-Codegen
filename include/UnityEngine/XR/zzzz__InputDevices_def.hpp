...
/// @brief Method GetDeviceAtXRNode addr 0x2eb28c8 size 0x44 virtual false final false
static inline ::UnityEngine::XR::InputDevice GetDeviceAtXRNode(::UnityEngine::XR::XRNode  node) ;

/// @brief Method InvokeConnectionEvent addr 0x2eb2948 size 0xac virtual false final false
static inline void InvokeConnectionEvent(uint64_t  deviceId, ::UnityEngine::XR::ConnectionChangeType  change) ;

/// @brief Method SendHapticImpulse addr 0x2eb23d0 size 0x5c virtual false final false
static inline bool SendHapticImpulse(uint64_t  deviceId, uint32_t  channel, float_t  amplitude, float_t  duration) ;

/// @brief Method StopHaptics addr 0x2eb2484 size 0x3c virtual false final false
static inline void StopHaptics(uint64_t  deviceId) ;

/// @brief Method IsDeviceValid addr 0x2eb21fc size 0x3c virtual false final false
static inline bool IsDeviceValid(uint64_t  deviceId) ;

/// @brief Method GetDeviceManufacturer addr 0x2eb2294 size 0x3c virtual false final false
...
// Static field deviceConnected

// Static field deviceDisconnected

// Static field deviceConfigChanged
