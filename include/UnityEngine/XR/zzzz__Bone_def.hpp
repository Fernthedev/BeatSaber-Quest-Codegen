...
struct CORDL_TYPE Bone : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
constexpr explicit Bone(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}
