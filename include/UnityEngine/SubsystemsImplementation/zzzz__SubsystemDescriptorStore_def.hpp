...
static inline void InitializeManagedDescriptor(::cordl_internals::intptr_t  ptr, ::UnityEngine::IntegratedSubsystemDescriptor*  desc) ;
...
// Ctor Parameters []
// @brief default ctor
 SubsystemDescriptorStore()  = default;
public:


// Fields

// Static field s_IntegratedDescriptors

// Static field s_StandaloneDescriptors

// Static field s_DeprecatedDescriptors
