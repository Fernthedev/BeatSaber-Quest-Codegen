...
struct CORDL_TYPE __TerrainData__BoundaryValueType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____TerrainData__BoundaryValueType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __TerrainData__BoundaryValueType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __TerrainData__BoundaryValueType()  = default;
...
// Static field k_MaximumResolution

// Static field k_MinimumDetailResolutionPerPatch

// Static field k_MaximumDetailResolutionPerPatch

// Static field k_MaximumDetailPatchCount

// Static field k_MaximumDetailsPerRes

// Static field k_MinimumAlphamapResolution

// Static field k_MaximumAlphamapResolution

// Static field k_MinimumBaseMapResolution

// Static field k_MaximumBaseMapResolution
