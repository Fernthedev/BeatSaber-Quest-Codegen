...
struct CORDL_TYPE __Camera__StereoscopicEye : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____Camera__StereoscopicEye_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __Camera__StereoscopicEye(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Camera__StereoscopicEye()  = default;
...
struct CORDL_TYPE __Camera__MonoOrStereoscopicEye : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____Camera__MonoOrStereoscopicEye_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Camera__MonoOrStereoscopicEye(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Camera__MonoOrStereoscopicEye()  = default;
...
struct CORDL_TYPE __Camera__RenderRequestMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____Camera__RenderRequestMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Camera__RenderRequestMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Camera__RenderRequestMode()  = default;
...
struct CORDL_TYPE __Camera__RenderRequestOutputSpace : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____Camera__RenderRequestOutputSpace_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Camera__RenderRequestOutputSpace(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Camera__RenderRequestOutputSpace()  = default;
...
struct CORDL_TYPE __Camera__RenderRequest : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x18};

/// @brief Field m_CameraRenderMode offset 0x0
 __declspec(property(get=__get_m_CameraRenderMode, put=__set_m_CameraRenderMode)) ::UnityEngine::__Camera__RenderRequestMode  m_CameraRenderMode;

/// @brief Field m_ResultRT offset 0x8
 __declspec(property(get=__get_m_ResultRT, put=__set_m_ResultRT)) ::UnityEngine::RenderTexture*  m_ResultRT;

/// @brief Field m_OutputSpace offset 0x10
 __declspec(property(get=__get_m_OutputSpace, put=__set_m_OutputSpace)) ::UnityEngine::__Camera__RenderRequestOutputSpace  m_OutputSpace;

constexpr void __set_m_CameraRenderMode(::UnityEngine::__Camera__RenderRequestMode  value) ;

constexpr ::UnityEngine::__Camera__RenderRequestMode& __get_m_CameraRenderMode() ;

constexpr ::UnityEngine::__Camera__RenderRequestMode const& __get_m_CameraRenderMode() const;

constexpr void __set_m_ResultRT(::UnityEngine::RenderTexture*  value) ;

constexpr ::UnityEngine::RenderTexture* __get_m_ResultRT() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RenderTexture*> __get_m_ResultRT() const;

constexpr void __set_m_OutputSpace(::UnityEngine::__Camera__RenderRequestOutputSpace  value) ;

constexpr ::UnityEngine::__Camera__RenderRequestOutputSpace& __get_m_OutputSpace() ;

constexpr ::UnityEngine::__Camera__RenderRequestOutputSpace const& __get_m_OutputSpace() const;

// Ctor Parameters [CppParam { name: "m_CameraRenderMode", ty: "::UnityEngine::__Camera__RenderRequestMode", modifiers: "", def_value: None }, CppParam { name: "m_ResultRT", ty: "::UnityEngine::RenderTexture*", modifiers: "", def_value: None }, CppParam { name: "m_OutputSpace", ty: "::UnityEngine::__Camera__RenderRequestOutputSpace", modifiers: "", def_value: None }]
constexpr __Camera__RenderRequest(::UnityEngine::__Camera__RenderRequestMode  m_CameraRenderMode, ::UnityEngine::RenderTexture*  m_ResultRT, ::UnityEngine::__Camera__RenderRequestOutputSpace  m_OutputSpace) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Camera__RenderRequest(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Camera__RenderRequest()  = default;
...
static inline ::UnityEngine::__Camera__CameraCallback* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method .ctor addr 0x2cc857c size 0xd4 virtual false final false
inline void _ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method Invoke addr 0x2cc8650 size 0x14 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 __Camera__CameraCallback()  = default;
public:
...
/// @brief Method .ctor addr 0x2cc69b4 size 0x4 virtual false final false
inline void _ctor() ;

/// @brief Method get_nearClipPlane addr 0x2cc69bc size 0x3c virtual false final false
inline float_t get_nearClipPlane() ;

/// @brief Method set_nearClipPlane addr 0x2cc69f8 size 0x4c virtual false final false
inline void set_nearClipPlane(float_t  value) ;

/// @brief Method get_farClipPlane addr 0x2cc6a44 size 0x3c virtual false final false
inline float_t get_farClipPlane() ;

/// @brief Method set_farClipPlane addr 0x2cc6a80 size 0x4c virtual false final false
inline void set_farClipPlane(float_t  value) ;

/// @brief Method get_fieldOfView addr 0x2cc6acc size 0x3c virtual false final false
inline float_t get_fieldOfView() ;

/// @brief Method set_fieldOfView addr 0x2cc6b08 size 0x4c virtual false final false
inline void set_fieldOfView(float_t  value) ;

/// @brief Method set_renderingPath addr 0x2cc6b54 size 0x44 virtual false final false
inline void set_renderingPath(::UnityEngine::RenderingPath  value) ;

/// @brief Method get_actualRenderingPath addr 0x2cc6b98 size 0x3c virtual false final false
inline ::UnityEngine::RenderingPath get_actualRenderingPath() ;

/// @brief Method set_allowHDR addr 0x2cc6bd4 size 0x44 virtual false final false
inline void set_allowHDR(bool  value) ;

/// @brief Method set_allowMSAA addr 0x2cc6c18 size 0x44 virtual false final false
inline void set_allowMSAA(bool  value) ;

/// @brief Method set_forceIntoRenderTexture addr 0x2cc6c5c size 0x44 virtual false final false
inline void set_forceIntoRenderTexture(bool  value) ;

/// @brief Method set_orthographicSize addr 0x2cc6ca0 size 0x4c virtual false final false
inline void set_orthographicSize(float_t  value) ;

/// @brief Method get_orthographic addr 0x2cc6cec size 0x3c virtual false final false
inline bool get_orthographic() ;

/// @brief Method set_orthographic addr 0x2cc6d28 size 0x44 virtual false final false
inline void set_orthographic(bool  value) ;

/// @brief Method get_depth addr 0x2cc6d6c size 0x3c virtual false final false
inline float_t get_depth() ;

/// @brief Method set_depth addr 0x2cc6da8 size 0x4c virtual false final false
inline void set_depth(float_t  value) ;

/// @brief Method get_aspect addr 0x2cc6df4 size 0x3c virtual false final false
inline float_t get_aspect() ;

/// @brief Method set_aspect addr 0x2cc6e30 size 0x4c virtual false final false
inline void set_aspect(float_t  value) ;

/// @brief Method get_cullingMask addr 0x2cc6e7c size 0x3c virtual false final false
inline int32_t get_cullingMask() ;

/// @brief Method set_cullingMask addr 0x2cc6eb8 size 0x44 virtual false final false
inline void set_cullingMask(int32_t  value) ;

/// @brief Method get_eventMask addr 0x2cc6efc size 0x3c virtual false final false
inline int32_t get_eventMask() ;

/// @brief Method set_useOcclusionCulling addr 0x2cc6f38 size 0x44 virtual false final false
inline void set_useOcclusionCulling(bool  value) ;

/// @brief Method get_backgroundColor addr 0x2cc6f7c size 0x58 virtual false final false
inline ::UnityEngine::Color get_backgroundColor() ;

/// @brief Method set_backgroundColor addr 0x2cc7018 size 0x54 virtual false final false
inline void set_backgroundColor(::UnityEngine::Color  value) ;

/// @brief Method get_clearFlags addr 0x2cc70b0 size 0x3c virtual false final false
inline ::UnityEngine::CameraClearFlags get_clearFlags() ;

/// @brief Method set_clearFlags addr 0x2cc70ec size 0x44 virtual false final false
inline void set_clearFlags(::UnityEngine::CameraClearFlags  value) ;

/// @brief Method get_depthTextureMode addr 0x2cc7130 size 0x3c virtual false final false
inline ::UnityEngine::DepthTextureMode get_depthTextureMode() ;

/// @brief Method set_depthTextureMode addr 0x2cc716c size 0x44 virtual false final false
inline void set_depthTextureMode(::UnityEngine::DepthTextureMode  value) ;

/// @brief Method set_rect addr 0x2cc71b0 size 0x54 virtual false final false
inline void set_rect(::UnityEngine::Rect  value) ;

/// @brief Method get_pixelRect addr 0x2cc7248 size 0x58 virtual false final false
inline ::UnityEngine::Rect get_pixelRect() ;

/// @brief Method get_pixelWidth addr 0x2cc72e4 size 0x3c virtual false final false
inline int32_t get_pixelWidth() ;

/// @brief Method get_pixelHeight addr 0x2cc7320 size 0x3c virtual false final false
inline int32_t get_pixelHeight() ;

/// @brief Method get_targetTexture addr 0x2cc735c size 0x3c virtual false final false
inline ::UnityEngine::RenderTexture* get_targetTexture() ;

/// @brief Method set_targetTexture addr 0x2cc7398 size 0x44 virtual false final false
inline void set_targetTexture(::UnityEngine::RenderTexture*  value) ;

/// @brief Method get_targetDisplay addr 0x2cc73dc size 0x3c virtual false final false
inline int32_t get_targetDisplay() ;

/// @brief Method set_targetDisplay addr 0x2cc7418 size 0x44 virtual false final false
inline void set_targetDisplay(int32_t  value) ;

/// @brief Method get_worldToCameraMatrix addr 0x2cc745c size 0x6c virtual false final false
inline ::UnityEngine::Matrix4x4 get_worldToCameraMatrix() ;

/// @brief Method set_worldToCameraMatrix addr 0x2cc750c size 0x44 virtual false final false
inline void set_worldToCameraMatrix(::UnityEngine::Matrix4x4  value) ;

/// @brief Method get_projectionMatrix addr 0x2cc7594 size 0x6c virtual false final false
inline ::UnityEngine::Matrix4x4 get_projectionMatrix() ;

/// @brief Method set_projectionMatrix addr 0x2cc7644 size 0x44 virtual false final false
inline void set_projectionMatrix(::UnityEngine::Matrix4x4  value) ;

/// @brief Method ResetWorldToCameraMatrix addr 0x2cc76cc size 0x3c virtual false final false
inline void ResetWorldToCameraMatrix() ;

/// @brief Method CalculateObliqueMatrix addr 0x2cc7708 size 0x78 virtual false final false
inline ::UnityEngine::Matrix4x4 CalculateObliqueMatrix(::UnityEngine::Vector4  clipPlane) ;

/// @brief Method WorldToScreenPoint addr 0x2cc77d4 size 0x70 virtual false final false
...
/// @brief Method WorldToViewportPoint addr 0x2cc78a0 size 0x70 virtual false final false
...
/// @brief Method ViewportToWorldPoint addr 0x2cc796c size 0x70 virtual false final false
...
/// @brief Method WorldToScreenPoint addr 0x2cc7a38 size 0x8 virtual false final false
inline ::UnityEngine::Vector3 WorldToScreenPoint(::UnityEngine::Vector3  position) ;

/// @brief Method WorldToViewportPoint addr 0x2cc7a40 size 0x8 virtual false final false
inline ::UnityEngine::Vector3 WorldToViewportPoint(::UnityEngine::Vector3  position) ;

/// @brief Method ScreenToViewportPoint addr 0x2cc7a48 size 0x68 virtual false final false
inline ::UnityEngine::Vector3 ScreenToViewportPoint(::UnityEngine::Vector3  position) ;

/// @brief Method ScreenPointToRay addr 0x2cc7b04 size 0x78 virtual false final false
inline ::UnityEngine::Ray ScreenPointToRay(::UnityEngine::Vector2  pos, ::UnityEngine::__Camera__MonoOrStereoscopicEye  eye) ;

/// @brief Method ScreenPointToRay addr 0x2cc7bd8 size 0x38 virtual false final false
inline ::UnityEngine::Ray ScreenPointToRay(::UnityEngine::Vector3  pos, ::UnityEngine::__Camera__MonoOrStereoscopicEye  eye) ;

/// @brief Method ScreenPointToRay addr 0x2cc7c10 size 0x4c virtual false final false
inline ::UnityEngine::Ray ScreenPointToRay(::UnityEngine::Vector3  pos) ;

/// @brief Method get_main addr 0x2cc7c5c size 0x28 virtual false final false
static inline ::UnityEngine::Camera* get_main() ;

/// @brief Method get_current addr 0x2cc7c84 size 0x28 virtual false final false
static inline ::UnityEngine::Camera* get_current() ;

/// @brief Method get_stereoEnabled addr 0x2cc7cac size 0x3c virtual false final false
inline bool get_stereoEnabled() ;

/// @brief Method get_stereoTargetEye addr 0x2cc7ce8 size 0x3c virtual false final false
inline ::UnityEngine::StereoTargetEyeMask get_stereoTargetEye() ;

/// @brief Method set_stereoTargetEye addr 0x2cc7d24 size 0x44 virtual false final false
inline void set_stereoTargetEye(::UnityEngine::StereoTargetEyeMask  value) ;

/// @brief Method GetStereoProjectionMatrix addr 0x2cc7d68 size 0x7c virtual false final false
inline ::UnityEngine::Matrix4x4 GetStereoProjectionMatrix(::UnityEngine::__Camera__StereoscopicEye  eye) ;

/// @brief Method GetAllCamerasCount addr 0x2cc7e38 size 0x28 virtual false final false
static inline int32_t GetAllCamerasCount() ;

/// @brief Method GetAllCamerasImpl addr 0x2cc7e60 size 0x3c virtual false final false
static inline int32_t GetAllCamerasImpl(ByRef<::ArrayW<::UnityEngine::Camera*,::Array<::UnityEngine::Camera*>*>>  cam) ;

/// @brief Method get_allCamerasCount addr 0x2cc7e9c size 0x28 virtual false final false
static inline int32_t get_allCamerasCount() ;

/// @brief Method GetAllCameras addr 0x2cc7ec4 size 0xe4 virtual false final false
static inline int32_t GetAllCameras(::ArrayW<::UnityEngine::Camera*,::Array<::UnityEngine::Camera*>*>  cameras) ;

/// @brief Method RenderToCubemapImpl addr 0x2cc7fa8 size 0x54 virtual false final false
inline bool RenderToCubemapImpl(::UnityEngine::Texture*  tex, int32_t  faceMask) ;

/// @brief Method RenderToCubemap addr 0x2cc7ffc size 0x48 virtual false final false
inline bool RenderToCubemap(::UnityEngine::RenderTexture*  cubemap) ;

/// @brief Method Render addr 0x2cc8044 size 0x3c virtual false final false
inline void Render() ;

/// @brief Method RenderWithShader addr 0x2cc8080 size 0x54 virtual false final false
inline void RenderWithShader(::UnityEngine::Shader*  shader, ::StringW  replacementTag) ;

/// @brief Method CopyFrom addr 0x2cc80d4 size 0x44 virtual false final false
inline void CopyFrom(::UnityEngine::Camera*  other) ;

/// @brief Method AddCommandBufferImpl addr 0x2cc8118 size 0x54 virtual false final false
inline void AddCommandBufferImpl(::UnityEngine::Rendering::CameraEvent  evt, ::UnityEngine::Rendering::CommandBuffer*  buffer) ;

/// @brief Method RemoveCommandBufferImpl addr 0x2cc816c size 0x54 virtual false final false
inline void RemoveCommandBufferImpl(::UnityEngine::Rendering::CameraEvent  evt, ::UnityEngine::Rendering::CommandBuffer*  buffer) ;

/// @brief Method AddCommandBuffer addr 0x2cc81c0 size 0x13c virtual false final false
inline void AddCommandBuffer(::UnityEngine::Rendering::CameraEvent  evt, ::UnityEngine::Rendering::CommandBuffer*  buffer) ;

/// @brief Method RemoveCommandBuffer addr 0x2cc82fc size 0x13c virtual false final false
inline void RemoveCommandBuffer(::UnityEngine::Rendering::CameraEvent  evt, ::UnityEngine::Rendering::CommandBuffer*  buffer) ;

/// @brief Method FireOnPreCull addr 0x2cc8438 size 0x6c virtual false final false
static inline void FireOnPreCull(::UnityEngine::Camera*  cam) ;

/// @brief Method FireOnPreRender addr 0x2cc84a4 size 0x6c virtual false final false
static inline void FireOnPreRender(::UnityEngine::Camera*  cam) ;

/// @brief Method FireOnPostRender addr 0x2cc8510 size 0x6c virtual false final false
static inline void FireOnPostRender(::UnityEngine::Camera*  cam) ;

/// @brief Method get_backgroundColor_Injected addr 0x2cc6fd4 size 0x44 virtual false final false
inline void get_backgroundColor_Injected(ByRef<::UnityEngine::Color>  ret) ;

/// @brief Method set_backgroundColor_Injected addr 0x2cc706c size 0x44 virtual false final false
inline void set_backgroundColor_Injected(ByRef<::UnityEngine::Color>  value) ;

/// @brief Method set_rect_Injected addr 0x2cc7204 size 0x44 virtual false final false
inline void set_rect_Injected(ByRef<::UnityEngine::Rect>  value) ;

/// @brief Method get_pixelRect_Injected addr 0x2cc72a0 size 0x44 virtual false final false
inline void get_pixelRect_Injected(ByRef<::UnityEngine::Rect>  ret) ;

/// @brief Method get_worldToCameraMatrix_Injected addr 0x2cc74c8 size 0x44 virtual false final false
inline void get_worldToCameraMatrix_Injected(ByRef<::UnityEngine::Matrix4x4>  ret) ;

/// @brief Method set_worldToCameraMatrix_Injected addr 0x2cc7550 size 0x44 virtual false final false
inline void set_worldToCameraMatrix_Injected(ByRef<::UnityEngine::Matrix4x4>  value) ;

/// @brief Method get_projectionMatrix_Injected addr 0x2cc7600 size 0x44 virtual false final false
inline void get_projectionMatrix_Injected(ByRef<::UnityEngine::Matrix4x4>  ret) ;

/// @brief Method set_projectionMatrix_Injected addr 0x2cc7688 size 0x44 virtual false final false
inline void set_projectionMatrix_Injected(ByRef<::UnityEngine::Matrix4x4>  value) ;

/// @brief Method CalculateObliqueMatrix_Injected addr 0x2cc7780 size 0x54 virtual false final false
inline void CalculateObliqueMatrix_Injected(ByRef<::UnityEngine::Vector4>  clipPlane, ByRef<::UnityEngine::Matrix4x4>  ret) ;

/// @brief Method WorldToScreenPoint_Injected addr 0x2cc7844 size 0x5c virtual false final false
...
/// @brief Method WorldToViewportPoint_Injected addr 0x2cc7910 size 0x5c virtual false final false
...
/// @brief Method ViewportToWorldPoint_Injected addr 0x2cc79dc size 0x5c virtual false final false
...
/// @brief Method ScreenToViewportPoint_Injected addr 0x2cc7ab0 size 0x54 virtual false final false
inline void ScreenToViewportPoint_Injected(ByRef<::UnityEngine::Vector3>  position, ByRef<::UnityEngine::Vector3>  ret) ;

/// @brief Method ScreenPointToRay_Injected addr 0x2cc7b7c size 0x5c virtual false final false
...
/// @brief Method GetStereoProjectionMatrix_Injected addr 0x2cc7de4 size 0x54 virtual false final false
...
// Static field onPreCull

// Static field onPreRender

// Static field onPostRender
