...
static inline void GLIssuePluginEvent(::cordl_internals::intptr_t  callback, int32_t  eventID) ;

/// @brief Method IssuePluginEvent addr 0x2cc3f30 size 0xf0 virtual false final false
static inline void IssuePluginEvent(::cordl_internals::intptr_t  callback, int32_t  eventID) ;
