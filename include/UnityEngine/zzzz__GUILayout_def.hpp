...
/// @brief Method Label addr 0x2d08608 size 0xa8 virtual false final false
static inline void Label(::StringW  text, ::ArrayW<::UnityEngine::GUILayoutOption*,::Array<::UnityEngine::GUILayoutOption*>*>  options) ;

/// @brief Method DoLabel addr 0x2d086b0 size 0xcc virtual false final false
...
/// @brief Method Width addr 0x2cfd694 size 0x9c virtual false final false
static inline ::UnityEngine::GUILayoutOption* Width(float_t  width) ;

/// @brief Method Height addr 0x2cfd730 size 0x9c virtual false final false
