...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::RangeInt::*)()>(&::UnityEngine::RangeInt::get_end)> {
  ...
  constexpr static std::size_t addrs = 0x2ccef64;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::RangeInt::*)(int32_t, int32_t)>(&::UnityEngine::RangeInt::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2ccef70;
...
constexpr int32_t& UnityEngine::RangeInt::__get_start()  {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::RangeInt::__get_start() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::RangeInt::RangeInt(int32_t  start, int32_t  length) noexcept : ::bs_hook::ValueTypeWrapper<0x8>() {this->start = start;
this->length = length;
}
