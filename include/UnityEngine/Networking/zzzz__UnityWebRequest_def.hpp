...
struct CORDL_TYPE __UnityWebRequest__UnityWebRequestMethod : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____UnityWebRequest__UnityWebRequestMethod_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __UnityWebRequest__UnityWebRequestMethod(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __UnityWebRequest__UnityWebRequestMethod()  = default;
...
struct CORDL_TYPE __UnityWebRequest__UnityWebRequestError : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____UnityWebRequest__UnityWebRequestError_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __UnityWebRequest__UnityWebRequestError(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __UnityWebRequest__UnityWebRequestError()  = default;
...
struct CORDL_TYPE __UnityWebRequest__Result : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____UnityWebRequest__Result_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __UnityWebRequest__Result(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __UnityWebRequest__Result()  = default;
...
/// @brief Field m_UploadHandler offset 0x20
...
/// @brief Field m_CertificateHandler offset 0x28
...
/// @brief Field m_Uri offset 0x30
 __declspec(property(get=__get_m_Uri, put=__set_m_Uri)) ::System::Uri*  m_Uri;

/// @brief Field <disposeCertificateHandlerOnDispose>k__BackingField offset 0x38
 __declspec(property(get=__get__disposeCertificateHandlerOnDispose_k__BackingField, put=__set__disposeCertificateHandlerOnDispose_k__BackingField)) bool  _disposeCertificateHandlerOnDispose_k__BackingField;

/// @brief Field <disposeDownloadHandlerOnDispose>k__BackingField offset 0x39
 __declspec(property(get=__get__disposeDownloadHandlerOnDispose_k__BackingField, put=__set__disposeDownloadHandlerOnDispose_k__BackingField)) bool  _disposeDownloadHandlerOnDispose_k__BackingField;

/// @brief Field <disposeUploadHandlerOnDispose>k__BackingField offset 0x3a
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Networking::DownloadHandler*> __get_m_DownloadHandler() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Networking::UploadHandler*> __get_m_UploadHandler() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Networking::CertificateHandler*> __get_m_CertificateHandler() const;

constexpr void __set_m_Uri(::System::Uri*  value) ;

constexpr ::System::Uri* __get_m_Uri() ;

constexpr ::cordl_internals::to_const_pointer<::System::Uri*> __get_m_Uri() const;
...
/// @brief Method GetWebErrorString addr 0x2ead9e4 size 0x3c virtual false final false
static inline ::StringW GetWebErrorString(::UnityEngine::Networking::__UnityWebRequest__UnityWebRequestError  err) ;

/// @brief Method GetHTTPStatusString addr 0x2eada20 size 0x3c virtual false final false
static inline ::StringW GetHTTPStatusString(int64_t  responseCode) ;

/// @brief Method get_disposeCertificateHandlerOnDispose addr 0x2eada5c size 0x8 virtual false final false
inline bool get_disposeCertificateHandlerOnDispose() ;

/// @brief Method set_disposeCertificateHandlerOnDispose addr 0x2eada64 size 0xc virtual false final false
inline void set_disposeCertificateHandlerOnDispose(bool  value) ;

/// @brief Method get_disposeDownloadHandlerOnDispose addr 0x2eada70 size 0x8 virtual false final false
inline bool get_disposeDownloadHandlerOnDispose() ;

/// @brief Method set_disposeDownloadHandlerOnDispose addr 0x2eada78 size 0xc virtual false final false
inline void set_disposeDownloadHandlerOnDispose(bool  value) ;

/// @brief Method get_disposeUploadHandlerOnDispose addr 0x2eada84 size 0x8 virtual false final false
inline bool get_disposeUploadHandlerOnDispose() ;

/// @brief Method set_disposeUploadHandlerOnDispose addr 0x2eada8c size 0xc virtual false final false
inline void set_disposeUploadHandlerOnDispose(bool  value) ;

/// @brief Method Create addr 0x2eada98 size 0x28 virtual false final false
static inline ::cordl_internals::intptr_t Create() ;

/// @brief Method Release addr 0x2eadac0 size 0x3c virtual false final false
inline void Release() ;

/// @brief Method InternalDestroy addr 0x2eadafc size 0xbc virtual false final false
inline void InternalDestroy() ;

/// @brief Method InternalSetDefaults addr 0x2eadbf4 size 0x14 virtual false final false
...
/// @brief Method .ctor addr 0x2eadc08 size 0xa4 virtual false final false
...
/// @brief Method Finalize addr 0x2eae0d8 size 0x9c virtual true final false
inline void Finalize() ;

/// @brief Method Dispose addr 0x2eae1d4 size 0x68 virtual true final true
inline void Dispose() ;

/// @brief Method DisposeHandlers addr 0x2eae174 size 0x60 virtual false final false
inline void DisposeHandlers() ;

/// @brief Method BeginWebRequest addr 0x2eae2e8 size 0x3c virtual false final false
inline ::UnityEngine::Networking::UnityWebRequestAsyncOperation* BeginWebRequest() ;

/// @brief Method SendWebRequest addr 0x2eae324 size 0x48 virtual false final false
inline ::UnityEngine::Networking::UnityWebRequestAsyncOperation* SendWebRequest() ;

/// @brief Method Abort addr 0x2eadbb8 size 0x3c virtual false final false
inline void Abort() ;

/// @brief Method SetMethod addr 0x2eae36c size 0x44 virtual false final false
...
/// @brief Method InternalSetMethod addr 0x2eae3b0 size 0x10c virtual false final false
inline void InternalSetMethod(::UnityEngine::Networking::__UnityWebRequest__UnityWebRequestMethod  methodType) ;

/// @brief Method SetCustomMethod addr 0x2eae4f8 size 0x44 virtual false final false
inline ::UnityEngine::Networking::__UnityWebRequest__UnityWebRequestError SetCustomMethod(::StringW  customMethodName) ;

/// @brief Method InternalSetCustomMethod addr 0x2eae53c size 0x10c virtual false final false
inline void InternalSetCustomMethod(::StringW  customMethodName) ;

/// @brief Method GetMethod addr 0x2eae648 size 0x3c virtual false final false
inline ::UnityEngine::Networking::__UnityWebRequest__UnityWebRequestMethod GetMethod() ;

/// @brief Method GetCustomMethod addr 0x2eae684 size 0x3c virtual false final false
inline ::StringW GetCustomMethod() ;

/// @brief Method get_method addr 0x2eae6c0 size 0x108 virtual false final false
inline ::StringW get_method() ;

/// @brief Method set_method addr 0x2eadd34 size 0x184 virtual false final false
inline void set_method(::StringW  value) ;

/// @brief Method GetError addr 0x2eae7c8 size 0x3c virtual false final false
inline ::UnityEngine::Networking::__UnityWebRequest__UnityWebRequestError GetError() ;

/// @brief Method get_error addr 0x2eae804 size 0x1a4 virtual false final false
inline ::StringW get_error() ;

/// @brief Method get_url addr 0x2eaea20 size 0x3c virtual false final false
inline ::StringW get_url() ;

/// @brief Method set_url addr 0x2eadcac size 0x88 virtual false final false
inline void set_url(::StringW  value) ;

/// @brief Method GetUrl addr 0x2eaea5c size 0x3c virtual false final false
inline ::StringW GetUrl() ;

/// @brief Method SetUrl addr 0x2eaeba4 size 0x44 virtual false final false
inline ::UnityEngine::Networking::__UnityWebRequest__UnityWebRequestError SetUrl(::StringW  url) ;

/// @brief Method InternalSetUrl addr 0x2eaea98 size 0x10c virtual false final false
inline void InternalSetUrl(::StringW  url) ;

/// @brief Method get_responseCode addr 0x2eae9e4 size 0x3c virtual false final false
inline int64_t get_responseCode() ;

/// @brief Method IsExecuting addr 0x2eaebe8 size 0x3c virtual false final false
inline bool IsExecuting() ;

/// @brief Method get_isModifiable addr 0x2eae4bc size 0x3c virtual false final false
inline bool get_isModifiable() ;

/// @brief Method get_isDone addr 0x2eaec24 size 0x48 virtual false final false
inline bool get_isDone() ;

/// @brief Method get_result addr 0x2eae9a8 size 0x3c virtual false final false
inline ::UnityEngine::Networking::__UnityWebRequest__Result get_result() ;

/// @brief Method GetDownloadProgress addr 0x2eaec6c size 0x3c virtual false final false
inline float_t GetDownloadProgress() ;

/// @brief Method get_downloadProgress addr 0x2eaeca8 size 0xa4 virtual false final false
inline float_t get_downloadProgress() ;

/// @brief Method get_downloadedBytes addr 0x2eaed4c size 0x3c virtual false final false
inline uint64_t get_downloadedBytes() ;

/// @brief Method SetRedirectLimitFromScripting addr 0x2eaed88 size 0x44 virtual false final false
inline void SetRedirectLimitFromScripting(int32_t  limit) ;

/// @brief Method set_redirectLimit addr 0x2eaedcc size 0x44 virtual false final false
inline void set_redirectLimit(int32_t  value) ;

/// @brief Method SetUploadHandler addr 0x2eaee10 size 0x44 virtual false final false
...
/// @brief Method get_uploadHandler addr 0x2eae244 size 0x8 virtual false final false
inline ::UnityEngine::Networking::UploadHandler* get_uploadHandler() ;

/// @brief Method set_uploadHandler addr 0x2eadfc8 size 0x110 virtual false final false
inline void set_uploadHandler(::UnityEngine::Networking::UploadHandler*  value) ;

/// @brief Method SetDownloadHandler addr 0x2eaee54 size 0x44 virtual false final false
...
/// @brief Method get_downloadHandler addr 0x2eae23c size 0x8 virtual false final false
inline ::UnityEngine::Networking::DownloadHandler* get_downloadHandler() ;

/// @brief Method set_downloadHandler addr 0x2eadeb8 size 0x110 virtual false final false
inline void set_downloadHandler(::UnityEngine::Networking::DownloadHandler*  value) ;

/// @brief Method SetCertificateHandler addr 0x2eaee98 size 0x44 virtual false final false
...
/// @brief Method get_certificateHandler addr 0x2eae24c size 0x8 virtual false final false
inline ::UnityEngine::Networking::CertificateHandler* get_certificateHandler() ;

/// @brief Method set_certificateHandler addr 0x2eaeedc size 0x110 virtual false final false
inline void set_certificateHandler(::UnityEngine::Networking::CertificateHandler*  value) ;

/// @brief Method SetTimeoutMsec addr 0x2eaefec size 0x44 virtual false final false
inline ::UnityEngine::Networking::__UnityWebRequest__UnityWebRequestError SetTimeoutMsec(int32_t  timeout) ;

/// @brief Method set_timeout addr 0x2eaf030 size 0x15c virtual false final false
inline void set_timeout(int32_t  value) ;

/// @brief Method Get addr 0x2eaf18c size 0xa8 virtual false final false
static inline ::UnityEngine::Networking::UnityWebRequest* Get(::StringW  uri) ;

/// @brief Method EscapeURL addr 0x2eaf280 size 0x20 virtual false final false
static inline ::StringW EscapeURL(::StringW  s) ;

/// @brief Method EscapeURL addr 0x2eaf2a0 size 0xd8 virtual false final false
