...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::Networking::DownloadHandler)]{};
...
static inline ::cordl_internals::intptr_t Create(::UnityEngine::Networking::DownloadHandlerAssetBundle*  obj, ::StringW  url, uint32_t  crc) ;

/// @brief Method CreateCached addr 0x2eabc5c size 0x70 virtual false final false
static inline ::cordl_internals::intptr_t CreateCached(::UnityEngine::Networking::DownloadHandlerAssetBundle*  obj, ::StringW  url, ::StringW  name, ::UnityEngine::Hash128  hash, uint32_t  crc) ;
...
static inline ::cordl_internals::intptr_t CreateCached_Injected(::UnityEngine::Networking::DownloadHandlerAssetBundle*  obj, ::StringW  url, ::StringW  name, ByRef<::UnityEngine::Hash128>  hash, uint32_t  crc) ;
...
// Ctor Parameters []
// @brief default ctor
 DownloadHandlerAssetBundle()  = default;
public:
