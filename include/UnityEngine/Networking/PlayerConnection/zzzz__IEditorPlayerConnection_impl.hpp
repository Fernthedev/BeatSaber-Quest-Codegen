...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::Networking::PlayerConnection::IEditorPlayerConnection::*)(::System::Guid, ::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::UnityEngine::Networking::PlayerConnection::IEditorPlayerConnection::Send)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
