...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::__GUIClip__ParentClipScope::*)(::UnityEngine::Matrix4x4, ::UnityEngine::Rect)>(&::UnityEngine::__GUIClip__ParentClipScope::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::__GUIClip__ParentClipScope::*)()>(&::UnityEngine::__GUIClip__ParentClipScope::Dispose)> {
...
constexpr void UnityEngine::__GUIClip__ParentClipScope::__set_m_Disposed(bool  value)  {
...
constexpr bool& UnityEngine::__GUIClip__ParentClipScope::__get_m_Disposed()  {
return ::cordl_internals::getInstanceField<bool, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr bool const& UnityEngine::__GUIClip__ParentClipScope::__get_m_Disposed() const {
return ::cordl_internals::getInstanceField<bool, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::__GUIClip__ParentClipScope::__GUIClip__ParentClipScope(bool  m_Disposed) noexcept : ::bs_hook::ValueTypeWrapper<0x1>() {this->m_Disposed = m_Disposed;
}
