...
inline ::UnityEngine::AndroidJavaClass* UnityEngine::AndroidJavaClass::New_ctor(::cordl_internals::intptr_t  jclass)  {
return THROW_UNLESS(::il2cpp_utils::New<::UnityEngine::AndroidJavaClass*>(jclass));
}
inline void UnityEngine::AndroidJavaClass::_ctor(::cordl_internals::intptr_t  jclass)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::AndroidJavaClass*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
