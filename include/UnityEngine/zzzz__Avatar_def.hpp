...
/// @brief Method .ctor addr 0x2c8e5f4 size 0x58 virtual false final false
inline void _ctor() ;

/// @brief Method get_isValid addr 0x2c8e64c size 0x3c virtual false final false
inline bool get_isValid() ;

/// @brief Method get_isHuman addr 0x2c8e688 size 0x3c virtual false final false
inline bool get_isHuman() ;

/// @brief Method get_humanDescription addr 0x2c8e6c4 size 0x6c virtual false final false
inline ::UnityEngine::HumanDescription get_humanDescription() ;

/// @brief Method SetMuscleMinMax addr 0x2c8e774 size 0x5c virtual false final false
inline void SetMuscleMinMax(int32_t  muscleId, float_t  min, float_t  max) ;

/// @brief Method SetParameter addr 0x2c8e7d0 size 0x54 virtual false final false
inline void SetParameter(int32_t  parameterId, float_t  value) ;

/// @brief Method GetAxisLength addr 0x2c8e824 size 0x70 virtual false final false
inline float_t GetAxisLength(int32_t  humanId) ;

/// @brief Method GetPreRotation addr 0x2c8e914 size 0x4c virtual false final false
inline ::UnityEngine::Quaternion GetPreRotation(int32_t  humanId) ;

/// @brief Method GetPostRotation addr 0x2c8e9c0 size 0x4c virtual false final false
inline ::UnityEngine::Quaternion GetPostRotation(int32_t  humanId) ;

/// @brief Method GetZYPostQ addr 0x2c8ea6c size 0xac virtual false final false
inline ::UnityEngine::Quaternion GetZYPostQ(int32_t  humanId, ::UnityEngine::Quaternion  parentQ, ::UnityEngine::Quaternion  q) ;

/// @brief Method GetZYRoll addr 0x2c8eb90 size 0x74 virtual false final false
inline ::UnityEngine::Quaternion GetZYRoll(int32_t  humanId, ::UnityEngine::Vector3  uvw) ;

/// @brief Method GetLimitSign addr 0x2c8ec70 size 0x4c virtual false final false
inline ::UnityEngine::Vector3 GetLimitSign(int32_t  humanId) ;

/// @brief Method Internal_GetAxisLength addr 0x2c8e8d0 size 0x44 virtual false final false
inline float_t Internal_GetAxisLength(int32_t  humanId) ;

/// @brief Method Internal_GetPreRotation addr 0x2c8e960 size 0x60 virtual false final false
inline ::UnityEngine::Quaternion Internal_GetPreRotation(int32_t  humanId) ;

/// @brief Method Internal_GetPostRotation addr 0x2c8ea0c size 0x60 virtual false final false
inline ::UnityEngine::Quaternion Internal_GetPostRotation(int32_t  humanId) ;

/// @brief Method Internal_GetZYPostQ addr 0x2c8eb18 size 0x78 virtual false final false
...
/// @brief Method Internal_GetZYRoll addr 0x2c8ec04 size 0x6c virtual false final false
inline ::UnityEngine::Quaternion Internal_GetZYRoll(int32_t  humanId, ::UnityEngine::Vector3  uvw) ;

/// @brief Method Internal_GetLimitSign addr 0x2c8ecbc size 0x64 virtual false final false
inline ::UnityEngine::Vector3 Internal_GetLimitSign(int32_t  humanId) ;

/// @brief Method get_humanDescription_Injected addr 0x2c8e730 size 0x44 virtual false final false
inline void get_humanDescription_Injected(ByRef<::UnityEngine::HumanDescription>  ret) ;

/// @brief Method Internal_GetPreRotation_Injected addr 0x2c8ed20 size 0x54 virtual false final false
inline void Internal_GetPreRotation_Injected(int32_t  humanId, ByRef<::UnityEngine::Quaternion>  ret) ;

/// @brief Method Internal_GetPostRotation_Injected addr 0x2c8ed74 size 0x54 virtual false final false
inline void Internal_GetPostRotation_Injected(int32_t  humanId, ByRef<::UnityEngine::Quaternion>  ret) ;

/// @brief Method Internal_GetZYPostQ_Injected addr 0x2c8edc8 size 0x6c virtual false final false
...
/// @brief Method Internal_GetZYRoll_Injected addr 0x2c8ee34 size 0x5c virtual false final false
inline void Internal_GetZYRoll_Injected(int32_t  humanId, ByRef<::UnityEngine::Vector3>  uvw, ByRef<::UnityEngine::Quaternion>  ret) ;

/// @brief Method Internal_GetLimitSign_Injected addr 0x2c8ee90 size 0x54 virtual false final false
