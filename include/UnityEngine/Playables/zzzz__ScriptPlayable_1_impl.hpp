...
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::UnityEngine::Playables::PlayableHandle& UnityEngine::Playables::ScriptPlayable_1<T>::__get_m_Handle()  {
...
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::UnityEngine::Playables::PlayableHandle const& UnityEngine::Playables::ScriptPlayable_1<T>::__get_m_Handle() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Playables::PlayableHandle, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
template<::il2cpp_utils::il2cpp_reference_type T>
...
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::UnityEngine::Playables::ScriptPlayable_1<T>::ScriptPlayable_1(::UnityEngine::Playables::PlayableHandle  m_Handle) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->m_Handle = m_Handle;
}
