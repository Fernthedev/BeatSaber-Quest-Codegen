...
static inline void Internal_CreatePlayable(::UnityEngine::Playables::PlayableAsset*  asset, ::UnityEngine::Playables::PlayableGraph  graph, ::UnityEngine::GameObject*  go, ::cordl_internals::intptr_t  ptr) ;

/// @brief Method Internal_GetPlayableAssetDuration addr 0x2cf59c8 size 0x28 virtual false final false
static inline void Internal_GetPlayableAssetDuration(::UnityEngine::Playables::PlayableAsset*  asset, ::cordl_internals::intptr_t  ptrToDouble) ;
