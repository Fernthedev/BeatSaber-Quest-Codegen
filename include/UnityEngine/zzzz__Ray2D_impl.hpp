...
constexpr ::UnityEngine::Vector2& UnityEngine::Ray2D::__get_m_Origin()  {
...
constexpr ::UnityEngine::Vector2 const& UnityEngine::Ray2D::__get_m_Origin() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Vector2& UnityEngine::Ray2D::__get_m_Direction()  {
...
constexpr ::UnityEngine::Vector2 const& UnityEngine::Ray2D::__get_m_Direction() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Ray2D::Ray2D(::UnityEngine::Vector2  m_Origin, ::UnityEngine::Vector2  m_Direction) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->m_Origin = m_Origin;
