...
/// @brief Field _ygNode offset 0x10
 __declspec(property(get=__get__ygNode, put=__set__ygNode)) ::cordl_internals::intptr_t  _ygNode;

/// @brief Field _config offset 0x18
 __declspec(property(get=__get__config, put=__set__config)) ::UnityEngine::Yoga::YogaConfig*  _config;

/// @brief Field _parent offset 0x20
 __declspec(property(get=__get__parent, put=__set__parent)) ::System::WeakReference*  _parent;

/// @brief Field _children offset 0x28
...
/// @brief Field _measureFunction offset 0x30
...
/// @brief Field _baselineFunction offset 0x38
...
constexpr ::cordl_internals::intptr_t& __get__ygNode() ;

constexpr ::cordl_internals::intptr_t const& __get__ygNode() const;

constexpr void __set__config(::UnityEngine::Yoga::YogaConfig*  value) ;

constexpr ::UnityEngine::Yoga::YogaConfig* __get__config() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Yoga::YogaConfig*> __get__config() const;

constexpr void __set__parent(::System::WeakReference*  value) ;

constexpr ::System::WeakReference* __get__parent() ;

constexpr ::cordl_internals::to_const_pointer<::System::WeakReference*> __get__parent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Yoga::YogaNode*>*> __get__children() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Yoga::MeasureFunction*> __get__measureFunction() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Yoga::BaselineFunction*> __get__baselineFunction() const;
