...
struct CORDL_TYPE Ray2D : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
/// @brief Field m_Origin offset 0x0
 __declspec(property(get=__get_m_Origin, put=__set_m_Origin)) ::UnityEngine::Vector2  m_Origin;

/// @brief Field m_Direction offset 0x8
 __declspec(property(get=__get_m_Direction, put=__set_m_Direction)) ::UnityEngine::Vector2  m_Direction;
...
constexpr ::UnityEngine::Vector2& __get_m_Origin() ;

constexpr ::UnityEngine::Vector2 const& __get_m_Origin() const;

constexpr void __set_m_Direction(::UnityEngine::Vector2  value) ;

constexpr ::UnityEngine::Vector2& __get_m_Direction() ;

constexpr ::UnityEngine::Vector2 const& __get_m_Direction() const;
...
constexpr explicit Ray2D(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}
