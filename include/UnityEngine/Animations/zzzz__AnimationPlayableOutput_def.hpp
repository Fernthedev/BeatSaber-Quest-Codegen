...
struct CORDL_TYPE AnimationPlayableOutput : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
/// @brief Method Create addr 0x2c990f0 size 0xa8 virtual false final false
...
/// @brief Method .ctor addr 0x2c99214 size 0xc0 virtual false final false
inline void _ctor(::UnityEngine::Playables::PlayableOutputHandle  handle) ;

/// @brief Method get_Null addr 0x2c99198 size 0x7c virtual false final false
static inline ::UnityEngine::Animations::AnimationPlayableOutput get_Null() ;

/// @brief Method GetHandle addr 0x2c99318 size 0xc virtual true final true
inline ::UnityEngine::Playables::PlayableOutputHandle GetHandle() ;

/// @brief Method op_Implicit addr 0x2c99324 size 0x30 virtual false final false
...
/// @brief Method op_Explicit addr 0x2c99354 size 0x44 virtual false final false
...
/// @brief Method GetTarget addr 0x2c99398 size 0x3c virtual false final false
inline ::UnityEngine::Animator* GetTarget() ;

/// @brief Method SetTarget addr 0x2c992d4 size 0x44 virtual false final false
inline void SetTarget(::UnityEngine::Animator*  value) ;

/// @brief Method InternalGetTarget addr 0x2c993d4 size 0x3c virtual false final false
static inline ::UnityEngine::Animator* InternalGetTarget(ByRef<::UnityEngine::Playables::PlayableOutputHandle>  handle) ;

/// @brief Method InternalSetTarget addr 0x2c99410 size 0x44 virtual false final false
...
constexpr explicit AnimationPlayableOutput(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 AnimationPlayableOutput()  = default;
