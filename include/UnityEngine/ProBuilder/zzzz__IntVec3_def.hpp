...
struct CORDL_TYPE IntVec3 : public ::bs_hook::ValueTypeWrapper<0xc> {
public:
// Declarations
...
constexpr explicit IntVec3(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0xc>(instance) {
}
