...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> UnityEngine::ProBuilder::MeshHandle::__get_m_Transform() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x10>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Mesh*> UnityEngine::ProBuilder::MeshHandle::__get_m_Mesh() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Mesh*, 0x18>(this);
}
