...
// Ctor Parameters []
// @brief default ctor
 __EdgeLookup____c__DisplayClass16_0()  = default;
public:
...
struct CORDL_TYPE EdgeLookup : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
/// @brief Field m_Local offset 0x0
 __declspec(property(get=__get_m_Local, put=__set_m_Local)) ::UnityEngine::ProBuilder::Edge  m_Local;

/// @brief Field m_Common offset 0x8
 __declspec(property(get=__get_m_Common, put=__set_m_Common)) ::UnityEngine::ProBuilder::Edge  m_Common;
...
constexpr ::UnityEngine::ProBuilder::Edge& __get_m_Local() ;

constexpr ::UnityEngine::ProBuilder::Edge const& __get_m_Local() const;

constexpr void __set_m_Common(::UnityEngine::ProBuilder::Edge  value) ;

constexpr ::UnityEngine::ProBuilder::Edge& __get_m_Common() ;

constexpr ::UnityEngine::ProBuilder::Edge const& __get_m_Common() const;
...
constexpr explicit EdgeLookup(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}
