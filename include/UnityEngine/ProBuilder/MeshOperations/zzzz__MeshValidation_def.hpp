...
struct CORDL_TYPE __MeshValidation__AttributeValidationStrategy : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____MeshValidation__AttributeValidationStrategy_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __MeshValidation__AttributeValidationStrategy(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MeshValidation__AttributeValidationStrategy()  = default;
...
/// @brief Field triangle offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<::UnityEngine::ProBuilder::Triangle,bool>*> __get___9__0() const;
...
// Ctor Parameters []
// @brief default ctor
 __MeshValidation____c__DisplayClass5_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __MeshValidation____c__DisplayClass10_0()  = default;
public:
