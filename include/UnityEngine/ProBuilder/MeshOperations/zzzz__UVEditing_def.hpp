...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ProBuilder::Face*> __get_f1() const;

constexpr void __set_f2(::UnityEngine::ProBuilder::Face*  value) ;

constexpr ::UnityEngine::ProBuilder::Face* __get_f2() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ProBuilder::Face*> __get_f2() const;
...
// Ctor Parameters []
// @brief default ctor
 __UVEditing____c__DisplayClass0_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __UVEditing____c__DisplayClass4_0()  = default;
public:
