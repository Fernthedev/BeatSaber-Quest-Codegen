...
::cordl_internals::setInstanceField<::UnityEngine::ProBuilder::EntityType, 0x18>(this, std::forward<::UnityEngine::ProBuilder::EntityType>(value));
}
constexpr ::UnityEngine::ProBuilder::EntityType& UnityEngine::ProBuilder::Entity::__get_m_EntityType()  {
return ::cordl_internals::getInstanceField<::UnityEngine::ProBuilder::EntityType, 0x18>(this);
}
