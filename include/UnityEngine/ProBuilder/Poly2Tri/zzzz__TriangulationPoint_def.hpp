...
/// @brief Field INSERTED_INDEX offset 0x0
static constexpr int32_t  INSERTED_INDEX{static_cast<int32_t>(0xffffffff)};

/// @brief Field INVALID_INDEX offset 0x0
static constexpr int32_t  INVALID_INDEX{static_cast<int32_t>(0xfffffffe)};

/// @brief Field <Edges>k__BackingField offset 0x10
 __declspec(property(get=__get__Edges_k__BackingField, put=__set__Edges_k__BackingField)) ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint*>*  _Edges_k__BackingField;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint*>*> __get__Edges_k__BackingField() const;
...
/// @brief Method get_Edges addr 0x2b356d8 size 0x8 virtual false final false
inline ::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint*>* get_Edges() ;

/// @brief Method set_Edges addr 0x2b356e0 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2b2f1a4 size 0x3c virtual false final false
inline void _ctor(double_t  x, double_t  y, int32_t  index) ;

/// @brief Method ToString addr 0x2b356e8 size 0x1a4 virtual true final false
inline ::StringW ToString() ;

/// @brief Method get_Xf addr 0x2b3588c size 0xc virtual false final false
inline float_t get_Xf() ;

/// @brief Method set_Xf addr 0x2b35898 size 0xc virtual false final false
inline void set_Xf(float_t  value) ;

/// @brief Method get_Yf addr 0x2b358a4 size 0xc virtual false final false
inline float_t get_Yf() ;

/// @brief Method set_Yf addr 0x2b358b0 size 0xc virtual false final false
inline void set_Yf(float_t  value) ;

/// @brief Method AddEdge addr 0x2b34394 size 0xf0 virtual false final false
inline void AddEdge(::UnityEngine::ProBuilder::Poly2Tri::DTSweepConstraint*  e) ;

/// @brief Method get_HasEdges addr 0x2b315d0 size 0x10 virtual false final false
