...
/// @brief Field _polygons offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::ProBuilder::Poly2Tri::Polygon*>*> __get__polygons() const;

static inline ::UnityEngine::ProBuilder::Poly2Tri::PolygonSet* New_ctor() ;

/// @brief Method .ctor addr 0x2b2f200 size 0x7c virtual false final false
inline void _ctor() ;

static inline ::UnityEngine::ProBuilder::Poly2Tri::PolygonSet* New_ctor(::UnityEngine::ProBuilder::Poly2Tri::Polygon*  poly) ;

/// @brief Method .ctor addr 0x2b2f27c size 0x104 virtual false final false
inline void _ctor(::UnityEngine::ProBuilder::Poly2Tri::Polygon*  poly) ;

/// @brief Method Add addr 0x2b2f380 size 0xa8 virtual false final false
inline void Add(::UnityEngine::ProBuilder::Poly2Tri::Polygon*  p) ;

/// @brief Method get_Polygons addr 0x2b2f428 size 0x8 virtual false final false
