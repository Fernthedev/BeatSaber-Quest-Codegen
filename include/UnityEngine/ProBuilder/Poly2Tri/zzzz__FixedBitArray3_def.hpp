...
/// @brief Field <i>5__2 offset 0x24
...
/// @brief Method .ctor addr 0x2b36440 size 0x34 virtual false final false
inline void _ctor(int32_t  __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2b36520 size 0x4 virtual true final true
inline void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2b36524 size 0x70 virtual true final true
inline bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Boolean>.get_Current addr 0x2b36594 size 0x8 virtual true final true
inline bool System_Collections_Generic_IEnumerator_System_Boolean__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x2b3659c size 0x40 virtual true final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2b365dc size 0x5c virtual true final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<System.Boolean>.GetEnumerator addr 0x2b36638 size 0xc0 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2b366f8 size 0x4 virtual true final true
...
// Ctor Parameters []
// @brief default ctor
 __FixedBitArray3___Enumerate_d__10()  = default;
public:
...
struct CORDL_TYPE FixedBitArray3 : public ::bs_hook::ValueTypeWrapper<0x3> {
public:
// Declarations
...
/// @brief Field _0 offset 0x0
 __declspec(property(get=__get__0, put=__set__0)) bool  _0;

/// @brief Field _1 offset 0x1
 __declspec(property(get=__get__1, put=__set__1)) bool  _1;

/// @brief Field _2 offset 0x2
 __declspec(property(get=__get__2, put=__set__2)) bool  _2;
...
constexpr void __set__0(bool  value) ;

constexpr bool& __get__0() ;

constexpr bool const& __get__0() const;

constexpr void __set__1(bool  value) ;

constexpr bool& __get__1() ;

constexpr bool const& __get__1() const;

constexpr void __set__2(bool  value) ;

constexpr bool& __get__2() ;

constexpr bool const& __get__2() const;

/// @brief Method get_Item addr 0x2b30130 size 0x6c virtual false final false
inline bool get_Item(int32_t  index) ;

/// @brief Method set_Item addr 0x2b304e8 size 0x70 virtual false final false
inline void set_Item(int32_t  index, bool  value) ;

/// @brief Method Contains addr 0x2b362d8 size 0x4c virtual false final false
inline bool Contains(bool  value) ;

/// @brief Method IndexOf addr 0x2b36324 size 0x48 virtual false final false
inline int32_t IndexOf(bool  value) ;

/// @brief Method Clear addr 0x2b33da0 size 0xc virtual false final false
inline void Clear() ;

/// @brief Method Clear addr 0x2b3636c size 0x50 virtual false final false
inline void Clear(bool  value) ;

/// @brief Method Enumerate addr 0x2b363bc size 0x84 virtual false final false
inline ::System::Collections::Generic::IEnumerable_1<bool>* Enumerate() ;

/// @brief Method GetEnumerator addr 0x2b36474 size 0xa8 virtual true final true
inline ::System::Collections::Generic::IEnumerator_1<bool>* GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2b3651c size 0x4 virtual true final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;
...
constexpr explicit FixedBitArray3(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x3>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 FixedBitArray3()  = default;
