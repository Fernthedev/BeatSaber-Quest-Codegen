...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::IList_1<::UnityEngine::ProBuilder::Poly2Tri::TriangulationPoint*>* (::UnityEngine::ProBuilder::Poly2Tri::Triangulatable::*)()>(&::UnityEngine::ProBuilder::Poly2Tri::Triangulatable::get_Points)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ProBuilder::Poly2Tri::Triangulatable::*)()>(&::UnityEngine::ProBuilder::Poly2Tri::Triangulatable::ClearTriangles)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
