...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Object* (::UnityEngine::ProBuilder::WingedEdgeEnumerator::*)()>(&::UnityEngine::ProBuilder::WingedEdgeEnumerator::System_Collections_IEnumerator_get_Current)> {
  constexpr static std::size_t size = 0x8;
...
::cordl_internals::setInstanceField<::UnityEngine::ProBuilder::WingedEdge*, 0x10>(this, std::forward<::UnityEngine::ProBuilder::WingedEdge*>(value));
}
constexpr ::UnityEngine::ProBuilder::WingedEdge* UnityEngine::ProBuilder::WingedEdgeEnumerator::__get_m_Start()  {
return ::cordl_internals::getInstanceField<::UnityEngine::ProBuilder::WingedEdge*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ProBuilder::WingedEdge*> UnityEngine::ProBuilder::WingedEdgeEnumerator::__get_m_Start() const {
return ::cordl_internals::getInstanceField<::UnityEngine::ProBuilder::WingedEdge*, 0x10>(this);
}
constexpr void UnityEngine::ProBuilder::WingedEdgeEnumerator::__set_m_Current(::UnityEngine::ProBuilder::WingedEdge*  value)  {
::cordl_internals::setInstanceField<::UnityEngine::ProBuilder::WingedEdge*, 0x18>(this, std::forward<::UnityEngine::ProBuilder::WingedEdge*>(value));
}
constexpr ::UnityEngine::ProBuilder::WingedEdge* UnityEngine::ProBuilder::WingedEdgeEnumerator::__get_m_Current()  {
return ::cordl_internals::getInstanceField<::UnityEngine::ProBuilder::WingedEdge*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ProBuilder::WingedEdge*> UnityEngine::ProBuilder::WingedEdgeEnumerator::__get_m_Current() const {
return ::cordl_internals::getInstanceField<::UnityEngine::ProBuilder::WingedEdge*, 0x18>(this);
}
