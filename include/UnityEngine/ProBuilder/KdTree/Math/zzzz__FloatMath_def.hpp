...
namespace UnityEngine::ProBuilder::KdTree::Math {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15927), inst: 391 }), TypeDefinitionIndex(TypeDefinitionIndex(15927))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x10 - sizeof(::UnityEngine::ProBuilder::KdTree::Math::TypeMath_1<float_t>)]{};
