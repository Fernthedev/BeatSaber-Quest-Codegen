...
struct CORDL_TYPE Rect : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
/// @brief Field m_XMin offset 0x0
 __declspec(property(get=__get_m_XMin, put=__set_m_XMin)) float_t  m_XMin;

/// @brief Field m_YMin offset 0x4
 __declspec(property(get=__get_m_YMin, put=__set_m_YMin)) float_t  m_YMin;
...
constexpr float_t& __get_m_XMin() ;

constexpr float_t const& __get_m_XMin() const;

constexpr void __set_m_YMin(float_t  value) ;

constexpr float_t& __get_m_YMin() ;

constexpr float_t const& __get_m_YMin() const;
...
constexpr explicit Rect(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}
