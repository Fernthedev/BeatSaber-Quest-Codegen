...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord::*)(::System::Object*)>(&::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord::Equals)> {
...
constexpr uint32_t& UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord::__get_m_GlyphIndex()  {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord::__get_m_GlyphIndex() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
::cordl_internals::setInstanceField<::UnityEngine::TextCore::LowLevel::GlyphValueRecord, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::UnityEngine::TextCore::LowLevel::GlyphValueRecord>(value));
}
constexpr ::UnityEngine::TextCore::LowLevel::GlyphValueRecord& UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord::__get_m_GlyphValueRecord()  {
return ::cordl_internals::getInstanceField<::UnityEngine::TextCore::LowLevel::GlyphValueRecord, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::UnityEngine::TextCore::LowLevel::GlyphValueRecord const& UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord::__get_m_GlyphValueRecord() const {
return ::cordl_internals::getInstanceField<::UnityEngine::TextCore::LowLevel::GlyphValueRecord, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::TextCore::LowLevel::GlyphAdjustmentRecord::GlyphAdjustmentRecord(uint32_t  m_GlyphIndex, ::UnityEngine::TextCore::LowLevel::GlyphValueRecord  m_GlyphValueRecord) noexcept : ::bs_hook::ValueTypeWrapper<0x14>() {this->m_GlyphIndex = m_GlyphIndex;
