...
/// @brief Method .ctor addr 0x2d4366c size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <SortGlyphPairAdjustmentRecords>b__6_0 addr 0x2d43674 size 0x48 virtual false final false
inline uint32_t _SortGlyphPairAdjustmentRecords_b__6_0(::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord  s) ;

/// @brief Method <SortGlyphPairAdjustmentRecords>b__6_1 addr 0x2d436bc size 0x48 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __FontFeatureTable____c()  = default;
public:
...
/// @brief Field m_GlyphPairAdjustmentRecords offset 0x10
 __declspec(property(get=__get_m_GlyphPairAdjustmentRecords, put=__set_m_GlyphPairAdjustmentRecords)) ::System::Collections::Generic::List_1<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord>*  m_GlyphPairAdjustmentRecords;

/// @brief Field m_GlyphPairAdjustmentRecordLookup offset 0x18
 __declspec(property(get=__get_m_GlyphPairAdjustmentRecordLookup, put=__set_m_GlyphPairAdjustmentRecordLookup)) ::System::Collections::Generic::Dictionary_2<uint32_t,::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord>*  m_GlyphPairAdjustmentRecordLookup;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord>*> __get_m_GlyphPairAdjustmentRecords() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint32_t,::UnityEngine::TextCore::LowLevel::GlyphPairAdjustmentRecord>*> __get_m_GlyphPairAdjustmentRecordLookup() const;

/// @brief Method get_glyphPairAdjustmentRecords addr 0x2d3f20c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2d3e8b4 size 0xc4 virtual false final false
inline void _ctor() ;

/// @brief Method SortGlyphPairAdjustmentRecords addr 0x2d39cb4 size 0x1ec virtual false final false
