...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x1e0 - sizeof(::UnityEngine::TextCore::Text::TextAsset)]{};
...
/// @brief Field InternalDynamicOS offset 0x4c
...
/// @brief Field m_FamilyNameHashCode offset 0xb0
 __declspec(property(get=__get_m_FamilyNameHashCode, put=__set_m_FamilyNameHashCode)) int32_t  m_FamilyNameHashCode;

/// @brief Field m_StyleNameHashCode offset 0xb4
 __declspec(property(get=__get_m_StyleNameHashCode, put=__set_m_StyleNameHashCode)) int32_t  m_StyleNameHashCode;

/// @brief Field m_FontWeightTable offset 0xb8
 __declspec(property(get=__get_m_FontWeightTable, put=__set_m_FontWeightTable)) ::ArrayW<::UnityEngine::TextCore::Text::FontWeightPair,::Array<::UnityEngine::TextCore::Text::FontWeightPair>*>  m_FontWeightTable;

/// @brief Field m_GlyphTable offset 0xc0
...
/// @brief Field m_GlyphLookupDictionary offset 0xc8
...
/// @brief Field m_CharacterTable offset 0xd0
...
/// @brief Field m_CharacterLookupDictionary offset 0xd8
 __declspec(property(get=__get_m_CharacterLookupDictionary, put=__set_m_CharacterLookupDictionary)) ::System::Collections::Generic::Dictionary_2<uint32_t,::UnityEngine::TextCore::Text::Character*>*  m_CharacterLookupDictionary;

/// @brief Field m_AtlasTexture offset 0xe0
 __declspec(property(get=__get_m_AtlasTexture, put=__set_m_AtlasTexture)) ::UnityEngine::Texture2D*  m_AtlasTexture;

/// @brief Field m_AtlasTextures offset 0xe8
...
/// @brief Field m_ClearDynamicDataOnBuild offset 0xf5
...
/// @brief Field m_UsedGlyphRects offset 0x108
...
/// @brief Field m_FreeGlyphRects offset 0x110
...
/// @brief Field m_FontFeatureTable offset 0x118
...
/// @brief Field m_FallbackFontAssetTable offset 0x120
 __declspec(property(get=__get_m_FallbackFontAssetTable, put=__set_m_FallbackFontAssetTable)) ::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::FontAsset*>*  m_FallbackFontAssetTable;

/// @brief Field m_fontAssetCreationEditorSettings offset 0x128
 __declspec(property(get=__get_m_fontAssetCreationEditorSettings, put=__set_m_fontAssetCreationEditorSettings)) ::UnityEngine::TextCore::Text::FontAssetCreationEditorSettings  m_fontAssetCreationEditorSettings;

/// @brief Field m_RegularStyleWeight offset 0x178
 __declspec(property(get=__get_m_RegularStyleWeight, put=__set_m_RegularStyleWeight)) float_t  m_RegularStyleWeight;

/// @brief Field m_RegularStyleSpacing offset 0x17c
 __declspec(property(get=__get_m_RegularStyleSpacing, put=__set_m_RegularStyleSpacing)) float_t  m_RegularStyleSpacing;

/// @brief Field m_BoldStyleWeight offset 0x180
 __declspec(property(get=__get_m_BoldStyleWeight, put=__set_m_BoldStyleWeight)) float_t  m_BoldStyleWeight;

/// @brief Field m_BoldStyleSpacing offset 0x184
 __declspec(property(get=__get_m_BoldStyleSpacing, put=__set_m_BoldStyleSpacing)) float_t  m_BoldStyleSpacing;

/// @brief Field m_ItalicStyleSlant offset 0x188
 __declspec(property(get=__get_m_ItalicStyleSlant, put=__set_m_ItalicStyleSlant)) uint8_t  m_ItalicStyleSlant;

/// @brief Field m_TabMultiple offset 0x189
 __declspec(property(get=__get_m_TabMultiple, put=__set_m_TabMultiple)) uint8_t  m_TabMultiple;

/// @brief Field IsFontAssetLookupTablesDirty offset 0x18a
...
/// @brief Field m_GlyphsToRender offset 0x190
...
/// @brief Field m_GlyphsRendered offset 0x198
...
/// @brief Field m_GlyphIndexList offset 0x1a0
...
/// @brief Field m_GlyphIndexListNewlyAdded offset 0x1a8
...
/// @brief Field m_GlyphsToAdd offset 0x1b0
...
/// @brief Field m_GlyphsToAddLookup offset 0x1b8
...
/// @brief Field m_CharactersToAdd offset 0x1c0
...
/// @brief Field m_CharactersToAddLookup offset 0x1c8
...
/// @brief Field s_MissingCharacterList offset 0x1d0
...
/// @brief Field m_MissingUnicodesFromFontFile offset 0x1d8
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::Character*>*> __get_m_CharacterTable() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint32_t,::UnityEngine::TextCore::Text::Character*>*> __get_m_CharacterLookupDictionary() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TextCore::Text::FontFeatureTable*> __get_m_FontFeatureTable() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::FontAsset*>*> __get_m_FallbackFontAssetTable() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::Character*>*> __get_m_CharactersToAdd() const;
...
static inline ::UnityEngine::TextCore::Text::FontAsset* CreateFontAsset(::StringW  fontFilePath, int32_t  faceIndex, int32_t  samplingPointSize, int32_t  atlasPadding, ::UnityEngine::TextCore::LowLevel::GlyphRenderMode  renderMode, int32_t  atlasWidth, int32_t  atlasHeight, ::UnityEngine::TextCore::Text::AtlasPopulationMode  atlasPopulationMode, bool  enableMultiAtlasSupport) ;
...
static inline ::UnityEngine::TextCore::Text::FontAsset* CreateFontAsset(::UnityEngine::Font*  font, int32_t  samplingPointSize, int32_t  atlasPadding, ::UnityEngine::TextCore::LowLevel::GlyphRenderMode  renderMode, int32_t  atlasWidth, int32_t  atlasHeight, ::UnityEngine::TextCore::Text::AtlasPopulationMode  atlasPopulationMode, bool  enableMultiAtlasSupport) ;

/// @brief Method CreateFontAsset addr 0x2d38a48 size 0x214 virtual false final false
static inline ::UnityEngine::TextCore::Text::FontAsset* CreateFontAsset(::UnityEngine::Font*  font, int32_t  faceIndex, int32_t  samplingPointSize, int32_t  atlasPadding, ::UnityEngine::TextCore::LowLevel::GlyphRenderMode  renderMode, int32_t  atlasWidth, int32_t  atlasHeight, ::UnityEngine::TextCore::Text::AtlasPopulationMode  atlasPopulationMode, bool  enableMultiAtlasSupport) ;

/// @brief Method CreateFontAssetInstance addr 0x2d384b0 size 0x45c virtual false final false
static inline ::UnityEngine::TextCore::Text::FontAsset* CreateFontAssetInstance(::UnityEngine::Font*  font, int32_t  atlasPadding, ::UnityEngine::TextCore::LowLevel::GlyphRenderMode  renderMode, int32_t  atlasWidth, int32_t  atlasHeight, ::UnityEngine::TextCore::Text::AtlasPopulationMode  atlasPopulationMode, bool  enableMultiAtlasSupport) ;
