...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::HashSet_1<uint32_t>* (::UnityEngine::TextCore::Text::UnicodeLineBreakingRules::*)()>(&::UnityEngine::TextCore::Text::UnicodeLineBreakingRules::get_leadingCharactersLookup)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::HashSet_1<uint32_t>* (::UnityEngine::TextCore::Text::UnicodeLineBreakingRules::*)()>(&::UnityEngine::TextCore::Text::UnicodeLineBreakingRules::get_followingCharactersLookup)> {
  constexpr static std::size_t size = 0x88;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Collections::Generic::HashSet_1<uint32_t>* (*)(::UnityEngine::TextAsset*)>(&::UnityEngine::TextCore::Text::UnicodeLineBreakingRules::GetCharacters)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::TextCore::Text::UnicodeLineBreakingRules::*)()>(&::UnityEngine::TextCore::Text::UnicodeLineBreakingRules::_ctor)> {
...
::cordl_internals::setStaticField<::UnityEngine::TextCore::Text::UnicodeLineBreakingRules*, "s_Instance", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::UnicodeLineBreakingRules*>::get>(std::forward<::UnityEngine::TextCore::Text::UnicodeLineBreakingRules*>(value));
}
...
return ::cordl_internals::getStaticField<::UnityEngine::TextCore::Text::UnicodeLineBreakingRules*, "s_Instance", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::UnicodeLineBreakingRules*>::get>();
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TextAsset*> UnityEngine::TextCore::Text::UnicodeLineBreakingRules::__get_m_UnicodeLineBreakingRules() const {
return ::cordl_internals::getInstanceField<::UnityEngine::TextAsset*, 0x10>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TextAsset*> UnityEngine::TextCore::Text::UnicodeLineBreakingRules::__get_m_LeadingCharacters() const {
return ::cordl_internals::getInstanceField<::UnityEngine::TextAsset*, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::UnityEngine::TextAsset*, 0x20>(this, std::forward<::UnityEngine::TextAsset*>(value));
}
constexpr ::UnityEngine::TextAsset* UnityEngine::TextCore::Text::UnicodeLineBreakingRules::__get_m_FollowingCharacters()  {
return ::cordl_internals::getInstanceField<::UnityEngine::TextAsset*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TextAsset*> UnityEngine::TextCore::Text::UnicodeLineBreakingRules::__get_m_FollowingCharacters() const {
return ::cordl_internals::getInstanceField<::UnityEngine::TextAsset*, 0x20>(this);
}
...
::cordl_internals::setStaticField<::System::Collections::Generic::HashSet_1<uint32_t>*, "s_LeadingCharactersLookup", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::UnicodeLineBreakingRules*>::get>(std::forward<::System::Collections::Generic::HashSet_1<uint32_t>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Collections::Generic::HashSet_1<uint32_t>*, "s_LeadingCharactersLookup", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::UnicodeLineBreakingRules*>::get>();
}
...
::cordl_internals::setStaticField<::System::Collections::Generic::HashSet_1<uint32_t>*, "s_FollowingCharactersLookup", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::UnicodeLineBreakingRules*>::get>(std::forward<::System::Collections::Generic::HashSet_1<uint32_t>*>(value));
}
...
return ::cordl_internals::getStaticField<::System::Collections::Generic::HashSet_1<uint32_t>*, "s_FollowingCharactersLookup", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::TextCore::Text::UnicodeLineBreakingRules*>::get>();
}
