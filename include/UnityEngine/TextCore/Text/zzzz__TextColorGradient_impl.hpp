...
::cordl_internals::setInstanceField<::UnityEngine::TextCore::Text::ColorGradientMode, 0x18>(this, std::forward<::UnityEngine::TextCore::Text::ColorGradientMode>(value));
}
constexpr ::UnityEngine::TextCore::Text::ColorGradientMode& UnityEngine::TextCore::Text::TextColorGradient::__get_colorMode()  {
return ::cordl_internals::getInstanceField<::UnityEngine::TextCore::Text::ColorGradientMode, 0x18>(this);
}
