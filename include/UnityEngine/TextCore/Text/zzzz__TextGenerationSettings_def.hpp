...
/// @brief Field overflowMode offset 0x74
...
/// @brief Field verticalMapping offset 0xe8
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TextCore::Text::TextStyleSheet*> __get_styleSheet() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TextCore::Text::TextSettings*> __get_textSettings() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TextCore::Text::TextColorGradient*> __get_fontColorGradient() const;
