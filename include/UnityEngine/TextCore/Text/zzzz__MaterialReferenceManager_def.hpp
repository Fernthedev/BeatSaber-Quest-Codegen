...
/// @brief Field m_FontMaterialReferenceLookup offset 0x10
 __declspec(property(get=__get_m_FontMaterialReferenceLookup, put=__set_m_FontMaterialReferenceLookup)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::Material*>*  m_FontMaterialReferenceLookup;

/// @brief Field m_FontAssetReferenceLookup offset 0x18
 __declspec(property(get=__get_m_FontAssetReferenceLookup, put=__set_m_FontAssetReferenceLookup)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::TextCore::Text::FontAsset*>*  m_FontAssetReferenceLookup;

/// @brief Field m_SpriteAssetReferenceLookup offset 0x20
 __declspec(property(get=__get_m_SpriteAssetReferenceLookup, put=__set_m_SpriteAssetReferenceLookup)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::TextCore::Text::SpriteAsset*>*  m_SpriteAssetReferenceLookup;

/// @brief Field m_ColorGradientReferenceLookup offset 0x28
 __declspec(property(get=__get_m_ColorGradientReferenceLookup, put=__set_m_ColorGradientReferenceLookup)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::TextCore::Text::TextColorGradient*>*  m_ColorGradientReferenceLookup;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::Material*>*> __get_m_FontMaterialReferenceLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::TextCore::Text::FontAsset*>*> __get_m_FontAssetReferenceLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::TextCore::Text::SpriteAsset*>*> __get_m_SpriteAssetReferenceLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::TextCore::Text::TextColorGradient*>*> __get_m_ColorGradientReferenceLookup() const;
...
// Ctor Parameters []
// @brief default ctor
 MaterialReferenceManager()  = default;
public:
