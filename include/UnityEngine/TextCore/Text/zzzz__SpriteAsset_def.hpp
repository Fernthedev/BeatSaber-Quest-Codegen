...
/// @brief Method .ctor addr 0x2d427d8 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <SortGlyphTable>b__37_0 addr 0x2d427e0 size 0x18 virtual false final false
inline uint32_t _SortGlyphTable_b__37_0(::UnityEngine::TextCore::Text::SpriteGlyph*  item) ;

/// @brief Method <SortCharacterTable>b__38_0 addr 0x2d427f8 size 0x18 virtual false final false
...
namespace UnityEngine::TextCore::Text {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13724))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xe0 - sizeof(::UnityEngine::TextCore::Text::TextAsset)]{};

/// @brief Field m_NameLookup offset 0x38
...
/// @brief Field m_GlyphIndexLookup offset 0x40
...
/// @brief Field m_SpriteCharacterTable offset 0xb0
 __declspec(property(get=__get_m_SpriteCharacterTable, put=__set_m_SpriteCharacterTable)) ::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteCharacter*>*  m_SpriteCharacterTable;

/// @brief Field m_SpriteCharacterLookup offset 0xb8
 __declspec(property(get=__get_m_SpriteCharacterLookup, put=__set_m_SpriteCharacterLookup)) ::System::Collections::Generic::Dictionary_2<uint32_t,::UnityEngine::TextCore::Text::SpriteCharacter*>*  m_SpriteCharacterLookup;

/// @brief Field m_SpriteGlyphTable offset 0xc0
...
/// @brief Field m_SpriteGlyphLookup offset 0xc8
 __declspec(property(get=__get_m_SpriteGlyphLookup, put=__set_m_SpriteGlyphLookup)) ::System::Collections::Generic::Dictionary_2<uint32_t,::UnityEngine::TextCore::Text::SpriteGlyph*>*  m_SpriteGlyphLookup;

/// @brief Field fallbackSpriteAssets offset 0xd0
...
/// @brief Field m_IsSpriteAssetLookupTablesDirty offset 0xd8
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,int32_t>*> __get_m_NameLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint32_t,int32_t>*> __get_m_GlyphIndexLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Texture*> __get_m_SpriteAtlasTexture() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteCharacter*>*> __get_m_SpriteCharacterTable() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint32_t,::UnityEngine::TextCore::Text::SpriteCharacter*>*> __get_m_SpriteCharacterLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteGlyph*>*> __get_m_SpriteGlyphTable() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint32_t,::UnityEngine::TextCore::Text::SpriteGlyph*>*> __get_m_SpriteGlyphLookup() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteAsset*>*> __get_fallbackSpriteAssets() const;
...
/// @brief Method get_faceInfo addr 0x2d413ac size 0x1c virtual false final false
inline ::UnityEngine::TextCore::FaceInfo get_faceInfo() ;

/// @brief Method set_faceInfo addr 0x2d413c8 size 0x18 virtual false final false
inline void set_faceInfo(::UnityEngine::TextCore::FaceInfo  value) ;

/// @brief Method get_spriteSheet addr 0x2d413e0 size 0x8 virtual false final false
inline ::UnityEngine::Texture* get_spriteSheet() ;

/// @brief Method set_spriteSheet addr 0x2d413e8 size 0x8 virtual false final false
inline void set_spriteSheet(::UnityEngine::Texture*  value) ;

/// @brief Method get_spriteCharacterTable addr 0x2d413f0 size 0x24 virtual false final false
inline ::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteCharacter*>* get_spriteCharacterTable() ;

/// @brief Method set_spriteCharacterTable addr 0x2d418f0 size 0x8 virtual false final false
inline void set_spriteCharacterTable(::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteCharacter*>*  value) ;

/// @brief Method get_spriteCharacterLookupTable addr 0x2d418f8 size 0x24 virtual false final false
...
/// @brief Method set_spriteCharacterLookupTable addr 0x2d4191c size 0x8 virtual false final false
...
/// @brief Method get_spriteGlyphTable addr 0x2d41924 size 0x8 virtual false final false
inline ::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteGlyph*>* get_spriteGlyphTable() ;

/// @brief Method set_spriteGlyphTable addr 0x2d4192c size 0x8 virtual false final false
inline void set_spriteGlyphTable(::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteGlyph*>*  value) ;

/// @brief Method Awake addr 0x2d41934 size 0x4 virtual false final false
inline void Awake() ;

/// @brief Method UpdateLookupTables addr 0x2d41414 size 0x4dc virtual false final false
inline void UpdateLookupTables() ;

/// @brief Method GetSpriteIndexFromHashcode addr 0x2d41938 size 0x88 virtual false final false
inline int32_t GetSpriteIndexFromHashcode(int32_t  hashCode) ;

/// @brief Method GetSpriteIndexFromUnicode addr 0x2d419c0 size 0x94 virtual false final false
inline int32_t GetSpriteIndexFromUnicode(uint32_t  unicode) ;

/// @brief Method GetSpriteIndexFromName addr 0x2d41a54 size 0x3c virtual false final false
inline int32_t GetSpriteIndexFromName(::StringW  name) ;

/// @brief Method SearchForSpriteByUnicode addr 0x2d41a90 size 0x1c8 virtual false final false
static inline ::UnityEngine::TextCore::Text::SpriteAsset* SearchForSpriteByUnicode(::UnityEngine::TextCore::Text::SpriteAsset*  spriteAsset, uint32_t  unicode, bool  includeFallbacks, ByRef<int32_t>  spriteIndex) ;

/// @brief Method SearchForSpriteByUnicodeInternal addr 0x2d41c58 size 0x1a0 virtual false final false
static inline ::UnityEngine::TextCore::Text::SpriteAsset* SearchForSpriteByUnicodeInternal(::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteAsset*>*  spriteAssets, uint32_t  unicode, bool  includeFallbacks, ByRef<int32_t>  spriteIndex) ;

/// @brief Method SearchForSpriteByUnicodeInternal addr 0x2d41df8 size 0xb0 virtual false final false
static inline ::UnityEngine::TextCore::Text::SpriteAsset* SearchForSpriteByUnicodeInternal(::UnityEngine::TextCore::Text::SpriteAsset*  spriteAsset, uint32_t  unicode, bool  includeFallbacks, ByRef<int32_t>  spriteIndex) ;

/// @brief Method SearchForSpriteByHashCode addr 0x2d41ea8 size 0x32c virtual false final false
static inline ::UnityEngine::TextCore::Text::SpriteAsset* SearchForSpriteByHashCode(::UnityEngine::TextCore::Text::SpriteAsset*  spriteAsset, int32_t  hashCode, bool  includeFallbacks, ByRef<int32_t>  spriteIndex, ::UnityEngine::TextCore::Text::TextSettings*  textSettings) ;

/// @brief Method SearchForSpriteByHashCodeInternal addr 0x2d421d4 size 0x1a0 virtual false final false
static inline ::UnityEngine::TextCore::Text::SpriteAsset* SearchForSpriteByHashCodeInternal(::System::Collections::Generic::List_1<::UnityEngine::TextCore::Text::SpriteAsset*>*  spriteAssets, int32_t  hashCode, bool  searchFallbacks, ByRef<int32_t>  spriteIndex) ;

/// @brief Method SearchForSpriteByHashCodeInternal addr 0x2d42374 size 0xb0 virtual false final false
static inline ::UnityEngine::TextCore::Text::SpriteAsset* SearchForSpriteByHashCodeInternal(::UnityEngine::TextCore::Text::SpriteAsset*  spriteAsset, int32_t  hashCode, bool  searchFallbacks, ByRef<int32_t>  spriteIndex) ;

/// @brief Method SortGlyphTable addr 0x2d42424 size 0x138 virtual false final false
inline void SortGlyphTable() ;

/// @brief Method SortCharacterTable addr 0x2d4255c size 0x13c virtual false final false
inline void SortCharacterTable() ;

/// @brief Method SortGlyphAndCharacterTables addr 0x2d42698 size 0x18 virtual false final false
inline void SortGlyphAndCharacterTables() ;

static inline ::UnityEngine::TextCore::Text::SpriteAsset* New_ctor() ;

/// @brief Method .ctor addr 0x2d426b0 size 0xc4 virtual false final false
inline void _ctor() ;
...
// Static field k_searchedSpriteAssets
