...
struct CORDL_TYPE LineInfo : public ::bs_hook::ValueTypeWrapper<0x60> {
public:
// Declarations
...
/// @brief Field visibleSpaceCount offset 0x10
 __declspec(property(get=__get_visibleSpaceCount, put=__set_visibleSpaceCount)) int32_t  visibleSpaceCount;

/// @brief Field wordCount offset 0x14
 __declspec(property(get=__get_wordCount, put=__set_wordCount)) int32_t  wordCount;

/// @brief Field firstCharacterIndex offset 0x18
 __declspec(property(get=__get_firstCharacterIndex, put=__set_firstCharacterIndex)) int32_t  firstCharacterIndex;

/// @brief Field firstVisibleCharacterIndex offset 0x1c
...
/// @brief Field marginLeft offset 0x44
 __declspec(property(get=__get_marginLeft, put=__set_marginLeft)) float_t  marginLeft;

/// @brief Field marginRight offset 0x48
 __declspec(property(get=__get_marginRight, put=__set_marginRight)) float_t  marginRight;

/// @brief Field alignment offset 0x4c
 __declspec(property(get=__get_alignment, put=__set_alignment)) ::UnityEngine::TextCore::Text::TextAlignment  alignment;

/// @brief Field lineExtents offset 0x50
 __declspec(property(get=__get_lineExtents, put=__set_lineExtents)) ::UnityEngine::TextCore::Text::Extents  lineExtents;
...
constexpr int32_t& __get_visibleSpaceCount() ;

constexpr int32_t const& __get_visibleSpaceCount() const;
...
constexpr ::UnityEngine::TextCore::Text::TextAlignment& __get_alignment() ;

constexpr ::UnityEngine::TextCore::Text::TextAlignment const& __get_alignment() const;

constexpr void __set_lineExtents(::UnityEngine::TextCore::Text::Extents  value) ;

constexpr ::UnityEngine::TextCore::Text::Extents& __get_lineExtents() ;

constexpr ::UnityEngine::TextCore::Text::Extents const& __get_lineExtents() const;
...
constexpr explicit LineInfo(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x60>(instance) {
}
