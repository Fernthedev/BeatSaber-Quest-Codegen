...
struct CORDL_TYPE PageInfo : public ::bs_hook::ValueTypeWrapper<0x14> {
public:
// Declarations
...
constexpr explicit PageInfo(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x14>(instance) {
}
