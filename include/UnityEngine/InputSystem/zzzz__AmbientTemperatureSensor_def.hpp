...
/// @brief Field <ambientTemperature>k__BackingField offset 0x158
 __declspec(property(get=__get__ambientTemperature_k__BackingField, put=__set__ambientTemperature_k__BackingField)) ::UnityEngine::InputSystem::Controls::AxisControl*  _ambientTemperature_k__BackingField;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::AxisControl*> __get__ambientTemperature_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 AmbientTemperatureSensor()  = default;
public:
