...
struct CORDL_TYPE __InputActionSetupExtensions__BindingSyntax : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x18};

/// @brief Field m_ActionMap offset 0x0
...
/// @brief Field m_BindingIndexInMap offset 0x10
 __declspec(property(get=__get_m_BindingIndexInMap, put=__set_m_BindingIndexInMap)) int32_t  m_BindingIndexInMap;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputActionMap*> __get_m_ActionMap() const;
...
constexpr int32_t& __get_m_BindingIndexInMap() ;

constexpr int32_t const& __get_m_BindingIndexInMap() const;

/// @brief Method get_valid addr 0x2a4b3c0 size 0x6c virtual false final false
inline bool get_valid() ;

/// @brief Method get_bindingIndex addr 0x2a4b42c size 0x38 virtual false final false
inline int32_t get_bindingIndex() ;

/// @brief Method get_binding addr 0x2a4b464 size 0xac virtual false final false
inline ::UnityEngine::InputSystem::InputBinding get_binding() ;

/// @brief Method .ctor addr 0x2a4b510 size 0xc virtual false final false
...
/// @brief Method WithProcessor addr 0x2a4bd94 size 0x1a8 virtual false final false
inline ::UnityEngine::InputSystem::__InputActionSetupExtensions__BindingSyntax WithProcessor(::StringW  processor) ;

/// @brief Method WithProcessors addr 0x2a4bf3c size 0x1d4 virtual false final false
...
/// @brief Method Triggering addr 0x2a4c110 size 0x17c virtual false final false
...
/// @brief Method To addr 0x2a4c28c size 0x134 virtual false final false
...
/// @brief Method Iterate addr 0x2a4c3f4 size 0xb0 virtual false final false
inline ::UnityEngine::InputSystem::__InputActionSetupExtensions__BindingSyntax Iterate(bool  next) ;

/// @brief Method IterateCompositeBinding addr 0x2a4c770 size 0xf4 virtual false final false
...
/// @brief Method IteratePartBinding addr 0x2a4c580 size 0x110 virtual false final false
inline ::UnityEngine::InputSystem::__InputActionSetupExtensions__BindingSyntax IteratePartBinding(bool  next, ::StringW  partName) ;

/// @brief Method Erase addr 0x2a4c90c size 0x17c virtual false final false
inline void Erase() ;

/// @brief Method InsertPartBinding addr 0x2a4ca88 size 0x16c virtual false final false
...
constexpr explicit __InputActionSetupExtensions__BindingSyntax(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputActionSetupExtensions__BindingSyntax()  = default;
...
struct CORDL_TYPE __InputActionSetupExtensions__CompositeSyntax : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x18};

/// @brief Field m_Action offset 0x0
 __declspec(property(get=__get_m_Action, put=__set_m_Action)) ::UnityEngine::InputSystem::InputAction*  m_Action;

/// @brief Field m_ActionMap offset 0x8
 __declspec(property(get=__get_m_ActionMap, put=__set_m_ActionMap)) ::UnityEngine::InputSystem::InputActionMap*  m_ActionMap;
...
/// @brief Method get_bindingIndex addr 0x2a4cc10 size 0x2c virtual false final false
inline int32_t get_bindingIndex() ;

/// @brief Method .ctor addr 0x2a4cc3c size 0xc virtual false final false
...
/// @brief Method With addr 0x2a4cc48 size 0x24c virtual false final false
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputActionSetupExtensions__CompositeSyntax(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputActionSetupExtensions__CompositeSyntax()  = default;
...
struct CORDL_TYPE __InputActionSetupExtensions__ControlSchemeSyntax : public ::bs_hook::ValueTypeWrapper<0x28> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x28};

/// @brief Field m_Asset offset 0x0
 __declspec(property(get=__get_m_Asset, put=__set_m_Asset)) ::UnityEngine::InputSystem::InputActionAsset*  m_Asset;

/// @brief Field m_ControlSchemeIndex offset 0x8
 __declspec(property(get=__get_m_ControlSchemeIndex, put=__set_m_ControlSchemeIndex)) int32_t  m_ControlSchemeIndex;

/// @brief Field m_ControlScheme offset 0x10
 __declspec(property(get=__get_m_ControlScheme, put=__set_m_ControlScheme)) ::UnityEngine::InputSystem::InputControlScheme  m_ControlScheme;
...
constexpr int32_t& __get_m_ControlSchemeIndex() ;

constexpr int32_t const& __get_m_ControlSchemeIndex() const;

constexpr void __set_m_ControlScheme(::UnityEngine::InputSystem::InputControlScheme  value) ;

constexpr ::UnityEngine::InputSystem::InputControlScheme& __get_m_ControlScheme() ;

constexpr ::UnityEngine::InputSystem::InputControlScheme const& __get_m_ControlScheme() const;

/// @brief Method .ctor addr 0x2a4ce94 size 0x14 virtual false final false
inline void _ctor(::UnityEngine::InputSystem::InputActionAsset*  asset, int32_t  index) ;

/// @brief Method .ctor addr 0x2a4cea8 size 0x20 virtual false final false
inline void _ctor(::UnityEngine::InputSystem::InputControlScheme  controlScheme) ;

/// @brief Method WithBindingGroup addr 0x2a4cec8 size 0x124 virtual false final false
...
/// @brief Method WithRequiredDevice addr 0x2a4cfec size 0x34 virtual false final false
inline ::UnityEngine::InputSystem::__InputActionSetupExtensions__ControlSchemeSyntax WithRequiredDevice(::StringW  controlPath) ;

/// @brief Method WithOptionalDevice addr 0x2a4d22c size 0x34 virtual false final false
inline ::UnityEngine::InputSystem::__InputActionSetupExtensions__ControlSchemeSyntax WithOptionalDevice(::StringW  controlPath) ;

/// @brief Method OrWithRequiredDevice addr 0x2a4d260 size 0x34 virtual false final false
...
/// @brief Method OrWithOptionalDevice addr 0x2a4d294 size 0x34 virtual false final false
...
/// @brief Method Done addr 0x2a4d2c8 size 0xc4 virtual false final false
inline ::UnityEngine::InputSystem::InputControlScheme Done() ;

/// @brief Method AddDeviceEntry addr 0x2a4d020 size 0x20c virtual false final false
...
constexpr __InputActionSetupExtensions__ControlSchemeSyntax(::UnityEngine::InputSystem::InputActionAsset*  m_Asset, int32_t  m_ControlSchemeIndex, ::UnityEngine::InputSystem::InputControlScheme  m_ControlScheme) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputActionSetupExtensions__ControlSchemeSyntax(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x28>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputActionSetupExtensions__ControlSchemeSyntax()  = default;
...
/// @brief Field binding offset 0x10
...
/// @brief Method .ctor addr 0x2a4d38c size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <RemoveAction>b__0 addr 0x2a4d394 size 0x44 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __InputActionSetupExtensions____c__DisplayClass5_0()  = default;
public:
...
/// @brief Method AddActionMap addr 0x2a47778 size 0x1ec virtual false final false
...
/// @brief Method AddActionMap addr 0x2a47964 size 0x24c virtual false final false
...
/// @brief Method RemoveActionMap addr 0x2a47bb0 size 0x160 virtual false final false
...
/// @brief Method RemoveActionMap addr 0x2a47d10 size 0x118 virtual false final false
static inline void RemoveActionMap(::UnityEngine::InputSystem::InputActionAsset*  asset, ::StringW  nameOrId) ;

/// @brief Method AddAction addr 0x2a47e28 size 0x3e8 virtual false final false
...
/// @brief Method RemoveAction addr 0x2a48210 size 0x364 virtual false final false
static inline void RemoveAction(::UnityEngine::InputSystem::InputAction*  action) ;

/// @brief Method RemoveAction addr 0x2a48574 size 0x110 virtual false final false
static inline void RemoveAction(::UnityEngine::InputSystem::InputActionAsset*  asset, ::StringW  nameOrId) ;

/// @brief Method AddBinding addr 0x2a466c4 size 0x4c virtual false final false
...
/// @brief Method AddBinding addr 0x2a48760 size 0xb8 virtual false final false
...
/// @brief Method AddBinding addr 0x2a48684 size 0xdc virtual false final false
...
/// @brief Method AddBinding addr 0x2a489a4 size 0xb8 virtual false final false
...
/// @brief Method AddBinding addr 0x2a48b60 size 0x138 virtual false final false
...
/// @brief Method AddBinding addr 0x2a48c98 size 0xfc virtual false final false
...
/// @brief Method AddBinding addr 0x2a48a5c size 0x104 virtual false final false
...
/// @brief Method AddCompositeBinding addr 0x2a48d94 size 0x1a8 virtual false final false
...
/// @brief Method AddBindingInternal addr 0x2a48818 size 0x18c virtual false final false
...
/// @brief Method ChangeBinding addr 0x2a44cbc size 0xa0 virtual false final false
...
/// @brief Method ChangeBinding addr 0x2a48f3c size 0x50 virtual false final false
...
/// @brief Method ChangeBinding addr 0x2a490e0 size 0x10c virtual false final false
...
/// @brief Method ChangeBindingWithId addr 0x2a491ec size 0x98 virtual false final false
...
/// @brief Method ChangeBindingWithId addr 0x2a49284 size 0xd4 virtual false final false
...
/// @brief Method ChangeBindingWithGroup addr 0x2a49358 size 0x98 virtual false final false
...
/// @brief Method ChangeBindingWithPath addr 0x2a493f0 size 0xa0 virtual false final false
...
/// @brief Method ChangeBinding addr 0x2a48f8c size 0x154 virtual false final false
...
/// @brief Method ChangeCompositeBinding addr 0x2a49490 size 0x1e8 virtual false final false
...
/// @brief Method Rename addr 0x2a49678 size 0x27c virtual false final false
static inline void Rename(::UnityEngine::InputSystem::InputAction*  action, ::StringW  newName) ;

/// @brief Method AddControlScheme addr 0x2a498f4 size 0x32c virtual false final false
...
/// @brief Method AddControlScheme addr 0x2a49c20 size 0x178 virtual false final false
...
/// @brief Method RemoveControlScheme addr 0x2a49d98 size 0x13c virtual false final false
static inline void RemoveControlScheme(::UnityEngine::InputSystem::InputActionAsset*  asset, ::StringW  name) ;

/// @brief Method WithBindingGroup addr 0x2a49ed4 size 0xc0 virtual false final false
...
/// @brief Method WithDevice addr 0x2a49f94 size 0x12c virtual false final false
...
/// @brief Method WithRequiredDevice addr 0x2a4a0c0 size 0xc0 virtual false final false
...
/// @brief Method WithOptionalDevice addr 0x2a4a180 size 0xc0 virtual false final false
...
/// @brief Method OrWithRequiredDevice addr 0x2a4a240 size 0xc0 virtual false final false
...
/// @brief Method OrWithOptionalDevice addr 0x2a4a300 size 0x10c0 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 InputActionSetupExtensions()  = default;
public:
