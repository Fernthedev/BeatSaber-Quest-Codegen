...
namespace UnityEngine::InputSystem::Processors {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6236)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6236), inst: 411 }), TypeDefinitionIndex(TypeDefinitionIndex(10243))}
...
// Ctor Parameters []
// @brief default ctor
 StickDeadzoneProcessor()  = default;
public:
