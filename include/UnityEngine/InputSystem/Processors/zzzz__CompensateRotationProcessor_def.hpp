...
namespace UnityEngine::InputSystem::Processors {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6236)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6236), inst: 3342 }), TypeDefinitionIndex(TypeDefinitionIndex(10252))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x10 - sizeof(::UnityEngine::InputSystem::InputProcessor_1<::UnityEngine::Quaternion>)]{};
...
// Ctor Parameters []
// @brief default ctor
 CompensateRotationProcessor()  = default;
public:
