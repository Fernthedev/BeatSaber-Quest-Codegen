...
struct CORDL_TYPE __InputUser__ControlSchemeChangeSyntax : public ::bs_hook::ValueTypeWrapper<0x4> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x4};

/// @brief Field m_UserIndex offset 0x0
 __declspec(property(get=__get_m_UserIndex, put=__set_m_UserIndex)) int32_t  m_UserIndex;

constexpr void __set_m_UserIndex(int32_t  value) ;

constexpr int32_t& __get_m_UserIndex() ;

constexpr int32_t const& __get_m_UserIndex() const;
...
constexpr explicit __InputUser__ControlSchemeChangeSyntax(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputUser__ControlSchemeChangeSyntax()  = default;
...
struct CORDL_TYPE __InputUser__UserFlags : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____InputUser__UserFlags_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputUser__UserFlags(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputUser__UserFlags()  = default;
...
struct CORDL_TYPE __InputUser__UserData : public ::bs_hook::ValueTypeWrapper<0xb8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0xb8};

/// @brief Field platformUserAccountHandle offset 0x0
 __declspec(property(get=__get_platformUserAccountHandle, put=__set_platformUserAccountHandle)) ::System::Nullable_1<::UnityEngine::InputSystem::Users::InputUserAccountHandle>  platformUserAccountHandle;

/// @brief Field platformUserAccountName offset 0x18
 __declspec(property(get=__get_platformUserAccountName, put=__set_platformUserAccountName)) ::StringW  platformUserAccountName;

/// @brief Field platformUserAccountId offset 0x20
 __declspec(property(get=__get_platformUserAccountId, put=__set_platformUserAccountId)) ::StringW  platformUserAccountId;

/// @brief Field deviceCount offset 0x28
 __declspec(property(get=__get_deviceCount, put=__set_deviceCount)) int32_t  deviceCount;

/// @brief Field deviceStartIndex offset 0x2c
 __declspec(property(get=__get_deviceStartIndex, put=__set_deviceStartIndex)) int32_t  deviceStartIndex;

/// @brief Field actions offset 0x30
 __declspec(property(get=__get_actions, put=__set_actions)) ::UnityEngine::InputSystem::IInputActionCollection*  actions;

/// @brief Field controlScheme offset 0x38
 __declspec(property(get=__get_controlScheme, put=__set_controlScheme)) ::System::Nullable_1<::UnityEngine::InputSystem::InputControlScheme>  controlScheme;

/// @brief Field controlSchemeMatch offset 0x58
 __declspec(property(get=__get_controlSchemeMatch, put=__set_controlSchemeMatch)) ::UnityEngine::InputSystem::__InputControlScheme__MatchResult  controlSchemeMatch;

/// @brief Field lostDeviceCount offset 0xa8
 __declspec(property(get=__get_lostDeviceCount, put=__set_lostDeviceCount)) int32_t  lostDeviceCount;

/// @brief Field lostDeviceStartIndex offset 0xac
 __declspec(property(get=__get_lostDeviceStartIndex, put=__set_lostDeviceStartIndex)) int32_t  lostDeviceStartIndex;

/// @brief Field flags offset 0xb0
 __declspec(property(get=__get_flags, put=__set_flags)) ::UnityEngine::InputSystem::Users::__InputUser__UserFlags  flags;
...
constexpr ::System::Nullable_1<::UnityEngine::InputSystem::Users::InputUserAccountHandle>& __get_platformUserAccountHandle() ;

constexpr ::System::Nullable_1<::UnityEngine::InputSystem::Users::InputUserAccountHandle> const& __get_platformUserAccountHandle() const;

constexpr void __set_platformUserAccountName(::StringW  value) ;

constexpr ::StringW& __get_platformUserAccountName() ;

constexpr ::StringW const& __get_platformUserAccountName() const;

constexpr void __set_platformUserAccountId(::StringW  value) ;

constexpr ::StringW& __get_platformUserAccountId() ;

constexpr ::StringW const& __get_platformUserAccountId() const;

constexpr void __set_deviceCount(int32_t  value) ;

constexpr int32_t& __get_deviceCount() ;

constexpr int32_t const& __get_deviceCount() const;

constexpr void __set_deviceStartIndex(int32_t  value) ;

constexpr int32_t& __get_deviceStartIndex() ;

constexpr int32_t const& __get_deviceStartIndex() const;

constexpr void __set_actions(::UnityEngine::InputSystem::IInputActionCollection*  value) ;

constexpr ::UnityEngine::InputSystem::IInputActionCollection* __get_actions() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::IInputActionCollection*> __get_actions() const;

constexpr void __set_controlScheme(::System::Nullable_1<::UnityEngine::InputSystem::InputControlScheme>  value) ;

constexpr ::System::Nullable_1<::UnityEngine::InputSystem::InputControlScheme>& __get_controlScheme() ;

constexpr ::System::Nullable_1<::UnityEngine::InputSystem::InputControlScheme> const& __get_controlScheme() const;

constexpr void __set_controlSchemeMatch(::UnityEngine::InputSystem::__InputControlScheme__MatchResult  value) ;

constexpr ::UnityEngine::InputSystem::__InputControlScheme__MatchResult& __get_controlSchemeMatch() ;

constexpr ::UnityEngine::InputSystem::__InputControlScheme__MatchResult const& __get_controlSchemeMatch() const;

constexpr void __set_lostDeviceCount(int32_t  value) ;

constexpr int32_t& __get_lostDeviceCount() ;

constexpr int32_t const& __get_lostDeviceCount() const;

constexpr void __set_lostDeviceStartIndex(int32_t  value) ;

constexpr int32_t& __get_lostDeviceStartIndex() ;

constexpr int32_t const& __get_lostDeviceStartIndex() const;

constexpr void __set_flags(::UnityEngine::InputSystem::Users::__InputUser__UserFlags  value) ;

constexpr ::UnityEngine::InputSystem::Users::__InputUser__UserFlags& __get_flags() ;

constexpr ::UnityEngine::InputSystem::Users::__InputUser__UserFlags const& __get_flags() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputUser__UserData(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0xb8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputUser__UserData()  = default;
...
struct CORDL_TYPE __InputUser__CompareDevicesByUserAccount : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field platformUserAccountHandle offset 0x0
 __declspec(property(get=__get_platformUserAccountHandle, put=__set_platformUserAccountHandle)) ::UnityEngine::InputSystem::Users::InputUserAccountHandle  platformUserAccountHandle;
...
constexpr ::UnityEngine::InputSystem::Users::InputUserAccountHandle& __get_platformUserAccountHandle() ;

constexpr ::UnityEngine::InputSystem::Users::InputUserAccountHandle const& __get_platformUserAccountHandle() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputUser__CompareDevicesByUserAccount(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputUser__CompareDevicesByUserAccount()  = default;
...
struct CORDL_TYPE __InputUser__OngoingAccountSelection : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x10};

/// @brief Field device offset 0x0
...
/// @brief Field userId offset 0x8
 __declspec(property(get=__get_userId, put=__set_userId)) uint32_t  userId;
...
constexpr uint32_t& __get_userId() ;

constexpr uint32_t const& __get_userId() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputUser__OngoingAccountSelection(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputUser__OngoingAccountSelection()  = default;
...
struct CORDL_TYPE __InputUser__GlobalState : public ::bs_hook::ValueTypeWrapper<0x168> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x168};

/// @brief Field pairingStateVersion offset 0x0
 __declspec(property(get=__get_pairingStateVersion, put=__set_pairingStateVersion)) int32_t  pairingStateVersion;

/// @brief Field lastUserId offset 0x4
 __declspec(property(get=__get_lastUserId, put=__set_lastUserId)) uint32_t  lastUserId;

/// @brief Field allUserCount offset 0x8
 __declspec(property(get=__get_allUserCount, put=__set_allUserCount)) int32_t  allUserCount;

/// @brief Field allPairedDeviceCount offset 0xc
 __declspec(property(get=__get_allPairedDeviceCount, put=__set_allPairedDeviceCount)) int32_t  allPairedDeviceCount;

/// @brief Field allLostDeviceCount offset 0x10
 __declspec(property(get=__get_allLostDeviceCount, put=__set_allLostDeviceCount)) int32_t  allLostDeviceCount;

/// @brief Field allUsers offset 0x18
 __declspec(property(get=__get_allUsers, put=__set_allUsers)) ::ArrayW<::UnityEngine::InputSystem::Users::InputUser,::Array<::UnityEngine::InputSystem::Users::InputUser>*>  allUsers;

/// @brief Field allUserData offset 0x20
 __declspec(property(get=__get_allUserData, put=__set_allUserData)) ::ArrayW<::UnityEngine::InputSystem::Users::__InputUser__UserData,::Array<::UnityEngine::InputSystem::Users::__InputUser__UserData>*>  allUserData;

/// @brief Field allPairedDevices offset 0x28
 __declspec(property(get=__get_allPairedDevices, put=__set_allPairedDevices)) ::ArrayW<::UnityEngine::InputSystem::InputDevice*,::Array<::UnityEngine::InputSystem::InputDevice*>*>  allPairedDevices;

/// @brief Field allLostDevices offset 0x30
 __declspec(property(get=__get_allLostDevices, put=__set_allLostDevices)) ::ArrayW<::UnityEngine::InputSystem::InputDevice*,::Array<::UnityEngine::InputSystem::InputDevice*>*>  allLostDevices;

/// @brief Field ongoingAccountSelections offset 0x38
 __declspec(property(get=__get_ongoingAccountSelections, put=__set_ongoingAccountSelections)) ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::Users::__InputUser__OngoingAccountSelection>  ongoingAccountSelections;

/// @brief Field onChange offset 0x58
 __declspec(property(get=__get_onChange, put=__set_onChange)) ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_3<::UnityEngine::InputSystem::Users::InputUser,::UnityEngine::InputSystem::Users::InputUserChange,::UnityEngine::InputSystem::InputDevice*>*>  onChange;

/// @brief Field onUnpairedDeviceUsed offset 0xa8
 __declspec(property(get=__get_onUnpairedDeviceUsed, put=__set_onUnpairedDeviceUsed)) ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::UnityEngine::InputSystem::InputControl*,::UnityEngine::InputSystem::LowLevel::InputEventPtr>*>  onUnpairedDeviceUsed;

/// @brief Field onPreFilterUnpairedDeviceUsed offset 0xf8
 __declspec(property(get=__get_onPreFilterUnpairedDeviceUsed, put=__set_onPreFilterUnpairedDeviceUsed)) ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Func_3<::UnityEngine::InputSystem::InputDevice*,::UnityEngine::InputSystem::LowLevel::InputEventPtr,bool>*>  onPreFilterUnpairedDeviceUsed;

/// @brief Field actionChangeDelegate offset 0x148
 __declspec(property(get=__get_actionChangeDelegate, put=__set_actionChangeDelegate)) ::System::Action_2<::System::Object*,::UnityEngine::InputSystem::InputActionChange>*  actionChangeDelegate;

/// @brief Field onDeviceChangeDelegate offset 0x150
 __declspec(property(get=__get_onDeviceChangeDelegate, put=__set_onDeviceChangeDelegate)) ::System::Action_2<::UnityEngine::InputSystem::InputDevice*,::UnityEngine::InputSystem::InputDeviceChange>*  onDeviceChangeDelegate;

/// @brief Field onEventDelegate offset 0x158
...
/// @brief Field onActionChangeHooked offset 0x160
 __declspec(property(get=__get_onActionChangeHooked, put=__set_onActionChangeHooked)) bool  onActionChangeHooked;

/// @brief Field onDeviceChangeHooked offset 0x161
 __declspec(property(get=__get_onDeviceChangeHooked, put=__set_onDeviceChangeHooked)) bool  onDeviceChangeHooked;

/// @brief Field onEventHooked offset 0x162
 __declspec(property(get=__get_onEventHooked, put=__set_onEventHooked)) bool  onEventHooked;

/// @brief Field listenForUnpairedDeviceActivity offset 0x164
 __declspec(property(get=__get_listenForUnpairedDeviceActivity, put=__set_listenForUnpairedDeviceActivity)) int32_t  listenForUnpairedDeviceActivity;

constexpr void __set_pairingStateVersion(int32_t  value) ;

constexpr int32_t& __get_pairingStateVersion() ;

constexpr int32_t const& __get_pairingStateVersion() const;

constexpr void __set_lastUserId(uint32_t  value) ;

constexpr uint32_t& __get_lastUserId() ;

constexpr uint32_t const& __get_lastUserId() const;

constexpr void __set_allUserCount(int32_t  value) ;

constexpr int32_t& __get_allUserCount() ;

constexpr int32_t const& __get_allUserCount() const;

constexpr void __set_allPairedDeviceCount(int32_t  value) ;

constexpr int32_t& __get_allPairedDeviceCount() ;

constexpr int32_t const& __get_allPairedDeviceCount() const;

constexpr void __set_allLostDeviceCount(int32_t  value) ;

constexpr int32_t& __get_allLostDeviceCount() ;

constexpr int32_t const& __get_allLostDeviceCount() const;

constexpr void __set_allUsers(::ArrayW<::UnityEngine::InputSystem::Users::InputUser,::Array<::UnityEngine::InputSystem::Users::InputUser>*>  value) ;

constexpr ::ArrayW<::UnityEngine::InputSystem::Users::InputUser,::Array<::UnityEngine::InputSystem::Users::InputUser>*>& __get_allUsers() ;

constexpr ::ArrayW<::UnityEngine::InputSystem::Users::InputUser,::Array<::UnityEngine::InputSystem::Users::InputUser>*> const& __get_allUsers() const;

constexpr void __set_allUserData(::ArrayW<::UnityEngine::InputSystem::Users::__InputUser__UserData,::Array<::UnityEngine::InputSystem::Users::__InputUser__UserData>*>  value) ;

constexpr ::ArrayW<::UnityEngine::InputSystem::Users::__InputUser__UserData,::Array<::UnityEngine::InputSystem::Users::__InputUser__UserData>*>& __get_allUserData() ;

constexpr ::ArrayW<::UnityEngine::InputSystem::Users::__InputUser__UserData,::Array<::UnityEngine::InputSystem::Users::__InputUser__UserData>*> const& __get_allUserData() const;

constexpr void __set_allPairedDevices(::ArrayW<::UnityEngine::InputSystem::InputDevice*,::Array<::UnityEngine::InputSystem::InputDevice*>*>  value) ;

constexpr ::ArrayW<::UnityEngine::InputSystem::InputDevice*,::Array<::UnityEngine::InputSystem::InputDevice*>*>& __get_allPairedDevices() ;

constexpr ::ArrayW<::UnityEngine::InputSystem::InputDevice*,::Array<::UnityEngine::InputSystem::InputDevice*>*> const& __get_allPairedDevices() const;

constexpr void __set_allLostDevices(::ArrayW<::UnityEngine::InputSystem::InputDevice*,::Array<::UnityEngine::InputSystem::InputDevice*>*>  value) ;

constexpr ::ArrayW<::UnityEngine::InputSystem::InputDevice*,::Array<::UnityEngine::InputSystem::InputDevice*>*>& __get_allLostDevices() ;

constexpr ::ArrayW<::UnityEngine::InputSystem::InputDevice*,::Array<::UnityEngine::InputSystem::InputDevice*>*> const& __get_allLostDevices() const;

constexpr void __set_ongoingAccountSelections(::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::Users::__InputUser__OngoingAccountSelection>  value) ;

constexpr ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::Users::__InputUser__OngoingAccountSelection>& __get_ongoingAccountSelections() ;

constexpr ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::Users::__InputUser__OngoingAccountSelection> const& __get_ongoingAccountSelections() const;
...
constexpr ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_3<::UnityEngine::InputSystem::Users::InputUser,::UnityEngine::InputSystem::Users::InputUserChange,::UnityEngine::InputSystem::InputDevice*>*>& __get_onChange() ;

constexpr ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_3<::UnityEngine::InputSystem::Users::InputUser,::UnityEngine::InputSystem::Users::InputUserChange,::UnityEngine::InputSystem::InputDevice*>*> const& __get_onChange() const;
...
constexpr ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::UnityEngine::InputSystem::InputControl*,::UnityEngine::InputSystem::LowLevel::InputEventPtr>*>& __get_onUnpairedDeviceUsed() ;

constexpr ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::UnityEngine::InputSystem::InputControl*,::UnityEngine::InputSystem::LowLevel::InputEventPtr>*> const& __get_onUnpairedDeviceUsed() const;
...
constexpr ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Func_3<::UnityEngine::InputSystem::InputDevice*,::UnityEngine::InputSystem::LowLevel::InputEventPtr,bool>*>& __get_onPreFilterUnpairedDeviceUsed() ;

constexpr ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Func_3<::UnityEngine::InputSystem::InputDevice*,::UnityEngine::InputSystem::LowLevel::InputEventPtr,bool>*> const& __get_onPreFilterUnpairedDeviceUsed() const;

constexpr void __set_actionChangeDelegate(::System::Action_2<::System::Object*,::UnityEngine::InputSystem::InputActionChange>*  value) ;

constexpr ::System::Action_2<::System::Object*,::UnityEngine::InputSystem::InputActionChange>* __get_actionChangeDelegate() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::System::Object*,::UnityEngine::InputSystem::InputActionChange>*> __get_actionChangeDelegate() const;
...
constexpr ::System::Action_2<::UnityEngine::InputSystem::InputDevice*,::UnityEngine::InputSystem::InputDeviceChange>* __get_onDeviceChangeDelegate() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityEngine::InputSystem::InputDevice*,::UnityEngine::InputSystem::InputDeviceChange>*> __get_onDeviceChangeDelegate() const;
...
constexpr bool& __get_onActionChangeHooked() ;

constexpr bool const& __get_onActionChangeHooked() const;

constexpr void __set_onDeviceChangeHooked(bool  value) ;

constexpr bool& __get_onDeviceChangeHooked() ;

constexpr bool const& __get_onDeviceChangeHooked() const;

constexpr void __set_onEventHooked(bool  value) ;

constexpr bool& __get_onEventHooked() ;

constexpr bool const& __get_onEventHooked() const;

constexpr void __set_listenForUnpairedDeviceActivity(int32_t  value) ;

constexpr int32_t& __get_listenForUnpairedDeviceActivity() ;

constexpr int32_t const& __get_listenForUnpairedDeviceActivity() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputUser__GlobalState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x168>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputUser__GlobalState()  = default;
...
// Static field <>9__86_0

// Static field <>9__86_1
...
struct CORDL_TYPE InputUser : public ::bs_hook::ValueTypeWrapper<0x4> {
public:
// Declarations
...
/// @brief Field InvalidId offset 0x0
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit InputUser(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x4>(instance) {
}
