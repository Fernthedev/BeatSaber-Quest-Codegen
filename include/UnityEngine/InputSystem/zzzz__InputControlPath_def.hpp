...
struct CORDL_TYPE __InputControlPath__HumanReadableStringOptions : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____InputControlPath__HumanReadableStringOptions_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __InputControlPath__HumanReadableStringOptions(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputControlPath__HumanReadableStringOptions()  = default;
...
struct CORDL_TYPE __InputControlPath__PathComponentType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____InputControlPath__PathComponentType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputControlPath__PathComponentType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputControlPath__PathComponentType()  = default;
...
/// @brief Method .ctor addr 0x2a6a188 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <get_usages>b__7_0 addr 0x2a6a190 size 0x24 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __InputControlPath__ParsedPathComponent____c()  = default;
public:
...
struct CORDL_TYPE __InputControlPath__ParsedPathComponent : public ::bs_hook::ValueTypeWrapper<0x50> {
public:
// Declarations
...
/// @brief Field m_Layout offset 0x0
 __declspec(property(get=__get_m_Layout, put=__set_m_Layout)) ::UnityEngine::InputSystem::Utilities::Substring  m_Layout;

/// @brief Field m_Usages offset 0x10
 __declspec(property(get=__get_m_Usages, put=__set_m_Usages)) ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::Utilities::Substring>  m_Usages;

/// @brief Field m_Name offset 0x30
 __declspec(property(get=__get_m_Name, put=__set_m_Name)) ::UnityEngine::InputSystem::Utilities::Substring  m_Name;

/// @brief Field m_DisplayName offset 0x40
 __declspec(property(get=__get_m_DisplayName, put=__set_m_DisplayName)) ::UnityEngine::InputSystem::Utilities::Substring  m_DisplayName;
...
constexpr ::UnityEngine::InputSystem::Utilities::Substring& __get_m_Layout() ;

constexpr ::UnityEngine::InputSystem::Utilities::Substring const& __get_m_Layout() const;
...
constexpr ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::Utilities::Substring>& __get_m_Usages() ;

constexpr ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::UnityEngine::InputSystem::Utilities::Substring> const& __get_m_Usages() const;

constexpr void __set_m_Name(::UnityEngine::InputSystem::Utilities::Substring  value) ;

constexpr ::UnityEngine::InputSystem::Utilities::Substring& __get_m_Name() ;

constexpr ::UnityEngine::InputSystem::Utilities::Substring const& __get_m_Name() const;

constexpr void __set_m_DisplayName(::UnityEngine::InputSystem::Utilities::Substring  value) ;

constexpr ::UnityEngine::InputSystem::Utilities::Substring& __get_m_DisplayName() ;

constexpr ::UnityEngine::InputSystem::Utilities::Substring const& __get_m_DisplayName() const;

/// @brief Method get_layout addr 0x2a69da4 size 0x8 virtual false final false
inline ::StringW get_layout() ;

/// @brief Method get_usages addr 0x2a69dac size 0x138 virtual false final false
inline ::System::Collections::Generic::IEnumerable_1<::StringW>* get_usages() ;

/// @brief Method get_name addr 0x2a69ee4 size 0xc virtual false final false
inline ::StringW get_name() ;

/// @brief Method get_displayName addr 0x2a69ef0 size 0xc virtual false final false
inline ::StringW get_displayName() ;

/// @brief Method get_isWildcard addr 0x2a68a8c size 0x64 virtual false final false
inline bool get_isWildcard() ;

/// @brief Method get_isDoubleWildcard addr 0x2a69efc size 0x64 virtual false final false
inline bool get_isDoubleWildcard() ;

/// @brief Method ToHumanReadableString addr 0x2a68054 size 0x744 virtual false final false
...
/// @brief Method ToHumanReadableString addr 0x2a69f60 size 0x64 virtual false final false
static inline ::StringW ToHumanReadableString(::UnityEngine::InputSystem::Utilities::Substring  substring) ;

/// @brief Method Matches addr 0x2a6973c size 0x2b0 virtual false final false
inline bool Matches(::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method ComparePathElementToString addr 0x2a69fc4 size 0x160 virtual false final false
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputControlPath__ParsedPathComponent(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x50>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputControlPath__ParsedPathComponent()  = default;
...
struct CORDL_TYPE __InputControlPath__PathParser : public ::bs_hook::ValueTypeWrapper<0x68> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field leftIndexInPath offset 0xc
 __declspec(property(get=__get_leftIndexInPath, put=__set_leftIndexInPath)) int32_t  leftIndexInPath;

/// @brief Field rightIndexInPath offset 0x10
 __declspec(property(get=__get_rightIndexInPath, put=__set_rightIndexInPath)) int32_t  rightIndexInPath;

/// @brief Field current offset 0x18
 __declspec(property(get=__get_current, put=__set_current)) ::UnityEngine::InputSystem::__InputControlPath__ParsedPathComponent  current;
...
constexpr int32_t& __get_leftIndexInPath() ;

constexpr int32_t const& __get_leftIndexInPath() const;

constexpr void __set_rightIndexInPath(int32_t  value) ;

constexpr int32_t& __get_rightIndexInPath() ;

constexpr int32_t const& __get_rightIndexInPath() const;

constexpr void __set_current(::UnityEngine::InputSystem::__InputControlPath__ParsedPathComponent  value) ;

constexpr ::UnityEngine::InputSystem::__InputControlPath__ParsedPathComponent& __get_current() ;

constexpr ::UnityEngine::InputSystem::__InputControlPath__ParsedPathComponent const& __get_current() const;

/// @brief Method get_isAtEnd addr 0x2a691d8 size 0x14 virtual false final false
inline bool get_isAtEnd() ;

/// @brief Method .ctor addr 0x2a67da0 size 0x3c virtual false final false
inline void _ctor(::StringW  path) ;

/// @brief Method MoveToNextComponent addr 0x2a67ddc size 0x278 virtual false final false
inline bool MoveToNextComponent() ;

/// @brief Method ParseComponentPart addr 0x2a6a1b4 size 0x104 virtual false final false
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputControlPath__PathParser(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x68>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputControlPath__PathParser()  = default;
...
/// @brief Method .ctor addr 0x2a6a31c size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <TryGetDeviceUsages>b__9_0 addr 0x2a6a324 size 0x24 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __InputControlPath____c()  = default;
public:
...
/// @brief Field <>l__initialThreadId offset 0x68
 __declspec(property(get=__get___l__initialThreadId, put=__set___l__initialThreadId)) int32_t  __l__initialThreadId;

/// @brief Field path offset 0x70
 __declspec(property(get=__get_path, put=__set_path)) ::StringW  path;

/// @brief Field <>3__path offset 0x78
 __declspec(property(get=__get___3__path, put=__set___3__path)) ::StringW  __3__path;

/// @brief Field <parser>5__2 offset 0x80
...
/// @brief Method .ctor addr 0x2a69d70 size 0x34 virtual false final false
inline void _ctor(int32_t  __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2a6a348 size 0x4 virtual true final true
inline void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2a6a34c size 0x140 virtual true final true
inline bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.InputSystem.InputControlPath.ParsedPathComponent>.get_Current addr 0x2a6a48c size 0x10 virtual true final true
...
/// @brief Method System.Collections.IEnumerator.Reset addr 0x2a6a49c size 0x40 virtual true final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2a6a4dc size 0x64 virtual true final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.InputSystem.InputControlPath.ParsedPathComponent>.GetEnumerator addr 0x2a6a540 size 0xa4 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2a6a5e4 size 0x4 virtual true final true
...
// Ctor Parameters []
// @brief default ctor
 __InputControlPath___Parse_d__33()  = default;
public:
...
/// @brief Field Wildcard offset 0x0
static constexpr ::ConstString  Wildcard{u"*"};

/// @brief Field DoubleWildcard offset 0x0
static constexpr ::ConstString  DoubleWildcard{u"**"};

/// @brief Field Separator offset 0x0
static constexpr char16_t  Separator{u'/'};

/// @brief Field SeparatorReplacement offset 0x0
static constexpr char16_t  SeparatorReplacement{u' '};

/// @brief Method CleanSlashes addr 0x2a67828 size 0x1c virtual false final false
static inline ::StringW CleanSlashes(::StringW  pathComponent) ;

/// @brief Method Combine addr 0x2a634b8 size 0xf4 virtual false final false
static inline ::StringW Combine(::UnityEngine::InputSystem::InputControl*  parent, ::StringW  path) ;

/// @brief Method ToHumanReadableString addr 0x2a67844 size 0x2c virtual false final false
...
/// @brief Method ToHumanReadableString addr 0x2a67870 size 0x434 virtual false final false
...
/// @brief Method TryGetDeviceUsages addr 0x2a68798 size 0x1a8 virtual false final false
static inline ::ArrayW<::StringW,::Array<::StringW>*> TryGetDeviceUsages(::StringW  path) ;

/// @brief Method TryGetDeviceLayout addr 0x2a68940 size 0x14c virtual false final false
static inline ::StringW TryGetDeviceLayout(::StringW  path) ;

/// @brief Method TryGetControlLayout addr 0x2a68af0 size 0x23c virtual false final false
static inline ::StringW TryGetControlLayout(::StringW  path) ;

/// @brief Method FindControlLayoutRecursive addr 0x2a68d2c size 0x170 virtual false final false
...
/// @brief Method FindControlLayoutRecursive addr 0x2a68e9c size 0x198 virtual false final false
...
/// @brief Method ControlLayoutMatchesPathComponent addr 0x2a69034 size 0x1a4 virtual false final false
...
/// @brief Method StringMatches addr 0x2a691ec size 0x204 virtual false final false
...
/// @brief Method TryFindControl addr 0x2a60da4 size 0x60 virtual false final false
...
/// @brief Method TryFindControls addr 0x2a693f0 size 0x15c virtual false final false
...
/// @brief Method TryFindControls addr 0x2a6954c size 0x70 virtual false final false
...
/// @brief Method TryFindChild addr 0x2a638cc size 0x60 virtual false final false
...
/// @brief Method Matches addr 0x2a67ca4 size 0xfc virtual false final false
static inline bool Matches(::StringW  expected, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method MatchesPrefix addr 0x2a69624 size 0x118 virtual false final false
static inline bool MatchesPrefix(::StringW  expected, ::UnityEngine::InputSystem::InputControl*  control) ;

/// @brief Method MatchesRecursive addr 0x2a695bc size 0x68 virtual false final false
...
/// @brief Method MatchPathComponent addr 0x2a699ec size 0x250 virtual false final false
...
/// @brief Method PathComponentCanYieldMultipleMatches addr 0x2a69c3c size 0xbc virtual false final false
static inline bool PathComponentCanYieldMultipleMatches(::StringW  path, int32_t  indexInPath) ;

/// @brief Method Parse addr 0x2a69cf8 size 0x78 virtual false final false
