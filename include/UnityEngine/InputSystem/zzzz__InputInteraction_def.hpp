...
/// @brief Method GetValueType addr 0x2a354c8 size 0xf4 virtual false final false
static inline ::System::Type* GetValueType(::System::Type*  interactionType) ;

/// @brief Method GetDisplayName addr 0x2a355bc size 0x104 virtual false final false
static inline ::StringW GetDisplayName(::StringW  interaction) ;

/// @brief Method GetDisplayName addr 0x2a356c0 size 0x198 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 InputInteraction()  = default;
public:


// Fields

// Static field s_Interactions
