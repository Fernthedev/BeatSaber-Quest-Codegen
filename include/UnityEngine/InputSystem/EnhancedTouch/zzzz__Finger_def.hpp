...
/// @brief Field <screen>k__BackingField offset 0x10
...
/// @brief Field <index>k__BackingField offset 0x18
 __declspec(property(get=__get__index_k__BackingField, put=__set__index_k__BackingField)) int32_t  _index_k__BackingField;

/// @brief Field m_StateHistory offset 0x20
 __declspec(property(get=__get_m_StateHistory, put=__set_m_StateHistory)) ::UnityEngine::InputSystem::LowLevel::InputStateHistory_1<::UnityEngine::InputSystem::LowLevel::TouchState>*  m_StateHistory;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Touchscreen*> __get__screen_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::LowLevel::InputStateHistory_1<::UnityEngine::InputSystem::LowLevel::TouchState>*> __get_m_StateHistory() const;

/// @brief Method get_screen addr 0x2ae0b70 size 0x8 virtual false final false
inline ::UnityEngine::InputSystem::Touchscreen* get_screen() ;

/// @brief Method get_index addr 0x2ae0b78 size 0x8 virtual false final false
inline int32_t get_index() ;

/// @brief Method get_isActive addr 0x2ae0b80 size 0x2c virtual false final false
inline bool get_isActive() ;

/// @brief Method get_screenPosition addr 0x2ae0cbc size 0x40 virtual false final false
inline ::UnityEngine::Vector2 get_screenPosition() ;

/// @brief Method get_lastTouch addr 0x2ae0cfc size 0x78 virtual false final false
inline ::UnityEngine::InputSystem::EnhancedTouch::Touch get_lastTouch() ;

/// @brief Method get_currentTouch addr 0x2ae0bac size 0xc8 virtual false final false
inline ::UnityEngine::InputSystem::EnhancedTouch::Touch get_currentTouch() ;

/// @brief Method get_touchHistory addr 0x2ae0ddc size 0x34 virtual false final false
...
/// @brief Method .ctor addr 0x2ae0e4c size 0x31c virtual false final false
...
/// @brief Method ShouldRecordTouch addr 0x2ae11c0 size 0x98 virtual false final false
...
/// @brief Method OnTouchRecorded addr 0x2ae128c size 0x2ac virtual false final false
inline void OnTouchRecorded(::UnityEngine::InputSystem::LowLevel::__InputStateHistory__Record  record) ;

/// @brief Method FindTouch addr 0x2ae1564 size 0x338 virtual false final false
inline ::UnityEngine::InputSystem::EnhancedTouch::Touch FindTouch(uint32_t  uniqueId) ;

/// @brief Method GetTouchHistory addr 0x2ae189c size 0x1f0 virtual false final false
