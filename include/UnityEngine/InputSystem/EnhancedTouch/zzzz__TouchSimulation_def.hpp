...
/// @brief Field <simulatedTouchscreen>k__BackingField offset 0x18
 __declspec(property(get=__get__simulatedTouchscreen_k__BackingField, put=__set__simulatedTouchscreen_k__BackingField)) ::UnityEngine::InputSystem::Touchscreen*  _simulatedTouchscreen_k__BackingField;

/// @brief Field m_NumPointers offset 0x20
 __declspec(property(get=__get_m_NumPointers, put=__set_m_NumPointers)) int32_t  m_NumPointers;

/// @brief Field m_Pointers offset 0x28
...
/// @brief Field m_CurrentPositions offset 0x30
...
/// @brief Field m_Touches offset 0x38
 __declspec(property(get=__get_m_Touches, put=__set_m_Touches)) ::ArrayW<::UnityEngine::InputSystem::Controls::ButtonControl*,::Array<::UnityEngine::InputSystem::Controls::ButtonControl*>*>  m_Touches;

/// @brief Field m_LastTouchId offset 0x40
 __declspec(property(get=__get_m_LastTouchId, put=__set_m_LastTouchId)) int32_t  m_LastTouchId;

/// @brief Field m_PrimaryTouchIndex offset 0x44
 __declspec(property(get=__get_m_PrimaryTouchIndex, put=__set_m_PrimaryTouchIndex)) int32_t  m_PrimaryTouchIndex;

/// @brief Field m_OnDeviceChange offset 0x48
 __declspec(property(get=__get_m_OnDeviceChange, put=__set_m_OnDeviceChange)) ::System::Action_2<::UnityEngine::InputSystem::InputDevice*,::UnityEngine::InputSystem::InputDeviceChange>*  m_OnDeviceChange;

/// @brief Field m_OnEvent offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Touchscreen*> __get__simulatedTouchscreen_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityEngine::InputSystem::InputDevice*,::UnityEngine::InputSystem::InputDeviceChange>*> __get_m_OnDeviceChange() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityEngine::InputSystem::LowLevel::InputEventPtr,::UnityEngine::InputSystem::InputDevice*>*> __get_m_OnEvent() const;
...
/// @brief Method get_simulatedTouchscreen addr 0x2ae3bac size 0x8 virtual false final false
inline ::UnityEngine::InputSystem::Touchscreen* get_simulatedTouchscreen() ;

/// @brief Method set_simulatedTouchscreen addr 0x2ae3bb4 size 0x8 virtual false final false
inline void set_simulatedTouchscreen(::UnityEngine::InputSystem::Touchscreen*  value) ;

/// @brief Method get_instance addr 0x2ae3bbc size 0x48 virtual false final false
static inline ::UnityEngine::InputSystem::EnhancedTouch::TouchSimulation* get_instance() ;

/// @brief Method Enable addr 0x2ae3c04 size 0x19c virtual false final false
static inline void Enable() ;

/// @brief Method Disable addr 0x2ae3da0 size 0xd8 virtual false final false
static inline void Disable() ;

/// @brief Method Destroy addr 0x2ae3e78 size 0xd0 virtual false final false
static inline void Destroy() ;

/// @brief Method AddPointer addr 0x2ae3f48 size 0x160 virtual false final false
inline void AddPointer(::UnityEngine::InputSystem::Pointer*  pointer) ;

/// @brief Method RemovePointer addr 0x2ae40a8 size 0x1d0 virtual false final false
inline void RemovePointer(::UnityEngine::InputSystem::Pointer*  pointer) ;

/// @brief Method OnEvent addr 0x2ae4600 size 0x514 virtual false final false
inline void OnEvent(::UnityEngine::InputSystem::LowLevel::InputEventPtr  eventPtr, ::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method OnDeviceChange addr 0x2ae4b8c size 0x144 virtual false final false
inline void OnDeviceChange(::UnityEngine::InputSystem::InputDevice*  device, ::UnityEngine::InputSystem::InputDeviceChange  change) ;

/// @brief Method OnEnable addr 0x2ae4cd0 size 0x3bc virtual false final false
inline void OnEnable() ;

/// @brief Method OnDisable addr 0x2ae520c size 0x164 virtual false final false
inline void OnDisable() ;

/// @brief Method UpdateTouch addr 0x2ae4278 size 0x388 virtual false final false
...
/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyControlStateChanged addr 0x2ae5664 size 0x4 virtual true final true
...
/// @brief Method UnityEngine.InputSystem.LowLevel.IInputStateChangeMonitor.NotifyTimerExpired addr 0x2ae5668 size 0x4 virtual true final true
...
/// @brief Method InstallStateChangeMonitors addr 0x2ae566c size 0x4 virtual false final false
inline void InstallStateChangeMonitors(int32_t  startIndex) ;

/// @brief Method OnSourceControlChangedValue addr 0x2ae5670 size 0x4 virtual false final false
...
/// @brief Method UninstallStateChangeMonitors addr 0x2ae5674 size 0x4 virtual false final false
...
/// @brief Method .ctor addr 0x2ae5678 size 0x10 virtual false final false
inline void _ctor() ;
