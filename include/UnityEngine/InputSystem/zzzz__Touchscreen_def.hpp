...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x198 - sizeof(::UnityEngine::InputSystem::Pointer)]{};

/// @brief Field <primaryTouch>k__BackingField offset 0x180
...
/// @brief Field <touches>k__BackingField offset 0x188
 __declspec(property(get=__get__touches_k__BackingField, put=__set__touches_k__BackingField)) ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::Controls::TouchControl*>  _touches_k__BackingField;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::TouchControl*> __get__primaryTouch_k__BackingField() const;
...
// Static field s_TapTime

// Static field s_TapDelayTime

// Static field s_TapRadiusSquared
