...
struct CORDL_TYPE __InputAction__ActionFlags : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____InputAction__ActionFlags_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __InputAction__ActionFlags(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputAction__ActionFlags()  = default;
...
struct CORDL_TYPE __InputAction__CallbackContext : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field m_ActionIndex offset 0x8
 __declspec(property(get=__get_m_ActionIndex, put=__set_m_ActionIndex)) int32_t  m_ActionIndex;
...
constexpr int32_t& __get_m_ActionIndex() ;

constexpr int32_t const& __get_m_ActionIndex() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputAction__CallbackContext(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputAction__CallbackContext()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x1c0 - sizeof(::System::Object)]{};
...
/// @brief Field m_ExpectedControlType offset 0x20
 __declspec(property(get=__get_m_ExpectedControlType, put=__set_m_ExpectedControlType)) ::StringW  m_ExpectedControlType;

/// @brief Field m_Id offset 0x28
 __declspec(property(get=__get_m_Id, put=__set_m_Id)) ::StringW  m_Id;

/// @brief Field m_Processors offset 0x30
 __declspec(property(get=__get_m_Processors, put=__set_m_Processors)) ::StringW  m_Processors;

/// @brief Field m_Interactions offset 0x38
 __declspec(property(get=__get_m_Interactions, put=__set_m_Interactions)) ::StringW  m_Interactions;

/// @brief Field m_SingletonActionBindings offset 0x40
 __declspec(property(get=__get_m_SingletonActionBindings, put=__set_m_SingletonActionBindings)) ::ArrayW<::UnityEngine::InputSystem::InputBinding,::Array<::UnityEngine::InputSystem::InputBinding>*>  m_SingletonActionBindings;
...
/// @brief Field m_BindingMask offset 0x50
...
/// @brief Field m_BindingsStartIndex offset 0xb0
 __declspec(property(get=__get_m_BindingsStartIndex, put=__set_m_BindingsStartIndex)) int32_t  m_BindingsStartIndex;

/// @brief Field m_BindingsCount offset 0xb4
 __declspec(property(get=__get_m_BindingsCount, put=__set_m_BindingsCount)) int32_t  m_BindingsCount;

/// @brief Field m_ControlStartIndex offset 0xb8
 __declspec(property(get=__get_m_ControlStartIndex, put=__set_m_ControlStartIndex)) int32_t  m_ControlStartIndex;

/// @brief Field m_ControlCount offset 0xbc
 __declspec(property(get=__get_m_ControlCount, put=__set_m_ControlCount)) int32_t  m_ControlCount;

/// @brief Field m_ActionIndexInState offset 0xc0
 __declspec(property(get=__get_m_ActionIndexInState, put=__set_m_ActionIndexInState)) int32_t  m_ActionIndexInState;

/// @brief Field m_ActionMap offset 0xc8
 __declspec(property(get=__get_m_ActionMap, put=__set_m_ActionMap)) ::UnityEngine::InputSystem::InputActionMap*  m_ActionMap;

/// @brief Field m_OnStarted offset 0xd0
 __declspec(property(get=__get_m_OnStarted, put=__set_m_OnStarted)) ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>*>  m_OnStarted;

/// @brief Field m_OnCanceled offset 0x120
 __declspec(property(get=__get_m_OnCanceled, put=__set_m_OnCanceled)) ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>*>  m_OnCanceled;

/// @brief Field m_OnPerformed offset 0x170
 __declspec(property(get=__get_m_OnPerformed, put=__set_m_OnPerformed)) ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>*>  m_OnPerformed;
