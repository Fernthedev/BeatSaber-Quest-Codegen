...
/// @brief Field <component>k__BackingField offset 0x118
...
// Ctor Parameters []
// @brief default ctor
 __DpadControl__DpadAxisControl()  = default;
public:
...
struct CORDL_TYPE __DpadControl__ButtonBits : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____DpadControl__ButtonBits_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __DpadControl__ButtonBits(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __DpadControl__ButtonBits()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x120 - sizeof(::UnityEngine::InputSystem::Controls::Vector2Control)]{};

/// @brief Field <up>k__BackingField offset 0x100
...
/// @brief Field <down>k__BackingField offset 0x108
...
/// @brief Field <left>k__BackingField offset 0x110
...
/// @brief Field <right>k__BackingField offset 0x118
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::ButtonControl*> __get__up_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::ButtonControl*> __get__down_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::ButtonControl*> __get__left_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::ButtonControl*> __get__right_k__BackingField() const;
