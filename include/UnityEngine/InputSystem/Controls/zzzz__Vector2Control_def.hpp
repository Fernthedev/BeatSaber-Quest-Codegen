...
namespace UnityEngine::InputSystem::Controls {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10243)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6216), inst: 411 }), TypeDefinitionIndex(TypeDefinitionIndex(6216))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x100 - sizeof(::UnityEngine::InputSystem::InputControl_1<::UnityEngine::Vector2>)]{};
