...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x128 - sizeof(::UnityEngine::InputSystem::Controls::ButtonControl)]{};

/// @brief Field <keyCode>k__BackingField offset 0x11c
...
/// @brief Field m_ScanCode offset 0x120
