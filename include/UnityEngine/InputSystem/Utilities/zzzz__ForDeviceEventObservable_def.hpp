...
/// @brief Field m_DeviceType offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::IObserver_1<::UnityEngine::InputSystem::LowLevel::InputEventPtr>*> __get_m_Observer() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get_m_DeviceType() const;
...
// Ctor Parameters []
// @brief default ctor
 __ForDeviceEventObservable__ForDevice()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 ForDeviceEventObservable()  = default;
public:
