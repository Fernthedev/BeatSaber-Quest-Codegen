...
struct CORDL_TYPE PrimitiveValue : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
/// @brief Method get_valuePtr addr 0x2b166ac size 0x8 virtual false final false
inline ::cordl_internals::Ptr<uint8_t> get_valuePtr() ;

/// @brief Method get_type addr 0x2b166b4 size 0x8 virtual false final false
inline ::System::TypeCode get_type() ;

/// @brief Method get_isEmpty addr 0x2b09f48 size 0x10 virtual false final false
inline bool get_isEmpty() ;

/// @brief Method .ctor addr 0x2b166bc size 0x1c virtual false final false
inline void _ctor(bool  value) ;

/// @brief Method .ctor addr 0x2b166d8 size 0x18 virtual false final false
inline void _ctor(char16_t  value) ;

/// @brief Method .ctor addr 0x2b166f0 size 0x18 virtual false final false
inline void _ctor(uint8_t  value) ;

/// @brief Method .ctor addr 0x2b16708 size 0x18 virtual false final false
inline void _ctor(int8_t  value) ;

/// @brief Method .ctor addr 0x2b16720 size 0x18 virtual false final false
inline void _ctor(int16_t  value) ;

/// @brief Method .ctor addr 0x2b16738 size 0x18 virtual false final false
inline void _ctor(uint16_t  value) ;

/// @brief Method .ctor addr 0x2b16750 size 0x10 virtual false final false
inline void _ctor(int32_t  value) ;

/// @brief Method .ctor addr 0x2b16760 size 0x10 virtual false final false
inline void _ctor(uint32_t  value) ;

/// @brief Method .ctor addr 0x2b16770 size 0x14 virtual false final false
inline void _ctor(int64_t  value) ;

/// @brief Method .ctor addr 0x2b16784 size 0x14 virtual false final false
inline void _ctor(uint64_t  value) ;

/// @brief Method .ctor addr 0x2b16798 size 0x14 virtual false final false
inline void _ctor(float_t  value) ;

/// @brief Method .ctor addr 0x2b167ac size 0x14 virtual false final false
inline void _ctor(double_t  value) ;

/// @brief Method ConvertTo addr 0x2b14a18 size 0x1f8 virtual false final false
inline ::UnityEngine::InputSystem::Utilities::PrimitiveValue ConvertTo(::System::TypeCode  type) ;

/// @brief Method Equals addr 0x2b16c18 size 0x4c virtual true final true
inline bool Equals(::UnityEngine::InputSystem::Utilities::PrimitiveValue  other) ;

/// @brief Method Equals addr 0x2b16c64 size 0x218 virtual true final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method op_Equality addr 0x2b14c6c size 0x2c virtual false final false
...
/// @brief Method op_Inequality addr 0x2b17464 size 0x30 virtual false final false
...
/// @brief Method GetHashCode addr 0x2b14d84 size 0x88 virtual true final false
inline int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2b17494 size 0x3d0 virtual true final false
inline ::StringW ToString() ;

/// @brief Method FromString addr 0x2b15280 size 0x2f4 virtual false final false
static inline ::UnityEngine::InputSystem::Utilities::PrimitiveValue FromString(::StringW  value) ;

/// @brief Method GetTypeCode addr 0x2b17864 size 0x8 virtual true final true
inline ::System::TypeCode GetTypeCode() ;

/// @brief Method ToBoolean addr 0x2b167c0 size 0x158 virtual true final true
inline bool ToBoolean(::System::IFormatProvider*  provider) ;

/// @brief Method ToByte addr 0x2b16964 size 0x10 virtual true final true
inline uint8_t ToByte(::System::IFormatProvider*  provider) ;

/// @brief Method ToChar addr 0x2b16918 size 0x38 virtual true final true
inline char16_t ToChar(::System::IFormatProvider*  provider) ;

/// @brief Method ToDateTime addr 0x2b1786c size 0x50 virtual true final true
inline ::System::DateTime ToDateTime(::System::IFormatProvider*  provider) ;

/// @brief Method ToDecimal addr 0x2b178bc size 0x4c virtual true final true
inline ::System::Decimal ToDecimal(::System::IFormatProvider*  provider) ;

/// @brief Method ToDouble addr 0x2b16b58 size 0xa8 virtual true final true
inline double_t ToDouble(::System::IFormatProvider*  provider) ;

/// @brief Method ToInt16 addr 0x2b169ac size 0x10 virtual true final true
inline int16_t ToInt16(::System::IFormatProvider*  provider) ;

/// @brief Method ToInt32 addr 0x2b169d0 size 0x10 virtual true final true
inline int32_t ToInt32(::System::IFormatProvider*  provider) ;

/// @brief Method ToInt64 addr 0x2b169f4 size 0xa0 virtual true final true
inline int64_t ToInt64(::System::IFormatProvider*  provider) ;

/// @brief Method ToSByte addr 0x2b16988 size 0x10 virtual true final true
inline int8_t ToSByte(::System::IFormatProvider*  provider) ;

/// @brief Method ToSingle addr 0x2b09f58 size 0x14 virtual true final true
inline float_t ToSingle(::System::IFormatProvider*  provider) ;

/// @brief Method ToString addr 0x2b17908 size 0x4 virtual true final true
inline ::StringW ToString(::System::IFormatProvider*  provider) ;

/// @brief Method ToType addr 0x2b1790c size 0x40 virtual true final true
inline ::System::Object* ToType(::System::Type*  conversionType, ::System::IFormatProvider*  provider) ;

/// @brief Method ToUInt16 addr 0x2b1794c size 0x10 virtual true final true
inline uint16_t ToUInt16(::System::IFormatProvider*  provider) ;

/// @brief Method ToUInt32 addr 0x2b1795c size 0x10 virtual true final true
inline uint32_t ToUInt32(::System::IFormatProvider*  provider) ;

/// @brief Method ToUInt64 addr 0x2b16aac size 0x94 virtual true final true
inline uint64_t ToUInt64(::System::IFormatProvider*  provider) ;

/// @brief Method ToObject addr 0x2b1585c size 0x1b0 virtual false final false
...
/// @brief Method FromObject addr 0x2b16e7c size 0x5e8 virtual false final false
static inline ::UnityEngine::InputSystem::Utilities::PrimitiveValue FromObject(::System::Object*  value) ;

/// @brief Method op_Implicit addr 0x2b1526c size 0x14 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b16950 size 0x14 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b16974 size 0x14 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b16998 size 0x14 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b169bc size 0x14 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b1796c size 0x14 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b169e0 size 0x14 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b17980 size 0x14 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b16a94 size 0x18 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b16b40 size 0x18 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b09fc4 size 0x14 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b16c00 size 0x18 virtual false final false
...
constexpr explicit PrimitiveValue(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}
