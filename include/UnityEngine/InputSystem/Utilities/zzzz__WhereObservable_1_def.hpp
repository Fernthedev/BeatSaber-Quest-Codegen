...
namespace UnityEngine::InputSystem::Utilities {
template<::il2cpp_utils::il2cpp_reference_type TValue>
class __WhereObservable_1__Where<TValue>;
}
// Write type traits
...
template<::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(6694))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6694), inst: 2 })
// CS Name: ::WhereObservable`1::Where<TValue>*
class CORDL_TYPE __WhereObservable_1__Where<TValue> : public ::System::Object {
public:
// Declarations
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Utilities::WhereObservable_1<TValue>*> __get_m_Observable() const;
...
// Ctor Parameters []
// @brief default ctor
 __WhereObservable_1__Where()  = default;
public:
...
template<::il2cpp_utils::il2cpp_reference_type TValue>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(6695))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6695), inst: 2 })
// CS Name: ::UnityEngine.InputSystem.Utilities::WhereObservable`1<TValue>*
class CORDL_TYPE WhereObservable_1<TValue> : public ::System::Object {
public:
// Declarations
...
/// @brief Field m_Predicate offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<TValue,bool>*> __get_m_Predicate() const;
