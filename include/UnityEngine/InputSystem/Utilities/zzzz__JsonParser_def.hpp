...
struct CORDL_TYPE __JsonParser__JsonValueType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____JsonParser__JsonValueType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __JsonParser__JsonValueType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __JsonParser__JsonValueType()  = default;
...
struct CORDL_TYPE __JsonParser__JsonString : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field text offset 0x0
 __declspec(property(get=__get_text, put=__set_text)) ::UnityEngine::InputSystem::Utilities::Substring  text;

/// @brief Field hasEscapes offset 0x10
 __declspec(property(get=__get_hasEscapes, put=__set_hasEscapes)) bool  hasEscapes;
...
constexpr ::UnityEngine::InputSystem::Utilities::Substring& __get_text() ;

constexpr ::UnityEngine::InputSystem::Utilities::Substring const& __get_text() const;

constexpr void __set_hasEscapes(bool  value) ;

constexpr bool& __get_hasEscapes() ;

constexpr bool const& __get_hasEscapes() const;

/// @brief Method ToString addr 0x2b11b0c size 0xf4 virtual true final false
inline ::StringW ToString() ;

/// @brief Method Equals addr 0x2b11c00 size 0x1a8 virtual true final true
inline bool Equals(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonString  other) ;

/// @brief Method Equals addr 0x2b11da8 size 0x90 virtual true final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode addr 0x2b11e38 size 0x3c virtual true final false
inline int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x2b11e74 size 0x30 virtual false final false
...
/// @brief Method op_Inequality addr 0x2b11ea4 size 0x34 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b11ed8 size 0x20 virtual false final false
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __JsonParser__JsonString(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __JsonParser__JsonString()  = default;
...
/// @brief Method .ctor addr 0x2b13394 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <ToString>b__11_0 addr 0x2b1339c size 0x8 virtual false final false
inline ::StringW _ToString_b__11_0(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue  x) ;

/// @brief Method <ToString>b__11_1 addr 0x2b133a4 size 0xb4 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __JsonParser__JsonValue____c()  = default;
public:
...
struct CORDL_TYPE __JsonParser__JsonValue : public ::bs_hook::ValueTypeWrapper<0x48> {
public:
// Declarations
...
/// @brief Field type offset 0x0
 __declspec(property(get=__get_type, put=__set_type)) ::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValueType  type;

/// @brief Field boolValue offset 0x4
 __declspec(property(get=__get_boolValue, put=__set_boolValue)) bool  boolValue;

/// @brief Field realValue offset 0x8
 __declspec(property(get=__get_realValue, put=__set_realValue)) double_t  realValue;

/// @brief Field integerValue offset 0x10
 __declspec(property(get=__get_integerValue, put=__set_integerValue)) int64_t  integerValue;

/// @brief Field stringValue offset 0x18
 __declspec(property(get=__get_stringValue, put=__set_stringValue)) ::UnityEngine::InputSystem::Utilities::__JsonParser__JsonString  stringValue;

/// @brief Field arrayValue offset 0x30
 __declspec(property(get=__get_arrayValue, put=__set_arrayValue)) ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>*  arrayValue;

/// @brief Field objectValue offset 0x38
 __declspec(property(get=__get_objectValue, put=__set_objectValue)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>*  objectValue;

/// @brief Field anyValue offset 0x40
 __declspec(property(get=__get_anyValue, put=__set_anyValue)) ::System::Object*  anyValue;
...
constexpr void __set_type(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValueType  value) ;

constexpr ::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValueType& __get_type() ;

constexpr ::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValueType const& __get_type() const;

constexpr void __set_boolValue(bool  value) ;

constexpr bool& __get_boolValue() ;

constexpr bool const& __get_boolValue() const;

constexpr void __set_realValue(double_t  value) ;

constexpr double_t& __get_realValue() ;

constexpr double_t const& __get_realValue() const;

constexpr void __set_integerValue(int64_t  value) ;

constexpr int64_t& __get_integerValue() ;

constexpr int64_t const& __get_integerValue() const;

constexpr void __set_stringValue(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonString  value) ;

constexpr ::UnityEngine::InputSystem::Utilities::__JsonParser__JsonString& __get_stringValue() ;

constexpr ::UnityEngine::InputSystem::Utilities::__JsonParser__JsonString const& __get_stringValue() const;

constexpr void __set_arrayValue(::System::Collections::Generic::List_1<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>*  value) ;

constexpr ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>* __get_arrayValue() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>*> __get_arrayValue() const;

constexpr void __set_objectValue(::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>*  value) ;

constexpr ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>* __get_objectValue() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>*> __get_objectValue() const;

constexpr void __set_anyValue(::System::Object*  value) ;

constexpr ::System::Object* __get_anyValue() ;

constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get_anyValue() const;

/// @brief Method ToBoolean addr 0x2b11ef8 size 0x140 virtual false final false
inline bool ToBoolean() ;

/// @brief Method ToInteger addr 0x2b12470 size 0xd0 virtual false final false
inline int64_t ToInteger() ;

/// @brief Method ToDouble addr 0x2b12540 size 0xcc virtual false final false
inline double_t ToDouble() ;

/// @brief Method ToString addr 0x2b12038 size 0x438 virtual true final false
inline ::StringW ToString() ;

/// @brief Method op_Implicit addr 0x2b11ad0 size 0x2c virtual false final false
...
/// @brief Method op_Implicit addr 0x2b119e0 size 0x28 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b11a08 size 0x20 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b1260c size 0x3c virtual false final false
...
/// @brief Method op_Implicit addr 0x2b11948 size 0x74 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b119bc size 0x24 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b12648 size 0x24 virtual false final false
...
/// @brief Method op_Implicit addr 0x2b1266c size 0x24 virtual false final false
...
/// @brief Method Equals addr 0x2b12690 size 0x204 virtual true final true
inline bool Equals(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue  other) ;

/// @brief Method Equals addr 0x2b12894 size 0x878 virtual false final false
static inline bool Equals(::System::Object*  obj, ::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue  value) ;

/// @brief Method Equals addr 0x2b1310c size 0x90 virtual true final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode addr 0x2b1319c size 0x15c virtual true final false
inline int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x2b10d8c size 0x34 virtual false final false
...
/// @brief Method op_Inequality addr 0x2b132f8 size 0x38 virtual false final false
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __JsonParser__JsonValue(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x48>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __JsonParser__JsonValue()  = default;
...
struct CORDL_TYPE JsonParser : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
...
/// @brief Field m_Position offset 0xc
 __declspec(property(get=__get_m_Position, put=__set_m_Position)) int32_t  m_Position;

/// @brief Field m_MatchAnyElementInArray offset 0x10
 __declspec(property(get=__get_m_MatchAnyElementInArray, put=__set_m_MatchAnyElementInArray)) bool  m_MatchAnyElementInArray;

/// @brief Field m_DryRun offset 0x11
 __declspec(property(get=__get_m_DryRun, put=__set_m_DryRun)) bool  m_DryRun;
...
constexpr bool& __get_m_MatchAnyElementInArray() ;

constexpr bool const& __get_m_MatchAnyElementInArray() const;

constexpr void __set_m_DryRun(bool  value) ;

constexpr bool& __get_m_DryRun() ;

constexpr bool const& __get_m_DryRun() const;

/// @brief Method .ctor addr 0x2b1039c size 0x70 virtual false final false
inline void _ctor(::StringW  json) ;

/// @brief Method Reset addr 0x2b1040c size 0xc virtual false final false
inline void Reset() ;

/// @brief Method ToString addr 0x2b10418 size 0xec virtual true final false
inline ::StringW ToString() ;

/// @brief Method NavigateToProperty addr 0x2b10504 size 0x48c virtual false final false
inline bool NavigateToProperty(::StringW  path) ;

/// @brief Method CurrentPropertyHasValueEqualTo addr 0x2b10b30 size 0x14c virtual false final false
inline bool CurrentPropertyHasValueEqualTo(::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue  expectedValue) ;

/// @brief Method ParseToken addr 0x2b10990 size 0x74 virtual false final false
inline bool ParseToken(char16_t  token) ;

/// @brief Method ParseValue addr 0x2b10b00 size 0x30 virtual false final false
inline bool ParseValue() ;

/// @brief Method ParseValue addr 0x2b10c7c size 0x110 virtual false final false
inline bool ParseValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>  result) ;

/// @brief Method ParseStringValue addr 0x2b10dc0 size 0x184 virtual false final false
inline bool ParseStringValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>  result) ;

/// @brief Method ParseArrayValue addr 0x2b10f44 size 0x2c8 virtual false final false
inline bool ParseArrayValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>  result) ;

/// @brief Method ParseObjectValue addr 0x2b1120c size 0x170 virtual false final false
inline bool ParseObjectValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>  result) ;

/// @brief Method ParseNumber addr 0x2b114b8 size 0x490 virtual false final false
inline bool ParseNumber(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>  result) ;

/// @brief Method ParseBooleanValue addr 0x2b1137c size 0xd8 virtual false final false
inline bool ParseBooleanValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>  result) ;

/// @brief Method ParseNullValue addr 0x2b11454 size 0x64 virtual false final false
inline bool ParseNullValue(ByRef<::UnityEngine::InputSystem::Utilities::__JsonParser__JsonValue>  result) ;

/// @brief Method SkipToValue addr 0x2b10aa0 size 0x60 virtual false final false
inline bool SkipToValue() ;

/// @brief Method SkipString addr 0x2b11a28 size 0xa8 virtual false final false
inline bool SkipString(::StringW  text) ;

/// @brief Method SkipWhitespace addr 0x2b10a04 size 0x9c virtual false final false
inline void SkipWhitespace() ;

/// @brief Method get_isAtEnd addr 0x2b11afc size 0x10 virtual false final false
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit JsonParser(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}
