...
struct CORDL_TYPE NamedValue : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
...
/// @brief Field <value>k__BackingField offset 0x8
 __declspec(property(get=__get__value_k__BackingField, put=__set__value_k__BackingField)) ::UnityEngine::InputSystem::Utilities::PrimitiveValue  _value_k__BackingField;
...
constexpr ::UnityEngine::InputSystem::Utilities::PrimitiveValue& __get__value_k__BackingField() ;

constexpr ::UnityEngine::InputSystem::Utilities::PrimitiveValue const& __get__value_k__BackingField() const;
...
constexpr explicit NamedValue(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}
