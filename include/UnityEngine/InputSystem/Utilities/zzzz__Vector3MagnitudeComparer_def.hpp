...
struct CORDL_TYPE Vector3MagnitudeComparer : public ::bs_hook::ValueTypeWrapper<0x1> {
public:
// Declarations
...
constexpr explicit Vector3MagnitudeComparer(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x1>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 Vector3MagnitudeComparer()  = default;
