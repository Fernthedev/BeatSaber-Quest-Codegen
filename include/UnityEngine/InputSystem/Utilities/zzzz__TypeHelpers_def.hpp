...
/// @brief Method IsInt addr 0x2a599b4 size 0x10 virtual false final false
static inline bool IsInt(::System::TypeCode  type) ;

/// @brief Method GetValueType addr 0x2a599c4 size 0x1a0 virtual false final false
static inline ::System::Type* GetValueType(::System::Reflection::MemberInfo*  member) ;

/// @brief Method GetNiceTypeName addr 0x2a59b64 size 0x490 virtual false final false
static inline ::StringW GetNiceTypeName(::System::Type*  type) ;

/// @brief Method GetGenericTypeArgumentFromHierarchy addr 0x2a59ff4 size 0x3cc virtual false final false
