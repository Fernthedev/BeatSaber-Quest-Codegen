...
struct CORDL_TYPE FourCC : public ::bs_hook::ValueTypeWrapper<0x4> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x4};

/// @brief Field m_Code offset 0x0
 __declspec(property(get=__get_m_Code, put=__set_m_Code)) int32_t  m_Code;
...
constexpr int32_t& __get_m_Code() ;

constexpr int32_t const& __get_m_Code() const;
...
constexpr explicit FourCC(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x4>(instance) {
}
