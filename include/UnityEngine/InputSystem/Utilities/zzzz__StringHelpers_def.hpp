...
// Ctor Parameters []
// @brief default ctor
 __StringHelpers___Tokenize_d__8()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<char16_t,bool>*> __get_predicate() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<char16_t,bool>*> __get___3__predicate() const;
...
// Ctor Parameters []
// @brief default ctor
 __StringHelpers___Split_d__9()  = default;
public:
...
static inline bool WriteStringToBuffer(::StringW  text, ::cordl_internals::intptr_t  buffer, int32_t  bufferSizeInCharacters) ;

/// @brief Method WriteStringToBuffer addr 0x2b18698 size 0x1f0 virtual false final false
static inline bool WriteStringToBuffer(::StringW  text, ::cordl_internals::intptr_t  buffer, int32_t  bufferSizeInCharacters, ByRef<uint32_t>  offset) ;

/// @brief Method ReadStringFromBuffer addr 0x2b18888 size 0x18 virtual false final false
static inline ::StringW ReadStringFromBuffer(::cordl_internals::intptr_t  buffer, int32_t  bufferSize) ;

/// @brief Method ReadStringFromBuffer addr 0x2b188a0 size 0x13c virtual false final false
static inline ::StringW ReadStringFromBuffer(::cordl_internals::intptr_t  buffer, int32_t  bufferSize, ByRef<uint32_t>  offset) ;
