...
/// @brief Field <attitude>k__BackingField offset 0x158
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::QuaternionControl*> __get__attitude_k__BackingField() const;
