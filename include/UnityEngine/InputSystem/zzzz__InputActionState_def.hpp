...
struct CORDL_TYPE __InputActionState__InteractionState__Flags : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____InputActionState__InteractionState__Flags_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __InputActionState__InteractionState__Flags(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputActionState__InteractionState__Flags()  = default;
...
struct CORDL_TYPE __InputActionState__InteractionState : public ::bs_hook::ValueTypeWrapper<0x30> {
public:
// Declarations
...
/// @brief Field m_TotalTimeoutCompletionTimeRemaining offset 0x24
...
/// @brief Field m_TimerMonitorIndex offset 0x28
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputActionState__InteractionState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x30>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputActionState__InteractionState()  = default;
...
struct CORDL_TYPE __InputActionState__BindingState__Flags : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____InputActionState__BindingState__Flags_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputActionState__BindingState__Flags(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputActionState__BindingState__Flags()  = default;
...
struct CORDL_TYPE __InputActionState__BindingState : public ::bs_hook::ValueTypeWrapper<0x20> {
public:
// Declarations
...
/// @brief Field __padding offset 0x1c
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputActionState__BindingState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x20>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputActionState__BindingState()  = default;
...
struct CORDL_TYPE __InputActionState__TriggerState__Flags : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____InputActionState__TriggerState__Flags_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputActionState__TriggerState__Flags(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputActionState__TriggerState__Flags()  = default;
...
struct CORDL_TYPE __InputActionState__TriggerState : public ::bs_hook::ValueTypeWrapper<0x30> {
public:
// Declarations
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputActionState__TriggerState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x30>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputActionState__TriggerState()  = default;
...
struct CORDL_TYPE __InputActionState__ActionMapIndices : public ::bs_hook::ValueTypeWrapper<0x30> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x30};

/// @brief Field actionStartIndex offset 0x0
 __declspec(property(get=__get_actionStartIndex, put=__set_actionStartIndex)) int32_t  actionStartIndex;

/// @brief Field actionCount offset 0x4
 __declspec(property(get=__get_actionCount, put=__set_actionCount)) int32_t  actionCount;

/// @brief Field controlStartIndex offset 0x8
 __declspec(property(get=__get_controlStartIndex, put=__set_controlStartIndex)) int32_t  controlStartIndex;

/// @brief Field controlCount offset 0xc
 __declspec(property(get=__get_controlCount, put=__set_controlCount)) int32_t  controlCount;

/// @brief Field bindingStartIndex offset 0x10
 __declspec(property(get=__get_bindingStartIndex, put=__set_bindingStartIndex)) int32_t  bindingStartIndex;

/// @brief Field bindingCount offset 0x14
 __declspec(property(get=__get_bindingCount, put=__set_bindingCount)) int32_t  bindingCount;

/// @brief Field interactionStartIndex offset 0x18
 __declspec(property(get=__get_interactionStartIndex, put=__set_interactionStartIndex)) int32_t  interactionStartIndex;

/// @brief Field interactionCount offset 0x1c
 __declspec(property(get=__get_interactionCount, put=__set_interactionCount)) int32_t  interactionCount;

/// @brief Field processorStartIndex offset 0x20
 __declspec(property(get=__get_processorStartIndex, put=__set_processorStartIndex)) int32_t  processorStartIndex;

/// @brief Field processorCount offset 0x24
 __declspec(property(get=__get_processorCount, put=__set_processorCount)) int32_t  processorCount;

/// @brief Field compositeStartIndex offset 0x28
 __declspec(property(get=__get_compositeStartIndex, put=__set_compositeStartIndex)) int32_t  compositeStartIndex;

/// @brief Field compositeCount offset 0x2c
 __declspec(property(get=__get_compositeCount, put=__set_compositeCount)) int32_t  compositeCount;

constexpr void __set_actionStartIndex(int32_t  value) ;

constexpr int32_t& __get_actionStartIndex() ;

constexpr int32_t const& __get_actionStartIndex() const;

constexpr void __set_actionCount(int32_t  value) ;

constexpr int32_t& __get_actionCount() ;

constexpr int32_t const& __get_actionCount() const;

constexpr void __set_controlStartIndex(int32_t  value) ;

constexpr int32_t& __get_controlStartIndex() ;

constexpr int32_t const& __get_controlStartIndex() const;

constexpr void __set_controlCount(int32_t  value) ;

constexpr int32_t& __get_controlCount() ;

constexpr int32_t const& __get_controlCount() const;

constexpr void __set_bindingStartIndex(int32_t  value) ;

constexpr int32_t& __get_bindingStartIndex() ;

constexpr int32_t const& __get_bindingStartIndex() const;

constexpr void __set_bindingCount(int32_t  value) ;

constexpr int32_t& __get_bindingCount() ;

constexpr int32_t const& __get_bindingCount() const;

constexpr void __set_interactionStartIndex(int32_t  value) ;

constexpr int32_t& __get_interactionStartIndex() ;

constexpr int32_t const& __get_interactionStartIndex() const;

constexpr void __set_interactionCount(int32_t  value) ;

constexpr int32_t& __get_interactionCount() ;

constexpr int32_t const& __get_interactionCount() const;

constexpr void __set_processorStartIndex(int32_t  value) ;

constexpr int32_t& __get_processorStartIndex() ;

constexpr int32_t const& __get_processorStartIndex() const;

constexpr void __set_processorCount(int32_t  value) ;

constexpr int32_t& __get_processorCount() ;

constexpr int32_t const& __get_processorCount() const;

constexpr void __set_compositeStartIndex(int32_t  value) ;

constexpr int32_t& __get_compositeStartIndex() ;

constexpr int32_t const& __get_compositeStartIndex() const;

constexpr void __set_compositeCount(int32_t  value) ;

constexpr int32_t& __get_compositeCount() ;

constexpr int32_t const& __get_compositeCount() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputActionState__ActionMapIndices(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x30>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputActionState__ActionMapIndices()  = default;
...
struct CORDL_TYPE __InputActionState__UnmanagedMemory : public ::bs_hook::ValueTypeWrapper<0x80> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x80};

/// @brief Field basePtr offset 0x0
 __declspec(property(get=__get_basePtr, put=__set_basePtr)) ::cordl_internals::Ptr<void>  basePtr;

/// @brief Field mapCount offset 0x8
 __declspec(property(get=__get_mapCount, put=__set_mapCount)) int32_t  mapCount;

/// @brief Field actionCount offset 0xc
 __declspec(property(get=__get_actionCount, put=__set_actionCount)) int32_t  actionCount;

/// @brief Field interactionCount offset 0x10
 __declspec(property(get=__get_interactionCount, put=__set_interactionCount)) int32_t  interactionCount;

/// @brief Field bindingCount offset 0x14
 __declspec(property(get=__get_bindingCount, put=__set_bindingCount)) int32_t  bindingCount;

/// @brief Field controlCount offset 0x18
 __declspec(property(get=__get_controlCount, put=__set_controlCount)) int32_t  controlCount;

/// @brief Field compositeCount offset 0x1c
 __declspec(property(get=__get_compositeCount, put=__set_compositeCount)) int32_t  compositeCount;

/// @brief Field actionStates offset 0x20
 __declspec(property(get=__get_actionStates, put=__set_actionStates)) ::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__TriggerState>  actionStates;

/// @brief Field bindingStates offset 0x28
 __declspec(property(get=__get_bindingStates, put=__set_bindingStates)) ::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__BindingState>  bindingStates;

/// @brief Field interactionStates offset 0x30
 __declspec(property(get=__get_interactionStates, put=__set_interactionStates)) ::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__InteractionState>  interactionStates;

/// @brief Field controlMagnitudes offset 0x38
 __declspec(property(get=__get_controlMagnitudes, put=__set_controlMagnitudes)) ::cordl_internals::Ptr<float_t>  controlMagnitudes;

/// @brief Field compositeMagnitudes offset 0x40
 __declspec(property(get=__get_compositeMagnitudes, put=__set_compositeMagnitudes)) ::cordl_internals::Ptr<float_t>  compositeMagnitudes;

/// @brief Field enabledControls offset 0x48
 __declspec(property(get=__get_enabledControls, put=__set_enabledControls)) ::cordl_internals::Ptr<int32_t>  enabledControls;

/// @brief Field actionBindingIndicesAndCounts offset 0x50
 __declspec(property(get=__get_actionBindingIndicesAndCounts, put=__set_actionBindingIndicesAndCounts)) ::cordl_internals::Ptr<uint16_t>  actionBindingIndicesAndCounts;

/// @brief Field actionBindingIndices offset 0x58
 __declspec(property(get=__get_actionBindingIndices, put=__set_actionBindingIndices)) ::cordl_internals::Ptr<uint16_t>  actionBindingIndices;

/// @brief Field controlIndexToBindingIndex offset 0x60
 __declspec(property(get=__get_controlIndexToBindingIndex, put=__set_controlIndexToBindingIndex)) ::cordl_internals::Ptr<int32_t>  controlIndexToBindingIndex;

/// @brief Field controlGroupingAndComplexity offset 0x68
 __declspec(property(get=__get_controlGroupingAndComplexity, put=__set_controlGroupingAndComplexity)) ::cordl_internals::Ptr<uint16_t>  controlGroupingAndComplexity;

/// @brief Field controlGroupingInitialized offset 0x70
 __declspec(property(get=__get_controlGroupingInitialized, put=__set_controlGroupingInitialized)) bool  controlGroupingInitialized;

/// @brief Field mapIndices offset 0x78
 __declspec(property(get=__get_mapIndices, put=__set_mapIndices)) ::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__ActionMapIndices>  mapIndices;
...
constexpr void __set_basePtr(::cordl_internals::Ptr<void>  value) ;

constexpr ::cordl_internals::Ptr<void>& __get_basePtr() ;

constexpr ::cordl_internals::Ptr<void> const& __get_basePtr() const;

constexpr void __set_mapCount(int32_t  value) ;

constexpr int32_t& __get_mapCount() ;

constexpr int32_t const& __get_mapCount() const;
...
constexpr void __set_actionStates(::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__TriggerState>  value) ;

constexpr ::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__TriggerState>& __get_actionStates() ;

constexpr ::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__TriggerState> const& __get_actionStates() const;

constexpr void __set_bindingStates(::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__BindingState>  value) ;

constexpr ::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__BindingState>& __get_bindingStates() ;

constexpr ::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__BindingState> const& __get_bindingStates() const;

constexpr void __set_interactionStates(::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__InteractionState>  value) ;

constexpr ::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__InteractionState>& __get_interactionStates() ;

constexpr ::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__InteractionState> const& __get_interactionStates() const;

constexpr void __set_controlMagnitudes(::cordl_internals::Ptr<float_t>  value) ;

constexpr ::cordl_internals::Ptr<float_t>& __get_controlMagnitudes() ;

constexpr ::cordl_internals::Ptr<float_t> const& __get_controlMagnitudes() const;

constexpr void __set_compositeMagnitudes(::cordl_internals::Ptr<float_t>  value) ;

constexpr ::cordl_internals::Ptr<float_t>& __get_compositeMagnitudes() ;

constexpr ::cordl_internals::Ptr<float_t> const& __get_compositeMagnitudes() const;

constexpr void __set_enabledControls(::cordl_internals::Ptr<int32_t>  value) ;

constexpr ::cordl_internals::Ptr<int32_t>& __get_enabledControls() ;

constexpr ::cordl_internals::Ptr<int32_t> const& __get_enabledControls() const;

constexpr void __set_actionBindingIndicesAndCounts(::cordl_internals::Ptr<uint16_t>  value) ;

constexpr ::cordl_internals::Ptr<uint16_t>& __get_actionBindingIndicesAndCounts() ;

constexpr ::cordl_internals::Ptr<uint16_t> const& __get_actionBindingIndicesAndCounts() const;

constexpr void __set_actionBindingIndices(::cordl_internals::Ptr<uint16_t>  value) ;

constexpr ::cordl_internals::Ptr<uint16_t>& __get_actionBindingIndices() ;

constexpr ::cordl_internals::Ptr<uint16_t> const& __get_actionBindingIndices() const;

constexpr void __set_controlIndexToBindingIndex(::cordl_internals::Ptr<int32_t>  value) ;

constexpr ::cordl_internals::Ptr<int32_t>& __get_controlIndexToBindingIndex() ;

constexpr ::cordl_internals::Ptr<int32_t> const& __get_controlIndexToBindingIndex() const;

constexpr void __set_controlGroupingAndComplexity(::cordl_internals::Ptr<uint16_t>  value) ;

constexpr ::cordl_internals::Ptr<uint16_t>& __get_controlGroupingAndComplexity() ;

constexpr ::cordl_internals::Ptr<uint16_t> const& __get_controlGroupingAndComplexity() const;

constexpr void __set_controlGroupingInitialized(bool  value) ;

constexpr bool& __get_controlGroupingInitialized() ;

constexpr bool const& __get_controlGroupingInitialized() const;

constexpr void __set_mapIndices(::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__ActionMapIndices>  value) ;

constexpr ::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__ActionMapIndices>& __get_mapIndices() ;

constexpr ::cordl_internals::Ptr<::UnityEngine::InputSystem::__InputActionState__ActionMapIndices> const& __get_mapIndices() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputActionState__UnmanagedMemory(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x80>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputActionState__UnmanagedMemory()  = default;
...
struct CORDL_TYPE __InputActionState__GlobalState : public ::bs_hook::ValueTypeWrapper<0xb8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0xb8};

/// @brief Field globalList offset 0x0
 __declspec(property(get=__get_globalList, put=__set_globalList)) ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::System::Runtime::InteropServices::GCHandle>  globalList;

/// @brief Field onActionChange offset 0x18
 __declspec(property(get=__get_onActionChange, put=__set_onActionChange)) ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::System::Object*,::UnityEngine::InputSystem::InputActionChange>*>  onActionChange;

/// @brief Field onActionControlsChanged offset 0x68
 __declspec(property(get=__get_onActionControlsChanged, put=__set_onActionControlsChanged)) ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_1<::System::Object*>*>  onActionControlsChanged;
...
constexpr ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::System::Runtime::InteropServices::GCHandle>& __get_globalList() ;

constexpr ::UnityEngine::InputSystem::Utilities::InlinedArray_1<::System::Runtime::InteropServices::GCHandle> const& __get_globalList() const;

constexpr void __set_onActionChange(::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::System::Object*,::UnityEngine::InputSystem::InputActionChange>*>  value) ;

constexpr ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::System::Object*,::UnityEngine::InputSystem::InputActionChange>*>& __get_onActionChange() ;

constexpr ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_2<::System::Object*,::UnityEngine::InputSystem::InputActionChange>*> const& __get_onActionChange() const;

constexpr void __set_onActionControlsChanged(::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_1<::System::Object*>*>  value) ;

constexpr ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_1<::System::Object*>*>& __get_onActionControlsChanged() ;

constexpr ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_1<::System::Object*>*> const& __get_onActionControlsChanged() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputActionState__GlobalState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0xb8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputActionState__GlobalState()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __InputActionState____c()  = default;
public:
...
// Static field <>9__135_0

// Static field <>9__135_1
...
/// @brief Field interactions offset 0x20
...
/// @brief Field composites offset 0x30
...
/// @brief Field m_CurrentlyProcessingThisEvent offset 0xc8
...
/// @brief Field m_OnBeforeUpdateDelegate offset 0xd0
...
/// @brief Field m_OnAfterUpdateDelegate offset 0xd8
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_m_OnBeforeUpdateDelegate() const;
