...
struct CORDL_TYPE __DefaultInputActions__PlayerActions : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x8};

/// @brief Field m_Wrapper offset 0x0
 __declspec(property(get=__get_m_Wrapper, put=__set_m_Wrapper)) ::UnityEngine::InputSystem::DefaultInputActions*  m_Wrapper;
...
constexpr ::UnityEngine::InputSystem::DefaultInputActions* __get_m_Wrapper() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::DefaultInputActions*> __get_m_Wrapper() const;
...
constexpr explicit __DefaultInputActions__PlayerActions(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __DefaultInputActions__PlayerActions()  = default;
...
struct CORDL_TYPE __DefaultInputActions__UIActions : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x8};
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __DefaultInputActions__UIActions(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __DefaultInputActions__UIActions()  = default;
...
/// @brief Field <asset>k__BackingField offset 0x10
...
/// @brief Field m_UI_MiddleClick offset 0x80
...
/// @brief Field m_UI_RightClick offset 0x88
...
/// @brief Field m_UI_TrackedDevicePosition offset 0x90
...
/// @brief Field m_UI_TrackedDeviceOrientation offset 0x98
...
/// @brief Field m_KeyboardMouseSchemeIndex offset 0xa0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputActionAsset*> __get__asset_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputActionMap*> __get_m_Player() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::__DefaultInputActions__IPlayerActions*> __get_m_PlayerActionsCallbackInterface() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_m_Player_Move() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_m_Player_Look() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_m_Player_Fire() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputActionMap*> __get_m_UI() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::__DefaultInputActions__IUIActions*> __get_m_UIActionsCallbackInterface() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_m_UI_Navigate() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_m_UI_Submit() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_m_UI_Cancel() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_m_UI_Point() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_m_UI_Click() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_m_UI_ScrollWheel() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_m_UI_MiddleClick() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_m_UI_RightClick() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_m_UI_TrackedDevicePosition() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_m_UI_TrackedDeviceOrientation() const;
