...
struct CORDL_TYPE __VirtualMouseInput__CursorMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____VirtualMouseInput__CursorMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __VirtualMouseInput__CursorMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __VirtualMouseInput__CursorMode()  = default;
...
/// @brief Field m_CursorMode offset 0x18
...
/// @brief Field m_LeftButtonAction offset 0x50
...
/// @brief Field m_MiddleButtonAction offset 0x68
...
/// @brief Field m_RightButtonAction offset 0x80
...
/// @brief Field m_ForwardButtonAction offset 0x98
...
/// @brief Field m_BackButtonAction offset 0xb0
...
/// @brief Field m_ScrollWheelAction offset 0xc8
...
/// @brief Field m_ButtonActionTriggeredDelegate offset 0x100
 __declspec(property(get=__get_m_ButtonActionTriggeredDelegate, put=__set_m_ButtonActionTriggeredDelegate)) ::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>*  m_ButtonActionTriggeredDelegate;

/// @brief Field m_LastTime offset 0x108
 __declspec(property(get=__get_m_LastTime, put=__set_m_LastTime)) double_t  m_LastTime;

/// @brief Field m_LastStickValue offset 0x110
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Graphic*> __get_m_CursorGraphic() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> __get_m_CursorTransform() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Mouse*> __get_m_VirtualMouse() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Mouse*> __get_m_SystemMouse() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_m_AfterInputUpdateDelegate() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>*> __get_m_ButtonActionTriggeredDelegate() const;
