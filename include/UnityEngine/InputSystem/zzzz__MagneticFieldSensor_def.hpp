...
/// @brief Field <magneticField>k__BackingField offset 0x158
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::Vector3Control*> __get__magneticField_k__BackingField() const;
