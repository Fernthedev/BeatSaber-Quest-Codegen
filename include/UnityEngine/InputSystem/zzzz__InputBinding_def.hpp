...
struct CORDL_TYPE __InputBinding__DisplayStringOptions : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____InputBinding__DisplayStringOptions_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __InputBinding__DisplayStringOptions(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputBinding__DisplayStringOptions()  = default;
...
struct CORDL_TYPE __InputBinding__MatchOptions : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____InputBinding__MatchOptions_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputBinding__MatchOptions(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputBinding__MatchOptions()  = default;
...
struct CORDL_TYPE __InputBinding__Flags : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____InputBinding__Flags_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputBinding__Flags(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputBinding__Flags()  = default;
...
struct CORDL_TYPE InputBinding : public ::bs_hook::ValueTypeWrapper<0x58> {
public:
// Declarations
...
/// @brief Field kSeparatorString offset 0x0
...
/// @brief Field m_Id offset 0x8
 __declspec(property(get=__get_m_Id, put=__set_m_Id)) ::StringW  m_Id;

/// @brief Field m_Path offset 0x10
 __declspec(property(get=__get_m_Path, put=__set_m_Path)) ::StringW  m_Path;

/// @brief Field m_Interactions offset 0x18
 __declspec(property(get=__get_m_Interactions, put=__set_m_Interactions)) ::StringW  m_Interactions;

/// @brief Field m_Processors offset 0x20
 __declspec(property(get=__get_m_Processors, put=__set_m_Processors)) ::StringW  m_Processors;

/// @brief Field m_Groups offset 0x28
 __declspec(property(get=__get_m_Groups, put=__set_m_Groups)) ::StringW  m_Groups;

/// @brief Field m_Action offset 0x30
 __declspec(property(get=__get_m_Action, put=__set_m_Action)) ::StringW  m_Action;

/// @brief Field m_Flags offset 0x38
 __declspec(property(get=__get_m_Flags, put=__set_m_Flags)) ::UnityEngine::InputSystem::__InputBinding__Flags  m_Flags;

/// @brief Field m_OverridePath offset 0x40
 __declspec(property(get=__get_m_OverridePath, put=__set_m_OverridePath)) ::StringW  m_OverridePath;

/// @brief Field m_OverrideInteractions offset 0x48
 __declspec(property(get=__get_m_OverrideInteractions, put=__set_m_OverrideInteractions)) ::StringW  m_OverrideInteractions;

/// @brief Field m_OverrideProcessors offset 0x50
 __declspec(property(get=__get_m_OverrideProcessors, put=__set_m_OverrideProcessors)) ::StringW  m_OverrideProcessors;
...
constexpr ::StringW& __get_m_Groups() ;

constexpr ::StringW const& __get_m_Groups() const;

constexpr void __set_m_Action(::StringW  value) ;

constexpr ::StringW& __get_m_Action() ;

constexpr ::StringW const& __get_m_Action() const;

constexpr void __set_m_Flags(::UnityEngine::InputSystem::__InputBinding__Flags  value) ;

constexpr ::UnityEngine::InputSystem::__InputBinding__Flags& __get_m_Flags() ;

constexpr ::UnityEngine::InputSystem::__InputBinding__Flags const& __get_m_Flags() const;

constexpr void __set_m_OverridePath(::StringW  value) ;

constexpr ::StringW& __get_m_OverridePath() ;

constexpr ::StringW const& __get_m_OverridePath() const;

constexpr void __set_m_OverrideInteractions(::StringW  value) ;

constexpr ::StringW& __get_m_OverrideInteractions() ;

constexpr ::StringW const& __get_m_OverrideInteractions() const;

constexpr void __set_m_OverrideProcessors(::StringW  value) ;

constexpr ::StringW& __get_m_OverrideProcessors() ;

constexpr ::StringW const& __get_m_OverrideProcessors() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit InputBinding(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x58>(instance) {
}
