...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (::UnityEngine::InputSystem::XR::PoseState::*)()>(&::UnityEngine::InputSystem::XR::PoseState::get_format)> {
  ...
  constexpr static std::size_t addrs = 0x2ac5264;
...
constexpr bool& UnityEngine::InputSystem::XR::PoseState::__get_isTracked()  {
return ::cordl_internals::getInstanceField<bool, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr bool const& UnityEngine::InputSystem::XR::PoseState::__get_isTracked() const {
return ::cordl_internals::getInstanceField<bool, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void UnityEngine::InputSystem::XR::PoseState::__set_trackingState(::UnityEngine::XR::InputTrackingState  value)  {
::cordl_internals::setInstanceField<::UnityEngine::XR::InputTrackingState, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::UnityEngine::XR::InputTrackingState>(value));
}
constexpr ::UnityEngine::XR::InputTrackingState& UnityEngine::InputSystem::XR::PoseState::__get_trackingState()  {
return ::cordl_internals::getInstanceField<::UnityEngine::XR::InputTrackingState, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::UnityEngine::XR::InputTrackingState const& UnityEngine::InputSystem::XR::PoseState::__get_trackingState() const {
return ::cordl_internals::getInstanceField<::UnityEngine::XR::InputTrackingState, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Vector3& UnityEngine::InputSystem::XR::PoseState::__get_position()  {
...
constexpr ::UnityEngine::Vector3 const& UnityEngine::InputSystem::XR::PoseState::__get_position() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Quaternion& UnityEngine::InputSystem::XR::PoseState::__get_rotation()  {
...
constexpr ::UnityEngine::Quaternion const& UnityEngine::InputSystem::XR::PoseState::__get_rotation() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Quaternion, 0x14>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Vector3& UnityEngine::InputSystem::XR::PoseState::__get_velocity()  {
...
constexpr ::UnityEngine::Vector3 const& UnityEngine::InputSystem::XR::PoseState::__get_velocity() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0x24>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Vector3& UnityEngine::InputSystem::XR::PoseState::__get_angularVelocity()  {
...
constexpr ::UnityEngine::Vector3 const& UnityEngine::InputSystem::XR::PoseState::__get_angularVelocity() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0x30>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
