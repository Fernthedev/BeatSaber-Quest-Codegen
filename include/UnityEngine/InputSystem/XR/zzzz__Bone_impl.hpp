...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<uint32_t (::UnityEngine::InputSystem::XR::Bone::*)()>(&::UnityEngine::InputSystem::XR::Bone::get_parentBoneIndex)> {
  ...
  constexpr static std::size_t addrs = 0x2ac8338;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Vector3 (::UnityEngine::InputSystem::XR::Bone::*)()>(&::UnityEngine::InputSystem::XR::Bone::get_position)> {
  ...
  constexpr static std::size_t addrs = 0x2ac8348;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::InputSystem::XR::Bone::*)(::UnityEngine::Vector3)>(&::UnityEngine::InputSystem::XR::Bone::set_position)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x2ac8354;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Quaternion (::UnityEngine::InputSystem::XR::Bone::*)()>(&::UnityEngine::InputSystem::XR::Bone::get_rotation)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x2ac8360;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::InputSystem::XR::Bone::*)(::UnityEngine::Quaternion)>(&::UnityEngine::InputSystem::XR::Bone::set_rotation)> {
  constexpr static std::size_t size = 0xc;
  constexpr static std::size_t addrs = 0x2ac836c;
...
constexpr uint32_t& UnityEngine::InputSystem::XR::Bone::__get__parentBoneIndex_k__BackingField()  {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& UnityEngine::InputSystem::XR::Bone::__get__parentBoneIndex_k__BackingField() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Vector3& UnityEngine::InputSystem::XR::Bone::__get__position_k__BackingField()  {
...
constexpr ::UnityEngine::Vector3 const& UnityEngine::InputSystem::XR::Bone::__get__position_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Quaternion& UnityEngine::InputSystem::XR::Bone::__get__rotation_k__BackingField()  {
...
constexpr ::UnityEngine::Quaternion const& UnityEngine::InputSystem::XR::Bone::__get__rotation_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Quaternion, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::InputSystem::XR::Bone::Bone(uint32_t  _parentBoneIndex_k__BackingField, ::UnityEngine::Vector3  _position_k__BackingField, ::UnityEngine::Quaternion  _rotation_k__BackingField) noexcept : ::bs_hook::ValueTypeWrapper<0x20>() {this->_parentBoneIndex_k__BackingField = _parentBoneIndex_k__BackingField;
