...
constexpr ::UnityEngine::InputSystem::XR::Haptics::GetCurrentHapticStateCommand::GetCurrentHapticStateCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand  baseCommand, uint32_t  samplesQueued, uint32_t  samplesAvailable) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->baseCommand = baseCommand;
