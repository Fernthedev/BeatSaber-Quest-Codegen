...
constexpr ::UnityEngine::InputSystem::XR::Haptics::SendHapticImpulseCommand::SendHapticImpulseCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand  baseCommand, int32_t  channel, float_t  amplitude, float_t  duration) noexcept : ::bs_hook::ValueTypeWrapper<0x14>() {this->baseCommand = baseCommand;
