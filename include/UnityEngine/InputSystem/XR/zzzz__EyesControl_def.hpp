...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x128 - sizeof(::UnityEngine::InputSystem::InputControl_1<::UnityEngine::InputSystem::XR::Eyes>)]{};

/// @brief Field <leftEyePosition>k__BackingField offset 0xf0
...
/// @brief Field <leftEyeRotation>k__BackingField offset 0xf8
...
/// @brief Field <rightEyePosition>k__BackingField offset 0x100
...
/// @brief Field <rightEyeRotation>k__BackingField offset 0x108
...
/// @brief Field <fixationPoint>k__BackingField offset 0x110
 __declspec(property(get=__get__fixationPoint_k__BackingField, put=__set__fixationPoint_k__BackingField)) ::UnityEngine::InputSystem::Controls::Vector3Control*  _fixationPoint_k__BackingField;

/// @brief Field <leftEyeOpenAmount>k__BackingField offset 0x118
 __declspec(property(get=__get__leftEyeOpenAmount_k__BackingField, put=__set__leftEyeOpenAmount_k__BackingField)) ::UnityEngine::InputSystem::Controls::AxisControl*  _leftEyeOpenAmount_k__BackingField;

/// @brief Field <rightEyeOpenAmount>k__BackingField offset 0x120
 __declspec(property(get=__get__rightEyeOpenAmount_k__BackingField, put=__set__rightEyeOpenAmount_k__BackingField)) ::UnityEngine::InputSystem::Controls::AxisControl*  _rightEyeOpenAmount_k__BackingField;
...
constexpr ::UnityEngine::InputSystem::Controls::Vector3Control* __get__fixationPoint_k__BackingField() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::Vector3Control*> __get__fixationPoint_k__BackingField() const;

constexpr void __set__leftEyeOpenAmount_k__BackingField(::UnityEngine::InputSystem::Controls::AxisControl*  value) ;

constexpr ::UnityEngine::InputSystem::Controls::AxisControl* __get__leftEyeOpenAmount_k__BackingField() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::AxisControl*> __get__leftEyeOpenAmount_k__BackingField() const;

constexpr void __set__rightEyeOpenAmount_k__BackingField(::UnityEngine::InputSystem::Controls::AxisControl*  value) ;

constexpr ::UnityEngine::InputSystem::Controls::AxisControl* __get__rightEyeOpenAmount_k__BackingField() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::AxisControl*> __get__rightEyeOpenAmount_k__BackingField() const;
