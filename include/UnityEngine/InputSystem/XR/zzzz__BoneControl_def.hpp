...
namespace UnityEngine::InputSystem::XR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6216)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6216), inst: 3892 }), TypeDefinitionIndex(TypeDefinitionIndex(6337))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x108 - sizeof(::UnityEngine::InputSystem::InputControl_1<::UnityEngine::InputSystem::XR::Bone>)]{};

/// @brief Field <parentBoneIndex>k__BackingField offset 0xf0
 __declspec(property(get=__get__parentBoneIndex_k__BackingField, put=__set__parentBoneIndex_k__BackingField)) ::UnityEngine::InputSystem::Controls::IntegerControl*  _parentBoneIndex_k__BackingField;

/// @brief Field <position>k__BackingField offset 0xf8
...
/// @brief Field <rotation>k__BackingField offset 0x100
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::Controls::IntegerControl*> __get__parentBoneIndex_k__BackingField() const;
