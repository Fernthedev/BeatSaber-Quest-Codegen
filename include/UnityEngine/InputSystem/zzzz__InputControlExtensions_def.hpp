...
struct CORDL_TYPE __InputControlExtensions__Enumerate : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____InputControlExtensions__Enumerate_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __InputControlExtensions__Enumerate(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputControlExtensions__Enumerate()  = default;
...
struct CORDL_TYPE __InputControlExtensions__InputEventControlCollection : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field m_EventPtr offset 0x8
 __declspec(property(get=__get_m_EventPtr, put=__set_m_EventPtr)) ::UnityEngine::InputSystem::LowLevel::InputEventPtr  m_EventPtr;

/// @brief Field m_Flags offset 0x10
 __declspec(property(get=__get_m_Flags, put=__set_m_Flags)) ::UnityEngine::InputSystem::__InputControlExtensions__Enumerate  m_Flags;

/// @brief Field m_MagnitudeThreshold offset 0x14
...
constexpr ::UnityEngine::InputSystem::LowLevel::InputEventPtr& __get_m_EventPtr() ;

constexpr ::UnityEngine::InputSystem::LowLevel::InputEventPtr const& __get_m_EventPtr() const;

constexpr void __set_m_Flags(::UnityEngine::InputSystem::__InputControlExtensions__Enumerate  value) ;

constexpr ::UnityEngine::InputSystem::__InputControlExtensions__Enumerate& __get_m_Flags() ;

constexpr ::UnityEngine::InputSystem::__InputControlExtensions__Enumerate const& __get_m_Flags() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputControlExtensions__InputEventControlCollection(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputControlExtensions__InputEventControlCollection()  = default;
...
struct CORDL_TYPE __InputControlExtensions__InputEventControlEnumerator : public ::bs_hook::ValueTypeWrapper<0x70> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x70};

/// @brief Field m_Flags offset 0x0
 __declspec(property(get=__get_m_Flags, put=__set_m_Flags)) ::UnityEngine::InputSystem::__InputControlExtensions__Enumerate  m_Flags;

/// @brief Field m_Device offset 0x8
 __declspec(property(get=__get_m_Device, put=__set_m_Device)) ::UnityEngine::InputSystem::InputDevice*  m_Device;

/// @brief Field m_StateOffsetToControlIndex offset 0x10
 __declspec(property(get=__get_m_StateOffsetToControlIndex, put=__set_m_StateOffsetToControlIndex)) ::ArrayW<uint32_t,::Array<uint32_t>*>  m_StateOffsetToControlIndex;

/// @brief Field m_StateOffsetToControlIndexLength offset 0x18
 __declspec(property(get=__get_m_StateOffsetToControlIndexLength, put=__set_m_StateOffsetToControlIndexLength)) int32_t  m_StateOffsetToControlIndexLength;

/// @brief Field m_AllControls offset 0x20
 __declspec(property(get=__get_m_AllControls, put=__set_m_AllControls)) ::ArrayW<::UnityEngine::InputSystem::InputControl*,::Array<::UnityEngine::InputSystem::InputControl*>*>  m_AllControls;

/// @brief Field m_DefaultState offset 0x28
 __declspec(property(get=__get_m_DefaultState, put=__set_m_DefaultState)) ::cordl_internals::Ptr<uint8_t>  m_DefaultState;

/// @brief Field m_CurrentState offset 0x30
 __declspec(property(get=__get_m_CurrentState, put=__set_m_CurrentState)) ::cordl_internals::Ptr<uint8_t>  m_CurrentState;

/// @brief Field m_NoiseMask offset 0x38
 __declspec(property(get=__get_m_NoiseMask, put=__set_m_NoiseMask)) ::cordl_internals::Ptr<uint8_t>  m_NoiseMask;

/// @brief Field m_EventPtr offset 0x40
 __declspec(property(get=__get_m_EventPtr, put=__set_m_EventPtr)) ::UnityEngine::InputSystem::LowLevel::InputEventPtr  m_EventPtr;

/// @brief Field m_CurrentControl offset 0x48
 __declspec(property(get=__get_m_CurrentControl, put=__set_m_CurrentControl)) ::UnityEngine::InputSystem::InputControl*  m_CurrentControl;

/// @brief Field m_CurrentIndexInStateOffsetToControlIndexMap offset 0x50
 __declspec(property(get=__get_m_CurrentIndexInStateOffsetToControlIndexMap, put=__set_m_CurrentIndexInStateOffsetToControlIndexMap)) int32_t  m_CurrentIndexInStateOffsetToControlIndexMap;

/// @brief Field m_CurrentControlStateBitOffset offset 0x54
 __declspec(property(get=__get_m_CurrentControlStateBitOffset, put=__set_m_CurrentControlStateBitOffset)) uint32_t  m_CurrentControlStateBitOffset;

/// @brief Field m_EventState offset 0x58
 __declspec(property(get=__get_m_EventState, put=__set_m_EventState)) ::cordl_internals::Ptr<uint8_t>  m_EventState;

/// @brief Field m_CurrentBitOffset offset 0x60
 __declspec(property(get=__get_m_CurrentBitOffset, put=__set_m_CurrentBitOffset)) uint32_t  m_CurrentBitOffset;

/// @brief Field m_EndBitOffset offset 0x64
 __declspec(property(get=__get_m_EndBitOffset, put=__set_m_EndBitOffset)) uint32_t  m_EndBitOffset;

/// @brief Field m_MagnitudeThreshold offset 0x68
 __declspec(property(get=__get_m_MagnitudeThreshold, put=__set_m_MagnitudeThreshold)) float_t  m_MagnitudeThreshold;
...
constexpr void __set_m_StateOffsetToControlIndex(::ArrayW<uint32_t,::Array<uint32_t>*>  value) ;

constexpr ::ArrayW<uint32_t,::Array<uint32_t>*>& __get_m_StateOffsetToControlIndex() ;

constexpr ::ArrayW<uint32_t,::Array<uint32_t>*> const& __get_m_StateOffsetToControlIndex() const;

constexpr void __set_m_StateOffsetToControlIndexLength(int32_t  value) ;

constexpr int32_t& __get_m_StateOffsetToControlIndexLength() ;

constexpr int32_t const& __get_m_StateOffsetToControlIndexLength() const;

constexpr void __set_m_AllControls(::ArrayW<::UnityEngine::InputSystem::InputControl*,::Array<::UnityEngine::InputSystem::InputControl*>*>  value) ;

constexpr ::ArrayW<::UnityEngine::InputSystem::InputControl*,::Array<::UnityEngine::InputSystem::InputControl*>*>& __get_m_AllControls() ;

constexpr ::ArrayW<::UnityEngine::InputSystem::InputControl*,::Array<::UnityEngine::InputSystem::InputControl*>*> const& __get_m_AllControls() const;

constexpr void __set_m_DefaultState(::cordl_internals::Ptr<uint8_t>  value) ;

constexpr ::cordl_internals::Ptr<uint8_t>& __get_m_DefaultState() ;

constexpr ::cordl_internals::Ptr<uint8_t> const& __get_m_DefaultState() const;

constexpr void __set_m_CurrentState(::cordl_internals::Ptr<uint8_t>  value) ;

constexpr ::cordl_internals::Ptr<uint8_t>& __get_m_CurrentState() ;

constexpr ::cordl_internals::Ptr<uint8_t> const& __get_m_CurrentState() const;

constexpr void __set_m_NoiseMask(::cordl_internals::Ptr<uint8_t>  value) ;

constexpr ::cordl_internals::Ptr<uint8_t>& __get_m_NoiseMask() ;

constexpr ::cordl_internals::Ptr<uint8_t> const& __get_m_NoiseMask() const;
...
constexpr ::UnityEngine::InputSystem::InputControl* __get_m_CurrentControl() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputControl*> __get_m_CurrentControl() const;

constexpr void __set_m_CurrentIndexInStateOffsetToControlIndexMap(int32_t  value) ;

constexpr int32_t& __get_m_CurrentIndexInStateOffsetToControlIndexMap() ;

constexpr int32_t const& __get_m_CurrentIndexInStateOffsetToControlIndexMap() const;

constexpr void __set_m_CurrentControlStateBitOffset(uint32_t  value) ;

constexpr uint32_t& __get_m_CurrentControlStateBitOffset() ;

constexpr uint32_t const& __get_m_CurrentControlStateBitOffset() const;

constexpr void __set_m_EventState(::cordl_internals::Ptr<uint8_t>  value) ;

constexpr ::cordl_internals::Ptr<uint8_t>& __get_m_EventState() ;

constexpr ::cordl_internals::Ptr<uint8_t> const& __get_m_EventState() const;

constexpr void __set_m_CurrentBitOffset(uint32_t  value) ;

constexpr uint32_t& __get_m_CurrentBitOffset() ;

constexpr uint32_t const& __get_m_CurrentBitOffset() const;

constexpr void __set_m_EndBitOffset(uint32_t  value) ;

constexpr uint32_t& __get_m_EndBitOffset() ;

constexpr uint32_t const& __get_m_EndBitOffset() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputControlExtensions__InputEventControlEnumerator(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x70>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputControlExtensions__InputEventControlEnumerator()  = default;
...
struct CORDL_TYPE __InputControlExtensions__ControlBuilder : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x8};

/// @brief Field <control>k__BackingField offset 0x0
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputControlExtensions__ControlBuilder(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputControlExtensions__ControlBuilder()  = default;
...
struct CORDL_TYPE __InputControlExtensions__DeviceBuilder : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x8};

/// @brief Field <device>k__BackingField offset 0x0
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputControlExtensions__DeviceBuilder(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputControlExtensions__DeviceBuilder()  = default;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputControl*> __get___2__current() const;
...
// Ctor Parameters []
// @brief default ctor
 __InputControlExtensions___GetAllButtonPresses_d__43()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 InputControlExtensions()  = default;
public:
