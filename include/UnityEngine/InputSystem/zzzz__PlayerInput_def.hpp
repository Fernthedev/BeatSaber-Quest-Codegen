...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6133)), TypeDefinitionIndex(TypeDefinitionIndex(10465)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10465), inst: 424 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::UnityEngine::Events::UnityEvent_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>)]{};

/// @brief Field m_ActionId offset 0x30
 __declspec(property(get=__get_m_ActionId, put=__set_m_ActionId)) ::StringW  m_ActionId;

/// @brief Field m_ActionName offset 0x38
...
/// @brief Method get_actionId addr 0x2ac2d88 size 0x8 virtual false final false
inline ::StringW get_actionId() ;

/// @brief Method get_actionName addr 0x2ac2d90 size 0x8 virtual false final false
inline ::StringW get_actionName() ;

static inline ::UnityEngine::InputSystem::__PlayerInput__ActionEvent* New_ctor() ;

/// @brief Method .ctor addr 0x2ac2d98 size 0x48 virtual false final false
inline void _ctor() ;

static inline ::UnityEngine::InputSystem::__PlayerInput__ActionEvent* New_ctor(::UnityEngine::InputSystem::InputAction*  action) ;

/// @brief Method .ctor addr 0x2ac2de0 size 0x1dc virtual false final false
...
/// @brief Method .ctor addr 0x2ac2fbc size 0x74 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __PlayerInput__ActionEvent()  = default;
public:
...
/// @brief The size of the true reference type
static constexpr auto  __IL2CPP_REFERENCE_TYPE_SIZE{0x210};

/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x210 - sizeof(::UnityEngine::MonoBehaviour)]{};

/// @brief Field DeviceLostMessage offset 0x0
static constexpr ::ConstString  DeviceLostMessage{u"OnDeviceLost"};

/// @brief Field DeviceRegainedMessage offset 0x0
static constexpr ::ConstString  DeviceRegainedMessage{u"OnDeviceRegained"};

/// @brief Field ControlsChangedMessage offset 0x0
...
/// @brief Field m_NotificationBehavior offset 0x20
...
/// @brief Field m_UIInputModule offset 0x28
...
/// @brief Field m_DeviceLostEvent offset 0x30
...
/// @brief Field m_DeviceRegainedEvent offset 0x38
...
/// @brief Field m_ControlsChangedEvent offset 0x40
...
/// @brief Field m_ActionEvents offset 0x48
 __declspec(property(get=__get_m_ActionEvents, put=__set_m_ActionEvents)) ::ArrayW<::UnityEngine::InputSystem::__PlayerInput__ActionEvent*,::Array<::UnityEngine::InputSystem::__PlayerInput__ActionEvent*>*>  m_ActionEvents;

/// @brief Field m_NeverAutoSwitchControlSchemes offset 0x50
...
/// @brief Field m_CurrentActionMap offset 0x80
...
/// @brief Field m_InputUser offset 0x98
 __declspec(property(get=__get_m_InputUser, put=__set_m_InputUser)) ::UnityEngine::InputSystem::Users::InputUser  m_InputUser;

/// @brief Field m_ActionTriggeredDelegate offset 0xa0
 __declspec(property(get=__get_m_ActionTriggeredDelegate, put=__set_m_ActionTriggeredDelegate)) ::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>*  m_ActionTriggeredDelegate;

/// @brief Field m_DeviceLostCallbacks offset 0xa8
 __declspec(property(get=__get_m_DeviceLostCallbacks, put=__set_m_DeviceLostCallbacks)) ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>*>  m_DeviceLostCallbacks;

/// @brief Field m_DeviceRegainedCallbacks offset 0xf8
 __declspec(property(get=__get_m_DeviceRegainedCallbacks, put=__set_m_DeviceRegainedCallbacks)) ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>*>  m_DeviceRegainedCallbacks;

/// @brief Field m_ControlsChangedCallbacks offset 0x148
 __declspec(property(get=__get_m_ControlsChangedCallbacks, put=__set_m_ControlsChangedCallbacks)) ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>*>  m_ControlsChangedCallbacks;

/// @brief Field m_ActionTriggeredCallbacks offset 0x198
 __declspec(property(get=__get_m_ActionTriggeredCallbacks, put=__set_m_ActionTriggeredCallbacks)) ::UnityEngine::InputSystem::Utilities::CallbackArray_1<::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>*>  m_ActionTriggeredCallbacks;

/// @brief Field m_UnpairedDeviceUsedDelegate offset 0x1e8
 __declspec(property(get=__get_m_UnpairedDeviceUsedDelegate, put=__set_m_UnpairedDeviceUsedDelegate)) ::System::Action_2<::UnityEngine::InputSystem::InputControl*,::UnityEngine::InputSystem::LowLevel::InputEventPtr>*  m_UnpairedDeviceUsedDelegate;

/// @brief Field m_PreFilterUnpairedDeviceUsedDelegate offset 0x1f0
 __declspec(property(get=__get_m_PreFilterUnpairedDeviceUsedDelegate, put=__set_m_PreFilterUnpairedDeviceUsedDelegate)) ::System::Func_3<::UnityEngine::InputSystem::InputDevice*,::UnityEngine::InputSystem::LowLevel::InputEventPtr,bool>*  m_PreFilterUnpairedDeviceUsedDelegate;

/// @brief Field m_OnUnpairedDeviceUsedHooked offset 0x1f8
...
/// @brief Field m_DeviceChangeDelegate offset 0x200
 __declspec(property(get=__get_m_DeviceChangeDelegate, put=__set_m_DeviceChangeDelegate)) ::System::Action_2<::UnityEngine::InputSystem::InputDevice*,::UnityEngine::InputSystem::InputDeviceChange>*  m_DeviceChangeDelegate;

/// @brief Field m_OnDeviceChangeHooked offset 0x208
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputActionAsset*> __get_m_Actions() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::UI::InputSystemUIInputModule*> __get_m_UIInputModule() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::__PlayerInput__DeviceLostEvent*> __get_m_DeviceLostEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::__PlayerInput__DeviceRegainedEvent*> __get_m_DeviceRegainedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::__PlayerInput__ControlsChangedEvent*> __get_m_ControlsChangedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Camera*> __get_m_Camera() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputValue*> __get_m_InputValueObject() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputActionMap*> __get_m_CurrentActionMap() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::StringW>*> __get_m_ActionMessageNames() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>*> __get_m_ActionTriggeredDelegate() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityEngine::InputSystem::InputControl*,::UnityEngine::InputSystem::LowLevel::InputEventPtr>*> __get_m_UnpairedDeviceUsedDelegate() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_3<::UnityEngine::InputSystem::InputDevice*,::UnityEngine::InputSystem::LowLevel::InputEventPtr,bool>*> __get_m_PreFilterUnpairedDeviceUsedDelegate() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityEngine::InputSystem::InputDevice*,::UnityEngine::InputSystem::InputDeviceChange>*> __get_m_DeviceChangeDelegate() const;
...
/// @brief Method get_inputIsActive addr 0x2abc118 size 0x8 virtual false final false
inline bool get_inputIsActive() ;

/// @brief Method get_active addr 0x2abc120 size 0x8 virtual false final false
inline bool get_active() ;

/// @brief Method get_playerIndex addr 0x2abc128 size 0x8 virtual false final false
inline int32_t get_playerIndex() ;

/// @brief Method get_splitScreenIndex addr 0x2abc130 size 0x8 virtual false final false
inline int32_t get_splitScreenIndex() ;

/// @brief Method get_actions addr 0x2abc138 size 0x44 virtual false final false
inline ::UnityEngine::InputSystem::InputActionAsset* get_actions() ;

/// @brief Method set_actions addr 0x2abc688 size 0xf8 virtual false final false
inline void set_actions(::UnityEngine::InputSystem::InputActionAsset*  value) ;

/// @brief Method get_currentControlScheme addr 0x2abd198 size 0x80 virtual false final false
inline ::StringW get_currentControlScheme() ;

/// @brief Method get_defaultControlScheme addr 0x2abd348 size 0x8 virtual false final false
inline ::StringW get_defaultControlScheme() ;

/// @brief Method set_defaultControlScheme addr 0x2abd350 size 0x8 virtual false final false
inline void set_defaultControlScheme(::StringW  value) ;

/// @brief Method get_neverAutoSwitchControlSchemes addr 0x2abd358 size 0x8 virtual false final false
inline bool get_neverAutoSwitchControlSchemes() ;

/// @brief Method set_neverAutoSwitchControlSchemes addr 0x2abd360 size 0x38 virtual false final false
inline void set_neverAutoSwitchControlSchemes(bool  value) ;

/// @brief Method get_currentActionMap addr 0x2abd540 size 0x8 virtual false final false
inline ::UnityEngine::InputSystem::InputActionMap* get_currentActionMap() ;

/// @brief Method set_currentActionMap addr 0x2abd548 size 0x4c virtual false final false
inline void set_currentActionMap(::UnityEngine::InputSystem::InputActionMap*  value) ;

/// @brief Method get_defaultActionMap addr 0x2abd594 size 0x8 virtual false final false
inline ::StringW get_defaultActionMap() ;

/// @brief Method set_defaultActionMap addr 0x2abd59c size 0x8 virtual false final false
inline void set_defaultActionMap(::StringW  value) ;

/// @brief Method get_notificationBehavior addr 0x2abd5a4 size 0x8 virtual false final false
inline ::UnityEngine::InputSystem::PlayerNotifications get_notificationBehavior() ;

/// @brief Method set_notificationBehavior addr 0x2abd5ac size 0x58 virtual false final false
inline void set_notificationBehavior(::UnityEngine::InputSystem::PlayerNotifications  value) ;

/// @brief Method get_actionEvents addr 0x2abd604 size 0x48 virtual false final false
...
/// @brief Method set_actionEvents addr 0x2abd64c size 0x7c virtual false final false
...
/// @brief Method get_deviceLostEvent addr 0x2abd6c8 size 0x68 virtual false final false
inline ::UnityEngine::InputSystem::__PlayerInput__DeviceLostEvent* get_deviceLostEvent() ;

/// @brief Method get_deviceRegainedEvent addr 0x2abd778 size 0x68 virtual false final false
inline ::UnityEngine::InputSystem::__PlayerInput__DeviceRegainedEvent* get_deviceRegainedEvent() ;

/// @brief Method get_controlsChangedEvent addr 0x2abd828 size 0x68 virtual false final false
inline ::UnityEngine::InputSystem::__PlayerInput__ControlsChangedEvent* get_controlsChangedEvent() ;

/// @brief Method add_onActionTriggered addr 0x2abd8d8 size 0xa0 virtual false final false
inline void add_onActionTriggered(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>*  value) ;

/// @brief Method remove_onActionTriggered addr 0x2abd978 size 0xa0 virtual false final false
inline void remove_onActionTriggered(::System::Action_1<::UnityEngine::InputSystem::__InputAction__CallbackContext>*  value) ;

/// @brief Method add_onDeviceLost addr 0x2abda18 size 0xa0 virtual false final false
inline void add_onDeviceLost(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>*  value) ;

/// @brief Method remove_onDeviceLost addr 0x2abdab8 size 0xa0 virtual false final false
inline void remove_onDeviceLost(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>*  value) ;

/// @brief Method add_onDeviceRegained addr 0x2abdb58 size 0xa0 virtual false final false
inline void add_onDeviceRegained(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>*  value) ;

/// @brief Method remove_onDeviceRegained addr 0x2abdbf8 size 0xa0 virtual false final false
inline void remove_onDeviceRegained(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>*  value) ;

/// @brief Method add_onControlsChanged addr 0x2abdc98 size 0xa0 virtual false final false
inline void add_onControlsChanged(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>*  value) ;

/// @brief Method remove_onControlsChanged addr 0x2abdd38 size 0xa0 virtual false final false
inline void remove_onControlsChanged(::System::Action_1<::UnityEngine::InputSystem::PlayerInput*>*  value) ;

/// @brief Method get_camera addr 0x2abddd8 size 0x8 virtual false final false
inline ::UnityEngine::Camera* get_camera() ;

/// @brief Method set_camera addr 0x2abdde0 size 0x8 virtual false final false
inline void set_camera(::UnityEngine::Camera*  value) ;

/// @brief Method get_uiInputModule addr 0x2abdde8 size 0x8 virtual false final false
inline ::UnityEngine::InputSystem::UI::InputSystemUIInputModule* get_uiInputModule() ;

/// @brief Method set_uiInputModule addr 0x2abddf0 size 0x158 virtual false final false
inline void set_uiInputModule(::UnityEngine::InputSystem::UI::InputSystemUIInputModule*  value) ;

/// @brief Method get_user addr 0x2abdf48 size 0x8 virtual false final false
inline ::UnityEngine::InputSystem::Users::InputUser get_user() ;

/// @brief Method get_devices addr 0x2abdf50 size 0x30 virtual false final false
inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::InputDevice*> get_devices() ;

/// @brief Method get_hasMissingRequiredDevices addr 0x2abe02c size 0x48 virtual false final false
inline bool get_hasMissingRequiredDevices() ;

/// @brief Method get_all addr 0x2abe0f0 size 0x90 virtual false final false
static inline ::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::PlayerInput*> get_all() ;

/// @brief Method get_isSinglePlayer addr 0x2abe180 size 0x118 virtual false final false
...
/// @brief Method ActivateInput addr 0x2abd0e4 size 0xb4 virtual false final false
inline void ActivateInput() ;

/// @brief Method DeactivateInput addr 0x2abe404 size 0x24 virtual false final false
inline void DeactivateInput() ;

/// @brief Method PassivateInput addr 0x2abe428 size 0x24 virtual false final false
inline void PassivateInput() ;

/// @brief Method SwitchCurrentControlScheme addr 0x2abe44c size 0x1d8 virtual false final false
...
/// @brief Method SwitchCurrentControlScheme addr 0x2abea18 size 0xe0 virtual false final false
...
/// @brief Method SwitchCurrentActionMap addr 0x2abe298 size 0x16c virtual false final false
inline void SwitchCurrentActionMap(::StringW  mapNameOrId) ;

/// @brief Method GetPlayerByIndex addr 0x2abebb4 size 0xfc virtual false final false
static inline ::UnityEngine::InputSystem::PlayerInput* GetPlayerByIndex(int32_t  playerIndex) ;

/// @brief Method FindFirstPairedToDevice addr 0x2abecb0 size 0x16c virtual false final false
static inline ::UnityEngine::InputSystem::PlayerInput* FindFirstPairedToDevice(::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method Instantiate addr 0x2abee1c size 0x15c virtual false final false
static inline ::UnityEngine::InputSystem::PlayerInput* Instantiate(::UnityEngine::GameObject*  prefab, int32_t  playerIndex, ::StringW  controlScheme, int32_t  splitScreenIndex, ::UnityEngine::InputSystem::InputDevice*  pairWithDevice) ;

/// @brief Method Instantiate addr 0x2abf2b8 size 0x194 virtual false final false
static inline ::UnityEngine::InputSystem::PlayerInput* Instantiate(::UnityEngine::GameObject*  prefab, int32_t  playerIndex, ::StringW  controlScheme, int32_t  splitScreenIndex, ::ArrayW<::UnityEngine::InputSystem::InputDevice*,::Array<::UnityEngine::InputSystem::InputDevice*>*>  pairWithDevices) ;

/// @brief Method DoInstantiate addr 0x2abef78 size 0x340 virtual false final false
static inline ::UnityEngine::InputSystem::PlayerInput* DoInstantiate(::UnityEngine::GameObject*  prefab) ;

/// @brief Method InitializeActions addr 0x2abc17c size 0x50c virtual false final false
inline void InitializeActions() ;

/// @brief Method UninitializeActions addr 0x2abc780 size 0x1d4 virtual false final false
inline void UninitializeActions() ;

/// @brief Method InstallOnActionTriggeredHook addr 0x2abf44c size 0x1d8 virtual false final false
inline void InstallOnActionTriggeredHook() ;

/// @brief Method UninstallOnActionTriggeredHook addr 0x2abf9f0 size 0x18c virtual false final false
inline void UninstallOnActionTriggeredHook() ;

/// @brief Method OnActionTriggered addr 0x2abfb7c size 0x1f4 virtual false final false
inline void OnActionTriggered(::UnityEngine::InputSystem::__InputAction__CallbackContext  context) ;

/// @brief Method CacheMessageNames addr 0x2abf624 size 0x3cc virtual false final false
inline void CacheMessageNames() ;

/// @brief Method ClearCaches addr 0x2abc954 size 0x4 virtual false final false
inline void ClearCaches() ;

/// @brief Method AssignUserAndDevices addr 0x2abc958 size 0x78c virtual false final false
inline void AssignUserAndDevices() ;

/// @brief Method HaveBindingForDevice addr 0x2ac0400 size 0x108 virtual false final false
inline bool HaveBindingForDevice(::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method UnassignUserAndDevices addr 0x2ac0840 size 0xb8 virtual false final false
inline void UnassignUserAndDevices() ;

/// @brief Method TryToActivateControlScheme addr 0x2ac01ac size 0x1e0 virtual false final false
inline bool TryToActivateControlScheme(::UnityEngine::InputSystem::InputControlScheme  controlScheme) ;

/// @brief Method AssignPlayerIndex addr 0x2ac0bd4 size 0x208 virtual false final false
inline void AssignPlayerIndex() ;

/// @brief Method OnEnable addr 0x2ac0ddc size 0x4c8 virtual false final false
inline void OnEnable() ;

/// @brief Method StartListeningForUnpairedDeviceActivity addr 0x2abd398 size 0x138 virtual false final false
inline void StartListeningForUnpairedDeviceActivity() ;

/// @brief Method StopListeningForUnpairedDeviceActivity addr 0x2abd4d0 size 0x70 virtual false final false
inline void StopListeningForUnpairedDeviceActivity() ;

/// @brief Method StartListeningForDeviceChanges addr 0x2ac135c size 0xc4 virtual false final false
inline void StartListeningForDeviceChanges() ;

/// @brief Method StopListeningForDeviceChanges addr 0x2ac1adc size 0x6c virtual false final false
inline void StopListeningForDeviceChanges() ;

/// @brief Method OnDisable addr 0x2ac1b48 size 0x2f4 virtual false final false
inline void OnDisable() ;

/// @brief Method DebugLogAction addr 0x2ac201c size 0x78 virtual false final false
inline void DebugLogAction(::UnityEngine::InputSystem::__InputAction__CallbackContext  context) ;

/// @brief Method HandleDeviceLost addr 0x2ac2094 size 0x11c virtual false final false
inline void HandleDeviceLost() ;

/// @brief Method HandleDeviceRegained addr 0x2ac21b0 size 0x11c virtual false final false
inline void HandleDeviceRegained() ;

/// @brief Method HandleControlsChanged addr 0x2ac1420 size 0x11c virtual false final false
inline void HandleControlsChanged() ;

/// @brief Method OnUserChange addr 0x2ac22cc size 0x168 virtual false final false
...
/// @brief Method OnPreFilterUnpairedDeviceUsed addr 0x2ac2440 size 0xf4 virtual false final false
...
/// @brief Method OnUnpairedDeviceUsed addr 0x2ac2534 size 0x610 virtual false final false
...
/// @brief Method OnDeviceChange addr 0x2ac2b44 size 0x108 virtual false final false
inline void OnDeviceChange(::UnityEngine::InputSystem::InputDevice*  device, ::UnityEngine::InputSystem::InputDeviceChange  change) ;

/// @brief Method SwitchControlSchemeInternal addr 0x2abe624 size 0x3f4 virtual false final false
...
/// @brief Method .ctor addr 0x2ac2d28 size 0x14 virtual false final false
inline void _ctor() ;
...
// Static field s_AllActivePlayersCount

// Static field s_AllActivePlayers

// Static field s_UserChangeDelegate

// Static field s_InitPairWithDevicesCount

// Static field s_InitPairWithDevices

// Static field s_InitPlayerIndex

// Static field s_InitSplitScreenIndex

// Static field s_InitControlScheme

// Static field s_DestroyIfDeviceSetupUnsuccessful
...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10465)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10465), inst: 378 }), TypeDefinitionIndex(TypeDefinitionIndex(6315))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::UnityEngine::Events::UnityEvent_1<::UnityEngine::InputSystem::PlayerInput*>)]{};

static inline ::UnityEngine::InputSystem::__PlayerInput__DeviceLostEvent* New_ctor() ;

/// @brief Method .ctor addr 0x2abd730 size 0x48 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __PlayerInput__DeviceLostEvent()  = default;
public:
...
namespace UnityEngine::InputSystem {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10465)), TypeDefinitionIndex(TypeDefinitionIndex(6315)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10465), inst: 378 })}
...
/// @brief Method .ctor addr 0x2abd7e0 size 0x48 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __PlayerInput__DeviceRegainedEvent()  = default;
public:
...
/// @brief Method .ctor addr 0x2abd890 size 0x48 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __PlayerInput__ControlsChangedEvent()  = default;
public:
