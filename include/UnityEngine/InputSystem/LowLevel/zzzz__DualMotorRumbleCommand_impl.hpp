...
constexpr ::UnityEngine::InputSystem::LowLevel::DualMotorRumbleCommand::DualMotorRumbleCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand  baseCommand, float_t  lowFrequencyMotorSpeed, float_t  highFrequencyMotorSpeed) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->baseCommand = baseCommand;
