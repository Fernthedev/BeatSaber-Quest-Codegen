...
::cordl_internals::setInstanceField<uint16_t, 0x1c>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<uint16_t>(value));
}
constexpr uint16_t& UnityEngine::InputSystem::LowLevel::MouseState::__get_clickCount()  {
return ::cordl_internals::getInstanceField<uint16_t, 0x1c>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::InputSystem::LowLevel::MouseState::MouseState(::UnityEngine::Vector2  position, ::UnityEngine::Vector2  delta, ::UnityEngine::Vector2  scroll, uint16_t  buttons, uint16_t  displayIndex, uint16_t  clickCount) noexcept : ::bs_hook::ValueTypeWrapper<0x20>() {this->position = position;
this->delta = delta;
this->scroll = scroll;
