...
constexpr ::UnityEngine::InputSystem::LowLevel::EnableIMECompositionCommand::EnableIMECompositionCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand  baseCommand, uint8_t  m_ImeEnabled) noexcept : ::bs_hook::ValueTypeWrapper<0xc>() {this->baseCommand = baseCommand;
