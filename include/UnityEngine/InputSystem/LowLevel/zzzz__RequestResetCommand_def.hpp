...
struct CORDL_TYPE RequestResetCommand : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
...
constexpr explicit RequestResetCommand(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 RequestResetCommand()  = default;
