...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (*)()>(&::UnityEngine::InputSystem::LowLevel::GyroscopeState::get_kFormat)> {
  ...
  constexpr static std::size_t addrs = 0x2ae8bdc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (::UnityEngine::InputSystem::LowLevel::GyroscopeState::*)()>(&::UnityEngine::InputSystem::LowLevel::GyroscopeState::get_format)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x2ae8c0c;
...
constexpr ::UnityEngine::Vector3& UnityEngine::InputSystem::LowLevel::GyroscopeState::__get_angularVelocity()  {
...
constexpr ::UnityEngine::Vector3 const& UnityEngine::InputSystem::LowLevel::GyroscopeState::__get_angularVelocity() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::InputSystem::LowLevel::GyroscopeState::GyroscopeState(::UnityEngine::Vector3  angularVelocity) noexcept : ::bs_hook::ValueTypeWrapper<0xc>() {this->angularVelocity = angularVelocity;
}
