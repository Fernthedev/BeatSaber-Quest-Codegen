...
constexpr ::UnityEngine::InputSystem::LowLevel::EnableDeviceCommand::EnableDeviceCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand  baseCommand) noexcept : ::bs_hook::ValueTypeWrapper<0x8>() {this->baseCommand = baseCommand;
}
