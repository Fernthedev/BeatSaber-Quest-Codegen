...
constexpr ::UnityEngine::InputSystem::LowLevel::DeviceConfigurationEvent::DeviceConfigurationEvent(::UnityEngine::InputSystem::LowLevel::InputEvent  baseEvent) noexcept : ::bs_hook::ValueTypeWrapper<0x14>() {this->baseEvent = baseEvent;
}
