...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (*)()>(&::UnityEngine::InputSystem::LowLevel::UseWindowsGamingInputCommand::get_Type)> {
  ...
  constexpr static std::size_t addrs = 0x2ae8540;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (::UnityEngine::InputSystem::LowLevel::UseWindowsGamingInputCommand::*)()>(&::UnityEngine::InputSystem::LowLevel::UseWindowsGamingInputCommand::get_typeStatic)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x2ae8570;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::LowLevel::UseWindowsGamingInputCommand (*)(bool)>(&::UnityEngine::InputSystem::LowLevel::UseWindowsGamingInputCommand::Create)> {
  ...
  constexpr static std::size_t addrs = 0x2ae85a0;
...
constexpr ::UnityEngine::InputSystem::LowLevel::InputDeviceCommand& UnityEngine::InputSystem::LowLevel::UseWindowsGamingInputCommand::__get_baseCommand()  {
...
constexpr ::UnityEngine::InputSystem::LowLevel::InputDeviceCommand const& UnityEngine::InputSystem::LowLevel::UseWindowsGamingInputCommand::__get_baseCommand() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::LowLevel::InputDeviceCommand, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr uint8_t& UnityEngine::InputSystem::LowLevel::UseWindowsGamingInputCommand::__get_enable()  {
return ::cordl_internals::getInstanceField<uint8_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint8_t const& UnityEngine::InputSystem::LowLevel::UseWindowsGamingInputCommand::__get_enable() const {
return ::cordl_internals::getInstanceField<uint8_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::InputSystem::LowLevel::UseWindowsGamingInputCommand::UseWindowsGamingInputCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand  baseCommand, uint8_t  enable) noexcept : ::bs_hook::ValueTypeWrapper<0xc>() {this->baseCommand = baseCommand;
this->enable = enable;
}
