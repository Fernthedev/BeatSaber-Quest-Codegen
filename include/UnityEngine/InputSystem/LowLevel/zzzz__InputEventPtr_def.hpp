...
struct CORDL_TYPE InputEventPtr : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x8};

/// @brief Field m_EventPtr offset 0x0
 __declspec(property(get=__get_m_EventPtr, put=__set_m_EventPtr)) ::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent>  m_EventPtr;
...
constexpr void __set_m_EventPtr(::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent>  value) ;

constexpr ::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent>& __get_m_EventPtr() ;

constexpr ::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::InputEvent> const& __get_m_EventPtr() const;
...
constexpr explicit InputEventPtr(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 InputEventPtr()  = default;
