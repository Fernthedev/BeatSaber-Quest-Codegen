...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (*)()>(&::UnityEngine::InputSystem::LowLevel::QueryCanRunInBackground::get_Type)> {
  ...
  constexpr static std::size_t addrs = 0x2ae7ac8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (::UnityEngine::InputSystem::LowLevel::QueryCanRunInBackground::*)()>(&::UnityEngine::InputSystem::LowLevel::QueryCanRunInBackground::get_typeStatic)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x2ae7af8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::LowLevel::QueryCanRunInBackground (*)()>(&::UnityEngine::InputSystem::LowLevel::QueryCanRunInBackground::Create)> {
  ...
  constexpr static std::size_t addrs = 0x2ae7b28;
...
constexpr ::UnityEngine::InputSystem::LowLevel::InputDeviceCommand& UnityEngine::InputSystem::LowLevel::QueryCanRunInBackground::__get_baseCommand()  {
...
constexpr ::UnityEngine::InputSystem::LowLevel::InputDeviceCommand const& UnityEngine::InputSystem::LowLevel::QueryCanRunInBackground::__get_baseCommand() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::LowLevel::InputDeviceCommand, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr bool& UnityEngine::InputSystem::LowLevel::QueryCanRunInBackground::__get_canRunInBackground()  {
return ::cordl_internals::getInstanceField<bool, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr bool const& UnityEngine::InputSystem::LowLevel::QueryCanRunInBackground::__get_canRunInBackground() const {
return ::cordl_internals::getInstanceField<bool, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::InputSystem::LowLevel::QueryCanRunInBackground::QueryCanRunInBackground(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand  baseCommand, bool  canRunInBackground) noexcept : ::bs_hook::ValueTypeWrapper<0xc>() {this->baseCommand = baseCommand;
