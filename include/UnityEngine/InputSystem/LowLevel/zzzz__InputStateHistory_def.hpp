...
struct CORDL_TYPE __InputStateHistory__Enumerator : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
/// @brief Field m_History offset 0x0
 __declspec(property(get=__get_m_History, put=__set_m_History)) ::UnityEngine::InputSystem::LowLevel::InputStateHistory*  m_History;
...
constexpr ::UnityEngine::InputSystem::LowLevel::InputStateHistory* __get_m_History() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::LowLevel::InputStateHistory*> __get_m_History() const;
...
constexpr explicit __InputStateHistory__Enumerator(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputStateHistory__Enumerator()  = default;
...
struct CORDL_TYPE __InputStateHistory__RecordHeader___m_StateWithoutControlIndex_e__FixedBuffer : public ::bs_hook::ValueTypeWrapper<0x1> {
public:
// Declarations
/// @brief The size of the true value type
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputStateHistory__RecordHeader___m_StateWithoutControlIndex_e__FixedBuffer(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x1>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputStateHistory__RecordHeader___m_StateWithoutControlIndex_e__FixedBuffer()  = default;
...
struct CORDL_TYPE __InputStateHistory__RecordHeader___m_StateWithControlIndex_e__FixedBuffer : public ::bs_hook::ValueTypeWrapper<0x1> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x1};
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputStateHistory__RecordHeader___m_StateWithControlIndex_e__FixedBuffer(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x1>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputStateHistory__RecordHeader___m_StateWithControlIndex_e__FixedBuffer()  = default;
...
struct CORDL_TYPE __InputStateHistory__RecordHeader : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
...
/// @brief Field kSizeWithControlIndex offset 0x0
static constexpr int32_t  kSizeWithControlIndex{static_cast<int32_t>(0x10)};

/// @brief Field kSizeWithoutControlIndex offset 0x0
...
/// @brief Field controlIndex offset 0xc
 __declspec(property(get=__get_controlIndex, put=__set_controlIndex)) int32_t  controlIndex;

/// @brief Field m_StateWithoutControlIndex offset 0xc
 __declspec(property(get=__get_m_StateWithoutControlIndex, put=__set_m_StateWithoutControlIndex)) ::GlobalNamespace::__InputStateHistory__RecordHeader___m_StateWithoutControlIndex_e__FixedBuffer  m_StateWithoutControlIndex;

/// @brief Field m_StateWithControlIndex offset 0x10
 __declspec(property(get=__get_m_StateWithControlIndex, put=__set_m_StateWithControlIndex)) ::GlobalNamespace::__InputStateHistory__RecordHeader___m_StateWithControlIndex_e__FixedBuffer  m_StateWithControlIndex;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputStateHistory__RecordHeader(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputStateHistory__RecordHeader()  = default;
...
struct CORDL_TYPE __InputStateHistory__Record : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x10};
...
/// @brief Field m_Owner offset 0x0
 __declspec(property(get=__get_m_Owner, put=__set_m_Owner)) ::UnityEngine::InputSystem::LowLevel::InputStateHistory*  m_Owner;
...
constexpr ::UnityEngine::InputSystem::LowLevel::InputStateHistory* __get_m_Owner() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::LowLevel::InputStateHistory*> __get_m_Owner() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputStateHistory__Record(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputStateHistory__Record()  = default;
...
/// @brief Field kDefaultHistorySize offset 0x0
static constexpr int32_t  kDefaultHistorySize{static_cast<int32_t>(0x80)};

/// @brief Field <onRecordAdded>k__BackingField offset 0x10
 __declspec(property(get=__get__onRecordAdded_k__BackingField, put=__set__onRecordAdded_k__BackingField)) ::System::Action_1<::UnityEngine::InputSystem::LowLevel::__InputStateHistory__Record>*  _onRecordAdded_k__BackingField;

/// @brief Field <onShouldRecordStateChange>k__BackingField offset 0x18
 __declspec(property(get=__get__onShouldRecordStateChange_k__BackingField, put=__set__onShouldRecordStateChange_k__BackingField)) ::System::Func_4<::UnityEngine::InputSystem::InputControl*,double_t,::UnityEngine::InputSystem::LowLevel::InputEventPtr,bool>*  _onShouldRecordStateChange_k__BackingField;

/// @brief Field m_Controls offset 0x20
...
/// @brief Field m_AddNewControls offset 0x60
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::InputSystem::LowLevel::__InputStateHistory__Record>*> __get__onRecordAdded_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_4<::UnityEngine::InputSystem::InputControl*,double_t,::UnityEngine::InputSystem::LowLevel::InputEventPtr,bool>*> __get__onShouldRecordStateChange_k__BackingField() const;
