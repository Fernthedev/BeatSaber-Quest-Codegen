...
struct CORDL_TYPE SetSamplingFrequencyCommand : public ::bs_hook::ValueTypeWrapper<0xc> {
public:
// Declarations
...
constexpr explicit SetSamplingFrequencyCommand(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0xc>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 SetSamplingFrequencyCommand()  = default;
