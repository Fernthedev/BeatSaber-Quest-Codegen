...
/// @brief Field <byteOffset>k__BackingField offset 0x4
 __declspec(property(get=__get__byteOffset_k__BackingField, put=__set__byteOffset_k__BackingField)) uint32_t  _byteOffset_k__BackingField;

/// @brief Field <bitOffset>k__BackingField offset 0x8
 __declspec(property(get=__get__bitOffset_k__BackingField, put=__set__bitOffset_k__BackingField)) uint32_t  _bitOffset_k__BackingField;

/// @brief Field <sizeInBits>k__BackingField offset 0xc
...
constexpr uint32_t& __get__byteOffset_k__BackingField() ;

constexpr uint32_t const& __get__byteOffset_k__BackingField() const;

constexpr void __set__bitOffset_k__BackingField(uint32_t  value) ;

constexpr uint32_t& __get__bitOffset_k__BackingField() ;

constexpr uint32_t const& __get__bitOffset_k__BackingField() const;
...
/// @brief Method GetSizeOfPrimitiveFormatInBits addr 0x2af2698 size 0x3d0 virtual false final false
static inline int32_t GetSizeOfPrimitiveFormatInBits(::UnityEngine::InputSystem::Utilities::FourCC  type) ;

/// @brief Method GetPrimitiveFormatFromType addr 0x2af2a68 size 0x4dc virtual false final false
static inline ::UnityEngine::InputSystem::Utilities::FourCC GetPrimitiveFormatFromType(::System::Type*  type) ;

/// @brief Method get_format addr 0x2af2f44 size 0x8 virtual false final false
inline ::UnityEngine::InputSystem::Utilities::FourCC get_format() ;

/// @brief Method set_format addr 0x2af2f4c size 0x8 virtual false final false
inline void set_format(::UnityEngine::InputSystem::Utilities::FourCC  value) ;

/// @brief Method get_byteOffset addr 0x2af2f54 size 0x8 virtual false final false
inline uint32_t get_byteOffset() ;

/// @brief Method set_byteOffset addr 0x2af2f5c size 0x8 virtual false final false
inline void set_byteOffset(uint32_t  value) ;

/// @brief Method get_bitOffset addr 0x2af2f64 size 0x8 virtual false final false
inline uint32_t get_bitOffset() ;

/// @brief Method set_bitOffset addr 0x2af2f6c size 0x8 virtual false final false
inline void set_bitOffset(uint32_t  value) ;

/// @brief Method get_sizeInBits addr 0x2af2f74 size 0x8 virtual false final false
inline uint32_t get_sizeInBits() ;

/// @brief Method set_sizeInBits addr 0x2af2f7c size 0x8 virtual false final false
inline void set_sizeInBits(uint32_t  value) ;

/// @brief Method get_alignedSizeInBytes addr 0x2ae99f4 size 0x10 virtual false final false
inline uint32_t get_alignedSizeInBytes() ;

/// @brief Method get_effectiveByteOffset addr 0x2af2f84 size 0xc virtual false final false
inline uint32_t get_effectiveByteOffset() ;

/// @brief Method get_effectiveBitOffset addr 0x2af2f90 size 0xc virtual false final false
inline uint32_t get_effectiveBitOffset() ;

/// @brief Method ReadInt addr 0x2af2f9c size 0x1d0 virtual false final false
inline int32_t ReadInt(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method WriteInt addr 0x2af316c size 0x1bc virtual false final false
inline void WriteInt(::cordl_internals::Ptr<void>  statePtr, int32_t  value) ;

/// @brief Method ReadFloat addr 0x2af3328 size 0x2fc virtual false final false
inline float_t ReadFloat(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method WriteFloat addr 0x2af3624 size 0x400 virtual false final false
inline void WriteFloat(::cordl_internals::Ptr<void>  statePtr, float_t  value) ;

/// @brief Method FloatToPrimitiveValue addr 0x2af3a24 size 0x4a0 virtual false final false
inline ::UnityEngine::InputSystem::Utilities::PrimitiveValue FloatToPrimitiveValue(float_t  value) ;

/// @brief Method ReadDouble addr 0x2af3ec4 size 0x2fc virtual false final false
inline double_t ReadDouble(::cordl_internals::Ptr<void>  statePtr) ;

/// @brief Method WriteDouble addr 0x2af41c0 size 0x424 virtual false final false
inline void WriteDouble(::cordl_internals::Ptr<void>  statePtr, double_t  value) ;

/// @brief Method Write addr 0x2af45e4 size 0x2c0 virtual false final false
inline void Write(::cordl_internals::Ptr<void>  statePtr, ::UnityEngine::InputSystem::Utilities::PrimitiveValue  value) ;

/// @brief Method CopyToFrom addr 0x2af48a4 size 0x8c virtual false final false
...
constexpr explicit InputStateBlock(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 InputStateBlock()  = default;


// Fields

// Static field FormatBit

// Static field FormatSBit

// Static field FormatInt

// Static field FormatUInt

// Static field FormatShort

// Static field FormatUShort

// Static field FormatByte

// Static field FormatSByte

// Static field FormatLong

// Static field FormatULong

// Static field FormatFloat

// Static field FormatDouble

// Static field FormatVector2

// Static field FormatVector3

// Static field FormatQuaternion

// Static field FormatVector2Short

// Static field FormatVector3Short

// Static field FormatVector2Byte

// Static field FormatVector3Byte
