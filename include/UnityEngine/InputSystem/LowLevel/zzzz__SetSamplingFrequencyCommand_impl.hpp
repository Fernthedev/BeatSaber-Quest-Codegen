...
constexpr ::UnityEngine::InputSystem::LowLevel::SetSamplingFrequencyCommand::SetSamplingFrequencyCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand  baseCommand, float_t  frequency) noexcept : ::bs_hook::ValueTypeWrapper<0xc>() {this->baseCommand = baseCommand;
