...
struct CORDL_TYPE QueryEnabledStateCommand : public ::bs_hook::ValueTypeWrapper<0xc> {
public:
// Declarations
...
/// @brief Field isEnabled offset 0x8
...
constexpr explicit QueryEnabledStateCommand(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0xc>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 QueryEnabledStateCommand()  = default;
