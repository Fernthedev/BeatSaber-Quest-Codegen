...
struct CORDL_TYPE DeviceConfigurationEvent : public ::bs_hook::ValueTypeWrapper<0x14> {
public:
// Declarations
...
/// @brief Method get_typeStatic addr 0x2ae9b08 size 0x20 virtual true final true
inline ::UnityEngine::InputSystem::Utilities::FourCC get_typeStatic() ;

/// @brief Method ToEventPtr addr 0x2ae9b28 size 0x4 virtual false final false
inline ::UnityEngine::InputSystem::LowLevel::InputEventPtr ToEventPtr() ;

/// @brief Method Create addr 0x2ae9b2c size 0x90 virtual false final false
...
constexpr explicit DeviceConfigurationEvent(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x14>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 DeviceConfigurationEvent()  = default;
