...
struct CORDL_TYPE __InitiateUserAccountPairingCommand__Result : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____InitiateUserAccountPairingCommand__Result_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __InitiateUserAccountPairingCommand__Result(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InitiateUserAccountPairingCommand__Result()  = default;
...
struct CORDL_TYPE InitiateUserAccountPairingCommand : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit InitiateUserAccountPairingCommand(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 InitiateUserAccountPairingCommand()  = default;
