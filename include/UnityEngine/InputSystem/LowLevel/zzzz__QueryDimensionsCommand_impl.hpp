...
constexpr ::UnityEngine::InputSystem::LowLevel::QueryDimensionsCommand::QueryDimensionsCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand  baseCommand, ::UnityEngine::Vector2  outDimensions) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->baseCommand = baseCommand;
