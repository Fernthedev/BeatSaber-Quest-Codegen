...
struct CORDL_TYPE DeviceRemoveEvent : public ::bs_hook::ValueTypeWrapper<0x14> {
public:
// Declarations
...
constexpr explicit DeviceRemoveEvent(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x14>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 DeviceRemoveEvent()  = default;
