...
constexpr ::UnityEngine::InputSystem::LowLevel::DeviceResetEvent::DeviceResetEvent(::UnityEngine::InputSystem::LowLevel::InputEvent  baseEvent, bool  hardReset) noexcept : ::bs_hook::ValueTypeWrapper<0x14>() {this->baseEvent = baseEvent;
