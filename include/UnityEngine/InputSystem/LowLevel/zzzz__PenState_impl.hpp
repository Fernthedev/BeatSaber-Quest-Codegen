...
::cordl_internals::setInstanceField<uint16_t, 0x22>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<uint16_t>(value));
}
constexpr uint16_t& UnityEngine::InputSystem::LowLevel::PenState::__get_displayIndex()  {
return ::cordl_internals::getInstanceField<uint16_t, 0x22>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::InputSystem::LowLevel::PenState::PenState(::UnityEngine::Vector2  position, ::UnityEngine::Vector2  delta, ::UnityEngine::Vector2  tilt, float_t  pressure, float_t  twist, uint16_t  buttons, uint16_t  displayIndex) noexcept : ::bs_hook::ValueTypeWrapper<0x24>() {this->position = position;
this->delta = delta;
this->tilt = tilt;
