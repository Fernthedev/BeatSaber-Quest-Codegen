...
#include "UnityEngine/InputSystem/LowLevel/zzzz__StateEvent_def.hpp"
constexpr void UnityEngine::InputSystem::LowLevel::__StateEvent___stateData_e__FixedBuffer::__set_FixedElementField(uint8_t  value)  {
...
constexpr uint8_t& UnityEngine::InputSystem::LowLevel::__StateEvent___stateData_e__FixedBuffer::__get_FixedElementField()  {
return ::cordl_internals::getInstanceField<uint8_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint8_t const& UnityEngine::InputSystem::LowLevel::__StateEvent___stateData_e__FixedBuffer::__get_FixedElementField() const {
return ::cordl_internals::getInstanceField<uint8_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "FixedElementField", ty: "uint8_t", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::InputSystem::LowLevel::__StateEvent___stateData_e__FixedBuffer::__StateEvent___stateData_e__FixedBuffer(uint8_t  FixedElementField) noexcept : ::bs_hook::ValueTypeWrapper<0x1>() {this->FixedElementField = FixedElementField;
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::cordl_internals::Ptr<void> (::UnityEngine::InputSystem::LowLevel::StateEvent::*)()>(&::UnityEngine::InputSystem::LowLevel::StateEvent::get_state)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::StateEvent> (*)(::UnityEngine::InputSystem::LowLevel::InputEventPtr)>(&::UnityEngine::InputSystem::LowLevel::StateEvent::From)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::cordl_internals::Ptr<::UnityEngine::InputSystem::LowLevel::StateEvent> (*)(::UnityEngine::InputSystem::LowLevel::InputEventPtr)>(&::UnityEngine::InputSystem::LowLevel::StateEvent::FromUnchecked)> {
  constexpr static std::size_t size = 0x4;
...
::cordl_internals::setInstanceField<::UnityEngine::InputSystem::LowLevel::__StateEvent___stateData_e__FixedBuffer, 0x18>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::UnityEngine::InputSystem::LowLevel::__StateEvent___stateData_e__FixedBuffer>(value));
}
...
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::LowLevel::__StateEvent___stateData_e__FixedBuffer, 0x18>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::InputSystem::LowLevel::StateEvent::StateEvent(::UnityEngine::InputSystem::LowLevel::InputEvent  baseEvent, ::UnityEngine::InputSystem::Utilities::FourCC  stateFormat, ::UnityEngine::InputSystem::LowLevel::__StateEvent___stateData_e__FixedBuffer  stateData) noexcept : ::bs_hook::ValueTypeWrapper<0x19>() {this->baseEvent = baseEvent;
