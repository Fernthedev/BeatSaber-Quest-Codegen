...
struct CORDL_TYPE DualMotorRumbleCommand : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
constexpr explicit DualMotorRumbleCommand(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 DualMotorRumbleCommand()  = default;
