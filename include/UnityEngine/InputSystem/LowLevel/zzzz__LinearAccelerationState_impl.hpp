...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (*)()>(&::UnityEngine::InputSystem::LowLevel::LinearAccelerationState::get_kFormat)> {
  ...
  constexpr static std::size_t addrs = 0x2ae8cfc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::FourCC (::UnityEngine::InputSystem::LowLevel::LinearAccelerationState::*)()>(&::UnityEngine::InputSystem::LowLevel::LinearAccelerationState::get_format)> {
  constexpr static std::size_t size = 0x30;
  constexpr static std::size_t addrs = 0x2ae8d2c;
...
constexpr ::UnityEngine::Vector3& UnityEngine::InputSystem::LowLevel::LinearAccelerationState::__get_acceleration()  {
...
constexpr ::UnityEngine::Vector3 const& UnityEngine::InputSystem::LowLevel::LinearAccelerationState::__get_acceleration() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::InputSystem::LowLevel::LinearAccelerationState::LinearAccelerationState(::UnityEngine::Vector3  acceleration) noexcept : ::bs_hook::ValueTypeWrapper<0xc>() {this->acceleration = acceleration;
}
