...
static inline ::UnityEngine::InputSystem::LowLevel::InputDeviceExecuteCommandDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 InputDeviceExecuteCommandDelegate()  = default;
public:
