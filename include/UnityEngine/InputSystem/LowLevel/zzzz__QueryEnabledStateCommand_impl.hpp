...
constexpr ::UnityEngine::InputSystem::LowLevel::QueryEnabledStateCommand::QueryEnabledStateCommand(::UnityEngine::InputSystem::LowLevel::InputDeviceCommand  baseCommand, bool  isEnabled) noexcept : ::bs_hook::ValueTypeWrapper<0xc>() {this->baseCommand = baseCommand;
