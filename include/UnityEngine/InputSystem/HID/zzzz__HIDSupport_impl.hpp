...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage::*)(::UnityEngine::InputSystem::HID::__HID__UsagePage, int32_t)>(&::UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage::*)(::UnityEngine::InputSystem::HID::__HID__GenericDesktop)>(&::UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage::_ctor)> {
...
constexpr void UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage::__set_page(::UnityEngine::InputSystem::HID::__HID__UsagePage  value)  {
...
constexpr ::UnityEngine::InputSystem::HID::__HID__UsagePage& UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage::__get_page()  {
...
constexpr ::UnityEngine::InputSystem::HID::__HID__UsagePage const& UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage::__get_page() const {
return ::cordl_internals::getInstanceField<::UnityEngine::InputSystem::HID::__HID__UsagePage, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage::__set_usage(int32_t  value)  {
...
constexpr int32_t& UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage::__get_usage()  {
return ::cordl_internals::getInstanceField<int32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage::__get_usage() const {
return ::cordl_internals::getInstanceField<int32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage::__HIDSupport__HIDPageUsage(::UnityEngine::InputSystem::HID::__HID__UsagePage  page, int32_t  usage) noexcept : ::bs_hook::ValueTypeWrapper<0x8>() {this->page = page;
this->usage = usage;
}
//  Writing Method size for method: ::UnityEngine::InputSystem::HID::HIDSupport.get_supportedHIDUsages
template<>

struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage> (*)()>(&::UnityEngine::InputSystem::HID::HIDSupport::get_supportedHIDUsages)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (*)(::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage>)>(&::UnityEngine::InputSystem::HID::HIDSupport::set_supportedHIDUsages)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::InputSystem::Utilities::ReadOnlyArray_1<::UnityEngine::InputSystem::HID::__HIDSupport__HIDPageUsage>>::get()}
                        )));
    return ___internal_method;
  }
};
