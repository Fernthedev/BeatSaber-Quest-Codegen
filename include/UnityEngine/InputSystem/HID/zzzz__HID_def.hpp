...
// Ctor Parameters []
// @brief default ctor
 __HID__HIDLayoutBuilder____c()  = default;
public:
...
/// @brief Field hidDescriptor offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get_deviceType() const;
...
// Ctor Parameters []
// @brief default ctor
 __HID__HIDLayoutBuilder()  = default;
public:
...
struct CORDL_TYPE __HID__HIDReportType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____HID__HIDReportType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __HID__HIDReportType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HID__HIDReportType()  = default;
...
struct CORDL_TYPE __HID__HIDCollectionType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____HID__HIDCollectionType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HID__HIDCollectionType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HID__HIDCollectionType()  = default;
...
struct CORDL_TYPE __HID__HIDElementFlags : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____HID__HIDElementFlags_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HID__HIDElementFlags(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HID__HIDElementFlags()  = default;
...
struct CORDL_TYPE __HID__HIDElementDescriptor : public ::bs_hook::ValueTypeWrapper<0x48> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x48};

/// @brief Field usage offset 0x0
 __declspec(property(get=__get_usage, put=__set_usage)) int32_t  usage;

/// @brief Field usagePage offset 0x4
 __declspec(property(get=__get_usagePage, put=__set_usagePage)) ::UnityEngine::InputSystem::HID::__HID__UsagePage  usagePage;

/// @brief Field unit offset 0x8
 __declspec(property(get=__get_unit, put=__set_unit)) int32_t  unit;

/// @brief Field unitExponent offset 0xc
 __declspec(property(get=__get_unitExponent, put=__set_unitExponent)) int32_t  unitExponent;

/// @brief Field logicalMin offset 0x10
 __declspec(property(get=__get_logicalMin, put=__set_logicalMin)) int32_t  logicalMin;

/// @brief Field logicalMax offset 0x14
 __declspec(property(get=__get_logicalMax, put=__set_logicalMax)) int32_t  logicalMax;

/// @brief Field physicalMin offset 0x18
 __declspec(property(get=__get_physicalMin, put=__set_physicalMin)) int32_t  physicalMin;

/// @brief Field physicalMax offset 0x1c
 __declspec(property(get=__get_physicalMax, put=__set_physicalMax)) int32_t  physicalMax;

/// @brief Field reportType offset 0x20
 __declspec(property(get=__get_reportType, put=__set_reportType)) ::UnityEngine::InputSystem::HID::__HID__HIDReportType  reportType;

/// @brief Field collectionIndex offset 0x24
 __declspec(property(get=__get_collectionIndex, put=__set_collectionIndex)) int32_t  collectionIndex;

/// @brief Field reportId offset 0x28
 __declspec(property(get=__get_reportId, put=__set_reportId)) int32_t  reportId;

/// @brief Field reportSizeInBits offset 0x2c
 __declspec(property(get=__get_reportSizeInBits, put=__set_reportSizeInBits)) int32_t  reportSizeInBits;

/// @brief Field reportOffsetInBits offset 0x30
 __declspec(property(get=__get_reportOffsetInBits, put=__set_reportOffsetInBits)) int32_t  reportOffsetInBits;

/// @brief Field flags offset 0x34
 __declspec(property(get=__get_flags, put=__set_flags)) ::UnityEngine::InputSystem::HID::__HID__HIDElementFlags  flags;

/// @brief Field usageMin offset 0x38
 __declspec(property(get=__get_usageMin, put=__set_usageMin)) ::System::Nullable_1<int32_t>  usageMin;

/// @brief Field usageMax offset 0x40
 __declspec(property(get=__get_usageMax, put=__set_usageMax)) ::System::Nullable_1<int32_t>  usageMax;
...
constexpr void __set_usagePage(::UnityEngine::InputSystem::HID::__HID__UsagePage  value) ;

constexpr ::UnityEngine::InputSystem::HID::__HID__UsagePage& __get_usagePage() ;

constexpr ::UnityEngine::InputSystem::HID::__HID__UsagePage const& __get_usagePage() const;

constexpr void __set_unit(int32_t  value) ;

constexpr int32_t& __get_unit() ;

constexpr int32_t const& __get_unit() const;

constexpr void __set_unitExponent(int32_t  value) ;

constexpr int32_t& __get_unitExponent() ;

constexpr int32_t const& __get_unitExponent() const;

constexpr void __set_logicalMin(int32_t  value) ;

constexpr int32_t& __get_logicalMin() ;

constexpr int32_t const& __get_logicalMin() const;

constexpr void __set_logicalMax(int32_t  value) ;

constexpr int32_t& __get_logicalMax() ;

constexpr int32_t const& __get_logicalMax() const;

constexpr void __set_physicalMin(int32_t  value) ;

constexpr int32_t& __get_physicalMin() ;

constexpr int32_t const& __get_physicalMin() const;

constexpr void __set_physicalMax(int32_t  value) ;

constexpr int32_t& __get_physicalMax() ;

constexpr int32_t const& __get_physicalMax() const;

constexpr void __set_reportType(::UnityEngine::InputSystem::HID::__HID__HIDReportType  value) ;

constexpr ::UnityEngine::InputSystem::HID::__HID__HIDReportType& __get_reportType() ;

constexpr ::UnityEngine::InputSystem::HID::__HID__HIDReportType const& __get_reportType() const;

constexpr void __set_collectionIndex(int32_t  value) ;

constexpr int32_t& __get_collectionIndex() ;

constexpr int32_t const& __get_collectionIndex() const;

constexpr void __set_reportId(int32_t  value) ;

constexpr int32_t& __get_reportId() ;

constexpr int32_t const& __get_reportId() const;

constexpr void __set_reportSizeInBits(int32_t  value) ;

constexpr int32_t& __get_reportSizeInBits() ;

constexpr int32_t const& __get_reportSizeInBits() const;

constexpr void __set_reportOffsetInBits(int32_t  value) ;

constexpr int32_t& __get_reportOffsetInBits() ;

constexpr int32_t const& __get_reportOffsetInBits() const;

constexpr void __set_flags(::UnityEngine::InputSystem::HID::__HID__HIDElementFlags  value) ;

constexpr ::UnityEngine::InputSystem::HID::__HID__HIDElementFlags& __get_flags() ;

constexpr ::UnityEngine::InputSystem::HID::__HID__HIDElementFlags const& __get_flags() const;

constexpr void __set_usageMin(::System::Nullable_1<int32_t>  value) ;

constexpr ::System::Nullable_1<int32_t>& __get_usageMin() ;

constexpr ::System::Nullable_1<int32_t> const& __get_usageMin() const;

constexpr void __set_usageMax(::System::Nullable_1<int32_t>  value) ;

constexpr ::System::Nullable_1<int32_t>& __get_usageMax() ;

constexpr ::System::Nullable_1<int32_t> const& __get_usageMax() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HID__HIDElementDescriptor(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x48>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HID__HIDElementDescriptor()  = default;
...
struct CORDL_TYPE __HID__HIDCollectionDescriptor : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field type offset 0x0
 __declspec(property(get=__get_type, put=__set_type)) ::UnityEngine::InputSystem::HID::__HID__HIDCollectionType  type;

/// @brief Field usage offset 0x4
 __declspec(property(get=__get_usage, put=__set_usage)) int32_t  usage;

/// @brief Field usagePage offset 0x8
 __declspec(property(get=__get_usagePage, put=__set_usagePage)) ::UnityEngine::InputSystem::HID::__HID__UsagePage  usagePage;

/// @brief Field parent offset 0xc
 __declspec(property(get=__get_parent, put=__set_parent)) int32_t  parent;

/// @brief Field childCount offset 0x10
 __declspec(property(get=__get_childCount, put=__set_childCount)) int32_t  childCount;

/// @brief Field firstChild offset 0x14
 __declspec(property(get=__get_firstChild, put=__set_firstChild)) int32_t  firstChild;

constexpr void __set_type(::UnityEngine::InputSystem::HID::__HID__HIDCollectionType  value) ;

constexpr ::UnityEngine::InputSystem::HID::__HID__HIDCollectionType& __get_type() ;

constexpr ::UnityEngine::InputSystem::HID::__HID__HIDCollectionType const& __get_type() const;
...
constexpr int32_t& __get_parent() ;

constexpr int32_t const& __get_parent() const;

constexpr void __set_childCount(int32_t  value) ;

constexpr int32_t& __get_childCount() ;

constexpr int32_t const& __get_childCount() const;

constexpr void __set_firstChild(int32_t  value) ;

constexpr int32_t& __get_firstChild() ;

constexpr int32_t const& __get_firstChild() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HID__HIDCollectionDescriptor(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HID__HIDCollectionDescriptor()  = default;
...
struct CORDL_TYPE __HID__HIDDeviceDescriptor : public ::bs_hook::ValueTypeWrapper<0x30> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x30};

/// @brief Field vendorId offset 0x0
 __declspec(property(get=__get_vendorId, put=__set_vendorId)) int32_t  vendorId;

/// @brief Field productId offset 0x4
 __declspec(property(get=__get_productId, put=__set_productId)) int32_t  productId;

/// @brief Field usage offset 0x8
 __declspec(property(get=__get_usage, put=__set_usage)) int32_t  usage;

/// @brief Field usagePage offset 0xc
 __declspec(property(get=__get_usagePage, put=__set_usagePage)) ::UnityEngine::InputSystem::HID::__HID__UsagePage  usagePage;

/// @brief Field inputReportSize offset 0x10
 __declspec(property(get=__get_inputReportSize, put=__set_inputReportSize)) int32_t  inputReportSize;

/// @brief Field outputReportSize offset 0x14
 __declspec(property(get=__get_outputReportSize, put=__set_outputReportSize)) int32_t  outputReportSize;

/// @brief Field featureReportSize offset 0x18
 __declspec(property(get=__get_featureReportSize, put=__set_featureReportSize)) int32_t  featureReportSize;

/// @brief Field elements offset 0x20
 __declspec(property(get=__get_elements, put=__set_elements)) ::ArrayW<::UnityEngine::InputSystem::HID::__HID__HIDElementDescriptor,::Array<::UnityEngine::InputSystem::HID::__HID__HIDElementDescriptor>*>  elements;

/// @brief Field collections offset 0x28
 __declspec(property(get=__get_collections, put=__set_collections)) ::ArrayW<::UnityEngine::InputSystem::HID::__HID__HIDCollectionDescriptor,::Array<::UnityEngine::InputSystem::HID::__HID__HIDCollectionDescriptor>*>  collections;
...
constexpr int32_t& __get_inputReportSize() ;

constexpr int32_t const& __get_inputReportSize() const;

constexpr void __set_outputReportSize(int32_t  value) ;

constexpr int32_t& __get_outputReportSize() ;

constexpr int32_t const& __get_outputReportSize() const;

constexpr void __set_featureReportSize(int32_t  value) ;

constexpr int32_t& __get_featureReportSize() ;

constexpr int32_t const& __get_featureReportSize() const;

constexpr void __set_elements(::ArrayW<::UnityEngine::InputSystem::HID::__HID__HIDElementDescriptor,::Array<::UnityEngine::InputSystem::HID::__HID__HIDElementDescriptor>*>  value) ;

constexpr ::ArrayW<::UnityEngine::InputSystem::HID::__HID__HIDElementDescriptor,::Array<::UnityEngine::InputSystem::HID::__HID__HIDElementDescriptor>*>& __get_elements() ;

constexpr ::ArrayW<::UnityEngine::InputSystem::HID::__HID__HIDElementDescriptor,::Array<::UnityEngine::InputSystem::HID::__HID__HIDElementDescriptor>*> const& __get_elements() const;

constexpr void __set_collections(::ArrayW<::UnityEngine::InputSystem::HID::__HID__HIDCollectionDescriptor,::Array<::UnityEngine::InputSystem::HID::__HID__HIDCollectionDescriptor>*>  value) ;

constexpr ::ArrayW<::UnityEngine::InputSystem::HID::__HID__HIDCollectionDescriptor,::Array<::UnityEngine::InputSystem::HID::__HID__HIDCollectionDescriptor>*>& __get_collections() ;

constexpr ::ArrayW<::UnityEngine::InputSystem::HID::__HID__HIDCollectionDescriptor,::Array<::UnityEngine::InputSystem::HID::__HID__HIDCollectionDescriptor>*> const& __get_collections() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HID__HIDDeviceDescriptor(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x30>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HID__HIDDeviceDescriptor()  = default;
...
struct CORDL_TYPE __HID__HIDDeviceDescriptorBuilder : public ::bs_hook::ValueTypeWrapper<0x38> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x38};

/// @brief Field usagePage offset 0x0
 __declspec(property(get=__get_usagePage, put=__set_usagePage)) ::UnityEngine::InputSystem::HID::__HID__UsagePage  usagePage;

/// @brief Field usage offset 0x4
 __declspec(property(get=__get_usage, put=__set_usage)) int32_t  usage;

/// @brief Field m_CurrentReportId offset 0x8
 __declspec(property(get=__get_m_CurrentReportId, put=__set_m_CurrentReportId)) int32_t  m_CurrentReportId;

/// @brief Field m_CurrentReportType offset 0xc
 __declspec(property(get=__get_m_CurrentReportType, put=__set_m_CurrentReportType)) ::UnityEngine::InputSystem::HID::__HID__HIDReportType  m_CurrentReportType;

/// @brief Field m_CurrentReportOffsetInBits offset 0x10
 __declspec(property(get=__get_m_CurrentReportOffsetInBits, put=__set_m_CurrentReportOffsetInBits)) int32_t  m_CurrentReportOffsetInBits;

/// @brief Field m_Elements offset 0x18
 __declspec(property(get=__get_m_Elements, put=__set_m_Elements)) ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::HID::__HID__HIDElementDescriptor>*  m_Elements;

/// @brief Field m_Collections offset 0x20
 __declspec(property(get=__get_m_Collections, put=__set_m_Collections)) ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::HID::__HID__HIDCollectionDescriptor>*  m_Collections;

/// @brief Field m_InputReportSize offset 0x28
 __declspec(property(get=__get_m_InputReportSize, put=__set_m_InputReportSize)) int32_t  m_InputReportSize;

/// @brief Field m_OutputReportSize offset 0x2c
 __declspec(property(get=__get_m_OutputReportSize, put=__set_m_OutputReportSize)) int32_t  m_OutputReportSize;

/// @brief Field m_FeatureReportSize offset 0x30
 __declspec(property(get=__get_m_FeatureReportSize, put=__set_m_FeatureReportSize)) int32_t  m_FeatureReportSize;
...
constexpr int32_t& __get_m_CurrentReportId() ;

constexpr int32_t const& __get_m_CurrentReportId() const;

constexpr void __set_m_CurrentReportType(::UnityEngine::InputSystem::HID::__HID__HIDReportType  value) ;

constexpr ::UnityEngine::InputSystem::HID::__HID__HIDReportType& __get_m_CurrentReportType() ;

constexpr ::UnityEngine::InputSystem::HID::__HID__HIDReportType const& __get_m_CurrentReportType() const;

constexpr void __set_m_CurrentReportOffsetInBits(int32_t  value) ;

constexpr int32_t& __get_m_CurrentReportOffsetInBits() ;

constexpr int32_t const& __get_m_CurrentReportOffsetInBits() const;

constexpr void __set_m_Elements(::System::Collections::Generic::List_1<::UnityEngine::InputSystem::HID::__HID__HIDElementDescriptor>*  value) ;

constexpr ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::HID::__HID__HIDElementDescriptor>* __get_m_Elements() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::InputSystem::HID::__HID__HIDElementDescriptor>*> __get_m_Elements() const;

constexpr void __set_m_Collections(::System::Collections::Generic::List_1<::UnityEngine::InputSystem::HID::__HID__HIDCollectionDescriptor>*  value) ;

constexpr ::System::Collections::Generic::List_1<::UnityEngine::InputSystem::HID::__HID__HIDCollectionDescriptor>* __get_m_Collections() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::InputSystem::HID::__HID__HIDCollectionDescriptor>*> __get_m_Collections() const;

constexpr void __set_m_InputReportSize(int32_t  value) ;

constexpr int32_t& __get_m_InputReportSize() ;

constexpr int32_t const& __get_m_InputReportSize() const;

constexpr void __set_m_OutputReportSize(int32_t  value) ;

constexpr int32_t& __get_m_OutputReportSize() ;

constexpr int32_t const& __get_m_OutputReportSize() const;

constexpr void __set_m_FeatureReportSize(int32_t  value) ;

constexpr int32_t& __get_m_FeatureReportSize() ;

constexpr int32_t const& __get_m_FeatureReportSize() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HID__HIDDeviceDescriptorBuilder(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x38>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HID__HIDDeviceDescriptorBuilder()  = default;
...
struct CORDL_TYPE __HID__UsagePage : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____HID__UsagePage_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HID__UsagePage(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HID__UsagePage()  = default;
...
struct CORDL_TYPE __HID__GenericDesktop : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____HID__GenericDesktop_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HID__GenericDesktop(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HID__GenericDesktop()  = default;
...
struct CORDL_TYPE __HID__Simulation : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____HID__Simulation_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HID__Simulation(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HID__Simulation()  = default;
...
// CS Name: ::HID::Button
struct CORDL_TYPE __HID__Button : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____HID__Button_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __HID__Button(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HID__Button()  = default;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::HID::__HID__HIDLayoutBuilder*> __get_layout() const;
...
// Ctor Parameters []
// @brief default ctor
 __HID____c__DisplayClass12_0()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x190 - sizeof(::UnityEngine::InputSystem::InputDevice)]{};

/// @brief Field kHIDInterface offset 0x0
static constexpr ::ConstString  kHIDInterface{u"HID"};

/// @brief Field kHIDNamespace offset 0x0
static constexpr ::ConstString  kHIDNamespace{u"HID"};

/// @brief Field m_HaveParsedHIDDescriptor offset 0x158
...
/// @brief Field m_HIDDescriptor offset 0x160
