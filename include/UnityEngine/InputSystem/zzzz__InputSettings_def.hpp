...
struct CORDL_TYPE __InputSettings__UpdateMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____InputSettings__UpdateMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __InputSettings__UpdateMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputSettings__UpdateMode()  = default;
...
struct CORDL_TYPE __InputSettings__BackgroundBehavior : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____InputSettings__BackgroundBehavior_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputSettings__BackgroundBehavior(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputSettings__BackgroundBehavior()  = default;
...
struct CORDL_TYPE __InputSettings__EditorInputBehaviorInPlayMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____InputSettings__EditorInputBehaviorInPlayMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputSettings__EditorInputBehaviorInPlayMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputSettings__EditorInputBehaviorInPlayMode()  = default;
...
/// @brief Field s_OldUnsupportedFixedAndDynamicUpdateSetting offset 0x0
static constexpr int32_t  s_OldUnsupportedFixedAndDynamicUpdateSetting{static_cast<int32_t>(0x0)};

/// @brief Field m_SupportedDevices offset 0x18
...
/// @brief Field m_UpdateMode offset 0x20
...
/// @brief Field m_MaxEventBytesPerUpdate offset 0x24
...
/// @brief Field m_MaxQueuedEventsPerUpdate offset 0x28
...
/// @brief Field m_CompensateForScreenOrientation offset 0x2c
...
/// @brief Field m_BackgroundBehavior offset 0x30
...
/// @brief Field m_EditorInputBehaviorInPlayMode offset 0x34
 __declspec(property(get=__get_m_EditorInputBehaviorInPlayMode, put=__set_m_EditorInputBehaviorInPlayMode)) ::UnityEngine::InputSystem::__InputSettings__EditorInputBehaviorInPlayMode  m_EditorInputBehaviorInPlayMode;

/// @brief Field m_DefaultDeadzoneMin offset 0x38
 __declspec(property(get=__get_m_DefaultDeadzoneMin, put=__set_m_DefaultDeadzoneMin)) float_t  m_DefaultDeadzoneMin;

/// @brief Field m_DefaultDeadzoneMax offset 0x3c
 __declspec(property(get=__get_m_DefaultDeadzoneMax, put=__set_m_DefaultDeadzoneMax)) float_t  m_DefaultDeadzoneMax;

/// @brief Field m_DefaultButtonPressPoint offset 0x40
...
/// @brief Field m_ButtonReleaseThreshold offset 0x44
...
/// @brief Field m_ShortcutKeysConsumeInputs offset 0x5d
...
/// @brief Field m_FeatureFlags offset 0x60
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::StringW>*> __get_m_FeatureFlags() const;
