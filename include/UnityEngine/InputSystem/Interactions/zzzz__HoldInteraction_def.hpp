...
/// @brief Field m_TimePressed offset 0x18
...
/// @brief Method get_durationOrDefault addr 0x2b0c468 size 0x70 virtual false final false
inline float_t get_durationOrDefault() ;

/// @brief Method get_pressPointOrDefault addr 0x2b0c4d8 size 0x58 virtual false final false
inline float_t get_pressPointOrDefault() ;

/// @brief Method Process addr 0x2b0c530 size 0x1a4 virtual true final true
inline void Process(ByRef<::UnityEngine::InputSystem::InputInteractionContext>  context) ;

/// @brief Method Reset addr 0x2b0c6d4 size 0x8 virtual true final true
inline void Reset() ;

static inline ::UnityEngine::InputSystem::Interactions::HoldInteraction* New_ctor() ;

/// @brief Method .ctor addr 0x2b0c6dc size 0x8 virtual false final false
inline void _ctor() ;
