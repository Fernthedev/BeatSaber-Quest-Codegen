...
namespace UnityEngine::InputSystem::Android {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6280))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x160 - sizeof(::UnityEngine::InputSystem::MagneticFieldSensor)]{};

static inline ::UnityEngine::InputSystem::Android::AndroidMagneticFieldSensor* New_ctor() ;

/// @brief Method .ctor addr 0x2ae59d0 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 AndroidMagneticFieldSensor()  = default;
public:
...
static_assert(::cordl_internals::size_check_v<::UnityEngine::InputSystem::Android::AndroidMagneticFieldSensor, 0x160>, "Size mismatch!");
