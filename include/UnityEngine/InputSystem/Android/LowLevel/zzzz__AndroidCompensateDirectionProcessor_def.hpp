...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x10 - sizeof(::UnityEngine::InputSystem::Processors::CompensateDirectionProcessor)]{};

/// @brief Field kSensorStandardGravity offset 0x0
static constexpr float_t  kSensorStandardGravity{9.80665};

/// @brief Field kAccelerationMultiplier offset 0x0
...
// Ctor Parameters []
// @brief default ctor
 AndroidCompensateDirectionProcessor()  = default;
public:
