...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x160 - sizeof(::UnityEngine::InputSystem::StepCounter)]{};

static inline ::UnityEngine::InputSystem::Android::AndroidStepCounter* New_ctor() ;

/// @brief Method .ctor addr 0x2ae5a20 size 0x8 virtual false final false
inline void _ctor() ;
