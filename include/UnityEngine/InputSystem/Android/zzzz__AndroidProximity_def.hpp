...
namespace UnityEngine::InputSystem::Android {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6283))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x160 - sizeof(::UnityEngine::InputSystem::ProximitySensor)]{};

static inline ::UnityEngine::InputSystem::Android::AndroidProximity* New_ctor() ;

/// @brief Method .ctor addr 0x2ae59f0 size 0x8 virtual false final false
inline void _ctor() ;
