...
struct CORDL_TYPE __InputControl__ControlFlags : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____InputControl__ControlFlags_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __InputControl__ControlFlags(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputControl__ControlFlags()  = default;
...
/// @brief Field m_StateBlock offset 0x10
...
/// @brief Field m_DefaultState offset 0xa8
...
/// @brief Field m_MinValue offset 0xb8
...
/// @brief Field m_MaxValue offset 0xc8
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputControl*> __get_m_Parent() const;
