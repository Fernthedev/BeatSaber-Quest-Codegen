...
inline void GetComponentFastPath(::System::Type*  type, ::cordl_internals::intptr_t  oneFurtherThanResultValue) ;
...
inline void TryGetComponentFastPath(::System::Type*  type, ::cordl_internals::intptr_t  oneFurtherThanResultValue) ;
