...
namespace UnityEngine::ResourceManagement {
template<::il2cpp_utils::il2cpp_reference_type TObject,::il2cpp_utils::il2cpp_reference_type TObjectDependency>
...
template<>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14032)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14032), inst: 789 }), TypeDefinitionIndex(TypeDefinitionIndex(13949))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13949), inst: 6926 })
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x118 - sizeof(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>)]{};

/// @brief Field m_DepOp offset 0x90
 __declspec(property(get=__get_m_DepOp, put=__set_m_DepOp)) ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>  m_DepOp;

/// @brief Field m_WrappedOp offset 0xb0
...
/// @brief Field m_depStatus offset 0xd0
...
/// @brief Field m_wrapStatus offset 0xe8
...
/// @brief Field m_Callback offset 0x100
 __declspec(property(get=__get_m_Callback, put=__set_m_Callback)) ::System::Func_2<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>,::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>>*  m_Callback;

/// @brief Field m_CachedOnWrappedCompleted offset 0x108
...
/// @brief Field m_ReleaseDependenciesOnFailure offset 0x110
...
constexpr ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>& __get_m_DepOp() ;

constexpr ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance> const& __get_m_DepOp() const;
...
static inline ::UnityEngine::ResourceManagement::ChainOperation_2<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance,::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>* New_ctor() ;
...
template<::il2cpp_utils::il2cpp_reference_type TObject,::il2cpp_utils::il2cpp_reference_type TObjectDependency>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14032)), TypeDefinitionIndex(TypeDefinitionIndex(13949)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14032), inst: 789 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13949), inst: 81 })
// CS Name: ::UnityEngine.ResourceManagement::ChainOperation`2<TObject,TObjectDependency>*
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x110 - sizeof(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<TObject>)]{};
...
/// @brief Field m_Callback offset 0xf8
 __declspec(property(get=__get_m_Callback, put=__set_m_Callback)) ::System::Func_2<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObjectDependency>,::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObject>>*  m_Callback;
...
constexpr ::System::Func_2<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObjectDependency>,::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObject>>* __get_m_Callback() ;

constexpr ::cordl_internals::to_const_pointer<::System::Func_2<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObjectDependency>,::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<TObject>>*> __get_m_Callback() const;
