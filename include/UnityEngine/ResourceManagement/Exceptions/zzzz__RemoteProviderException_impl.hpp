...
::cordl_internals::setInstanceField<::UnityEngine::ResourceManagement::Util::UnityWebRequestResult*, 0x98>(this, std::forward<::UnityEngine::ResourceManagement::Util::UnityWebRequestResult*>(value));
}
...
return ::cordl_internals::getInstanceField<::UnityEngine::ResourceManagement::Util::UnityWebRequestResult*, 0x98>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ResourceManagement::Util::UnityWebRequestResult*> UnityEngine::ResourceManagement::Exceptions::RemoteProviderException::__get__WebRequestResult_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::ResourceManagement::Util::UnityWebRequestResult*, 0x98>(this);
}
