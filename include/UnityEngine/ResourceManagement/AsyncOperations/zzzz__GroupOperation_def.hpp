...
struct CORDL_TYPE __GroupOperation__GroupOperationSettings : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____GroupOperation__GroupOperationSettings_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __GroupOperation__GroupOperationSettings(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __GroupOperation__GroupOperationSettings()  = default;
...
namespace UnityEngine::ResourceManagement::AsyncOperations {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14032), inst: 792 }), TypeDefinitionIndex(TypeDefinitionIndex(3835)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(3835), inst: 275 }), TypeDefinitionIndex(TypeDefinitionIndex(14032)), TypeDefinitionIndex(TypeDefinitionIndex(14034))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xb0 - sizeof(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<::System::Collections::Generic::IList_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*>)]{};

/// @brief Field k_MaxDisplayedLocationLength offset 0x0
static constexpr int32_t  k_MaxDisplayedLocationLength{static_cast<int32_t>(0x2d)};

/// @brief Field m_InternalOnComplete offset 0x88
 __declspec(property(get=__get_m_InternalOnComplete, put=__set_m_InternalOnComplete)) ::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*  m_InternalOnComplete;

/// @brief Field m_LoadedCount offset 0x90
 __declspec(property(get=__get_m_LoadedCount, put=__set_m_LoadedCount)) int32_t  m_LoadedCount;

/// @brief Field m_Settings offset 0x94
...
/// @brief Field debugName offset 0x98
 __declspec(property(get=__get_debugName, put=__set_debugName)) ::StringW  debugName;

/// @brief Field <UnityEngine.ResourceManagement.AsyncOperations.ICachable.Key>k__BackingField offset 0xa0
...
/// @brief Field m_CachedDependencyLocations offset 0xa8
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*> __get_m_InternalOnComplete() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::StringW>*> __get_m_CachedDependencyLocations() const;
