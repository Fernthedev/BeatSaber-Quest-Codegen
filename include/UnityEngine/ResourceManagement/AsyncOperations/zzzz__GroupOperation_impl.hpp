...
constexpr void UnityEngine::ResourceManagement::AsyncOperations::__GroupOperation__GroupOperationSettings::__set_value__(int32_t  value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<int32_t>(value));
}
constexpr int32_t& UnityEngine::ResourceManagement::AsyncOperations::__GroupOperation__GroupOperationSettings::__get_value__()  {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::ResourceManagement::AsyncOperations::__GroupOperation__GroupOperationSettings::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::ResourceManagement::AsyncOperations::__GroupOperation__GroupOperationSettings::__GroupOperation__GroupOperationSettings(int32_t  value__) noexcept : ::bs_hook::EnumTypeWrapper<0x4>() {this->value__ = value__;
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::ResourceManagement::AsyncOperations::DownloadStatus (::UnityEngine::ResourceManagement::AsyncOperations::GroupOperation::*)(::System::Collections::Generic::HashSet_1<::System::Object*>*)>(&::UnityEngine::ResourceManagement::AsyncOperations::GroupOperation::GetDownloadStatus)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::ResourceManagement::AsyncOperations::GroupOperation::*)(::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*, ::UnityEngine::ResourceManagement::AsyncOperations::__GroupOperation__GroupOperationSettings)>(&::UnityEngine::ResourceManagement::AsyncOperations::GroupOperation::Init)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "Init",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::ResourceManagement::AsyncOperations::__GroupOperation__GroupOperationSettings>::get()}
                        )));
    return ___internal_method;
  }
};
...
::cordl_internals::setInstanceField<::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*, 0x88>(this, std::forward<::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*>(value));
}
constexpr ::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>* UnityEngine::ResourceManagement::AsyncOperations::GroupOperation::__get_m_InternalOnComplete()  {
return ::cordl_internals::getInstanceField<::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*, 0x88>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*> UnityEngine::ResourceManagement::AsyncOperations::GroupOperation::__get_m_InternalOnComplete() const {
return ::cordl_internals::getInstanceField<::System::Action_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*, 0x88>(this);
}
...
::cordl_internals::setInstanceField<::UnityEngine::ResourceManagement::AsyncOperations::__GroupOperation__GroupOperationSettings, 0x94>(this, std::forward<::UnityEngine::ResourceManagement::AsyncOperations::__GroupOperation__GroupOperationSettings>(value));
}
...
return ::cordl_internals::getInstanceField<::UnityEngine::ResourceManagement::AsyncOperations::__GroupOperation__GroupOperationSettings, 0x94>(this);
}
constexpr ::UnityEngine::ResourceManagement::AsyncOperations::__GroupOperation__GroupOperationSettings const& UnityEngine::ResourceManagement::AsyncOperations::GroupOperation::__get_m_Settings() const {
return ::cordl_internals::getInstanceField<::UnityEngine::ResourceManagement::AsyncOperations::__GroupOperation__GroupOperationSettings, 0x94>(this);
}
...
::cordl_internals::setInstanceField<::UnityEngine::ResourceManagement::Util::IOperationCacheKey*, 0xa0>(this, std::forward<::UnityEngine::ResourceManagement::Util::IOperationCacheKey*>(value));
}
constexpr ::UnityEngine::ResourceManagement::Util::IOperationCacheKey* UnityEngine::ResourceManagement::AsyncOperations::GroupOperation::__get__UnityEngine_ResourceManagement_AsyncOperations_ICachable_Key_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::ResourceManagement::Util::IOperationCacheKey*, 0xa0>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ResourceManagement::Util::IOperationCacheKey*> UnityEngine::ResourceManagement::AsyncOperations::GroupOperation::__get__UnityEngine_ResourceManagement_AsyncOperations_ICachable_Key_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::ResourceManagement::Util::IOperationCacheKey*, 0xa0>(this);
}
...
::cordl_internals::setInstanceField<::System::Collections::Generic::HashSet_1<::StringW>*, 0xa8>(this, std::forward<::System::Collections::Generic::HashSet_1<::StringW>*>(value));
}
...
return ::cordl_internals::getInstanceField<::System::Collections::Generic::HashSet_1<::StringW>*, 0xa8>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::StringW>*> UnityEngine::ResourceManagement::AsyncOperations::GroupOperation::__get_m_CachedDependencyLocations() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::HashSet_1<::StringW>*, 0xa8>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::UnityEngine::ResourceManagement::AsyncOperations::GroupOperation*>());
}
