...
/// @brief Field m_Location offset 0x10
...
/// @brief Field m_DesiredType offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get_m_DesiredType() const;
