...
/// @brief Field <Result>k__BackingField offset 0x20
...
/// @brief Method .ctor addr 0x2bd32a8 size 0x108 virtual false final false
inline void _ctor(::UnityEngine::Networking::UnityWebRequest*  request) ;

/// @brief Method ToString addr 0x2bd33b8 size 0x180 virtual true final false
inline ::StringW ToString() ;

/// @brief Method get_Error addr 0x2bd3538 size 0x8 virtual false final false
inline ::StringW get_Error() ;

/// @brief Method set_Error addr 0x2bd3540 size 0x8 virtual false final false
inline void set_Error(::StringW  value) ;

/// @brief Method get_ResponseCode addr 0x2bd3548 size 0x8 virtual false final false
inline int64_t get_ResponseCode() ;

/// @brief Method get_Result addr 0x2bd3550 size 0x8 virtual false final false
inline ::UnityEngine::Networking::__UnityWebRequest__Result get_Result() ;

/// @brief Method get_Method addr 0x2bd3558 size 0x8 virtual false final false
inline ::StringW get_Method() ;

/// @brief Method get_Url addr 0x2bd3560 size 0x8 virtual false final false
inline ::StringW get_Url() ;

/// @brief Method ShouldRetryDownloadError addr 0x2bd3568 size 0x2d0 virtual false final false
