...
namespace UnityEngine::ResourceManagement::ResourceProviders {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14032)), TypeDefinitionIndex(TypeDefinitionIndex(14004)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14032), inst: 797 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xe0 - sizeof(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>)]{};

/// @brief Field m_ActivateOnLoad offset 0x90
 __declspec(property(get=__get_m_ActivateOnLoad, put=__set_m_ActivateOnLoad)) bool  m_ActivateOnLoad;

/// @brief Field m_Inst offset 0x98
...
/// @brief Field m_Location offset 0xa8
...
/// @brief Field m_ResourceManager offset 0xd8
...
inline ::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance InternalLoadScene(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  location, bool  loadingFromBundle, ::UnityEngine::SceneManagement::LoadSceneMode  loadMode, bool  activateOnLoad, int32_t  priority) ;
...
// Ctor Parameters []
// @brief default ctor
 __SceneProvider__SceneOp()  = default;
public:
...
namespace UnityEngine::ResourceManagement::ResourceProviders {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14032), inst: 797 }), TypeDefinitionIndex(TypeDefinitionIndex(14032)), TypeDefinitionIndex(TypeDefinitionIndex(14004))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xc8 - sizeof(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>)]{};

/// @brief Field m_Instance offset 0x90
...
/// @brief Field m_sceneLoadHandle offset 0xa0
 __declspec(property(get=__get_m_sceneLoadHandle, put=__set_m_sceneLoadHandle)) ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::ResourceManagement::ResourceProviders::SceneInstance>  m_sceneLoadHandle;

/// @brief Field m_UnloadOptions offset 0xc0
...
// Ctor Parameters []
// @brief default ctor
 __SceneProvider__UnloadSceneOp()  = default;
public:
