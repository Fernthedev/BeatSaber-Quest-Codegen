...
struct CORDL_TYPE ProvideHandle : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x18};

/// @brief Field m_Version offset 0x0
 __declspec(property(get=__get_m_Version, put=__set_m_Version)) int32_t  m_Version;

/// @brief Field m_InternalOp offset 0x8
 __declspec(property(get=__get_m_InternalOp, put=__set_m_InternalOp)) ::UnityEngine::ResourceManagement::AsyncOperations::IGenericProviderOperation*  m_InternalOp;
...
constexpr ::UnityEngine::ResourceManagement::AsyncOperations::IGenericProviderOperation* __get_m_InternalOp() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ResourceManagement::AsyncOperations::IGenericProviderOperation*> __get_m_InternalOp() const;
...
constexpr explicit ProvideHandle(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 ProvideHandle()  = default;
