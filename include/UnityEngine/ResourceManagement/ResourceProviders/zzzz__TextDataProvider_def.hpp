...
/// @brief Field m_Provider offset 0x10
...
/// @brief Field m_RequestOperation offset 0x18
...
/// @brief Field m_RequestQueueOperation offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ResourceManagement::ResourceProviders::TextDataProvider*> __get_m_Provider() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Networking::UnityWebRequestAsyncOperation*> __get_m_RequestOperation() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ResourceManagement::WebRequestQueueOperation*> __get_m_RequestQueueOperation() const;
...
// Ctor Parameters []
// @brief default ctor
 __TextDataProvider__InternalOp()  = default;
public:
...
/// @brief Field <IgnoreFailures>k__BackingField offset 0x1c
