...
/// @brief Field m_RequestOperation offset 0x10
...
/// @brief Field m_ProvideHandle offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ResourceRequest*> __get_m_RequestOperation() const;
...
// Ctor Parameters []
// @brief default ctor
 __LegacyResourcesProvider__InternalOp()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 LegacyResourcesProvider()  = default;
public:
