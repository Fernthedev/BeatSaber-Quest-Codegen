...
/// @brief Field m_DependencyHashCode offset 0x30
 __declspec(property(get=__get_m_DependencyHashCode, put=__set_m_DependencyHashCode)) int32_t  m_DependencyHashCode;

/// @brief Field m_HashCode offset 0x34
 __declspec(property(get=__get_m_HashCode, put=__set_m_HashCode)) int32_t  m_HashCode;

/// @brief Field m_Type offset 0x38
 __declspec(property(get=__get_m_Type, put=__set_m_Type)) ::System::Type*  m_Type;

/// @brief Field m_Dependencies offset 0x40
 __declspec(property(get=__get_m_Dependencies, put=__set_m_Dependencies)) ::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*>*  m_Dependencies;

/// @brief Field m_PrimaryKey offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*>*> __get_m_Dependencies() const;
