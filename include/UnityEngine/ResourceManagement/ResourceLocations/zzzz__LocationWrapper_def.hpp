...
/// @brief Field m_InternalLocation offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*> __get_m_InternalLocation() const;
...
/// @brief Method .ctor addr 0x2bd3860 size 0x28 virtual false final false
inline void _ctor(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  location) ;

/// @brief Method get_InternalId addr 0x2bdb040 size 0xa0 virtual true final true
inline ::StringW get_InternalId() ;

/// @brief Method get_ProviderId addr 0x2bdb0e0 size 0xa4 virtual true final true
inline ::StringW get_ProviderId() ;

/// @brief Method get_Dependencies addr 0x2bdb184 size 0xa4 virtual true final true
...
/// @brief Method get_DependencyHashCode addr 0x2bdb228 size 0xa4 virtual true final true
inline int32_t get_DependencyHashCode() ;

/// @brief Method get_HasDependencies addr 0x2bdb2cc size 0xa4 virtual true final true
inline bool get_HasDependencies() ;

/// @brief Method get_Data addr 0x2bdb370 size 0xa4 virtual true final true
inline ::System::Object* get_Data() ;

/// @brief Method get_PrimaryKey addr 0x2bdb414 size 0xa4 virtual true final true
inline ::StringW get_PrimaryKey() ;

/// @brief Method get_ResourceType addr 0x2bdb4b8 size 0xa4 virtual true final true
inline ::System::Type* get_ResourceType() ;

/// @brief Method Hash addr 0x2bdb55c size 0xac virtual true final true
