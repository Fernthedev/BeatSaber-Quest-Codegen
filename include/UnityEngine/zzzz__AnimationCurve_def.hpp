...
static inline ::cordl_internals::intptr_t Internal_Create(::ArrayW<::UnityEngine::Keyframe,::Array<::UnityEngine::Keyframe>*>  keys) ;

/// @brief Method Internal_Equals addr 0x2c9eb50 size 0x44 virtual false final false
inline bool Internal_Equals(::cordl_internals::intptr_t  other) ;
