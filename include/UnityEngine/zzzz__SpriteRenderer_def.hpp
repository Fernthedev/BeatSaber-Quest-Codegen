...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::UnityEngine::Renderer)]{};

/// @brief Field m_SpriteChangeEvent offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Events::UnityEvent_1<::UnityEngine::SpriteRenderer*>*> __get_m_SpriteChangeEvent() const;
