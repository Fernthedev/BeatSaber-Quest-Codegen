...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::UnityEngine::Timeline::RuntimeElement)]{};

/// @brief Field m_Playable offset 0x18
...
// Ctor Parameters []
// @brief default ctor
 InfiniteRuntimeClip()  = default;
public:


// Fields

// Static field kIntervalEnd
