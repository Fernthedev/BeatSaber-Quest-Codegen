...
/// @brief Field m_Signals offset 0x10
...
/// @brief Field m_Events offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Timeline::SignalAsset*>*> __get_m_Signals() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Events::UnityEvent*>*> __get_m_Events() const;
...
// Ctor Parameters []
// @brief default ctor
 __SignalReceiver__EventKeyValue()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Timeline::__SignalReceiver__EventKeyValue*> __get_m_Events() const;
