...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Timeline::AudioTrack*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __AudioTrack___get_outputs_d__4()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xa8 - sizeof(::UnityEngine::Timeline::TrackAsset)]{};

/// @brief Field m_TrackProperties offset 0xa0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Timeline::AudioMixerProperties*> __get_m_TrackProperties() const;
