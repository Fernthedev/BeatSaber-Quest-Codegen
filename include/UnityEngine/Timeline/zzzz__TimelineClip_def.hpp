...
struct CORDL_TYPE __TimelineClip__Versions : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____TimelineClip__Versions_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __TimelineClip__Versions(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __TimelineClip__Versions()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __TimelineClip__TimelineClipUpgrade()  = default;
public:
...
struct CORDL_TYPE __TimelineClip__ClipExtrapolation : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____TimelineClip__ClipExtrapolation_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __TimelineClip__ClipExtrapolation(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __TimelineClip__ClipExtrapolation()  = default;
...
struct CORDL_TYPE __TimelineClip__BlendCurveMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____TimelineClip__BlendCurveMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __TimelineClip__BlendCurveMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __TimelineClip__BlendCurveMode()  = default;
...
/// @brief Field m_BlendOutCurveMode offset 0x7c
...
/// @brief Field m_ExposedParameterNames offset 0x80
...
/// @brief Field m_PreExtrapolationMode offset 0x98
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Object*> __get_m_Asset() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Timeline::TrackAsset*> __get_m_ParentTrack() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get_m_MixInCurve() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get_m_MixOutCurve() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> __get_m_ExposedParameterNames() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationClip*> __get_m_AnimationCurves() const;
...
// Static field kDefaultClipCaps

// Static field kDefaultClipDurationInSeconds

// Static field kTimeScaleMin

// Static field kTimeScaleMax

// Static field kDefaultCurvesName

// Static field kMinDuration

// Static field kMaxTimeValue
