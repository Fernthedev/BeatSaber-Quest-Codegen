...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Timeline::AudioPlayableAsset*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __AudioPlayableAsset___get_outputs_d__16()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AudioClip*> __get_m_Clip() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Timeline::AudioClipProperties*> __get_m_ClipProperties() const;
