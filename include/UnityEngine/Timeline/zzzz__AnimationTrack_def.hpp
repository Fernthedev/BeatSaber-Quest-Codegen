...
// Ctor Parameters []
// @brief default ctor
 __AnimationTrack__AnimationTrackUpgrade()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Timeline::AnimationTrack*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __AnimationTrack___get_outputs_d__49()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x130 - sizeof(::UnityEngine::Timeline::TrackAsset)]{};

/// @brief Field k_DefaultInfiniteClipName offset 0x0
static constexpr ::ConstString  k_DefaultInfiniteClipName{u"Recorded"};

/// @brief Field k_DefaultRecordableClipName offset 0x0
static constexpr ::ConstString  k_DefaultRecordableClipName{u"Recorded"};

/// @brief Field m_InfiniteClipPreExtrapolation offset 0xa0
...
/// @brief Field m_InfiniteClipPostExtrapolation offset 0xa4
 __declspec(property(get=__get_m_InfiniteClipPostExtrapolation, put=__set_m_InfiniteClipPostExtrapolation)) ::UnityEngine::Timeline::__TimelineClip__ClipExtrapolation  m_InfiniteClipPostExtrapolation;

/// @brief Field m_InfiniteClipOffsetPosition offset 0xa8
...
/// @brief Field m_InfiniteClipOffsetEulerAngles offset 0xb4
...
/// @brief Field m_InfiniteClipTimeOffset offset 0xc0
...
/// @brief Field m_InfiniteClipRemoveOffset offset 0xc8
...
/// @brief Field m_InfiniteClipApplyFootIK offset 0xc9
...
/// @brief Field mInfiniteClipLoop offset 0xcc
...
/// @brief Field m_MatchTargetFields offset 0xd0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AvatarMask*> __get_m_AvatarMask() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationClip*> __get_m_InfiniteClip() const;
