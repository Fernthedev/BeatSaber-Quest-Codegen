...
struct CORDL_TYPE __TimelineAsset__Versions : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____TimelineAsset__Versions_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __TimelineAsset__Versions(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __TimelineAsset__Versions()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __TimelineAsset__TimelineAssetUpgrade()  = default;
public:
...
struct CORDL_TYPE __TimelineAsset__MediaType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____TimelineAsset__MediaType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __TimelineAsset__MediaType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __TimelineAsset__MediaType()  = default;
...
struct CORDL_TYPE __TimelineAsset__DurationMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____TimelineAsset__DurationMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __TimelineAsset__DurationMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __TimelineAsset__DurationMode()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __TimelineAsset__EditorSettings()  = default;
public:


// Fields

// Static field kMinFrameRate

// Static field kMaxFrameRate

// Static field kDefaultFrameRate
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Timeline::TimelineAsset*> __get___4__this() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IEnumerator_1<::UnityEngine::Timeline::TrackAsset*>*> __get___7__wrap1() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IEnumerator_1<::UnityEngine::Playables::PlayableBinding>*> __get___7__wrap2() const;
...
// Ctor Parameters []
// @brief default ctor
 __TimelineAsset___get_outputs_d__27()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x60 - sizeof(::UnityEngine::Playables::PlayableAsset)]{};
...
/// @brief Field m_Tracks offset 0x20
...
/// @brief Field m_FixedDuration offset 0x28
 __declspec(property(get=__get_m_FixedDuration, put=__set_m_FixedDuration)) double_t  m_FixedDuration;

/// @brief Field m_CacheOutputTracks offset 0x30
 __declspec(property(get=__get_m_CacheOutputTracks, put=__set_m_CacheOutputTracks)) ::ArrayW<::UnityEngine::Timeline::TrackAsset*,::Array<::UnityEngine::Timeline::TrackAsset*>*>  m_CacheOutputTracks;

/// @brief Field m_CacheRootTracks offset 0x38
...
/// @brief Field m_CacheFlattenedTracks offset 0x40
 __declspec(property(get=__get_m_CacheFlattenedTracks, put=__set_m_CacheFlattenedTracks)) ::ArrayW<::UnityEngine::Timeline::TrackAsset*,::Array<::UnityEngine::Timeline::TrackAsset*>*>  m_CacheFlattenedTracks;

/// @brief Field m_EditorSettings offset 0x48
...
/// @brief Field m_DurationMode offset 0x50
...
/// @brief Field m_MarkerTrack offset 0x58
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::ScriptableObject*>*> __get_m_Tracks() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Timeline::TrackAsset*>*> __get_m_CacheRootTracks() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Timeline::__TimelineAsset__EditorSettings*> __get_m_EditorSettings() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Timeline::MarkerTrack*> __get_m_MarkerTrack() const;
