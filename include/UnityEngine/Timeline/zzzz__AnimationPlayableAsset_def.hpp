...
struct CORDL_TYPE __AnimationPlayableAsset__LoopMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____AnimationPlayableAsset__LoopMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __AnimationPlayableAsset__LoopMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __AnimationPlayableAsset__LoopMode()  = default;
...
struct CORDL_TYPE __AnimationPlayableAsset__Versions : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____AnimationPlayableAsset__Versions_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __AnimationPlayableAsset__Versions(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __AnimationPlayableAsset__Versions()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __AnimationPlayableAsset__AnimationPlayableAssetUpgrade()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Timeline::AnimationPlayableAsset*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __AnimationPlayableAsset___get_outputs_d__45()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationClip*> __get_m_Clip() const;
...
// Ctor Parameters []
// @brief default ctor
 AnimationPlayableAsset()  = default;
public:


// Fields

// Static field k_LatestVersion
