...
struct CORDL_TYPE NotificationFlags : public ::bs_hook::EnumTypeWrapper<0x2> {
public:
// Declarations
...
return std::bit_cast<__NotificationFlags_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x2>::instance);
}
...
constexpr explicit NotificationFlags(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x2>(instance) {
}
