...
constexpr void UnityEngine::EventSystems::__StandaloneInputModule__InputMode::__set_value__(int32_t  value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<int32_t>(value));
}
constexpr int32_t& UnityEngine::EventSystems::__StandaloneInputModule__InputMode::__get_value__()  {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::EventSystems::__StandaloneInputModule__InputMode::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::UnityEngine::EventSystems::__StandaloneInputModule__InputMode::__StandaloneInputModule__InputMode(int32_t  value__) noexcept : ::bs_hook::EnumTypeWrapper<0x4>() {this->value__ = value__;
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::EventSystems::__StandaloneInputModule__InputMode (::UnityEngine::EventSystems::StandaloneInputModule::*)()>(&::UnityEngine::EventSystems::StandaloneInputModule::get_inputMode)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::EventSystems::StandaloneInputModule::*)(::UnityEngine::EventSystems::__PointerInputModule__MouseButtonEventData*)>(&::UnityEngine::EventSystems::StandaloneInputModule::ProcessMousePress)> {
...
::cordl_internals::setInstanceField<::UnityEngine::Vector2, 0x78>(this, std::forward<::UnityEngine::Vector2>(value));
}
constexpr ::UnityEngine::Vector2& UnityEngine::EventSystems::StandaloneInputModule::__get_m_MousePosition()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0x78>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> UnityEngine::EventSystems::StandaloneInputModule::__get_m_CurrentFocusedGameObject() const {
return ::cordl_internals::getInstanceField<::UnityEngine::GameObject*, 0x80>(this);
}
...
::cordl_internals::setInstanceField<::UnityEngine::EventSystems::PointerEventData*, 0x88>(this, std::forward<::UnityEngine::EventSystems::PointerEventData*>(value));
}
...
return ::cordl_internals::getInstanceField<::UnityEngine::EventSystems::PointerEventData*, 0x88>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::EventSystems::PointerEventData*> UnityEngine::EventSystems::StandaloneInputModule::__get_m_InputPointerEvent() const {
return ::cordl_internals::getInstanceField<::UnityEngine::EventSystems::PointerEventData*, 0x88>(this);
}
