...
/// @brief Field m_RootRaycaster offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::EventSystems::BaseRaycaster*> __get_m_RootRaycaster() const;
