...
struct CORDL_TYPE __StandaloneInputModule__InputMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____StandaloneInputModule__InputMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __StandaloneInputModule__InputMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __StandaloneInputModule__InputMode()  = default;
...
/// @brief Field m_InputPointerEvent offset 0x88
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_CurrentFocusedGameObject() const;
