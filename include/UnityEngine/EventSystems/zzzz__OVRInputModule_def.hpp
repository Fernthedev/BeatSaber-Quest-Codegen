...
struct CORDL_TYPE __OVRInputModule__InputMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____OVRInputModule__InputMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __OVRInputModule__InputMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRInputModule__InputMode()  = default;
...
/// @brief Field m_VRRayPointerData offset 0xe0
 __declspec(property(get=__get_m_VRRayPointerData, put=__set_m_VRRayPointerData)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::EventSystems::OVRPointerEventData*>*  m_VRRayPointerData;

/// @brief Field m_MouseState offset 0xe8
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRCursor*> __get_m_Cursor() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRRaycaster*> __get_activeGraphicRaycaster() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::EventSystems::OVRPointerEventData*>*> __get_m_VRRayPointerData() const;
