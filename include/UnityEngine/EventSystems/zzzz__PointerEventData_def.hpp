...
struct CORDL_TYPE __PointerEventData__InputButton : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____PointerEventData__InputButton_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __PointerEventData__InputButton(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __PointerEventData__InputButton()  = default;
...
struct CORDL_TYPE __PointerEventData__FramePressState : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____PointerEventData__FramePressState_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __PointerEventData__FramePressState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __PointerEventData__FramePressState()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x160 - sizeof(::UnityEngine::EventSystems::BaseEventData)]{};

/// @brief Field <pointerEnter>k__BackingField offset 0x20
...
/// @brief Field <rawPointerPress>k__BackingField offset 0x38
...
/// @brief Field <pointerDrag>k__BackingField offset 0x40
...
/// @brief Field <pointerClick>k__BackingField offset 0x48
...
/// @brief Field <pointerCurrentRaycast>k__BackingField offset 0x50
 __declspec(property(get=__get__pointerCurrentRaycast_k__BackingField, put=__set__pointerCurrentRaycast_k__BackingField)) ::UnityEngine::EventSystems::RaycastResult  _pointerCurrentRaycast_k__BackingField;

/// @brief Field <pointerPressRaycast>k__BackingField offset 0x98
 __declspec(property(get=__get__pointerPressRaycast_k__BackingField, put=__set__pointerPressRaycast_k__BackingField)) ::UnityEngine::EventSystems::RaycastResult  _pointerPressRaycast_k__BackingField;

/// @brief Field hovered offset 0xe0
 __declspec(property(get=__get_hovered, put=__set_hovered)) ::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*  hovered;

/// @brief Field <eligibleForClick>k__BackingField offset 0xe8
...
/// @brief Field <pointerId>k__BackingField offset 0xec
...
/// @brief Field <position>k__BackingField offset 0xf0
...
/// @brief Field <delta>k__BackingField offset 0xf8
...
/// @brief Field <pressPosition>k__BackingField offset 0x100
...
/// @brief Field <worldPosition>k__BackingField offset 0x108
...
/// @brief Field <worldNormal>k__BackingField offset 0x114
...
/// @brief Field <clickTime>k__BackingField offset 0x120
...
/// @brief Field <clickCount>k__BackingField offset 0x124
...
/// @brief Field <scrollDelta>k__BackingField offset 0x128
...
/// @brief Field <useDragThreshold>k__BackingField offset 0x130
...
/// @brief Field <dragging>k__BackingField offset 0x131
...
/// @brief Field <button>k__BackingField offset 0x134
...
/// @brief Field <pressure>k__BackingField offset 0x138
...
/// @brief Field <tangentialPressure>k__BackingField offset 0x13c
...
/// @brief Field <altitudeAngle>k__BackingField offset 0x140
...
/// @brief Field <azimuthAngle>k__BackingField offset 0x144
...
/// @brief Field <radiusVariance>k__BackingField offset 0x154
...
/// @brief Field <fullyExited>k__BackingField offset 0x15c
...
/// @brief Field <reentered>k__BackingField offset 0x15d
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__pointerEnter_k__BackingField() const;

constexpr void __set_m_PointerPress(::UnityEngine::GameObject*  value) ;

constexpr ::UnityEngine::GameObject* __get_m_PointerPress() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_PointerPress() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__lastPress_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__rawPointerPress_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__pointerDrag_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__pointerClick_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::GameObject*>*> __get_hovered() const;
...
/// @brief Method get_pointerEnter addr 0x2d956c4 size 0x8 virtual false final false
inline ::UnityEngine::GameObject* get_pointerEnter() ;

/// @brief Method set_pointerEnter addr 0x2d956cc size 0x8 virtual false final false
inline void set_pointerEnter(::UnityEngine::GameObject*  value) ;

/// @brief Method get_lastPress addr 0x2d956d4 size 0x8 virtual false final false
inline ::UnityEngine::GameObject* get_lastPress() ;

/// @brief Method set_lastPress addr 0x2d956dc size 0x8 virtual false final false
inline void set_lastPress(::UnityEngine::GameObject*  value) ;

/// @brief Method get_rawPointerPress addr 0x2d956e4 size 0x8 virtual false final false
inline ::UnityEngine::GameObject* get_rawPointerPress() ;

/// @brief Method set_rawPointerPress addr 0x2d956ec size 0x8 virtual false final false
inline void set_rawPointerPress(::UnityEngine::GameObject*  value) ;

/// @brief Method get_pointerDrag addr 0x2d956f4 size 0x8 virtual false final false
inline ::UnityEngine::GameObject* get_pointerDrag() ;

/// @brief Method set_pointerDrag addr 0x2d956fc size 0x8 virtual false final false
inline void set_pointerDrag(::UnityEngine::GameObject*  value) ;

/// @brief Method get_pointerClick addr 0x2d95704 size 0x8 virtual false final false
inline ::UnityEngine::GameObject* get_pointerClick() ;

/// @brief Method set_pointerClick addr 0x2d9570c size 0x8 virtual false final false
inline void set_pointerClick(::UnityEngine::GameObject*  value) ;

/// @brief Method get_pointerCurrentRaycast addr 0x2d95714 size 0x10 virtual false final false
inline ::UnityEngine::EventSystems::RaycastResult get_pointerCurrentRaycast() ;

/// @brief Method set_pointerCurrentRaycast addr 0x2d95724 size 0x18 virtual false final false
inline void set_pointerCurrentRaycast(::UnityEngine::EventSystems::RaycastResult  value) ;

/// @brief Method get_pointerPressRaycast addr 0x2d9573c size 0x10 virtual false final false
inline ::UnityEngine::EventSystems::RaycastResult get_pointerPressRaycast() ;

/// @brief Method set_pointerPressRaycast addr 0x2d9574c size 0x18 virtual false final false
inline void set_pointerPressRaycast(::UnityEngine::EventSystems::RaycastResult  value) ;

/// @brief Method get_eligibleForClick addr 0x2d95764 size 0x8 virtual false final false
inline bool get_eligibleForClick() ;

/// @brief Method set_eligibleForClick addr 0x2d9576c size 0xc virtual false final false
inline void set_eligibleForClick(bool  value) ;

/// @brief Method get_pointerId addr 0x2d95778 size 0x8 virtual false final false
inline int32_t get_pointerId() ;

/// @brief Method set_pointerId addr 0x2d95780 size 0x8 virtual false final false
inline void set_pointerId(int32_t  value) ;

/// @brief Method get_position addr 0x2d95788 size 0x8 virtual false final false
inline ::UnityEngine::Vector2 get_position() ;

/// @brief Method set_position addr 0x2d95790 size 0x8 virtual false final false
inline void set_position(::UnityEngine::Vector2  value) ;

/// @brief Method get_delta addr 0x2d95798 size 0x8 virtual false final false
inline ::UnityEngine::Vector2 get_delta() ;

/// @brief Method set_delta addr 0x2d957a0 size 0x8 virtual false final false
inline void set_delta(::UnityEngine::Vector2  value) ;

/// @brief Method get_pressPosition addr 0x2d957a8 size 0xc virtual false final false
inline ::UnityEngine::Vector2 get_pressPosition() ;

/// @brief Method set_pressPosition addr 0x2d957b4 size 0xc virtual false final false
inline void set_pressPosition(::UnityEngine::Vector2  value) ;

/// @brief Method get_worldPosition addr 0x2d957c0 size 0x10 virtual false final false
inline ::UnityEngine::Vector3 get_worldPosition() ;

/// @brief Method set_worldPosition addr 0x2d957d0 size 0x10 virtual false final false
inline void set_worldPosition(::UnityEngine::Vector3  value) ;

/// @brief Method get_worldNormal addr 0x2d957e0 size 0x10 virtual false final false
inline ::UnityEngine::Vector3 get_worldNormal() ;

/// @brief Method set_worldNormal addr 0x2d957f0 size 0x10 virtual false final false
inline void set_worldNormal(::UnityEngine::Vector3  value) ;

/// @brief Method get_clickTime addr 0x2d95800 size 0x8 virtual false final false
inline float_t get_clickTime() ;

/// @brief Method set_clickTime addr 0x2d95808 size 0x8 virtual false final false
inline void set_clickTime(float_t  value) ;

/// @brief Method get_clickCount addr 0x2d95810 size 0x8 virtual false final false
inline int32_t get_clickCount() ;

/// @brief Method set_clickCount addr 0x2d95818 size 0x8 virtual false final false
inline void set_clickCount(int32_t  value) ;

/// @brief Method get_scrollDelta addr 0x2d95820 size 0xc virtual false final false
inline ::UnityEngine::Vector2 get_scrollDelta() ;

/// @brief Method set_scrollDelta addr 0x2d9582c size 0xc virtual false final false
inline void set_scrollDelta(::UnityEngine::Vector2  value) ;

/// @brief Method get_useDragThreshold addr 0x2d95838 size 0x8 virtual false final false
inline bool get_useDragThreshold() ;

/// @brief Method set_useDragThreshold addr 0x2d95840 size 0xc virtual false final false
inline void set_useDragThreshold(bool  value) ;

/// @brief Method get_dragging addr 0x2d9584c size 0x8 virtual false final false
inline bool get_dragging() ;

/// @brief Method set_dragging addr 0x2d95854 size 0xc virtual false final false
inline void set_dragging(bool  value) ;

/// @brief Method get_button addr 0x2d95860 size 0x8 virtual false final false
inline ::UnityEngine::EventSystems::__PointerEventData__InputButton get_button() ;

/// @brief Method set_button addr 0x2d95868 size 0x8 virtual false final false
inline void set_button(::UnityEngine::EventSystems::__PointerEventData__InputButton  value) ;

/// @brief Method get_pressure addr 0x2d95870 size 0x8 virtual false final false
inline float_t get_pressure() ;

/// @brief Method set_pressure addr 0x2d95878 size 0x8 virtual false final false
inline void set_pressure(float_t  value) ;

/// @brief Method get_tangentialPressure addr 0x2d95880 size 0x8 virtual false final false
inline float_t get_tangentialPressure() ;

/// @brief Method set_tangentialPressure addr 0x2d95888 size 0x8 virtual false final false
inline void set_tangentialPressure(float_t  value) ;

/// @brief Method get_altitudeAngle addr 0x2d95890 size 0x8 virtual false final false
inline float_t get_altitudeAngle() ;

/// @brief Method set_altitudeAngle addr 0x2d95898 size 0x8 virtual false final false
inline void set_altitudeAngle(float_t  value) ;

/// @brief Method get_azimuthAngle addr 0x2d958a0 size 0x8 virtual false final false
inline float_t get_azimuthAngle() ;

/// @brief Method set_azimuthAngle addr 0x2d958a8 size 0x8 virtual false final false
inline void set_azimuthAngle(float_t  value) ;

/// @brief Method get_twist addr 0x2d958b0 size 0x8 virtual false final false
inline float_t get_twist() ;

/// @brief Method set_twist addr 0x2d958b8 size 0x8 virtual false final false
inline void set_twist(float_t  value) ;

/// @brief Method get_radius addr 0x2d958c0 size 0xc virtual false final false
inline ::UnityEngine::Vector2 get_radius() ;

/// @brief Method set_radius addr 0x2d958cc size 0xc virtual false final false
inline void set_radius(::UnityEngine::Vector2  value) ;

/// @brief Method get_radiusVariance addr 0x2d958d8 size 0xc virtual false final false
inline ::UnityEngine::Vector2 get_radiusVariance() ;

/// @brief Method set_radiusVariance addr 0x2d958e4 size 0xc virtual false final false
inline void set_radiusVariance(::UnityEngine::Vector2  value) ;

/// @brief Method get_fullyExited addr 0x2d958f0 size 0x8 virtual false final false
inline bool get_fullyExited() ;

/// @brief Method set_fullyExited addr 0x2d958f8 size 0xc virtual false final false
inline void set_fullyExited(bool  value) ;

/// @brief Method get_reentered addr 0x2d95904 size 0x8 virtual false final false
inline bool get_reentered() ;

/// @brief Method set_reentered addr 0x2d9590c size 0xc virtual false final false
...
/// @brief Method .ctor addr 0x2d95918 size 0x12c virtual false final false
inline void _ctor(::UnityEngine::EventSystems::EventSystem*  eventSystem) ;

/// @brief Method IsPointerMoving addr 0x2d95a44 size 0x1c virtual false final false
inline bool IsPointerMoving() ;

/// @brief Method IsScrolling addr 0x2d95a60 size 0x20 virtual false final false
inline bool IsScrolling() ;

/// @brief Method get_enterEventCamera addr 0x2d95a80 size 0x90 virtual false final false
inline ::UnityEngine::Camera* get_enterEventCamera() ;

/// @brief Method get_pressEventCamera addr 0x2d95b10 size 0x90 virtual false final false
inline ::UnityEngine::Camera* get_pressEventCamera() ;

/// @brief Method get_pointerPress addr 0x2d95ba0 size 0x8 virtual false final false
inline ::UnityEngine::GameObject* get_pointerPress() ;

/// @brief Method set_pointerPress addr 0x2d95ba8 size 0x7c virtual false final false
inline void set_pointerPress(::UnityEngine::GameObject*  value) ;

/// @brief Method ToString addr 0x2d95c24 size 0x5e0 virtual true final false
