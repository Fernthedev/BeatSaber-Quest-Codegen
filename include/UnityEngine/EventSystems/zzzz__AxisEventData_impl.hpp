...
::cordl_internals::setInstanceField<::UnityEngine::EventSystems::MoveDirection, 0x28>(this, std::forward<::UnityEngine::EventSystems::MoveDirection>(value));
}
constexpr ::UnityEngine::EventSystems::MoveDirection& UnityEngine::EventSystems::AxisEventData::__get__moveDir_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::EventSystems::MoveDirection, 0x28>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::UnityEngine::EventSystems::AxisEventData*>(eventSystem));
}
