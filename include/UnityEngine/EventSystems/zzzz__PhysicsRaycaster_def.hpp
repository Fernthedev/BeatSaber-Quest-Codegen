...
// Ctor Parameters []
// @brief default ctor
 __PhysicsRaycaster__RaycastHitComparer()  = default;
public:
...
/// @brief Field m_Hits offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Camera*> __get_m_EventCamera() const;
