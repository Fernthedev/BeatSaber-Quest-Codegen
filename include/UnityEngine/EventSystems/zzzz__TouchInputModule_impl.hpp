...
::cordl_internals::setInstanceField<::UnityEngine::EventSystems::PointerEventData*, 0x70>(this, std::forward<::UnityEngine::EventSystems::PointerEventData*>(value));
}
constexpr ::UnityEngine::EventSystems::PointerEventData* UnityEngine::EventSystems::TouchInputModule::__get_m_InputPointerEvent()  {
return ::cordl_internals::getInstanceField<::UnityEngine::EventSystems::PointerEventData*, 0x70>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::EventSystems::PointerEventData*> UnityEngine::EventSystems::TouchInputModule::__get_m_InputPointerEvent() const {
return ::cordl_internals::getInstanceField<::UnityEngine::EventSystems::PointerEventData*, 0x70>(this);
}
