...
namespace UnityEngine::AddressableAssets {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14082), inst: 778 }), TypeDefinitionIndex(TypeDefinitionIndex(14082)), TypeDefinitionIndex(TypeDefinitionIndex(10075))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityEngine::Texture3D*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 AssetReferenceTexture3D()  = default;
public:
