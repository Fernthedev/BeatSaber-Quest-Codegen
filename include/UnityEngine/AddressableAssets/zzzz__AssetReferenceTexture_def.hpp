...
namespace UnityEngine::AddressableAssets {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14082), inst: 402 }), TypeDefinitionIndex(TypeDefinitionIndex(10071)), TypeDefinitionIndex(TypeDefinitionIndex(14082))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::UnityEngine::AddressableAssets::AssetReferenceT_1<::UnityEngine::Texture*>)]{};

static inline ::UnityEngine::AddressableAssets::AssetReferenceTexture* New_ctor(::StringW  guid) ;

/// @brief Method .ctor addr 0x2a23b1c size 0x58 virtual false final false
