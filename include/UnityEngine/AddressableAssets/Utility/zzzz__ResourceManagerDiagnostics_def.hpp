...
/// @brief Field k_NumberOfCompletedOpResultEntriesToShow offset 0x0
static constexpr int32_t  k_NumberOfCompletedOpResultEntriesToShow{static_cast<int32_t>(0x4)};

/// @brief Field k_MaximumCompletedOpResultEntryLength offset 0x0
...
/// @brief Field m_cachedDiagnosticInfo offset 0x18
 __declspec(property(get=__get_m_cachedDiagnosticInfo, put=__set_m_cachedDiagnosticInfo)) ::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::AddressableAssets::Utility::DiagnosticInfo*>*  m_cachedDiagnosticInfo;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::UnityEngine::AddressableAssets::Utility::DiagnosticInfo*>*> __get_m_cachedDiagnosticInfo() const;
...
// Ctor Parameters []
// @brief default ctor
 ResourceManagerDiagnostics()  = default;
public:
