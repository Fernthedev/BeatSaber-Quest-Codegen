...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x98 - sizeof(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<bool>)]{};
...
/// @brief Field m_UpdateRequired offset 0x90
...
// Ctor Parameters []
// @brief default ctor
 __CacheInitialization__CacheInitOp()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AddressableAssets::Initialization::CacheInitialization*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __CacheInitialization____c__DisplayClass1_0()  = default;
public:
