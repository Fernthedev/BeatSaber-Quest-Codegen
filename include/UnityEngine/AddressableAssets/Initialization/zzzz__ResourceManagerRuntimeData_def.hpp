...
/// @brief Field kCatalogAddress offset 0x0
static constexpr ::ConstString  kCatalogAddress{u"AddressablesMainContentCatalog"};

/// @brief Field m_buildTarget offset 0x10
 __declspec(property(get=__get_m_buildTarget, put=__set_m_buildTarget)) ::StringW  m_buildTarget;

/// @brief Field m_SettingsHash offset 0x18
 __declspec(property(get=__get_m_SettingsHash, put=__set_m_SettingsHash)) ::StringW  m_SettingsHash;

/// @brief Field m_CatalogLocations offset 0x20
 __declspec(property(get=__get_m_CatalogLocations, put=__set_m_CatalogLocations)) ::System::Collections::Generic::List_1<::UnityEngine::AddressableAssets::ResourceLocators::ResourceLocationData*>*  m_CatalogLocations;

/// @brief Field m_ProfileEvents offset 0x28
 __declspec(property(get=__get_m_ProfileEvents, put=__set_m_ProfileEvents)) bool  m_ProfileEvents;

/// @brief Field m_LogResourceManagerExceptions offset 0x29
...
/// @brief Field m_ExtraInitializationData offset 0x30
 __declspec(property(get=__get_m_ExtraInitializationData, put=__set_m_ExtraInitializationData)) ::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::ObjectInitializationData>*  m_ExtraInitializationData;

/// @brief Field m_DisableCatalogUpdateOnStart offset 0x38
...
/// @brief Field m_CatalogRequestsTimeout offset 0x6c
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::AddressableAssets::ResourceLocators::ResourceLocationData*>*> __get_m_CatalogLocations() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::Util::ObjectInitializationData>*> __get_m_ExtraInitializationData() const;
...
// Ctor Parameters []
// @brief default ctor
 ResourceManagerRuntimeData()  = default;
public:
