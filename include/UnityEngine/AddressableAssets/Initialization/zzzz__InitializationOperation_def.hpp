...
/// @brief Method .ctor addr 0x2a33a18 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <Execute>b__13_0 addr 0x2a33a20 size 0x9c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __InitializationOperation____c()  = default;
public:
...
/// @brief Field addressables offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AddressableAssets::AddressablesImpl*> __get_addressables() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*> __get_remoteHashLocation() const;

static inline ::UnityEngine::AddressableAssets::Initialization::__InitializationOperation____c__DisplayClass16_0* New_ctor() ;

/// @brief Method .ctor addr 0x2a33abc size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <LoadContentCatalog>b__0 addr 0x2a33ac4 size 0x44 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __InitializationOperation____c__DisplayClass16_0()  = default;
public:
...
/// @brief Field locMap offset 0x20
...
/// @brief Field index offset 0x28
 __declspec(property(get=__get_index, put=__set_index)) int32_t  index;

/// @brief Field remoteHashLocation offset 0x30
 __declspec(property(get=__get_remoteHashLocation, put=__set_remoteHashLocation)) ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  remoteHashLocation;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AddressableAssets::Initialization::InitializationOperation*> __get___4__this() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*>*> __get_catalogs() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AddressableAssets::ResourceLocators::ResourceLocationMap*> __get_locMap() const;
...
/// @brief Method .ctor addr 0x2a33b08 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <LoadContentCatalogInternal>b__0 addr 0x2a33b10 size 0x4c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __InitializationOperation____c__DisplayClass18_0()  = default;
public:
...
namespace UnityEngine::AddressableAssets::Initialization {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14112)), TypeDefinitionIndex(TypeDefinitionIndex(14032)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14032), inst: 796 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xe8 - sizeof(::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationBase_1<::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator*>)]{};

/// @brief Field m_rtdOp offset 0x88
 __declspec(property(get=__get_m_rtdOp, put=__set_m_rtdOp)) ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::AddressableAssets::Initialization::ResourceManagerRuntimeData*>  m_rtdOp;

/// @brief Field m_loadCatalogOp offset 0xa8
 __declspec(property(get=__get_m_loadCatalogOp, put=__set_m_loadCatalogOp)) ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator*>  m_loadCatalogOp;

/// @brief Field m_ProviderSuffix offset 0xc8
 __declspec(property(get=__get_m_ProviderSuffix, put=__set_m_ProviderSuffix)) ::StringW  m_ProviderSuffix;

/// @brief Field m_Addressables offset 0xd0
...
/// @brief Field m_Diagnostics offset 0xd8
...
/// @brief Field m_InitGroupOps offset 0xe0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AddressableAssets::Utility::ResourceManagerDiagnostics*> __get_m_Diagnostics() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ResourceManagement::AsyncOperations::InitalizationObjectsOperation*> __get_m_InitGroupOps() const;
...
/// @brief Method .ctor addr 0x2a309c4 size 0xa4 virtual false final false
inline void _ctor(::UnityEngine::AddressableAssets::AddressablesImpl*  aa) ;

/// @brief Method get_Progress addr 0x2a30a68 size 0x80 virtual true final false
inline float_t get_Progress() ;

/// @brief Method get_DebugName addr 0x2a30ae8 size 0x40 virtual true final false
inline ::StringW get_DebugName() ;

/// @brief Method CreateInitializationOperation addr 0x2a1d434 size 0x588 virtual false final false
...
/// @brief Method InvokeWaitForCompletion addr 0x2a30b28 size 0x1c4 virtual true final false
inline bool InvokeWaitForCompletion() ;

/// @brief Method Execute addr 0x2a30cec size 0xd10 virtual true final false
inline void Execute() ;

/// @brief Method LoadProvider addr 0x2a31bf0 size 0x490 virtual false final false
...
/// @brief Method OnCatalogDataLoaded addr 0x2a32080 size 0x5a0 virtual false final false
...
/// @brief Method LoadContentCatalog addr 0x2a1df08 size 0x6a4 virtual false final false
...
/// @brief Method LoadContentCatalog addr 0x2a32620 size 0x2c virtual false final false
inline ::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle_1<::UnityEngine::AddressableAssets::ResourceLocators::IResourceLocator*> LoadContentCatalog(::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  loc, ::StringW  providerSuffix, ::UnityEngine::ResourceManagement::ResourceLocations::IResourceLocation*  remoteHashLocation) ;

/// @brief Method LoadContentCatalogInternal addr 0x2a319fc size 0x1f4 virtual false final false
...
/// @brief Method LoadOpComplete addr 0x2a3264c size 0x1368 virtual false final false
