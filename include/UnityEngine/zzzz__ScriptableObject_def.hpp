...
/// @brief Method .ctor addr 0x2cd1874 size 0x80 virtual false final false
inline void _ctor() ;

/// @brief Method CreateInstance addr 0x2cd1930 size 0x40 virtual false final false
...
/// @brief Method CreateScriptableObject addr 0x2cd18f4 size 0x3c virtual false final false
static inline void CreateScriptableObject(::UnityEngine::ScriptableObject*  self) ;

/// @brief Method CreateScriptableObjectInstanceFromType addr 0x2cd1970 size 0x44 virtual false final false
