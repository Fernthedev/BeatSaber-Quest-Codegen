...
::cordl_internals::setInstanceField<::UnityEngine::Scripting::APIUpdating::MovedFromAttributeData, 0x10>(this, std::forward<::UnityEngine::Scripting::APIUpdating::MovedFromAttributeData>(value));
}
...
return ::cordl_internals::getInstanceField<::UnityEngine::Scripting::APIUpdating::MovedFromAttributeData, 0x10>(this);
}
