...
struct CORDL_TYPE Cache : public ::bs_hook::ValueTypeWrapper<0x4> {
public:
// Declarations
...
constexpr explicit Cache(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x4>(instance) {
}
