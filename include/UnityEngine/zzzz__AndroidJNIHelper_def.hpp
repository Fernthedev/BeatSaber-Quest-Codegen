...
static inline ::cordl_internals::intptr_t GetConstructorID(::cordl_internals::intptr_t  javaClass) ;

/// @brief Method GetConstructorID addr 0x2c8a34c size 0x4 virtual false final false
static inline ::cordl_internals::intptr_t GetConstructorID(::cordl_internals::intptr_t  javaClass, ::StringW  signature) ;

/// @brief Method GetMethodID addr 0x2c8bb10 size 0x5c virtual false final false
static inline ::cordl_internals::intptr_t GetMethodID(::cordl_internals::intptr_t  javaClass, ::StringW  methodName) ;

/// @brief Method GetMethodID addr 0x2c8bb6c size 0x8 virtual false final false
static inline ::cordl_internals::intptr_t GetMethodID(::cordl_internals::intptr_t  javaClass, ::StringW  methodName, ::StringW  signature) ;

/// @brief Method GetMethodID addr 0x2c86604 size 0x8 virtual false final false
static inline ::cordl_internals::intptr_t GetMethodID(::cordl_internals::intptr_t  javaClass, ::StringW  methodName, ::StringW  signature, bool  isStatic) ;

/// @brief Method GetFieldID addr 0x2c8bb74 size 0x5c virtual false final false
static inline ::cordl_internals::intptr_t GetFieldID(::cordl_internals::intptr_t  javaClass, ::StringW  fieldName) ;

/// @brief Method GetFieldID addr 0x2c8bbd8 size 0x8 virtual false final false
static inline ::cordl_internals::intptr_t GetFieldID(::cordl_internals::intptr_t  javaClass, ::StringW  fieldName, ::StringW  signature) ;

/// @brief Method GetFieldID addr 0x2c8bbd0 size 0x8 virtual false final false
static inline ::cordl_internals::intptr_t GetFieldID(::cordl_internals::intptr_t  javaClass, ::StringW  fieldName, ::StringW  signature, bool  isStatic) ;
...
static inline ::cordl_internals::intptr_t CreateJavaProxy(::UnityEngine::AndroidJavaProxy*  proxy) ;
