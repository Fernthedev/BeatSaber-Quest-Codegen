...
struct CORDL_TYPE TileData : public ::bs_hook::ValueTypeWrapper<0x60> {
public:
// Declarations
...
constexpr explicit TileData(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x60>(instance) {
}
