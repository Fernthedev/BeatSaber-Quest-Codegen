...
::cordl_internals::setInstanceField<::UnityEngine::Android::AndroidAssetPackError, 0x34>(this, std::forward<::UnityEngine::Android::AndroidAssetPackError>(value));
}
...
return ::cordl_internals::getInstanceField<::UnityEngine::Android::AndroidAssetPackError, 0x34>(this);
}
