...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::Rendering::LocalKeywordSpace::*)(::System::Object*)>(&::UnityEngine::Rendering::LocalKeywordSpace::Equals)> {
...
constexpr ::cordl_internals::intptr_t& UnityEngine::Rendering::LocalKeywordSpace::__get_m_KeywordSpace()  {
...
constexpr ::cordl_internals::intptr_t const& UnityEngine::Rendering::LocalKeywordSpace::__get_m_KeywordSpace() const {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Rendering::LocalKeywordSpace::LocalKeywordSpace(::cordl_internals::intptr_t  m_KeywordSpace) noexcept : ::bs_hook::ValueTypeWrapper<0x8>() {this->m_KeywordSpace = m_KeywordSpace;
}
