...
struct CORDL_TYPE LocalKeyword : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x18};

/// @brief Field m_SpaceInfo offset 0x0
 __declspec(property(get=__get_m_SpaceInfo, put=__set_m_SpaceInfo)) ::UnityEngine::Rendering::LocalKeywordSpace  m_SpaceInfo;
...
constexpr ::UnityEngine::Rendering::LocalKeywordSpace& __get_m_SpaceInfo() ;

constexpr ::UnityEngine::Rendering::LocalKeywordSpace const& __get_m_SpaceInfo() const;
...
constexpr explicit LocalKeyword(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}
