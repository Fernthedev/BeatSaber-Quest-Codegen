...
/// @brief Field <IntermediateScriptingStructName>k__BackingField offset 0x18
 __declspec(property(get=__get__IntermediateScriptingStructName_k__BackingField, put=__set__IntermediateScriptingStructName_k__BackingField)) ::StringW  _IntermediateScriptingStructName_k__BackingField;

/// @brief Field <CodegenOptions>k__BackingField offset 0x20
