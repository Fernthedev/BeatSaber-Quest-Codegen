...
::cordl_internals::setInstanceField<::UnityEngine::Bindings::StaticAccessorType, 0x18>(this, std::forward<::UnityEngine::Bindings::StaticAccessorType>(value));
}
...
return ::cordl_internals::getInstanceField<::UnityEngine::Bindings::StaticAccessorType, 0x18>(this);
}
