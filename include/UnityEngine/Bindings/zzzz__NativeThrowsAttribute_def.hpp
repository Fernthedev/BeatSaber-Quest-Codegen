...
/// @brief Field <ThrowsException>k__BackingField offset 0x10
...
/// @brief Method set_ThrowsException addr 0x2d189a4 size 0xc virtual true final true
inline void set_ThrowsException(bool  value) ;

static inline ::UnityEngine::Bindings::NativeThrowsAttribute* New_ctor() ;

/// @brief Method .ctor addr 0x2d189b0 size 0x20 virtual false final false
inline void _ctor() ;
