...
constexpr ::Unity::Collections::NativeArray_1<uint8_t>& UnityEngine::Profiling::Experimental::DebugScreenCapture::__get__rawImageDataReference_k__BackingField()  {
...
constexpr ::Unity::Collections::NativeArray_1<uint8_t> const& UnityEngine::Profiling::Experimental::DebugScreenCapture::__get__rawImageDataReference_k__BackingField() const {
return ::cordl_internals::getInstanceField<::Unity::Collections::NativeArray_1<uint8_t>, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
::cordl_internals::setInstanceField<::UnityEngine::TextureFormat, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::UnityEngine::TextureFormat>(value));
}
constexpr ::UnityEngine::TextureFormat& UnityEngine::Profiling::Experimental::DebugScreenCapture::__get__imageFormat_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::TextureFormat, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::UnityEngine::TextureFormat const& UnityEngine::Profiling::Experimental::DebugScreenCapture::__get__imageFormat_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::TextureFormat, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& UnityEngine::Profiling::Experimental::DebugScreenCapture::__get__width_k__BackingField()  {
return ::cordl_internals::getInstanceField<int32_t, 0x14>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::Profiling::Experimental::DebugScreenCapture::__get__width_k__BackingField() const {
return ::cordl_internals::getInstanceField<int32_t, 0x14>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& UnityEngine::Profiling::Experimental::DebugScreenCapture::__get__height_k__BackingField()  {
return ::cordl_internals::getInstanceField<int32_t, 0x18>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::Profiling::Experimental::DebugScreenCapture::__get__height_k__BackingField() const {
return ::cordl_internals::getInstanceField<int32_t, 0x18>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
