...
/// @brief Method GetGraphicsFormat addr 0x2cf3b14 size 0x84 virtual false final false
...
/// @brief Method GetGraphicsFormat_Native_TextureFormat addr 0x2cf3b98 size 0x44 virtual false final false
...
/// @brief Method GetGraphicsFormat addr 0x2cf3bdc size 0x84 virtual false final false
...
/// @brief Method GetGraphicsFormat_Native_RenderTextureFormat addr 0x2cf3c60 size 0x44 virtual false final false
...
/// @brief Method GetGraphicsFormat addr 0x2cf3ca4 size 0x88 virtual false final false
...
/// @brief Method GetDepthStencilFormatFromBitsLegacy_Native addr 0x2cf3d2c size 0x3c virtual false final false
...
/// @brief Method GetDepthStencilFormat addr 0x2cf3d68 size 0x74 virtual false final false
static inline ::UnityEngine::Experimental::Rendering::GraphicsFormat GetDepthStencilFormat(int32_t  minimumDepthBits) ;

/// @brief Method GetDepthBits addr 0x2cf3ddc size 0x3c virtual false final false
static inline int32_t GetDepthBits(::UnityEngine::Experimental::Rendering::GraphicsFormat  format) ;

/// @brief Method GetDepthStencilFormat addr 0x2cf3e18 size 0x1f4 virtual false final false
...
/// @brief Method IsSRGBFormat addr 0x2cf400c size 0x3c virtual false final false
static inline bool IsSRGBFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat  format) ;

/// @brief Method GetRenderTextureFormat addr 0x2cf4048 size 0x3c virtual false final false
...
/// @brief Method IsCompressedTextureFormat addr 0x2cf4084 size 0x3c virtual false final false
static inline bool IsCompressedTextureFormat(::UnityEngine::TextureFormat  format) ;

/// @brief Method CanDecompressFormat addr 0x2cf40c0 size 0x44 virtual false final false
static inline bool CanDecompressFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat  format, bool  wholeImage) ;

/// @brief Method CanDecompressFormat addr 0x2cf4104 size 0x78 virtual false final false
static inline bool CanDecompressFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat  format) ;

/// @brief Method IsDepthFormat addr 0x2cf417c size 0x3c virtual false final false
static inline bool IsDepthFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat  format) ;

/// @brief Method IsStencilFormat addr 0x2cf41b8 size 0x3c virtual false final false
static inline bool IsStencilFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat  format) ;

/// @brief Method IsPVRTCFormat addr 0x2cf41f4 size 0x3c virtual false final false
static inline bool IsPVRTCFormat(::UnityEngine::Experimental::Rendering::GraphicsFormat  format) ;

/// @brief Method IsCrunchFormat addr 0x2cf4230 size 0x24 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 GraphicsFormatUtility()  = default;
public:


// Fields

// Static field tableNoStencil

// Static field tableStencil
