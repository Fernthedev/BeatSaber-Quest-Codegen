...
/// @brief Method TickRealtimeProbes addr 0x2cf4670 size 0x28 virtual true final true
inline bool TickRealtimeProbes() ;

/// @brief Method Dispose addr 0x2cf46c0 size 0x4 virtual true final true
inline void Dispose() ;

/// @brief Method Dispose addr 0x2cf46c4 size 0x4 virtual false final false
inline void Dispose(bool  disposing) ;

/// @brief Method BuiltinUpdate addr 0x2cf4698 size 0x28 virtual false final false
static inline bool BuiltinUpdate() ;

/// @brief Method Internal_BuiltinRuntimeReflectionSystem_New addr 0x2cf46c8 size 0x5c virtual false final false
...
/// @brief Method .ctor addr 0x2cf4724 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 BuiltinRuntimeReflectionSystem()  = default;
public:
