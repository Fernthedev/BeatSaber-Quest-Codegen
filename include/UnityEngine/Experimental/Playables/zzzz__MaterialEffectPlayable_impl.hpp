...
constexpr ::UnityEngine::Playables::PlayableHandle& UnityEngine::Experimental::Playables::MaterialEffectPlayable::__get_m_Handle()  {
...
constexpr ::UnityEngine::Playables::PlayableHandle const& UnityEngine::Experimental::Playables::MaterialEffectPlayable::__get_m_Handle() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Playables::PlayableHandle, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Experimental::Playables::MaterialEffectPlayable::MaterialEffectPlayable(::UnityEngine::Playables::PlayableHandle  m_Handle) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->m_Handle = m_Handle;
}
