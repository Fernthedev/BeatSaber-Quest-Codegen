...
constexpr ::UnityEngine::Playables::PlayableOutputHandle& UnityEngine::Experimental::Playables::TexturePlayableOutput::__get_m_Handle()  {
...
constexpr ::UnityEngine::Playables::PlayableOutputHandle const& UnityEngine::Experimental::Playables::TexturePlayableOutput::__get_m_Handle() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Playables::PlayableOutputHandle, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Experimental::Playables::TexturePlayableOutput::TexturePlayableOutput(::UnityEngine::Playables::PlayableOutputHandle  m_Handle) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->m_Handle = m_Handle;
}
