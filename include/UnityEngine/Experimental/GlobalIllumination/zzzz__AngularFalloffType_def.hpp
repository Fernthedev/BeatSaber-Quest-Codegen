...
struct CORDL_TYPE AngularFalloffType : public ::bs_hook::EnumTypeWrapper<0x1> {
public:
// Declarations
...
return std::bit_cast<__AngularFalloffType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x1>::instance);
}
...
constexpr explicit AngularFalloffType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x1>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 AngularFalloffType()  = default;
