...
namespace UnityEngine {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10317))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::Scripting::PreserveAttribute)]{};

/// @brief Field m_LoadType offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 RuntimeInitializeOnLoadMethodAttribute()  = default;
public:
