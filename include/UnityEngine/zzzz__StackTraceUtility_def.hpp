...
/// @brief Method SetProjectFolder addr 0x2cd19b4 size 0xdc virtual false final false
static inline void SetProjectFolder(::StringW  folder) ;

/// @brief Method ExtractStackTrace addr 0x2cd1a90 size 0x164 virtual false final false
static inline ::StringW ExtractStackTrace() ;

/// @brief Method ExtractStringFromExceptionInternal addr 0x2cd229c size 0x368 virtual false final false
...
/// @brief Method ExtractFormattedStackTrace addr 0x2cd1bf4 size 0x6a8 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 StackTraceUtility()  = default;
public:


// Fields

// Static field projectFolder
