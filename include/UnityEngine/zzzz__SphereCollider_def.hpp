...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::Collider)]{};

 __declspec(property(get=get_center, put=set_center)) ::UnityEngine::Vector3  center;

 __declspec(property(get=get_radius, put=set_radius)) float_t  radius;

/// @brief Method get_center addr 0x2d171c4 size 0x5c virtual false final false
inline ::UnityEngine::Vector3 get_center() ;

/// @brief Method set_center addr 0x2d17264 size 0x54 virtual false final false
inline void set_center(::UnityEngine::Vector3  value) ;

/// @brief Method get_radius addr 0x2d172fc size 0x3c virtual false final false
inline float_t get_radius() ;

/// @brief Method set_radius addr 0x2d17338 size 0x4c virtual false final false
inline void set_radius(float_t  value) ;

static inline ::UnityEngine::SphereCollider* New_ctor() ;

/// @brief Method .ctor addr 0x2d17384 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method get_center_Injected addr 0x2d17220 size 0x44 virtual false final false
inline void get_center_Injected(ByRef<::UnityEngine::Vector3>  ret) ;

/// @brief Method set_center_Injected addr 0x2d172b8 size 0x44 virtual false final false
