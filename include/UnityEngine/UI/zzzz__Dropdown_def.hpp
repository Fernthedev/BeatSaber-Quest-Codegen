...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_Text() const;
...
// Ctor Parameters []
// @brief default ctor
 __Dropdown__DropdownItem()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __Dropdown__OptionData()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UI::__Dropdown__OptionData*>*> __get_m_Options() const;
...
// Ctor Parameters []
// @brief default ctor
 __Dropdown__OptionDataList()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __Dropdown__DropdownEvent()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::__Dropdown__DropdownItem*> __get_item() const;

constexpr void __set___4__this(::UnityEngine::UI::Dropdown*  value) ;

constexpr ::UnityEngine::UI::Dropdown* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Dropdown*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __Dropdown____c__DisplayClass63_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __Dropdown___DelayedDestroyDropdownList_d__75()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x168 - sizeof(::UnityEngine::UI::Selectable)]{};

/// @brief Field kHighSortingLayer offset 0x0
...
/// @brief Field m_AlphaTweenRunner offset 0x158
 __declspec(property(get=__get_m_AlphaTweenRunner, put=__set_m_AlphaTweenRunner)) ::UnityEngine::UI::CoroutineTween::TweenRunner_1<::UnityEngine::UI::CoroutineTween::FloatTween>*  m_AlphaTweenRunner;

/// @brief Field validTemplate offset 0x160
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_CaptionText() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_ItemText() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::__Dropdown__OptionDataList*> __get_m_Options() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::__Dropdown__DropdownEvent*> __get_m_OnValueChanged() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UI::__Dropdown__DropdownItem*>*> __get_m_Items() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::CoroutineTween::TweenRunner_1<::UnityEngine::UI::CoroutineTween::FloatTween>*> __get_m_AlphaTweenRunner() const;
...
inline ::UnityEngine::UI::__Dropdown__DropdownItem* AddItem(::UnityEngine::UI::__Dropdown__OptionData*  data, bool  selected, ::UnityEngine::UI::__Dropdown__DropdownItem*  itemTemplate, ::System::Collections::Generic::List_1<::UnityEngine::UI::__Dropdown__DropdownItem*>*  items) ;
