...
// Ctor Parameters []
// @brief default ctor
 __MaskableGraphic__CullStateChangedEvent()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xd0 - sizeof(::UnityEngine::UI::Graphic)]{};

/// @brief Field m_ShouldRecalculateStencil offset 0x99
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::RectMask2D*> __get_m_ParentMask() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::__MaskableGraphic__CullStateChangedEvent*> __get_m_OnCullStateChanged() const;
