...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xe8 - sizeof(::UnityEngine::UI::MaskableGraphic)]{};

/// @brief Field m_Texture offset 0xd0
 __declspec(property(get=__get_m_Texture, put=__set_m_Texture)) ::UnityEngine::Texture*  m_Texture;

/// @brief Field m_UVRect offset 0xd8
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Texture*> __get_m_Texture() const;
