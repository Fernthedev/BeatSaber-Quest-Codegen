...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13149)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13149), inst: 2 })
// CS Name: ::UnityEngine.UI.Collections::IndexedSet`1<T>*
class CORDL_TYPE IndexedSet_1<T> : public ::System::Object {
public:
// Declarations
...
/// @brief Field m_Dictionary offset 0x18
...
/// @brief Field m_EnabledObjectCount offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<T,int32_t>*> __get_m_Dictionary() const;
