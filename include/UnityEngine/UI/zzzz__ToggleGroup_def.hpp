...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::UnityEngine::EventSystems::UIBehaviour)]{};

/// @brief Field m_AllowSwitchOff offset 0x18
 __declspec(property(get=__get_m_AllowSwitchOff, put=__set_m_AllowSwitchOff)) bool  m_AllowSwitchOff;

/// @brief Field m_Toggles offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UI::Toggle*>*> __get_m_Toggles() const;
