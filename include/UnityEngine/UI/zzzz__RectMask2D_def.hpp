...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x88 - sizeof(::UnityEngine::EventSystems::UIBehaviour)]{};

/// @brief Field m_VertexClipper offset 0x18
...
/// @brief Field m_ClipTargets offset 0x30
...
/// @brief Field m_ShouldRecalculateClipRects offset 0x38
...
/// @brief Field m_Clippers offset 0x40
...
/// @brief Field m_LastClipRectCanvasSpace offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::RectangularVertexClipper*> __get_m_VertexClipper() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::UnityEngine::UI::MaskableGraphic*>*> __get_m_MaskableTargets() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::UnityEngine::UI::IClippable*>*> __get_m_ClipTargets() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UI::RectMask2D*>*> __get_m_Clippers() const;
...
/// @brief Method get_padding addr 0x2d7f8ac size 0xc virtual false final false
inline ::UnityEngine::Vector4 get_padding() ;

/// @brief Method set_padding addr 0x2d7f8b8 size 0x10 virtual false final false
inline void set_padding(::UnityEngine::Vector4  value) ;

/// @brief Method get_softness addr 0x2d7f8c8 size 0x8 virtual false final false
inline ::UnityEngine::Vector2Int get_softness() ;

/// @brief Method set_softness addr 0x2d7f8d0 size 0x1c virtual false final false
inline void set_softness(::UnityEngine::Vector2Int  value) ;

/// @brief Method get_Canvas addr 0x2d7f8ec size 0x160 virtual false final false
inline ::UnityEngine::Canvas* get_Canvas() ;

/// @brief Method get_canvasRect addr 0x2d7fa4c size 0x44 virtual false final false
inline ::UnityEngine::Rect get_canvasRect() ;

/// @brief Method get_rectTransform addr 0x2d7fa90 size 0x58 virtual false final false
inline ::UnityEngine::RectTransform* get_rectTransform() ;

static inline ::UnityEngine::UI::RectMask2D* New_ctor() ;

/// @brief Method .ctor addr 0x2d7fae8 size 0x158 virtual false final false
inline void _ctor() ;

/// @brief Method OnEnable addr 0x2d7fc40 size 0x34 virtual true final false
inline void OnEnable() ;

/// @brief Method OnDisable addr 0x2d7fc74 size 0xd0 virtual true final false
inline void OnDisable() ;

/// @brief Method OnDestroy addr 0x2d7fd44 size 0x20 virtual true final false
inline void OnDestroy() ;

/// @brief Method IsRaycastLocationValid addr 0x2d7fd64 size 0xdc virtual true final false
inline bool IsRaycastLocationValid(::UnityEngine::Vector2  sp, ::UnityEngine::Camera*  eventCamera) ;

/// @brief Method get_rootCanvasRect addr 0x2d7fe40 size 0x11c virtual false final false
inline ::UnityEngine::Rect get_rootCanvasRect() ;

/// @brief Method PerformClipping addr 0x2d7ff5c size 0x724 virtual true final false
inline void PerformClipping() ;

/// @brief Method UpdateClipSoftness addr 0x2d80680 size 0x2f4 virtual true final false
inline void UpdateClipSoftness() ;

/// @brief Method AddClippable addr 0x2d80974 size 0x114 virtual false final false
inline void AddClippable(::UnityEngine::UI::IClippable*  clippable) ;

/// @brief Method RemoveClippable addr 0x2d80a88 size 0x1a0 virtual false final false
inline void RemoveClippable(::UnityEngine::UI::IClippable*  clippable) ;

/// @brief Method OnTransformParentChanged addr 0x2d80c28 size 0x24 virtual true final false
inline void OnTransformParentChanged() ;

/// @brief Method OnCanvasHierarchyChanged addr 0x2d80c4c size 0x24 virtual true final false
