...
struct CORDL_TYPE __InputField__ContentType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____InputField__ContentType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __InputField__ContentType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputField__ContentType()  = default;
...
struct CORDL_TYPE __InputField__InputType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____InputField__InputType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputField__InputType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputField__InputType()  = default;
...
struct CORDL_TYPE __InputField__CharacterValidation : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____InputField__CharacterValidation_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputField__CharacterValidation(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputField__CharacterValidation()  = default;
...
struct CORDL_TYPE __InputField__LineType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____InputField__LineType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputField__LineType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputField__LineType()  = default;
...
static inline ::UnityEngine::UI::__InputField__OnValidateInput* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __InputField__OnValidateInput()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __InputField__SubmitEvent()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __InputField__EndEditEvent()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __InputField__OnChangeEvent()  = default;
public:
...
struct CORDL_TYPE __InputField__EditState : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____InputField__EditState_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InputField__EditState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InputField__EditState()  = default;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::InputField*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __InputField___CaretBlink_d__172()  = default;
public:
...
/// @brief Field eventData offset 0x20
...
// Ctor Parameters []
// @brief default ctor
 __InputField___MouseDragOutsideRect_d__194()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x218 - sizeof(::UnityEngine::UI::Selectable)]{};
...
/// @brief Field m_OnValueChanged offset 0x140
...
/// @brief Field m_OnValidateInput offset 0x148
...
/// @brief Field m_UpdateDrag offset 0x1ca
 __declspec(property(get=__get_m_UpdateDrag, put=__set_m_UpdateDrag)) bool  m_UpdateDrag;

/// @brief Field m_DragPositionOutOfBounds offset 0x1cb
...
/// @brief Field m_TouchKeyboardAllowsInPlaceEditing offset 0x208
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TouchScreenKeyboard*> __get_m_Keyboard() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_m_TextComponent() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::__InputField__SubmitEvent*> __get_m_OnSubmit() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::__InputField__EndEditEvent*> __get_m_OnDidEndEdit() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::__InputField__OnChangeEvent*> __get_m_OnValueChanged() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::__InputField__OnValidateInput*> __get_m_OnValidateInput() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TextGenerator*> __get_m_InputTextCache() const;
...
// Static field s_IsQuestDeviceEvaluated

// Static field s_IsQuestDevice
