...
/// @brief Field compareFunction offset 0x2c
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get_baseMat() const;

constexpr void __set_customMat(::UnityEngine::Material*  value) ;

constexpr ::UnityEngine::Material* __get_customMat() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get_customMat() const;
...
// Ctor Parameters []
// @brief default ctor
 __StencilMaterial__MatEntry()  = default;
public:
...
static inline ::UnityEngine::Material* Add(::UnityEngine::Material*  baseMat, int32_t  stencilID, ::UnityEngine::Rendering::StencilOp  operation, ::UnityEngine::Rendering::CompareFunction  compareFunction, ::UnityEngine::Rendering::ColorWriteMask  colorWriteMask) ;
...
static inline ::UnityEngine::Material* Add(::UnityEngine::Material*  baseMat, int32_t  stencilID, ::UnityEngine::Rendering::StencilOp  operation, ::UnityEngine::Rendering::CompareFunction  compareFunction, ::UnityEngine::Rendering::ColorWriteMask  colorWriteMask, int32_t  readMask, int32_t  writeMask) ;
