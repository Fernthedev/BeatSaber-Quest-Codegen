...
::cordl_internals::setInstanceField<::UnityEngine::Vector2, 0x30>(this, std::forward<::UnityEngine::Vector2>(value));
}
constexpr ::UnityEngine::Vector2& UnityEngine::UI::Shadow::__get_m_EffectDistance()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0x30>(this);
}
