...
struct CORDL_TYPE __Navigation__Mode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____Navigation__Mode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __Navigation__Mode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Navigation__Mode()  = default;
...
struct CORDL_TYPE Navigation : public ::bs_hook::ValueTypeWrapper<0x28> {
public:
// Declarations
...
/// @brief Field m_Mode offset 0x0
 __declspec(property(get=__get_m_Mode, put=__set_m_Mode)) ::UnityEngine::UI::__Navigation__Mode  m_Mode;

/// @brief Field m_WrapAround offset 0x4
 __declspec(property(get=__get_m_WrapAround, put=__set_m_WrapAround)) bool  m_WrapAround;

/// @brief Field m_SelectOnUp offset 0x8
 __declspec(property(get=__get_m_SelectOnUp, put=__set_m_SelectOnUp)) ::UnityEngine::UI::Selectable*  m_SelectOnUp;

/// @brief Field m_SelectOnDown offset 0x10
 __declspec(property(get=__get_m_SelectOnDown, put=__set_m_SelectOnDown)) ::UnityEngine::UI::Selectable*  m_SelectOnDown;

/// @brief Field m_SelectOnLeft offset 0x18
 __declspec(property(get=__get_m_SelectOnLeft, put=__set_m_SelectOnLeft)) ::UnityEngine::UI::Selectable*  m_SelectOnLeft;

/// @brief Field m_SelectOnRight offset 0x20
 __declspec(property(get=__get_m_SelectOnRight, put=__set_m_SelectOnRight)) ::UnityEngine::UI::Selectable*  m_SelectOnRight;
...
constexpr void __set_m_Mode(::UnityEngine::UI::__Navigation__Mode  value) ;

constexpr ::UnityEngine::UI::__Navigation__Mode& __get_m_Mode() ;

constexpr ::UnityEngine::UI::__Navigation__Mode const& __get_m_Mode() const;

constexpr void __set_m_WrapAround(bool  value) ;

constexpr bool& __get_m_WrapAround() ;

constexpr bool const& __get_m_WrapAround() const;

constexpr void __set_m_SelectOnUp(::UnityEngine::UI::Selectable*  value) ;

constexpr ::UnityEngine::UI::Selectable* __get_m_SelectOnUp() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Selectable*> __get_m_SelectOnUp() const;

constexpr void __set_m_SelectOnDown(::UnityEngine::UI::Selectable*  value) ;

constexpr ::UnityEngine::UI::Selectable* __get_m_SelectOnDown() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Selectable*> __get_m_SelectOnDown() const;

constexpr void __set_m_SelectOnLeft(::UnityEngine::UI::Selectable*  value) ;

constexpr ::UnityEngine::UI::Selectable* __get_m_SelectOnLeft() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Selectable*> __get_m_SelectOnLeft() const;

constexpr void __set_m_SelectOnRight(::UnityEngine::UI::Selectable*  value) ;

constexpr ::UnityEngine::UI::Selectable* __get_m_SelectOnRight() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Selectable*> __get_m_SelectOnRight() const;
...
// Ctor Parameters [CppParam { name: "m_Mode", ty: "::UnityEngine::UI::__Navigation__Mode", modifiers: "", def_value: None }, CppParam { name: "m_WrapAround", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "m_SelectOnUp", ty: "::UnityEngine::UI::Selectable*", modifiers: "", def_value: None }, CppParam { name: "m_SelectOnDown", ty: "::UnityEngine::UI::Selectable*", modifiers: "", def_value: None }, CppParam { name: "m_SelectOnLeft", ty: "::UnityEngine::UI::Selectable*", modifiers: "", def_value: None }, CppParam { name: "m_SelectOnRight", ty: "::UnityEngine::UI::Selectable*", modifiers: "", def_value: None }]
constexpr Navigation(::UnityEngine::UI::__Navigation__Mode  m_Mode, bool  m_WrapAround, ::UnityEngine::UI::Selectable*  m_SelectOnUp, ::UnityEngine::UI::Selectable*  m_SelectOnDown, ::UnityEngine::UI::Selectable*  m_SelectOnLeft, ::UnityEngine::UI::Selectable*  m_SelectOnRight) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit Navigation(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x28>(instance) {
}
