...
/// @brief Field m_Positions offset 0x10
...
/// @brief Field m_Tangents offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Vector3>*> __get_m_Positions() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Color32>*> __get_m_Colors() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Vector4>*> __get_m_Uv0S() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Vector4>*> __get_m_Uv1S() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Vector4>*> __get_m_Uv2S() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Vector4>*> __get_m_Uv3S() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Vector3>*> __get_m_Normals() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Vector4>*> __get_m_Tangents() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<int32_t>*> __get_m_Indices() const;
...
/// @brief Method .ctor addr 0x2d8f258 size 0x8 virtual false final false
inline void _ctor() ;

static inline ::UnityEngine::UI::VertexHelper* New_ctor(::UnityEngine::Mesh*  m) ;

/// @brief Method .ctor addr 0x2d8f260 size 0x238 virtual false final false
inline void _ctor(::UnityEngine::Mesh*  m) ;

/// @brief Method InitializeListIfRequired addr 0x2d8f498 size 0x190 virtual false final false
inline void InitializeListIfRequired() ;

/// @brief Method Dispose addr 0x2d8f628 size 0x1b4 virtual true final true
inline void Dispose() ;

/// @brief Method Clear addr 0x2d7f4a8 size 0x11c virtual false final false
inline void Clear() ;

/// @brief Method get_currentVertCount addr 0x2d8f7dc size 0x4c virtual false final false
inline int32_t get_currentVertCount() ;

/// @brief Method get_currentIndexCount addr 0x2d8f828 size 0x4c virtual false final false
inline int32_t get_currentIndexCount() ;

/// @brief Method PopulateUIVertex addr 0x2d8f874 size 0x160 virtual false final false
inline void PopulateUIVertex(ByRef<::UnityEngine::UIVertex>  vertex, int32_t  i) ;

/// @brief Method SetUIVertex addr 0x2d8f9d4 size 0x15c virtual false final false
inline void SetUIVertex(::UnityEngine::UIVertex  vertex, int32_t  i) ;

/// @brief Method FillMesh addr 0x2d8fb30 size 0x164 virtual false final false
inline void FillMesh(::UnityEngine::Mesh*  mesh) ;

/// @brief Method AddVert addr 0x2d8fc94 size 0x4fc virtual false final false
...
/// @brief Method AddVert addr 0x2d90190 size 0x110 virtual false final false
...
/// @brief Method AddVert addr 0x2d7f5c4 size 0x130 virtual false final false
inline void AddVert(::UnityEngine::Vector3  position, ::UnityEngine::Color32  color, ::UnityEngine::Vector4  uv0) ;

/// @brief Method AddVert addr 0x2d902a0 size 0x94 virtual false final false
inline void AddVert(::UnityEngine::UIVertex  v) ;

/// @brief Method AddTriangle addr 0x2d7f6f4 size 0x17c virtual false final false
inline void AddTriangle(int32_t  idx0, int32_t  idx1, int32_t  idx2) ;

/// @brief Method AddUIVertexQuad addr 0x2d8c288 size 0x110 virtual false final false
inline void AddUIVertexQuad(::ArrayW<::UnityEngine::UIVertex,::Array<::UnityEngine::UIVertex>*>  verts) ;

/// @brief Method AddUIVertexStream addr 0x2d90334 size 0xac virtual false final false
...
/// @brief Method AddUIVertexTriangleStream addr 0x2d903e0 size 0x50 virtual false final false
inline void AddUIVertexTriangleStream(::System::Collections::Generic::List_1<::UnityEngine::UIVertex>*  verts) ;

/// @brief Method GetUIVertexStream addr 0x2d90430 size 0x50 virtual false final false
