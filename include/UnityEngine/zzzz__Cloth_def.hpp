...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::UnityEngine::Component)]{};

/// @brief Field <useContinuousCollision>k__BackingField offset 0x18
...
/// @brief Field <selfCollision>k__BackingField offset 0x1c
