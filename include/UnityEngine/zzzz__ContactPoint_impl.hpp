...
constexpr ::UnityEngine::Vector3& UnityEngine::ContactPoint::__get_m_Point()  {
...
constexpr ::UnityEngine::Vector3 const& UnityEngine::ContactPoint::__get_m_Point() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Vector3& UnityEngine::ContactPoint::__get_m_Normal()  {
...
constexpr ::UnityEngine::Vector3 const& UnityEngine::ContactPoint::__get_m_Normal() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0xc>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& UnityEngine::ContactPoint::__get_m_ThisColliderInstanceID()  {
return ::cordl_internals::getInstanceField<int32_t, 0x18>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::ContactPoint::__get_m_ThisColliderInstanceID() const {
return ::cordl_internals::getInstanceField<int32_t, 0x18>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& UnityEngine::ContactPoint::__get_m_OtherColliderInstanceID()  {
return ::cordl_internals::getInstanceField<int32_t, 0x1c>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::ContactPoint::__get_m_OtherColliderInstanceID() const {
return ::cordl_internals::getInstanceField<int32_t, 0x1c>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr float_t& UnityEngine::ContactPoint::__get_m_Separation()  {
return ::cordl_internals::getInstanceField<float_t, 0x20>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr float_t const& UnityEngine::ContactPoint::__get_m_Separation() const {
return ::cordl_internals::getInstanceField<float_t, 0x20>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::ContactPoint::ContactPoint(::UnityEngine::Vector3  m_Point, ::UnityEngine::Vector3  m_Normal, int32_t  m_ThisColliderInstanceID, int32_t  m_OtherColliderInstanceID, float_t  m_Separation) noexcept : ::bs_hook::ValueTypeWrapper<0x24>() {this->m_Point = m_Point;
