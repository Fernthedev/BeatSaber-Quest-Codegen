...
static inline ::UnityEngine::__Display__DisplaysUpdatedDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __Display__DisplaysUpdatedDelegate()  = default;
public:
...
/// @brief Field nativeDisplay offset 0x10
 __declspec(property(get=__get_nativeDisplay, put=__set_nativeDisplay)) ::cordl_internals::intptr_t  nativeDisplay;
...
constexpr ::cordl_internals::intptr_t& __get_nativeDisplay() ;

constexpr ::cordl_internals::intptr_t const& __get_nativeDisplay() const;
...
static inline ::UnityEngine::Display* New_ctor(::cordl_internals::intptr_t  nativeDisplay) ;

/// @brief Method .ctor addr 0x2cc3150 size 0x28 virtual false final false
inline void _ctor(::cordl_internals::intptr_t  nativeDisplay) ;
...
static inline void RecreateDisplayList(::ArrayW<::cordl_internals::intptr_t,::Array<::cordl_internals::intptr_t>*>  nativeDisplay) ;
...
static inline void GetSystemExtImpl(::cordl_internals::intptr_t  nativeDisplay, ByRef<int32_t>  w, ByRef<int32_t>  h) ;

/// @brief Method GetRenderingExtImpl addr 0x2cc320c size 0x54 virtual false final false
static inline void GetRenderingExtImpl(::cordl_internals::intptr_t  nativeDisplay, ByRef<int32_t>  w, ByRef<int32_t>  h) ;
...
// Static field displays

// Static field _mainDisplay

// Static field m_ActiveEditorGameViewTarget

// Static field onDisplaysUpdated
