...
struct CORDL_TYPE __Mesh__MeshDataArray : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x10};

/// @brief Field m_Ptrs offset 0x0
 __declspec(property(get=__get_m_Ptrs, put=__set_m_Ptrs)) ::cordl_internals::Ptr<::cordl_internals::intptr_t>  m_Ptrs;
...
constexpr void __set_m_Ptrs(::cordl_internals::Ptr<::cordl_internals::intptr_t>  value) ;

constexpr ::cordl_internals::Ptr<::cordl_internals::intptr_t>& __get_m_Ptrs() ;

constexpr ::cordl_internals::Ptr<::cordl_internals::intptr_t> const& __get_m_Ptrs() const;
...
static inline void AcquireReadOnlyMeshData(::UnityEngine::Mesh*  mesh, ::cordl_internals::Ptr<::cordl_internals::intptr_t>  datas) ;

/// @brief Method AcquireReadOnlyMeshDatas addr 0x2cad02c size 0x54 virtual false final false
static inline void AcquireReadOnlyMeshDatas(::ArrayW<::UnityEngine::Mesh*,::Array<::UnityEngine::Mesh*>*>  meshes, ::cordl_internals::Ptr<::cordl_internals::intptr_t>  datas, int32_t  count) ;

/// @brief Method ReleaseMeshDatas addr 0x2cacef4 size 0x44 virtual false final false
static inline void ReleaseMeshDatas(::cordl_internals::Ptr<::cordl_internals::intptr_t>  datas, int32_t  count) ;

/// @brief Method CreateNewMeshDatas addr 0x2cad080 size 0x44 virtual false final false
static inline void CreateNewMeshDatas(::cordl_internals::Ptr<::cordl_internals::intptr_t>  datas, int32_t  count) ;

/// @brief Method ApplyToMeshesImpl addr 0x2cacf8c size 0x5c virtual false final false
static inline void ApplyToMeshesImpl(::ArrayW<::UnityEngine::Mesh*,::Array<::UnityEngine::Mesh*>*>  meshes, ::cordl_internals::Ptr<::cordl_internals::intptr_t>  datas, int32_t  count, ::UnityEngine::Rendering::MeshUpdateFlags  flags) ;

/// @brief Method ApplyToMeshImpl addr 0x2cacf38 size 0x54 virtual false final false
static inline void ApplyToMeshImpl(::UnityEngine::Mesh*  mesh, ::cordl_internals::intptr_t  data, ::UnityEngine::Rendering::MeshUpdateFlags  flags) ;

// Ctor Parameters [CppParam { name: "m_Ptrs", ty: "::cordl_internals::Ptr<::cordl_internals::intptr_t>", modifiers: "", def_value: None }, CppParam { name: "m_Length", ty: "int32_t", modifiers: "", def_value: None }]
constexpr __Mesh__MeshDataArray(::cordl_internals::Ptr<::cordl_internals::intptr_t>  m_Ptrs, int32_t  m_Length) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Mesh__MeshDataArray(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Mesh__MeshDataArray()  = default;
...
struct CORDL_TYPE __Mesh__MeshData : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
...
static inline int32_t GetVertexBufferCount(::cordl_internals::intptr_t  self) ;

/// @brief Method GetVertexDataPtr addr 0x2cad3e4 size 0x44 virtual false final false
static inline ::cordl_internals::intptr_t GetVertexDataPtr(::cordl_internals::intptr_t  self, int32_t  stream) ;

/// @brief Method GetVertexDataSize addr 0x2cad428 size 0x44 virtual false final false
static inline uint64_t GetVertexDataSize(::cordl_internals::intptr_t  self, int32_t  stream) ;

/// @brief Method GetIndexDataPtr addr 0x2cad46c size 0x3c virtual false final false
static inline ::cordl_internals::intptr_t GetIndexDataPtr(::cordl_internals::intptr_t  self) ;

/// @brief Method GetIndexDataSize addr 0x2cad4a8 size 0x3c virtual false final false
static inline uint64_t GetIndexDataSize(::cordl_internals::intptr_t  self) ;

/// @brief Method SetVertexBufferParamsFromArray addr 0x2cad190 size 0x54 virtual false final false
static inline void SetVertexBufferParamsFromArray(::cordl_internals::intptr_t  self, int32_t  vertexCount, ::ArrayW<::UnityEngine::Rendering::VertexAttributeDescriptor,::Array<::UnityEngine::Rendering::VertexAttributeDescriptor>*>  attributes) ;

/// @brief Method SetIndexBufferParamsImpl addr 0x2cad238 size 0x54 virtual false final false
static inline void SetIndexBufferParamsImpl(::cordl_internals::intptr_t  self, int32_t  indexCount, ::UnityEngine::Rendering::IndexFormat  indexFormat) ;

/// @brief Method SetSubMeshCount addr 0x2cad2d0 size 0x44 virtual false final false
static inline void SetSubMeshCount(::cordl_internals::intptr_t  self, int32_t  count) ;

/// @brief Method SetSubMeshImpl addr 0x2cad388 size 0x5c virtual false final false
static inline void SetSubMeshImpl(::cordl_internals::intptr_t  self, int32_t  index, ::UnityEngine::Rendering::SubMeshDescriptor  desc, ::UnityEngine::Rendering::MeshUpdateFlags  flags) ;

/// @brief Method SetSubMeshImpl_Injected addr 0x2cad4e4 size 0x5c virtual false final false
static inline void SetSubMeshImpl_Injected(::cordl_internals::intptr_t  self, int32_t  index, ByRef<::UnityEngine::Rendering::SubMeshDescriptor>  desc, ::UnityEngine::Rendering::MeshUpdateFlags  flags) ;

// Ctor Parameters [CppParam { name: "m_Ptr", ty: "::cordl_internals::intptr_t", modifiers: "", def_value: None }]
constexpr __Mesh__MeshData(::cordl_internals::intptr_t  m_Ptr) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Mesh__MeshData(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Mesh__MeshData()  = default;
...
inline void InternalSetIndexBufferData(::cordl_internals::intptr_t  data, int32_t  dataStart, int32_t  meshBufferStart, int32_t  count, int32_t  elemSize, ::UnityEngine::Rendering::MeshUpdateFlags  flags) ;
...
inline void SetVertexBufferParamsFromPtr(int32_t  vertexCount, ::cordl_internals::intptr_t  attributesPtr, int32_t  attributesCount) ;
...
inline void InternalSetVertexBufferData(int32_t  stream, ::cordl_internals::intptr_t  data, int32_t  dataStart, int32_t  meshBufferStart, int32_t  count, int32_t  elemSize, ::UnityEngine::Rendering::MeshUpdateFlags  flags) ;
...
inline void SetIndicesNativeArrayImpl(int32_t  submesh, ::UnityEngine::MeshTopology  topology, ::UnityEngine::Rendering::IndexFormat  indicesFormat, ::cordl_internals::intptr_t  indices, int32_t  arrayStart, int32_t  arraySize, bool  calculateBounds, int32_t  baseVertex) ;
...
inline void SetNativeArrayForChannelImpl(::UnityEngine::Rendering::VertexAttribute  channel, ::UnityEngine::Rendering::VertexAttributeFormat  format, int32_t  dim, ::cordl_internals::intptr_t  values, int32_t  arraySize, int32_t  valuesStart, int32_t  valuesCount, ::UnityEngine::Rendering::MeshUpdateFlags  flags) ;
...
inline ::cordl_internals::intptr_t GetNativeVertexBufferPtr(int32_t  index) ;

/// @brief Method GetNativeIndexBufferPtr addr 0x2ca52c0 size 0x3c virtual false final false
inline ::cordl_internals::intptr_t GetNativeIndexBufferPtr() ;
...
inline void InternalSetBoneWeights(::cordl_internals::intptr_t  bonesPerVertex, int32_t  bonesPerVertexSize, ::cordl_internals::intptr_t  weights, int32_t  weightsSize) ;
...
inline ::cordl_internals::intptr_t GetAllBoneWeightsArray() ;

/// @brief Method GetBonesPerVertexArray addr 0x2ca5b60 size 0x3c virtual false final false
inline ::cordl_internals::intptr_t GetBonesPerVertexArray() ;
...
inline void SetAllSubMeshesAtOnceFromNativeArray(::cordl_internals::intptr_t  desc, int32_t  start, int32_t  count, ::UnityEngine::Rendering::MeshUpdateFlags  flags) ;
...
inline void SetSizedNativeArrayForChannel(::UnityEngine::Rendering::VertexAttribute  channel, ::UnityEngine::Rendering::VertexAttributeFormat  format, int32_t  dim, ::cordl_internals::intptr_t  values, int32_t  valuesArrayLength, int32_t  valuesStart, int32_t  valuesCount, ::UnityEngine::Rendering::MeshUpdateFlags  flags) ;
...
static inline void ApplyAndDisposeWritableMeshData(::UnityEngine::__Mesh__MeshDataArray  data, ::System::Collections::Generic::List_1<::UnityEngine::Mesh*>*  meshes, ::UnityEngine::Rendering::MeshUpdateFlags  flags) ;
