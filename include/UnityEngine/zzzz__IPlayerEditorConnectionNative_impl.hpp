...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::IPlayerEditorConnectionNative::*)(::System::Guid, ::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t)>(&::UnityEngine::IPlayerEditorConnectionNative::SendMessage)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::IPlayerEditorConnectionNative::*)(::System::Guid, ::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t)>(&::UnityEngine::IPlayerEditorConnectionNative::TrySendMessage)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
