...
/// @brief Field m_CachedPtr offset 0x10
 __declspec(property(get=__get_m_CachedPtr, put=__set_m_CachedPtr)) ::cordl_internals::intptr_t  m_CachedPtr;
...
constexpr ::cordl_internals::intptr_t& __get_m_CachedPtr() ;

constexpr ::cordl_internals::intptr_t const& __get_m_CachedPtr() const;
...
inline ::cordl_internals::intptr_t GetCachedPtr() ;
...
static inline ::UnityEngine::Object* Internal_InstantiateSingleWithParent_Injected(::UnityEngine::Object*  data, ::UnityEngine::Transform*  parent, ByRef<::UnityEngine::Vector3>  pos, ByRef<::UnityEngine::Quaternion>  rot) ;
...
// Static field OffsetOfInstanceIDInCPlusPlusObject
