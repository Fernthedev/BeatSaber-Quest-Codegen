...
/// @brief Field m_TargetAssemblyTypeName offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Object*> __get_m_Target() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Events::ArgumentCache*> __get_m_Arguments() const;
