...
/// @brief Field m_PersistentCalls offset 0x18
...
/// @brief Field m_CallsDirty offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Events::InvokableCallList*> __get_m_Calls() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Events::PersistentCallGroup*> __get_m_PersistentCalls() const;
