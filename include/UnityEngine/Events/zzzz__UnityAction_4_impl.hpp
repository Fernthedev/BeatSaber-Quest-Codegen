...
inline ::UnityEngine::Events::UnityAction_4<T0,T1,T2,T3>* UnityEngine::Events::UnityAction_4<T0,T1,T2,T3>::New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method)  {
return THROW_UNLESS(::il2cpp_utils::New<::UnityEngine::Events::UnityAction_4<T0,T1,T2,T3>*>(object, method));
}
template<::il2cpp_utils::il2cpp_reference_type T0,::il2cpp_utils::il2cpp_reference_type T1,::il2cpp_utils::il2cpp_reference_type T2,::il2cpp_utils::il2cpp_reference_type T3>
inline void UnityEngine::Events::UnityAction_4<T0,T1,T2,T3>::_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method)  {
