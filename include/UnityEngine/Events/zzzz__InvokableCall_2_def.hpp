...
template<::il2cpp_utils::il2cpp_reference_type T1,::il2cpp_utils::il2cpp_reference_type T2>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10450)), TypeDefinitionIndex(TypeDefinitionIndex(10453))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(10453), inst: 81 })
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Events::UnityAction_2<T1,T2>*> __get_Delegate() const;
