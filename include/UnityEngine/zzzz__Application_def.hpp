...
static inline ::UnityEngine::__Application__LowMemoryCallback* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __Application__LowMemoryCallback()  = default;
public:
...
static inline ::UnityEngine::__Application__LogCallback* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __Application__LogCallback()  = default;
public:
...
// Static field lowMemory

// Static field s_LogCallbackHandler

// Static field s_LogCallbackHandlerThreaded

// Static field focusChanged

// Static field deepLinkActivated

// Static field wantsToQuit

// Static field quitting

// Static field unloading
