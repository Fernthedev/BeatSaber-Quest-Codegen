...
/// @brief Field panelDisposed offset 0x10
...
/// @brief Field <duringLayoutPhase>k__BackingField offset 0x40
...
/// @brief Field <repaintData>k__BackingField offset 0x48
...
/// @brief Field <cursorManager>k__BackingField offset 0x50
...
/// @brief Field <contextualMenuManager>k__BackingField offset 0x58
 __declspec(property(get=__get__contextualMenuManager_k__BackingField, put=__set__contextualMenuManager_k__BackingField)) ::UnityEngine::UIElements::ContextualMenuManager*  _contextualMenuManager_k__BackingField;

/// @brief Field <disposed>k__BackingField offset 0x60
...
/// @brief Field m_TopElementUnderPointers offset 0x68
...
/// @brief Field hierarchyChanged offset 0x90
...
/// @brief Field beforeUpdate offset 0x98
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::UIElements::BaseVisualElementPanel*>*> __get_panelDisposed() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Yoga::YogaConfig*> __get_yogaConfig() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::RepaintData*> __get__repaintData_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::ICursorManager*> __get__cursorManager_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::ContextualMenuManager*> __get__contextualMenuManager_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::ElementUnderPointer*> __get_m_TopElementUnderPointers() const;

constexpr void __set_standardShaderChanged(::System::Action*  value) ;

constexpr ::System::Action* __get_standardShaderChanged() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_standardShaderChanged() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_standardWorldSpaceShaderChanged() const;

constexpr void __set_atlasChanged(::System::Action*  value) ;

constexpr ::System::Action* __get_atlasChanged() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_atlasChanged() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::Material*>*> __get_updateMaterial() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::HierarchyEvent*> __get_hierarchyChanged() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::UIElements::IPanel*>*> __get_beforeUpdate() const;
...
// Ctor Parameters []
// @brief default ctor
 BaseVisualElementPanel()  = default;
public:
