...
struct CORDL_TYPE __TextureRegistry__TextureInfo : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
/// @brief Field dynamic offset 0x8
 __declspec(property(get=__get_dynamic, put=__set_dynamic)) bool  dynamic;

/// @brief Field refCount offset 0xc
...
constexpr bool& __get_dynamic() ;

constexpr bool const& __get_dynamic() const;
...
constexpr explicit __TextureRegistry__TextureInfo(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __TextureRegistry__TextureInfo()  = default;
...
/// @brief Field maxTextures offset 0x0
...
/// @brief Field m_TextureToId offset 0x18
...
/// @brief Field m_FreeIds offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__TextureRegistry__TextureInfo>*> __get_m_Textures() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityEngine::Texture*,::UnityEngine::UIElements::TextureId>*> __get_m_TextureToId() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::TextureId>*> __get_m_FreeIds() const;
