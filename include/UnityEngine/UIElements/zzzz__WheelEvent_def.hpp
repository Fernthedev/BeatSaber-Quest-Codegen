...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7215), inst: 4650 }), TypeDefinitionIndex(TypeDefinitionIndex(7215))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xc0 - sizeof(::UnityEngine::UIElements::MouseEventBase_1<::UnityEngine::UIElements::WheelEvent*>)]{};

/// @brief Field <delta>k__BackingField offset 0xb0
