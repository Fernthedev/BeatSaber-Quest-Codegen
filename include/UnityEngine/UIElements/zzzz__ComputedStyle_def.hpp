...
struct CORDL_TYPE ComputedStyle : public ::bs_hook::ValueTypeWrapper<0x58> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x58};

/// @brief Field inheritedData offset 0x0
 __declspec(property(get=__get_inheritedData, put=__set_inheritedData)) ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::InheritedData>  inheritedData;

/// @brief Field layoutData offset 0x8
 __declspec(property(get=__get_layoutData, put=__set_layoutData)) ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::LayoutData>  layoutData;

/// @brief Field rareData offset 0x10
 __declspec(property(get=__get_rareData, put=__set_rareData)) ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::RareData>  rareData;

/// @brief Field transformData offset 0x18
 __declspec(property(get=__get_transformData, put=__set_transformData)) ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::TransformData>  transformData;

/// @brief Field transitionData offset 0x20
 __declspec(property(get=__get_transitionData, put=__set_transitionData)) ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::TransitionData>  transitionData;

/// @brief Field visualData offset 0x28
 __declspec(property(get=__get_visualData, put=__set_visualData)) ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::VisualData>  visualData;

/// @brief Field yogaNode offset 0x30
 __declspec(property(get=__get_yogaNode, put=__set_yogaNode)) ::UnityEngine::Yoga::YogaNode*  yogaNode;

/// @brief Field customProperties offset 0x38
 __declspec(property(get=__get_customProperties, put=__set_customProperties)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::StyleSheets::StylePropertyValue>*  customProperties;

/// @brief Field matchingRulesHash offset 0x40
 __declspec(property(get=__get_matchingRulesHash, put=__set_matchingRulesHash)) int64_t  matchingRulesHash;

/// @brief Field dpiScaling offset 0x48
 __declspec(property(get=__get_dpiScaling, put=__set_dpiScaling)) float_t  dpiScaling;

/// @brief Field computedTransitions offset 0x50
 __declspec(property(get=__get_computedTransitions, put=__set_computedTransitions)) ::ArrayW<::UnityEngine::UIElements::ComputedTransitionProperty,::Array<::UnityEngine::UIElements::ComputedTransitionProperty>*>  computedTransitions;
...
constexpr ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::InheritedData>& __get_inheritedData() ;

constexpr ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::InheritedData> const& __get_inheritedData() const;

constexpr void __set_layoutData(::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::LayoutData>  value) ;

constexpr ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::LayoutData>& __get_layoutData() ;

constexpr ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::LayoutData> const& __get_layoutData() const;

constexpr void __set_rareData(::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::RareData>  value) ;

constexpr ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::RareData>& __get_rareData() ;

constexpr ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::RareData> const& __get_rareData() const;

constexpr void __set_transformData(::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::TransformData>  value) ;

constexpr ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::TransformData>& __get_transformData() ;

constexpr ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::TransformData> const& __get_transformData() const;

constexpr void __set_transitionData(::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::TransitionData>  value) ;

constexpr ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::TransitionData>& __get_transitionData() ;

constexpr ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::TransitionData> const& __get_transitionData() const;

constexpr void __set_visualData(::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::VisualData>  value) ;

constexpr ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::VisualData>& __get_visualData() ;

constexpr ::UnityEngine::UIElements::StyleDataRef_1<::UnityEngine::UIElements::VisualData> const& __get_visualData() const;

constexpr void __set_yogaNode(::UnityEngine::Yoga::YogaNode*  value) ;

constexpr ::UnityEngine::Yoga::YogaNode* __get_yogaNode() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Yoga::YogaNode*> __get_yogaNode() const;
...
constexpr ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::StyleSheets::StylePropertyValue>* __get_customProperties() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::StyleSheets::StylePropertyValue>*> __get_customProperties() const;

constexpr void __set_matchingRulesHash(int64_t  value) ;

constexpr int64_t& __get_matchingRulesHash() ;

constexpr int64_t const& __get_matchingRulesHash() const;

constexpr void __set_dpiScaling(float_t  value) ;

constexpr float_t& __get_dpiScaling() ;

constexpr float_t const& __get_dpiScaling() const;

constexpr void __set_computedTransitions(::ArrayW<::UnityEngine::UIElements::ComputedTransitionProperty,::Array<::UnityEngine::UIElements::ComputedTransitionProperty>*>  value) ;

constexpr ::ArrayW<::UnityEngine::UIElements::ComputedTransitionProperty,::Array<::UnityEngine::UIElements::ComputedTransitionProperty>*>& __get_computedTransitions() ;

constexpr ::ArrayW<::UnityEngine::UIElements::ComputedTransitionProperty,::Array<::UnityEngine::UIElements::ComputedTransitionProperty>*> const& __get_computedTransitions() const;
...
constexpr explicit ComputedStyle(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x58>(instance) {
}
