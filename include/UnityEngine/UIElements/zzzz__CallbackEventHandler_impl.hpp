...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::EventCallbackRegistry*, 0x10>(this, std::forward<::UnityEngine::UIElements::EventCallbackRegistry*>(value));
}
...
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::EventCallbackRegistry*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::EventCallbackRegistry*> UnityEngine::UIElements::CallbackEventHandler::__get_m_CallbackRegistry() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::EventCallbackRegistry*, 0x10>(this);
}
