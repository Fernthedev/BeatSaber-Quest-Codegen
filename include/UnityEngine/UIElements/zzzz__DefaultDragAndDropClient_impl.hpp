...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Object* (::UnityEngine::UIElements::DefaultDragAndDropClient::*)()>(&::UnityEngine::UIElements::DefaultDragAndDropClient::get_userData)> {
...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::StartDragArgs*, 0x10>(this, std::forward<::UnityEngine::UIElements::StartDragArgs*>(value));
}
constexpr ::UnityEngine::UIElements::StartDragArgs* UnityEngine::UIElements::DefaultDragAndDropClient::__get_m_StartDragArgs()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StartDragArgs*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StartDragArgs*> UnityEngine::UIElements::DefaultDragAndDropClient::__get_m_StartDragArgs() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StartDragArgs*, 0x10>(this);
}
