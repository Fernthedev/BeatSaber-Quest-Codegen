...
// Ctor Parameters []
// @brief default ctor
 __TreeView__UxmlTraits()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__TreeView__TreeViewItemWrapper>*> __get_m_ItemWrappers() const;
...
inline void CreateWrappers(::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::ITreeViewItem*>*  treeViewItems, int32_t  depth, ByRef<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__TreeView__TreeViewItemWrapper>*>  wrappers) ;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5282 }), TypeDefinitionIndex(TypeDefinitionIndex(7031)), TypeDefinitionIndex(TypeDefinitionIndex(6997)), TypeDefinitionIndex(TypeDefinitionIndex(7034))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::TreeView*,::UnityEngine::UIElements::__TreeView__UxmlTraits*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __TreeView__UxmlFactory()  = default;
public:
...
struct CORDL_TYPE __TreeView__TreeViewItemWrapper : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
constexpr explicit __TreeView__TreeViewItemWrapper(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __TreeView__TreeViewItemWrapper()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __TreeView___GetAllItems_d__64()  = default;
public:
