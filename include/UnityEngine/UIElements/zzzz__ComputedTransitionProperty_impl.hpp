...
constexpr ::UnityEngine::UIElements::StyleSheets::StylePropertyId& UnityEngine::UIElements::ComputedTransitionProperty::__get_id()  {
...
constexpr ::UnityEngine::UIElements::StyleSheets::StylePropertyId const& UnityEngine::UIElements::ComputedTransitionProperty::__get_id() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StyleSheets::StylePropertyId, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& UnityEngine::UIElements::ComputedTransitionProperty::__get_durationMs()  {
return ::cordl_internals::getInstanceField<int32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::UIElements::ComputedTransitionProperty::__get_durationMs() const {
return ::cordl_internals::getInstanceField<int32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& UnityEngine::UIElements::ComputedTransitionProperty::__get_delayMs()  {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::UIElements::ComputedTransitionProperty::__get_delayMs() const {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void UnityEngine::UIElements::ComputedTransitionProperty::__set_easingCurve(::System::Func_2<float_t,float_t>*  value)  {
::cordl_internals::setInstanceField<::System::Func_2<float_t,float_t>*, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::System::Func_2<float_t,float_t>*>(value));
}
constexpr ::System::Func_2<float_t,float_t>* UnityEngine::UIElements::ComputedTransitionProperty::__get_easingCurve()  {
return ::cordl_internals::getInstanceField<::System::Func_2<float_t,float_t>*, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<float_t,float_t>*> UnityEngine::UIElements::ComputedTransitionProperty::__get_easingCurve() const {
return ::cordl_internals::getInstanceField<::System::Func_2<float_t,float_t>*, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::UIElements::ComputedTransitionProperty::ComputedTransitionProperty(::UnityEngine::UIElements::StyleSheets::StylePropertyId  id, int32_t  durationMs, int32_t  delayMs, ::System::Func_2<float_t,float_t>*  easingCurve) noexcept : ::bs_hook::ValueTypeWrapper<0x18>() {this->id = id;
