...
struct CORDL_TYPE __ListViewDragger__DragPosition : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x18};

/// @brief Field insertAtIndex offset 0x0
 __declspec(property(get=__get_insertAtIndex, put=__set_insertAtIndex)) int32_t  insertAtIndex;

/// @brief Field recycledItem offset 0x8
 __declspec(property(get=__get_recycledItem, put=__set_recycledItem)) ::UnityEngine::UIElements::ReusableCollectionItem*  recycledItem;

/// @brief Field dragAndDropPosition offset 0x10
 __declspec(property(get=__get_dragAndDropPosition, put=__set_dragAndDropPosition)) ::UnityEngine::UIElements::DragAndDropPosition  dragAndDropPosition;
...
constexpr int32_t& __get_insertAtIndex() ;

constexpr int32_t const& __get_insertAtIndex() const;

constexpr void __set_recycledItem(::UnityEngine::UIElements::ReusableCollectionItem*  value) ;

constexpr ::UnityEngine::UIElements::ReusableCollectionItem* __get_recycledItem() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::ReusableCollectionItem*> __get_recycledItem() const;

constexpr void __set_dragAndDropPosition(::UnityEngine::UIElements::DragAndDropPosition  value) ;

constexpr ::UnityEngine::UIElements::DragAndDropPosition& __get_dragAndDropPosition() ;

constexpr ::UnityEngine::UIElements::DragAndDropPosition const& __get_dragAndDropPosition() const;
...
constexpr __ListViewDragger__DragPosition(int32_t  insertAtIndex, ::UnityEngine::UIElements::ReusableCollectionItem*  recycledItem, ::UnityEngine::UIElements::DragAndDropPosition  dragAndDropPosition) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __ListViewDragger__DragPosition(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ListViewDragger__DragPosition()  = default;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6969))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x60 - sizeof(::UnityEngine::UIElements::DragEventsProcessor)]{};

/// @brief Field m_LastDragPosition offset 0x38
...
/// @brief Field m_DragHoverBar offset 0x50
...
/// @brief Field <dragAndDropController>k__BackingField offset 0x58
 __declspec(property(get=__get__dragAndDropController_k__BackingField, put=__set__dragAndDropController_k__BackingField)) ::UnityEngine::UIElements::ICollectionDragAndDropController*  _dragAndDropController_k__BackingField;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get_m_DragHoverBar() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::ICollectionDragAndDropController*> __get__dragAndDropController_k__BackingField() const;
