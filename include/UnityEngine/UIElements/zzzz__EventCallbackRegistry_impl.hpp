...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::EventCallbackList*, 0x10>(this, std::forward<::UnityEngine::UIElements::EventCallbackList*>(value));
}
constexpr ::UnityEngine::UIElements::EventCallbackList* UnityEngine::UIElements::EventCallbackRegistry::__get_m_Callbacks()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::EventCallbackList*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::EventCallbackList*> UnityEngine::UIElements::EventCallbackRegistry::__get_m_Callbacks() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::EventCallbackList*, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::EventCallbackList*, 0x18>(this, std::forward<::UnityEngine::UIElements::EventCallbackList*>(value));
}
...
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::EventCallbackList*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::EventCallbackList*> UnityEngine::UIElements::EventCallbackRegistry::__get_m_TemporaryCallbacks() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::EventCallbackList*, 0x18>(this);
}
