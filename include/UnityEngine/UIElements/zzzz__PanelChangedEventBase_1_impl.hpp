...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::IPanel*, 0x80>(this, std::forward<::UnityEngine::UIElements::IPanel*>(value));
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::UnityEngine::UIElements::IPanel* UnityEngine::UIElements::PanelChangedEventBase_1<T>::__get__originPanel_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::IPanel*, 0x80>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::IPanel*> UnityEngine::UIElements::PanelChangedEventBase_1<T>::__get__originPanel_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::IPanel*, 0x80>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::IPanel*, 0x88>(this, std::forward<::UnityEngine::UIElements::IPanel*>(value));
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::UnityEngine::UIElements::IPanel* UnityEngine::UIElements::PanelChangedEventBase_1<T>::__get__destinationPanel_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::IPanel*, 0x88>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::IPanel*> UnityEngine::UIElements::PanelChangedEventBase_1<T>::__get__destinationPanel_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::IPanel*, 0x88>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
