...
// Ctor Parameters []
// @brief default ctor
 __UxmlFloatAttributeDescription____c()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::UnityEngine::UIElements::TypedUxmlAttributeDescription_1<float_t>)]{};
...
// Ctor Parameters []
// @brief default ctor
 UxmlFloatAttributeDescription()  = default;
public:
