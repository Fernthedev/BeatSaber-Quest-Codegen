...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::PanelSettings*, 0x1d8>(this, std::forward<::UnityEngine::UIElements::PanelSettings*>(value));
}
constexpr ::UnityEngine::UIElements::PanelSettings* UnityEngine::UIElements::RuntimePanel::__get_m_PanelSettings()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::PanelSettings*, 0x1d8>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::PanelSettings*> UnityEngine::UIElements::RuntimePanel::__get_m_PanelSettings() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::PanelSettings*, 0x1d8>(this);
}
