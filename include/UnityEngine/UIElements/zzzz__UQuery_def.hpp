...
// Ctor Parameters []
// @brief default ctor
 __UQuery__UQueryMatcher____c()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::UIElements::StyleSheets::HierarchyTraversal)]{};

/// @brief Field m_Matchers offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __UQuery__UQueryMatcher()  = default;
public:
...
/// @brief Field <match>k__BackingField offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get__match_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 __UQuery__SingleQueryMatcher()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::UnityEngine::UIElements::__UQuery__SingleQueryMatcher)]{};
...
// Ctor Parameters []
// @brief default ctor
 __UQuery__FirstQueryMatcher()  = default;
public:
...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6921)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6921), inst: 2 })
// CS Name: ::UQuery::IsOfType`1<T>*
class CORDL_TYPE __UQuery__IsOfType_1<T> : public ::System::Object {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __IL2CPP_REFERENCE_TYPE_SIZE{0x10};
