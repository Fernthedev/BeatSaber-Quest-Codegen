...
/// @brief Field k_RootStyleClassName offset 0x0
static constexpr ::ConstString  k_RootStyleClassName{u"unity-ui-document__root"};

/// @brief Field k_VisualElementNameSuffix offset 0x0
...
/// @brief Field m_UIDocumentCreationIndex offset 0x18
...
/// @brief Field m_PanelSettings offset 0x20
...
/// @brief Field m_PreviousPanelSettings offset 0x28
...
/// @brief Field m_ChildrenContentCopy offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::PanelSettings*> __get_m_PreviousPanelSettings() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIDocument*> __get_m_ParentUI() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIDocumentList*> __get_m_ChildrenContent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIDocument*>*> __get_m_ChildrenContentCopy() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualTreeAsset*> __get_sourceAsset() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get_m_RootVisualElement() const;
...
// Static field s_CurrentUIDocumentCounter
