...
/// @brief Field m_PendingPointerCapture offset 0x10
 __declspec(property(get=__get_m_PendingPointerCapture, put=__set_m_PendingPointerCapture)) ::ArrayW<::UnityEngine::UIElements::IEventHandler*,::Array<::UnityEngine::UIElements::IEventHandler*>*>  m_PendingPointerCapture;

/// @brief Field m_PointerCapture offset 0x18
 __declspec(property(get=__get_m_PointerCapture, put=__set_m_PointerCapture)) ::ArrayW<::UnityEngine::UIElements::IEventHandler*,::Array<::UnityEngine::UIElements::IEventHandler*>*>  m_PointerCapture;

/// @brief Field m_ShouldSendCompatibilityMouseEvents offset 0x20
