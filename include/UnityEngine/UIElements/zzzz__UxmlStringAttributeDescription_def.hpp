...
/// @brief Method .ctor addr 0x2e0efb4 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <GetValueFromBag>b__3_0 addr 0x2e0efbc size 0x8 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __UxmlStringAttributeDescription____c()  = default;
public:
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6982)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6982), inst: 397 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::UnityEngine::UIElements::TypedUxmlAttributeDescription_1<::StringW>)]{};

static inline ::UnityEngine::UIElements::UxmlStringAttributeDescription* New_ctor() ;

/// @brief Method .ctor addr 0x2e0e050 size 0xbc virtual false final false
inline void _ctor() ;

/// @brief Method GetValueFromBag addr 0x2e0edec size 0x164 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 UxmlStringAttributeDescription()  = default;
public:
