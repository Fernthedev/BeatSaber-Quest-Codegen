...
struct CORDL_TYPE __VisualElementFocusRing__DefaultFocusOrder : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____VisualElementFocusRing__DefaultFocusOrder_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __VisualElementFocusRing__DefaultFocusOrder(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __VisualElementFocusRing__DefaultFocusOrder()  = default;
...
/// @brief Field m_AutoIndex offset 0x10
 __declspec(property(get=__get_m_AutoIndex, put=__set_m_AutoIndex)) int32_t  m_AutoIndex;

/// @brief Field m_Focusable offset 0x18
 __declspec(property(get=__get_m_Focusable, put=__set_m_Focusable)) ::UnityEngine::UIElements::Focusable*  m_Focusable;

/// @brief Field m_IsSlot offset 0x20
 __declspec(property(get=__get_m_IsSlot, put=__set_m_IsSlot)) bool  m_IsSlot;

/// @brief Field m_ScopeNavigationOrder offset 0x28
 __declspec(property(get=__get_m_ScopeNavigationOrder, put=__set_m_ScopeNavigationOrder)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualElementFocusRing__FocusRingRecord*>*  m_ScopeNavigationOrder;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::Focusable*> __get_m_Focusable() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualElementFocusRing__FocusRingRecord*>*> __get_m_ScopeNavigationOrder() const;
...
// Ctor Parameters []
// @brief default ctor
 __VisualElementFocusRing__FocusRingRecord()  = default;
public:
...
/// @brief Field <defaultFocusOrder>k__BackingField offset 0x18
 __declspec(property(get=__get__defaultFocusOrder_k__BackingField, put=__set__defaultFocusOrder_k__BackingField)) ::UnityEngine::UIElements::__VisualElementFocusRing__DefaultFocusOrder  _defaultFocusOrder_k__BackingField;

/// @brief Field m_FocusRing offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get_root() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualElementFocusRing__FocusRingRecord*>*> __get_m_FocusRing() const;
...
// Ctor Parameters []
// @brief default ctor
 VisualElementFocusRing()  = default;
public:
