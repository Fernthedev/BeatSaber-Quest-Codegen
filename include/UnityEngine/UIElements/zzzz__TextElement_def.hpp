...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x90 - sizeof(::UnityEngine::UIElements::__BindableElement__UxmlTraits)]{};
...
/// @brief Field m_EnableRichText offset 0x80
...
/// @brief Field m_DisplayTooltipWhenElided offset 0x88
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlBoolAttributeDescription*> __get_m_EnableRichText() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlBoolAttributeDescription*> __get_m_DisplayTooltipWhenElided() const;
...
// Ctor Parameters []
// @brief default ctor
 __TextElement__UxmlTraits()  = default;
public:
...
/// @brief Field <isElided>k__BackingField offset 0x3d2
...
/// @brief Field m_PreviousTextParamsHashCode offset 0x470
...
// Static field maxTextVertices

// Static field k_EllipsisText
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6814)), TypeDefinitionIndex(TypeDefinitionIndex(6997)), TypeDefinitionIndex(TypeDefinitionIndex(6813)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5279 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::TextElement*,::UnityEngine::UIElements::__TextElement__UxmlTraits*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __TextElement__UxmlFactory()  = default;
public:
