...
struct CORDL_TYPE __DefaultEventSystem__UpdateMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____DefaultEventSystem__UpdateMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __DefaultEventSystem__UpdateMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __DefaultEventSystem__UpdateMode()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __DefaultEventSystem__Input()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __DefaultEventSystem__NoInput()  = default;
public:
...
static inline void setStaticF___9__23_1(::System::Func_4<::UnityEngine::Vector3,::UnityEngine::Vector3,::UnityEngine::UIElements::DefaultEventSystem*,::UnityEngine::UIElements::EventBase*>*  value) ;
...
static inline void setStaticF___9__23_2(::System::Func_4<::UnityEngine::Vector3,::UnityEngine::Vector3,::UnityEngine::UIElements::DefaultEventSystem*,::UnityEngine::UIElements::EventBase*>*  value) ;
...
// Ctor Parameters []
// @brief default ctor
 __DefaultEventSystem____c()  = default;
public:
...
// Static field <>9__23_2

// Static field <>9__24_0

// Static field <>9__24_1

// Static field <>9__24_2
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::__DefaultEventSystem__IInput*> __get_m_Input() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::BaseRuntimePanel*> __get_m_FocusedPanel() const;
...
// Ctor Parameters []
// @brief default ctor
 DefaultEventSystem()  = default;
public:


// Fields

// Static field IsEditorRemoteConnected
