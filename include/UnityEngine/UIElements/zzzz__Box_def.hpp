...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x3b0 - sizeof(::UnityEngine::UIElements::VisualElement)]{};
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::UIElements::UxmlFactory_1<::UnityEngine::UIElements::Box*>)]{};
