...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7131)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7131), inst: 915 }), TypeDefinitionIndex(TypeDefinitionIndex(6988))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xb8 - sizeof(::UnityEngine::UIElements::BaseFieldTraits_2<int32_t,::UnityEngine::UIElements::UxmlIntAttributeDescription*>)]{};

/// @brief Field m_LowValue offset 0x88
...
/// @brief Field m_HighValue offset 0x90
...
/// @brief Field m_PageSize offset 0x98
...
/// @brief Field m_ShowInputField offset 0xa0
...
/// @brief Field m_Direction offset 0xa8
...
/// @brief Field m_Inverted offset 0xb0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlIntAttributeDescription*> __get_m_LowValue() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlIntAttributeDescription*> __get_m_HighValue() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlIntAttributeDescription*> __get_m_PageSize() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlBoolAttributeDescription*> __get_m_ShowInputField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlBoolAttributeDescription*> __get_m_Inverted() const;
...
// Ctor Parameters []
// @brief default ctor
 __SliderInt__UxmlTraits()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x458 - sizeof(::UnityEngine::UIElements::BaseSlider_1<int32_t>)]{};
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5277 }), TypeDefinitionIndex(TypeDefinitionIndex(7122)), TypeDefinitionIndex(TypeDefinitionIndex(7121)), TypeDefinitionIndex(TypeDefinitionIndex(6997))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::SliderInt*,::UnityEngine::UIElements::__SliderInt__UxmlTraits*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __SliderInt__UxmlFactory()  = default;
public:
