...
/// @brief Method CanDispatchEvent addr 0x2e4cd5c size 0x78 virtual true final true
inline bool CanDispatchEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method DispatchEvent addr 0x2e4cdd4 size 0x200 virtual true final true
...
/// @brief Method .ctor addr 0x2e4cfe0 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 DefaultDispatchingStrategy()  = default;
public:
