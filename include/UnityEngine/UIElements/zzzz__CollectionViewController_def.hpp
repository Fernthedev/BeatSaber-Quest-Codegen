...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::BaseVerticalCollectionView*> __get_m_View() const;

constexpr void __set_m_ItemsSource(::System::Collections::IList*  value) ;

constexpr ::System::Collections::IList* __get_m_ItemsSource() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::IList*> __get_m_ItemsSource() const;
...
// Ctor Parameters []
// @brief default ctor
 CollectionViewController()  = default;
public:
