...
/// @brief Field m_StartDragArgs offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StartDragArgs*> __get_m_StartDragArgs() const;
...
// Ctor Parameters []
// @brief default ctor
 DefaultDragAndDropClient()  = default;
public:
