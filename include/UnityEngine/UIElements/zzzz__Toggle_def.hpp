...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x428 - sizeof(::UnityEngine::UIElements::BaseBoolField)]{};
...
// Static field noTextVariantUssClassName
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5281 }), TypeDefinitionIndex(TypeDefinitionIndex(6997)), TypeDefinitionIndex(TypeDefinitionIndex(7092)), TypeDefinitionIndex(TypeDefinitionIndex(7093))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::Toggle*,::UnityEngine::UIElements::__Toggle__UxmlTraits*>)]{};
