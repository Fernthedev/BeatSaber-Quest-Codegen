...
// Ctor Parameters []
// @brief default ctor
 __GroupBox__UxmlTraits()  = default;
public:
...
/// @brief The size of the true reference type
static constexpr auto  __IL2CPP_REFERENCE_TYPE_SIZE{0x3c8};

/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x3c8 - sizeof(::UnityEngine::UIElements::BindableElement)]{};

/// @brief Field m_TitleLabel offset 0x3c0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::Label*> __get_m_TitleLabel() const;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7115)), TypeDefinitionIndex(TypeDefinitionIndex(7114)), TypeDefinitionIndex(TypeDefinitionIndex(6997)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5261 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::GroupBox*,::UnityEngine::UIElements::__GroupBox__UxmlTraits*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __GroupBox__UxmlFactory()  = default;
public:
