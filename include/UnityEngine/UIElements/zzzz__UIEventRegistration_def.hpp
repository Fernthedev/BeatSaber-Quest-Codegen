...
/// @brief Method .ctor addr 0x2dfcd54 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <.cctor>b__1_0 addr 0x2dfcd5c size 0x4c virtual false final false
inline void __cctor_b__1_0() ;

/// @brief Method <.cctor>b__1_1 addr 0x2dfcda8 size 0x4c virtual false final false
inline void __cctor_b__1_1() ;

/// @brief Method <.cctor>b__1_2 addr 0x2dfcdf4 size 0x64 virtual false final false
inline bool __cctor_b__1_2(int32_t  i, ::cordl_internals::intptr_t  ptr) ;

/// @brief Method <.cctor>b__1_3 addr 0x2dfce58 size 0x4c virtual false final false
inline void __cctor_b__1_3() ;

/// @brief Method <.cctor>b__1_4 addr 0x2dfcea4 size 0x54 virtual false final false
inline bool __cctor_b__1_4(::System::Exception*  exception) ;

/// @brief Method <.cctor>b__1_5 addr 0x2dfcef8 size 0x4c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __UIEventRegistration____c()  = default;
public:
...
/// @brief Method RegisterUIElementSystem addr 0x2dfc0c4 size 0x84 virtual false final false
static inline void RegisterUIElementSystem(::UnityEngine::UIElements::IUIElementsUtility*  utility) ;

/// @brief Method TakeCapture addr 0x2dfc148 size 0x1d8 virtual false final false
static inline void TakeCapture() ;

/// @brief Method ReleaseCapture addr 0x2dfc320 size 0x1dc virtual false final false
static inline void ReleaseCapture() ;

/// @brief Method EndContainerGUIFromException addr 0x2dfc4fc size 0x218 virtual false final false
static inline bool EndContainerGUIFromException(::System::Exception*  exception) ;

/// @brief Method ProcessEvent addr 0x2dfc714 size 0x224 virtual false final false
static inline bool ProcessEvent(int32_t  instanceID, ::cordl_internals::intptr_t  nativeEventPtr) ;

/// @brief Method CleanupRoots addr 0x2dfc938 size 0x1dc virtual false final false
static inline void CleanupRoots() ;

/// @brief Method MakeCurrentIMGUIContainerDirty addr 0x2dfcb14 size 0x1dc virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 UIEventRegistration()  = default;
public:


// Fields

// Static field s_Utilities
