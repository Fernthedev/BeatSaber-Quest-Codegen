...
struct CORDL_TYPE __MouseCaptureDispatchingStrategy__EventBehavior : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____MouseCaptureDispatchingStrategy__EventBehavior_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __MouseCaptureDispatchingStrategy__EventBehavior(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MouseCaptureDispatchingStrategy__EventBehavior()  = default;
...
// Ctor Parameters []
// @brief default ctor
 MouseCaptureDispatchingStrategy()  = default;
public:
