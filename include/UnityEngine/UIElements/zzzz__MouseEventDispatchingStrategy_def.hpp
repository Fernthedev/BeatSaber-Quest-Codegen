...
/// @brief Method CanDispatchEvent addr 0x2e52288 size 0x54 virtual true final true
inline bool CanDispatchEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method DispatchEvent addr 0x2e522dc size 0x108 virtual true final true
inline void DispatchEvent(::UnityEngine::UIElements::EventBase*  evt, ::UnityEngine::UIElements::IPanel*  iPanel) ;

/// @brief Method SendEventToTarget addr 0x2e52484 size 0x3c virtual false final false
...
/// @brief Method SendEventToRegularTarget addr 0x2e524c0 size 0x38 virtual false final false
...
/// @brief Method SendEventToIMGUIContainer addr 0x2e524f8 size 0x1d8 virtual false final false
...
/// @brief Method SetBestTargetForEvent addr 0x2e523e4 size 0xa0 virtual false final false
...
/// @brief Method UpdateElementUnderMouse addr 0x2e52718 size 0x2fc virtual false final false
...
/// @brief Method IsDone addr 0x2e526d0 size 0x48 virtual false final false
...
/// @brief Method .ctor addr 0x2e52a14 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 MouseEventDispatchingStrategy()  = default;
public:
