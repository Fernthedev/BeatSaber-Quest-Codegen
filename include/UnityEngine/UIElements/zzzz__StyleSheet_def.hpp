...
struct CORDL_TYPE __StyleSheet__ImportStruct : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x10};

/// @brief Field styleSheet offset 0x0
 __declspec(property(get=__get_styleSheet, put=__set_styleSheet)) ::UnityEngine::UIElements::StyleSheet*  styleSheet;

/// @brief Field mediaQueries offset 0x8
 __declspec(property(get=__get_mediaQueries, put=__set_mediaQueries)) ::ArrayW<::StringW,::Array<::StringW>*>  mediaQueries;

constexpr void __set_styleSheet(::UnityEngine::UIElements::StyleSheet*  value) ;

constexpr ::UnityEngine::UIElements::StyleSheet* __get_styleSheet() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StyleSheet*> __get_styleSheet() const;

constexpr void __set_mediaQueries(::ArrayW<::StringW,::Array<::StringW>*>  value) ;

constexpr ::ArrayW<::StringW,::Array<::StringW>*>& __get_mediaQueries() ;

constexpr ::ArrayW<::StringW,::Array<::StringW>*> const& __get_mediaQueries() const;

// Ctor Parameters [CppParam { name: "styleSheet", ty: "::UnityEngine::UIElements::StyleSheet*", modifiers: "", def_value: None }, CppParam { name: "mediaQueries", ty: "::ArrayW<::StringW,::Array<::StringW>*>", modifiers: "", def_value: None }]
...
constexpr explicit __StyleSheet__ImportStruct(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __StyleSheet__ImportStruct()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x98 - sizeof(::UnityEngine::ScriptableObject)]{};
...
/// @brief Field m_Rules offset 0x20
...
/// @brief Field m_ComplexSelectors offset 0x28
 __declspec(property(get=__get_m_ComplexSelectors, put=__set_m_ComplexSelectors)) ::ArrayW<::UnityEngine::UIElements::StyleComplexSelector*,::Array<::UnityEngine::UIElements::StyleComplexSelector*>*>  m_ComplexSelectors;

/// @brief Field floats offset 0x30
 __declspec(property(get=__get_floats, put=__set_floats)) ::ArrayW<float_t,::Array<float_t>*>  floats;

/// @brief Field dimensions offset 0x38
 __declspec(property(get=__get_dimensions, put=__set_dimensions)) ::ArrayW<::UnityEngine::UIElements::StyleSheets::Dimension,::Array<::UnityEngine::UIElements::StyleSheets::Dimension>*>  dimensions;

/// @brief Field colors offset 0x40
 __declspec(property(get=__get_colors, put=__set_colors)) ::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  colors;

/// @brief Field strings offset 0x48
 __declspec(property(get=__get_strings, put=__set_strings)) ::ArrayW<::StringW,::Array<::StringW>*>  strings;

/// @brief Field assets offset 0x50
 __declspec(property(get=__get_assets, put=__set_assets)) ::ArrayW<::UnityEngine::Object*,::Array<::UnityEngine::Object*>*>  assets;

/// @brief Field imports offset 0x58
 __declspec(property(get=__get_imports, put=__set_imports)) ::ArrayW<::UnityEngine::UIElements::__StyleSheet__ImportStruct,::Array<::UnityEngine::UIElements::__StyleSheet__ImportStruct>*>  imports;

/// @brief Field m_FlattenedImportedStyleSheets offset 0x60
 __declspec(property(get=__get_m_FlattenedImportedStyleSheets, put=__set_m_FlattenedImportedStyleSheets)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSheet*>*  m_FlattenedImportedStyleSheets;

/// @brief Field m_ContentHash offset 0x68
 __declspec(property(get=__get_m_ContentHash, put=__set_m_ContentHash)) int32_t  m_ContentHash;

/// @brief Field scalableImages offset 0x70
 __declspec(property(get=__get_scalableImages, put=__set_scalableImages)) ::ArrayW<::UnityEngine::UIElements::StyleSheets::ScalableImage,::Array<::UnityEngine::UIElements::StyleSheets::ScalableImage>*>  scalableImages;

/// @brief Field orderedNameSelectors offset 0x78
 __declspec(property(get=__get_orderedNameSelectors, put=__set_orderedNameSelectors)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::StyleComplexSelector*>*  orderedNameSelectors;

/// @brief Field orderedTypeSelectors offset 0x80
 __declspec(property(get=__get_orderedTypeSelectors, put=__set_orderedTypeSelectors)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::StyleComplexSelector*>*  orderedTypeSelectors;

/// @brief Field orderedClassSelectors offset 0x88
 __declspec(property(get=__get_orderedClassSelectors, put=__set_orderedClassSelectors)) ::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::StyleComplexSelector*>*  orderedClassSelectors;

/// @brief Field m_IsDefaultStyleSheet offset 0x90
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSheet*>*> __get_m_FlattenedImportedStyleSheets() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::StyleComplexSelector*>*> __get_orderedNameSelectors() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::StyleComplexSelector*>*> __get_orderedTypeSelectors() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::UnityEngine::UIElements::StyleComplexSelector*>*> __get_orderedClassSelectors() const;
...
template<typename T>
static inline T CheckAccess(::ArrayW<T,::Array<T>*>  list, ::UnityEngine::UIElements::StyleValueType  type, ::UnityEngine::UIElements::StyleValueHandle  handle) ;
...
// Static field kCustomPropertyMarker
