...
constexpr ::UnityEngine::UIElements::__PanelRaycaster__FloatIntBits::__PanelRaycaster__FloatIntBits(float_t  f, int32_t  i) noexcept : ::bs_hook::ValueTypeWrapper<0x4>() {this->f = f;
this->i = i;
}
...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::BaseRuntimePanel*, 0x20>(this, std::forward<::UnityEngine::UIElements::BaseRuntimePanel*>(value));
}
constexpr ::UnityEngine::UIElements::BaseRuntimePanel* UnityEngine::UIElements::PanelRaycaster::__get_m_Panel()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::BaseRuntimePanel*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::BaseRuntimePanel*> UnityEngine::UIElements::PanelRaycaster::__get_m_Panel() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::BaseRuntimePanel*, 0x20>(this);
}
