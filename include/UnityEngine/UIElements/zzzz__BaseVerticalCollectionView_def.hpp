...
struct CORDL_TYPE __BaseVerticalCollectionView____c__DisplayClass164_0 : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x10};

/// @brief Field <>4__this offset 0x0
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::UnityEngine::UIElements::BaseVerticalCollectionView*  __4__this;

/// @brief Field shiftKey offset 0x8
 __declspec(property(get=__get_shiftKey, put=__set_shiftKey)) bool  shiftKey;

constexpr void __set___4__this(::UnityEngine::UIElements::BaseVerticalCollectionView*  value) ;

constexpr ::UnityEngine::UIElements::BaseVerticalCollectionView* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::BaseVerticalCollectionView*> __get___4__this() const;

constexpr void __set_shiftKey(bool  value) ;

constexpr bool& __get_shiftKey() ;

constexpr bool const& __get_shiftKey() const;
...
constexpr explicit __BaseVerticalCollectionView____c__DisplayClass164_0(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __BaseVerticalCollectionView____c__DisplayClass164_0()  = default;
...
static constexpr auto  __IL2CPP_REFERENCE_TYPE_SIZE{0x498};

/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x498 - sizeof(::UnityEngine::UIElements::BindableElement)]{};

/// @brief Field onItemsChosen offset 0x3c0
...
/// @brief Field onSelectionChange offset 0x3c8
...
/// @brief Field onSelectedIndicesChange offset 0x3d0
...
/// @brief Field itemIndexChanged offset 0x3d8
...
/// @brief Field m_BindItem offset 0x3f8
...
/// @brief Field <unbindItem>k__BackingField offset 0x400
 __declspec(property(get=__get__unbindItem_k__BackingField, put=__set__unbindItem_k__BackingField)) ::System::Action_2<::UnityEngine::UIElements::VisualElement*,int32_t>*  _unbindItem_k__BackingField;

/// @brief Field <destroyItem>k__BackingField offset 0x408
...
/// @brief Field m_SelectionType offset 0x410
...
/// @brief Field m_HorizontalScrollingEnabled offset 0x414
...
/// @brief Field m_ShowAlternatingRowBackgrounds offset 0x418
...
/// @brief Field m_VirtualizationController offset 0x438
...
/// @brief Field m_NavigationManipulator offset 0x440
...
/// @brief Field m_SelectedIndices offset 0x458
...
/// @brief Field m_SelectedItems offset 0x460
...
/// @brief Field m_LastHeight offset 0x468
 __declspec(property(get=__get_m_LastHeight, put=__set_m_LastHeight)) float_t  m_LastHeight;

/// @brief Field m_IsRangeSelectionDirectionUp offset 0x46c
...
/// @brief Field m_ItemsSourceChangedCallback offset 0x480
...
/// @brief Field m_TouchDownPosition offset 0x488
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::System::Collections::Generic::IEnumerable_1<::System::Object*>*>*> __get_onItemsChosen() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::System::Collections::Generic::IEnumerable_1<::System::Object*>*>*> __get_onSelectionChange() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::System::Collections::Generic::IEnumerable_1<int32_t>*>*> __get_onSelectedIndicesChange() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<int32_t,int32_t>*> __get_itemIndexChanged() const;

constexpr void __set_itemsSourceChanged(::System::Action*  value) ;

constexpr ::System::Action* __get_itemsSourceChanged() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_itemsSourceChanged() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<int32_t,int32_t>*> __get_m_GetItemId() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityEngine::UIElements::VisualElement*,int32_t>*> __get_m_BindItem() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityEngine::UIElements::VisualElement*,int32_t>*> __get__unbindItem_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::UIElements::VisualElement*>*> __get__destroyItem_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::CollectionViewController*> __get_m_ViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::CollectionVirtualizationController*> __get_m_VirtualizationController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::KeyboardNavigationManipulator*> __get_m_NavigationManipulator() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<int32_t>*> __get_m_SelectedIds() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<int32_t>*> __get_m_SelectedIndices() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::Object*>*> __get_m_SelectedItems() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::ListViewDragger*> __get_m_Dragger() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<int32_t,int32_t>*> __get_m_ItemIndexChangedCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_m_ItemsSourceChangedCallback() const;
...
// Ctor Parameters []
// @brief default ctor
 BaseVerticalCollectionView()  = default;
public:


// Fields

// Static field k_EmptyItems

// Static field s_DefaultItemHeight

// Static field s_ItemHeightProperty

// Static field ussClassName

// Static field borderUssClassName

// Static field itemUssClassName

// Static field dragHoverBarUssClassName

// Static field itemDragHoverUssClassName

// Static field itemSelectedVariantUssClassName

// Static field itemAlternativeBackgroundUssClassName

// Static field listScrollViewUssClassName

// Static field backgroundFillUssClassName
