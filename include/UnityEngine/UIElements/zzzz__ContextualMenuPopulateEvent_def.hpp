...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xc8 - sizeof(::UnityEngine::UIElements::MouseEventBase_1<::UnityEngine::UIElements::ContextualMenuPopulateEvent*>)]{};

/// @brief Field <menu>k__BackingField offset 0xb0
...
/// @brief Field <triggerEvent>k__BackingField offset 0xb8
...
/// @brief Field m_ContextualMenuManager offset 0xc0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::DropdownMenu*> __get__menu_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::EventBase*> __get__triggerEvent_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::ContextualMenuManager*> __get_m_ContextualMenuManager() const;
...
// Ctor Parameters []
// @brief default ctor
 ContextualMenuPopulateEvent()  = default;
public:
