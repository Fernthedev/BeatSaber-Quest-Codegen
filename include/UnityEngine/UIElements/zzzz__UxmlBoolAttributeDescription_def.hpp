...
/// @brief Method .ctor addr 0x2e0fec4 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <GetValueFromBag>b__3_0 addr 0x2e0fecc size 0x10 virtual false final false
inline bool _GetValueFromBag_b__3_0(::StringW  s, bool  b) ;

/// @brief Method <TryGetValueFromBag>b__4_0 addr 0x2e0fedc size 0x10 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __UxmlBoolAttributeDescription____c()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::UnityEngine::UIElements::TypedUxmlAttributeDescription_1<bool>)]{};

static inline ::UnityEngine::UIElements::UxmlBoolAttributeDescription* New_ctor() ;

/// @brief Method .ctor addr 0x2e0fa5c size 0x9c virtual false final false
inline void _ctor() ;

/// @brief Method GetValueFromBag addr 0x2e0faf8 size 0x168 virtual true final false
inline bool GetValueFromBag(::UnityEngine::UIElements::IUxmlAttributes*  bag, ::UnityEngine::UIElements::CreationContext  cc) ;

/// @brief Method TryGetValueFromBag addr 0x2e0fc60 size 0x178 virtual false final false
...
/// @brief Method ConvertValueToBool addr 0x2e0fdd8 size 0x88 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 UxmlBoolAttributeDescription()  = default;
public:
