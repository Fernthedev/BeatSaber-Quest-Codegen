...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::PanelSettings*> __get_m_Settings() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::BaseRuntimePanel*> __get_m_RuntimePanel() const;
...
/// @brief Method .ctor addr 0x2e192a4 size 0x28 virtual false final false
inline void _ctor(::UnityEngine::UIElements::PanelSettings*  settings) ;

/// @brief Method get_isInitialized addr 0x2e195ec size 0x10 virtual false final false
inline bool get_isInitialized() ;

/// @brief Method get_panel addr 0x2e1907c size 0x138 virtual false final false
inline ::UnityEngine::UIElements::BaseRuntimePanel* get_panel() ;

/// @brief Method DisposePanel addr 0x2e19590 size 0x20 virtual false final false
inline void DisposePanel() ;

/// @brief Method SetTargetTexture addr 0x2e18e60 size 0x28 virtual false final false
inline void SetTargetTexture() ;

/// @brief Method SetSortingPriority addr 0x2e18f80 size 0x34 virtual false final false
inline void SetSortingPriority() ;

/// @brief Method SetTargetDisplay addr 0x2e18ff0 size 0x28 virtual false final false
inline void SetTargetDisplay() ;

/// @brief Method CreateRelatedRuntimePanel addr 0x2e1995c size 0xf8 virtual false final false
inline ::UnityEngine::UIElements::BaseRuntimePanel* CreateRelatedRuntimePanel() ;

/// @brief Method DisposeRelatedPanel addr 0x2e19a54 size 0x5c virtual false final false
inline void DisposeRelatedPanel() ;

/// @brief Method MarkPotentiallyEmpty addr 0x2e19900 size 0x5c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __PanelSettings__RuntimePanelAccess()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xd0 - sizeof(::UnityEngine::ScriptableObject)]{};

/// @brief Field k_DefaultSortingOrder offset 0x0
static constexpr int32_t  k_DefaultSortingOrder{static_cast<int32_t>(0x0)};

/// @brief Field k_DefaultScaleValue offset 0x0
static constexpr float_t  k_DefaultScaleValue{1.0};

/// @brief Field k_DefaultStyleSheetPath offset 0x0
...
/// @brief Field m_ScreenMatchMode offset 0x40
...
/// @brief Field m_AttachedUIDocumentsList offset 0x70
...
/// @brief Field m_DynamicAtlasSettings offset 0x78
...
/// @brief Field m_AssignedScreenToPanel offset 0xc8
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::ThemeStyleSheet*> __get_themeUss() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RenderTexture*> __get_m_TargetTexture() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::__PanelSettings__RuntimePanelAccess*> __get_m_PanelAccess() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIDocumentList*> __get_m_AttachedUIDocumentsList() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::DynamicAtlasSettings*> __get_m_DynamicAtlasSettings() const;

constexpr void __set_m_AtlasBlitShader(::UnityEngine::Shader*  value) ;

constexpr ::UnityEngine::Shader* __get_m_AtlasBlitShader() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Shader*> __get_m_AtlasBlitShader() const;

constexpr void __set_m_RuntimeShader(::UnityEngine::Shader*  value) ;

constexpr ::UnityEngine::Shader* __get_m_RuntimeShader() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Shader*> __get_m_RuntimeShader() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Shader*> __get_m_RuntimeWorldShader() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::PanelTextSettings*> __get_textSettings() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StyleSheet*> __get_m_OldThemeUss() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<::UnityEngine::Vector2,::UnityEngine::Vector2>*> __get_m_AssignedScreenToPanel() const;

/// @brief Method get_themeStyleSheet addr 0x2e18cb4 size 0x8 virtual false final false
inline ::UnityEngine::UIElements::ThemeStyleSheet* get_themeStyleSheet() ;

/// @brief Method set_themeStyleSheet addr 0x2e18cbc size 0xc virtual false final false
inline void set_themeStyleSheet(::UnityEngine::UIElements::ThemeStyleSheet*  value) ;

/// @brief Method get_targetTexture addr 0x2e18e24 size 0x8 virtual false final false
inline ::UnityEngine::RenderTexture* get_targetTexture() ;

/// @brief Method set_targetTexture addr 0x2e18e2c size 0x34 virtual false final false
inline void set_targetTexture(::UnityEngine::RenderTexture*  value) ;

/// @brief Method get_scaleMode addr 0x2e18e88 size 0x8 virtual false final false
inline ::UnityEngine::UIElements::PanelScaleMode get_scaleMode() ;

/// @brief Method set_scaleMode addr 0x2e18e90 size 0x8 virtual false final false
inline void set_scaleMode(::UnityEngine::UIElements::PanelScaleMode  value) ;

/// @brief Method get_scale addr 0x2e18e98 size 0x8 virtual false final false
inline float_t get_scale() ;

/// @brief Method set_scale addr 0x2e18ea0 size 0x8 virtual false final false
inline void set_scale(float_t  value) ;

/// @brief Method get_referenceDpi addr 0x2e18ea8 size 0x8 virtual false final false
inline float_t get_referenceDpi() ;

/// @brief Method set_referenceDpi addr 0x2e18eb0 size 0x2c virtual false final false
inline void set_referenceDpi(float_t  value) ;

/// @brief Method get_fallbackDpi addr 0x2e18edc size 0x8 virtual false final false
inline float_t get_fallbackDpi() ;

/// @brief Method set_fallbackDpi addr 0x2e18ee4 size 0x2c virtual false final false
inline void set_fallbackDpi(float_t  value) ;

/// @brief Method get_referenceResolution addr 0x2e18f10 size 0x8 virtual false final false
inline ::UnityEngine::Vector2Int get_referenceResolution() ;

/// @brief Method set_referenceResolution addr 0x2e18f18 size 0x8 virtual false final false
inline void set_referenceResolution(::UnityEngine::Vector2Int  value) ;

/// @brief Method get_screenMatchMode addr 0x2e18f20 size 0x8 virtual false final false
inline ::UnityEngine::UIElements::PanelScreenMatchMode get_screenMatchMode() ;

/// @brief Method set_screenMatchMode addr 0x2e18f28 size 0x8 virtual false final false
inline void set_screenMatchMode(::UnityEngine::UIElements::PanelScreenMatchMode  value) ;

/// @brief Method get_match addr 0x2e18f30 size 0x8 virtual false final false
inline float_t get_match() ;

/// @brief Method set_match addr 0x2e18f38 size 0x8 virtual false final false
inline void set_match(float_t  value) ;

/// @brief Method get_sortingOrder addr 0x2e18f40 size 0x8 virtual false final false
inline float_t get_sortingOrder() ;

/// @brief Method set_sortingOrder addr 0x2e18f48 size 0x20 virtual false final false
inline void set_sortingOrder(float_t  value) ;

/// @brief Method ApplySortingOrder addr 0x2e18f68 size 0x18 virtual false final false
inline void ApplySortingOrder() ;

/// @brief Method get_targetDisplay addr 0x2e18fb4 size 0x8 virtual false final false
inline int32_t get_targetDisplay() ;

/// @brief Method set_targetDisplay addr 0x2e18fbc size 0x34 virtual false final false
inline void set_targetDisplay(int32_t  value) ;

/// @brief Method get_clearDepthStencil addr 0x2e19018 size 0x8 virtual false final false
inline bool get_clearDepthStencil() ;

/// @brief Method set_clearDepthStencil addr 0x2e19020 size 0xc virtual false final false
inline void set_clearDepthStencil(bool  value) ;

/// @brief Method get_depthClearValue addr 0x2e1902c size 0xc virtual false final false
inline float_t get_depthClearValue() ;

/// @brief Method get_clearColor addr 0x2e19038 size 0x8 virtual false final false
inline bool get_clearColor() ;

/// @brief Method set_clearColor addr 0x2e19040 size 0xc virtual false final false
inline void set_clearColor(bool  value) ;

/// @brief Method get_colorClearValue addr 0x2e1904c size 0xc virtual false final false
inline ::UnityEngine::Color get_colorClearValue() ;

/// @brief Method set_colorClearValue addr 0x2e19058 size 0xc virtual false final false
inline void set_colorClearValue(::UnityEngine::Color  value) ;

/// @brief Method get_panel addr 0x2e19064 size 0x18 virtual false final false
inline ::UnityEngine::UIElements::BaseRuntimePanel* get_panel() ;

/// @brief Method get_visualTree addr 0x2e191b4 size 0x2c virtual false final false
inline ::UnityEngine::UIElements::VisualElement* get_visualTree() ;

/// @brief Method get_dynamicAtlasSettings addr 0x2e191e0 size 0x8 virtual false final false
inline ::UnityEngine::UIElements::DynamicAtlasSettings* get_dynamicAtlasSettings() ;

/// @brief Method set_dynamicAtlasSettings addr 0x2e191e8 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2e191f0 size 0xb4 virtual false final false
inline void _ctor() ;

/// @brief Method Reset addr 0x2e192cc size 0x4 virtual false final false
inline void Reset() ;

/// @brief Method OnEnable addr 0x2e192d0 size 0x108 virtual false final false
inline void OnEnable() ;

/// @brief Method OnDisable addr 0x2e19564 size 0x2c virtual false final false
inline void OnDisable() ;

/// @brief Method DisposePanel addr 0x2e195b0 size 0x2c virtual false final false
inline void DisposePanel() ;

/// @brief Method get_ScreenDPI addr 0x2e195dc size 0x8 virtual false final false
inline float_t get_ScreenDPI() ;

/// @brief Method set_ScreenDPI addr 0x2e195e4 size 0x8 virtual false final false
inline void set_ScreenDPI(float_t  value) ;

/// @brief Method UpdateScreenDPI addr 0x2e193d8 size 0x1c virtual false final false
inline void UpdateScreenDPI() ;

/// @brief Method ApplyThemeStyleSheet addr 0x2e18cc8 size 0x15c virtual false final false
inline void ApplyThemeStyleSheet(::UnityEngine::UIElements::VisualElement*  root) ;

/// @brief Method InitializeShaders addr 0x2e193f4 size 0x170 virtual false final false
inline void InitializeShaders() ;

/// @brief Method ApplyPanelSettings addr 0x2e16928 size 0x5fc virtual false final false
inline void ApplyPanelSettings() ;

/// @brief Method SetScreenToPanelSpaceFunction addr 0x2e198d0 size 0x30 virtual false final false
...
/// @brief Method ResolveScale addr 0x2e197b8 size 0x118 virtual false final false
inline float_t ResolveScale(::UnityEngine::Rect  targetRect, float_t  screenDpi) ;

/// @brief Method GetDisplayRect addr 0x2e195fc size 0x1bc virtual false final false
inline ::UnityEngine::Rect GetDisplayRect() ;

/// @brief Method AttachAndInsertUIDocumentToVisualTree addr 0x2e156b4 size 0x94 virtual false final false
inline void AttachAndInsertUIDocumentToVisualTree(::UnityEngine::UIElements::UIDocument*  uiDocument) ;

/// @brief Method DetachUIDocument addr 0x2e15638 size 0x7c virtual false final false
