...
/// @brief Method CanDispatchEvent addr 0x2e4a6dc size 0x54 virtual true final true
inline bool CanDispatchEvent(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method DispatchEvent addr 0x2e4a730 size 0x5d0 virtual true final true
...
/// @brief Method .ctor addr 0x2e4ad8c size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 PointerCaptureDispatchingStrategy()  = default;
public:
