...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x90 - sizeof(::UnityEngine::UIElements::__VisualElement__UxmlTraits)]{};

/// @brief Field m_ItemHeight offset 0x70
...
/// @brief Field m_ShowBorder offset 0x78
...
/// @brief Field m_SelectionType offset 0x80
...
/// @brief Field m_ShowAlternatingRowBackgrounds offset 0x88
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlIntAttributeDescription*> __get_m_ItemHeight() const;
...
// Ctor Parameters []
// @brief default ctor
 __InternalTreeView__UxmlTraits()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x408 - sizeof(::UnityEngine::UIElements::VisualElement)]{};

/// @brief Field m_MakeItem offset 0x3b0
...
/// @brief Field onItemsChosen offset 0x3b8
 __declspec(property(get=__get_onItemsChosen, put=__set_onItemsChosen)) ::System::Action_1<::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::ITreeViewItem*>*>*  onItemsChosen;

/// @brief Field onSelectionChange offset 0x3c0
 __declspec(property(get=__get_onSelectionChange, put=__set_onSelectionChange)) ::System::Action_1<::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::ITreeViewItem*>*>*  onSelectionChange;

/// @brief Field m_SelectedItems offset 0x3c8
...
/// @brief Field m_BindItem offset 0x3d0
...
/// @brief Field <unbindItem>k__BackingField offset 0x3d8
 __declspec(property(get=__get__unbindItem_k__BackingField, put=__set__unbindItem_k__BackingField)) ::System::Action_2<::UnityEngine::UIElements::VisualElement*,::UnityEngine::UIElements::ITreeViewItem*>*  _unbindItem_k__BackingField;

/// @brief Field m_RootItems offset 0x3e0
...
/// @brief Field m_ExpandedItemIds offset 0x3e8
...
/// @brief Field m_ItemWrappers offset 0x3f0
 __declspec(property(get=__get_m_ItemWrappers, put=__set_m_ItemWrappers)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::__InternalTreeView__TreeViewItemWrapper>*  m_ItemWrappers;

/// @brief Field m_ListView offset 0x3f8
 __declspec(property(get=__get_m_ListView, put=__set_m_ListView)) ::UnityEngine::UIElements::ListView*  m_ListView;

/// @brief Field m_ScrollView offset 0x400
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_1<::UnityEngine::UIElements::VisualElement*>*> __get_m_MakeItem() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::ITreeViewItem*>*>*> __get_onItemsChosen() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::ITreeViewItem*>*>*> __get_onSelectionChange() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::ITreeViewItem*>*> __get_m_SelectedItems() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityEngine::UIElements::VisualElement*,::UnityEngine::UIElements::ITreeViewItem*>*> __get_m_BindItem() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::UnityEngine::UIElements::VisualElement*,::UnityEngine::UIElements::ITreeViewItem*>*> __get__unbindItem_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<::UnityEngine::UIElements::ITreeViewItem*>*> __get_m_RootItems() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<int32_t>*> __get_m_ExpandedItemIds() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__InternalTreeView__TreeViewItemWrapper>*> __get_m_ItemWrappers() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::ListView*> __get_m_ListView() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::ScrollView*> __get_m_ScrollView() const;
...
static inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::ITreeViewItem*>* GetAllItems(::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::ITreeViewItem*>*  rootItems) ;
...
inline void CreateWrappers(::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::ITreeViewItem*>*  treeViewItems, int32_t  depth, ByRef<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__InternalTreeView__TreeViewItemWrapper>*>  wrappers) ;
...
// Ctor Parameters []
// @brief default ctor
 InternalTreeView()  = default;
public:


// Fields

// Static field s_ListViewName

// Static field s_ItemName

// Static field s_ItemToggleName

// Static field s_ItemIndentsContainerName

// Static field s_ItemIndentName

// Static field s_ItemContentContainerName
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6997)), TypeDefinitionIndex(TypeDefinitionIndex(7347)), TypeDefinitionIndex(TypeDefinitionIndex(7350)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5265 })}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(7346))
// CS Name: ::InternalTreeView::UxmlFactory*
class CORDL_TYPE __InternalTreeView__UxmlFactory : public ::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::InternalTreeView*,::UnityEngine::UIElements::__InternalTreeView__UxmlTraits*> {
public:
// Declarations
/// @brief The size of the true reference type
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::InternalTreeView*,::UnityEngine::UIElements::__InternalTreeView__UxmlTraits*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __InternalTreeView__UxmlFactory()  = default;
public:
...
struct CORDL_TYPE __InternalTreeView__TreeViewItemWrapper : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
/// @brief Field item offset 0x8
 __declspec(property(get=__get_item, put=__set_item)) ::UnityEngine::UIElements::ITreeViewItem*  item;
...
constexpr ::UnityEngine::UIElements::ITreeViewItem* __get_item() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::ITreeViewItem*> __get_item() const;
...
constexpr explicit __InternalTreeView__TreeViewItemWrapper(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InternalTreeView__TreeViewItemWrapper()  = default;
...
/// @brief Field rootItems offset 0x28
...
/// @brief Field <>3__rootItems offset 0x30
...
/// @brief Field <iteratorStack>5__1 offset 0x38
 __declspec(property(get=__get__iteratorStack_5__1, put=__set__iteratorStack_5__1)) ::System::Collections::Generic::Stack_1<::System::Collections::Generic::IEnumerator_1<::UnityEngine::UIElements::ITreeViewItem*>*>*  _iteratorStack_5__1;

/// @brief Field <currentIterator>5__2 offset 0x40
 __declspec(property(get=__get__currentIterator_5__2, put=__set__currentIterator_5__2)) ::System::Collections::Generic::IEnumerator_1<::UnityEngine::UIElements::ITreeViewItem*>*  _currentIterator_5__2;

/// @brief Field <hasNext>5__3 offset 0x48
 __declspec(property(get=__get__hasNext_5__3, put=__set__hasNext_5__3)) bool  _hasNext_5__3;

/// @brief Field <currentItem>5__4 offset 0x50
 ...
 __declspec(property(get=System_Collections_Generic_IEnumerator_UnityEngine_UIElements_ITreeViewItem__get_Current)) ::UnityEngine::UIElements::ITreeViewItem*  System_Collections_Generic_IEnumerator_UnityEngine_UIElements_ITreeViewItem__Current;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::ITreeViewItem*> __get___2__current() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::ITreeViewItem*>*> __get_rootItems() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::ITreeViewItem*>*> __get___3__rootItems() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Stack_1<::System::Collections::Generic::IEnumerator_1<::UnityEngine::UIElements::ITreeViewItem*>*>*> __get__iteratorStack_5__1() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IEnumerator_1<::UnityEngine::UIElements::ITreeViewItem*>*> __get__currentIterator_5__2() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::ITreeViewItem*> __get__currentItem_5__4() const;
...
// Ctor Parameters []
// @brief default ctor
 __InternalTreeView___GetAllItems_d__64()  = default;
public:
