...
/// @brief Field element offset 0x18
...
/// @brief Field actionUserData offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::System::Object*>*> __get_actionUserData() const;

static inline ::UnityEngine::UIElements::__GenericDropdownMenu__MenuItem* New_ctor() ;

/// @brief Method .ctor addr 0x2e2fcf8 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __GenericDropdownMenu__MenuItem()  = default;
public:
...
struct CORDL_TYPE __GenericDropdownMenu____c__DisplayClass25_0 : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
/// @brief Field <>4__this offset 0x0
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::UnityEngine::UIElements::GenericDropdownMenu*  __4__this;

/// @brief Field selectedIndex offset 0x8
 __declspec(property(get=__get_selectedIndex, put=__set_selectedIndex)) int32_t  selectedIndex;

constexpr void __set___4__this(::UnityEngine::UIElements::GenericDropdownMenu*  value) ;

constexpr ::UnityEngine::UIElements::GenericDropdownMenu* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::GenericDropdownMenu*> __get___4__this() const;

constexpr void __set_selectedIndex(int32_t  value) ;

constexpr int32_t& __get_selectedIndex() ;

constexpr int32_t const& __get_selectedIndex() const;
...
constexpr explicit __GenericDropdownMenu____c__DisplayClass25_0(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __GenericDropdownMenu____c__DisplayClass25_0()  = default;
...
/// @brief Field m_Items offset 0x10
...
/// @brief Field m_MenuContainer offset 0x18
...
/// @brief Field m_OuterContainer offset 0x20
...
/// @brief Field m_TargetElement offset 0x38
...
/// @brief Field m_MousePosition offset 0x58
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__GenericDropdownMenu__MenuItem*>*> __get_m_Items() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get_m_MenuContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get_m_OuterContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get_m_PanelRootVisualContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get_m_TargetElement() const;
...
/// @brief Method get_contentContainer addr 0x2e2e408 size 0x24 virtual false final false
inline ::UnityEngine::UIElements::VisualElement* get_contentContainer() ;

static inline ::UnityEngine::UIElements::GenericDropdownMenu* New_ctor() ;

/// @brief Method .ctor addr 0x2e28378 size 0x2d4 virtual false final false
inline void _ctor() ;

/// @brief Method OnAttachToPanel addr 0x2e2e42c size 0x438 virtual false final false
inline void OnAttachToPanel(::UnityEngine::UIElements::AttachToPanelEvent*  evt) ;

/// @brief Method OnDetachFromPanel addr 0x2e2e864 size 0x494 virtual false final false
inline void OnDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent*  evt) ;

/// @brief Method Hide addr 0x2e2ecf8 size 0xe8 virtual false final false
inline void Hide() ;

/// @brief Method Apply addr 0x2e2ede0 size 0x3c virtual false final false
inline void Apply(::UnityEngine::UIElements::KeyboardNavigationOperation  op, ::UnityEngine::UIElements::EventBase*  sourceEvent) ;

/// @brief Method Apply addr 0x2e2ee1c size 0x184 virtual false final false
inline bool Apply(::UnityEngine::UIElements::KeyboardNavigationOperation  op) ;

/// @brief Method OnPointerDown addr 0x2e2f1a4 size 0x12c virtual false final false
inline void OnPointerDown(::UnityEngine::UIElements::PointerDownEvent*  evt) ;

/// @brief Method OnPointerMove addr 0x2e2f3f8 size 0x12c virtual false final false
inline void OnPointerMove(::UnityEngine::UIElements::PointerMoveEvent*  evt) ;

/// @brief Method OnPointerUp addr 0x2e2f524 size 0x13c virtual false final false
inline void OnPointerUp(::UnityEngine::UIElements::PointerUpEvent*  evt) ;

/// @brief Method OnFocusOut addr 0x2e2f660 size 0x148 virtual false final false
inline void OnFocusOut(::UnityEngine::UIElements::FocusOutEvent*  evt) ;

/// @brief Method OnParentResized addr 0x2e2f7a8 size 0x4 virtual false final false
inline void OnParentResized(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method UpdateSelection addr 0x2e2f2d0 size 0x128 virtual false final false
inline void UpdateSelection(::UnityEngine::UIElements::VisualElement*  target) ;

/// @brief Method ChangeSelectedIndex addr 0x2e2f7ac size 0x134 virtual false final false
inline void ChangeSelectedIndex(int32_t  newIndex, int32_t  previousIndex) ;

/// @brief Method GetSelectedIndex addr 0x2e2efa0 size 0xa0 virtual false final false
inline int32_t GetSelectedIndex() ;

/// @brief Method AddItem addr 0x2e2f8e0 size 0x28 virtual true final true
inline void AddItem(::StringW  itemName, bool  isChecked, ::System::Action*  action) ;

/// @brief Method AddSeparator addr 0x2e2fc48 size 0xb0 virtual true final true
inline void AddSeparator(::StringW  path) ;

/// @brief Method AddItem addr 0x2e2f908 size 0x340 virtual false final false
...
/// @brief Method DropDown addr 0x2e2fd00 size 0x75c virtual true final true
inline void DropDown(::UnityEngine::Rect  position, ::UnityEngine::UIElements::VisualElement*  targetElement, bool  anchored) ;

/// @brief Method OnTargetElementDetachFromPanel addr 0x2e30b40 size 0x4 virtual false final false
inline void OnTargetElementDetachFromPanel(::UnityEngine::UIElements::DetachFromPanelEvent*  evt) ;

/// @brief Method OnContainerGeometryChanged addr 0x2e30b44 size 0x4 virtual false final false
inline void OnContainerGeometryChanged(::UnityEngine::UIElements::GeometryChangedEvent*  evt) ;

/// @brief Method EnsureVisibilityInParent addr 0x2e3045c size 0x6e4 virtual false final false
inline void EnsureVisibilityInParent() ;

/// @brief Method <Apply>g__UpdateSelectionDown|25_0 addr 0x2e2f0e8 size 0xbc virtual false final false
...
/// @brief Method <Apply>g__UpdateSelectionUp|25_1 addr 0x2e2f040 size 0xa8 virtual false final false
...
// Static field containerInnerUssClassName

// Static field containerOuterUssClassName

// Static field checkmarkUssClassName

// Static field separatorUssClassName
