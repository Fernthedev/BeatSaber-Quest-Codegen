...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x98 - sizeof(::UnityEngine::UIElements::__BindableElement__UxmlTraits)]{};

/// @brief Field m_LowValue offset 0x78
...
/// @brief Field m_HighValue offset 0x80
...
/// @brief Field m_Title offset 0x90
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlStringAttributeDescription*> __get_m_Title() const;
...
// Ctor Parameters []
// @brief default ctor
 __AbstractProgressBar__UxmlTraits()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get_m_Background() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get_m_Progress() const;

constexpr void __set_m_Title(::UnityEngine::UIElements::Label*  value) ;

constexpr ::UnityEngine::UIElements::Label* __get_m_Title() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::Label*> __get_m_Title() const;
...
// Static field containerUssClassName

// Static field titleUssClassName

// Static field titleContainerUssClassName

// Static field progressUssClassName

// Static field backgroundUssClassName
