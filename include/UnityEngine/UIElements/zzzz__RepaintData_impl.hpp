...
::cordl_internals::setInstanceField<::UnityEngine::Matrix4x4, 0x10>(this, std::forward<::UnityEngine::Matrix4x4>(value));
}
constexpr ::UnityEngine::Matrix4x4& UnityEngine::UIElements::RepaintData::__get__currentOffset_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Matrix4x4, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::UnityEngine::Rect, 0x58>(this, std::forward<::UnityEngine::Rect>(value));
}
constexpr ::UnityEngine::Rect& UnityEngine::UIElements::RepaintData::__get__currentWorldClip_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Rect, 0x58>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Event*> UnityEngine::UIElements::RepaintData::__get__repaintEvent_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Event*, 0x68>(this);
}
