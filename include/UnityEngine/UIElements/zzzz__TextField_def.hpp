...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xc0 - sizeof(::UnityEngine::UIElements::__TextInputBaseField_1__UxmlTraits<::StringW>)]{};

/// @brief Field m_Multiline offset 0xb8
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlBoolAttributeDescription*> __get_m_Multiline() const;

/// @brief Method Init addr 0x2e29338 size 0x114 virtual true final false
inline void Init(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::IUxmlAttributes*  bag, ::UnityEngine::UIElements::CreationContext  cc) ;

static inline ::UnityEngine::UIElements::__TextField__UxmlTraits* New_ctor() ;

/// @brief Method .ctor addr 0x2e2944c size 0xa0 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __TextField__UxmlTraits()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x420 - sizeof(::UnityEngine::UIElements::TextInputBaseField_1<::StringW>)]{};
...
/// @brief Method get_textInput addr 0x2e28c1c size 0x84 virtual false final false
inline ::UnityEngine::UIElements::__TextField__TextInput* get_textInput() ;

/// @brief Method set_multiline addr 0x2e28ca0 size 0x20 virtual false final false
inline void set_multiline(bool  value) ;

static inline ::UnityEngine::UIElements::TextField* New_ctor() ;

/// @brief Method .ctor addr 0x2e28d8c size 0x18 virtual false final false
inline void _ctor() ;

static inline ::UnityEngine::UIElements::TextField* New_ctor(::StringW  label) ;

/// @brief Method .ctor addr 0x2e28da4 size 0x14 virtual false final false
...
/// @brief Method .ctor addr 0x2e28db8 size 0x1dc virtual false final false
inline void _ctor(::StringW  label, int32_t  maxLength, bool  multiline, bool  isPasswordField, char16_t  maskChar) ;

/// @brief Method get_value addr 0x2e28fdc size 0x48 virtual true final false
inline ::StringW get_value() ;

/// @brief Method set_value addr 0x2e29024 size 0xa4 virtual true final false
inline void set_value(::StringW  value) ;

/// @brief Method SetValueWithoutNotify addr 0x2e290c8 size 0xa4 virtual true final false
inline void SetValueWithoutNotify(::StringW  newValue) ;

/// @brief Method OnViewDataReady addr 0x2e2916c size 0xb4 virtual true final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5280 }), TypeDefinitionIndex(TypeDefinitionIndex(7059)), TypeDefinitionIndex(TypeDefinitionIndex(6997)), TypeDefinitionIndex(TypeDefinitionIndex(7061))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::TextField*,::UnityEngine::UIElements::__TextField__UxmlTraits*>)]{};

static inline ::UnityEngine::UIElements::__TextField__UxmlFactory* New_ctor() ;

/// @brief Method .ctor addr 0x2e292f0 size 0x48 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __TextField__UxmlFactory()  = default;
public:
...
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __IL2CPP_REFERENCE_TYPE_SIZE{0x418};

/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x418 - sizeof(::UnityEngine::UIElements::__TextInputBaseField_1__TextInputBase<::StringW>)]{};

/// @brief Field m_Multiline offset 0x410
...
/// @brief Method get_parentTextField addr 0x2e294ec size 0x80 virtual false final false
inline ::UnityEngine::UIElements::TextField* get_parentTextField() ;

/// @brief Method get_multiline addr 0x2e2956c size 0x8 virtual false final false
inline bool get_multiline() ;

/// @brief Method set_multiline addr 0x2e28cc0 size 0xcc virtual false final false
inline void set_multiline(bool  value) ;

/// @brief Method SetTextAlign addr 0x2e29574 size 0xa0 virtual false final false
inline void SetTextAlign() ;

/// @brief Method set_isPasswordField addr 0x2e29614 size 0x5c virtual true final false
inline void set_isPasswordField(bool  value) ;

/// @brief Method StringToValue addr 0x2e29670 size 0x8 virtual true final false
inline ::StringW StringToValue(::StringW  str) ;

/// @brief Method SyncTextEngine addr 0x2e29678 size 0x90 virtual true final false
inline void SyncTextEngine() ;

/// @brief Method ExecuteDefaultActionAtTarget addr 0x2e29708 size 0x730 virtual true final false
inline void ExecuteDefaultActionAtTarget(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method ExecuteDefaultAction addr 0x2e29e38 size 0x18c virtual true final false
...
/// @brief Method .ctor addr 0x2e28f94 size 0x48 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __TextField__TextInput()  = default;
public:
