...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7198), inst: 1734 }), TypeDefinitionIndex(TypeDefinitionIndex(7198))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xf0 - sizeof(::UnityEngine::UIElements::PointerEventBase_1<::UnityEngine::UIElements::PointerUpEvent*>)]{};

/// @brief Method Init addr 0x2e4fc30 size 0x50 virtual true final false
inline void Init() ;

/// @brief Method LocalInit addr 0x2e4fc80 size 0x104 virtual false final false
inline void LocalInit() ;

static inline ::UnityEngine::UIElements::PointerUpEvent* New_ctor() ;

/// @brief Method .ctor addr 0x2e4fd84 size 0x50 virtual false final false
inline void _ctor() ;

/// @brief Method PostDispatch addr 0x2e4fdd4 size 0x32c virtual true final false
