...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7037)), TypeDefinitionIndex(TypeDefinitionIndex(7036)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5266 }), TypeDefinitionIndex(TypeDefinitionIndex(6997))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::Label*,::UnityEngine::UIElements::__Label__UxmlTraits*>)]{};
