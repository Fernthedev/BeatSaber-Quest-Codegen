...
/// @brief Field m_Vertices offset 0x10
...
/// @brief Method .ctor addr 0x2e796c0 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method get_vertexCount addr 0x2e796c8 size 0x48 virtual false final false
inline int32_t get_vertexCount() ;

/// @brief Method get_indexCount addr 0x2e79710 size 0x48 virtual false final false
inline int32_t get_indexCount() ;

/// @brief Method get_uvRegion addr 0x2e79758 size 0xc virtual false final false
inline ::UnityEngine::Rect get_uvRegion() ;

/// @brief Method SetNextVertex addr 0x2e79764 size 0x9c virtual false final false
inline void SetNextVertex(::UnityEngine::UIElements::Vertex  vertex) ;

/// @brief Method SetNextIndex addr 0x2e79800 size 0x64 virtual false final false
inline void SetNextIndex(uint16_t  index) ;

/// @brief Method SetAllVertices addr 0x2e79864 size 0xd8 virtual false final false
inline void SetAllVertices(::ArrayW<::UnityEngine::UIElements::Vertex,::Array<::UnityEngine::UIElements::Vertex>*>  vertices) ;

/// @brief Method SetAllIndices addr 0x2e7993c size 0xd8 virtual false final false
inline void SetAllIndices(::ArrayW<uint16_t,::Array<uint16_t>*>  indices) ;

/// @brief Method Reset addr 0x2e79a14 size 0x4c virtual false final false
...
/// @brief Method Reset addr 0x2e79a60 size 0x18 virtual false final false
