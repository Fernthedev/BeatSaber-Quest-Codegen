...
/// @brief Field m_Template offset 0x78
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlStringAttributeDescription*> __get_m_Template() const;

/// @brief Method Init addr 0x2db91d4 size 0x39c virtual true final false
inline void Init(::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::IUxmlAttributes*  bag, ::UnityEngine::UIElements::CreationContext  cc) ;

static inline ::UnityEngine::UIElements::__TemplateContainer__UxmlTraits* New_ctor() ;

/// @brief Method .ctor addr 0x2db96a4 size 0x88 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __TemplateContainer__UxmlTraits()  = default;
public:
...
/// @brief Field <templateId>k__BackingField offset 0x3c0
...
/// @brief Field m_ContentContainer offset 0x3c8
...
/// @brief Field m_TemplateSource offset 0x3d0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualTreeAsset*> __get_m_TemplateSource() const;

/// @brief Method get_templateId addr 0x2db9014 size 0x8 virtual false final false
inline ::StringW get_templateId() ;

/// @brief Method set_templateId addr 0x2db901c size 0x8 virtual false final false
inline void set_templateId(::StringW  value) ;

/// @brief Method set_templateSource addr 0x2db9024 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x2db902c size 0x1c virtual false final false
inline void _ctor() ;

static inline ::UnityEngine::UIElements::TemplateContainer* New_ctor(::StringW  templateId) ;

/// @brief Method .ctor addr 0x2db9048 size 0x28 virtual false final false
inline void _ctor(::StringW  templateId) ;

/// @brief Method get_contentContainer addr 0x2db90c8 size 0x8 virtual true final false
inline ::UnityEngine::UIElements::VisualElement* get_contentContainer() ;

/// @brief Method SetContentContainer addr 0x2db90d0 size 0x8 virtual false final false
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6778)), TypeDefinitionIndex(TypeDefinitionIndex(6997)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5278 }), TypeDefinitionIndex(TypeDefinitionIndex(6779))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::TemplateContainer*,::UnityEngine::UIElements::__TemplateContainer__UxmlTraits*>)]{};
...
/// @brief Method get_uxmlName addr 0x2db90d8 size 0x40 virtual true final false
inline ::StringW get_uxmlName() ;

/// @brief Method get_uxmlQualifiedName addr 0x2db9118 size 0x74 virtual true final false
inline ::StringW get_uxmlQualifiedName() ;

static inline ::UnityEngine::UIElements::__TemplateContainer__UxmlFactory* New_ctor() ;

/// @brief Method .ctor addr 0x2db918c size 0x48 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __TemplateContainer__UxmlFactory()  = default;
public:
