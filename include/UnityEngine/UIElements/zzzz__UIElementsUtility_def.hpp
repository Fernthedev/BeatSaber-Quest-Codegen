...
inline bool UnityEngine_UIElements_IUIElementsUtility_ProcessEvent(int32_t  instanceID, ::cordl_internals::intptr_t  nativeEventPtr, ByRef<bool>  eventHandled) ;
...
// Ctor Parameters []
// @brief default ctor
 UIElementsUtility()  = default;
public:


// Fields

// Static field s_ContainerStack

// Static field s_UIElementsCache

// Static field s_EventInstance

// Static field editorPlayModeTintColor

// Static field singleLineHeight

// Static field s_Instance

// Static field s_PanelsIterationList

// Static field s_RepaintProfilerMarkerName

// Static field s_EventProfilerMarkerName

// Static field s_RepaintProfilerMarker

// Static field s_EventProfilerMarker
