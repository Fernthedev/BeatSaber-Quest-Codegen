...
/// @brief Field <bindableElement>k__BackingField offset 0x10
...
/// @brief Field <animator>k__BackingField offset 0x18
 __declspec(property(get=__get__animator_k__BackingField, put=__set__animator_k__BackingField)) ::UnityEngine::UIElements::Experimental::ValueAnimation_1<::UnityEngine::UIElements::Experimental::StyleValues>*  _animator_k__BackingField;

/// @brief Field <index>k__BackingField offset 0x20
...
/// @brief Field onGeometryChanged offset 0x28
...
/// @brief Field m_GeometryChangedEventCallback offset 0x30
 __declspec(property(get=__get_m_GeometryChangedEventCallback, put=__set_m_GeometryChangedEventCallback)) ::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::GeometryChangedEvent*>*  m_GeometryChangedEventCallback;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get__bindableElement_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::Experimental::ValueAnimation_1<::UnityEngine::UIElements::Experimental::StyleValues>*> __get__animator_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::UIElements::ReusableCollectionItem*>*> __get_onGeometryChanged() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::GeometryChangedEvent*>*> __get_m_GeometryChangedEventCallback() const;
...
// Ctor Parameters []
// @brief default ctor
 ReusableCollectionItem()  = default;
public:
