...
struct CORDL_TYPE __UxmlAttributeDescription__Use : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____UxmlAttributeDescription__Use_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __UxmlAttributeDescription__Use(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __UxmlAttributeDescription__Use()  = default;
...
/// @brief Field m_ObsoleteNames offset 0x18
...
/// @brief Field <typeNamespace>k__BackingField offset 0x28
...
/// @brief Field <use>k__BackingField offset 0x30
...
/// @brief Field <restriction>k__BackingField offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlTypeRestriction*> __get__restriction_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 UxmlAttributeDescription()  = default;
public:
