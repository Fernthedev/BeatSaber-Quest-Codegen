...
// Ctor Parameters []
// @brief default ctor
 __IMGUIContainer__UxmlTraits()  = default;
public:
...
/// @brief Field <focusOnlyIfHasFocusableControls>k__BackingField offset 0x448
 __declspec(property(get=__get__focusOnlyIfHasFocusableControls_k__BackingField, put=__set__focusOnlyIfHasFocusableControls_k__BackingField)) bool  _focusOnlyIfHasFocusableControls_k__BackingField;

/// @brief Field m_GUIGlobals offset 0x44c
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_m_OnGUIHandler() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ObjectGUIState*> __get_m_ObjectGUIState() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::__GUILayoutUtility__LayoutCache*> __get_m_Cache() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::FocusChangeDirection*> __get_focusChangeDirection() const;
...
// Static field ussFoldoutChildDepthClassName

// Static field ussFoldoutChildDepthClassNames

// Static field k_OnGUIMarker

// Static field k_ImmediateCallbackMarker

// Static field s_DefaultMeasureEvent

// Static field s_MeasureEvent

// Static field s_CurrentEvent
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6997)), TypeDefinitionIndex(TypeDefinitionIndex(6907)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5263 }), TypeDefinitionIndex(TypeDefinitionIndex(6909))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::IMGUIContainer*,::UnityEngine::UIElements::__IMGUIContainer__UxmlTraits*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __IMGUIContainer__UxmlFactory()  = default;
public:
...
struct CORDL_TYPE __IMGUIContainer__GUIGlobals : public ::bs_hook::ValueTypeWrapper<0x78> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x78};

/// @brief Field matrix offset 0x0
 __declspec(property(get=__get_matrix, put=__set_matrix)) ::UnityEngine::Matrix4x4  matrix;

/// @brief Field color offset 0x40
 __declspec(property(get=__get_color, put=__set_color)) ::UnityEngine::Color  color;

/// @brief Field contentColor offset 0x50
 __declspec(property(get=__get_contentColor, put=__set_contentColor)) ::UnityEngine::Color  contentColor;

/// @brief Field backgroundColor offset 0x60
 __declspec(property(get=__get_backgroundColor, put=__set_backgroundColor)) ::UnityEngine::Color  backgroundColor;

/// @brief Field enabled offset 0x70
 __declspec(property(get=__get_enabled, put=__set_enabled)) bool  enabled;

/// @brief Field changed offset 0x71
 __declspec(property(get=__get_changed, put=__set_changed)) bool  changed;

/// @brief Field displayIndex offset 0x74
...
constexpr ::UnityEngine::Matrix4x4& __get_matrix() ;

constexpr ::UnityEngine::Matrix4x4 const& __get_matrix() const;
...
constexpr ::UnityEngine::Color& __get_contentColor() ;

constexpr ::UnityEngine::Color const& __get_contentColor() const;
...
constexpr bool& __get_changed() ;

constexpr bool const& __get_changed() const;
...
constexpr explicit __IMGUIContainer__GUIGlobals(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x78>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __IMGUIContainer__GUIGlobals()  = default;
