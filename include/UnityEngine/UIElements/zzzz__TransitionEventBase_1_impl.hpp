...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::StylePropertyNameCollection, 0x80>(this, std::forward<::UnityEngine::UIElements::StylePropertyNameCollection>(value));
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::UnityEngine::UIElements::StylePropertyNameCollection& UnityEngine::UIElements::TransitionEventBase_1<T>::__get__stylePropertyNames_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StylePropertyNameCollection, 0x80>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::UnityEngine::UIElements::StylePropertyNameCollection const& UnityEngine::UIElements::TransitionEventBase_1<T>::__get__stylePropertyNames_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StylePropertyNameCollection, 0x80>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr void UnityEngine::UIElements::TransitionEventBase_1<T>::__set__elapsedTime_k__BackingField(double_t  value)  {
::cordl_internals::setInstanceField<double_t, 0x88>(this, std::forward<double_t>(value));
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr double_t& UnityEngine::UIElements::TransitionEventBase_1<T>::__get__elapsedTime_k__BackingField()  {
return ::cordl_internals::getInstanceField<double_t, 0x88>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr double_t const& UnityEngine::UIElements::TransitionEventBase_1<T>::__get__elapsedTime_k__BackingField() const {
return ::cordl_internals::getInstanceField<double_t, 0x88>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
