...
struct CORDL_TYPE VisualElementStyleSheetSet : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
...
/// @brief Method .ctor addr 0x2dc7ff0 size 0x8 virtual false final false
inline void _ctor(::UnityEngine::UIElements::VisualElement*  element) ;

/// @brief Method Add addr 0x2dc7ff8 size 0x1d0 virtual false final false
inline void Add(::UnityEngine::UIElements::StyleSheet*  styleSheet) ;

/// @brief Method Remove addr 0x2dc81c8 size 0x134 virtual false final false
inline bool Remove(::UnityEngine::UIElements::StyleSheet*  styleSheet) ;

/// @brief Method Equals addr 0x2dc82fc size 0xc virtual true final true
inline bool Equals(::UnityEngine::UIElements::VisualElementStyleSheetSet  other) ;

/// @brief Method Equals addr 0x2dc8308 size 0x7c virtual true final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode addr 0x2dc8384 size 0x18 virtual true final false
...
constexpr explicit VisualElementStyleSheetSet(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 VisualElementStyleSheetSet()  = default;
