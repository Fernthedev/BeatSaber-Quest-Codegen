...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::ManipulatorActivationFilter::*)(::UnityEngine::UIElements::MouseButton)>(&::UnityEngine::UIElements::ManipulatorActivationFilter::set_button)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_button",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::UIElements::MouseButton>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::UIElements::ManipulatorActivationFilter::*)()>(&::UnityEngine::UIElements::ManipulatorActivationFilter::get_clickCount)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::UIElements::ManipulatorActivationFilter::*)(::System::Object*)>(&::UnityEngine::UIElements::ManipulatorActivationFilter::Equals)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::UnityEngine::UIElements::ManipulatorActivationFilter::*)()>(&::UnityEngine::UIElements::ManipulatorActivationFilter::GetHashCode)> {
...
constexpr void UnityEngine::UIElements::ManipulatorActivationFilter::__set__button_k__BackingField(::UnityEngine::UIElements::MouseButton  value)  {
::cordl_internals::setInstanceField<::UnityEngine::UIElements::MouseButton, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::UnityEngine::UIElements::MouseButton>(value));
}
constexpr ::UnityEngine::UIElements::MouseButton& UnityEngine::UIElements::ManipulatorActivationFilter::__get__button_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::MouseButton, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::UnityEngine::UIElements::MouseButton const& UnityEngine::UIElements::ManipulatorActivationFilter::__get__button_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::MouseButton, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void UnityEngine::UIElements::ManipulatorActivationFilter::__set__modifiers_k__BackingField(::UnityEngine::EventModifiers  value)  {
::cordl_internals::setInstanceField<::UnityEngine::EventModifiers, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::UnityEngine::EventModifiers>(value));
}
constexpr ::UnityEngine::EventModifiers& UnityEngine::UIElements::ManipulatorActivationFilter::__get__modifiers_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::EventModifiers, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::UnityEngine::EventModifiers const& UnityEngine::UIElements::ManipulatorActivationFilter::__get__modifiers_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::EventModifiers, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void UnityEngine::UIElements::ManipulatorActivationFilter::__set__clickCount_k__BackingField(int32_t  value)  {
...
constexpr int32_t& UnityEngine::UIElements::ManipulatorActivationFilter::__get__clickCount_k__BackingField()  {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::UIElements::ManipulatorActivationFilter::__get__clickCount_k__BackingField() const {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::UIElements::ManipulatorActivationFilter::ManipulatorActivationFilter(::UnityEngine::UIElements::MouseButton  _button_k__BackingField, ::UnityEngine::EventModifiers  _modifiers_k__BackingField, int32_t  _clickCount_k__BackingField) noexcept : ::bs_hook::ValueTypeWrapper<0xc>() {this->_button_k__BackingField = _button_k__BackingField;
