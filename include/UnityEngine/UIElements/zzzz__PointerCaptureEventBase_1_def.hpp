...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7150)), TypeDefinitionIndex(TypeDefinitionIndex(7180)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7180), inst: 1717 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7150), inst: 2 })
...
/// @brief Field <pointerId>k__BackingField offset 0x88
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::IEventHandler*> __get__relatedTarget_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 PointerCaptureEventBase_1()  = default;
public:
