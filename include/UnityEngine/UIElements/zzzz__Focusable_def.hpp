...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::UnityEngine::UIElements::CallbackEventHandler)]{};

/// @brief Field <focusable>k__BackingField offset 0x18
...
/// @brief Field <tabIndex>k__BackingField offset 0x1c
...
/// @brief Method .ctor addr 0x2df9a5c size 0x28 virtual false final false
inline void _ctor() ;
...
/// @brief Method get_focusable addr 0x2df9a84 size 0x8 virtual false final false
inline bool get_focusable() ;

/// @brief Method set_focusable addr 0x2df9a8c size 0xc virtual false final false
inline void set_focusable(bool  value) ;

/// @brief Method get_tabIndex addr 0x2df9a98 size 0x8 virtual false final false
inline int32_t get_tabIndex() ;

/// @brief Method set_tabIndex addr 0x2df9aa0 size 0x8 virtual false final false
inline void set_tabIndex(int32_t  value) ;

/// @brief Method get_delegatesFocus addr 0x2df9aa8 size 0x8 virtual false final false
inline bool get_delegatesFocus() ;

/// @brief Method set_delegatesFocus addr 0x2df9ab0 size 0xe4 virtual false final false
inline void set_delegatesFocus(bool  value) ;

/// @brief Method get_excludeFromFocusRing addr 0x2df9b94 size 0x8 virtual false final false
inline bool get_excludeFromFocusRing() ;

/// @brief Method set_excludeFromFocusRing addr 0x2df9b9c size 0xe4 virtual false final false
inline void set_excludeFromFocusRing(bool  value) ;

/// @brief Method get_canGrabFocus addr 0x2df9c80 size 0x8 virtual true final false
inline bool get_canGrabFocus() ;

/// @brief Method Focus addr 0x2df9c88 size 0xb0 virtual true final false
inline void Focus() ;

/// @brief Method Blur addr 0x2df9e80 size 0x38 virtual true final false
inline void Blur() ;

/// @brief Method BlurImmediately addr 0x2df9f10 size 0x38 virtual false final false
inline void BlurImmediately() ;

/// @brief Method GetFocusDelegate addr 0x2df9d38 size 0x90 virtual false final false
inline ::UnityEngine::UIElements::Focusable* GetFocusDelegate() ;

/// @brief Method GetFirstFocusableChild addr 0x2df9f48 size 0x120 virtual false final false
static inline ::UnityEngine::UIElements::Focusable* GetFirstFocusableChild(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method ExecuteDefaultAction addr 0x2dfa068 size 0x2c virtual true final false
inline void ExecuteDefaultAction(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method ExecuteDefaultActionDisabled addr 0x2dfa0f4 size 0x2c virtual true final false
inline void ExecuteDefaultActionDisabled(::UnityEngine::UIElements::EventBase*  evt) ;

/// @brief Method ProcessEvent addr 0x2dfa094 size 0x60 virtual false final false
