...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xa0 - sizeof(::UnityEngine::UIElements::__BaseField_1__UxmlTraits<::UnityEngine::Vector2>)]{};

/// @brief Field m_MinValue offset 0x80
...
/// @brief Field m_MaxValue offset 0x88
...
/// @brief Field m_LowLimit offset 0x90
...
/// @brief Field m_HighLimit offset 0x98
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlFloatAttributeDescription*> __get_m_MinValue() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlFloatAttributeDescription*> __get_m_MaxValue() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlFloatAttributeDescription*> __get_m_LowLimit() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlFloatAttributeDescription*> __get_m_HighLimit() const;
...
// Ctor Parameters []
// @brief default ctor
 __MinMaxSlider__UxmlTraits()  = default;
public:
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7130)), TypeDefinitionIndex(TypeDefinitionIndex(10243)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7130), inst: 411 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x468 - sizeof(::UnityEngine::UIElements::BaseField_1<::UnityEngine::Vector2>)]{};

/// @brief Field <dragElement>k__BackingField offset 0x408
...
/// @brief Field <dragMinThumb>k__BackingField offset 0x410
...
/// @brief Field <dragMaxThumb>k__BackingField offset 0x418
...
/// @brief Field <clampedDragger>k__BackingField offset 0x420
...
/// @brief Field m_DragElementStartPos offset 0x428
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get__dragMinThumb_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get__dragMaxThumb_k__BackingField() const;
...
// Static field minThumbUssClassName

// Static field maxThumbUssClassName
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6997)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5268 }), TypeDefinitionIndex(TypeDefinitionIndex(7106)), TypeDefinitionIndex(TypeDefinitionIndex(7108))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::MinMaxSlider*,::UnityEngine::UIElements::__MinMaxSlider__UxmlTraits*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __MinMaxSlider__UxmlFactory()  = default;
public:
...
struct CORDL_TYPE __MinMaxSlider__DragState : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____MinMaxSlider__DragState_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __MinMaxSlider__DragState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MinMaxSlider__DragState()  = default;
