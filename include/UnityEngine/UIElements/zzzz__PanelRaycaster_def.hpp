...
struct CORDL_TYPE __PanelRaycaster__FloatIntBits : public ::bs_hook::ValueTypeWrapper<0x4> {
public:
// Declarations
...
constexpr explicit __PanelRaycaster__FloatIntBits(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __PanelRaycaster__FloatIntBits()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::UnityEngine::EventSystems::BaseRaycaster)]{};

/// @brief Field m_Panel offset 0x20
