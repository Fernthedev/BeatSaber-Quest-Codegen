...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::UnityEngine::UIElements::MouseManipulator)]{};

/// @brief Field m_CurrentPointerId offset 0x2c
...
/// @brief Method CanStartManipulation addr 0x2dbe108 size 0x1f4 virtual false final false
inline bool CanStartManipulation(::UnityEngine::UIElements::IPointerEvent*  e) ;

/// @brief Method CanStopManipulation addr 0x2dbe540 size 0xb4 virtual false final false
...
/// @brief Method .ctor addr 0x2dbd1ac size 0x4 virtual false final false
inline void _ctor() ;
