...
struct CORDL_TYPE __PointerDeviceState__LocationFlag : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____PointerDeviceState__LocationFlag_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __PointerDeviceState__LocationFlag(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __PointerDeviceState__LocationFlag()  = default;
...
struct CORDL_TYPE __PointerDeviceState__PointerLocation : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x18};

/// @brief Field <Position>k__BackingField offset 0x0
...
/// @brief Field <Panel>k__BackingField offset 0x8
 __declspec(property(get=__get__Panel_k__BackingField, put=__set__Panel_k__BackingField)) ::UnityEngine::UIElements::IPanel*  _Panel_k__BackingField;

/// @brief Field <Flags>k__BackingField offset 0x10
 __declspec(property(get=__get__Flags_k__BackingField, put=__set__Flags_k__BackingField)) ::UnityEngine::UIElements::__PointerDeviceState__LocationFlag  _Flags_k__BackingField;
...
constexpr ::UnityEngine::UIElements::IPanel* __get__Panel_k__BackingField() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::IPanel*> __get__Panel_k__BackingField() const;

constexpr void __set__Flags_k__BackingField(::UnityEngine::UIElements::__PointerDeviceState__LocationFlag  value) ;

constexpr ::UnityEngine::UIElements::__PointerDeviceState__LocationFlag& __get__Flags_k__BackingField() ;

constexpr ::UnityEngine::UIElements::__PointerDeviceState__LocationFlag const& __get__Flags_k__BackingField() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __PointerDeviceState__PointerLocation(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __PointerDeviceState__PointerLocation()  = default;
...
// Ctor Parameters []
// @brief default ctor
 PointerDeviceState()  = default;
public:


// Fields

// Static field s_PlayerPointerLocations

// Static field s_PressedButtons

// Static field s_PlayerPanelWithSoftPointerCapture
