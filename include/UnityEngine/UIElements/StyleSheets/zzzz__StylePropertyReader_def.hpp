...
static inline ::UnityEngine::UIElements::StyleSheets::__StylePropertyReader__GetCursorIdFunction* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method .ctor addr 0x2de9730 size 0x130 virtual false final false
inline void _ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method Invoke addr 0x2de9860 size 0x14 virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 __StylePropertyReader__GetCursorIdFunction()  = default;
public:
...
/// @brief Field m_PropertyIds offset 0x38
 __declspec(property(get=__get_m_PropertyIds, put=__set_m_PropertyIds)) ::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::Array<::UnityEngine::UIElements::StyleSheets::StylePropertyId>*>  m_PropertyIds;

/// @brief Field m_CurrentValueIndex offset 0x40
 __declspec(property(get=__get_m_CurrentValueIndex, put=__set_m_CurrentValueIndex)) int32_t  m_CurrentValueIndex;

/// @brief Field m_CurrentPropertyIndex offset 0x44
 __declspec(property(get=__get_m_CurrentPropertyIndex, put=__set_m_CurrentPropertyIndex)) int32_t  m_CurrentPropertyIndex;

/// @brief Field <property>k__BackingField offset 0x48
...
/// @brief Field <propertyId>k__BackingField offset 0x50
...
/// @brief Field <valueCount>k__BackingField offset 0x54
...
/// @brief Field <dpiScaling>k__BackingField offset 0x58
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSheets::StylePropertyValue>*> __get_m_Values() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<int32_t>*> __get_m_ValueCount() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StyleVariableResolver*> __get_m_Resolver() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StyleSheet*> __get_m_Sheet() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StyleProperty*> __get__property_k__BackingField() const;
...
/// @brief Method get_property addr 0x2de60a4 size 0x8 virtual false final false
inline ::UnityEngine::UIElements::StyleProperty* get_property() ;

/// @brief Method set_property addr 0x2de60ac size 0x8 virtual false final false
inline void set_property(::UnityEngine::UIElements::StyleProperty*  value) ;

/// @brief Method get_propertyId addr 0x2de60b4 size 0x8 virtual false final false
inline ::UnityEngine::UIElements::StyleSheets::StylePropertyId get_propertyId() ;

/// @brief Method set_propertyId addr 0x2de60bc size 0x8 virtual false final false
inline void set_propertyId(::UnityEngine::UIElements::StyleSheets::StylePropertyId  value) ;

/// @brief Method get_valueCount addr 0x2de60c4 size 0x8 virtual false final false
inline int32_t get_valueCount() ;

/// @brief Method set_valueCount addr 0x2de60cc size 0x8 virtual false final false
inline void set_valueCount(int32_t  value) ;

/// @brief Method get_dpiScaling addr 0x2de60d4 size 0x8 virtual false final false
inline float_t get_dpiScaling() ;

/// @brief Method set_dpiScaling addr 0x2de60dc size 0x8 virtual false final false
inline void set_dpiScaling(float_t  value) ;

/// @brief Method SetContext addr 0x2de60e4 size 0xb8 virtual false final false
...
/// @brief Method SetInlineContext addr 0x2de6780 size 0x10 virtual false final false
...
/// @brief Method MoveNextProperty addr 0x2de6790 size 0x2c virtual false final false
inline ::UnityEngine::UIElements::StyleSheets::StylePropertyId MoveNextProperty() ;

/// @brief Method GetValue addr 0x2de686c size 0x5c virtual false final false
inline ::UnityEngine::UIElements::StyleSheets::StylePropertyValue GetValue(int32_t  index) ;

/// @brief Method GetValueType addr 0x2de4170 size 0x80 virtual false final false
inline ::UnityEngine::UIElements::StyleValueType GetValueType(int32_t  index) ;

/// @brief Method IsValueType addr 0x2de4038 size 0x94 virtual false final false
inline bool IsValueType(int32_t  index, ::UnityEngine::UIElements::StyleValueType  type) ;

/// @brief Method IsKeyword addr 0x2de40cc size 0xa4 virtual false final false
inline bool IsKeyword(int32_t  index, ::UnityEngine::UIElements::StyleValueKeyword  keyword) ;

/// @brief Method ReadAsString addr 0x2de50e0 size 0x60 virtual false final false
inline ::StringW ReadAsString(int32_t  index) ;

/// @brief Method ReadLength addr 0x2de41f0 size 0xf4 virtual false final false
inline ::UnityEngine::UIElements::Length ReadLength(int32_t  index) ;

/// @brief Method ReadTimeValue addr 0x2de5048 size 0x98 virtual false final false
inline ::UnityEngine::UIElements::TimeValue ReadTimeValue(int32_t  index) ;

/// @brief Method ReadTranslate addr 0x2de6928 size 0x130 virtual false final false
inline ::UnityEngine::UIElements::Translate ReadTranslate(int32_t  index) ;

/// @brief Method ReadTransformOrigin addr 0x2de6ce0 size 0x134 virtual false final false
inline ::UnityEngine::UIElements::TransformOrigin ReadTransformOrigin(int32_t  index) ;

/// @brief Method ReadRotate addr 0x2de6fd8 size 0x124 virtual false final false
inline ::UnityEngine::UIElements::Rotate ReadRotate(int32_t  index) ;

/// @brief Method ReadScale addr 0x2de71c8 size 0x100 virtual false final false
inline ::UnityEngine::UIElements::Scale ReadScale(int32_t  index) ;

/// @brief Method ReadFloat addr 0x2de42e4 size 0x68 virtual false final false
inline float_t ReadFloat(int32_t  index) ;

/// @brief Method ReadInt addr 0x2de74c4 size 0x84 virtual false final false
inline int32_t ReadInt(int32_t  index) ;

/// @brief Method ReadColor addr 0x2de4810 size 0x104 virtual false final false
inline ::UnityEngine::Color ReadColor(int32_t  index) ;

/// @brief Method ReadEnum addr 0x2de763c size 0xfc virtual false final false
inline int32_t ReadEnum(::UnityEngine::UIElements::StyleSheets::StyleEnumType  enumType, int32_t  index) ;

/// @brief Method ReadFontDefinition addr 0x2de7738 size 0x528 virtual false final false
inline ::UnityEngine::UIElements::FontDefinition ReadFontDefinition(int32_t  index) ;

/// @brief Method ReadFont addr 0x2de7c60 size 0x344 virtual false final false
inline ::UnityEngine::Font* ReadFont(int32_t  index) ;

/// @brief Method ReadBackground addr 0x2de7fa4 size 0x270 virtual false final false
inline ::UnityEngine::UIElements::Background ReadBackground(int32_t  index) ;

/// @brief Method ReadCursor addr 0x2de88c8 size 0x2ac virtual false final false
inline ::UnityEngine::UIElements::Cursor ReadCursor(int32_t  index) ;

/// @brief Method ReadTextShadow addr 0x2de8b74 size 0x274 virtual false final false
inline ::UnityEngine::UIElements::TextShadow ReadTextShadow(int32_t  index) ;

/// @brief Method ReadListEasingFunction addr 0x2de8de8 size 0x1f0 virtual false final false
...
/// @brief Method ReadListTimeValue addr 0x2de8fd8 size 0x194 virtual false final false
inline void ReadListTimeValue(::System::Collections::Generic::List_1<::UnityEngine::UIElements::TimeValue>*  list, int32_t  index) ;

/// @brief Method ReadListStylePropertyName addr 0x2de916c size 0x198 virtual false final false
...
/// @brief Method LoadProperties addr 0x2de634c size 0x434 virtual false final false
inline void LoadProperties() ;

/// @brief Method SetCurrentProperty addr 0x2de67bc size 0xb0 virtual false final false
inline void SetCurrentProperty() ;

/// @brief Method ReadTransformOrigin addr 0x2de6e14 size 0x1c4 virtual false final false
...
/// @brief Method ReadTransformOriginEnum addr 0x2de9304 size 0x158 virtual false final false
...
/// @brief Method ReadTranslate addr 0x2de6a58 size 0x288 virtual false final false
...
/// @brief Method ReadScale addr 0x2de72c8 size 0x1fc virtual false final false
...
/// @brief Method ReadRotate addr 0x2de70fc size 0xcc virtual false final false
...
/// @brief Method ReadEnum addr 0x2de945c size 0xc8 virtual false final false
...
/// @brief Method ReadAngle addr 0x2de9524 size 0x78 virtual false final false
static inline ::UnityEngine::UIElements::Angle ReadAngle(::UnityEngine::UIElements::StyleSheets::StylePropertyValue  value) ;

/// @brief Method TryGetImageSourceFromValue addr 0x2de8214 size 0x6b4 virtual false final false
...
/// @brief Method .ctor addr 0x2de9640 size 0xf0 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 StylePropertyReader()  = default;
public:


// Fields

// Static field getCursorIdFunc
