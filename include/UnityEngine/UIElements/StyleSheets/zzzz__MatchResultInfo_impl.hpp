...
constexpr bool& UnityEngine::UIElements::StyleSheets::MatchResultInfo::__get_success()  {
return ::cordl_internals::getInstanceField<bool, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr bool const& UnityEngine::UIElements::StyleSheets::MatchResultInfo::__get_success() const {
return ::cordl_internals::getInstanceField<bool, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::PseudoStates, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::UnityEngine::UIElements::PseudoStates>(value));
}
constexpr ::UnityEngine::UIElements::PseudoStates& UnityEngine::UIElements::StyleSheets::MatchResultInfo::__get_triggerPseudoMask()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::PseudoStates, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::UnityEngine::UIElements::PseudoStates const& UnityEngine::UIElements::StyleSheets::MatchResultInfo::__get_triggerPseudoMask() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::PseudoStates, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::PseudoStates, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::UnityEngine::UIElements::PseudoStates>(value));
}
constexpr ::UnityEngine::UIElements::PseudoStates& UnityEngine::UIElements::StyleSheets::MatchResultInfo::__get_dependencyPseudoMask()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::PseudoStates, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::UnityEngine::UIElements::PseudoStates const& UnityEngine::UIElements::StyleSheets::MatchResultInfo::__get_dependencyPseudoMask() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::PseudoStates, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::UIElements::StyleSheets::MatchResultInfo::MatchResultInfo(bool  success, ::UnityEngine::UIElements::PseudoStates  triggerPseudoMask, ::UnityEngine::UIElements::PseudoStates  dependencyPseudoMask) noexcept : ::bs_hook::ValueTypeWrapper<0xc>() {this->success = success;
