...
struct CORDL_TYPE __StyleSheetCache__SheetHandleKey : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x8};

/// @brief Field sheetInstanceID offset 0x0
 __declspec(property(get=__get_sheetInstanceID, put=__set_sheetInstanceID)) int32_t  sheetInstanceID;
...
constexpr int32_t& __get_sheetInstanceID() ;

constexpr int32_t const& __get_sheetInstanceID() const;
...
constexpr explicit __StyleSheetCache__SheetHandleKey(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __StyleSheetCache__SheetHandleKey()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __StyleSheetCache__SheetHandleKeyComparer()  = default;
public:
...
// Static field s_Comparer

// Static field s_RulePropertyIdsCache
