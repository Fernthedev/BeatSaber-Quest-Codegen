...
constexpr ::UnityEngine::UIElements::StyleSheet* UnityEngine::UIElements::StyleSheets::SelectorMatchRecord::__get_sheet()  {
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StyleSheet*> UnityEngine::UIElements::StyleSheets::SelectorMatchRecord::__get_sheet() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StyleSheet*, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& UnityEngine::UIElements::StyleSheets::SelectorMatchRecord::__get_styleSheetIndexInStack()  {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::UIElements::StyleSheets::SelectorMatchRecord::__get_styleSheetIndexInStack() const {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::StyleComplexSelector*, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::UnityEngine::UIElements::StyleComplexSelector*>(value));
}
constexpr ::UnityEngine::UIElements::StyleComplexSelector* UnityEngine::UIElements::StyleSheets::SelectorMatchRecord::__get_complexSelector()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StyleComplexSelector*, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StyleComplexSelector*> UnityEngine::UIElements::StyleSheets::SelectorMatchRecord::__get_complexSelector() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StyleComplexSelector*, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::UIElements::StyleSheets::SelectorMatchRecord::SelectorMatchRecord(::UnityEngine::UIElements::StyleSheet*  sheet, int32_t  styleSheetIndexInStack, ::UnityEngine::UIElements::StyleComplexSelector*  complexSelector) noexcept : ::bs_hook::ValueTypeWrapper<0x18>() {this->sheet = sheet;
