...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::StyleSheets::MatchResultErrorCode, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::UnityEngine::UIElements::StyleSheets::MatchResultErrorCode>(value));
}
constexpr ::UnityEngine::UIElements::StyleSheets::MatchResultErrorCode& UnityEngine::UIElements::StyleSheets::MatchResult::__get_errorCode()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StyleSheets::MatchResultErrorCode, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::UnityEngine::UIElements::StyleSheets::MatchResultErrorCode const& UnityEngine::UIElements::StyleSheets::MatchResult::__get_errorCode() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StyleSheets::MatchResultErrorCode, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::StringW& UnityEngine::UIElements::StyleSheets::MatchResult::__get_errorValue()  {
return ::cordl_internals::getInstanceField<::StringW, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::StringW const& UnityEngine::UIElements::StyleSheets::MatchResult::__get_errorValue() const {
return ::cordl_internals::getInstanceField<::StringW, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::UIElements::StyleSheets::MatchResult::MatchResult(::UnityEngine::UIElements::StyleSheets::MatchResultErrorCode  errorCode, ::StringW  errorValue) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->errorCode = errorCode;
