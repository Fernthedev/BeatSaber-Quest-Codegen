...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken::*)(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType)>(&::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2df5db4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken::*)(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType, ::StringW)>(&::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken::_ctor)> {
  constexpr static std::size_t size = 0x10;
  constexpr static std::size_t addrs = 0x2df5dc4;
...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType>(value));
}
constexpr ::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType& UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken::__get_type()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType const& UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken::__get_type() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::StringW& UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken::__get_text()  {
return ::cordl_internals::getInstanceField<::StringW, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::StringW const& UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken::__get_text() const {
return ::cordl_internals::getInstanceField<::StringW, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken::__get_number()  {
return ::cordl_internals::getInstanceField<int32_t, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken::__get_number() const {
return ::cordl_internals::getInstanceField<int32_t, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxToken::StyleSyntaxToken(::UnityEngine::UIElements::StyleSheets::Syntax::StyleSyntaxTokenType  type, ::StringW  text, int32_t  number) noexcept : ::bs_hook::ValueTypeWrapper<0x18>() {this->type = type;
this->text = text;
this->number = number;
}
