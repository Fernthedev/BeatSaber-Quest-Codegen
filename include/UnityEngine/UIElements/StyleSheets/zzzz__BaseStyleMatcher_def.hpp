...
struct CORDL_TYPE __BaseStyleMatcher__MatchContext : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x8};

/// @brief Field valueIndex offset 0x0
 __declspec(property(get=__get_valueIndex, put=__set_valueIndex)) int32_t  valueIndex;

/// @brief Field matchedVariableCount offset 0x4
 __declspec(property(get=__get_matchedVariableCount, put=__set_matchedVariableCount)) int32_t  matchedVariableCount;
...
constexpr int32_t& __get_matchedVariableCount() ;

constexpr int32_t const& __get_matchedVariableCount() const;
...
constexpr explicit __BaseStyleMatcher__MatchContext(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __BaseStyleMatcher__MatchContext()  = default;
...
/// @brief Field m_ContextStack offset 0x10
 __declspec(property(get=__get_m_ContextStack, put=__set_m_ContextStack)) ::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::StyleSheets::__BaseStyleMatcher__MatchContext>*  m_ContextStack;

/// @brief Field m_CurrentContext offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Stack_1<::UnityEngine::UIElements::StyleSheets::__BaseStyleMatcher__MatchContext>*> __get_m_ContextStack() const;
...
// Ctor Parameters []
// @brief default ctor
 BaseStyleMatcher()  = default;
public:


// Fields

// Static field s_CustomIdentRegex
