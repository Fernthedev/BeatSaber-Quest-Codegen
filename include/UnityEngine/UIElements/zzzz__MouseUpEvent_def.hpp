...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7215)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7215), inst: 4649 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xb0 - sizeof(::UnityEngine::UIElements::MouseEventBase_1<::UnityEngine::UIElements::MouseUpEvent*>)]{};

/// @brief Method Init addr 0x2e51074 size 0x54 virtual true final false
inline void Init() ;

/// @brief Method LocalInit addr 0x2e510c8 size 0xc virtual false final false
inline void LocalInit() ;

static inline ::UnityEngine::UIElements::MouseUpEvent* New_ctor() ;

/// @brief Method .ctor addr 0x2e510d4 size 0x54 virtual false final false
inline void _ctor() ;

/// @brief Method MakeFromPointerEvent addr 0x2e51128 size 0x18c virtual false final false
static inline ::UnityEngine::UIElements::MouseUpEvent* MakeFromPointerEvent(::UnityEngine::UIElements::IPointerEvent*  pointerEvent) ;

/// @brief Method GetPooled addr 0x2e50100 size 0x4 virtual false final false
static inline ::UnityEngine::UIElements::MouseUpEvent* GetPooled(::UnityEngine::UIElements::PointerUpEvent*  pointerEvent) ;

/// @brief Method GetPooled addr 0x2e4fa40 size 0x4 virtual false final false
static inline ::UnityEngine::UIElements::MouseUpEvent* GetPooled(::UnityEngine::UIElements::PointerMoveEvent*  pointerEvent) ;

/// @brief Method GetPooled addr 0x2e505d8 size 0x4 virtual false final false
