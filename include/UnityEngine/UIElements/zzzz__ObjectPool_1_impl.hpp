...
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::System::Collections::Generic::Stack_1<T>* UnityEngine::UIElements::ObjectPool_1<T>::__get_m_Stack()  {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::Stack_1<T>*, 0x10>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Stack_1<T>*> UnityEngine::UIElements::ObjectPool_1<T>::__get_m_Stack() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::Stack_1<T>*, 0x10>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
...
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr int32_t& UnityEngine::UIElements::ObjectPool_1<T>::__get_m_MaxSize()  {
return ::cordl_internals::getInstanceField<int32_t, 0x18>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr int32_t const& UnityEngine::UIElements::ObjectPool_1<T>::__get_m_MaxSize() const {
return ::cordl_internals::getInstanceField<int32_t, 0x18>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
...
template<::il2cpp_utils::il2cpp_reference_type T>
inline ::UnityEngine::UIElements::ObjectPool_1<T>* UnityEngine::UIElements::ObjectPool_1<T>::New_ctor(int32_t  maxSize)  {
return THROW_UNLESS(::il2cpp_utils::New<::UnityEngine::UIElements::ObjectPool_1<T>*>(maxSize));
}
/// @param maxSize: int32_t (default: static_cast<int32_t>(0x64))
template<::il2cpp_utils::il2cpp_reference_type T>
inline void UnityEngine::UIElements::ObjectPool_1<T>::_ctor(int32_t  maxSize)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::UnityEngine::UIElements::ObjectPool_1<T>*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
