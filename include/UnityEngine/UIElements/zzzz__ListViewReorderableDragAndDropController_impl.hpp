...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::ListView*, 0x28>(this, std::forward<::UnityEngine::UIElements::ListView*>(value));
}
...
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::ListView*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::ListView*> UnityEngine::UIElements::ListViewReorderableDragAndDropController::__get_m_ListView() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::ListView*, 0x28>(this);
}
