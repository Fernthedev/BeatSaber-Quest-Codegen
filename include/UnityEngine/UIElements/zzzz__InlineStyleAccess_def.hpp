...
struct CORDL_TYPE __InlineStyleAccess__InlineRule : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
...
/// @brief Field rule offset 0x8
 __declspec(property(get=__get_rule, put=__set_rule)) ::UnityEngine::UIElements::StyleRule*  rule;

/// @brief Field propertyIds offset 0x10
 __declspec(property(get=__get_propertyIds, put=__set_propertyIds)) ::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::Array<::UnityEngine::UIElements::StyleSheets::StylePropertyId>*>  propertyIds;
...
constexpr ::UnityEngine::UIElements::StyleRule* __get_rule() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StyleRule*> __get_rule() const;

constexpr void __set_propertyIds(::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::Array<::UnityEngine::UIElements::StyleSheets::StylePropertyId>*>  value) ;

constexpr ::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::Array<::UnityEngine::UIElements::StyleSheets::StylePropertyId>*>& __get_propertyIds() ;

constexpr ::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::Array<::UnityEngine::UIElements::StyleSheets::StylePropertyId>*> const& __get_propertyIds() const;

// Ctor Parameters [CppParam { name: "sheet", ty: "::UnityEngine::UIElements::StyleSheet*", modifiers: "", def_value: None }, CppParam { name: "rule", ty: "::UnityEngine::UIElements::StyleRule*", modifiers: "", def_value: None }, CppParam { name: "propertyIds", ty: "::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::Array<::UnityEngine::UIElements::StyleSheets::StylePropertyId>*>", modifiers: "", def_value: None }]
constexpr __InlineStyleAccess__InlineRule(::UnityEngine::UIElements::StyleSheet*  sheet, ::UnityEngine::UIElements::StyleRule*  rule, ::ArrayW<::UnityEngine::UIElements::StyleSheets::StylePropertyId,::Array<::UnityEngine::UIElements::StyleSheets::StylePropertyId>*>  propertyIds) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __InlineStyleAccess__InlineRule(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InlineStyleAccess__InlineRule()  = default;
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7308))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x100 - sizeof(::UnityEngine::UIElements::StyleValueCollection)]{};

/// @brief Field m_ValuesManaged offset 0x18
...
/// @brief Field <ve>k__BackingField offset 0x20
...
/// @brief Field m_HasInlineTransformOrigin offset 0x74
...
/// @brief Field m_InlineTransformOrigin offset 0x78
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::StyleSheets::StyleValueManaged>*> __get_m_ValuesManaged() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get__ve_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 InlineStyleAccess()  = default;
public:


// Fields

// Static field s_StylePropertyReader
