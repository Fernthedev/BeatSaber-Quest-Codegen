...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::IEventHandler*, 0x80>(this, std::forward<::UnityEngine::UIElements::IEventHandler*>(value));
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::UnityEngine::UIElements::IEventHandler* UnityEngine::UIElements::PointerCaptureEventBase_1<T>::__get__relatedTarget_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::IEventHandler*, 0x80>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::IEventHandler*> UnityEngine::UIElements::PointerCaptureEventBase_1<T>::__get__relatedTarget_k__BackingField() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::IEventHandler*, 0x80>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
...
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr int32_t& UnityEngine::UIElements::PointerCaptureEventBase_1<T>::__get__pointerId_k__BackingField()  {
return ::cordl_internals::getInstanceField<int32_t, 0x88>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
constexpr int32_t const& UnityEngine::UIElements::PointerCaptureEventBase_1<T>::__get__pointerId_k__BackingField() const {
return ::cordl_internals::getInstanceField<int32_t, 0x88>(this);
}
template<::il2cpp_utils::il2cpp_reference_type T>
