...
/// @brief Method RoundToPixelGrid addr 0x2db7ac0 size 0x1c virtual false final false
static inline float_t RoundToPixelGrid(float_t  v, float_t  pixelsPerPoint, float_t  offset) ;

/// @brief Method CeilToPixelGrid addr 0x2db7adc size 0x14 virtual false final false
