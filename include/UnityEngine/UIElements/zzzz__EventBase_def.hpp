...
struct CORDL_TYPE __EventBase__EventPropagation : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____EventBase__EventPropagation_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __EventBase__EventPropagation(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __EventBase__EventPropagation()  = default;
...
struct CORDL_TYPE __EventBase__LifeCycleStatus : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____EventBase__LifeCycleStatus_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __EventBase__LifeCycleStatus(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __EventBase__LifeCycleStatus()  = default;
...
/// @brief Field <timestamp>k__BackingField offset 0x10
...
/// @brief Field <eventId>k__BackingField offset 0x18
...
/// @brief Field <triggerEventId>k__BackingField offset 0x20
...
/// @brief Field <propagation>k__BackingField offset 0x28
...
/// @brief Field m_Path offset 0x30
 __declspec(property(get=__get_m_Path, put=__set_m_Path)) ::UnityEngine::UIElements::PropagationPaths*  m_Path;

/// @brief Field <lifeCycleStatus>k__BackingField offset 0x38
 __declspec(property(get=__get__lifeCycleStatus_k__BackingField, put=__set__lifeCycleStatus_k__BackingField)) ::UnityEngine::UIElements::__EventBase__LifeCycleStatus  _lifeCycleStatus_k__BackingField;

/// @brief Field <leafTarget>k__BackingField offset 0x40
...
/// @brief Field m_Target offset 0x48
 __declspec(property(get=__get_m_Target, put=__set_m_Target)) ::UnityEngine::UIElements::IEventHandler*  m_Target;

/// @brief Field <skipElements>k__BackingField offset 0x50
 __declspec(property(get=__get__skipElements_k__BackingField, put=__set__skipElements_k__BackingField)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::IEventHandler*>*  _skipElements_k__BackingField;

/// @brief Field <propagationPhase>k__BackingField offset 0x58
...
/// @brief Field m_CurrentTarget offset 0x60
...
/// @brief Field m_ImguiEvent offset 0x68
 __declspec(property(get=__get_m_ImguiEvent, put=__set_m_ImguiEvent)) ::UnityEngine::Event*  m_ImguiEvent;

/// @brief Field <originalMousePosition>k__BackingField offset 0x70
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::PropagationPaths*> __get_m_Path() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::IEventHandler*> __get__leafTarget_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::IEventHandler*> __get_m_Target() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::IEventHandler*>*> __get__skipElements_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::IEventHandler*> __get_m_CurrentTarget() const;
...
// Static field s_LastTypeId

// Static field s_NextEventId
