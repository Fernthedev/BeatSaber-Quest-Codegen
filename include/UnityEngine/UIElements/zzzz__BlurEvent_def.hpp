...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7232), inst: 1984 }), TypeDefinitionIndex(TypeDefinitionIndex(7232))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xa0 - sizeof(::UnityEngine::UIElements::FocusEventBase_1<::UnityEngine::UIElements::BlurEvent*>)]{};

/// @brief Method PreDispatch addr 0x2e52020 size 0x7c virtual true final false
inline void PreDispatch(::UnityEngine::UIElements::IPanel*  panel) ;

static inline ::UnityEngine::UIElements::BlurEvent* New_ctor() ;

/// @brief Method .ctor addr 0x2e5209c size 0x48 virtual false final false
inline void _ctor() ;
