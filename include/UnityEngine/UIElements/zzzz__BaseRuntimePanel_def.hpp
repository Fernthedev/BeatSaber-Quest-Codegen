...
// Ctor Parameters []
// @brief default ctor
 __BaseRuntimePanel____c()  = default;
public:
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6875))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x1d8 - sizeof(::UnityEngine::UIElements::Panel)]{};

/// @brief Field m_SelectableGameObject offset 0x158
...
/// @brief Field m_RuntimePanelCreationIndex offset 0x160
...
/// @brief Field m_ScreenToPanelSpace offset 0x1d0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_SelectableGameObject() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_destroyed() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Shader*> __get_m_StandardWorldSpaceShader() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RenderTexture*> __get_targetTexture() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<::UnityEngine::Vector2,::UnityEngine::Vector2>*> __get_m_ScreenToPanelSpace() const;
...
// Ctor Parameters []
// @brief default ctor
 BaseRuntimePanel()  = default;
public:


// Fields

// Static field s_CurrentRuntimePanelCounter

// Static field DefaultScreenToPanelSpace
