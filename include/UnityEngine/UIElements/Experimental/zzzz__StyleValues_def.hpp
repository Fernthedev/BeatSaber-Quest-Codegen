...
struct CORDL_TYPE StyleValues : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x8};

/// @brief Field m_StyleValues offset 0x0
 __declspec(property(get=__get_m_StyleValues, put=__set_m_StyleValues)) ::UnityEngine::UIElements::StyleValueCollection*  m_StyleValues;
...
constexpr ::UnityEngine::UIElements::StyleValueCollection* __get_m_StyleValues() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StyleValueCollection*> __get_m_StyleValues() const;

/// @brief Method set_top addr 0x2de362c size 0xc virtual false final false
inline void set_top(float_t  value) ;

/// @brief Method set_left addr 0x2de36bc size 0xc virtual false final false
inline void set_left(float_t  value) ;

/// @brief Method set_width addr 0x2de36c8 size 0xc virtual false final false
inline void set_width(float_t  value) ;

/// @brief Method set_height addr 0x2de36d4 size 0xc virtual false final false
inline void set_height(float_t  value) ;

/// @brief Method set_right addr 0x2de36e0 size 0xc virtual false final false
inline void set_right(float_t  value) ;

/// @brief Method set_bottom addr 0x2de36ec size 0xc virtual false final false
inline void set_bottom(float_t  value) ;

/// @brief Method set_color addr 0x2de36f8 size 0x8 virtual false final false
inline void set_color(::UnityEngine::Color  value) ;

/// @brief Method set_backgroundColor addr 0x2de3784 size 0x8 virtual false final false
inline void set_backgroundColor(::UnityEngine::Color  value) ;

/// @brief Method set_unityBackgroundImageTintColor addr 0x2de378c size 0xc virtual false final false
inline void set_unityBackgroundImageTintColor(::UnityEngine::Color  value) ;

/// @brief Method set_borderColor addr 0x2de3798 size 0xc virtual false final false
inline void set_borderColor(::UnityEngine::Color  value) ;

/// @brief Method set_marginLeft addr 0x2de37a4 size 0xc virtual false final false
inline void set_marginLeft(float_t  value) ;

/// @brief Method set_marginTop addr 0x2de37b0 size 0xc virtual false final false
inline void set_marginTop(float_t  value) ;

/// @brief Method set_marginRight addr 0x2de37bc size 0xc virtual false final false
inline void set_marginRight(float_t  value) ;

/// @brief Method set_marginBottom addr 0x2de37c8 size 0xc virtual false final false
inline void set_marginBottom(float_t  value) ;

/// @brief Method set_paddingLeft addr 0x2de37d4 size 0xc virtual false final false
inline void set_paddingLeft(float_t  value) ;

/// @brief Method get_paddingTop addr 0x2de37e0 size 0x3c virtual false final false
inline float_t get_paddingTop() ;

/// @brief Method set_paddingTop addr 0x2de3888 size 0xc virtual false final false
inline void set_paddingTop(float_t  value) ;

/// @brief Method set_paddingRight addr 0x2de3894 size 0xc virtual false final false
inline void set_paddingRight(float_t  value) ;

/// @brief Method set_paddingBottom addr 0x2de38a0 size 0xc virtual false final false
inline void set_paddingBottom(float_t  value) ;

/// @brief Method set_borderLeftWidth addr 0x2de38ac size 0xc virtual false final false
inline void set_borderLeftWidth(float_t  value) ;

/// @brief Method set_borderRightWidth addr 0x2de38b8 size 0xc virtual false final false
inline void set_borderRightWidth(float_t  value) ;

/// @brief Method set_borderTopWidth addr 0x2de38c4 size 0xc virtual false final false
inline void set_borderTopWidth(float_t  value) ;

/// @brief Method set_borderBottomWidth addr 0x2de38d0 size 0xc virtual false final false
inline void set_borderBottomWidth(float_t  value) ;

/// @brief Method set_borderTopLeftRadius addr 0x2de38dc size 0xc virtual false final false
inline void set_borderTopLeftRadius(float_t  value) ;

/// @brief Method set_borderTopRightRadius addr 0x2de38e8 size 0xc virtual false final false
inline void set_borderTopRightRadius(float_t  value) ;

/// @brief Method set_borderBottomLeftRadius addr 0x2de38f4 size 0xc virtual false final false
inline void set_borderBottomLeftRadius(float_t  value) ;

/// @brief Method set_borderBottomRightRadius addr 0x2de3900 size 0xc virtual false final false
inline void set_borderBottomRightRadius(float_t  value) ;

/// @brief Method set_opacity addr 0x2de390c size 0xc virtual false final false
inline void set_opacity(float_t  value) ;

/// @brief Method set_flexGrow addr 0x2de3918 size 0xc virtual false final false
inline void set_flexGrow(float_t  value) ;

/// @brief Method set_flexShrink addr 0x2de3924 size 0xc virtual false final false
inline void set_flexShrink(float_t  value) ;

/// @brief Method SetValue addr 0x2de3638 size 0x84 virtual false final false
inline void SetValue(::UnityEngine::UIElements::StyleSheets::StylePropertyId  id, float_t  value) ;

/// @brief Method SetValue addr 0x2de3700 size 0x84 virtual false final false
inline void SetValue(::UnityEngine::UIElements::StyleSheets::StylePropertyId  id, ::UnityEngine::Color  value) ;

/// @brief Method Values addr 0x2de381c size 0x6c virtual false final false
...
constexpr explicit StyleValues(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}
