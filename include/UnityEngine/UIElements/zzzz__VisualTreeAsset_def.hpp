...
struct CORDL_TYPE __VisualTreeAsset__UsingEntry : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x18};

/// @brief Field alias offset 0x0
 __declspec(property(get=__get_alias, put=__set_alias)) ::StringW  alias;

/// @brief Field path offset 0x8
 __declspec(property(get=__get_path, put=__set_path)) ::StringW  path;

/// @brief Field asset offset 0x10
 __declspec(property(get=__get_asset, put=__set_asset)) ::UnityEngine::UIElements::VisualTreeAsset*  asset;
...
constexpr ::UnityEngine::UIElements::VisualTreeAsset* __get_asset() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualTreeAsset*> __get_asset() const;

/// @brief Method .ctor addr 0x2e13448 size 0xc virtual false final false
...
constexpr explicit __VisualTreeAsset__UsingEntry(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __VisualTreeAsset__UsingEntry()  = default;
...
/// @brief Method Compare addr 0x2e138d0 size 0x10 virtual true final true
...
/// @brief Method .ctor addr 0x2e138c8 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __VisualTreeAsset__UsingEntryComparer()  = default;
public:
...
struct CORDL_TYPE __VisualTreeAsset__SlotDefinition : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field insertionPointId offset 0x8
 __declspec(property(get=__get_insertionPointId, put=__set_insertionPointId)) int32_t  insertionPointId;
...
constexpr int32_t& __get_insertionPointId() ;

constexpr int32_t const& __get_insertionPointId() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __VisualTreeAsset__SlotDefinition(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __VisualTreeAsset__SlotDefinition()  = default;
...
struct CORDL_TYPE __VisualTreeAsset__SlotUsageEntry : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x10};

/// @brief Field slotName offset 0x0
 __declspec(property(get=__get_slotName, put=__set_slotName)) ::StringW  slotName;

/// @brief Field assetId offset 0x8
 __declspec(property(get=__get_assetId, put=__set_assetId)) int32_t  assetId;

constexpr void __set_slotName(::StringW  value) ;

constexpr ::StringW& __get_slotName() ;

constexpr ::StringW const& __get_slotName() const;

constexpr void __set_assetId(int32_t  value) ;

constexpr int32_t& __get_assetId() ;

constexpr int32_t const& __get_assetId() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __VisualTreeAsset__SlotUsageEntry(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __VisualTreeAsset__SlotUsageEntry()  = default;
...
/// @brief Field <sent>5__1 offset 0x30
...
/// @brief Field <entry>5__3 offset 0x60
...
/// @brief Field <vta>5__4 offset 0x78
 __declspec(property(get=__get__vta_5__4, put=__set__vta_5__4)) ::UnityEngine::UIElements::VisualTreeAsset*  _vta_5__4;

 __declspec(property(get=System_Collections_Generic_IEnumerator_UnityEngine_UIElements_VisualTreeAsset__get_Current)) ::UnityEngine::UIElements::VisualTreeAsset*  System_Collections_Generic_IEnumerator_UnityEngine_UIElements_VisualTreeAsset__Current;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualTreeAsset*> __get___2__current() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualTreeAsset*> __get___4__this() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::UnityEngine::UIElements::VisualTreeAsset*>*> __get__sent_5__1() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualTreeAsset*> __get__vta_5__4() const;

static inline ::UnityEngine::UIElements::__VisualTreeAsset___get_templateDependencies_d__17* New_ctor(int32_t  __1__state) ;

/// @brief Method .ctor addr 0x2e1152c size 0x44 virtual false final false
inline void _ctor(int32_t  __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2e138e0 size 0x2c virtual true final true
inline void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2e1390c size 0x4e0 virtual true final true
inline bool MoveNext() ;

/// @brief Method <>m__Finally1 addr 0x2e13dec size 0x50 virtual false final false
inline void __m__Finally1() ;

/// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.UIElements.VisualTreeAsset>.get_Current addr 0x2e13e3c size 0x8 virtual true final true
...
/// @brief Method System.Collections.IEnumerator.Reset addr 0x2e13e44 size 0x40 virtual true final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2e13e84 size 0x8 virtual true final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.UIElements.VisualTreeAsset>.GetEnumerator addr 0x2e13e8c size 0xa0 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2e13f2c size 0x4 virtual true final true
...
// Ctor Parameters []
// @brief default ctor
 __VisualTreeAsset___get_templateDependencies_d__17()  = default;
public:
...
/// @brief Field <stylesheet>5__5 offset 0x70
...
/// @brief Field <stylesheet>5__8 offset 0x98
 ...
 __declspec(property(get=System_Collections_Generic_IEnumerator_UnityEngine_UIElements_StyleSheet__get_Current)) ::UnityEngine::UIElements::StyleSheet*  System_Collections_Generic_IEnumerator_UnityEngine_UIElements_StyleSheet__Current;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StyleSheet*> __get___2__current() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::UnityEngine::UIElements::StyleSheet*>*> __get__sent_5__1() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElementAsset*> __get__vea_5__3() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StyleSheet*> __get__stylesheet_5__5() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StyleSheet*> __get__stylesheet_5__8() const;

static inline ::UnityEngine::UIElements::__VisualTreeAsset___get_stylesheets_d__21* New_ctor(int32_t  __1__state) ;

/// @brief Method .ctor addr 0x2e115d4 size 0x44 virtual false final false
inline void _ctor(int32_t  __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2e13f30 size 0xec virtual true final true
inline void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2e1401c size 0x5bc virtual true final true
inline bool MoveNext() ;

/// @brief Method <>m__Finally1 addr 0x2e14678 size 0x50 virtual false final false
inline void __m__Finally1() ;

/// @brief Method <>m__Finally2 addr 0x2e145d8 size 0x50 virtual false final false
inline void __m__Finally2() ;

/// @brief Method <>m__Finally3 addr 0x2e14628 size 0x50 virtual false final false
inline void __m__Finally3() ;

/// @brief Method System.Collections.Generic.IEnumerator<UnityEngine.UIElements.StyleSheet>.get_Current addr 0x2e146c8 size 0x8 virtual true final true
...
/// @brief Method System.Collections.IEnumerator.Reset addr 0x2e146d0 size 0x40 virtual true final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2e14710 size 0x8 virtual true final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<UnityEngine.UIElements.StyleSheet>.GetEnumerator addr 0x2e14718 size 0xa0 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2e147b8 size 0x4 virtual true final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;
...
// Ctor Parameters []
// @brief default ctor
 __VisualTreeAsset___get_stylesheets_d__21()  = default;
public:
...
/// @brief Field childVea offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElementAsset*> __get_childVea() const;

static inline ::UnityEngine::UIElements::__VisualTreeAsset____c__DisplayClass45_0* New_ctor() ;

/// @brief Method .ctor addr 0x2e13194 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <CloneSetupRecursively>b__0 addr 0x2e147bc size 0x24 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __VisualTreeAsset____c__DisplayClass45_0()  = default;
public:
...
struct CORDL_TYPE __VisualTreeAsset____c__DisplayClass49_0 : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x8};

/// @brief Field asset offset 0x0
 __declspec(property(get=__get_asset, put=__set_asset)) ::UnityEngine::UIElements::VisualElementAsset*  asset;

constexpr void __set_asset(::UnityEngine::UIElements::VisualElementAsset*  value) ;

constexpr ::UnityEngine::UIElements::VisualElementAsset* __get_asset() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElementAsset*> __get_asset() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __VisualTreeAsset____c__DisplayClass49_0(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __VisualTreeAsset____c__DisplayClass49_0()  = default;
...
/// @brief Field inlineSheet offset 0x28
 __declspec(property(get=__get_inlineSheet, put=__set_inlineSheet)) ::UnityEngine::UIElements::StyleSheet*  inlineSheet;

/// @brief Field m_VisualElementAssets offset 0x30
 __declspec(property(get=__get_m_VisualElementAssets, put=__set_m_VisualElementAssets)) ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElementAsset*>*  m_VisualElementAssets;

/// @brief Field m_TemplateAssets offset 0x38
...
/// @brief Field m_Slots offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualTreeAsset__UsingEntry>*> __get_m_Usings() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::StyleSheet*> __get_inlineSheet() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElementAsset*>*> __get_m_VisualElementAssets() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::TemplateAsset*>*> __get_m_TemplateAssets() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualTreeAsset__SlotDefinition>*> __get_m_Slots() const;
...
/// @brief Method get_importedWithErrors addr 0x2e11440 size 0x8 virtual false final false
inline bool get_importedWithErrors() ;

/// @brief Method set_importedWithErrors addr 0x2e11448 size 0xc virtual false final false
inline void set_importedWithErrors(bool  value) ;

/// @brief Method get_importedWithWarnings addr 0x2e11454 size 0x8 virtual false final false
inline bool get_importedWithWarnings() ;

/// @brief Method set_importedWithWarnings addr 0x2e1145c size 0xc virtual false final false
inline void set_importedWithWarnings(bool  value) ;

/// @brief Method GetNextChildSerialNumber addr 0x2e11468 size 0x60 virtual false final false
inline int32_t GetNextChildSerialNumber() ;

/// @brief Method get_templateDependencies addr 0x2e114c8 size 0x64 virtual false final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::VisualTreeAsset*>* get_templateDependencies() ;

/// @brief Method get_stylesheets addr 0x2e11570 size 0x64 virtual false final false
inline ::System::Collections::Generic::IEnumerable_1<::UnityEngine::UIElements::StyleSheet*>* get_stylesheets() ;

/// @brief Method get_visualElementAssets addr 0x2e11618 size 0x8 virtual false final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElementAsset*>* get_visualElementAssets() ;

/// @brief Method set_visualElementAssets addr 0x2e11620 size 0x8 virtual false final false
inline void set_visualElementAssets(::System::Collections::Generic::List_1<::UnityEngine::UIElements::VisualElementAsset*>*  value) ;

/// @brief Method get_templateAssets addr 0x2e11628 size 0x8 virtual false final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::TemplateAsset*>* get_templateAssets() ;

/// @brief Method set_templateAssets addr 0x2e11630 size 0x8 virtual false final false
inline void set_templateAssets(::System::Collections::Generic::List_1<::UnityEngine::UIElements::TemplateAsset*>*  value) ;

/// @brief Method get_slots addr 0x2e11638 size 0x8 virtual false final false
inline ::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualTreeAsset__SlotDefinition>* get_slots() ;

/// @brief Method set_slots addr 0x2e11640 size 0x8 virtual false final false
inline void set_slots(::System::Collections::Generic::List_1<::UnityEngine::UIElements::__VisualTreeAsset__SlotDefinition>*  value) ;

/// @brief Method get_contentContainerId addr 0x2e11648 size 0x8 virtual false final false
inline int32_t get_contentContainerId() ;

/// @brief Method set_contentContainerId addr 0x2e11650 size 0x8 virtual false final false
inline void set_contentContainerId(int32_t  value) ;

/// @brief Method Instantiate addr 0x2e11658 size 0x180 virtual false final false
inline ::UnityEngine::UIElements::TemplateContainer* Instantiate() ;

/// @brief Method Instantiate addr 0x2e11e58 size 0x20 virtual false final false
inline ::UnityEngine::UIElements::TemplateContainer* Instantiate(::StringW  bindingPath) ;

/// @brief Method CloneTree addr 0x2e11e78 size 0x4 virtual false final false
inline ::UnityEngine::UIElements::TemplateContainer* CloneTree() ;

/// @brief Method CloneTree addr 0x2e11e7c size 0x20 virtual false final false
inline ::UnityEngine::UIElements::TemplateContainer* CloneTree(::StringW  bindingPath) ;

/// @brief Method CloneTree addr 0x2e11e9c size 0x1c virtual false final false
inline void CloneTree(::UnityEngine::UIElements::VisualElement*  target) ;

/// @brief Method CloneTree addr 0x2e11eb8 size 0x1dc virtual false final false
...
/// @brief Method CloneTree addr 0x2e117d8 size 0x680 virtual false final false
...
/// @brief Method CloneSetupRecursively addr 0x2e122d4 size 0x848 virtual false final false
...
/// @brief Method CompareForOrder addr 0x2e1319c size 0x34 virtual false final false
...
/// @brief Method TryGetSlotInsertionPoint addr 0x2e130dc size 0xb0 virtual false final false
inline bool TryGetSlotInsertionPoint(int32_t  insertionPointId, ByRef<::StringW>  slotName) ;

/// @brief Method ResolveTemplate addr 0x2e131d8 size 0x270 virtual false final false
inline ::UnityEngine::UIElements::VisualTreeAsset* ResolveTemplate(::StringW  templateName) ;

/// @brief Method Create addr 0x2e12b1c size 0x5c0 virtual false final false
...
/// @brief Method AssignClassListFromAssetToElement addr 0x2e1209c size 0x6c virtual false final false
...
/// @brief Method AssignStyleSheetFromAssetToElement addr 0x2e12108 size 0x1b8 virtual false final false
...
/// @brief Method get_contentHash addr 0x2e13780 size 0x8 virtual false final false
inline int32_t get_contentHash() ;

/// @brief Method set_contentHash addr 0x2e13788 size 0x8 virtual false final false
inline void set_contentHash(int32_t  value) ;

static inline ::UnityEngine::UIElements::VisualTreeAsset* New_ctor() ;

/// @brief Method .ctor addr 0x2e13790 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <Create>g__CreateError|49_0 addr 0x2e1345c size 0x144 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 VisualTreeAsset()  = default;
public:


// Fields

// Static field LinkedVEAInTemplatePropertyName

// Static field s_TemporarySlotInsertionPoints
