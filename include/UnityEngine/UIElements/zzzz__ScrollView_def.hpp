...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xc8 - sizeof(::UnityEngine::UIElements::__VisualElement__UxmlTraits)]{};

/// @brief Field m_ScrollViewMode offset 0x70
 __declspec(property(get=__get_m_ScrollViewMode, put=__set_m_ScrollViewMode)) ::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::UIElements::ScrollViewMode>*  m_ScrollViewMode;

/// @brief Field m_NestedInteractionKind offset 0x78
 __declspec(property(get=__get_m_NestedInteractionKind, put=__set_m_NestedInteractionKind)) ::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::UIElements::__ScrollView__NestedInteractionKind>*  m_NestedInteractionKind;

/// @brief Field m_ShowHorizontal offset 0x80
...
/// @brief Field m_ShowVertical offset 0x88
...
/// @brief Field m_HorizontalScrollerVisibility offset 0x90
 __declspec(property(get=__get_m_HorizontalScrollerVisibility, put=__set_m_HorizontalScrollerVisibility)) ::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::UIElements::ScrollerVisibility>*  m_HorizontalScrollerVisibility;

/// @brief Field m_VerticalScrollerVisibility offset 0x98
 __declspec(property(get=__get_m_VerticalScrollerVisibility, put=__set_m_VerticalScrollerVisibility)) ::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::UIElements::ScrollerVisibility>*  m_VerticalScrollerVisibility;

/// @brief Field m_HorizontalPageSize offset 0xa0
...
/// @brief Field m_VerticalPageSize offset 0xa8
...
/// @brief Field m_TouchScrollBehavior offset 0xb0
 __declspec(property(get=__get_m_TouchScrollBehavior, put=__set_m_TouchScrollBehavior)) ::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::UIElements::__ScrollView__TouchScrollBehavior>*  m_TouchScrollBehavior;

/// @brief Field m_ScrollDecelerationRate offset 0xb8
...
/// @brief Field m_Elasticity offset 0xc0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::UIElements::ScrollViewMode>*> __get_m_ScrollViewMode() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::UIElements::__ScrollView__NestedInteractionKind>*> __get_m_NestedInteractionKind() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlBoolAttributeDescription*> __get_m_ShowHorizontal() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlBoolAttributeDescription*> __get_m_ShowVertical() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::UIElements::ScrollerVisibility>*> __get_m_HorizontalScrollerVisibility() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::UIElements::ScrollerVisibility>*> __get_m_VerticalScrollerVisibility() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlFloatAttributeDescription*> __get_m_HorizontalPageSize() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlFloatAttributeDescription*> __get_m_VerticalPageSize() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlEnumAttributeDescription_1<::UnityEngine::UIElements::__ScrollView__TouchScrollBehavior>*> __get_m_TouchScrollBehavior() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlFloatAttributeDescription*> __get_m_ScrollDecelerationRate() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UxmlFloatAttributeDescription*> __get_m_Elasticity() const;
...
// Ctor Parameters []
// @brief default ctor
 __ScrollView__UxmlTraits()  = default;
public:
...
/// @brief The size of the true reference type
static constexpr auto  __IL2CPP_REFERENCE_TYPE_SIZE{0x468};

/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x468 - sizeof(::UnityEngine::UIElements::VisualElement)]{};

/// @brief Field m_HorizontalScrollerVisibility offset 0x3b0
...
/// @brief Field m_VerticalScrollerVisibility offset 0x3b4
...
/// @brief Field m_AttachedRootVisualContainer offset 0x3b8
...
/// @brief Field m_NestedInteractionKind offset 0x3d8
...
/// @brief Field <contentViewport>k__BackingField offset 0x3e0
...
/// @brief Field <horizontalScroller>k__BackingField offset 0x3e8
...
/// @brief Field <verticalScroller>k__BackingField offset 0x3f0
...
/// @brief Field m_ContentContainer offset 0x3f8
...
/// @brief Field m_ContentAndVerticalScrollContainer offset 0x400
...
/// @brief Field m_CapturedTargetPointerMoveCallback offset 0x450
 __declspec(property(get=__get_m_CapturedTargetPointerMoveCallback, put=__set_m_CapturedTargetPointerMoveCallback)) ::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::PointerMoveEvent*>*  m_CapturedTargetPointerMoveCallback;

/// @brief Field m_CapturedTargetPointerUpCallback offset 0x458
 __declspec(property(get=__get_m_CapturedTargetPointerUpCallback, put=__set_m_CapturedTargetPointerUpCallback)) ::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::PointerUpEvent*>*  m_CapturedTargetPointerUpCallback;

/// @brief Field m_PostPointerUpAnimation offset 0x460
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get_m_AttachedRootVisualContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get__contentViewport_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::Scroller*> __get__horizontalScroller_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::Scroller*> __get__verticalScroller_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get_m_ContentAndVerticalScrollContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::VisualElement*> __get_m_CapturedTarget() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::PointerMoveEvent*>*> __get_m_CapturedTargetPointerMoveCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::EventCallback_1<::UnityEngine::UIElements::PointerUpEvent*>*> __get_m_CapturedTargetPointerUpCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::IVisualElementScheduledItem*> __get_m_PostPointerUpAnimation() const;
...
// Static field k_DefaultScrollDecelerationRate

// Static field k_DefaultElasticity

// Static field ussClassName

// Static field viewportUssClassName

// Static field contentAndVerticalScrollUssClassName

// Static field contentUssClassName

// Static field hScrollerUssClassName

// Static field vScrollerUssClassName

// Static field horizontalVariantUssClassName

// Static field verticalVariantUssClassName

// Static field verticalHorizontalVariantUssClassName

// Static field scrollVariantUssClassName
...
namespace UnityEngine::UIElements {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7045)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6997), inst: 5274 }), TypeDefinitionIndex(TypeDefinitionIndex(6997)), TypeDefinitionIndex(TypeDefinitionIndex(7049))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x18 - sizeof(::UnityEngine::UIElements::UxmlFactory_2<::UnityEngine::UIElements::ScrollView*,::UnityEngine::UIElements::__ScrollView__UxmlTraits*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __ScrollView__UxmlFactory()  = default;
public:
...
struct CORDL_TYPE __ScrollView__TouchScrollBehavior : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____ScrollView__TouchScrollBehavior_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __ScrollView__TouchScrollBehavior(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ScrollView__TouchScrollBehavior()  = default;
...
struct CORDL_TYPE __ScrollView__NestedInteractionKind : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____ScrollView__NestedInteractionKind_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __ScrollView__NestedInteractionKind(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ScrollView__NestedInteractionKind()  = default;
...
struct CORDL_TYPE __ScrollView__TouchScrollingResult : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____ScrollView__TouchScrollingResult_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __ScrollView__TouchScrollingResult(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ScrollView__TouchScrollingResult()  = default;
