...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::BaseVisualElementPanel*, 0x20>(this, std::forward<::UnityEngine::UIElements::BaseVisualElementPanel*>(value));
}
constexpr ::UnityEngine::UIElements::BaseVisualElementPanel* UnityEngine::UIElements::UIRRepaintUpdater::__get_attachedPanel()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::BaseVisualElementPanel*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::BaseVisualElementPanel*> UnityEngine::UIElements::UIRRepaintUpdater::__get_attachedPanel() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::BaseVisualElementPanel*, 0x20>(this);
}
constexpr void UnityEngine::UIElements::UIRRepaintUpdater::__set_renderChain(::UnityEngine::UIElements::UIR::RenderChain*  value)  {
::cordl_internals::setInstanceField<::UnityEngine::UIElements::UIR::RenderChain*, 0x28>(this, std::forward<::UnityEngine::UIElements::UIR::RenderChain*>(value));
}
constexpr ::UnityEngine::UIElements::UIR::RenderChain* UnityEngine::UIElements::UIRRepaintUpdater::__get_renderChain()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::UIR::RenderChain*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIR::RenderChain*> UnityEngine::UIElements::UIRRepaintUpdater::__get_renderChain() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::UIR::RenderChain*, 0x28>(this);
}
