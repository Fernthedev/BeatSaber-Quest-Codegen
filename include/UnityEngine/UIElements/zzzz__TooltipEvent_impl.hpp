...
::cordl_internals::setInstanceField<::UnityEngine::Rect, 0x88>(this, std::forward<::UnityEngine::Rect>(value));
}
constexpr ::UnityEngine::Rect& UnityEngine::UIElements::TooltipEvent::__get__rect_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Rect, 0x88>(this);
}
