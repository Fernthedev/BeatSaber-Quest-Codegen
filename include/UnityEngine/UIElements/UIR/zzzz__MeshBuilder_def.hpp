...
static inline ::GlobalNamespace::__MeshBuilder__AllocMeshData__Allocator* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __MeshBuilder__AllocMeshData__Allocator()  = default;
public:
...
struct CORDL_TYPE __MeshBuilder__AllocMeshData : public ::bs_hook::ValueTypeWrapper<0x30> {
public:
// Declarations
...
/// @brief Field alloc offset 0x0
 __declspec(property(get=__get_alloc, put=__set_alloc)) ::GlobalNamespace::__MeshBuilder__AllocMeshData__Allocator*  alloc;

/// @brief Field texture offset 0x8
 __declspec(property(get=__get_texture, put=__set_texture)) ::UnityEngine::Texture*  texture;

/// @brief Field svgTexture offset 0x10
 __declspec(property(get=__get_svgTexture, put=__set_svgTexture)) ::UnityEngine::UIElements::TextureId  svgTexture;
...
/// @brief Field flags offset 0x20
 __declspec(property(get=__get_flags, put=__set_flags)) ::UnityEngine::UIElements::__MeshGenerationContext__MeshFlags  flags;

/// @brief Field colorAlloc offset 0x24
 __declspec(property(get=__get_colorAlloc, put=__set_colorAlloc)) ::UnityEngine::UIElements::UIR::BMPAlloc  colorAlloc;

constexpr void __set_alloc(::GlobalNamespace::__MeshBuilder__AllocMeshData__Allocator*  value) ;

constexpr ::GlobalNamespace::__MeshBuilder__AllocMeshData__Allocator* __get_alloc() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__MeshBuilder__AllocMeshData__Allocator*> __get_alloc() const;
...
constexpr ::UnityEngine::UIElements::TextureId& __get_svgTexture() ;

constexpr ::UnityEngine::UIElements::TextureId const& __get_svgTexture() const;
...
constexpr void __set_flags(::UnityEngine::UIElements::__MeshGenerationContext__MeshFlags  value) ;

constexpr ::UnityEngine::UIElements::__MeshGenerationContext__MeshFlags& __get_flags() ;

constexpr ::UnityEngine::UIElements::__MeshGenerationContext__MeshFlags const& __get_flags() const;

constexpr void __set_colorAlloc(::UnityEngine::UIElements::UIR::BMPAlloc  value) ;

constexpr ::UnityEngine::UIElements::UIR::BMPAlloc& __get_colorAlloc() ;

constexpr ::UnityEngine::UIElements::UIR::BMPAlloc const& __get_colorAlloc() const;
...
// Ctor Parameters [CppParam { name: "alloc", ty: "::GlobalNamespace::__MeshBuilder__AllocMeshData__Allocator*", modifiers: "", def_value: None }, CppParam { name: "texture", ty: "::UnityEngine::Texture*", modifiers: "", def_value: None }, CppParam { name: "svgTexture", ty: "::UnityEngine::UIElements::TextureId", modifiers: "", def_value: None }, CppParam { name: "material", ty: "::UnityEngine::Material*", modifiers: "", def_value: None }, CppParam { name: "flags", ty: "::UnityEngine::UIElements::__MeshGenerationContext__MeshFlags", modifiers: "", def_value: None }, CppParam { name: "colorAlloc", ty: "::UnityEngine::UIElements::UIR::BMPAlloc", modifiers: "", def_value: None }]
constexpr __MeshBuilder__AllocMeshData(::GlobalNamespace::__MeshBuilder__AllocMeshData__Allocator*  alloc, ::UnityEngine::Texture*  texture, ::UnityEngine::UIElements::TextureId  svgTexture, ::UnityEngine::Material*  material, ::UnityEngine::UIElements::__MeshGenerationContext__MeshFlags  flags, ::UnityEngine::UIElements::UIR::BMPAlloc  colorAlloc) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __MeshBuilder__AllocMeshData(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x30>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MeshBuilder__AllocMeshData()  = default;
...
struct CORDL_TYPE __MeshBuilder__ClipCounts : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x18};

/// @brief Field firstClippedIndex offset 0x0
 __declspec(property(get=__get_firstClippedIndex, put=__set_firstClippedIndex)) int32_t  firstClippedIndex;

/// @brief Field firstDegenerateIndex offset 0x4
 __declspec(property(get=__get_firstDegenerateIndex, put=__set_firstDegenerateIndex)) int32_t  firstDegenerateIndex;

/// @brief Field lastClippedIndex offset 0x8
 __declspec(property(get=__get_lastClippedIndex, put=__set_lastClippedIndex)) int32_t  lastClippedIndex;

/// @brief Field clippedTriangles offset 0xc
 __declspec(property(get=__get_clippedTriangles, put=__set_clippedTriangles)) int32_t  clippedTriangles;

/// @brief Field addedTriangles offset 0x10
 __declspec(property(get=__get_addedTriangles, put=__set_addedTriangles)) int32_t  addedTriangles;

/// @brief Field degenerateTriangles offset 0x14
 __declspec(property(get=__get_degenerateTriangles, put=__set_degenerateTriangles)) int32_t  degenerateTriangles;

constexpr void __set_firstClippedIndex(int32_t  value) ;

constexpr int32_t& __get_firstClippedIndex() ;

constexpr int32_t const& __get_firstClippedIndex() const;

constexpr void __set_firstDegenerateIndex(int32_t  value) ;

constexpr int32_t& __get_firstDegenerateIndex() ;

constexpr int32_t const& __get_firstDegenerateIndex() const;

constexpr void __set_lastClippedIndex(int32_t  value) ;

constexpr int32_t& __get_lastClippedIndex() ;

constexpr int32_t const& __get_lastClippedIndex() const;

constexpr void __set_clippedTriangles(int32_t  value) ;

constexpr int32_t& __get_clippedTriangles() ;

constexpr int32_t const& __get_clippedTriangles() const;

constexpr void __set_addedTriangles(int32_t  value) ;

constexpr int32_t& __get_addedTriangles() ;

constexpr int32_t const& __get_addedTriangles() const;

constexpr void __set_degenerateTriangles(int32_t  value) ;

constexpr int32_t& __get_degenerateTriangles() ;

constexpr int32_t const& __get_degenerateTriangles() const;
...
constexpr __MeshBuilder__ClipCounts(int32_t  firstClippedIndex, int32_t  firstDegenerateIndex, int32_t  lastClippedIndex, int32_t  clippedTriangles, int32_t  addedTriangles, int32_t  degenerateTriangles) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __MeshBuilder__ClipCounts(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MeshBuilder__ClipCounts()  = default;
...
struct CORDL_TYPE __MeshBuilder__VertexClipEdge : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____MeshBuilder__VertexClipEdge_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __MeshBuilder__VertexClipEdge(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MeshBuilder__VertexClipEdge()  = default;
...
static inline void MakeBorder(::UnityEngine::UIElements::__MeshGenerationContextUtils__BorderParams  borderParams, float_t  posZ, ::UnityEngine::UIElements::UIR::__MeshBuilder__AllocMeshData  meshAlloc) ;

/// @brief Method MakeSolidRect addr 0x2e921d0 size 0x154 virtual false final false
static inline void MakeSolidRect(::UnityEngine::UIElements::__MeshGenerationContextUtils__RectangleParams  rectParams, float_t  posZ, ::UnityEngine::UIElements::UIR::__MeshBuilder__AllocMeshData  meshAlloc) ;

/// @brief Method MakeTexturedRect addr 0x2e92db8 size 0x314 virtual false final false
static inline void MakeTexturedRect(::UnityEngine::UIElements::__MeshGenerationContextUtils__RectangleParams  rectParams, float_t  posZ, ::UnityEngine::UIElements::UIR::__MeshBuilder__AllocMeshData  meshAlloc, ::UnityEngine::UIElements::ColorPage  colorPage) ;
...
static inline void MakeText(::Unity::Collections::NativeArray_1<::UnityEngine::UIElements::TextVertex>  uiVertices, ::UnityEngine::Vector2  offset, ::UnityEngine::UIElements::UIR::__MeshBuilder__AllocMeshData  meshAlloc) ;

/// @brief Method UpdateText addr 0x2e95064 size 0x1b8 virtual false final false
static inline void UpdateText(::Unity::Collections::NativeArray_1<::UnityEngine::UIElements::TextVertex>  uiVertices, ::UnityEngine::Vector2  offset, ::UnityEngine::Matrix4x4  transform, ::UnityEngine::Color32  xformClipPages, ::UnityEngine::Color32  ids, ::UnityEngine::Color32  flags, ::UnityEngine::Color32  opacityPageSettingIndex, ::Unity::Collections::NativeSlice_1<::UnityEngine::UIElements::Vertex>  vertices) ;

/// @brief Method MakeQuad addr 0x2e930cc size 0xd58 virtual false final false
static inline void MakeQuad(::UnityEngine::Rect  rcPosition, ::UnityEngine::Rect  rcTexCoord, ::UnityEngine::Color  color, float_t  posZ, ::UnityEngine::UIElements::UIR::__MeshBuilder__AllocMeshData  meshAlloc, ::UnityEngine::UIElements::ColorPage  colorPage) ;

/// @brief Method MakeSlicedQuad addr 0x2e93e24 size 0x9a8 virtual false final false
static inline void MakeSlicedQuad(ByRef<::UnityEngine::UIElements::__MeshGenerationContextUtils__RectangleParams>  rectParams, float_t  posZ, ::UnityEngine::UIElements::UIR::__MeshBuilder__AllocMeshData  meshAlloc) ;

/// @brief Method MakeVectorGraphics addr 0x2e9521c size 0x3b0 virtual false final false
static inline void MakeVectorGraphics(::UnityEngine::UIElements::__MeshGenerationContextUtils__RectangleParams  rectParams, int32_t  settingIndexOffset, ::UnityEngine::UIElements::UIR::__MeshBuilder__AllocMeshData  meshAlloc, ByRef<int32_t>  finalVertexCount, ByRef<int32_t>  finalIndexCount) ;

/// @brief Method MakeVectorGraphicsStretchBackground addr 0x2e955cc size 0xfec virtual false final false
static inline void MakeVectorGraphicsStretchBackground(::ArrayW<::UnityEngine::UIElements::Vertex,::Array<::UnityEngine::UIElements::Vertex>*>  svgVertices, ::ArrayW<uint16_t,::Array<uint16_t>*>  svgIndices, float_t  svgWidth, float_t  svgHeight, ::UnityEngine::Rect  targetRect, ::UnityEngine::Rect  sourceUV, ::UnityEngine::ScaleMode  scaleMode, ::UnityEngine::Color  tint, int32_t  settingIndexOffset, ::UnityEngine::UIElements::UIR::__MeshBuilder__AllocMeshData  meshAlloc, ByRef<int32_t>  finalVertexCount, ByRef<int32_t>  finalIndexCount) ;

/// @brief Method SplitTriangle addr 0x2e9774c size 0xc48 virtual false final false
static inline void SplitTriangle(::cordl_internals::Ptr<::UnityEngine::UIElements::Vertex>  vertices, ::cordl_internals::Ptr<uint16_t>  indices, ByRef<int32_t>  vertexCount, int32_t  indexToProcess, ByRef<int32_t>  indexCount, float_t  svgWidth, float_t  svgHeight, ::UnityEngine::Vector4  sliceLTRB, int32_t  sliceIndex) ;

/// @brief Method ScaleSplittedTriangles addr 0x2e98394 size 0x284 virtual false final false
static inline void ScaleSplittedTriangles(::cordl_internals::Ptr<::UnityEngine::UIElements::Vertex>  vertices, int32_t  vertexCount, float_t  svgWidth, float_t  svgHeight, ::UnityEngine::Rect  targetRect, ::UnityEngine::Vector4  sliceLTRB) ;

/// @brief Method MakeVectorGraphics9SliceBackground addr 0x2e965b8 size 0xbac virtual false final false
static inline void MakeVectorGraphics9SliceBackground(::ArrayW<::UnityEngine::UIElements::Vertex,::Array<::UnityEngine::UIElements::Vertex>*>  svgVertices, ::ArrayW<uint16_t,::Array<uint16_t>*>  svgIndices, float_t  svgWidth, float_t  svgHeight, ::UnityEngine::Rect  targetRect, ::UnityEngine::Vector4  sliceLTRB, bool  stretch, ::UnityEngine::Color  tint, int32_t  settingIndexOffset, ::UnityEngine::UIElements::UIR::__MeshBuilder__AllocMeshData  meshAlloc) ;

/// @brief Method UpperBoundApproximateRectClippingResults addr 0x2e97164 size 0x1ac virtual false final false
static inline ::UnityEngine::UIElements::UIR::__MeshBuilder__ClipCounts UpperBoundApproximateRectClippingResults(::ArrayW<::UnityEngine::UIElements::Vertex,::Array<::UnityEngine::UIElements::Vertex>*>  vertices, ::ArrayW<uint16_t,::Array<uint16_t>*>  indices, ::UnityEngine::Vector4  clipRectMinMax) ;

/// @brief Method RectClip addr 0x2e97310 size 0x43c virtual false final false
static inline void RectClip(::ArrayW<::UnityEngine::UIElements::Vertex,::Array<::UnityEngine::UIElements::Vertex>*>  vertices, ::ArrayW<uint16_t,::Array<uint16_t>*>  indices, ::UnityEngine::Vector4  clipRectMinMax, ::UnityEngine::UIElements::MeshWriteData*  mwd, ::UnityEngine::UIElements::UIR::__MeshBuilder__ClipCounts  cc, ByRef<int32_t>  newVertexCount) ;

/// @brief Method RectClipTriangle addr 0x2e98618 size 0xb5c virtual false final false
static inline void RectClipTriangle(::cordl_internals::Ptr<::UnityEngine::UIElements::Vertex>  vt, ::cordl_internals::Ptr<uint16_t>  it, ::UnityEngine::Vector4  clipRectMinMax, ::UnityEngine::UIElements::MeshWriteData*  mwd, ByRef<uint16_t>  nextNewVertex) ;
...
// Static field s_VectorGraphics9Slice

// Static field s_VectorGraphicsSplitTriangle

// Static field s_VectorGraphicsScaleTriangle

// Static field s_VectorGraphicsStretch

// Static field s_MaxTextMeshVertices

// Static field slicedQuadIndices

// Static field k_TexCoordSlicesX

// Static field k_TexCoordSlicesY

// Static field k_PositionSlicesX

// Static field k_PositionSlicesY

// Static field s_AllClipEdges
