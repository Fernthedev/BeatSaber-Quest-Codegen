...
/// @brief Field m_Atlas offset 0x10
 __declspec(property(get=__get_m_Atlas, put=__set_m_Atlas)) ::UnityEngine::UIElements::AtlasBase*  m_Atlas;

/// @brief Field m_Registered offset 0x18
 __declspec(property(get=__get_m_Registered, put=__set_m_Registered)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::VectorImage*,::UnityEngine::UIElements::UIR::VectorImageRenderInfo*>*  m_Registered;

/// @brief Field m_RenderInfoPool offset 0x20
...
/// @brief Field m_GradientRemapPool offset 0x28
...
/// @brief Field m_GradientSettingsAtlas offset 0x30
...
/// @brief Field m_LoggedExhaustedSettingsAtlas offset 0x38
...
/// @brief Field <disposed>k__BackingField offset 0x39
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityEngine::UIElements::VectorImage*,::UnityEngine::UIElements::UIR::VectorImageRenderInfo*>*> __get_m_Registered() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIR::VectorImageRenderInfoPool*> __get_m_RenderInfoPool() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIR::GradientRemapPool*> __get_m_GradientRemapPool() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIR::GradientSettingsAtlas*> __get_m_GradientSettingsAtlas() const;
...
// Static field s_MarkerRegister

// Static field s_MarkerUnregister
