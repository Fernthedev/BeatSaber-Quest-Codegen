...
/// @brief Method ProcessOnClippingChanged addr 0x2dd5d38 size 0xec virtual false final false
...
/// @brief Method ProcessOnOpacityChanged addr 0x2dd6300 size 0xe4 virtual false final false
...
/// @brief Method ProcessOnColorChanged addr 0x2dd6768 size 0x88 virtual false final false
...
/// @brief Method ProcessOnTransformOrSizeChanged addr 0x2dd69bc size 0xc0 virtual false final false
...
/// @brief Method ProcessOnVisualsChanged addr 0x2dd6e00 size 0x104 virtual false final false
...
/// @brief Method ProcessRegenText addr 0x2dd7324 size 0x5c virtual false final false
static inline void ProcessRegenText(::UnityEngine::UIElements::UIR::RenderChain*  renderChain, ::UnityEngine::UIElements::VisualElement*  ve, ::UnityEngine::UIElements::UIR::Implementation::UIRTextUpdatePainter*  painter, ::UnityEngine::UIElements::UIR::UIRenderDevice*  device, ByRef<::UnityEngine::UIElements::UIR::ChainBuilderStats>  stats) ;

/// @brief Method GetTransformIDTransformInfo addr 0x2dd7380 size 0x150 virtual false final false
static inline ::UnityEngine::Matrix4x4 GetTransformIDTransformInfo(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method GetClipRectIDClipInfo addr 0x2dd74d0 size 0x1bc virtual false final false
static inline ::UnityEngine::Vector4 GetClipRectIDClipInfo(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method DepthFirstOnChildAdded addr 0x2dd768c size 0x528 virtual false final false
...
/// @brief Method DepthFirstOnChildRemoving addr 0x2dd85e0 size 0x45c virtual false final false
...
/// @brief Method DepthFirstOnClippingChanged addr 0x2dd5e24 size 0x4dc virtual false final false
...
/// @brief Method DepthFirstOnOpacityChanged addr 0x2dd63e4 size 0x384 virtual false final false
...
/// @brief Method OnColorChanged addr 0x2dd67f0 size 0x1cc virtual false final false
...
/// @brief Method DepthFirstOnTransformOrSizeChanged addr 0x2dd6a7c size 0x384 virtual false final false
...
/// @brief Method DepthFirstOnVisualsChanged addr 0x2dd6fc4 size 0x360 virtual false final false
...
/// @brief Method UpdateTextCoreSettings addr 0x2dd8b48 size 0x3d8 virtual false final false
...
/// @brief Method IsElementHierarchyHidden addr 0x2dd6f04 size 0xc0 virtual false final false
static inline bool IsElementHierarchyHidden(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method GetLastDeepestChild addr 0x2dd7ce8 size 0x80 virtual false final false
static inline ::UnityEngine::UIElements::VisualElement* GetLastDeepestChild(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method DetermineSelfClipMethod addr 0x2dd8a3c size 0x10c virtual false final false
...
/// @brief Method UpdateLocalFlipsWinding addr 0x2dd7bb4 size 0x134 virtual false final false
static inline bool UpdateLocalFlipsWinding(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method UpdateWorldFlipsWinding addr 0x2dd9098 size 0x58 virtual false final false
static inline void UpdateWorldFlipsWinding(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method UpdateZeroScaling addr 0x2dd8f20 size 0x178 virtual false final false
static inline void UpdateZeroScaling(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method NeedsTransformID addr 0x2dd7d68 size 0x3c virtual false final false
static inline bool NeedsTransformID(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method NeedsColorID addr 0x2dd7da4 size 0x20 virtual false final false
static inline bool NeedsColorID(::UnityEngine::UIElements::VisualElement*  ve) ;

/// @brief Method InitColorIDs addr 0x2dd7dc4 size 0x444 virtual false final false
...
/// @brief Method SetColorValues addr 0x2dd8208 size 0x3d8 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 RenderEvents()  = default;
public:


// Fields

// Static field VisibilityTreshold
