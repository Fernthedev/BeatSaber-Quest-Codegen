...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::UnityEngine::UIElements::UIR::TextCoreSettings::*)(::System::Object*)>(&::UnityEngine::UIElements::UIR::TextCoreSettings::Equals)> {
...
constexpr ::UnityEngine::Color& UnityEngine::UIElements::UIR::TextCoreSettings::__get_faceColor()  {
...
constexpr ::UnityEngine::Color const& UnityEngine::UIElements::UIR::TextCoreSettings::__get_faceColor() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Color, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Color& UnityEngine::UIElements::UIR::TextCoreSettings::__get_outlineColor()  {
...
constexpr ::UnityEngine::Color const& UnityEngine::UIElements::UIR::TextCoreSettings::__get_outlineColor() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Color, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr float_t& UnityEngine::UIElements::UIR::TextCoreSettings::__get_outlineWidth()  {
return ::cordl_internals::getInstanceField<float_t, 0x20>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr float_t const& UnityEngine::UIElements::UIR::TextCoreSettings::__get_outlineWidth() const {
return ::cordl_internals::getInstanceField<float_t, 0x20>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::UnityEngine::Color& UnityEngine::UIElements::UIR::TextCoreSettings::__get_underlayColor()  {
...
constexpr ::UnityEngine::Color const& UnityEngine::UIElements::UIR::TextCoreSettings::__get_underlayColor() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Color, 0x24>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void UnityEngine::UIElements::UIR::TextCoreSettings::__set_underlayOffset(::UnityEngine::Vector2  value)  {
::cordl_internals::setInstanceField<::UnityEngine::Vector2, 0x34>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::UnityEngine::Vector2>(value));
}
constexpr ::UnityEngine::Vector2& UnityEngine::UIElements::UIR::TextCoreSettings::__get_underlayOffset()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0x34>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::UnityEngine::Vector2 const& UnityEngine::UIElements::UIR::TextCoreSettings::__get_underlayOffset() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0x34>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr float_t& UnityEngine::UIElements::UIR::TextCoreSettings::__get_underlaySoftness()  {
return ::cordl_internals::getInstanceField<float_t, 0x3c>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr float_t const& UnityEngine::UIElements::UIR::TextCoreSettings::__get_underlaySoftness() const {
return ::cordl_internals::getInstanceField<float_t, 0x3c>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
