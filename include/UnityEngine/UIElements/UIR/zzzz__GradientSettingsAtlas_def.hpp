...
struct CORDL_TYPE __GradientSettingsAtlas__RawTexture : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
/// @brief Field rgba offset 0x0
 __declspec(property(get=__get_rgba, put=__set_rgba)) ::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*>  rgba;
...
constexpr void __set_rgba(::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*>  value) ;

constexpr ::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*>& __get_rgba() ;

constexpr ::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*> const& __get_rgba() const;
...
constexpr explicit __GradientSettingsAtlas__RawTexture(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __GradientSettingsAtlas__RawTexture()  = default;
...
/// @brief Field m_ElemWidth offset 0x14
...
/// @brief Field m_RawAtlas offset 0x28
...
/// @brief Field <disposed>k__BackingField offset 0x38
...
/// @brief Field <MustCommit>k__BackingField offset 0x39
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIR::BestFitAllocator*> __get_m_Allocator() const;

constexpr void __set_m_Atlas(::UnityEngine::Texture2D*  value) ;

constexpr ::UnityEngine::Texture2D* __get_m_Atlas() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Texture2D*> __get_m_Atlas() const;
...
// Ctor Parameters []
// @brief default ctor
 GradientSettingsAtlas()  = default;
public:


// Fields

// Static field s_MarkerWrite

// Static field s_MarkerCommit
