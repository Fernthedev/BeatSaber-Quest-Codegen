...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::UnityEngine::UIElements::UIR::GradientRemap::*)()>(&::UnityEngine::UIElements::UIR::GradientRemap::_ctor)> {
...
::cordl_internals::setInstanceField<::UnityEngine::RectInt, 0x20>(this, std::forward<::UnityEngine::RectInt>(value));
}
constexpr ::UnityEngine::RectInt& UnityEngine::UIElements::UIR::GradientRemap::__get_location()  {
return ::cordl_internals::getInstanceField<::UnityEngine::RectInt, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::UnityEngine::UIElements::UIR::GradientRemap*, 0x30>(this, std::forward<::UnityEngine::UIElements::UIR::GradientRemap*>(value));
}
constexpr ::UnityEngine::UIElements::UIR::GradientRemap* UnityEngine::UIElements::UIR::GradientRemap::__get_next()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::UIR::GradientRemap*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIR::GradientRemap*> UnityEngine::UIElements::UIR::GradientRemap::__get_next() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::UIR::GradientRemap*, 0x30>(this);
}
constexpr void UnityEngine::UIElements::UIR::GradientRemap::__set_atlas(::UnityEngine::UIElements::TextureId  value)  {
::cordl_internals::setInstanceField<::UnityEngine::UIElements::TextureId, 0x38>(this, std::forward<::UnityEngine::UIElements::TextureId>(value));
}
constexpr ::UnityEngine::UIElements::TextureId& UnityEngine::UIElements::UIR::GradientRemap::__get_atlas()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UIElements::TextureId, 0x38>(this);
}
