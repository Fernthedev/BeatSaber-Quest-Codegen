...
/// @brief Field allocator offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIR::BestFitAllocator*> __get_allocator() const;
...
namespace UnityEngine::UIElements::UIR {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(7399)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(7399), inst: 3979 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x58 - sizeof(::UnityEngine::UIElements::UIR::LinkedPoolItem_1<::UnityEngine::UIElements::UIR::__Allocator2D__Row*>)]{};

/// @brief Field rect offset 0x18
 __declspec(property(get=__get_rect, put=__set_rect)) ::UnityEngine::RectInt  rect;

/// @brief Field area offset 0x28
 __declspec(property(get=__get_area, put=__set_area)) ::UnityEngine::UIElements::UIR::__Allocator2D__Area*  area;

/// @brief Field allocator offset 0x30
 __declspec(property(get=__get_allocator, put=__set_allocator)) ::UnityEngine::UIElements::UIR::BestFitAllocator*  allocator;

/// @brief Field alloc offset 0x38
 __declspec(property(get=__get_alloc, put=__set_alloc)) ::UnityEngine::UIElements::UIR::Alloc  alloc;

/// @brief Field next offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIR::__Allocator2D__Area*> __get_area() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIR::__Allocator2D__Row*> __get_next() const;
...
struct CORDL_TYPE __Allocator2D__Alloc2D : public ::bs_hook::ValueTypeWrapper<0x30> {
public:
// Declarations
...
/// @brief Field row offset 0x10
 __declspec(property(get=__get_row, put=__set_row)) ::UnityEngine::UIElements::UIR::__Allocator2D__Row*  row;

/// @brief Field alloc offset 0x18
 __declspec(property(get=__get_alloc, put=__set_alloc)) ::UnityEngine::UIElements::UIR::Alloc  alloc;
...
constexpr void __set_row(::UnityEngine::UIElements::UIR::__Allocator2D__Row*  value) ;

constexpr ::UnityEngine::UIElements::UIR::__Allocator2D__Row* __get_row() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::UIR::__Allocator2D__Row*> __get_row() const;
...
constexpr explicit __Allocator2D__Alloc2D(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x30>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Allocator2D__Alloc2D()  = default;
...
/// @brief Field m_Areas offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::UIElements::UIR::__Allocator2D__Area*>*> __get_m_Areas() const;
