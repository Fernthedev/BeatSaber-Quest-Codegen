...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x88 - sizeof(::UnityEngine::UIElements::KeyboardEventBase_1<::UnityEngine::UIElements::KeyUpEvent*>)]{};

static inline ::UnityEngine::UIElements::KeyUpEvent* New_ctor() ;

/// @brief Method .ctor addr 0x2e52c64 size 0x48 virtual false final false
inline void _ctor() ;
