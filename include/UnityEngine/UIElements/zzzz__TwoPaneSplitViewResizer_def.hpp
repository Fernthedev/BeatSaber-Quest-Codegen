...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::TwoPaneSplitView*> __get_m_SplitView() const;
...
static inline ::UnityEngine::UIElements::TwoPaneSplitViewResizer* New_ctor(::UnityEngine::UIElements::TwoPaneSplitView*  splitView, int32_t  dir, ::UnityEngine::UIElements::TwoPaneSplitViewOrientation  orientation) ;
...
// Ctor Parameters []
// @brief default ctor
 TwoPaneSplitViewResizer()  = default;
public:
