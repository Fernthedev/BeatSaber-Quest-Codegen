...
/// @brief Field m_CallbackRegistry offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UIElements::EventCallbackRegistry*> __get_m_CallbackRegistry() const;
