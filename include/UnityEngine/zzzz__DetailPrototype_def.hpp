...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_Prototype() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Texture2D*> __get_m_PrototypeTexture() const;
...
// Ctor Parameters []
// @brief default ctor
 DetailPrototype()  = default;
public:


// Fields

// Static field DefaultHealthColor

// Static field DefaultDryColor
