...
/// @brief Method get_sharedMesh addr 0x2d1649c size 0x3c virtual false final false
inline ::UnityEngine::Mesh* get_sharedMesh() ;

/// @brief Method set_sharedMesh addr 0x2d164d8 size 0x44 virtual false final false
inline void set_sharedMesh(::UnityEngine::Mesh*  value) ;

/// @brief Method get_convex addr 0x2d1651c size 0x3c virtual false final false
inline bool get_convex() ;

/// @brief Method set_convex addr 0x2d16558 size 0x44 virtual false final false
