...
// Self: TypeDefinitionIndex(TypeDefinitionIndex(15779))
...
/// @brief Method .ctor addr 0x2eba654 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 AspMvcActionSelectorAttribute()  = default;
public:
