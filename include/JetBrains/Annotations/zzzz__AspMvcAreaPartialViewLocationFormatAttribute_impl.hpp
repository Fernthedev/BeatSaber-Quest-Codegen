...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::AspMvcAreaPartialViewLocationFormatAttribute::*)(::StringW)>(&::JetBrains::Annotations::AspMvcAreaPartialViewLocationFormatAttribute::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x2eba42c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::AspMvcAreaPartialViewLocationFormatAttribute::*)(::StringW)>(&::JetBrains::Annotations::AspMvcAreaPartialViewLocationFormatAttribute::set_Format)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2eba45c;
...
constexpr void JetBrains::Annotations::AspMvcAreaPartialViewLocationFormatAttribute::__set__Format_k__BackingField(::StringW  value)  {
::cordl_internals::setInstanceField<::StringW, 0x10>(this, std::forward<::StringW>(value));
}
constexpr ::StringW& JetBrains::Annotations::AspMvcAreaPartialViewLocationFormatAttribute::__get__Format_k__BackingField()  {
return ::cordl_internals::getInstanceField<::StringW, 0x10>(this);
}
constexpr ::StringW const& JetBrains::Annotations::AspMvcAreaPartialViewLocationFormatAttribute::__get__Format_k__BackingField() const {
return ::cordl_internals::getInstanceField<::StringW, 0x10>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::JetBrains::Annotations::AspMvcAreaPartialViewLocationFormatAttribute*>(format));
}
