...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::AspMvcMasterLocationFormatAttribute::*)(::StringW)>(&::JetBrains::Annotations::AspMvcMasterLocationFormatAttribute::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x2eba49c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::StringW (::JetBrains::Annotations::AspMvcMasterLocationFormatAttribute::*)()>(&::JetBrains::Annotations::AspMvcMasterLocationFormatAttribute::get_Format)> {
  ...
  constexpr static std::size_t addrs = 0x2eba4c4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::AspMvcMasterLocationFormatAttribute::*)(::StringW)>(&::JetBrains::Annotations::AspMvcMasterLocationFormatAttribute::set_Format)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2eba4cc;
...
constexpr ::StringW& JetBrains::Annotations::AspMvcMasterLocationFormatAttribute::__get__Format_k__BackingField()  {
return ::cordl_internals::getInstanceField<::StringW, 0x10>(this);
}
constexpr ::StringW const& JetBrains::Annotations::AspMvcMasterLocationFormatAttribute::__get__Format_k__BackingField() const {
return ::cordl_internals::getInstanceField<::StringW, 0x10>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::JetBrains::Annotations::AspMvcMasterLocationFormatAttribute*>(format));
}
