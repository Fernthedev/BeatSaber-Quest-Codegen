...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::MeansImplicitUseAttribute::*)()>(&::JetBrains::Annotations::MeansImplicitUseAttribute::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::MeansImplicitUseAttribute::*)(::JetBrains::Annotations::ImplicitUseKindFlags)>(&::JetBrains::Annotations::MeansImplicitUseAttribute::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::MeansImplicitUseAttribute::*)(::JetBrains::Annotations::ImplicitUseTargetFlags)>(&::JetBrains::Annotations::MeansImplicitUseAttribute::_ctor)> {
  constexpr static std::size_t size = 0x2c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::MeansImplicitUseAttribute::*)(::JetBrains::Annotations::ImplicitUseKindFlags, ::JetBrains::Annotations::ImplicitUseTargetFlags)>(&::JetBrains::Annotations::MeansImplicitUseAttribute::_ctor)> {
  constexpr static std::size_t size = 0x2c;
...
::cordl_internals::setInstanceField<::JetBrains::Annotations::ImplicitUseKindFlags, 0x10>(this, std::forward<::JetBrains::Annotations::ImplicitUseKindFlags>(value));
}
...
return ::cordl_internals::getInstanceField<::JetBrains::Annotations::ImplicitUseKindFlags, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::JetBrains::Annotations::ImplicitUseTargetFlags, 0x14>(this, std::forward<::JetBrains::Annotations::ImplicitUseTargetFlags>(value));
}
...
return ::cordl_internals::getInstanceField<::JetBrains::Annotations::ImplicitUseTargetFlags, 0x14>(this);
}
