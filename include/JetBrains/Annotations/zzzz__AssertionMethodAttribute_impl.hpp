...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::AssertionMethodAttribute::*)()>(&::JetBrains::Annotations::AssertionMethodAttribute::_ctor)> {
