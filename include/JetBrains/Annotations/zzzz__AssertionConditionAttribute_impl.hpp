...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::AssertionConditionAttribute::*)(::JetBrains::Annotations::AssertionConditionType)>(&::JetBrains::Annotations::AssertionConditionAttribute::_ctor)> {
  constexpr static std::size_t size = 0x28;
  constexpr static std::size_t addrs = 0x2eba71c;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::JetBrains::Annotations::AssertionConditionType>::get()}
                        )));
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::JetBrains::Annotations::AssertionConditionType (::JetBrains::Annotations::AssertionConditionAttribute::*)()>(&::JetBrains::Annotations::AssertionConditionAttribute::get_ConditionType)> {
  ...
  constexpr static std::size_t addrs = 0x2eba744;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::JetBrains::Annotations::AssertionConditionAttribute::*)(::JetBrains::Annotations::AssertionConditionType)>(&::JetBrains::Annotations::AssertionConditionAttribute::set_ConditionType)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2eba74c;
...
::cordl_internals::setInstanceField<::JetBrains::Annotations::AssertionConditionType, 0x10>(this, std::forward<::JetBrains::Annotations::AssertionConditionType>(value));
}
...
return ::cordl_internals::getInstanceField<::JetBrains::Annotations::AssertionConditionType, 0x10>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::JetBrains::Annotations::AssertionConditionAttribute*>(conditionType));
}
