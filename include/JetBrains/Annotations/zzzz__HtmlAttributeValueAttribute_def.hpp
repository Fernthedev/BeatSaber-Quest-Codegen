...
/// @brief Method .ctor addr 0x2eba69c size 0x28 virtual false final false
inline void _ctor(::StringW  name) ;

/// @brief Method get_Name addr 0x2eba6c4 size 0x8 virtual false final false
inline ::StringW get_Name() ;

/// @brief Method set_Name addr 0x2eba6cc size 0x8 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 HtmlAttributeValueAttribute()  = default;
public:
