...
namespace Priority_Queue {
template<::il2cpp_utils::il2cpp_reference_type T>
class __StablePriorityQueue_1___GetEnumerator_d__22<T>;
}
// Write type traits
...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(6102))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6102), inst: 2 })
// CS Name: ::StablePriorityQueue`1::<GetEnumerator>d__22<T>*
class CORDL_TYPE __StablePriorityQueue_1___GetEnumerator_d__22<T> : public ::System::Object {
public:
// Declarations
...
constexpr ::cordl_internals::to_const_pointer<::Priority_Queue::StablePriorityQueue_1<T>*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __StablePriorityQueue_1___GetEnumerator_d__22()  = default;
public:
...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(6103)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(6103), inst: 2 })
// CS Name: ::Priority_Queue::StablePriorityQueue`1<T>*
class CORDL_TYPE StablePriorityQueue_1<T> : public ::System::Object {
public:
// Declarations
