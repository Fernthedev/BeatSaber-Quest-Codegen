...
::cordl_internals::setInstanceField<::OVR::OpenVR::IVRTrackedCamera, 0x10>(this, std::forward<::OVR::OpenVR::IVRTrackedCamera>(value));
}
constexpr ::OVR::OpenVR::IVRTrackedCamera& OVR::OpenVR::CVRTrackedCamera::__get_FnTable()  {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRTrackedCamera, 0x10>(this);
}
constexpr ::OVR::OpenVR::IVRTrackedCamera const& OVR::OpenVR::CVRTrackedCamera::__get_FnTable() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRTrackedCamera, 0x10>(this);
}
inline ::OVR::OpenVR::CVRTrackedCamera* OVR::OpenVR::CVRTrackedCamera::New_ctor(::cordl_internals::intptr_t  pInterface)  {
return THROW_UNLESS(::il2cpp_utils::New<::OVR::OpenVR::CVRTrackedCamera*>(pInterface));
}
inline void OVR::OpenVR::CVRTrackedCamera::_ctor(::cordl_internals::intptr_t  pInterface)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OVR::OpenVR::CVRTrackedCamera*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
