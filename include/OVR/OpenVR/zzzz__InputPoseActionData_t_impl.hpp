...
constexpr bool& OVR::OpenVR::InputPoseActionData_t::__get_bActive()  {
return ::cordl_internals::getInstanceField<bool, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr bool const& OVR::OpenVR::InputPoseActionData_t::__get_bActive() const {
return ::cordl_internals::getInstanceField<bool, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr uint64_t& OVR::OpenVR::InputPoseActionData_t::__get_activeOrigin()  {
return ::cordl_internals::getInstanceField<uint64_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint64_t const& OVR::OpenVR::InputPoseActionData_t::__get_activeOrigin() const {
return ::cordl_internals::getInstanceField<uint64_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void OVR::OpenVR::InputPoseActionData_t::__set_pose(::OVR::OpenVR::TrackedDevicePose_t  value)  {
::cordl_internals::setInstanceField<::OVR::OpenVR::TrackedDevicePose_t, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::OVR::OpenVR::TrackedDevicePose_t>(value));
}
constexpr ::OVR::OpenVR::TrackedDevicePose_t& OVR::OpenVR::InputPoseActionData_t::__get_pose()  {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::TrackedDevicePose_t, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::OVR::OpenVR::TrackedDevicePose_t const& OVR::OpenVR::InputPoseActionData_t::__get_pose() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::TrackedDevicePose_t, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::OVR::OpenVR::InputPoseActionData_t::InputPoseActionData_t(bool  bActive, uint64_t  activeOrigin, ::OVR::OpenVR::TrackedDevicePose_t  pose) noexcept : ::bs_hook::ValueTypeWrapper<0x60>() {this->bActive = bActive;
