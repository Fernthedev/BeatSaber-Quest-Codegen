...
::cordl_internals::setInstanceField<::OVR::OpenVR::IVRChaperone, 0x10>(this, std::forward<::OVR::OpenVR::IVRChaperone>(value));
}
constexpr ::OVR::OpenVR::IVRChaperone& OVR::OpenVR::CVRChaperone::__get_FnTable()  {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRChaperone, 0x10>(this);
}
constexpr ::OVR::OpenVR::IVRChaperone const& OVR::OpenVR::CVRChaperone::__get_FnTable() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRChaperone, 0x10>(this);
}
inline ::OVR::OpenVR::CVRChaperone* OVR::OpenVR::CVRChaperone::New_ctor(::cordl_internals::intptr_t  pInterface)  {
return THROW_UNLESS(::il2cpp_utils::New<::OVR::OpenVR::CVRChaperone*>(pInterface));
}
inline void OVR::OpenVR::CVRChaperone::_ctor(::cordl_internals::intptr_t  pInterface)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OVR::OpenVR::CVRChaperone*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
