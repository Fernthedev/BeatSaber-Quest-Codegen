...
struct CORDL_TYPE RenderModel_t : public ::bs_hook::ValueTypeWrapper<0x20> {
public:
// Declarations
...
constexpr explicit RenderModel_t(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x20>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 RenderModel_t()  = default;
