...
::cordl_internals::setInstanceField<::OVR::OpenVR::IVRNotifications, 0x10>(this, std::forward<::OVR::OpenVR::IVRNotifications>(value));
}
constexpr ::OVR::OpenVR::IVRNotifications& OVR::OpenVR::CVRNotifications::__get_FnTable()  {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRNotifications, 0x10>(this);
}
constexpr ::OVR::OpenVR::IVRNotifications const& OVR::OpenVR::CVRNotifications::__get_FnTable() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRNotifications, 0x10>(this);
}
inline ::OVR::OpenVR::CVRNotifications* OVR::OpenVR::CVRNotifications::New_ctor(::cordl_internals::intptr_t  pInterface)  {
return THROW_UNLESS(::il2cpp_utils::New<::OVR::OpenVR::CVRNotifications*>(pInterface));
}
inline void OVR::OpenVR::CVRNotifications::_ctor(::cordl_internals::intptr_t  pInterface)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OVR::OpenVR::CVRNotifications*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
