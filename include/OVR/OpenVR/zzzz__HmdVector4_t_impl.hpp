...
constexpr ::OVR::OpenVR::HmdVector4_t::HmdVector4_t(float_t  v0, float_t  v1, float_t  v2, float_t  v3) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->v0 = v0;
this->v1 = v1;
this->v2 = v2;
this->v3 = v3;
}
