...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::OVR::OpenVR::RenderModel_TextureMap_t_Packed::*)(::OVR::OpenVR::RenderModel_TextureMap_t)>(&::OVR::OpenVR::RenderModel_TextureMap_t_Packed::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x27f6784;
...
constexpr uint16_t& OVR::OpenVR::RenderModel_TextureMap_t_Packed::__get_unWidth()  {
return ::cordl_internals::getInstanceField<uint16_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint16_t const& OVR::OpenVR::RenderModel_TextureMap_t_Packed::__get_unWidth() const {
return ::cordl_internals::getInstanceField<uint16_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr uint16_t& OVR::OpenVR::RenderModel_TextureMap_t_Packed::__get_unHeight()  {
return ::cordl_internals::getInstanceField<uint16_t, 0x2>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint16_t const& OVR::OpenVR::RenderModel_TextureMap_t_Packed::__get_unHeight() const {
return ::cordl_internals::getInstanceField<uint16_t, 0x2>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void OVR::OpenVR::RenderModel_TextureMap_t_Packed::__set_rubTextureMapData(::cordl_internals::intptr_t  value)  {
::cordl_internals::setInstanceField<::cordl_internals::intptr_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::cordl_internals::intptr_t>(value));
}
constexpr ::cordl_internals::intptr_t& OVR::OpenVR::RenderModel_TextureMap_t_Packed::__get_rubTextureMapData()  {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::cordl_internals::intptr_t const& OVR::OpenVR::RenderModel_TextureMap_t_Packed::__get_rubTextureMapData() const {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::OVR::OpenVR::RenderModel_TextureMap_t_Packed::RenderModel_TextureMap_t_Packed(uint16_t  unWidth, uint16_t  unHeight, ::cordl_internals::intptr_t  rubTextureMapData) noexcept : ::bs_hook::ValueTypeWrapper<0xc>() {this->unWidth = unWidth;
