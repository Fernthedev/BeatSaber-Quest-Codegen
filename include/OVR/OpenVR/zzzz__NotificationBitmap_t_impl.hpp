...
constexpr ::cordl_internals::intptr_t& OVR::OpenVR::NotificationBitmap_t::__get_m_pImageData()  {
...
constexpr ::cordl_internals::intptr_t const& OVR::OpenVR::NotificationBitmap_t::__get_m_pImageData() const {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& OVR::OpenVR::NotificationBitmap_t::__get_m_nWidth()  {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& OVR::OpenVR::NotificationBitmap_t::__get_m_nWidth() const {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& OVR::OpenVR::NotificationBitmap_t::__get_m_nHeight()  {
return ::cordl_internals::getInstanceField<int32_t, 0xc>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& OVR::OpenVR::NotificationBitmap_t::__get_m_nHeight() const {
return ::cordl_internals::getInstanceField<int32_t, 0xc>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& OVR::OpenVR::NotificationBitmap_t::__get_m_nBytesPerPixel()  {
return ::cordl_internals::getInstanceField<int32_t, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& OVR::OpenVR::NotificationBitmap_t::__get_m_nBytesPerPixel() const {
return ::cordl_internals::getInstanceField<int32_t, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::OVR::OpenVR::NotificationBitmap_t::NotificationBitmap_t(::cordl_internals::intptr_t  m_pImageData, int32_t  m_nWidth, int32_t  m_nHeight, int32_t  m_nBytesPerPixel) noexcept : ::bs_hook::ValueTypeWrapper<0x18>() {this->m_pImageData = m_pImageData;
