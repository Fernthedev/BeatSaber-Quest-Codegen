...
constexpr uint32_t& OVR::OpenVR::VREvent_Screenshot_t::__get_handle()  {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& OVR::OpenVR::VREvent_Screenshot_t::__get_handle() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr uint32_t& OVR::OpenVR::VREvent_Screenshot_t::__get_type()  {
return ::cordl_internals::getInstanceField<uint32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& OVR::OpenVR::VREvent_Screenshot_t::__get_type() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::OVR::OpenVR::VREvent_Screenshot_t::VREvent_Screenshot_t(uint32_t  handle, uint32_t  type) noexcept : ::bs_hook::ValueTypeWrapper<0x8>() {this->handle = handle;
this->type = type;
}
