...
struct CORDL_TYPE HmdMatrix44_t : public ::bs_hook::ValueTypeWrapper<0x40> {
public:
// Declarations
...
/// @brief Field m14 offset 0x38
 __declspec(property(get=__get_m14, put=__set_m14)) float_t  m14;

/// @brief Field m15 offset 0x3c
 __declspec(property(get=__get_m15, put=__set_m15)) float_t  m15;
...
constexpr float_t& __get_m14() ;

constexpr float_t const& __get_m14() const;

constexpr void __set_m15(float_t  value) ;

constexpr float_t& __get_m15() ;

constexpr float_t const& __get_m15() const;
...
constexpr explicit HmdMatrix44_t(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x40>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 HmdMatrix44_t()  = default;
