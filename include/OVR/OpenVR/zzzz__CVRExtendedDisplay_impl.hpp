...
::cordl_internals::setInstanceField<::OVR::OpenVR::IVRExtendedDisplay, 0x10>(this, std::forward<::OVR::OpenVR::IVRExtendedDisplay>(value));
}
constexpr ::OVR::OpenVR::IVRExtendedDisplay& OVR::OpenVR::CVRExtendedDisplay::__get_FnTable()  {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRExtendedDisplay, 0x10>(this);
}
constexpr ::OVR::OpenVR::IVRExtendedDisplay const& OVR::OpenVR::CVRExtendedDisplay::__get_FnTable() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRExtendedDisplay, 0x10>(this);
}
inline ::OVR::OpenVR::CVRExtendedDisplay* OVR::OpenVR::CVRExtendedDisplay::New_ctor(::cordl_internals::intptr_t  pInterface)  {
return THROW_UNLESS(::il2cpp_utils::New<::OVR::OpenVR::CVRExtendedDisplay*>(pInterface));
}
inline void OVR::OpenVR::CVRExtendedDisplay::_ctor(::cordl_internals::intptr_t  pInterface)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OVR::OpenVR::CVRExtendedDisplay*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
