...
constexpr ::cordl_internals::intptr_t& OVR::OpenVR::AppOverrideKeys_t::__get_pchKey()  {
...
constexpr ::cordl_internals::intptr_t const& OVR::OpenVR::AppOverrideKeys_t::__get_pchKey() const {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::cordl_internals::intptr_t& OVR::OpenVR::AppOverrideKeys_t::__get_pchValue()  {
...
constexpr ::cordl_internals::intptr_t const& OVR::OpenVR::AppOverrideKeys_t::__get_pchValue() const {
return ::cordl_internals::getInstanceField<::cordl_internals::intptr_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::OVR::OpenVR::AppOverrideKeys_t::AppOverrideKeys_t(::cordl_internals::intptr_t  pchKey, ::cordl_internals::intptr_t  pchValue) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->pchKey = pchKey;
