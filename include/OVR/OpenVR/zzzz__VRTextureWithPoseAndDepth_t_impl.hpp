...
constexpr ::OVR::OpenVR::VRTextureDepthInfo_t& OVR::OpenVR::VRTextureWithPoseAndDepth_t::__get_depth()  {
...
constexpr ::OVR::OpenVR::VRTextureDepthInfo_t const& OVR::OpenVR::VRTextureWithPoseAndDepth_t::__get_depth() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::VRTextureDepthInfo_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "depth", ty: "::OVR::OpenVR::VRTextureDepthInfo_t", modifiers: "", def_value: Some("{}") }]
constexpr ::OVR::OpenVR::VRTextureWithPoseAndDepth_t::VRTextureWithPoseAndDepth_t(::OVR::OpenVR::VRTextureDepthInfo_t  depth) noexcept : ::bs_hook::ValueTypeWrapper<0x50>() {this->depth = depth;
}
