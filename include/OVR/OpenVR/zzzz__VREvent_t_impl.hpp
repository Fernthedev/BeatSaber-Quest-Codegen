...
constexpr uint32_t& OVR::OpenVR::VREvent_t::__get_eventType()  {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& OVR::OpenVR::VREvent_t::__get_eventType() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr uint32_t& OVR::OpenVR::VREvent_t::__get_trackedDeviceIndex()  {
return ::cordl_internals::getInstanceField<uint32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& OVR::OpenVR::VREvent_t::__get_trackedDeviceIndex() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr float_t& OVR::OpenVR::VREvent_t::__get_eventAgeSeconds()  {
return ::cordl_internals::getInstanceField<float_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr float_t const& OVR::OpenVR::VREvent_t::__get_eventAgeSeconds() const {
return ::cordl_internals::getInstanceField<float_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void OVR::OpenVR::VREvent_t::__set_data(::OVR::OpenVR::VREvent_Data_t  value)  {
::cordl_internals::setInstanceField<::OVR::OpenVR::VREvent_Data_t, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::OVR::OpenVR::VREvent_Data_t>(value));
}
constexpr ::OVR::OpenVR::VREvent_Data_t& OVR::OpenVR::VREvent_t::__get_data()  {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::VREvent_Data_t, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::OVR::OpenVR::VREvent_Data_t const& OVR::OpenVR::VREvent_t::__get_data() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::VREvent_Data_t, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::OVR::OpenVR::VREvent_t::VREvent_t(uint32_t  eventType, uint32_t  trackedDeviceIndex, float_t  eventAgeSeconds, ::OVR::OpenVR::VREvent_Data_t  data) noexcept : ::bs_hook::ValueTypeWrapper<0x30>() {this->eventType = eventType;
