...
constexpr uint32_t& OVR::OpenVR::DriverDirectMode_FrameTiming::__get_m_nSize()  {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& OVR::OpenVR::DriverDirectMode_FrameTiming::__get_m_nSize() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr uint32_t& OVR::OpenVR::DriverDirectMode_FrameTiming::__get_m_nNumFramePresents()  {
return ::cordl_internals::getInstanceField<uint32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& OVR::OpenVR::DriverDirectMode_FrameTiming::__get_m_nNumFramePresents() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr uint32_t& OVR::OpenVR::DriverDirectMode_FrameTiming::__get_m_nNumMisPresented()  {
return ::cordl_internals::getInstanceField<uint32_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& OVR::OpenVR::DriverDirectMode_FrameTiming::__get_m_nNumMisPresented() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr uint32_t& OVR::OpenVR::DriverDirectMode_FrameTiming::__get_m_nNumDroppedFrames()  {
return ::cordl_internals::getInstanceField<uint32_t, 0xc>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& OVR::OpenVR::DriverDirectMode_FrameTiming::__get_m_nNumDroppedFrames() const {
return ::cordl_internals::getInstanceField<uint32_t, 0xc>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr uint32_t& OVR::OpenVR::DriverDirectMode_FrameTiming::__get_m_nReprojectionFlags()  {
return ::cordl_internals::getInstanceField<uint32_t, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& OVR::OpenVR::DriverDirectMode_FrameTiming::__get_m_nReprojectionFlags() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::OVR::OpenVR::DriverDirectMode_FrameTiming::DriverDirectMode_FrameTiming(uint32_t  m_nSize, uint32_t  m_nNumFramePresents, uint32_t  m_nNumMisPresented, uint32_t  m_nNumDroppedFrames, uint32_t  m_nReprojectionFlags) noexcept : ::bs_hook::ValueTypeWrapper<0x14>() {this->m_nSize = m_nSize;
