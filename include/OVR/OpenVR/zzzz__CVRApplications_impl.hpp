...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::OVR::OpenVR::EVRApplicationError (::OVR::OpenVR::CVRApplications::*)(::StringW, ::StringW, ::ArrayW<::OVR::OpenVR::AppOverrideKeys_t,::Array<::OVR::OpenVR::AppOverrideKeys_t>*>)>(&::OVR::OpenVR::CVRApplications::LaunchTemplateApplication)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<::OVR::OpenVR::AppOverrideKeys_t,::Array<::OVR::OpenVR::AppOverrideKeys_t>*>>::get()}
                        )));
    return ___internal_method;
  }
};
...
::cordl_internals::setInstanceField<::OVR::OpenVR::IVRApplications, 0x10>(this, std::forward<::OVR::OpenVR::IVRApplications>(value));
}
constexpr ::OVR::OpenVR::IVRApplications& OVR::OpenVR::CVRApplications::__get_FnTable()  {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRApplications, 0x10>(this);
}
constexpr ::OVR::OpenVR::IVRApplications const& OVR::OpenVR::CVRApplications::__get_FnTable() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRApplications, 0x10>(this);
}
inline ::OVR::OpenVR::CVRApplications* OVR::OpenVR::CVRApplications::New_ctor(::cordl_internals::intptr_t  pInterface)  {
return THROW_UNLESS(::il2cpp_utils::New<::OVR::OpenVR::CVRApplications*>(pInterface));
}
inline void OVR::OpenVR::CVRApplications::_ctor(::cordl_internals::intptr_t  pInterface)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OVR::OpenVR::CVRApplications*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
