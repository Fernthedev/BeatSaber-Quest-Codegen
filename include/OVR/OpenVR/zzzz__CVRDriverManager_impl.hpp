...
::cordl_internals::setInstanceField<::OVR::OpenVR::IVRDriverManager, 0x10>(this, std::forward<::OVR::OpenVR::IVRDriverManager>(value));
}
constexpr ::OVR::OpenVR::IVRDriverManager& OVR::OpenVR::CVRDriverManager::__get_FnTable()  {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRDriverManager, 0x10>(this);
}
constexpr ::OVR::OpenVR::IVRDriverManager const& OVR::OpenVR::CVRDriverManager::__get_FnTable() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRDriverManager, 0x10>(this);
}
inline ::OVR::OpenVR::CVRDriverManager* OVR::OpenVR::CVRDriverManager::New_ctor(::cordl_internals::intptr_t  pInterface)  {
return THROW_UNLESS(::il2cpp_utils::New<::OVR::OpenVR::CVRDriverManager*>(pInterface));
}
inline void OVR::OpenVR::CVRDriverManager::_ctor(::cordl_internals::intptr_t  pInterface)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OVR::OpenVR::CVRDriverManager*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
