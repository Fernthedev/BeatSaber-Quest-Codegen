...
static inline ::OVR::OpenVR::__IVRDriverManager___GetDriverCount* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __IVRDriverManager___GetDriverCount()  = default;
public:
...
static inline ::OVR::OpenVR::__IVRDriverManager___GetDriverName* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __IVRDriverManager___GetDriverName()  = default;
public:
...
static inline ::OVR::OpenVR::__IVRDriverManager___GetDriverHandle* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __IVRDriverManager___GetDriverHandle()  = default;
public:
...
struct CORDL_TYPE IVRDriverManager : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
...
/// @brief Field GetDriverCount offset 0x0
 __declspec(property(get=__get_GetDriverCount, put=__set_GetDriverCount)) ::OVR::OpenVR::__IVRDriverManager___GetDriverCount*  GetDriverCount;

/// @brief Field GetDriverName offset 0x8
 __declspec(property(get=__get_GetDriverName, put=__set_GetDriverName)) ::OVR::OpenVR::__IVRDriverManager___GetDriverName*  GetDriverName;

/// @brief Field GetDriverHandle offset 0x10
 __declspec(property(get=__get_GetDriverHandle, put=__set_GetDriverHandle)) ::OVR::OpenVR::__IVRDriverManager___GetDriverHandle*  GetDriverHandle;

constexpr void __set_GetDriverCount(::OVR::OpenVR::__IVRDriverManager___GetDriverCount*  value) ;

constexpr ::OVR::OpenVR::__IVRDriverManager___GetDriverCount* __get_GetDriverCount() ;

constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::__IVRDriverManager___GetDriverCount*> __get_GetDriverCount() const;

constexpr void __set_GetDriverName(::OVR::OpenVR::__IVRDriverManager___GetDriverName*  value) ;

constexpr ::OVR::OpenVR::__IVRDriverManager___GetDriverName* __get_GetDriverName() ;

constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::__IVRDriverManager___GetDriverName*> __get_GetDriverName() const;

constexpr void __set_GetDriverHandle(::OVR::OpenVR::__IVRDriverManager___GetDriverHandle*  value) ;

constexpr ::OVR::OpenVR::__IVRDriverManager___GetDriverHandle* __get_GetDriverHandle() ;

constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::__IVRDriverManager___GetDriverHandle*> __get_GetDriverHandle() const;
...
constexpr explicit IVRDriverManager(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}
