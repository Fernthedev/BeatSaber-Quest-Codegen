...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::OVR::OpenVR::EVRScreenshotError (::OVR::OpenVR::CVRScreenshots::*)(::ArrayW<::OVR::OpenVR::EVRScreenshotType,::Array<::OVR::OpenVR::EVRScreenshotType>*>)>(&::OVR::OpenVR::CVRScreenshots::HookScreenshot)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "HookScreenshot",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::ArrayW<::OVR::OpenVR::EVRScreenshotType,::Array<::OVR::OpenVR::EVRScreenshotType>*>>::get()}
                        )));
    return ___internal_method;
  }
};
...
::cordl_internals::setInstanceField<::OVR::OpenVR::IVRScreenshots, 0x10>(this, std::forward<::OVR::OpenVR::IVRScreenshots>(value));
}
constexpr ::OVR::OpenVR::IVRScreenshots& OVR::OpenVR::CVRScreenshots::__get_FnTable()  {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRScreenshots, 0x10>(this);
}
constexpr ::OVR::OpenVR::IVRScreenshots const& OVR::OpenVR::CVRScreenshots::__get_FnTable() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRScreenshots, 0x10>(this);
}
inline ::OVR::OpenVR::CVRScreenshots* OVR::OpenVR::CVRScreenshots::New_ctor(::cordl_internals::intptr_t  pInterface)  {
return THROW_UNLESS(::il2cpp_utils::New<::OVR::OpenVR::CVRScreenshots*>(pInterface));
}
inline void OVR::OpenVR::CVRScreenshots::_ctor(::cordl_internals::intptr_t  pInterface)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OVR::OpenVR::CVRScreenshots*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
