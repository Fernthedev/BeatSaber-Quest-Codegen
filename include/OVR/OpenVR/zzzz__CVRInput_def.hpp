...
static inline ::OVR::OpenVR::CVRInput* New_ctor(::cordl_internals::intptr_t  pInterface) ;
...
inline ::OVR::OpenVR::EVRInputError DecompressSkeletalBoneData(::cordl_internals::intptr_t  pvCompressedBuffer, uint32_t  unCompressedBufferSize, ByRef<::OVR::OpenVR::EVRSkeletalTransformSpace>  peTransformSpace, ::ArrayW<::OVR::OpenVR::VRBoneTransform_t,::Array<::OVR::OpenVR::VRBoneTransform_t>*>  pTransformArray) ;
