...
static inline ::OVR::OpenVR::__CVROverlay___PollNextOverlayEventPacked* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __CVROverlay___PollNextOverlayEventPacked()  = default;
public:
...
struct CORDL_TYPE __CVROverlay__PollNextOverlayEventUnion : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x8};

/// @brief Field pPollNextOverlayEvent offset 0x0
...
/// @brief Field pPollNextOverlayEventPacked offset 0x0
...
constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::__IVROverlay___PollNextOverlayEvent*> __get_pPollNextOverlayEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::__CVROverlay___PollNextOverlayEventPacked*> __get_pPollNextOverlayEventPacked() const;
...
constexpr explicit __CVROverlay__PollNextOverlayEventUnion(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __CVROverlay__PollNextOverlayEventUnion()  = default;
...
/// @brief The size of the true reference type
static constexpr auto  __IL2CPP_REFERENCE_TYPE_SIZE{0x2a0};

/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x2a0 - sizeof(::System::Object)]{};
...
static inline ::OVR::OpenVR::CVROverlay* New_ctor(::cordl_internals::intptr_t  pInterface) ;
...
inline ::OVR::OpenVR::EVROverlayError GetOverlayImageData(uint64_t  ulOverlayHandle, ::cordl_internals::intptr_t  pvBuffer, uint32_t  unBufferSize, ByRef<uint32_t>  punWidth, ByRef<uint32_t>  punHeight) ;
...
inline ::OVR::OpenVR::EVROverlayError SetOverlayDualAnalogTransform(uint64_t  ulOverlay, ::OVR::OpenVR::EDualAnalogWhich  eWhich, ::cordl_internals::intptr_t  vCenter, float_t  fRadius) ;
...
inline ::OVR::OpenVR::EVROverlayError SetOverlayRaw(uint64_t  ulOverlayHandle, ::cordl_internals::intptr_t  pvBuffer, uint32_t  unWidth, uint32_t  unHeight, uint32_t  unDepth) ;
...
inline ::OVR::OpenVR::EVROverlayError ReleaseNativeOverlayHandle(uint64_t  ulOverlayHandle, ::cordl_internals::intptr_t  pNativeTextureHandle) ;
