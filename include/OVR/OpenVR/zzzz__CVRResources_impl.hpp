...
::cordl_internals::setInstanceField<::OVR::OpenVR::IVRResources, 0x10>(this, std::forward<::OVR::OpenVR::IVRResources>(value));
}
constexpr ::OVR::OpenVR::IVRResources& OVR::OpenVR::CVRResources::__get_FnTable()  {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRResources, 0x10>(this);
}
constexpr ::OVR::OpenVR::IVRResources const& OVR::OpenVR::CVRResources::__get_FnTable() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRResources, 0x10>(this);
}
inline ::OVR::OpenVR::CVRResources* OVR::OpenVR::CVRResources::New_ctor(::cordl_internals::intptr_t  pInterface)  {
return THROW_UNLESS(::il2cpp_utils::New<::OVR::OpenVR::CVRResources*>(pInterface));
}
inline void OVR::OpenVR::CVRResources::_ctor(::cordl_internals::intptr_t  pInterface)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OVR::OpenVR::CVRResources*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
