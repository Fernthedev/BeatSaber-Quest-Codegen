...
/// @brief Field m_pVRTrackedCamera offset 0x60
...
/// @brief Field m_pVRSpatialAnchors offset 0x70
...
constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::CVRSystem*> __get_m_pVRSystem() const;

constexpr void __set_m_pVRChaperone(::OVR::OpenVR::CVRChaperone*  value) ;

constexpr ::OVR::OpenVR::CVRChaperone* __get_m_pVRChaperone() ;

constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::CVRChaperone*> __get_m_pVRChaperone() const;
...
constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::CVRChaperoneSetup*> __get_m_pVRChaperoneSetup() const;
...
constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::CVRCompositor*> __get_m_pVRCompositor() const;

constexpr void __set_m_pVROverlay(::OVR::OpenVR::CVROverlay*  value) ;

constexpr ::OVR::OpenVR::CVROverlay* __get_m_pVROverlay() ;

constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::CVROverlay*> __get_m_pVROverlay() const;
...
constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::CVRRenderModels*> __get_m_pVRRenderModels() const;
...
constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::CVRExtendedDisplay*> __get_m_pVRExtendedDisplay() const;

constexpr void __set_m_pVRSettings(::OVR::OpenVR::CVRSettings*  value) ;

constexpr ::OVR::OpenVR::CVRSettings* __get_m_pVRSettings() ;

constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::CVRSettings*> __get_m_pVRSettings() const;
...
constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::CVRApplications*> __get_m_pVRApplications() const;
...
constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::CVRScreenshots*> __get_m_pVRScreenshots() const;
...
constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::CVRTrackedCamera*> __get_m_pVRTrackedCamera() const;

constexpr void __set_m_pVRInput(::OVR::OpenVR::CVRInput*  value) ;

constexpr ::OVR::OpenVR::CVRInput* __get_m_pVRInput() ;

constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::CVRInput*> __get_m_pVRInput() const;
...
constexpr ::cordl_internals::to_const_pointer<::OVR::OpenVR::CVRSpatialAnchors*> __get_m_pVRSpatialAnchors() const;
...
// Ctor Parameters []
// @brief default ctor
 __OpenVR__COpenVRContext()  = default;
public:
...
static inline ::cordl_internals::intptr_t GetGenericInterface(::StringW  pchInterfaceVersion, ByRef<::OVR::OpenVR::EVRInitError>  peError) ;
...
// Static field <VRToken>k__BackingField

// Static field _OpenVRInternal_ModuleContext
