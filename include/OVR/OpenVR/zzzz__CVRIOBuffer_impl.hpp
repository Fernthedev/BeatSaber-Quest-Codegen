...
::cordl_internals::setInstanceField<::OVR::OpenVR::IVRIOBuffer, 0x10>(this, std::forward<::OVR::OpenVR::IVRIOBuffer>(value));
}
constexpr ::OVR::OpenVR::IVRIOBuffer& OVR::OpenVR::CVRIOBuffer::__get_FnTable()  {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRIOBuffer, 0x10>(this);
}
constexpr ::OVR::OpenVR::IVRIOBuffer const& OVR::OpenVR::CVRIOBuffer::__get_FnTable() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::IVRIOBuffer, 0x10>(this);
}
inline ::OVR::OpenVR::CVRIOBuffer* OVR::OpenVR::CVRIOBuffer::New_ctor(::cordl_internals::intptr_t  pInterface)  {
return THROW_UNLESS(::il2cpp_utils::New<::OVR::OpenVR::CVRIOBuffer*>(pInterface));
}
inline void OVR::OpenVR::CVRIOBuffer::_ctor(::cordl_internals::intptr_t  pInterface)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OVR::OpenVR::CVRIOBuffer*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
...
inline ::OVR::OpenVR::EIOBufferError OVR::OpenVR::CVRIOBuffer::Read(uint64_t  ulBuffer, ::cordl_internals::intptr_t  pDst, uint32_t  unBytes, ByRef<uint32_t>  punRead)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OVR::OpenVR::CVRIOBuffer*>::get(),
                            "Read",
                            std::vector<Il2CppClass*>{},
...
inline ::OVR::OpenVR::EIOBufferError OVR::OpenVR::CVRIOBuffer::Write(uint64_t  ulBuffer, ::cordl_internals::intptr_t  pSrc, uint32_t  unBytes)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::OVR::OpenVR::CVRIOBuffer*>::get(),
                            "Write",
                            std::vector<Il2CppClass*>{},
