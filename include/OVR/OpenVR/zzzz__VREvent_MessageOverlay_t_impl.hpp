...
constexpr uint32_t& OVR::OpenVR::VREvent_MessageOverlay_t::__get_unVRMessageOverlayResponse()  {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& OVR::OpenVR::VREvent_MessageOverlay_t::__get_unVRMessageOverlayResponse() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "unVRMessageOverlayResponse", ty: "uint32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::OVR::OpenVR::VREvent_MessageOverlay_t::VREvent_MessageOverlay_t(uint32_t  unVRMessageOverlayResponse) noexcept : ::bs_hook::ValueTypeWrapper<0x4>() {this->unVRMessageOverlayResponse = unVRMessageOverlayResponse;
}
