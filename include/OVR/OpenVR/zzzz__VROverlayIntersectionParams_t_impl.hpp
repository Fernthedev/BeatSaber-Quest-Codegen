...
constexpr ::OVR::OpenVR::HmdVector3_t& OVR::OpenVR::VROverlayIntersectionParams_t::__get_vSource()  {
...
constexpr ::OVR::OpenVR::HmdVector3_t const& OVR::OpenVR::VROverlayIntersectionParams_t::__get_vSource() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::HmdVector3_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::OVR::OpenVR::HmdVector3_t& OVR::OpenVR::VROverlayIntersectionParams_t::__get_vDirection()  {
...
constexpr ::OVR::OpenVR::HmdVector3_t const& OVR::OpenVR::VROverlayIntersectionParams_t::__get_vDirection() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::HmdVector3_t, 0xc>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void OVR::OpenVR::VROverlayIntersectionParams_t::__set_eOrigin(::OVR::OpenVR::ETrackingUniverseOrigin  value)  {
::cordl_internals::setInstanceField<::OVR::OpenVR::ETrackingUniverseOrigin, 0x18>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::OVR::OpenVR::ETrackingUniverseOrigin>(value));
}
constexpr ::OVR::OpenVR::ETrackingUniverseOrigin& OVR::OpenVR::VROverlayIntersectionParams_t::__get_eOrigin()  {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::ETrackingUniverseOrigin, 0x18>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::OVR::OpenVR::ETrackingUniverseOrigin const& OVR::OpenVR::VROverlayIntersectionParams_t::__get_eOrigin() const {
return ::cordl_internals::getInstanceField<::OVR::OpenVR::ETrackingUniverseOrigin, 0x18>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::OVR::OpenVR::VROverlayIntersectionParams_t::VROverlayIntersectionParams_t(::OVR::OpenVR::HmdVector3_t  vSource, ::OVR::OpenVR::HmdVector3_t  vDirection, ::OVR::OpenVR::ETrackingUniverseOrigin  eOrigin) noexcept : ::bs_hook::ValueTypeWrapper<0x1c>() {this->vSource = vSource;
