...
struct CORDL_TYPE RenderModel_TextureMap_t_Packed : public ::bs_hook::ValueTypeWrapper<0xc> {
public:
// Declarations
...
/// @brief Field rubTextureMapData offset 0x4
...
/// @brief Method .ctor addr 0x27f6784 size 0x14 virtual false final false
inline void _ctor(::OVR::OpenVR::RenderModel_TextureMap_t  unpacked) ;

/// @brief Method Unpack addr 0x27f6798 size 0x1c virtual false final false
...
constexpr explicit RenderModel_TextureMap_t_Packed(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0xc>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 RenderModel_TextureMap_t_Packed()  = default;
