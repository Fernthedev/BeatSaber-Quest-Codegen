...
constexpr ::OVR::OpenVR::HmdVector2_t::HmdVector2_t(float_t  v0, float_t  v1) noexcept : ::bs_hook::ValueTypeWrapper<0x8>() {this->v0 = v0;
this->v1 = v1;
}
