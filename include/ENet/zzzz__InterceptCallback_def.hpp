...
static inline ::ENet::InterceptCallback* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
inline int32_t Invoke(ByRef<::ENet::Event>  event, ByRef<::ENet::Address>  address, ::cordl_internals::intptr_t  receivedData, int32_t  receivedDataLength) ;

/// @brief Method BeginInvoke addr 0x21ef2f4 size 0x11c virtual true final false
inline ::System::IAsyncResult* BeginInvoke(ByRef<::ENet::Event>  event, ByRef<::ENet::Address>  address, ::cordl_internals::intptr_t  receivedData, int32_t  receivedDataLength, ::System::AsyncCallback*  callback, ::System::Object*  object) ;
