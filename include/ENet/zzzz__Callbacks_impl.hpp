...
::cordl_internals::setInstanceField<::ENet::ENetCallbacks, 0x10>(this, std::forward<::ENet::ENetCallbacks>(value));
}
constexpr ::ENet::ENetCallbacks& ENet::Callbacks::__get_nativeCallbacks()  {
return ::cordl_internals::getInstanceField<::ENet::ENetCallbacks, 0x10>(this);
}
