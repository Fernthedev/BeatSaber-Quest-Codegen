...
static inline ::ENet::FreeCallback* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
inline void Invoke(::cordl_internals::intptr_t  memory) ;

/// @brief Method BeginInvoke addr 0x21eef14 size 0x84 virtual true final false
inline ::System::IAsyncResult* BeginInvoke(::cordl_internals::intptr_t  memory, ::System::AsyncCallback*  callback, ::System::Object*  object) ;
