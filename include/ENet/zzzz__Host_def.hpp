...
/// @brief Field nativeHost offset 0x10
 __declspec(property(get=__get_nativeHost, put=__set_nativeHost)) ::cordl_internals::intptr_t  nativeHost;
...
constexpr ::cordl_internals::intptr_t& __get_nativeHost() ;

constexpr ::cordl_internals::intptr_t const& __get_nativeHost() const;
...
inline void SetInterceptCallback(::cordl_internals::intptr_t  callback) ;
...
inline void SetChecksumCallback(::cordl_internals::intptr_t  callback) ;
