...
static inline ::ENet::ChecksumCallback* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method .ctor addr 0x21ef444 size 0xc4 virtual false final false
inline void _ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method Invoke addr 0x21ef508 size 0x14 virtual true final false
inline uint64_t Invoke(::cordl_internals::intptr_t  buffers, int32_t  bufferCount) ;

/// @brief Method BeginInvoke addr 0x21ef51c size 0xb4 virtual true final false
inline ::System::IAsyncResult* BeginInvoke(::cordl_internals::intptr_t  buffers, int32_t  bufferCount, ::System::AsyncCallback*  callback, ::System::Object*  object) ;

/// @brief Method EndInvoke addr 0x21ef5d0 size 0x28 virtual true final false
