...
::cordl_internals::setInstanceField<::ENet::ENetEvent, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::ENet::ENetEvent>(value));
}
constexpr ::ENet::ENetEvent& ENet::Event::__get_nativeEvent()  {
return ::cordl_internals::getInstanceField<::ENet::ENetEvent, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::ENet::ENetEvent const& ENet::Event::__get_nativeEvent() const {
return ::cordl_internals::getInstanceField<::ENet::ENetEvent, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::ENet::Event::Event(::ENet::ENetEvent  nativeEvent) noexcept : ::bs_hook::ValueTypeWrapper<0x20>() {this->nativeEvent = nativeEvent;
}
