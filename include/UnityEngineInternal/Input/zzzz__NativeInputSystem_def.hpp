...
static inline void NotifyUpdate(::UnityEngineInternal::Input::NativeInputUpdateType  updateType, ::cordl_internals::intptr_t  eventBuffer) ;
...
static inline void QueueInputEvent(::cordl_internals::intptr_t  inputEvent) ;

/// @brief Method IOCTL addr 0x2d1018c size 0x5c virtual false final false
static inline int64_t IOCTL(int32_t  deviceId, int32_t  code, ::cordl_internals::intptr_t  data, int32_t  sizeInBytes) ;
...
// Ctor Parameters []
// @brief default ctor
 NativeInputSystem()  = default;
public:


// Fields

// Static field onUpdate

// Static field onBeforeUpdate

// Static field onShouldRunUpdate

// Static field s_OnDeviceDiscoveredCallback
