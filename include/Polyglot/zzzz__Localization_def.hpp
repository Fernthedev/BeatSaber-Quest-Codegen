...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::UnityEngine::ScriptableObject)]{};

/// @brief Field KeyNotFound offset 0x0
static constexpr ::ConstString  KeyNotFound{u"[{0}]"};

/// @brief Field customDocument offset 0x18
 __declspec(property(get=__get_customDocument, put=__set_customDocument)) ::Polyglot::LocalizationDocument*  customDocument;

/// @brief Field inputFiles offset 0x20
...
/// @brief Field supportedLanguages offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::Polyglot::LocalizationDocument*> __get_customDocument() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Polyglot::LocalizationAsset*>*> __get_inputFiles() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::Polyglot::Language>*> __get_supportedLanguages() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Events::UnityEvent*> __get_Localize() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Globalization::CultureInfo*> __get_selectedCultureInfo() const;
