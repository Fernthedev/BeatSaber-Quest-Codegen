...
namespace Polyglot {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(15565)), TypeDefinitionIndex(TypeDefinitionIndex(12307)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15565), inst: 4463 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::Polyglot::LocalizedTextComponent_1<::TMPro::TextMeshPro*>)]{};
