...
constexpr ::cordl_internals::to_const_pointer<::Polyglot::Localization*> __get_settings() const;
...
// Ctor Parameters []
// @brief default ctor
 __LocalizationImporter____c__DisplayClass5_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __LocalizationImporter____c__DisplayClass8_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 LocalizationImporter()  = default;
public:


// Fields

// Static field languageStrings

// Static field EmptyList

// Static field InputFiles
