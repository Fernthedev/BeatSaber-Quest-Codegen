...
struct CORDL_TYPE __IgnoranceServer__ThreadParamInfo : public ::bs_hook::ValueTypeWrapper<0x50> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x50};

/// @brief Field IsFruityDevice offset 0x0
 __declspec(property(get=__get_IsFruityDevice, put=__set_IsFruityDevice)) bool  IsFruityDevice;

/// @brief Field BindAllInterfaces offset 0x1
 __declspec(property(get=__get_BindAllInterfaces, put=__set_BindAllInterfaces)) bool  BindAllInterfaces;

/// @brief Field Channels offset 0x4
 __declspec(property(get=__get_Channels, put=__set_Channels)) int32_t  Channels;

/// @brief Field Peers offset 0x8
 __declspec(property(get=__get_Peers, put=__set_Peers)) int32_t  Peers;

/// @brief Field PollTime offset 0xc
...
constexpr int32_t& __get_Peers() ;

constexpr int32_t const& __get_Peers() const;
...
constexpr explicit __IgnoranceServer__ThreadParamInfo(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x50>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __IgnoranceServer__ThreadParamInfo()  = default;
...
/// @brief Field PollTime offset 0x28
 __declspec(property(get=__get_PollTime, put=__set_PollTime)) int32_t  PollTime;

/// @brief Field Verbosity offset 0x2c
 __declspec(property(get=__get_Verbosity, put=__set_Verbosity)) int32_t  Verbosity;

/// @brief Field IncomingOutgoingBufferSize offset 0x30
...
/// @brief Field ConnectionEventBufferSize offset 0x34
...
/// @brief Field IsFruityDevice offset 0x38
 __declspec(property(get=__get_IsFruityDevice, put=__set_IsFruityDevice)) bool  IsFruityDevice;

/// @brief Field BindAllInterfaces offset 0x39
 __declspec(property(get=__get_BindAllInterfaces, put=__set_BindAllInterfaces)) bool  BindAllInterfaces;

/// @brief Field UseSsl offset 0x3a
 __declspec(property(get=__get_UseSsl, put=__set_UseSsl)) bool  UseSsl;

/// @brief Field CertificatePath offset 0x40
 __declspec(property(get=__get_CertificatePath, put=__set_CertificatePath)) ::StringW  CertificatePath;

/// @brief Field Certificate offset 0x48
 __declspec(property(get=__get_Certificate, put=__set_Certificate)) ::StringW  Certificate;

/// @brief Field PrivateKeyPath offset 0x50
 __declspec(property(get=__get_PrivateKeyPath, put=__set_PrivateKeyPath)) ::StringW  PrivateKeyPath;

/// @brief Field PrivateKey offset 0x58
 __declspec(property(get=__get_PrivateKey, put=__set_PrivateKey)) ::StringW  PrivateKey;

/// @brief Field CeaseOperation offset 0x60
 __declspec(property(get=__get_CeaseOperation, put=__set_CeaseOperation)) bool  CeaseOperation;

/// @brief Field Incoming offset 0x68
...
/// @brief Field Outgoing offset 0x70
...
/// @brief Field Commands offset 0x78
...
/// @brief Field ConnectionEvents offset 0x80
...
/// @brief Field DisconnectionEvents offset 0x88
...
/// @brief Field StatusUpdates offset 0x90
...
/// @brief Field RecycledServerStatBlocks offset 0x98
...
/// @brief Field WorkerThread offset 0xa0
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceServerStats>*> __get_StatusUpdates() const;
...
constexpr ::cordl_internals::to_const_pointer<::IgnoranceThirdparty::RingBuffer_1<::IgnoranceCore::IgnoranceServerStats>*> __get_RecycledServerStatBlocks() const;
