...
struct CORDL_TYPE IgnoranceConnectionEvent : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
/// @brief Field EventType offset 0x0
 __declspec(property(get=__get_EventType, put=__set_EventType)) uint8_t  EventType;

/// @brief Field Port offset 0x2
...
constexpr uint8_t& __get_EventType() ;

constexpr uint8_t const& __get_EventType() const;
...
constexpr explicit IgnoranceConnectionEvent(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 IgnoranceConnectionEvent()  = default;
