...
constexpr uint8_t& IgnoranceCore::IgnoranceConnectionEvent::__get_EventType()  {
return ::cordl_internals::getInstanceField<uint8_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint8_t const& IgnoranceCore::IgnoranceConnectionEvent::__get_EventType() const {
return ::cordl_internals::getInstanceField<uint8_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr uint16_t& IgnoranceCore::IgnoranceConnectionEvent::__get_Port()  {
return ::cordl_internals::getInstanceField<uint16_t, 0x2>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint16_t const& IgnoranceCore::IgnoranceConnectionEvent::__get_Port() const {
return ::cordl_internals::getInstanceField<uint16_t, 0x2>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr uint32_t& IgnoranceCore::IgnoranceConnectionEvent::__get_NativePeerId()  {
return ::cordl_internals::getInstanceField<uint32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr uint32_t const& IgnoranceCore::IgnoranceConnectionEvent::__get_NativePeerId() const {
return ::cordl_internals::getInstanceField<uint32_t, 0x4>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::StringW& IgnoranceCore::IgnoranceConnectionEvent::__get_IP()  {
return ::cordl_internals::getInstanceField<::StringW, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::StringW const& IgnoranceCore::IgnoranceConnectionEvent::__get_IP() const {
return ::cordl_internals::getInstanceField<::StringW, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::IgnoranceCore::IgnoranceConnectionEvent::IgnoranceConnectionEvent(uint8_t  EventType, uint16_t  Port, uint32_t  NativePeerId, ::StringW  IP) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->EventType = EventType;
this->Port = Port;
