...
struct CORDL_TYPE __BipedNaming__BoneType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____BipedNaming__BoneType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __BipedNaming__BoneType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __BipedNaming__BoneType()  = default;
...
struct CORDL_TYPE __BipedNaming__BoneSide : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____BipedNaming__BoneSide_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __BipedNaming__BoneSide(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __BipedNaming__BoneSide()  = default;
...
static inline ::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*> GetBonesOfType(::RootMotion::__BipedNaming__BoneType  boneType, ::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*>  bones) ;

/// @brief Method GetBonesOfSide addr 0x1236640 size 0x1ac virtual false final false
static inline ::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*> GetBonesOfSide(::RootMotion::__BipedNaming__BoneSide  boneSide, ::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*>  bones) ;

/// @brief Method GetBonesOfTypeAndSide addr 0x1236874 size 0x74 virtual false final false
static inline ::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*> GetBonesOfTypeAndSide(::RootMotion::__BipedNaming__BoneType  boneType, ::RootMotion::__BipedNaming__BoneSide  boneSide, ::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*>  bones) ;

/// @brief Method GetFirstBoneOfTypeAndSide addr 0x12368e8 size 0x94 virtual false final false
static inline ::UnityEngine::Transform* GetFirstBoneOfTypeAndSide(::RootMotion::__BipedNaming__BoneType  boneType, ::RootMotion::__BipedNaming__BoneSide  boneSide, ::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*>  bones) ;

/// @brief Method GetNamingMatch addr 0x123697c size 0x114 virtual false final false
static inline ::UnityEngine::Transform* GetNamingMatch(::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*>  transforms, ::ArrayW<::ArrayW<::StringW,::Array<::StringW>*>,::Array<::ArrayW<::StringW,::Array<::StringW>*>>*>  namings) ;
...
static inline ::UnityEngine::Transform* GetBone(::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*>  transforms, ::RootMotion::__BipedNaming__BoneType  boneType, ::RootMotion::__BipedNaming__BoneSide  boneSide, ::ArrayW<::ArrayW<::StringW,::Array<::StringW>*>,::Array<::ArrayW<::StringW,::Array<::StringW>*>>*>  namings) ;
...
// Static field typeLeft

// Static field typeRight

// Static field typeSpine

// Static field typeHead

// Static field typeArm

// Static field typeLeg

// Static field typeTail

// Static field typeEye

// Static field typeExclude

// Static field typeExcludeSpine

// Static field typeExcludeHead

// Static field typeExcludeArm

// Static field typeExcludeLeg

// Static field typeExcludeTail

// Static field typeExcludeEye
