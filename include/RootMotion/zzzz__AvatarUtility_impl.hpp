...
inline ::RootMotion::TQ* RootMotion::AvatarUtility::GetIKGoalTQ(::UnityEngine::Avatar*  avatar, float_t  humanScale, ::UnityEngine::AvatarIKGoal  avatarIKGoal, ::RootMotion::TQ*  bodyPositionRotation, ::RootMotion::TQ*  boneTQ)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::RootMotion::AvatarUtility*>::get(),
                            "GetIKGoalTQ",
                            std::vector<Il2CppClass*>{},
...
return THROW_UNLESS(::il2cpp_utils::New<::RootMotion::AvatarUtility*>());
}
