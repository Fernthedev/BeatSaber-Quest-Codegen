...
#include "RootMotion/FinalIK/zzzz__Finger_def.hpp"
constexpr void RootMotion::FinalIK::__Finger__DOF::__set_value__(int32_t  value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<int32_t>(value));
}
constexpr int32_t& RootMotion::FinalIK::__Finger__DOF::__get_value__()  {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& RootMotion::FinalIK::__Finger__DOF::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::RootMotion::FinalIK::__Finger__DOF::__Finger__DOF(int32_t  value__) noexcept : ::bs_hook::EnumTypeWrapper<0x4>() {this->value__ = value__;
}
...
::cordl_internals::setInstanceField<::RootMotion::FinalIK::__Finger__DOF, 0x18>(this, std::forward<::RootMotion::FinalIK::__Finger__DOF>(value));
}
constexpr ::RootMotion::FinalIK::__Finger__DOF& RootMotion::FinalIK::Finger::__get_rotationDOF()  {
return ::cordl_internals::getInstanceField<::RootMotion::FinalIK::__Finger__DOF, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> RootMotion::FinalIK::Finger::__get_bone1() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x20>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> RootMotion::FinalIK::Finger::__get_bone2() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x28>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> RootMotion::FinalIK::Finger::__get_bone3() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x30>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> RootMotion::FinalIK::Finger::__get_tip() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x38>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> RootMotion::FinalIK::Finger::__get_target() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x40>(this);
}
...
::cordl_internals::setInstanceField<::RootMotion::FinalIK::IKSolverLimb*, 0x50>(this, std::forward<::RootMotion::FinalIK::IKSolverLimb*>(value));
}
constexpr ::RootMotion::FinalIK::IKSolverLimb* RootMotion::FinalIK::Finger::__get_solver()  {
return ::cordl_internals::getInstanceField<::RootMotion::FinalIK::IKSolverLimb*, 0x50>(this);
}
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::IKSolverLimb*> RootMotion::FinalIK::Finger::__get_solver() const {
return ::cordl_internals::getInstanceField<::RootMotion::FinalIK::IKSolverLimb*, 0x50>(this);
}
constexpr void RootMotion::FinalIK::Finger::__set_bone3RelativeToTarget(::UnityEngine::Quaternion  value)  {
::cordl_internals::setInstanceField<::UnityEngine::Quaternion, 0x58>(this, std::forward<::UnityEngine::Quaternion>(value));
}
constexpr ::UnityEngine::Quaternion& RootMotion::FinalIK::Finger::__get_bone3RelativeToTarget()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Quaternion, 0x58>(this);
}
