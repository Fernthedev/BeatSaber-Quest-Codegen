...
/// @brief Field defaultLocalRotation offset 0x1c
...
// Ctor Parameters []
// @brief default ctor
 __FBBIKHeadEffector__BendBone()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x170 - sizeof(::UnityEngine::MonoBehaviour)]{};
...
/// @brief Field OnPostHeadEffectorFK offset 0x90
...
/// @brief Field ccdDefaultLocalRotations offset 0x118
...
/// @brief Field stretchLocalRotations offset 0x148
...
/// @brief Field chestLocalPositions offset 0x150
...
/// @brief Field chestLocalRotations offset 0x158
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolver__UpdateDelegate*> __get_OnPostHeadEffectorFK() const;
