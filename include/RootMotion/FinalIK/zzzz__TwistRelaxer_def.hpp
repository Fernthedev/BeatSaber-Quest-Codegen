...
/// @brief Field axisRelativeToChildDefault offset 0x60
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_child() const;
