...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_spine() const;

constexpr void __set_chest(::UnityEngine::Transform*  value) ;

constexpr ::UnityEngine::Transform* __get_chest() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_chest() const;

constexpr void __set_neck(::UnityEngine::Transform*  value) ;

constexpr ::UnityEngine::Transform* __get_neck() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_neck() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_leftShoulder() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_rightShoulder() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_leftToes() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_rightToes() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__VRIK__References*> __get_references() const;

constexpr void __set_solver(::RootMotion::FinalIK::IKSolverVR*  value) ;

constexpr ::RootMotion::FinalIK::IKSolverVR* __get_solver() ;

constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::IKSolverVR*> __get_solver() const;
