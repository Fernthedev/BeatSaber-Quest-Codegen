...
static inline ::RootMotion::FinalIK::__InteractionSystem__InteractionDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
inline ::System::IAsyncResult* BeginInvoke(::RootMotion::FinalIK::FullBodyBipedEffector  effectorType, ::RootMotion::FinalIK::InteractionObject*  interactionObject, ::System::AsyncCallback*  callback, ::System::Object*  object) ;
...
// Ctor Parameters []
// @brief default ctor
 __InteractionSystem__InteractionDelegate()  = default;
public:
...
static inline ::RootMotion::FinalIK::__InteractionSystem__InteractionEventDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
inline void Invoke(::RootMotion::FinalIK::FullBodyBipedEffector  effectorType, ::RootMotion::FinalIK::InteractionObject*  interactionObject, ::RootMotion::FinalIK::__InteractionObject__InteractionEvent*  interactionEvent) ;

/// @brief Method BeginInvoke addr 0x128b47c size 0x98 virtual true final false
inline ::System::IAsyncResult* BeginInvoke(::RootMotion::FinalIK::FullBodyBipedEffector  effectorType, ::RootMotion::FinalIK::InteractionObject*  interactionObject, ::RootMotion::FinalIK::__InteractionObject__InteractionEvent*  interactionEvent, ::System::AsyncCallback*  callback, ::System::Object*  object) ;
...
// Ctor Parameters []
// @brief default ctor
 __InteractionSystem__InteractionEventDelegate()  = default;
public:
...
/// @brief Field bestRangeIndexes offset 0x58
...
/// @brief Field OnInteractionStart offset 0x60
...
/// @brief Field OnInteractionPause offset 0x68
...
/// @brief Field OnInteractionPickUp offset 0x70
...
/// @brief Field OnInteractionResume offset 0x78
...
/// @brief Field OnInteractionStop offset 0x80
...
/// @brief Field OnInteractionEvent offset 0x88
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Collider*> __get_characterCollider() const;

constexpr void __set_FPSCamera(::UnityEngine::Transform*  value) ;

constexpr ::UnityEngine::Transform* __get_FPSCamera() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_FPSCamera() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::RootMotion::FinalIK::InteractionTrigger*>*> __get__triggersInRange_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::RootMotion::FinalIK::InteractionTrigger*>*> __get_inContact() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<int32_t>*> __get_bestRangeIndexes() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__InteractionSystem__InteractionDelegate*> __get_OnInteractionStart() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__InteractionSystem__InteractionDelegate*> __get_OnInteractionPause() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__InteractionSystem__InteractionDelegate*> __get_OnInteractionPickUp() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__InteractionSystem__InteractionDelegate*> __get_OnInteractionResume() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__InteractionSystem__InteractionDelegate*> __get_OnInteractionStop() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__InteractionSystem__InteractionEventDelegate*> __get_OnInteractionEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::FullBodyBipedIK*> __get_fullBody() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::InteractionLookAt*> __get_lookAt() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Collider*> __get_lastCollider() const;

constexpr void __set_c(::UnityEngine::Collider*  value) ;

constexpr ::UnityEngine::Collider* __get_c() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Collider*> __get_c() const;
