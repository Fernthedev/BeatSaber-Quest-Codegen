...
/// @brief Field visualize offset 0x10
...
/// @brief Field angleBuffer offset 0x18
 __declspec(property(get=__get_angleBuffer, put=__set_angleBuffer)) float_t  angleBuffer;

/// @brief Field poses offset 0x20
