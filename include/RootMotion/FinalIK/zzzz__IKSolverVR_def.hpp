...
struct CORDL_TYPE __IKSolverVR__Arm__ShoulderRotationMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____IKSolverVR__Arm__ShoulderRotationMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __IKSolverVR__Arm__ShoulderRotationMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __IKSolverVR__Arm__ShoulderRotationMode()  = default;
...
inline void OnRead(::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>  positions, ::ArrayW<::UnityEngine::Quaternion,::Array<::UnityEngine::Quaternion>*>  rotations, bool  hasChest, bool  hasNeck, bool  hasShoulders, bool  hasToes, bool  hasLegs, int32_t  rootIndex, int32_t  index) ;
...
inline void Write(ByRef<::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>>  solvedPositions, ByRef<::ArrayW<::UnityEngine::Quaternion,::Array<::UnityEngine::Quaternion>*>>  solvedRotations) ;
...
inline void Read(::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>  positions, ::ArrayW<::UnityEngine::Quaternion,::Array<::UnityEngine::Quaternion>*>  rotations, bool  hasChest, bool  hasNeck, bool  hasShoulders, bool  hasToes, bool  hasLegs, int32_t  rootIndex, int32_t  index) ;
...
// Ctor Parameters []
// @brief default ctor
 __IKSolverVR__BodyPart()  = default;
public:
...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12585))}
...
/// @brief Field <rotation>k__BackingField offset 0xd8
...
/// @brief Field upperArmBendAxis offset 0x13c
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get_stretchCurve() const;
...
inline void Visualize(::RootMotion::FinalIK::__IKSolverVR__VirtualBone*  bone1, ::RootMotion::FinalIK::__IKSolverVR__VirtualBone*  bone2, ::RootMotion::FinalIK::__IKSolverVR__VirtualBone*  bone3, ::UnityEngine::Color  color) ;
...
/// @brief Field stepSpeed offset 0x10
 __declspec(property(get=__get_stepSpeed, put=__set_stepSpeed)) float_t  stepSpeed;

/// @brief Field characterSpaceOffset offset 0x14
...
static inline ::RootMotion::FinalIK::__IKSolverVR__Footstep* New_ctor(::UnityEngine::Quaternion  rootRotation, ::UnityEngine::Vector3  footPosition, ::UnityEngine::Quaternion  footRotation, ::UnityEngine::Vector3  characterSpaceOffset) ;
...
// Ctor Parameters []
// @brief default ctor
 __IKSolverVR__Footstep()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x150 - sizeof(::RootMotion::FinalIK::__IKSolverVR__BodyPart)]{};
...
/// @brief Field bendNormalRelToTarget offset 0x144
...
/// @brief Field footsteps offset 0x90
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get_stepHeight() const;

constexpr void __set_heelHeight(::UnityEngine::AnimationCurve*  value) ;

constexpr ::UnityEngine::AnimationCurve* __get_heelHeight() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get_heelHeight() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Events::UnityEvent*> __get_onLeftFootstep() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Events::UnityEvent*> __get_onRightFootstep() const;
...
// Ctor Parameters []
// @brief default ctor
 __IKSolverVR__Locomotion()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x228 - sizeof(::RootMotion::FinalIK::__IKSolverVR__BodyPart)]{};

/// @brief Field headTarget offset 0x48
 __declspec(property(get=__get_headTarget, put=__set_headTarget)) ::UnityEngine::Transform*  headTarget;

/// @brief Field pelvisTarget offset 0x50
...
/// @brief Field chestRotationOffset offset 0x118
...
/// @brief Field <anchorRelativeToHead>k__BackingField offset 0x16c
...
/// @brief Field pelvisRelativeRotation offset 0x1ac
...
/// @brief Field chestRelativeRotation offset 0x1bc
...
/// @brief Field chestTargetRotation offset 0x1e8
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_headTarget() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_chestGoal() const;
...
inline void CalculateChestTargetRotation(::RootMotion::FinalIK::__IKSolverVR__VirtualBone*  rootBone, ::ArrayW<::RootMotion::FinalIK::__IKSolverVR__Arm*,::Array<::RootMotion::FinalIK::__IKSolverVR__Arm*>*>  arms) ;

/// @brief Method Solve addr 0x127fff0 size 0x53c virtual false final false
inline void Solve(::RootMotion::FinalIK::__IKSolverVR__VirtualBone*  rootBone, ::ArrayW<::RootMotion::FinalIK::__IKSolverVR__Leg*,::Array<::RootMotion::FinalIK::__IKSolverVR__Leg*>*>  legs, ::ArrayW<::RootMotion::FinalIK::__IKSolverVR__Arm*,::Array<::RootMotion::FinalIK::__IKSolverVR__Arm*>*>  arms) ;
...
inline void InverseTranslateToHead(::ArrayW<::RootMotion::FinalIK::__IKSolverVR__Leg*,::Array<::RootMotion::FinalIK::__IKSolverVR__Leg*>*>  legs, bool  limited, bool  useCurrentLegMag, ::UnityEngine::Vector3  offset, float_t  w) ;

/// @brief Method TranslatePelvis addr 0x128052c size 0x410 virtual false final false
inline void TranslatePelvis(::ArrayW<::RootMotion::FinalIK::__IKSolverVR__Leg*,::Array<::RootMotion::FinalIK::__IKSolverVR__Leg*>*>  legs, ::UnityEngine::Vector3  deltaPosition, ::UnityEngine::Quaternion  deltaRotation) ;

/// @brief Method LimitPelvisPosition addr 0x1281dc8 size 0x2a8 virtual false final false
inline ::UnityEngine::Vector3 LimitPelvisPosition(::ArrayW<::RootMotion::FinalIK::__IKSolverVR__Leg*,::Array<::RootMotion::FinalIK::__IKSolverVR__Leg*>*>  legs, ::UnityEngine::Vector3  pelvisPosition, bool  useCurrentLegMag, int32_t  it) ;

/// @brief Method Bend addr 0x1280ee8 size 0x1fc virtual false final false
inline void Bend(::ArrayW<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*,::Array<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*>*>  bones, int32_t  firstIndex, int32_t  lastIndex, ::UnityEngine::Quaternion  targetRotation, float_t  clampWeight, bool  uniformWeight, float_t  w) ;

/// @brief Method Bend addr 0x1280b9c size 0x270 virtual false final false
inline void Bend(::ArrayW<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*,::Array<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*>*>  bones, int32_t  firstIndex, int32_t  lastIndex, ::UnityEngine::Quaternion  targetRotation, ::UnityEngine::Quaternion  rotationOffset, float_t  clampWeight, bool  uniformWeight, float_t  w) ;
...
struct CORDL_TYPE __IKSolverVR__PositionOffset : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____IKSolverVR__PositionOffset_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __IKSolverVR__PositionOffset(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __IKSolverVR__PositionOffset()  = default;
...
struct CORDL_TYPE __IKSolverVR__RotationOffset : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____IKSolverVR__RotationOffset_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __IKSolverVR__RotationOffset(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __IKSolverVR__RotationOffset()  = default;
...
static inline void SwingRotation(::ArrayW<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*,::Array<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*>*>  bones, int32_t  index, ::UnityEngine::Vector3  swingTarget, float_t  weight) ;
...
static inline void RotateAroundPoint(::ArrayW<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*,::Array<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*>*>  bones, int32_t  index, ::UnityEngine::Vector3  point, ::UnityEngine::Quaternion  rotation) ;

/// @brief Method RotateBy addr 0x128265c size 0x1a8 virtual false final false
static inline void RotateBy(::ArrayW<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*,::Array<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*>*>  bones, int32_t  index, ::UnityEngine::Quaternion  rotation) ;
...
static inline void RotateTo(::ArrayW<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*,::Array<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*>*>  bones, int32_t  index, ::UnityEngine::Quaternion  rotation) ;

/// @brief Method SolveTrigonometric addr 0x1281740 size 0x3e4 virtual false final false
static inline void SolveTrigonometric(::ArrayW<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*,::Array<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*>*>  bones, int32_t  first, int32_t  second, int32_t  third, ::UnityEngine::Vector3  targetPosition, ::UnityEngine::Vector3  bendNormal, float_t  weight) ;
...
static inline void SolveCCD(::ArrayW<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*,::Array<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*>*>  bones, ::UnityEngine::Vector3  targetPosition, float_t  weight, int32_t  iterations) ;
...
// Ctor Parameters []
// @brief default ctor
 __IKSolverVR__VirtualBone()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x178 - sizeof(::RootMotion::FinalIK::IKSolver)]{};

/// @brief Field solverTransforms offset 0x58
...
/// @brief Field hasChest offset 0x60
 __declspec(property(get=__get_hasChest, put=__set_hasChest)) bool  hasChest;

/// @brief Field hasNeck offset 0x61
 __declspec(property(get=__get_hasNeck, put=__set_hasNeck)) bool  hasNeck;

/// @brief Field hasShoulders offset 0x62
 __declspec(property(get=__get_hasShoulders, put=__set_hasShoulders)) bool  hasShoulders;

/// @brief Field hasToes offset 0x63
 __declspec(property(get=__get_hasToes, put=__set_hasToes)) bool  hasToes;

/// @brief Field hasLegs offset 0x64
 __declspec(property(get=__get_hasLegs, put=__set_hasLegs)) bool  hasLegs;

/// @brief Field readPositions offset 0x68
...
/// @brief Field readRotations offset 0x70
...
/// @brief Field solvedPositions offset 0x78
...
/// @brief Field solvedRotations offset 0x80
...
/// @brief Field defaultLocalRotations offset 0x88
...
/// @brief Field defaultLocalPositions offset 0x90
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolverVR__VirtualBone*> __get__rootBone_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolverVR__Spine*> __get_spine() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolverVR__Arm*> __get_leftArm() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolverVR__Arm*> __get_rightArm() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolverVR__Leg*> __get_leftLeg() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolverVR__Leg*> __get_rightLeg() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolverVR__Locomotion*> __get_locomotion() const;
...
inline void Read(::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>  positions, ::ArrayW<::UnityEngine::Quaternion,::Array<::UnityEngine::Quaternion>*>  rotations, bool  hasChest, bool  hasNeck, bool  hasShoulders, bool  hasToes, bool  hasLegs) ;
