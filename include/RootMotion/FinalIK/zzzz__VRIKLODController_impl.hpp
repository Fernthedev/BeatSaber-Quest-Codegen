...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Renderer*> RootMotion::FinalIK::VRIKLODController::__get_LODRenderer() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Renderer*, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::RootMotion::FinalIK::VRIK*, 0x28>(this, std::forward<::RootMotion::FinalIK::VRIK*>(value));
}
constexpr ::RootMotion::FinalIK::VRIK* RootMotion::FinalIK::VRIKLODController::__get_ik()  {
return ::cordl_internals::getInstanceField<::RootMotion::FinalIK::VRIK*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::VRIK*> RootMotion::FinalIK::VRIKLODController::__get_ik() const {
return ::cordl_internals::getInstanceField<::RootMotion::FinalIK::VRIK*, 0x28>(this);
}
