...
// Ctor Parameters []
// @brief default ctor
 __InteractionTrigger__CharacterPosition()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Collider*> __get_lookAtTarget() const;
...
// Ctor Parameters []
// @brief default ctor
 __InteractionTrigger__CameraPosition()  = default;
public:
...
/// @brief Field interactionObject offset 0x10
...
/// @brief Field effectors offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::InteractionObject*> __get_interactionObject() const;
...
// Ctor Parameters []
// @brief default ctor
 __InteractionTrigger__Range__Interaction()  = default;
public:
...
/// @brief Field show offset 0x18
 __declspec(property(get=__get_show, put=__set_show)) bool  show;

/// @brief Field characterPosition offset 0x20
...
/// @brief Field cameraPosition offset 0x28
...
/// @brief Field interactions offset 0x30
 __declspec(property(get=__get_interactions, put=__set_interactions)) ::ArrayW<::GlobalNamespace::__InteractionTrigger__Range__Interaction*,::Array<::GlobalNamespace::__InteractionTrigger__Range__Interaction*>*>  interactions;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__InteractionTrigger__CharacterPosition*> __get_characterPosition() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__InteractionTrigger__CameraPosition*> __get_cameraPosition() const;
...
// Ctor Parameters []
// @brief default ctor
 __InteractionTrigger__Range()  = default;
public:
...
/// @brief Field ranges offset 0x18
