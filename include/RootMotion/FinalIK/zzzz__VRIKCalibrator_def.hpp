...
// Ctor Parameters []
// @brief default ctor
 __VRIKCalibrator__Settings()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __VRIKCalibrator__CalibrationData__Target()  = default;
public:
...
/// @brief Field rightFoot offset 0x40
...
/// @brief Field leftLegGoal offset 0x48
...
/// @brief Field rightLegGoal offset 0x50
...
/// @brief Field pelvisTargetRight offset 0x58
 __declspec(property(get=__get_pelvisTargetRight, put=__set_pelvisTargetRight)) ::UnityEngine::Vector3  pelvisTargetRight;

/// @brief Field pelvisPositionWeight offset 0x64
 __declspec(property(get=__get_pelvisPositionWeight, put=__set_pelvisPositionWeight)) float_t  pelvisPositionWeight;

/// @brief Field pelvisRotationWeight offset 0x68
 __declspec(property(get=__get_pelvisRotationWeight, put=__set_pelvisRotationWeight)) float_t  pelvisRotationWeight;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__VRIKCalibrator__CalibrationData__Target*> __get_head() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__VRIKCalibrator__CalibrationData__Target*> __get_leftHand() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__VRIKCalibrator__CalibrationData__Target*> __get_rightHand() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__VRIKCalibrator__CalibrationData__Target*> __get_pelvis() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__VRIKCalibrator__CalibrationData__Target*> __get_leftFoot() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__VRIKCalibrator__CalibrationData__Target*> __get_rightFoot() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__VRIKCalibrator__CalibrationData__Target*> __get_leftLegGoal() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__VRIKCalibrator__CalibrationData__Target*> __get_rightLegGoal() const;
...
// Ctor Parameters []
// @brief default ctor
 __VRIKCalibrator__CalibrationData()  = default;
public:
...
static inline ::RootMotion::FinalIK::__VRIKCalibrator__CalibrationData* Calibrate(::RootMotion::FinalIK::VRIK*  ik, ::RootMotion::FinalIK::__VRIKCalibrator__Settings*  settings, ::UnityEngine::Transform*  headTracker, ::UnityEngine::Transform*  bodyTracker, ::UnityEngine::Transform*  leftHandTracker, ::UnityEngine::Transform*  rightHandTracker, ::UnityEngine::Transform*  leftFootTracker, ::UnityEngine::Transform*  rightFootTracker) ;

/// @brief Method CalibrateLeg addr 0x129bdd8 size 0x6b8 virtual false final false
static inline void CalibrateLeg(::RootMotion::FinalIK::__VRIKCalibrator__Settings*  settings, ::UnityEngine::Transform*  tracker, ::RootMotion::FinalIK::__IKSolverVR__Leg*  leg, ::UnityEngine::Transform*  lastBone, ::UnityEngine::Vector3  rootForward, bool  isLeft) ;

/// @brief Method Calibrate addr 0x129c704 size 0x8f4 virtual false final false
static inline void Calibrate(::RootMotion::FinalIK::VRIK*  ik, ::RootMotion::FinalIK::__VRIKCalibrator__CalibrationData*  data, ::UnityEngine::Transform*  headTracker, ::UnityEngine::Transform*  bodyTracker, ::UnityEngine::Transform*  leftHandTracker, ::UnityEngine::Transform*  rightHandTracker, ::UnityEngine::Transform*  leftFootTracker, ::UnityEngine::Transform*  rightFootTracker) ;

/// @brief Method CalibrateLeg addr 0x129d054 size 0x24c virtual false final false
static inline void CalibrateLeg(::RootMotion::FinalIK::__VRIKCalibrator__CalibrationData*  data, ::UnityEngine::Transform*  tracker, ::RootMotion::FinalIK::__IKSolverVR__Leg*  leg, ::UnityEngine::Transform*  lastBone, ::UnityEngine::Vector3  rootForward, bool  isLeft) ;
