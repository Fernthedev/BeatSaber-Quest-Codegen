...
/// @brief Field pause offset 0x14
 __declspec(property(get=__get_pause, put=__set_pause)) bool  pause;

/// @brief Field pickUp offset 0x15
 __declspec(property(get=__get_pickUp, put=__set_pickUp)) bool  pickUp;

/// @brief Field animations offset 0x18
 __declspec(property(get=__get_animations, put=__set_animations)) ::ArrayW<::RootMotion::FinalIK::__InteractionObject__AnimatorEvent*,::Array<::RootMotion::FinalIK::__InteractionObject__AnimatorEvent*>*>  animations;

/// @brief Field messages offset 0x20
 __declspec(property(get=__get_messages, put=__set_messages)) ::ArrayW<::RootMotion::FinalIK::__InteractionObject__Message*,::Array<::RootMotion::FinalIK::__InteractionObject__Message*>*>  messages;

/// @brief Field unityEvent offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Events::UnityEvent*> __get_unityEvent() const;

/// @brief Method Activate addr 0x1285e5c size 0xc4 virtual false final false
...
/// @brief Method .ctor addr 0x12876e4 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __InteractionObject__InteractionEvent()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_recipient() const;

/// @brief Method Send addr 0x12875ec size 0xf8 virtual false final false
inline void Send(::UnityEngine::Transform*  t) ;

static inline ::RootMotion::FinalIK::__InteractionObject__Message* New_ctor() ;

/// @brief Method .ctor addr 0x12876ec size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __InteractionObject__Message()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Animation*> __get_animation() const;
...
/// @brief Method Activate addr 0x1287510 size 0xdc virtual false final false
inline void Activate(bool  pickUp) ;

/// @brief Method Activate addr 0x12876f4 size 0xb0 virtual false final false
inline void Activate(::UnityEngine::Animator*  animator) ;

/// @brief Method Activate addr 0x12877a4 size 0xd8 virtual false final false
...
/// @brief Method .ctor addr 0x128787c size 0x14 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __InteractionObject__AnimatorEvent()  = default;
public:
...
struct CORDL_TYPE __InteractionObject__WeightCurve__Type : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____InteractionObject__WeightCurve__Type_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __InteractionObject__WeightCurve__Type(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __InteractionObject__WeightCurve__Type()  = default;
...
/// @brief Method GetValue addr 0x1286e20 size 0x1c virtual false final false
inline float_t GetValue(float_t  timer) ;

static inline ::RootMotion::FinalIK::__InteractionObject__WeightCurve* New_ctor() ;

/// @brief Method .ctor addr 0x1287890 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __InteractionObject__WeightCurve()  = default;
public:
...
/// @brief Method GetValue addr 0x1287428 size 0x30 virtual false final false
...
/// @brief Method .ctor addr 0x1287898 size 0x10 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __InteractionObject__Multiplier()  = default;
public:
...
/// @brief Field weightCurves offset 0x30
 __declspec(property(get=__get_weightCurves, put=__set_weightCurves)) ::ArrayW<::RootMotion::FinalIK::__InteractionObject__WeightCurve*,::Array<::RootMotion::FinalIK::__InteractionObject__WeightCurve*>*>  weightCurves;

/// @brief Field multipliers offset 0x38
 __declspec(property(get=__get_multipliers, put=__set_multipliers)) ::ArrayW<::RootMotion::FinalIK::__InteractionObject__Multiplier*,::Array<::RootMotion::FinalIK::__InteractionObject__Multiplier*>*>  multipliers;

/// @brief Field events offset 0x40
 __declspec(property(get=__get_events, put=__set_events)) ::ArrayW<::RootMotion::FinalIK::__InteractionObject__InteractionEvent*,::Array<::RootMotion::FinalIK::__InteractionObject__InteractionEvent*>*>  events;

/// @brief Field <length>k__BackingField offset 0x48
 __declspec(property(get=__get__length_k__BackingField, put=__set__length_k__BackingField)) float_t  _length_k__BackingField;

/// @brief Field <lastUsedInteractionSystem>k__BackingField offset 0x50
 __declspec(property(get=__get__lastUsedInteractionSystem_k__BackingField, put=__set__lastUsedInteractionSystem_k__BackingField)) ::RootMotion::FinalIK::InteractionSystem*  _lastUsedInteractionSystem_k__BackingField;

/// @brief Field targets offset 0x58
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_otherLookAtTarget() const;

constexpr void __set_otherTargetsRoot(::UnityEngine::Transform*  value) ;

constexpr ::UnityEngine::Transform* __get_otherTargetsRoot() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_otherTargetsRoot() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_positionOffsetSpace() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::InteractionSystem*> __get__lastUsedInteractionSystem_k__BackingField() const;
...
/// @brief Method OpenUserManual addr 0x1286768 size 0x44 virtual false final false
inline void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x12867ac size 0x44 virtual false final false
inline void OpenScriptReference() ;

/// @brief Method OpenTutorial1 addr 0x12867f0 size 0x44 virtual false final false
inline void OpenTutorial1() ;

/// @brief Method OpenTutorial2 addr 0x1286834 size 0x44 virtual false final false
inline void OpenTutorial2() ;

/// @brief Method OpenTutorial3 addr 0x1286878 size 0x44 virtual false final false
inline void OpenTutorial3() ;

/// @brief Method OpenTutorial4 addr 0x12868bc size 0x44 virtual false final false
inline void OpenTutorial4() ;

/// @brief Method SupportGroup addr 0x1286900 size 0x44 virtual false final false
inline void SupportGroup() ;

/// @brief Method ASThread addr 0x1286944 size 0x44 virtual false final false
inline void ASThread() ;

/// @brief Method get_length addr 0x1286988 size 0x8 virtual false final false
inline float_t get_length() ;

/// @brief Method set_length addr 0x1286990 size 0x8 virtual false final false
inline void set_length(float_t  value) ;

/// @brief Method get_lastUsedInteractionSystem addr 0x1286998 size 0x8 virtual false final false
inline ::RootMotion::FinalIK::InteractionSystem* get_lastUsedInteractionSystem() ;

/// @brief Method set_lastUsedInteractionSystem addr 0x12869a0 size 0x8 virtual false final false
inline void set_lastUsedInteractionSystem(::RootMotion::FinalIK::InteractionSystem*  value) ;

/// @brief Method Initiate addr 0x12869a8 size 0x1b0 virtual false final false
inline void Initiate() ;

/// @brief Method get_lookAtTarget addr 0x1286b58 size 0x80 virtual false final false
inline ::UnityEngine::Transform* get_lookAtTarget() ;

/// @brief Method GetTarget addr 0x1286bd8 size 0x178 virtual false final false
...
/// @brief Method CurveUsed addr 0x1284720 size 0x94 virtual false final false
inline bool CurveUsed(::GlobalNamespace::__InteractionObject__WeightCurve__Type  type) ;

/// @brief Method GetTargets addr 0x1286d50 size 0x8 virtual false final false
inline ::ArrayW<::RootMotion::FinalIK::InteractionTarget*,::Array<::RootMotion::FinalIK::InteractionTarget*>*> GetTargets() ;

/// @brief Method GetTarget addr 0x12845dc size 0x13c virtual false final false
inline ::UnityEngine::Transform* GetTarget(::RootMotion::FinalIK::FullBodyBipedEffector  effectorType, ::StringW  tag) ;

/// @brief Method OnStartInteraction addr 0x1284718 size 0x8 virtual false final false
inline void OnStartInteraction(::RootMotion::FinalIK::InteractionSystem*  interactionSystem) ;

/// @brief Method Apply addr 0x1285298 size 0x408 virtual false final false
inline void Apply(::RootMotion::FinalIK::IKSolverFullBodyBiped*  solver, ::RootMotion::FinalIK::FullBodyBipedEffector  effector, ::RootMotion::FinalIK::InteractionTarget*  target, float_t  timer, float_t  weight) ;

/// @brief Method GetValue addr 0x1285ad8 size 0x20c virtual false final false
...
/// @brief Method get_targetsRoot addr 0x1285f20 size 0x80 virtual false final false
inline ::UnityEngine::Transform* get_targetsRoot() ;

/// @brief Method Start addr 0x1287458 size 0x4 virtual false final false
inline void Start() ;

/// @brief Method Apply addr 0x1286e3c size 0x590 virtual false final false
inline void Apply(::RootMotion::FinalIK::IKSolverFullBodyBiped*  solver, ::RootMotion::FinalIK::FullBodyBipedEffector  effector, ::GlobalNamespace::__InteractionObject__WeightCurve__Type  type, float_t  value, float_t  weight) ;

/// @brief Method GetTarget addr 0x1286d58 size 0x64 virtual false final false
inline ::UnityEngine::Transform* GetTarget(::RootMotion::FinalIK::FullBodyBipedEffector  effectorType) ;

/// @brief Method GetWeightCurveIndex addr 0x12873cc size 0x5c virtual false final false
inline int32_t GetWeightCurveIndex(::GlobalNamespace::__InteractionObject__WeightCurve__Type  weightCurveType) ;

/// @brief Method GetMultiplierIndex addr 0x128745c size 0x5c virtual false final false
...
/// @brief Method .ctor addr 0x12874b8 size 0x58 virtual false final false
inline void _ctor() ;
