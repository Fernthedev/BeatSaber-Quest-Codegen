...
::cordl_internals::setInstanceField<::RootMotion::FinalIK::IKSolverFABRIK*, 0x38>(this, std::forward<::RootMotion::FinalIK::IKSolverFABRIK*>(value));
}
constexpr ::RootMotion::FinalIK::IKSolverFABRIK* RootMotion::FinalIK::FABRIK::__get_solver()  {
return ::cordl_internals::getInstanceField<::RootMotion::FinalIK::IKSolverFABRIK*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::IKSolverFABRIK*> RootMotion::FinalIK::FABRIK::__get_solver() const {
return ::cordl_internals::getInstanceField<::RootMotion::FinalIK::IKSolverFABRIK*, 0x38>(this);
}
