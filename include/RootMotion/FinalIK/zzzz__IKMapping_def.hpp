...
/// @brief Method Initiate addr 0x125b1fc size 0x28 virtual false final false
inline void Initiate(::UnityEngine::Transform*  transform, ::RootMotion::FinalIK::IKSolverFullBody*  solver) ;

/// @brief Method get_swingDirection addr 0x125b224 size 0x30 virtual false final false
inline ::UnityEngine::Vector3 get_swingDirection() ;

/// @brief Method StoreDefaultLocalState addr 0x125b254 size 0x44 virtual false final false
inline void StoreDefaultLocalState() ;

/// @brief Method FixTransform addr 0x125b298 size 0x44 virtual false final false
inline void FixTransform(bool  position) ;

/// @brief Method get_isNodeBone addr 0x125b2dc size 0x10 virtual false final false
inline bool get_isNodeBone() ;

/// @brief Method SetLength addr 0x125b2ec size 0xd4 virtual false final false
inline void SetLength(::RootMotion::FinalIK::__IKMapping__BoneMap*  nextBone) ;

/// @brief Method SetLocalSwingAxis addr 0x125b3c0 size 0x8 virtual false final false
inline void SetLocalSwingAxis(::RootMotion::FinalIK::__IKMapping__BoneMap*  swingTarget) ;

/// @brief Method SetLocalSwingAxis addr 0x125b3c8 size 0xcc virtual false final false
...
/// @brief Method SetLocalTwistAxis addr 0x125b494 size 0x6c virtual false final false
inline void SetLocalTwistAxis(::UnityEngine::Vector3  twistDirection, ::UnityEngine::Vector3  normalDirection) ;

/// @brief Method SetPlane addr 0x125b500 size 0x88 virtual false final false
...
/// @brief Method UpdatePlane addr 0x125b588 size 0x110 virtual false final false
inline void UpdatePlane(bool  rotation, bool  position) ;

/// @brief Method SetIKPosition addr 0x125b800 size 0x2c virtual false final false
inline void SetIKPosition() ;

/// @brief Method MaintainRotation addr 0x125b82c size 0x2c virtual false final false
inline void MaintainRotation() ;

/// @brief Method SetToIKPosition addr 0x125b858 size 0x28 virtual false final false
inline void SetToIKPosition() ;

/// @brief Method FixToNode addr 0x125b880 size 0xc0 virtual false final false
...
/// @brief Method GetPlanePosition addr 0x125b940 size 0x74 virtual false final false
inline ::UnityEngine::Vector3 GetPlanePosition(::RootMotion::FinalIK::IKSolverFullBody*  solver) ;

/// @brief Method PositionToPlane addr 0x125bac4 size 0x24 virtual false final false
inline void PositionToPlane(::RootMotion::FinalIK::IKSolverFullBody*  solver) ;

/// @brief Method RotateToPlane addr 0x125bae8 size 0x120 virtual false final false
inline void RotateToPlane(::RootMotion::FinalIK::IKSolverFullBody*  solver, float_t  weight) ;

/// @brief Method Swing addr 0x125bc08 size 0x64 virtual false final false
inline void Swing(::UnityEngine::Vector3  swingTarget, float_t  weight) ;

/// @brief Method Swing addr 0x125bc6c size 0x180 virtual false final false
inline void Swing(::UnityEngine::Vector3  pos1, ::UnityEngine::Vector3  pos2, float_t  weight) ;

/// @brief Method Twist addr 0x125bdec size 0x180 virtual false final false
inline void Twist(::UnityEngine::Vector3  twistDirection, ::UnityEngine::Vector3  normalDirection, float_t  weight) ;

/// @brief Method RotateToMaintain addr 0x125bf6c size 0x7c virtual false final false
inline void RotateToMaintain(float_t  weight) ;

/// @brief Method RotateToEffector addr 0x125bfe8 size 0x11c virtual false final false
inline void RotateToEffector(::RootMotion::FinalIK::IKSolverFullBody*  solver, float_t  weight) ;

/// @brief Method GetTargetRotation addr 0x125b9b4 size 0x110 virtual false final false
inline ::UnityEngine::Quaternion GetTargetRotation(::RootMotion::FinalIK::IKSolverFullBody*  solver) ;

/// @brief Method get_lastAnimatedTargetRotation addr 0x125b698 size 0x168 virtual false final false
...
/// @brief Method .ctor addr 0x125c104 size 0x1c virtual false final false
inline void _ctor() ;
...
/// @brief Method IsValid addr 0x125af98 size 0x8 virtual true final false
inline bool IsValid(::RootMotion::FinalIK::IKSolver*  solver, ByRef<::StringW>  message) ;

/// @brief Method Initiate addr 0x125afa0 size 0x4 virtual true final false
inline void Initiate(::RootMotion::FinalIK::IKSolverFullBody*  solver) ;

/// @brief Method BoneIsValid addr 0x125afa4 size 0x13c virtual false final false
...
/// @brief Method SolveFABRIKJoint addr 0x125b0e0 size 0x114 virtual false final false
...
/// @brief Method .ctor addr 0x125b1f4 size 0x8 virtual false final false
inline void _ctor() ;
