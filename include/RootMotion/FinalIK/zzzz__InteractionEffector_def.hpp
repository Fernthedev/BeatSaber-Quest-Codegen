...
/// @brief Field <effectorType>k__BackingField offset 0x10
...
/// @brief Field <isPaused>k__BackingField offset 0x14
...
/// @brief Field <interactionObject>k__BackingField offset 0x18
...
/// @brief Field interactionTarget offset 0xa8
...
/// @brief Field started offset 0xc8
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::InteractionObject*> __get__interactionObject_k__BackingField() const;

constexpr void __set_poser(::RootMotion::FinalIK::Poser*  value) ;

constexpr ::RootMotion::FinalIK::Poser* __get_poser() ;

constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::Poser*> __get_poser() const;

constexpr void __set_effector(::RootMotion::FinalIK::IKEffector*  value) ;

constexpr ::RootMotion::FinalIK::IKEffector* __get_effector() ;

constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::IKEffector*> __get_effector() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::InteractionTarget*> __get_interactionTarget() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<bool>*> __get_triggered() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::InteractionSystem*> __get_interactionSystem() const;
