...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xd0 - sizeof(::RootMotion::FinalIK::IKSolver)]{};

/// @brief Field iterations offset 0x58
 __declspec(property(get=__get_iterations, put=__set_iterations)) int32_t  iterations;

/// @brief Field chain offset 0x60
...
/// @brief Field effectors offset 0x68
...
/// @brief Field limbMappings offset 0x80
...
/// @brief Field OnPostIteration offset 0xa8
...
/// @brief Field OnStoreDefaultLocalState offset 0xc0
...
/// @brief Field OnFixTransforms offset 0xc8
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::IKMappingSpine*> __get_spineMapping() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolver__UpdateDelegate*> __get_OnPreRead() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolver__UpdateDelegate*> __get_OnPreSolve() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolver__IterationDelegate*> __get_OnPostIteration() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolver__UpdateDelegate*> __get_OnPreBend() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolver__UpdateDelegate*> __get_OnPostSolve() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolver__UpdateDelegate*> __get_OnStoreDefaultLocalState() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolver__UpdateDelegate*> __get_OnFixTransforms() const;
