...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::IKSolverTrigonometric*> __get_solver() const;

/// @brief Method OpenUserManual addr 0x124f914 size 0x44 virtual true final false
inline void OpenUserManual() ;

/// @brief Method OpenScriptReference addr 0x124f958 size 0x44 virtual true final false
inline void OpenScriptReference() ;

/// @brief Method SupportGroup addr 0x124f99c size 0x44 virtual false final false
inline void SupportGroup() ;

/// @brief Method ASThread addr 0x124f9e0 size 0x44 virtual false final false
inline void ASThread() ;

/// @brief Method GetIKSolver addr 0x124fa24 size 0x8 virtual true final false
inline ::RootMotion::FinalIK::IKSolver* GetIKSolver() ;

static inline ::RootMotion::FinalIK::TrigonometricIK* New_ctor() ;

/// @brief Method .ctor addr 0x124fa2c size 0x68 virtual false final false
inline void _ctor() ;
