...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x90 - sizeof(::RootMotion::FinalIK::__IKSolver__Bone)]{};

/// @brief Field targetToLocalSpace offset 0x74
 __declspec(property(get=__get_targetToLocalSpace, put=__set_targetToLocalSpace)) ::UnityEngine::Quaternion  targetToLocalSpace;

/// @brief Field defaultLocalBendNormal offset 0x84
...
// Ctor Parameters []
// @brief default ctor
 __IKSolverTrigonometric__TrigonometricBone()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolverTrigonometric__TrigonometricBone*> __get_bone1() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolverTrigonometric__TrigonometricBone*> __get_bone2() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolverTrigonometric__TrigonometricBone*> __get_bone3() const;
...
static inline void Solve(::UnityEngine::Transform*  bone1, ::UnityEngine::Transform*  bone2, ::UnityEngine::Transform*  bone3, ::UnityEngine::Vector3  targetPosition, ::UnityEngine::Vector3  bendNormal, float_t  weight) ;
