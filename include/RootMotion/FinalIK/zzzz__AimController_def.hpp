...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::AimController*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __AimController___TurnToTarget_d__33()  = default;
public:
...
/// @brief Field weight offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::AimIK*> __get_ik() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_lastTarget() const;
