...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rigidbody*> __get_r() const;

constexpr void __set_t(::UnityEngine::Transform*  value) ;

constexpr ::UnityEngine::Transform* __get_t() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_t() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Joint*> __get_joint() const;

constexpr void __set_c(::UnityEngine::Rigidbody*  value) ;

constexpr ::UnityEngine::Rigidbody* __get_c() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Rigidbody*> __get_c() const;
...
// Ctor Parameters []
// @brief default ctor
 __RagdollUtility__Rigidbone()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __RagdollUtility__Child()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::RagdollUtility*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __RagdollUtility___DisableRagdollSmooth_d__21()  = default;
public:
...
/// @brief Field allIKComponents offset 0x50
