...
struct CORDL_TYPE __Grounding__Quality : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____Grounding__Quality_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __Grounding__Quality(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Grounding__Quality()  = default;
...
/// @brief Field <isGrounded>k__BackingField offset 0x10
...
/// @brief Field <IKPosition>k__BackingField offset 0x14
...
/// @brief Field <heightFromGround>k__BackingField offset 0x34
...
/// @brief Field <velocity>k__BackingField offset 0x38
...
/// @brief Field <transform>k__BackingField offset 0x48
...
/// @brief Field <IKOffset>k__BackingField offset 0x50
...
/// @brief Field <capsuleHit>k__BackingField offset 0x84
...
/// @brief Field transformPosition offset 0x108
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__transform_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::Grounding*> __get_grounding() const;
...
/// @brief Field <IKOffset>k__BackingField offset 0x10
...
/// @brief Field <heightOffset>k__BackingField offset 0x1c
...
/// @brief Field <isGrounded>k__BackingField offset 0x68
 __declspec(property(get=__get__isGrounded_k__BackingField, put=__set__isGrounded_k__BackingField)) bool  _isGrounded_k__BackingField;

/// @brief Field <root>k__BackingField offset 0x70
...
/// @brief Field <rootHit>k__BackingField offset 0x78
...
/// @brief Field initiated offset 0xa4
 __declspec(property(get=__get_initiated, put=__set_initiated)) bool  initiated;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__Grounding__Pelvis*> __get__pelvis_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__root_k__BackingField() const;
