...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::OffsetModifierVRIK*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __OffsetModifierVRIK___Initiate_d__7()  = default;
public:
