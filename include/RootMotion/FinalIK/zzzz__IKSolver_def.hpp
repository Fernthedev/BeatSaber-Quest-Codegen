...
/// @brief Field defaultLocalRotation offset 0x44
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::RotationLimit*> __get__rotationLimit() const;
...
static inline void SolverSwing(::ArrayW<::RootMotion::FinalIK::__IKSolver__Bone*,::Array<::RootMotion::FinalIK::__IKSolver__Bone*>*>  bones, int32_t  index, ::UnityEngine::Vector3  swingTarget, float_t  weight) ;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x70 - sizeof(::RootMotion::FinalIK::__IKSolver__Point)]{};

/// @brief Field length offset 0x54
 __declspec(property(get=__get_length, put=__set_length)) float_t  length;

/// @brief Field effectorPositionWeight offset 0x58
 __declspec(property(get=__get_effectorPositionWeight, put=__set_effectorPositionWeight)) float_t  effectorPositionWeight;

/// @brief Field effectorRotationWeight offset 0x5c
...
static inline ::RootMotion::FinalIK::__IKSolver__UpdateDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __IKSolver__UpdateDelegate()  = default;
public:
...
static inline ::RootMotion::FinalIK::__IKSolver__IterationDelegate* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;
...
// Ctor Parameters []
// @brief default ctor
 __IKSolver__IterationDelegate()  = default;
public:
...
/// @brief Field OnPreInitiate offset 0x28
...
/// @brief Field OnPostInitiate offset 0x30
...
/// @brief Field OnPreUpdate offset 0x38
...
/// @brief Field OnPostUpdate offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolver__UpdateDelegate*> __get_OnPreInitiate() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolver__UpdateDelegate*> __get_OnPostInitiate() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolver__UpdateDelegate*> __get_OnPreUpdate() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolver__UpdateDelegate*> __get_OnPostUpdate() const;
