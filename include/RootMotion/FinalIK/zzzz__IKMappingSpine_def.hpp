...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x78 - sizeof(::RootMotion::FinalIK::IKMapping)]{};

/// @brief Field spineBones offset 0x10
...
/// @brief Field rightUpperArm offset 0x58
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_leftUpperArmBone() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_rightUpperArmBone() const;

constexpr void __set_leftThighBone(::UnityEngine::Transform*  value) ;

constexpr ::UnityEngine::Transform* __get_leftThighBone() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_leftThighBone() const;

constexpr void __set_rightThighBone(::UnityEngine::Transform*  value) ;

constexpr ::UnityEngine::Transform* __get_rightThighBone() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_rightThighBone() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKMapping__BoneMap*> __get_leftUpperArm() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKMapping__BoneMap*> __get_rightUpperArm() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKMapping__BoneMap*> __get_leftThigh() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKMapping__BoneMap*> __get_rightThigh() const;
...
static inline ::RootMotion::FinalIK::IKMappingSpine* New_ctor(::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*>  spineBones, ::UnityEngine::Transform*  leftUpperArmBone, ::UnityEngine::Transform*  rightUpperArmBone, ::UnityEngine::Transform*  leftThighBone, ::UnityEngine::Transform*  rightThighBone) ;

/// @brief Method .ctor addr 0x125d3d4 size 0x170 virtual false final false
inline void _ctor(::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*>  spineBones, ::UnityEngine::Transform*  leftUpperArmBone, ::UnityEngine::Transform*  rightUpperArmBone, ::UnityEngine::Transform*  leftThighBone, ::UnityEngine::Transform*  rightThighBone) ;

/// @brief Method SetBones addr 0x125d544 size 0x10 virtual false final false
inline void SetBones(::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*>  spineBones, ::UnityEngine::Transform*  leftUpperArmBone, ::UnityEngine::Transform*  rightUpperArmBone, ::UnityEngine::Transform*  leftThighBone, ::UnityEngine::Transform*  rightThighBone) ;
