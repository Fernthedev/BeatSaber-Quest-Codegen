...
namespace RootMotion::FinalIK {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12560))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x80 - sizeof(::RootMotion::FinalIK::__IKSolver__Bone)]{};

/// @brief Field baseForwardOffsetEuler offset 0x74
...
/// @brief Method .ctor addr 0x126f21c size 0x8 virtual false final false
inline void _ctor() ;

static inline ::RootMotion::FinalIK::__IKSolverLookAt__LookAtBone* New_ctor(::UnityEngine::Transform*  transform) ;

/// @brief Method .ctor addr 0x126dd24 size 0x28 virtual false final false
inline void _ctor(::UnityEngine::Transform*  transform) ;

/// @brief Method Initiate addr 0x126dfd4 size 0xec virtual false final false
inline void Initiate(::UnityEngine::Transform*  root) ;

/// @brief Method LookAt addr 0x126ef0c size 0x108 virtual false final false
inline void LookAt(::UnityEngine::Vector3  direction, float_t  weight) ;

/// @brief Method get_forward addr 0x126ebc4 size 0x30 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __IKSolverLookAt__LookAtBone()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xc8 - sizeof(::RootMotion::FinalIK::IKSolver)]{};

/// @brief Field target offset 0x58
 __declspec(property(get=__get_target, put=__set_target)) ::UnityEngine::Transform*  target;

/// @brief Field spine offset 0x60
...
/// @brief Field headForwards offset 0xb8
...
/// @brief Field eyeForward offset 0xc0
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolverLookAt__LookAtBone*> __get_head() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get_spineWeightCurve() const;
...
/// @brief Method SetLookAtWeight addr 0x126cfa4 size 0x1c virtual false final false
inline void SetLookAtWeight(float_t  weight) ;

/// @brief Method SetLookAtWeight addr 0x126cfc0 size 0x2c virtual false final false
inline void SetLookAtWeight(float_t  weight, float_t  bodyWeight) ;

/// @brief Method SetLookAtWeight addr 0x126cfec size 0x38 virtual false final false
inline void SetLookAtWeight(float_t  weight, float_t  bodyWeight, float_t  headWeight) ;

/// @brief Method SetLookAtWeight addr 0x126d024 size 0x48 virtual false final false
inline void SetLookAtWeight(float_t  weight, float_t  bodyWeight, float_t  headWeight, float_t  eyesWeight) ;

/// @brief Method SetLookAtWeight addr 0x126d06c size 0x58 virtual false final false
inline void SetLookAtWeight(float_t  weight, float_t  bodyWeight, float_t  headWeight, float_t  eyesWeight, float_t  clampWeight) ;

/// @brief Method SetLookAtWeight addr 0x126d0c4 size 0x70 virtual false final false
...
/// @brief Method StoreDefaultLocalState addr 0x126d134 size 0x118 virtual true final false
inline void StoreDefaultLocalState() ;

/// @brief Method FixTransforms addr 0x126d24c size 0x12c virtual true final false
inline void FixTransforms() ;

/// @brief Method IsValid addr 0x126d378 size 0x1b0 virtual true final false
inline bool IsValid(ByRef<::StringW>  message) ;

/// @brief Method GetPoints addr 0x126d784 size 0x224 virtual true final false
inline ::ArrayW<::RootMotion::FinalIK::__IKSolver__Point*,::Array<::RootMotion::FinalIK::__IKSolver__Point*>*> GetPoints() ;

/// @brief Method GetPoint addr 0x126d9a8 size 0x160 virtual true final false
inline ::RootMotion::FinalIK::__IKSolver__Point* GetPoint(::UnityEngine::Transform*  transform) ;

/// @brief Method SetChain addr 0x126db08 size 0xb0 virtual false final false
inline bool SetChain(::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*>  spine, ::UnityEngine::Transform*  head, ::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*>  eyes, ::UnityEngine::Transform*  root) ;

/// @brief Method OnInitiate addr 0x126dd4c size 0x288 virtual true final false
inline void OnInitiate() ;

/// @brief Method OnUpdate addr 0x126e0c0 size 0xc4 virtual true final false
inline void OnUpdate() ;

/// @brief Method get_spineIsValid addr 0x126d528 size 0xcc virtual false final false
inline bool get_spineIsValid() ;

/// @brief Method get_spineIsEmpty addr 0x126d6d0 size 0x24 virtual false final false
inline bool get_spineIsEmpty() ;

/// @brief Method SolveSpine addr 0x126e184 size 0x21c virtual false final false
inline void SolveSpine() ;

/// @brief Method get_headIsValid addr 0x126d5f4 size 0x10 virtual false final false
inline bool get_headIsValid() ;

/// @brief Method get_headIsEmpty addr 0x126d6f4 size 0x6c virtual false final false
inline bool get_headIsEmpty() ;

/// @brief Method SolveHead addr 0x126e3a0 size 0x348 virtual false final false
inline void SolveHead() ;

/// @brief Method get_eyesIsValid addr 0x126d604 size 0xcc virtual false final false
inline bool get_eyesIsValid() ;

/// @brief Method get_eyesIsEmpty addr 0x126d760 size 0x24 virtual false final false
inline bool get_eyesIsEmpty() ;

/// @brief Method SolveEyes addr 0x126e6e8 size 0x4dc virtual false final false
inline void SolveEyes() ;

/// @brief Method GetForwards addr 0x126ebf4 size 0x318 virtual false final false
inline ::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*> GetForwards(ByRef<::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>>  forwards, ::UnityEngine::Vector3  baseForward, ::UnityEngine::Vector3  targetForward, int32_t  bones, float_t  clamp) ;

/// @brief Method SetBones addr 0x126dbb8 size 0x16c virtual false final false
inline void SetBones(::ArrayW<::UnityEngine::Transform*,::Array<::UnityEngine::Transform*>*>  array, ByRef<::ArrayW<::RootMotion::FinalIK::__IKSolverLookAt__LookAtBone*,::Array<::RootMotion::FinalIK::__IKSolverLookAt__LookAtBone*>*>>  bones) ;

static inline ::RootMotion::FinalIK::IKSolverLookAt* New_ctor() ;

/// @brief Method .ctor addr 0x126f014 size 0x208 virtual false final false
inline void _ctor() ;
