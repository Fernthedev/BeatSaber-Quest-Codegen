...
/// @brief Field tetrahedron offset 0x10
...
/// @brief Field volume offset 0x18
...
// Ctor Parameters []
// @brief default ctor
 __RotationLimitPolygonal__ReachCone()  = default;
public:
...
/// @brief Field tangentWeight offset 0x1c
...
// Ctor Parameters []
// @brief default ctor
 __RotationLimitPolygonal__LimitPoint()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x58 - sizeof(::RootMotion::FinalIK::RotationLimit)]{};

/// @brief Field twistLimit offset 0x38
 __declspec(property(get=__get_twistLimit, put=__set_twistLimit)) float_t  twistLimit;

/// @brief Field smoothIterations offset 0x3c
 __declspec(property(get=__get_smoothIterations, put=__set_smoothIterations)) int32_t  smoothIterations;

/// @brief Field points offset 0x40
 __declspec(property(get=__get_points, put=__set_points)) ::ArrayW<::RootMotion::FinalIK::__RotationLimitPolygonal__LimitPoint*,::Array<::RootMotion::FinalIK::__RotationLimitPolygonal__LimitPoint*>*>  points;

/// @brief Field P offset 0x48
 __declspec(property(get=__get_P, put=__set_P)) ::ArrayW<::UnityEngine::Vector3,::Array<::UnityEngine::Vector3>*>  P;

/// @brief Field reachCones offset 0x50
 __declspec(property(get=__get_reachCones, put=__set_reachCones)) ::ArrayW<::RootMotion::FinalIK::__RotationLimitPolygonal__ReachCone*,::Array<::RootMotion::FinalIK::__RotationLimitPolygonal__ReachCone*>*>  reachCones;
...
// Ctor Parameters []
// @brief default ctor
 RotationLimitPolygonal()  = default;
public:
