...
/// @brief Field <nominalDistance>k__BackingField offset 0x28
...
// Ctor Parameters []
// @brief default ctor
 __FBIKChain__ChildConstraint()  = default;
public:
...
struct CORDL_TYPE __FBIKChain__Smoothing : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____FBIKChain__Smoothing_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __FBIKChain__Smoothing(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __FBIKChain__Smoothing()  = default;
...
/// @brief Field pushSmoothing offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::IKConstraintBend*> __get_bendConstraint() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::FinalIK::__IKSolver__Point*> __get_p() const;
