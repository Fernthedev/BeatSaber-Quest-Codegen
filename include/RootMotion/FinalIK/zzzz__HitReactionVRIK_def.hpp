...
// Ctor Parameters []
// @brief default ctor
 __HitReactionVRIK__Offset()  = default;
public:
...
/// @brief Field positionOffset offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __HitReactionVRIK__PositionOffset__PositionOffsetLink()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x60 - sizeof(::RootMotion::FinalIK::__HitReactionVRIK__Offset)]{};

/// @brief Field forceDirCurveIndex offset 0x50
 __declspec(property(get=__get_forceDirCurveIndex, put=__set_forceDirCurveIndex)) int32_t  forceDirCurveIndex;

/// @brief Field upDirCurveIndex offset 0x54
 __declspec(property(get=__get_upDirCurveIndex, put=__set_upDirCurveIndex)) int32_t  upDirCurveIndex;

/// @brief Field offsetLinks offset 0x58
 __declspec(property(get=__get_offsetLinks, put=__set_offsetLinks)) ::ArrayW<::GlobalNamespace::__HitReactionVRIK__PositionOffset__PositionOffsetLink*,::Array<::GlobalNamespace::__HitReactionVRIK__PositionOffset__PositionOffsetLink*>*>  offsetLinks;
...
constexpr void __set_offsetLinks(::ArrayW<::GlobalNamespace::__HitReactionVRIK__PositionOffset__PositionOffsetLink*,::Array<::GlobalNamespace::__HitReactionVRIK__PositionOffset__PositionOffsetLink*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__HitReactionVRIK__PositionOffset__PositionOffsetLink*,::Array<::GlobalNamespace::__HitReactionVRIK__PositionOffset__PositionOffsetLink*>*>& __get_offsetLinks() ;

constexpr ::ArrayW<::GlobalNamespace::__HitReactionVRIK__PositionOffset__PositionOffsetLink*,::Array<::GlobalNamespace::__HitReactionVRIK__PositionOffset__PositionOffsetLink*>*> const& __get_offsetLinks() const;
...
// Ctor Parameters []
// @brief default ctor
 __HitReactionVRIK__PositionOffset()  = default;
public:
...
/// @brief Field rotationOffset offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __HitReactionVRIK__RotationOffset__RotationOffsetLink()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x68 - sizeof(::RootMotion::FinalIK::__HitReactionVRIK__Offset)]{};

/// @brief Field curveIndex offset 0x50
 __declspec(property(get=__get_curveIndex, put=__set_curveIndex)) int32_t  curveIndex;

/// @brief Field offsetLinks offset 0x58
 __declspec(property(get=__get_offsetLinks, put=__set_offsetLinks)) ::ArrayW<::GlobalNamespace::__HitReactionVRIK__RotationOffset__RotationOffsetLink*,::Array<::GlobalNamespace::__HitReactionVRIK__RotationOffset__RotationOffsetLink*>*>  offsetLinks;
...
constexpr void __set_offsetLinks(::ArrayW<::GlobalNamespace::__HitReactionVRIK__RotationOffset__RotationOffsetLink*,::Array<::GlobalNamespace::__HitReactionVRIK__RotationOffset__RotationOffsetLink*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__HitReactionVRIK__RotationOffset__RotationOffsetLink*,::Array<::GlobalNamespace::__HitReactionVRIK__RotationOffset__RotationOffsetLink*>*>& __get_offsetLinks() ;

constexpr ::ArrayW<::GlobalNamespace::__HitReactionVRIK__RotationOffset__RotationOffsetLink*,::Array<::GlobalNamespace::__HitReactionVRIK__RotationOffset__RotationOffsetLink*>*> const& __get_offsetLinks() const;
...
// Ctor Parameters []
// @brief default ctor
 __HitReactionVRIK__RotationOffset()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::RootMotion::FinalIK::OffsetModifierVRIK)]{};

/// @brief Field offsetCurves offset 0x30
...
/// @brief Field positionOffsets offset 0x38
 __declspec(property(get=__get_positionOffsets, put=__set_positionOffsets)) ::ArrayW<::RootMotion::FinalIK::__HitReactionVRIK__PositionOffset*,::Array<::RootMotion::FinalIK::__HitReactionVRIK__PositionOffset*>*>  positionOffsets;

/// @brief Field rotationOffsets offset 0x40
 __declspec(property(get=__get_rotationOffsets, put=__set_rotationOffsets)) ::ArrayW<::RootMotion::FinalIK::__HitReactionVRIK__RotationOffset*,::Array<::RootMotion::FinalIK::__HitReactionVRIK__RotationOffset*>*>  rotationOffsets;
