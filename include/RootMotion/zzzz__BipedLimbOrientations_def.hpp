...
/// @brief Field upperBoneForwardAxis offset 0x10
...
/// @brief Field lowerBoneForwardAxis offset 0x1c
...
/// @brief Field lastBoneLeftAxis offset 0x28
...
static inline ::RootMotion::__BipedLimbOrientations__LimbOrientation* New_ctor(::UnityEngine::Vector3  upperBoneForwardAxis, ::UnityEngine::Vector3  lowerBoneForwardAxis, ::UnityEngine::Vector3  lastBoneLeftAxis) ;
...
// Ctor Parameters []
// @brief default ctor
 __BipedLimbOrientations__LimbOrientation()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::__BipedLimbOrientations__LimbOrientation*> __get_leftArm() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::__BipedLimbOrientations__LimbOrientation*> __get_rightArm() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::__BipedLimbOrientations__LimbOrientation*> __get_leftLeg() const;
...
constexpr ::cordl_internals::to_const_pointer<::RootMotion::__BipedLimbOrientations__LimbOrientation*> __get_rightLeg() const;

static inline ::RootMotion::BipedLimbOrientations* New_ctor(::RootMotion::__BipedLimbOrientations__LimbOrientation*  leftArm, ::RootMotion::__BipedLimbOrientations__LimbOrientation*  rightArm, ::RootMotion::__BipedLimbOrientations__LimbOrientation*  leftLeg, ::RootMotion::__BipedLimbOrientations__LimbOrientation*  rightLeg) ;

/// @brief Method .ctor addr 0x1235d60 size 0x40 virtual false final false
inline void _ctor(::RootMotion::__BipedLimbOrientations__LimbOrientation*  leftArm, ::RootMotion::__BipedLimbOrientations__LimbOrientation*  rightArm, ::RootMotion::__BipedLimbOrientations__LimbOrientation*  leftLeg, ::RootMotion::__BipedLimbOrientations__LimbOrientation*  rightLeg) ;
