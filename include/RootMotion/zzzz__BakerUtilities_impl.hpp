...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::UnityEngine::Keyframe,::Array<::UnityEngine::Keyframe>*> (*)(::UnityEngine::AnimationCurve*, float_t)>(&::RootMotion::BakerUtilities::GetReducedKeyframes)> {
