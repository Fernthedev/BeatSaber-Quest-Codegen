...
/// @brief Method get_lightGroup addr 0x210f16c size 0x8 virtual false final false
inline ::GlobalNamespace::LightGroupSO* get_lightGroup() ;

/// @brief Method get_groupIntensity addr 0x210f174 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x210f17c size 0x30 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __DirectionalLightWithIdsGroupEntry__GroupLightData()  = default;
public:
...
/// @brief Method get_lightId addr 0x210f1ac size 0x8 virtual false final false
inline int32_t get_lightId() ;

/// @brief Method get_intensity addr 0x210f1b4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x210f1bc size 0x38 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __DirectionalLightWithIdsGroupEntry__LightIntensitiesWithId()  = default;
public:
...
/// @brief Field _directionalLightWithIds offset 0x18
...
/// @brief Field _groupLightData offset 0x20
 __declspec(property(get=__get__groupLightData, put=__set__groupLightData)) ::System::Collections::Generic::List_1<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightData*>*  _groupLightData;

/// @brief Field _individualLightData offset 0x28
 __declspec(property(get=__get__individualLightData, put=__set__individualLightData)) ::System::Collections::Generic::List_1<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__LightIntensitiesWithId*>*  _individualLightData;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::DirectionalLightWithIds*> __get__directionalLightWithIds() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__GroupLightData*>*> __get__groupLightData() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__DirectionalLightWithIdsGroupEntry__LightIntensitiesWithId*>*> __get__individualLightData() const;
...
/// @brief Method get_groupLightData addr 0x210f14c size 0x8 virtual false final false
...
/// @brief Method get_individualLightData addr 0x210f154 size 0x8 virtual false final false
...
/// @brief Method get_groupLightsWeighting addr 0x210f15c size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x210f164 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 DirectionalLightWithIdsGroupEntry()  = default;
public:
