...
struct CORDL_TYPE __ListLogger__LogType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____ListLogger__LogType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __ListLogger__LogType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ListLogger__LogType()  = default;
...
/// @brief Field context offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get_context() const;
...
// Ctor Parameters []
// @brief default ctor
 __ListLogger__LogMessage()  = default;
public:
...
/// @brief Field _messages offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__ListLogger__LogMessage*>*> __get__messages() const;
