...
/// @brief Field _playersSpecificSettings offset 0x30
 __declspec(property(get=__get__playersSpecificSettings, put=__set__playersSpecificSettings)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::PlayerSpecificSettingsNetSerializable*>*  _playersSpecificSettings;

/// @brief Field _started offset 0x38
 __declspec(property(get=__get__started, put=__set__started)) bool  _started;

/// @brief Field _sessionGameId offset 0x40
 __declspec(property(get=__get__sessionGameId, put=__set__sessionGameId)) ::StringW  _sessionGameId;

/// @brief Field sceneSetupDidFinishEvent offset 0x48
...
/// @brief Field sceneSetupDidReceiveTooLateEvent offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::PlayerSpecificSettingsNetSerializable*>*> __get__playersSpecificSettings() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::StringW>*> __get_sceneSetupDidFinishEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::StringW>*> __get_sceneSetupDidReceiveTooLateEvent() const;

/// @brief Method add_sceneSetupDidFinishEvent addr 0xe54748 size 0xb0 virtual false final false
inline void add_sceneSetupDidFinishEvent(::System::Action_1<::StringW>*  value) ;

/// @brief Method remove_sceneSetupDidFinishEvent addr 0xe547f8 size 0xb0 virtual false final false
inline void remove_sceneSetupDidFinishEvent(::System::Action_1<::StringW>*  value) ;

/// @brief Method add_sceneSetupDidReceiveTooLateEvent addr 0xe548a8 size 0xb0 virtual false final false
inline void add_sceneSetupDidReceiveTooLateEvent(::System::Action_1<::StringW>*  value) ;

/// @brief Method remove_sceneSetupDidReceiveTooLateEvent addr 0xe54958 size 0xb0 virtual false final false
...
/// @brief Method .ctor addr 0xe54a08 size 0xe8 virtual false final false
...
/// @brief Method Dispose addr 0xe54af0 size 0x364 virtual true final true
inline void Dispose() ;

/// @brief Method GetSceneLoadStatus addr 0xe54e54 size 0x6e4 virtual false final false
inline void GetSceneLoadStatus() ;

/// @brief Method ForceStart addr 0xe558ac size 0x6f0 virtual false final false
inline void ForceStart() ;

/// @brief Method HandleSetGameplaySceneReady addr 0xe55f9c size 0x3c8 virtual false final false
...
/// @brief Method HandleGetGameplaySceneReady addr 0xe56364 size 0xb4 virtual false final false
inline void HandleGetGameplaySceneReady(::StringW  userId) ;

/// @brief Method HandleSetGameplaySceneSyncFinished addr 0xe56418 size 0x68 virtual false final false
...
/// @brief Method HandleSetPlayerDidConnectLate addr 0xe56480 size 0x2a0 virtual false final false
...
/// @brief Method AddPlayerSpecificSettingsToDictionary addr 0xe55538 size 0x6c virtual false final false
...
/// @brief Method CreatePlayersSpecificSettingsAtGameStartData addr 0xe555a4 size 0x308 virtual false final false
