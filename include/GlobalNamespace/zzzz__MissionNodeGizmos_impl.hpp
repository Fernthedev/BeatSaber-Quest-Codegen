...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionNode*> GlobalNamespace::MissionNodeGizmos::__get__missionNode() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MissionNode*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameplayModifiersModelSO*> GlobalNamespace::MissionNodeGizmos::__get__gameplayModifiersModel() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayModifiersModelSO*, 0x20>(this);
}
constexpr void GlobalNamespace::MissionNodeGizmos::__set__missionProgressModel(::GlobalNamespace::CampaignProgressModel*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::CampaignProgressModel*, 0x28>(this, std::forward<::GlobalNamespace::CampaignProgressModel*>(value));
}
constexpr ::GlobalNamespace::CampaignProgressModel* GlobalNamespace::MissionNodeGizmos::__get__missionProgressModel()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::CampaignProgressModel*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::CampaignProgressModel*> GlobalNamespace::MissionNodeGizmos::__get__missionProgressModel() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::CampaignProgressModel*, 0x28>(this);
}
