...
/// @brief Field kInMultiplayerLobbyRichPresenceLocalizationKey offset 0x0
static constexpr ::ConstString  kInMultiplayerLobbyRichPresenceLocalizationKey{u"IN_MULTIPLAYER_LOBBY_PRESENCE"};

/// @brief Field <apiName>k__BackingField offset 0x10
...
/// @brief Field <localizedDescription>k__BackingField offset 0x18
...
/// @brief Field <multiplayerSecret>k__BackingField offset 0x20
...
/// @brief Field <atMaxPartySize>k__BackingField offset 0x28
...
/// @brief Field <canInvite>k__BackingField offset 0x29
...
// Ctor Parameters []
// @brief default ctor
 InMultiplayerRichPresenceData()  = default;
public:
