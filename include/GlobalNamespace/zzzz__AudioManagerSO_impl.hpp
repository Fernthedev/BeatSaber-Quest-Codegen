...
::cordl_internals::setInstanceField<::UnityEngine::Audio::AudioMixer*, 0x18>(this, std::forward<::UnityEngine::Audio::AudioMixer*>(value));
}
constexpr ::UnityEngine::Audio::AudioMixer* GlobalNamespace::AudioManagerSO::__get__audioMixer()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Audio::AudioMixer*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Audio::AudioMixer*> GlobalNamespace::AudioManagerSO::__get__audioMixer() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Audio::AudioMixer*, 0x18>(this);
}
