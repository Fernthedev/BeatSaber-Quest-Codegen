...
struct CORDL_TYPE __FormattedFloatListSettingsValueController__ValueType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____FormattedFloatListSettingsValueController__ValueType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __FormattedFloatListSettingsValueController__ValueType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __FormattedFloatListSettingsValueController__ValueType()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x50 - sizeof(::GlobalNamespace::ListSettingsController)]{};
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FloatSO*> __get__settingsValue() const;
...
// Ctor Parameters []
// @brief default ctor
 FormattedFloatListSettingsValueController()  = default;
public:
