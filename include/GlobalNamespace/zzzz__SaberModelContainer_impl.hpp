...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::Saber*> GlobalNamespace::SaberModelContainer::__get__saber() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::Saber*, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::SaberModelController*, 0x20>(this, std::forward<::GlobalNamespace::SaberModelController*>(value));
}
constexpr ::GlobalNamespace::SaberModelController* GlobalNamespace::SaberModelContainer::__get__saberModelControllerPrefab()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SaberModelController*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SaberModelController*> GlobalNamespace::SaberModelContainer::__get__saberModelControllerPrefab() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SaberModelController*, 0x20>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::DiContainer*> GlobalNamespace::SaberModelContainer::__get__container() const {
return ::cordl_internals::getInstanceField<::Zenject::DiContainer*, 0x28>(this);
}
