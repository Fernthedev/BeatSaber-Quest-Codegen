...
/// @brief Method GetValue addr 0x23cf874 size 0x3c virtual true final false
...
/// @brief Method .ctor addr 0x23cf8b0 size 0x10 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerBadgeDataPrecisionSO()  = default;
public:
