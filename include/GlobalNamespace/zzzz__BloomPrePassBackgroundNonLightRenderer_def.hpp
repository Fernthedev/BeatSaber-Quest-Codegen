...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x68 - sizeof(::GlobalNamespace::BloomPrePassBackgroundNonLightRendererCore)]{};
...
/// @brief Field _cachedTransform offset 0x60
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__cachedTransform() const;

/// @brief Method get_renderer addr 0x2105844 size 0x8 virtual true final false
inline ::UnityEngine::Renderer* get_renderer() ;

/// @brief Method get_meshFilter addr 0x210584c size 0x8 virtual false final false
inline ::UnityEngine::MeshFilter* get_meshFilter() ;

/// @brief Method get_cachedTransform addr 0x2105854 size 0x8 virtual false final false
inline ::UnityEngine::Transform* get_cachedTransform() ;

/// @brief Method set_isPartOfInstancedRendering addr 0x2104cd4 size 0x30 virtual false final false
inline void set_isPartOfInstancedRendering(bool  value) ;

/// @brief Method Awake addr 0x2105a3c size 0x2c virtual true final false
inline void Awake() ;

/// @brief Method OnEnable addr 0x2105a74 size 0x10 virtual true final false
inline void OnEnable() ;

/// @brief Method OnValidate addr 0x2105a88 size 0x34 virtual true final false
inline void OnValidate() ;

/// @brief Method InitIfNeeded addr 0x2105abc size 0xc8 virtual true final false
inline void InitIfNeeded() ;

static inline ::GlobalNamespace::BloomPrePassBackgroundNonLightRenderer* New_ctor() ;

/// @brief Method .ctor addr 0x2105c98 size 0x54 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 BloomPrePassBackgroundNonLightRenderer()  = default;
public:
