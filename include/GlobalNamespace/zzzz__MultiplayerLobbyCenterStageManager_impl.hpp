...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> GlobalNamespace::MultiplayerLobbyCenterStageManager::__get__centerObjectTransform() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::CenterStageScreenController*, 0x20>(this, std::forward<::GlobalNamespace::CenterStageScreenController*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::CenterStageScreenController*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::CenterStageScreenController*> GlobalNamespace::MultiplayerLobbyCenterStageManager::__get__centerStageScreenController() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::CenterStageScreenController*, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::ILobbyStateDataModel*, 0x28>(this, std::forward<::GlobalNamespace::ILobbyStateDataModel*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::ILobbyStateDataModel*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ILobbyStateDataModel*> GlobalNamespace::MultiplayerLobbyCenterStageManager::__get__lobbyStateDataModel() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ILobbyStateDataModel*, 0x28>(this);
}
