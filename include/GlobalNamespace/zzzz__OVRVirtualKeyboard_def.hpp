...
struct CORDL_TYPE __OVRVirtualKeyboard__KeyboardPosition : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____OVRVirtualKeyboard__KeyboardPosition_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __OVRVirtualKeyboard__KeyboardPosition(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRVirtualKeyboard__KeyboardPosition()  = default;
...
struct CORDL_TYPE __OVRVirtualKeyboard__InteractorRootTransformOverride__InteractorRootOverrideData : public ::bs_hook::ValueTypeWrapper<0x40> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field originalPose offset 0x8
 __declspec(property(get=__get_originalPose, put=__set_originalPose)) ::GlobalNamespace::OVRPose  originalPose;

/// @brief Field targetPose offset 0x24
 __declspec(property(get=__get_targetPose, put=__set_targetPose)) ::GlobalNamespace::OVRPose  targetPose;
...
constexpr void __set_originalPose(::GlobalNamespace::OVRPose  value) ;

constexpr ::GlobalNamespace::OVRPose& __get_originalPose() ;

constexpr ::GlobalNamespace::OVRPose const& __get_originalPose() const;

constexpr void __set_targetPose(::GlobalNamespace::OVRPose  value) ;

constexpr ::GlobalNamespace::OVRPose& __get_targetPose() ;

constexpr ::GlobalNamespace::OVRPose const& __get_targetPose() const;

// Ctor Parameters [CppParam { name: "root", ty: "::UnityEngine::Transform*", modifiers: "", def_value: None }, CppParam { name: "originalPose", ty: "::GlobalNamespace::OVRPose", modifiers: "", def_value: None }, CppParam { name: "targetPose", ty: "::GlobalNamespace::OVRPose", modifiers: "", def_value: None }]
constexpr __OVRVirtualKeyboard__InteractorRootTransformOverride__InteractorRootOverrideData(::UnityEngine::Transform*  root, ::GlobalNamespace::OVRPose  originalPose, ::GlobalNamespace::OVRPose  targetPose) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRVirtualKeyboard__InteractorRootTransformOverride__InteractorRootOverrideData(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x40>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRVirtualKeyboard__InteractorRootTransformOverride__InteractorRootOverrideData()  = default;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRVirtualKeyboard__InteractorRootTransformOverride*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __OVRVirtualKeyboard__InteractorRootTransformOverride___RevertInteractorOverrides_d__6()  = default;
public:
...
/// @brief Field applyQueue offset 0x10
 __declspec(property(get=__get_applyQueue, put=__set_applyQueue)) ::System::Collections::Generic::Queue_1<::GlobalNamespace::__OVRVirtualKeyboard__InteractorRootTransformOverride__InteractorRootOverrideData>*  applyQueue;

/// @brief Field revertQueue offset 0x18
 __declspec(property(get=__get_revertQueue, put=__set_revertQueue)) ::System::Collections::Generic::Queue_1<::GlobalNamespace::__OVRVirtualKeyboard__InteractorRootTransformOverride__InteractorRootOverrideData>*  revertQueue;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Queue_1<::GlobalNamespace::__OVRVirtualKeyboard__InteractorRootTransformOverride__InteractorRootOverrideData>*> __get_applyQueue() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Queue_1<::GlobalNamespace::__OVRVirtualKeyboard__InteractorRootTransformOverride__InteractorRootOverrideData>*> __get_revertQueue() const;
...
// Ctor Parameters []
// @brief default ctor
 __OVRVirtualKeyboard__InteractorRootTransformOverride()  = default;
public:
...
struct CORDL_TYPE __OVRVirtualKeyboard__InputSource : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____OVRVirtualKeyboard__InputSource_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRVirtualKeyboard__InputSource(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRVirtualKeyboard__InputSource()  = default;
...
/// @brief Field _operatingWithoutOVRCameraRig offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRCameraRig*> __get__rig() const;
...
// Ctor Parameters []
// @brief default ctor
 __OVRVirtualKeyboard__BaseInputSource()  = default;
public:
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(8052))}
...
/// @brief Field _controllerType offset 0x34
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__rootTransform() const;

constexpr void __set__directTransform(::UnityEngine::Transform*  value) ;

constexpr ::UnityEngine::Transform* __get__directTransform() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__directTransform() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRVirtualKeyboard*> __get__keyboard() const;
...
// Ctor Parameters []
// @brief default ctor
 __OVRVirtualKeyboard__ControllerInputSource()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __OVRVirtualKeyboard__HandInputSource____c()  = default;
public:
...
/// @brief Field _hand offset 0x20
 __declspec(property(get=__get__hand, put=__set__hand)) ::GlobalNamespace::OVRHand*  _hand;

/// @brief Field _inputSource offset 0x28
 __declspec(property(get=__get__inputSource, put=__set__inputSource)) ::GlobalNamespace::__OVRVirtualKeyboard__InputSource  _inputSource;

/// @brief Field _keyboard offset 0x30
 __declspec(property(get=__get__keyboard, put=__set__keyboard)) ::GlobalNamespace::OVRVirtualKeyboard*  _keyboard;

/// @brief Field _skeleton offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRHand*> __get__hand() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRSkeleton*> __get__skeleton() const;
...
// Ctor Parameters []
// @brief default ctor
 __OVRVirtualKeyboard__HandInputSource()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __OVRVirtualKeyboard____c()  = default;
public:
...
// Static field <>9__68_0

// Static field <>9__70_0
...
/// @brief Field InitialPosition offset 0x48
...
/// @brief Field leftControllerDirectTransform offset 0x60
...
/// @brief Field rightControllerRootTransform offset 0x68
...
/// @brief Field rightControllerDirectTransform offset 0x70
...
/// @brief Field controllerDirectInteraction offset 0x78
...
/// @brief Field InputEnabled offset 0xb8
 __declspec(property(get=__get_InputEnabled, put=__set_InputEnabled)) bool  InputEnabled;

/// @brief Field isKeyboardCreated_ offset 0xb9
 __declspec(property(get=__get_isKeyboardCreated_, put=__set_isKeyboardCreated_)) bool  isKeyboardCreated_;

/// @brief Field keyboardSpace_ offset 0xc0
 __declspec(property(get=__get_keyboardSpace_, put=__set_keyboardSpace_)) uint64_t  keyboardSpace_;

/// @brief Field virtualKeyboardTextures_ offset 0xc8
 __declspec(property(get=__get_virtualKeyboardTextures_, put=__set_virtualKeyboardTextures_)) ::System::Collections::Generic::Dictionary_2<uint64_t,::System::Collections::Generic::List_1<::UnityEngine::Material*>*>*  virtualKeyboardTextures_;

/// @brief Field virtualKeyboardScene_ offset 0xd0
...
/// @brief Field virtualKeyboardModelKey_ offset 0xf8
...
/// @brief Field modelInitialized_ offset 0x100
 __declspec(property(get=__get_modelInitialized_, put=__set_modelInitialized_)) bool  modelInitialized_;

/// @brief Field modelAvailable_ offset 0x101
 __declspec(property(get=__get_modelAvailable_, put=__set_modelAvailable_)) bool  modelAvailable_;

/// @brief Field keyboardVisible_ offset 0x102
 __declspec(property(get=__get_keyboardVisible_, put=__set_keyboardVisible_)) bool  keyboardVisible_;

/// @brief Field _interactorRootTransformOverride offset 0x108
 __declspec(property(get=__get__interactorRootTransformOverride, put=__set__interactorRootTransformOverride)) ::GlobalNamespace::__OVRVirtualKeyboard__InteractorRootTransformOverride*  _interactorRootTransformOverride;

/// @brief Field _inputSources offset 0x110
...
/// @brief Field ignoreTextCommmitFieldOnValueChanged_ offset 0x118
...
/// @brief Field runtimeInputField_ offset 0x120
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::StringW>*> __get_CommitText() const;

constexpr void __set_Backspace(::System::Action*  value) ;

constexpr ::System::Action* __get_Backspace() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_Backspace() const;

constexpr void __set_Enter(::System::Action*  value) ;

constexpr ::System::Action* __get_Enter() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_Enter() const;

constexpr void __set_KeyboardShown(::System::Action*  value) ;

constexpr ::System::Action* __get_KeyboardShown() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_KeyboardShown() const;

constexpr void __set_KeyboardHidden(::System::Action*  value) ;

constexpr ::System::Action* __get_KeyboardHidden() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_KeyboardHidden() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Collider*> __get__Collider_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::InputField*> __get_textCommitField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_leftControllerRootTransform() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_leftControllerDirectTransform() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_rightControllerRootTransform() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_rightControllerDirectTransform() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::EventSystems::OVRPhysicsRaycaster*> __get_controllerRaycaster() const;

constexpr void __set_handLeft(::GlobalNamespace::OVRHand*  value) ;

constexpr ::GlobalNamespace::OVRHand* __get_handLeft() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRHand*> __get_handLeft() const;

constexpr void __set_handRight(::GlobalNamespace::OVRHand*  value) ;

constexpr ::GlobalNamespace::OVRHand* __get_handRight() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRHand*> __get_handRight() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::EventSystems::OVRPhysicsRaycaster*> __get_handRaycaster() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint64_t,::System::Collections::Generic::List_1<::UnityEngine::Material*>*>*> __get_virtualKeyboardTextures_() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRVirtualKeyboard__InteractorRootTransformOverride*> __get__interactorRootTransformOverride() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__OVRVirtualKeyboard__IInputSource*>*> __get__inputSources() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::InputField*> __get_runtimeInputField_() const;
