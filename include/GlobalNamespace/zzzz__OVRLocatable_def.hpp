...
struct CORDL_TYPE __OVRLocatable__TrackingSpacePose : public ::bs_hook::ValueTypeWrapper<0x30> {
public:
// Declarations
...
/// @brief Field _flags offset 0x28
 __declspec(property(get=__get__flags, put=__set__flags)) ::GlobalNamespace::__OVRPlugin__SpaceLocationFlags  _flags;
...
constexpr void __set__flags(::GlobalNamespace::__OVRPlugin__SpaceLocationFlags  value) ;

constexpr ::GlobalNamespace::__OVRPlugin__SpaceLocationFlags& __get__flags() ;

constexpr ::GlobalNamespace::__OVRPlugin__SpaceLocationFlags const& __get__flags() const;
...
constexpr explicit __OVRLocatable__TrackingSpacePose(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x30>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRLocatable__TrackingSpacePose()  = default;
...
struct CORDL_TYPE OVRLocatable : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit OVRLocatable(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 OVRLocatable()  = default;
