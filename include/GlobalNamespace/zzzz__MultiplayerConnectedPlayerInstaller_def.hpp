...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x80 - sizeof(::Zenject::MonoInstaller)]{};

/// @brief Field _connectedPlayerAudioTimeSyncControllerPrefab offset 0x20
 __declspec(property(get=__get__connectedPlayerAudioTimeSyncControllerPrefab, put=__set__connectedPlayerAudioTimeSyncControllerPrefab)) ::GlobalNamespace::MultiplayerConnectedPlayerSongTimeSyncController*  _connectedPlayerAudioTimeSyncControllerPrefab;

/// @brief Field _connectedPlayerBeatmapObjectEventManagerPrefab offset 0x28
 __declspec(property(get=__get__connectedPlayerBeatmapObjectEventManagerPrefab, put=__set__connectedPlayerBeatmapObjectEventManagerPrefab)) ::GlobalNamespace::MultiplayerConnectedPlayerBeatmapObjectEventManager*  _connectedPlayerBeatmapObjectEventManagerPrefab;

/// @brief Field _multiplayerGameNoteControllerPrefab offset 0x30
 __declspec(property(get=__get__multiplayerGameNoteControllerPrefab, put=__set__multiplayerGameNoteControllerPrefab)) ::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*  _multiplayerGameNoteControllerPrefab;

/// @brief Field _multiplayerBurstSliderHeadGameNoteControllerPrefab offset 0x38
 __declspec(property(get=__get__multiplayerBurstSliderHeadGameNoteControllerPrefab, put=__set__multiplayerBurstSliderHeadGameNoteControllerPrefab)) ::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*  _multiplayerBurstSliderHeadGameNoteControllerPrefab;

/// @brief Field _multiplayerBurstSliderGameNoteControllerPrefab offset 0x40
 __declspec(property(get=__get__multiplayerBurstSliderGameNoteControllerPrefab, put=__set__multiplayerBurstSliderGameNoteControllerPrefab)) ::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*  _multiplayerBurstSliderGameNoteControllerPrefab;

/// @brief Field _multiplayerBurstSliderFillControllerPrefab offset 0x48
 __declspec(property(get=__get__multiplayerBurstSliderFillControllerPrefab, put=__set__multiplayerBurstSliderFillControllerPrefab)) ::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*  _multiplayerBurstSliderFillControllerPrefab;

/// @brief Field _multiplayerBombNoteControllerPrefab offset 0x50
 __declspec(property(get=__get__multiplayerBombNoteControllerPrefab, put=__set__multiplayerBombNoteControllerPrefab)) ::GlobalNamespace::MultiplayerConnectedPlayerBombNoteController*  _multiplayerBombNoteControllerPrefab;

/// @brief Field _multiplayerObstacleControllerPrefab offset 0x58
 __declspec(property(get=__get__multiplayerObstacleControllerPrefab, put=__set__multiplayerObstacleControllerPrefab)) ::GlobalNamespace::MultiplayerConnectedPlayerObstacleController*  _multiplayerObstacleControllerPrefab;
...
/// @brief Field _localPlayerStartState offset 0x68
...
/// @brief Field _playersSpecificSettingsAtGameStartModel offset 0x78
 __declspec(property(get=__get__playersSpecificSettingsAtGameStartModel, put=__set__playersSpecificSettingsAtGameStartModel)) ::GlobalNamespace::PlayersSpecificSettingsAtGameStartModel*  _playersSpecificSettingsAtGameStartModel;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerConnectedPlayerSongTimeSyncController*> __get__connectedPlayerAudioTimeSyncControllerPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerConnectedPlayerBeatmapObjectEventManager*> __get__connectedPlayerBeatmapObjectEventManagerPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*> __get__multiplayerGameNoteControllerPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*> __get__multiplayerBurstSliderHeadGameNoteControllerPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*> __get__multiplayerBurstSliderGameNoteControllerPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*> __get__multiplayerBurstSliderFillControllerPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerConnectedPlayerBombNoteController*> __get__multiplayerBombNoteControllerPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerConnectedPlayerObstacleController*> __get__multiplayerObstacleControllerPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlayersSpecificSettingsAtGameStartModel*> __get__playersSpecificSettingsAtGameStartModel() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerConnectedPlayerInstaller()  = default;
public:
