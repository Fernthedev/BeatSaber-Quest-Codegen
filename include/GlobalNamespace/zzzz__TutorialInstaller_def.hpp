...
/// @brief Field _effectPoolsManualInstaller offset 0x38
...
/// @brief Field _sceneSetupData offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::TutorialSceneSetupData*> __get__sceneSetupData() const;

/// @brief Method InstallBindings addr 0x2273700 size 0xd08 virtual true final false
inline void InstallBindings() ;

static inline ::GlobalNamespace::TutorialInstaller* New_ctor() ;

/// @brief Method .ctor addr 0x2274408 size 0x10 virtual false final false
inline void _ctor() ;
