...
/// @brief Field _beatmapObjectsData offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapObjectData*>*> __get__beatmapObjectsData() const;
