...
/// @brief Field missionHelp offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionHelpSO*> __get_missionHelp() const;
...
/// @brief Method .ctor addr 0x22c9c4c size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __MissionHelpViewController__MissionHelpGameObjectPair()  = default;
public:
...
/// @brief Field _missionHelpGameObjectPairs offset 0x78
 __declspec(property(get=__get__missionHelpGameObjectPairs, put=__set__missionHelpGameObjectPairs)) ::ArrayW<::GlobalNamespace::__MissionHelpViewController__MissionHelpGameObjectPair*,::Array<::GlobalNamespace::__MissionHelpViewController__MissionHelpGameObjectPair*>*>  _missionHelpGameObjectPairs;
...
/// @brief Field _missionHelp offset 0x88
...
constexpr void __set__missionHelpGameObjectPairs(::ArrayW<::GlobalNamespace::__MissionHelpViewController__MissionHelpGameObjectPair*,::Array<::GlobalNamespace::__MissionHelpViewController__MissionHelpGameObjectPair*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__MissionHelpViewController__MissionHelpGameObjectPair*,::Array<::GlobalNamespace::__MissionHelpViewController__MissionHelpGameObjectPair*>*>& __get__missionHelpGameObjectPairs() ;

constexpr ::ArrayW<::GlobalNamespace::__MissionHelpViewController__MissionHelpGameObjectPair*,::Array<::GlobalNamespace::__MissionHelpViewController__MissionHelpGameObjectPair*>*> const& __get__missionHelpGameObjectPairs() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::MissionHelpViewController*>*> __get_didFinishEvent() const;
...
/// @brief Method add_didFinishEvent addr 0x22c991c size 0xb0 virtual false final false
inline void add_didFinishEvent(::System::Action_1<::GlobalNamespace::MissionHelpViewController*>*  value) ;

/// @brief Method remove_didFinishEvent addr 0x22c99cc size 0xb0 virtual false final false
inline void remove_didFinishEvent(::System::Action_1<::GlobalNamespace::MissionHelpViewController*>*  value) ;

/// @brief Method Setup addr 0x22c9a7c size 0x2c virtual false final false
inline void Setup(::GlobalNamespace::MissionHelpSO*  missionHelp) ;

/// @brief Method DidActivate addr 0x22c9b78 size 0xac virtual true final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method RefreshContent addr 0x22c9aa8 size 0xd0 virtual false final false
inline void RefreshContent() ;

/// @brief Method OkButtonPressed addr 0x22c9c24 size 0x20 virtual false final false
inline void OkButtonPressed() ;

static inline ::GlobalNamespace::MissionHelpViewController* New_ctor() ;

/// @brief Method .ctor addr 0x22c9c44 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 MissionHelpViewController()  = default;
public:
