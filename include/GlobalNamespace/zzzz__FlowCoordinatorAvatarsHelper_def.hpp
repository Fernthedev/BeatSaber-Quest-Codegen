...
/// @brief Field playerDataModel offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __FlowCoordinatorAvatarsHelper____c__DisplayClass0_0()  = default;
public:
...
struct CORDL_TYPE __FlowCoordinatorAvatarsHelper___HasUserSelectedAvatarSystemWithCreatedAvatar_d__0 : public ::bs_hook::ValueTypeWrapper<0x38> {
public:
// Declarations
...
/// @brief Field playerDataModel offset 0x20
 __declspec(property(get=__get_playerDataModel, put=__set_playerDataModel)) ::GlobalNamespace::PlayerDataModel*  playerDataModel;

/// @brief Field avatarSystemCollection offset 0x28
 __declspec(property(get=__get_avatarSystemCollection, put=__set_avatarSystemCollection)) ::BeatSaber::AvatarCore::AvatarSystemCollection*  avatarSystemCollection;
...
constexpr void __set_avatarSystemCollection(::BeatSaber::AvatarCore::AvatarSystemCollection*  value) ;

constexpr ::BeatSaber::AvatarCore::AvatarSystemCollection* __get_avatarSystemCollection() ;

constexpr ::cordl_internals::to_const_pointer<::BeatSaber::AvatarCore::AvatarSystemCollection*> __get_avatarSystemCollection() const;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<bool>", modifiers: "", def_value: None }, CppParam { name: "playerDataModel", ty: "::GlobalNamespace::PlayerDataModel*", modifiers: "", def_value: None }, CppParam { name: "avatarSystemCollection", ty: "::BeatSaber::AvatarCore::AvatarSystemCollection*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<bool>", modifiers: "", def_value: None }]
constexpr __FlowCoordinatorAvatarsHelper___HasUserSelectedAvatarSystemWithCreatedAvatar_d__0(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<bool>  __t__builder, ::GlobalNamespace::PlayerDataModel*  playerDataModel, ::BeatSaber::AvatarCore::AvatarSystemCollection*  avatarSystemCollection, ::System::Runtime::CompilerServices::TaskAwaiter_1<bool>  __u__1) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __FlowCoordinatorAvatarsHelper___HasUserSelectedAvatarSystemWithCreatedAvatar_d__0(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x38>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __FlowCoordinatorAvatarsHelper___HasUserSelectedAvatarSystemWithCreatedAvatar_d__0()  = default;
...
// Ctor Parameters []
// @brief default ctor
 FlowCoordinatorAvatarsHelper()  = default;
public:
