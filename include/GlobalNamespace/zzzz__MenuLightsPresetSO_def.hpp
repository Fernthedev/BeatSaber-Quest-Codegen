...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorSO*> __get_baseColor() const;
...
/// @brief Method get_lightColor addr 0x23524dc size 0x2c virtual false final false
inline ::UnityEngine::Color get_lightColor() ;

static inline ::GlobalNamespace::__MenuLightsPresetSO__LightIdColorPair* New_ctor() ;

/// @brief Method .ctor addr 0x2352508 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __MenuLightsPresetSO__LightIdColorPair()  = default;
public:
...
/// @brief Field _playersPlaceNeonsColor offset 0x18
...
/// @brief Field _playersPlaceNeonsIntensity offset 0x20
...
/// @brief Field _lightIdColorPairs offset 0x28
 __declspec(property(get=__get__lightIdColorPairs, put=__set__lightIdColorPairs)) ::ArrayW<::GlobalNamespace::__MenuLightsPresetSO__LightIdColorPair*,::Array<::GlobalNamespace::__MenuLightsPresetSO__LightIdColorPair*>*>  _lightIdColorPairs;
 ...
 __declspec(property(get=get_lightIdColorPairs)) ::ArrayW<::GlobalNamespace::__MenuLightsPresetSO__LightIdColorPair*,::Array<::GlobalNamespace::__MenuLightsPresetSO__LightIdColorPair*>*>  lightIdColorPairs;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorSO*> __get__playersPlaceNeonsColor() const;
...
/// @brief Method get_playersPlaceNeonsColor addr 0x23524b4 size 0x8 virtual false final false
inline ::GlobalNamespace::ColorSO* get_playersPlaceNeonsColor() ;

/// @brief Method get_playersPlaceNeonsIntensity addr 0x23524bc size 0x8 virtual false final false
inline float_t get_playersPlaceNeonsIntensity() ;

/// @brief Method get_lightIdColorPairs addr 0x23524c4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x23524cc size 0x10 virtual false final false
inline void _ctor() ;
