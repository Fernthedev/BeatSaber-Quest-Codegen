...
struct CORDL_TYPE OVRAnchorContainer : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
...
constexpr explicit OVRAnchorContainer(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 OVRAnchorContainer()  = default;
