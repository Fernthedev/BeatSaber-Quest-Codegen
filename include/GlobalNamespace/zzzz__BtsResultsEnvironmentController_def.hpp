...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__placeTransform() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BTSCharacterResultAnimationController*> __get__animationController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BTSCharacter*> __get__btsCharacter() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AddressableAssets::AssetReference*> __get__btsCharacterAssetReference() const;
...
// Ctor Parameters []
// @brief default ctor
 __BtsResultsEnvironmentController__BTSResultCharacterPlaceWithAnimation()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BtsResultsEnvironmentController*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __BtsResultsEnvironmentController___DestroyCharactersDelayed_d__11()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::GlobalNamespace::BaseResultsEnvironmentController)]{};
...
/// @brief Field _btsCharacterAnimationWrapper offset 0x18
...
/// @brief Field _btsCharactersResultsAppearPlayableDirector offset 0x28
 __declspec(property(get=__get__btsCharactersResultsAppearPlayableDirector, put=__set__btsCharactersResultsAppearPlayableDirector)) ::UnityEngine::Playables::PlayableDirector*  _btsCharactersResultsAppearPlayableDirector;

/// @brief Field _resultPlacesWithAnimations offset 0x30
 __declspec(property(get=__get__resultPlacesWithAnimations, put=__set__resultPlacesWithAnimations)) ::ArrayW<::GlobalNamespace::__BtsResultsEnvironmentController__BTSResultCharacterPlaceWithAnimation*,::Array<::GlobalNamespace::__BtsResultsEnvironmentController__BTSResultCharacterPlaceWithAnimation*>*>  _resultPlacesWithAnimations;

/// @brief Field _handles offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__btsCharacterAnimationWrapper() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Playables::PlayableDirector*> __get__btsCharactersResultsAppearPlayableDirector() const;

constexpr void __set__resultPlacesWithAnimations(::ArrayW<::GlobalNamespace::__BtsResultsEnvironmentController__BTSResultCharacterPlaceWithAnimation*,::Array<::GlobalNamespace::__BtsResultsEnvironmentController__BTSResultCharacterPlaceWithAnimation*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__BtsResultsEnvironmentController__BTSResultCharacterPlaceWithAnimation*,::Array<::GlobalNamespace::__BtsResultsEnvironmentController__BTSResultCharacterPlaceWithAnimation*>*>& __get__resultPlacesWithAnimations() ;

constexpr ::ArrayW<::GlobalNamespace::__BtsResultsEnvironmentController__BTSResultCharacterPlaceWithAnimation*,::Array<::GlobalNamespace::__BtsResultsEnvironmentController__BTSResultCharacterPlaceWithAnimation*>*> const& __get__resultPlacesWithAnimations() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::ResourceManagement::AsyncOperations::AsyncOperationHandle>*> __get__handles() const;
...
// Ctor Parameters []
// @brief default ctor
 BtsResultsEnvironmentController()  = default;
public:
