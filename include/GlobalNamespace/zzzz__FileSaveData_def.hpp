...
/// @brief Method Save addr 0x20f498c size 0x10 virtual true final true
inline void Save(::StringW  key, ::StringW  value) ;

/// @brief Method Load addr 0x20f499c size 0x80 virtual true final true
inline bool Load(::StringW  key, ByRef<::StringW>  value) ;

/// @brief Method Save addr 0x20f4a1c size 0x78 virtual true final true
inline void Save(::StringW  key, ::StringW  value, ::StringW  tempKey, ::StringW  backupKey) ;

/// @brief Method Load addr 0x20f4a94 size 0x168 virtual true final true
inline bool Load(::StringW  key, ByRef<::StringW>  value, ::StringW  backupKey) ;

/// @brief Method Delete addr 0x20f4bfc size 0xc virtual true final true
inline void Delete(::StringW  key) ;

/// @brief Method HasKey addr 0x20f4c08 size 0xc virtual true final true
inline bool HasKey(::StringW  key) ;

static inline ::GlobalNamespace::FileSaveData* New_ctor() ;

/// @brief Method .ctor addr 0x20f4c14 size 0x8 virtual false final false
inline void _ctor() ;
