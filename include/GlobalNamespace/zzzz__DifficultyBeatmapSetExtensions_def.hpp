...
template<typename T>
static inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::PreviewDifficultyBeatmapSet*>* GetPreviewDifficultyBeatmapSets(::System::Collections::Generic::IReadOnlyList_1<T>*  difficultyBeatmapSets) ;
...
// Ctor Parameters []
// @brief default ctor
 DifficultyBeatmapSetExtensions()  = default;
public:
