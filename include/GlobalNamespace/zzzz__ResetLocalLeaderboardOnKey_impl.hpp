...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LocalLeaderboardsModel*> GlobalNamespace::ResetLocalLeaderboardOnKey::__get__localLeaderboardsModel() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::LocalLeaderboardsModel*, 0x18>(this);
}
constexpr void GlobalNamespace::ResetLocalLeaderboardOnKey::__set__keyCode(::UnityEngine::KeyCode  value)  {
::cordl_internals::setInstanceField<::UnityEngine::KeyCode, 0x20>(this, std::forward<::UnityEngine::KeyCode>(value));
}
constexpr ::UnityEngine::KeyCode& GlobalNamespace::ResetLocalLeaderboardOnKey::__get__keyCode()  {
return ::cordl_internals::getInstanceField<::UnityEngine::KeyCode, 0x20>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ISaveData*> GlobalNamespace::ResetLocalLeaderboardOnKey::__get__saveData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ISaveData*, 0x28>(this);
}
