...
/// @brief Field materialPropertyBlockController offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LightGroup*> __get_lightGroup() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MaterialPropertyBlockController*> __get_materialPropertyBlockController() const;
...
// Ctor Parameters []
// @brief default ctor
 __BufferedLightColorGroupEffect__InitData()  = default;
public:
...
/// @brief Field _colorBoostBeatmapDataCallbackWrapper offset 0x28
...
/// @brief Field _lightColorBeatmapEventCallbackWrappers offset 0x30
 __declspec(property(get=__get__lightColorBeatmapEventCallbackWrappers, put=__set__lightColorBeatmapEventCallbackWrappers)) ::ArrayW<::GlobalNamespace::BeatmapDataCallbackWrapper*,::Array<::GlobalNamespace::BeatmapDataCallbackWrapper*>*>  _lightColorBeatmapEventCallbackWrappers;

/// @brief Field _lastIndex offset 0x38
 __declspec(property(get=__get__lastIndex, put=__set__lastIndex)) int32_t  _lastIndex;

/// @brief Field _timesBuffer offset 0x40
 __declspec(property(get=__get__timesBuffer, put=__set__timesBuffer)) ::ArrayW<float_t,::Array<float_t>*>  _timesBuffer;

/// @brief Field _colorsBuffer offset 0x48
...
/// @brief Field _elementIdsBuffer offset 0x50
...
// Ctor Parameters []
// @brief default ctor
 BufferedLightColorGroupEffect()  = default;
public:


// Fields

// Static field _timesBufferPropertyId

// Static field _colorBufferPropertyId

// Static field _elementIdBufferPropertyId
