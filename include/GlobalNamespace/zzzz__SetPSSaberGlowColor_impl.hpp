...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SaberTypeObject*> GlobalNamespace::SetPSSaberGlowColor::__get__saber() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SaberTypeObject*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorManager*> GlobalNamespace::SetPSSaberGlowColor::__get__colorManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ColorManager*, 0x20>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ParticleSystem*> GlobalNamespace::SetPSSaberGlowColor::__get__particleSystem() const {
return ::cordl_internals::getInstanceField<::UnityEngine::ParticleSystem*, 0x28>(this);
}
