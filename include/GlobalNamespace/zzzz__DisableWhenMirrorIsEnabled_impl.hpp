...
::cordl_internals::setInstanceField<::GlobalNamespace::Mirror*, 0x18>(this, std::forward<::GlobalNamespace::Mirror*>(value));
}
constexpr ::GlobalNamespace::Mirror* GlobalNamespace::DisableWhenMirrorIsEnabled::__get__mirror()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::Mirror*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::Mirror*> GlobalNamespace::DisableWhenMirrorIsEnabled::__get__mirror() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::Mirror*, 0x18>(this);
}
