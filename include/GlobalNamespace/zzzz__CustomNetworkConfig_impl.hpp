...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::CustomNetworkConfig::*)()>(&::GlobalNamespace::CustomNetworkConfig::get_maxPartySize)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::CustomNetworkConfig::*)()>(&::GlobalNamespace::CustomNetworkConfig::get_discoveryPort)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::CustomNetworkConfig::*)()>(&::GlobalNamespace::CustomNetworkConfig::get_partyPort)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::CustomNetworkConfig::*)()>(&::GlobalNamespace::CustomNetworkConfig::get_multiplayerPort)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::CustomNetworkConfig::*)(::GlobalNamespace::INetworkConfig*, ::StringW, int32_t, bool)>(&::GlobalNamespace::CustomNetworkConfig::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::INetworkConfig*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::StringW>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get()}
                        )));
    return ___internal_method;
  }
};
...
::cordl_internals::setInstanceField<::GlobalNamespace::DnsEndPoint*, 0x20>(this, std::forward<::GlobalNamespace::DnsEndPoint*>(value));
}
constexpr ::GlobalNamespace::DnsEndPoint* GlobalNamespace::CustomNetworkConfig::__get__masterServerEndPoint_k__BackingField()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::DnsEndPoint*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::DnsEndPoint*> GlobalNamespace::CustomNetworkConfig::__get__masterServerEndPoint_k__BackingField() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::DnsEndPoint*, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::ServiceEnvironment, 0x44>(this, std::forward<::GlobalNamespace::ServiceEnvironment>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::ServiceEnvironment, 0x44>(this);
}
