...
struct CORDL_TYPE __OVRPlatformMenu__eHandler : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____OVRPlatformMenu__eHandler_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __OVRPlatformMenu__eHandler(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRPlatformMenu__eHandler()  = default;
...
struct CORDL_TYPE __OVRPlatformMenu__eBackButtonAction : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____OVRPlatformMenu__eBackButtonAction_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRPlatformMenu__eBackButtonAction(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRPlatformMenu__eBackButtonAction()  = default;
...
/// @brief Field OnShortPress offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_1<bool>*> __get_OnShortPress() const;
...
// Ctor Parameters []
// @brief default ctor
 OVRPlatformMenu()  = default;
public:


// Fields

// Static field sceneStack
