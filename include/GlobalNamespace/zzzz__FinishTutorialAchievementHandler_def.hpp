...
/// @brief Field _tutorialFinishedSignal offset 0x20
...
/// @brief Field _finishTutorialAchievement offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::AchievementSO*> __get__finishTutorialAchievement() const;
...
// Ctor Parameters []
// @brief default ctor
 FinishTutorialAchievementHandler()  = default;
public:
