...
::cordl_internals::setInstanceField<::GlobalNamespace::GameplayModifierParamsSO*, 0x18>(this, std::forward<::GlobalNamespace::GameplayModifierParamsSO*>(value));
}
constexpr ::GlobalNamespace::GameplayModifierParamsSO* GlobalNamespace::GameplayModifierToggle::__get__gameplayModifier()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayModifierParamsSO*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameplayModifierParamsSO*> GlobalNamespace::GameplayModifierToggle::__get__gameplayModifier() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayModifierParamsSO*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> GlobalNamespace::GameplayModifierToggle::__get__nameText() const {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x20>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> GlobalNamespace::GameplayModifierToggle::__get__multiplierText() const {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x28>(this);
}
constexpr void GlobalNamespace::GameplayModifierToggle::__set__hoverTextSetter(::HMUI::HoverTextSetter*  value)  {
::cordl_internals::setInstanceField<::HMUI::HoverTextSetter*, 0x30>(this, std::forward<::HMUI::HoverTextSetter*>(value));
}
constexpr ::HMUI::HoverTextSetter* GlobalNamespace::GameplayModifierToggle::__get__hoverTextSetter()  {
return ::cordl_internals::getInstanceField<::HMUI::HoverTextSetter*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::HMUI::HoverTextSetter*> GlobalNamespace::GameplayModifierToggle::__get__hoverTextSetter() const {
return ::cordl_internals::getInstanceField<::HMUI::HoverTextSetter*, 0x30>(this);
}
constexpr void GlobalNamespace::GameplayModifierToggle::__set__icon(::UnityEngine::UI::Image*  value)  {
::cordl_internals::setInstanceField<::UnityEngine::UI::Image*, 0x38>(this, std::forward<::UnityEngine::UI::Image*>(value));
}
constexpr ::UnityEngine::UI::Image* GlobalNamespace::GameplayModifierToggle::__get__icon()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Image*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Image*> GlobalNamespace::GameplayModifierToggle::__get__icon() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Image*, 0x38>(this);
}
constexpr void GlobalNamespace::GameplayModifierToggle::__set__toggle(::UnityEngine::UI::Toggle*  value)  {
::cordl_internals::setInstanceField<::UnityEngine::UI::Toggle*, 0x40>(this, std::forward<::UnityEngine::UI::Toggle*>(value));
}
constexpr ::UnityEngine::UI::Toggle* GlobalNamespace::GameplayModifierToggle::__get__toggle()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Toggle*, 0x40>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> GlobalNamespace::GameplayModifierToggle::__get__toggle() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Toggle*, 0x40>(this);
}
