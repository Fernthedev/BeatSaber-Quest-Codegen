...
/// @brief Field _gameplayModifiers offset 0x20
...
/// @brief Field _audioTimeSyncController offset 0x38
...
/// @brief Field _goodCutScoringElementPool offset 0x40
...
/// @brief Field _badCutScoringElementPool offset 0x48
...
/// @brief Field _missScoringElementPool offset 0x50
...
/// @brief Field _playerHeadAndObstacleInteraction offset 0x58
...
/// @brief Field scoreDidChangeEvent offset 0x60
...
/// @brief Field multiplierDidChangeEvent offset 0x68
...
/// @brief Field scoringForNoteStartedEvent offset 0x70
...
/// @brief Field scoringForNoteFinishedEvent offset 0x78
...
/// @brief Field _gameplayModifierParams offset 0x80
 __declspec(property(get=__get__gameplayModifierParams, put=__set__gameplayModifierParams)) ::System::Collections::Generic::List_1<::GlobalNamespace::GameplayModifierParamsSO*>*  _gameplayModifierParams;

/// @brief Field _modifiedScore offset 0x88
 __declspec(property(get=__get__modifiedScore, put=__set__modifiedScore)) int32_t  _modifiedScore;

/// @brief Field _multipliedScore offset 0x8c
 __declspec(property(get=__get__multipliedScore, put=__set__multipliedScore)) int32_t  _multipliedScore;

/// @brief Field _immediateMaxPossibleMultipliedScore offset 0x90
...
/// @brief Field _immediateMaxPossibleModifiedScore offset 0x94
...
/// @brief Field _prevMultiplierFromModifiers offset 0x98
...
/// @brief Field _maxScoreMultiplierCounter offset 0xa0
...
/// @brief Field _scoreMultiplierCounter offset 0xa8
...
/// @brief Field _sortedNoteTimesWithoutScoringElements offset 0xb0
 __declspec(property(get=__get__sortedNoteTimesWithoutScoringElements, put=__set__sortedNoteTimesWithoutScoringElements)) ::System::Collections::Generic::List_1<float_t>*  _sortedNoteTimesWithoutScoringElements;

/// @brief Field _sortedScoringElementsWithoutMultiplier offset 0xb8
 __declspec(property(get=__get__sortedScoringElementsWithoutMultiplier, put=__set__sortedScoringElementsWithoutMultiplier)) ::System::Collections::Generic::List_1<::GlobalNamespace::ScoringElement*>*  _sortedScoringElementsWithoutMultiplier;

/// @brief Field _scoringElementsWithMultiplier offset 0xc0
 __declspec(property(get=__get__scoringElementsWithMultiplier, put=__set__scoringElementsWithMultiplier)) ::System::Collections::Generic::List_1<::GlobalNamespace::ScoringElement*>*  _scoringElementsWithMultiplier;

/// @brief Field _scoringElementsToRemove offset 0xc8
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__GoodCutScoringElement__Pool*> __get__goodCutScoringElementPool() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__BadCutScoringElement__Pool*> __get__badCutScoringElementPool() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__MissScoringElement__Pool*> __get__missScoringElementPool() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<int32_t,int32_t>*> __get_scoreDidChangeEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<int32_t,float_t>*> __get_multiplierDidChangeEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::ScoringElement*>*> __get_scoringForNoteStartedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::ScoringElement*>*> __get_scoringForNoteFinishedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::GameplayModifierParamsSO*>*> __get__gameplayModifierParams() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ScoreMultiplierCounter*> __get__maxScoreMultiplierCounter() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ScoreMultiplierCounter*> __get__scoreMultiplierCounter() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<float_t>*> __get__sortedNoteTimesWithoutScoringElements() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::ScoringElement*>*> __get__sortedScoringElementsWithoutMultiplier() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::ScoringElement*>*> __get__scoringElementsWithMultiplier() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::ScoringElement*>*> __get__scoringElementsToRemove() const;
