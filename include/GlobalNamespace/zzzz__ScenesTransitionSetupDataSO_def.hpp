...
struct CORDL_TYPE __ScenesTransitionSetupDataSO___BeforeScenesWillBeActivated_d__10 : public ::bs_hook::ValueTypeWrapper<0x40> {
public:
// Declarations
...
/// @brief Field <>4__this offset 0x28
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::GlobalNamespace::ScenesTransitionSetupDataSO*  __4__this;

/// @brief Field runAsync offset 0x30
 __declspec(property(get=__get_runAsync, put=__set_runAsync)) bool  runAsync;
...
constexpr ::GlobalNamespace::ScenesTransitionSetupDataSO* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ScenesTransitionSetupDataSO*> __get___4__this() const;

constexpr void __set_runAsync(bool  value) ;

constexpr bool& __get_runAsync() ;

constexpr bool const& __get_runAsync() const;
...
constexpr __ScenesTransitionSetupDataSO___BeforeScenesWillBeActivated_d__10(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::GlobalNamespace::ScenesTransitionSetupDataSO*  __4__this, bool  runAsync, ::System::Runtime::CompilerServices::TaskAwaiter  __u__1) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __ScenesTransitionSetupDataSO___BeforeScenesWillBeActivated_d__10(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x40>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ScenesTransitionSetupDataSO___BeforeScenesWillBeActivated_d__10()  = default;
...
struct CORDL_TYPE __ScenesTransitionSetupDataSO____BeforeScenesWillBeActivated_b__10_0_d : public ::bs_hook::ValueTypeWrapper<0x30> {
public:
// Declarations
/// @brief The size of the true value type
...
constexpr __ScenesTransitionSetupDataSO____BeforeScenesWillBeActivated_b__10_0_d(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::GlobalNamespace::ScenesTransitionSetupDataSO*  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter  __u__1) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __ScenesTransitionSetupDataSO____BeforeScenesWillBeActivated_b__10_0_d(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x30>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ScenesTransitionSetupDataSO____BeforeScenesWillBeActivated_b__10_0_d()  = default;
...
/// @brief Field <scenes>k__BackingField offset 0x18
 __declspec(property(get=__get__scenes_k__BackingField, put=__set__scenes_k__BackingField)) ::ArrayW<::GlobalNamespace::SceneInfo*,::Array<::GlobalNamespace::SceneInfo*>*>  _scenes_k__BackingField;

/// @brief Field _sceneSetupDataArray offset 0x20
 __declspec(property(get=__get__sceneSetupDataArray, put=__set__sceneSetupDataArray)) ::ArrayW<::GlobalNamespace::SceneSetupData*,::Array<::GlobalNamespace::SceneSetupData*>*>  _sceneSetupDataArray;

/// @brief Field <beforeScenesWillBeActivatedTaskIsComplete>k__BackingField offset 0x28
 __declspec(property(get=__get__beforeScenesWillBeActivatedTaskIsComplete_k__BackingField, put=__set__beforeScenesWillBeActivatedTaskIsComplete_k__BackingField)) bool  _beforeScenesWillBeActivatedTaskIsComplete_k__BackingField;
...
// Ctor Parameters []
// @brief default ctor
 ScenesTransitionSetupDataSO()  = default;
public:
