...
/// @brief Field envFogParams offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BloomFogParamsAnimator*> __get___4__this() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BloomFogEnvironmentParams*> __get_envFogParams() const;
...
// Ctor Parameters []
// @brief default ctor
 __BloomFogParamsAnimator___AnimationCoroutine_d__2()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 BloomFogParamsAnimator()  = default;
public:
