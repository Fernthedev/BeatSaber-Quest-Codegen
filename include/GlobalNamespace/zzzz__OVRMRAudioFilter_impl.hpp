...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::OVRMRAudioFilter::*)(::ArrayW<float_t,::Array<float_t>*>, int32_t)>(&::GlobalNamespace::OVRMRAudioFilter::OnAudioFilterRead)> {
...
::cordl_internals::setInstanceField<::GlobalNamespace::OVRExternalComposition*, 0x20>(this, std::forward<::GlobalNamespace::OVRExternalComposition*>(value));
}
constexpr ::GlobalNamespace::OVRExternalComposition* GlobalNamespace::OVRMRAudioFilter::__get_composition()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::OVRExternalComposition*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRExternalComposition*> GlobalNamespace::OVRMRAudioFilter::__get_composition() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::OVRExternalComposition*, 0x20>(this);
}
