...
/// @brief Field <id>k__BackingField offset 0x58
...
/// @brief Field <time>k__BackingField offset 0x60
...
/// @brief Method get_pool addr 0xe59e2c size 0x40 virtual false final false
static inline ::GlobalNamespace::PacketPool_1<::GlobalNamespace::NodePoseSyncStateNetSerializable*>* get_pool() ;

/// @brief Method get_id addr 0xe59e6c size 0x8 virtual true final true
inline ::GlobalNamespace::SyncStateId get_id() ;

/// @brief Method set_id addr 0xe59e74 size 0x8 virtual true final true
inline void set_id(::GlobalNamespace::SyncStateId  value) ;

/// @brief Method get_time addr 0xe59e7c size 0x8 virtual true final true
inline int64_t get_time() ;

/// @brief Method set_time addr 0xe59e84 size 0x8 virtual true final true
inline void set_time(int64_t  value) ;

/// @brief Method get_state addr 0xe59e8c size 0x10 virtual true final true
inline ::GlobalNamespace::NodePoseSyncState get_state() ;

/// @brief Method set_state addr 0xe59e9c size 0x18 virtual true final true
inline void set_state(::GlobalNamespace::NodePoseSyncState  value) ;

/// @brief Method Serialize addr 0xe59eb4 size 0x4c virtual true final true
inline void Serialize(::LiteNetLib::Utils::NetDataWriter*  writer) ;

/// @brief Method Deserialize addr 0xe59f24 size 0x50 virtual true final true
inline void Deserialize(::LiteNetLib::Utils::NetDataReader*  reader) ;

/// @brief Method Release addr 0xe59f94 size 0x54 virtual true final true
inline void Release() ;

static inline ::GlobalNamespace::NodePoseSyncStateNetSerializable* New_ctor() ;

/// @brief Method .ctor addr 0xe59fe8 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 NodePoseSyncStateNetSerializable()  = default;
public:
