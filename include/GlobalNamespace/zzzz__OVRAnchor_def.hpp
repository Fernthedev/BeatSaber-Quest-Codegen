...
// CS Name: ::OVRAnchor
struct CORDL_TYPE OVRAnchor : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
...
constexpr explicit OVRAnchor(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}
