...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xc8 - sizeof(::GlobalNamespace::OVRComposition)]{};

/// @brief Field previousMainCameraObject offset 0x40
...
/// @brief Field foregroundCameraGameObject offset 0x48
...
/// @brief Field frameIndex offset 0x90
 __declspec(property(get=__get_frameIndex, put=__set_frameIndex)) int32_t  frameIndex;

/// @brief Field lastMrcEncodeFrameSyncId offset 0x94
...
/// @brief Field mrcForegroundRenderTextureArray offset 0x98
 __declspec(property(get=__get_mrcForegroundRenderTextureArray, put=__set_mrcForegroundRenderTextureArray)) ::ArrayW<::UnityEngine::RenderTexture*,::Array<::UnityEngine::RenderTexture*>*>  mrcForegroundRenderTextureArray;

/// @brief Field cameraPoseTimeArray offset 0xa0
...
/// @brief Field cachedAudioDataArray offset 0xa8
...
/// @brief Field cachedChannels offset 0xc0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_previousMainCameraObject() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_foregroundCameraGameObject() const;

constexpr void __set_foregroundCamera(::UnityEngine::Camera*  value) ;

constexpr ::UnityEngine::Camera* __get_foregroundCamera() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Camera*> __get_foregroundCamera() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_backgroundCameraGameObject() const;

constexpr void __set_backgroundCamera(::UnityEngine::Camera*  value) ;

constexpr ::UnityEngine::Camera* __get_backgroundCamera() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Camera*> __get_backgroundCamera() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AudioListener*> __get_audioListener() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRMRAudioFilter*> __get_audioFilter() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get_audioDataLock() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<float_t>*> __get_cachedAudioData() const;
...
// Ctor Parameters []
// @brief default ctor
 OVRExternalComposition()  = default;
public:
