...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::GlobalNamespace::SingleFixedSceneScenesTransitionSetupDataSO)]{};
...
/// @brief Field <goStraightToEditor>k__BackingField offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::BeatmapEditorScenesTransitionSetupDataSO*>*> __get_didFinishEvent() const;
...
// Ctor Parameters []
// @brief default ctor
 BeatmapEditorScenesTransitionSetupDataSO()  = default;
public:
