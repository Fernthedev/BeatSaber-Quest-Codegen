...
// Ctor Parameters []
// @brief default ctor
 __HealthWarningFlowCoordinator__InitData()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x120 - sizeof(::HMUI::FlowCoordinator)]{};
...
/// @brief Field _appInitScenesTransitionSetupDataContainer offset 0xb0
...
/// @brief Field _selectLanguageViewController offset 0xb8
...
/// @brief Field _selectRegionViewController offset 0xc0
...
/// @brief Field _eulaViewController offset 0xc8
...
/// @brief Field _privacyPolicyViewController offset 0xd0
...
/// @brief Field _healthWarningViewController offset 0xd8
...
/// @brief Field _explicitContentWarningViewController offset 0xe0
 __declspec(property(get=__get__explicitContentWarningViewController, put=__set__explicitContentWarningViewController)) ::GlobalNamespace::ExplicitContentWarningViewController*  _explicitContentWarningViewController;

/// @brief Field _playerDataModel offset 0xe8
 __declspec(property(get=__get__playerDataModel, put=__set__playerDataModel)) ::GlobalNamespace::PlayerDataModel*  _playerDataModel;

/// @brief Field _fadeInOut offset 0xf0
 __declspec(property(get=__get__fadeInOut, put=__set__fadeInOut)) ::GlobalNamespace::FadeInOutController*  _fadeInOut;

/// @brief Field _gameScenesManager offset 0xf8
...
/// @brief Field _initData offset 0x100
...
/// @brief Field _selectedRegion offset 0x118
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SelectLanguageViewController*> __get__selectLanguageViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SelectRegionViewController*> __get__selectRegionViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::EulaViewController*> __get__eulaViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PrivacyPolicyViewController*> __get__privacyPolicyViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::HealthWarningViewController*> __get__healthWarningViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ExplicitContentWarningViewController*> __get__explicitContentWarningViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__HealthWarningFlowCoordinator__InitData*> __get__initData() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::HMUI::ViewController*,::StringW>*> __get__viewControllerTitles() const;
...
// Ctor Parameters []
// @brief default ctor
 HealthWarningFlowCoordinator()  = default;
public:
