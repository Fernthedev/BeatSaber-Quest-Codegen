...
// CS Name: ::OVRStorable
struct CORDL_TYPE OVRStorable : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
...
/// @brief Method IOVRAnchorComponent<OVRStorable>.get_Type addr 0x2713014 size 0x8 virtual true final true
inline ::GlobalNamespace::__OVRPlugin__SpaceComponentType IOVRAnchorComponent_OVRStorable__get_Type() ;

/// @brief Method IOVRAnchorComponent<OVRStorable>.get_Handle addr 0x2713024 size 0x8 virtual true final true
inline uint64_t IOVRAnchorComponent_OVRStorable__get_Handle() ;

/// @brief Method IOVRAnchorComponent<OVRStorable>.FromAnchor addr 0x271302c size 0x8 virtual true final true
inline ::GlobalNamespace::OVRStorable IOVRAnchorComponent_OVRStorable__FromAnchor(::GlobalNamespace::OVRAnchor  anchor) ;

/// @brief Method get_IsNull addr 0x2713040 size 0x10 virtual true final true
inline bool get_IsNull() ;

/// @brief Method get_IsEnabled addr 0x2713050 size 0xa8 virtual true final true
inline bool get_IsEnabled() ;

/// @brief Method SetEnabledAsync addr 0x27130f8 size 0xdc virtual true final true
inline ::GlobalNamespace::OVRTask_1<bool> SetEnabledAsync(bool  enabled, double_t  timeout) ;

/// @brief Method Equals addr 0x27131d4 size 0x10 virtual true final true
inline bool Equals(::GlobalNamespace::OVRStorable  other) ;

/// @brief Method op_Equality addr 0x27131e4 size 0xc virtual false final false
static inline bool op_Equality(::GlobalNamespace::OVRStorable  lhs, ::GlobalNamespace::OVRStorable  rhs) ;

/// @brief Method op_Inequality addr 0x27131f0 size 0xc virtual false final false
static inline bool op_Inequality(::GlobalNamespace::OVRStorable  lhs, ::GlobalNamespace::OVRStorable  rhs) ;

/// @brief Method Equals addr 0x27131fc size 0x78 virtual true final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode addr 0x2713274 size 0x4c virtual true final false
inline int32_t GetHashCode() ;

/// @brief Method ToString addr 0x27132c0 size 0x84 virtual true final false
inline ::StringW ToString() ;

/// @brief Method get_Type addr 0x271301c size 0x8 virtual false final false
inline ::GlobalNamespace::__OVRPlugin__SpaceComponentType get_Type() ;

/// @brief Method get_Handle addr 0x2713344 size 0x8 virtual false final false
inline uint64_t get_Handle() ;

/// @brief Method .ctor addr 0x2713034 size 0xc virtual false final false
...
constexpr explicit OVRStorable(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}
