...
/// @brief Method .ctor addr 0x22f79b4 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 DuplicateMirrorForReflectionProbe()  = default;
public:
...
static_assert(::cordl_internals::size_check_v<::GlobalNamespace::DuplicateMirrorForReflectionProbe, 0x18>, "Size mismatch!");
