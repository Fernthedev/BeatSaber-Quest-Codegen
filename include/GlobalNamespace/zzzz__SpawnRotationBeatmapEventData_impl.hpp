...
constexpr void GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType::__set_value__(int32_t  value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<int32_t>(value));
}
constexpr int32_t& GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType::__get_value__()  {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType::__SpawnRotationBeatmapEventData__SpawnRotationEventType(int32_t  value__) noexcept : ::bs_hook::EnumTypeWrapper<0x4>() {this->value__ = value__;
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SpawnRotationBeatmapEventData::*)(float_t, ::GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType, float_t)>(&::GlobalNamespace::SpawnRotationBeatmapEventData::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get()}
                        )));
    return ___internal_method;
  }
};
...
::cordl_internals::setInstanceField<::GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType, 0x34>(this, std::forward<::GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::__SpawnRotationBeatmapEventData__SpawnRotationEventType, 0x34>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::GlobalNamespace::SpawnRotationBeatmapEventData*>(time, spawnRotationEventType, deltaRotation));
}
