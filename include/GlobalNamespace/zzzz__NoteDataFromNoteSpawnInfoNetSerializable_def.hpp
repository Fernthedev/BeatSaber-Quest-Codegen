...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x58 - sizeof(::GlobalNamespace::NoteData)]{};
...
/// @brief Method .ctor addr 0x23d3ca4 size 0x50 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 NoteDataFromNoteSpawnInfoNetSerializable()  = default;
public:
