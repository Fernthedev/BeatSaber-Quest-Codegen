...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14743)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14743), inst: 2548 }), TypeDefinitionIndex(TypeDefinitionIndex(14732))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x10 - sizeof(::GlobalNamespace::FxBeatmapEventDataProcessor_1<::GlobalNamespace::FloatFxBeatmapEventData*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 FloatFxBeatmapEventDataProcessor()  = default;
public:
