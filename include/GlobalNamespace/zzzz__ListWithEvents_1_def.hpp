...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(13947))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(13947), inst: 2 })
// CS Name: ::ListWithEvents`1<T>*
class CORDL_TYPE ListWithEvents_1<T> : public ::System::Object {
public:
// Declarations
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<T>*> __get_OnElementAdded() const;

constexpr void __set_OnElementRemoved(::System::Action_1<T>*  value) ;

constexpr ::System::Action_1<T>* __get_OnElementRemoved() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action_1<T>*> __get_OnElementRemoved() const;
