...
/// @brief Method get_supportsOpenDataPrivacyPage addr 0xdfcb44 size 0x8 virtual true final true
inline bool get_supportsOpenDataPrivacyPage() ;

/// @brief Method OpenDataPrivacyPage addr 0xdfcb4c size 0x4 virtual true final true
inline void OpenDataPrivacyPage() ;

/// @brief Method LogEditAvatarEvent addr 0xdfcb50 size 0x4 virtual true final true
inline void LogEditAvatarEvent(::StringW  eventType, ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>*  eventData) ;

/// @brief Method LogEvent addr 0xdfcb54 size 0x4 virtual true final true
inline void LogEvent(::StringW  eventType, ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>*  eventData) ;

/// @brief Method LogClick addr 0xdfcb58 size 0x4 virtual true final true
inline void LogClick(::StringW  clickType, ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>*  clickData) ;

/// @brief Method LogImpression addr 0xdfcb5c size 0x4 virtual true final true
inline void LogImpression(::StringW  impressionType, ::System::Collections::Generic::Dictionary_2<::StringW,::StringW>*  impressionData) ;

/// @brief Method LogExposure addr 0xdfcb60 size 0x4 virtual true final true
...
/// @brief Method .ctor addr 0xdfcb64 size 0x8 virtual false final false
inline void _ctor() ;
