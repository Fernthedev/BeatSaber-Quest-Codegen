...
struct CORDL_TYPE __HowToPlayViewController__HowToPlayOptions : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____HowToPlayViewController__HowToPlayOptions_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __HowToPlayViewController__HowToPlayOptions(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __HowToPlayViewController__HowToPlayOptions()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x88 - sizeof(::HMUI::ViewController)]{};

/// @brief Field _tutorialButton offset 0x70
 __declspec(property(get=__get__tutorialButton, put=__set__tutorialButton)) ::UnityEngine::UI::Button*  _tutorialButton;

/// @brief Field _creditsButton offset 0x78
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> __get__tutorialButton() const;

constexpr void __set__creditsButton(::UnityEngine::UI::Button*  value) ;

constexpr ::UnityEngine::UI::Button* __get__creditsButton() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> __get__creditsButton() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::__HowToPlayViewController__HowToPlayOptions>*> __get_didFinishEvent() const;
...
// Ctor Parameters []
// @brief default ctor
 HowToPlayViewController()  = default;
public:
