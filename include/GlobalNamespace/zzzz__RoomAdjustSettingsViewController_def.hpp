...
/// @brief Field kHorizontalMoveStep offset 0x0
static constexpr float_t  kHorizontalMoveStep{0.1};

/// @brief Field kVerticalMoveStep offset 0x0
...
/// @brief Field _yStepValuePicker offset 0x88
...
/// @brief Field _zStepValuePicker offset 0x90
...
/// @brief Field _rotStepValuePicker offset 0x98
...
/// @brief Field _resetButton offset 0xa0
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::StepValuePicker*> __get__xStepValuePicker() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::StepValuePicker*> __get__yStepValuePicker() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::StepValuePicker*> __get__zStepValuePicker() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::StepValuePicker*> __get__rotStepValuePicker() const;

constexpr void __set__resetButton(::UnityEngine::UI::Button*  value) ;

constexpr ::UnityEngine::UI::Button* __get__resetButton() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> __get__resetButton() const;
...
// Ctor Parameters []
// @brief default ctor
 RoomAdjustSettingsViewController()  = default;
public:
