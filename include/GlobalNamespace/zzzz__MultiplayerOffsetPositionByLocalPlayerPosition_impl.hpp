...
::cordl_internals::setInstanceField<::GlobalNamespace::MultiplayerPlayersManager*, 0x18>(this, std::forward<::GlobalNamespace::MultiplayerPlayersManager*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::MultiplayerPlayersManager*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerPlayersManager*> GlobalNamespace::MultiplayerOffsetPositionByLocalPlayerPosition::__get__multiplayerPlayersManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MultiplayerPlayersManager*, 0x18>(this);
}
