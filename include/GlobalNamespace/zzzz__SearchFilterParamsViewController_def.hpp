...
/// @brief Field _filterByOwnedToggle offset 0x70
...
/// @brief Field _filterByNotOwnedToggle offset 0x78
...
/// @brief Field _filterByCharacteristicToggle offset 0x80
...
/// @brief Field _beatmapCharacteristicsDropdown offset 0x88
...
/// @brief Field _filterByDifficultyToggle offset 0x90
...
/// @brief Field _beatmapDifficultyDropdown offset 0x98
...
/// @brief Field _filterBySongPacksToggle offset 0xa0
...
/// @brief Field _songPacksDropdown offset 0xa8
...
/// @brief Field _filterByNotPlayedYetToggle offset 0xb0
...
/// @brief Field _filterByMinBpmToggle offset 0xb8
...
/// @brief Field _minBpmController offset 0xc0
...
/// @brief Field _filterByMaxBpmToggle offset 0xc8
...
/// @brief Field _maxBpmController offset 0xd0
...
/// @brief Field _filterBySensitivity offset 0xd8
...
/// @brief Field _okButton offset 0xe0
...
/// @brief Field _currentSearchFilter offset 0xf0
...
/// @brief Field didFinishEvent offset 0x140
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get__filterByOwnedToggle() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get__filterByNotOwnedToggle() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get__filterByCharacteristicToggle() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapCharacteristicsDropdown*> __get__beatmapCharacteristicsDropdown() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get__filterByDifficultyToggle() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get__filterBySongPacksToggle() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SongPacksDropdown*> __get__songPacksDropdown() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get__filterByNotPlayedYetToggle() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get__filterByMinBpmToggle() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FormattedFloatListSettingsController*> __get__minBpmController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get__filterByMaxBpmToggle() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FormattedFloatListSettingsController*> __get__maxBpmController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlayerSensitivityDropdown*> __get__filterBySensitivity() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::SearchFilterParamsViewController*,::GlobalNamespace::LevelFilter>*> __get_didFinishEvent() const;
...
// Ctor Parameters []
// @brief default ctor
 SearchFilterParamsViewController()  = default;
public:
