...
::cordl_internals::setInstanceField<::HMUI::CurvedTextMeshPro*, 0x58>(this, std::forward<::HMUI::CurvedTextMeshPro*>(value));
}
constexpr ::HMUI::CurvedTextMeshPro* GlobalNamespace::GameServerListTableCell::__get__serverName()  {
return ::cordl_internals::getInstanceField<::HMUI::CurvedTextMeshPro*, 0x58>(this);
}
constexpr ::cordl_internals::to_const_pointer<::HMUI::CurvedTextMeshPro*> GlobalNamespace::GameServerListTableCell::__get__serverName() const {
return ::cordl_internals::getInstanceField<::HMUI::CurvedTextMeshPro*, 0x58>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::CurvedTextMeshPro*> GlobalNamespace::GameServerListTableCell::__get__difficultiesText() const {
return ::cordl_internals::getInstanceField<::HMUI::CurvedTextMeshPro*, 0x60>(this);
}
constexpr void GlobalNamespace::GameServerListTableCell::__set__musicPackText(::HMUI::CurvedTextMeshPro*  value)  {
::cordl_internals::setInstanceField<::HMUI::CurvedTextMeshPro*, 0x68>(this, std::forward<::HMUI::CurvedTextMeshPro*>(value));
}
constexpr ::HMUI::CurvedTextMeshPro* GlobalNamespace::GameServerListTableCell::__get__musicPackText()  {
return ::cordl_internals::getInstanceField<::HMUI::CurvedTextMeshPro*, 0x68>(this);
}
constexpr ::cordl_internals::to_const_pointer<::HMUI::CurvedTextMeshPro*> GlobalNamespace::GameServerListTableCell::__get__musicPackText() const {
return ::cordl_internals::getInstanceField<::HMUI::CurvedTextMeshPro*, 0x68>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::CurvedTextMeshPro*> GlobalNamespace::GameServerListTableCell::__get__playerCount() const {
return ::cordl_internals::getInstanceField<::HMUI::CurvedTextMeshPro*, 0x70>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> GlobalNamespace::GameServerListTableCell::__get__passwordProtected() const {
return ::cordl_internals::getInstanceField<::UnityEngine::GameObject*, 0x78>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::SongPackMasksModel*, 0x80>(this, std::forward<::GlobalNamespace::SongPackMasksModel*>(value));
}
constexpr ::GlobalNamespace::SongPackMasksModel* GlobalNamespace::GameServerListTableCell::__get__songPackMasksModel()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SongPackMasksModel*, 0x80>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SongPackMasksModel*> GlobalNamespace::GameServerListTableCell::__get__songPackMasksModel() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SongPackMasksModel*, 0x80>(this);
}
