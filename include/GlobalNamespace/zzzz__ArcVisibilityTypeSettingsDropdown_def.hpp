...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5602)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5602), inst: 4729 }), TypeDefinitionIndex(TypeDefinitionIndex(4606))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::GlobalNamespace::ValueDropdownController_1<::GlobalNamespace::ArcVisibilityType>)]{};
...
// Ctor Parameters []
// @brief default ctor
 ArcVisibilityTypeSettingsDropdown()  = default;
public:
