...
/// @brief Field _creditsContentTextAsset offset 0x68
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__normalTextPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__normalLocalizedTextPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__titleTextPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__titleLocalizedTextPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__headerTextPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__headerLocalizedTextPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__contentRoot() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> __get__rootRectTransform() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TextAsset*> __get__creditsContentTextAsset() const;
