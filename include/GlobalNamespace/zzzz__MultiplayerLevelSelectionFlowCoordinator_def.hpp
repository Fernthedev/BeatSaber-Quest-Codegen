...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x138 - sizeof(::GlobalNamespace::LevelSelectionFlowCoordinator)]{};

/// @brief Field _notAllowedCharacteristics offset 0xd0
...
/// @brief Field _lobbyGameStateController offset 0xd8
...
/// @brief Field didSelectLevelEvent offset 0xe0
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::__LevelSelectionFlowCoordinator__State*>*> __get_didSelectLevelEvent() const;

constexpr void __set_didFinishedEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_didFinishedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_didFinishedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__LevelSelectionFlowCoordinator__State*> __get__state() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerLevelSelectionFlowCoordinator()  = default;
public:
