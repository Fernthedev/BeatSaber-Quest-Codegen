...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::AudioTimeSyncController*> GlobalNamespace::GameSongController::__get__audioTimeSyncController() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::AudioTimeSyncController*, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::AudioPitchGainEffect*, 0x28>(this, std::forward<::GlobalNamespace::AudioPitchGainEffect*>(value));
}
constexpr ::GlobalNamespace::AudioPitchGainEffect* GlobalNamespace::GameSongController::__get__failAudioPitchGainEffect()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::AudioPitchGainEffect*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::AudioPitchGainEffect*> GlobalNamespace::GameSongController::__get__failAudioPitchGainEffect() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::AudioPitchGainEffect*, 0x28>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapCallbacksController*> GlobalNamespace::GameSongController::__get__beatmapCallbacksController() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapCallbacksController*, 0x30>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::BeatmapCallbacksUpdater*, 0x38>(this, std::forward<::GlobalNamespace::BeatmapCallbacksUpdater*>(value));
}
constexpr ::GlobalNamespace::BeatmapCallbacksUpdater* GlobalNamespace::GameSongController::__get__beatmapCallbacksUpdater()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapCallbacksUpdater*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapCallbacksUpdater*> GlobalNamespace::GameSongController::__get__beatmapCallbacksUpdater() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapCallbacksUpdater*, 0x38>(this);
}
