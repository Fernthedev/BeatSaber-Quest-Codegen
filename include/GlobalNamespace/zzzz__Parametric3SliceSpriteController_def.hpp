...
/// @brief Field kMaxWidth offset 0x0
static constexpr float_t  kMaxWidth{10.0};

/// @brief Field kMaxLength offset 0x0
static constexpr float_t  kMaxLength{2500.0};

/// @brief Field _widthMultiplier offset 0x18
...
/// @brief Field center offset 0x24
...
// Ctor Parameters []
// @brief default ctor
 Parametric3SliceSpriteController()  = default;
public:
...
// Static field _alphaStartID

// Static field _alphaEndID

// Static field _widthStartID

// Static field _widthEndID

// Static field _materialPropertyBlock

// Static field _mesh

// Static field _instanceCount
