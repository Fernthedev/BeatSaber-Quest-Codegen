...
/// @brief Field _levelsEntitlements offset 0x18
 __declspec(property(get=__get__levelsEntitlements, put=__set__levelsEntitlements)) ::ArrayW<::GlobalNamespace::MockPlatformEntitlement*,::Array<::GlobalNamespace::MockPlatformEntitlement*>*>  _levelsEntitlements;

/// @brief Field _levelPacksEntitlements offset 0x20
 __declspec(property(get=__get__levelPacksEntitlements, put=__set__levelPacksEntitlements)) ::ArrayW<::GlobalNamespace::MockPlatformEntitlement*,::Array<::GlobalNamespace::MockPlatformEntitlement*>*>  _levelPacksEntitlements;

/// @brief Field _packBetterBuyThanLevel offset 0x28
...
// Ctor Parameters []
// @brief default ctor
 MockPlatformAdditionalContentModelInitialDataSO()  = default;
public:
