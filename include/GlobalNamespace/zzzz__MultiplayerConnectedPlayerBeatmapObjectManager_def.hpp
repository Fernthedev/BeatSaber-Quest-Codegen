...
/// @brief Field notesUniformScale offset 0x14
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerConnectedPlayerBeatmapObjectManager__InitData()  = default;
public:
...
/// @brief Field _gameNotePoolContainer offset 0xa0
 __declspec(property(get=__get__gameNotePoolContainer, put=__set__gameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*>*  _gameNotePoolContainer;

/// @brief Field _burstSliderHeadGameNotePoolContainer offset 0xa8
 __declspec(property(get=__get__burstSliderHeadGameNotePoolContainer, put=__set__burstSliderHeadGameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*>*  _burstSliderHeadGameNotePoolContainer;

/// @brief Field _burstSliderGameNotePoolContainer offset 0xb0
 __declspec(property(get=__get__burstSliderGameNotePoolContainer, put=__set__burstSliderGameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*>*  _burstSliderGameNotePoolContainer;

/// @brief Field _burstSliderFillPoolContainer offset 0xb8
 __declspec(property(get=__get__burstSliderFillPoolContainer, put=__set__burstSliderFillPoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*>*  _burstSliderFillPoolContainer;

/// @brief Field _bombNotePoolContainer offset 0xc0
 __declspec(property(get=__get__bombNotePoolContainer, put=__set__bombNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MultiplayerConnectedPlayerBombNoteController*>*  _bombNotePoolContainer;

/// @brief Field _obstaclePoolContainer offset 0xc8
 __declspec(property(get=__get__obstaclePoolContainer, put=__set__obstaclePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_2<::GlobalNamespace::MultiplayerConnectedPlayerObstacleController*,::GlobalNamespace::ObstacleController*>*  _obstaclePoolContainer;

/// @brief Field _beatmapObjectEventManager offset 0xd0
...
/// @brief Field _initData offset 0xd8
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*>*> __get__gameNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*>*> __get__burstSliderHeadGameNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*>*> __get__burstSliderGameNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*>*> __get__burstSliderFillPoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MultiplayerConnectedPlayerBombNoteController*>*> __get__bombNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_2<::GlobalNamespace::MultiplayerConnectedPlayerObstacleController*,::GlobalNamespace::ObstacleController*>*> __get__obstaclePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__MultiplayerConnectedPlayerBeatmapObjectManager__InitData*> __get__initData() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerConnectedPlayerBeatmapObjectManager()  = default;
public:
