...
/// @brief Field _filterByDifficultyToggle offset 0x70
...
/// @brief Field _filterByDifficultyButton offset 0x78
...
/// @brief Field _beatmapDifficultyDropdown offset 0x80
...
/// @brief Field _filterByModifiersToggle offset 0x88
...
/// @brief Field _filterByModifiersButton offset 0x90
...
/// @brief Field _gameplayModifiersDropdown offset 0x98
...
/// @brief Field _filterBySongsToggle offset 0xa0
...
/// @brief Field _filterBySongsButton offset 0xa8
...
/// @brief Field _songPacksDropdown offset 0xb0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> __get__filterByDifficultyButton() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get__filterByModifiersToggle() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> __get__filterByModifiersButton() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameplayModifiersDropdown*> __get__gameplayModifiersDropdown() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get__filterBySongsToggle() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> __get__filterBySongsButton() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get__showFullToggle() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get__showPasswordProtectedToggle() const;
...
// Ctor Parameters []
// @brief default ctor
 GameServersFilterViewController()  = default;
public:
