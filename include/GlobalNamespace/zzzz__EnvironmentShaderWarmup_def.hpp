...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::EnvironmentShaderWarmup*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __EnvironmentShaderWarmup___Start_d__6()  = default;
public:
...
/// @brief Field kNumberOfColumns offset 0x0
static constexpr int32_t  kNumberOfColumns{static_cast<int32_t>(0x4)};

/// @brief Field kNumberOfRows offset 0x0
...
/// @brief Field _parentingTransform offset 0x30
...
// Ctor Parameters []
// @brief default ctor
 EnvironmentShaderWarmup()  = default;
public:
