...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerLocalActivePlayerGameplayManager__InitData()  = default;
public:
...
/// @brief Field _gameSongController offset 0x18
...
/// @brief Field _multiplayerLevelEndActions offset 0x28
...
/// @brief Field _prepareLevelCompletionResults offset 0x30
...
/// @brief Field _inGameMenuController offset 0x40
...
/// @brief Field _platformHelper offset 0x48
...
/// @brief Field _disconnectHelper offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLocalActivePlayerInGameMenuController*> __get__inGameMenuController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__MultiplayerLocalActivePlayerGameplayManager__InitData*> __get__initData() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerLocalActivePlayerGameplayManager()  = default;
public:
