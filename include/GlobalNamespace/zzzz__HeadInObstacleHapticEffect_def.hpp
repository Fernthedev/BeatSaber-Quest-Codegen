...
/// @brief Field kInvalidTime offset 0x0
static constexpr float_t  kInvalidTime{-1.0};

/// @brief Field _headHapticPreset offset 0x18
...
/// @brief Field _minimalHapticDuration offset 0x20
...
/// @brief Field _wasHeadInWallLastFrame offset 0x58
...
/// @brief Method Start addr 0x2399d04 size 0x20c virtual false final false
inline void Start() ;

/// @brief Method OnDestroy addr 0x2399f10 size 0x1f0 virtual false final false
inline void OnDestroy() ;

/// @brief Method Update addr 0x239a100 size 0x88 virtual false final false
inline void Update() ;

/// @brief Method HandleAnyGameplayLevelDidFinish addr 0x239a188 size 0x14 virtual false final false
inline void HandleAnyGameplayLevelDidFinish() ;

/// @brief Method HandleDidResumeEvent addr 0x239a19c size 0x28 virtual false final false
inline void HandleDidResumeEvent() ;

/// @brief Method HandleDidPauseEvent addr 0x239a1c4 size 0x14 virtual false final false
inline void HandleDidPauseEvent() ;

static inline ::GlobalNamespace::HeadInObstacleHapticEffect* New_ctor() ;

/// @brief Method .ctor addr 0x239a1d8 size 0x1c virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 HeadInObstacleHapticEffect()  = default;
public:
