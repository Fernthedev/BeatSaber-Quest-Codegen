...
/// @brief Field _sliderInteractionManager offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SliderInteractionManager*> __get__sliderInteractionManager() const;
...
// Ctor Parameters []
// @brief default ctor
 SliderInteractionEffect()  = default;
public:
