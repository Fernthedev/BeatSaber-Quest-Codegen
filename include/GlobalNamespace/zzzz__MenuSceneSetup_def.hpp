...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MenuSceneSetup*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __MenuSceneSetup___Start_d__3()  = default;
public:
...
/// @brief Field _rootFlowCoordinator offset 0x18
