...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x90 - sizeof(::GlobalNamespace::NoteController)]{};

/// @brief Field _cuttableBySaber offset 0x80
...
/// @brief Field _wrapperGO offset 0x88
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::CuttableBySaber*> __get__cuttableBySaber() const;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11050), inst: 2810 }), TypeDefinitionIndex(TypeDefinitionIndex(11050)), TypeDefinitionIndex(TypeDefinitionIndex(4736))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::Zenject::MonoMemoryPool_1<::GlobalNamespace::BombNoteController*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __BombNoteController__Pool()  = default;
public:
