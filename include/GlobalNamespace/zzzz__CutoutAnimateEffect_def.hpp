...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::CutoutAnimateEffect*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __CutoutAnimateEffect___AnimateToCutoutCoroutine_d__7()  = default;
public:
...
/// @brief Field _cuttoutEffects offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get__transitionCurve() const;
