...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x118 - sizeof(::GlobalNamespace::MockPlayerGamePoseGenerator)]{};

/// @brief Field _scoreCalculator offset 0x38
...
/// @brief Field _rightNotes offset 0xd0
...
/// @brief Field _bombNotes offset 0xd8
...
/// @brief Field _obstacles offset 0xe0
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IMockPlayerScoreCalculator*> __get__scoreCalculator() const;
...
// Ctor Parameters []
// @brief default ctor
 MockPlayerGamePoseGeneratorAI()  = default;
public:
