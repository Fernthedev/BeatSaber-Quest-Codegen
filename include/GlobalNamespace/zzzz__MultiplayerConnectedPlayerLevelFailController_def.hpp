...
/// @brief Field _failVFXController offset 0x18
...
/// @brief Field _connectedPlayer offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::VFXController*> __get__failVFXController() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_playerDidFailEvent() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerConnectedPlayerLevelFailController()  = default;
public:
