...
struct CORDL_TYPE __NoteData__GameplayType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____NoteData__GameplayType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __NoteData__GameplayType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __NoteData__GameplayType()  = default;
...
struct CORDL_TYPE __NoteData__ScoringType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____NoteData__ScoringType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __NoteData__ScoringType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __NoteData__ScoringType()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x58 - sizeof(::GlobalNamespace::BeatmapObjectData)]{};

/// @brief Field <gameplayType>k__BackingField offset 0x20
...
/// @brief Field <scoringType>k__BackingField offset 0x24
...
/// @brief Field <colorType>k__BackingField offset 0x28
...
/// @brief Field <cutDirection>k__BackingField offset 0x2c
...
/// @brief Field <timeToNextColorNote>k__BackingField offset 0x30
...
/// @brief Field <timeToPrevColorNote>k__BackingField offset 0x34
...
/// @brief Field <lineIndex>k__BackingField offset 0x38
...
/// @brief Field <noteLineLayer>k__BackingField offset 0x3c
...
/// @brief Field <beforeJumpNoteLineLayer>k__BackingField offset 0x40
 __declspec(property(get=__get__beforeJumpNoteLineLayer_k__BackingField, put=__set__beforeJumpNoteLineLayer_k__BackingField)) ::GlobalNamespace::NoteLineLayer  _beforeJumpNoteLineLayer_k__BackingField;

/// @brief Field <flipLineIndex>k__BackingField offset 0x44
...
/// @brief Field <flipYSide>k__BackingField offset 0x48
...
/// @brief Field <cutDirectionAngleOffset>k__BackingField offset 0x4c
...
/// @brief Field <cutSfxVolumeMultiplier>k__BackingField offset 0x50
...
static inline ::GlobalNamespace::NoteData* CreateBasicNoteData(float_t  time, int32_t  lineIndex, ::GlobalNamespace::NoteLineLayer  noteLineLayer, ::GlobalNamespace::ColorType  colorType, ::GlobalNamespace::NoteCutDirection  cutDirection) ;
