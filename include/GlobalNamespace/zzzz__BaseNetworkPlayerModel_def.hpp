...
/// @brief Field selectionMask offset 0x10
...
/// @brief Field configuration offset 0x38
...
/// @brief Field partyManager offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::INetworkPlayerModel*> __get_partyManager() const;

static inline ::GlobalNamespace::__BaseNetworkPlayerModel__PartyConfig* New_ctor() ;

/// @brief Method .ctor addr 0x2636880 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __BaseNetworkPlayerModel__PartyConfig()  = default;
public:
...
/// @brief Method .ctor addr 0x2636580 size 0x34 virtual false final false
inline void _ctor(int32_t  __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2636888 size 0x4 virtual true final true
inline void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x263688c size 0x18 virtual true final true
inline bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<INetworkPlayer>.get_Current addr 0x26368a4 size 0x8 virtual true final true
inline ::GlobalNamespace::INetworkPlayer* System_Collections_Generic_IEnumerator_INetworkPlayer__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x26368ac size 0x40 virtual true final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x26368ec size 0x8 virtual true final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<INetworkPlayer>.GetEnumerator addr 0x26368f4 size 0x98 virtual true final true
...
/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x263698c size 0x4 virtual true final true
...
// Ctor Parameters []
// @brief default ctor
 __BaseNetworkPlayerModel___GetPartyPlayers_d__55()  = default;
public:
...
/// @brief Method .ctor addr 0x2636624 size 0x34 virtual false final false
inline void _ctor(int32_t  __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2636990 size 0x4 virtual true final true
inline void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x2636994 size 0x18 virtual true final true
inline bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<INetworkPlayer>.get_Current addr 0x26369ac size 0x8 virtual true final true
inline ::GlobalNamespace::INetworkPlayer* System_Collections_Generic_IEnumerator_INetworkPlayer__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x26369b4 size 0x40 virtual true final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x26369f4 size 0x8 virtual true final true
inline ::System::Object* System_Collections_IEnumerator_get_Current() ;

/// @brief Method System.Collections.Generic.IEnumerable<INetworkPlayer>.GetEnumerator addr 0x26369fc size 0x98 virtual true final true
inline ::System::Collections::Generic::IEnumerator_1<::GlobalNamespace::INetworkPlayer*>* System_Collections_Generic_IEnumerable_INetworkPlayer__GetEnumerator() ;

/// @brief Method System.Collections.IEnumerable.GetEnumerator addr 0x2636a94 size 0x4 virtual true final true
inline ::System::Collections::IEnumerator* System_Collections_IEnumerable_GetEnumerator() ;
...
// Ctor Parameters []
// @brief default ctor
 __BaseNetworkPlayerModel___GetOtherPlayers_d__56()  = default;
public:
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12966))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xa0 - sizeof(::GlobalNamespace::StandaloneMonobehavior)]{};

/// @brief Field _connectedPlayerManager offset 0x38
...
/// @brief Field _partyManager offset 0x40
...
/// @brief Field _selectionMask offset 0x60
...
/// @brief Field <discoveryEnabled>k__BackingField offset 0x88
...
/// @brief Field connectedPlayerManagerCreatedEvent offset 0x90
 __declspec(property(get=__get_connectedPlayerManagerCreatedEvent, put=__set_connectedPlayerManagerCreatedEvent)) ::System::Action_1<::GlobalNamespace::INetworkPlayerModel*>*  connectedPlayerManagerCreatedEvent;

/// @brief Field connectedPlayerManagerDestroyedEvent offset 0x98
 __declspec(property(get=__get_connectedPlayerManagerDestroyedEvent, put=__set_connectedPlayerManagerDestroyedEvent)) ::System::Action_1<::GlobalNamespace::INetworkPlayerModel*>*  connectedPlayerManagerDestroyedEvent;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::INetworkPlayerModel*> __get__partyManager() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::INetworkPlayerModel*>*> __get_connectedPlayerManagerCreatedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::INetworkPlayerModel*>*> __get_connectedPlayerManagerDestroyedEvent() const;

/// @brief Method get_connectedPlayerManager addr 0x2635de8 size 0x8 virtual true final true
inline ::GlobalNamespace::ConnectedPlayerManager* get_connectedPlayerManager() ;

/// @brief Method get_partyManager addr 0x2635df0 size 0x10 virtual false final false
inline ::GlobalNamespace::INetworkPlayerModel* get_partyManager() ;

/// @brief Method get_isConnectedOrConnecting addr 0x2635e00 size 0x14 virtual false final false
inline bool get_isConnectedOrConnecting() ;

/// @brief Method get_isConnectionOwner addr 0x2635e14 size 0x14 virtual false final false
inline bool get_isConnectionOwner() ;

/// @brief Method get_discoveryEnabled addr 0x2635e28 size 0x8 virtual true final false
inline bool get_discoveryEnabled() ;

/// @brief Method set_discoveryEnabled addr 0x2635e30 size 0xc virtual true final false
inline void set_discoveryEnabled(bool  value) ;

/// @brief Method get_hasNetworkingFailed addr 0x2635e3c size 0x8 virtual true final false
inline bool get_hasNetworkingFailed() ;

/// @brief Method get_currentPartySize addr 0x2635e44 size 0x8 virtual true final false
inline int32_t get_currentPartySize() ;

/// @brief Method get_configuration addr 0x2635e4c size 0x14 virtual true final false
inline ::GlobalNamespace::GameplayServerConfiguration get_configuration() ;

/// @brief Method get_selectionMask addr 0x2635e60 size 0x14 virtual true final false
inline ::GlobalNamespace::BeatmapLevelSelectionMask get_selectionMask() ;

/// @brief Method add_connectedPlayerManagerCreatedEvent addr 0x2635e74 size 0xb0 virtual true final true
inline void add_connectedPlayerManagerCreatedEvent(::System::Action_1<::GlobalNamespace::INetworkPlayerModel*>*  value) ;

/// @brief Method remove_connectedPlayerManagerCreatedEvent addr 0x2635f24 size 0xb0 virtual true final true
inline void remove_connectedPlayerManagerCreatedEvent(::System::Action_1<::GlobalNamespace::INetworkPlayerModel*>*  value) ;

/// @brief Method add_connectedPlayerManagerDestroyedEvent addr 0x2635fd4 size 0xb0 virtual true final true
inline void add_connectedPlayerManagerDestroyedEvent(::System::Action_1<::GlobalNamespace::INetworkPlayerModel*>*  value) ;

/// @brief Method remove_connectedPlayerManagerDestroyedEvent addr 0x2636084 size 0xb0 virtual true final true
inline void remove_connectedPlayerManagerDestroyedEvent(::System::Action_1<::GlobalNamespace::INetworkPlayerModel*>*  value) ;

/// @brief Method add_partyChangedEvent addr 0x2636134 size 0x4 virtual true final false
inline void add_partyChangedEvent(::System::Action_1<::GlobalNamespace::INetworkPlayerModel*>*  value) ;

/// @brief Method remove_partyChangedEvent addr 0x2636138 size 0x4 virtual true final false
inline void remove_partyChangedEvent(::System::Action_1<::GlobalNamespace::INetworkPlayerModel*>*  value) ;

/// @brief Method add_partySizeChangedEvent addr 0x263613c size 0x4 virtual true final false
inline void add_partySizeChangedEvent(::System::Action_1<int32_t>*  value) ;

/// @brief Method remove_partySizeChangedEvent addr 0x2636140 size 0x4 virtual true final false
inline void remove_partySizeChangedEvent(::System::Action_1<int32_t>*  value) ;

/// @brief Method add_joinRequestedEvent addr 0x2636144 size 0x4 virtual true final false
inline void add_joinRequestedEvent(::System::Action_1<::GlobalNamespace::INetworkPlayer*>*  value) ;

/// @brief Method remove_joinRequestedEvent addr 0x2636148 size 0x4 virtual true final false
inline void remove_joinRequestedEvent(::System::Action_1<::GlobalNamespace::INetworkPlayer*>*  value) ;

/// @brief Method add_inviteRequestedEvent addr 0x263614c size 0x4 virtual true final false
inline void add_inviteRequestedEvent(::System::Action_1<::GlobalNamespace::INetworkPlayer*>*  value) ;

/// @brief Method remove_inviteRequestedEvent addr 0x2636150 size 0x4 virtual true final false
inline void remove_inviteRequestedEvent(::System::Action_1<::GlobalNamespace::INetworkPlayer*>*  value) ;

/// @brief Method get_partyPlayers addr 0x2636154 size 0x10 virtual true final true
inline ::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::INetworkPlayer*>* get_partyPlayers() ;

/// @brief Method INetworkPlayerModel.get_otherPlayers addr 0x2636164 size 0x10 virtual true final true
inline ::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::INetworkPlayer*>* INetworkPlayerModel_get_otherPlayers() ;

/// @brief Method get_localPlayerIsPartyOwner addr 0x2636174 size 0x8 virtual true final false
inline bool get_localPlayerIsPartyOwner() ;

/// @brief Method get_isServer addr 0x263617c size 0x3c virtual false final false
inline bool get_isServer() ;

/// @brief Method get_isClient addr 0x26361b8 size 0x4c virtual false final false
inline bool get_isClient() ;

/// @brief Method OnDestroy addr 0x2636204 size 0x4 virtual true final false
inline void OnDestroy() ;

/// @brief Method Update addr 0x26364e0 size 0x30 virtual true final false
inline void Update() ;

/// @brief Method GetPartyPlayers addr 0x2636510 size 0x70 virtual true final false
inline ::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::INetworkPlayer*>* GetPartyPlayers() ;

/// @brief Method GetOtherPlayers addr 0x26365b4 size 0x70 virtual true final false
inline ::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::INetworkPlayer*>* GetOtherPlayers() ;

/// @brief Method ConnectionFailed addr 0x2636658 size 0x10 virtual true final false
inline void ConnectionFailed(::GlobalNamespace::ConnectionFailedReason  reason) ;

/// @brief Method PlayerConnected addr 0x2636668 size 0x4 virtual true final false
inline void PlayerConnected(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method PlayerDisconnected addr 0x263666c size 0x4 virtual true final false
inline void PlayerDisconnected(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method PlayerStateChanged addr 0x2636670 size 0x4 virtual true final false
inline void PlayerStateChanged(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method ConnectedPlayerManagerChanged addr 0x2636674 size 0x4 virtual true final false
inline void ConnectedPlayerManagerChanged() ;

/// @brief Method PlayerOrderChanged addr 0x2636678 size 0x4 virtual true final false
inline void PlayerOrderChanged(::GlobalNamespace::IConnectedPlayer*  player) ;

/// @brief Method PartySizeChanged addr 0x263667c size 0x4 virtual true final false
inline void PartySizeChanged(int32_t  currentPartySize) ;

/// @brief Method Connected addr 0x2636680 size 0x4 virtual true final false
inline void Connected() ;

/// @brief Method Disconnected addr 0x2636684 size 0x10 virtual true final false
...
/// @brief Method DestroyPartyConnection addr 0x2636694 size 0x114 virtual true final false
inline void DestroyPartyConnection() ;

/// @brief Method DestroyConnectedPlayerManager addr 0x2636208 size 0x2d8 virtual false final false
...
/// @brief Method Log addr 0x26367a8 size 0xd0 virtual false final false
inline void Log(::StringW  message) ;

static inline ::GlobalNamespace::BaseNetworkPlayerModel* New_ctor() ;

/// @brief Method .ctor addr 0x2636878 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 BaseNetworkPlayerModel()  = default;
public:
