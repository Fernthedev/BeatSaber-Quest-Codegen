...
struct CORDL_TYPE __BeatmapLevelDataLoader__AssetBundleLevelInfo : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x18};

/// @brief Field assetBundlePath offset 0x0
 __declspec(property(get=__get_assetBundlePath, put=__set_assetBundlePath)) ::StringW  assetBundlePath;

/// @brief Field levelDataAssetName offset 0x8
...
constexpr explicit __BeatmapLevelDataLoader__AssetBundleLevelInfo(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __BeatmapLevelDataLoader__AssetBundleLevelInfo()  = default;
...
/// @brief Field _difficultyBeatmapSet offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet*> __get__difficultyBeatmapSet() const;
...
inline void _ctor(::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet*  difficultyBeatmapSet, ::GlobalNamespace::BeatmapCharacteristicSO*  beatmapCharacteristicSerializedName, ::GlobalNamespace::IBeatmapLevel*  parentLevel) ;
...
// Ctor Parameters []
// @brief default ctor
 __BeatmapLevelDataLoader__BeatmapLevelFromPreview__BeatmapLevelData__DifficultyBeatmapSet()  = default;
public:
...
/// @brief Field _difficultyBeatmapSets offset 0x18
 __declspec(property(get=__get__difficultyBeatmapSets, put=__set__difficultyBeatmapSets)) ::System::Collections::Generic::List_1<::GlobalNamespace::__BeatmapLevelDataLoader__BeatmapLevelFromPreview__BeatmapLevelData__DifficultyBeatmapSet*>*  _difficultyBeatmapSets;
...
constexpr void __set__difficultyBeatmapSets(::System::Collections::Generic::List_1<::GlobalNamespace::__BeatmapLevelDataLoader__BeatmapLevelFromPreview__BeatmapLevelData__DifficultyBeatmapSet*>*  value) ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__BeatmapLevelDataLoader__BeatmapLevelFromPreview__BeatmapLevelData__DifficultyBeatmapSet*>*> __get__difficultyBeatmapSets() const;
...
static inline ::GlobalNamespace::__BeatmapLevelDataLoader__BeatmapLevelFromPreview__BeatmapLevelData* New_ctor(::GlobalNamespace::BeatmapLevelDataSO*  beatmapLevelData, ::GlobalNamespace::BeatmapCharacteristicCollection*  beatmapCharacteristicCollection, ::GlobalNamespace::IBeatmapLevel*  parentLevel) ;

/// @brief Method .ctor addr 0x233f148 size 0x1c4 virtual false final false
inline void _ctor(::GlobalNamespace::BeatmapLevelDataSO*  beatmapLevelData, ::GlobalNamespace::BeatmapCharacteristicCollection*  beatmapCharacteristicCollection, ::GlobalNamespace::IBeatmapLevel*  parentLevel) ;
...
// Ctor Parameters []
// @brief default ctor
 __BeatmapLevelDataLoader__BeatmapLevelFromPreview__BeatmapLevelData()  = default;
public:
...
// CS Name: ::BeatmapLevelDataLoader::BeatmapLevelFromPreview::<GetCoverImageAsync>d__41
struct CORDL_TYPE __BeatmapLevelDataLoader__BeatmapLevelFromPreview___GetCoverImageAsync_d__41 : public ::bs_hook::ValueTypeWrapper<0x38> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field <>4__this offset 0x20
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::GlobalNamespace::__BeatmapLevelDataLoader__BeatmapLevelFromPreview*  __4__this;
...
constexpr void __set___4__this(::GlobalNamespace::__BeatmapLevelDataLoader__BeatmapLevelFromPreview*  value) ;

constexpr ::GlobalNamespace::__BeatmapLevelDataLoader__BeatmapLevelFromPreview* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__BeatmapLevelDataLoader__BeatmapLevelFromPreview*> __get___4__this() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __BeatmapLevelDataLoader__BeatmapLevelFromPreview___GetCoverImageAsync_d__41(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x38>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __BeatmapLevelDataLoader__BeatmapLevelFromPreview___GetCoverImageAsync_d__41()  = default;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IPreviewBeatmapLevel*> __get__level() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__BeatmapLevelDataLoader__BeatmapLevelFromPreview__BeatmapLevelData*> __get__beatmapLevelData() const;
...
// Ctor Parameters []
// @brief default ctor
 __BeatmapLevelDataLoader__BeatmapLevelFromPreview()  = default;
public:
...
struct CORDL_TYPE __BeatmapLevelDataLoader___LoadBeatmapLevelFormAssetBundleAsync_d__5 : public ::bs_hook::ValueTypeWrapper<0x58> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field <>t__builder offset 0x8
 __declspec(property(get=__get___t__builder, put=__set___t__builder)) ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::GlobalNamespace::IBeatmapLevel*>  __t__builder;

/// @brief Field previewBeatmapLevel offset 0x20
 __declspec(property(get=__get_previewBeatmapLevel, put=__set_previewBeatmapLevel)) ::GlobalNamespace::IPreviewBeatmapLevel*  previewBeatmapLevel;

/// @brief Field <>4__this offset 0x28
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::GlobalNamespace::BeatmapLevelDataLoader*  __4__this;

/// @brief Field assetBundlePath offset 0x30
 __declspec(property(get=__get_assetBundlePath, put=__set_assetBundlePath)) ::StringW  assetBundlePath;

/// @brief Field levelDataAssetName offset 0x38
 __declspec(property(get=__get_levelDataAssetName, put=__set_levelDataAssetName)) ::StringW  levelDataAssetName;

/// @brief Field cancellationToken offset 0x40
 __declspec(property(get=__get_cancellationToken, put=__set_cancellationToken)) ::System::Threading::CancellationToken  cancellationToken;

/// @brief Field <levelID>5__2 offset 0x48
 __declspec(property(get=__get__levelID_5__2, put=__set__levelID_5__2)) ::StringW  _levelID_5__2;

/// @brief Field <>u__1 offset 0x50
 __declspec(property(get=__get___u__1, put=__set___u__1)) ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::IBeatmapLevel*>  __u__1;
...
constexpr ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::GlobalNamespace::IBeatmapLevel*>& __get___t__builder() ;

constexpr ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::GlobalNamespace::IBeatmapLevel*> const& __get___t__builder() const;
...
constexpr ::GlobalNamespace::BeatmapLevelDataLoader* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapLevelDataLoader*> __get___4__this() const;
...
constexpr ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::IBeatmapLevel*>& __get___u__1() ;

constexpr ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::IBeatmapLevel*> const& __get___u__1() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __BeatmapLevelDataLoader___LoadBeatmapLevelFormAssetBundleAsync_d__5(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x58>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __BeatmapLevelDataLoader___LoadBeatmapLevelFormAssetBundleAsync_d__5()  = default;
...
struct CORDL_TYPE __BeatmapLevelDataLoader___LoadBeatmapLevelAsync_d__7 : public ::bs_hook::ValueTypeWrapper<0x38> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x38};
...
/// @brief Field <>u__1 offset 0x30
 __declspec(property(get=__get___u__1, put=__set___u__1)) ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::BeatmapLevelDataSO*>  __u__1;
...
constexpr ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::BeatmapLevelDataSO*>& __get___u__1() ;

constexpr ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::BeatmapLevelDataSO*> const& __get___u__1() const;
...
constexpr __BeatmapLevelDataLoader___LoadBeatmapLevelAsync_d__7(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::GlobalNamespace::IBeatmapLevel*>  __t__builder, ::GlobalNamespace::BeatmapLevelDataLoader*  __4__this, ::StringW  levelID, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::BeatmapLevelDataSO*>  __u__1) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __BeatmapLevelDataLoader___LoadBeatmapLevelAsync_d__7(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x38>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __BeatmapLevelDataLoader___LoadBeatmapLevelAsync_d__7()  = default;
...
/// @brief Field assetBundleCreateRequest offset 0x10
...
/// @brief Field levelDataAssetName offset 0x18
 __declspec(property(get=__get_levelDataAssetName, put=__set_levelDataAssetName)) ::StringW  levelDataAssetName;

/// @brief Field taskSource offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AssetBundleCreateRequest*> __get_assetBundleCreateRequest() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::TaskCompletionSource_1<::GlobalNamespace::BeatmapLevelDataSO*>*> __get_taskSource() const;
...
// Ctor Parameters []
// @brief default ctor
 __BeatmapLevelDataLoader____c__DisplayClass8_0()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AssetBundle*> __get_assetBundle() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AssetBundleRequest*> __get_assetBundleRequest() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__BeatmapLevelDataLoader____c__DisplayClass8_0*> __get_CS$__8__locals1() const;
...
// Ctor Parameters []
// @brief default ctor
 __BeatmapLevelDataLoader____c__DisplayClass8_1()  = default;
public:
...
struct CORDL_TYPE __BeatmapLevelDataLoader___LoadBeatmapLevelDataAsync_d__8 : public ::bs_hook::ValueTypeWrapper<0x38> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x38};
...
/// @brief Field <>t__builder offset 0x8
 __declspec(property(get=__get___t__builder, put=__set___t__builder)) ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::GlobalNamespace::BeatmapLevelDataSO*>  __t__builder;

/// @brief Field levelDataAssetName offset 0x20
 __declspec(property(get=__get_levelDataAssetName, put=__set_levelDataAssetName)) ::StringW  levelDataAssetName;

/// @brief Field assetBundlePath offset 0x28
 __declspec(property(get=__get_assetBundlePath, put=__set_assetBundlePath)) ::StringW  assetBundlePath;
...
constexpr ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::GlobalNamespace::BeatmapLevelDataSO*>& __get___t__builder() ;

constexpr ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder_1<::GlobalNamespace::BeatmapLevelDataSO*> const& __get___t__builder() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __BeatmapLevelDataLoader___LoadBeatmapLevelDataAsync_d__8(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x38>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __BeatmapLevelDataLoader___LoadBeatmapLevelDataAsync_d__8()  = default;
...
/// @brief Field _beatmapLevelsAsyncCache offset 0x10
 __declspec(property(get=__get__beatmapLevelsAsyncCache, put=__set__beatmapLevelsAsyncCache)) ::GlobalNamespace::AsyncCache_2<::StringW,::GlobalNamespace::IBeatmapLevel*>*  _beatmapLevelsAsyncCache;

/// @brief Field _bundleLevelInfos offset 0x18
 __declspec(property(get=__get__bundleLevelInfos, put=__set__bundleLevelInfos)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::__BeatmapLevelDataLoader__AssetBundleLevelInfo>*  _bundleLevelInfos;

/// @brief Field _allBeatmapCharacteristicCollection offset 0x20
 __declspec(property(get=__get__allBeatmapCharacteristicCollection, put=__set__allBeatmapCharacteristicCollection)) ::GlobalNamespace::BeatmapCharacteristicCollection*  _allBeatmapCharacteristicCollection;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::AsyncCache_2<::StringW,::GlobalNamespace::IBeatmapLevel*>*> __get__beatmapLevelsAsyncCache() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::__BeatmapLevelDataLoader__AssetBundleLevelInfo>*> __get__bundleLevelInfos() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapCharacteristicCollection*> __get__allBeatmapCharacteristicCollection() const;
...
inline ::System::Threading::Tasks::Task_1<::GlobalNamespace::IBeatmapLevel*>* LoadBeatmapLevelFormAssetBundleAsync(::GlobalNamespace::IPreviewBeatmapLevel*  previewBeatmapLevel, ::StringW  assetBundlePath, ::StringW  levelDataAssetName, ::System::Threading::CancellationToken  cancellationToken) ;
...
// Ctor Parameters []
// @brief default ctor
 BeatmapLevelDataLoader()  = default;
public:
...
DEFINE_IL2CPP_ARG_TYPE(::GlobalNamespace::__BeatmapLevelDataLoader__BeatmapLevelFromPreview__BeatmapLevelData__DifficultyBeatmapSet*, "", "BeatmapLevelDataLoader/BeatmapLevelFromPreview/BeatmapLevelData/DifficultyBeatmapSet");
