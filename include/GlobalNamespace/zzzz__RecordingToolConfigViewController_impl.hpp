...
constexpr ::cordl_internals::to_const_pointer<::HMUI::TextPageScrollView*> GlobalNamespace::RecordingToolConfigViewController::__get__textPageScrollView() const {
return ::cordl_internals::getInstanceField<::HMUI::TextPageScrollView*, 0x70>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::RecordingToolManager*, 0x78>(this, std::forward<::GlobalNamespace::RecordingToolManager*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::RecordingToolManager*, 0x78>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::RecordingToolManager*> GlobalNamespace::RecordingToolConfigViewController::__get__recordingToolManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::RecordingToolManager*, 0x78>(this);
}
