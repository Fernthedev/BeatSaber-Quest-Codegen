...
/// @brief Field _videoAssetReference offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AddressableAssets::AssetReference*> __get__videoAssetReference() const;
...
// Ctor Parameters []
// @brief default ctor
 __VideoProjectionDataModelSO__VideoClipWithId()  = default;
public:
...
/// @brief Field _videoClipsWithId offset 0x18
 __declspec(property(get=__get__videoClipsWithId, put=__set__videoClipsWithId)) ::ArrayW<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*,::Array<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*>*>  _videoClipsWithId;
...
constexpr void __set__videoClipsWithId(::ArrayW<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*,::Array<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*>*>  value) ;
...
constexpr ::ArrayW<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*,::Array<::GlobalNamespace::__VideoProjectionDataModelSO__VideoClipWithId*>*> const& __get__videoClipsWithId() const;
...
// Ctor Parameters []
// @brief default ctor
 VideoProjectionDataModelSO()  = default;
public:
