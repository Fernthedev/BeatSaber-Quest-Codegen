...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RectangleFakeGlow::*)(::UnityEngine::Color)>(&::GlobalNamespace::RectangleFakeGlow::set_color)> {
  ...
  constexpr static std::size_t addrs = 0x23b4e30;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (::GlobalNamespace::RectangleFakeGlow::*)()>(&::GlobalNamespace::RectangleFakeGlow::get_color)> {
  ...
  constexpr static std::size_t addrs = 0x23b4ef4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RectangleFakeGlow::*)()>(&::GlobalNamespace::RectangleFakeGlow::Awake)> {
  ...
  constexpr static std::size_t addrs = 0x23b4f00;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RectangleFakeGlow::*)()>(&::GlobalNamespace::RectangleFakeGlow::OnEnable)> {
  ...
  constexpr static std::size_t addrs = 0x23b4f6c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RectangleFakeGlow::*)()>(&::GlobalNamespace::RectangleFakeGlow::OnDisable)> {
  constexpr static std::size_t size = 0x6c;
  constexpr static std::size_t addrs = 0x23b50f4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RectangleFakeGlow::*)()>(&::GlobalNamespace::RectangleFakeGlow::Refresh)> {
  ...
  constexpr static std::size_t addrs = 0x23b4fe0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::RectangleFakeGlow::*)()>(&::GlobalNamespace::RectangleFakeGlow::_ctor)> {
  constexpr static std::size_t size = 0x24;
  constexpr static std::size_t addrs = 0x23b5160;
...
constexpr void GlobalNamespace::RectangleFakeGlow::__set__size(::UnityEngine::Vector2  value)  {
::cordl_internals::setInstanceField<::UnityEngine::Vector2, 0x18>(this, std::forward<::UnityEngine::Vector2>(value));
}
constexpr ::UnityEngine::Vector2& GlobalNamespace::RectangleFakeGlow::__get__size()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0x18>(this);
}
constexpr ::UnityEngine::Vector2 const& GlobalNamespace::RectangleFakeGlow::__get__size() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector2, 0x18>(this);
}
constexpr void GlobalNamespace::RectangleFakeGlow::__set__edgeSize(float_t  value)  {
::cordl_internals::setInstanceField<float_t, 0x20>(this, std::forward<float_t>(value));
}
constexpr float_t& GlobalNamespace::RectangleFakeGlow::__get__edgeSize()  {
return ::cordl_internals::getInstanceField<float_t, 0x20>(this);
}
constexpr float_t const& GlobalNamespace::RectangleFakeGlow::__get__edgeSize() const {
return ::cordl_internals::getInstanceField<float_t, 0x20>(this);
}
constexpr void GlobalNamespace::RectangleFakeGlow::__set__color(::UnityEngine::Color  value)  {
::cordl_internals::setInstanceField<::UnityEngine::Color, 0x24>(this, std::forward<::UnityEngine::Color>(value));
}
constexpr ::UnityEngine::Color& GlobalNamespace::RectangleFakeGlow::__get__color()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Color, 0x24>(this);
}
constexpr ::UnityEngine::Color const& GlobalNamespace::RectangleFakeGlow::__get__color() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Color, 0x24>(this);
}
constexpr void GlobalNamespace::RectangleFakeGlow::__set__materialPropertyBlockController(::GlobalNamespace::MaterialPropertyBlockController*  value)  {
...
constexpr ::GlobalNamespace::MaterialPropertyBlockController* GlobalNamespace::RectangleFakeGlow::__get__materialPropertyBlockController()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MaterialPropertyBlockController*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MaterialPropertyBlockController*> GlobalNamespace::RectangleFakeGlow::__get__materialPropertyBlockController() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MaterialPropertyBlockController*, 0x38>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::GlobalNamespace::RectangleFakeGlow*>());
}
