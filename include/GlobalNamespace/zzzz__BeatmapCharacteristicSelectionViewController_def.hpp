...
/// @brief Field _beatmapCharacteristicSegmentedControl offset 0x70
...
/// @brief Field _beatmapCharacteristicCollection offset 0x78
...
/// @brief Field didSelectBeatmapCharacteristicEvent offset 0x80
 __declspec(property(get=__get_didSelectBeatmapCharacteristicEvent, put=__set_didSelectBeatmapCharacteristicEvent)) ::System::Action_2<::GlobalNamespace::BeatmapCharacteristicSelectionViewController*,::GlobalNamespace::BeatmapCharacteristicSO*>*  didSelectBeatmapCharacteristicEvent;

/// @brief Field _selectedBeatmapCharacteristic offset 0x88
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::IconSegmentedControl*> __get__beatmapCharacteristicSegmentedControl() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::BeatmapCharacteristicSelectionViewController*,::GlobalNamespace::BeatmapCharacteristicSO*>*> __get_didSelectBeatmapCharacteristicEvent() const;
...
/// @brief Method add_didSelectBeatmapCharacteristicEvent addr 0x22ad594 size 0xb0 virtual false final false
...
/// @brief Method remove_didSelectBeatmapCharacteristicEvent addr 0x22ad644 size 0xb0 virtual false final false
...
/// @brief Method get_selectedBeatmapCharacteristic addr 0x22ad6f4 size 0x8 virtual false final false
inline ::GlobalNamespace::BeatmapCharacteristicSO* get_selectedBeatmapCharacteristic() ;

/// @brief Method Init addr 0x22ad6fc size 0xc8 virtual false final false
inline void Init() ;

/// @brief Method DidActivate addr 0x22ad7c4 size 0x2f4 virtual true final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x22adab8 size 0xa0 virtual true final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method HandleBeatmapCharacteristicSegmentedControlDidSelectCell addr 0x22adb58 size 0xec virtual false final false
...
/// @brief Method .ctor addr 0x22adc44 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 BeatmapCharacteristicSelectionViewController()  = default;
public:
