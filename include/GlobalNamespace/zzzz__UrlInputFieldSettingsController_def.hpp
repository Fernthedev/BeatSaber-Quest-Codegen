...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::GlobalNamespace::InputFieldSettingsController)]{};

/// @brief Method HandleInputFieldDidChange addr 0x22ab188 size 0x90 virtual true final false
...
/// @brief Method .ctor addr 0x22ab218 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 UrlInputFieldSettingsController()  = default;
public:
