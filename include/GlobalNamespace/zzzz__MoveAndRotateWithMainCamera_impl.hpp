...
::cordl_internals::setInstanceField<::GlobalNamespace::MainCamera*, 0x18>(this, std::forward<::GlobalNamespace::MainCamera*>(value));
}
constexpr ::GlobalNamespace::MainCamera* GlobalNamespace::MoveAndRotateWithMainCamera::__get__mainCamera()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MainCamera*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MainCamera*> GlobalNamespace::MoveAndRotateWithMainCamera::__get__mainCamera() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MainCamera*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> GlobalNamespace::MoveAndRotateWithMainCamera::__get__transform() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x40>(this);
}
