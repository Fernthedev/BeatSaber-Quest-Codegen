...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> GlobalNamespace::RecordingToolSettingsViewController::__get__continueButton() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Button*, 0x70>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::TextPageScrollView*> GlobalNamespace::RecordingToolSettingsViewController::__get__textPageScrollView() const {
return ::cordl_internals::getInstanceField<::HMUI::TextPageScrollView*, 0x78>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::RecordingToolManager*, 0x80>(this, std::forward<::GlobalNamespace::RecordingToolManager*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::RecordingToolManager*, 0x80>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::RecordingToolManager*> GlobalNamespace::RecordingToolSettingsViewController::__get__recordingToolManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::RecordingToolManager*, 0x80>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> GlobalNamespace::RecordingToolSettingsViewController::__get_didFinishEvent() const {
return ::cordl_internals::getInstanceField<::System::Action*, 0x88>(this);
}
