...
struct CORDL_TYPE __LiteNetLibConnectionManager__NetworkMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____LiteNetLibConnectionManager__NetworkMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __LiteNetLibConnectionManager__NetworkMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __LiteNetLibConnectionManager__NetworkMode()  = default;
...
struct CORDL_TYPE __LiteNetLibConnectionManager__ConnectionState : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____LiteNetLibConnectionManager__ConnectionState_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __LiteNetLibConnectionManager__ConnectionState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __LiteNetLibConnectionManager__ConnectionState()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __LiteNetLibConnectionManager__LiteNetLibConnectionParamsBase()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::GlobalNamespace::__LiteNetLibConnectionManager__LiteNetLibConnectionParamsBase)]{};

/// @brief Field userId offset 0x28
 __declspec(property(get=__get_userId, put=__set_userId)) ::StringW  userId;

/// @brief Field userName offset 0x30
...
// Ctor Parameters []
// @brief default ctor
 __LiteNetLibConnectionManager__StartServerParams()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::GlobalNamespace::__LiteNetLibConnectionManager__LiteNetLibConnectionParamsBase)]{};
...
// Ctor Parameters []
// @brief default ctor
 __LiteNetLibConnectionManager__StartClientParams()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x58 - sizeof(::GlobalNamespace::__LiteNetLibConnectionManager__LiteNetLibConnectionParamsBase)]{};
...
// Ctor Parameters []
// @brief default ctor
 __LiteNetLibConnectionManager__ConnectToServerParams()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::ConnectionRequest*> __get__request() const;
...
// Ctor Parameters []
// @brief default ctor
 __LiteNetLibConnectionManager__NetPeerConnectionRequest()  = default;
public:
...
/// @brief Field netPeer offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetPeer*> __get_netPeer() const;
...
// Ctor Parameters []
// @brief default ctor
 __LiteNetLibConnectionManager__NetPeerConnection()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __LiteNetLibConnectionManager____c()  = default;
public:
...
struct CORDL_TYPE __LiteNetLibConnectionManager___BackgroundDisconnectSentry_d__126 : public ::bs_hook::ValueTypeWrapper<0x38> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field <>4__this offset 0x20
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::GlobalNamespace::LiteNetLibConnectionManager*  __4__this;
...
constexpr ::GlobalNamespace::LiteNetLibConnectionManager* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LiteNetLibConnectionManager*> __get___4__this() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __LiteNetLibConnectionManager___BackgroundDisconnectSentry_d__126(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x38>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __LiteNetLibConnectionManager___BackgroundDisconnectSentry_d__126()  = default;
...
struct CORDL_TYPE __LiteNetLibConnectionManager___BackgroundShutdownSentry_d__127 : public ::bs_hook::ValueTypeWrapper<0x38> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x38};
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __LiteNetLibConnectionManager___BackgroundShutdownSentry_d__127(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x38>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __LiteNetLibConnectionManager___BackgroundShutdownSentry_d__127()  = default;
...
/// @brief Field _pendingConnections offset 0x38
 __declspec(property(get=__get__pendingConnections, put=__set__pendingConnections)) ::System::Collections::Generic::List_1<::GlobalNamespace::__LiteNetLibConnectionManager__NetPeerConnection*>*  _pendingConnections;

/// @brief Field _pendingRequests offset 0x40
 __declspec(property(get=__get__pendingRequests, put=__set__pendingRequests)) ::System::Collections::Generic::List_1<::GlobalNamespace::__LiteNetLibConnectionManager__NetPeerConnectionRequest*>*  _pendingRequests;

/// @brief Field _pendingReconnections offset 0x48
...
/// @brief Field _userId offset 0x50
 __declspec(property(get=__get__userId, put=__set__userId)) ::StringW  _userId;

/// @brief Field _userName offset 0x58
 __declspec(property(get=__get__userName, put=__set__userName)) ::StringW  _userName;

/// @brief Field _connectionRequestHandler offset 0x60
...
/// @brief Field _backgroundSentryDisconnectCts offset 0x70
...
/// @brief Field _backgroundSentryShutdownCts offset 0x78
...
/// @brief Field onConnectionFailedEvent offset 0xb0
...
/// @brief Field onConnectionConnectedEvent offset 0xb8
...
/// @brief Field onConnectionDisconnectedEvent offset 0xc0
...
/// @brief Field onReceivedDataEvent offset 0xc8
...
/// @brief Field onReceiveUnconnectedDataEvent offset 0xd0
 __declspec(property(get=__get_onReceiveUnconnectedDataEvent, put=__set_onReceiveUnconnectedDataEvent)) ::System::Action_2<::System::Net::IPEndPoint*,::LiteNetLib::Utils::NetDataReader*>*  onReceiveUnconnectedDataEvent;

/// @brief Field onStatisticsUpdatedEvent offset 0xd8
 __declspec(property(get=__get_onStatisticsUpdatedEvent, put=__set_onStatisticsUpdatedEvent)) ::GlobalNamespace::__NetworkStatisticsState__NetworkStatisticsUpdateDelegate*  onStatisticsUpdatedEvent;
...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetManager*> __get__netManager() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PacketEncryptionLayer*> __get__encryptionLayer() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__LiteNetLibConnectionManager__NetPeerConnection*>*> __get__connections() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__LiteNetLibConnectionManager__NetPeerConnection*>*> __get__pendingConnections() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__LiteNetLibConnectionManager__NetPeerConnectionRequest*>*> __get__pendingRequests() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::System::Net::IPEndPoint*>*> __get__pendingReconnections() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::CancellationTokenSource*> __get__backgroundSentryShutdownCts() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::System::Net::IPEndPoint*,::LiteNetLib::Utils::NetDataReader*>*> __get_onReceiveUnconnectedDataEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__NetworkStatisticsState__NetworkStatisticsUpdateDelegate*> __get_onStatisticsUpdatedEvent() const;
...
// Ctor Parameters []
// @brief default ctor
 LiteNetLibConnectionManager()  = default;
public:
