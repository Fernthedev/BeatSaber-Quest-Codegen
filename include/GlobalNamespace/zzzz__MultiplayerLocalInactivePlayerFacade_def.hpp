...
/// @brief Field _inactivePlayerSongSyncController offset 0x18
 __declspec(property(get=__get__inactivePlayerSongSyncController, put=__set__inactivePlayerSongSyncController)) ::GlobalNamespace::MultiplayerLocalInactivePlayerSongSyncController*  _inactivePlayerSongSyncController;
...
/// @brief Field _introAnimator offset 0x28
...
/// @brief Field _outroAnimator offset 0x30
...
/// @brief Field playerDidFinishEvent offset 0x38
...
/// @brief Field playerNetworkDidFailedEvent offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLocalInactivePlayerSongSyncController*> __get__inactivePlayerSongSyncController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Playables::PlayableDirector*> __get__introAnimator() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLocalInactivePlayerOutroAnimator*> __get__outroAnimator() const;
...
/// @brief Method get_songController addr 0x23dc8c4 size 0x8 virtual true final true
inline ::GlobalNamespace::IStartSeekSongController* get_songController() ;

/// @brief Method get_spectatorController addr 0x23dc8cc size 0x8 virtual false final false
inline ::GlobalNamespace::MultiplayerSpectatorController* get_spectatorController() ;

/// @brief Method get_introAnimator addr 0x23dc8d4 size 0x1c virtual false final false
inline ::UnityEngine::GameObject* get_introAnimator() ;

/// @brief Method get_introPlayableDirector addr 0x23dc8f0 size 0x8 virtual false final false
inline ::UnityEngine::Playables::PlayableDirector* get_introPlayableDirector() ;

/// @brief Method get_outroAnimator addr 0x23dc8f8 size 0x8 virtual false final false
inline ::GlobalNamespace::MultiplayerLocalInactivePlayerOutroAnimator* get_outroAnimator() ;

/// @brief Method add_playerDidFinishEvent addr 0x23dc900 size 0xb0 virtual true final true
inline void add_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  value) ;

/// @brief Method remove_playerDidFinishEvent addr 0x23dc9b0 size 0xb0 virtual true final true
inline void remove_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  value) ;

/// @brief Method add_playerNetworkDidFailedEvent addr 0x23dca60 size 0xb0 virtual true final true
inline void add_playerNetworkDidFailedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  value) ;

/// @brief Method remove_playerNetworkDidFailedEvent addr 0x23dcb10 size 0xb0 virtual true final true
inline void remove_playerNetworkDidFailedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  value) ;

/// @brief Method ReportPlayerDidFinish addr 0x23dcbc0 size 0x1c virtual true final true
inline void ReportPlayerDidFinish(::GlobalNamespace::MultiplayerLevelCompletionResults*  results) ;

/// @brief Method ReportPlayerNetworkDidFailed addr 0x23dcbdc size 0x1c virtual true final true
...
/// @brief Method .ctor addr 0x23dcbf8 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerLocalInactivePlayerFacade()  = default;
public:
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5239)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11005), inst: 3491 }), TypeDefinitionIndex(TypeDefinitionIndex(11005)), TypeDefinitionIndex(TypeDefinitionIndex(5161))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(5160))
// CS Name: ::MultiplayerLocalInactivePlayerFacade::Factory*
class CORDL_TYPE __MultiplayerLocalInactivePlayerFacade__Factory : public ::Zenject::PlaceholderFactory_2<::GlobalNamespace::MultiplayerPlayerStartState,::GlobalNamespace::MultiplayerLocalInactivePlayerFacade*> {
public:
// Declarations
/// @brief The size of the true reference type
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::Zenject::PlaceholderFactory_2<::GlobalNamespace::MultiplayerPlayerStartState,::GlobalNamespace::MultiplayerLocalInactivePlayerFacade*>)]{};

static inline ::GlobalNamespace::__MultiplayerLocalInactivePlayerFacade__Factory* New_ctor() ;

/// @brief Method .ctor addr 0x23dcc00 size 0x48 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerLocalInactivePlayerFacade__Factory()  = default;
public:
