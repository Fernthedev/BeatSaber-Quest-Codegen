...
/// @brief Field _colorAnimationStartDuration offset 0x98
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerPositionDisplay()  = default;
public:
