...
/// @brief Field kMaxColors offset 0x0
static constexpr int32_t  kMaxColors{static_cast<int32_t>(0x2)};

/// @brief Field _graphics offset 0x18
...
/// @brief Field colorWasSelectedEvent offset 0x28
...
/// @brief Field _buttonBinder offset 0x30
...
/// @brief Field _graphicsColor offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::Color>*> __get_colorWasSelectedEvent() const;
...
// Ctor Parameters []
// @brief default ctor
 PreviousColorPanelController()  = default;
public:
