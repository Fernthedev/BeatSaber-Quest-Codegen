...
public:
// Declarations
/// @brief Method add_didInvalidateDataEvent addr 0x0 size 0xffffffffffffffff virtual true final false
inline void add_didInvalidateDataEvent(::System::Action*  value) ;

/// @brief Method remove_didInvalidateDataEvent addr 0x0 size 0xffffffffffffffff virtual true final false
inline void remove_didInvalidateDataEvent(::System::Action*  value) ;

/// @brief Method GetLevelEntitlementStatusAsync addr 0x0 size 0xffffffffffffffff virtual true final false
...
/// @brief Method GetPackEntitlementStatusAsync addr 0x0 size 0xffffffffffffffff virtual true final false
