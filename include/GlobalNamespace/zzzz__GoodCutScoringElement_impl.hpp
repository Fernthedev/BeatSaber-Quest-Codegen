...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType (::GlobalNamespace::GoodCutScoringElement::*)()>(&::GlobalNamespace::GoodCutScoringElement::get_wouldBeCorrectCutBestPossibleMultiplierEventType)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType (::GlobalNamespace::GoodCutScoringElement::*)()>(&::GlobalNamespace::GoodCutScoringElement::get_multiplierEventType)> {
  constexpr static std::size_t size = 0x8;
...
::cordl_internals::setInstanceField<::GlobalNamespace::CutScoreBuffer*, 0x28>(this, std::forward<::GlobalNamespace::CutScoreBuffer*>(value));
}
constexpr ::GlobalNamespace::CutScoreBuffer* GlobalNamespace::GoodCutScoringElement::__get__cutScoreBuffer()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::CutScoreBuffer*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::CutScoreBuffer*> GlobalNamespace::GoodCutScoringElement::__get__cutScoreBuffer() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::CutScoreBuffer*, 0x28>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType, 0x30>(this, std::forward<::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType, 0x30>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType, 0x34>(this, std::forward<::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::__ScoreMultiplierCounter__MultiplierEventType, 0x34>(this);
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__GoodCutScoringElement__Pool::*)()>(&::GlobalNamespace::__GoodCutScoringElement__Pool::_ctor)> {
