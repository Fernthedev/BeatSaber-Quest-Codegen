...
/// @brief Field _environmentInfo offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __GameObjectTestExceptionsSO__GameObjectTestException()  = default;
public:
...
/// @brief Field tubeBloomPrePassLightIgnores offset 0x18
 __declspec(property(get=__get_tubeBloomPrePassLightIgnores, put=__set_tubeBloomPrePassLightIgnores)) ::ArrayW<::GlobalNamespace::__GameObjectTestExceptionsSO__GameObjectTestException*,::Array<::GlobalNamespace::__GameObjectTestExceptionsSO__GameObjectTestException*>*>  tubeBloomPrePassLightIgnores;

constexpr void __set_tubeBloomPrePassLightIgnores(::ArrayW<::GlobalNamespace::__GameObjectTestExceptionsSO__GameObjectTestException*,::Array<::GlobalNamespace::__GameObjectTestExceptionsSO__GameObjectTestException*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__GameObjectTestExceptionsSO__GameObjectTestException*,::Array<::GlobalNamespace::__GameObjectTestExceptionsSO__GameObjectTestException*>*>& __get_tubeBloomPrePassLightIgnores() ;

constexpr ::ArrayW<::GlobalNamespace::__GameObjectTestExceptionsSO__GameObjectTestException*,::Array<::GlobalNamespace::__GameObjectTestExceptionsSO__GameObjectTestException*>*> const& __get_tubeBloomPrePassLightIgnores() const;

/// @brief Method GetExceptionAsDictionary addr 0x23237c4 size 0xe0 virtual false final false
static inline ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::EnvironmentInfoSO*,::ArrayW<::StringW,::Array<::StringW>*>>* GetExceptionAsDictionary(::ArrayW<::GlobalNamespace::__GameObjectTestExceptionsSO__GameObjectTestException*,::Array<::GlobalNamespace::__GameObjectTestExceptionsSO__GameObjectTestException*>*>  testExceptionArray) ;
...
// Ctor Parameters []
// @brief default ctor
 GameObjectTestExceptionsSO()  = default;
public:
