...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_xTransform() const;

constexpr void __set_yTransform(::UnityEngine::Transform*  value) ;

constexpr ::UnityEngine::Transform* __get_yTransform() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_yTransform() const;

constexpr void __set_zTransform(::UnityEngine::Transform*  value) ;

constexpr ::UnityEngine::Transform* __get_zTransform() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_zTransform() const;
...
// Ctor Parameters []
// @brief default ctor
 __LightTranslationGroupEffect__InitData()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::Tweening::FloatTween*> __get_translationTween() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LightTranslationGroupEffect*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __LightTranslationGroupEffect____c__DisplayClass12_0()  = default;
public:
...
/// @brief Field _transformMask offset 0x20
 __declspec(property(get=__get__transformMask, put=__set__transformMask)) ::System::Collections::Generic::List_1<::System::ValueTuple_2<::UnityEngine::Transform*,::UnityEngine::Vector3>>*  _transformMask;

/// @brief Field _xTranslationTween offset 0x28
 __declspec(property(get=__get__xTranslationTween, put=__set__xTranslationTween)) ::Tweening::FloatTween*  _xTranslationTween;

/// @brief Field _yTranslationTween offset 0x30
 __declspec(property(get=__get__yTranslationTween, put=__set__yTranslationTween)) ::Tweening::FloatTween*  _yTranslationTween;

/// @brief Field _zTranslationTween offset 0x38
 __declspec(property(get=__get__zTranslationTween, put=__set__zTranslationTween)) ::Tweening::FloatTween*  _zTranslationTween;

/// @brief Field _lightTranslationXBeatmapEventCallbackWrapper offset 0x40
 __declspec(property(get=__get__lightTranslationXBeatmapEventCallbackWrapper, put=__set__lightTranslationXBeatmapEventCallbackWrapper)) ::GlobalNamespace::BeatmapDataCallbackWrapper*  _lightTranslationXBeatmapEventCallbackWrapper;

/// @brief Field _lightTranslationYBeatmapEventCallbackWrapper offset 0x48
 __declspec(property(get=__get__lightTranslationYBeatmapEventCallbackWrapper, put=__set__lightTranslationYBeatmapEventCallbackWrapper)) ::GlobalNamespace::BeatmapDataCallbackWrapper*  _lightTranslationYBeatmapEventCallbackWrapper;

/// @brief Field _lightTranslationZBeatmapEventCallbackWrapper offset 0x50
 __declspec(property(get=__get__lightTranslationZBeatmapEventCallbackWrapper, put=__set__lightTranslationZBeatmapEventCallbackWrapper)) ::GlobalNamespace::BeatmapDataCallbackWrapper*  _lightTranslationZBeatmapEventCallbackWrapper;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::System::ValueTuple_2<::UnityEngine::Transform*,::UnityEngine::Vector3>>*> __get__transformMask() const;

constexpr void __set__xTranslationTween(::Tweening::FloatTween*  value) ;

constexpr ::Tweening::FloatTween* __get__xTranslationTween() ;

constexpr ::cordl_internals::to_const_pointer<::Tweening::FloatTween*> __get__xTranslationTween() const;

constexpr void __set__yTranslationTween(::Tweening::FloatTween*  value) ;

constexpr ::Tweening::FloatTween* __get__yTranslationTween() ;

constexpr ::cordl_internals::to_const_pointer<::Tweening::FloatTween*> __get__yTranslationTween() const;

constexpr void __set__zTranslationTween(::Tweening::FloatTween*  value) ;

constexpr ::Tweening::FloatTween* __get__zTranslationTween() ;

constexpr ::cordl_internals::to_const_pointer<::Tweening::FloatTween*> __get__zTranslationTween() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapDataCallbackWrapper*> __get__lightTranslationXBeatmapEventCallbackWrapper() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapDataCallbackWrapper*> __get__lightTranslationYBeatmapEventCallbackWrapper() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapDataCallbackWrapper*> __get__lightTranslationZBeatmapEventCallbackWrapper() const;
...
// Ctor Parameters []
// @brief default ctor
 LightTranslationGroupEffect()  = default;
public:
