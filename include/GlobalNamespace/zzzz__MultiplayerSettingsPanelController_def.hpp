...
/// @brief Field _spectateSettingsWrapper offset 0x30
...
/// @brief Field _refreshed offset 0x48
 __declspec(property(get=__get__refreshed, put=__set__refreshed)) bool  _refreshed;

/// @brief Field playerActiveStateChangedEvent offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ServerCodeView*> __get__serverCodeView() const;

constexpr void __set__spectateToggle(::UnityEngine::UI::Toggle*  value) ;

constexpr ::UnityEngine::UI::Toggle* __get__spectateToggle() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get__spectateToggle() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__connectionSettingsWrapper() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__spectateSettingsWrapper() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ILobbyPlayerData*> __get__lobbyPlayerData() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<bool>*> __get_playerActiveStateChangedEvent() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerSettingsPanelController()  = default;
public:
