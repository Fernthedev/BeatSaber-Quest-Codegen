...
struct CORDL_TYPE SongPackMask : public ::bs_hook::ValueTypeWrapper<0x20> {
public:
// Declarations
...
/// @brief Field _bloomFilter offset 0x0
 __declspec(property(get=__get__bloomFilter, put=__set__bloomFilter)) ::GlobalNamespace::BitMask256  _bloomFilter;
...
constexpr void __set__bloomFilter(::GlobalNamespace::BitMask256  value) ;

constexpr ::GlobalNamespace::BitMask256& __get__bloomFilter() ;

constexpr ::GlobalNamespace::BitMask256 const& __get__bloomFilter() const;
...
constexpr explicit SongPackMask(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x20>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 SongPackMask()  = default;
