...
// Ctor Parameters []
// @brief default ctor
 __BeatmapEventDataLightsExtensions__LightSwitchEventEffectDataValues()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 BeatmapEventDataLightsExtensions()  = default;
public:
