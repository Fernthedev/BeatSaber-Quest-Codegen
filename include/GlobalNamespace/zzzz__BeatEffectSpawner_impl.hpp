...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BeatEffectSpawner__InitData::*)(bool)>(&::GlobalNamespace::__BeatEffectSpawner__InitData::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatEffectSpawner::*)(::GlobalNamespace::__BeatEffect__Pool*)>(&::GlobalNamespace::BeatEffectSpawner::Init)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "Init",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatEffect__Pool*>::get()}
                        )));
    return ___internal_method;
  }
};
...
::cordl_internals::setInstanceField<::GlobalNamespace::ColorManager*, 0x30>(this, std::forward<::GlobalNamespace::ColorManager*>(value));
}
constexpr ::GlobalNamespace::ColorManager* GlobalNamespace::BeatEffectSpawner::__get__colorManager()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ColorManager*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorManager*> GlobalNamespace::BeatEffectSpawner::__get__colorManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ColorManager*, 0x30>(this);
}
constexpr void GlobalNamespace::BeatEffectSpawner::__set__beatmapObjectManager(::GlobalNamespace::BeatmapObjectManager*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::BeatmapObjectManager*, 0x38>(this, std::forward<::GlobalNamespace::BeatmapObjectManager*>(value));
}
constexpr ::GlobalNamespace::BeatmapObjectManager* GlobalNamespace::BeatEffectSpawner::__get__beatmapObjectManager()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapObjectManager*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapObjectManager*> GlobalNamespace::BeatEffectSpawner::__get__beatmapObjectManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapObjectManager*, 0x38>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::AudioTimeSyncController*, 0x40>(this, std::forward<::GlobalNamespace::AudioTimeSyncController*>(value));
}
constexpr ::GlobalNamespace::AudioTimeSyncController* GlobalNamespace::BeatEffectSpawner::__get__audioTimeSyncController()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::AudioTimeSyncController*, 0x40>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::AudioTimeSyncController*> GlobalNamespace::BeatEffectSpawner::__get__audioTimeSyncController() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::AudioTimeSyncController*, 0x40>(this);
}
constexpr void GlobalNamespace::BeatEffectSpawner::__set__initData(::GlobalNamespace::__BeatEffectSpawner__InitData*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::__BeatEffectSpawner__InitData*, 0x48>(this, std::forward<::GlobalNamespace::__BeatEffectSpawner__InitData*>(value));
}
constexpr ::GlobalNamespace::__BeatEffectSpawner__InitData* GlobalNamespace::BeatEffectSpawner::__get__initData()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::__BeatEffectSpawner__InitData*, 0x48>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__BeatEffectSpawner__InitData*> GlobalNamespace::BeatEffectSpawner::__get__initData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::__BeatEffectSpawner__InitData*, 0x48>(this);
}
constexpr void GlobalNamespace::BeatEffectSpawner::__set__bloomFog(::GlobalNamespace::BloomFogSO*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::BloomFogSO*, 0x50>(this, std::forward<::GlobalNamespace::BloomFogSO*>(value));
}
constexpr ::GlobalNamespace::BloomFogSO* GlobalNamespace::BeatEffectSpawner::__get__bloomFog()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BloomFogSO*, 0x50>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BloomFogSO*> GlobalNamespace::BeatEffectSpawner::__get__bloomFog() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BloomFogSO*, 0x50>(this);
}
constexpr void GlobalNamespace::BeatEffectSpawner::__set__songController(::GlobalNamespace::SongController*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::SongController*, 0x58>(this, std::forward<::GlobalNamespace::SongController*>(value));
}
constexpr ::GlobalNamespace::SongController* GlobalNamespace::BeatEffectSpawner::__get__songController()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SongController*, 0x58>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SongController*> GlobalNamespace::BeatEffectSpawner::__get__songController() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SongController*, 0x58>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::BeatEffect*>*, 0x60>(this, std::forward<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::BeatEffect*>*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::BeatEffect*>*, 0x60>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::BeatEffect*>*> GlobalNamespace::BeatEffectSpawner::__get__beatEffectPoolContainer() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::BeatEffect*>*, 0x60>(this);
}
