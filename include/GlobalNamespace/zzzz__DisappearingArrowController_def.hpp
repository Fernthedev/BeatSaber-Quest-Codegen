...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4742)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4742), inst: 310 }), TypeDefinitionIndex(TypeDefinitionIndex(4744))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x58 - sizeof(::GlobalNamespace::DisappearingArrowControllerBase_1<::GlobalNamespace::GameNoteController*>)]{};
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameNoteController*> __get__gameNoteController() const;
...
// Ctor Parameters []
// @brief default ctor
 DisappearingArrowController()  = default;
public:
