...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator::*)(::GlobalNamespace::__MultiplayerController__State)>(&::GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator::HandleStateChanged)> {
...
::cordl_internals::setInstanceField<::GlobalNamespace::CoreGameHUDController*, 0x68>(this, std::forward<::GlobalNamespace::CoreGameHUDController*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::CoreGameHUDController*, 0x68>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::CoreGameHUDController*> GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator::__get__coreGameHUDController() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::CoreGameHUDController*, 0x68>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::MultiplayerPositionHUDController*, 0x70>(this, std::forward<::GlobalNamespace::MultiplayerPositionHUDController*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::MultiplayerPositionHUDController*, 0x70>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerPositionHUDController*> GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator::__get__multiplayerPositionHUDController() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MultiplayerPositionHUDController*, 0x70>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::IMultiplayerLevelEndActionsPublisher*, 0x78>(this, std::forward<::GlobalNamespace::IMultiplayerLevelEndActionsPublisher*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::IMultiplayerLevelEndActionsPublisher*, 0x78>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IMultiplayerLevelEndActionsPublisher*> GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator::__get__levelEndActionsPublisher() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IMultiplayerLevelEndActionsPublisher*, 0x78>(this);
}
...
::cordl_internals::setInstanceField<::Tweening::FloatTween*, 0x80>(this, std::forward<::Tweening::FloatTween*>(value));
}
constexpr ::Tweening::FloatTween* GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator::__get__fadeOutHUDTween()  {
return ::cordl_internals::getInstanceField<::Tweening::FloatTween*, 0x80>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Tweening::FloatTween*> GlobalNamespace::MultiplayerLocalActivePlayerGameplayAnimator::__get__fadeOutHUDTween() const {
return ::cordl_internals::getInstanceField<::Tweening::FloatTween*, 0x80>(this);
}
