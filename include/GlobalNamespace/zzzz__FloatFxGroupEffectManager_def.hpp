...
/// @brief Method .ctor addr 0x23a6294 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <Start>b__3_0 addr 0x23a629c size 0x20 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __FloatFxGroupEffectManager____c()  = default;
public:
...
/// @brief Field _floatFxGroups offset 0x18
...
/// @brief Field _floatFxGroupEffects offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::FloatFxGroupEffect*>*> __get__floatFxGroupEffects() const;

/// @brief Method Start addr 0x23a5910 size 0x668 virtual false final false
inline void Start() ;

/// @brief Method OnDestroy addr 0x23a5fd0 size 0x148 virtual false final false
inline void OnDestroy() ;

static inline ::GlobalNamespace::FloatFxGroupEffectManager* New_ctor() ;

/// @brief Method .ctor addr 0x23a61b4 size 0x7c virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 FloatFxGroupEffectManager()  = default;
public:
