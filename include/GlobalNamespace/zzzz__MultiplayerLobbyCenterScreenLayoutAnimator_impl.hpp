...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> GlobalNamespace::MultiplayerLobbyCenterScreenLayoutAnimator::__get__nextLevelTransform() const {
return ::cordl_internals::getInstanceField<::UnityEngine::RectTransform*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> GlobalNamespace::MultiplayerLobbyCenterScreenLayoutAnimator::__get__nextLevelBasePosition() const {
return ::cordl_internals::getInstanceField<::UnityEngine::RectTransform*, 0x20>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> GlobalNamespace::MultiplayerLobbyCenterScreenLayoutAnimator::__get__nextLevelCountdownPosition() const {
return ::cordl_internals::getInstanceField<::UnityEngine::RectTransform*, 0x28>(this);
}
...
::cordl_internals::setInstanceField<::Tweening::TimeTweeningManager*, 0x38>(this, std::forward<::Tweening::TimeTweeningManager*>(value));
}
constexpr ::Tweening::TimeTweeningManager* GlobalNamespace::MultiplayerLobbyCenterScreenLayoutAnimator::__get__tweeningManager()  {
return ::cordl_internals::getInstanceField<::Tweening::TimeTweeningManager*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Tweening::TimeTweeningManager*> GlobalNamespace::MultiplayerLobbyCenterScreenLayoutAnimator::__get__tweeningManager() const {
return ::cordl_internals::getInstanceField<::Tweening::TimeTweeningManager*, 0x38>(this);
}
