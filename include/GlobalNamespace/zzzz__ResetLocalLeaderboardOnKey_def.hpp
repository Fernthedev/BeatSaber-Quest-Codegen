...
/// @brief Field _localLeaderboardsModel offset 0x18
...
/// @brief Field _keyCode offset 0x20
...
/// @brief Method Update addr 0x2373554 size 0x40 virtual false final false
inline void Update() ;

static inline ::GlobalNamespace::ResetLocalLeaderboardOnKey* New_ctor() ;

/// @brief Method .ctor addr 0x2373594 size 0x10 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 ResetLocalLeaderboardOnKey()  = default;
public:
