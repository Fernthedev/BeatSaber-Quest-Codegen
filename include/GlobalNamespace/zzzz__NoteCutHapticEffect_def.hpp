...
struct CORDL_TYPE __NoteCutHapticEffect__Type : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____NoteCutHapticEffect__Type_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __NoteCutHapticEffect__Type(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __NoteCutHapticEffect__Type()  = default;
...
/// @brief Field _shortWeakPreset offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::Libraries::HM::HMLib::VR::HapticPresetSO*> __get__normalPreset() const;
...
constexpr ::cordl_internals::to_const_pointer<::Libraries::HM::HMLib::VR::HapticPresetSO*> __get__shortNormalPreset() const;
...
constexpr ::cordl_internals::to_const_pointer<::Libraries::HM::HMLib::VR::HapticPresetSO*> __get__shortWeakPreset() const;
...
constexpr ::cordl_internals::to_const_pointer<::Libraries::HM::HMLib::VR::HapticPresetSO*> __get__bombPreset() const;
...
constexpr ::cordl_internals::to_const_pointer<::Libraries::HM::HMLib::VR::HapticPresetSO*> __get__badCutPreset() const;
...
/// @brief Method HitNote addr 0x239a8cc size 0x88 virtual false final false
...
/// @brief Method .ctor addr 0x239a954 size 0x8 virtual false final false
inline void _ctor() ;
