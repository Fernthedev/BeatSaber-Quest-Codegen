...
struct CORDL_TYPE __GhostDuplicationEffect__GhostEffectParams : public ::bs_hook::ValueTypeWrapper<0x48> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x48};

/// @brief Field startAlpha offset 0x0
 __declspec(property(get=__get_startAlpha, put=__set_startAlpha)) float_t  startAlpha;

/// @brief Field startPosition offset 0x4
 __declspec(property(get=__get_startPosition, put=__set_startPosition)) ::UnityEngine::Vector3  startPosition;

/// @brief Field startSize offset 0x10
 __declspec(property(get=__get_startSize, put=__set_startSize)) float_t  startSize;

/// @brief Field endAlpha offset 0x14
 __declspec(property(get=__get_endAlpha, put=__set_endAlpha)) float_t  endAlpha;

/// @brief Field endPosition offset 0x18
 __declspec(property(get=__get_endPosition, put=__set_endPosition)) ::UnityEngine::Vector3  endPosition;

/// @brief Field endSize offset 0x24
 __declspec(property(get=__get_endSize, put=__set_endSize)) float_t  endSize;

/// @brief Field duration offset 0x28
 __declspec(property(get=__get_duration, put=__set_duration)) float_t  duration;

/// @brief Field delay offset 0x2c
...
/// @brief Field distanceCurve offset 0x38
 __declspec(property(get=__get_distanceCurve, put=__set_distanceCurve)) ::UnityEngine::AnimationCurve*  distanceCurve;

/// @brief Field peakDistance offset 0x40
 __declspec(property(get=__get_peakDistance, put=__set_peakDistance)) float_t  peakDistance;

/// @brief Field lastPhase offset 0x44
 __declspec(property(get=__get_lastPhase, put=__set_lastPhase)) bool  lastPhase;
...
constexpr float_t& __get_startSize() ;

constexpr float_t const& __get_startSize() const;
...
constexpr ::UnityEngine::Vector3& __get_endPosition() ;

constexpr ::UnityEngine::Vector3 const& __get_endPosition() const;

constexpr void __set_endSize(float_t  value) ;

constexpr float_t& __get_endSize() ;

constexpr float_t const& __get_endSize() const;
...
constexpr float_t& __get_peakDistance() ;

constexpr float_t const& __get_peakDistance() const;

constexpr void __set_lastPhase(bool  value) ;

constexpr bool& __get_lastPhase() ;

constexpr bool const& __get_lastPhase() const;
...
constexpr explicit __GhostDuplicationEffect__GhostEffectParams(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x48>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __GhostDuplicationEffect__GhostEffectParams()  = default;
...
/// @brief Field ghostEffectParams offset 0x18
...
/// @brief Field direction offset 0x60
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GhostDuplicationEffect*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __GhostDuplicationEffect____c__DisplayClass7_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __GhostDuplicationEffect___HideRedundantWithDelay_d__8()  = default;
public:
...
/// @brief Field _canvases offset 0x18
...
/// @brief Field isInitialized offset 0x20
...
// Ctor Parameters []
// @brief default ctor
 GhostDuplicationEffect()  = default;
public:
