...
class __ScoringElement__Pool_1<T>;
}
// Write type traits
...
/// @brief Field <noteData>k__BackingField offset 0x10
...
/// @brief Field <multiplier>k__BackingField offset 0x18
...
/// @brief Field <maxMultiplier>k__BackingField offset 0x1c
...
/// @brief Field <isFinished>k__BackingField offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NoteData*> __get__noteData_k__BackingField() const;
...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11038)), TypeDefinitionIndex(TypeDefinitionIndex(5322)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11038), inst: 2757 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5322), inst: 2 })
// CS Name: ::ScoringElement::Pool`1<T>*
class CORDL_TYPE __ScoringElement__Pool_1<T> : public ::Zenject::MemoryPool_1<T> {
public:
// Declarations
/// @brief The size of the true reference type
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::Zenject::MemoryPool_1<T>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __ScoringElement__Pool_1()  = default;
public:
