...
::cordl_internals::setInstanceField<::GlobalNamespace::BloomFogParamsBehaviour*, 0x18>(this, std::forward<::GlobalNamespace::BloomFogParamsBehaviour*>(value));
}
constexpr ::GlobalNamespace::BloomFogParamsBehaviour* GlobalNamespace::BloomFogParamsAsset::__get__template()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BloomFogParamsBehaviour*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BloomFogParamsBehaviour*> GlobalNamespace::BloomFogParamsAsset::__get__template() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BloomFogParamsBehaviour*, 0x18>(this);
}
