...
/// @brief Field _downsampledCubemapRenderTexture offset 0x38
...
/// @brief Field _cubemapFlatTexture offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get__cubemapMaterial() const;

constexpr void __set__flatMaterial(::UnityEngine::Material*  value) ;

constexpr ::UnityEngine::Material* __get__flatMaterial() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get__flatMaterial() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RenderTexture*> __get__cubemapRenderTexture() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RenderTexture*> __get__downsampledCubemapRenderTexture() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RenderTexture*> __get__cubemapFlatTexture() const;
