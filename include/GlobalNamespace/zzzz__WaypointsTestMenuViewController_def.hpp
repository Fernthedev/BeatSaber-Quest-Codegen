...
/// @brief Field levels offset 0x28
...
/// @brief Field <count>5__2 offset 0x30
 __declspec(property(get=__get__count_5__2, put=__set__count_5__2)) int32_t  _count_5__2;

/// @brief Field <difficultiesToCheck>5__3 offset 0x38
 __declspec(property(get=__get__difficultiesToCheck_5__3, put=__set__difficultiesToCheck_5__3)) ::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapDifficulty>*  _difficultiesToCheck_5__3;

/// @brief Field <>7__wrap3 offset 0x40
...
/// @brief Field <characteristic>5__7 offset 0x78
...
/// @brief Field <>7__wrap7 offset 0x80
...
/// @brief Field <difficulty>5__9 offset 0x98
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::WaypointsTestMenuViewController*> __get___4__this() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapLevelSO*>*> __get_levels() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapDifficulty>*> __get__difficultiesToCheck_5__3() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapLevelSO*> __get__level_5__5() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapCharacteristicSO*> __get__characteristic_5__7() const;
...
// Ctor Parameters []
// @brief default ctor
 __WaypointsTestMenuViewController___CheckBeatmaps_d__14()  = default;
public:
...
/// @brief Field _btsButton offset 0x18
 __declspec(property(get=__get__btsButton, put=__set__btsButton)) ::UnityEngine::UI::Button*  _btsButton;

/// @brief Field _cancelButton offset 0x20
 __declspec(property(get=__get__cancelButton, put=__set__cancelButton)) ::UnityEngine::UI::Button*  _cancelButton;

/// @brief Field _progressText offset 0x28
 __declspec(property(get=__get__progressText, put=__set__progressText)) ::TMPro::TextMeshProUGUI*  _progressText;

/// @brief Field _waypointsTestScenesTransitionSetupData offset 0x30
 __declspec(property(get=__get__waypointsTestScenesTransitionSetupData, put=__set__waypointsTestScenesTransitionSetupData)) ::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO*  _waypointsTestScenesTransitionSetupData;

/// @brief Field _levels offset 0x38
...
/// @brief Field _characteristics offset 0x40
...
/// @brief Field _playerDataModel offset 0x50
 __declspec(property(get=__get__playerDataModel, put=__set__playerDataModel)) ::GlobalNamespace::PlayerDataModel*  _playerDataModel;

/// @brief Field _coroutineStarter offset 0x58
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> __get__btsButton() const;
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> __get__progressText() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::StandardLevelScenesTransitionSetupDataSO*> __get__waypointsTestScenesTransitionSetupData() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapLevelSO*>*> __get__levels() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapCharacteristicSO*>*> __get__characteristics() const;
...
// Ctor Parameters []
// @brief default ctor
 WaypointsTestMenuViewController()  = default;
public:
