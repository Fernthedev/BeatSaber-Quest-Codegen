...
/// @brief Field _beatmapCharacteristicName offset 0x10
...
/// @brief Field _difficultyBeatmaps offset 0x18
 __declspec(property(get=__get__difficultyBeatmaps, put=__set__difficultyBeatmaps)) ::ArrayW<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmap*,::Array<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmap*>*>  _difficultyBeatmaps;
...
constexpr void __set__difficultyBeatmaps(::ArrayW<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmap*,::Array<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmap*>*>  value) ;
...
constexpr ::ArrayW<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmap*,::Array<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmap*>*> const& __get__difficultyBeatmaps() const;

/// @brief Method get_beatmapCharacteristicName addr 0x234e2b4 size 0x8 virtual false final false
inline ::StringW get_beatmapCharacteristicName() ;

/// @brief Method get_difficultyBeatmaps addr 0x234e2bc size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x234e288 size 0x2c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __StandardLevelInfoSaveData__DifficultyBeatmapSet()  = default;
public:
...
/// @brief Method get_difficulty addr 0x234e2c4 size 0x8 virtual false final false
inline ::StringW get_difficulty() ;

/// @brief Method get_difficultyRank addr 0x234e2cc size 0x8 virtual false final false
inline int32_t get_difficultyRank() ;

/// @brief Method get_beatmapFilename addr 0x234e2d4 size 0x8 virtual false final false
inline ::StringW get_beatmapFilename() ;

/// @brief Method get_noteJumpMovementSpeed addr 0x234e2dc size 0x8 virtual false final false
inline float_t get_noteJumpMovementSpeed() ;

/// @brief Method get_noteJumpStartBeatOffset addr 0x234e2e4 size 0x8 virtual false final false
inline float_t get_noteJumpStartBeatOffset() ;

/// @brief Method get_beatmapColorSchemeIdx addr 0x234e2ec size 0x8 virtual false final false
inline int32_t get_beatmapColorSchemeIdx() ;

/// @brief Method get_environmentNameIdx addr 0x234e2f4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x234e220 size 0x68 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __StandardLevelInfoSaveData__DifficultyBeatmap()  = default;
public:
...
/// @brief Method get_version addr 0x234e2fc size 0x8 virtual false final false
inline ::StringW get_version() ;

static inline ::GlobalNamespace::__StandardLevelInfoSaveData__VersionCheck* New_ctor() ;

/// @brief Method .ctor addr 0x234e304 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __StandardLevelInfoSaveData__VersionCheck()  = default;
public:
...
/// @brief Field _environmentNames offset 0x70
...
/// @brief Field _colorSchemes offset 0x78
 __declspec(property(get=__get__colorSchemes, put=__set__colorSchemes)) ::ArrayW<::GlobalNamespace::BeatmapLevelColorSchemeSaveData*,::Array<::GlobalNamespace::BeatmapLevelColorSchemeSaveData*>*>  _colorSchemes;

/// @brief Field _difficultyBeatmapSets offset 0x80
 __declspec(property(get=__get__difficultyBeatmapSets, put=__set__difficultyBeatmapSets)) ::ArrayW<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmapSet*,::Array<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmapSet*>*>  _difficultyBeatmapSets;
...
constexpr void __set__difficultyBeatmapSets(::ArrayW<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmapSet*,::Array<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmapSet*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmapSet*,::Array<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmapSet*>*>& __get__difficultyBeatmapSets() ;

constexpr ::ArrayW<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmapSet*,::Array<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmapSet*>*> const& __get__difficultyBeatmapSets() const;

/// @brief Method get_version addr 0x234da9c size 0x8 virtual false final false
inline ::StringW get_version() ;

/// @brief Method get_songName addr 0x234daa4 size 0x8 virtual false final false
inline ::StringW get_songName() ;

/// @brief Method get_songSubName addr 0x234daac size 0x8 virtual false final false
inline ::StringW get_songSubName() ;

/// @brief Method get_songAuthorName addr 0x234dab4 size 0x8 virtual false final false
inline ::StringW get_songAuthorName() ;

/// @brief Method get_levelAuthorName addr 0x234dabc size 0x8 virtual false final false
inline ::StringW get_levelAuthorName() ;

/// @brief Method get_beatsPerMinute addr 0x234dac4 size 0x8 virtual false final false
inline float_t get_beatsPerMinute() ;

/// @brief Method get_songTimeOffset addr 0x234dacc size 0x8 virtual false final false
inline float_t get_songTimeOffset() ;

/// @brief Method get_shuffle addr 0x234dad4 size 0x8 virtual false final false
inline float_t get_shuffle() ;

/// @brief Method get_shufflePeriod addr 0x234dadc size 0x8 virtual false final false
inline float_t get_shufflePeriod() ;

/// @brief Method get_previewStartTime addr 0x234dae4 size 0x8 virtual false final false
inline float_t get_previewStartTime() ;

/// @brief Method get_previewDuration addr 0x234daec size 0x8 virtual false final false
inline float_t get_previewDuration() ;

/// @brief Method get_songFilename addr 0x234daf4 size 0x8 virtual false final false
inline ::StringW get_songFilename() ;

/// @brief Method get_coverImageFilename addr 0x234dafc size 0x8 virtual false final false
inline ::StringW get_coverImageFilename() ;

/// @brief Method get_environmentName addr 0x234db04 size 0x8 virtual false final false
inline ::StringW get_environmentName() ;

/// @brief Method get_allDirectionsEnvironmentName addr 0x234db0c size 0x8 virtual false final false
inline ::StringW get_allDirectionsEnvironmentName() ;

/// @brief Method get_environmentNames addr 0x234db14 size 0x8 virtual false final false
inline ::ArrayW<::StringW,::Array<::StringW>*> get_environmentNames() ;

/// @brief Method get_colorSchemes addr 0x234db1c size 0x8 virtual false final false
...
/// @brief Method get_difficultyBeatmapSets addr 0x234db24 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x234db2c size 0xf8 virtual false final false
inline void _ctor(::StringW  songName, ::StringW  songSubName, ::StringW  songAuthorName, ::StringW  levelAuthorName, float_t  beatsPerMinute, float_t  songTimeOffset, float_t  shuffle, float_t  shufflePeriod, float_t  previewStartTime, float_t  previewDuration, ::StringW  songFilename, ::StringW  coverImageFilename, ::StringW  environmentName, ::StringW  allDirectionsEnvironmentName, ::ArrayW<::StringW,::Array<::StringW>*>  environmentNames, ::ArrayW<::GlobalNamespace::BeatmapLevelColorSchemeSaveData*,::Array<::GlobalNamespace::BeatmapLevelColorSchemeSaveData*>*>  colorSchemes, ::ArrayW<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmapSet*,::Array<::GlobalNamespace::__StandardLevelInfoSaveData__DifficultyBeatmapSet*>*>  difficultyBeatmapSets) ;

/// @brief Method get_hasAllData addr 0x234dc24 size 0x5c virtual false final false
inline bool get_hasAllData() ;

/// @brief Method SetSongFilename addr 0x234dc80 size 0x8 virtual false final false
inline void SetSongFilename(::StringW  songFilename) ;

/// @brief Method SerializeToJSONString addr 0x234dc88 size 0x8 virtual false final false
inline ::StringW SerializeToJSONString() ;

/// @brief Method DeserializeFromJSONString addr 0x234dc90 size 0x590 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 StandardLevelInfoSaveData()  = default;
public:
