...
struct CORDL_TYPE __PlatformLeaderboardsModel__State : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____PlatformLeaderboardsModel__State_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __PlatformLeaderboardsModel__State(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __PlatformLeaderboardsModel__State()  = default;
...
struct CORDL_TYPE __PlatformLeaderboardsModel__GetScoresResult : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____PlatformLeaderboardsModel__GetScoresResult_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __PlatformLeaderboardsModel__GetScoresResult(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __PlatformLeaderboardsModel__GetScoresResult()  = default;
...
struct CORDL_TYPE __PlatformLeaderboardsModel__UploadScoreResult : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____PlatformLeaderboardsModel__UploadScoreResult_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __PlatformLeaderboardsModel__UploadScoreResult(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __PlatformLeaderboardsModel__UploadScoreResult()  = default;
...
struct CORDL_TYPE __PlatformLeaderboardsModel__ScoresScope : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____PlatformLeaderboardsModel__ScoresScope_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __PlatformLeaderboardsModel__ScoresScope(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __PlatformLeaderboardsModel__ScoresScope()  = default;
...
static inline ::GlobalNamespace::__PlatformLeaderboardsModel__GetScoresCompletionHandler* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method .ctor addr 0x232b898 size 0xc4 virtual false final false
inline void _ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method Invoke addr 0x232b95c size 0x14 virtual true final false
...
/// @brief Method BeginInvoke addr 0x232b970 size 0xb8 virtual true final false
...
/// @brief Method EndInvoke addr 0x232ba28 size 0xc virtual true final false
...
// Ctor Parameters []
// @brief default ctor
 __PlatformLeaderboardsModel__GetScoresCompletionHandler()  = default;
public:
...
static inline ::GlobalNamespace::__PlatformLeaderboardsModel__UploadScoreCompletionHandler* New_ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method .ctor addr 0x232893c size 0xc4 virtual false final false
inline void _ctor(::System::Object*  object, ::cordl_internals::intptr_t  method) ;

/// @brief Method Invoke addr 0x232ba34 size 0x14 virtual true final false
inline void Invoke(::GlobalNamespace::__PlatformLeaderboardsModel__UploadScoreResult  result) ;

/// @brief Method BeginInvoke addr 0x232ba48 size 0x84 virtual true final false
...
/// @brief Method EndInvoke addr 0x232bacc size 0xc virtual true final false
inline void EndInvoke(::System::IAsyncResult*  result) ;
...
// Ctor Parameters []
// @brief default ctor
 __PlatformLeaderboardsModel__UploadScoreCompletionHandler()  = default;
public:
...
/// @brief Field playerId offset 0x20
...
static inline ::GlobalNamespace::__PlatformLeaderboardsModel__LeaderboardScore* New_ctor(int32_t  score, int32_t  rank, ::StringW  playerName, ::StringW  playerId, ::System::Collections::Generic::List_1<::GlobalNamespace::GameplayModifierParamsSO*>*  gameplayModifiers) ;

/// @brief Method .ctor addr 0x232aedc size 0x40 virtual false final false
...
/// @brief Method CompareTo addr 0x232bad8 size 0x2c virtual true final true
...
// Ctor Parameters []
// @brief default ctor
 __PlatformLeaderboardsModel__LeaderboardScore()  = default;
public:
...
struct CORDL_TYPE __PlatformLeaderboardsModel___Initialize_d__19 : public ::bs_hook::ValueTypeWrapper<0x38> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field <>4__this offset 0x28
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::GlobalNamespace::PlatformLeaderboardsModel*  __4__this;
...
constexpr ::GlobalNamespace::PlatformLeaderboardsModel* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlatformLeaderboardsModel*> __get___4__this() const;
...
/// @brief Method MoveNext addr 0x232bb04 size 0x364 virtual true final true
inline void MoveNext() ;

/// @brief Method SetStateMachine addr 0x232be68 size 0xc virtual true final true
...
constexpr __PlatformLeaderboardsModel___Initialize_d__19(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::GlobalNamespace::PlatformLeaderboardsModel*  __4__this, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::UserInfo*>  __u__1) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __PlatformLeaderboardsModel___Initialize_d__19(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x38>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __PlatformLeaderboardsModel___Initialize_d__19()  = default;
...
/// @brief Field _leaderboardScoreUploader offset 0x20
...
/// @brief Field _platformUserModel offset 0x28
...
/// @brief Field _platformLeaderboardsHandler offset 0x30
...
/// @brief Field allScoresDidUploadEvent offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlatformLeaderboardsHandler*> __get__platformLeaderboardsHandler() const;

constexpr void __set_allScoresDidUploadEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_allScoresDidUploadEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_allScoresDidUploadEvent() const;
...
/// @brief Method add_allScoresDidUploadEvent addr 0x232b074 size 0x9c virtual false final false
inline void add_allScoresDidUploadEvent(::System::Action*  value) ;

/// @brief Method remove_allScoresDidUploadEvent addr 0x232b110 size 0x9c virtual false final false
inline void remove_allScoresDidUploadEvent(::System::Action*  value) ;

/// @brief Method get_initialized addr 0x232b1ac size 0x28 virtual false final false
inline bool get_initialized() ;

/// @brief Method OnDestroy addr 0x232b268 size 0x1ac virtual false final false
inline void OnDestroy() ;

/// @brief Method Initialize addr 0x232b1d4 size 0x94 virtual false final false
inline void Initialize() ;

/// @brief Method InitializeForUserInfo addr 0x232b414 size 0x19c virtual false final false
inline void InitializeForUserInfo(::GlobalNamespace::UserInfo*  newInfo) ;

/// @brief Method HandlePlatformUserInfoDidChange addr 0x232b5b0 size 0x4 virtual false final false
inline void HandlePlatformUserInfoDidChange(::GlobalNamespace::UserInfo*  newInfo) ;

/// @brief Method UploadScore addr 0x232b5b4 size 0x80 virtual false final false
...
/// @brief Method GetScores addr 0x232b634 size 0xbc virtual false final false
inline ::GlobalNamespace::HMAsyncRequest* GetScores(::GlobalNamespace::IDifficultyBeatmap*  beatmap, int32_t  count, int32_t  fromRank, ::GlobalNamespace::__PlatformLeaderboardsModel__ScoresScope  scope, ::GlobalNamespace::__PlatformLeaderboardsModel__GetScoresCompletionHandler*  completionHandler) ;

/// @brief Method HandleAllScoresDidUpload addr 0x232b6f0 size 0x1c virtual false final false
inline void HandleAllScoresDidUpload() ;

/// @brief Method GetScores addr 0x232b70c size 0xc virtual false final false
inline ::GlobalNamespace::HMAsyncRequest* GetScores(::GlobalNamespace::IDifficultyBeatmap*  beatmap, int32_t  count, int32_t  fromRank, ::GlobalNamespace::__PlatformLeaderboardsModel__GetScoresCompletionHandler*  completionHandler) ;

/// @brief Method GetScoresAroundPlayer addr 0x232b718 size 0x10 virtual false final false
inline ::GlobalNamespace::HMAsyncRequest* GetScoresAroundPlayer(::GlobalNamespace::IDifficultyBeatmap*  beatmap, int32_t  count, ::GlobalNamespace::__PlatformLeaderboardsModel__GetScoresCompletionHandler*  completionHandler) ;

/// @brief Method GetFriendsScores addr 0x232b728 size 0xc virtual false final false
inline ::GlobalNamespace::HMAsyncRequest* GetFriendsScores(::GlobalNamespace::IDifficultyBeatmap*  beatmap, int32_t  count, int32_t  fromRank, ::GlobalNamespace::__PlatformLeaderboardsModel__GetScoresCompletionHandler*  completionHandler) ;

/// @brief Method UploadScore addr 0x232b734 size 0x15c virtual false final false
...
/// @brief Method .ctor addr 0x232b890 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 PlatformLeaderboardsModel()  = default;
public:
