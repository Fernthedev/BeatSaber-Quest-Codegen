...
/// @brief Field _energyCounter offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameEnergyCounter*> __get__energyCounter() const;
...
// Ctor Parameters []
// @brief default ctor
 EnergyMissionObjectiveChecker()  = default;
public:
