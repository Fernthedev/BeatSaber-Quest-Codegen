...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14741), inst: 936 }), TypeDefinitionIndex(TypeDefinitionIndex(14741)), TypeDefinitionIndex(TypeDefinitionIndex(14737))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x10 - sizeof(::GlobalNamespace::BeatmapEventDataProcessor_1<::GlobalNamespace::LightTranslationBeatmapEventData*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 LightTranslationBeatmapEventDataProcessor()  = default;
public:
