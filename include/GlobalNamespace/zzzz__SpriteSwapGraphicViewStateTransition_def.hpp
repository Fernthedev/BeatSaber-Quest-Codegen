...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5442)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5442), inst: 924 }), TypeDefinitionIndex(TypeDefinitionIndex(13055))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::GlobalNamespace::BaseStateTransition_1<::UnityEngine::UI::Image*>)]{};
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SpriteSwapTransitionSO*> __get__transition() const;
...
// Ctor Parameters []
// @brief default ctor
 SpriteSwapGraphicViewStateTransition()  = default;
public:
