...
// Ctor Parameters []
// @brief default ctor
 __SonyLevelProductModelSO__LevelProductData()  = default;
public:
...
/// @brief Field _levelProductsData offset 0x28
 __declspec(property(get=__get__levelProductsData, put=__set__levelProductsData)) ::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData*>*>  _levelProductsData;

/// @brief Field _packIndex offset 0x30
 ...
 __declspec(property(get=get_levelProductsData)) ::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData*>*>  levelProductsData;
...
constexpr ::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData*>*> const& __get__levelProductsData() const;
...
static inline ::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData* New_ctor(::StringW  productLabel, ::StringW  levelPackId, float_t  packLevelPriceDiscountMul, ::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData*>*>  levelProductsData, int32_t  packIndex) ;

/// @brief Method .ctor addr 0x2369b08 size 0x98 virtual false final false
inline void _ctor(::StringW  productLabel, ::StringW  levelPackId, float_t  packLevelPriceDiscountMul, ::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelProductData*>*>  levelProductsData, int32_t  packIndex) ;
...
// Ctor Parameters []
// @brief default ctor
 __SonyLevelProductModelSO__LevelPackProductData()  = default;
public:
...
/// @brief Field _redirectedProductLabel offset 0x20
...
// Ctor Parameters []
// @brief default ctor
 __SonyLevelProductModelSO__LevelPackRedirectionData()  = default;
public:
...
/// @brief Field _levelPackProductsData offset 0x18
 __declspec(property(get=__get__levelPackProductsData, put=__set__levelPackProductsData)) ::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData*>*>  _levelPackProductsData;

/// @brief Field _levelPackRedirectionData offset 0x20
 __declspec(property(get=__get__levelPackRedirectionData, put=__set__levelPackRedirectionData)) ::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData*>*>  _levelPackRedirectionData;

 __declspec(property(get=get_levelPackProductsData)) ::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData*>*>  levelPackProductsData;

 __declspec(property(get=get_levelPackRedirectionData)) ::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData*>*>  levelPackRedirectionData;

constexpr void __set__levelPackProductsData(::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData*>*>& __get__levelPackProductsData() ;

constexpr ::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackProductData*>*> const& __get__levelPackProductsData() const;

constexpr void __set__levelPackRedirectionData(::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData*>*>& __get__levelPackRedirectionData() ;

constexpr ::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData*>*> const& __get__levelPackRedirectionData() const;
...
inline ::ArrayW<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData*,::Array<::GlobalNamespace::__SonyLevelProductModelSO__LevelPackRedirectionData*>*> get_levelPackRedirectionData() ;
...
// Ctor Parameters []
// @brief default ctor
 SonyLevelProductModelSO()  = default;
public:
