...
class RemoteProcedureCall_3<T0,T1,int64_t>;
}
// Write type traits
...
template<::il2cpp_utils::il2cpp_reference_type T0,::il2cpp_utils::il2cpp_reference_type T1>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12936)), TypeDefinitionIndex(TypeDefinitionIndex(12939))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12939), inst: 7776 })
// CS Name: ::RemoteProcedureCall`3<T0,T1,T2>*
class CORDL_TYPE RemoteProcedureCall_3<T0,T1,int64_t> : public ::GlobalNamespace::RemoteProcedureCall {
public:
// Declarations
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::GlobalNamespace::RemoteProcedureCall)]{};
...
/// @brief Field _value2 offset 0x28
 __declspec(property(get=__get__value2, put=__set__value2)) ::GlobalNamespace::__RemoteProcedureCall__TypeWrapper_1<int64_t>*  _value2;

 __declspec(property(get=get_value0)) T0  value0;

 __declspec(property(get=get_value1)) T1  value1;

 __declspec(property(get=get_value2)) int64_t  value2;
...
constexpr void __set__value2(::GlobalNamespace::__RemoteProcedureCall__TypeWrapper_1<int64_t>*  value) ;

constexpr ::GlobalNamespace::__RemoteProcedureCall__TypeWrapper_1<int64_t>* __get__value2() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__RemoteProcedureCall__TypeWrapper_1<int64_t>*> __get__value2() const;
...
inline ::GlobalNamespace::IRemoteProcedureCall* Init(int64_t  syncTime, T0  value0, T1  value1, int64_t  value2) ;

/// @brief Method Release addr 0x0 size 0xffffffffffffffff virtual true final false
inline void Release() ;

static inline ::GlobalNamespace::RemoteProcedureCall_3<T0,T1,int64_t>* New_ctor() ;
...
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12936)), TypeDefinitionIndex(TypeDefinitionIndex(12939))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12939), inst: 5330 })
// CS Name: ::RemoteProcedureCall`3<T0,T1,T2>*
