...
::cordl_internals::setInstanceField<::GlobalNamespace::BeatmapSelectionView*, 0x70>(this, std::forward<::GlobalNamespace::BeatmapSelectionView*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapSelectionView*, 0x70>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapSelectionView*> GlobalNamespace::CenterStageLobbyViewController::__get__beatmapSelectionView() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapSelectionView*, 0x70>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::ModifiersSelectionView*, 0x78>(this, std::forward<::GlobalNamespace::ModifiersSelectionView*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::ModifiersSelectionView*, 0x78>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ModifiersSelectionView*> GlobalNamespace::CenterStageLobbyViewController::__get__modifiersSelectionView() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ModifiersSelectionView*, 0x78>(this);
}
