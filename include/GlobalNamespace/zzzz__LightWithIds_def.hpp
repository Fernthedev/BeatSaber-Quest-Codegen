...
/// @brief Field _color offset 0x14
 __declspec(property(get=__get__color, put=__set__color)) ::UnityEngine::Color  _color;

/// @brief Field _isRegistered offset 0x24
 __declspec(property(get=__get__isRegistered, put=__set__isRegistered)) bool  _isRegistered;

/// @brief Field _parentLightWithIds offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LightWithIds*> __get__parentLightWithIds() const;
...
// Ctor Parameters []
// @brief default ctor
 __LightWithIds__LightWithId()  = default;
public:
...
/// @brief Field _childrenColorWasSet offset 0x29
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IEnumerable_1<::GlobalNamespace::__LightWithIds__LightWithId*>*> __get__lightWithIds() const;
