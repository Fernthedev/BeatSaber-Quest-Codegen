...
struct CORDL_TYPE __BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0 : public ::bs_hook::ValueTypeWrapper<0x4> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x4};

/// @brief Field numberOfElements offset 0x0
 __declspec(property(get=__get_numberOfElements, put=__set_numberOfElements)) int32_t  numberOfElements;

constexpr void __set_numberOfElements(int32_t  value) ;

constexpr int32_t& __get_numberOfElements() ;

constexpr int32_t const& __get_numberOfElements() const;
...
constexpr explicit __BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0()  = default;
...
static inline ::GlobalNamespace::BeatmapEventDataBoxGroup* CreateSingleLightBeatmapEventDataBoxGroup(float_t  beat, int32_t  numberOfElements, ::GlobalNamespace::__DefaultEnvironmentEvents__LightGroupEvent*  lightGroupEvent) ;
...
static inline ::GlobalNamespace::IndexFilter* _CreateSingleLightBeatmapEventDataBoxGroup_g__CreateIndexFilter_2_0(::GlobalNamespace::__DefaultEnvironmentEvents__LightGroupFiltering*  filtering, ByRef<::GlobalNamespace::__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0>  _cordl_fixed_empty_name_whitespace) ;
...
// Ctor Parameters []
// @brief default ctor
 BeatmapEventDataBoxGroupFactory()  = default;
public:
