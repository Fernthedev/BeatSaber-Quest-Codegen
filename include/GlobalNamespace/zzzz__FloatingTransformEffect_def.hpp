...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__rotationTransform() const;
...
// Ctor Parameters []
// @brief default ctor
 FloatingTransformEffect()  = default;
public:
