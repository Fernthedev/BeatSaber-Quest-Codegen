...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::Transform*>*> __get_TransformUpdated() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_CameraUpdated() const;

constexpr void __set_PreCharacterMove(::System::Action*  value) ;

constexpr ::System::Action* __get_PreCharacterMove() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_PreCharacterMove() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::CharacterController*> __get_Controller() const;
