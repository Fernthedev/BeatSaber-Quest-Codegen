...
struct CORDL_TYPE OVRBounded3D : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
...
/// @brief Method IOVRAnchorComponent<OVRBounded3D>.get_Type addr 0x2713c24 size 0x8 virtual true final true
inline ::GlobalNamespace::__OVRPlugin__SpaceComponentType IOVRAnchorComponent_OVRBounded3D__get_Type() ;

/// @brief Method IOVRAnchorComponent<OVRBounded3D>.get_Handle addr 0x2713c34 size 0x8 virtual true final true
inline uint64_t IOVRAnchorComponent_OVRBounded3D__get_Handle() ;

/// @brief Method IOVRAnchorComponent<OVRBounded3D>.FromAnchor addr 0x2713c3c size 0x8 virtual true final true
inline ::GlobalNamespace::OVRBounded3D IOVRAnchorComponent_OVRBounded3D__FromAnchor(::GlobalNamespace::OVRAnchor  anchor) ;

/// @brief Method get_IsNull addr 0x2713c50 size 0x10 virtual true final true
inline bool get_IsNull() ;

/// @brief Method get_IsEnabled addr 0x2713c60 size 0xa8 virtual true final true
inline bool get_IsEnabled() ;

/// @brief Method IOVRAnchorComponent<OVRBounded3D>.SetEnabledAsync addr 0x2713d08 size 0x50 virtual true final true
inline ::GlobalNamespace::OVRTask_1<bool> IOVRAnchorComponent_OVRBounded3D__SetEnabledAsync(bool  enabled, double_t  timeout) ;

/// @brief Method Equals addr 0x2713d58 size 0x10 virtual true final true
inline bool Equals(::GlobalNamespace::OVRBounded3D  other) ;

/// @brief Method op_Equality addr 0x2713d68 size 0xc virtual false final false
static inline bool op_Equality(::GlobalNamespace::OVRBounded3D  lhs, ::GlobalNamespace::OVRBounded3D  rhs) ;

/// @brief Method op_Inequality addr 0x2713d74 size 0xc virtual false final false
static inline bool op_Inequality(::GlobalNamespace::OVRBounded3D  lhs, ::GlobalNamespace::OVRBounded3D  rhs) ;

/// @brief Method Equals addr 0x2713d80 size 0x78 virtual true final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode addr 0x2713df8 size 0x4c virtual true final false
inline int32_t GetHashCode() ;

/// @brief Method ToString addr 0x2713e44 size 0x84 virtual true final false
inline ::StringW ToString() ;

/// @brief Method get_Type addr 0x2713c2c size 0x8 virtual false final false
inline ::GlobalNamespace::__OVRPlugin__SpaceComponentType get_Type() ;

/// @brief Method get_Handle addr 0x2713ec8 size 0x8 virtual false final false
inline uint64_t get_Handle() ;

/// @brief Method .ctor addr 0x2713c44 size 0xc virtual false final false
inline void _ctor(::GlobalNamespace::OVRAnchor  anchor) ;

/// @brief Method get_BoundingBox addr 0x2713ed0 size 0xfc virtual false final false
inline ::UnityEngine::Bounds get_BoundingBox() ;

/// @brief Method ConvertBounds addr 0x2713fcc size 0x44 virtual false final false
...
constexpr explicit OVRBounded3D(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 OVRBounded3D()  = default;
