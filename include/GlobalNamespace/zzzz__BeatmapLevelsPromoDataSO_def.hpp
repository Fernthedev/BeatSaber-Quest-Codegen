...
// Ctor Parameters []
// @brief default ctor
 __BeatmapLevelsPromoDataSO____c()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x58 - sizeof(::UnityEngine::ScriptableObject)]{};

/// @brief Field _promotedBeatmapLevelPacks offset 0x18
 __declspec(property(get=__get__promotedBeatmapLevelPacks, put=__set__promotedBeatmapLevelPacks)) ::System::Collections::Generic::List_1<::GlobalNamespace::PreviewBeatmapLevelPackSO*>*  _promotedBeatmapLevelPacks;

/// @brief Field _updatedBeatmapLevelPacks offset 0x20
 __declspec(property(get=__get__updatedBeatmapLevelPacks, put=__set__updatedBeatmapLevelPacks)) ::System::Collections::Generic::List_1<::GlobalNamespace::PreviewBeatmapLevelPackSO*>*  _updatedBeatmapLevelPacks;

/// @brief Field _promotedBeatmapLevels offset 0x28
...
/// @brief Field _updatedBeatmapLevels offset 0x30
...
/// @brief Field _promotedBeatmapLevelPacksSet offset 0x38
...
/// @brief Field _updatedBeatmapLevelPacksSet offset 0x40
...
/// @brief Field _promotedBeatmapLevelsSet offset 0x48
...
/// @brief Field _updatedBeatmapLevelsSet offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::PreviewBeatmapLevelPackSO*>*> __get__promotedBeatmapLevelPacks() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::PreviewBeatmapLevelPackSO*>*> __get__updatedBeatmapLevelPacks() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::PreviewBeatmapLevelSO*>*> __get__promotedBeatmapLevels() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::PreviewBeatmapLevelSO*>*> __get__updatedBeatmapLevels() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::StringW>*> __get__promotedBeatmapLevelPacksSet() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::StringW>*> __get__updatedBeatmapLevelPacksSet() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::StringW>*> __get__promotedBeatmapLevelsSet() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::StringW>*> __get__updatedBeatmapLevelsSet() const;
...
// Ctor Parameters []
// @brief default ctor
 BeatmapLevelsPromoDataSO()  = default;
public:
