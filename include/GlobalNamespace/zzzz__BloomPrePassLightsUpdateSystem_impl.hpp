...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BloomPrePassLightsUpdateSystem::*)()>(&::GlobalNamespace::BloomPrePassLightsUpdateSystem::LateUpdate)> {
  ...
  constexpr static std::size_t addrs = 0x2106e78;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BloomPrePassLightsUpdateSystem::*)()>(&::GlobalNamespace::BloomPrePassLightsUpdateSystem::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x2107168;
...
return THROW_UNLESS(::il2cpp_utils::New<::GlobalNamespace::BloomPrePassLightsUpdateSystem*>());
}
