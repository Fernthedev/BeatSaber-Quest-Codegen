...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SimpleLevelStarter::*)()>(&::GlobalNamespace::SimpleLevelStarter::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::SimpleLevelStarter::*)(::Zenject::DiContainer*)>(&::GlobalNamespace::SimpleLevelStarter::_StartLevel_g__AfterSceneSwitchCallback_16_0)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::SimpleLevelStarter*>::get(),
                            "<StartLevel>g__AfterSceneSwitchCallback|16_0",
                            std::vector<Il2CppClass*>{},
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapLevelSO*> GlobalNamespace::SimpleLevelStarter::__get__level() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapLevelSO*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapCharacteristicSO*> GlobalNamespace::SimpleLevelStarter::__get__beatmapCharacteristic() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapCharacteristicSO*, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::UnityEngine::TextAsset*, 0x30>(this, std::forward<::UnityEngine::TextAsset*>(value));
}
constexpr ::UnityEngine::TextAsset* GlobalNamespace::SimpleLevelStarter::__get__recordingTextAsset()  {
return ::cordl_internals::getInstanceField<::UnityEngine::TextAsset*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TextAsset*> GlobalNamespace::SimpleLevelStarter::__get__recordingTextAsset() const {
return ::cordl_internals::getInstanceField<::UnityEngine::TextAsset*, 0x30>(this);
}
...
::cordl_internals::setInstanceField<::ArrayW<::UnityEngine::Component*,::Array<::UnityEngine::Component*>*>, 0x38>(this, std::forward<::ArrayW<::UnityEngine::Component*,::Array<::UnityEngine::Component*>*>>(value));
}
...
return ::cordl_internals::getInstanceField<::ArrayW<::UnityEngine::Component*,::Array<::UnityEngine::Component*>*>, 0x38>(this);
}
...
::cordl_internals::setInstanceField<::UnityEngine::UI::Button*, 0x48>(this, std::forward<::UnityEngine::UI::Button*>(value));
}
constexpr ::UnityEngine::UI::Button* GlobalNamespace::SimpleLevelStarter::__get__button()  {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Button*, 0x48>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> GlobalNamespace::SimpleLevelStarter::__get__button() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Button*, 0x48>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::MenuTransitionsHelper*, 0x50>(this, std::forward<::GlobalNamespace::MenuTransitionsHelper*>(value));
}
constexpr ::GlobalNamespace::MenuTransitionsHelper* GlobalNamespace::SimpleLevelStarter::__get__menuTransitionsHelper()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MenuTransitionsHelper*, 0x50>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MenuTransitionsHelper*> GlobalNamespace::SimpleLevelStarter::__get__menuTransitionsHelper() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MenuTransitionsHelper*, 0x50>(this);
}
constexpr void GlobalNamespace::SimpleLevelStarter::__set__gameScenesManager(::GlobalNamespace::GameScenesManager*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::GameScenesManager*, 0x58>(this, std::forward<::GlobalNamespace::GameScenesManager*>(value));
}
constexpr ::GlobalNamespace::GameScenesManager* GlobalNamespace::SimpleLevelStarter::__get__gameScenesManager()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameScenesManager*, 0x58>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameScenesManager*> GlobalNamespace::SimpleLevelStarter::__get__gameScenesManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameScenesManager*, 0x58>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlayerDataModel*> GlobalNamespace::SimpleLevelStarter::__get__playerDataModel() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::PlayerDataModel*, 0x60>(this);
}
constexpr void GlobalNamespace::SimpleLevelStarter::__set__buttonBinder(::HMUI::ButtonBinder*  value)  {
::cordl_internals::setInstanceField<::HMUI::ButtonBinder*, 0x68>(this, std::forward<::HMUI::ButtonBinder*>(value));
}
constexpr ::HMUI::ButtonBinder* GlobalNamespace::SimpleLevelStarter::__get__buttonBinder()  {
return ::cordl_internals::getInstanceField<::HMUI::ButtonBinder*, 0x68>(this);
}
constexpr ::cordl_internals::to_const_pointer<::HMUI::ButtonBinder*> GlobalNamespace::SimpleLevelStarter::__get__buttonBinder() const {
return ::cordl_internals::getInstanceField<::HMUI::ButtonBinder*, 0x68>(this);
}
constexpr void GlobalNamespace::SimpleLevelStarter::__set__gameplayModifiers(::GlobalNamespace::GameplayModifiers*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::GameplayModifiers*, 0x70>(this, std::forward<::GlobalNamespace::GameplayModifiers*>(value));
}
constexpr ::GlobalNamespace::GameplayModifiers* GlobalNamespace::SimpleLevelStarter::__get__gameplayModifiers()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayModifiers*, 0x70>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameplayModifiers*> GlobalNamespace::SimpleLevelStarter::__get__gameplayModifiers() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayModifiers*, 0x70>(this);
}
