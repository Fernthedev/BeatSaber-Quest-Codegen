...
/// @brief Field _burstSliderHeadNotesDebrisPool offset 0x30
...
/// @brief Field _burstSliderElementNotesDebrisPool offset 0x38
...
/// @brief Field _poolForNoteGameplayType offset 0x40
 __declspec(property(get=__get__poolForNoteGameplayType, put=__set__poolForNoteGameplayType)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__NoteData__GameplayType,::GlobalNamespace::__NoteDebris__Pool*>*  _poolForNoteGameplayType;

/// @brief Field _poolForNoteDebris offset 0x48
 __declspec(property(get=__get__poolForNoteDebris, put=__set__poolForNoteDebris)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::NoteDebris*,::GlobalNamespace::__NoteDebris__Pool*>*  _poolForNoteDebris;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__NoteDebris__Pool*> __get__normalNotesDebrisPool() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__NoteDebris__Pool*> __get__burstSliderHeadNotesDebrisPool() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__NoteDebris__Pool*> __get__burstSliderElementNotesDebrisPool() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__NoteData__GameplayType,::GlobalNamespace::__NoteDebris__Pool*>*> __get__poolForNoteGameplayType() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::NoteDebris*,::GlobalNamespace::__NoteDebris__Pool*>*> __get__poolForNoteDebris() const;
