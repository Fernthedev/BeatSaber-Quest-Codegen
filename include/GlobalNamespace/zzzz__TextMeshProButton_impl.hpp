...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> GlobalNamespace::TextMeshProButton::__get__text() const {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> GlobalNamespace::TextMeshProButton::__get__button() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Button*, 0x20>(this);
}
