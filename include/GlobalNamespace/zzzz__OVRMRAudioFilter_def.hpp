...
/// @brief Field composition offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRExternalComposition*> __get_composition() const;
