...
/// @brief Field _audioPitchGainEffect2 offset 0x38
...
/// @brief Field _inactivePitchGainEffect offset 0x70
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AudioSource*> __get__audioSource1() const;

constexpr void __set__audioSource2(::UnityEngine::AudioSource*  value) ;

constexpr ::UnityEngine::AudioSource* __get__audioSource2() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AudioSource*> __get__audioSource2() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::AudioPitchGainEffect*> __get__audioPitchGainEffect1() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::AudioPitchGainEffect*> __get__audioPitchGainEffect2() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AudioSource*> __get__activeAudioSource() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AudioSource*> __get__inactiveAudioSource() const;
...
constexpr ::cordl_internals::to_const_pointer<::Tweening::Tween_1<float_t>*> __get__volumeDownTween() const;
...
constexpr ::cordl_internals::to_const_pointer<::Tweening::Tween_1<float_t>*> __get__volumeUpTween() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::AudioPitchGainEffect*> __get__activePitchGainEffect() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::AudioPitchGainEffect*> __get__inactivePitchGainEffect() const;
