...
::cordl_internals::setInstanceField<::GlobalNamespace::SaberTypeObject*, 0x18>(this, std::forward<::GlobalNamespace::SaberTypeObject*>(value));
}
constexpr ::GlobalNamespace::SaberTypeObject* GlobalNamespace::SetBlocksBladeSaberGlowColor::__get__saber()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SaberTypeObject*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SaberTypeObject*> GlobalNamespace::SetBlocksBladeSaberGlowColor::__get__saber() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SaberTypeObject*, 0x18>(this);
}
constexpr void GlobalNamespace::SetBlocksBladeSaberGlowColor::__set__colorManager(::GlobalNamespace::ColorManager*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::ColorManager*, 0x20>(this, std::forward<::GlobalNamespace::ColorManager*>(value));
}
constexpr ::GlobalNamespace::ColorManager* GlobalNamespace::SetBlocksBladeSaberGlowColor::__get__colorManager()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ColorManager*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorManager*> GlobalNamespace::SetBlocksBladeSaberGlowColor::__get__colorManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ColorManager*, 0x20>(this);
}
constexpr void GlobalNamespace::SetBlocksBladeSaberGlowColor::__set__blocksBlade(::GlobalNamespace::BlocksBlade*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::BlocksBlade*, 0x28>(this, std::forward<::GlobalNamespace::BlocksBlade*>(value));
}
constexpr ::GlobalNamespace::BlocksBlade* GlobalNamespace::SetBlocksBladeSaberGlowColor::__get__blocksBlade()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BlocksBlade*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BlocksBlade*> GlobalNamespace::SetBlocksBladeSaberGlowColor::__get__blocksBlade() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BlocksBlade*, 0x28>(this);
}
