...
/// @brief Field <positionActionReference>k__BackingField offset 0x10
 __declspec(property(get=__get__positionActionReference_k__BackingField, put=__set__positionActionReference_k__BackingField)) ::UnityEngine::InputSystem::InputActionReference*  _positionActionReference_k__BackingField;

/// @brief Field <orientationActionReference>k__BackingField offset 0x18
 __declspec(property(get=__get__orientationActionReference_k__BackingField, put=__set__orientationActionReference_k__BackingField)) ::UnityEngine::InputSystem::InputActionReference*  _orientationActionReference_k__BackingField;

/// @brief Field <thumbstickActionReference>k__BackingField offset 0x20
 __declspec(property(get=__get__thumbstickActionReference_k__BackingField, put=__set__thumbstickActionReference_k__BackingField)) ::UnityEngine::InputSystem::InputActionReference*  _thumbstickActionReference_k__BackingField;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputActionReference*> __get__positionActionReference_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputActionReference*> __get__orientationActionReference_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputActionReference*> __get__thumbstickActionReference_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 __UnityXRController__Configuration()  = default;
public:
...
/// @brief Field node offset 0x28
 __declspec(property(get=__get_node, put=__set_node)) ::UnityEngine::XR::XRNode  node;

/// @brief Field <manufacturerName>k__BackingField offset 0x2c
 __declspec(property(get=__get__manufacturerName_k__BackingField, put=__set__manufacturerName_k__BackingField)) ::GlobalNamespace::__UnityXRHelper__VRControllerManufacturerName  _manufacturerName_k__BackingField;

/// @brief Field _hapticsHandler offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_positionAction() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_rotationAction() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get_thumbstickAction() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IUnityXRHapticsHandler*> __get__hapticsHandler() const;
