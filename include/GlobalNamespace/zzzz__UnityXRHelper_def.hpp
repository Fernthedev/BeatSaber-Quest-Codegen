...
struct CORDL_TYPE __UnityXRHelper__VRControllerManufacturerName : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____UnityXRHelper__VRControllerManufacturerName_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __UnityXRHelper__VRControllerManufacturerName(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __UnityXRHelper__VRControllerManufacturerName()  = default;
...
/// @brief Field inputFocusWasCapturedEvent offset 0x18
...
/// @brief Field inputFocusWasReleasedEvent offset 0x20
...
/// @brief Field vrFocusWasCapturedEvent offset 0x28
...
/// @brief Field vrFocusWasReleasedEvent offset 0x30
...
/// @brief Field controllersDidDisconnectEvent offset 0x50
...
/// @brief Field <hasVrFocus>k__BackingField offset 0x58
...
/// @brief Field _rightControllerConfiguration offset 0xb8
...
/// @brief Field _userPresenceActionReference offset 0xc0
...
/// @brief Field _headPositionActionReference offset 0xc8
...
/// @brief Field _headOrientationActionReference offset 0xd0
...
/// @brief Field _pauseGameActionReference offset 0xd8
...
/// @brief Field _leftController offset 0xe0
...
/// @brief Field _rightController offset 0xe8
...
/// @brief Field _headPositionAction offset 0xf0
...
/// @brief Field _headOrientationAction offset 0xf8
...
/// @brief Field _userPresenceAction offset 0x100
...
/// @brief Field _pauseGameAction offset 0x108
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_inputFocusWasCapturedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_inputFocusWasReleasedEvent() const;

constexpr void __set_vrFocusWasCapturedEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_vrFocusWasCapturedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_vrFocusWasCapturedEvent() const;

constexpr void __set_vrFocusWasReleasedEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_vrFocusWasReleasedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_vrFocusWasReleasedEvent() const;

constexpr void __set_hmdUnmountedEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_hmdUnmountedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_hmdUnmountedEvent() const;

constexpr void __set_hmdMountedEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_hmdMountedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_hmdMountedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_controllersDidChangeReferenceEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_controllersDidDisconnectEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__UnityXRController__Configuration*> __get__leftControllerConfiguration() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__UnityXRController__Configuration*> __get__rightControllerConfiguration() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputActionReference*> __get__userPresenceActionReference() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputActionReference*> __get__headPositionActionReference() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputActionReference*> __get__headOrientationActionReference() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputActionReference*> __get__pauseGameActionReference() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::UnityXRController*> __get__leftController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::UnityXRController*> __get__rightController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get__headPositionAction() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get__headOrientationAction() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get__userPresenceAction() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::InputSystem::InputAction*> __get__pauseGameAction() const;
...
/// @brief Method add_inputFocusWasCapturedEvent addr 0x20fd71c size 0x9c virtual true final true
inline void add_inputFocusWasCapturedEvent(::System::Action*  value) ;

/// @brief Method remove_inputFocusWasCapturedEvent addr 0x20fd7b8 size 0x9c virtual true final true
inline void remove_inputFocusWasCapturedEvent(::System::Action*  value) ;

/// @brief Method add_inputFocusWasReleasedEvent addr 0x20fd854 size 0x9c virtual true final true
inline void add_inputFocusWasReleasedEvent(::System::Action*  value) ;

/// @brief Method remove_inputFocusWasReleasedEvent addr 0x20fd8f0 size 0x9c virtual true final true
inline void remove_inputFocusWasReleasedEvent(::System::Action*  value) ;

/// @brief Method add_vrFocusWasCapturedEvent addr 0x20fd98c size 0x9c virtual true final true
inline void add_vrFocusWasCapturedEvent(::System::Action*  value) ;

/// @brief Method remove_vrFocusWasCapturedEvent addr 0x20fda28 size 0x9c virtual true final true
inline void remove_vrFocusWasCapturedEvent(::System::Action*  value) ;

/// @brief Method add_vrFocusWasReleasedEvent addr 0x20fdac4 size 0x9c virtual true final true
inline void add_vrFocusWasReleasedEvent(::System::Action*  value) ;

/// @brief Method remove_vrFocusWasReleasedEvent addr 0x20fdb60 size 0x9c virtual true final true
inline void remove_vrFocusWasReleasedEvent(::System::Action*  value) ;

/// @brief Method add_hmdUnmountedEvent addr 0x20fdbfc size 0x9c virtual true final true
inline void add_hmdUnmountedEvent(::System::Action*  value) ;

/// @brief Method remove_hmdUnmountedEvent addr 0x20fdc98 size 0x9c virtual true final true
inline void remove_hmdUnmountedEvent(::System::Action*  value) ;

/// @brief Method add_hmdMountedEvent addr 0x20fdd34 size 0x9c virtual true final true
inline void add_hmdMountedEvent(::System::Action*  value) ;

/// @brief Method remove_hmdMountedEvent addr 0x20fddd0 size 0x9c virtual true final true
inline void remove_hmdMountedEvent(::System::Action*  value) ;

/// @brief Method add_controllersDidChangeReferenceEvent addr 0x20fde6c size 0x9c virtual true final true
inline void add_controllersDidChangeReferenceEvent(::System::Action*  value) ;

/// @brief Method remove_controllersDidChangeReferenceEvent addr 0x20fdf08 size 0x9c virtual true final true
inline void remove_controllersDidChangeReferenceEvent(::System::Action*  value) ;

/// @brief Method add_controllersDidDisconnectEvent addr 0x20fdfa4 size 0x9c virtual true final true
inline void add_controllersDidDisconnectEvent(::System::Action*  value) ;

/// @brief Method remove_controllersDidDisconnectEvent addr 0x20fe040 size 0x9c virtual true final true
inline void remove_controllersDidDisconnectEvent(::System::Action*  value) ;

/// @brief Method get_hasInputFocus addr 0x20fe0dc size 0x8 virtual true final true
inline bool get_hasInputFocus() ;

/// @brief Method get_hasVrFocus addr 0x20fe0e4 size 0x8 virtual true final true
inline bool get_hasVrFocus() ;

/// @brief Method set_hasVrFocus addr 0x20fe0ec size 0xc virtual false final false
inline void set_hasVrFocus(bool  value) ;

/// @brief Method get_isAlwaysWireless addr 0x20fe0f8 size 0x8 virtual true final true
inline bool get_isAlwaysWireless() ;

/// @brief Method get_vrPlatformSDK addr 0x20fe100 size 0x8 virtual true final true
inline ::GlobalNamespace::VRPlatformSDK get_vrPlatformSDK() ;

/// @brief Method get_loggerPrefix addr 0x20fe108 size 0x40 virtual true final true
inline ::StringW get_loggerPrefix() ;

/// @brief Method set_userPresence addr 0x20fe148 size 0x80 virtual false final false
inline void set_userPresence(bool  value) ;

/// @brief Method Start addr 0x20fe1c8 size 0x43c virtual false final false
inline void Start() ;

/// @brief Method OnTrackingOriginUpdated addr 0x20fe69c size 0x1c virtual false final false
inline void OnTrackingOriginUpdated(::UnityEngine::XR::XRInputSubsystem*  inputSystem) ;

/// @brief Method OnboundaryChanged addr 0x20fe6d4 size 0x1c virtual false final false
inline void OnboundaryChanged(::UnityEngine::XR::XRInputSubsystem*  inputSystem) ;

/// @brief Method OnDestroy addr 0x20fe6f0 size 0x22c virtual false final false
inline void OnDestroy() ;

/// @brief Method OnUserPresenceCanceled addr 0x20fe91c size 0x8 virtual false final false
inline void OnUserPresenceCanceled(::UnityEngine::InputSystem::__InputAction__CallbackContext  context) ;

/// @brief Method OnUserPresenceStarted addr 0x20fe924 size 0x8 virtual false final false
inline void OnUserPresenceStarted(::UnityEngine::InputSystem::__InputAction__CallbackContext  context) ;

/// @brief Method OnApplicationPause addr 0x20fe92c size 0x34 virtual false final false
inline void OnApplicationPause(bool  pauseStatus) ;

/// @brief Method OnPauseGamePerformed addr 0x20fe960 size 0xc virtual false final false
inline void OnPauseGamePerformed(::UnityEngine::InputSystem::__InputAction__CallbackContext  context) ;

/// @brief Method OnPauseGameCancelled addr 0x20fe96c size 0x8 virtual false final false
inline void OnPauseGameCancelled(::UnityEngine::InputSystem::__InputAction__CallbackContext  context) ;

/// @brief Method HandleNewXRNode addr 0x20fe974 size 0x24 virtual false final false
inline void HandleNewXRNode(::UnityEngine::XR::XRNodeState  state) ;

/// @brief Method UpdateManufacturerOnNode addr 0x20fe604 size 0x98 virtual false final false
inline void UpdateManufacturerOnNode(::UnityEngine::XR::XRNode  node) ;

/// @brief Method HandleRemovedXRNode addr 0x20fe998 size 0x60 virtual false final false
inline void HandleRemovedXRNode(::UnityEngine::XR::XRNodeState  state) ;

/// @brief Method ControllerFromNode addr 0x20fe9f8 size 0x2c virtual false final false
inline ::GlobalNamespace::UnityXRController* ControllerFromNode(::UnityEngine::XR::XRNode  node) ;

/// @brief Method TriggerHapticPulse addr 0x20fea24 size 0x18c virtual true final true
inline void TriggerHapticPulse(::UnityEngine::XR::XRNode  node, float_t  duration, float_t  strength, float_t  frequency) ;

/// @brief Method StopHaptics addr 0x20febb0 size 0x174 virtual true final true
inline void StopHaptics(::UnityEngine::XR::XRNode  node) ;

/// @brief Method TryGetPoseOffsetForNode addr 0x20fed24 size 0xe8 virtual true final true
inline bool TryGetPoseOffsetForNode(::UnityEngine::XR::XRNode  node, ByRef<::UnityEngine::Pose>  poseOffset) ;

/// @brief Method GetPoseOffsetForManufacturer addr 0x20fee0c size 0x150 virtual false final false
...
/// @brief Method GetNodePose addr 0x20fef5c size 0x1f4 virtual true final true
...
/// @brief Method GetAnyJoystickMaxAxis addr 0x20ff1e8 size 0x4 virtual true final true
inline ::UnityEngine::Vector2 GetAnyJoystickMaxAxis() ;

/// @brief Method GetTriggerValue addr 0x20ff1ec size 0x8 virtual true final true
inline float_t GetTriggerValue(::UnityEngine::XR::XRNode  node) ;

/// @brief Method GetThumbstickValue addr 0x20ff1f4 size 0x78 virtual true final true
inline ::UnityEngine::Vector2 GetThumbstickValue(::UnityEngine::XR::XRNode  node) ;

/// @brief Method GetMenuButton addr 0x20ff26c size 0x8 virtual true final true
inline bool GetMenuButton() ;

/// @brief Method GetMenuButtonDown addr 0x20ff274 size 0x8 virtual true final true
inline bool GetMenuButtonDown() ;

/// @brief Method RefreshControllersReference addr 0x20fe6b8 size 0x1c virtual true final true
inline void RefreshControllersReference() ;

/// @brief Method ReadHeadPose addr 0x20ff150 size 0x98 virtual false final false
inline void ReadHeadPose(ByRef<::UnityEngine::Vector3>  pos, ByRef<::UnityEngine::Quaternion>  rot) ;

/// @brief Method LateUpdate addr 0x20ff27c size 0x8 virtual false final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::UnityXRHelper* New_ctor() ;

/// @brief Method .ctor addr 0x20ff284 size 0x8 virtual false final false
inline void _ctor() ;
