...
struct CORDL_TYPE __BezierSplineEvaluator__CubicSolveResult : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x10};

/// @brief Field numberOfSolutions offset 0x0
 __declspec(property(get=__get_numberOfSolutions, put=__set_numberOfSolutions)) int32_t  numberOfSolutions;

/// @brief Field solution1 offset 0x4
 __declspec(property(get=__get_solution1, put=__set_solution1)) float_t  solution1;

/// @brief Field solution2 offset 0x8
 __declspec(property(get=__get_solution2, put=__set_solution2)) float_t  solution2;

/// @brief Field solution3 offset 0xc
 __declspec(property(get=__get_solution3, put=__set_solution3)) float_t  solution3;

constexpr void __set_numberOfSolutions(int32_t  value) ;

constexpr int32_t& __get_numberOfSolutions() ;

constexpr int32_t const& __get_numberOfSolutions() const;

constexpr void __set_solution1(float_t  value) ;

constexpr float_t& __get_solution1() ;

constexpr float_t const& __get_solution1() const;

constexpr void __set_solution2(float_t  value) ;

constexpr float_t& __get_solution2() ;

constexpr float_t const& __get_solution2() const;

constexpr void __set_solution3(float_t  value) ;

constexpr float_t& __get_solution3() ;

constexpr float_t const& __get_solution3() const;
...
constexpr explicit __BezierSplineEvaluator__CubicSolveResult(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __BezierSplineEvaluator__CubicSolveResult()  = default;
...
/// @brief Field kSlightAboveOne offset 0x0
static constexpr float_t  kSlightAboveOne{1.0005};

/// @brief Field kSlightBelowZero offset 0x0
...
/// @brief Field _currentSegmentIndex offset 0x18
