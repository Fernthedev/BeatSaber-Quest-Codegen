...
/// @brief Field shaderName offset 0x28
 __declspec(property(get=__get_shaderName, put=__set_shaderName)) ::StringW  shaderName;

/// @brief Field <trackingWasEnabled>5__2 offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRTrackedKeyboardSampleControls*> __get___4__this() const;
...
/// @brief Method .ctor addr 0x27991e4 size 0x28 virtual false final false
inline void _ctor(int32_t  __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x2799298 size 0x4 virtual true final true
inline void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x279929c size 0x134 virtual true final true
inline bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x27993d0 size 0x8 virtual true final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x27993d8 size 0x40 virtual true final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x2799418 size 0x8 virtual true final true
...
// Ctor Parameters []
// @brief default ctor
 __OVRTrackedKeyboardSampleControls___SetShaderCoroutine_d__19()  = default;
public:
...
/// @brief Field trackedKeyboard offset 0x18
...
/// @brief Field StartingFocusField offset 0x20
...
/// @brief Field ShaderButtons offset 0x88
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRTrackedKeyboard*> __get_trackedKeyboard() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::InputField*> __get_StartingFocusField() const;

constexpr void __set_NameValue(::UnityEngine::UI::Text*  value) ;

constexpr ::UnityEngine::UI::Text* __get_NameValue() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_NameValue() const;

constexpr void __set_ConnectedValue(::UnityEngine::UI::Text*  value) ;

constexpr ::UnityEngine::UI::Text* __get_ConnectedValue() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_ConnectedValue() const;

constexpr void __set_StateValue(::UnityEngine::UI::Text*  value) ;

constexpr ::UnityEngine::UI::Text* __get_StateValue() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_StateValue() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_SelectKeyboardValue() const;

constexpr void __set_TypeValue(::UnityEngine::UI::Text*  value) ;

constexpr ::UnityEngine::UI::Text* __get_TypeValue() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_TypeValue() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get_TrackingToggle() const;

constexpr void __set_ConnectionToggle(::UnityEngine::UI::Toggle*  value) ;

constexpr ::UnityEngine::UI::Toggle* __get_ConnectionToggle() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get_ConnectionToggle() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Toggle*> __get_RemoteKeyboardToggle() const;
...
/// @brief Method Start addr 0x2798d40 size 0x100 virtual false final false
inline void Start() ;

/// @brief Method Update addr 0x2798e40 size 0x248 virtual false final false
inline void Update() ;

/// @brief Method SetPresentationOpaque addr 0x2799088 size 0x1c virtual false final false
inline void SetPresentationOpaque() ;

/// @brief Method SetPresentationKeyLabels addr 0x27990a4 size 0x1c virtual false final false
inline void SetPresentationKeyLabels() ;

/// @brief Method SetUnlitShader addr 0x27990c0 size 0x58 virtual false final false
inline void SetUnlitShader() ;

/// @brief Method SetDiffuseShader addr 0x279918c size 0x58 virtual false final false
inline void SetDiffuseShader() ;

/// @brief Method SetShaderCoroutine addr 0x2799118 size 0x74 virtual false final false
inline ::System::Collections::IEnumerator* SetShaderCoroutine(::StringW  shaderName) ;

/// @brief Method LaunchKeyboardSelection addr 0x279920c size 0x2c virtual false final false
inline void LaunchKeyboardSelection() ;

/// @brief Method SetTrackingEnabled addr 0x2799238 size 0x20 virtual false final false
inline void SetTrackingEnabled(bool  value) ;

static inline ::GlobalNamespace::OVRTrackedKeyboardSampleControls* New_ctor() ;

/// @brief Method .ctor addr 0x2799258 size 0x1c virtual false final false
inline void _ctor() ;

/// @brief Method <SetShaderCoroutine>b__19_0 addr 0x2799274 size 0x24 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 OVRTrackedKeyboardSampleControls()  = default;
public:
