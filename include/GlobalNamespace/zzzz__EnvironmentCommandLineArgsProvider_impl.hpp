...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::StringW,::Array<::StringW>*> (::GlobalNamespace::EnvironmentCommandLineArgsProvider::*)()>(&::GlobalNamespace::EnvironmentCommandLineArgsProvider::GetCommandLineArgs)> {
