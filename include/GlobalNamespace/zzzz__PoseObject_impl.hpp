...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> GlobalNamespace::PoseObject::__get__transform() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x10>(this);
}
constexpr void GlobalNamespace::PoseObject::__set__poseObjectId(::GlobalNamespace::PoseObjectIdSO*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::PoseObjectIdSO*, 0x18>(this, std::forward<::GlobalNamespace::PoseObjectIdSO*>(value));
}
constexpr ::GlobalNamespace::PoseObjectIdSO* GlobalNamespace::PoseObject::__get__poseObjectId()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::PoseObjectIdSO*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PoseObjectIdSO*> GlobalNamespace::PoseObject::__get__poseObjectId() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::PoseObjectIdSO*, 0x18>(this);
}
