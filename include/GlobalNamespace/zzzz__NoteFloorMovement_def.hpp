...
/// @brief Field floorMovementDidFinishEvent offset 0x30
...
/// @brief Field _localPosition offset 0x78
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_floorMovementDidFinishEvent() const;
