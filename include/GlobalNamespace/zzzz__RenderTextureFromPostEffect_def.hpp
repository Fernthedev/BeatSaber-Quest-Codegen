...
/// @brief Field _targetTexture offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RenderTexture*> __get__targetTexture() const;
...
// Ctor Parameters []
// @brief default ctor
 RenderTextureFromPostEffect()  = default;
public:
