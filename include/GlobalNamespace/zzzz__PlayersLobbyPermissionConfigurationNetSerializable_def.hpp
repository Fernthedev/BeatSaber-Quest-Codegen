...
/// @brief Field _playersPermission offset 0x18
 __declspec(property(get=__get__playersPermission, put=__set__playersPermission)) ::System::Collections::Generic::List_1<::GlobalNamespace::PlayerLobbyPermissionConfigurationNetSerializable*>*  _playersPermission;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::PlayerLobbyPermissionConfigurationNetSerializable*>*> __get__playersPermission() const;
...
// Ctor Parameters []
// @brief default ctor
 PlayersLobbyPermissionConfigurationNetSerializable()  = default;
public:
