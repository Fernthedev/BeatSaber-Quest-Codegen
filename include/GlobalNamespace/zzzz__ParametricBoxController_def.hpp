...
/// @brief Field heightCenter offset 0x24
 __declspec(property(get=__get_heightCenter, put=__set_heightCenter)) float_t  heightCenter;
...
constexpr float_t& __get_heightCenter() ;

constexpr float_t const& __get_heightCenter() const;
...
// Ctor Parameters []
// @brief default ctor
 ParametricBoxController()  = default;
public:
