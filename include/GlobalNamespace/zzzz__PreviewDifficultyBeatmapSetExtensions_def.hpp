...
static inline ::ArrayW<::GlobalNamespace::BeatmapCharacteristicSO*,::Array<::GlobalNamespace::BeatmapCharacteristicSO*>*> GetBeatmapCharacteristics(::ArrayW<::GlobalNamespace::PreviewDifficultyBeatmapSet*,::Array<::GlobalNamespace::PreviewDifficultyBeatmapSet*>*>  previewDifficultyBeatmapSet) ;

/// @brief Method GetPreviewDifficultyBeatmapSetWithout360Movement addr 0x232d28c size 0x144 virtual false final false
static inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::PreviewDifficultyBeatmapSet*>* GetPreviewDifficultyBeatmapSetWithout360Movement(::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::PreviewDifficultyBeatmapSet*>*  previewDifficultyBeatmapSet) ;
...
// Ctor Parameters []
// @brief default ctor
 PreviewDifficultyBeatmapSetExtensions()  = default;
public:
