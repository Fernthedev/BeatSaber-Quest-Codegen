...
// Ctor Parameters []
// @brief default ctor
 __MissionObjectiveCheckersManager__InitData()  = default;
public:
...
/// @brief Field _missionObjectiveCheckers offset 0x18
 __declspec(property(get=__get__missionObjectiveCheckers, put=__set__missionObjectiveCheckers)) ::ArrayW<::GlobalNamespace::MissionObjectiveChecker*,::Array<::GlobalNamespace::MissionObjectiveChecker*>*>  _missionObjectiveCheckers;
...
/// @brief Field objectivesListDidChangeEvent offset 0x40
...
/// @brief Field _activeMissionObjectiveCheckers offset 0x48
 __declspec(property(get=__get__activeMissionObjectiveCheckers, put=__set__activeMissionObjectiveCheckers)) ::ArrayW<::GlobalNamespace::MissionObjectiveChecker*,::Array<::GlobalNamespace::MissionObjectiveChecker*>*>  _activeMissionObjectiveCheckers;

 __declspec(property(get=get_activeMissionObjectiveCheckers)) ::ArrayW<::GlobalNamespace::MissionObjectiveChecker*,::Array<::GlobalNamespace::MissionObjectiveChecker*>*>  activeMissionObjectiveCheckers;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__MissionObjectiveCheckersManager__InitData*> __get__initData() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_objectiveDidFailEvent() const;

constexpr void __set_objectiveWasClearedEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_objectiveWasClearedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_objectiveWasClearedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_objectivesListDidChangeEvent() const;
...
// Ctor Parameters []
// @brief default ctor
 MissionObjectiveCheckersManager()  = default;
public:
