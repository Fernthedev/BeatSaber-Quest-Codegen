...
/// @brief Field gameObjects offset 0x18
...
/// @brief Field <isActive>k__BackingField offset 0x20
...
/// @brief Method get_isActive addr 0x23a545c size 0x8 virtual false final false
inline bool get_isActive() ;

/// @brief Method set_isActive addr 0x23a5464 size 0xc virtual false final false
inline void set_isActive(bool  value) ;

/// @brief Method SetActive addr 0x23a5268 size 0x7c virtual false final false
inline void SetActive(bool  active) ;

static inline ::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList* New_ctor() ;

/// @brief Method .ctor addr 0x23a5470 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __GameObjectIntSwitchEventEffect__GameObjectValueList()  = default;
public:
...
/// @brief Field _defaultValue offset 0x1c
 __declspec(property(get=__get__defaultValue, put=__set__defaultValue)) int32_t  _defaultValue;

/// @brief Field _gameObjectsValueLists offset 0x20
 __declspec(property(get=__get__gameObjectsValueLists, put=__set__gameObjectsValueLists)) ::ArrayW<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*,::Array<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*>*>  _gameObjectsValueLists;
...
/// @brief Field _valueToListMap offset 0x38
 __declspec(property(get=__get__valueToListMap, put=__set__valueToListMap)) ::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*>*  _valueToListMap;

/// @brief Field _previousActiveIdx offset 0x40
...
constexpr void __set__gameObjectsValueLists(::ArrayW<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*,::Array<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*,::Array<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*>*>& __get__gameObjectsValueLists() ;

constexpr ::ArrayW<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*,::Array<::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*>*> const& __get__gameObjectsValueLists() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::__GameObjectIntSwitchEventEffect__GameObjectValueList*>*> __get__valueToListMap() const;
...
/// @brief Method Start addr 0x23a50b0 size 0x1b8 virtual false final false
inline void Start() ;

/// @brief Method OnDestroy addr 0x23a52e4 size 0x2c virtual false final false
inline void OnDestroy() ;

/// @brief Method HandleBasicBeatmapEventData addr 0x23a5310 size 0x144 virtual false final false
...
/// @brief Method .ctor addr 0x23a5454 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 GameObjectIntSwitchEventEffect()  = default;
public:
