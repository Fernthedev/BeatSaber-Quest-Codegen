...
/// @brief Method .ctor addr 0x23020b0 size 0x64 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __PosesRecordingSaveData__PoseSaveData()  = default;
public:
...
/// @brief Field poses offset 0x10
 __declspec(property(get=__get_poses, put=__set_poses)) ::ArrayW<::GlobalNamespace::__PosesRecordingSaveData__PoseSaveData*,::Array<::GlobalNamespace::__PosesRecordingSaveData__PoseSaveData*>*>  poses;
...
/// @brief Method .ctor addr 0x2302114 size 0x38 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __PosesRecordingSaveData__TransformsSaveKeyframe()  = default;
public:
...
/// @brief Method .ctor addr 0x230214c size 0x50 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __PosesRecordingSaveData__ExternalCameraCalibrationSaveData()  = default;
public:
...
/// @brief Field keyframes offset 0x18
 __declspec(property(get=__get_keyframes, put=__set_keyframes)) ::ArrayW<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*,::Array<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*>*>  keyframes;

/// @brief Field externalCameraCalibration offset 0x20
 __declspec(property(get=__get_externalCameraCalibration, put=__set_externalCameraCalibration)) ::GlobalNamespace::__PosesRecordingSaveData__ExternalCameraCalibrationSaveData*  externalCameraCalibration;
...
constexpr ::ArrayW<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*,::Array<::GlobalNamespace::__PosesRecordingSaveData__TransformsSaveKeyframe*>*> const& __get_keyframes() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__PosesRecordingSaveData__ExternalCameraCalibrationSaveData*> __get_externalCameraCalibration() const;
...
/// @brief Method .ctor addr 0x2302074 size 0x3c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 PosesRecordingSaveData()  = default;
public:
