...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::ObstacleSpawnInfoNetSerializable* (::GlobalNamespace::ObstacleSpawnInfoNetSerializable::*)(float_t, int32_t, ::GlobalNamespace::NoteLineLayer, float_t, int32_t, int32_t, ::UnityEngine::Vector3, ::UnityEngine::Vector3, ::UnityEngine::Vector3, float_t, float_t, float_t, float_t, float_t)>(&::GlobalNamespace::ObstacleSpawnInfoNetSerializable::Init)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ObstacleSpawnInfoNetSerializable::*)()>(&::GlobalNamespace::ObstacleSpawnInfoNetSerializable::_ctor)> {
...
::cordl_internals::setInstanceField<::GlobalNamespace::Vector3Serializable, 0x2c>(this, std::forward<::GlobalNamespace::Vector3Serializable>(value));
}
constexpr ::GlobalNamespace::Vector3Serializable& GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_moveStartPos()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::Vector3Serializable, 0x2c>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::Vector3Serializable, 0x38>(this, std::forward<::GlobalNamespace::Vector3Serializable>(value));
}
constexpr ::GlobalNamespace::Vector3Serializable& GlobalNamespace::ObstacleSpawnInfoNetSerializable::__get_moveEndPos()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::Vector3Serializable, 0x38>(this);
}
...
return ::cordl_internals::RunMethodRethrow<::GlobalNamespace::ObstacleSpawnInfoNetSerializable*, false>(*this, ___internal_method, time, lineIndex, lineLayer, duration, width, height, moveStartPos, moveEndPos, jumpEndPos, obstacleHeight, moveDuration, jumpDuration, noteLinesDistance, rotation);
}
