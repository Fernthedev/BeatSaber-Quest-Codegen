...
// Ctor Parameters []
// @brief default ctor
 __OVRSceneManager__Classification()  = default;
public:


// Fields

// Static field <List>k__BackingField
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRScenePlane*> __get_Floor() const;

constexpr void __set_Ceiling(::GlobalNamespace::OVRScenePlane*  value) ;

constexpr ::GlobalNamespace::OVRScenePlane* __get_Ceiling() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRScenePlane*> __get_Ceiling() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::OVRScenePlane*>*> __get_Walls() const;
...
// Ctor Parameters []
// @brief default ctor
 __OVRSceneManager__RoomLayoutInformation()  = default;
public:
...
struct CORDL_TYPE __OVRSceneManager__LogForwarder : public ::bs_hook::ValueTypeWrapper<0x1> {
public:
// Declarations
...
constexpr explicit __OVRSceneManager__LogForwarder(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x1>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRSceneManager__LogForwarder()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __OVRSceneManager__Development()  = default;
public:
...
struct CORDL_TYPE __OVRSceneManager___OnApplicationPause_d__28 : public ::bs_hook::ValueTypeWrapper<0x58> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field isPaused offset 0x28
 __declspec(property(get=__get_isPaused, put=__set_isPaused)) bool  isPaused;

/// @brief Field <>4__this offset 0x30
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::GlobalNamespace::OVRSceneManager*  __4__this;

/// @brief Field <anchors>5__2 offset 0x38
 __declspec(property(get=__get__anchors_5__2, put=__set__anchors_5__2)) ::System::Collections::Generic::List_1<::GlobalNamespace::OVRAnchor>*  _anchors_5__2;

/// @brief Field <>7__wrap2 offset 0x40
 __declspec(property(get=__get___7__wrap2, put=__set___7__wrap2)) ::GlobalNamespace::__OVRObjectPool__ListScope_1<::GlobalNamespace::OVRAnchor>  __7__wrap2;

/// @brief Field <>u__1 offset 0x48
 __declspec(property(get=__get___u__1, put=__set___u__1)) ::GlobalNamespace::__OVRTask_1__Awaiter<bool>  __u__1;
...
constexpr void __set___4__this(::GlobalNamespace::OVRSceneManager*  value) ;

constexpr ::GlobalNamespace::OVRSceneManager* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRSceneManager*> __get___4__this() const;

constexpr void __set__anchors_5__2(::System::Collections::Generic::List_1<::GlobalNamespace::OVRAnchor>*  value) ;

constexpr ::System::Collections::Generic::List_1<::GlobalNamespace::OVRAnchor>* __get__anchors_5__2() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::OVRAnchor>*> __get__anchors_5__2() const;

constexpr void __set___7__wrap2(::GlobalNamespace::__OVRObjectPool__ListScope_1<::GlobalNamespace::OVRAnchor>  value) ;

constexpr ::GlobalNamespace::__OVRObjectPool__ListScope_1<::GlobalNamespace::OVRAnchor>& __get___7__wrap2() ;

constexpr ::GlobalNamespace::__OVRObjectPool__ListScope_1<::GlobalNamespace::OVRAnchor> const& __get___7__wrap2() const;

constexpr void __set___u__1(::GlobalNamespace::__OVRTask_1__Awaiter<bool>  value) ;

constexpr ::GlobalNamespace::__OVRTask_1__Awaiter<bool>& __get___u__1() ;

constexpr ::GlobalNamespace::__OVRTask_1__Awaiter<bool> const& __get___u__1() const;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "isPaused", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::OVRSceneManager*", modifiers: "", def_value: None }, CppParam { name: "_anchors_5__2", ty: "::System::Collections::Generic::List_1<::GlobalNamespace::OVRAnchor>*", modifiers: "", def_value: None }, CppParam { name: "__7__wrap2", ty: "::GlobalNamespace::__OVRObjectPool__ListScope_1<::GlobalNamespace::OVRAnchor>", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::GlobalNamespace::__OVRTask_1__Awaiter<bool>", modifiers: "", def_value: None }]
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRSceneManager___OnApplicationPause_d__28(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x58>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRSceneManager___OnApplicationPause_d__28()  = default;
...
struct CORDL_TYPE __OVRSceneManager___QueryForExistingAnchorsTransform_d__29 : public ::bs_hook::ValueTypeWrapper<0x48> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field <>7__wrap1 offset 0x28
 __declspec(property(get=__get___7__wrap1, put=__set___7__wrap1)) ::GlobalNamespace::__OVRObjectPool__ListScope_1<::GlobalNamespace::OVRAnchor>  __7__wrap1;

/// @brief Field <>7__wrap2 offset 0x30
 __declspec(property(get=__get___7__wrap2, put=__set___7__wrap2)) ::GlobalNamespace::__OVRObjectPool__ListScope_1<::System::Guid>  __7__wrap2;
...
constexpr void __set___7__wrap1(::GlobalNamespace::__OVRObjectPool__ListScope_1<::GlobalNamespace::OVRAnchor>  value) ;

constexpr ::GlobalNamespace::__OVRObjectPool__ListScope_1<::GlobalNamespace::OVRAnchor>& __get___7__wrap1() ;

constexpr ::GlobalNamespace::__OVRObjectPool__ListScope_1<::GlobalNamespace::OVRAnchor> const& __get___7__wrap1() const;

constexpr void __set___7__wrap2(::GlobalNamespace::__OVRObjectPool__ListScope_1<::System::Guid>  value) ;

constexpr ::GlobalNamespace::__OVRObjectPool__ListScope_1<::System::Guid>& __get___7__wrap2() ;

constexpr ::GlobalNamespace::__OVRObjectPool__ListScope_1<::System::Guid> const& __get___7__wrap2() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRSceneManager___QueryForExistingAnchorsTransform_d__29(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x48>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRSceneManager___QueryForExistingAnchorsTransform_d__29()  = default;
...
/// @brief Field requestedAnchorClassifications offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IEnumerable_1<::StringW>*> __get_requestedAnchorClassifications() const;
...
// Ctor Parameters []
// @brief default ctor
 __OVRSceneManager____c__DisplayClass37_0()  = default;
public:
...
/// @brief Field roomAnchors offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::OVRAnchor>*> __get_roomAnchors() const;
...
// Ctor Parameters []
// @brief default ctor
 __OVRSceneManager____c__DisplayClass40_0()  = default;
public:
...
/// @brief Field VerboseLogging offset 0x30
 __declspec(property(get=__get_VerboseLogging, put=__set_VerboseLogging)) bool  VerboseLogging;

/// @brief Field MaxSceneAnchorUpdatesPerFrame offset 0x34
...
/// @brief Field _initialAnchorParent offset 0x38
...
/// @brief Field SceneModelLoadedSuccessfully offset 0x40
...
/// @brief Field UnexpectedErrorWithSceneCapture offset 0x58
...
/// @brief Field NewSceneModelAvailable offset 0x60
...
/// @brief Field RoomLayout offset 0x68
...
/// @brief Field _sceneCaptureRequestId offset 0x70
 __declspec(property(get=__get__sceneCaptureRequestId, put=__set__sceneCaptureRequestId)) uint64_t  _sceneCaptureRequestId;

/// @brief Field _cameraRig offset 0x78
 __declspec(property(get=__get__cameraRig, put=__set__cameraRig)) ::GlobalNamespace::OVRCameraRig*  _cameraRig;

/// @brief Field _sceneAnchorUpdateIndex offset 0x80
 __declspec(property(get=__get__sceneAnchorUpdateIndex, put=__set__sceneAnchorUpdateIndex)) int32_t  _sceneAnchorUpdateIndex;

/// @brief Field _roomCounter offset 0x84
 __declspec(property(get=__get__roomCounter, put=__set__roomCounter)) int32_t  _roomCounter;

/// @brief Field _onAnchorsFetchCompleted offset 0x88
 __declspec(property(get=__get__onAnchorsFetchCompleted, put=__set__onAnchorsFetchCompleted)) ::System::Action_2<bool,::System::Collections::Generic::List_1<::GlobalNamespace::OVRAnchor>*>*  _onAnchorsFetchCompleted;

/// @brief Field _hasLoadedScene offset 0x90
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRSceneAnchor*> __get_PlanePrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRSceneAnchor*> __get_VolumePrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::OVRScenePrefabOverride*>*> __get_PrefabOverrides() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__initialAnchorParent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_SceneModelLoadedSuccessfully() const;

constexpr void __set_NoSceneModelToLoad(::System::Action*  value) ;

constexpr ::System::Action* __get_NoSceneModelToLoad() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_NoSceneModelToLoad() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_SceneCaptureReturnedWithoutError() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_UnexpectedErrorWithSceneCapture() const;

constexpr void __set_NewSceneModelAvailable(::System::Action*  value) ;

constexpr ::System::Action* __get_NewSceneModelAvailable() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_NewSceneModelAvailable() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRSceneManager__RoomLayoutInformation*> __get_RoomLayout() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRCameraRig*> __get__cameraRig() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<bool,::System::Collections::Generic::List_1<::GlobalNamespace::OVRAnchor>*>*> __get__onAnchorsFetchCompleted() const;
