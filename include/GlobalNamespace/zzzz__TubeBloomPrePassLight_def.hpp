...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(14474))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xe0 - sizeof(::GlobalNamespace::BloomPrePassLight)]{};

/// @brief Field _mainEffectPostProcessEnabled offset 0x30
...
/// @brief Field _fakeBloomIntensityMultiplier offset 0x60
...
/// @brief Field _dynamic3SliceSprite offset 0xc0
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get__mainEffectPostProcessEnabled() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get__thickenCurve() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ParametricBoxController*> __get__parametricBoxController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::Parametric3SliceSpriteController*> __get__dynamic3SliceSprite() const;

constexpr void __set_didRefreshEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_didRefreshEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_didRefreshEvent() const;
...
/// @brief Method add_didRefreshEvent addr 0x2109950 size 0x9c virtual false final false
inline void add_didRefreshEvent(::System::Action*  value) ;

/// @brief Method remove_didRefreshEvent addr 0x21099ec size 0x9c virtual false final false
inline void remove_didRefreshEvent(::System::Action*  value) ;

/// @brief Method get_colorAlphaMultiplier addr 0x2109a88 size 0x8 virtual false final false
inline float_t get_colorAlphaMultiplier() ;

/// @brief Method get_center addr 0x2109a90 size 0x8 virtual false final false
inline float_t get_center() ;

/// @brief Method get_isDirty addr 0x2109a98 size 0x20 virtual true final false
inline bool get_isDirty() ;

/// @brief Method MarkDirty addr 0x2109ab8 size 0xc virtual false final false
inline void MarkDirty() ;

/// @brief Method get_length addr 0x2109ac4 size 0x8 virtual false final false
inline float_t get_length() ;

/// @brief Method set_length addr 0x2109acc size 0x10 virtual false final false
inline void set_length(float_t  value) ;

/// @brief Method get_width addr 0x2109adc size 0x8 virtual false final false
inline float_t get_width() ;

/// @brief Method set_width addr 0x2109ae4 size 0x10 virtual false final false
inline void set_width(float_t  value) ;

/// @brief Method get_lightWidthMultiplier addr 0x2109af4 size 0x8 virtual false final false
inline float_t get_lightWidthMultiplier() ;

/// @brief Method set_lightWidthMultiplier addr 0x2109afc size 0x8 virtual false final false
inline void set_lightWidthMultiplier(float_t  value) ;

/// @brief Method get_bloomFogIntensityMultiplier addr 0x2109b04 size 0x8 virtual false final false
inline float_t get_bloomFogIntensityMultiplier() ;

/// @brief Method set_bloomFogIntensityMultiplier addr 0x2109b0c size 0x8 virtual false final false
inline void set_bloomFogIntensityMultiplier(float_t  value) ;

/// @brief Method set_color addr 0x2109b14 size 0x118 virtual false final false
inline void set_color(::UnityEngine::Color  value) ;

/// @brief Method get_color addr 0x2109c2c size 0xc virtual false final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method OnEnable addr 0x2109c38 size 0x20 virtual true final false
inline void OnEnable() ;

/// @brief Method DidRegisterLight addr 0x2109c58 size 0x1c virtual true final false
inline void DidRegisterLight() ;

/// @brief Method Refresh addr 0x2109c74 size 0x3f8 virtual true final false
inline void Refresh() ;

/// @brief Method FillMeshData addr 0x210a06c size 0x99c virtual true final false
...
/// @brief Method ClipPoints addr 0x210aaa0 size 0x94 virtual false final false
...
/// @brief Method ZeroQuad addr 0x210aa08 size 0x98 virtual false final false
static inline void ZeroQuad(ByRef<::GlobalNamespace::__BloomPrePassLight__QuadData>  quad) ;

/// @brief Method OnDrawGizmos addr 0x210ab34 size 0x13c virtual false final false
inline void OnDrawGizmos() ;

static inline ::GlobalNamespace::TubeBloomPrePassLight* New_ctor() ;

/// @brief Method .ctor addr 0x210ac70 size 0xd8 virtual false final false
inline void _ctor() ;
