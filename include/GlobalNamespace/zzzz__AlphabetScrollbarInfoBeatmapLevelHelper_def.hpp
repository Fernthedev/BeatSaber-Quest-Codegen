...
// Ctor Parameters []
// @brief default ctor
 __AlphabetScrollbarInfoBeatmapLevelHelper____c()  = default;
public:
...
/// @brief Field kFirstAlphabet offset 0x0
static constexpr ::ConstString  kFirstAlphabet{u"A"};

/// @brief Field kNonAlphabetChar offset 0x0
static constexpr char16_t  kNonAlphabetChar{u'#'};

/// @brief Field kMaxCharactersCount offset 0x0
...
static inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::__AlphabetScrollInfo__Data*>* CreateData(::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IPreviewBeatmapLevel*>*  previewBeatmapLevels, bool  sortPreviewBeatmapLevels, ByRef<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IPreviewBeatmapLevel*>*>  sortedPreviewBeatmapLevels) ;
...
// Ctor Parameters []
// @brief default ctor
 AlphabetScrollbarInfoBeatmapLevelHelper()  = default;
public:
