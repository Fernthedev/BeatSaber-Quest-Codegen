...
/// @brief Method GetIdentifier addr 0x2340e78 size 0x298 virtual false final false
...
/// @brief Method HasIdentifier addr 0x2341110 size 0x290 virtual false final false
...
/// @brief Method ToPreviewDifficultyBeatmap addr 0x23413a0 size 0xd0 virtual false final false
static inline ::GlobalNamespace::PreviewDifficultyBeatmap* ToPreviewDifficultyBeatmap(::GlobalNamespace::BeatmapIdentifierNetSerializable*  beatmapId, ::GlobalNamespace::BeatmapLevelsModel*  beatmapLevelsModel, ::GlobalNamespace::BeatmapCharacteristicCollection*  beatmapCharacteristicCollection) ;

/// @brief Method ToIdentifier addr 0x23416cc size 0x120 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 BeatmapIdentifierNetSerializableHelper()  = default;
public:
