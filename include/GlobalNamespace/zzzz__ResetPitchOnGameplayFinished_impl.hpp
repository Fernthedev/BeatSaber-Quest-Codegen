...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameplayLevelSceneTransitionEvents*> GlobalNamespace::ResetPitchOnGameplayFinished::__get__gameplayLevelSceneTransitionEvents() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayLevelSceneTransitionEvents*, 0x10>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::AudioManagerSO*> GlobalNamespace::ResetPitchOnGameplayFinished::__get__audioManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::AudioManagerSO*, 0x18>(this);
}
