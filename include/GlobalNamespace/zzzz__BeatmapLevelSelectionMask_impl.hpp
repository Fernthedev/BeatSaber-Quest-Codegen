...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatmapLevelSelectionMask::*)(::GlobalNamespace::BeatmapDifficultyMask, ::GlobalNamespace::GameplayModifierMask, ::GlobalNamespace::SongPackMask)>(&::GlobalNamespace::BeatmapLevelSelectionMask::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0xe299a4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::BeatmapLevelSelectionMask::*)(::System::Object*)>(&::GlobalNamespace::BeatmapLevelSelectionMask::Equals)> {
  constexpr static std::size_t size = 0x90;
  constexpr static std::size_t addrs = 0xe299bc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::BeatmapLevelSelectionMask::*)(::GlobalNamespace::BeatmapLevelSelectionMask)>(&::GlobalNamespace::BeatmapLevelSelectionMask::Equals)> {
  ...
  constexpr static std::size_t addrs = 0xe29a4c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::BeatmapLevelSelectionMask::*)()>(&::GlobalNamespace::BeatmapLevelSelectionMask::GetHashCode)> {
  ...
  constexpr static std::size_t addrs = 0xe29b60;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BeatmapLevelSelectionMask::*)(::LiteNetLib::Utils::NetDataWriter*, uint32_t)>(&::GlobalNamespace::BeatmapLevelSelectionMask::Serialize)> {
  ...
  constexpr static std::size_t addrs = 0xe29b8c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BeatmapLevelSelectionMask (*)(::LiteNetLib::Utils::NetDataReader*, uint32_t)>(&::GlobalNamespace::BeatmapLevelSelectionMask::Deserialize)> {
  ...
  constexpr static std::size_t addrs = 0xe29bdc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::GlobalNamespace::BeatmapLevelSelectionMask, ::GlobalNamespace::BeatmapLevelSelectionMask)>(&::GlobalNamespace::BeatmapLevelSelectionMask::op_Equality)> {
  ...
  constexpr static std::size_t addrs = 0xe29c5c;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (*)(::GlobalNamespace::BeatmapLevelSelectionMask, ::GlobalNamespace::BeatmapLevelSelectionMask)>(&::GlobalNamespace::BeatmapLevelSelectionMask::op_Inequality)> {
  constexpr static std::size_t size = 0x88;
  constexpr static std::size_t addrs = 0xe29ce4;
...
return static_cast<::System::IEquatable_1<::GlobalNamespace::BeatmapLevelSelectionMask>*>(static_cast<void*>(::cordl_internals::Box(this)));
}
constexpr void GlobalNamespace::BeatmapLevelSelectionMask::__set_difficulties(::GlobalNamespace::BeatmapDifficultyMask  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::BeatmapDifficultyMask, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::GlobalNamespace::BeatmapDifficultyMask>(value));
}
constexpr ::GlobalNamespace::BeatmapDifficultyMask& GlobalNamespace::BeatmapLevelSelectionMask::__get_difficulties()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapDifficultyMask, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::GlobalNamespace::BeatmapDifficultyMask const& GlobalNamespace::BeatmapLevelSelectionMask::__get_difficulties() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapDifficultyMask, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void GlobalNamespace::BeatmapLevelSelectionMask::__set_modifiers(::GlobalNamespace::GameplayModifierMask  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::GameplayModifierMask, 0x2>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::GlobalNamespace::GameplayModifierMask>(value));
}
constexpr ::GlobalNamespace::GameplayModifierMask& GlobalNamespace::BeatmapLevelSelectionMask::__get_modifiers()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayModifierMask, 0x2>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::GlobalNamespace::GameplayModifierMask const& GlobalNamespace::BeatmapLevelSelectionMask::__get_modifiers() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayModifierMask, 0x2>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::GlobalNamespace::SongPackMask& GlobalNamespace::BeatmapLevelSelectionMask::__get_songPacks()  {
...
constexpr ::GlobalNamespace::SongPackMask const& GlobalNamespace::BeatmapLevelSelectionMask::__get_songPacks() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SongPackMask, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::GlobalNamespace::BeatmapLevelSelectionMask::BeatmapLevelSelectionMask(::GlobalNamespace::BeatmapDifficultyMask  difficulties, ::GlobalNamespace::GameplayModifierMask  modifiers, ::GlobalNamespace::SongPackMask  songPacks) noexcept : ::bs_hook::ValueTypeWrapper<0x28>() {this->difficulties = difficulties;
