...
::cordl_internals::setInstanceField<::GlobalNamespace::TubeLightBehaviour*, 0x18>(this, std::forward<::GlobalNamespace::TubeLightBehaviour*>(value));
}
constexpr ::GlobalNamespace::TubeLightBehaviour* GlobalNamespace::TubeLightAsset::__get__template()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::TubeLightBehaviour*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::TubeLightBehaviour*> GlobalNamespace::TubeLightAsset::__get__template() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::TubeLightBehaviour*, 0x18>(this);
}
