...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> GlobalNamespace::ServerCodeView::__get__serverCodeText() const {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> GlobalNamespace::ServerCodeView::__get__button() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Button*, 0x20>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::ButtonBinder*> GlobalNamespace::ServerCodeView::__get__buttonBinder() const {
return ::cordl_internals::getInstanceField<::HMUI::ButtonBinder*, 0x28>(this);
}
