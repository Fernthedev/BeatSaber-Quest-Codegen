...
// CS Name: ::GameplayCoreSceneSetupData::<LoadTransformedBeatmapDataAsync>d__15
struct CORDL_TYPE __GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__15 : public ::bs_hook::ValueTypeWrapper<0x30> {
public:
// Declarations
...
/// @brief Field <>4__this offset 0x20
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::GlobalNamespace::GameplayCoreSceneSetupData*  __4__this;
...
constexpr ::GlobalNamespace::GameplayCoreSceneSetupData* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameplayCoreSceneSetupData*> __get___4__this() const;
...
/// @brief Method MoveNext addr 0x231c674 size 0x1c8 virtual true final true
inline void MoveNext() ;

/// @brief Method SetStateMachine addr 0x231c83c size 0xc virtual true final true
...
constexpr explicit __GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__15(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x30>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __GameplayCoreSceneSetupData___LoadTransformedBeatmapDataAsync_d__15()  = default;
...
// CS Name: ::GameplayCoreSceneSetupData::<GetTransformedBeatmapDataAsync>d__16
struct CORDL_TYPE __GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__16 : public ::bs_hook::ValueTypeWrapper<0x30> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x30};
...
/// @brief Method MoveNext addr 0x231c848 size 0x410 virtual true final true
inline void MoveNext() ;

/// @brief Method SetStateMachine addr 0x231cc58 size 0x58 virtual true final true
inline void SetStateMachine(::System::Runtime::CompilerServices::IAsyncStateMachine*  stateMachine) ;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__16(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x30>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __GameplayCoreSceneSetupData___GetTransformedBeatmapDataAsync_d__16()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x70 - sizeof(::GlobalNamespace::SceneSetupData)]{};
...
/// @brief Field gameplayModifiers offset 0x20
...
/// @brief Field playerSpecificSettings offset 0x28
...
/// @brief Field practiceSettings offset 0x30
...
/// @brief Field useTestNoteCutSoundEffects offset 0x38
...
/// @brief Field environmentInfo offset 0x40
...
/// @brief Field beatmapDataCache offset 0x58
...
/// @brief Field recordingToolData offset 0x60
...
/// @brief Field _transformedBeatmapData offset 0x68
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PracticeSettings*> __get_practiceSettings() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MainSettingsModelSO*> __get_mainSettingsModel() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapDataCache*> __get_beatmapDataCache() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IReadonlyBeatmapData*> __get__transformedBeatmapData() const;

/// @brief Method get_transformedBeatmapData addr 0x231c414 size 0x8 virtual false final false
inline ::GlobalNamespace::IReadonlyBeatmapData* get_transformedBeatmapData() ;

static inline ::GlobalNamespace::GameplayCoreSceneSetupData* New_ctor(::GlobalNamespace::IDifficultyBeatmap*  difficultyBeatmap, ::GlobalNamespace::IPreviewBeatmapLevel*  previewBeatmapLevel, ::GlobalNamespace::GameplayModifiers*  gameplayModifiers, ::GlobalNamespace::PlayerSpecificSettings*  playerSpecificSettings, ::GlobalNamespace::PracticeSettings*  practiceSettings, bool  useTestNoteCutSoundEffects, ::GlobalNamespace::EnvironmentInfoSO*  environmentInfo, ::GlobalNamespace::ColorScheme*  colorScheme, ::GlobalNamespace::MainSettingsModelSO*  mainSettingsModel, ::GlobalNamespace::BeatmapDataCache*  beatmapDataCache, ::System::Nullable_1<::GlobalNamespace::__RecordingToolManager__SetupData>  recordingToolData) ;

/// @brief Method .ctor addr 0x231c41c size 0xa0 virtual false final false
...
/// @brief Method LoadTransformedBeatmapDataAsync addr 0x231c4bc size 0xc8 virtual false final false
inline ::System::Threading::Tasks::Task* LoadTransformedBeatmapDataAsync() ;

/// @brief Method GetTransformedBeatmapDataAsync addr 0x231c584 size 0xf0 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 GameplayCoreSceneSetupData()  = default;
public:
