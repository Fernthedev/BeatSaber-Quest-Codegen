...
/// @brief Field _characteristicNameLocalizationKey offset 0x28
...
// Ctor Parameters []
// @brief default ctor
 BeatmapCharacteristicSO()  = default;
public:
