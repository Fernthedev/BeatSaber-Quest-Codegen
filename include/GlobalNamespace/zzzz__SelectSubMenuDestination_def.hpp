...
struct CORDL_TYPE __SelectSubMenuDestination__Destination : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____SelectSubMenuDestination__Destination_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __SelectSubMenuDestination__Destination(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __SelectSubMenuDestination__Destination()  = default;
...
/// @brief Field menuDestination offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 SelectSubMenuDestination()  = default;
public:
