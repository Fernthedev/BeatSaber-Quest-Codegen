...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BloomPrePassRendererSO*> GlobalNamespace::SceneCameraBloomPrePass::__get__bloomPrepassRenderer() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BloomPrePassRendererSO*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BloomPrePassEffectContainerSO*> GlobalNamespace::SceneCameraBloomPrePass::__get__bloomPrePassEffectContainer() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BloomPrePassEffectContainerSO*, 0x20>(this);
}
constexpr void GlobalNamespace::SceneCameraBloomPrePass::__set__bloomPrepassRenderTexture(::UnityEngine::RenderTexture*  value)  {
::cordl_internals::setInstanceField<::UnityEngine::RenderTexture*, 0x28>(this, std::forward<::UnityEngine::RenderTexture*>(value));
}
constexpr ::UnityEngine::RenderTexture* GlobalNamespace::SceneCameraBloomPrePass::__get__bloomPrepassRenderTexture()  {
return ::cordl_internals::getInstanceField<::UnityEngine::RenderTexture*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RenderTexture*> GlobalNamespace::SceneCameraBloomPrePass::__get__bloomPrepassRenderTexture() const {
return ::cordl_internals::getInstanceField<::UnityEngine::RenderTexture*, 0x28>(this);
}
