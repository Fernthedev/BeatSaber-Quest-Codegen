...
constexpr void GlobalNamespace::__OVRRaycaster__RaycastHit::__set_graphic(::UnityEngine::UI::Graphic*  value)  {
...
constexpr ::UnityEngine::UI::Graphic* GlobalNamespace::__OVRRaycaster__RaycastHit::__get_graphic()  {
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Graphic*> GlobalNamespace::__OVRRaycaster__RaycastHit::__get_graphic() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Graphic*, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void GlobalNamespace::__OVRRaycaster__RaycastHit::__set_worldPos(::UnityEngine::Vector3  value)  {
...
constexpr ::UnityEngine::Vector3& GlobalNamespace::__OVRRaycaster__RaycastHit::__get_worldPos()  {
...
constexpr ::UnityEngine::Vector3 const& GlobalNamespace::__OVRRaycaster__RaycastHit::__get_worldPos() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Vector3, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void GlobalNamespace::__OVRRaycaster__RaycastHit::__set_fromMouse(bool  value)  {
...
constexpr bool& GlobalNamespace::__OVRRaycaster__RaycastHit::__get_fromMouse()  {
return ::cordl_internals::getInstanceField<bool, 0x14>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr bool const& GlobalNamespace::__OVRRaycaster__RaycastHit::__get_fromMouse() const {
return ::cordl_internals::getInstanceField<bool, 0x14>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::GlobalNamespace::__OVRRaycaster__RaycastHit::__OVRRaycaster__RaycastHit(::UnityEngine::UI::Graphic*  graphic, ::UnityEngine::Vector3  worldPos, bool  fromMouse) noexcept : ::bs_hook::ValueTypeWrapper<0x18>() {this->graphic = graphic;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__OVRRaycaster____c::*)()>(&::GlobalNamespace::__OVRRaycaster____c::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::__OVRRaycaster____c::*)(::GlobalNamespace::__OVRRaycaster__RaycastHit, ::GlobalNamespace::__OVRRaycaster__RaycastHit)>(&::GlobalNamespace::__OVRRaycaster____c::_GraphicRaycast_b__16_0)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::OVRRaycaster::*)(::UnityEngine::Canvas*, ::UnityEngine::Ray, ::System::Collections::Generic::List_1<::GlobalNamespace::__OVRRaycaster__RaycastHit>*)>(&::GlobalNamespace::OVRRaycaster::GraphicRaycast)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "GraphicRaycast",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Canvas*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::UnityEngine::Ray>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::System::Collections::Generic::List_1<::GlobalNamespace::__OVRRaycaster__RaycastHit>*>::get()}
                        )));
    return ___internal_method;
  }
};
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> GlobalNamespace::OVRRaycaster::__get_pointer() const {
return ::cordl_internals::getInstanceField<::UnityEngine::GameObject*, 0x40>(this);
}
...
::cordl_internals::setInstanceField<::UnityEngine::Canvas*, 0x50>(this, std::forward<::UnityEngine::Canvas*>(value));
}
constexpr ::UnityEngine::Canvas* GlobalNamespace::OVRRaycaster::__get_m_Canvas()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Canvas*, 0x50>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Canvas*> GlobalNamespace::OVRRaycaster::__get_m_Canvas() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Canvas*, 0x50>(this);
}
...
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::GlobalNamespace::__OVRRaycaster__RaycastHit>*, 0x58>(this, std::forward<::System::Collections::Generic::List_1<::GlobalNamespace::__OVRRaycaster__RaycastHit>*>(value));
}
...
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::GlobalNamespace::__OVRRaycaster__RaycastHit>*, 0x58>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__OVRRaycaster__RaycastHit>*> GlobalNamespace::OVRRaycaster::__get_m_RaycastResults() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::GlobalNamespace::__OVRRaycaster__RaycastHit>*, 0x58>(this);
}
