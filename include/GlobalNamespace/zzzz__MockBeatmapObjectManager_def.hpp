...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x98 - sizeof(::GlobalNamespace::BeatmapObjectManager)]{};
...
/// @brief Method get_activeObstacleControllers addr 0x2382958 size 0x8 virtual true final false
inline ::System::Collections::Generic::List_1<::GlobalNamespace::ObstacleController*>* get_activeObstacleControllers() ;

/// @brief Method ProcessObstacleData addr 0x2382960 size 0x4 virtual true final false
...
/// @brief Method ProcessNoteData addr 0x2382964 size 0x4 virtual true final false
...
/// @brief Method ProcessSliderData addr 0x2382968 size 0x4 virtual true final false
...
/// @brief Method DespawnInternal addr 0x238296c size 0x4 virtual true final false
inline void DespawnInternal(::GlobalNamespace::NoteController*  noteController) ;

/// @brief Method DespawnInternal addr 0x2382970 size 0x4 virtual true final false
inline void DespawnInternal(::GlobalNamespace::ObstacleController*  obstacleController) ;

/// @brief Method DespawnInternal addr 0x2382974 size 0x4 virtual true final false
...
/// @brief Method .ctor addr 0x2382978 size 0x4 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 MockBeatmapObjectManager()  = default;
public:
