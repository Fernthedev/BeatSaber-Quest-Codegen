...
/// @brief Field kOutOfRangeBladeSpeed offset 0x0
static constexpr float_t  kOutOfRangeBladeSpeed{100.0};

/// @brief Field kSmoothUpBladeSpeedCoef offset 0x0
static constexpr float_t  kSmoothUpBladeSpeedCoef{24.0};

/// @brief Field kSmoothDownBladeSpeedCoef offset 0x0
...
/// @brief Field _dataProcessors offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::ISaberMovementDataProcessor*>*> __get__dataProcessors() const;
