...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> GlobalNamespace::CountdownElementController::__get__text() const {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x18>(this);
}
constexpr void GlobalNamespace::CountdownElementController::__set__animation(::UnityEngine::Animation*  value)  {
::cordl_internals::setInstanceField<::UnityEngine::Animation*, 0x20>(this, std::forward<::UnityEngine::Animation*>(value));
}
constexpr ::UnityEngine::Animation* GlobalNamespace::CountdownElementController::__get__animation()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Animation*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Animation*> GlobalNamespace::CountdownElementController::__get__animation() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Animation*, 0x20>(this);
}
