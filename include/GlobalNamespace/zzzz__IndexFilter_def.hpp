...
struct CORDL_TYPE __IndexFilter__IndexFilterRandomType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____IndexFilter__IndexFilterRandomType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __IndexFilter__IndexFilterRandomType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __IndexFilter__IndexFilterRandomType()  = default;
...
struct CORDL_TYPE __IndexFilter__IndexFilterLimitAlsoAffectType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____IndexFilter__IndexFilterLimitAlsoAffectType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __IndexFilter__IndexFilterLimitAlsoAffectType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __IndexFilter__IndexFilterLimitAlsoAffectType()  = default;
...
/// @brief Field <limitedOrderIndex>5__2 offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IndexFilter*> __get___4__this() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IEnumerator_1<::System::ValueTuple_2<int32_t,int32_t>>*> __get___7__wrap2() const;
...
// Ctor Parameters []
// @brief default ctor
 __IndexFilter___GetEnumerator_d__23()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __IndexFilter___GetValues_d__24()  = default;
public:
