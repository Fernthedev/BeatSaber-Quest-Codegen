...
/// @brief Field _centroidComputationMesh offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__meshTransform() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NoteDebrisPhysics*> __get__physics() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get__cutoutCurve() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Mesh*> __get__centroidComputationMesh() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::INoteDebrisDidFinishEvent*>*> __get__didFinishEvent() const;
...
// Static field _cutPlaneID

// Static field _cutoutTexOffsetID

// Static field _meshVertices
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11050)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11050), inst: 2824 }), TypeDefinitionIndex(TypeDefinitionIndex(4773))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::Zenject::MonoMemoryPool_1<::GlobalNamespace::NoteDebris*>)]{};
