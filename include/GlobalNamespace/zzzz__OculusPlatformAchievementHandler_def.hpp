...
/// @brief Field completionHandler offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__IPlatformAchievementsHandler__UnlockAchievementCompletionHandler*> __get_completionHandler() const;
...
// Ctor Parameters []
// @brief default ctor
 __OculusPlatformAchievementHandler____c__DisplayClass2_0()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__IPlatformAchievementsHandler__GetUnlockedAchievementsCompletionHandler*> __get_completionHandler() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OculusPlatformAchievementHandler*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __OculusPlatformAchievementHandler____c__DisplayClass3_0()  = default;
public:
...
/// @brief Field achievement offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Oculus::Platform::Models::AchievementProgress*> __get_achievement() const;
...
// Ctor Parameters []
// @brief default ctor
 __OculusPlatformAchievementHandler____c__DisplayClass3_1()  = default;
public:
...
/// @brief Field _achievementIdsModel offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 OculusPlatformAchievementHandler()  = default;
public:
