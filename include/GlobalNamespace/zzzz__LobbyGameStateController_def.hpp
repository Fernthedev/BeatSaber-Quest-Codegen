...
/// @brief Field getGameStateAsyncTcs offset 0x18
...
/// @brief Field getPlayerPermissionAsyncTcs offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LobbyGameStateController*> __get___4__this() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::TaskCompletionSource_1<bool>*> __get_getGameStateAsyncTcs() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::TaskCompletionSource_1<bool>*> __get_getPlayerPermissionAsyncTcs() const;
...
// Ctor Parameters []
// @brief default ctor
 __LobbyGameStateController____c__DisplayClass98_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __LobbyGameStateController____c()  = default;
public:
...
/// @brief Field _menuRpcManager offset 0x20
...
/// @brief Field _multiplayerLevelLoader offset 0x30
...
/// @brief Field _menuTransitionsHelper offset 0x38
...
/// @brief Field _lobbyGameStateModel offset 0x40
...
/// @brief Field _lobbyPlayerPermissionsModel offset 0x48
...
/// @brief Field _beatmapLevelsModel offset 0x50
...
/// @brief Field _beatmapCharacteristicCollection offset 0x58
...
/// @brief Field selectedLevelGameplaySetupDataChangedEvent offset 0x60
 __declspec(property(get=__get_selectedLevelGameplaySetupDataChangedEvent, put=__set_selectedLevelGameplaySetupDataChangedEvent)) ::System::Action_1<::GlobalNamespace::ILevelGameplaySetupData*>*  selectedLevelGameplaySetupDataChangedEvent;

/// @brief Field gameStartedEvent offset 0x68
...
/// @brief Field gameStartCancelledEvent offset 0x70
...
/// @brief Field songStillDownloadingEvent offset 0x88
...
/// @brief Field startTimeChangedEvent offset 0x90
 __declspec(property(get=__get_startTimeChangedEvent, put=__set_startTimeChangedEvent)) ::System::Action*  startTimeChangedEvent;

/// @brief Field levelFinishedEvent offset 0x98
 __declspec(property(get=__get_levelFinishedEvent, put=__set_levelFinishedEvent)) ::System::Action_2<::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO*,::GlobalNamespace::MultiplayerResultsData*>*  levelFinishedEvent;

/// @brief Field levelDidGetDisconnectedEvent offset 0xa0
...
/// @brief Field lobbyDisconnectedEvent offset 0xa8
...
/// @brief Field beforeSceneSwitchCallbackEvent offset 0xb0
...
/// @brief Field lobbyStateChangedEvent offset 0xb8
...
/// @brief Field startButtonEnabledEvent offset 0xc0
...
/// @brief Field playerMissingEntitlementsChangedEvent offset 0xc8
 __declspec(property(get=__get_playerMissingEntitlementsChangedEvent, put=__set_playerMissingEntitlementsChangedEvent)) ::System::Action_1<::GlobalNamespace::PlayersMissingEntitlementsNetSerializable*>*  playerMissingEntitlementsChangedEvent;

/// @brief Field <levelStartInitiated>k__BackingField offset 0xd0
...
/// @brief Field <countdownStarted>k__BackingField offset 0xd1
...
/// @brief Field <countdownEndTime>k__BackingField offset 0xd8
...
/// @brief Field <isDisconnected>k__BackingField offset 0xe0
...
/// @brief Field <disconnectedReason>k__BackingField offset 0xe4
...
/// @brief Field _selectedLevelGameplaySetupData offset 0x108
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLevelLoader*> __get__multiplayerLevelLoader() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::ILevelGameplaySetupData*>*> __get_selectedLevelGameplaySetupDataChangedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::ILevelGameplaySetupData*>*> __get_gameStartedEvent() const;

constexpr void __set_gameStartCancelledEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_gameStartCancelledEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_gameStartCancelledEvent() const;

constexpr void __set_countdownStartedEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_countdownStartedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_countdownStartedEvent() const;

constexpr void __set_countdownCancelledEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_countdownCancelledEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_countdownCancelledEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_songStillDownloadingEvent() const;

constexpr void __set_startTimeChangedEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_startTimeChangedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_startTimeChangedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO*,::GlobalNamespace::MultiplayerResultsData*>*> __get_levelFinishedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::DisconnectedReason>*> __get_levelDidGetDisconnectedEvent() const;

constexpr void __set_lobbyDisconnectedEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_lobbyDisconnectedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_lobbyDisconnectedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_beforeSceneSwitchCallbackEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::MultiplayerLobbyState>*> __get_lobbyStateChangedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::CannotStartGameReason>*> __get_startButtonEnabledEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::PlayersMissingEntitlementsNetSerializable*>*> __get_playerMissingEntitlementsChangedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LevelGameplaySetupData*> __get__selectedLevelGameplaySetupData() const;
...
inline void HandleMenuRpcManagerStartedLevel(::StringW  userId, ::GlobalNamespace::BeatmapIdentifierNetSerializable*  beatmapId, ::GlobalNamespace::GameplayModifiers*  gameplayModifiers, int64_t  startTime) ;
...
inline void StartMultiplayerLevel(::GlobalNamespace::ILevelGameplaySetupData*  gameplaySetupData, ::GlobalNamespace::IDifficultyBeatmap*  difficultyBeatmap, ::System::Action*  beforeSceneSwitchCallback) ;
...
// Ctor Parameters []
// @brief default ctor
 LobbyGameStateController()  = default;
public:
