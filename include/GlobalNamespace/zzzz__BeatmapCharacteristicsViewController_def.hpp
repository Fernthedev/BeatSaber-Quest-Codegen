...
/// @brief Field _beatmapCharacteristicsTableView offset 0x70
...
/// @brief Field didSelectBeatmapCharacteristicEvent offset 0x78
 __declspec(property(get=__get_didSelectBeatmapCharacteristicEvent, put=__set_didSelectBeatmapCharacteristicEvent)) ::System::Action_1<::GlobalNamespace::BeatmapCharacteristicSO*>*  didSelectBeatmapCharacteristicEvent;

/// @brief Field _beatmapCharacteristicCollection offset 0x80
...
/// @brief Field _selectedBeatmapCharacteristicNum offset 0x88
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapCharacteristicsTableView*> __get__beatmapCharacteristicsTableView() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::BeatmapCharacteristicSO*>*> __get_didSelectBeatmapCharacteristicEvent() const;
...
// Ctor Parameters []
// @brief default ctor
 BeatmapCharacteristicsViewController()  = default;
public:
