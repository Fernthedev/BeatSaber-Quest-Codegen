...
/// @brief Field startBeat offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Type*> __get_eventBoxType() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapEventDataBox*> __get_eventBox() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapEventDataBoxGroup*> __get_boxGroup() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__BeatmapEventDataBoxGroup__ElementData*> __get__next() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__BeatmapEventDataBoxGroup__ElementData*> __get__previous() const;
...
// Ctor Parameters []
// @brief default ctor
 __BeatmapEventDataBoxGroup__ElementData()  = default;
public:
...
/// @brief Field _elementDataDict offset 0x18
 __declspec(property(get=__get__elementDataDict, put=__set__elementDataDict)) ::System::Collections::Generic::Dictionary_2<::System::ValueTuple_3<int32_t,::System::Type*,int32_t>,::GlobalNamespace::__BeatmapEventDataBoxGroup__ElementData*>*  _elementDataDict;

/// @brief Field _unpackedBeatmapEventData offset 0x20
 __declspec(property(get=__get__unpackedBeatmapEventData, put=__set__unpackedBeatmapEventData)) ::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapEventData*>*  _unpackedBeatmapEventData;

/// @brief Field _beatmapEventDataBoxList offset 0x28
 __declspec(property(get=__get__beatmapEventDataBoxList, put=__set__beatmapEventDataBoxList)) ::System::Collections::Generic::IReadOnlyCollection_1<::GlobalNamespace::BeatmapEventDataBox*>*  _beatmapEventDataBoxList;
...
constexpr void __set__elementDataDict(::System::Collections::Generic::Dictionary_2<::System::ValueTuple_3<int32_t,::System::Type*,int32_t>,::GlobalNamespace::__BeatmapEventDataBoxGroup__ElementData*>*  value) ;

constexpr ::System::Collections::Generic::Dictionary_2<::System::ValueTuple_3<int32_t,::System::Type*,int32_t>,::GlobalNamespace::__BeatmapEventDataBoxGroup__ElementData*>* __get__elementDataDict() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::System::ValueTuple_3<int32_t,::System::Type*,int32_t>,::GlobalNamespace::__BeatmapEventDataBoxGroup__ElementData*>*> __get__elementDataDict() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::BeatmapEventData*>*> __get__unpackedBeatmapEventData() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyCollection_1<::GlobalNamespace::BeatmapEventDataBox*>*> __get__beatmapEventDataBoxList() const;
...
// Ctor Parameters []
// @brief default ctor
 BeatmapEventDataBoxGroup()  = default;
public:
