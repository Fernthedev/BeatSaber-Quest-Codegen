...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4932)), TypeDefinitionIndex(TypeDefinitionIndex(4934)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4943), inst: 3959 }), TypeDefinitionIndex(TypeDefinitionIndex(4943)), TypeDefinitionIndex(TypeDefinitionIndex(4933))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::GlobalNamespace::LightTransformGroup_3<::GlobalNamespace::LightGroupRotationXTransform*,::GlobalNamespace::LightGroupRotationYTransform*,::GlobalNamespace::LightGroupRotationZTransform*>)]{};

static inline ::GlobalNamespace::LightRotationGroup* New_ctor() ;

/// @brief Method .ctor addr 0x23a9a28 size 0x48 virtual false final false
inline void _ctor() ;
