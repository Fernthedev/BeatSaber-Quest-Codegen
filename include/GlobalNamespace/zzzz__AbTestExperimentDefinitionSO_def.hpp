...
struct CORDL_TYPE __AbTestExperimentDefinitionSO__Group : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____AbTestExperimentDefinitionSO__Group_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __AbTestExperimentDefinitionSO__Group(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __AbTestExperimentDefinitionSO__Group()  = default;
...
// Ctor Parameters []
// @brief default ctor
 AbTestExperimentDefinitionSO()  = default;
public:
