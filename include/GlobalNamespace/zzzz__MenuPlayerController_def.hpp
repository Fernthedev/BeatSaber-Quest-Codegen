...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::VRController*> __get__leftController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::VRController*> __get__rightController() const;
