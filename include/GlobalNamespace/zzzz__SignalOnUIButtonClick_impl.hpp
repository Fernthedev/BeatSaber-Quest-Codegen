...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::Signal*> GlobalNamespace::SignalOnUIButtonClick::__get__buttonClickedSignal() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::Signal*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> GlobalNamespace::SignalOnUIButtonClick::__get__button() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Button*, 0x20>(this);
}
