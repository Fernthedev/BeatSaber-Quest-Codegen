...
/// @brief Field _averagingValueRecorer offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::AveragingValueRecorder*> __get__averagingValueRecorer() const;
...
// Ctor Parameters []
// @brief default ctor
 MovementHistoryRecorder()  = default;
public:
