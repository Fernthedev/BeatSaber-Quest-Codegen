...
struct CORDL_TYPE __PlatformLeaderboardViewController___Refresh_d__30 : public ::bs_hook::ValueTypeWrapper<0x40> {
public:
// Declarations
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlatformLeaderboardViewController*> __get___4__this() const;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncVoidMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "__4__this", ty: "::GlobalNamespace::PlatformLeaderboardViewController*", modifiers: "", def_value: None }, CppParam { name: "showLoadingIndicator", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "clear", ty: "bool", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter", modifiers: "", def_value: None }]
constexpr __PlatformLeaderboardViewController___Refresh_d__30(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncVoidMethodBuilder  __t__builder, ::GlobalNamespace::PlatformLeaderboardViewController*  __4__this, bool  showLoadingIndicator, bool  clear, ::System::Runtime::CompilerServices::TaskAwaiter  __u__1) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __PlatformLeaderboardViewController___Refresh_d__30(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x40>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __PlatformLeaderboardViewController___Refresh_d__30()  = default;
...
/// @brief Field clear offset 0x28
 __declspec(property(get=__get_clear, put=__set_clear)) bool  clear;

/// @brief Field showLoadingIndicator offset 0x29
 __declspec(property(get=__get_showLoadingIndicator, put=__set_showLoadingIndicator)) bool  showLoadingIndicator;
...
// Ctor Parameters []
// @brief default ctor
 __PlatformLeaderboardViewController___RefreshDelayed_d__32()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xe8 - sizeof(::GlobalNamespace::LeaderboardViewController)]{};

/// @brief Field _leaderboardTableView offset 0x70
...
/// @brief Field _scopeSegmentedControl offset 0x78
...
/// @brief Field _aroundPlayerLeaderboardIcon offset 0x90
...
/// @brief Field _friendsLeaderboardIcon offset 0x98
...
/// @brief Field _playerDataModel offset 0xb0
 __declspec(property(get=__get__playerDataModel, put=__set__playerDataModel)) ::GlobalNamespace::PlayerDataModel*  _playerDataModel;

/// @brief Field _getScoresAsyncRequest offset 0xb8
...
/// @brief Field _difficultyBeatmap offset 0xd0
...
/// @brief Field _refreshIsNeeded offset 0xd8
 __declspec(property(get=__get__refreshIsNeeded, put=__set__refreshIsNeeded)) bool  _refreshIsNeeded;

/// @brief Field _hasScoresData offset 0xd9
 __declspec(property(get=__get__hasScoresData, put=__set__hasScoresData)) bool  _hasScoresData;

/// @brief Field _scoreScopes offset 0xe0
 __declspec(property(get=__get__scoreScopes, put=__set__scoreScopes)) ::ArrayW<::GlobalNamespace::__PlatformLeaderboardsModel__ScoresScope,::Array<::GlobalNamespace::__PlatformLeaderboardsModel__ScoresScope>*>  _scoreScopes;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LeaderboardTableView*> __get__leaderboardTableView() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Sprite*> __get__globalLeaderboardIcon() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Sprite*> __get__aroundPlayerLeaderboardIcon() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Sprite*> __get__friendsLeaderboardIcon() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LevelStatsView*> __get__levelStatsView() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlatformLeaderboardsModel*> __get__leaderboardsModel() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::HMAsyncRequest*> __get__getScoresAsyncRequest() const;
...
// Ctor Parameters []
// @brief default ctor
 PlatformLeaderboardViewController()  = default;
public:


// Fields

// Static field _scoresScope
