...
template<::il2cpp_utils::il2cpp_reference_type T,::il2cpp_utils::il2cpp_reference_type TBase>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(14780))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(14780), inst: 81 })
// CS Name: ::SortedList`2<T,TBase>*
class CORDL_TYPE SortedList_2<T,TBase> : public ::System::Object {
public:
// Declarations
...
/// @brief Field _sortedListDataProcessor offset 0x18
...
/// @brief Field _lastUsedNode offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::LinkedList_1<TBase>*> __get__items() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ISortedListItemProcessor_1<TBase>*> __get__sortedListDataProcessor() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::LinkedListNode_1<TBase>*> __get__lastUsedNode() const;
