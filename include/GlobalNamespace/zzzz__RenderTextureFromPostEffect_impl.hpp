...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RenderTexture*> GlobalNamespace::RenderTextureFromPostEffect::__get__targetTexture() const {
return ::cordl_internals::getInstanceField<::UnityEngine::RenderTexture*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Camera*> GlobalNamespace::RenderTextureFromPostEffect::__get__camera() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Camera*, 0x20>(this);
}
