...
/// @brief Method .ctor addr 0x236b05c size 0x1c virtual false final false
inline void _ctor() ;
...
/// @brief Method .ctor addr 0x236b078 size 0x40 virtual false final false
...
/// @brief Method AgreeToEula addr 0x236b0b8 size 0xc virtual false final false
inline void AgreeToEula() ;

/// @brief Method AgreeToPrivacyPolicy addr 0x236b0c4 size 0xc virtual false final false
inline void AgreeToPrivacyPolicy() ;

/// @brief Method AgreeToHealthAndSafety addr 0x236b0d0 size 0xc virtual false final false
inline void AgreeToHealthAndSafety() ;

/// @brief Method AgreeToPlayerSensitivityFlag addr 0x236b0dc size 0xc virtual false final false
inline void AgreeToPlayerSensitivityFlag() ;

/// @brief Method AgreedToPreviousPrivacyPolicy addr 0x236b0e8 size 0x10 virtual false final false
inline bool AgreedToPreviousPrivacyPolicy() ;

/// @brief Method AgreedToAnyPreviousEula addr 0x236b0f8 size 0x1c virtual false final false
inline bool AgreedToAnyPreviousEula() ;

/// @brief Method AgreedToAnyPreviousPrivacyPolicy addr 0x236b114 size 0x1c virtual false final false
inline bool AgreedToAnyPreviousPrivacyPolicy() ;

/// @brief Method AgreedToAnyPreviousHealthAndSafety addr 0x236b130 size 0xc virtual false final false
inline bool AgreedToAnyPreviousHealthAndSafety() ;

/// @brief Method AgreedToAnyPreviousPlayerSensitivityFlag addr 0x236b13c size 0xc virtual false final false
inline bool AgreedToAnyPreviousPlayerSensitivityFlag() ;

/// @brief Method AgreedToEula addr 0x236b148 size 0x10 virtual false final false
inline bool AgreedToEula() ;

/// @brief Method AgreedToPrivacyPolicy addr 0x236b158 size 0x10 virtual false final false
inline bool AgreedToPrivacyPolicy() ;

/// @brief Method AgreedToHealthAndSafety addr 0x236b168 size 0x10 virtual false final false
inline bool AgreedToHealthAndSafety() ;

/// @brief Method AgreedToPlayerSenstivityFlag addr 0x236b178 size 0x10 virtual false final false
