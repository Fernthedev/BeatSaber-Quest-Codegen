...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(16252))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::GlobalNamespace::NullAllowed)]{};
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__valueToCompare() const;
