...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BakedLightDataLoader::*)(::GlobalNamespace::LightmapDataSO*)>(&::GlobalNamespace::BakedLightDataLoader::set_lightmapData)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "set_lightmapData",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::LightmapDataSO*>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::BakedLightDataLoader::*)()>(&::GlobalNamespace::BakedLightDataLoader::_ctor)> {
  constexpr static std::size_t size = 0x8;
...
::cordl_internals::setInstanceField<::GlobalNamespace::LightmapDataSO*, 0x18>(this, std::forward<::GlobalNamespace::LightmapDataSO*>(value));
}
constexpr ::GlobalNamespace::LightmapDataSO* GlobalNamespace::BakedLightDataLoader::__get__lightmapData()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::LightmapDataSO*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LightmapDataSO*> GlobalNamespace::BakedLightDataLoader::__get__lightmapData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::LightmapDataSO*, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::UnityEngine::Texture2D*, 0x20>(this, std::forward<::UnityEngine::Texture2D*>(value));
}
constexpr ::UnityEngine::Texture2D* GlobalNamespace::BakedLightDataLoader::__get__blackTexture()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Texture2D*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Texture2D*> GlobalNamespace::BakedLightDataLoader::__get__blackTexture() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Texture2D*, 0x20>(this);
}
