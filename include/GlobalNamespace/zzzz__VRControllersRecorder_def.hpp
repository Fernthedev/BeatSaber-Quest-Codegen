...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x10 - sizeof(::System::Runtime::Serialization::SerializationBinder)]{};
...
// Ctor Parameters []
// @brief default ctor
 __VRControllersRecorder__TypeSerializationBinder()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __VRControllersRecorder__SavedData__KeyframeSerializable()  = default;
public:
...
/// @brief Field _keyframes offset 0x10
 __declspec(property(get=__get__keyframes, put=__set__keyframes)) ::ArrayW<::GlobalNamespace::__VRControllersRecorder__SavedData__KeyframeSerializable*,::Array<::GlobalNamespace::__VRControllersRecorder__SavedData__KeyframeSerializable*>*>  _keyframes;

constexpr void __set__keyframes(::ArrayW<::GlobalNamespace::__VRControllersRecorder__SavedData__KeyframeSerializable*,::Array<::GlobalNamespace::__VRControllersRecorder__SavedData__KeyframeSerializable*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__VRControllersRecorder__SavedData__KeyframeSerializable*,::Array<::GlobalNamespace::__VRControllersRecorder__SavedData__KeyframeSerializable*>*>& __get__keyframes() ;

constexpr ::ArrayW<::GlobalNamespace::__VRControllersRecorder__SavedData__KeyframeSerializable*,::Array<::GlobalNamespace::__VRControllersRecorder__SavedData__KeyframeSerializable*>*> const& __get__keyframes() const;
...
// Ctor Parameters []
// @brief default ctor
 __VRControllersRecorder__SavedData()  = default;
public:
...
struct CORDL_TYPE __VRControllersRecorder__Mode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____VRControllersRecorder__Mode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __VRControllersRecorder__Mode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __VRControllersRecorder__Mode()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __VRControllersRecorder__Keyframe()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __VRControllersRecorder__State____c()  = default;
public:
...
/// @brief Field _version offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__VRControllersRecorder__Keyframe*>*> __get__keyframes() const;
...
// Ctor Parameters []
// @brief default ctor
 __VRControllersRecorder__State()  = default;
public:
...
/// @brief Field _controller0Transform offset 0x98
...
/// @brief Field _controller1Transform offset 0xa0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Camera*> __get__recorderCamera() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__spawnRotationTransform() const;

constexpr void __set__originTransform(::UnityEngine::Transform*  value) ;

constexpr ::UnityEngine::Transform* __get__originTransform() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__originTransform() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__controller0Transform() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__controller1Transform() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__VRControllersRecorder__State*> __get__state() const;
