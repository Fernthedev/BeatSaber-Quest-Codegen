...
template<::il2cpp_utils::il2cpp_reference_type TBase,::il2cpp_utils::il2cpp_reference_type TIn,::il2cpp_utils::il2cpp_reference_type TOut>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4293)), TypeDefinitionIndex(TypeDefinitionIndex(4292)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4292), inst: 1155 })}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(4293), inst: 5330 })
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x10 - sizeof(::GlobalNamespace::DataItemConvertor_3<TBase,TIn,TOut>)]{};
...
// Ctor Parameters []
// @brief default ctor
 DefaultDataConvertor_3()  = default;
public:
