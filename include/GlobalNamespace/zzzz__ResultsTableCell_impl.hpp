...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> GlobalNamespace::ResultsTableCell::__get__border() const {
return ::cordl_internals::getInstanceField<::UnityEngine::GameObject*, 0x60>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> GlobalNamespace::ResultsTableCell::__get__orderText() const {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x68>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> GlobalNamespace::ResultsTableCell::__get__nameText() const {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x70>(this);
}
constexpr void GlobalNamespace::ResultsTableCell::__set__scoreText(::TMPro::TextMeshProUGUI*  value)  {
::cordl_internals::setInstanceField<::TMPro::TextMeshProUGUI*, 0x78>(this, std::forward<::TMPro::TextMeshProUGUI*>(value));
}
constexpr ::TMPro::TextMeshProUGUI* GlobalNamespace::ResultsTableCell::__get__scoreText()  {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x78>(this);
}
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> GlobalNamespace::ResultsTableCell::__get__scoreText() const {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x78>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> GlobalNamespace::ResultsTableCell::__get__rankText() const {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x80>(this);
}
