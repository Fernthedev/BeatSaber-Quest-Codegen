...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::GlobalNamespace::BeatmapObjectData)]{};

/// @brief Field <offsetDirection>k__BackingField offset 0x20
...
/// @brief Field <lineIndex>k__BackingField offset 0x24
...
/// @brief Field <lineLayer>k__BackingField offset 0x28
