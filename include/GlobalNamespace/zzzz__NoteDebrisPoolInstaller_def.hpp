...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x58 - sizeof(::Zenject::ScriptableObjectInstaller)]{};

/// @brief Field _normalNoteDebrisHDPrefab offset 0x20
...
/// @brief Field _normalNoteDebrisLWPrefab offset 0x28
...
/// @brief Field _burstSliderHeadNoteDebrisHDPrefab offset 0x30
...
/// @brief Field _burstSliderHeadNoteDebrisLWPrefab offset 0x38
...
/// @brief Field _burstSliderElementNoteHDPrefab offset 0x40
...
/// @brief Field _burstSliderElementNoteLWPrefab offset 0x48
...
/// @brief Field _noteDebrisHDConditionVariable offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NoteDebris*> __get__normalNoteDebrisHDPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NoteDebris*> __get__normalNoteDebrisLWPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NoteDebris*> __get__burstSliderHeadNoteDebrisHDPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NoteDebris*> __get__burstSliderHeadNoteDebrisLWPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NoteDebris*> __get__burstSliderElementNoteHDPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NoteDebris*> __get__burstSliderElementNoteLWPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get__noteDebrisHDConditionVariable() const;
...
// Ctor Parameters []
// @brief default ctor
 NoteDebrisPoolInstaller()  = default;
public:
