...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x128 - sizeof(::GlobalNamespace::ObstacleController)]{};

/// @brief Field _multiplayerConnectedPlayerObstacleClippingController offset 0x120
 __declspec(property(get=__get__multiplayerConnectedPlayerObstacleClippingController, put=__set__multiplayerConnectedPlayerObstacleClippingController)) ::GlobalNamespace::MultiplayerConnectedPlayerObstacleClippingController*  _multiplayerConnectedPlayerObstacleClippingController;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerConnectedPlayerObstacleClippingController*> __get__multiplayerConnectedPlayerObstacleClippingController() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerConnectedPlayerObstacleController()  = default;
public:
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5142)), TypeDefinitionIndex(TypeDefinitionIndex(11050)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11050), inst: 2820 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::Zenject::MonoMemoryPool_1<::GlobalNamespace::MultiplayerConnectedPlayerObstacleController*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerConnectedPlayerObstacleController__Pool()  = default;
public:
