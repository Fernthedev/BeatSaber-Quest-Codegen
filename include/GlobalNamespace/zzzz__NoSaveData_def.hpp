...
/// @brief Method Save addr 0x20f4c1c size 0x4 virtual true final true
inline void Save(::StringW  key, ::StringW  value) ;

/// @brief Method Load addr 0x20f4c20 size 0xc virtual true final true
inline bool Load(::StringW  key, ByRef<::StringW>  value) ;

/// @brief Method Save addr 0x20f4c2c size 0x4 virtual true final true
inline void Save(::StringW  key, ::StringW  value, ::StringW  tempKey, ::StringW  backupKey) ;

/// @brief Method Load addr 0x20f4c30 size 0xc virtual true final true
inline bool Load(::StringW  key, ByRef<::StringW>  value, ::StringW  backupKey) ;

/// @brief Method Delete addr 0x20f4c3c size 0x4 virtual true final true
inline void Delete(::StringW  key) ;

/// @brief Method HasKey addr 0x20f4c40 size 0x8 virtual true final true
inline bool HasKey(::StringW  key) ;

static inline ::GlobalNamespace::NoSaveData* New_ctor() ;

/// @brief Method .ctor addr 0x20f4c48 size 0x8 virtual false final false
inline void _ctor() ;
