...
struct CORDL_TYPE __Interop__Error : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____Interop__Error_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __Interop__Error(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Interop__Error()  = default;
...
struct CORDL_TYPE __Interop__ErrorInfo : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x8};

/// @brief Field _error offset 0x0
 __declspec(property(get=__get__error, put=__set__error)) ::GlobalNamespace::__Interop__Error  _error;

/// @brief Field _rawErrno offset 0x4
 __declspec(property(get=__get__rawErrno, put=__set__rawErrno)) int32_t  _rawErrno;
...
constexpr void __set__error(::GlobalNamespace::__Interop__Error  value) ;

constexpr ::GlobalNamespace::__Interop__Error& __get__error() ;

constexpr ::GlobalNamespace::__Interop__Error const& __get__error() const;

constexpr void __set__rawErrno(int32_t  value) ;

constexpr int32_t& __get__rawErrno() ;

constexpr int32_t const& __get__rawErrno() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Interop__ErrorInfo(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Interop__ErrorInfo()  = default;
...
struct CORDL_TYPE __Interop__Sys__NodeType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____Interop__Sys__NodeType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Interop__Sys__NodeType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Interop__Sys__NodeType()  = default;
...
struct CORDL_TYPE __Interop__Sys__DirectoryEntry : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field Name offset 0x0
 __declspec(property(get=__get_Name, put=__set_Name)) ::cordl_internals::Ptr<uint8_t>  Name;

/// @brief Field NameLength offset 0x8
 __declspec(property(get=__get_NameLength, put=__set_NameLength)) int32_t  NameLength;

/// @brief Field InodeType offset 0xc
 __declspec(property(get=__get_InodeType, put=__set_InodeType)) ::GlobalNamespace::__Interop__Sys__NodeType  InodeType;

constexpr void __set_Name(::cordl_internals::Ptr<uint8_t>  value) ;

constexpr ::cordl_internals::Ptr<uint8_t>& __get_Name() ;

constexpr ::cordl_internals::Ptr<uint8_t> const& __get_Name() const;

constexpr void __set_NameLength(int32_t  value) ;

constexpr int32_t& __get_NameLength() ;

constexpr int32_t const& __get_NameLength() const;

constexpr void __set_InodeType(::GlobalNamespace::__Interop__Sys__NodeType  value) ;

constexpr ::GlobalNamespace::__Interop__Sys__NodeType& __get_InodeType() ;

constexpr ::GlobalNamespace::__Interop__Sys__NodeType const& __get_InodeType() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Interop__Sys__DirectoryEntry(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Interop__Sys__DirectoryEntry()  = default;
...
struct CORDL_TYPE __Interop__Sys__FileStatus : public ::bs_hook::ValueTypeWrapper<0x70> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x70};

/// @brief Field Flags offset 0x0
 __declspec(property(get=__get_Flags, put=__set_Flags)) ::GlobalNamespace::__Interop__Sys__FileStatusFlags  Flags;

/// @brief Field Mode offset 0x4
 __declspec(property(get=__get_Mode, put=__set_Mode)) int32_t  Mode;

/// @brief Field Uid offset 0x8
 __declspec(property(get=__get_Uid, put=__set_Uid)) uint32_t  Uid;

/// @brief Field Gid offset 0xc
 __declspec(property(get=__get_Gid, put=__set_Gid)) uint32_t  Gid;

/// @brief Field Size offset 0x10
 __declspec(property(get=__get_Size, put=__set_Size)) int64_t  Size;

/// @brief Field ATime offset 0x18
 __declspec(property(get=__get_ATime, put=__set_ATime)) int64_t  ATime;

/// @brief Field ATimeNsec offset 0x20
 __declspec(property(get=__get_ATimeNsec, put=__set_ATimeNsec)) int64_t  ATimeNsec;

/// @brief Field MTime offset 0x28
 __declspec(property(get=__get_MTime, put=__set_MTime)) int64_t  MTime;

/// @brief Field MTimeNsec offset 0x30
 __declspec(property(get=__get_MTimeNsec, put=__set_MTimeNsec)) int64_t  MTimeNsec;

/// @brief Field CTime offset 0x38
 __declspec(property(get=__get_CTime, put=__set_CTime)) int64_t  CTime;

/// @brief Field CTimeNsec offset 0x40
 __declspec(property(get=__get_CTimeNsec, put=__set_CTimeNsec)) int64_t  CTimeNsec;

/// @brief Field BirthTime offset 0x48
 __declspec(property(get=__get_BirthTime, put=__set_BirthTime)) int64_t  BirthTime;

/// @brief Field BirthTimeNsec offset 0x50
 __declspec(property(get=__get_BirthTimeNsec, put=__set_BirthTimeNsec)) int64_t  BirthTimeNsec;

/// @brief Field Dev offset 0x58
 __declspec(property(get=__get_Dev, put=__set_Dev)) int64_t  Dev;

/// @brief Field Ino offset 0x60
 __declspec(property(get=__get_Ino, put=__set_Ino)) int64_t  Ino;

/// @brief Field UserFlags offset 0x68
 __declspec(property(get=__get_UserFlags, put=__set_UserFlags)) uint32_t  UserFlags;

constexpr void __set_Flags(::GlobalNamespace::__Interop__Sys__FileStatusFlags  value) ;

constexpr ::GlobalNamespace::__Interop__Sys__FileStatusFlags& __get_Flags() ;

constexpr ::GlobalNamespace::__Interop__Sys__FileStatusFlags const& __get_Flags() const;
...
constexpr uint32_t& __get_Uid() ;

constexpr uint32_t const& __get_Uid() const;

constexpr void __set_Gid(uint32_t  value) ;

constexpr uint32_t& __get_Gid() ;

constexpr uint32_t const& __get_Gid() const;

constexpr void __set_Size(int64_t  value) ;

constexpr int64_t& __get_Size() ;

constexpr int64_t const& __get_Size() const;

constexpr void __set_ATime(int64_t  value) ;

constexpr int64_t& __get_ATime() ;

constexpr int64_t const& __get_ATime() const;

constexpr void __set_ATimeNsec(int64_t  value) ;

constexpr int64_t& __get_ATimeNsec() ;

constexpr int64_t const& __get_ATimeNsec() const;

constexpr void __set_MTime(int64_t  value) ;

constexpr int64_t& __get_MTime() ;

constexpr int64_t const& __get_MTime() const;

constexpr void __set_MTimeNsec(int64_t  value) ;

constexpr int64_t& __get_MTimeNsec() ;

constexpr int64_t const& __get_MTimeNsec() const;

constexpr void __set_CTime(int64_t  value) ;

constexpr int64_t& __get_CTime() ;

constexpr int64_t const& __get_CTime() const;

constexpr void __set_CTimeNsec(int64_t  value) ;

constexpr int64_t& __get_CTimeNsec() ;

constexpr int64_t const& __get_CTimeNsec() const;

constexpr void __set_BirthTime(int64_t  value) ;

constexpr int64_t& __get_BirthTime() ;

constexpr int64_t const& __get_BirthTime() const;

constexpr void __set_BirthTimeNsec(int64_t  value) ;

constexpr int64_t& __get_BirthTimeNsec() ;

constexpr int64_t const& __get_BirthTimeNsec() const;

constexpr void __set_Dev(int64_t  value) ;

constexpr int64_t& __get_Dev() ;

constexpr int64_t const& __get_Dev() const;

constexpr void __set_Ino(int64_t  value) ;

constexpr int64_t& __get_Ino() ;

constexpr int64_t const& __get_Ino() const;

constexpr void __set_UserFlags(uint32_t  value) ;

constexpr uint32_t& __get_UserFlags() ;

constexpr uint32_t const& __get_UserFlags() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Interop__Sys__FileStatus(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x70>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Interop__Sys__FileStatus()  = default;
...
struct CORDL_TYPE __Interop__Sys__FileStatusFlags : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____Interop__Sys__FileStatusFlags_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Interop__Sys__FileStatusFlags(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Interop__Sys__FileStatusFlags()  = default;
...
struct CORDL_TYPE __Interop__Sys__Permissions : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____Interop__Sys__Permissions_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __Interop__Sys__Permissions(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __Interop__Sys__Permissions()  = default;
...
static inline ::cordl_internals::intptr_t OpenDir(::StringW  path) ;
...
static inline int32_t ReadDirR(::cordl_internals::intptr_t  dir, ::cordl_internals::Ptr<uint8_t>  buffer, int32_t  bufferSize, ByRef<::GlobalNamespace::__Interop__Sys__DirectoryEntry>  outputEntry) ;

/// @brief Method CloseDir addr 0x2411318 size 0x1c virtual false final false
static inline int32_t CloseDir(::cordl_internals::intptr_t  dir) ;
...
// Ctor Parameters []
// @brief default ctor
 __Interop__Sys()  = default;
public:


// Fields

// Static field CanSetHiddenFlag
