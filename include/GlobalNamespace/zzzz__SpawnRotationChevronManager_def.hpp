...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SpawnRotationChevron*> __get_chevron() const;
...
// Ctor Parameters []
// @brief default ctor
 __SpawnRotationChevronManager__DirectionData()  = default;
public:
...
/// @brief Field _fadeOutLightAmountCurve offset 0x30
...
/// @brief Field _chevronPool offset 0x38
...
/// @brief Field _beatmapObjectSpawnController offset 0x48
...
/// @brief Field _spawnRotationDataCallbackWrapper offset 0x58
...
/// @brief Field _beatmapObjectDataCallbackWrapper offset 0x60
...
/// @brief Field _directionToDataDictionary offset 0x68
 __declspec(property(get=__get__directionToDataDictionary, put=__set__directionToDataDictionary)) ::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::__SpawnRotationChevronManager__DirectionData*>*  _directionToDataDictionary;

/// @brief Field _activeDirections offset 0x70
...
/// @brief Field _reusableDirectionsList offset 0x78
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get__fadeInLightAmountCurve() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get__fadeOutLightAmountCurve() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__SpawnRotationChevron__Pool*> __get__chevronPool() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapDataCallbackWrapper*> __get__spawnRotationDataCallbackWrapper() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapDataCallbackWrapper*> __get__beatmapObjectDataCallbackWrapper() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::GlobalNamespace::__SpawnRotationChevronManager__DirectionData*>*> __get__directionToDataDictionary() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<int32_t>*> __get__activeDirections() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<int32_t>*> __get__reusableDirectionsList() const;
...
// Ctor Parameters []
// @brief default ctor
 SpawnRotationChevronManager()  = default;
public:
