...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::GlobalNamespace::ValueDropdownController_1<float_t>)]{};

/// @brief Method GetNamedValues addr 0x22ab8a0 size 0x198 virtual true final false
...
/// @brief Method .ctor addr 0x22aba38 size 0x48 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 NoteJumpStartBeatOffsetDropdown()  = default;
public:
