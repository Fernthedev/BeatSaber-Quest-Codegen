...
::cordl_internals::setInstanceField<::GlobalNamespace::Vector3SO*, 0x18>(this, std::forward<::GlobalNamespace::Vector3SO*>(value));
}
constexpr ::GlobalNamespace::Vector3SO* GlobalNamespace::VRControllersValueSOOffsets::__get__positionOffset()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::Vector3SO*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::Vector3SO*> GlobalNamespace::VRControllersValueSOOffsets::__get__positionOffset() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::Vector3SO*, 0x18>(this);
}
constexpr void GlobalNamespace::VRControllersValueSOOffsets::__set__rotationOffset(::GlobalNamespace::Vector3SO*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::Vector3SO*, 0x20>(this, std::forward<::GlobalNamespace::Vector3SO*>(value));
}
constexpr ::GlobalNamespace::Vector3SO* GlobalNamespace::VRControllersValueSOOffsets::__get__rotationOffset()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::Vector3SO*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::Vector3SO*> GlobalNamespace::VRControllersValueSOOffsets::__get__rotationOffset() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::Vector3SO*, 0x20>(this);
}
