...
// Ctor Parameters []
// @brief default ctor
 __PerceivedLoudnessPerLevelSO__PerceivedLevelLoudnessPair()  = default;
public:
...
/// @brief Field perceivedLoudnessPerLevel offset 0x18
 __declspec(property(get=__get_perceivedLoudnessPerLevel, put=__set_perceivedLoudnessPerLevel)) ::ArrayW<::GlobalNamespace::__PerceivedLoudnessPerLevelSO__PerceivedLevelLoudnessPair*,::Array<::GlobalNamespace::__PerceivedLoudnessPerLevelSO__PerceivedLevelLoudnessPair*>*>  perceivedLoudnessPerLevel;

constexpr void __set_perceivedLoudnessPerLevel(::ArrayW<::GlobalNamespace::__PerceivedLoudnessPerLevelSO__PerceivedLevelLoudnessPair*,::Array<::GlobalNamespace::__PerceivedLoudnessPerLevelSO__PerceivedLevelLoudnessPair*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__PerceivedLoudnessPerLevelSO__PerceivedLevelLoudnessPair*,::Array<::GlobalNamespace::__PerceivedLoudnessPerLevelSO__PerceivedLevelLoudnessPair*>*>& __get_perceivedLoudnessPerLevel() ;

constexpr ::ArrayW<::GlobalNamespace::__PerceivedLoudnessPerLevelSO__PerceivedLevelLoudnessPair*,::Array<::GlobalNamespace::__PerceivedLoudnessPerLevelSO__PerceivedLevelLoudnessPair*>*> const& __get_perceivedLoudnessPerLevel() const;
...
// Ctor Parameters []
// @brief default ctor
 PerceivedLoudnessPerLevelSO()  = default;
public:
