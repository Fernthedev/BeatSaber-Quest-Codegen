...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::TutorialScenesTransitionSetupDataSO*> GlobalNamespace::TutorialReturnToMenuController::__get__tutorialSceneSetupData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::TutorialScenesTransitionSetupDataSO*, 0x18>(this);
}
