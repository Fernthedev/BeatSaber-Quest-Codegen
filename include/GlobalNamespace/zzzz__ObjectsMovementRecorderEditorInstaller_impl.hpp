...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ObjectsMovementRecorderEditorInstaller::*)()>(&::GlobalNamespace::ObjectsMovementRecorderEditorInstaller::InstallBindings)> {
  ...
  constexpr static std::size_t addrs = 0x23001dc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ObjectsMovementRecorderEditorInstaller::*)()>(&::GlobalNamespace::ObjectsMovementRecorderEditorInstaller::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x23001e0;
