...
template<typename T>
inline ::System::Collections::Generic::IReadOnlyList_1<T>* GlobalNamespace::DifficultyBeatmapSetExtensions::GetDifficultyBeatmapSetsWithout360Movement(::System::Collections::Generic::IReadOnlyList_1<T>*  difficultyBeatmapSets)  {
...
template<typename T>
inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::PreviewDifficultyBeatmapSet*>* GlobalNamespace::DifficultyBeatmapSetExtensions::GetPreviewDifficultyBeatmapSets(::System::Collections::Generic::IReadOnlyList_1<T>*  difficultyBeatmapSets)  {
static auto* ___internal_method_base = THROW_UNLESS((::il2cpp_utils::FindMethod(
                        ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::DifficultyBeatmapSetExtensions*>::get(),
