...
/// @brief Field _previewBeatmapLevelCollection offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PreviewBeatmapLevelCollectionSO*> __get__previewBeatmapLevelCollection() const;
...
// Ctor Parameters []
// @brief default ctor
 PreviewBeatmapLevelPackSO()  = default;
public:
