...
// Ctor Parameters []
// @brief default ctor
 __TriggerFloatFxGroupEffectManager____c()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::TriggerFloatFxGroupEffect*>*> __get__floatFxGroupEffects() const;
...
// Ctor Parameters []
// @brief default ctor
 TriggerFloatFxGroupEffectManager()  = default;
public:
