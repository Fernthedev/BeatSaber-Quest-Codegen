...
/// @brief Field _manualResetEvent offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::Thread*> __get__runThread() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::ManualResetEvent*> __get__manualResetEvent() const;

constexpr void __set__listener(::System::Net::HttpListener*  value) ;

constexpr ::System::Net::HttpListener* __get__listener() ;

constexpr ::cordl_internals::to_const_pointer<::System::Net::HttpListener*> __get__listener() const;
