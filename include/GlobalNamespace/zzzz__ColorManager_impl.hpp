...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (::GlobalNamespace::ColorManager::*)()>(&::GlobalNamespace::ColorManager::get_obstaclesColor)> {
  ...
  constexpr static std::size_t addrs = 0x22ec0cc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ColorManager::*)(::GlobalNamespace::ColorScheme*)>(&::GlobalNamespace::ColorManager::SetColorScheme)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x22ec0ec;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (::GlobalNamespace::ColorManager::*)(::GlobalNamespace::EnvironmentColorType, bool)>(&::GlobalNamespace::ColorManager::ColorForType)> {
  ...
  constexpr static std::size_t addrs = 0x22ec0f4;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            "ColorForType",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::EnvironmentColorType>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<bool>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (::GlobalNamespace::ColorManager::*)(::GlobalNamespace::ColorType)>(&::GlobalNamespace::ColorManager::ColorForType)> {
  ...
  constexpr static std::size_t addrs = 0x22ec1dc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (::GlobalNamespace::ColorManager::*)(::GlobalNamespace::SaberType)>(&::GlobalNamespace::ColorManager::ColorForSaberType)> {
  ...
  constexpr static std::size_t addrs = 0x22ec250;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (::GlobalNamespace::ColorManager::*)(::GlobalNamespace::SaberType)>(&::GlobalNamespace::ColorManager::EffectsColorForSaberType)> {
  ...
  constexpr static std::size_t addrs = 0x22ec2a4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::UnityEngine::Color (::GlobalNamespace::ColorManager::*)()>(&::GlobalNamespace::ColorManager::GetObstacleEffectColor)> {
  ...
  constexpr static std::size_t addrs = 0x22ec334;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::ColorManager::*)()>(&::GlobalNamespace::ColorManager::_ctor)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0x22ec390;
...
constexpr void GlobalNamespace::ColorManager::__set__colorScheme(::GlobalNamespace::ColorScheme*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::ColorScheme*, 0x10>(this, std::forward<::GlobalNamespace::ColorScheme*>(value));
}
constexpr ::GlobalNamespace::ColorScheme* GlobalNamespace::ColorManager::__get__colorScheme()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ColorScheme*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorScheme*> GlobalNamespace::ColorManager::__get__colorScheme() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ColorScheme*, 0x10>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::GlobalNamespace::ColorManager*>());
}
