...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerPlayersManager*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerPlayersManager___SwitchLocalPlayerToInactiveCoroutine_d__51()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xe0 - sizeof(::UnityEngine::MonoBehaviour)]{};

/// @brief Field _activeLocalPlayerControllerPrefab offset 0x18
 __declspec(property(get=__get__activeLocalPlayerControllerPrefab, put=__set__activeLocalPlayerControllerPrefab)) ::GlobalNamespace::MultiplayerLocalActivePlayerFacade*  _activeLocalPlayerControllerPrefab;

/// @brief Field _activeLocalPlayerDuelControllerPrefab offset 0x20
 __declspec(property(get=__get__activeLocalPlayerDuelControllerPrefab, put=__set__activeLocalPlayerDuelControllerPrefab)) ::GlobalNamespace::MultiplayerLocalActivePlayerFacade*  _activeLocalPlayerDuelControllerPrefab;

/// @brief Field _inactiveLocalPlayerControllerPrefab offset 0x28
 __declspec(property(get=__get__inactiveLocalPlayerControllerPrefab, put=__set__inactiveLocalPlayerControllerPrefab)) ::GlobalNamespace::MultiplayerLocalInactivePlayerFacade*  _inactiveLocalPlayerControllerPrefab;

/// @brief Field _connectedPlayerControllerPrefab offset 0x30
...
/// @brief Field _connectedPlayerDuelControllerPrefab offset 0x38
 __declspec(property(get=__get__connectedPlayerDuelControllerPrefab, put=__set__connectedPlayerDuelControllerPrefab)) ::GlobalNamespace::MultiplayerConnectedPlayerFacade*  _connectedPlayerDuelControllerPrefab;

/// @brief Field _multiplayerSessionManager offset 0x40
 __declspec(property(get=__get__multiplayerSessionManager, put=__set__multiplayerSessionManager)) ::GlobalNamespace::IMultiplayerSessionManager*  _multiplayerSessionManager;

/// @brief Field _beatmapObjectSpawnCenter offset 0x48
...
/// @brief Field _layoutProvider offset 0x50
...
/// @brief Field _fadeInOutController offset 0x58
...
/// @brief Field <playerSpawningFinished>k__BackingField offset 0x68
...
/// @brief Field playerSpawningDidFinishEvent offset 0x70
...
/// @brief Field didSwitchPlayerToInactiveEvent offset 0x78
...
/// @brief Field playerDidFinishEvent offset 0x80
...
/// @brief Field playerNetworkDidFailedEvent offset 0x88
 __declspec(property(get=__get_playerNetworkDidFailedEvent, put=__set_playerNetworkDidFailedEvent)) ::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  playerNetworkDidFailedEvent;

/// @brief Field _activeLocalPlayerFacade offset 0x90
...
/// @brief Field _inactiveLocalPlayerFacade offset 0x98
...
/// @brief Field _currentEventsPublisher offset 0xa0
...
/// @brief Field _currentStartSeekSongControllerProvider offset 0xa8
 __declspec(property(get=__get__currentStartSeekSongControllerProvider, put=__set__currentStartSeekSongControllerProvider)) ::GlobalNamespace::IStartSeekSongControllerProvider*  _currentStartSeekSongControllerProvider;

/// @brief Field _activeLocalPlayerFactory offset 0xb0
...
/// @brief Field _inactiveLocalPlayerFactory offset 0xb8
...
/// @brief Field _connectedPlayerFactory offset 0xc0
...
/// @brief Field _connectedPlayerControllersMap offset 0xc8
 __declspec(property(get=__get__connectedPlayerControllersMap, put=__set__connectedPlayerControllersMap)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::MultiplayerConnectedPlayerFacade*>*  _connectedPlayerControllersMap;

/// @brief Field _connectedPlayerCenterFacingRotationsMap offset 0xd0
 __declspec(property(get=__get__connectedPlayerCenterFacingRotationsMap, put=__set__connectedPlayerCenterFacingRotationsMap)) ::System::Collections::Generic::Dictionary_2<::StringW,float_t>*  _connectedPlayerCenterFacingRotationsMap;

/// @brief Field _allActiveAtGameStartPlayers offset 0xd8
 __declspec(property(get=__get__allActiveAtGameStartPlayers, put=__set__allActiveAtGameStartPlayers)) ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IConnectedPlayer*>*  _allActiveAtGameStartPlayers;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLocalActivePlayerFacade*> __get__activeLocalPlayerControllerPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLocalActivePlayerFacade*> __get__activeLocalPlayerDuelControllerPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLocalInactivePlayerFacade*> __get__inactiveLocalPlayerControllerPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerConnectedPlayerFacade*> __get__connectedPlayerControllerPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerConnectedPlayerFacade*> __get__connectedPlayerDuelControllerPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_playerSpawningDidFinishEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_didSwitchPlayerToInactiveEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*> __get_playerDidFinishEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*> __get_playerNetworkDidFailedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLocalActivePlayerFacade*> __get__activeLocalPlayerFacade() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLocalInactivePlayerFacade*> __get__inactiveLocalPlayerFacade() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IMultiplayerLevelEndActionsPublisher*> __get__currentEventsPublisher() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IStartSeekSongControllerProvider*> __get__currentStartSeekSongControllerProvider() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__MultiplayerLocalActivePlayerFacade__Factory*> __get__activeLocalPlayerFactory() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__MultiplayerLocalInactivePlayerFacade__Factory*> __get__inactiveLocalPlayerFactory() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__MultiplayerConnectedPlayerFacade__Factory*> __get__connectedPlayerFactory() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::MultiplayerConnectedPlayerFacade*>*> __get__connectedPlayerControllersMap() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,float_t>*> __get__connectedPlayerCenterFacingRotationsMap() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IConnectedPlayer*>*> __get__allActiveAtGameStartPlayers() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerPlayersManager()  = default;
public:
