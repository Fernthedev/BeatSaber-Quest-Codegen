...
struct CORDL_TYPE __OVRControllerHelper__ControllerType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____OVRControllerHelper__ControllerType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __OVRControllerHelper__ControllerType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRControllerHelper__ControllerType()  = default;
...
/// @brief Field m_modelOculusTouchQuestAndRiftSLeftController offset 0x18
 __declspec(property(get=__get_m_modelOculusTouchQuestAndRiftSLeftController, put=__set_m_modelOculusTouchQuestAndRiftSLeftController)) ::UnityEngine::GameObject*  m_modelOculusTouchQuestAndRiftSLeftController;

/// @brief Field m_modelOculusTouchQuestAndRiftSRightController offset 0x20
 __declspec(property(get=__get_m_modelOculusTouchQuestAndRiftSRightController, put=__set_m_modelOculusTouchQuestAndRiftSRightController)) ::UnityEngine::GameObject*  m_modelOculusTouchQuestAndRiftSRightController;

/// @brief Field m_modelOculusTouchRiftLeftController offset 0x28
...
/// @brief Field m_modelOculusTouchRiftRightController offset 0x30
...
/// @brief Field m_modelOculusTouchQuest2LeftController offset 0x38
...
/// @brief Field m_modelOculusTouchQuest2RightController offset 0x40
...
/// @brief Field m_modelMetaTouchProLeftController offset 0x48
...
/// @brief Field m_modelMetaTouchProRightController offset 0x50
...
/// @brief Field m_modelMetaTouchPlusLeftController offset 0x58
...
/// @brief Field m_modelMetaTouchPlusRightController offset 0x60
...
/// @brief Field showWhenHandsArePoweredByNaturalControllerPoses offset 0x70
...
/// @brief Field m_prevControllerConnected offset 0x90
...
/// @brief Field m_prevControllerConnectedCached offset 0x91
...
/// @brief Field m_prevControllerInHandState offset 0x94
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_modelOculusTouchQuestAndRiftSLeftController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_modelOculusTouchQuestAndRiftSRightController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_modelOculusTouchRiftLeftController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_modelOculusTouchRiftRightController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_modelOculusTouchQuest2LeftController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_modelOculusTouchQuest2RightController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_modelMetaTouchProLeftController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_modelMetaTouchProRightController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_modelMetaTouchPlusLeftController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_modelMetaTouchPlusRightController() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Animator*> __get_m_animator() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_m_activeController() const;
...
/// @brief Method Start addr 0x27a232c size 0x70 virtual false final false
inline void Start() ;

/// @brief Method InitializeControllerModels addr 0x27a239c size 0x49c virtual false final false
inline void InitializeControllerModels() ;

/// @brief Method Update addr 0x27a2838 size 0x880 virtual false final false
inline void Update() ;

/// @brief Method InputFocusAquired addr 0x27a30b8 size 0xc virtual false final false
inline void InputFocusAquired() ;

/// @brief Method InputFocusLost addr 0x27a30c4 size 0x8 virtual false final false
inline void InputFocusLost() ;

static inline ::GlobalNamespace::OVRControllerHelper* New_ctor() ;

/// @brief Method .ctor addr 0x27a30cc size 0x1c virtual false final false
inline void _ctor() ;
