...
struct CORDL_TYPE __MultiplayerLevelLoader__MultiplayerBeatmapLoaderState : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____MultiplayerLevelLoader__MultiplayerBeatmapLoaderState_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __MultiplayerLevelLoader__MultiplayerBeatmapLoaderState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MultiplayerLevelLoader__MultiplayerBeatmapLoaderState()  = default;
...
/// @brief Field _beatmapLevelsModel offset 0x18
...
/// @brief Field stillDownloadingSongEvent offset 0x20
...
/// @brief Field countdownFinishedEvent offset 0x28
 __declspec(property(get=__get_countdownFinishedEvent, put=__set_countdownFinishedEvent)) ::System::Action_2<::GlobalNamespace::ILevelGameplaySetupData*,::GlobalNamespace::IDifficultyBeatmap*>*  countdownFinishedEvent;

/// @brief Field _loaderState offset 0x30
...
/// @brief Field _getBeatmapCancellationTokenSource offset 0x38
...
/// @brief Field _getBeatmapLevelResultTask offset 0x40
 __declspec(property(get=__get__getBeatmapLevelResultTask, put=__set__getBeatmapLevelResultTask)) ::System::Threading::Tasks::Task_1<::GlobalNamespace::__BeatmapLevelsModel__GetBeatmapLevelResult>*  _getBeatmapLevelResultTask;

/// @brief Field _gameplaySetupData offset 0x48
...
/// @brief Field _difficultyBeatmap offset 0x50
...
/// @brief Field _startTime offset 0x58
 __declspec(property(get=__get__startTime, put=__set__startTime)) int64_t  _startTime;

/// @brief Field _stillDownloadingCalled offset 0x60
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_stillDownloadingSongEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::ILevelGameplaySetupData*,::GlobalNamespace::IDifficultyBeatmap*>*> __get_countdownFinishedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::CancellationTokenSource*> __get__getBeatmapCancellationTokenSource() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::Tasks::Task_1<::GlobalNamespace::__BeatmapLevelsModel__GetBeatmapLevelResult>*> __get__getBeatmapLevelResultTask() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ILevelGameplaySetupData*> __get__gameplaySetupData() const;
...
/// @brief Method add_stillDownloadingSongEvent addr 0x22a6bfc size 0x9c virtual false final false
inline void add_stillDownloadingSongEvent(::System::Action*  value) ;

/// @brief Method remove_stillDownloadingSongEvent addr 0x22a6c98 size 0x9c virtual false final false
inline void remove_stillDownloadingSongEvent(::System::Action*  value) ;

/// @brief Method add_countdownFinishedEvent addr 0x22a6d34 size 0xb0 virtual false final false
...
/// @brief Method remove_countdownFinishedEvent addr 0x22a6de4 size 0xb0 virtual false final false
...
/// @brief Method LoadLevel addr 0x22a6e94 size 0x1a8 virtual false final false
inline void LoadLevel(::GlobalNamespace::ILevelGameplaySetupData*  gameplaySetupData, int64_t  initialStartTime) ;

/// @brief Method SetNewStartTime addr 0x22a703c size 0x8 virtual false final false
inline void SetNewStartTime(int64_t  newStartTime) ;

/// @brief Method ClearLoading addr 0x22a7044 size 0x34 virtual false final false
inline void ClearLoading() ;

/// @brief Method Tick addr 0x22a7078 size 0x2ec virtual true final true
inline void Tick() ;

static inline ::GlobalNamespace::MultiplayerLevelLoader* New_ctor() ;

/// @brief Method .ctor addr 0x22a7364 size 0x8 virtual false final false
inline void _ctor() ;
