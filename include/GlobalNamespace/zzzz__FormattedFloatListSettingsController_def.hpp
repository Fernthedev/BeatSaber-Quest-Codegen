...
struct CORDL_TYPE __FormattedFloatListSettingsController__ValueType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____FormattedFloatListSettingsController__ValueType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __FormattedFloatListSettingsController__ValueType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __FormattedFloatListSettingsController__ValueType()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x58 - sizeof(::GlobalNamespace::ListSettingsController)]{};
...
/// @brief Field valueDidChangeEvent offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::FormattedFloatListSettingsController*,float_t>*> __get_valueDidChangeEvent() const;
...
// Ctor Parameters []
// @brief default ctor
 FormattedFloatListSettingsController()  = default;
public:
