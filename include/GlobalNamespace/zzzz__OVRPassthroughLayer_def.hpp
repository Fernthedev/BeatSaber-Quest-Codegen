...
struct CORDL_TYPE __OVRPassthroughLayer__ProjectionSurfaceType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____OVRPassthroughLayer__ProjectionSurfaceType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __OVRPassthroughLayer__ProjectionSurfaceType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer__ProjectionSurfaceType()  = default;
...
struct CORDL_TYPE __OVRPassthroughLayer__ColorMapEditorType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____OVRPassthroughLayer__ColorMapEditorType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRPassthroughLayer__ColorMapEditorType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer__ColorMapEditorType()  = default;
...
struct CORDL_TYPE __OVRPassthroughLayer__Settings : public ::bs_hook::ValueTypeWrapper<0x30> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x30};

/// @brief Field colorLutTargetTexture offset 0x0
 __declspec(property(get=__get_colorLutTargetTexture, put=__set_colorLutTargetTexture)) ::UnityEngine::Texture2D*  colorLutTargetTexture;

/// @brief Field colorLutSourceTexture offset 0x8
 __declspec(property(get=__get_colorLutSourceTexture, put=__set_colorLutSourceTexture)) ::UnityEngine::Texture2D*  colorLutSourceTexture;

/// @brief Field saturation offset 0x10
 __declspec(property(get=__get_saturation, put=__set_saturation)) float_t  saturation;

/// @brief Field posterize offset 0x14
 __declspec(property(get=__get_posterize, put=__set_posterize)) float_t  posterize;

/// @brief Field brightness offset 0x18
 __declspec(property(get=__get_brightness, put=__set_brightness)) float_t  brightness;

/// @brief Field contrast offset 0x1c
 __declspec(property(get=__get_contrast, put=__set_contrast)) float_t  contrast;

/// @brief Field gradient offset 0x20
 __declspec(property(get=__get_gradient, put=__set_gradient)) ::UnityEngine::Gradient*  gradient;

/// @brief Field lutWeight offset 0x28
 __declspec(property(get=__get_lutWeight, put=__set_lutWeight)) float_t  lutWeight;

/// @brief Field flipLutY offset 0x2c
 __declspec(property(get=__get_flipLutY, put=__set_flipLutY)) bool  flipLutY;

constexpr void __set_colorLutTargetTexture(::UnityEngine::Texture2D*  value) ;

constexpr ::UnityEngine::Texture2D* __get_colorLutTargetTexture() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Texture2D*> __get_colorLutTargetTexture() const;

constexpr void __set_colorLutSourceTexture(::UnityEngine::Texture2D*  value) ;

constexpr ::UnityEngine::Texture2D* __get_colorLutSourceTexture() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Texture2D*> __get_colorLutSourceTexture() const;

constexpr void __set_saturation(float_t  value) ;

constexpr float_t& __get_saturation() ;

constexpr float_t const& __get_saturation() const;

constexpr void __set_posterize(float_t  value) ;

constexpr float_t& __get_posterize() ;

constexpr float_t const& __get_posterize() const;
...
constexpr void __set_contrast(float_t  value) ;

constexpr float_t& __get_contrast() ;

constexpr float_t const& __get_contrast() const;

constexpr void __set_gradient(::UnityEngine::Gradient*  value) ;

constexpr ::UnityEngine::Gradient* __get_gradient() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Gradient*> __get_gradient() const;

constexpr void __set_lutWeight(float_t  value) ;

constexpr float_t& __get_lutWeight() ;

constexpr float_t const& __get_lutWeight() const;

constexpr void __set_flipLutY(bool  value) ;

constexpr bool& __get_flipLutY() ;

constexpr bool const& __get_flipLutY() const;

/// @brief Method .ctor addr 0x2751e60 size 0x20 virtual false final false
...
// Ctor Parameters [CppParam { name: "colorLutTargetTexture", ty: "::UnityEngine::Texture2D*", modifiers: "", def_value: None }, CppParam { name: "colorLutSourceTexture", ty: "::UnityEngine::Texture2D*", modifiers: "", def_value: None }, CppParam { name: "saturation", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "posterize", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "brightness", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "contrast", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "gradient", ty: "::UnityEngine::Gradient*", modifiers: "", def_value: None }, CppParam { name: "lutWeight", ty: "float_t", modifiers: "", def_value: None }, CppParam { name: "flipLutY", ty: "bool", modifiers: "", def_value: None }]
constexpr __OVRPassthroughLayer__Settings(::UnityEngine::Texture2D*  colorLutTargetTexture, ::UnityEngine::Texture2D*  colorLutSourceTexture, float_t  saturation, float_t  posterize, float_t  brightness, float_t  contrast, ::UnityEngine::Gradient*  gradient, float_t  lutWeight, bool  flipLutY) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRPassthroughLayer__Settings(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x30>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer__Settings()  = default;
...
struct CORDL_TYPE __OVRPassthroughLayer__PassthroughMeshInstance : public ::bs_hook::ValueTypeWrapper<0x58> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x58};

/// @brief Field meshHandle offset 0x0
 __declspec(property(get=__get_meshHandle, put=__set_meshHandle)) uint64_t  meshHandle;

/// @brief Field instanceHandle offset 0x8
 __declspec(property(get=__get_instanceHandle, put=__set_instanceHandle)) uint64_t  instanceHandle;

/// @brief Field updateTransform offset 0x10
 __declspec(property(get=__get_updateTransform, put=__set_updateTransform)) bool  updateTransform;

/// @brief Field localToWorld offset 0x14
 __declspec(property(get=__get_localToWorld, put=__set_localToWorld)) ::UnityEngine::Matrix4x4  localToWorld;

constexpr void __set_meshHandle(uint64_t  value) ;

constexpr uint64_t& __get_meshHandle() ;

constexpr uint64_t const& __get_meshHandle() const;

constexpr void __set_instanceHandle(uint64_t  value) ;

constexpr uint64_t& __get_instanceHandle() ;

constexpr uint64_t const& __get_instanceHandle() const;

constexpr void __set_updateTransform(bool  value) ;

constexpr bool& __get_updateTransform() ;

constexpr bool const& __get_updateTransform() const;

constexpr void __set_localToWorld(::UnityEngine::Matrix4x4  value) ;

constexpr ::UnityEngine::Matrix4x4& __get_localToWorld() ;

constexpr ::UnityEngine::Matrix4x4 const& __get_localToWorld() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRPassthroughLayer__PassthroughMeshInstance(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x58>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer__PassthroughMeshInstance()  = default;
...
struct CORDL_TYPE __OVRPassthroughLayer__SerializedSurfaceGeometry : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x10};

/// @brief Field meshFilter offset 0x0
 __declspec(property(get=__get_meshFilter, put=__set_meshFilter)) ::UnityEngine::MeshFilter*  meshFilter;

/// @brief Field updateTransform offset 0x8
 __declspec(property(get=__get_updateTransform, put=__set_updateTransform)) bool  updateTransform;

constexpr void __set_meshFilter(::UnityEngine::MeshFilter*  value) ;

constexpr ::UnityEngine::MeshFilter* __get_meshFilter() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::MeshFilter*> __get_meshFilter() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRPassthroughLayer__SerializedSurfaceGeometry(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer__SerializedSurfaceGeometry()  = default;
...
struct CORDL_TYPE __OVRPassthroughLayer__DeferredPassthroughMeshAddition : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x10};

/// @brief Field gameObject offset 0x0
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRPassthroughLayer__DeferredPassthroughMeshAddition(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer__DeferredPassthroughMeshAddition()  = default;
...
/// @brief Method ApplyStyleSettings addr 0x0 size 0xffffffffffffffff virtual true final false
...
/// @brief Field _noneHandler offset 0x10
...
/// @brief Field _lutHandler offset 0x18
...
/// @brief Field _interpolatedLutHandler offset 0x20
...
/// @brief Field _monoToRgbaHandler offset 0x28
...
/// @brief Field _monoToMonoHandler offset 0x30
...
/// @brief Field _bcsHandler offset 0x38
...
/// @brief Field _colorMapDataHandle offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRPassthroughLayer__NoneStyleHandler*> __get__noneHandler() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRPassthroughLayer__ColorLutHandler*> __get__lutHandler() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRPassthroughLayer__InterpolatedColorLutHandler*> __get__interpolatedLutHandler() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRPassthroughLayer__MonoToRgbaStyleHandler*> __get__monoToRgbaHandler() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRPassthroughLayer__MonoToMonoStyleHandler*> __get__monoToMonoHandler() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRPassthroughLayer__BCSStyleHandler*> __get__bcsHandler() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRPassthroughLayer__IStyleHandler*> __get_CurrentStyleHandler() const;

static inline ::GlobalNamespace::__OVRPassthroughLayer__StylesHandler* New_ctor() ;

/// @brief Method .ctor addr 0x2751e80 size 0x188 virtual false final false
inline void _ctor() ;

/// @brief Method SetStyleHandler addr 0x274fbac size 0xc4 virtual false final false
inline void SetStyleHandler(::GlobalNamespace::__OVRPlugin__InsightPassthroughColorMapType  type) ;

/// @brief Method GetStyleHandler addr 0x27521d8 size 0xe0 virtual false final false
...
/// @brief Method SetColorLutHandler addr 0x274f288 size 0x58 virtual false final false
inline void SetColorLutHandler(::GlobalNamespace::OVRPassthroughColorLut*  lut, float_t  weight) ;

/// @brief Method SetInterpolatedColorLutHandler addr 0x274f3fc size 0x64 virtual false final false
...
/// @brief Method SetMonoToRgbaHandler addr 0x274f0bc size 0x34 virtual false final false
inline void SetMonoToRgbaHandler(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  values) ;

/// @brief Method SetMonoToMonoHandler addr 0x274f864 size 0x5c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer__StylesHandler()  = default;
public:
...
/// @brief Method get_IsValid addr 0x27523b8 size 0x8 virtual true final true
inline bool get_IsValid() ;

/// @brief Method ApplyStyleSettings addr 0x27523c0 size 0x4 virtual true final true
inline void ApplyStyleSettings(ByRef<::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2>  style) ;

/// @brief Method Update addr 0x27523c4 size 0x4 virtual true final true
inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings  settings) ;

/// @brief Method Clear addr 0x27523c8 size 0x4 virtual true final true
inline void Clear() ;

static inline ::GlobalNamespace::__OVRPassthroughLayer__NoneStyleHandler* New_ctor() ;

/// @brief Method .ctor addr 0x2752130 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer__NoneStyleHandler()  = default;
public:
...
/// @brief Field _colorMapDataHandle offset 0x10
 __declspec(property(get=__get__colorMapDataHandle, put=__set__colorMapDataHandle)) ::System::Runtime::InteropServices::GCHandle  _colorMapDataHandle;

/// @brief Field _colorMapData offset 0x18
 __declspec(property(get=__get__colorMapData, put=__set__colorMapData)) ::ArrayW<uint8_t,::Array<uint8_t>*>  _colorMapData;
...
/// @brief Method get_MapSize addr 0x0 size 0xffffffffffffffff virtual true final false
inline uint32_t get_MapSize() ;

/// @brief Method get_IsValid addr 0x27523cc size 0x8 virtual true final true
inline bool get_IsValid() ;
...
/// @brief Method .ctor addr 0x27523d4 size 0x30 virtual false final false
...
/// @brief Method Update addr 0x2752404 size 0x4 virtual true final false
inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings  settings) ;

/// @brief Method ApplyStyleSettings addr 0x2752408 size 0x68 virtual true final false
inline void ApplyStyleSettings(ByRef<::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2>  style) ;

/// @brief Method Clear addr 0x2752470 size 0xc virtual true final true
inline void Clear() ;

/// @brief Method AllocateColorMapData addr 0x275247c size 0x90 virtual true final false
inline void AllocateColorMapData(uint32_t  size) ;

/// @brief Method DeallocateColorMapData addr 0x275250c size 0x28 virtual true final false
inline void DeallocateColorMapData() ;

/// @brief Method WriteColorToColorMap addr 0x2752534 size 0x188 virtual false final false
inline void WriteColorToColorMap(int32_t  colorIndex, ByRef<::UnityEngine::Color>  color) ;

/// @brief Method WriteFloatToColorMap addr 0x27526bc size 0x88 virtual false final false
inline void WriteFloatToColorMap(int32_t  index, float_t  value) ;

/// @brief Method ComputeBrightnessContrastPosterizeMap addr 0x2752744 size 0x174 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer__BaseGeneratedStyleHandler()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::GlobalNamespace::__OVRPassthroughLayer__BaseGeneratedStyleHandler)]{};

/// @brief Field _tmpColorMapData offset 0x20
...
/// @brief Method get_MapSize addr 0x27528b8 size 0x8 virtual true final false
inline uint32_t get_MapSize() ;
...
/// @brief Method .ctor addr 0x2752178 size 0x30 virtual false final false
inline void _ctor(ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method Update addr 0x27528c0 size 0xbc virtual true final false
inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings  settings) ;

/// @brief Method Update addr 0x2752300 size 0x74 virtual false final false
inline void Update(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  values) ;

/// @brief Method AllocateColorMapData addr 0x275297c size 0x68 virtual true final false
inline void AllocateColorMapData(uint32_t  size) ;

/// @brief Method DeallocateColorMapData addr 0x27529e4 size 0x2c virtual true final false
inline void DeallocateColorMapData() ;
...
// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer__MonoToRgbaStyleHandler()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::GlobalNamespace::__OVRPassthroughLayer__BaseGeneratedStyleHandler)]{};

 __declspec(property(get=get_MapSize)) uint32_t  MapSize;

/// @brief Method get_MapSize addr 0x2752a10 size 0x8 virtual true final false
inline uint32_t get_MapSize() ;
...
/// @brief Method .ctor addr 0x2752148 size 0x30 virtual false final false
inline void _ctor(ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method Update addr 0x2752a18 size 0x38 virtual true final false
inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings  settings) ;

/// @brief Method Update addr 0x2752374 size 0x44 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer__MonoToMonoStyleHandler()  = default;
public:
...
/// @brief Method get_MapSize addr 0x2752a50 size 0x8 virtual true final false
inline uint32_t get_MapSize() ;
...
/// @brief Method .ctor addr 0x27521a8 size 0x30 virtual false final false
inline void _ctor(ByRef<::System::Runtime::InteropServices::GCHandle>  colorMapDataHandler, ::ArrayW<uint8_t,::Array<uint8_t>*>  colorMapData) ;

/// @brief Method Update addr 0x2752a58 size 0x78 virtual true final false
inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings  settings) ;
...
// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer__BCSStyleHandler()  = default;
public:
...
/// @brief Field <Lut>k__BackingField offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Texture2D*> __get__currentColorLutSourceTexture() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRPassthroughColorLut*> __get__Lut_k__BackingField() const;
...
/// @brief Method get_Lut addr 0x2752ad0 size 0x8 virtual false final false
inline ::GlobalNamespace::OVRPassthroughColorLut* get_Lut() ;

/// @brief Method set_Lut addr 0x2752ad8 size 0x8 virtual false final false
inline void set_Lut(::GlobalNamespace::OVRPassthroughColorLut*  value) ;

/// @brief Method get_Weight addr 0x2752ae0 size 0x8 virtual false final false
inline float_t get_Weight() ;

/// @brief Method set_Weight addr 0x2752ae8 size 0x8 virtual false final false
inline void set_Weight(float_t  value) ;

/// @brief Method get_IsValid addr 0x2752af0 size 0x8 virtual true final true
inline bool get_IsValid() ;

/// @brief Method set_IsValid addr 0x2752af8 size 0xc virtual false final false
inline void set_IsValid(bool  value) ;

/// @brief Method ApplyStyleSettings addr 0x2752b04 size 0x28 virtual true final false
inline void ApplyStyleSettings(ByRef<::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2>  style) ;

/// @brief Method Update addr 0x2752b2c size 0x54 virtual true final false
inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings  settings) ;

/// @brief Method GetColorLutForTexture addr 0x2752b80 size 0x160 virtual false final false
...
/// @brief Method Update addr 0x27522b8 size 0x20 virtual false final false
inline void Update(::GlobalNamespace::OVRPassthroughColorLut*  lut, float_t  weight) ;

/// @brief Method Clear addr 0x2752ce0 size 0x8 virtual true final false
inline void Clear() ;

static inline ::GlobalNamespace::__OVRPassthroughLayer__ColorLutHandler* New_ctor() ;

/// @brief Method .ctor addr 0x2752138 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer__ColorLutHandler()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::GlobalNamespace::__OVRPassthroughLayer__ColorLutHandler)]{};

/// @brief Field _currentColorLutTargetTexture offset 0x30
...
/// @brief Field <LutTarget>k__BackingField offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Texture2D*> __get__currentColorLutTargetTexture() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRPassthroughColorLut*> __get__LutTarget_k__BackingField() const;

/// @brief Method get_LutTarget addr 0x2752ce8 size 0x8 virtual false final false
inline ::GlobalNamespace::OVRPassthroughColorLut* get_LutTarget() ;

/// @brief Method set_LutTarget addr 0x2752cf0 size 0x8 virtual false final false
inline void set_LutTarget(::GlobalNamespace::OVRPassthroughColorLut*  value) ;

/// @brief Method ApplyStyleSettings addr 0x2752cf8 size 0x38 virtual true final false
inline void ApplyStyleSettings(ByRef<::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2>  style) ;

/// @brief Method Update addr 0x2752d30 size 0x7c virtual true final false
inline void Update(::GlobalNamespace::__OVRPassthroughLayer__Settings  settings) ;

/// @brief Method Update addr 0x27522d8 size 0x28 virtual false final false
...
/// @brief Method Clear addr 0x2752dac size 0xc virtual true final false
inline void Clear() ;

static inline ::GlobalNamespace::__OVRPassthroughLayer__InterpolatedColorLutHandler* New_ctor() ;

/// @brief Method .ctor addr 0x2752140 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer__InterpolatedColorLutHandler()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_obj() const;

static inline ::GlobalNamespace::__OVRPassthroughLayer____c__DisplayClass9_0* New_ctor() ;

/// @brief Method .ctor addr 0x274ebd8 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <RemoveSurfaceGeometry>b__0 addr 0x2752db8 size 0x6c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer____c__DisplayClass9_0()  = default;
public:
...
/// @brief Method .ctor addr 0x274ee8c size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <IsSurfaceGeometry>b__0 addr 0x2752e24 size 0x6c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughLayer____c__DisplayClass10_0()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x110 - sizeof(::UnityEngine::MonoBehaviour)]{};

/// @brief Field projectionSurfaceType offset 0x18
...
/// @brief Field colorMapEditorGradient offset 0x50
...
/// @brief Field _colorLutSourceTexture offset 0x68
...
/// @brief Field _colorLutTargetTexture offset 0x70
...
/// @brief Field surfaceGameObjects offset 0xd0
 __declspec(property(get=__get_surfaceGameObjects, put=__set_surfaceGameObjects)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::GameObject*,::GlobalNamespace::__OVRPassthroughLayer__PassthroughMeshInstance>*  surfaceGameObjects;

/// @brief Field deferredSurfaceGameObjects offset 0xd8
 __declspec(property(get=__get_deferredSurfaceGameObjects, put=__set_deferredSurfaceGameObjects)) ::System::Collections::Generic::List_1<::GlobalNamespace::__OVRPassthroughLayer__DeferredPassthroughMeshAddition>*  deferredSurfaceGameObjects;

/// @brief Field serializedSurfaceGeometry offset 0xe0
 __declspec(property(get=__get_serializedSurfaceGeometry, put=__set_serializedSurfaceGeometry)) ::System::Collections::Generic::List_1<::GlobalNamespace::__OVRPassthroughLayer__SerializedSurfaceGeometry>*  serializedSurfaceGeometry;

/// @brief Field textureOpacity_ offset 0xe8
 __declspec(property(get=__get_textureOpacity_, put=__set_textureOpacity_)) float_t  textureOpacity_;

/// @brief Field edgeRenderingEnabled_ offset 0xec
 __declspec(property(get=__get_edgeRenderingEnabled_, put=__set_edgeRenderingEnabled_)) bool  edgeRenderingEnabled_;

/// @brief Field edgeColor_ offset 0xf0
 __declspec(property(get=__get_edgeColor_, put=__set_edgeColor_)) ::UnityEngine::Color  edgeColor_;

/// @brief Field colorMapType offset 0x100
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Gradient*> __get_colorMapEditorGradient() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Texture2D*> __get__colorLutSourceTexture() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Texture2D*> __get__colorLutTargetTexture() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_auxGameObject() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVROverlay*> __get_passthroughOverlay() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityEngine::GameObject*,::GlobalNamespace::__OVRPassthroughLayer__PassthroughMeshInstance>*> __get_surfaceGameObjects() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__OVRPassthroughLayer__DeferredPassthroughMeshAddition>*> __get_deferredSurfaceGameObjects() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__OVRPassthroughLayer__SerializedSurfaceGeometry>*> __get_serializedSurfaceGeometry() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRPassthroughLayer__StylesHandler*> __get__stylesHandler() const;
...
/// @brief Method AddSurfaceGeometry addr 0x274e7d0 size 0x1f0 virtual false final false
inline void AddSurfaceGeometry(::UnityEngine::GameObject*  obj, bool  updateTransform) ;

/// @brief Method RemoveSurfaceGeometry addr 0x274e9c0 size 0x218 virtual false final false
inline void RemoveSurfaceGeometry(::UnityEngine::GameObject*  obj) ;

/// @brief Method IsSurfaceGeometry addr 0x274ed70 size 0x11c virtual false final false
inline bool IsSurfaceGeometry(::UnityEngine::GameObject*  obj) ;

/// @brief Method get_textureOpacity addr 0x274ee94 size 0x8 virtual false final false
inline float_t get_textureOpacity() ;

/// @brief Method set_textureOpacity addr 0x274ee9c size 0x1c virtual false final false
inline void set_textureOpacity(float_t  value) ;

/// @brief Method get_edgeRenderingEnabled addr 0x274eeb8 size 0x8 virtual false final false
inline bool get_edgeRenderingEnabled() ;

/// @brief Method set_edgeRenderingEnabled addr 0x274eec0 size 0x20 virtual false final false
inline void set_edgeRenderingEnabled(bool  value) ;

/// @brief Method get_edgeColor addr 0x274eee0 size 0xc virtual false final false
inline ::UnityEngine::Color get_edgeColor() ;

/// @brief Method set_edgeColor addr 0x274eeec size 0x58 virtual false final false
inline void set_edgeColor(::UnityEngine::Color  value) ;

/// @brief Method SetColorMap addr 0x274ef44 size 0xa0 virtual false final false
inline void SetColorMap(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  values) ;

/// @brief Method SetColorLut addr 0x274f0f0 size 0xfc virtual false final false
inline void SetColorLut(::GlobalNamespace::OVRPassthroughColorLut*  lut, float_t  weight) ;

/// @brief Method SetColorLut addr 0x274f2e0 size 0x11c virtual false final false
...
/// @brief Method SetColorMapControls addr 0x274f460 size 0x190 virtual false final false
...
/// @brief Method SetColorMapMonochromatic addr 0x274f7c0 size 0xa4 virtual false final false
inline void SetColorMapMonochromatic(::ArrayW<uint8_t,::Array<uint8_t>*>  values) ;

/// @brief Method SetBrightnessContrastSaturation addr 0x274f8c0 size 0x4c virtual false final false
inline void SetBrightnessContrastSaturation(float_t  brightness, float_t  contrast, float_t  saturation) ;

/// @brief Method DisableColorMap addr 0x274fb9c size 0x8 virtual false final false
inline void DisableColorMap() ;

/// @brief Method get_colorMapEditorType addr 0x274fba4 size 0x8 virtual false final false
inline ::GlobalNamespace::__OVRPassthroughLayer__ColorMapEditorType get_colorMapEditorType() ;

/// @brief Method set_colorMapEditorType addr 0x274efe4 size 0xd8 virtual false final false
inline void set_colorMapEditorType(::GlobalNamespace::__OVRPassthroughLayer__ColorMapEditorType  value) ;

/// @brief Method SetStyleDirty addr 0x274fc70 size 0xc virtual false final false
inline void SetStyleDirty() ;

/// @brief Method AddDeferredSurfaceGeometries addr 0x274fc7c size 0x258 virtual false final false
inline void AddDeferredSurfaceGeometries() ;

/// @brief Method GetTransformMatrixForPassthroughSurfaceObject addr 0x2750184 size 0x354 virtual false final false
inline ::UnityEngine::Matrix4x4 GetTransformMatrixForPassthroughSurfaceObject(::UnityEngine::Matrix4x4  worldFromObj) ;

/// @brief Method CreateAndAddMesh addr 0x274fed4 size 0x2b0 virtual false final false
...
/// @brief Method DestroySurfaceGeometries addr 0x27507a4 size 0x280 virtual false final false
inline void DestroySurfaceGeometries(bool  addBackToDeferredQueue) ;

/// @brief Method UpdateSurfaceGeometryTransforms addr 0x2750a24 size 0x31c virtual false final false
inline void UpdateSurfaceGeometryTransforms() ;

/// @brief Method UpdateSurfaceGeometryTransform addr 0x2750d40 size 0x1b8 virtual false final false
inline void UpdateSurfaceGeometryTransform(uint64_t  instanceHandle, ::UnityEngine::Matrix4x4  localToWorld) ;

/// @brief Method CreateNeutralColorMapGradient addr 0x274f5f0 size 0x1d0 virtual false final false
static inline ::UnityEngine::Gradient* CreateNeutralColorMapGradient() ;

/// @brief Method HasControlsBasedColorMap addr 0x2751000 size 0x30 virtual false final false
inline bool HasControlsBasedColorMap() ;

/// @brief Method UpdateColorMapFromControls addr 0x274f90c size 0x290 virtual false final false
inline void UpdateColorMapFromControls(bool  forceUpdate) ;

/// @brief Method SyncToOverlay addr 0x2751030 size 0x274 virtual false final false
inline void SyncToOverlay() ;

/// @brief Method ClampWeight addr 0x274f1ec size 0x9c virtual false final false
static inline float_t ClampWeight(float_t  weight) ;

/// @brief Method get_overlayShape addr 0x27512a4 size 0x14 virtual false final false
inline ::GlobalNamespace::__OVROverlay__OverlayShape get_overlayShape() ;

/// @brief Method Awake addr 0x27512b8 size 0x228 virtual false final false
inline void Awake() ;

/// @brief Method Update addr 0x27514e0 size 0x4 virtual false final false
inline void Update() ;

/// @brief Method LateUpdate addr 0x27514e4 size 0x170 virtual false final false
inline void LateUpdate() ;

/// @brief Method CreateOvrPluginStyleObject addr 0x2751654 size 0x154 virtual false final false
inline ::GlobalNamespace::__OVRPlugin__InsightPassthroughStyle2 CreateOvrPluginStyleObject() ;

/// @brief Method OnEnable addr 0x27519bc size 0x18c virtual false final false
inline void OnEnable() ;

/// @brief Method OnDisable addr 0x2751b48 size 0xd0 virtual false final false
inline void OnDisable() ;

/// @brief Method OnDestroy addr 0x2751c18 size 0x8 virtual false final false
inline void OnDestroy() ;

static inline ::GlobalNamespace::OVRPassthroughLayer* New_ctor() ;

/// @brief Method .ctor addr 0x2751c20 size 0x240 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 OVRPassthroughLayer()  = default;
public:


// Fields

// Static field _editorToColorMapType

// Static field colorMapNeutralGradient
