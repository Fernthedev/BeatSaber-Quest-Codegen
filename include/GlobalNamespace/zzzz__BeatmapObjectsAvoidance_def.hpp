...
/// @brief Field _playerTransforms offset 0x48
...
/// @brief Field _avoidanceYOffsetEvaluatorProvider offset 0x50
 __declspec(property(get=__get__avoidanceYOffsetEvaluatorProvider, put=__set__avoidanceYOffsetEvaluatorProvider)) ::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator*  _avoidanceYOffsetEvaluatorProvider;

/// @brief Field _pathEvaluator offset 0x58
...
/// @brief Field _tiltEvaluator offset 0x60
...
/// @brief Field _pathBezierSplineEvaluator offset 0x68
...
/// @brief Field _accelerationBezierSplineEvaluator offset 0x70
...
/// @brief Field _transform offset 0x78
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__towardsPlayerWrapperTransform() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapObjectAvoidanceYOffsetEvaluator*> __get__avoidanceYOffsetEvaluatorProvider() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapObjectAvoidancePathEvaluator*> __get__pathEvaluator() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapObjectAvoidanceTiltEvaluator*> __get__tiltEvaluator() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BezierSplineEvaluator*> __get__pathBezierSplineEvaluator() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BezierSplineEvaluator*> __get__accelerationBezierSplineEvaluator() const;
...
// Ctor Parameters []
// @brief default ctor
 BeatmapObjectsAvoidance()  = default;
public:
