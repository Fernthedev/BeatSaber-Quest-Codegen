...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::PoseSerializable::*)(::System::Object*)>(&::GlobalNamespace::PoseSerializable::Equals)> {
...
::cordl_internals::setInstanceField<::GlobalNamespace::Vector3Serializable, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::GlobalNamespace::Vector3Serializable>(value));
}
constexpr ::GlobalNamespace::Vector3Serializable& GlobalNamespace::PoseSerializable::__get_position()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::Vector3Serializable, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::GlobalNamespace::Vector3Serializable const& GlobalNamespace::PoseSerializable::__get_position() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::Vector3Serializable, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void GlobalNamespace::PoseSerializable::__set_rotation(::GlobalNamespace::QuaternionSerializable  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::QuaternionSerializable, 0xc>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::GlobalNamespace::QuaternionSerializable>(value));
}
constexpr ::GlobalNamespace::QuaternionSerializable& GlobalNamespace::PoseSerializable::__get_rotation()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::QuaternionSerializable, 0xc>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::GlobalNamespace::QuaternionSerializable const& GlobalNamespace::PoseSerializable::__get_rotation() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::QuaternionSerializable, 0xc>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::GlobalNamespace::PoseSerializable::PoseSerializable(::GlobalNamespace::Vector3Serializable  position, ::GlobalNamespace::QuaternionSerializable  rotation) noexcept : ::bs_hook::ValueTypeWrapper<0x18>() {this->position = position;
