...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::UnityEngine::Timeline::Marker)]{};

static inline ::GlobalNamespace::JumpDestinationMarker* New_ctor() ;

/// @brief Method .ctor addr 0x20f5ba0 size 0x8 virtual false final false
inline void _ctor() ;
