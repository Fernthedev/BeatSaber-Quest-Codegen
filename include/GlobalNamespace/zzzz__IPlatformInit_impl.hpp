...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<bool (::GlobalNamespace::IPlatformInit::*)()>(&::GlobalNamespace::IPlatformInit::get_IsInitialized)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::System::Threading::Tasks::Task_1<bool>* (::GlobalNamespace::IPlatformInit::*)()>(&::GlobalNamespace::IPlatformInit::InitializeAsync)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
