...
// Ctor Parameters []
// @brief default ctor
 __BasicBeatmapObjectManager__InitData()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xe0 - sizeof(::GlobalNamespace::BeatmapObjectManager)]{};

/// @brief Field _firstBasicNoteTime offset 0x94
...
/// @brief Field _initData offset 0xa0
...
/// @brief Field _basicGameNotePoolContainer offset 0xa8
 __declspec(property(get=__get__basicGameNotePoolContainer, put=__set__basicGameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::GameNoteController*>*  _basicGameNotePoolContainer;

/// @brief Field _burstSliderHeadGameNotePoolContainer offset 0xb0
 __declspec(property(get=__get__burstSliderHeadGameNotePoolContainer, put=__set__burstSliderHeadGameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::GameNoteController*>*  _burstSliderHeadGameNotePoolContainer;

/// @brief Field _burstSliderGameNotePoolContainer offset 0xb8
 __declspec(property(get=__get__burstSliderGameNotePoolContainer, put=__set__burstSliderGameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::BurstSliderGameNoteController*>*  _burstSliderGameNotePoolContainer;

/// @brief Field _burstSliderFillPoolContainer offset 0xc0
 __declspec(property(get=__get__burstSliderFillPoolContainer, put=__set__burstSliderFillPoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::BurstSliderGameNoteController*>*  _burstSliderFillPoolContainer;

/// @brief Field _bombNotePoolContainer offset 0xc8
...
/// @brief Field _obstaclePoolContainer offset 0xd0
...
/// @brief Field _sliderNotePoolContainersDictionary offset 0xd8
 __declspec(property(get=__get__sliderNotePoolContainersDictionary, put=__set__sliderNotePoolContainersDictionary)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__SliderController__LengthType,::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::SliderController*>*>*  _sliderNotePoolContainersDictionary;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__BasicBeatmapObjectManager__InitData*> __get__initData() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::GameNoteController*>*> __get__basicGameNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::GameNoteController*>*> __get__burstSliderHeadGameNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::BurstSliderGameNoteController*>*> __get__burstSliderGameNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::BurstSliderGameNoteController*>*> __get__burstSliderFillPoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::BombNoteController*>*> __get__bombNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::ObstacleController*>*> __get__obstaclePoolContainer() const;

constexpr void __set__sliderNotePoolContainersDictionary(::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__SliderController__LengthType,::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::SliderController*>*>*  value) ;

constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__SliderController__LengthType,::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::SliderController*>*>* __get__sliderNotePoolContainersDictionary() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__SliderController__LengthType,::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::SliderController*>*>*> __get__sliderNotePoolContainersDictionary() const;
...
// Ctor Parameters []
// @brief default ctor
 BasicBeatmapObjectManager()  = default;
public:
