...
::cordl_internals::setInstanceField<::GlobalNamespace::CrashManagerSO*, 0x18>(this, std::forward<::GlobalNamespace::CrashManagerSO*>(value));
}
constexpr ::GlobalNamespace::CrashManagerSO* GlobalNamespace::CrashInfoViewController::__get__crashManager()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::CrashManagerSO*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::CrashManagerSO*> GlobalNamespace::CrashInfoViewController::__get__crashManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::CrashManagerSO*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> GlobalNamespace::CrashInfoViewController::__get__text() const {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x20>(this);
}
