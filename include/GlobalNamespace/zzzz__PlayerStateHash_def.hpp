...
struct CORDL_TYPE PlayerStateHash : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
...
/// @brief Field _bloomFilter offset 0x0
 __declspec(property(get=__get__bloomFilter, put=__set__bloomFilter)) ::GlobalNamespace::BitMask128  _bloomFilter;
...
constexpr ::GlobalNamespace::BitMask128& __get__bloomFilter() ;

constexpr ::GlobalNamespace::BitMask128 const& __get__bloomFilter() const;
...
constexpr explicit PlayerStateHash(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 PlayerStateHash()  = default;
