...
/// @brief Field _nodeConnectionPref offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionNodeConnection*> __get__nodeConnectionPref() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__connectionsCanvas() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::MissionNode*>*> __get__missionNodes() const;
...
// Ctor Parameters []
// @brief default ctor
 MissionConnectionsGenerator()  = default;
public:
