...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x68 - sizeof(::GlobalNamespace::PoolableSerializable)]{};
...
// Ctor Parameters []
// @brief default ctor
 ObstacleSpawnInfoNetSerializable()  = default;
public:
