...
struct CORDL_TYPE __SelectLevelCategoryViewController__LevelCategory : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____SelectLevelCategoryViewController__LevelCategory_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __SelectLevelCategoryViewController__LevelCategory(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __SelectLevelCategoryViewController__LevelCategory()  = default;
...
/// @brief Field levelCategory offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Sprite*> __get_categoryIcon() const;
...
// Ctor Parameters []
// @brief default ctor
 __SelectLevelCategoryViewController__LevelCategoryInfo()  = default;
public:
...
/// @brief Field enabledLevelCategories offset 0x10
 __declspec(property(get=__get_enabledLevelCategories, put=__set_enabledLevelCategories)) ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*>  enabledLevelCategories;

constexpr void __set_enabledLevelCategories(::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*>& __get_enabledLevelCategories() ;

constexpr ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*> const& __get_enabledLevelCategories() const;
...
// Ctor Parameters []
// @brief default ctor
 __SelectLevelCategoryViewController____c__DisplayClass12_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __SelectLevelCategoryViewController____c()  = default;
public:
...
/// @brief Field _allLevelCategoryInfos offset 0x70
 __declspec(property(get=__get__allLevelCategoryInfos, put=__set__allLevelCategoryInfos)) ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*>*>  _allLevelCategoryInfos;

/// @brief Field _levelFilterCategoryIconSegmentedControl offset 0x78
 __declspec(property(get=__get__levelFilterCategoryIconSegmentedControl, put=__set__levelFilterCategoryIconSegmentedControl)) ::HMUI::IconSegmentedControl*  _levelFilterCategoryIconSegmentedControl;

/// @brief Field _analyticsModel offset 0x80
 __declspec(property(get=__get__analyticsModel, put=__set__analyticsModel)) ::GlobalNamespace::IAnalyticsModel*  _analyticsModel;

/// @brief Field didSelectLevelCategoryEvent offset 0x88
 __declspec(property(get=__get_didSelectLevelCategoryEvent, put=__set_didSelectLevelCategoryEvent)) ::System::Action_2<::GlobalNamespace::SelectLevelCategoryViewController*,::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*  didSelectLevelCategoryEvent;

/// @brief Field _prevSelectedLevelCategory offset 0x90
...
/// @brief Field _levelCategoryInfos offset 0x98
 __declspec(property(get=__get__levelCategoryInfos, put=__set__levelCategoryInfos)) ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*>*>  _levelCategoryInfos;
...
constexpr void __set__allLevelCategoryInfos(::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*>*>& __get__allLevelCategoryInfos() ;

constexpr ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*>*> const& __get__allLevelCategoryInfos() const;
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::IconSegmentedControl*> __get__levelFilterCategoryIconSegmentedControl() const;
...
constexpr void __set_didSelectLevelCategoryEvent(::System::Action_2<::GlobalNamespace::SelectLevelCategoryViewController*,::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*  value) ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::SelectLevelCategoryViewController*,::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*> __get_didSelectLevelCategoryEvent() const;
...
constexpr void __set__levelCategoryInfos(::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*>*>& __get__levelCategoryInfos() ;

constexpr ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategoryInfo*>*> const& __get__levelCategoryInfos() const;
...
inline void remove_didSelectLevelCategoryEvent(::System::Action_2<::GlobalNamespace::SelectLevelCategoryViewController*,::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*  value) ;
...
// Ctor Parameters []
// @brief default ctor
 SelectLevelCategoryViewController()  = default;
public:
