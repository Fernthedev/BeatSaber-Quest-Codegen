...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NetworkPlayerTableCell::*)(::HMUI::__SelectableCell__TransitionType)>(&::GlobalNamespace::NetworkPlayerTableCell::SelectionDidChange)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::NetworkPlayerTableCell::*)(::HMUI::__SelectableCell__TransitionType)>(&::GlobalNamespace::NetworkPlayerTableCell::HighlightDidChange)> {
  constexpr static std::size_t size = 0x4;
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> GlobalNamespace::NetworkPlayerTableCell::__get__playerNameText() const {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x58>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> GlobalNamespace::NetworkPlayerTableCell::__get__separator() const {
return ::cordl_internals::getInstanceField<::UnityEngine::GameObject*, 0x60>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Image*> GlobalNamespace::NetworkPlayerTableCell::__get__privateIcon() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Image*, 0x68>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Image*> GlobalNamespace::NetworkPlayerTableCell::__get__spectateIcon() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Image*, 0x70>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Image*> GlobalNamespace::NetworkPlayerTableCell::__get__partyLeaderIcon() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Image*, 0x78>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Image*> GlobalNamespace::NetworkPlayerTableCell::__get__bgImage() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Image*, 0x80>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Image*> GlobalNamespace::NetworkPlayerTableCell::__get__highlightImage() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Image*, 0x88>(this);
}
