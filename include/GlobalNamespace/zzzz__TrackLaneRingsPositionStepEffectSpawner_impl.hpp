...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::TrackLaneRingsManager*> GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner::__get__trackLaneRingsManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::TrackLaneRingsManager*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapCallbacksController*> GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner::__get__beatmapCallbacksController() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapCallbacksController*, 0x30>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapDataCallbackWrapper*> GlobalNamespace::TrackLaneRingsPositionStepEffectSpawner::__get__beatmapDataCallbackWrapper() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapDataCallbackWrapper*, 0x38>(this);
}
