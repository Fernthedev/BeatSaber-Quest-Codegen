...
struct CORDL_TYPE __DynamicBone__UpdateMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____DynamicBone__UpdateMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __DynamicBone__UpdateMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __DynamicBone__UpdateMode()  = default;
...
struct CORDL_TYPE __DynamicBone__FreezeAxis : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____DynamicBone__FreezeAxis_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __DynamicBone__FreezeAxis(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __DynamicBone__FreezeAxis()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __DynamicBone__Particle()  = default;
public:
...
/// @brief Field m_Stiffness offset 0x48
 __declspec(property(get=__get_m_Stiffness, put=__set_m_Stiffness)) float_t  m_Stiffness;

/// @brief Field m_StiffnessDistrib offset 0x50
...
/// @brief Field m_Exclusions offset 0xa8
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_m_Root() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get_m_DampingDistrib() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get_m_ElasticityDistrib() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get_m_StiffnessDistrib() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get_m_InertDistrib() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get_m_RadiusDistrib() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::DynamicBoneColliderBase*>*> __get_m_Colliders() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::Transform*>*> __get_m_Exclusions() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_m_ReferenceObject() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__DynamicBone__Particle*>*> __get_m_Particles() const;
