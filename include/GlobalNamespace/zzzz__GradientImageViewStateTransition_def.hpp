...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13627)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5442), inst: 925 }), TypeDefinitionIndex(TypeDefinitionIndex(5442))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::GlobalNamespace::BaseStateTransition_1<::HMUI::ImageView*>)]{};
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GradientTransitionSO*> __get__transition() const;

constexpr void __set__colorTweenA(::Tweening::ColorTween*  value) ;

constexpr ::Tweening::ColorTween* __get__colorTweenA() ;

constexpr ::cordl_internals::to_const_pointer<::Tweening::ColorTween*> __get__colorTweenA() const;

constexpr void __set__colorTweenB(::Tweening::ColorTween*  value) ;

constexpr ::Tweening::ColorTween* __get__colorTweenB() ;

constexpr ::cordl_internals::to_const_pointer<::Tweening::ColorTween*> __get__colorTweenB() const;
...
inline void StartTween(::UnityEngine::Color  startColor, ::UnityEngine::Color  endColor, ::System::Action_1<::UnityEngine::Color>*  tweenAction, ::System::Action*  onCompleteAction, ByRef<::Tweening::ColorTween*>  colorTween) ;
...
// Ctor Parameters []
// @brief default ctor
 GradientImageViewStateTransition()  = default;
public:
