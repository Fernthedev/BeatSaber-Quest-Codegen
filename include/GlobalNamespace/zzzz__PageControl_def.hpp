...
/// @brief Field _inactiveElements offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> __get__content() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PageControlElement*> __get__elementPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::PageControlElement*>*> __get__activeElements() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Queue_1<::GlobalNamespace::PageControlElement*>*> __get__inactiveElements() const;
