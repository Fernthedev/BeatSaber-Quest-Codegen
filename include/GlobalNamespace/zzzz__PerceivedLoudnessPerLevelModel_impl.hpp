...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,float_t>*> GlobalNamespace::PerceivedLoudnessPerLevelModel::__get__loudnessLevelPerLevelId() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::Dictionary_2<::StringW,float_t>*, 0x10>(this);
}
