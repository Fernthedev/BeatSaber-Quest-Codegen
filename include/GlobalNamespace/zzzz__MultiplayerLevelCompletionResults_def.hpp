...
struct CORDL_TYPE __MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndState : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndState_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndState()  = default;
...
struct CORDL_TYPE __MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndReason : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndReason_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndReason(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndReason()  = default;
...
/// @brief Field _playerLevelEndState offset 0x10
...
/// @brief Field _playerLevelEndReason offset 0x14
 __declspec(property(get=__get__playerLevelEndReason, put=__set__playerLevelEndReason)) ::GlobalNamespace::__MultiplayerLevelCompletionResults__MultiplayerPlayerLevelEndReason  _playerLevelEndReason;

/// @brief Field _levelCompletionResults offset 0x18
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerLevelCompletionResults()  = default;
public:
