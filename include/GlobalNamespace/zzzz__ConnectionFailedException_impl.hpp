...
::cordl_internals::setInstanceField<::GlobalNamespace::ConnectionFailedReason, 0x8c>(this, std::forward<::GlobalNamespace::ConnectionFailedReason>(value));
}
constexpr ::GlobalNamespace::ConnectionFailedReason& GlobalNamespace::ConnectionFailedException::__get_reason()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ConnectionFailedReason, 0x8c>(this);
}
