...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x50 - sizeof(::Zenject::MonoInstaller)]{};

/// @brief Field _defaultSettingsMenuViewController offset 0x20
 __declspec(property(get=__get__defaultSettingsMenuViewController, put=__set__defaultSettingsMenuViewController)) ::GlobalNamespace::MainSettingsMenuViewController*  _defaultSettingsMenuViewController;

/// @brief Field _oculusPCSettingsMenuViewController offset 0x28
 __declspec(property(get=__get__oculusPCSettingsMenuViewController, put=__set__oculusPCSettingsMenuViewController)) ::GlobalNamespace::MainSettingsMenuViewController*  _oculusPCSettingsMenuViewController;

/// @brief Field _questSettingsMenuViewController offset 0x30
...
/// @brief Field _psvrSettingsMenuViewController offset 0x38
...
/// @brief Field _psvr2SettingsMenuViewController offset 0x40
...
/// @brief Field _tabBarViewControllerPrefab offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MainSettingsMenuViewController*> __get__defaultSettingsMenuViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MainSettingsMenuViewController*> __get__oculusPCSettingsMenuViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MainSettingsMenuViewController*> __get__questSettingsMenuViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MainSettingsMenuViewController*> __get__psvrSettingsMenuViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MainSettingsMenuViewController*> __get__psvr2SettingsMenuViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::TabBarViewController*> __get__tabBarViewControllerPrefab() const;
...
// Ctor Parameters []
// @brief default ctor
 MainSettingsMenuViewControllersInstaller()  = default;
public:
