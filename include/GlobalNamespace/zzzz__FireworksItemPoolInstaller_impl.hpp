...
::cordl_internals::setInstanceField<::GlobalNamespace::FireworksController*, 0x20>(this, std::forward<::GlobalNamespace::FireworksController*>(value));
}
constexpr ::GlobalNamespace::FireworksController* GlobalNamespace::FireworksItemPoolInstaller::__get__fireworksController()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::FireworksController*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FireworksController*> GlobalNamespace::FireworksItemPoolInstaller::__get__fireworksController() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::FireworksController*, 0x20>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FireworkItemController*> GlobalNamespace::FireworksItemPoolInstaller::__get__fireworkItemControllerPrefab() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::FireworkItemController*, 0x28>(this);
}
