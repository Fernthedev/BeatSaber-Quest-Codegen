...
/// @brief Field _nameColorTween offset 0x30
...
/// @brief Field _scoreColorTween offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::Tweening::Tween_1<::UnityEngine::Color>*> __get__nameColorTween() const;
...
constexpr ::cordl_internals::to_const_pointer<::Tweening::Tween_1<::UnityEngine::Color>*> __get__scoreColorTween() const;

/// @brief Method Awake addr 0x2258b98 size 0x1b0 virtual false final false
inline void Awake() ;

/// @brief Method OnDestroy addr 0x2258d48 size 0x88 virtual false final false
inline void OnDestroy() ;

/// @brief Method SetPositionAndRotation addr 0x2258dd0 size 0x78 virtual false final false
inline void SetPositionAndRotation(::UnityEngine::Vector3  position, ::UnityEngine::Quaternion  rotation) ;

/// @brief Method AnimateColors addr 0x224b894 size 0x114 virtual false final false
...
/// @brief Method SetName addr 0x224c0b4 size 0x24 virtual false final false
inline void SetName(::StringW  text) ;

/// @brief Method SetScore addr 0x224c170 size 0x24 virtual false final false
inline void SetScore(::StringW  text) ;

static inline ::GlobalNamespace::MultiplayerScoreItem* New_ctor() ;

/// @brief Method .ctor addr 0x2258e48 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <Awake>b__5_0 addr 0x2258e50 size 0x24 virtual false final false
inline void _Awake_b__5_0(::UnityEngine::Color  val) ;

/// @brief Method <Awake>b__5_1 addr 0x2258e74 size 0x24 virtual false final false
