...
struct CORDL_TYPE __LightConstants__BakeId : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____LightConstants__BakeId_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __LightConstants__BakeId(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __LightConstants__BakeId()  = default;
...
/// @brief Field kBaseLightId offset 0x0
static constexpr int32_t  kBaseLightId{static_cast<int32_t>(0x19)};

/// @brief Field kLightProbeLightBakeIdPrefix offset 0x0
...
// Static field allBakeIds

// Static field _probeLightPropertyIds
