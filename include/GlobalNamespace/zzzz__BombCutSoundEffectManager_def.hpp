...
/// @brief Field _volume offset 0x18
 __declspec(property(get=__get__volume, put=__set__volume)) float_t  _volume;

/// @brief Field _bombExplosionAudioClips offset 0x20
...
/// @brief Field _randomSoundPicker offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SaberManager*> __get_saberManager() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__BombCutSoundEffect__Pool*> __get__bombCutSoundEffectPool() const;
...
// Ctor Parameters []
// @brief default ctor
 BombCutSoundEffectManager()  = default;
public:
