...
/// @brief Field beatmapLevelPack offset 0x18
...
/// @brief Field difficultyBeatmap offset 0x28
...
inline void _ctor(::System::Nullable_1<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>  levelCategory, ::GlobalNamespace::IBeatmapLevelPack*  beatmapLevelPack, ::GlobalNamespace::IPreviewBeatmapLevel*  previewBeatmapLevel, ::GlobalNamespace::IDifficultyBeatmap*  difficultyBeatmap) ;
...
static inline ::GlobalNamespace::__LevelSelectionFlowCoordinator__State* New_ctor(::GlobalNamespace::IBeatmapLevelPack*  beatmapLevelPack, ::GlobalNamespace::IPreviewBeatmapLevel*  previewBeatmapLevel) ;
...
static inline ::GlobalNamespace::__LevelSelectionFlowCoordinator__State* New_ctor(::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory  levelCategory, ::GlobalNamespace::IBeatmapLevelPack*  beatmapLevelPack, ::GlobalNamespace::IDifficultyBeatmap*  difficultyBeatmap) ;

/// @brief Method .ctor addr 0x228b368 size 0x100 virtual false final false
inline void _ctor(::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory  levelCategory, ::GlobalNamespace::IBeatmapLevelPack*  beatmapLevelPack, ::GlobalNamespace::IDifficultyBeatmap*  difficultyBeatmap) ;
...
// Ctor Parameters []
// @brief default ctor
 __LevelSelectionFlowCoordinator__State()  = default;
public:
...
/// @brief Field playerDataModel offset 0xa8
 __declspec(property(get=__get_playerDataModel, put=__set_playerDataModel)) ::GlobalNamespace::PlayerDataModel*  playerDataModel;

/// @brief Field levelSelectionNavigationController offset 0xb0
 __declspec(property(get=__get_levelSelectionNavigationController, put=__set_levelSelectionNavigationController)) ::GlobalNamespace::LevelSelectionNavigationController*  levelSelectionNavigationController;

/// @brief Field _searchFilterParamsViewController offset 0xb8
 __declspec(property(get=__get__searchFilterParamsViewController, put=__set__searchFilterParamsViewController)) ::GlobalNamespace::SearchFilterParamsViewController*  _searchFilterParamsViewController;
...
/// @brief Field _startState offset 0xc8
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LevelSelectionNavigationController*> __get_levelSelectionNavigationController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SearchFilterParamsViewController*> __get__searchFilterParamsViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__LevelSelectionFlowCoordinator__State*> __get__startState() const;
...
// Ctor Parameters []
// @brief default ctor
 LevelSelectionFlowCoordinator()  = default;
public:
