...
// Ctor Parameters []
// @brief default ctor
 __SonyLeaderboardIdsModelSO__LeaderboardIdData()  = default;
public:
...
/// @brief Field _leaderboardIds offset 0x18
 __declspec(property(get=__get__leaderboardIds, put=__set__leaderboardIds)) ::System::Collections::Generic::List_1<::GlobalNamespace::__SonyLeaderboardIdsModelSO__LeaderboardIdData*>*  _leaderboardIds;

/// @brief Field _leaderboardIdToSonyId offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__SonyLeaderboardIdsModelSO__LeaderboardIdData*>*> __get__leaderboardIds() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,uint32_t>*> __get__leaderboardIdToSonyId() const;
...
// Ctor Parameters []
// @brief default ctor
 SonyLeaderboardIdsModelSO()  = default;
public:
