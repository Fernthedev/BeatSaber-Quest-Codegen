...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xa8 - sizeof(::HMUI::FlowCoordinator)]{};

/// @brief Method DidActivate addr 0x228ea24 size 0x4 virtual true final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

static inline ::GlobalNamespace::GameServerBrowserFlowCoordinator* New_ctor() ;

/// @brief Method .ctor addr 0x228ea28 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 GameServerBrowserFlowCoordinator()  = default;
public:
