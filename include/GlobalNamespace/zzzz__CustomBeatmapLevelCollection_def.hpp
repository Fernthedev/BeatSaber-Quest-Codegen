...
/// @brief Field _customPreviewBeatmapLevels offset 0x10
 __declspec(property(get=__get__customPreviewBeatmapLevels, put=__set__customPreviewBeatmapLevels)) ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::CustomPreviewBeatmapLevel*>*  _customPreviewBeatmapLevels;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::CustomPreviewBeatmapLevel*>*> __get__customPreviewBeatmapLevels() const;

/// @brief Method get_beatmapLevels addr 0x2346a7c size 0x8 virtual true final true
inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IPreviewBeatmapLevel*>* get_beatmapLevels() ;

static inline ::GlobalNamespace::CustomBeatmapLevelCollection* New_ctor(::ArrayW<::GlobalNamespace::CustomPreviewBeatmapLevel*,::Array<::GlobalNamespace::CustomPreviewBeatmapLevel*>*>  customPreviewBeatmapLevels) ;

/// @brief Method .ctor addr 0x2346a84 size 0x28 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 CustomBeatmapLevelCollection()  = default;
public:
