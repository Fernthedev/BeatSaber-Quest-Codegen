...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x58 - sizeof(::GlobalNamespace::RuntimeLightWithLightGroupIds)]{};

/// @brief Field _directionalLight offset 0x50
...
// Ctor Parameters []
// @brief default ctor
 DirectionalLightWithLightGroupIds()  = default;
public:
