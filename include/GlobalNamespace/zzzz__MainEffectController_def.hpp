...
/// @brief Field kMainEffectEnabledKeyword offset 0x0
static constexpr ::ConstString  kMainEffectEnabledKeyword{u"MAIN_EFFECT_ENABLED"};

/// @brief Field _mainEffectContainer offset 0x18
...
/// @brief Field _imageEffectController offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FloatSO*> __get__fadeValue() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::RenderTexture*>*> __get_afterImageEffectEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ImageEffectController*> __get__imageEffectController() const;
