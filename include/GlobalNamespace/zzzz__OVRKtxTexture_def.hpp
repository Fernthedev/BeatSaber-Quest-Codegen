...
/// @brief Field KTX_TTF_BC7_RGBA offset 0x0
static constexpr uint32_t  KTX_TTF_BC7_RGBA{static_cast<uint32_t>(0x400a06u)};

/// @brief Field KTX_TTF_ASTC_4x4_RGBA offset 0x0
static constexpr uint32_t  KTX_TTF_ASTC_4x4_RGBA{static_cast<uint32_t>(0x200400au)};

/// @brief Method Load addr 0x2738e04 size 0x250 virtual false final false
...
/// @brief Method .ctor addr 0x2739054 size 0x8 virtual false final false
inline void _ctor() ;
