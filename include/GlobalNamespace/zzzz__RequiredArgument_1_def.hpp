...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5979)), TypeDefinitionIndex(TypeDefinitionIndex(5978))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5979), inst: 2 })
// CS Name: ::RequiredArgument`1<T>*
class CORDL_TYPE RequiredArgument_1<T> : public ::GlobalNamespace::ArgumentBase {
public:
// Declarations
