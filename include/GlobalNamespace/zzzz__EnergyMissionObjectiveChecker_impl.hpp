...
::cordl_internals::setInstanceField<::GlobalNamespace::GameEnergyCounter*, 0x48>(this, std::forward<::GlobalNamespace::GameEnergyCounter*>(value));
}
constexpr ::GlobalNamespace::GameEnergyCounter* GlobalNamespace::EnergyMissionObjectiveChecker::__get__energyCounter()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameEnergyCounter*, 0x48>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameEnergyCounter*> GlobalNamespace::EnergyMissionObjectiveChecker::__get__energyCounter() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameEnergyCounter*, 0x48>(this);
}
