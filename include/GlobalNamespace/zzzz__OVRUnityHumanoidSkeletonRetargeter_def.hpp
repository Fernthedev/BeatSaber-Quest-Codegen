...
struct CORDL_TYPE __OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection()  = default;
...
struct CORDL_TYPE __OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodyTrackingBoneId : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodyTrackingBoneId_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodyTrackingBoneId(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodyTrackingBoneId()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings()  = default;
public:


// Fields

// Static field BoneToJointPair

// Static field BoneToBodySection

// Static field BoneIdToHumanBodyBone

// Static field BoneIdToJointPair
...
/// @brief Field CorrectionQuaternion offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_OriginalJoint() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_JointPairStart() const;

constexpr void __set_JointPairEnd(::UnityEngine::Transform*  value) ;

constexpr ::UnityEngine::Transform* __get_JointPairEnd() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_JointPairEnd() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get_ParentTransform() const;
...
// Ctor Parameters []
// @brief default ctor
 __OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata__BoneData()  = default;
public:
...
/// @brief Field <BodyToBoneData>k__BackingField offset 0x10
 __declspec(property(get=__get__BodyToBoneData_k__BackingField, put=__set__BodyToBoneData_k__BackingField)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::HumanBodyBones,::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata__BoneData*>*  _BodyToBoneData_k__BackingField;

/// @brief Field _boneEnumValues offset 0x18
...
constexpr void __set__BodyToBoneData_k__BackingField(::System::Collections::Generic::Dictionary_2<::UnityEngine::HumanBodyBones,::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata__BoneData*>*  value) ;

constexpr ::System::Collections::Generic::Dictionary_2<::UnityEngine::HumanBodyBones,::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata__BoneData*>* __get__BodyToBoneData_k__BackingField() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityEngine::HumanBodyBones,::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata__BoneData*>*> __get__BodyToBoneData_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 __OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __OVRUnityHumanoidSkeletonRetargeter__JointAdjustment()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x108 - sizeof(::GlobalNamespace::OVRSkeleton)]{};

/// @brief Field _sourceSkeletonData offset 0xb8
...
/// @brief Field _sourceSkeletonTPoseData offset 0xc0
 __declspec(property(get=__get__sourceSkeletonTPoseData, put=__set__sourceSkeletonTPoseData)) ::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata*  _sourceSkeletonTPoseData;

/// @brief Field _targetSkeletonData offset 0xc8
...
/// @brief Field _animatorTargetSkeleton offset 0xd0
...
/// @brief Field _customBoneIdToHumanBodyBone offset 0xd8
 __declspec(property(get=__get__customBoneIdToHumanBodyBone, put=__set__customBoneIdToHumanBodyBone)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__OVRSkeleton__BoneId,::UnityEngine::HumanBodyBones>*  _customBoneIdToHumanBodyBone;

/// @brief Field _targetTPoseRotations offset 0xe0
 __declspec(property(get=__get__targetTPoseRotations, put=__set__targetTPoseRotations)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::HumanBodyBones,::UnityEngine::Quaternion>*  _targetTPoseRotations;

/// @brief Field _lastSkelChangeCount offset 0xe8
 __declspec(property(get=__get__lastSkelChangeCount, put=__set__lastSkelChangeCount)) int32_t  _lastSkelChangeCount;

/// @brief Field _adjustments offset 0xf0
 __declspec(property(get=__get__adjustments, put=__set__adjustments)) ::ArrayW<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__JointAdjustment*,::Array<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__JointAdjustment*>*>  _adjustments;

/// @brief Field _bodySectionsToAlign offset 0xf8
 __declspec(property(get=__get__bodySectionsToAlign, put=__set__bodySectionsToAlign)) ::ArrayW<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection,::Array<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection>*>  _bodySectionsToAlign;

/// @brief Field _bodySectionToPosition offset 0x100
 __declspec(property(get=__get__bodySectionToPosition, put=__set__bodySectionToPosition)) ::ArrayW<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection,::Array<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection>*>  _bodySectionToPosition;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata*> __get__sourceSkeletonData() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata*> __get__sourceSkeletonTPoseData() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRSkeletonMetadata*> __get__targetSkeletonData() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Animator*> __get__animatorTargetSkeleton() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__OVRSkeleton__BoneId,::UnityEngine::HumanBodyBones>*> __get__customBoneIdToHumanBodyBone() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityEngine::HumanBodyBones,::UnityEngine::Quaternion>*> __get__targetTPoseRotations() const;
...
constexpr void __set__adjustments(::ArrayW<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__JointAdjustment*,::Array<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__JointAdjustment*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__JointAdjustment*,::Array<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__JointAdjustment*>*>& __get__adjustments() ;

constexpr ::ArrayW<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__JointAdjustment*,::Array<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__JointAdjustment*>*> const& __get__adjustments() const;

constexpr void __set__bodySectionsToAlign(::ArrayW<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection,::Array<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection,::Array<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection>*>& __get__bodySectionsToAlign() ;

constexpr ::ArrayW<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection,::Array<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection>*> const& __get__bodySectionsToAlign() const;

constexpr void __set__bodySectionToPosition(::ArrayW<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection,::Array<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection,::Array<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection>*>& __get__bodySectionToPosition() ;

constexpr ::ArrayW<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection,::Array<::GlobalNamespace::__OVRUnityHumanoidSkeletonRetargeter__OVRHumanBodyBonesMappings__BodySection>*> const& __get__bodySectionToPosition() const;
...
// Ctor Parameters []
// @brief default ctor
 OVRUnityHumanoidSkeletonRetargeter()  = default;
public:
