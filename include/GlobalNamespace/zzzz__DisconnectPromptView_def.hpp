...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::DisconnectPromptView*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __DisconnectPromptView____c__DisplayClass12_0()  = default;
public:
...
/// @brief Field _presentPanelAnimation offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__promptGameObject() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<bool>*> __get_didViewFinishEvent() const;
