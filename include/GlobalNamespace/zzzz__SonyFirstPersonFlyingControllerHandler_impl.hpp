...
::cordl_internals::setInstanceField<::GlobalNamespace::FirstPersonFlyingController*, 0x18>(this, std::forward<::GlobalNamespace::FirstPersonFlyingController*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::FirstPersonFlyingController*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FirstPersonFlyingController*> GlobalNamespace::SonyFirstPersonFlyingControllerHandler::__get__fpsFlying() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::FirstPersonFlyingController*, 0x18>(this);
}
