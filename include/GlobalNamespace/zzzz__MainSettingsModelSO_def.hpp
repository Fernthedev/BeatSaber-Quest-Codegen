...
struct CORDL_TYPE __MainSettingsModelSO__WindowMode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____MainSettingsModelSO__WindowMode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __MainSettingsModelSO__WindowMode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MainSettingsModelSO__WindowMode()  = default;
...
/// @brief Field obstaclesQuality offset 0x4c
...
/// @brief Field smoothCameraThirdPersonPositionY offset 0x8c
...
/// @brief Field smoothCameraThirdPersonPositionZ offset 0x90
...
/// @brief Field smoothCameraThirdPersonEulerAnglesX offset 0x94
...
/// @brief Field smoothCameraThirdPersonEulerAnglesY offset 0x98
...
/// @brief Field smoothCameraThirdPersonEulerAnglesZ offset 0x9c
...
/// @brief Field smoothCameraThirdPersonEnabled offset 0xa0
...
/// @brief Field smoothCameraRotationSmooth offset 0xa4
...
/// @brief Field smoothCameraPositionSmooth offset 0xa8
...
/// @brief Field useCustomServerEnvironment offset 0xac
...
/// @brief Field forceGameLiftServerEnvironment offset 0xad
...
// Ctor Parameters []
// @brief default ctor
 __MainSettingsModelSO__Config()  = default;
public:
...
struct CORDL_TYPE __MainSettingsModelSO___ForceApplyPerformancePresetAsync_d__71 : public ::bs_hook::ValueTypeWrapper<0x40> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field config offset 0x20
 __declspec(property(get=__get_config, put=__set_config)) ::GlobalNamespace::__MainSettingsModelSO__Config*  config;
...
/// @brief Field <>7__wrap1 offset 0x30
 __declspec(property(get=__get___7__wrap1, put=__set___7__wrap1)) ::StringW  __7__wrap1;
...
constexpr void __set_config(::GlobalNamespace::__MainSettingsModelSO__Config*  value) ;

constexpr ::GlobalNamespace::__MainSettingsModelSO__Config* __get_config() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__MainSettingsModelSO__Config*> __get_config() const;
...
constexpr void __set___7__wrap1(::StringW  value) ;

constexpr ::StringW& __get___7__wrap1() ;

constexpr ::StringW const& __get___7__wrap1() const;
...
// Ctor Parameters [CppParam { name: "__1__state", ty: "int32_t", modifiers: "", def_value: None }, CppParam { name: "__t__builder", ty: "::System::Runtime::CompilerServices::AsyncTaskMethodBuilder", modifiers: "", def_value: None }, CppParam { name: "config", ty: "::GlobalNamespace::__MainSettingsModelSO__Config*", modifiers: "", def_value: None }, CppParam { name: "__u__1", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::System::ValueTuple_2<::StringW,::GlobalNamespace::PerformancePreset*>>", modifiers: "", def_value: None }, CppParam { name: "__7__wrap1", ty: "::StringW", modifiers: "", def_value: None }, CppParam { name: "__u__2", ty: "::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::PerformancePreset*>", modifiers: "", def_value: None }]
constexpr __MainSettingsModelSO___ForceApplyPerformancePresetAsync_d__71(int32_t  __1__state, ::System::Runtime::CompilerServices::AsyncTaskMethodBuilder  __t__builder, ::GlobalNamespace::__MainSettingsModelSO__Config*  config, ::System::Runtime::CompilerServices::TaskAwaiter_1<::System::ValueTuple_2<::StringW,::GlobalNamespace::PerformancePreset*>>  __u__1, ::StringW  __7__wrap1, ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::PerformancePreset*>  __u__2) noexcept;

// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __MainSettingsModelSO___ForceApplyPerformancePresetAsync_d__71(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x40>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MainSettingsModelSO___ForceApplyPerformancePresetAsync_d__71()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x1a8 - sizeof(::GlobalNamespace::PersistentScriptableObject)]{};

/// @brief Field kDefaultPlayerHeight offset 0x0
static constexpr float_t  kDefaultPlayerHeight{1.8};

/// @brief Field kHeadPosToPlayerHeightOffset offset 0x0
static constexpr float_t  kHeadPosToPlayerHeightOffset{0.1};

/// @brief Field kFileName offset 0x0
...
/// @brief Field controllerRotation offset 0x78
...
/// @brief Field mirrorGraphicsSettings offset 0x80
...
/// @brief Field mainEffectGraphicsSettings offset 0x88
...
/// @brief Field bloomPrePassGraphicsSettings offset 0x90
...
/// @brief Field smokeGraphicsSettings offset 0x98
...
/// @brief Field enableAlphaFeatures offset 0xa0
...
/// @brief Field pauseButtonPressDurationLevel offset 0xa8
...
/// @brief Field burnMarkTrailsEnabled offset 0xb0
...
/// @brief Field screenDisplacementEffectsEnabled offset 0xb8
...
/// @brief Field obstaclesQuality offset 0xc0
...
/// @brief Field performancePresetKey offset 0xc8
...
/// @brief Field smoothCameraEnabled offset 0xd0
...
/// @brief Field smoothCameraFieldOfView offset 0xd8
...
/// @brief Field smoothCameraThirdPersonPosition offset 0xe0
...
/// @brief Field smoothCameraThirdPersonEulerAngles offset 0xe8
...
/// @brief Field smoothCameraThirdPersonEnabled offset 0xf0
...
/// @brief Field smoothCameraRotationSmooth offset 0xf8
...
/// @brief Field smoothCameraPositionSmooth offset 0x100
...
/// @brief Field overrideAudioLatency offset 0x108
...
/// @brief Field maxNumberOfCutSoundEffects offset 0x120
...
/// @brief Field forceGameLiftServerEnvironment offset 0x138
...
/// @brief Field customServerHostName offset 0x140
...
/// @brief Field useFixedFoveatedRenderingDuringGameplay offset 0x160
...
/// @brief Field <createScreenshotDuringTheGame>k__BackingField offset 0x188
...
/// @brief Field <playingForTheFirstTime>k__BackingField offset 0x189
...
/// @brief Field _playingForTheFirstTimeChecked offset 0x18a
...
/// @brief Field _isLoaded offset 0x18b
 __declspec(property(get=__get__isLoaded, put=__set__isLoaded)) bool  _isLoaded;

/// @brief Field _defaultPerformancePreset offset 0x190
 __declspec(property(get=__get__defaultPerformancePreset, put=__set__defaultPerformancePreset)) ::System::Nullable_1<::System::ValueTuple_2<::StringW,::GlobalNamespace::PerformancePreset*>>  _defaultPerformancePreset;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FloatSO*> __get_vrResolutionScale() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FloatSO*> __get_menuVRResolutionScaleMultiplier() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::Vector2IntSO*> __get_windowResolution() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::Vector2IntSO*> __get_editorWindowResolution() const;

constexpr void __set_fullscreen(::GlobalNamespace::BoolSO*  value) ;

constexpr ::GlobalNamespace::BoolSO* __get_fullscreen() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_fullscreen() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IntSO*> __get_antiAliasingLevel() const;

constexpr void __set_volume(::GlobalNamespace::FloatSO*  value) ;

constexpr ::GlobalNamespace::FloatSO* __get_volume() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FloatSO*> __get_volume() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FloatSO*> __get_ambientVolumeScale() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_controllersRumbleEnabled() const;

constexpr void __set_roomCenter(::GlobalNamespace::Vector3SO*  value) ;

constexpr ::GlobalNamespace::Vector3SO* __get_roomCenter() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::Vector3SO*> __get_roomCenter() const;

constexpr void __set_roomRotation(::GlobalNamespace::FloatSO*  value) ;

constexpr ::GlobalNamespace::FloatSO* __get_roomRotation() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FloatSO*> __get_roomRotation() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::Vector3SO*> __get_controllerPosition() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::Vector3SO*> __get_controllerRotation() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IntSO*> __get_mirrorGraphicsSettings() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IntSO*> __get_mainEffectGraphicsSettings() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IntSO*> __get_bloomPrePassGraphicsSettings() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_smokeGraphicsSettings() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_enableAlphaFeatures() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IntSO*> __get_pauseButtonPressDurationLevel() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_burnMarkTrailsEnabled() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_screenDisplacementEffectsEnabled() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ObstaclesQualitySO*> __get_obstaclesQuality() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::StringSO*> __get_performancePresetKey() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_smoothCameraEnabled() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FloatSO*> __get_smoothCameraFieldOfView() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::Vector3SO*> __get_smoothCameraThirdPersonPosition() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::Vector3SO*> __get_smoothCameraThirdPersonEulerAngles() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_smoothCameraThirdPersonEnabled() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FloatSO*> __get_smoothCameraRotationSmooth() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FloatSO*> __get_smoothCameraPositionSmooth() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_overrideAudioLatency() const;

constexpr void __set_audioLatency(::GlobalNamespace::FloatSO*  value) ;

constexpr ::GlobalNamespace::FloatSO* __get_audioLatency() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FloatSO*> __get_audioLatency() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IntSO*> __get_maxShockwaveParticles() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IntSO*> __get_maxNumberOfCutSoundEffects() const;

constexpr void __set_language(::GlobalNamespace::LanguageSO*  value) ;

constexpr ::GlobalNamespace::LanguageSO* __get_language() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LanguageSO*> __get_language() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_useCustomServerEnvironment() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_forceGameLiftServerEnvironment() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::StringSO*> __get_customServerHostName() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_enableFPSCounter() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_enableFPSRecorder() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_enableMemoryTracker() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_useFixedFoveatedRenderingDuringGameplay() const;

constexpr void __set_gpuLevel(::GlobalNamespace::IntSO*  value) ;

constexpr ::GlobalNamespace::IntSO* __get_gpuLevel() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IntSO*> __get_gpuLevel() const;

constexpr void __set_cpuLevel(::GlobalNamespace::IntSO*  value) ;

constexpr ::GlobalNamespace::IntSO* __get_cpuLevel() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IntSO*> __get_cpuLevel() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FloatSO*> __get_targetFramerate() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> __get_depthTextureEnabled() const;
...
// Ctor Parameters []
// @brief default ctor
 MainSettingsModelSO()  = default;
public:


// Fields

// Static field bestGraphicsPreset
