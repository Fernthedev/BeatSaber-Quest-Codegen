...
constexpr void GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__set_taskUtility(::BGNet::Core::ITaskUtility*  value)  {
::cordl_internals::setInstanceField<::BGNet::Core::ITaskUtility*, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::BGNet::Core::ITaskUtility*>(value));
}
constexpr ::BGNet::Core::ITaskUtility* GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__get_taskUtility()  {
return ::cordl_internals::getInstanceField<::BGNet::Core::ITaskUtility*, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::cordl_internals::to_const_pointer<::BGNet::Core::ITaskUtility*> GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__get_taskUtility() const {
return ::cordl_internals::getInstanceField<::BGNet::Core::ITaskUtility*, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__set_multiplayerSessionManager(::GlobalNamespace::IMultiplayerSessionManager*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::IMultiplayerSessionManager*, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::GlobalNamespace::IMultiplayerSessionManager*>(value));
}
constexpr ::GlobalNamespace::IMultiplayerSessionManager* GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__get_multiplayerSessionManager()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IMultiplayerSessionManager*, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IMultiplayerSessionManager*> GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__get_multiplayerSessionManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IMultiplayerSessionManager*, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__set_creatorId(::StringW  value)  {
...
constexpr ::StringW& GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__get_creatorId()  {
return ::cordl_internals::getInstanceField<::StringW, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::StringW const& GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__get_creatorId() const {
return ::cordl_internals::getInstanceField<::StringW, 0x10>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__set_selectionMask(::GlobalNamespace::BeatmapLevelSelectionMask  value)  {
...
constexpr ::GlobalNamespace::BeatmapLevelSelectionMask& GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__get_selectionMask()  {
...
constexpr ::GlobalNamespace::BeatmapLevelSelectionMask const& GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__get_selectionMask() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapLevelSelectionMask, 0x18>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__set_configuration(::GlobalNamespace::GameplayServerConfiguration  value)  {
...
constexpr ::GlobalNamespace::GameplayServerConfiguration& GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__get_configuration()  {
...
constexpr ::GlobalNamespace::GameplayServerConfiguration const& GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__get_configuration() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayServerConfiguration, 0x40>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr void GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__set_beatmapProvider(::GlobalNamespace::IServerBeatmapProvider*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::IServerBeatmapProvider*, 0x58>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<::GlobalNamespace::IServerBeatmapProvider*>(value));
}
constexpr ::GlobalNamespace::IServerBeatmapProvider* GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__get_beatmapProvider()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IServerBeatmapProvider*, 0x58>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IServerBeatmapProvider*> GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__get_beatmapProvider() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IServerBeatmapProvider*, 0x58>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams::__GameplayServerFiniteStateMachine__InitParams(::BGNet::Core::ITaskUtility*  taskUtility, ::GlobalNamespace::IMultiplayerSessionManager*  multiplayerSessionManager, ::StringW  creatorId, ::GlobalNamespace::BeatmapLevelSelectionMask  selectionMask, ::GlobalNamespace::GameplayServerConfiguration  configuration, ::GlobalNamespace::IServerBeatmapProvider*  beatmapProvider) noexcept : ::bs_hook::ValueTypeWrapper<0x60>() {this->taskUtility = taskUtility;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::GameplayServerFiniteStateMachine::*)(::GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams)>(&::GlobalNamespace::GameplayServerFiniteStateMachine::_ctor)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            ".ctor",
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__GameplayServerFiniteStateMachine__InitParams>::get()}
                        )));
    return ___internal_method;
  }
};
...
::cordl_internals::setInstanceField<::BGNet::Core::ITaskUtility*, 0x10>(this, std::forward<::BGNet::Core::ITaskUtility*>(value));
}
constexpr ::BGNet::Core::ITaskUtility* GlobalNamespace::GameplayServerFiniteStateMachine::__get__taskUtility_k__BackingField()  {
return ::cordl_internals::getInstanceField<::BGNet::Core::ITaskUtility*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::BGNet::Core::ITaskUtility*> GlobalNamespace::GameplayServerFiniteStateMachine::__get__taskUtility_k__BackingField() const {
return ::cordl_internals::getInstanceField<::BGNet::Core::ITaskUtility*, 0x10>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IMultiplayerSessionManager*> GlobalNamespace::GameplayServerFiniteStateMachine::__get__multiplayerSessionManager_k__BackingField() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IMultiplayerSessionManager*, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::BeatmapLevelSelectionMask, 0x28>(this, std::forward<::GlobalNamespace::BeatmapLevelSelectionMask>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapLevelSelectionMask, 0x28>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::GameplayServerConfiguration, 0x50>(this, std::forward<::GlobalNamespace::GameplayServerConfiguration>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayServerConfiguration, 0x50>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::IServerBeatmapProvider*, 0x68>(this, std::forward<::GlobalNamespace::IServerBeatmapProvider*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::IServerBeatmapProvider*, 0x68>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IServerBeatmapProvider*> GlobalNamespace::GameplayServerFiniteStateMachine::__get__beatmapProvider_k__BackingField() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IServerBeatmapProvider*, 0x68>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::MenuRpcManager*, 0x70>(this, std::forward<::GlobalNamespace::MenuRpcManager*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::MenuRpcManager*, 0x70>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MenuRpcManager*> GlobalNamespace::GameplayServerFiniteStateMachine::__get__menuRpcManager_k__BackingField() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MenuRpcManager*, 0x70>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::GameplayRpcManager*, 0x78>(this, std::forward<::GlobalNamespace::GameplayRpcManager*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayRpcManager*, 0x78>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameplayRpcManager*> GlobalNamespace::GameplayServerFiniteStateMachine::__get__gameplayRpcManager_k__BackingField() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayRpcManager*, 0x78>(this);
}
constexpr void GlobalNamespace::GameplayServerFiniteStateMachine::__set_state(::GlobalNamespace::GameState*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::GameState*, 0x80>(this, std::forward<::GlobalNamespace::GameState*>(value));
}
constexpr ::GlobalNamespace::GameState* GlobalNamespace::GameplayServerFiniteStateMachine::__get_state()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameState*, 0x80>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameState*> GlobalNamespace::GameplayServerFiniteStateMachine::__get_state() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameState*, 0x80>(this);
}
