...
/// @brief Method Start addr 0x2807864 size 0x8c virtual false final false
inline void Start() ;

/// @brief Method OnDestroy addr 0x28078f0 size 0xd4 virtual false final false
inline void OnDestroy() ;

/// @brief Method HandleGameScenesManagerTransitionDidStart addr 0x28079c4 size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0x28079e0 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 FadeOutOnSceneTransitionStart()  = default;
public:
