...
::cordl_internals::setInstanceField<::Polyglot::Localization*, 0x18>(this, std::forward<::Polyglot::Localization*>(value));
}
constexpr ::Polyglot::Localization* GlobalNamespace::LocalizationProvider::__get__localization()  {
return ::cordl_internals::getInstanceField<::Polyglot::Localization*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::Polyglot::Localization*> GlobalNamespace::LocalizationProvider::__get__localization() const {
return ::cordl_internals::getInstanceField<::Polyglot::Localization*, 0x18>(this);
}
