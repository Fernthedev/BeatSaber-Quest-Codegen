...
// Ctor Parameters []
// @brief default ctor
 __StandardLevelGameplayManager__InitData()  = default;
public:
...
struct CORDL_TYPE __StandardLevelGameplayManager__GameState : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____StandardLevelGameplayManager__GameState_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __StandardLevelGameplayManager__GameState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __StandardLevelGameplayManager__GameState()  = default;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::StandardLevelGameplayManager*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __StandardLevelGameplayManager___Start_d__22()  = default;
public:
...
/// @brief Field _gameSongController offset 0x20
...
/// @brief Field _pauseController offset 0x30
...
/// @brief Field levelWillStartIntroEvent offset 0x40
...
/// @brief Field _prePauseGameState offset 0x64
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__StandardLevelGameplayManager__InitData*> __get__initData() const;
...
// Ctor Parameters []
// @brief default ctor
 StandardLevelGameplayManager()  = default;
public:
