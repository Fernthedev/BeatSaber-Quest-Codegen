...
/// @brief Field _environmentInfo offset 0x38
...
/// @brief Field _practiceSettings offset 0x50
...
// Ctor Parameters []
// @brief default ctor
 StandardLevelNoTransitionInstallerData()  = default;
public:
