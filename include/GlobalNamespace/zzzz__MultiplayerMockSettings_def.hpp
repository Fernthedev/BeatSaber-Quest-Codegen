...
/// @brief Field _quickplayServer offset 0x30
...
/// @brief Field _multiplayerStatusData offset 0x38
...
/// @brief Field _quickPlaySetupData offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MockPlayerSettings*> __get__localPlayer() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::MockPlayerSettings*>*> __get__otherPlayers() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MockServerSettings*> __get__quickplayServer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerStatusData*> __get__multiplayerStatusData() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerMockSettings()  = default;
public:
