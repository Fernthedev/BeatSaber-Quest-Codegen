...
::cordl_internals::setInstanceField<::GlobalNamespace::SaberActivityCounter*, 0x48>(this, std::forward<::GlobalNamespace::SaberActivityCounter*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::SaberActivityCounter*, 0x48>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SaberActivityCounter*> GlobalNamespace::HandsMovementMissionObjectiveChecker::__get__saberActivityCounter() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SaberActivityCounter*, 0x48>(this);
}
