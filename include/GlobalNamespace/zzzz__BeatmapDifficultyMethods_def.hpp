...
/// @brief Method Name addr 0x2340cf0 size 0x9c virtual false final false
static inline ::StringW Name(::GlobalNamespace::BeatmapDifficulty  difficulty) ;

/// @brief Method ShortName addr 0x2340d8c size 0x9c virtual false final false
static inline ::StringW ShortName(::GlobalNamespace::BeatmapDifficulty  difficulty) ;

/// @brief Method DefaultRating addr 0x2340e28 size 0x28 virtual false final false
static inline int32_t DefaultRating(::GlobalNamespace::BeatmapDifficulty  difficulty) ;

/// @brief Method NoteJumpMovementSpeed addr 0x2340e50 size 0x28 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 BeatmapDifficultyMethods()  = default;
public:
