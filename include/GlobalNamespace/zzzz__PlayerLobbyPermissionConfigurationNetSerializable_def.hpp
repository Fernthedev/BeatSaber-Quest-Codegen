...
/// @brief Field _hasRecommendGameplayModifiersPermission offset 0x22
...
// Ctor Parameters []
// @brief default ctor
 PlayerLobbyPermissionConfigurationNetSerializable()  = default;
public:
