...
struct CORDL_TYPE __UnifiedNetworkPlayerModel__ActiveNetworkPlayerModelType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____UnifiedNetworkPlayerModel__ActiveNetworkPlayerModelType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __UnifiedNetworkPlayerModel__ActiveNetworkPlayerModelType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __UnifiedNetworkPlayerModel__ActiveNetworkPlayerModelType()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __UnifiedNetworkPlayerModel__JoinMatchmakingPartyConfig()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __UnifiedNetworkPlayerModel__StartClientPartyConfig()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::UnifiedNetworkPlayerModel*> __get___4__this() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IEnumerator_1<::GlobalNamespace::INetworkPlayer*>*> __get___7__wrap1() const;
...
// Ctor Parameters []
// @brief default ctor
 __UnifiedNetworkPlayerModel___get_otherPlayers_d__64()  = default;
public:
...
/// @brief Field _gameLiftNetworkPlayerModel offset 0x10
...
/// @brief Field _platformNetworkPlayerModel offset 0x18
...
/// @brief Field connectedPlayerManagerCreatedEvent offset 0x20
...
/// @brief Field connectedPlayerManagerDestroyedEvent offset 0x28
...
/// @brief Field partySizeChangedEvent offset 0x30
...
/// @brief Field joinRequestedEvent offset 0x48
...
/// @brief Field inviteRequestedEvent offset 0x50
...
/// @brief Field _partyMessageHandler offset 0x58
...
/// @brief Field _friendPartyMessageHandler offset 0x60
...
/// @brief Field _activeNetworkPlayerModelType offset 0x68
 __declspec(property(get=__get__activeNetworkPlayerModelType, put=__set__activeNetworkPlayerModelType)) ::GlobalNamespace::__UnifiedNetworkPlayerModel__ActiveNetworkPlayerModelType  _activeNetworkPlayerModelType;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameLiftNetworkPlayerModel*> __get__gameLiftNetworkPlayerModel() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlatformNetworkPlayerModel*> __get__platformNetworkPlayerModel() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PartyMessageHandler*> __get__partyMessageHandler() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PartyMessageHandler*> __get__friendPartyMessageHandler() const;
...
// Ctor Parameters []
// @brief default ctor
 UnifiedNetworkPlayerModel()  = default;
public:
