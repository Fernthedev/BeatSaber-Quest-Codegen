...
/// @brief Field <beatmapLevel>k__BackingField offset 0x10
...
/// @brief Field <beatmapCharacteristic>k__BackingField offset 0x18
...
/// @brief Field <beatmapDifficulty>k__BackingField offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IPreviewBeatmapLevel*> __get__beatmapLevel_k__BackingField() const;
...
/// @brief Method get_beatmapLevel addr 0x234c2fc size 0x8 virtual false final false
inline ::GlobalNamespace::IPreviewBeatmapLevel* get_beatmapLevel() ;

/// @brief Method set_beatmapLevel addr 0x234c304 size 0x8 virtual false final false
inline void set_beatmapLevel(::GlobalNamespace::IPreviewBeatmapLevel*  value) ;

/// @brief Method get_beatmapCharacteristic addr 0x234c30c size 0x8 virtual false final false
inline ::GlobalNamespace::BeatmapCharacteristicSO* get_beatmapCharacteristic() ;

/// @brief Method set_beatmapCharacteristic addr 0x234c314 size 0x8 virtual false final false
inline void set_beatmapCharacteristic(::GlobalNamespace::BeatmapCharacteristicSO*  value) ;

/// @brief Method get_beatmapDifficulty addr 0x234c31c size 0x8 virtual false final false
inline ::GlobalNamespace::BeatmapDifficulty get_beatmapDifficulty() ;

/// @brief Method set_beatmapDifficulty addr 0x234c324 size 0x8 virtual false final false
inline void set_beatmapDifficulty(::GlobalNamespace::BeatmapDifficulty  value) ;

static inline ::GlobalNamespace::PreviewDifficultyBeatmap* New_ctor(::GlobalNamespace::IPreviewBeatmapLevel*  beatmapLevel, ::GlobalNamespace::BeatmapCharacteristicSO*  beatmapCharacteristic, ::GlobalNamespace::BeatmapDifficulty  beatmapDifficulty) ;

/// @brief Method .ctor addr 0x2341690 size 0x3c virtual false final false
...
/// @brief Method Equals addr 0x234c32c size 0xb4 virtual true final true
inline bool Equals(::GlobalNamespace::PreviewDifficultyBeatmap*  other) ;

/// @brief Method Equals addr 0x234c3e0 size 0x10c virtual true final false
inline bool Equals(::System::Object*  obj) ;

/// @brief Method GetHashCode addr 0x234c4ec size 0xc0 virtual true final false
inline int32_t GetHashCode() ;

/// @brief Method op_Equality addr 0x23417ec size 0x18 virtual false final false
static inline bool op_Equality(::GlobalNamespace::PreviewDifficultyBeatmap*  a, ::GlobalNamespace::PreviewDifficultyBeatmap*  b) ;

/// @brief Method op_Inequality addr 0x234c5ac size 0x34 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 PreviewDifficultyBeatmap()  = default;
public:
