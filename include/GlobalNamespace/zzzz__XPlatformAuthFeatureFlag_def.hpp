...
/// @brief Field <UseXPlatformAuth>k__BackingField offset 0x10
...
/// @brief Method get_UseXPlatformAuth addr 0xe5df24 size 0x8 virtual false final false
inline bool get_UseXPlatformAuth() ;

/// @brief Method set_UseXPlatformAuth addr 0xe5df2c size 0xc virtual false final false
inline void set_UseXPlatformAuth(bool  value) ;

static inline ::GlobalNamespace::XPlatformAuthFeatureFlag* New_ctor() ;

/// @brief Method .ctor addr 0xe5df38 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 XPlatformAuthFeatureFlag()  = default;
public:
