...
::cordl_internals::setInstanceField<::UnityEngine::PropertyName, 0x28>(this, std::forward<::UnityEngine::PropertyName>(value));
}
constexpr ::UnityEngine::PropertyName& GlobalNamespace::TimelinePauseMarker::__get__id_k__BackingField()  {
return ::cordl_internals::getInstanceField<::UnityEngine::PropertyName, 0x28>(this);
}
