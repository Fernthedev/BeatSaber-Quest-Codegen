...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PrepareLevelCompletionResults*> GlobalNamespace::MissionLevelFinishedController::__get__prepareLevelCompletionResults() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::PrepareLevelCompletionResults*, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO*, 0x20>(this, std::forward<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO*> GlobalNamespace::MissionLevelFinishedController::__get__missionLevelSceneSetupData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MissionLevelScenesTransitionSetupDataSO*, 0x20>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionObjectiveCheckersManager*> GlobalNamespace::MissionLevelFinishedController::__get__missionObjectiveCheckersManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MissionObjectiveCheckersManager*, 0x28>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::ILevelEndActions*, 0x30>(this, std::forward<::GlobalNamespace::ILevelEndActions*>(value));
}
constexpr ::GlobalNamespace::ILevelEndActions* GlobalNamespace::MissionLevelFinishedController::__get__gameplayManager()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ILevelEndActions*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ILevelEndActions*> GlobalNamespace::MissionLevelFinishedController::__get__gameplayManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ILevelEndActions*, 0x30>(this);
}
