...
/// @brief Field _beatmapObjectManager offset 0x10
 __declspec(property(get=__get__beatmapObjectManager, put=__set__beatmapObjectManager)) ::GlobalNamespace::BeatmapObjectManager*  _beatmapObjectManager;

/// @brief Field _mirroredBasicGameNotePoolContainer offset 0x18
 __declspec(property(get=__get__mirroredBasicGameNotePoolContainer, put=__set__mirroredBasicGameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredGameNoteController*>*  _mirroredBasicGameNotePoolContainer;

/// @brief Field _mirroredBurstSliderHeadGameNotePoolContainer offset 0x20
 __declspec(property(get=__get__mirroredBurstSliderHeadGameNotePoolContainer, put=__set__mirroredBurstSliderHeadGameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredGameNoteController*>*  _mirroredBurstSliderHeadGameNotePoolContainer;

/// @brief Field _mirroredBurstSliderGameNotePoolContainer offset 0x28
 __declspec(property(get=__get__mirroredBurstSliderGameNotePoolContainer, put=__set__mirroredBurstSliderGameNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredGameNoteController*>*  _mirroredBurstSliderGameNotePoolContainer;

/// @brief Field _mirroredBurstSliderFillPoolContainer offset 0x30
 __declspec(property(get=__get__mirroredBurstSliderFillPoolContainer, put=__set__mirroredBurstSliderFillPoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredGameNoteController*>*  _mirroredBurstSliderFillPoolContainer;

/// @brief Field _mirroredBombNotePoolContainer offset 0x38
 __declspec(property(get=__get__mirroredBombNotePoolContainer, put=__set__mirroredBombNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredBombNoteController*>*  _mirroredBombNotePoolContainer;

/// @brief Field _mirroredObstaclePoolContainer offset 0x40
 __declspec(property(get=__get__mirroredObstaclePoolContainer, put=__set__mirroredObstaclePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredObstacleController*>*  _mirroredObstaclePoolContainer;

/// @brief Field _mirroredSlidersPoolContainer offset 0x48
 __declspec(property(get=__get__mirroredSlidersPoolContainer, put=__set__mirroredSlidersPoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredSliderController*>*  _mirroredSlidersPoolContainer;

/// @brief Field _gameNoteControllersToMirroredGameNoteControllers offset 0x50
 __declspec(property(get=__get__gameNoteControllersToMirroredGameNoteControllers, put=__set__gameNoteControllersToMirroredGameNoteControllers)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::IGameNoteMirrorable*,::System::ValueTuple_2<::GlobalNamespace::MirroredGameNoteController*,::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredGameNoteController*>*>>*  _gameNoteControllersToMirroredGameNoteControllers;

/// @brief Field _bombNoteControllersToMirroredBombNoteControllers offset 0x58
 __declspec(property(get=__get__bombNoteControllersToMirroredBombNoteControllers, put=__set__bombNoteControllersToMirroredBombNoteControllers)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::INoteMirrorable*,::GlobalNamespace::MirroredBombNoteController*>*  _bombNoteControllersToMirroredBombNoteControllers;

/// @brief Field _obstacleControllersToMirroredObstacleControllers offset 0x60
 __declspec(property(get=__get__obstacleControllersToMirroredObstacleControllers, put=__set__obstacleControllersToMirroredObstacleControllers)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ObstacleController*,::GlobalNamespace::MirroredObstacleController*>*  _obstacleControllersToMirroredObstacleControllers;

/// @brief Field _sliderControllersToMirroredSliderControllers offset 0x68
 __declspec(property(get=__get__sliderControllersToMirroredSliderControllers, put=__set__sliderControllersToMirroredSliderControllers)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::SliderController*,::GlobalNamespace::MirroredSliderController*>*  _sliderControllersToMirroredSliderControllers;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredGameNoteController*>*> __get__mirroredBasicGameNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredGameNoteController*>*> __get__mirroredBurstSliderHeadGameNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredGameNoteController*>*> __get__mirroredBurstSliderGameNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredGameNoteController*>*> __get__mirroredBurstSliderFillPoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredBombNoteController*>*> __get__mirroredBombNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredObstacleController*>*> __get__mirroredObstaclePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredSliderController*>*> __get__mirroredSlidersPoolContainer() const;
...
constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::IGameNoteMirrorable*,::System::ValueTuple_2<::GlobalNamespace::MirroredGameNoteController*,::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::MirroredGameNoteController*>*>>* __get__gameNoteControllersToMirroredGameNoteControllers() ;
...
constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::INoteMirrorable*,::GlobalNamespace::MirroredBombNoteController*>* __get__bombNoteControllersToMirroredBombNoteControllers() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::INoteMirrorable*,::GlobalNamespace::MirroredBombNoteController*>*> __get__bombNoteControllersToMirroredBombNoteControllers() const;
...
constexpr ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ObstacleController*,::GlobalNamespace::MirroredObstacleController*>* __get__obstacleControllersToMirroredObstacleControllers() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::ObstacleController*,::GlobalNamespace::MirroredObstacleController*>*> __get__obstacleControllersToMirroredObstacleControllers() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::SliderController*,::GlobalNamespace::MirroredSliderController*>*> __get__sliderControllersToMirroredSliderControllers() const;
...
// Ctor Parameters []
// @brief default ctor
 MirroredBeatmapObjectManager()  = default;
public:
