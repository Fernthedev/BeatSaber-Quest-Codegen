...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::GlobalNamespace::MockPlayerLobbyPoseGenerator)]{};
...
/// @brief Method .ctor addr 0x22442f4 size 0x8 virtual false final false
inline void _ctor(::GlobalNamespace::IMultiplayerSessionManager*  multiplayerSessionManager) ;

/// @brief Method Init addr 0x22442fc size 0x68 virtual true final false
inline void Init() ;

/// @brief Method Tick addr 0x2244364 size 0x68 virtual true final false
inline void Tick() ;
...
// Ctor Parameters []
// @brief default ctor
 MockPlayerLobbyPoseGeneratorRecording()  = default;
public:
