...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::GlobalNamespace::BeatmapLevelPackSO*,::Array<::GlobalNamespace::BeatmapLevelPackSO*>*> (::GlobalNamespace::AlwaysOwnedContentSO::*)()>(&::GlobalNamespace::AlwaysOwnedContentSO::get_alwaysOwnedPacks)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::GlobalNamespace::BeatmapLevelSO*,::Array<::GlobalNamespace::BeatmapLevelSO*>*> (::GlobalNamespace::AlwaysOwnedContentSO::*)()>(&::GlobalNamespace::AlwaysOwnedContentSO::get_alwaysOwnedBeatmapLevels)> {
  constexpr static std::size_t size = 0x8;
...
::cordl_internals::setInstanceField<::ArrayW<::GlobalNamespace::BeatmapLevelSO*,::Array<::GlobalNamespace::BeatmapLevelSO*>*>, 0x20>(this, std::forward<::ArrayW<::GlobalNamespace::BeatmapLevelSO*,::Array<::GlobalNamespace::BeatmapLevelSO*>*>>(value));
}
...
return ::cordl_internals::getInstanceField<::ArrayW<::GlobalNamespace::BeatmapLevelSO*,::Array<::GlobalNamespace::BeatmapLevelSO*>*>, 0x20>(this);
}
