...
/// @brief Field _beatmapLevelPacks offset 0x18
 __declspec(property(get=__get__beatmapLevelPacks, put=__set__beatmapLevelPacks)) ::ArrayW<::GlobalNamespace::BeatmapLevelPackSO*,::Array<::GlobalNamespace::BeatmapLevelPackSO*>*>  _beatmapLevelPacks;

/// @brief Field _previewBeatmapLevelPack offset 0x20
 __declspec(property(get=__get__previewBeatmapLevelPack, put=__set__previewBeatmapLevelPack)) ::ArrayW<::GlobalNamespace::PreviewBeatmapLevelPackSO*,::Array<::GlobalNamespace::PreviewBeatmapLevelPackSO*>*>  _previewBeatmapLevelPack;

/// @brief Field _allBeatmapLevelPacks offset 0x28
 ...
 __declspec(property(get=get_previewBeatmapLevelPack, put=set_previewBeatmapLevelPack)) ::ArrayW<::GlobalNamespace::PreviewBeatmapLevelPackSO*,::Array<::GlobalNamespace::PreviewBeatmapLevelPackSO*>*>  previewBeatmapLevelPack;
...
// Ctor Parameters []
// @brief default ctor
 BeatmapLevelPackCollectionSO()  = default;
public:
