...
/// @brief Field _playerSpaceConvertor offset 0x38
...
/// @brief Field noteJumpDidFinishEvent offset 0x48
...
/// @brief Field noteJumpDidPassMissedMarkerEvent offset 0x50
...
/// @brief Field noteJumpDidPassThreeQuartersEvent offset 0x58
...
/// @brief Field noteJumpDidPassHalfEvent offset 0x60
...
/// @brief Field noteJumpDidUpdateProgressEvent offset 0x68
...
/// @brief Field _rotateTowardsPlayer offset 0x118
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__rotatedObject() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlayerSpaceConvertor*> __get__playerSpaceConvertor() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_noteJumpDidFinishEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_noteJumpDidPassMissedMarkerEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::NoteJump*>*> __get_noteJumpDidPassThreeQuartersEvent() const;

constexpr void __set_noteJumpDidPassHalfEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_noteJumpDidPassHalfEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_noteJumpDidPassHalfEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<float_t>*> __get_noteJumpDidUpdateProgressEvent() const;
