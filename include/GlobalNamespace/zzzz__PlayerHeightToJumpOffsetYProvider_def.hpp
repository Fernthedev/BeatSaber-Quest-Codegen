...
/// @brief Field _playerHeightDetector offset 0x10
...
/// @brief Field _jumpOffsetY offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlayerHeightDetector*> __get__playerHeightDetector() const;
...
// Ctor Parameters []
// @brief default ctor
 PlayerHeightToJumpOffsetYProvider()  = default;
public:
