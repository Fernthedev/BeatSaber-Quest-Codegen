...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MaterialPropertyBlockController*> GlobalNamespace::CutoutEffect::__get__materialPropertyBlockController() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MaterialPropertyBlockController*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> GlobalNamespace::CutoutEffect::__get__useRandomCutoutOffset() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BoolSO*, 0x20>(this);
}
