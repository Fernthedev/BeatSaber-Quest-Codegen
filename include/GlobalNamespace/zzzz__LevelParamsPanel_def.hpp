...
/// @brief Field _notesPerSecondText offset 0x18
...
/// @brief Field _bombsCountText offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> __get__notesPerSecondText() const;

constexpr void __set__notesCountText(::TMPro::TextMeshProUGUI*  value) ;

constexpr ::TMPro::TextMeshProUGUI* __get__notesCountText() ;

constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> __get__notesCountText() const;
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> __get__obstaclesCountText() const;

constexpr void __set__bombsCountText(::TMPro::TextMeshProUGUI*  value) ;

constexpr ::TMPro::TextMeshProUGUI* __get__bombsCountText() ;

constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> __get__bombsCountText() const;
