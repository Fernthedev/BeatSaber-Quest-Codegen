...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ResultsViewController*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __ResultsViewController___StartFireworksAfterDelay_d__33()  = default;
public:
...
/// @brief Field _restartButton offset 0x70
...
/// @brief Field _fireworksController offset 0xd0
...
/// @brief Field _songPreviewPlayer offset 0xd8
...
/// @brief Field _resultsEnvironmentManager offset 0xe0
...
/// @brief Field _menuDestinationRequest offset 0xe8
...
/// @brief Field continueButtonPressedEvent offset 0xf0
...
/// @brief Field restartButtonPressedEvent offset 0xf8
...
/// @brief Field _levelCompletionResults offset 0x100
...
/// @brief Field _difficultyBeatmap offset 0x108
...
/// @brief Field _transformedBeatmapData offset 0x110
...
/// @brief Field _startFireworksAfterDelayCoroutine offset 0x118
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__clearedPanel() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__newHighScoreText() const;
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> __get__goodCutsPercentageText() const;

constexpr void __set__comboText(::TMPro::TextMeshProUGUI*  value) ;

constexpr ::TMPro::TextMeshProUGUI* __get__comboText() ;

constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> __get__comboText() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ResultsEnvironmentManager*> __get__resultsEnvironmentManager() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::ResultsViewController*>*> __get_continueButtonPressedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::ResultsViewController*>*> __get_restartButtonPressedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LevelCompletionResults*> __get__levelCompletionResults() const;
...
inline void Init(::GlobalNamespace::LevelCompletionResults*  levelCompletionResults, ::GlobalNamespace::IReadonlyBeatmapData*  transformedBeatmapData, ::GlobalNamespace::IDifficultyBeatmap*  difficultyBeatmap, bool  practice, bool  newHighScore) ;
