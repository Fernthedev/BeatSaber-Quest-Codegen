...
struct CORDL_TYPE __OVRHand__Hand : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____OVRHand__Hand_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __OVRHand__Hand(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRHand__Hand()  = default;
...
struct CORDL_TYPE __OVRHand__HandFinger : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____OVRHand__HandFinger_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRHand__HandFinger(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRHand__HandFinger()  = default;
...
struct CORDL_TYPE __OVRHand__TrackingConfidence : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____OVRHand__TrackingConfidence_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRHand__TrackingConfidence(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRHand__TrackingConfidence()  = default;
...
/// @brief Field <IsDataHighConfidence>k__BackingField offset 0xb1
...
/// @brief Field <IsTracked>k__BackingField offset 0xb2
...
/// @brief Field <IsSystemGestureInProgress>k__BackingField offset 0xb3
...
/// @brief Field <IsPointerPoseValid>k__BackingField offset 0xb4
...
/// @brief Field <PointerPose>k__BackingField offset 0xb8
...
/// @brief Field <HandScale>k__BackingField offset 0xc0
...
/// @brief Field <HandConfidence>k__BackingField offset 0xc4
...
/// @brief Field <IsDominantHand>k__BackingField offset 0xc8
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__pointerPoseRoot() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__pointerPoseGO() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> __get__PointerPose_k__BackingField() const;
...
/// @brief Method SetHandType addr 0x27aeb50 size 0x8 virtual false final false
inline void SetHandType(::GlobalNamespace::__OVRHand__Hand  type) ;

/// @brief Method get_IsDataValid addr 0x27aeb58 size 0x8 virtual false final false
inline bool get_IsDataValid() ;

/// @brief Method set_IsDataValid addr 0x27aeb60 size 0xc virtual false final false
inline void set_IsDataValid(bool  value) ;

/// @brief Method get_IsDataHighConfidence addr 0x27aeb6c size 0x8 virtual false final false
inline bool get_IsDataHighConfidence() ;

/// @brief Method set_IsDataHighConfidence addr 0x27aeb74 size 0xc virtual false final false
inline void set_IsDataHighConfidence(bool  value) ;

/// @brief Method get_IsTracked addr 0x27aeb80 size 0x8 virtual false final false
inline bool get_IsTracked() ;

/// @brief Method set_IsTracked addr 0x27aeb88 size 0xc virtual false final false
inline void set_IsTracked(bool  value) ;

/// @brief Method get_IsSystemGestureInProgress addr 0x27aeb94 size 0x8 virtual false final false
inline bool get_IsSystemGestureInProgress() ;

/// @brief Method set_IsSystemGestureInProgress addr 0x27aeb9c size 0xc virtual false final false
inline void set_IsSystemGestureInProgress(bool  value) ;

/// @brief Method get_IsPointerPoseValid addr 0x27aeba8 size 0x8 virtual false final false
inline bool get_IsPointerPoseValid() ;

/// @brief Method set_IsPointerPoseValid addr 0x27aebb0 size 0xc virtual false final false
inline void set_IsPointerPoseValid(bool  value) ;

/// @brief Method get_PointerPose addr 0x27aebbc size 0x8 virtual false final false
inline ::UnityEngine::Transform* get_PointerPose() ;

/// @brief Method set_PointerPose addr 0x27aebc4 size 0x8 virtual false final false
inline void set_PointerPose(::UnityEngine::Transform*  value) ;

/// @brief Method get_HandScale addr 0x27aebcc size 0x8 virtual false final false
inline float_t get_HandScale() ;

/// @brief Method set_HandScale addr 0x27aebd4 size 0x8 virtual false final false
inline void set_HandScale(float_t  value) ;

/// @brief Method get_HandConfidence addr 0x27aebdc size 0x8 virtual false final false
inline ::GlobalNamespace::__OVRHand__TrackingConfidence get_HandConfidence() ;

/// @brief Method set_HandConfidence addr 0x27aebe4 size 0x8 virtual false final false
inline void set_HandConfidence(::GlobalNamespace::__OVRHand__TrackingConfidence  value) ;

/// @brief Method get_IsDominantHand addr 0x27aebec size 0x8 virtual false final false
inline bool get_IsDominantHand() ;

/// @brief Method set_IsDominantHand addr 0x27aebf4 size 0xc virtual false final false
inline void set_IsDominantHand(bool  value) ;

/// @brief Method Awake addr 0x27aec00 size 0xcc virtual false final false
inline void Awake() ;

/// @brief Method Update addr 0x27aef2c size 0x8 virtual false final false
inline void Update() ;

/// @brief Method FixedUpdate addr 0x27aef34 size 0x74 virtual false final false
inline void FixedUpdate() ;

/// @brief Method GetHandState addr 0x27aeccc size 0x260 virtual false final false
inline void GetHandState(::GlobalNamespace::__OVRPlugin__Step  step) ;

/// @brief Method GetFingerIsPinching addr 0x27aefa8 size 0x28 virtual false final false
inline bool GetFingerIsPinching(::GlobalNamespace::__OVRHand__HandFinger  finger) ;

/// @brief Method GetFingerPinchStrength addr 0x27aefd0 size 0x40 virtual false final false
inline float_t GetFingerPinchStrength(::GlobalNamespace::__OVRHand__HandFinger  finger) ;

/// @brief Method GetFingerConfidence addr 0x27af010 size 0x44 virtual false final false
inline ::GlobalNamespace::__OVRHand__TrackingConfidence GetFingerConfidence(::GlobalNamespace::__OVRHand__HandFinger  finger) ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonType addr 0x27af054 size 0x18 virtual true final true
inline ::GlobalNamespace::__OVRSkeleton__SkeletonType OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonType() ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.GetSkeletonPoseData addr 0x27af06c size 0x6c virtual true final true
inline ::GlobalNamespace::__OVRSkeleton__SkeletonPoseData OVRSkeleton_IOVRSkeletonDataProvider_GetSkeletonPoseData() ;

/// @brief Method OVRSkeletonRenderer.IOVRSkeletonRendererDataProvider.GetSkeletonRendererData addr 0x27af0d8 size 0x4c virtual true final true
...
/// @brief Method OVRMesh.IOVRMeshDataProvider.GetMeshType addr 0x27af124 size 0x18 virtual true final true
inline ::GlobalNamespace::__OVRMesh__MeshType OVRMesh_IOVRMeshDataProvider_GetMeshType() ;

/// @brief Method OVRMeshRenderer.IOVRMeshRendererDataProvider.GetMeshRendererData addr 0x27af13c size 0x50 virtual true final true
...
/// @brief Method .ctor addr 0x27af18c size 0x18 virtual false final false
inline void _ctor() ;

/// @brief Method OVRSkeleton.IOVRSkeletonDataProvider.get_enabled addr 0x27af1a4 size 0x8 virtual true final true
