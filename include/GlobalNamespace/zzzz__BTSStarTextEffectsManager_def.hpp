...
/// @brief Field effectController offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BTSStarTextEffectController*> __get_effectController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BTSStarTextEffectsManager*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __BTSStarTextEffectsManager___DespawnEffectDelayed_d__5()  = default;
public:
...
/// @brief Field _btsStarTextEventEffect offset 0x18
...
/// @brief Field _btsStarTextEffectControllerPool offset 0x20
 __declspec(property(get=__get__btsStarTextEffectControllerPool, put=__set__btsStarTextEffectControllerPool)) ::GlobalNamespace::__BTSStarTextEffectController__Pool*  _btsStarTextEffectControllerPool;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BTSStarTextEventEffect*> __get__btsStarTextEventEffect() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__BTSStarTextEffectController__Pool*> __get__btsStarTextEffectControllerPool() const;
...
// Ctor Parameters []
// @brief default ctor
 BTSStarTextEffectsManager()  = default;
public:
