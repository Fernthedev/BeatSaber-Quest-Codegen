...
/// @brief Field kFixedSyncTimeOffset offset 0x0
...
/// @brief Field _publicEncryptionKey offset 0x80
...
/// @brief Field _latency offset 0x98
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ConnectedPlayerManager*> __get__manager() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IConnection*> __get__connection() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*> __get__parent() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__EncryptionUtility__IEncryptionState*> __get__encryptionState() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LongRollingAverage*> __get__latency() const;
...
// Ctor Parameters []
// @brief default ctor
 __ConnectedPlayerManager__ConnectedPlayer()  = default;
public:
...
struct CORDL_TYPE __ConnectedPlayerManager__InternalMessageType : public ::bs_hook::EnumTypeWrapper<0x1> {
public:
// Declarations
...
return std::bit_cast<____ConnectedPlayerManager__InternalMessageType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x1>::instance);
}
...
constexpr explicit __ConnectedPlayerManager__InternalMessageType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x1>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ConnectedPlayerManager__InternalMessageType()  = default;
...
struct CORDL_TYPE __ConnectedPlayerManager__MessageType : public ::bs_hook::EnumTypeWrapper<0x1> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = uint8_t;
...
return std::bit_cast<____ConnectedPlayerManager__MessageType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x1>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __ConnectedPlayerManager__MessageType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x1>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ConnectedPlayerManager__MessageType()  = default;
...
/// @brief Field remoteConnectionId offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __ConnectedPlayerManager__PlayerConnectedPacket()  = default;
public:
...
/// @brief Field publicEncryptionKey offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ByteArrayNetSerializable*> __get_random() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ByteArrayNetSerializable*> __get_publicEncryptionKey() const;
...
// Ctor Parameters []
// @brief default ctor
 __ConnectedPlayerManager__PlayerIdentityPacket()  = default;
public:
...
/// @brief Field playerAvatar offset 0x10
 __declspec(property(get=__get_playerAvatar, put=__set_playerAvatar)) ::GlobalNamespace::MultiplayerAvatarsData  playerAvatar;
...
// Ctor Parameters []
// @brief default ctor
 __ConnectedPlayerManager__PlayerAvatarPacket()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __ConnectedPlayerManager__PlayerStatePacket()  = default;
public:
...
/// @brief Field sortIndex offset 0x18
...
// Ctor Parameters []
// @brief default ctor
 __ConnectedPlayerManager__PlayerSortOrderPacket()  = default;
public:
...
/// @brief Field disconnectedReason offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __ConnectedPlayerManager__PlayerDisconnectedPacket()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __ConnectedPlayerManager__KickPlayerPacket()  = default;
public:
...
/// @brief Field syncTime offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __ConnectedPlayerManager__SyncTimePacket()  = default;
public:
...
/// @brief Field pingTime offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __ConnectedPlayerManager__PingPacket()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __ConnectedPlayerManager__PongPacket()  = default;
public:
...
struct CORDL_TYPE __ConnectedPlayerManager___InitializePlayerEncryption_d__132 : public ::bs_hook::ValueTypeWrapper<0x50> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field <>4__this offset 0x28
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::GlobalNamespace::ConnectedPlayerManager*  __4__this;

/// @brief Field player offset 0x30
 __declspec(property(get=__get_player, put=__set_player)) ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*  player;

/// @brief Field <isClient>5__2 offset 0x38
 __declspec(property(get=__get__isClient_5__2, put=__set__isClient_5__2)) bool  _isClient_5__2;

/// @brief Field <>u__1 offset 0x40
 __declspec(property(get=__get___u__1, put=__set___u__1)) ::System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<uint8_t,::Array<uint8_t>*>>  __u__1;

/// @brief Field <>u__2 offset 0x48
 __declspec(property(get=__get___u__2, put=__set___u__2)) ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::__EncryptionUtility__IEncryptionState*>  __u__2;
...
constexpr ::GlobalNamespace::ConnectedPlayerManager* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ConnectedPlayerManager*> __get___4__this() const;

constexpr void __set_player(::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*  value) ;

constexpr ::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer* __get_player() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*> __get_player() const;

constexpr void __set__isClient_5__2(bool  value) ;

constexpr bool& __get__isClient_5__2() ;

constexpr bool const& __get__isClient_5__2() const;

constexpr void __set___u__1(::System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<uint8_t,::Array<uint8_t>*>>  value) ;

constexpr ::System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<uint8_t,::Array<uint8_t>*>>& __get___u__1() ;

constexpr ::System::Runtime::CompilerServices::TaskAwaiter_1<::ArrayW<uint8_t,::Array<uint8_t>*>> const& __get___u__1() const;

constexpr void __set___u__2(::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::__EncryptionUtility__IEncryptionState*>  value) ;

constexpr ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::__EncryptionUtility__IEncryptionState*>& __get___u__2() ;

constexpr ::System::Runtime::CompilerServices::TaskAwaiter_1<::GlobalNamespace::__EncryptionUtility__IEncryptionState*> const& __get___u__2() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __ConnectedPlayerManager___InitializePlayerEncryption_d__132(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x50>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ConnectedPlayerManager___InitializePlayerEncryption_d__132()  = default;
...
/// @brief Field playerConnectedEvent offset 0x30
...
/// @brief Field playerDisconnectedEvent offset 0x38
...
/// @brief Field playerStateChangedEvent offset 0x40
...
/// @brief Field playerAvatarChangedEvent offset 0x48
...
/// @brief Field playerOrderChangedEvent offset 0x50
...
/// @brief Field playerLatencyInitializedEvent offset 0x58
...
/// @brief Field syncTimeInitializedEvent offset 0x60
...
/// @brief Field _temporaryDataWriter offset 0x90
...
/// @brief Field _temporaryEncryptedDataWriter offset 0x98
...
/// @brief Field _reliableDataWriter offset 0xa0
...
/// @brief Field _unreliableDataWriter offset 0xa8
...
/// @brief Field _players offset 0xb0
...
/// @brief Field _localPlayerState offset 0xb8
...
/// @brief Field _localPlayerAvatars offset 0xc0
...
/// @brief Field _encryptionKeys offset 0xd8
...
/// @brief Field _encryptionRandom offset 0xe0
...
/// @brief Field _localPlayer offset 0xe8
...
/// @brief Field _lastConnectionId offset 0xf0
 __declspec(property(get=__get__lastConnectionId, put=__set__lastConnectionId)) uint8_t  _lastConnectionId;

/// @brief Field _lastPollTime offset 0xf8
 __declspec(property(get=__get__lastPollTime, put=__set__lastPollTime)) int64_t  _lastPollTime;

/// @brief Field _lastPollFrame offset 0x100
 __declspec(property(get=__get__lastPollFrame, put=__set__lastPollFrame)) int32_t  _lastPollFrame;

/// @brief Field _lastPingTime offset 0x108
 __declspec(property(get=__get__lastPingTime, put=__set__lastPingTime)) int64_t  _lastPingTime;

/// @brief Field _messageSerializer offset 0x110
 __declspec(property(get=__get__messageSerializer, put=__set__messageSerializer)) ::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::__ConnectedPlayerManager__InternalMessageType,::GlobalNamespace::IConnectedPlayer*>*  _messageSerializer;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_connectedEvent() const;

constexpr void __set_initializedEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_initializedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_initializedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::DisconnectedReason>*> __get_disconnectedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::ConnectionFailedReason>*> __get_connectionFailedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*> __get_playerStateChangedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*> __get_playerAvatarChangedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*> __get_playerOrderChangedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*> __get_playerLatencyInitializedEvent() const;

constexpr void __set_syncTimeInitializedEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_syncTimeInitializedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_syncTimeInitializedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LongRollingAverage*> __get__syncTimeOffset() const;
...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::Utils::NetDataWriter*> __get__temporaryDataWriter() const;
...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::Utils::NetDataWriter*> __get__temporaryEncryptedDataWriter() const;
...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::Utils::NetDataWriter*> __get__reliableDataWriter() const;
...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::Utils::NetDataWriter*> __get__unreliableDataWriter() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*>*> __get__players() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::StringW>*> __get__localPlayerState() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IDiffieHellmanKeyPair*> __get__encryptionKeys() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__ConnectedPlayerManager__ConnectedPlayer*> __get__localPlayer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::__ConnectedPlayerManager__InternalMessageType,::GlobalNamespace::IConnectedPlayer*>*> __get__messageSerializer() const;
...
// Ctor Parameters []
// @brief default ctor
 ConnectedPlayerManager()  = default;
public:
