...
::cordl_internals::setStaticField<::GlobalNamespace::OVRRuntimeSettings*, "_instance", ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::OVRRuntimeSettings*>::get>(std::forward<::GlobalNamespace::OVRRuntimeSettings*>(value));
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::__OVRManager__ColorSpace, 0x18>(this, std::forward<::GlobalNamespace::__OVRManager__ColorSpace>(value));
}
constexpr ::GlobalNamespace::__OVRManager__ColorSpace& GlobalNamespace::OVRRuntimeSettings::__get_colorSpace()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::__OVRManager__ColorSpace, 0x18>(this);
}
