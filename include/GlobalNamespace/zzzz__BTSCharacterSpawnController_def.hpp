...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BTSCharacterSpawnController*> __get___4__this() const;

static inline ::GlobalNamespace::__BTSCharacterSpawnController___TimelineStoppedDelayed_d__19* New_ctor(int32_t  __1__state) ;

/// @brief Method .ctor addr 0x221ae54 size 0x28 virtual false final false
inline void _ctor(int32_t  __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x221ae84 size 0x4 virtual true final true
inline void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x221ae88 size 0xc8 virtual true final true
inline bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x221af50 size 0x8 virtual true final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x221af58 size 0x40 virtual true final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x221af98 size 0x8 virtual true final true
...
// Ctor Parameters []
// @brief default ctor
 __BTSCharacterSpawnController___TimelineStoppedDelayed_d__19()  = default;
public:
...
/// @brief Field _characterSpawnAnimationController offset 0x18
 __declspec(property(get=__get__characterSpawnAnimationController, put=__set__characterSpawnAnimationController)) ::GlobalNamespace::BTSCharacterSpawnAnimationController*  _characterSpawnAnimationController;

/// @brief Field _btsCharacterSpawnEventEffect offset 0x20
...
/// @brief Field _animatorNormalizedTimeBeforePause offset 0x48
...
/// @brief Field _despawnCharacterCoroutine offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BTSCharacterSpawnAnimationController*> __get__characterSpawnAnimationController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BTSCharacterSpawnEventEffect*> __get__btsCharacterSpawnEventEffect() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Coroutine*> __get__despawnCharacterCoroutine() const;

/// @brief Method get_isCharacterVisible addr 0x221a3f8 size 0x18 virtual false final false
inline bool get_isCharacterVisible() ;

/// @brief Method get_isSpawned addr 0x221a410 size 0x8 virtual false final false
inline bool get_isSpawned() ;

/// @brief Method Start addr 0x221a418 size 0x338 virtual false final false
inline void Start() ;

/// @brief Method OnDestroy addr 0x221a800 size 0x3a0 virtual false final false
inline void OnDestroy() ;

/// @brief Method HandleStartCharacterAnimation addr 0x221ac50 size 0xc8 virtual false final false
inline void HandleStartCharacterAnimation(::GlobalNamespace::BTSCharacter*  btsCharacter) ;

/// @brief Method HandleGamePauseDidPause addr 0x221ad80 size 0x40 virtual false final false
inline void HandleGamePauseDidPause() ;

/// @brief Method HandleGamePauseWillResume addr 0x221adc0 size 0x44 virtual false final false
inline void HandleGamePauseWillResume() ;

/// @brief Method HandleGamePauseDidResume addr 0x221ae04 size 0x28 virtual false final false
inline void HandleGamePauseDidResume() ;

/// @brief Method HandleLevelEndActionsLevelFailed addr 0x221ae2c size 0x28 virtual false final false
inline void HandleLevelEndActionsLevelFailed() ;

/// @brief Method TimelineStoppedDelayed addr 0x221ad18 size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x221ae7c size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 BTSCharacterSpawnController()  = default;
public:
