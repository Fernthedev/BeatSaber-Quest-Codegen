...
/// @brief Field kLoadOtherTimeout offset 0x0
static constexpr float_t  kLoadOtherTimeout{15.0};

/// @brief Field kLoadSelfTimeout offset 0x0
...
/// @brief Field syncStartDidSuccessEvent offset 0x28
...
/// @brief Field syncStartDidReceiveTooLateEvent offset 0x30
...
/// @brief Field _playersAtGameStartModel offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::StringW>*> __get_syncStartDidSuccessEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::StringW>*> __get_syncStartDidReceiveTooLateEvent() const;

constexpr void __set_syncStartDidFailEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_syncStartDidFailEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_syncStartDidFailEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SceneStartHandler*> __get__sceneStartHandler() const;
...
// Ctor Parameters []
// @brief default ctor
 SceneStartSyncController()  = default;
public:
