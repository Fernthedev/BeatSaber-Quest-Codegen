...
/// @brief Field kGongTime offset 0x0
...
/// @brief Field _countdownElementControllers offset 0x20
 __declspec(property(get=__get__countdownElementControllers, put=__set__countdownElementControllers)) ::ArrayW<::GlobalNamespace::CountdownElementController*,::Array<::GlobalNamespace::CountdownElementController*>*>  _countdownElementControllers;
...
/// @brief Field _countdownEndTime offset 0x30
 __declspec(property(get=__get__countdownEndTime, put=__set__countdownEndTime)) int64_t  _countdownEndTime;

/// @brief Field _currentRemainingSecond offset 0x38
 __declspec(property(get=__get__currentRemainingSecond, put=__set__currentRemainingSecond)) int32_t  _currentRemainingSecond;

/// @brief Field _gongSounded offset 0x3c
 __declspec(property(get=__get__gongSounded, put=__set__gongSounded)) bool  _gongSounded;

/// @brief Field _countdownRunning offset 0x3d
 __declspec(property(get=__get__countdownRunning, put=__set__countdownRunning)) bool  _countdownRunning;

/// @brief Field _countdownElementControllerQueue offset 0x40
 __declspec(property(get=__get__countdownElementControllerQueue, put=__set__countdownElementControllerQueue)) ::System::Collections::Generic::Queue_1<::GlobalNamespace::CountdownElementController*>*  _countdownElementControllerQueue;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ITimeProvider*> __get__timeProvider() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Queue_1<::GlobalNamespace::CountdownElementController*>*> __get__countdownElementControllerQueue() const;
