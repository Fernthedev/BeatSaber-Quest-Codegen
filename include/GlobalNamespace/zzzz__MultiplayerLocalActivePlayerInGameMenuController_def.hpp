...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerLocalActivePlayerInGameMenuController____c__DisplayClass19_0()  = default;
public:
...
/// @brief Field _inGameMenuViewController offset 0x18
...
/// @brief Field _menuButtonTrigger offset 0x20
...
/// @brief Field _multiplayerController offset 0x38
...
/// @brief Field requestsDisconnectEvent offset 0x60
...
/// @brief Field _gameMenuIsShown offset 0x68
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLocalActivePlayerInGameMenuViewController*> __get__inGameMenuViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_didGiveUpEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::System::Action_1<bool>*>*> __get_canShowInGameMenuEvent() const;

constexpr void __set_requestsDisconnectEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_requestsDisconnectEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_requestsDisconnectEvent() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerLocalActivePlayerInGameMenuController()  = default;
public:
