...
/// @brief Field kPauseButtonPressDurationMultiplier offset 0x0
static constexpr float_t  kPauseButtonPressDurationMultiplier{0.75};

/// @brief Field _screenCaptureAfterDelayPrefab offset 0x20
...
/// @brief Field _bloomFog offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ScreenCaptureAfterDelay*> __get__screenCaptureAfterDelayPrefab() const;
...
/// @brief Method InstallBindings addr 0x2319894 size 0x46c virtual true final false
inline void InstallBindings() ;

static inline ::GlobalNamespace::GameCoreSceneSetup* New_ctor() ;

/// @brief Method .ctor addr 0x2319d00 size 0x8 virtual false final false
inline void _ctor() ;
