...
struct CORDL_TYPE __AppInitScenesTransitionSetupDataSO__AppInitOverrideStartType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____AppInitScenesTransitionSetupDataSO__AppInitOverrideStartType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __AppInitScenesTransitionSetupDataSO__AppInitOverrideStartType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __AppInitScenesTransitionSetupDataSO__AppInitOverrideStartType()  = default;
...
/// @brief Field <appInitOverrideStartType>k__BackingField offset 0x10
 __declspec(property(get=__get__appInitOverrideStartType_k__BackingField, put=__set__appInitOverrideStartType_k__BackingField)) ::GlobalNamespace::__AppInitScenesTransitionSetupDataSO__AppInitOverrideStartType  _appInitOverrideStartType_k__BackingField;
...
// Ctor Parameters []
// @brief default ctor
 __AppInitScenesTransitionSetupDataSO__AppInitSceneSetupData()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 AppInitScenesTransitionSetupDataSO()  = default;
public:
