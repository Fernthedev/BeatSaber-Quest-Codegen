...
constexpr void GlobalNamespace::__BloomPrePassNonLightPass__ExecutionTimeType::__set_value__(int32_t  value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<int32_t>(value));
}
constexpr int32_t& GlobalNamespace::__BloomPrePassNonLightPass__ExecutionTimeType::__get_value__()  {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& GlobalNamespace::__BloomPrePassNonLightPass__ExecutionTimeType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::__BloomPrePassNonLightPass__ExecutionTimeType::__BloomPrePassNonLightPass__ExecutionTimeType(int32_t  value__) noexcept : ::bs_hook::EnumTypeWrapper<0x4>() {this->value__ = value__;
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::__BloomPrePassNonLightPass__ExecutionTimeType (::GlobalNamespace::BloomPrePassNonLightPass::*)()>(&::GlobalNamespace::BloomPrePassNonLightPass::get_executionTimeType)> {
...
::cordl_internals::setInstanceField<::GlobalNamespace::__BloomPrePassNonLightPass__ExecutionTimeType, 0x18>(this, std::forward<::GlobalNamespace::__BloomPrePassNonLightPass__ExecutionTimeType>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::__BloomPrePassNonLightPass__ExecutionTimeType, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::__BloomPrePassNonLightPass__ExecutionTimeType, 0x1c>(this, std::forward<::GlobalNamespace::__BloomPrePassNonLightPass__ExecutionTimeType>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::__BloomPrePassNonLightPass__ExecutionTimeType, 0x1c>(this);
}
