...
struct CORDL_TYPE __DiffieHellmanUtility__KeyType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____DiffieHellmanUtility__KeyType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __DiffieHellmanUtility__KeyType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __DiffieHellmanUtility__KeyType()  = default;
...
/// @brief Field clientPublicKey offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__DiffieHellmanUtility__DiffieHellmanKeyPair*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __DiffieHellmanUtility__DiffieHellmanKeyPair____c__DisplayClass5_0()  = default;
public:
...
/// @brief Field _dhBasicAgreement offset 0x10
...
/// @brief Field _publicKey offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Agreement::DHBasicAgreement*> __get__dhBasicAgreement() const;
...
// Ctor Parameters []
// @brief default ctor
 __DiffieHellmanUtility__DiffieHellmanKeyPair()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__DiffieHellmanUtility__ElipticalCurveKeyPair*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __DiffieHellmanUtility__ElipticalCurveKeyPair____c__DisplayClass5_0()  = default;
public:
...
/// @brief Field _ecdhBasicAgreement offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::Org::BouncyCastle::Crypto::Agreement::ECDHBasicAgreement*> __get__ecdhBasicAgreement() const;
...
// Ctor Parameters []
// @brief default ctor
 __DiffieHellmanUtility__ElipticalCurveKeyPair()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __DiffieHellmanUtility__OperationTimer()  = default;
public:
...
/// @brief Field kMaxDiffieHellmanPublicKeyLength offset 0x0
static constexpr int32_t  kMaxDiffieHellmanPublicKeyLength{static_cast<int32_t>(0x800)};

/// @brief Field kMaxElipticalCurvePublicKeyLength offset 0x0
...
// Ctor Parameters []
// @brief default ctor
 DiffieHellmanUtility()  = default;
public:


// Fields

// Static field _secureRandom

// Static field _dhParameters

// Static field _ecParameters

// Static field _ecPointFormats
