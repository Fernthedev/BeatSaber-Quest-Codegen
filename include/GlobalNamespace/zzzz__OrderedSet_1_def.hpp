...
namespace GlobalNamespace {
template<::il2cpp_utils::il2cpp_reference_type T>
class __OrderedSet_1__Node<T>;
}
namespace GlobalNamespace {
template<::il2cpp_utils::il2cpp_reference_type T>
class __OrderedSet_1___GetEnumerator_d__23<T>;
}
// Write type traits
...
struct CORDL_TYPE __OrderedSet_1__ProcessOrder : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____OrderedSet_1__ProcessOrder_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __OrderedSet_1__ProcessOrder(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OrderedSet_1__ProcessOrder()  = default;
...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(12904))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12904), inst: 2 })
// CS Name: ::OrderedSet`1::Node<T>*
class CORDL_TYPE __OrderedSet_1__Node<T> : public ::System::Object {
public:
// Declarations
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OrderedSet_1__Node<T>*> __get_previous() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OrderedSet_1__Node<T>*> __get_next() const;
...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12905)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12905), inst: 2 })
// CS Name: ::OrderedSet`1::<GetEnumerator>d__23<T>*
class CORDL_TYPE __OrderedSet_1___GetEnumerator_d__23<T> : public ::System::Object {
public:
// Declarations
/// @brief The size of the true reference type
static constexpr auto  __IL2CPP_REFERENCE_TYPE_SIZE{0x30};
...
/// @brief Field <next>5__2 offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OrderedSet_1<T>*> __get___4__this() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OrderedSet_1__Node<T>*> __get__next_5__2() const;
...
// Ctor Parameters []
// @brief default ctor
 __OrderedSet_1___GetEnumerator_d__23()  = default;
public:
...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(2613)), TypeDefinitionIndex(TypeDefinitionIndex(12906))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12906), inst: 2 })
// CS Name: ::OrderedSet`1<T>*
class CORDL_TYPE OrderedSet_1<T> : public ::System::Object {
public:
// Declarations
...
/// @brief Field _sortIndices offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Comparison_1<T>*> __get__comparison() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<T,::GlobalNamespace::__OrderedSet_1__Node<T>*>*> __get__sortIndices() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OrderedSet_1__Node<T>*> __get__head() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OrderedSet_1__Node<T>*> __get__tail() const;
