...
/// @brief Field _poseObjectId offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PoseObjectIdSO*> __get__poseObjectId() const;

/// @brief Method get_objectTransform addr 0x230178c size 0x8 virtual false final false
inline ::UnityEngine::Transform* get_objectTransform() ;

/// @brief Method get_id addr 0x2301794 size 0x1c virtual false final false
...
/// @brief Method .ctor addr 0x22ff910 size 0x2c virtual false final false
