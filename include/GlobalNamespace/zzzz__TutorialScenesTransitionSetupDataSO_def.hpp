...
struct CORDL_TYPE __TutorialScenesTransitionSetupDataSO__TutorialEndStateType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____TutorialScenesTransitionSetupDataSO__TutorialEndStateType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __TutorialScenesTransitionSetupDataSO__TutorialEndStateType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __TutorialScenesTransitionSetupDataSO__TutorialEndStateType()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x58 - sizeof(::GlobalNamespace::ScenesTransitionSetupDataSO)]{};

/// @brief Field _environmentInfo offset 0x30
...
/// @brief Field _tutorialSceneInfo offset 0x38
...
/// @brief Field didFinishEvent offset 0x48
 __declspec(property(get=__get_didFinishEvent, put=__set_didFinishEvent)) ::System::Action_2<::GlobalNamespace::TutorialScenesTransitionSetupDataSO*,::GlobalNamespace::__TutorialScenesTransitionSetupDataSO__TutorialEndStateType>*  didFinishEvent;

/// @brief Field <playerSpecificSettings>k__BackingField offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SceneInfo*> __get__tutorialSceneInfo() const;
...
constexpr void __set_didFinishEvent(::System::Action_2<::GlobalNamespace::TutorialScenesTransitionSetupDataSO*,::GlobalNamespace::__TutorialScenesTransitionSetupDataSO__TutorialEndStateType>*  value) ;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::TutorialScenesTransitionSetupDataSO*,::GlobalNamespace::__TutorialScenesTransitionSetupDataSO__TutorialEndStateType>*> __get_didFinishEvent() const;
...
/// @brief Method add_didFinishEvent addr 0x231ee7c size 0xb0 virtual false final false
...
/// @brief Method remove_didFinishEvent addr 0x231e2e0 size 0xb0 virtual false final false
...
/// @brief Method get_playerSpecificSettings addr 0x2320058 size 0x8 virtual false final false
inline ::GlobalNamespace::PlayerSpecificSettings* get_playerSpecificSettings() ;

/// @brief Method set_playerSpecificSettings addr 0x2320060 size 0x8 virtual false final false
inline void set_playerSpecificSettings(::GlobalNamespace::PlayerSpecificSettings*  value) ;

/// @brief Method Init addr 0x231c004 size 0x27c virtual false final false
inline void Init(::GlobalNamespace::PlayerSpecificSettings*  playerSpecificSettings) ;

/// @brief Method Finish addr 0x2320068 size 0x28 virtual false final false
...
/// @brief Method .ctor addr 0x2320090 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 TutorialScenesTransitionSetupDataSO()  = default;
public:
