...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::GlobalNamespace::__LightWithIds__LightWithId)]{};

/// @brief Field _index offset 0x30
 __declspec(property(get=__get__index, put=__set__index)) int32_t  _index;

/// @brief Field didSetColorEvent offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<int32_t,::UnityEngine::Color>*> __get_didSetColorEvent() const;
...
// Ctor Parameters []
// @brief default ctor
 __ColorArrayLightWithIds__ColorArrayLightWithId()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x68 - sizeof(::GlobalNamespace::LightWithIds)]{};

/// @brief Field _colorArrayLightWithIds offset 0x30
 __declspec(property(get=__get__colorArrayLightWithIds, put=__set__colorArrayLightWithIds)) ::ArrayW<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*,::Array<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*>*>  _colorArrayLightWithIds;

/// @brief Field _materialController offset 0x38
...
/// @brief Field _colorsArrayPropertyName offset 0x48
...
/// @brief Field _colorsArrayOffsetPropertyName offset 0x50
...
/// @brief Field _colorsArray offset 0x60
...
constexpr void __set__colorArrayLightWithIds(::ArrayW<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*,::Array<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*,::Array<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*>*>& __get__colorArrayLightWithIds() ;

constexpr ::ArrayW<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*,::Array<::GlobalNamespace::__ColorArrayLightWithIds__ColorArrayLightWithId*>*> const& __get__colorArrayLightWithIds() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MaterialController*> __get__materialController() const;
...
// Ctor Parameters []
// @brief default ctor
 ColorArrayLightWithIds()  = default;
public:
