...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x98 - sizeof(::GlobalNamespace::MultiplayerConnectedPlayerNoteController)]{};

/// @brief Field cubeNoteControllerDidInitEvent offset 0x88
 __declspec(property(get=__get_cubeNoteControllerDidInitEvent, put=__set_cubeNoteControllerDidInitEvent)) ::System::Action_1<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*>*  cubeNoteControllerDidInitEvent;

/// @brief Field _noteVisualModifierType offset 0x90
...
/// @brief Field _gameplayType offset 0x94
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*>*> __get_cubeNoteControllerDidInitEvent() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerConnectedPlayerGameNoteController()  = default;
public:
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11050)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11050), inst: 356 }), TypeDefinitionIndex(TypeDefinitionIndex(5137))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::Zenject::MonoMemoryPool_1<::GlobalNamespace::MultiplayerConnectedPlayerGameNoteController*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerConnectedPlayerGameNoteController__Pool()  = default;
public:
