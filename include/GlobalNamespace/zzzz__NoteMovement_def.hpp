...
struct CORDL_TYPE __NoteMovement__MovementPhase : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____NoteMovement__MovementPhase_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __NoteMovement__MovementPhase(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __NoteMovement__MovementPhase()  = default;
...
/// @brief Field noteDidFinishJumpEvent offset 0x40
...
/// @brief Field noteDidPassMissedMarkerEvent offset 0x48
...
/// @brief Field noteDidPassHalfJumpEvent offset 0x50
...
/// @brief Field noteDidPassJumpThreeQuartersEvent offset 0x58
 __declspec(property(get=__get_noteDidPassJumpThreeQuartersEvent, put=__set_noteDidPassJumpThreeQuartersEvent)) ::System::Action_1<::GlobalNamespace::NoteMovement*>*  noteDidPassJumpThreeQuartersEvent;

/// @brief Field noteDidMoveInJumpPhaseEvent offset 0x60
...
/// @brief Field <movementPhase>k__BackingField offset 0x68
...
/// @brief Field _position offset 0x6c
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NoteFloorMovement*> __get__floorMovement() const;

constexpr void __set__jump(::GlobalNamespace::NoteJump*  value) ;

constexpr ::GlobalNamespace::NoteJump* __get__jump() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NoteJump*> __get__jump() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_noteDidStartJumpEvent() const;

constexpr void __set_noteDidFinishJumpEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_noteDidFinishJumpEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_noteDidFinishJumpEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_noteDidPassMissedMarkerEvent() const;

constexpr void __set_noteDidPassHalfJumpEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_noteDidPassHalfJumpEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_noteDidPassHalfJumpEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::NoteMovement*>*> __get_noteDidPassJumpThreeQuartersEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_noteDidMoveInJumpPhaseEvent() const;
