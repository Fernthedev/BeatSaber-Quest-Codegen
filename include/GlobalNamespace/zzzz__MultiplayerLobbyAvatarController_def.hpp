...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Playables::PlayableDirector*> __get__spawnEffect() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::VFXController*> __get__despawnVFXController() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerLobbyAvatarController()  = default;
public:
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5221)), TypeDefinitionIndex(TypeDefinitionIndex(12778)), TypeDefinitionIndex(TypeDefinitionIndex(11005)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11005), inst: 3488 })}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::Zenject::PlaceholderFactory_2<::GlobalNamespace::IConnectedPlayer*,::GlobalNamespace::MultiplayerLobbyAvatarController*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerLobbyAvatarController__Factory()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLobbyAvatarController*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerLobbyAvatarController___SpawnAnimationCoroutine_d__8()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerLobbyAvatarController___ShowDespawnAnimationAndDestroy_d__10()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerLobbyAvatarController___DespawnAnimationCoroutine_d__12()  = default;
public:
