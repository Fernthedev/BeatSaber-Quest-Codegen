...
/// @brief Field mainEffect offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MainEffectSO*> __get_mainEffect() const;
...
// Ctor Parameters []
// @brief default ctor
 __MainEffectGraphicsSettingsPresetsSO__Preset()  = default;
public:
...
/// @brief Field _presets offset 0x18
 __declspec(property(get=__get__presets, put=__set__presets)) ::ArrayW<::GlobalNamespace::__MainEffectGraphicsSettingsPresetsSO__Preset*,::Array<::GlobalNamespace::__MainEffectGraphicsSettingsPresetsSO__Preset*>*>  _presets;
...
// Ctor Parameters []
// @brief default ctor
 MainEffectGraphicsSettingsPresetsSO()  = default;
public:
