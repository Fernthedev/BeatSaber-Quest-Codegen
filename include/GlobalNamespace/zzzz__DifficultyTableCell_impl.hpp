...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DifficultyTableCell::*)(::HMUI::__SelectableCell__TransitionType)>(&::GlobalNamespace::DifficultyTableCell::SelectionDidChange)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::DifficultyTableCell::*)(::HMUI::__SelectableCell__TransitionType)>(&::GlobalNamespace::DifficultyTableCell::HighlightDidChange)> {
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> GlobalNamespace::DifficultyTableCell::__get__difficultyText() const {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x58>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Image*> GlobalNamespace::DifficultyTableCell::__get__bgImage() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Image*, 0x60>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Image*> GlobalNamespace::DifficultyTableCell::__get__highlightImage() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Image*, 0x68>(this);
}
constexpr void GlobalNamespace::DifficultyTableCell::__set__fillIndicator(::GlobalNamespace::FillIndicator*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::FillIndicator*, 0x70>(this, std::forward<::GlobalNamespace::FillIndicator*>(value));
}
constexpr ::GlobalNamespace::FillIndicator* GlobalNamespace::DifficultyTableCell::__get__fillIndicator()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::FillIndicator*, 0x70>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FillIndicator*> GlobalNamespace::DifficultyTableCell::__get__fillIndicator() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::FillIndicator*, 0x70>(this);
}
