...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::GlobalNamespace::BeatmapObjectData)]{};

/// @brief Field <lineIndex>k__BackingField offset 0x20
...
/// @brief Field <lineLayer>k__BackingField offset 0x24
