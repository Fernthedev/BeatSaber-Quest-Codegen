...
/// @brief Field <timeOffsetMs>k__BackingField offset 0x28
...
// Ctor Parameters []
// @brief default ctor
 StandardScoreSyncStateDeltaNetSerializable()  = default;
public:
