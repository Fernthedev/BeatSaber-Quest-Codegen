...
struct CORDL_TYPE __MultiplayerStatusData__AvailabilityStatus : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____MultiplayerStatusData__AvailabilityStatus_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __MultiplayerStatusData__AvailabilityStatus(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MultiplayerStatusData__AvailabilityStatus()  = default;
...
/// @brief Field message offset 0x18
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerStatusData__UserMessage__LocalizedMessage()  = default;
public:
...
/// @brief Field localizations offset 0x10
 __declspec(property(get=__get_localizations, put=__set_localizations)) ::ArrayW<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*,::Array<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*>*>  localizations;

constexpr void __set_localizations(::ArrayW<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*,::Array<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*,::Array<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*>*>& __get_localizations() ;

constexpr ::ArrayW<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*,::Array<::GlobalNamespace::__MultiplayerStatusData__UserMessage__LocalizedMessage*>*> const& __get_localizations() const;
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerStatusData__UserMessage()  = default;
public:
...
/// @brief Field minimum_app_version offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__MultiplayerStatusData__UserMessage*> __get_user_message() const;
