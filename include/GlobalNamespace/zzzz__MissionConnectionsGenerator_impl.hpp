...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionNodesManager*> GlobalNamespace::MissionConnectionsGenerator::__get__missionNodesManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MissionNodesManager*, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::MissionNodeConnection*, 0x20>(this, std::forward<::GlobalNamespace::MissionNodeConnection*>(value));
}
constexpr ::GlobalNamespace::MissionNodeConnection* GlobalNamespace::MissionConnectionsGenerator::__get__nodeConnectionPref()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MissionNodeConnection*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionNodeConnection*> GlobalNamespace::MissionConnectionsGenerator::__get__nodeConnectionPref() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MissionNodeConnection*, 0x20>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> GlobalNamespace::MissionConnectionsGenerator::__get__connectionsCanvas() const {
return ::cordl_internals::getInstanceField<::UnityEngine::GameObject*, 0x28>(this);
}
...
::cordl_internals::setInstanceField<::System::Collections::Generic::List_1<::GlobalNamespace::MissionNode*>*, 0x30>(this, std::forward<::System::Collections::Generic::List_1<::GlobalNamespace::MissionNode*>*>(value));
}
...
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::GlobalNamespace::MissionNode*>*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::MissionNode*>*> GlobalNamespace::MissionConnectionsGenerator::__get__missionNodes() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::GlobalNamespace::MissionNode*>*, 0x30>(this);
}
...
inline void GlobalNamespace::MissionConnectionsGenerator::CreateConnections(::GlobalNamespace::MissionNode*  missionNode, ::System::Collections::Generic::List_1<::GlobalNamespace::MissionNode*>*  visitedNodes)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MissionConnectionsGenerator*>::get(),
                            "CreateConnections",
                            std::vector<Il2CppClass*>{},
...
inline ::GlobalNamespace::MissionNodeConnection* GlobalNamespace::MissionConnectionsGenerator::CreateConnectionBetweenNodes(::GlobalNamespace::MissionNode*  parentMissionNode, ::GlobalNamespace::MissionNode*  childMissionNode)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::MissionConnectionsGenerator*>::get(),
                            "CreateConnectionBetweenNodes",
                            std::vector<Il2CppClass*>{},
