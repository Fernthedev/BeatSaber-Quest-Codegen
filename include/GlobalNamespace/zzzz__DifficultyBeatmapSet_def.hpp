...
/// @brief Field <beatmapCharacteristic>k__BackingField offset 0x10
...
/// @brief Field <difficultyBeatmaps>k__BackingField offset 0x18
 __declspec(property(get=__get__difficultyBeatmaps_k__BackingField, put=__set__difficultyBeatmaps_k__BackingField)) ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IDifficultyBeatmap*>*  _difficultyBeatmaps_k__BackingField;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IDifficultyBeatmap*>*> __get__difficultyBeatmaps_k__BackingField() const;

/// @brief Method get_beatmapCharacteristic addr 0x234954c size 0x8 virtual true final true
inline ::GlobalNamespace::BeatmapCharacteristicSO* get_beatmapCharacteristic() ;

/// @brief Method get_difficultyBeatmaps addr 0x2349554 size 0x8 virtual true final true
inline ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IDifficultyBeatmap*>* get_difficultyBeatmaps() ;

static inline ::GlobalNamespace::DifficultyBeatmapSet* New_ctor(::GlobalNamespace::BeatmapCharacteristicSO*  beatmapCharacteristic, ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IDifficultyBeatmap*>*  difficultyBeatmaps) ;

/// @brief Method .ctor addr 0x234955c size 0x2c virtual false final false
