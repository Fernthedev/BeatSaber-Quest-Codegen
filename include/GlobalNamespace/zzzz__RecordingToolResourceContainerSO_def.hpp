...
/// @brief Field _dlcLevelPackCollection offset 0x18
...
/// @brief Field _environmentsList offset 0x28
...
/// @brief Field _beatmapLevelPacks offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapLevelPackCollectionSO*> __get__dlcLevelPackCollection() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::EnvironmentsListSO*> __get__environmentsList() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::IBeatmapLevelPack*>*> __get__beatmapLevelPacks() const;
...
// Ctor Parameters []
// @brief default ctor
 RecordingToolResourceContainerSO()  = default;
public:
