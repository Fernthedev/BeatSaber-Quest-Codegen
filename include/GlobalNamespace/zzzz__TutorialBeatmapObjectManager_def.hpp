...
/// @brief Field cutAngleTolerance offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __TutorialBeatmapObjectManager__InitData()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xb8 - sizeof(::GlobalNamespace::BeatmapObjectManager)]{};

/// @brief Field _tutorialNotePoolContainer offset 0x98
 __declspec(property(get=__get__tutorialNotePoolContainer, put=__set__tutorialNotePoolContainer)) ::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::TutorialNoteController*>*  _tutorialNotePoolContainer;

/// @brief Field _bombNotePoolContainer offset 0xa0
...
/// @brief Field _obstaclePoolContainer offset 0xa8
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MemoryPoolContainer_1<::GlobalNamespace::TutorialNoteController*>*> __get__tutorialNotePoolContainer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__TutorialBeatmapObjectManager__InitData*> __get__initData() const;
...
// Ctor Parameters []
// @brief default ctor
 TutorialBeatmapObjectManager()  = default;
public:
