...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::OffsetDirection (::GlobalNamespace::WaypointData::*)()>(&::GlobalNamespace::WaypointData::get_offsetDirection)> {
  ...
  constexpr static std::size_t addrs = 0xe01ca4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::WaypointData::*)(::GlobalNamespace::OffsetDirection)>(&::GlobalNamespace::WaypointData::set_offsetDirection)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xe01cac;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::WaypointData::*)()>(&::GlobalNamespace::WaypointData::get_lineIndex)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xe01cb4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::WaypointData::*)(int32_t)>(&::GlobalNamespace::WaypointData::set_lineIndex)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xe01cbc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::NoteLineLayer (::GlobalNamespace::WaypointData::*)()>(&::GlobalNamespace::WaypointData::get_lineLayer)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xe01cc4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::WaypointData::*)(::GlobalNamespace::NoteLineLayer)>(&::GlobalNamespace::WaypointData::set_lineLayer)> {
  constexpr static std::size_t size = 0x8;
  constexpr static std::size_t addrs = 0xe01ccc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BeatmapDataItem* (::GlobalNamespace::WaypointData::*)()>(&::GlobalNamespace::WaypointData::GetCopy)> {
  ...
  constexpr static std::size_t addrs = 0xe01cd4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::WaypointData::*)(float_t, int32_t, ::GlobalNamespace::NoteLineLayer, ::GlobalNamespace::OffsetDirection)>(&::GlobalNamespace::WaypointData::_ctor)> {
  constexpr static std::size_t size = 0x58;
  constexpr static std::size_t addrs = 0xe01d64;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::WaypointData::*)(int32_t)>(&::GlobalNamespace::WaypointData::Mirror)> {
  constexpr static std::size_t size = 0x14;
  constexpr static std::size_t addrs = 0xe01dbc;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::WaypointData::*)()>(&::GlobalNamespace::WaypointData::MirrorTransformOffsetDirection)> {
  ...
  constexpr static std::size_t addrs = 0xe01dd0;
...
::cordl_internals::setInstanceField<::GlobalNamespace::OffsetDirection, 0x20>(this, std::forward<::GlobalNamespace::OffsetDirection>(value));
}
constexpr ::GlobalNamespace::OffsetDirection& GlobalNamespace::WaypointData::__get__offsetDirection_k__BackingField()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::OffsetDirection, 0x20>(this);
}
...
inline ::GlobalNamespace::WaypointData* GlobalNamespace::WaypointData::New_ctor(float_t  time, int32_t  lineIndex, ::GlobalNamespace::NoteLineLayer  lineLayer, ::GlobalNamespace::OffsetDirection  offsetDirection)  {
return THROW_UNLESS(::il2cpp_utils::New<::GlobalNamespace::WaypointData*>(time, lineIndex, lineLayer, offsetDirection));
}
inline void GlobalNamespace::WaypointData::_ctor(float_t  time, int32_t  lineIndex, ::GlobalNamespace::NoteLineLayer  lineLayer, ::GlobalNamespace::OffsetDirection  offsetDirection)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::WaypointData*>::get(),
                            ".ctor",
                            std::vector<Il2CppClass*>{},
