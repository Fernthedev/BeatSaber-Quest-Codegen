...
/// @brief Field _defaultMenuLightsPreset offset 0x18
...
/// @brief Field _lobbyLightsPreset offset 0x20
...
/// @brief Field _countdownMenuLightsPreset offset 0x28
...
/// @brief Field _beatmapSelectionView offset 0x30
...
/// @brief Field _modifiersSelectionView offset 0x38
...
/// @brief Field _countdownController offset 0x40
...
/// @brief Field _multiplayerLobbyCenterScreenLayoutAnimator offset 0x48
 __declspec(property(get=__get__multiplayerLobbyCenterScreenLayoutAnimator, put=__set__multiplayerLobbyCenterScreenLayoutAnimator)) ::GlobalNamespace::MultiplayerLobbyCenterScreenLayoutAnimator*  _multiplayerLobbyCenterScreenLayoutAnimator;

/// @brief Field _lobbyGameStateController offset 0x50
...
/// @brief Field _menuLightsManager offset 0x58
...
/// @brief Field <countdownShown>k__BackingField offset 0x60
...
/// @brief Field _countdownEndTime offset 0x68
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MenuLightsPresetSO*> __get__defaultMenuLightsPreset() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MenuLightsPresetSO*> __get__lobbyLightsPreset() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MenuLightsPresetSO*> __get__countdownMenuLightsPreset() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::CountdownController*> __get__countdownController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLobbyCenterScreenLayoutAnimator*> __get__multiplayerLobbyCenterScreenLayoutAnimator() const;
...
/// @brief Method get_countdownShown addr 0x22cc948 size 0x8 virtual false final false
inline bool get_countdownShown() ;

/// @brief Method set_countdownShown addr 0x22cc950 size 0xc virtual false final false
inline void set_countdownShown(bool  value) ;

/// @brief Method Setup addr 0x22cc95c size 0x30 virtual false final false
inline void Setup(bool  showModifiers) ;

/// @brief Method Show addr 0x22cc98c size 0x18c virtual false final false
inline void Show() ;

/// @brief Method Hide addr 0x22ccc80 size 0x130 virtual false final false
inline void Hide() ;

/// @brief Method ShowCountdown addr 0x22ccdf4 size 0x3c virtual false final false
inline void ShowCountdown(int64_t  countdownEndTime) ;

/// @brief Method HideCountdown addr 0x22ccdb0 size 0x44 virtual false final false
inline void HideCountdown(bool  instant) ;

/// @brief Method SetCountdownEndTime addr 0x22cce30 size 0x58 virtual false final false
inline void SetCountdownEndTime(int64_t  countdownEndTime) ;

/// @brief Method ShowCountdownColorPreset addr 0x22cce88 size 0x2c virtual false final false
inline void ShowCountdownColorPreset(bool  animated) ;

/// @brief Method ShowLobbyColorPreset addr 0x22ccb18 size 0x2c virtual false final false
inline void ShowLobbyColorPreset(bool  animated) ;

/// @brief Method HandleLobbyGameStateControllerSelectedLevelGameplaySetupDataChanged addr 0x22cceb4 size 0x4 virtual false final false
...
/// @brief Method SetNextGameplaySetupData addr 0x22ccb44 size 0x13c virtual false final false
...
/// @brief Method .ctor addr 0x22cceb8 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 CenterStageScreenController()  = default;
public:
