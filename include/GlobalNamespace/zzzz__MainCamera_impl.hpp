...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Camera*> GlobalNamespace::MainCamera::__get__camera() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Camera*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> GlobalNamespace::MainCamera::__get__transform() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x20>(this);
}
