...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SoloFreePlayFlowCoordinator*> __get___4__this() const;
...
/// @brief Method .ctor addr 0x229e130 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <HandleResultsViewControllerRestartButtonPressed>b__0 addr 0x229e138 size 0x50 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __SoloFreePlayFlowCoordinator____c__DisplayClass21_0()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x148 - sizeof(::GlobalNamespace::SinglePlayerLevelSelectionFlowCoordinator)]{};
...
/// @brief Field _platformLeaderboardViewController offset 0x138
 __declspec(property(get=__get__platformLeaderboardViewController, put=__set__platformLeaderboardViewController)) ::GlobalNamespace::PlatformLeaderboardViewController*  _platformLeaderboardViewController;

/// @brief Field _platformLeaderboardsModel offset 0x140
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlatformLeaderboardViewController*> __get__platformLeaderboardViewController() const;
...
/// @brief Method get_gameMode addr 0x229cad8 size 0x40 virtual true final false
inline ::StringW get_gameMode() ;

/// @brief Method get_leaderboardViewController addr 0x229cb18 size 0x8 virtual true final false
inline ::GlobalNamespace::LeaderboardViewController* get_leaderboardViewController() ;

/// @brief Method get_showBackButtonForMainViewController addr 0x229cb20 size 0x8 virtual true final false
inline bool get_showBackButtonForMainViewController() ;

/// @brief Method get_mainTitle addr 0x229cb28 size 0x44 virtual true final false
inline ::StringW get_mainTitle() ;

/// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidActivate addr 0x229cb6c size 0x17c virtual true final false
inline void SinglePlayerLevelSelectionFlowCoordinatorDidActivate(bool  firstActivation, bool  addedToHierarchy) ;

/// @brief Method SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate addr 0x229cce8 size 0x134 virtual true final false
inline void SinglePlayerLevelSelectionFlowCoordinatorDidDeactivate(bool  removedFromHierarchy) ;

/// @brief Method ProcessLevelCompletionResultsAfterLevelDidFinish addr 0x229ce1c size 0x198 virtual true final false
...
/// @brief Method IsNewHighScore addr 0x229cfb4 size 0x28 virtual false final false
...
/// @brief Method Refresh addr 0x229cfdc size 0x48 virtual true final false
inline void Refresh() ;

/// @brief Method HandleResultsViewControllerContinueButtonPressed addr 0x229d024 size 0x3c virtual false final false
inline void HandleResultsViewControllerContinueButtonPressed(::GlobalNamespace::ResultsViewController*  viewController) ;

/// @brief Method HandleResultsViewControllerRestartButtonPressed addr 0x229d060 size 0xc8 virtual false final false
inline void HandleResultsViewControllerRestartButtonPressed(::GlobalNamespace::ResultsViewController*  resultsViewController) ;

/// @brief Method __SetupFromDestination addr 0x228dda4 size 0x32c virtual false final false
...
/// @brief Method .ctor addr 0x229d128 size 0x1008 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 SoloFreePlayFlowCoordinator()  = default;
public:
