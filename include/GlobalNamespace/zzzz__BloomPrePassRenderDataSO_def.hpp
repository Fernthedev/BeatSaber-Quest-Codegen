...
// Self: TypeDefinitionIndex(TypeDefinitionIndex(14479))
...
/// @brief Field bloomPrePassRenderTexture offset 0x10
...
/// @brief Field textureToScreenRatio offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RenderTexture*> __get_bloomPrePassRenderTexture() const;
...
/// @brief Method .ctor addr 0x210290c size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __BloomPrePassRenderDataSO__Data()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__BloomPrePassRenderDataSO__Data*> __get_data() const;

static inline ::GlobalNamespace::BloomPrePassRenderDataSO* New_ctor() ;

/// @brief Method .ctor addr 0x21072fc size 0x68 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 BloomPrePassRenderDataSO()  = default;
public:
