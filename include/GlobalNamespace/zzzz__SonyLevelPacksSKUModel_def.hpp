...
// Ctor Parameters []
// @brief default ctor
 __SonyLevelPacksSKUModel__PricePerBundlePair()  = default;
public:
...
/// @brief Field _levelIndex offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __SonyLevelPacksSKUModel__LevelProductData()  = default;
public:
...
/// @brief Field _levelProductsData offset 0x20
 __declspec(property(get=__get__levelProductsData, put=__set__levelProductsData)) ::ArrayW<::GlobalNamespace::__SonyLevelPacksSKUModel__LevelProductData*,::Array<::GlobalNamespace::__SonyLevelPacksSKUModel__LevelProductData*>*>  _levelProductsData;
 ...
 __declspec(property(get=get_levelProductsData)) ::ArrayW<::GlobalNamespace::__SonyLevelPacksSKUModel__LevelProductData*,::Array<::GlobalNamespace::__SonyLevelPacksSKUModel__LevelProductData*>*>  levelProductsData;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapLevelPackSO*> __get__levelPack() const;
...
// Ctor Parameters []
// @brief default ctor
 __SonyLevelPacksSKUModel__LevelPackProductData()  = default;
public:
...
/// @brief Field _pricePerLevel offset 0x18
 __declspec(property(get=__get__pricePerLevel, put=__set__pricePerLevel)) float_t  _pricePerLevel;

/// @brief Field _pricePairBundlePairs offset 0x20
 __declspec(property(get=__get__pricePairBundlePairs, put=__set__pricePairBundlePairs)) ::ArrayW<::GlobalNamespace::__SonyLevelPacksSKUModel__PricePerBundlePair*,::Array<::GlobalNamespace::__SonyLevelPacksSKUModel__PricePerBundlePair*>*>  _pricePairBundlePairs;

/// @brief Field _levelPackProductsData offset 0x28
 __declspec(property(get=__get__levelPackProductsData, put=__set__levelPackProductsData)) ::ArrayW<::GlobalNamespace::__SonyLevelPacksSKUModel__LevelPackProductData*,::Array<::GlobalNamespace::__SonyLevelPacksSKUModel__LevelPackProductData*>*>  _levelPackProductsData;

 __declspec(property(get=get_pricePerLevel)) float_t  pricePerLevel;

 __declspec(property(get=get_pricePairBundlePairs)) ::ArrayW<::GlobalNamespace::__SonyLevelPacksSKUModel__PricePerBundlePair*,::Array<::GlobalNamespace::__SonyLevelPacksSKUModel__PricePerBundlePair*>*>  pricePairBundlePairs;

 __declspec(property(get=get_levelPackProductsData)) ::ArrayW<::GlobalNamespace::__SonyLevelPacksSKUModel__LevelPackProductData*,::Array<::GlobalNamespace::__SonyLevelPacksSKUModel__LevelPackProductData*>*>  levelPackProductsData;
...
constexpr void __set__pricePairBundlePairs(::ArrayW<::GlobalNamespace::__SonyLevelPacksSKUModel__PricePerBundlePair*,::Array<::GlobalNamespace::__SonyLevelPacksSKUModel__PricePerBundlePair*>*>  value) ;
...
constexpr ::ArrayW<::GlobalNamespace::__SonyLevelPacksSKUModel__PricePerBundlePair*,::Array<::GlobalNamespace::__SonyLevelPacksSKUModel__PricePerBundlePair*>*> const& __get__pricePairBundlePairs() const;

constexpr void __set__levelPackProductsData(::ArrayW<::GlobalNamespace::__SonyLevelPacksSKUModel__LevelPackProductData*,::Array<::GlobalNamespace::__SonyLevelPacksSKUModel__LevelPackProductData*>*>  value) ;
...
constexpr ::ArrayW<::GlobalNamespace::__SonyLevelPacksSKUModel__LevelPackProductData*,::Array<::GlobalNamespace::__SonyLevelPacksSKUModel__LevelPackProductData*>*> const& __get__levelPackProductsData() const;
...
// Ctor Parameters []
// @brief default ctor
 SonyLevelPacksSKUModel()  = default;
public:
