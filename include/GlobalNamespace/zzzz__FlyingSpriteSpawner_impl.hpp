...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Sprite*> GlobalNamespace::FlyingSpriteSpawner::__get__sprite() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Sprite*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> GlobalNamespace::FlyingSpriteSpawner::__get__material() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Material*, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::__FlyingSpriteEffect__Pool*, 0x50>(this, std::forward<::GlobalNamespace::__FlyingSpriteEffect__Pool*>(value));
}
constexpr ::GlobalNamespace::__FlyingSpriteEffect__Pool* GlobalNamespace::FlyingSpriteSpawner::__get__flyingSpriteEffectPool()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::__FlyingSpriteEffect__Pool*, 0x50>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__FlyingSpriteEffect__Pool*> GlobalNamespace::FlyingSpriteSpawner::__get__flyingSpriteEffectPool() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::__FlyingSpriteEffect__Pool*, 0x50>(this);
}
