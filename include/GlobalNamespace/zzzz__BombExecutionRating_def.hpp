...
struct CORDL_TYPE __BombExecutionRating__Rating : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____BombExecutionRating__Rating_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __BombExecutionRating__Rating(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __BombExecutionRating__Rating()  = default;
...
/// @brief Method get_rating addr 0x223bfbc size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x223bfc4 size 0x38 virtual false final false
