...
/// @brief Field showDebris offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __MainCameraCullingMask__InitData()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__MainCameraCullingMask__InitData*> __get__initData() const;
