...
/// @brief Field _saberAColorToggleController offset 0x18
...
/// @brief Field _saberBColorToggleController offset 0x20
...
/// @brief Field _environmentColor0ToggleController offset 0x28
 __declspec(property(get=__get__environmentColor0ToggleController, put=__set__environmentColor0ToggleController)) ::GlobalNamespace::ColorSchemeColorToggleController*  _environmentColor0ToggleController;

/// @brief Field _environmentColor1ToggleController offset 0x30
 __declspec(property(get=__get__environmentColor1ToggleController, put=__set__environmentColor1ToggleController)) ::GlobalNamespace::ColorSchemeColorToggleController*  _environmentColor1ToggleController;

/// @brief Field _obstaclesColorToggleController offset 0x38
...
/// @brief Field _environmentColor0BoostToggleController offset 0x40
 __declspec(property(get=__get__environmentColor0BoostToggleController, put=__set__environmentColor0BoostToggleController)) ::GlobalNamespace::ColorSchemeColorToggleController*  _environmentColor0BoostToggleController;

/// @brief Field _environmentColor1BoostToggleController offset 0x48
 __declspec(property(get=__get__environmentColor1BoostToggleController, put=__set__environmentColor1BoostToggleController)) ::GlobalNamespace::ColorSchemeColorToggleController*  _environmentColor1BoostToggleController;

/// @brief Field selectedColorDidChangeEvent offset 0x50
...
/// @brief Field _colorScheme offset 0x68
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorSchemeColorToggleController*> __get__saberAColorToggleController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorSchemeColorToggleController*> __get__saberBColorToggleController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorSchemeColorToggleController*> __get__environmentColor0ToggleController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorSchemeColorToggleController*> __get__environmentColor1ToggleController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorSchemeColorToggleController*> __get__obstaclesColorToggleController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorSchemeColorToggleController*> __get__environmentColor0BoostToggleController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorSchemeColorToggleController*> __get__environmentColor1BoostToggleController() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::UnityEngine::Color>*> __get_selectedColorDidChangeEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorSchemeColorToggleController*> __get__selectedColorToggleController() const;
...
// Ctor Parameters []
// @brief default ctor
 ColorSchemeColorsToggleGroup()  = default;
public:
