...
/// @brief Method NormalizedVolumeToDB addr 0xe265e4 size 0x74 virtual false final false
static inline float_t NormalizedVolumeToDB(float_t  normalizedVolume) ;

/// @brief Method DBToNormalizedVolume addr 0xe26658 size 0x18 virtual false final false
