...
/// @brief Field updateBeatmapDataOnInsert offset 0x10
...
/// @brief Field _beatmapEventDataBoxGroupProcessor offset 0x18
 __declspec(property(get=__get__beatmapEventDataBoxGroupProcessor, put=__set__beatmapEventDataBoxGroupProcessor)) ::GlobalNamespace::BeatmapEventDataBoxGroupProcessor*  _beatmapEventDataBoxGroupProcessor;

/// @brief Field _sortedList offset 0x20
 __declspec(property(get=__get__sortedList, put=__set__sortedList)) ::GlobalNamespace::SortedList_2<::GlobalNamespace::BeatmapEventDataBoxGroup*,::GlobalNamespace::BeatmapEventDataBoxGroup*>*  _sortedList;

/// @brief Field _groupId offset 0x28
 __declspec(property(get=__get__groupId, put=__set__groupId)) int32_t  _groupId;

/// @brief Field _beatmapData offset 0x30
 __declspec(property(get=__get__beatmapData, put=__set__beatmapData)) ::GlobalNamespace::BeatmapData*  _beatmapData;

/// @brief Field _beatToTimeConvertor offset 0x38
...
/// @brief Field _nonSyncedInsertsExist offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapEventDataBoxGroupProcessor*> __get__beatmapEventDataBoxGroupProcessor() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SortedList_2<::GlobalNamespace::BeatmapEventDataBoxGroup*,::GlobalNamespace::BeatmapEventDataBoxGroup*>*> __get__sortedList() const;
...
// Ctor Parameters []
// @brief default ctor
 BeatmapEventDataBoxGroupList()  = default;
public:


// Fields

// Static field _usedBeatmapEventDataBoxes
