...
::cordl_internals::setInstanceField<::GlobalNamespace::ObstacleControllerBase*, 0x18>(this, std::forward<::GlobalNamespace::ObstacleControllerBase*>(value));
}
constexpr ::GlobalNamespace::ObstacleControllerBase* GlobalNamespace::ObstacleDissolve::__get__obstacleController()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ObstacleControllerBase*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ObstacleControllerBase*> GlobalNamespace::ObstacleDissolve::__get__obstacleController() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ObstacleControllerBase*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::CutoutAnimateEffect*> GlobalNamespace::ObstacleDissolve::__get__cutoutAnimateEffect() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::CutoutAnimateEffect*, 0x20>(this);
}
