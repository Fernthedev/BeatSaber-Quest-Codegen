...
// CS Name: ::OVRPose
struct CORDL_TYPE OVRPose : public ::bs_hook::ValueTypeWrapper<0x1c> {
public:
// Declarations
...
/// @brief Field orientation offset 0xc
...
constexpr explicit OVRPose(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x1c>(instance) {
}
