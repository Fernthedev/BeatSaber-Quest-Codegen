...
/// @brief Field _viewportTransform offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::Tweening::Vector2Tween*> __get__viewportSizeTween() const;
...
constexpr ::cordl_internals::to_const_pointer<::Tweening::Vector2Tween*> __get__contentPositionTween() const;
...
// Ctor Parameters []
// @brief default ctor
 AnnotatedBeatmapLevelCollectionsGridViewAnimator()  = default;
public:
