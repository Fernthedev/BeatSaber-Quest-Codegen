...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameplayCoreSceneSetupData*> GlobalNamespace::MultiplayerLocalActivePlayerInstaller::__get__sceneSetupData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayCoreSceneSetupData*, 0x20>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlayerDataModel*> GlobalNamespace::MultiplayerLocalActivePlayerInstaller::__get__playerDataModel() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::PlayerDataModel*, 0x28>(this);
}
...
::cordl_internals::setInstanceField<::BeatSaber::AvatarCore::OptionalAvatarDataSender*, 0x30>(this, std::forward<::BeatSaber::AvatarCore::OptionalAvatarDataSender*>(value));
}
...
return ::cordl_internals::getInstanceField<::BeatSaber::AvatarCore::OptionalAvatarDataSender*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::BeatSaber::AvatarCore::OptionalAvatarDataSender*> GlobalNamespace::MultiplayerLocalActivePlayerInstaller::__get__optionalAvatarDataSender() const {
return ::cordl_internals::getInstanceField<::BeatSaber::AvatarCore::OptionalAvatarDataSender*, 0x30>(this);
}
