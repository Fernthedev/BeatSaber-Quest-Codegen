...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::VFXController*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __VFXController___MainCoroutine_d__9()  = default;
public:
...
/// @brief Field _deactivateAfterAnimationDuration offset 0x28
