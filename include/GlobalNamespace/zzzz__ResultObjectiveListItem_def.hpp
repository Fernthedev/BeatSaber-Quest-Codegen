...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Image*> __get__iconGlow() const;
...
// Ctor Parameters []
// @brief default ctor
 ResultObjectiveListItem()  = default;
public:
