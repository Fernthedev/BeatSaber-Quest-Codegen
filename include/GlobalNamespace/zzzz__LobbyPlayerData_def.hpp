...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x28 - sizeof(::GlobalNamespace::LevelGameplaySetupData)]{};
...
/// @brief Field <isActive>k__BackingField offset 0x21
