...
::cordl_internals::setInstanceField<::UnityEngine::MeshFilter*, 0x30>(this, std::forward<::UnityEngine::MeshFilter*>(value));
}
constexpr ::UnityEngine::MeshFilter* GlobalNamespace::MirroredSliderController::__get__meshFilter()  {
return ::cordl_internals::getInstanceField<::UnityEngine::MeshFilter*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::MeshFilter*> GlobalNamespace::MirroredSliderController::__get__meshFilter() const {
return ::cordl_internals::getInstanceField<::UnityEngine::MeshFilter*, 0x30>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::IBeatmapObjectSpawnController*, 0x38>(this, std::forward<::GlobalNamespace::IBeatmapObjectSpawnController*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::IBeatmapObjectSpawnController*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IBeatmapObjectSpawnController*> GlobalNamespace::MirroredSliderController::__get__beatmapObjectSpawnController() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IBeatmapObjectSpawnController*, 0x38>(this);
}
constexpr void GlobalNamespace::MirroredSliderController::__set__followedSlider(::GlobalNamespace::SliderController*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::SliderController*, 0x40>(this, std::forward<::GlobalNamespace::SliderController*>(value));
}
constexpr ::GlobalNamespace::SliderController* GlobalNamespace::MirroredSliderController::__get__followedSlider()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SliderController*, 0x40>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SliderController*> GlobalNamespace::MirroredSliderController::__get__followedSlider() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SliderController*, 0x40>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> GlobalNamespace::MirroredSliderController::__get__transform() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x48>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> GlobalNamespace::MirroredSliderController::__get__followedTransform() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x50>(this);
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__MirroredSliderController__Pool::*)()>(&::GlobalNamespace::__MirroredSliderController__Pool::_ctor)> {
