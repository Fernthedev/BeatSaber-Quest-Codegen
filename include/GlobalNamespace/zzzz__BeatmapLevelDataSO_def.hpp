...
/// @brief Field _beatmapCharacteristicSerializedName offset 0x10
...
/// @brief Field _difficultyBeatmaps offset 0x18
 ...
 __declspec(property(get=get_difficultyBeatmaps)) ::ArrayW<::GlobalNamespace::__BeatmapLevelSO__DifficultyBeatmap*,::Array<::GlobalNamespace::__BeatmapLevelSO__DifficultyBeatmap*>*>  difficultyBeatmaps;
...
/// @brief Method get_beatmapCharacteristicSerializedName addr 0x2342064 size 0x8 virtual false final false
inline ::StringW get_beatmapCharacteristicSerializedName() ;

/// @brief Method get_difficultyBeatmaps addr 0x234206c size 0x8 virtual false final false
...
static inline ::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet* New_ctor(::StringW  beatmapCharacteristicSerializedName, ::ArrayW<::GlobalNamespace::__BeatmapLevelSO__DifficultyBeatmap*,::Array<::GlobalNamespace::__BeatmapLevelSO__DifficultyBeatmap*>*>  difficultyBeatmaps) ;

/// @brief Method .ctor addr 0x2342074 size 0x2c virtual false final false
inline void _ctor(::StringW  beatmapCharacteristicSerializedName, ::ArrayW<::GlobalNamespace::__BeatmapLevelSO__DifficultyBeatmap*,::Array<::GlobalNamespace::__BeatmapLevelSO__DifficultyBeatmap*>*>  difficultyBeatmaps) ;
...
// Ctor Parameters []
// @brief default ctor
 __BeatmapLevelDataSO__DifficultyBeatmapSet()  = default;
public:
...
/// @brief Field _difficultyBeatmapSets offset 0x20
 __declspec(property(get=__get__difficultyBeatmapSets, put=__set__difficultyBeatmapSets)) ::ArrayW<::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet*,::Array<::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet*>*>  _difficultyBeatmapSets;

/// @brief Field _no360MovementDifficultyBeatmapSets offset 0x28
 __declspec(property(get=__get__no360MovementDifficultyBeatmapSets, put=__set__no360MovementDifficultyBeatmapSets)) ::ArrayW<::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet*,::Array<::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet*>*>  _no360MovementDifficultyBeatmapSets;
...
constexpr ::ArrayW<::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet*,::Array<::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet*>*> const& __get__difficultyBeatmapSets() const;

constexpr void __set__no360MovementDifficultyBeatmapSets(::ArrayW<::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet*,::Array<::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet*,::Array<::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet*>*>& __get__no360MovementDifficultyBeatmapSets() ;

constexpr ::ArrayW<::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet*,::Array<::GlobalNamespace::__BeatmapLevelDataSO__DifficultyBeatmapSet*>*> const& __get__no360MovementDifficultyBeatmapSets() const;

/// @brief Method get_audioClip addr 0x234204c size 0x8 virtual false final false
inline ::UnityEngine::AudioClip* get_audioClip() ;

/// @brief Method get_difficultyBeatmapSets addr 0x2342054 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x234205c size 0x8 virtual false final false
inline void _ctor() ;
