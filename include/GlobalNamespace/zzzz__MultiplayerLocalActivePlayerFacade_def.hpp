...
/// @brief Field _activeOnlyGameObjects offset 0x18
...
/// @brief Field _introAnimator offset 0x30
...
/// @brief Field _gameSongController offset 0x38
...
/// @brief Field _prepareLevelCompletionResults offset 0x48
...
/// @brief Field _beatmapCallbacksUpdater offset 0x50
...
/// @brief Field playerDidFinishEvent offset 0x58
...
/// @brief Field playerNetworkDidFailedEvent offset 0x60
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IStartSeekSongController*> __get__songController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLocalActivePlayerIntroAnimator*> __get__introAnimator() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapCallbacksUpdater*> __get__beatmapCallbacksUpdater() const;
...
/// @brief Method get_introAnimator addr 0x23da6e0 size 0x8 virtual false final false
inline ::GlobalNamespace::MultiplayerLocalActivePlayerIntroAnimator* get_introAnimator() ;

/// @brief Method get_outroAnimator addr 0x23da6e8 size 0x8 virtual false final false
inline ::UnityEngine::GameObject* get_outroAnimator() ;

/// @brief Method get_songController addr 0x23da6f0 size 0x8 virtual true final true
inline ::GlobalNamespace::IStartSeekSongController* get_songController() ;

/// @brief Method get_currentLocalPlayerLevelCompletionResult addr 0x23da6f8 size 0x24 virtual false final false
inline ::GlobalNamespace::LevelCompletionResults* get_currentLocalPlayerLevelCompletionResult() ;

/// @brief Method add_playerDidFinishEvent addr 0x23da71c size 0xb0 virtual true final true
inline void add_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  value) ;

/// @brief Method remove_playerDidFinishEvent addr 0x23da7cc size 0xb0 virtual true final true
inline void remove_playerDidFinishEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  value) ;

/// @brief Method add_playerNetworkDidFailedEvent addr 0x23da87c size 0xb0 virtual true final true
inline void add_playerNetworkDidFailedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  value) ;

/// @brief Method remove_playerNetworkDidFailedEvent addr 0x23da92c size 0xb0 virtual true final true
inline void remove_playerNetworkDidFailedEvent(::System::Action_1<::GlobalNamespace::MultiplayerLevelCompletionResults*>*  value) ;

/// @brief Method ReportPlayerDidFinish addr 0x23da9dc size 0x1c virtual true final true
inline void ReportPlayerDidFinish(::GlobalNamespace::MultiplayerLevelCompletionResults*  results) ;

/// @brief Method ReportPlayerNetworkDidFailed addr 0x23da9f8 size 0x1c virtual true final true
inline void ReportPlayerNetworkDidFailed(::GlobalNamespace::MultiplayerLevelCompletionResults*  results) ;

/// @brief Method DisablePlayer addr 0x23daa14 size 0x64 virtual false final false
inline void DisablePlayer() ;

/// @brief Method PauseSpawning addr 0x23daa78 size 0x1c virtual false final false
inline void PauseSpawning() ;

/// @brief Method ResumeSpawning addr 0x23daa94 size 0x1c virtual false final false
inline void ResumeSpawning() ;

/// @brief Method __ForceStopSong addr 0x23daab0 size 0x34 virtual false final false
inline void __ForceStopSong() ;

/// @brief Method __GetActiveOnlyGameObjects addr 0x23daae4 size 0x8 virtual false final false
...
/// @brief Method .ctor addr 0x23daaec size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerLocalActivePlayerFacade()  = default;
public:
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11005), inst: 3490 }), TypeDefinitionIndex(TypeDefinitionIndex(5151)), TypeDefinitionIndex(TypeDefinitionIndex(11005)), TypeDefinitionIndex(TypeDefinitionIndex(5239))}
// Self: TypeDefinitionIndex(TypeDefinitionIndex(5150))
// CS Name: ::MultiplayerLocalActivePlayerFacade::Factory*
class CORDL_TYPE __MultiplayerLocalActivePlayerFacade__Factory : public ::Zenject::PlaceholderFactory_2<::GlobalNamespace::MultiplayerPlayerStartState,::GlobalNamespace::MultiplayerLocalActivePlayerFacade*> {
public:
// Declarations
/// @brief The size of the true reference type
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::Zenject::PlaceholderFactory_2<::GlobalNamespace::MultiplayerPlayerStartState,::GlobalNamespace::MultiplayerLocalActivePlayerFacade*>)]{};

static inline ::GlobalNamespace::__MultiplayerLocalActivePlayerFacade__Factory* New_ctor() ;

/// @brief Method .ctor addr 0x23daaf4 size 0x48 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerLocalActivePlayerFacade__Factory()  = default;
public:
