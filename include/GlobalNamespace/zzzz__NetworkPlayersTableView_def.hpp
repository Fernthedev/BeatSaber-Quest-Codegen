...
struct CORDL_TYPE __NetworkPlayersTableView__CellInfo__CellType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____NetworkPlayersTableView__CellInfo__CellType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __NetworkPlayersTableView__CellInfo__CellType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __NetworkPlayersTableView__CellInfo__CellType()  = default;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::INetworkPlayer*> __get_player() const;
...
// Ctor Parameters []
// @brief default ctor
 __NetworkPlayersTableView__CellInfo()  = default;
public:
...
/// @brief Field kPlayerCellIdentifier offset 0x0
static constexpr ::ConstString  kPlayerCellIdentifier{u"PlayerCell"};

/// @brief Field kHeaderCellIdentifier offset 0x0
static constexpr ::ConstString  kHeaderCellIdentifier{u"HeaderCell"};

/// @brief Field kOptionsCellIdentifier offset 0x0
...
/// @brief Field _playerCellPrefab offset 0x20
...
/// @brief Field _optionsCellPrefab offset 0x28
...
/// @brief Field _headerCellPrefab offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NetworkPlayerTableCell*> __get__playerCellPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NetworkPlayerOptionsTableCell*> __get__optionsCellPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LevelPackHeaderTableCell*> __get__headerCellPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__NetworkPlayersTableView__CellInfo*>*> __get__cellInfo() const;
...
// Ctor Parameters []
// @brief default ctor
 NetworkPlayersTableView()  = default;
public:
