...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FireworksController*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __FireworksController___SpawningCoroutine_d__8()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__FireworkItemController__Pool*> __get__fireworkItemPool() const;
