...
constexpr void GlobalNamespace::__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0::__set_numberOfElements(int32_t  value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<int32_t>(value));
}
constexpr int32_t& GlobalNamespace::__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0::__get_numberOfElements()  {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& GlobalNamespace::__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0::__get_numberOfElements() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "numberOfElements", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0::__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0(int32_t  numberOfElements) noexcept : ::bs_hook::ValueTypeWrapper<0x4>() {this->numberOfElements = numberOfElements;
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::BeatmapEventDataBoxGroup* (*)(float_t, int32_t, ::GlobalNamespace::__DefaultEnvironmentEvents__LightGroupEvent*)>(&::GlobalNamespace::BeatmapEventDataBoxGroupFactory::CreateSingleLightBeatmapEventDataBoxGroup)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__DefaultEnvironmentEvents__LightGroupEvent*>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::IndexFilter* (*)(::GlobalNamespace::__DefaultEnvironmentEvents__LightGroupFiltering*, ByRef<::GlobalNamespace::__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0>)>(&::GlobalNamespace::BeatmapEventDataBoxGroupFactory::_CreateSingleLightBeatmapEventDataBoxGroup_g__CreateIndexFilter_2_0)> {
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__DefaultEnvironmentEvents__LightGroupFiltering*>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<ByRef<::GlobalNamespace::__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0>>::get()}
                        )));
    return ___internal_method;
  }
};
...
inline ::GlobalNamespace::BeatmapEventDataBoxGroup* GlobalNamespace::BeatmapEventDataBoxGroupFactory::CreateSingleLightBeatmapEventDataBoxGroup(float_t  beat, int32_t  numberOfElements, ::GlobalNamespace::__DefaultEnvironmentEvents__LightGroupEvent*  lightGroupEvent)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapEventDataBoxGroupFactory*>::get(),
                            "CreateSingleLightBeatmapEventDataBoxGroup",
                            std::vector<Il2CppClass*>{},
...
inline ::GlobalNamespace::IndexFilter* GlobalNamespace::BeatmapEventDataBoxGroupFactory::_CreateSingleLightBeatmapEventDataBoxGroup_g__CreateIndexFilter_2_0(::GlobalNamespace::__DefaultEnvironmentEvents__LightGroupFiltering*  filtering, ByRef<::GlobalNamespace::__BeatmapEventDataBoxGroupFactory____c__DisplayClass2_0>  _cordl_fixed_empty_name_whitespace)  {
static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_class<::GlobalNamespace::BeatmapEventDataBoxGroupFactory*>::get(),
                            "<CreateSingleLightBeatmapEventDataBoxGroup>g__CreateIndexFilter|2_0",
                            std::vector<Il2CppClass*>{},
