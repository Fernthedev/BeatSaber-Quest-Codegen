...
constexpr ::cordl_internals::to_const_pointer<::HMUI::InputFieldView*> GlobalNamespace::InputFieldSettingsController::__get__inputFieldView() const {
return ::cordl_internals::getInstanceField<::HMUI::InputFieldView*, 0x18>(this);
}
constexpr void GlobalNamespace::InputFieldSettingsController::__set__settingsValue(::GlobalNamespace::StringSO*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::StringSO*, 0x20>(this, std::forward<::GlobalNamespace::StringSO*>(value));
}
constexpr ::GlobalNamespace::StringSO* GlobalNamespace::InputFieldSettingsController::__get__settingsValue()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::StringSO*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::StringSO*> GlobalNamespace::InputFieldSettingsController::__get__settingsValue() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::StringSO*, 0x20>(this);
}
