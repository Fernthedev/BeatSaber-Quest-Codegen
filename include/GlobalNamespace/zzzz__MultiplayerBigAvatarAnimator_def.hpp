...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::HologramRays*> __get__hologramRays() const;
...
constexpr ::cordl_internals::to_const_pointer<::Tweening::Tween_1<float_t>*> __get__scaleUpTween() const;
...
constexpr ::cordl_internals::to_const_pointer<::Tweening::Tween_1<float_t>*> __get__scaleDownTween() const;
...
/// @brief Method OnDestroy addr 0x2244a88 size 0x88 virtual false final false
inline void OnDestroy() ;

/// @brief Method InitIfNeeded addr 0x2244b10 size 0x1d8 virtual false final false
inline void InitIfNeeded() ;

/// @brief Method SetPositionAndRotation addr 0x2244ce8 size 0x78 virtual false final false
inline void SetPositionAndRotation(::UnityEngine::Vector3  position, ::UnityEngine::Quaternion  rotation) ;

/// @brief Method HideInstant addr 0x2244d60 size 0xa8 virtual false final false
inline void HideInstant() ;

/// @brief Method Animate addr 0x2244e08 size 0x1d4 virtual false final false
...
/// @brief Method .ctor addr 0x2244fdc size 0x10 virtual false final false
inline void _ctor() ;

/// @brief Method <InitIfNeeded>b__8_0 addr 0x2244fec size 0x78 virtual false final false
inline void _InitIfNeeded_b__8_0(float_t  val) ;

/// @brief Method <InitIfNeeded>b__8_1 addr 0x2245064 size 0x78 virtual false final false
inline void _InitIfNeeded_b__8_1(float_t  val) ;

/// @brief Method <InitIfNeeded>b__8_2 addr 0x22450dc size 0x2c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerBigAvatarAnimator()  = default;
public:
