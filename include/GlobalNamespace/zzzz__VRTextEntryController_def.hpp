...
/// @brief Field <cursorColor>5__2 offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::VRTextEntryController*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __VRTextEntryController___BlinkCursor_d__23()  = default;
public:
...
/// @brief Field cancelButtonWasPressedEvent offset 0x48
...
/// @brief Field _stopBlinkingCursor offset 0x50
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::UIKeyboard*> __get__uiKeyboard() const;
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> __get__cursorText() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::StringW>*> __get_textDidChangeEvent() const;
