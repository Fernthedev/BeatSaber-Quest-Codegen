...
/// @brief Field _smoothCamera offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SmoothCamera*> __get__smoothCamera() const;
...
// Ctor Parameters []
// @brief default ctor
 SmoothCameraController()  = default;
public:
