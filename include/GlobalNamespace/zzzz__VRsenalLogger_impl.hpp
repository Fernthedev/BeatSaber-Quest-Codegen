...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ScenesTransitionSetupDataSO*> GlobalNamespace::VRsenalLogger::__get__standardLevelScenesTransitionSetupData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ScenesTransitionSetupDataSO*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ScenesTransitionSetupDataSO*> GlobalNamespace::VRsenalLogger::__get__tutorialScenesTransitionSetupData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ScenesTransitionSetupDataSO*, 0x20>(this);
}
constexpr void GlobalNamespace::VRsenalLogger::__set__playerNameWasEnteredSignal(::GlobalNamespace::StringSignal*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::StringSignal*, 0x28>(this, std::forward<::GlobalNamespace::StringSignal*>(value));
}
constexpr ::GlobalNamespace::StringSignal* GlobalNamespace::VRsenalLogger::__get__playerNameWasEnteredSignal()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::StringSignal*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::StringSignal*> GlobalNamespace::VRsenalLogger::__get__playerNameWasEnteredSignal() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::StringSignal*, 0x28>(this);
}
constexpr void GlobalNamespace::VRsenalLogger::__set__vRsenalScoreLoggerPrefab(::GlobalNamespace::VRsenalScoreLogger*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::VRsenalScoreLogger*, 0x30>(this, std::forward<::GlobalNamespace::VRsenalScoreLogger*>(value));
}
constexpr ::GlobalNamespace::VRsenalScoreLogger* GlobalNamespace::VRsenalLogger::__get__vRsenalScoreLoggerPrefab()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::VRsenalScoreLogger*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::VRsenalScoreLogger*> GlobalNamespace::VRsenalLogger::__get__vRsenalScoreLoggerPrefab() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::VRsenalScoreLogger*, 0x30>(this);
}
constexpr void GlobalNamespace::VRsenalLogger::__set__gameScenesManager(::GlobalNamespace::GameScenesManager*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::GameScenesManager*, 0x38>(this, std::forward<::GlobalNamespace::GameScenesManager*>(value));
}
constexpr ::GlobalNamespace::GameScenesManager* GlobalNamespace::VRsenalLogger::__get__gameScenesManager()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameScenesManager*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameScenesManager*> GlobalNamespace::VRsenalLogger::__get__gameScenesManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameScenesManager*, 0x38>(this);
}
