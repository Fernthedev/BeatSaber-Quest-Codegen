...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRSceneAnchor*> __get_Prefab() const;
...
// Ctor Parameters []
// @brief default ctor
 OVRScenePrefabOverride()  = default;
public:
