...
struct CORDL_TYPE __OVRMeshRenderer__MeshRendererData : public ::bs_hook::ValueTypeWrapper<0x3> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x3};

/// @brief Field <IsDataValid>k__BackingField offset 0x0
...
/// @brief Field <IsDataHighConfidence>k__BackingField offset 0x1
...
/// @brief Field <ShouldUseSystemGestureMaterial>k__BackingField offset 0x2
...
constexpr explicit __OVRMeshRenderer__MeshRendererData(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x3>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRMeshRenderer__MeshRendererData()  = default;
...
struct CORDL_TYPE __OVRMeshRenderer__ConfidenceBehavior : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____OVRMeshRenderer__ConfidenceBehavior_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRMeshRenderer__ConfidenceBehavior(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRMeshRenderer__ConfidenceBehavior()  = default;
...
struct CORDL_TYPE __OVRMeshRenderer__SystemGestureBehavior : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____OVRMeshRenderer__SystemGestureBehavior_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRMeshRenderer__SystemGestureBehavior(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRMeshRenderer__SystemGestureBehavior()  = default;
...
/// @brief Field _systemGestureBehavior offset 0x34
...
/// @brief Field _systemGestureMaterial offset 0x38
...
/// @brief Field <IsInitialized>k__BackingField offset 0x50
...
/// @brief Field <IsDataValid>k__BackingField offset 0x51
 __declspec(property(get=__get__IsDataValid_k__BackingField, put=__set__IsDataValid_k__BackingField)) bool  _IsDataValid_k__BackingField;

/// @brief Field <IsDataHighConfidence>k__BackingField offset 0x52
 __declspec(property(get=__get__IsDataHighConfidence_k__BackingField, put=__set__IsDataHighConfidence_k__BackingField)) bool  _IsDataHighConfidence_k__BackingField;

/// @brief Field <ShouldUseSystemGestureMaterial>k__BackingField offset 0x53
 __declspec(property(get=__get__ShouldUseSystemGestureMaterial_k__BackingField, put=__set__ShouldUseSystemGestureMaterial_k__BackingField)) bool  _ShouldUseSystemGestureMaterial_k__BackingField;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRMeshRenderer__IOVRMeshRendererDataProvider*> __get__dataProvider() const;

constexpr void __set__ovrMesh(::GlobalNamespace::OVRMesh*  value) ;

constexpr ::GlobalNamespace::OVRMesh* __get__ovrMesh() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRMesh*> __get__ovrMesh() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Material*> __get__originalMaterial() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::SkinnedMeshRenderer*> __get__skinnedMeshRenderer() const;
