...
/// @brief Field multiplayerAvatar offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLobbyAvatarManager*> __get___4__this() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLobbyAvatarController*> __get_multiplayerAvatar() const;
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerLobbyAvatarManager___RemovePlayerAndDestroy_d__13()  = default;
public:
...
/// @brief Field _avatarControllerFactory offset 0x20
...
/// @brief Field _innerCircleRadius offset 0x28
 __declspec(property(get=__get__innerCircleRadius, put=__set__innerCircleRadius)) float_t  _innerCircleRadius;

/// @brief Field _minOuterCircleRadius offset 0x2c
 __declspec(property(get=__get__minOuterCircleRadius, put=__set__minOuterCircleRadius)) float_t  _minOuterCircleRadius;

/// @brief Field _playerIdToAvatarMap offset 0x30
 __declspec(property(get=__get__playerIdToAvatarMap, put=__set__playerIdToAvatarMap)) ::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::MultiplayerLobbyAvatarController*>*  _playerIdToAvatarMap;

/// @brief Field _inProgressDespawnAnimations offset 0x38
 __declspec(property(get=__get__inProgressDespawnAnimations, put=__set__inProgressDespawnAnimations)) ::System::Collections::Generic::HashSet_1<::GlobalNamespace::MultiplayerLobbyAvatarController*>*  _inProgressDespawnAnimations;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__MultiplayerLobbyAvatarController__Factory*> __get__avatarControllerFactory() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::StringW,::GlobalNamespace::MultiplayerLobbyAvatarController*>*> __get__playerIdToAvatarMap() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::GlobalNamespace::MultiplayerLobbyAvatarController*>*> __get__inProgressDespawnAnimations() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerLobbyAvatarManager()  = default;
public:
