...
/// @brief Method Contains addr 0x12a20a4 size 0x10 virtual false final false
static inline bool Contains(::GlobalNamespace::GameplayModifierMask  mask, ::GlobalNamespace::GameplayModifierMask  other) ;

/// @brief Method DifferenceFrom addr 0x12a20b4 size 0x10 virtual false final false
...
/// @brief Method ToHexString addr 0x12a20c4 size 0x5c virtual false final false
static inline ::StringW ToHexString(::GlobalNamespace::GameplayModifierMask  mask) ;

/// @brief Method ToModifiers addr 0x12a2120 size 0x148 virtual false final false
static inline ::GlobalNamespace::GameplayModifiers* ToModifiers(::GlobalNamespace::GameplayModifierMask  gameplayModifierMask) ;

/// @brief Method ToMask addr 0x12a235c size 0xb8 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 GameplayModifierMaskExtensions()  = default;
public:
