...
::cordl_internals::setInstanceField<::GlobalNamespace::CuttableBySaber*, 0x80>(this, std::forward<::GlobalNamespace::CuttableBySaber*>(value));
}
constexpr ::GlobalNamespace::CuttableBySaber* GlobalNamespace::BombNoteController::__get__cuttableBySaber()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::CuttableBySaber*, 0x80>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::CuttableBySaber*> GlobalNamespace::BombNoteController::__get__cuttableBySaber() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::CuttableBySaber*, 0x80>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> GlobalNamespace::BombNoteController::__get__wrapperGO() const {
return ::cordl_internals::getInstanceField<::UnityEngine::GameObject*, 0x88>(this);
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__BombNoteController__Pool::*)()>(&::GlobalNamespace::__BombNoteController__Pool::_ctor)> {
