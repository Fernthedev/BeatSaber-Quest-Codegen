...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MainSettingsModelSO*> GlobalNamespace::ReleaseInfoViewController::__get__mainSettingsModel() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MainSettingsModelSO*, 0x70>(this);
}
constexpr void GlobalNamespace::ReleaseInfoViewController::__set__textPageScrollView(::HMUI::TextPageScrollView*  value)  {
::cordl_internals::setInstanceField<::HMUI::TextPageScrollView*, 0x78>(this, std::forward<::HMUI::TextPageScrollView*>(value));
}
constexpr ::HMUI::TextPageScrollView* GlobalNamespace::ReleaseInfoViewController::__get__textPageScrollView()  {
return ::cordl_internals::getInstanceField<::HMUI::TextPageScrollView*, 0x78>(this);
}
constexpr ::cordl_internals::to_const_pointer<::HMUI::TextPageScrollView*> GlobalNamespace::ReleaseInfoViewController::__get__textPageScrollView() const {
return ::cordl_internals::getInstanceField<::HMUI::TextPageScrollView*, 0x78>(this);
}
constexpr void GlobalNamespace::ReleaseInfoViewController::__set__releaseNotesTextAsset(::UnityEngine::TextAsset*  value)  {
::cordl_internals::setInstanceField<::UnityEngine::TextAsset*, 0x80>(this, std::forward<::UnityEngine::TextAsset*>(value));
}
constexpr ::UnityEngine::TextAsset* GlobalNamespace::ReleaseInfoViewController::__get__releaseNotesTextAsset()  {
return ::cordl_internals::getInstanceField<::UnityEngine::TextAsset*, 0x80>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TextAsset*> GlobalNamespace::ReleaseInfoViewController::__get__releaseNotesTextAsset() const {
return ::cordl_internals::getInstanceField<::UnityEngine::TextAsset*, 0x80>(this);
}
constexpr void GlobalNamespace::ReleaseInfoViewController::__set__firstTextAsset(::UnityEngine::TextAsset*  value)  {
::cordl_internals::setInstanceField<::UnityEngine::TextAsset*, 0x88>(this, std::forward<::UnityEngine::TextAsset*>(value));
}
constexpr ::UnityEngine::TextAsset* GlobalNamespace::ReleaseInfoViewController::__get__firstTextAsset()  {
return ::cordl_internals::getInstanceField<::UnityEngine::TextAsset*, 0x88>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::TextAsset*> GlobalNamespace::ReleaseInfoViewController::__get__firstTextAsset() const {
return ::cordl_internals::getInstanceField<::UnityEngine::TextAsset*, 0x88>(this);
}
