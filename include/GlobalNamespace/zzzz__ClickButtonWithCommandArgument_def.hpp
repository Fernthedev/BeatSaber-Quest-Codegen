...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ClickButtonWithCommandArgument*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __ClickButtonWithCommandArgument___Start_d__2()  = default;
public:
...
/// @brief Field _argument offset 0x18
...
// Ctor Parameters []
// @brief default ctor
 ClickButtonWithCommandArgument()  = default;
public:
