...
/// @brief Method GetValue addr 0x23cd750 size 0x28 virtual true final false
...
/// @brief Method .ctor addr 0x23cd778 size 0x10 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerBadgeDataComboSO()  = default;
public:
