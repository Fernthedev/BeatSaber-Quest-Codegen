...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::EnvironmentInfoSO*> GlobalNamespace::CustomLevelLoader::__get__defaultEnvironmentInfo() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::EnvironmentInfoSO*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::EnvironmentInfoSO*> GlobalNamespace::CustomLevelLoader::__get__defaultAllDirectionsEnvironmentInfo() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::EnvironmentInfoSO*, 0x20>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::EnvironmentsListSO*> GlobalNamespace::CustomLevelLoader::__get__environmentSceneInfoCollection() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::EnvironmentsListSO*, 0x28>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Sprite*> GlobalNamespace::CustomLevelLoader::__get__defaultPackCover() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Sprite*, 0x30>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Sprite*> GlobalNamespace::CustomLevelLoader::__get__smallDefaultPackCover() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Sprite*, 0x38>(this);
}
