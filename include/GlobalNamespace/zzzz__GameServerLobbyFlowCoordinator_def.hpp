...
struct CORDL_TYPE __GameServerLobbyFlowCoordinator__LobbyType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____GameServerLobbyFlowCoordinator__LobbyType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __GameServerLobbyFlowCoordinator__LobbyType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __GameServerLobbyFlowCoordinator__LobbyType()  = default;
...
/// @brief Field eventSystem offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameServerLobbyFlowCoordinator*> __get___4__this() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::EventSystems::EventSystem*> __get_eventSystem() const;
...
// Ctor Parameters []
// @brief default ctor
 __GameServerLobbyFlowCoordinator____c__DisplayClass70_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __GameServerLobbyFlowCoordinator____c__DisplayClass85_0()  = default;
public:
...
/// @brief Field _selectModifiersViewController offset 0xc0
...
/// @brief Field _multiplayerLevelSelectionFlowCoordinator offset 0xc8
 __declspec(property(get=__get__multiplayerLevelSelectionFlowCoordinator, put=__set__multiplayerLevelSelectionFlowCoordinator)) ::GlobalNamespace::MultiplayerLevelSelectionFlowCoordinator*  _multiplayerLevelSelectionFlowCoordinator;

/// @brief Field _multiplayerResultsViewController offset 0xd0
 __declspec(property(get=__get__multiplayerResultsViewController, put=__set__multiplayerResultsViewController)) ::GlobalNamespace::MultiplayerResultsViewController*  _multiplayerResultsViewController;

/// @brief Field _simpleDialogPromptViewController offset 0xd8
...
/// @brief Field _connectionErrorDialogViewController offset 0xe0
 __declspec(property(get=__get__connectionErrorDialogViewController, put=__set__connectionErrorDialogViewController)) ::GlobalNamespace::ConnectionErrorDialogViewController*  _connectionErrorDialogViewController;

/// @brief Field _multiplayerSettingsPanelController offset 0xe8
...
/// @brief Field _gameplaySetupViewController offset 0xf0
...
/// @brief Field _multiplayerLobbyController offset 0xf8
...
/// @brief Field _fadeInOutController offset 0x100
...
/// @brief Field _centerStageScreenController offset 0x108
...
/// @brief Field _lobbyStateDataModel offset 0x110
...
/// @brief Field _lobbyGameStateModel offset 0x118
...
/// @brief Field _lobbyPlayersDataModel offset 0x120
...
/// @brief Field _lobbyGameStateController offset 0x128
...
/// @brief Field _lobbyPlayerPermissionsModel offset 0x130
...
/// @brief Field _lobbySetupViewController offset 0x138
...
/// @brief Field _unifiedNetworkPlayerModel offset 0x140
...
/// @brief Field _screenModeController offset 0x148
...
/// @brief Field _playerDataModel offset 0x150
 __declspec(property(get=__get__playerDataModel, put=__set__playerDataModel)) ::GlobalNamespace::PlayerDataModel*  _playerDataModel;

/// @brief Field _platformLeaderboardsModel offset 0x158
...
/// @brief Field _songPreviewPlayer offset 0x160
...
/// @brief Field _analyticsModel offset 0x168
 __declspec(property(get=__get__analyticsModel, put=__set__analyticsModel)) ::GlobalNamespace::IAnalyticsModel*  _analyticsModel;

/// @brief Field _lastSimpleLevelSelectionFlowCoordinatorState offset 0x170
 __declspec(property(get=__get__lastSimpleLevelSelectionFlowCoordinatorState, put=__set__lastSimpleLevelSelectionFlowCoordinatorState)) ::GlobalNamespace::__LevelSelectionFlowCoordinator__State*  _lastSimpleLevelSelectionFlowCoordinatorState;

/// @brief Field _isAlreadyFinishing offset 0x178
 __declspec(property(get=__get__isAlreadyFinishing, put=__set__isAlreadyFinishing)) bool  _isAlreadyFinishing;

/// @brief Field _stringBuilder offset 0x180
 __declspec(property(get=__get__stringBuilder, put=__set__stringBuilder)) ::System::Text::StringBuilder*  _stringBuilder;

/// @brief Field _canStartGameCts offset 0x188
...
/// @brief Field <rejoinQuickPlay>k__BackingField offset 0x1b8
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::ScreenModeSO*> __get__screenMode() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ServerPlayerListViewController*> __get__serverPlayerListViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SelectModifiersViewController*> __get__selectModifiersViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLevelSelectionFlowCoordinator*> __get__multiplayerLevelSelectionFlowCoordinator() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerResultsViewController*> __get__multiplayerResultsViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ConnectionErrorDialogViewController*> __get__connectionErrorDialogViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLobbyController*> __get__multiplayerLobbyController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LobbySetupViewController*> __get__lobbySetupViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::ScreenModeController*> __get__screenModeController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__LevelSelectionFlowCoordinator__State*> __get__lastSimpleLevelSelectionFlowCoordinatorState() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Threading::CancellationTokenSource*> __get__canStartGameCts() const;

constexpr void __set_willFinishEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_willFinishEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_willFinishEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_didSetupEvent() const;

constexpr void __set_didOpenInvitePanelEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_didOpenInvitePanelEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_didOpenInvitePanelEvent() const;
...
// Ctor Parameters []
// @brief default ctor
 GameServerLobbyFlowCoordinator()  = default;
public:
