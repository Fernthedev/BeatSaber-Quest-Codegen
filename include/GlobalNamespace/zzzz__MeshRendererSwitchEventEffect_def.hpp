...
/// @brief Field _deactivateOnBoostRenderers offset 0x20
 __declspec(property(get=__get__deactivateOnBoostRenderers, put=__set__deactivateOnBoostRenderers)) ::ArrayW<::UnityEngine::MeshRenderer*,::Array<::UnityEngine::MeshRenderer*>*>  _deactivateOnBoostRenderers;

/// @brief Field _activateOnBoostRenderers offset 0x28
 __declspec(property(get=__get__activateOnBoostRenderers, put=__set__activateOnBoostRenderers)) ::ArrayW<::UnityEngine::MeshRenderer*,::Array<::UnityEngine::MeshRenderer*>*>  _activateOnBoostRenderers;
...
// Ctor Parameters []
// @brief default ctor
 MeshRendererSwitchEventEffect()  = default;
public:
