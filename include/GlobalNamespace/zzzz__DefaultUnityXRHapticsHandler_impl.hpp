...
::cordl_internals::setInstanceField<::UnityEngine::XR::XRNode, 0x10>(this, std::forward<::UnityEngine::XR::XRNode>(value));
}
constexpr ::UnityEngine::XR::XRNode& GlobalNamespace::DefaultUnityXRHapticsHandler::__get__node()  {
return ::cordl_internals::getInstanceField<::UnityEngine::XR::XRNode, 0x10>(this);
}
