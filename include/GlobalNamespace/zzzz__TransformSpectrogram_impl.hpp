...
::cordl_internals::setInstanceField<::GlobalNamespace::LightAxis, 0x20>(this, std::forward<::GlobalNamespace::LightAxis>(value));
}
constexpr ::GlobalNamespace::LightAxis& GlobalNamespace::TransformSpectrogram::__get__axis()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::LightAxis, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::BasicSpectrogramData*, 0x38>(this, std::forward<::GlobalNamespace::BasicSpectrogramData*>(value));
}
constexpr ::GlobalNamespace::BasicSpectrogramData* GlobalNamespace::TransformSpectrogram::__get__spectrogramData()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BasicSpectrogramData*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BasicSpectrogramData*> GlobalNamespace::TransformSpectrogram::__get__spectrogramData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BasicSpectrogramData*, 0x38>(this);
}
