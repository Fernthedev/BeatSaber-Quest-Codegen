...
/// @brief Field _childNodes offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionDataSO*> __get__missionDataSO() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionNodeVisualController*> __get__missionNodeVisualController() const;
