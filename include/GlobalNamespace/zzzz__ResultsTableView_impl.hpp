...
constexpr ::cordl_internals::to_const_pointer<::HMUI::TableView*> GlobalNamespace::ResultsTableView::__get__tableView() const {
return ::cordl_internals::getInstanceField<::HMUI::TableView*, 0x18>(this);
}
constexpr void GlobalNamespace::ResultsTableView::__set__cellPrefab(::GlobalNamespace::ResultsTableCell*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::ResultsTableCell*, 0x20>(this, std::forward<::GlobalNamespace::ResultsTableCell*>(value));
}
constexpr ::GlobalNamespace::ResultsTableCell* GlobalNamespace::ResultsTableView::__get__cellPrefab()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ResultsTableCell*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ResultsTableCell*> GlobalNamespace::ResultsTableView::__get__cellPrefab() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ResultsTableCell*, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MultiplayerPlayerResultsData*>*, 0x30>(this, std::forward<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MultiplayerPlayerResultsData*>*>(value));
}
...
return ::cordl_internals::getInstanceField<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MultiplayerPlayerResultsData*>*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MultiplayerPlayerResultsData*>*> GlobalNamespace::ResultsTableView::__get__dataList() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MultiplayerPlayerResultsData*>*, 0x30>(this);
}
