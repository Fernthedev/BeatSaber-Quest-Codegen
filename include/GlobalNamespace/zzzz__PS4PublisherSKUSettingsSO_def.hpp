...
/// @brief Field _applicationVersion offset 0x18
...
// Ctor Parameters []
// @brief default ctor
 __PS4PublisherSKUSettingsSO__PS4BuildVersion()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x60 - sizeof(::GlobalNamespace::SonyPublisherSKUSettingsSO)]{};

/// @brief Field _buildVersion offset 0x38
...
/// @brief Field _latestBuildVersion offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__PS4PublisherSKUSettingsSO__PS4BuildVersion*> __get__buildVersion() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__PS4PublisherSKUSettingsSO__PS4BuildVersion*> __get__latestBuildVersion() const;
...
// Ctor Parameters []
// @brief default ctor
 PS4PublisherSKUSettingsSO()  = default;
public:
