...
/// @brief Field _alwaysOwnedPacks offset 0x18
 __declspec(property(get=__get__alwaysOwnedPacks, put=__set__alwaysOwnedPacks)) ::ArrayW<::GlobalNamespace::BeatmapLevelPackSO*,::Array<::GlobalNamespace::BeatmapLevelPackSO*>*>  _alwaysOwnedPacks;

/// @brief Field _alwaysOwnedBeatmapLevels offset 0x20
 __declspec(property(get=__get__alwaysOwnedBeatmapLevels, put=__set__alwaysOwnedBeatmapLevels)) ::ArrayW<::GlobalNamespace::BeatmapLevelSO*,::Array<::GlobalNamespace::BeatmapLevelSO*>*>  _alwaysOwnedBeatmapLevels;
