...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::GlobalNamespace::ScenesTransitionSetupDataSO)]{};
...
/// @brief Field _eventsTestSceneInfo offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SceneInfo*> __get__eventsTestSceneInfo() const;
...
// Ctor Parameters []
// @brief default ctor
 EventsTestScenesTransitionSetupDataSO()  = default;
public:
