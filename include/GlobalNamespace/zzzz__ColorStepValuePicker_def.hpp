...
/// @brief Field incButtonWasPressedEvent offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> __get__decButton() const;

constexpr void __set__incButton(::UnityEngine::UI::Button*  value) ;

constexpr ::UnityEngine::UI::Button* __get__incButton() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> __get__incButton() const;

constexpr void __set__valueImage(::HMUI::ImageView*  value) ;

constexpr ::HMUI::ImageView* __get__valueImage() ;

constexpr ::cordl_internals::to_const_pointer<::HMUI::ImageView*> __get__valueImage() const;

constexpr void __set_decButtonWasPressedEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_decButtonWasPressedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_decButtonWasPressedEvent() const;

constexpr void __set_incButtonWasPressedEvent(::System::Action*  value) ;

constexpr ::System::Action* __get_incButtonWasPressedEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_incButtonWasPressedEvent() const;

/// @brief Method add_decButtonWasPressedEvent addr 0x23e42a0 size 0x9c virtual false final false
inline void add_decButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method remove_decButtonWasPressedEvent addr 0x23e433c size 0x9c virtual false final false
inline void remove_decButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method add_incButtonWasPressedEvent addr 0x23e43d8 size 0x9c virtual false final false
inline void add_incButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method remove_incButtonWasPressedEvent addr 0x23e4474 size 0x9c virtual false final false
inline void remove_incButtonWasPressedEvent(::System::Action*  value) ;

/// @brief Method get_color addr 0x23e4510 size 0x24 virtual false final false
inline ::UnityEngine::Color get_color() ;

/// @brief Method set_color addr 0x23e4534 size 0x24 virtual false final false
inline void set_color(::UnityEngine::Color  value) ;

/// @brief Method set_decButtonInteractable addr 0x23e4558 size 0x20 virtual false final false
inline void set_decButtonInteractable(bool  value) ;

/// @brief Method set_incButtonInteractable addr 0x23e4578 size 0x20 virtual false final false
inline void set_incButtonInteractable(bool  value) ;

/// @brief Method OnEnable addr 0x23e4598 size 0xf0 virtual true final false
inline void OnEnable() ;

/// @brief Method OnDisable addr 0x23e4688 size 0xf0 virtual false final false
inline void OnDisable() ;

/// @brief Method IncButtonPressed addr 0x23e4778 size 0x1c virtual false final false
inline void IncButtonPressed() ;

/// @brief Method DecButtonPressed addr 0x23e4794 size 0x1c virtual false final false
inline void DecButtonPressed() ;

static inline ::GlobalNamespace::ColorStepValuePicker* New_ctor() ;

/// @brief Method .ctor addr 0x23e47b0 size 0x8 virtual false final false
inline void _ctor() ;
