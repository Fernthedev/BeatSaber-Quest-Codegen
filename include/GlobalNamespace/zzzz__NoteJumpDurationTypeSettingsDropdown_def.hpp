...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5602), inst: 4748 }), TypeDefinitionIndex(TypeDefinitionIndex(4622)), TypeDefinitionIndex(TypeDefinitionIndex(5602))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::GlobalNamespace::ValueDropdownController_1<::GlobalNamespace::NoteJumpDurationTypeSettings>)]{};
...
// Ctor Parameters []
// @brief default ctor
 NoteJumpDurationTypeSettingsDropdown()  = default;
public:
