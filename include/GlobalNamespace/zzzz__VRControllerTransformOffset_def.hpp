...
/// @brief Method get_poseOffset addr 0x20ffd98 size 0xb0 virtual false final false
...
/// @brief Method .ctor addr 0x21003b4 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 VRControllerTransformOffset()  = default;
public:
