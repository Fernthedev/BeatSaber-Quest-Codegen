...
struct CORDL_TYPE __OVRSceneLoader__SceneInfo : public ::bs_hook::ValueTypeWrapper<0x10> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x10};

/// @brief Field scenes offset 0x0
 __declspec(property(get=__get_scenes, put=__set_scenes)) ::System::Collections::Generic::List_1<::StringW>*  scenes;

/// @brief Field version offset 0x8
 __declspec(property(get=__get_version, put=__set_version)) int64_t  version;

constexpr void __set_scenes(::System::Collections::Generic::List_1<::StringW>*  value) ;

constexpr ::System::Collections::Generic::List_1<::StringW>* __get_scenes() ;

constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> __get_scenes() const;

constexpr void __set_version(int64_t  value) ;

constexpr int64_t& __get_version() ;

constexpr int64_t const& __get_version() const;
...
constexpr explicit __OVRSceneLoader__SceneInfo(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x10>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRSceneLoader__SceneInfo()  = default;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRSceneLoader*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __OVRSceneLoader___DelayCanvasPosUpdate_d__24()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __OVRSceneLoader___onCheckSceneCoroutine_d__25()  = default;
public:
...
/// @brief Field currentSceneInfo offset 0x60
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Canvas*> __get_mainCanvas() const;

constexpr void __set_logTextBox(::UnityEngine::UI::Text*  value) ;

constexpr ::UnityEngine::UI::Text* __get_logTextBox() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Text*> __get_logTextBox() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AsyncOperation*> __get_loadSceneOperation() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::UnityEngine::AssetBundle*>*> __get_loadedAssetBundles() const;
