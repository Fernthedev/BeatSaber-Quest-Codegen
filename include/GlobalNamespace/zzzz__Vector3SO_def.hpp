...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(10249)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(15869), inst: 412 }), TypeDefinitionIndex(TypeDefinitionIndex(15869))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::GlobalNamespace::ObservableVariableSO_1<::UnityEngine::Vector3>)]{};

static inline ::GlobalNamespace::Vector3SO* New_ctor() ;

/// @brief Method .ctor addr 0xe28b20 size 0x48 virtual false final false
inline void _ctor() ;
