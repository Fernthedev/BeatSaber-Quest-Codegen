...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x88 - sizeof(::GlobalNamespace::MockPlayerSettings)]{};

static inline ::GlobalNamespace::MockServerSettings* New_ctor() ;

/// @brief Method .ctor addr 0x2244568 size 0x8 virtual false final false
inline void _ctor() ;
