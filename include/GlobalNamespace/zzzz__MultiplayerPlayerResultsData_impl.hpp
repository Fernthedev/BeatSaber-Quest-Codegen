...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<int32_t (::GlobalNamespace::MultiplayerPlayerResultsData::*)(::System::Object*)>(&::GlobalNamespace::MultiplayerPlayerResultsData::CompareTo)> {
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IConnectedPlayer*> GlobalNamespace::MultiplayerPlayerResultsData::__get_connectedPlayer() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IConnectedPlayer*, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::MultiplayerLevelCompletionResults*, 0x18>(this, std::forward<::GlobalNamespace::MultiplayerLevelCompletionResults*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::MultiplayerLevelCompletionResults*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLevelCompletionResults*> GlobalNamespace::MultiplayerPlayerResultsData::__get_multiplayerLevelCompletionResults() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MultiplayerLevelCompletionResults*, 0x18>(this);
}
constexpr void GlobalNamespace::MultiplayerPlayerResultsData::__set_badge(::GlobalNamespace::MultiplayerBadgeAwardData*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::MultiplayerBadgeAwardData*, 0x20>(this, std::forward<::GlobalNamespace::MultiplayerBadgeAwardData*>(value));
}
constexpr ::GlobalNamespace::MultiplayerBadgeAwardData* GlobalNamespace::MultiplayerPlayerResultsData::__get_badge()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MultiplayerBadgeAwardData*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerBadgeAwardData*> GlobalNamespace::MultiplayerPlayerResultsData::__get_badge() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MultiplayerBadgeAwardData*, 0x20>(this);
}
