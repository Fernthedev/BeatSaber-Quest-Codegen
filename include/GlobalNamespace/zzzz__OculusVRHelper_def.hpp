...
/// @brief Field inputFocusWasCapturedEvent offset 0x38
...
/// @brief Field inputFocusWasReleasedEvent offset 0x40
...
/// @brief Field vrFocusWasCapturedEvent offset 0x48
...
/// @brief Field vrFocusWasReleasedEvent offset 0x50
...
/// @brief Field controllersDidDisconnectEvent offset 0x70
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::EventSystems::EventSystem*> __get__disabledEventSystem() const;

/// @brief Method add_inputFocusWasCapturedEvent addr 0x20f7bf4 size 0x9c virtual true final true
inline void add_inputFocusWasCapturedEvent(::System::Action*  value) ;

/// @brief Method remove_inputFocusWasCapturedEvent addr 0x20f7c90 size 0x9c virtual true final true
inline void remove_inputFocusWasCapturedEvent(::System::Action*  value) ;

/// @brief Method add_inputFocusWasReleasedEvent addr 0x20f7d2c size 0x9c virtual true final true
inline void add_inputFocusWasReleasedEvent(::System::Action*  value) ;

/// @brief Method remove_inputFocusWasReleasedEvent addr 0x20f7dc8 size 0x9c virtual true final true
inline void remove_inputFocusWasReleasedEvent(::System::Action*  value) ;

/// @brief Method add_vrFocusWasCapturedEvent addr 0x20f7e64 size 0x9c virtual true final true
inline void add_vrFocusWasCapturedEvent(::System::Action*  value) ;

/// @brief Method remove_vrFocusWasCapturedEvent addr 0x20f7f00 size 0x9c virtual true final true
inline void remove_vrFocusWasCapturedEvent(::System::Action*  value) ;

/// @brief Method add_vrFocusWasReleasedEvent addr 0x20f7f9c size 0x9c virtual true final true
inline void add_vrFocusWasReleasedEvent(::System::Action*  value) ;

/// @brief Method remove_vrFocusWasReleasedEvent addr 0x20f8038 size 0x9c virtual true final true
inline void remove_vrFocusWasReleasedEvent(::System::Action*  value) ;

/// @brief Method add_hmdUnmountedEvent addr 0x20f80d4 size 0x9c virtual true final true
inline void add_hmdUnmountedEvent(::System::Action*  value) ;

/// @brief Method remove_hmdUnmountedEvent addr 0x20f8170 size 0x9c virtual true final true
inline void remove_hmdUnmountedEvent(::System::Action*  value) ;

/// @brief Method add_hmdMountedEvent addr 0x20f820c size 0x9c virtual true final true
inline void add_hmdMountedEvent(::System::Action*  value) ;

/// @brief Method remove_hmdMountedEvent addr 0x20f82a8 size 0x9c virtual true final true
inline void remove_hmdMountedEvent(::System::Action*  value) ;

/// @brief Method add_controllersDidChangeReferenceEvent addr 0x20f8344 size 0x9c virtual true final true
inline void add_controllersDidChangeReferenceEvent(::System::Action*  value) ;

/// @brief Method remove_controllersDidChangeReferenceEvent addr 0x20f83e0 size 0x9c virtual true final true
inline void remove_controllersDidChangeReferenceEvent(::System::Action*  value) ;

/// @brief Method add_controllersDidDisconnectEvent addr 0x20f847c size 0x9c virtual true final true
inline void add_controllersDidDisconnectEvent(::System::Action*  value) ;

/// @brief Method remove_controllersDidDisconnectEvent addr 0x20f8518 size 0x9c virtual true final true
inline void remove_controllersDidDisconnectEvent(::System::Action*  value) ;

/// @brief Method get_hasInputFocus addr 0x20f85b4 size 0x50 virtual true final true
inline bool get_hasInputFocus() ;

/// @brief Method get_hasVrFocus addr 0x20f8604 size 0x50 virtual true final true
inline bool get_hasVrFocus() ;

/// @brief Method get_isAlwaysWireless addr 0x20f8654 size 0x8 virtual true final true
inline bool get_isAlwaysWireless() ;

/// @brief Method get_vrPlatformSDK addr 0x20f865c size 0x8 virtual true final true
inline ::GlobalNamespace::VRPlatformSDK get_vrPlatformSDK() ;

/// @brief Method get_loggerPrefix addr 0x20f8664 size 0x40 virtual true final true
inline ::StringW get_loggerPrefix() ;

/// @brief Method get__isOVRManagerPresent addr 0x20f86a4 size 0xbc virtual false final false
inline bool get__isOVRManagerPresent() ;

/// @brief Method Update addr 0x20f8760 size 0x218 virtual false final false
inline void Update() ;

/// @brief Method FixedUpdate addr 0x20f8af4 size 0x58 virtual false final false
inline void FixedUpdate() ;

/// @brief Method LateUpdate addr 0x20f8b4c size 0x58 virtual false final false
inline void LateUpdate() ;

/// @brief Method TriggerHapticPulse addr 0x20f8ba4 size 0x7c virtual true final true
inline void TriggerHapticPulse(::UnityEngine::XR::XRNode  node, float_t  duration, float_t  strength, float_t  frequency) ;

/// @brief Method StopHaptics addr 0x20f8c20 size 0x6c virtual true final true
inline void StopHaptics(::UnityEngine::XR::XRNode  node) ;

/// @brief Method TryGetPoseOffsetForNode addr 0x20f8c8c size 0xc4 virtual true final true
inline bool TryGetPoseOffsetForNode(::UnityEngine::XR::XRNode  node, ByRef<::UnityEngine::Pose>  poseOffset) ;

/// @brief Method GetNodePose addr 0x20f8d50 size 0x164 virtual true final true
...
/// @brief Method XRNodeToOVRNode addr 0x20f8eb4 size 0xd8 virtual false final false
static inline ::GlobalNamespace::__OVRPlugin__Node XRNodeToOVRNode(::UnityEngine::XR::XRNode  node) ;

/// @brief Method GetAnyJoystickMaxAxis addr 0x20f8f8c size 0x4 virtual true final true
inline ::UnityEngine::Vector2 GetAnyJoystickMaxAxis() ;

/// @brief Method GetTriggerValue addr 0x20f8f90 size 0x98 virtual true final true
inline float_t GetTriggerValue(::UnityEngine::XR::XRNode  node) ;

/// @brief Method GetThumbstickValue addr 0x20f9028 size 0xf8 virtual true final true
inline ::UnityEngine::Vector2 GetThumbstickValue(::UnityEngine::XR::XRNode  node) ;

/// @brief Method GetMenuButton addr 0x20f9120 size 0x44 virtual true final true
inline bool GetMenuButton() ;

/// @brief Method GetMenuButtonDown addr 0x20f9164 size 0x44 virtual true final true
inline bool GetMenuButtonDown() ;

/// @brief Method RefreshControllersReference addr 0x20f91a8 size 0x1c virtual true final true
inline void RefreshControllersReference() ;

/// @brief Method EnableEventSystem addr 0x20f8a70 size 0x84 virtual false final false
inline void EnableEventSystem() ;

/// @brief Method DisableEventSystem addr 0x20f8978 size 0xf8 virtual false final false
inline void DisableEventSystem() ;

static inline ::GlobalNamespace::OculusVRHelper* New_ctor() ;

/// @brief Method .ctor addr 0x20f91c4 size 0x8 virtual false final false
inline void _ctor() ;
