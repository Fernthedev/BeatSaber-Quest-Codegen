...
/// @brief Field <timeSinceReminder>5__2 offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRSceneModelLoader*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __OVRSceneModelLoader___AttemptToLoadSceneModel_d__7()  = default;
public:
...
/// @brief Field RetryingReminderDelay offset 0x0
static constexpr float_t  RetryingReminderDelay{10.0};

/// @brief Field <SceneManager>k__BackingField offset 0x18
...
/// @brief Field _sceneCaptureRequested offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRSceneManager*> __get__SceneManager_k__BackingField() const;
