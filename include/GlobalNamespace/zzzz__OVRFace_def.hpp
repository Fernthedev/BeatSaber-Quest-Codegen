...
/// @brief Field _faceExpressions offset 0x18
...
/// @brief Field _blendShapeStrengthMultiplier offset 0x20
...
/// @brief Field _skinnedMeshRenderer offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRFaceExpressions*> __get__faceExpressions() const;
...
/// @brief Method get_FaceExpressions addr 0x27ab7d8 size 0x8 virtual false final false
inline ::GlobalNamespace::OVRFaceExpressions* get_FaceExpressions() ;

/// @brief Method set_FaceExpressions addr 0x27ab7e0 size 0x8 virtual false final false
inline void set_FaceExpressions(::GlobalNamespace::OVRFaceExpressions*  value) ;

/// @brief Method get_BlendShapeStrengthMultiplier addr 0x27ab7e8 size 0x8 virtual false final false
inline float_t get_BlendShapeStrengthMultiplier() ;

/// @brief Method set_BlendShapeStrengthMultiplier addr 0x27ab7f0 size 0x8 virtual false final false
inline void set_BlendShapeStrengthMultiplier(float_t  value) ;

/// @brief Method RetrieveSkinnedMeshRenderer addr 0x27ab7f8 size 0x48 virtual false final false
inline ::UnityEngine::SkinnedMeshRenderer* RetrieveSkinnedMeshRenderer() ;

/// @brief Method get_SkinnedMesh addr 0x27ab840 size 0x8 virtual false final false
inline ::UnityEngine::SkinnedMeshRenderer* get_SkinnedMesh() ;

/// @brief Method Awake addr 0x27ab848 size 0x104 virtual true final false
inline void Awake() ;

/// @brief Method SearchFaceExpressions addr 0x27ab94c size 0x58 virtual false final false
inline ::GlobalNamespace::OVRFaceExpressions* SearchFaceExpressions() ;

/// @brief Method Start addr 0x27a8cbc size 0x50 virtual true final false
inline void Start() ;

/// @brief Method Update addr 0x27ab9a4 size 0xf4 virtual true final false
inline void Update() ;

/// @brief Method GetFaceExpression addr 0x27aba98 size 0x8 virtual true final false
inline ::GlobalNamespace::__OVRFaceExpressions__FaceExpression GetFaceExpression(int32_t  blendShapeIndex) ;

/// @brief Method GetWeightValue addr 0x27abaa0 size 0x64 virtual true final false
...
/// @brief Method .ctor addr 0x27a8e8c size 0x10 virtual false final false
inline void _ctor() ;
