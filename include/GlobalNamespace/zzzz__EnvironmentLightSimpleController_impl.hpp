...
::cordl_internals::setInstanceField<::GlobalNamespace::LightWithIdManager*, 0x30>(this, std::forward<::GlobalNamespace::LightWithIdManager*>(value));
}
constexpr ::GlobalNamespace::LightWithIdManager* GlobalNamespace::EnvironmentLightSimpleController::__get__lightManager()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::LightWithIdManager*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LightWithIdManager*> GlobalNamespace::EnvironmentLightSimpleController::__get__lightManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::LightWithIdManager*, 0x30>(this);
}
