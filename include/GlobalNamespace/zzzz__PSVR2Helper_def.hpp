...
struct CORDL_TYPE __PSVR2Helper__HeadsetHapticFrequencyLimit : public ::bs_hook::ValueTypeWrapper<0x8> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x8};

/// @brief Field maxTimePlayed offset 0x0
 __declspec(property(get=__get_maxTimePlayed, put=__set_maxTimePlayed)) float_t  maxTimePlayed;

/// @brief Field maximumFrequency offset 0x4
 __declspec(property(get=__get_maximumFrequency, put=__set_maximumFrequency)) int32_t  maximumFrequency;

constexpr void __set_maxTimePlayed(float_t  value) ;

constexpr float_t& __get_maxTimePlayed() ;

constexpr float_t const& __get_maxTimePlayed() const;

constexpr void __set_maximumFrequency(int32_t  value) ;

constexpr int32_t& __get_maximumFrequency() ;

constexpr int32_t const& __get_maximumFrequency() const;

/// @brief Method .ctor addr 0x20fbb58 size 0xc virtual false final false
...
constexpr explicit __PSVR2Helper__HeadsetHapticFrequencyLimit(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x8>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __PSVR2Helper__HeadsetHapticFrequencyLimit()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xb8 - sizeof(::UnityEngine::MonoBehaviour)]{};

/// @brief Field kRightControllerName offset 0x0
static constexpr ::ConstString  kRightControllerName{u"PSVR2ControllerRight"};

/// @brief Field kLeftControllerName offset 0x0
static constexpr ::ConstString  kLeftControllerName{u"PSVR2ControllerLeft"};

/// @brief Field kMaxHMDFrequency offset 0x0
static constexpr int32_t  kMaxHMDFrequency{static_cast<int32_t>(0x19)};

/// @brief Field kRumbleMinimalDuration offset 0x0
static constexpr float_t  kRumbleMinimalDuration{0.05};

/// @brief Field _leftController offset 0x18
...
/// @brief Field _rightController offset 0x20
...
/// @brief Field _controllersWithRumble offset 0x50
 __declspec(property(get=__get__controllersWithRumble, put=__set__controllersWithRumble)) ::System::Collections::Generic::Dictionary_2<::UnityEngine::XR::XRNode,::UnityEngine::InputSystem::XR::XRControllerWithRumble*>*  _controllersWithRumble;

/// @brief Field _timeWhenStartedPlayingHaptic offset 0x58
...
/// @brief Field _lastTimeWhenTriggeredHaptic offset 0x5c
...
/// @brief Field _hasInputFocus offset 0x60
 __declspec(property(get=__get__hasInputFocus, put=__set__hasInputFocus)) bool  _hasInputFocus;

/// @brief Field _maximumHapticFrequencyLimits offset 0x68
 __declspec(property(get=__get__maximumHapticFrequencyLimits, put=__set__maximumHapticFrequencyLimits)) ::System::Collections::Generic::List_1<::GlobalNamespace::__PSVR2Helper__HeadsetHapticFrequencyLimit>*  _maximumHapticFrequencyLimits;

/// @brief Field controllersDidChangeReferenceEvent offset 0x70
...
/// @brief Field _hasVrFocus offset 0x78
 __declspec(property(get=__get__hasVrFocus, put=__set__hasVrFocus)) bool  _hasVrFocus;

/// @brief Field inputFocusWasCapturedEvent offset 0x80
...
/// @brief Field inputFocusWasReleasedEvent offset 0x88
...
/// @brief Field vrFocusWasCapturedEvent offset 0x90
...
/// @brief Field vrFocusWasReleasedEvent offset 0x98
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__UnityXRController__Configuration*> __get__leftController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__UnityXRController__Configuration*> __get__rightController() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityEngine::XR::XRNode,::GlobalNamespace::UnityXRController*>*> __get__controllers() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::UnityEngine::XR::XRNode,::UnityEngine::InputSystem::XR::XRControllerWithRumble*>*> __get__controllersWithRumble() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__PSVR2Helper__HeadsetHapticFrequencyLimit>*> __get__maximumHapticFrequencyLimits() const;
...
/// @brief Method add_controllersDidChangeReferenceEvent addr 0x20fa108 size 0x9c virtual true final true
inline void add_controllersDidChangeReferenceEvent(::System::Action*  value) ;

/// @brief Method remove_controllersDidChangeReferenceEvent addr 0x20fa1a4 size 0x9c virtual true final true
inline void remove_controllersDidChangeReferenceEvent(::System::Action*  value) ;

/// @brief Method get_hasInputFocus addr 0x20fa240 size 0x8 virtual true final true
inline bool get_hasInputFocus() ;

/// @brief Method get_hasVrFocus addr 0x20fa248 size 0x8 virtual true final true
inline bool get_hasVrFocus() ;

/// @brief Method get_isAlwaysWireless addr 0x20fa250 size 0x8 virtual true final true
inline bool get_isAlwaysWireless() ;

/// @brief Method get_vrPlatformSDK addr 0x20fa258 size 0x8 virtual true final true
inline ::GlobalNamespace::VRPlatformSDK get_vrPlatformSDK() ;

/// @brief Method add_inputFocusWasCapturedEvent addr 0x20fa260 size 0x9c virtual true final true
inline void add_inputFocusWasCapturedEvent(::System::Action*  value) ;

/// @brief Method remove_inputFocusWasCapturedEvent addr 0x20fa2fc size 0x9c virtual true final true
inline void remove_inputFocusWasCapturedEvent(::System::Action*  value) ;

/// @brief Method add_inputFocusWasReleasedEvent addr 0x20fa398 size 0x9c virtual true final true
inline void add_inputFocusWasReleasedEvent(::System::Action*  value) ;

/// @brief Method remove_inputFocusWasReleasedEvent addr 0x20fa434 size 0x9c virtual true final true
inline void remove_inputFocusWasReleasedEvent(::System::Action*  value) ;

/// @brief Method add_vrFocusWasCapturedEvent addr 0x20fa4d0 size 0x9c virtual true final true
inline void add_vrFocusWasCapturedEvent(::System::Action*  value) ;

/// @brief Method remove_vrFocusWasCapturedEvent addr 0x20fa56c size 0x9c virtual true final true
inline void remove_vrFocusWasCapturedEvent(::System::Action*  value) ;

/// @brief Method add_vrFocusWasReleasedEvent addr 0x20fa608 size 0x9c virtual true final true
inline void add_vrFocusWasReleasedEvent(::System::Action*  value) ;

/// @brief Method remove_vrFocusWasReleasedEvent addr 0x20fa6a4 size 0x9c virtual true final true
inline void remove_vrFocusWasReleasedEvent(::System::Action*  value) ;

/// @brief Method add_hmdUnmountedEvent addr 0x20fa740 size 0x9c virtual true final true
inline void add_hmdUnmountedEvent(::System::Action*  value) ;

/// @brief Method remove_hmdUnmountedEvent addr 0x20fa7dc size 0x9c virtual true final true
inline void remove_hmdUnmountedEvent(::System::Action*  value) ;

/// @brief Method add_hmdMountedEvent addr 0x20fa878 size 0x9c virtual true final true
inline void add_hmdMountedEvent(::System::Action*  value) ;

/// @brief Method remove_hmdMountedEvent addr 0x20fa914 size 0x9c virtual true final true
inline void remove_hmdMountedEvent(::System::Action*  value) ;

/// @brief Method add_controllersDidDisconnectEvent addr 0x20fa9b0 size 0x9c virtual true final true
inline void add_controllersDidDisconnectEvent(::System::Action*  value) ;

/// @brief Method remove_controllersDidDisconnectEvent addr 0x20faa4c size 0x9c virtual true final true
inline void remove_controllersDidDisconnectEvent(::System::Action*  value) ;

/// @brief Method Awake addr 0x20faae8 size 0x258 virtual false final false
inline void Awake() ;

/// @brief Method TryGetPoseOffsetForNode addr 0x20fae00 size 0x20 virtual true final true
inline bool TryGetPoseOffsetForNode(::UnityEngine::XR::XRNode  node, ByRef<::UnityEngine::Pose>  poseOffset) ;

/// @brief Method GetNodePose addr 0x20fae20 size 0x16c virtual true final true
...
/// @brief Method GetTriggerValue addr 0x20faf8c size 0x8 virtual true final true
inline float_t GetTriggerValue(::UnityEngine::XR::XRNode  node) ;

/// @brief Method GetAnyJoystickMaxAxis addr 0x20faf94 size 0x4 virtual true final true
inline ::UnityEngine::Vector2 GetAnyJoystickMaxAxis() ;

/// @brief Method GetThumbstickValue addr 0x20faf98 size 0xd4 virtual true final true
inline ::UnityEngine::Vector2 GetThumbstickValue(::UnityEngine::XR::XRNode  nodeType) ;

/// @brief Method GetMenuButton addr 0x20fb06c size 0x4 virtual true final true
inline bool GetMenuButton() ;

/// @brief Method GetMenuButtonDown addr 0x20fb070 size 0x4 virtual true final true
inline bool GetMenuButtonDown() ;

/// @brief Method RefreshControllersReference addr 0x20fb074 size 0x1c virtual true final true
inline void RefreshControllersReference() ;

/// @brief Method StopHaptics addr 0x20fb090 size 0x4 virtual true final true
inline void StopHaptics(::UnityEngine::XR::XRNode  node) ;

/// @brief Method TriggerHapticPulse addr 0x20fb094 size 0xa0 virtual true final true
inline void TriggerHapticPulse(::UnityEngine::XR::XRNode  node, float_t  duration, float_t  strength, float_t  frequency) ;

/// @brief Method GetTRCCompliantHeadsetHapticFrequency addr 0x20fb134 size 0x200 virtual false final false
inline int32_t GetTRCCompliantHeadsetHapticFrequency(float_t  initialFrequency) ;

/// @brief Method HandleApplicationFocusLost addr 0x20fb334 size 0x24 virtual false final false
inline void HandleApplicationFocusLost() ;

/// @brief Method HandleApplicationFocusResumed addr 0x20fb358 size 0x28 virtual false final false
inline void HandleApplicationFocusResumed() ;

/// @brief Method InputDeviceChangeTriggered addr 0x20fb380 size 0x34c virtual false final false
...
/// @brief Method AddControllerToMap addr 0x20fb6cc size 0x278 virtual false final false
inline void AddControllerToMap(::UnityEngine::XR::XRNode  forNode, ::UnityEngine::InputSystem::InputDevice*  device) ;

/// @brief Method OnDestroy addr 0x20fb944 size 0xa4 virtual false final false
inline void OnDestroy() ;

static inline ::GlobalNamespace::PSVR2Helper* New_ctor() ;

/// @brief Method .ctor addr 0x20fb9e8 size 0x170 virtual false final false
inline void _ctor() ;
