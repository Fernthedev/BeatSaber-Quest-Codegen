...
::cordl_internals::setInstanceField<::GlobalNamespace::OculusMRCManager*, 0x18>(this, std::forward<::GlobalNamespace::OculusMRCManager*>(value));
}
constexpr ::GlobalNamespace::OculusMRCManager* GlobalNamespace::ExternalCamerasManager::__get__oculusMRCManager()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::OculusMRCManager*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OculusMRCManager*> GlobalNamespace::ExternalCamerasManager::__get__oculusMRCManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::OculusMRCManager*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Camera*> GlobalNamespace::ExternalCamerasManager::__get__mrcBackgroundCameraPrefab() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Camera*, 0x20>(this);
}
constexpr void GlobalNamespace::ExternalCamerasManager::__set__mrcForegroundCameraPrefab(::UnityEngine::Camera*  value)  {
::cordl_internals::setInstanceField<::UnityEngine::Camera*, 0x28>(this, std::forward<::UnityEngine::Camera*>(value));
}
constexpr ::UnityEngine::Camera* GlobalNamespace::ExternalCamerasManager::__get__mrcForegroundCameraPrefab()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Camera*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Camera*> GlobalNamespace::ExternalCamerasManager::__get__mrcForegroundCameraPrefab() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Camera*, 0x28>(this);
}
