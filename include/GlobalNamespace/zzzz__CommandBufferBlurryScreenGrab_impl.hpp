...
::cordl_internals::setInstanceField<::GlobalNamespace::KawaseBlurRendererSO*, 0x28>(this, std::forward<::GlobalNamespace::KawaseBlurRendererSO*>(value));
}
constexpr ::GlobalNamespace::KawaseBlurRendererSO* GlobalNamespace::CommandBufferBlurryScreenGrab::__get__kawaseBlurRenderer()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::KawaseBlurRendererSO*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::KawaseBlurRendererSO*> GlobalNamespace::CommandBufferBlurryScreenGrab::__get__kawaseBlurRenderer() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::KawaseBlurRendererSO*, 0x28>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::__KawaseBlurRendererSO__KernelSize, 0x30>(this, std::forward<::GlobalNamespace::__KawaseBlurRendererSO__KernelSize>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::__KawaseBlurRendererSO__KernelSize, 0x30>(this);
}
...
::cordl_internals::setInstanceField<::UnityEngine::Rendering::CameraEvent, 0x34>(this, std::forward<::UnityEngine::Rendering::CameraEvent>(value));
}
constexpr ::UnityEngine::Rendering::CameraEvent& GlobalNamespace::CommandBufferBlurryScreenGrab::__get__cameraEvent()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Rendering::CameraEvent, 0x34>(this);
}
