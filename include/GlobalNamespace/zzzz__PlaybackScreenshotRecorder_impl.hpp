...
::cordl_internals::setInstanceField<::GlobalNamespace::PlaybackRenderer*, 0x20>(this, std::forward<::GlobalNamespace::PlaybackRenderer*>(value));
}
constexpr ::GlobalNamespace::PlaybackRenderer* GlobalNamespace::PlaybackScreenshotRecorder::__get__playbackRenderer()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::PlaybackRenderer*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlaybackRenderer*> GlobalNamespace::PlaybackScreenshotRecorder::__get__playbackRenderer() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::PlaybackRenderer*, 0x20>(this);
}
