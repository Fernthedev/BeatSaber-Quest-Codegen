...
/// @brief Field _accelerationMetersPerSecondSquared offset 0x24
...
/// @brief Field _decelerationMetersPerSecondSquared offset 0x28
...
/// @brief Field _layoutProvider offset 0x40
...
/// @brief Field _multiplayerController offset 0x48
...
/// @brief Field _reusablePlayersList offset 0x50
 __declspec(property(get=__get__reusablePlayersList, put=__set__reusablePlayersList)) ::System::Collections::Generic::List_1<::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*>*  _reusablePlayersList;

/// @brief Field _currentSpeedsDictionary offset 0x58
 __declspec(property(get=__get__currentSpeedsDictionary, put=__set__currentSpeedsDictionary)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::MultiplayerConnectedPlayerFacade*,float_t>*  _currentSpeedsDictionary;

/// @brief Field _lastFrameBaseScore offset 0x60
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__MultiplayerScoreProvider__RankedPlayer*>*> __get__reusablePlayersList() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::MultiplayerConnectedPlayerFacade*,float_t>*> __get__currentSpeedsDictionary() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerVerticalPlayerMovementManager()  = default;
public:
