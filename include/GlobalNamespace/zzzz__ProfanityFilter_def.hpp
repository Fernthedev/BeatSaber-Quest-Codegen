...
/// @brief Field _children offset 0x10
...
/// @brief Field _shortestWord offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<char16_t,::GlobalNamespace::__ProfanityFilter__TrieNode*>*> __get__children() const;
...
// Ctor Parameters []
// @brief default ctor
 __ProfanityFilter__TrieNode()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __ProfanityFilter___GetLookalikeLetters_d__4()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__ProfanityFilter__TrieNode*> __get__trie() const;
