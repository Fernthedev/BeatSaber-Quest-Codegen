...
/// @brief Field _instantiateMixedRealityBackgroundCameraGameObject offset 0x20
 __declspec(property(get=__get__instantiateMixedRealityBackgroundCameraGameObject, put=__set__instantiateMixedRealityBackgroundCameraGameObject)) ::System::Func_2<::UnityEngine::GameObject*,::UnityEngine::GameObject*>*  _instantiateMixedRealityBackgroundCameraGameObject;

/// @brief Field _instantiateMixedRealityForegroundCameraGameObject offset 0x28
 __declspec(property(get=__get__instantiateMixedRealityForegroundCameraGameObject, put=__set__instantiateMixedRealityForegroundCameraGameObject)) ::System::Func_2<::UnityEngine::GameObject*,::UnityEngine::GameObject*>*  _instantiateMixedRealityForegroundCameraGameObject;

/// @brief Field <enableMixedReality>k__BackingField offset 0x30
...
/// @brief Field <extraHiddenLayers>k__BackingField offset 0x34
...
/// @brief Field <extraVisibleLayers>k__BackingField offset 0x38
...
/// @brief Field <dynamicCullingMask>k__BackingField offset 0x3c
...
/// @brief Field <compositionMethod>k__BackingField offset 0x40
 __declspec(property(get=__get__compositionMethod_k__BackingField, put=__set__compositionMethod_k__BackingField)) ::GlobalNamespace::__OVRManager__CompositionMethod  _compositionMethod_k__BackingField;

/// @brief Field <externalCompositionBackdropColorRift>k__BackingField offset 0x44
 __declspec(property(get=__get__externalCompositionBackdropColorRift_k__BackingField, put=__set__externalCompositionBackdropColorRift_k__BackingField)) ::UnityEngine::Color  _externalCompositionBackdropColorRift_k__BackingField;

/// @brief Field <externalCompositionBackdropColorQuest>k__BackingField offset 0x54
 __declspec(property(get=__get__externalCompositionBackdropColorQuest_k__BackingField, put=__set__externalCompositionBackdropColorQuest_k__BackingField)) ::UnityEngine::Color  _externalCompositionBackdropColorQuest_k__BackingField;

/// @brief Field <capturingCameraDevice>k__BackingField offset 0x64
 __declspec(property(get=__get__capturingCameraDevice_k__BackingField, put=__set__capturingCameraDevice_k__BackingField)) ::GlobalNamespace::__OVRManager__CameraDevice  _capturingCameraDevice_k__BackingField;

/// @brief Field <flipCameraFrameHorizontally>k__BackingField offset 0x68
...
/// @brief Field <flipCameraFrameVertically>k__BackingField offset 0x69
...
/// @brief Field <handPoseStateLatency>k__BackingField offset 0x6c
...
/// @brief Field <sandwichCompositionRenderLatency>k__BackingField offset 0x70
 __declspec(property(get=__get__sandwichCompositionRenderLatency_k__BackingField, put=__set__sandwichCompositionRenderLatency_k__BackingField)) float_t  _sandwichCompositionRenderLatency_k__BackingField;

/// @brief Field <sandwichCompositionBufferedFrames>k__BackingField offset 0x74
 __declspec(property(get=__get__sandwichCompositionBufferedFrames_k__BackingField, put=__set__sandwichCompositionBufferedFrames_k__BackingField)) int32_t  _sandwichCompositionBufferedFrames_k__BackingField;

/// @brief Field <chromaKeyColor>k__BackingField offset 0x78
...
/// @brief Field <chromaKeySimilarity>k__BackingField offset 0x88
...
/// @brief Field <chromaKeySmoothRange>k__BackingField offset 0x8c
...
/// @brief Field <chromaKeySpillRange>k__BackingField offset 0x90
...
/// @brief Field <useDynamicLighting>k__BackingField offset 0x94
...
/// @brief Field <depthQuality>k__BackingField offset 0x98
...
/// @brief Field <dynamicLightingSmoothFactor>k__BackingField offset 0x9c
...
/// @brief Field <dynamicLightingDepthVariationClampingValue>k__BackingField offset 0xa0
 __declspec(property(get=__get__dynamicLightingDepthVariationClampingValue_k__BackingField, put=__set__dynamicLightingDepthVariationClampingValue_k__BackingField)) float_t  _dynamicLightingDepthVariationClampingValue_k__BackingField;

/// @brief Field <virtualGreenScreenType>k__BackingField offset 0xa4
 __declspec(property(get=__get__virtualGreenScreenType_k__BackingField, put=__set__virtualGreenScreenType_k__BackingField)) ::GlobalNamespace::__OVRManager__VirtualGreenScreenType  _virtualGreenScreenType_k__BackingField;

/// @brief Field <virtualGreenScreenTopY>k__BackingField offset 0xa8
...
/// @brief Field <virtualGreenScreenBottomY>k__BackingField offset 0xac
...
/// @brief Field <virtualGreenScreenApplyDepthCulling>k__BackingField offset 0xb0
 __declspec(property(get=__get__virtualGreenScreenApplyDepthCulling_k__BackingField, put=__set__virtualGreenScreenApplyDepthCulling_k__BackingField)) bool  _virtualGreenScreenApplyDepthCulling_k__BackingField;

/// @brief Field <virtualGreenScreenDepthTolerance>k__BackingField offset 0xb4
 __declspec(property(get=__get__virtualGreenScreenDepthTolerance_k__BackingField, put=__set__virtualGreenScreenDepthTolerance_k__BackingField)) float_t  _virtualGreenScreenDepthTolerance_k__BackingField;

/// @brief Field <mrcActivationMode>k__BackingField offset 0xb8
 __declspec(property(get=__get__mrcActivationMode_k__BackingField, put=__set__mrcActivationMode_k__BackingField)) ::GlobalNamespace::__OVRManager__MrcActivationMode  _mrcActivationMode_k__BackingField;

/// @brief Field _instantiateMixedRealityCameraGameObject offset 0xc0
 __declspec(property(get=__get__instantiateMixedRealityCameraGameObject, put=__set__instantiateMixedRealityCameraGameObject)) ::GlobalNamespace::__OVRManager__InstantiateMrcCameraDelegate*  _instantiateMixedRealityCameraGameObject;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<::UnityEngine::GameObject*,::UnityEngine::GameObject*>*> __get__instantiateMixedRealityBackgroundCameraGameObject() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<::UnityEngine::GameObject*,::UnityEngine::GameObject*>*> __get__instantiateMixedRealityForegroundCameraGameObject() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRManager__InstantiateMrcCameraDelegate*> __get__instantiateMixedRealityCameraGameObject() const;
...
inline void Init(::System::Func_2<::UnityEngine::GameObject*,::UnityEngine::GameObject*>*  instantiateMixedRealityBackgroundCameraGameObject, ::System::Func_2<::UnityEngine::GameObject*,::UnityEngine::GameObject*>*  instantiateMixedRealityForegroundCameraGameObject) ;
