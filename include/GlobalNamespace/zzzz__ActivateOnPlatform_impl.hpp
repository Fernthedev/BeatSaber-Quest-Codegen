...
::cordl_internals::setInstanceField<::GlobalNamespace::VRPlatformSDK, 0x18>(this, std::forward<::GlobalNamespace::VRPlatformSDK>(value));
}
constexpr ::GlobalNamespace::VRPlatformSDK& GlobalNamespace::ActivateOnPlatform::__get__vrPlatformSdk()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::VRPlatformSDK, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IVRPlatformHelper*> GlobalNamespace::ActivateOnPlatform::__get__vrPlatformHelper() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IVRPlatformHelper*, 0x20>(this);
}
