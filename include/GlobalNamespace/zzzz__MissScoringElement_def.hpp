...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5322)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5322), inst: 2818 }), TypeDefinitionIndex(TypeDefinitionIndex(5329))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::GlobalNamespace::__ScoringElement__Pool_1<::GlobalNamespace::MissScoringElement*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __MissScoringElement__Pool()  = default;
public:
