...
/// @brief Field _missionStagesManager offset 0x28
...
/// @brief Field _connectionsParentObject offset 0x30
...
/// @brief Field _missionNodesParentObject offset 0x38
...
/// @brief Field _missionProgressModel offset 0x40
...
/// @brief Field _allMissionNodeConnections offset 0x48
 __declspec(property(get=__get__allMissionNodeConnections, put=__set__allMissionNodeConnections)) ::ArrayW<::GlobalNamespace::MissionNodeConnection*,::Array<::GlobalNamespace::MissionNodeConnection*>*>  _allMissionNodeConnections;

/// @brief Field _allMissionNodes offset 0x50
...
/// @brief Field _isInitialized offset 0x58
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionNode*> __get__rootMissionNode() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionNode*> __get__finalMissionNode() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionStagesManager*> __get__missionStagesManager() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__connectionsParentObject() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__missionNodesParentObject() const;
...
inline ::System::Collections::Generic::HashSet_1<::GlobalNamespace::MissionNode*>* GetAllMissionNodes(::GlobalNamespace::MissionNode*  node, ::System::Collections::Generic::HashSet_1<::GlobalNamespace::MissionNode*>*  visited) ;
