...
struct CORDL_TYPE __MultiplayerSessionManager__MessageType : public ::bs_hook::EnumTypeWrapper<0x1> {
public:
// Declarations
...
return std::bit_cast<____MultiplayerSessionManager__MessageType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x1>::instance);
}
...
constexpr explicit __MultiplayerSessionManager__MessageType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x1>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MultiplayerSessionManager__MessageType()  = default;
...
struct CORDL_TYPE __MultiplayerSessionManager__SessionType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____MultiplayerSessionManager__SessionType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __MultiplayerSessionManager__SessionType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MultiplayerSessionManager__SessionType()  = default;
...
struct CORDL_TYPE __MultiplayerSessionManager__ConnectionState : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____MultiplayerSessionManager__ConnectionState_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __MultiplayerSessionManager__ConnectionState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MultiplayerSessionManager__ConnectionState()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerSessionManager____c__DisplayClass98_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerSessionManager____c()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xb8 - sizeof(::GlobalNamespace::StandaloneMonobehavior)]{};

/// @brief Field kMultiplayerSessionState offset 0x0
static constexpr ::ConstString  kMultiplayerSessionState{u"multiplayer_session"};

/// @brief Field _packetSerializer offset 0x38
 __declspec(property(get=__get__packetSerializer, put=__set__packetSerializer)) ::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::__MultiplayerSessionManager__MessageType,::GlobalNamespace::IConnectedPlayer*>*  _packetSerializer;

/// @brief Field _connectedPlayers offset 0x40
...
/// @brief Field _localPlayerState offset 0x48
...
/// @brief Field _freeSortIndices offset 0x58
...
/// @brief Field playerConnectedEvent offset 0x70
...
/// @brief Field playerDisconnectedEvent offset 0x78
...
/// @brief Field playerAvatarChangedEvent offset 0x80
...
/// @brief Field playerStateChangedEvent offset 0x88
...
/// @brief Field connectionOwnerStateChangedEvent offset 0x90
 __declspec(property(get=__get_connectionOwnerStateChangedEvent, put=__set_connectionOwnerStateChangedEvent)) ::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*  connectionOwnerStateChangedEvent;

/// @brief Field disconnectedEvent offset 0x98
...
/// @brief Field _connectedPlayerManager offset 0xb0
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NetworkPacketSerializer_2<::GlobalNamespace::__MultiplayerSessionManager__MessageType,::GlobalNamespace::IConnectedPlayer*>*> __get__packetSerializer() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Queue_1<int32_t>*> __get__freeSortIndices() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::IConnectedPlayer*>*> __get_connectionOwnerStateChangedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_pollUpdateEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IConnectedPlayer*> __get__connectionOwner_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerSessionManager()  = default;
public:
