...
struct CORDL_TYPE __LocalLeaderboardsModel__LeaderboardType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____LocalLeaderboardsModel__LeaderboardType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __LocalLeaderboardsModel__LeaderboardType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __LocalLeaderboardsModel__LeaderboardType()  = default;
...
// Ctor Parameters []
// @brief default ctor
 __LocalLeaderboardsModel__ScoreData()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__LocalLeaderboardsModel__ScoreData*>*> __get__scores() const;
...
// Ctor Parameters []
// @brief default ctor
 __LocalLeaderboardsModel__LeaderboardData()  = default;
public:
...
/// @brief Field _leaderboardsData offset 0x10
 __declspec(property(get=__get__leaderboardsData, put=__set__leaderboardsData)) ::System::Collections::Generic::List_1<::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardData*>*  _leaderboardsData;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardData*>*> __get__leaderboardsData() const;
...
// Ctor Parameters []
// @brief default ctor
 __LocalLeaderboardsModel__SavedLeaderboardsData()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __LocalLeaderboardsModel____c()  = default;
public:
...
/// @brief Field newScoreWasAddedToLeaderboardEvent offset 0x20
 __declspec(property(get=__get_newScoreWasAddedToLeaderboardEvent, put=__set_newScoreWasAddedToLeaderboardEvent)) ::System::Action_2<::StringW,::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardType>*  newScoreWasAddedToLeaderboardEvent;

/// @brief Field _lastScorePositions offset 0x28
 __declspec(property(get=__get__lastScorePositions, put=__set__lastScorePositions)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardType,int32_t>*  _lastScorePositions;

/// @brief Field _lastScoreLeaderboardId offset 0x30
 __declspec(property(get=__get__lastScoreLeaderboardId, put=__set__lastScoreLeaderboardId)) ::StringW  _lastScoreLeaderboardId;

/// @brief Field _leaderboardsData offset 0x38
 __declspec(property(get=__get__leaderboardsData, put=__set__leaderboardsData)) ::System::Collections::Generic::List_1<::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardData*>*  _leaderboardsData;

/// @brief Field _dailyLeaderboardsData offset 0x40
 __declspec(property(get=__get__dailyLeaderboardsData, put=__set__dailyLeaderboardsData)) ::System::Collections::Generic::List_1<::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardData*>*  _dailyLeaderboardsData;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::StringW,::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardType>*> __get_newScoreWasAddedToLeaderboardEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardType,int32_t>*> __get__lastScorePositions() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardData*>*> __get__dailyLeaderboardsData() const;
...
inline void LoadLeaderboardsData(::GlobalNamespace::ISaveData*  saveData, ::StringW  filename, ByRef<::System::Collections::Generic::List_1<::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardData*>*>  leaderboardsData) ;

/// @brief Method SaveLeaderboardsData addr 0x2328df0 size 0x138 virtual false final false
inline void SaveLeaderboardsData(::GlobalNamespace::ISaveData*  saveData, ::StringW  filename, ::System::Collections::Generic::List_1<::GlobalNamespace::__LocalLeaderboardsModel__LeaderboardData*>*  leaderboardsData) ;
...
// Ctor Parameters []
// @brief default ctor
 LocalLeaderboardsModel()  = default;
public:
