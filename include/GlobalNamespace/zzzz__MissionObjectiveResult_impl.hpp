...
::cordl_internals::setInstanceField<::GlobalNamespace::MissionObjective*, 0x10>(this, std::forward<::GlobalNamespace::MissionObjective*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::MissionObjective*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionObjective*> GlobalNamespace::MissionObjectiveResult::__get__missionObjective_k__BackingField() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MissionObjective*, 0x10>(this);
}
