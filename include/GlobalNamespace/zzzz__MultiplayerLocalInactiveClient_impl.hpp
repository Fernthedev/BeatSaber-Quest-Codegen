...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlayerTransforms*> GlobalNamespace::MultiplayerLocalInactiveClient::__get__playerTransforms() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::PlayerTransforms*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::INodePoseSyncStateManager*> GlobalNamespace::MultiplayerLocalInactiveClient::__get__nodePoseSyncStateManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::INodePoseSyncStateManager*, 0x20>(this);
}
