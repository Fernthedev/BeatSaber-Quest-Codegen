...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__ModifiersSelectionView____c__DisplayClass3_0::*)()>(&::GlobalNamespace::__ModifiersSelectionView____c__DisplayClass3_0::_ctor)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::__ModifiersSelectionView____c__DisplayClass3_0::*)(int32_t, ::GlobalNamespace::GameplayModifierInfoListItem*)>(&::GlobalNamespace::__ModifiersSelectionView____c__DisplayClass3_0::_SetGameplayModifiers_b__0)> {
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::GameplayModifierParamsSO*>*> GlobalNamespace::__ModifiersSelectionView____c__DisplayClass3_0::__get_modifierParams() const {
return ::cordl_internals::getInstanceField<::System::Collections::Generic::List_1<::GlobalNamespace::GameplayModifierParamsSO*>*, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::GameplayModifierInfoListItemsList*, 0x18>(this, std::forward<::GlobalNamespace::GameplayModifierInfoListItemsList*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayModifierInfoListItemsList*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameplayModifierInfoListItemsList*> GlobalNamespace::ModifiersSelectionView::__get__modifierInfoList() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayModifierInfoListItemsList*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> GlobalNamespace::ModifiersSelectionView::__get__noModifiersText() const {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::GameplayModifiersModelSO*, 0x28>(this, std::forward<::GlobalNamespace::GameplayModifiersModelSO*>(value));
}
constexpr ::GlobalNamespace::GameplayModifiersModelSO* GlobalNamespace::ModifiersSelectionView::__get__gameplayModifiersModel()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayModifiersModelSO*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameplayModifiersModelSO*> GlobalNamespace::ModifiersSelectionView::__get__gameplayModifiersModel() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::GameplayModifiersModelSO*, 0x28>(this);
}
