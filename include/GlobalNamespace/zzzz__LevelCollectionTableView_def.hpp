...
// Ctor Parameters []
// @brief default ctor
 __LevelCollectionTableView____c()  = default;
public:
...
/// @brief Field _levelCellsReuseIdentifier offset 0x30
...
/// @brief Field _packCellPrefab offset 0x38
...
/// @brief Field _packCellsReuseIdentifier offset 0x40
...
/// @brief Field _cellHeight offset 0x48
 __declspec(property(get=__get__cellHeight, put=__set__cellHeight)) float_t  _cellHeight;

/// @brief Field _showAlphabetScrollbarLevelCountThreshold offset 0x4c
...
/// @brief Field _beatmapLevelsPromoData offset 0x58
...
/// @brief Field didSelectLevelEvent offset 0x68
 __declspec(property(get=__get_didSelectLevelEvent, put=__set_didSelectLevelEvent)) ::System::Action_2<::GlobalNamespace::LevelCollectionTableView*,::GlobalNamespace::IPreviewBeatmapLevel*>*  didSelectLevelEvent;

/// @brief Field didSelectHeaderEvent offset 0x70
...
/// @brief Field _isInitialized offset 0x78
 __declspec(property(get=__get__isInitialized, put=__set__isInitialized)) bool  _isInitialized;

/// @brief Field _previewBeatmapLevels offset 0x80
 __declspec(property(get=__get__previewBeatmapLevels, put=__set__previewBeatmapLevels)) ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IPreviewBeatmapLevel*>*  _previewBeatmapLevels;

/// @brief Field _headerSprite offset 0x88
 __declspec(property(get=__get__headerSprite, put=__set__headerSprite)) ::UnityEngine::Sprite*  _headerSprite;

/// @brief Field _headerText offset 0x90
 __declspec(property(get=__get__headerText, put=__set__headerText)) ::StringW  _headerText;

/// @brief Field _showLevelPackHeader offset 0x98
 __declspec(property(get=__get__showLevelPackHeader, put=__set__showLevelPackHeader)) bool  _showLevelPackHeader;

/// @brief Field _favoriteLevelIds offset 0xa0
...
/// @brief Field _selectedRow offset 0xa8
 __declspec(property(get=__get__selectedRow, put=__set__selectedRow)) int32_t  _selectedRow;

/// @brief Field _selectedPreviewBeatmapLevel offset 0xb0
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::AlphabetScrollbar*> __get__alphabetScrollbar() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LevelListTableCell*> __get__levelCellPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LevelPackHeaderTableCell*> __get__packCellPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::LevelCollectionTableView*,::GlobalNamespace::IPreviewBeatmapLevel*>*> __get_didSelectLevelEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::LevelCollectionTableView*>*> __get_didSelectHeaderEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IPreviewBeatmapLevel*>*> __get__previewBeatmapLevels() const;

constexpr void __set__headerSprite(::UnityEngine::Sprite*  value) ;

constexpr ::UnityEngine::Sprite* __get__headerSprite() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Sprite*> __get__headerSprite() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::StringW>*> __get__favoriteLevelIds() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IPreviewBeatmapLevel*> __get__selectedPreviewBeatmapLevel() const;
...
inline void SetData(::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::IPreviewBeatmapLevel*>*  previewBeatmapLevels, ::System::Collections::Generic::HashSet_1<::StringW>*  favoriteLevelIds, bool  beatmapLevelsAreSorted, bool  sortPreviewBeatmapLevels) ;
...
// Ctor Parameters []
// @brief default ctor
 LevelCollectionTableView()  = default;
public:
