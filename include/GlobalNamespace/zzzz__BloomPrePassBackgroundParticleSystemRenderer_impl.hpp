...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::ParticleSystem*> GlobalNamespace::BloomPrePassBackgroundParticleSystemRenderer::__get__particleSystem() const {
return ::cordl_internals::getInstanceField<::UnityEngine::ParticleSystem*, 0x48>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Renderer*> GlobalNamespace::BloomPrePassBackgroundParticleSystemRenderer::__get__renderer() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Renderer*, 0x50>(this);
}
