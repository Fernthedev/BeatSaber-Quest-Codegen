...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xd0 - sizeof(::GlobalNamespace::NoteController)]{};

/// @brief Field _bigCuttableBySaberList offset 0x80
 __declspec(property(get=__get__bigCuttableBySaberList, put=__set__bigCuttableBySaberList)) ::ArrayW<::GlobalNamespace::BoxCuttableBySaber*,::Array<::GlobalNamespace::BoxCuttableBySaber*>*>  _bigCuttableBySaberList;

/// @brief Field _smallCuttableBySaberList offset 0x88
 __declspec(property(get=__get__smallCuttableBySaberList, put=__set__smallCuttableBySaberList)) ::ArrayW<::GlobalNamespace::BoxCuttableBySaber*,::Array<::GlobalNamespace::BoxCuttableBySaber*>*>  _smallCuttableBySaberList;
...
/// @brief Field _audioTimeSyncController offset 0x98
...
/// @brief Field cubeNoteControllerDidInitEvent offset 0xa0
 __declspec(property(get=__get_cubeNoteControllerDidInitEvent, put=__set_cubeNoteControllerDidInitEvent)) ::System::Action_1<::GlobalNamespace::BurstSliderGameNoteController*>*  cubeNoteControllerDidInitEvent;

/// @brief Field _noteVisualModifierType offset 0xa8
...
/// @brief Field _gameplayType offset 0xac
...
/// @brief Field _bigCuttableBySaber offset 0xb0
...
/// @brief Field _originalColliderSize offset 0xb8
...
/// @brief Field _originalColliderCenter offset 0xc4
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::BurstSliderGameNoteController*>*> __get_cubeNoteControllerDidInitEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoxCuttableBySaber*> __get__bigCuttableBySaber() const;
...
// Ctor Parameters []
// @brief default ctor
 BurstSliderGameNoteController()  = default;
public:
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11050)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11050), inst: 288 }), TypeDefinitionIndex(TypeDefinitionIndex(4738))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::Zenject::MonoMemoryPool_1<::GlobalNamespace::BurstSliderGameNoteController*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __BurstSliderGameNoteController__Pool()  = default;
public:
