...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::CreditsController*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __CreditsController___ScrollCoroutine_d__13()  = default;
public:
...
/// @brief Field _creditsSceneSetupDataSO offset 0x18
...
/// @brief Field _audioPlayer offset 0x20
...
/// @brief Field _contentRectTransform offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::CreditsScenesTransitionSetupDataSO*> __get__creditsSceneSetupDataSO() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::AudioPlayerBase*> __get__audioPlayer() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> __get__contentWrapper() const;
