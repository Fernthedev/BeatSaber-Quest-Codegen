...
/// @brief Field kMaxSimDelta offset 0x0
...
/// @brief Field _particleSystemFullDuration offset 0x20
...
/// @brief Field <startTime>k__BackingField offset 0x24
...
// Ctor Parameters []
// @brief default ctor
 ParticleSystemEventController()  = default;
public:
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(4966)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11050), inst: 2825 }), TypeDefinitionIndex(TypeDefinitionIndex(11050))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::Zenject::MonoMemoryPool_1<::GlobalNamespace::ParticleSystemEventController*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __ParticleSystemEventController__Pool()  = default;
public:
