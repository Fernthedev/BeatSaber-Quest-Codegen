...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TMP_Text*> GlobalNamespace::ResizableTextMeshPro::__get__textMeshPro() const {
return ::cordl_internals::getInstanceField<::TMPro::TMP_Text*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> GlobalNamespace::ResizableTextMeshPro::__get__rectTransform() const {
return ::cordl_internals::getInstanceField<::UnityEngine::RectTransform*, 0x20>(this);
}
