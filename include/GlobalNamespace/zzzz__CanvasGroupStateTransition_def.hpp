...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5442), inst: 922 }), TypeDefinitionIndex(TypeDefinitionIndex(5442)), TypeDefinitionIndex(TypeDefinitionIndex(15666))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::GlobalNamespace::BaseStateTransition_1<::UnityEngine::CanvasGroup*>)]{};
...
/// @brief Field _floatTween offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::CanvasGroupTransitionSO*> __get__transition() const;
...
/// @brief Method get_transition addr 0x227ce1c size 0x8 virtual true final false
inline ::GlobalNamespace::BaseTransitionSO* get_transition() ;

/// @brief Method TransitionToNormalState addr 0x227ce24 size 0x1c virtual true final false
inline void TransitionToNormalState() ;

/// @brief Method TransitionToHighlightedState addr 0x227d01c size 0x1c virtual true final false
inline void TransitionToHighlightedState() ;

/// @brief Method TransitionToPressedState addr 0x227d038 size 0x1c virtual true final false
inline void TransitionToPressedState() ;

/// @brief Method TransitionToDisabledState addr 0x227d054 size 0x1c virtual true final false
inline void TransitionToDisabledState() ;

/// @brief Method TransitionToSelectedState addr 0x227d070 size 0x1c virtual true final false
inline void TransitionToSelectedState() ;

/// @brief Method TransitionToSelectedAndHighlightedState addr 0x227d08c size 0x1c virtual true final false
inline void TransitionToSelectedAndHighlightedState() ;

/// @brief Method SetNormalState addr 0x227d0a8 size 0x28 virtual true final false
inline void SetNormalState() ;

/// @brief Method SetHighlightedState addr 0x227d0d0 size 0x28 virtual true final false
inline void SetHighlightedState() ;

/// @brief Method SetPressedState addr 0x227d0f8 size 0x28 virtual true final false
inline void SetPressedState() ;

/// @brief Method SetDisabledState addr 0x227d120 size 0x28 virtual true final false
inline void SetDisabledState() ;

/// @brief Method SetSelectedState addr 0x227d148 size 0x28 virtual true final false
inline void SetSelectedState() ;

/// @brief Method SetSelectedAndHighlightedState addr 0x227d170 size 0x28 virtual true final false
inline void SetSelectedAndHighlightedState() ;

/// @brief Method StartTween addr 0x227ce40 size 0x1dc virtual false final false
inline void StartTween(float_t  endAlpha) ;

static inline ::GlobalNamespace::CanvasGroupStateTransition* New_ctor() ;

/// @brief Method .ctor addr 0x227d198 size 0x48 virtual false final false
inline void _ctor() ;

/// @brief Method <StartTween>b__16_0 addr 0x227d1e0 size 0x1c virtual false final false
inline void _StartTween_b__16_0(float_t  alpha) ;

/// @brief Method <StartTween>b__16_1 addr 0x227d1fc size 0x88 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 CanvasGroupStateTransition()  = default;
public:
