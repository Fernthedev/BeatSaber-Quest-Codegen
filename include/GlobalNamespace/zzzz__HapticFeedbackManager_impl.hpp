...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BoolSO*> GlobalNamespace::HapticFeedbackManager::__get__controllersRumbleEnabled() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BoolSO*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::Libraries::HM::HMLib::VR::HapticPresetSO*> GlobalNamespace::HapticFeedbackManager::__get__continuousRumblePreset() const {
return ::cordl_internals::getInstanceField<::Libraries::HM::HMLib::VR::HapticPresetSO*, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::RumbleHapticFeedbackPlayer*, 0x28>(this, std::forward<::GlobalNamespace::RumbleHapticFeedbackPlayer*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::RumbleHapticFeedbackPlayer*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::RumbleHapticFeedbackPlayer*> GlobalNamespace::HapticFeedbackManager::__get__rumbleHapticFeedbackPlayer() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::RumbleHapticFeedbackPlayer*, 0x28>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::IHapticFeedbackPlayer*, 0x30>(this, std::forward<::GlobalNamespace::IHapticFeedbackPlayer*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::IHapticFeedbackPlayer*, 0x30>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IHapticFeedbackPlayer*> GlobalNamespace::HapticFeedbackManager::__get__advancedHapticFeedbackPlayer() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IHapticFeedbackPlayer*, 0x30>(this);
}
