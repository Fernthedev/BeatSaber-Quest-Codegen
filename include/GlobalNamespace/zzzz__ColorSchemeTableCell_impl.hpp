...
constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> GlobalNamespace::ColorSchemeTableCell::__get__text() const {
return ::cordl_internals::getInstanceField<::TMPro::TextMeshProUGUI*, 0x58>(this);
}
constexpr void GlobalNamespace::ColorSchemeTableCell::__set__colorSchemeView(::GlobalNamespace::ColorSchemeView*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::ColorSchemeView*, 0x60>(this, std::forward<::GlobalNamespace::ColorSchemeView*>(value));
}
constexpr ::GlobalNamespace::ColorSchemeView* GlobalNamespace::ColorSchemeTableCell::__get__colorSchemeView()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ColorSchemeView*, 0x60>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorSchemeView*> GlobalNamespace::ColorSchemeTableCell::__get__colorSchemeView() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::ColorSchemeView*, 0x60>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Image*> GlobalNamespace::ColorSchemeTableCell::__get__editIcon() const {
return ::cordl_internals::getInstanceField<::UnityEngine::UI::Image*, 0x68>(this);
}
