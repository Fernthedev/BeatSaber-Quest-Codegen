...
struct CORDL_TYPE __OVRPassthroughColorLut__ColorChannels : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____OVRPassthroughColorLut__ColorChannels_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __OVRPassthroughColorLut__ColorChannels(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughColorLut__ColorChannels()  = default;
...
struct CORDL_TYPE __OVRPassthroughColorLut__WriteColorsAsBytesJob : public ::bs_hook::ValueTypeWrapper<0x28> {
public:
// Declarations
/// @brief The size of the true value type
...
/// @brief Field target offset 0x0
 __declspec(property(get=__get_target, put=__set_target)) ::Unity::Collections::NativeArray_1<uint8_t>  target;

/// @brief Field source offset 0x10
 __declspec(property(get=__get_source, put=__set_source)) ::Unity::Collections::NativeArray_1<::UnityEngine::Color>  source;

/// @brief Field channelCount offset 0x20
 __declspec(property(get=__get_channelCount, put=__set_channelCount)) int32_t  channelCount;

/// @brief Convert operator to "::Unity::Jobs::IJobParallelFor"
constexpr operator  ::Unity::Jobs::IJobParallelFor*() ;

constexpr void __set_target(::Unity::Collections::NativeArray_1<uint8_t>  value) ;

constexpr ::Unity::Collections::NativeArray_1<uint8_t>& __get_target() ;

constexpr ::Unity::Collections::NativeArray_1<uint8_t> const& __get_target() const;

constexpr void __set_source(::Unity::Collections::NativeArray_1<::UnityEngine::Color>  value) ;

constexpr ::Unity::Collections::NativeArray_1<::UnityEngine::Color>& __get_source() ;

constexpr ::Unity::Collections::NativeArray_1<::UnityEngine::Color> const& __get_source() const;

constexpr void __set_channelCount(int32_t  value) ;

constexpr int32_t& __get_channelCount() ;

constexpr int32_t const& __get_channelCount() const;

/// @brief Method Execute addr 0x27c759c size 0x130 virtual true final true
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRPassthroughColorLut__WriteColorsAsBytesJob(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x28>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughColorLut__WriteColorsAsBytesJob()  = default;
...
struct CORDL_TYPE __OVRPassthroughColorLut__ColorLutTextureConverter__MapColorValuesJob : public ::bs_hook::ValueTypeWrapper<0x38> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x38};

/// @brief Field settings offset 0x0
 __declspec(property(get=__get_settings, put=__set_settings)) ::GlobalNamespace::__OVRPassthroughColorLut__ColorLutTextureConverter__TextureSettings  settings;

/// @brief Field target offset 0x18
 __declspec(property(get=__get_target, put=__set_target)) ::Unity::Collections::NativeArray_1<uint8_t>  target;

/// @brief Field source offset 0x28
 __declspec(property(get=__get_source, put=__set_source)) ::Unity::Collections::NativeArray_1<uint8_t>  source;

/// @brief Convert operator to "::Unity::Jobs::IJobParallelFor"
constexpr operator  ::Unity::Jobs::IJobParallelFor*() ;

constexpr void __set_settings(::GlobalNamespace::__OVRPassthroughColorLut__ColorLutTextureConverter__TextureSettings  value) ;

constexpr ::GlobalNamespace::__OVRPassthroughColorLut__ColorLutTextureConverter__TextureSettings& __get_settings() ;

constexpr ::GlobalNamespace::__OVRPassthroughColorLut__ColorLutTextureConverter__TextureSettings const& __get_settings() const;
...
constexpr void __set_source(::Unity::Collections::NativeArray_1<uint8_t>  value) ;

constexpr ::Unity::Collections::NativeArray_1<uint8_t>& __get_source() ;

constexpr ::Unity::Collections::NativeArray_1<uint8_t> const& __get_source() const;

/// @brief Method Execute addr 0x27c798c size 0xa0 virtual true final true
inline void Execute(int32_t  index) ;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRPassthroughColorLut__ColorLutTextureConverter__MapColorValuesJob(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x38>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughColorLut__ColorLutTextureConverter__MapColorValuesJob()  = default;
...
struct CORDL_TYPE __OVRPassthroughColorLut__ColorLutTextureConverter__TextureSettings : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x18};

/// @brief Field <Width>k__BackingField offset 0x0
 __declspec(property(get=__get__Width_k__BackingField, put=__set__Width_k__BackingField)) int32_t  _Width_k__BackingField;

/// @brief Field <Height>k__BackingField offset 0x4
 __declspec(property(get=__get__Height_k__BackingField, put=__set__Height_k__BackingField)) int32_t  _Height_k__BackingField;

/// @brief Field <Resolution>k__BackingField offset 0x8
 __declspec(property(get=__get__Resolution_k__BackingField, put=__set__Resolution_k__BackingField)) int32_t  _Resolution_k__BackingField;

/// @brief Field <SlicesPerRow>k__BackingField offset 0xc
 __declspec(property(get=__get__SlicesPerRow_k__BackingField, put=__set__SlicesPerRow_k__BackingField)) int32_t  _SlicesPerRow_k__BackingField;

/// @brief Field <ChannelCount>k__BackingField offset 0x10
 __declspec(property(get=__get__ChannelCount_k__BackingField, put=__set__ChannelCount_k__BackingField)) int32_t  _ChannelCount_k__BackingField;

/// @brief Field <FlipY>k__BackingField offset 0x14
 __declspec(property(get=__get__FlipY_k__BackingField, put=__set__FlipY_k__BackingField)) bool  _FlipY_k__BackingField;
...
constexpr void __set__Resolution_k__BackingField(int32_t  value) ;

constexpr int32_t& __get__Resolution_k__BackingField() ;

constexpr int32_t const& __get__Resolution_k__BackingField() const;

constexpr void __set__SlicesPerRow_k__BackingField(int32_t  value) ;

constexpr int32_t& __get__SlicesPerRow_k__BackingField() ;

constexpr int32_t const& __get__SlicesPerRow_k__BackingField() const;

constexpr void __set__ChannelCount_k__BackingField(int32_t  value) ;

constexpr int32_t& __get__ChannelCount_k__BackingField() ;

constexpr int32_t const& __get__ChannelCount_k__BackingField() const;

constexpr void __set__FlipY_k__BackingField(bool  value) ;

constexpr bool& __get__FlipY_k__BackingField() ;

constexpr bool const& __get__FlipY_k__BackingField() const;

/// @brief Method get_Width addr 0x27c7a2c size 0x8 virtual false final false
inline int32_t get_Width() ;

/// @brief Method get_Height addr 0x27c7a34 size 0x8 virtual false final false
inline int32_t get_Height() ;

/// @brief Method get_Resolution addr 0x27c7a3c size 0x8 virtual false final false
inline int32_t get_Resolution() ;

/// @brief Method get_SlicesPerRow addr 0x27c7a44 size 0x8 virtual false final false
inline int32_t get_SlicesPerRow() ;

/// @brief Method get_ChannelCount addr 0x27c7a4c size 0x8 virtual false final false
inline int32_t get_ChannelCount() ;

/// @brief Method get_FlipY addr 0x27c7a54 size 0x8 virtual false final false
inline bool get_FlipY() ;

/// @brief Method .ctor addr 0x27c7974 size 0x18 virtual false final false
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRPassthroughColorLut__ColorLutTextureConverter__TextureSettings(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughColorLut__ColorLutTextureConverter__TextureSettings()  = default;
...
/// @brief Method TextureToColorByteMap addr 0x27c6cd8 size 0xb4 virtual false final false
...
/// @brief Method MapColorValues addr 0x27c77d0 size 0x1a4 virtual false final false
...
/// @brief Method GetTextureSettings addr 0x27c76cc size 0x104 virtual false final false
...
/// @brief Method TryGetTextureLayout addr 0x27c7090 size 0x23c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __OVRPassthroughColorLut__ColorLutTextureConverter()  = default;
public:
...
/// @brief Field RecomendedBatchSize offset 0x0
static constexpr int32_t  RecomendedBatchSize{static_cast<int32_t>(0x80)};

/// @brief Field <Resolution>k__BackingField offset 0x10
...
/// @brief Field <Channels>k__BackingField offset 0x14
...
/// @brief Field <IsInitialized>k__BackingField offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__locker() const;

/// @brief Method get_Resolution addr 0x27c5b6c size 0x8 virtual false final false
inline uint32_t get_Resolution() ;

/// @brief Method set_Resolution addr 0x27c5b74 size 0x8 virtual false final false
inline void set_Resolution(uint32_t  value) ;

/// @brief Method get_Channels addr 0x27c5b7c size 0x8 virtual false final false
inline ::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels get_Channels() ;

/// @brief Method set_Channels addr 0x27c5b84 size 0x8 virtual false final false
inline void set_Channels(::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels  value) ;

/// @brief Method get_IsInitialized addr 0x27c5b8c size 0x8 virtual false final false
inline bool get_IsInitialized() ;

/// @brief Method set_IsInitialized addr 0x27c5b94 size 0xc virtual false final false
inline void set_IsInitialized(bool  value) ;

static inline ::GlobalNamespace::OVRPassthroughColorLut* New_ctor(::UnityEngine::Texture2D*  initialLutTexture, bool  flipY) ;

/// @brief Method .ctor addr 0x27c5ba0 size 0x94 virtual false final false
...
/// @brief Method .ctor addr 0x27c6160 size 0x9c virtual false final false
...
/// @brief Method .ctor addr 0x27c6248 size 0x9c virtual false final false
...
/// @brief Method .ctor addr 0x27c6330 size 0x5c virtual false final false
...
/// @brief Method UpdateFrom addr 0x27c64fc size 0xc0 virtual false final false
inline void UpdateFrom(::ArrayW<::UnityEngine::Color,::Array<::UnityEngine::Color>*>  colors) ;

/// @brief Method UpdateFrom addr 0x27c67fc size 0xc0 virtual false final false
inline void UpdateFrom(::ArrayW<::UnityEngine::Color32,::Array<::UnityEngine::Color32>*>  colors) ;

/// @brief Method UpdateFrom addr 0x27c6a38 size 0xcc virtual false final false
inline void UpdateFrom(::ArrayW<uint8_t,::Array<uint8_t>*>  colors) ;

/// @brief Method UpdateFrom addr 0x27c6b04 size 0xb8 virtual false final false
inline void UpdateFrom(::UnityEngine::Texture2D*  lutTexture, bool  flipY) ;

/// @brief Method Dispose addr 0x27c6d8c size 0x44 virtual true final true
inline void Dispose() ;

/// @brief Method IsTextureSupported addr 0x27c6ee4 size 0x1ac virtual false final false
...
/// @brief Method .ctor addr 0x27c5db4 size 0x264 virtual false final false
inline void _ctor(int32_t  size, ::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels  channels) ;

/// @brief Method IsValidUpdateResolution addr 0x27c6bbc size 0x11c virtual false final false
inline bool IsValidUpdateResolution(int32_t  lutSize, int32_t  elementByteSize) ;

/// @brief Method IsValidLutUpdate addr 0x0 size 0xffffffffffffffff virtual false final false
template<typename T>
inline bool IsValidLutUpdate(::ArrayW<T,::Array<T>*>  colorArray, int32_t  elementByteSize) ;

/// @brief Method GetChannelsForTextureFormat addr 0x27c5d14 size 0xa0 virtual false final false
...
/// @brief Method GetTextureSizeFromByteArray addr 0x27c638c size 0x118 virtual false final false
...
/// @brief Method GetTextureSize addr 0x27c5c34 size 0xe0 virtual false final false
static inline int32_t GetTextureSize(::UnityEngine::Texture2D*  texture) ;

/// @brief Method GetArraySize addr 0x0 size 0xffffffffffffffff virtual false final false
template<typename T>
static inline int32_t GetArraySize(::ArrayW<T,::Array<T>*>  array) ;

/// @brief Method ChannelsToCount addr 0x27c7444 size 0x10 virtual false final false
static inline int32_t ChannelsToCount(::GlobalNamespace::__OVRPassthroughColorLut__ColorChannels  channels) ;

/// @brief Method IsResolutionAccepted addr 0x27c7380 size 0xc4 virtual false final false
static inline bool IsResolutionAccepted(uint32_t  resolution, int32_t  size, ByRef<::StringW>  errorMessage) ;

/// @brief Method IsPowerOfTwo addr 0x27c7454 size 0x20 virtual false final false
static inline bool IsPowerOfTwo(uint32_t  x) ;

/// @brief Method Create addr 0x27c6070 size 0xf0 virtual false final false
inline void Create(::GlobalNamespace::__OVRPlugin__PassthroughColorLutData  lutData) ;

/// @brief Method GetResolutionFromSize addr 0x27c72cc size 0xb4 virtual false final false
static inline uint32_t GetResolutionFromSize(int32_t  size) ;

/// @brief Method CreateLutData addr 0x27c7474 size 0x94 virtual false final false
inline ::GlobalNamespace::__OVRPlugin__PassthroughColorLutData CreateLutData(ByRef<::ArrayW<uint8_t,::Array<uint8_t>*>>  colorBytes) ;

/// @brief Method CreateLutDataFromTexture addr 0x27c6018 size 0x58 virtual false final false
...
/// @brief Method CreateLutDataFromArray addr 0x27c61fc size 0x4c virtual false final false
...
/// @brief Method CreateLutDataFromArray addr 0x27c62e4 size 0x4c virtual false final false
...
/// @brief Method CreateLutDataFromArray addr 0x27c64a4 size 0x58 virtual false final false
inline ::GlobalNamespace::__OVRPlugin__PassthroughColorLutData CreateLutDataFromArray(::ArrayW<uint8_t,::Array<uint8_t>*>  colors) ;

/// @brief Method WriteColorsAsBytes addr 0x27c65bc size 0x240 virtual false final false
...
/// @brief Method WriteColorsAsBytes addr 0x27c68bc size 0x17c virtual false final false
...
/// @brief Method Finalize addr 0x27c7508 size 0x94 virtual true final false
inline void Finalize() ;

/// @brief Method Destroy addr 0x27c6dd0 size 0x114 virtual false final false
inline void Destroy() ;
...
// Ctor Parameters []
// @brief default ctor
 OVRPassthroughColorLut()  = default;
public:
