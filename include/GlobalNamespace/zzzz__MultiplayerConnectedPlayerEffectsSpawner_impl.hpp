...
::cordl_internals::setInstanceField<::GlobalNamespace::NoteDebrisSpawner*, 0x18>(this, std::forward<::GlobalNamespace::NoteDebrisSpawner*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::NoteDebrisSpawner*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::NoteDebrisSpawner*> GlobalNamespace::MultiplayerConnectedPlayerEffectsSpawner::__get__noteDebrisSpawner() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::NoteDebrisSpawner*, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::BombExplosionEffect*, 0x20>(this, std::forward<::GlobalNamespace::BombExplosionEffect*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::BombExplosionEffect*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BombExplosionEffect*> GlobalNamespace::MultiplayerConnectedPlayerEffectsSpawner::__get__bombExplosionEffect() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BombExplosionEffect*, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::IConnectedPlayerBeatmapObjectEventManager*, 0x28>(this, std::forward<::GlobalNamespace::IConnectedPlayerBeatmapObjectEventManager*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::IConnectedPlayerBeatmapObjectEventManager*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IConnectedPlayerBeatmapObjectEventManager*> GlobalNamespace::MultiplayerConnectedPlayerEffectsSpawner::__get__beatmapObjectEventManager() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IConnectedPlayerBeatmapObjectEventManager*, 0x28>(this);
}
