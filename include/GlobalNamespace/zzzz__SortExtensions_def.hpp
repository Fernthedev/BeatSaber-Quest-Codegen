...
class __SortExtensions____c__DisplayClass1_0_1<T>;
}
// Write type traits
...
template<::il2cpp_utils::il2cpp_reference_type T>
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(12961)), TypeDefinitionIndex(TypeDefinitionIndex(2613))}
// Self: GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(12961), inst: 2 })
// CS Name: ::SortExtensions::<>c__DisplayClass1_0`1<T>*
class CORDL_TYPE __SortExtensions____c__DisplayClass1_0_1<T> : public ::System::Object {
public:
// Declarations
/// @brief The size of the true reference type
...
/// @brief Field getSortIndex offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<T,int32_t>*> __get_getSortIndex() const;
...
// Ctor Parameters []
// @brief default ctor
 __SortExtensions____c__DisplayClass1_0_1()  = default;
public:
