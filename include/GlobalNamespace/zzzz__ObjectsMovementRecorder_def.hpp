...
struct CORDL_TYPE __ObjectsMovementRecorder__Mode : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____ObjectsMovementRecorder__Mode_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __ObjectsMovementRecorder__Mode(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ObjectsMovementRecorder__Mode()  = default;
...
struct CORDL_TYPE __ObjectsMovementRecorder__CameraView : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____ObjectsMovementRecorder__CameraView_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __ObjectsMovementRecorder__CameraView(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __ObjectsMovementRecorder__CameraView()  = default;
...
/// @brief Field addDateTimeSuffixToRecordingName offset 0x24
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IPosesSerializer*> __get_posesSerializer() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IBeatSaberLogger*> __get_logger() const;
...
// Ctor Parameters []
// @brief default ctor
 __ObjectsMovementRecorder__InitData()  = default;
public:
...
/// @brief Field _poseObjects offset 0x18
...
/// @brief Field _livPoseObjectId offset 0x20
...
/// @brief Field _audioTimeSyncController offset 0x50
...
/// @brief Field _externalCamera offset 0x80
 __declspec(property(get=__get__externalCamera, put=__set__externalCamera)) ::UnityEngine::Camera*  _externalCamera;

/// @brief Field _playbackScreenshots offset 0x88
 __declspec(property(get=__get__playbackScreenshots, put=__set__playbackScreenshots)) ::ArrayW<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*,::Array<::GlobalNamespace::__PlaybackRenderer__PlaybackScreenshot*>*>  _playbackScreenshots;

/// @brief Field _logger offset 0x90
 __declspec(property(get=__get__logger, put=__set__logger)) ::GlobalNamespace::IBeatSaberLogger*  _logger;

/// @brief Field _posesSerializer offset 0x98
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PoseObjectIdSO*> __get__livPoseObjectId() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PosesRecorder*> __get__recorder() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PosesPlayback*> __get__playback() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlaybackScreenshotRecorder*> __get__playbackScreenshotRecorder() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::PlaybackRenderer*> __get__playbackRender() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Camera*> __get__externalCameraPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__ObjectsMovementRecorder__InitData*> __get__initData() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Camera*> __get__externalCamera() const;
...
// Ctor Parameters []
// @brief default ctor
 ObjectsMovementRecorder()  = default;
public:
