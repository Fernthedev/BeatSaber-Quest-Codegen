...
/// @brief Field localizedName offset 0x18
...
/// @brief Field songPackMask offset 0x28
...
/// @brief Method .ctor addr 0x22a6190 size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __QuickPlaySongPacksDropdown__SongPackMaskItem()  = default;
public:
...
/// @brief Method .ctor addr 0x22a60ac size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <SelectCellWithSerializedName>b__0 addr 0x22a6254 size 0x24 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __QuickPlaySongPacksDropdown____c__DisplayClass13_0()  = default;
public:
...
/// @brief Method .ctor addr 0x22a62dc size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <LazyInit>b__15_2 addr 0x22a62e4 size 0x1a0 virtual false final false
...
/// @brief Method <LazyInit>b__15_4 addr 0x22a6484 size 0x3c virtual false final false
...
/// @brief Method <LazyInit>b__15_3 addr 0x22a64c0 size 0x18 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __QuickPlaySongPacksDropdown____c()  = default;
public:
...
// Static field <>9__15_4

// Static field <>9__15_2

// Static field <>9__15_3
...
/// @brief Field _quickPlaySongPacksOverride offset 0x38
 __declspec(property(get=__get__quickPlaySongPacksOverride, put=__set__quickPlaySongPacksOverride)) ::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride*  _quickPlaySongPacksOverride;

/// @brief Field _data offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__QuickPlaySetupData__QuickPlaySongPacksOverride*> __get__quickPlaySongPacksOverride() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__QuickPlaySongPacksDropdown__SongPackMaskItem*>*> __get__data() const;

/// @brief Method add_didSelectCellWithIdxEvent addr 0x22a5848 size 0xb0 virtual false final false
inline void add_didSelectCellWithIdxEvent(::System::Action_1<int32_t>*  value) ;

/// @brief Method remove_didSelectCellWithIdxEvent addr 0x22a58f8 size 0xb0 virtual false final false
inline void remove_didSelectCellWithIdxEvent(::System::Action_1<int32_t>*  value) ;

/// @brief Method Start addr 0x22a59a8 size 0x8c virtual false final false
inline void Start() ;

/// @brief Method OnDestroy addr 0x22a5a34 size 0xd4 virtual false final false
inline void OnDestroy() ;

/// @brief Method SetOverrideSongPacks addr 0x22a5b08 size 0x8 virtual false final false
...
/// @brief Method GetSelectedSerializedName addr 0x22a5b10 size 0x70 virtual false final false
inline ::StringW GetSelectedSerializedName() ;

/// @brief Method SelectCellWithSerializedName addr 0x22a5f5c size 0x150 virtual false final false
inline void SelectCellWithSerializedName(::StringW  serializedName) ;

/// @brief Method HandleSimpleTextDropdownDidSelectCellWithIdx addr 0x22a60b4 size 0x24 virtual false final false
inline void HandleSimpleTextDropdownDidSelectCellWithIdx(::HMUI::DropdownWithTableView*  dropdownWithTableView, int32_t  idx) ;

/// @brief Method LazyInit addr 0x22a5b80 size 0x3dc virtual false final false
inline void LazyInit() ;

static inline ::GlobalNamespace::QuickPlaySongPacksDropdown* New_ctor() ;

/// @brief Method .ctor addr 0x22a60d8 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <LazyInit>b__15_0 addr 0x22a60e0 size 0xb0 virtual false final false
inline ::GlobalNamespace::__QuickPlaySongPacksDropdown__SongPackMaskItem* _LazyInit_b__15_0(::StringW  serializedName) ;

/// @brief Method <LazyInit>b__15_1 addr 0x22a6198 size 0xbc virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 QuickPlaySongPacksDropdown()  = default;
public:
