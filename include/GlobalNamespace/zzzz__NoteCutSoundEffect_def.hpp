...
/// @brief Field kEndOverlap offset 0x0
static constexpr float_t  kEndOverlap{100.01};

/// @brief Field kEndFadeLength offset 0x0
...
/// @brief Field _speedToVolumeCurve offset 0x20
...
/// @brief Field _handleWrongSaberTypeAsGood offset 0x90
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get__speedToVolumeCurve() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::RandomObjectPicker_1<::UnityEngine::AudioClip*>*> __get__badCutRandomSoundPicker() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LazyCopyHashSet_1<::GlobalNamespace::INoteCutSoundEffectDidFinishEvent*>*> __get__didFinishEvent() const;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11050)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11050), inst: 2823 }), TypeDefinitionIndex(TypeDefinitionIndex(4070))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::Zenject::MonoMemoryPool_1<::GlobalNamespace::NoteCutSoundEffect*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __NoteCutSoundEffect__Pool()  = default;
public:
