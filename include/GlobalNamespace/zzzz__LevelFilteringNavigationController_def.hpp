...
/// @brief Field levelPack offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IBeatmapLevelPack*> __get_levelPack() const;
...
// Ctor Parameters []
// @brief default ctor
 __LevelFilteringNavigationController____c__DisplayClass53_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __LevelFilteringNavigationController____c()  = default;
public:
...
struct CORDL_TYPE __LevelFilteringNavigationController___UpdateCustomSongs_d__54 : public ::bs_hook::ValueTypeWrapper<0x40> {
public:
// Declarations
...
/// @brief Field <>4__this offset 0x28
 __declspec(property(get=__get___4__this, put=__set___4__this)) ::GlobalNamespace::LevelFilteringNavigationController*  __4__this;

/// @brief Field <cancellationToken>5__2 offset 0x30
...
constexpr ::GlobalNamespace::LevelFilteringNavigationController* __get___4__this() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LevelFilteringNavigationController*> __get___4__this() const;
...
constexpr explicit __LevelFilteringNavigationController___UpdateCustomSongs_d__54(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x40>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __LevelFilteringNavigationController___UpdateCustomSongs_d__54()  = default;
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x168 - sizeof(::HMUI::NavigationController)]{};

/// @brief Field _emptyFavoritesListInfoPrefab offset 0x98
...
/// @brief Field _emptyCustomSongListInfoPrefab offset 0xa0
...
/// @brief Field _selectLevelCategoryViewController offset 0xb0
 __declspec(property(get=__get__selectLevelCategoryViewController, put=__set__selectLevelCategoryViewController)) ::GlobalNamespace::SelectLevelCategoryViewController*  _selectLevelCategoryViewController;

/// @brief Field _annotatedBeatmapLevelCollectionsViewController offset 0xb8
 __declspec(property(get=__get__annotatedBeatmapLevelCollectionsViewController, put=__set__annotatedBeatmapLevelCollectionsViewController)) ::GlobalNamespace::AnnotatedBeatmapLevelCollectionsViewController*  _annotatedBeatmapLevelCollectionsViewController;

/// @brief Field _levelSearchViewController offset 0xc0
...
/// @brief Field _beatmapLevelsModel offset 0xc8
...
/// @brief Field didSelectAnnotatedBeatmapLevelCollectionEvent offset 0xd0
 __declspec(property(get=__get_didSelectAnnotatedBeatmapLevelCollectionEvent, put=__set_didSelectAnnotatedBeatmapLevelCollectionEvent)) ::System::Action_5<::GlobalNamespace::LevelFilteringNavigationController*,::GlobalNamespace::IAnnotatedBeatmapLevelCollection*,::UnityEngine::GameObject*,bool,::GlobalNamespace::BeatmapCharacteristicSO*>*  didSelectAnnotatedBeatmapLevelCollectionEvent;

/// @brief Field didStartLoadingEvent offset 0xd8
...
/// @brief Field didPressAllSongsEvent offset 0xe0
...
/// @brief Field didOpenBeatmapLevelCollectionsEvent offset 0xe8
...
/// @brief Field didCloseBeatmapLevelCollectionsEvent offset 0xf0
...
/// @brief Field _cancellationTokenSource offset 0xf8
...
/// @brief Field _currentNoDataInfoPrefab offset 0x100
...
/// @brief Field _levelPackIdToBeSelectedAfterPresent offset 0x108
...
/// @brief Field _hidePacksIfOneOrNone offset 0x110
 __declspec(property(get=__get__hidePacksIfOneOrNone, put=__set__hidePacksIfOneOrNone)) bool  _hidePacksIfOneOrNone;

/// @brief Field _enableCustomLevels offset 0x111
 __declspec(property(get=__get__enableCustomLevels, put=__set__enableCustomLevels)) bool  _enableCustomLevels;

/// @brief Field _songPackMask offset 0x118
 __declspec(property(get=__get__songPackMask, put=__set__songPackMask)) ::GlobalNamespace::SongPackMask  _songPackMask;

/// @brief Field _enabledLevelCategories offset 0x138
 __declspec(property(get=__get__enabledLevelCategories, put=__set__enabledLevelCategories)) ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*>  _enabledLevelCategories;

/// @brief Field _ostBeatmapLevelPacks offset 0x140
 __declspec(property(get=__get__ostBeatmapLevelPacks, put=__set__ostBeatmapLevelPacks)) ::ArrayW<::GlobalNamespace::IBeatmapLevelPack*,::Array<::GlobalNamespace::IBeatmapLevelPack*>*>  _ostBeatmapLevelPacks;

/// @brief Field _musicPacksBeatmapLevelPacks offset 0x148
 __declspec(property(get=__get__musicPacksBeatmapLevelPacks, put=__set__musicPacksBeatmapLevelPacks)) ::ArrayW<::GlobalNamespace::IBeatmapLevelPack*,::Array<::GlobalNamespace::IBeatmapLevelPack*>*>  _musicPacksBeatmapLevelPacks;

/// @brief Field _customLevelPacks offset 0x150
...
/// @brief Field _allOfficialBeatmapLevelPacks offset 0x158
 __declspec(property(get=__get__allOfficialBeatmapLevelPacks, put=__set__allOfficialBeatmapLevelPacks)) ::ArrayW<::GlobalNamespace::IBeatmapLevelPack*,::Array<::GlobalNamespace::IBeatmapLevelPack*>*>  _allOfficialBeatmapLevelPacks;

/// @brief Field _allBeatmapLevelPacks offset 0x160
 __declspec(property(get=__get__allBeatmapLevelPacks, put=__set__allBeatmapLevelPacks)) ::ArrayW<::GlobalNamespace::IBeatmapLevelPack*,::Array<::GlobalNamespace::IBeatmapLevelPack*>*>  _allBeatmapLevelPacks;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__emptyFavoritesListInfoPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__emptyCustomSongListInfoPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SelectLevelCategoryViewController*> __get__selectLevelCategoryViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::AnnotatedBeatmapLevelCollectionsViewController*> __get__annotatedBeatmapLevelCollectionsViewController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::LevelSearchViewController*> __get__levelSearchViewController() const;
...
constexpr ::System::Action_5<::GlobalNamespace::LevelFilteringNavigationController*,::GlobalNamespace::IAnnotatedBeatmapLevelCollection*,::UnityEngine::GameObject*,bool,::GlobalNamespace::BeatmapCharacteristicSO*>* __get_didSelectAnnotatedBeatmapLevelCollectionEvent() ;

constexpr ::cordl_internals::to_const_pointer<::System::Action_5<::GlobalNamespace::LevelFilteringNavigationController*,::GlobalNamespace::IAnnotatedBeatmapLevelCollection*,::UnityEngine::GameObject*,bool,::GlobalNamespace::BeatmapCharacteristicSO*>*> __get_didSelectAnnotatedBeatmapLevelCollectionEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::LevelFilteringNavigationController*>*> __get_didStartLoadingEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::LevelFilteringNavigationController*>*> __get_didPressAllSongsEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__currentNoDataInfoPrefab() const;
...
constexpr void __set__enabledLevelCategories(::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*>& __get__enabledLevelCategories() ;

constexpr ::ArrayW<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory,::Array<::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory>*> const& __get__enabledLevelCategories() const;
...
inline void add_didSelectAnnotatedBeatmapLevelCollectionEvent(::System::Action_5<::GlobalNamespace::LevelFilteringNavigationController*,::GlobalNamespace::IAnnotatedBeatmapLevelCollection*,::UnityEngine::GameObject*,bool,::GlobalNamespace::BeatmapCharacteristicSO*>*  value) ;

/// @brief Method remove_didSelectAnnotatedBeatmapLevelCollectionEvent addr 0x22bcc1c size 0xb0 virtual false final false
inline void remove_didSelectAnnotatedBeatmapLevelCollectionEvent(::System::Action_5<::GlobalNamespace::LevelFilteringNavigationController*,::GlobalNamespace::IAnnotatedBeatmapLevelCollection*,::UnityEngine::GameObject*,bool,::GlobalNamespace::BeatmapCharacteristicSO*>*  value) ;
...
inline void Setup(::GlobalNamespace::SongPackMask  songPackMask, ::GlobalNamespace::IBeatmapLevelPack*  levelPackToBeSelectedAfterPresent, ::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory  startLevelCategory, bool  hidePacksIfOneOrNone, bool  enableCustomLevels) ;
...
inline void LevelSearchViewControllerDidFilterBeatmapLevelCollection(::GlobalNamespace::IAnnotatedBeatmapLevelCollection*  annotatedBeatmapLevelCollection, ::GlobalNamespace::BeatmapCharacteristicSO*  preferredBeatmapCharacteristic, bool  alphabeticallySort) ;

/// @brief Method SelectLevelCategoryViewControllerDidSelectLevelCategory addr 0x22be8bc size 0x8 virtual false final false
inline void SelectLevelCategoryViewControllerDidSelectLevelCategory(::GlobalNamespace::SelectLevelCategoryViewController*  viewController, ::GlobalNamespace::__SelectLevelCategoryViewController__LevelCategory  levelCategory) ;
...
// Ctor Parameters []
// @brief default ctor
 LevelFilteringNavigationController()  = default;
public:
