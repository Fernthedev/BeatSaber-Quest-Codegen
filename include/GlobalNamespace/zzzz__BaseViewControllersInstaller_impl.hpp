...
::cordl_internals::setInstanceField<::GlobalNamespace::SimpleDialogPromptViewController*, 0x20>(this, std::forward<::GlobalNamespace::SimpleDialogPromptViewController*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::SimpleDialogPromptViewController*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SimpleDialogPromptViewController*> GlobalNamespace::BaseViewControllersInstaller::__get__simpleDialogPromptViewControllerPrefab() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SimpleDialogPromptViewController*, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::SafeAreaFocusedSimpleDialogPromptViewController*, 0x28>(this, std::forward<::GlobalNamespace::SafeAreaFocusedSimpleDialogPromptViewController*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::SafeAreaFocusedSimpleDialogPromptViewController*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SafeAreaFocusedSimpleDialogPromptViewController*> GlobalNamespace::BaseViewControllersInstaller::__get__safeAreaFocusedSimpleDialogPromptViewControllerPrefab() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::SafeAreaFocusedSimpleDialogPromptViewController*, 0x28>(this);
}
