...
struct CORDL_TYPE __MultiplayerController__State : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____MultiplayerController__State_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __MultiplayerController__State(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __MultiplayerController__State()  = default;
...
/// @brief Field localPlayerSyncState offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerController*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerController___PerformSongStartSync_d__39()  = default;
public:
...
/// @brief Field introAnimationStartSyncTime offset 0x18
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerController____c__DisplayClass45_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerController____c()  = default;
public:
...
/// @brief Field _multiplayerLevelSceneSetupData offset 0x20
 __declspec(property(get=__get__multiplayerLevelSceneSetupData, put=__set__multiplayerLevelSceneSetupData)) ::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO*  _multiplayerLevelSceneSetupData;

/// @brief Field _gameScenesManager offset 0x28
...
/// @brief Field _playersManager offset 0x30
...
/// @brief Field _sceneStartSyncController offset 0x38
...
/// @brief Field _songStartSyncController offset 0x40
...
/// @brief Field _multiplayerLevelFinishedController offset 0x48
 __declspec(property(get=__get__multiplayerLevelFinishedController, put=__set__multiplayerLevelFinishedController)) ::GlobalNamespace::MultiplayerLevelFinishedController*  _multiplayerLevelFinishedController;

/// @brief Field _fadeInOutController offset 0x50
...
/// @brief Field _multiplayerSessionManager offset 0x58
 __declspec(property(get=__get__multiplayerSessionManager, put=__set__multiplayerSessionManager)) ::GlobalNamespace::IMultiplayerSessionManager*  _multiplayerSessionManager;

/// @brief Field _introAnimationController offset 0x60
...
/// @brief Field _outroAnimationController offset 0x68
...
/// @brief Field stateChangedEvent offset 0x98
...
/// @brief Field _startTime offset 0xa0
 __declspec(property(get=__get__startTime, put=__set__startTime)) float_t  _startTime;

/// @brief Field _localPlayerSyncStartState offset 0xa4
...
/// @brief Field _timeoutGetGameStateCoroutine offset 0xc8
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__loadingEnvironment() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLevelScenesTransitionSetupDataSO*> __get__multiplayerLevelSceneSetupData() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SceneStartSyncController*> __get__sceneStartSyncController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SongStartSyncController*> __get__songStartSyncController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerLevelFinishedController*> __get__multiplayerLevelFinishedController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerIntroAnimationController*> __get__introAnimationController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerOutroAnimationController*> __get__outroAnimationController() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerBadgesProvider*> __get__badgesProvider() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::__MultiplayerController__State>*> __get_stateChangedEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MultiplayerResultsData*> __get__resultsData() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Coroutine*> __get__timeoutGetGameStateCoroutine() const;
