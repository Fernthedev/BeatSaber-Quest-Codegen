...
/// @brief Field _beatmapDataCallbackWrapper offset 0x28
...
/// @brief Method Start addr 0x23b527c size 0x138 virtual false final false
inline void Start() ;

/// @brief Method OnDestroy addr 0x23b53b4 size 0x1c virtual false final false
inline void OnDestroy() ;

/// @brief Method HandleSpawnRotationBeatmapEvent addr 0x23b53d0 size 0x9c virtual false final false
inline void HandleSpawnRotationBeatmapEvent(::GlobalNamespace::SpawnRotationBeatmapEventData*  beatmapEventData) ;

/// @brief Method FixedUpdate addr 0x23b546c size 0x90 virtual false final false
inline void FixedUpdate() ;

/// @brief Method LateUpdate addr 0x23b54fc size 0xc0 virtual false final false
inline void LateUpdate() ;

static inline ::GlobalNamespace::RotateBySpawnRotation* New_ctor() ;

/// @brief Method .ctor addr 0x23b55bc size 0x8 virtual false final false
inline void _ctor() ;
