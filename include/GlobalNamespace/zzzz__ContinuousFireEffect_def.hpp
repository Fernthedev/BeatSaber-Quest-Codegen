...
/// @brief Field _bloomSustainCurve offset 0x98
...
/// @brief Field _audioTimeSource offset 0xa0
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get__flipbookSustainCurve() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AnimationCurve*> __get__bloomSustainCurve() const;
