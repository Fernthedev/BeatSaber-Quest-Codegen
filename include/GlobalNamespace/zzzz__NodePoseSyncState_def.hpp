...
struct CORDL_TYPE __NodePoseSyncState__NodePose : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____NodePoseSyncState__NodePose_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __NodePoseSyncState__NodePose(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __NodePoseSyncState__NodePose()  = default;
...
struct CORDL_TYPE NodePoseSyncState : public ::bs_hook::ValueTypeWrapper<0x48> {
public:
// Declarations
...
/// @brief Field _head offset 0x0
 __declspec(property(get=__get__head, put=__set__head)) ::GlobalNamespace::PoseSerializable  _head;

/// @brief Field _leftController offset 0x18
 __declspec(property(get=__get__leftController, put=__set__leftController)) ::GlobalNamespace::PoseSerializable  _leftController;

/// @brief Field _rightController offset 0x30
 __declspec(property(get=__get__rightController, put=__set__rightController)) ::GlobalNamespace::PoseSerializable  _rightController;
...
constexpr ::GlobalNamespace::PoseSerializable& __get__head() ;

constexpr ::GlobalNamespace::PoseSerializable const& __get__head() const;

constexpr void __set__leftController(::GlobalNamespace::PoseSerializable  value) ;

constexpr ::GlobalNamespace::PoseSerializable& __get__leftController() ;

constexpr ::GlobalNamespace::PoseSerializable const& __get__leftController() const;

constexpr void __set__rightController(::GlobalNamespace::PoseSerializable  value) ;

constexpr ::GlobalNamespace::PoseSerializable& __get__rightController() ;

constexpr ::GlobalNamespace::PoseSerializable const& __get__rightController() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit NodePoseSyncState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x48>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 NodePoseSyncState()  = default;
