...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::GlobalNamespace::ScoringElement)]{};

/// @brief Field _multiplierEventType offset 0x24
...
/// @brief Field _wouldBeCorrectCutBestPossibleMultiplierEventType offset 0x28
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(5322)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5322), inst: 2807 }), TypeDefinitionIndex(TypeDefinitionIndex(5327))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::GlobalNamespace::__ScoringElement__Pool_1<::GlobalNamespace::BadCutScoringElement*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __BadCutScoringElement__Pool()  = default;
public:
