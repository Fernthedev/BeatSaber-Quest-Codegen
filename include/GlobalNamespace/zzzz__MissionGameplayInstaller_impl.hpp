...
::cordl_internals::setInstanceField<::GlobalNamespace::MissionGameplaySceneSetupData*, 0x20>(this, std::forward<::GlobalNamespace::MissionGameplaySceneSetupData*>(value));
}
constexpr ::GlobalNamespace::MissionGameplaySceneSetupData* GlobalNamespace::MissionGameplayInstaller::__get__sceneSetupData()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MissionGameplaySceneSetupData*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionGameplaySceneSetupData*> GlobalNamespace::MissionGameplayInstaller::__get__sceneSetupData() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MissionGameplaySceneSetupData*, 0x20>(this);
}
