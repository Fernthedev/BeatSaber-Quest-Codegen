...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::FloatFxGroupEffectTarget::*)(float_t)>(&::GlobalNamespace::FloatFxGroupEffectTarget::SetValue)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::FloatFxGroupEffectTarget::*)(float_t)>(&::GlobalNamespace::FloatFxGroupEffectTarget::TriggerValue)> {
  constexpr static std::size_t size = 0xffffffffffffffff;
  constexpr static std::size_t addrs = 0x0;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::FloatFxGroupEffectTarget::*)()>(&::GlobalNamespace::FloatFxGroupEffectTarget::_ctor)> {
