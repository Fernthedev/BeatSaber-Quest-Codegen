...
constexpr ::cordl_internals::to_const_pointer<::System::Func_2<::GlobalNamespace::PreviewDifficultyBeatmapSet*,bool>*> __get___9__0() const;

static inline ::GlobalNamespace::__RunSongPackConsoleCommand____c__DisplayClass12_0* New_ctor() ;

/// @brief Method .ctor addr 0x2311b0c size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <Execute>b__0 addr 0x2311df8 size 0x2c virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __RunSongPackConsoleCommand____c__DisplayClass12_0()  = default;
public:
...
/// @brief Method .ctor addr 0x2311e88 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <Execute>b__12_1 addr 0x2311e90 size 0x20 virtual false final false
inline ::StringW _Execute_b__12_1(::GlobalNamespace::PreviewDifficultyBeatmapSet*  x) ;

/// @brief Method <Execute>b__12_2 addr 0x2311eb0 size 0x64 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 __RunSongPackConsoleCommand____c()  = default;
public:
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x48 - sizeof(::GlobalNamespace::ConsoleCommandBase)]{};
...
/// @brief Field _runUnityProfiler offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::RequiredArgument_1<::StringW>*> __get__packId() const;
...
/// @brief Method get_isAsyncCommand addr 0x2310f54 size 0x8 virtual true final false
inline bool get_isAsyncCommand() ;

/// @brief Method GetArguments addr 0x2310f5c size 0x144 virtual true final false
inline ::ArrayW<::GlobalNamespace::ArgumentBase*,::Array<::GlobalNamespace::ArgumentBase*>*> GetArguments() ;

/// @brief Method GetShortHelpText addr 0x23110a0 size 0x44 virtual true final false
inline ::GlobalNamespace::__DebugConsoleController__ConsoleMessage GetShortHelpText() ;

/// @brief Method GetLongUsageHelp addr 0x23110e4 size 0x44 virtual true final false
inline ::GlobalNamespace::__DebugConsoleController__ConsoleMessage GetLongUsageHelp() ;

/// @brief Method GetCommandName addr 0x2311128 size 0x40 virtual true final false
inline ::StringW GetCommandName() ;

/// @brief Method Execute addr 0x2311168 size 0x9a4 virtual true final false
inline void Execute(::System::Collections::Generic::List_1<::GlobalNamespace::__DebugConsoleController__ConsoleMessage>*  messages) ;

/// @brief Method ExecuteAsync addr 0x2311b14 size 0x88 virtual true final false
...
/// @brief Method .ctor addr 0x2311b9c size 0x25c virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 RunSongPackConsoleCommand()  = default;
public:
