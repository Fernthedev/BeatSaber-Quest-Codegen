...
/// @brief Field _difficultyText offset 0x58
...
/// @brief Field _fillIndicator offset 0x70
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FillIndicator*> __get__fillIndicator() const;
