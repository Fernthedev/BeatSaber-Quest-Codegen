...
/// @brief Field _defaultColorScheme offset 0x18
...
/// @brief Field _environmentColor0 offset 0x20
...
/// @brief Field _environmentColor1 offset 0x28
...
/// @brief Field _environmentColor0Boost offset 0x30
...
/// @brief Field _environmentColor1Boost offset 0x38
...
/// @brief Field _colorScheme offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ColorSchemeSO*> __get__defaultColorScheme() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SimpleColorSO*> __get__environmentColor0() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SimpleColorSO*> __get__environmentColor1() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SimpleColorSO*> __get__environmentColor0Boost() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SimpleColorSO*> __get__environmentColor1Boost() const;
...
// Ctor Parameters []
// @brief default ctor
 EnvironmentColorManager()  = default;
public:
