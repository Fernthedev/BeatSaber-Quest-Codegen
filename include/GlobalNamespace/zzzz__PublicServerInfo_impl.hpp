...
constexpr ::StringW& GlobalNamespace::PublicServerInfo::__get_code()  {
return ::cordl_internals::getInstanceField<::StringW, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr ::StringW const& GlobalNamespace::PublicServerInfo::__get_code() const {
return ::cordl_internals::getInstanceField<::StringW, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr int32_t& GlobalNamespace::PublicServerInfo::__get_currentPlayerCount()  {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& GlobalNamespace::PublicServerInfo::__get_currentPlayerCount() const {
return ::cordl_internals::getInstanceField<int32_t, 0x8>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
...
constexpr ::GlobalNamespace::PublicServerInfo::PublicServerInfo(::StringW  code, int32_t  currentPlayerCount) noexcept : ::bs_hook::ValueTypeWrapper<0x10>() {this->code = code;
