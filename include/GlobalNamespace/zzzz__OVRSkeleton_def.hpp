...
struct CORDL_TYPE __OVRSkeleton__SkeletonPoseData : public ::bs_hook::ValueTypeWrapper<0x40> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x40};

/// @brief Field <RootPose>k__BackingField offset 0x0
 __declspec(property(get=__get__RootPose_k__BackingField, put=__set__RootPose_k__BackingField)) ::GlobalNamespace::__OVRPlugin__Posef  _RootPose_k__BackingField;

/// @brief Field <RootScale>k__BackingField offset 0x1c
...
/// @brief Field <BoneRotations>k__BackingField offset 0x20
 __declspec(property(get=__get__BoneRotations_k__BackingField, put=__set__BoneRotations_k__BackingField)) ::ArrayW<::GlobalNamespace::__OVRPlugin__Quatf,::Array<::GlobalNamespace::__OVRPlugin__Quatf>*>  _BoneRotations_k__BackingField;

/// @brief Field <IsDataValid>k__BackingField offset 0x28
...
/// @brief Field <IsDataHighConfidence>k__BackingField offset 0x29
...
/// @brief Field <BoneTranslations>k__BackingField offset 0x30
 __declspec(property(get=__get__BoneTranslations_k__BackingField, put=__set__BoneTranslations_k__BackingField)) ::ArrayW<::GlobalNamespace::__OVRPlugin__Vector3f,::Array<::GlobalNamespace::__OVRPlugin__Vector3f>*>  _BoneTranslations_k__BackingField;

/// @brief Field <SkeletonChangedCount>k__BackingField offset 0x38
...
constexpr void __set__RootPose_k__BackingField(::GlobalNamespace::__OVRPlugin__Posef  value) ;

constexpr ::GlobalNamespace::__OVRPlugin__Posef& __get__RootPose_k__BackingField() ;

constexpr ::GlobalNamespace::__OVRPlugin__Posef const& __get__RootPose_k__BackingField() const;
...
constexpr void __set__BoneRotations_k__BackingField(::ArrayW<::GlobalNamespace::__OVRPlugin__Quatf,::Array<::GlobalNamespace::__OVRPlugin__Quatf>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__OVRPlugin__Quatf,::Array<::GlobalNamespace::__OVRPlugin__Quatf>*>& __get__BoneRotations_k__BackingField() ;

constexpr ::ArrayW<::GlobalNamespace::__OVRPlugin__Quatf,::Array<::GlobalNamespace::__OVRPlugin__Quatf>*> const& __get__BoneRotations_k__BackingField() const;
...
constexpr void __set__BoneTranslations_k__BackingField(::ArrayW<::GlobalNamespace::__OVRPlugin__Vector3f,::Array<::GlobalNamespace::__OVRPlugin__Vector3f>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__OVRPlugin__Vector3f,::Array<::GlobalNamespace::__OVRPlugin__Vector3f>*>& __get__BoneTranslations_k__BackingField() ;

constexpr ::ArrayW<::GlobalNamespace::__OVRPlugin__Vector3f,::Array<::GlobalNamespace::__OVRPlugin__Vector3f>*> const& __get__BoneTranslations_k__BackingField() const;
...
constexpr explicit __OVRSkeleton__SkeletonPoseData(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x40>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRSkeleton__SkeletonPoseData()  = default;
...
struct CORDL_TYPE __OVRSkeleton__SkeletonType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____OVRSkeleton__SkeletonType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRSkeleton__SkeletonType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRSkeleton__SkeletonType()  = default;
...
struct CORDL_TYPE __OVRSkeleton__BoneId : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____OVRSkeleton__BoneId_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __OVRSkeleton__BoneId(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRSkeleton__BoneId()  = default;
...
/// @brief Field _skeletonType offset 0x18
...
/// @brief Field _dataProvider offset 0x20
...
/// @brief Field _capsules offset 0x58
...
/// @brief Field <IsDataValid>k__BackingField offset 0x91
 __declspec(property(get=__get__IsDataValid_k__BackingField, put=__set__IsDataValid_k__BackingField)) bool  _IsDataValid_k__BackingField;

/// @brief Field <IsDataHighConfidence>k__BackingField offset 0x92
 __declspec(property(get=__get__IsDataHighConfidence_k__BackingField, put=__set__IsDataHighConfidence_k__BackingField)) bool  _IsDataHighConfidence_k__BackingField;

/// @brief Field <Bones>k__BackingField offset 0x98
...
/// @brief Field <BindPoses>k__BackingField offset 0xa0
...
/// @brief Field <Capsules>k__BackingField offset 0xa8
 __declspec(property(get=__get__Capsules_k__BackingField, put=__set__Capsules_k__BackingField)) ::System::Collections::Generic::IList_1<::GlobalNamespace::OVRBoneCapsule*>*  _Capsules_k__BackingField;

/// @brief Field <SkeletonChangedCount>k__BackingField offset 0xb0
 __declspec(property(get=__get__SkeletonChangedCount_k__BackingField, put=__set__SkeletonChangedCount_k__BackingField)) int32_t  _SkeletonChangedCount_k__BackingField;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRSkeleton__IOVRSkeletonDataProvider*> __get__dataProvider() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__bonesGO() const;

constexpr void __set__bindPosesGO(::UnityEngine::GameObject*  value) ;

constexpr ::UnityEngine::GameObject* __get__bindPosesGO() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__bindPosesGO() const;

constexpr void __set__capsulesGO(::UnityEngine::GameObject*  value) ;

constexpr ::UnityEngine::GameObject* __get__capsulesGO() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__capsulesGO() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::OVRBone*>*> __get__bones() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::OVRBone*>*> __get__bindPoses() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::OVRBoneCapsule*>*> __get__capsules() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<::GlobalNamespace::OVRBone*>*> __get__Bones_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<::GlobalNamespace::OVRBone*>*> __get__BindPoses_k__BackingField() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IList_1<::GlobalNamespace::OVRBoneCapsule*>*> __get__Capsules_k__BackingField() const;
