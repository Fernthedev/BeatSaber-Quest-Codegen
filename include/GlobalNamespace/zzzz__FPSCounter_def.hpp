...
/// @brief Field <currentFPS>k__BackingField offset 0x18
...
/// @brief Field <lowestFPS>k__BackingField offset 0x1c
...
/// @brief Field <highestFPS>k__BackingField offset 0x20
...
/// @brief Field <droppedFrames>k__BackingField offset 0x24
...
/// @brief Method get_currentFPS addr 0x226c604 size 0x8 virtual false final false
inline int32_t get_currentFPS() ;

/// @brief Method set_currentFPS addr 0x226c60c size 0x8 virtual false final false
inline void set_currentFPS(int32_t  value) ;

/// @brief Method get_lowestFPS addr 0x226c614 size 0x8 virtual false final false
inline int32_t get_lowestFPS() ;

/// @brief Method set_lowestFPS addr 0x226c61c size 0x8 virtual false final false
inline void set_lowestFPS(int32_t  value) ;

/// @brief Method get_highestFPS addr 0x226c624 size 0x8 virtual false final false
inline int32_t get_highestFPS() ;

/// @brief Method set_highestFPS addr 0x226c62c size 0x8 virtual false final false
inline void set_highestFPS(int32_t  value) ;

/// @brief Method get_droppedFrames addr 0x226c634 size 0x8 virtual false final false
inline int32_t get_droppedFrames() ;

/// @brief Method set_droppedFrames addr 0x226c63c size 0x8 virtual false final false
inline void set_droppedFrames(int32_t  value) ;

/// @brief Method Awake addr 0x226c644 size 0x10 virtual false final false
inline void Awake() ;

/// @brief Method Update addr 0x226c654 size 0xac virtual false final false
inline void Update() ;

static inline ::GlobalNamespace::FPSCounter* New_ctor() ;

/// @brief Method .ctor addr 0x226c700 size 0x10 virtual false final false
inline void _ctor() ;
