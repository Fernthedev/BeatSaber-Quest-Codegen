...
/// @brief Field _prefabAssetReference offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AddressableAssets::AssetReference*> __get__prefabAssetReference() const;
...
// Ctor Parameters []
// @brief default ctor
 __BTSCharacterDataModel__PrefabWithId()  = default;
public:
...
/// @brief Field _animationClipAssetReference offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AddressableAssets::AssetReference*> __get__animationClipAssetReference() const;
...
// Ctor Parameters []
// @brief default ctor
 __BTSCharacterDataModel__AnimationClipWithId()  = default;
public:
...
/// @brief Field _prefabsWithIds offset 0x18
 __declspec(property(get=__get__prefabsWithIds, put=__set__prefabsWithIds)) ::ArrayW<::GlobalNamespace::__BTSCharacterDataModel__PrefabWithId*,::Array<::GlobalNamespace::__BTSCharacterDataModel__PrefabWithId*>*>  _prefabsWithIds;

/// @brief Field _animationClipsWithIds offset 0x20
 __declspec(property(get=__get__animationClipsWithIds, put=__set__animationClipsWithIds)) ::ArrayW<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*,::Array<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*>*>  _animationClipsWithIds;
...
constexpr void __set__animationClipsWithIds(::ArrayW<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*,::Array<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*>*>  value) ;
...
constexpr ::ArrayW<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*,::Array<::GlobalNamespace::__BTSCharacterDataModel__AnimationClipWithId*>*> const& __get__animationClipsWithIds() const;
