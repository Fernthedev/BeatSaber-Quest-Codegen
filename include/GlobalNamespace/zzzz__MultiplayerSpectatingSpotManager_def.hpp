...
// Ctor Parameters []
// @brief default ctor
 __MultiplayerSpectatingSpotManager____c()  = default;
public:
...
/// @brief Field _spectatingSpots offset 0x10
...
/// @brief Field _spotIndexBySpot offset 0x18
 __declspec(property(get=__get__spotIndexBySpot, put=__set__spotIndexBySpot)) ::System::Collections::Generic::Dictionary_2<::GlobalNamespace::IMultiplayerSpectatingSpot*,int32_t>*  _spotIndexBySpot;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::IMultiplayerSpectatingSpot*>*> __get__spectatingSpots() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<::GlobalNamespace::IMultiplayerSpectatingSpot*,int32_t>*> __get__spotIndexBySpot() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerSpectatingSpotManager()  = default;
public:
