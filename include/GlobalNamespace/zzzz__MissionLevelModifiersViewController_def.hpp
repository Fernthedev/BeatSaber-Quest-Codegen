...
/// @brief Field modifierParamsList offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __MissionLevelModifiersViewController____c__DisplayClass7_0()  = default;
public:
...
/// @brief Field _gameplayModifierInfoListItemsList offset 0x78
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__modifiersPanel() const;
...
// Ctor Parameters []
// @brief default ctor
 MissionLevelModifiersViewController()  = default;
public:
