...
/// @brief Field _dataList offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ResultsTableCell*> __get__cellPrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::MultiplayerPlayerResultsData*>*> __get__dataList() const;
