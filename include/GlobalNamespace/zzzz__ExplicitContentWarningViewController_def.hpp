...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ExplicitContentWarningViewController*> __get___4__this() const;

static inline ::GlobalNamespace::__ExplicitContentWarningViewController___MainCoroutine_d__9* New_ctor(int32_t  __1__state) ;

/// @brief Method .ctor addr 0x22b0ae0 size 0x28 virtual false final false
inline void _ctor(int32_t  __1__state) ;

/// @brief Method System.IDisposable.Dispose addr 0x22b0be0 size 0x4 virtual true final true
inline void System_IDisposable_Dispose() ;

/// @brief Method MoveNext addr 0x22b0be4 size 0xc0 virtual true final true
inline bool MoveNext() ;

/// @brief Method System.Collections.Generic.IEnumerator<System.Object>.get_Current addr 0x22b0ca4 size 0x8 virtual true final true
inline ::System::Object* System_Collections_Generic_IEnumerator_System_Object__get_Current() ;

/// @brief Method System.Collections.IEnumerator.Reset addr 0x22b0cac size 0x40 virtual true final true
inline void System_Collections_IEnumerator_Reset() ;

/// @brief Method System.Collections.IEnumerator.get_Current addr 0x22b0cec size 0x8 virtual true final true
...
// Ctor Parameters []
// @brief default ctor
 __ExplicitContentWarningViewController___MainCoroutine_d__9()  = default;
public:
...
/// @brief Field _coroutineInProgress offset 0x90
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> __get__showButton() const;

constexpr void __set__hideButton(::UnityEngine::UI::Button*  value) ;

constexpr ::UnityEngine::UI::Button* __get__hideButton() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> __get__hideButton() const;
...
/// @brief Method add_didFinishEvent addr 0x22b0794 size 0x9c virtual false final false
inline void add_didFinishEvent(::System::Action*  value) ;

/// @brief Method remove_didFinishEvent addr 0x22b0830 size 0x9c virtual false final false
inline void remove_didFinishEvent(::System::Action*  value) ;

/// @brief Method DidActivate addr 0x22b08cc size 0x150 virtual true final false
inline void DidActivate(bool  firstActivation, bool  addedToHierarchy, bool  screenSystemEnabling) ;

/// @brief Method DidDeactivate addr 0x22b0a84 size 0x5c virtual true final false
inline void DidDeactivate(bool  removedFromHierarchy, bool  screenSystemDisabling) ;

/// @brief Method MainCoroutine addr 0x22b0a1c size 0x68 virtual false final false
...
/// @brief Method .ctor addr 0x22b0b08 size 0x8 virtual false final false
inline void _ctor() ;

/// @brief Method <DidActivate>b__7_0 addr 0x22b0b10 size 0x68 virtual false final false
inline void _DidActivate_b__7_0() ;

/// @brief Method <DidActivate>b__7_1 addr 0x22b0b78 size 0x68 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 ExplicitContentWarningViewController()  = default;
public:
