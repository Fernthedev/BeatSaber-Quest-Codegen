...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Animator*> GlobalNamespace::DeactivateAnimatorOnInputFocusCapture::__get__animator() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Animator*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IVRPlatformHelper*> GlobalNamespace::DeactivateAnimatorOnInputFocusCapture::__get__vrPlatformHelper() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IVRPlatformHelper*, 0x20>(this);
}
