...
/// @brief Field _canvasGroup offset 0x18
...
/// @brief Field _invertToggle offset 0x28
...
/// @brief Method OnEnable addr 0x2116b24 size 0xbc virtual false final false
inline void OnEnable() ;

/// @brief Method OnDisable addr 0x2116c10 size 0xa8 virtual false final false
inline void OnDisable() ;

/// @brief Method HandleToggleValueChanged addr 0x2116cb8 size 0x8 virtual false final false
inline void HandleToggleValueChanged(bool  isOn) ;

/// @brief Method SetCanvasGroupData addr 0x2116be0 size 0x30 virtual false final false
inline void SetCanvasGroupData(bool  isOn) ;

static inline ::GlobalNamespace::ToggleableCanvasGroup* New_ctor() ;

/// @brief Method .ctor addr 0x2116cc0 size 0x8 virtual false final false
inline void _ctor() ;
