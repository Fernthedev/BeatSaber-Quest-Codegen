...
/// @brief Field _missionNodeConnection offset 0x18
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MissionNodeConnection*> __get__missionNodeConnection() const;
...
// Ctor Parameters []
// @brief default ctor
 MissionNodeUpdatePositionInEditMode()  = default;
public:
