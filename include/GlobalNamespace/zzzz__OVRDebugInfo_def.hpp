...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_resolutionEyeTexture() const;

constexpr void __set_latencies(::UnityEngine::GameObject*  value) ;

constexpr ::UnityEngine::GameObject* __get_latencies() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_latencies() const;

constexpr void __set_texts(::UnityEngine::GameObject*  value) ;

constexpr ::UnityEngine::GameObject* __get_texts() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get_texts() const;
