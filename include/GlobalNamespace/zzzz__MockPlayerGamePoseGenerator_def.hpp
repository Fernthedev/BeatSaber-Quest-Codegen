...
/// @brief Field gameplayRpcManager offset 0x18
...
/// @brief Field mockNodePoseSyncStateSender offset 0x28
...
/// @brief Field mockScoreSyncStateSender offset 0x30
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IGameplayRpcManager*> __get_gameplayRpcManager() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MockScoreSyncStateSender*> __get_mockScoreSyncStateSender() const;
...
// Ctor Parameters []
// @brief default ctor
 MockPlayerGamePoseGenerator()  = default;
public:
