...
/// @brief Field _lastRightHandPoseTarget offset 0xb4
...
// Ctor Parameters []
// @brief default ctor
 MockPlayerLobbyPoseGeneratorAI()  = default;
public:
