...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x30 - sizeof(::GlobalNamespace::MockPlayerLobbyPoseGenerator)]{};
...
/// @brief Field _mirroredPlayer offset 0x28
...
// Ctor Parameters []
// @brief default ctor
 MockPlayerLobbyPoseGeneratorMirror()  = default;
public:
