...
/// @brief Field _idx offset 0x28
 __declspec(property(get=__get__idx, put=__set__idx)) int32_t  _idx;

/// @brief Field _numberOfElements offset 0x2c
...
constexpr ::cordl_internals::to_const_pointer<::HMUI::SimpleTextDropdown*> __get__dropdown() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_dropDownValueDidChangeEvent() const;
...
/// @brief Method add_dropDownValueDidChangeEvent addr 0x22a9f0c size 0x9c virtual false final false
inline void add_dropDownValueDidChangeEvent(::System::Action*  value) ;

/// @brief Method remove_dropDownValueDidChangeEvent addr 0x22a9fa8 size 0x9c virtual false final false
...
/// @brief Method OnEnable addr 0x22aa044 size 0xbc virtual false final false
inline void OnEnable() ;

/// @brief Method OnDisable addr 0x22aa240 size 0xd0 virtual false final false
inline void OnDisable() ;

/// @brief Method HandleDropdownValueDidChange addr 0x22aa310 size 0x40 virtual false final false
inline void HandleDropdownValueDidChange(::HMUI::DropdownWithTableView*  dropdownWithTableView, int32_t  idx) ;

/// @brief Method RefreshUI addr 0x22aa100 size 0x140 virtual false final false
inline void RefreshUI() ;

/// @brief Method Refresh addr 0x22aa350 size 0x5c virtual false final false
inline void Refresh(bool  applyValue) ;

static inline ::GlobalNamespace::DropdownSettingsController* New_ctor() ;

/// @brief Method .ctor addr 0x22aa3ac size 0x8 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 DropdownSettingsController()  = default;
public:
