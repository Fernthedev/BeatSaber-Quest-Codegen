...
::cordl_internals::setInstanceField<::GlobalNamespace::MaterialPropertyBlockColorSetter*, 0x18>(this, std::forward<::GlobalNamespace::MaterialPropertyBlockColorSetter*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::MaterialPropertyBlockColorSetter*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MaterialPropertyBlockColorSetter*> GlobalNamespace::BTSCharacterResultAnimationController::__get__rimLightColorSetter() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MaterialPropertyBlockColorSetter*, 0x18>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::MaterialPropertyBlockFloatAnimator*, 0x20>(this, std::forward<::GlobalNamespace::MaterialPropertyBlockFloatAnimator*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::MaterialPropertyBlockFloatAnimator*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MaterialPropertyBlockFloatAnimator*> GlobalNamespace::BTSCharacterResultAnimationController::__get__rimLightIntensityAnimator() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MaterialPropertyBlockFloatAnimator*, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::MaterialPropertyBlockFloatAnimator*, 0x28>(this, std::forward<::GlobalNamespace::MaterialPropertyBlockFloatAnimator*>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::MaterialPropertyBlockFloatAnimator*, 0x28>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::MaterialPropertyBlockFloatAnimator*> GlobalNamespace::BTSCharacterResultAnimationController::__get__rimLightEdgeStartAnimator() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::MaterialPropertyBlockFloatAnimator*, 0x28>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> GlobalNamespace::BTSCharacterResultAnimationController::__get__collidersGameObject() const {
return ::cordl_internals::getInstanceField<::UnityEngine::GameObject*, 0x30>(this);
}
