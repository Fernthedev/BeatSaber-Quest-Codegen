...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::ArrayW<::UnityEngine::Collider*,::Array<::UnityEngine::Collider*>*> (::GlobalNamespace::OVRGrabbable::*)()>(&::GlobalNamespace::OVRGrabbable::get_grabPoints)> {
  constexpr static std::size_t size = 0x8;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> GlobalNamespace::OVRGrabbable::__get_m_snapOffset() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x20>(this);
}
...
::cordl_internals::setInstanceField<::ArrayW<::UnityEngine::Collider*,::Array<::UnityEngine::Collider*>*>, 0x28>(this, std::forward<::ArrayW<::UnityEngine::Collider*,::Array<::UnityEngine::Collider*>*>>(value));
}
constexpr ::ArrayW<::UnityEngine::Collider*,::Array<::UnityEngine::Collider*>*>& GlobalNamespace::OVRGrabbable::__get_m_grabPoints()  {
return ::cordl_internals::getInstanceField<::ArrayW<::UnityEngine::Collider*,::Array<::UnityEngine::Collider*>*>, 0x28>(this);
}
...
::cordl_internals::setInstanceField<::UnityEngine::Collider*, 0x38>(this, std::forward<::UnityEngine::Collider*>(value));
}
constexpr ::UnityEngine::Collider* GlobalNamespace::OVRGrabbable::__get_m_grabbedCollider()  {
return ::cordl_internals::getInstanceField<::UnityEngine::Collider*, 0x38>(this);
}
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Collider*> GlobalNamespace::OVRGrabbable::__get_m_grabbedCollider() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Collider*, 0x38>(this);
}
constexpr void GlobalNamespace::OVRGrabbable::__set_m_grabbedBy(::GlobalNamespace::OVRGrabber*  value)  {
::cordl_internals::setInstanceField<::GlobalNamespace::OVRGrabber*, 0x40>(this, std::forward<::GlobalNamespace::OVRGrabber*>(value));
}
constexpr ::GlobalNamespace::OVRGrabber* GlobalNamespace::OVRGrabbable::__get_m_grabbedBy()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::OVRGrabber*, 0x40>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::OVRGrabber*> GlobalNamespace::OVRGrabbable::__get_m_grabbedBy() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::OVRGrabber*, 0x40>(this);
}
