...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<::GlobalNamespace::__Interop__ErrorInfo (*)(::GlobalNamespace::__Interop__Error)>(&::GlobalNamespace::InteropErrorExtensions::Info)> {
