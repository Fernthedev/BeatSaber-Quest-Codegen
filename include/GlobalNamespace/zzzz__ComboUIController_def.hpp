...
/// @brief Field _comboText offset 0x18
...
/// @brief Field _comboController offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IComboController*> __get__comboController() const;
