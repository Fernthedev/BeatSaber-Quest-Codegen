...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5457), inst: 4967 }), TypeDefinitionIndex(TypeDefinitionIndex(13653)), TypeDefinitionIndex(TypeDefinitionIndex(5457))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::GlobalNamespace::SelectableStateController_1<::HMUI::SelectableCell*>)]{};

/// @brief Method OnEnable addr 0x227fab0 size 0x164 virtual false final false
inline void OnEnable() ;

/// @brief Method OnDisable addr 0x227fc80 size 0x154 virtual false final false
inline void OnDisable() ;

/// @brief Method HandleSelectableCellInteractableDidChange addr 0x227fdd4 size 0x88 virtual false final false
inline void HandleSelectableCellInteractableDidChange(::HMUI::Interactable*  interactableCell, bool  interactable) ;

/// @brief Method HandleSelectableCellHighlightDidChange addr 0x227fe5c size 0x4 virtual false final false
...
/// @brief Method HandleSelectableCellSelectionStateDidChange addr 0x227fe60 size 0x4 virtual false final false
...
/// @brief Method ResolveState addr 0x227fc14 size 0x6c virtual false final false
...
/// @brief Method .ctor addr 0x227fe64 size 0x48 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 SelectableCellSelectableStateController()  = default;
public:
