...
/// @brief Field <levelID>k__BackingField offset 0x10
...
/// @brief Field <beatmapCharacteristicSerializedName>k__BackingField offset 0x18
 __declspec(property(get=__get__beatmapCharacteristicSerializedName_k__BackingField, put=__set__beatmapCharacteristicSerializedName_k__BackingField)) ::StringW  _beatmapCharacteristicSerializedName_k__BackingField;
...
// Ctor Parameters []
// @brief default ctor
 BeatmapIdentifierNetSerializable()  = default;
public:
