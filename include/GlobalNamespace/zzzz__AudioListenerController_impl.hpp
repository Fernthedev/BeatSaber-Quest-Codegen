...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::AudioListenerController::*)()>(&::GlobalNamespace::AudioListenerController::_ctor)> {
  constexpr static std::size_t size = 0x8;
...
return THROW_UNLESS(::il2cpp_utils::New<::GlobalNamespace::AudioListenerController*>());
}
