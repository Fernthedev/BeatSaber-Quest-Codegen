...
/// @brief Field _lightTranslationBaseDataList offset 0x38
 __declspec(property(get=__get__lightTranslationBaseDataList, put=__set__lightTranslationBaseDataList)) ::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::LightTranslationBaseData*>*  _lightTranslationBaseDataList;

/// @brief Field _axis offset 0x40
 __declspec(property(get=__get__axis, put=__set__axis)) ::GlobalNamespace::LightAxis  _axis;

/// @brief Field _translationDirection offset 0x44
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::IReadOnlyList_1<::GlobalNamespace::LightTranslationBaseData*>*> __get__lightTranslationBaseDataList() const;
...
// Ctor Parameters []
// @brief default ctor
 LightTranslationBeatmapEventDataBox()  = default;
public:
