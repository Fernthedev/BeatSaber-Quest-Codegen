...
/// @brief Field _localPositionOffset offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __MovementBeatmapEventEffect__MovementData()  = default;
public:
...
/// @brief Field _transitionSpeed offset 0x1c
 __declspec(property(get=__get__transitionSpeed, put=__set__transitionSpeed)) float_t  _transitionSpeed;

/// @brief Field _movementData offset 0x20
 __declspec(property(get=__get__movementData, put=__set__movementData)) ::ArrayW<::GlobalNamespace::__MovementBeatmapEventEffect__MovementData*,::Array<::GlobalNamespace::__MovementBeatmapEventEffect__MovementData*>*>  _movementData;
...
// Ctor Parameters []
// @brief default ctor
 MovementBeatmapEventEffect()  = default;
public:
