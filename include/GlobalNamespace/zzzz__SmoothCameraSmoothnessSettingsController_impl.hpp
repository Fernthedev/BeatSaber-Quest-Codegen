...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FloatSO*> GlobalNamespace::SmoothCameraSmoothnessSettingsController::__get__smoothCameraPositionSmooth() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::FloatSO*, 0x28>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::FloatSO*> GlobalNamespace::SmoothCameraSmoothnessSettingsController::__get__smoothCameraRotationSmooth() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::FloatSO*, 0x30>(this);
}
...
::cordl_internals::setInstanceField<::ArrayW<float_t,::Array<float_t>*>, 0x38>(this, std::forward<::ArrayW<float_t,::Array<float_t>*>>(value));
}
constexpr ::ArrayW<float_t,::Array<float_t>*>& GlobalNamespace::SmoothCameraSmoothnessSettingsController::__get__smoothnesses()  {
return ::cordl_internals::getInstanceField<::ArrayW<float_t,::Array<float_t>*>, 0x38>(this);
}
