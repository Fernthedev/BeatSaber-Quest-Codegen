...
/// @brief Method NoteCutDirectionFromDirection addr 0xe00908 size 0x218 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 NoteCutDirectionExtensions()  = default;
public:
