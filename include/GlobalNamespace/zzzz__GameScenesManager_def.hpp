...
/// @brief Field <sceneNames>k__BackingField offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> __get__sceneNames_k__BackingField() const;
...
// Ctor Parameters []
// @brief default ctor
 __GameScenesManager__ScenesStackData()  = default;
public:
...
struct CORDL_TYPE __GameScenesManager__ScenePresentType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
...
return std::bit_cast<____GameScenesManager__ScenePresentType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
constexpr explicit __GameScenesManager__ScenePresentType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __GameScenesManager__ScenePresentType()  = default;
...
struct CORDL_TYPE __GameScenesManager__SceneDismissType : public ::bs_hook::EnumTypeWrapper<0x4> {
public:
// Declarations
using __CORDL_BACKING_ENUM_TYPE = int32_t;
...
return std::bit_cast<____GameScenesManager__SceneDismissType_Unwrapped>(this->::bs_hook::EnumTypeWrapper<0x4>::instance);
}
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit __GameScenesManager__SceneDismissType(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::EnumTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __GameScenesManager__SceneDismissType()  = default;
...
/// @brief Field scenesStackData offset 0x10
...
/// @brief Field scenesTransitionSetupData offset 0x18
...
/// @brief Field finishCallback offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__GameScenesManager__ScenesStackData*> __get_scenesStackData() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ScenesTransitionSetupDataSO*> __get_scenesTransitionSetupData() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::GameScenesManager*> __get___4__this() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::Zenject::DiContainer*>*> __get_finishCallback() const;
...
// Ctor Parameters []
// @brief default ctor
 __GameScenesManager____c__DisplayClass30_0()  = default;
public:
...
/// @brief Field finishCallback offset 0x18
 __declspec(property(get=__get_finishCallback, put=__set_finishCallback)) ::System::Action_1<::Zenject::DiContainer*>*  finishCallback;
...
// Ctor Parameters []
// @brief default ctor
 __GameScenesManager____c__DisplayClass31_0()  = default;
public:
...
/// @brief Field newSceneNames offset 0x20
...
/// @brief Field emptyTransitionSceneNameList offset 0x28
...
/// @brief Field scenesStackData offset 0x30
 __declspec(property(get=__get_scenesStackData, put=__set_scenesStackData)) ::GlobalNamespace::__GameScenesManager__ScenesStackData*  scenesStackData;

/// @brief Field finishCallback offset 0x38
 __declspec(property(get=__get_finishCallback, put=__set_finishCallback)) ::System::Action_1<::Zenject::DiContainer*>*  finishCallback;

/// @brief Field <>9__1 offset 0x40
 __declspec(property(get=__get___9__1, put=__set___9__1)) ::System::Action_1<::Zenject::DiContainer*>*  __9__1;

/// @brief Field <>9__2 offset 0x48
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> __get_newSceneNames() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> __get_emptyTransitionSceneNameList() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::Zenject::DiContainer*>*> __get___9__1() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::Zenject::DiContainer*>*> __get___9__2() const;
...
// Ctor Parameters []
// @brief default ctor
 __GameScenesManager____c__DisplayClass32_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __GameScenesManager____c__DisplayClass33_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __GameScenesManager____c__DisplayClass34_0()  = default;
public:
...
/// @brief Field sceneNamesToRemove offset 0x20
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> __get_sceneNamesToRemove() const;
...
// Ctor Parameters []
// @brief default ctor
 __GameScenesManager____c__DisplayClass35_0()  = default;
public:
...
/// @brief Field newScenesTransitionSetupData offset 0x10
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::ScenesTransitionSetupDataSO*> __get_newScenesTransitionSetupData() const;
...
// Ctor Parameters []
// @brief default ctor
 __GameScenesManager____c__DisplayClass38_0()  = default;
public:
...
/// @brief Field newScenesTransitionSetupData offset 0x20
 __declspec(property(get=__get_newScenesTransitionSetupData, put=__set_newScenesTransitionSetupData)) ::GlobalNamespace::ScenesTransitionSetupDataSO*  newScenesTransitionSetupData;

/// @brief Field scenesToDismiss offset 0x28
...
/// @brief Field scenesToPresent offset 0x38
...
/// @brief Field afterMinDurationCallback offset 0x48
...
/// @brief Field dismissType offset 0x60
...
/// @brief Field finishCallback offset 0x68
 __declspec(property(get=__get_finishCallback, put=__set_finishCallback)) ::System::Action_1<::Zenject::DiContainer*>*  finishCallback;

/// @brief Field <eventSystem>5__2 offset 0x70
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> __get_scenesToDismiss() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::StringW>*> __get_scenesToPresent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_afterMinDurationCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__GameScenesManager____c__DisplayClass38_0*> __get___8__1() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::Zenject::DiContainer*>*> __get_extraBindingsCallback() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::EventSystems::EventSystem*> __get__eventSystem_5__2() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AsyncOperation*> __get__loadSceneOperation_5__4() const;
...
// Ctor Parameters []
// @brief default ctor
 __GameScenesManager___ScenesTransitionCoroutine_d__38()  = default;
public:
...
/// @brief Field kStandardTransitionLength offset 0x0
static constexpr float_t  kStandardTransitionLength{0.7};

/// @brief Field kShortTransitionLength offset 0x0
static constexpr float_t  kShortTransitionLength{0.35};

/// @brief Field kLongTransitionLength offset 0x0
static constexpr float_t  kLongTransitionLength{1.3};

/// @brief Field kRootContainerGOName offset 0x0
static constexpr ::ConstString  kRootContainerGOName{u"RootContainer"};

/// @brief Field _emptyTransitionSceneInfo offset 0x18
...
/// @brief Field _zenjectSceneLoader offset 0x20
...
/// @brief Field transitionDidStartEvent offset 0x28
...
/// @brief Field beforeDismissingScenesEvent offset 0x30
...
/// @brief Field transitionDidFinishEvent offset 0x38
 __declspec(property(get=__get_transitionDidFinishEvent, put=__set_transitionDidFinishEvent)) ::System::Action_2<::GlobalNamespace::ScenesTransitionSetupDataSO*,::Zenject::DiContainer*>*  transitionDidFinishEvent;

/// @brief Field installEarlyBindingsEvent offset 0x40
 __declspec(property(get=__get_installEarlyBindingsEvent, put=__set_installEarlyBindingsEvent)) ::System::Action_2<::GlobalNamespace::ScenesTransitionSetupDataSO*,::Zenject::DiContainer*>*  installEarlyBindingsEvent;

/// @brief Field _inTransition offset 0x48
 __declspec(property(get=__get__inTransition, put=__set__inTransition)) bool  _inTransition;

/// @brief Field _scenesStack offset 0x50
...
/// @brief Field _neverUnloadScenes offset 0x58
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SceneInfo*> __get__emptyTransitionSceneInfo() const;
...
constexpr ::cordl_internals::to_const_pointer<::Zenject::ZenjectSceneLoader*> __get__zenjectSceneLoader() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<float_t>*> __get_transitionDidStartEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action*> __get_beforeDismissingScenesEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::ScenesTransitionSetupDataSO*,::Zenject::DiContainer*>*> __get_transitionDidFinishEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_2<::GlobalNamespace::ScenesTransitionSetupDataSO*,::Zenject::DiContainer*>*> __get_installEarlyBindingsEvent() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::List_1<::GlobalNamespace::__GameScenesManager__ScenesStackData*>*> __get__scenesStack() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::HashSet_1<::StringW>*> __get__neverUnloadScenes() const;
...
inline void AppendScenes(::GlobalNamespace::ScenesTransitionSetupDataSO*  scenesTransitionSetupData, float_t  minDuration, ::System::Action*  afterMinDurationCallback, ::System::Action_1<::Zenject::DiContainer*>*  finishCallback) ;
