...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> GlobalNamespace::SpawnLaserAnimation::__get__centerThresholdTransform() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x18>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::Transform*> GlobalNamespace::SpawnLaserAnimation::__get__horizontalLasersTransform() const {
return ::cordl_internals::getInstanceField<::UnityEngine::Transform*, 0x20>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::TubeBloomPrePassLight*> GlobalNamespace::SpawnLaserAnimation::__get__leftHorizontalLaser() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::TubeBloomPrePassLight*, 0x28>(this);
}
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::TubeBloomPrePassLight*> GlobalNamespace::SpawnLaserAnimation::__get__rightHorizontalLaser() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::TubeBloomPrePassLight*, 0x30>(this);
}
