...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::OffsetByBeatmapObjectSpawnCenter::*)(float_t)>(&::GlobalNamespace::OffsetByBeatmapObjectSpawnCenter::HandleSpawnCenterDistanceWasFound)> {
  ...
  constexpr static std::size_t addrs = 0x23766b4;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::GlobalNamespace::OffsetByBeatmapObjectSpawnCenter::*)()>(&::GlobalNamespace::OffsetByBeatmapObjectSpawnCenter::_ctor)> {
  ...
  constexpr static std::size_t addrs = 0x23767cc;
...
::cordl_internals::setInstanceField<::GlobalNamespace::BeatmapObjectSpawnCenter*, 0x18>(this, std::forward<::GlobalNamespace::BeatmapObjectSpawnCenter*>(value));
}
constexpr ::GlobalNamespace::BeatmapObjectSpawnCenter* GlobalNamespace::OffsetByBeatmapObjectSpawnCenter::__get__spawnCenter()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapObjectSpawnCenter*, 0x18>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BeatmapObjectSpawnCenter*> GlobalNamespace::OffsetByBeatmapObjectSpawnCenter::__get__spawnCenter() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::BeatmapObjectSpawnCenter*, 0x18>(this);
}
