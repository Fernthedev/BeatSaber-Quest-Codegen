...
struct CORDL_TYPE __OVRTelemetryMarker__OVRTelemetryMarkerState : public ::bs_hook::ValueTypeWrapper<0x4> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x4};

/// @brief Field <Sent>k__BackingField offset 0x0
 __declspec(property(get=__get__Sent_k__BackingField, put=__set__Sent_k__BackingField)) bool  _Sent_k__BackingField;

/// @brief Field <Result>k__BackingField offset 0x2
 __declspec(property(get=__get__Result_k__BackingField, put=__set__Result_k__BackingField)) ::GlobalNamespace::__OVRPlugin__Qpl__ResultType  _Result_k__BackingField;
...
constexpr void __set__Sent_k__BackingField(bool  value) ;

constexpr bool& __get__Sent_k__BackingField() ;

constexpr bool const& __get__Sent_k__BackingField() const;

constexpr void __set__Result_k__BackingField(::GlobalNamespace::__OVRPlugin__Qpl__ResultType  value) ;

constexpr ::GlobalNamespace::__OVRPlugin__Qpl__ResultType& __get__Result_k__BackingField() ;

constexpr ::GlobalNamespace::__OVRPlugin__Qpl__ResultType const& __get__Result_k__BackingField() const;
...
constexpr explicit __OVRTelemetryMarker__OVRTelemetryMarkerState(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x4>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 __OVRTelemetryMarker__OVRTelemetryMarkerState()  = default;
...
struct CORDL_TYPE OVRTelemetryMarker : public ::bs_hook::ValueTypeWrapper<0x18> {
public:
// Declarations
...
/// @brief Field <State>k__BackingField offset 0x0
 __declspec(property(get=__get__State_k__BackingField, put=__set__State_k__BackingField)) ::GlobalNamespace::__OVRTelemetryMarker__OVRTelemetryMarkerState  _State_k__BackingField;

/// @brief Field <MarkerId>k__BackingField offset 0x4
 __declspec(property(get=__get__MarkerId_k__BackingField, put=__set__MarkerId_k__BackingField)) int32_t  _MarkerId_k__BackingField;

/// @brief Field <InstanceKey>k__BackingField offset 0x8
 __declspec(property(get=__get__InstanceKey_k__BackingField, put=__set__InstanceKey_k__BackingField)) int32_t  _InstanceKey_k__BackingField;

/// @brief Field _client offset 0x10
 __declspec(property(get=__get__client, put=__set__client)) ::GlobalNamespace::__OVRTelemetry__TelemetryClient*  _client;
...
constexpr void __set__State_k__BackingField(::GlobalNamespace::__OVRTelemetryMarker__OVRTelemetryMarkerState  value) ;

constexpr ::GlobalNamespace::__OVRTelemetryMarker__OVRTelemetryMarkerState& __get__State_k__BackingField() ;

constexpr ::GlobalNamespace::__OVRTelemetryMarker__OVRTelemetryMarkerState const& __get__State_k__BackingField() const;

constexpr void __set__MarkerId_k__BackingField(int32_t  value) ;

constexpr int32_t& __get__MarkerId_k__BackingField() ;

constexpr int32_t const& __get__MarkerId_k__BackingField() const;

constexpr void __set__InstanceKey_k__BackingField(int32_t  value) ;

constexpr int32_t& __get__InstanceKey_k__BackingField() ;

constexpr int32_t const& __get__InstanceKey_k__BackingField() const;

constexpr void __set__client(::GlobalNamespace::__OVRTelemetry__TelemetryClient*  value) ;

constexpr ::GlobalNamespace::__OVRTelemetry__TelemetryClient* __get__client() ;

constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__OVRTelemetry__TelemetryClient*> __get__client() const;
...
// Ctor Parameters [CppParam { name: "instance", ty: "std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>", modifiers: "", def_value: None }]
// @brief Constructor that lets you initialize the internal array explicitly
constexpr explicit OVRTelemetryMarker(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x18>(instance) {
}

// Ctor Parameters []
// @brief default ctor
 OVRTelemetryMarker()  = default;
