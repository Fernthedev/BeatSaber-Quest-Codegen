...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> __get__buyLevelButton() const;

constexpr void __set__openPackButton(::UnityEngine::UI::Button*  value) ;

constexpr ::UnityEngine::UI::Button* __get__openPackButton() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> __get__openPackButton() const;

constexpr void __set__buyPackButton(::UnityEngine::UI::Button*  value) ;

constexpr ::UnityEngine::UI::Button* __get__buyPackButton() ;

constexpr ::cordl_internals::to_const_pointer<::UnityEngine::UI::Button*> __get__buyPackButton() const;
...
// Ctor Parameters []
// @brief default ctor
 StandardLevelBuyInfoView()  = default;
public:
