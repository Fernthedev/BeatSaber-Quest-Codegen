...
/// @brief Field _promoText offset 0x28
...
/// @brief Field _currentPromoMusicPack offset 0x38
...
/// @brief Field _currentPromoBeatmapLevel offset 0x40
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::GameObject*> __get__promoBannerGo() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> __get__promoBannerTransform() const;

constexpr void __set__promoText(::TMPro::TextMeshProUGUI*  value) ;

constexpr ::TMPro::TextMeshProUGUI* __get__promoText() ;

constexpr ::cordl_internals::to_const_pointer<::TMPro::TextMeshProUGUI*> __get__promoText() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IBeatmapLevelPack*> __get__currentPromoMusicPack() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IPreviewBeatmapLevel*> __get__currentPromoBeatmapLevel() const;
