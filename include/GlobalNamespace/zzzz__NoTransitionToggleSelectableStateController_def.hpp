...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(13637)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(5457), inst: 4966 }), TypeDefinitionIndex(TypeDefinitionIndex(5457))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x38 - sizeof(::GlobalNamespace::SelectableStateController_1<::HMUI::NoTransitionsToggle*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 NoTransitionToggleSelectableStateController()  = default;
public:
