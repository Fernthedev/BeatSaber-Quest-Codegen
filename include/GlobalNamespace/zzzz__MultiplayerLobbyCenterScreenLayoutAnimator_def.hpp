...
/// @brief Field _nextLevelTransform offset 0x18
...
/// @brief Field _nextLevelBasePosition offset 0x20
...
/// @brief Field _nextLevelCountdownPosition offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> __get__nextLevelTransform() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> __get__nextLevelBasePosition() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::RectTransform*> __get__nextLevelCountdownPosition() const;
...
// Ctor Parameters []
// @brief default ctor
 MultiplayerLobbyCenterScreenLayoutAnimator()  = default;
public:
