...
/// @brief Field ambientVolumeScale offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __SongPreviewPlayer__InitData()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 __SongPreviewPlayer__AudioSourceParams()  = default;
public:
...
/// @brief Field _volume offset 0x1c
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AudioSource*> __get_audioSource() const;
...
// Ctor Parameters []
// @brief default ctor
 __SongPreviewPlayer__AudioSourceVolumeController()  = default;
public:
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::SongPreviewPlayer*> __get___4__this() const;
...
// Ctor Parameters []
// @brief default ctor
 __SongPreviewPlayer___CrossFadeAfterDelayCoroutine_d__28()  = default;
public:
...
/// @brief Field _crossFadeToAnotherSongSpeed offset 0x34
...
/// @brief Field _crossFadeToDefaultSpeed offset 0x38
...
/// @brief Field _othersAudioSourceParams offset 0x48
...
/// @brief Field _audioManager offset 0x58
 __declspec(property(get=__get__audioManager, put=__set__audioManager)) ::GlobalNamespace::AudioManagerSO*  _audioManager;

/// @brief Field _audioSourceControllers offset 0x60
 __declspec(property(get=__get__audioSourceControllers, put=__set__audioSourceControllers)) ::ArrayW<::GlobalNamespace::__SongPreviewPlayer__AudioSourceVolumeController*,::Array<::GlobalNamespace::__SongPreviewPlayer__AudioSourceVolumeController*>*>  _audioSourceControllers;

/// @brief Field _activeChannel offset 0x68
 __declspec(property(get=__get__activeChannel, put=__set__activeChannel)) int32_t  _activeChannel;

/// @brief Field _timeToDefaultAudioTransition offset 0x6c
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AudioSource*> __get__audioSourcePrefab() const;
...
constexpr ::cordl_internals::to_const_pointer<::UnityEngine::AudioClip*> __get__defaultAudioClip() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__SongPreviewPlayer__AudioSourceParams*> __get__defaultAudioSourceParams() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__SongPreviewPlayer__AudioSourceParams*> __get__othersAudioSourceParams() const;
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::__SongPreviewPlayer__InitData*> __get__initData() const;
...
constexpr void __set__audioSourceControllers(::ArrayW<::GlobalNamespace::__SongPreviewPlayer__AudioSourceVolumeController*,::Array<::GlobalNamespace::__SongPreviewPlayer__AudioSourceVolumeController*>*>  value) ;

constexpr ::ArrayW<::GlobalNamespace::__SongPreviewPlayer__AudioSourceVolumeController*,::Array<::GlobalNamespace::__SongPreviewPlayer__AudioSourceVolumeController*>*>& __get__audioSourceControllers() ;

constexpr ::ArrayW<::GlobalNamespace::__SongPreviewPlayer__AudioSourceVolumeController*,::Array<::GlobalNamespace::__SongPreviewPlayer__AudioSourceVolumeController*>*> const& __get__audioSourceControllers() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<int32_t,::System::Action*>*> __get__channelToFadeOutCallbackDictionary() const;
