...
/// @brief Field _playerTransforms offset 0x38
...
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::BezierSplineEvaluator*> __get__pathBezierCurveEvaluator() const;
...
/// @brief Method .ctor addr 0x2217174 size 0x78 virtual false final false
...
/// @brief Method GetCurrentPathPosition addr 0x22171ec size 0x104 virtual false final false
...
// Ctor Parameters []
// @brief default ctor
 BeatmapObjectAvoidancePathEvaluator()  = default;
public:
