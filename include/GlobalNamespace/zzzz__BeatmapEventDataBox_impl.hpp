...
constexpr void GlobalNamespace::__BeatmapEventDataBox__DistributionParamType::__set_value__(int32_t  value)  {
::cordl_internals::setInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance, std::forward<int32_t>(value));
}
constexpr int32_t& GlobalNamespace::__BeatmapEventDataBox__DistributionParamType::__get_value__()  {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
constexpr int32_t const& GlobalNamespace::__BeatmapEventDataBox__DistributionParamType::__get_value__() const {
return ::cordl_internals::getInstanceField<int32_t, 0x0>(this->::bs_hook::ValueTypeWrapper<__IL2CPP_VALUE_TYPE_SIZE>::instance);
}
// Ctor Parameters [CppParam { name: "value__", ty: "int32_t", modifiers: "", def_value: Some("{}") }]
constexpr ::GlobalNamespace::__BeatmapEventDataBox__DistributionParamType::__BeatmapEventDataBox__DistributionParamType(int32_t  value__) noexcept : ::bs_hook::EnumTypeWrapper<0x4>() {this->value__ = value__;
}
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (*)(float_t, ::GlobalNamespace::__BeatmapEventDataBox__DistributionParamType, int32_t)>(&::GlobalNamespace::BeatmapEventDataBox::BeatDistributionParamToStep)> {
  constexpr static std::size_t size = 0x20;
  ...
  inline static const ::MethodInfo* methodInfo() {
    static auto* ___internal_method = THROW_UNLESS((::il2cpp_utils::FindMethod(
                            ...
                            std::vector<Il2CppClass*>{},
                            ::std::vector<const Il2CppType*>{::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<float_t>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<::GlobalNamespace::__BeatmapEventDataBox__DistributionParamType>::get(), ::il2cpp_utils::il2cpp_type_check::il2cpp_no_arg_type<int32_t>::get()}
                        )));
    return ___internal_method;
  }
};
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (*)(::GlobalNamespace::IndexFilter*, ::GlobalNamespace::__BeatmapEventDataBox__DistributionParamType, float_t, float_t)>(&::GlobalNamespace::BeatmapEventDataBox::GetBeatStep)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<float_t (*)(int32_t, float_t, ::GlobalNamespace::__BeatmapEventDataBox__DistributionParamType, int32_t, ::GlobalNamespace::EaseType)>(&::GlobalNamespace::BeatmapEventDataBox::EventDistributionParamToStep)> {
...
::cordl_internals::setInstanceField<::GlobalNamespace::IndexFilter*, 0x10>(this, std::forward<::GlobalNamespace::IndexFilter*>(value));
}
constexpr ::GlobalNamespace::IndexFilter* GlobalNamespace::BeatmapEventDataBox::__get__indexFilter_k__BackingField()  {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IndexFilter*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::GlobalNamespace::IndexFilter*> GlobalNamespace::BeatmapEventDataBox::__get__indexFilter_k__BackingField() const {
return ::cordl_internals::getInstanceField<::GlobalNamespace::IndexFilter*, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::__BeatmapEventDataBox__DistributionParamType, 0x1c>(this, std::forward<::GlobalNamespace::__BeatmapEventDataBox__DistributionParamType>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::__BeatmapEventDataBox__DistributionParamType, 0x1c>(this);
}
...
::cordl_internals::setInstanceField<::GlobalNamespace::__BeatmapEventDataBox__DistributionParamType, 0x24>(this, std::forward<::GlobalNamespace::__BeatmapEventDataBox__DistributionParamType>(value));
}
...
return ::cordl_internals::getInstanceField<::GlobalNamespace::__BeatmapEventDataBox__DistributionParamType, 0x24>(this);
}
...
return THROW_UNLESS(::il2cpp_utils::New<::GlobalNamespace::BeatmapEventDataBox*>(indexFilter, beatDistributionParamType, beatDistributionParam, eventDistributionParamType, eventDistributionParam, eventDistributionShouldAffectFirstBaseEvent, eventDistributionEaseType));
}
