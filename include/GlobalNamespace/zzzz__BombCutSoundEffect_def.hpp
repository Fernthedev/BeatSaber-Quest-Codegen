...
/// @brief Field didFinishEvent offset 0x20
...
/// @brief Field _saber offset 0x28
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::BombCutSoundEffect*>*> __get_didFinishEvent() const;
...
/// @brief Method add_didFinishEvent addr 0x222c5d4 size 0xb0 virtual false final false
inline void add_didFinishEvent(::System::Action_1<::GlobalNamespace::BombCutSoundEffect*>*  value) ;

/// @brief Method remove_didFinishEvent addr 0x222c684 size 0xb0 virtual false final false
inline void remove_didFinishEvent(::System::Action_1<::GlobalNamespace::BombCutSoundEffect*>*  value) ;

/// @brief Method Init addr 0x222c734 size 0x74 virtual false final false
inline void Init(::UnityEngine::AudioClip*  audioClip, ::GlobalNamespace::Saber*  saber, float_t  volume) ;

/// @brief Method LateUpdate addr 0x222c7a8 size 0x90 virtual false final false
inline void LateUpdate() ;

/// @brief Method StopPlayingAndFinish addr 0x222c838 size 0x50 virtual false final false
inline void StopPlayingAndFinish() ;

static inline ::GlobalNamespace::BombCutSoundEffect* New_ctor() ;

/// @brief Method .ctor addr 0x222c888 size 0x8 virtual false final false
inline void _ctor() ;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11050), inst: 287 }), TypeDefinitionIndex(TypeDefinitionIndex(4058)), TypeDefinitionIndex(TypeDefinitionIndex(11050))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::Zenject::MonoMemoryPool_1<::GlobalNamespace::BombCutSoundEffect*>)]{};

static inline ::GlobalNamespace::__BombCutSoundEffect__Pool* New_ctor() ;

/// @brief Method .ctor addr 0x222c890 size 0x48 virtual false final false
inline void _ctor() ;
...
// Ctor Parameters []
// @brief default ctor
 __BombCutSoundEffect__Pool()  = default;
public:
