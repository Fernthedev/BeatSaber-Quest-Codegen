...
// CS Name: ::BitMask256
struct CORDL_TYPE BitMask256 : public ::bs_hook::ValueTypeWrapper<0x20> {
public:
// Declarations
/// @brief The size of the true value type
static constexpr auto  __IL2CPP_VALUE_TYPE_SIZE{0x20};

/// @brief Field _d0 offset 0x0
 __declspec(property(get=__get__d0, put=__set__d0)) uint64_t  _d0;

/// @brief Field _d1 offset 0x8
 __declspec(property(get=__get__d1, put=__set__d1)) uint64_t  _d1;

/// @brief Field _d2 offset 0x10
 __declspec(property(get=__get__d2, put=__set__d2)) uint64_t  _d2;

/// @brief Field _d3 offset 0x18
 __declspec(property(get=__get__d3, put=__set__d3)) uint64_t  _d3;
...
constexpr uint64_t& __get__d0() ;

constexpr uint64_t const& __get__d0() const;

constexpr void __set__d1(uint64_t  value) ;

constexpr uint64_t& __get__d1() ;

constexpr uint64_t const& __get__d1() const;

constexpr void __set__d2(uint64_t  value) ;

constexpr uint64_t& __get__d2() ;

constexpr uint64_t const& __get__d2() const;

constexpr void __set__d3(uint64_t  value) ;

constexpr uint64_t& __get__d3() ;

constexpr uint64_t const& __get__d3() const;
...
constexpr explicit BitMask256(std::array<std::byte, __IL2CPP_VALUE_TYPE_SIZE>  instance) noexcept : ::bs_hook::ValueTypeWrapper<0x20>(instance) {
}
