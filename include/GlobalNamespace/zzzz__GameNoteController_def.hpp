...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0xb8 - sizeof(::GlobalNamespace::NoteController)]{};
...
/// @brief Field cubeNoteControllerDidInitEvent offset 0xa0
 __declspec(property(get=__get_cubeNoteControllerDidInitEvent, put=__set_cubeNoteControllerDidInitEvent)) ::System::Action_1<::GlobalNamespace::GameNoteController*>*  cubeNoteControllerDidInitEvent;
...
/// @brief Field _cutAngleTolerance offset 0xb0
...
constexpr ::cordl_internals::to_const_pointer<::System::Action_1<::GlobalNamespace::GameNoteController*>*> __get_cubeNoteControllerDidInitEvent() const;
...
namespace GlobalNamespace {
// Is value type: false
// Dependencies: {TypeDefinitionIndex(TypeDefinitionIndex(11050)), GenericInstantiation(GenericInstantiation { tdi: TypeDefinitionIndex(11050), inst: 310 }), TypeDefinitionIndex(TypeDefinitionIndex(4744))}
...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x40 - sizeof(::Zenject::MonoMemoryPool_1<::GlobalNamespace::GameNoteController*>)]{};
...
// Ctor Parameters []
// @brief default ctor
 __GameNoteController__Pool()  = default;
public:
