...
/// @brief Field prevObstacleDataInLines offset 0x10
 __declspec(property(get=__get_prevObstacleDataInLines, put=__set_prevObstacleDataInLines)) ::ArrayW<::GlobalNamespace::ObstacleData*,::Array<::GlobalNamespace::ObstacleData*>*>  prevObstacleDataInLines;
...
// Ctor Parameters []
// @brief default ctor
 __BeatmapDataObstaclesMergingTransform____c__DisplayClass0_0()  = default;
public:
...
// Ctor Parameters []
// @brief default ctor
 BeatmapDataObstaclesMergingTransform()  = default;
public:
