...
/// @brief The size this ref type adds onto its base type, may evaluate to 0
 uint8_t  __fields[0x20 - sizeof(::LiteNetLib::Layers::PacketLayerBase)]{};

/// @brief Field _byteKey offset 0x18
...
/// @brief Method .ctor addr 0x220d468 size 0x1c virtual false final false
inline void _ctor() ;

static inline ::LiteNetLib::Layers::XorEncryptLayer* New_ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method .ctor addr 0x220d484 size 0x30 virtual false final false
inline void _ctor(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

static inline ::LiteNetLib::Layers::XorEncryptLayer* New_ctor(::StringW  key) ;

/// @brief Method .ctor addr 0x220d548 size 0x30 virtual false final false
inline void _ctor(::StringW  key) ;

/// @brief Method SetKey addr 0x220d578 size 0x44 virtual false final false
inline void SetKey(::StringW  key) ;

/// @brief Method SetKey addr 0x220d4b4 size 0x94 virtual false final false
inline void SetKey(::ArrayW<uint8_t,::Array<uint8_t>*>  key) ;

/// @brief Method ProcessInboundPacket addr 0x220d5bc size 0x90 virtual true final false
...
/// @brief Method ProcessOutBoundPacket addr 0x220d64c size 0x8c virtual true final false
