...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::LiteNetLib::ConnectionRequest::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t, bool)>(&::LiteNetLib::ConnectionRequest::Reject)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::LiteNetLib::ConnectionRequest::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t)>(&::LiteNetLib::ConnectionRequest::Reject)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::LiteNetLib::ConnectionRequest::*)(::ArrayW<uint8_t,::Array<uint8_t>*>, int32_t, int32_t)>(&::LiteNetLib::ConnectionRequest::RejectForce)> {
  constexpr static std::size_t size = 0x8;
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::LiteNetLib::ConnectionRequest::*)(::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::LiteNetLib::ConnectionRequest::RejectForce)> {
...
struct ::il2cpp_utils::il2cpp_type_check::MetadataGetter<static_cast<void (::LiteNetLib::ConnectionRequest::*)(::ArrayW<uint8_t,::Array<uint8_t>*>)>(&::LiteNetLib::ConnectionRequest::Reject)> {
  constexpr static std::size_t size = 0x20;
...
::cordl_internals::setInstanceField<::LiteNetLib::NetManager*, 0x10>(this, std::forward<::LiteNetLib::NetManager*>(value));
}
constexpr ::LiteNetLib::NetManager* LiteNetLib::ConnectionRequest::__get__listener()  {
return ::cordl_internals::getInstanceField<::LiteNetLib::NetManager*, 0x10>(this);
}
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetManager*> LiteNetLib::ConnectionRequest::__get__listener() const {
return ::cordl_internals::getInstanceField<::LiteNetLib::NetManager*, 0x10>(this);
}
...
::cordl_internals::setInstanceField<::LiteNetLib::Utils::NetDataReader*, 0x20>(this, std::forward<::LiteNetLib::Utils::NetDataReader*>(value));
}
constexpr ::LiteNetLib::Utils::NetDataReader* LiteNetLib::ConnectionRequest::__get_Data()  {
return ::cordl_internals::getInstanceField<::LiteNetLib::Utils::NetDataReader*, 0x20>(this);
}
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::Utils::NetDataReader*> LiteNetLib::ConnectionRequest::__get_Data() const {
return ::cordl_internals::getInstanceField<::LiteNetLib::Utils::NetDataReader*, 0x20>(this);
}
constexpr void LiteNetLib::ConnectionRequest::__set__Result_k__BackingField(::LiteNetLib::ConnectionRequestResult  value)  {
::cordl_internals::setInstanceField<::LiteNetLib::ConnectionRequestResult, 0x28>(this, std::forward<::LiteNetLib::ConnectionRequestResult>(value));
}
constexpr ::LiteNetLib::ConnectionRequestResult& LiteNetLib::ConnectionRequest::__get__Result_k__BackingField()  {
return ::cordl_internals::getInstanceField<::LiteNetLib::ConnectionRequestResult, 0x28>(this);
}
...
::cordl_internals::setInstanceField<uint8_t, 0x38>(this, std::forward<uint8_t>(value));
}
constexpr uint8_t& LiteNetLib::ConnectionRequest::__get_ConnectionNumber()  {
return ::cordl_internals::getInstanceField<uint8_t, 0x38>(this);
}
...
::cordl_internals::setInstanceField<::System::Net::IPEndPoint*, 0x40>(this, std::forward<::System::Net::IPEndPoint*>(value));
}
constexpr ::System::Net::IPEndPoint* LiteNetLib::ConnectionRequest::__get_RemoteEndPoint()  {
return ::cordl_internals::getInstanceField<::System::Net::IPEndPoint*, 0x40>(this);
}
constexpr ::cordl_internals::to_const_pointer<::System::Net::IPEndPoint*> LiteNetLib::ConnectionRequest::__get_RemoteEndPoint() const {
return ::cordl_internals::getInstanceField<::System::Net::IPEndPoint*, 0x40>(this);
}
