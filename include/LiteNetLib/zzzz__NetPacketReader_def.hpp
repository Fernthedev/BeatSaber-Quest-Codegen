...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetManager*> __get__manager() const;

constexpr void __set__evt(::LiteNetLib::NetEvent*  value) ;

constexpr ::LiteNetLib::NetEvent* __get__evt() ;

constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetEvent*> __get__evt() const;
