...
/// @brief Field Fragments offset 0x10
...
// Ctor Parameters []
// @brief default ctor
 __NetPeer__IncomingFragments()  = default;
public:
...
/// @brief Field _channels offset 0x80
...
/// @brief Field _deliveredFramgnets offset 0xc0
...
/// @brief Field _connectAcceptPacket offset 0x118
...
constexpr ::cordl_internals::to_const_pointer<::System::Diagnostics::Stopwatch*> __get__pingTimer() const;
...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetPacketPool*> __get__packetPool() const;

constexpr void __set__flushLock(::System::Object*  value) ;

constexpr ::System::Object* __get__flushLock() ;

constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__flushLock() const;

constexpr void __set__sendLock(::System::Object*  value) ;

constexpr ::System::Object* __get__sendLock() ;

constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__sendLock() const;

constexpr void __set__shutdownLock(::System::Object*  value) ;

constexpr ::System::Object* __get__shutdownLock() ;

constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__shutdownLock() const;

constexpr void __set_NextPeer(::LiteNetLib::NetPeer*  value) ;

constexpr ::LiteNetLib::NetPeer* __get_NextPeer() ;

constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetPeer*> __get_NextPeer() const;

constexpr void __set_PrevPeer(::LiteNetLib::NetPeer*  value) ;

constexpr ::LiteNetLib::NetPeer* __get_PrevPeer() ;

constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetPeer*> __get_PrevPeer() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Queue_1<::LiteNetLib::NetPacket*>*> __get__unreliableChannel() const;
...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::BaseChannel*> __get__headChannel() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get__mtuMutex() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint16_t,::LiteNetLib::__NetPeer__IncomingFragments*>*> __get__holdedFragments() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Collections::Generic::Dictionary_2<uint16_t,uint16_t>*> __get__deliveredFramgnets() const;

constexpr void __set__mergeData(::LiteNetLib::NetPacket*  value) ;

constexpr ::LiteNetLib::NetPacket* __get__mergeData() ;

constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetPacket*> __get__mergeData() const;
...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetPacket*> __get__shutdownPacket() const;
...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetPacket*> __get__pingPacket() const;

constexpr void __set__pongPacket(::LiteNetLib::NetPacket*  value) ;

constexpr ::LiteNetLib::NetPacket* __get__pongPacket() ;

constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetPacket*> __get__pongPacket() const;
...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetPacket*> __get__connectRequestPacket() const;
...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetPacket*> __get__connectAcceptPacket() const;
...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetManager*> __get_NetManager() const;
...
constexpr ::cordl_internals::to_const_pointer<::System::Object*> __get_Tag() const;
