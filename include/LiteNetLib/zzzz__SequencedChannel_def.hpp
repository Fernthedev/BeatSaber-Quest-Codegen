...
constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetPacket*> __get__lastPacket() const;

constexpr void __set__ackPacket(::LiteNetLib::NetPacket*  value) ;

constexpr ::LiteNetLib::NetPacket* __get__ackPacket() ;

constexpr ::cordl_internals::to_const_pointer<::LiteNetLib::NetPacket*> __get__ackPacket() const;
